...
public class GlDebug {
   ...
   private static final List DEBUG_LEVELS;
   private static final List DEBUG_LEVELS_ARB;
   private static final Map SAVED_STATES;

   private static String printUnknownToken(int var0) {
      return "Unknown (0x" + Integer.toHexString(var0).toUpperCase() + ")";
   }

   private static String sourceToString(int var0) {
      switch(var0) {
      case 33350:
         return "API";
      case 33351:
   ...
   private static String severityToString(int var0) {
      switch(var0) {
      case 33387:
         return "NOTIFICATION";
      case 37190:
   ...
   private static void printDebugLog(int var0, int var1, int var2, int var3, int var4, long var5, long var7) {
      LOGGER.info("OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", var2, sourceToString(var0), typeToString(var1), severityToString(var3), GLDebugMessageCallback.getMessage(var4, var5));
   }

   private static void setup(int var0, String var1) {
      BY_ID.merge(var0, var1, (var0x, var1x) -> {
         return var0x + "/" + var1x;
      });
   }
   ...
   static {
      ...
      DEBUG_LEVELS = ImmutableList.of(37190, 37191, 37192, 33387);
      DEBUG_LEVELS_ARB = ImmutableList.of(37190, 37191, 37192);
