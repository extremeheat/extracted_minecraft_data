...
public abstract class RowButton {
   ...
   public static void drawButtonsInRow(List var0, RealmsObjectSelectionList var1, int var2, int var3, int var4, int var5) {
   ...
   public static void rowButtonMouseClicked(RealmsObjectSelectionList var0, RealmListEntry var1, List var2, int var3, double var4, double var6) {
      if (var3 == 0) {
