...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   private static final List playButtonIds = Arrays.asList(1, 2, 3);
   private static final List resetButtonIds = Arrays.asList(4, 5, 6);
   private static final List downloadButtonIds = Arrays.asList(7, 8, 9);
   private static final List downloadConfirmationIds = Arrays.asList(10, 11, 12);
