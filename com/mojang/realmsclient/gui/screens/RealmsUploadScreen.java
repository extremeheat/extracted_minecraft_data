         ...
         try {
            if (uploadLock.tryLock(1L, TimeUnit.SECONDS)) {
               ...
               if (this.verify(var1)) {
                  ...
                  FileUpload var26 = new FileUpload(var1, this.worldId, this.slotId, var5, Realms.getSessionId(), Realms.getName(), Realms.getMinecraftVersionString(), this.uploadStatus);
                  var26.upload((var3x) -> {
               ...
               RealmsUploadScreen.Unit var9 = getLargestUnit(var7);
               RealmsUploadScreen.Unit var10 = getLargestUnit(5368709120L);
               if (humanReadableSize(var7, var9).equals(humanReadableSize(5368709120L, var10)) && var9 != RealmsUploadScreen.Unit.B) {
                  RealmsUploadScreen.Unit var11 = RealmsUploadScreen.Unit.values()[var9.ordinal() - 1];
                  this.errorMessage = getLocalizedString("mco.upload.size.failure.line1", new Object[]{this.selectedLevel.getLevelName()}) + "\\n" + getLocalizedString("mco.upload.size.failure.line2", new Object[]{humanReadableSize(var7, var11), humanReadableSize(5368709120L, var11)});
                  return;
               }

               this.errorMessage = getLocalizedString("mco.upload.size.failure.line1", new Object[]{this.selectedLevel.getLevelName()}) + "\\n" + getLocalizedString("mco.upload.size.failure.line2", new Object[]{humanReadableSize(var7, var9), humanReadableSize(5368709120L, var10)});
               return;
            }
