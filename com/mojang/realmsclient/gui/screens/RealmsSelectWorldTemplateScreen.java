...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   private Either fetchTemplates(WorldTemplatePaginatedList var1, RealmsClient var2) {
      try {
   ...
   private void renderMultilineMessage(int var1, int var2, List var3) {
   ...
   class WorldTemplateObjectSelectionList extends RealmsObjectSelectionList {
      ...
      public WorldTemplateObjectSelectionList(Iterable var2) {
