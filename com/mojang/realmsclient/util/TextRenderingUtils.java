...
public class TextRenderingUtils {
   static List lineBreak(String var0) {
      return Arrays.asList(var0.split("\\n"));
   }

   public static List decompose(String var0, TextRenderingUtils.LineSegment... var1) {
      return decompose(var0, Arrays.asList(var1));
   }

   private static List decompose(String var0, List var1) {
