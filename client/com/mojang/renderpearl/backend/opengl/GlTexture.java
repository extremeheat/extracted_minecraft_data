...
class GlTexture extends BaseGpuTexture implements FrameBufferAttachment {
   ...
   protected GlTexture(final GlDevice device, final @GpuTexture.Usage int usage, final String label, final GpuFormat format, final int width, final int height, final int depthOrLayers, final int mipLevels, final int id, final FrameBufferCache frameBufferCache) {
   ...
   private void destroyImmediately() {
      ...
      this.device.stateManager()._deleteTexture(this.id);
   }
