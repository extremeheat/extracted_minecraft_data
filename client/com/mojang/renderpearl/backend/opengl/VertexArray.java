         ...
         for(int attributeIndex = 0; attributeIndex < 16; ++attributeIndex) {
            if (this.bufferIndex[attributeIndex] != -1) {
               ...
               if (this.isInteger[attributeIndex]) {
                  ...
                  GL33C.glVertexAttribPointer(attributeIndex, this.channelCount[attributeIndex], this.glType[attributeIndex], this.isNormalized[attributeIndex], this.bufferStride[vertexBufferIndex], totalOffset);
               }
