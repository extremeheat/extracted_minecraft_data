...
public class Lighting implements AutoCloseable {
   ...
   public static final int UBO_SIZE = 32;
   ...
   public Lighting() {
      ...
      this.paddedSize = Mth.roundToward(32, var1.getUniformOffsetAlignment());
      ...
      Matrix4f var4 = (new Matrix4f()).rotateX(0.7853982F);
   ...
   private void updateBuffer(Entry var1, Vector3f var2, Vector3f var3) {
      ...
      try {
         ByteBuffer var5 = Std140Builder.onStack(var4, 32).putVec3(var2).putVec3(var3).get();
   ...
   public void setupFor(Entry var1) {
      RenderSystem.setShaderLights(this.buffer.slice(var1.ordinal() * this.paddedSize, 32));
   }
