...
public final class Window implements AutoCloseable {
   ...
   public Window(WindowEventHandler var1, ScreenManager var2, DisplayData var3, @Nullable String var4, String var5) {
      ...
      if (var7 != null) {
         ...
         this.windowedX = this.field_401 = var7.getX() + var8.getWidth() / 2 - this.width / 2;
         this.windowedY = this.field_402 = var7.getY() + var8.getHeight() / 2 - this.height / 2;
      } else {
         int[] var10 = new int[1];
         int[] var9 = new int[1];
         GLFW.glfwGetWindowPos(this.window, var10, var9);
         this.windowedX = this.field_401 = var10[0];
         this.windowedY = this.field_402 = var9[0];
      }
   ...
   private void setMode() {
      ...
      if (this.fullscreen) {
         ...
         if (var2 == null) {
            ...
            if (!var1) {
               this.windowedX = this.field_401;
               this.windowedY = this.field_402;
            ...
            GLFW.glfwSetWindowMonitor(this.window, var2.getMonitor(), this.field_401, this.field_402, this.width, this.height, var3.getRefreshRate());
         }
      } else {
         this.field_401 = this.windowedX;
         this.field_402 = this.windowedY;
         this.width = this.windowedWidth;
         this.height = this.windowedHeight;
         GLFW.glfwSetWindowMonitor(this.window, 0L, this.field_401, this.field_402, this.width, this.height, -1);
      }
