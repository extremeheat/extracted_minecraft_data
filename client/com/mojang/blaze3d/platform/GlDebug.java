...
public class GlDebug {
   ...
   public static List<String> getLastOpenGlDebugMessages() {
      synchronized(MESSAGE_BUFFER) {
         ...
         while(var2.hasNext()) {
            GlDebug.LogEntry var3 = (GlDebug.LogEntry)var2.next();
   ...
   private static class LogEntry {
      ...
      boolean isSame(int var1, int var2, int var3, int var4, String var5) {
         return var2 == this.type && var1 == this.source && var3 == this.field_361 && var4 == this.severity && var5.equals(this.message);
      }

      public String toString() {
         int var10000 = this.field_361;
