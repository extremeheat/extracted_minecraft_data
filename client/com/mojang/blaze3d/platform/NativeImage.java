...
public final class NativeImage implements AutoCloseable {
   ...
   public static enum InternalGlFormat {
      RGBA(6408),
      RGB(6407),
      // $FF: renamed from: RG com.mojang.blaze3d.platform.NativeImage$InternalGlFormat
      field_434(33319),
      RED(6403);
      ...
      // $FF: synthetic method
      private static NativeImage.InternalGlFormat[] $values() {
         return new NativeImage.InternalGlFormat[]{RGBA, RGB, field_434, RED};
      }
   }
}
