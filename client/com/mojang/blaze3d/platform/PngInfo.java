...
public class PngInfo {
   ...
   public PngInfo(Supplier<String> var1, InputStream var2) throws IOException {
      super();
      MemoryStack var3 = MemoryStack.stackPush();

      try {
         StbReader var4 = createCallbacks(var2);
               ...
               try {
                  ...
                  try {
                     ...
                     if (!STBImage.stbi_info_from_callbacks(var8, 0L, var9, var10, var11)) {
                        String var10002 = (String)var1.get();
   ...
   private static StbReader createCallbacks(InputStream var0) {
      return (StbReader)(var0 instanceof FileInputStream ? new StbReaderSeekableByteChannel(((FileInputStream)var0).getChannel()) : new StbReaderBufferedChannel(Channels.newChannel(var0)));
   }
   ...
   private static class StbReaderBufferedChannel extends StbReader {
