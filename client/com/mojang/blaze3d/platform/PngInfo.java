...
public class PngInfo {
   ...
   public PngInfo(Supplier<String> var1, InputStream var2) throws IOException {
      ...
      try (PngInfo.StbReader var4 = createCallbacks(var2)) {
            ...
            try {
               ...
               try {
                  ...
                  if (!STBImage.stbi_info_from_callbacks(var8, 0L, var9, var10, var11)) {
                     throw new IOException("Could not read info from the PNG file " + (String)var1.get() + " " + STBImage.stbi_failure_reason());
                  }
   ...
   private static PngInfo.StbReader createCallbacks(InputStream var0) {
      return (PngInfo.StbReader)(var0 instanceof FileInputStream
         ? new PngInfo.StbReaderSeekableByteChannel(((FileInputStream)var0).getChannel())
         : new PngInfo.StbReaderBufferedChannel(Channels.newChannel(var0)));
   }
