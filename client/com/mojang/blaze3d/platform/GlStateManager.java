...
public class GlStateManager {
   ...
   public static void setupGuiFlatDiffuseLighting(Vector3f var0, Vector3f var1) {
      ...
      var2.multiply(Vector3f.field_292.rotationDegrees(-22.5F));
      var2.multiply(Vector3f.field_290.rotationDegrees(135.0F));
   ...
   public static void setupGui3DDiffuseLighting(Vector3f var0, Vector3f var1) {
      ...
      Matrix4f var2 = new Matrix4f();
      var2.setIdentity();
      var2.multiply(Vector3f.field_292.rotationDegrees(62.0F));
      var2.multiply(Vector3f.field_290.rotationDegrees(185.5F));
      var2.multiply(Vector3f.field_292.rotationDegrees(-22.5F));
      var2.multiply(Vector3f.field_290.rotationDegrees(135.0F));
      setupLevelDiffuseLighting(var0, var1, var2);
   }
   ...
   public static void _logicOp(int var0) {
      RenderSystem.assertOnRenderThread();
      if (var0 != COLOR_LOGIC.field_161) {
         COLOR_LOGIC.field_161 = var0;
         GL11.glLogicOp(var0);
      }
   ...
   public static void _viewport(int var0, int var1, int var2, int var3) {
      RenderSystem.assertOnRenderThreadOrInit();
      GlStateManager.Viewport.INSTANCE.field_405 = var0;
      GlStateManager.Viewport.INSTANCE.field_406 = var1;
   ...
   static {
      ON_LINUX = Util.getPlatform() == Util.class_278.LINUX;
      ...
      SCISSOR = new GlStateManager.ScissorState();
      TEXTURES = (GlStateManager.TextureState[])IntStream.range(0, 12).mapToObj((var0) -> {
   ...
   public static enum Viewport {
      ...
      protected int field_405;
      // $FF: renamed from: y int
      protected int field_406;
      protected int width;
      ...
      public static int method_102() {
         return INSTANCE.field_405;
      }

      // $FF: renamed from: y () int
      public static int method_103() {
         return INSTANCE.field_406;
      }
   ...
   public static enum LogicOp {
      ...
      private static GlStateManager.LogicOp[] $values() {
         return new GlStateManager.LogicOp[]{AND, AND_INVERTED, AND_REVERSE, CLEAR, COPY, COPY_INVERTED, EQUIV, INVERT, NAND, NOOP, NOR, field_241, OR_INVERTED, OR_REVERSE, SET, XOR};
      }
   }
}
