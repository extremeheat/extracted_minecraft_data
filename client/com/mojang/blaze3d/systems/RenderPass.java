...
public interface RenderPass extends AutoCloseable {
   ...
   void drawMultipleIndexed(Collection<Draw> var1);

   void draw(int var1, int var2);

   void close();

   public static record Draw(int slot, GpuBuffer vertexBuffer, GpuBuffer indexBuffer, VertexFormat.IndexType indexType, int firstIndex, int indexCount, @Nullable Consumer<UniformUploader> uniformUploaderConsumer) {
      ...
      public Draw(int var1, GpuBuffer var2, GpuBuffer var3, VertexFormat.IndexType var4, int var5, int var6, @Nullable Consumer<UniformUploader> var7) {
         super();
         this.slot = var1;
