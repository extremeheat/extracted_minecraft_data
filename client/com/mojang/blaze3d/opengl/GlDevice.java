...
class GlDevice implements GpuDeviceBackend {
   ...
   public GlDevice(final long windowHandle, final ShaderSource defaultShaderSource, final GpuDebugOptions debugOptions) {
      ...
      this.deviceInfo = new DeviceInfo(GlStateManager._getString(7937), GlStateManager._getString(7936), GlStateManager._getString(7938), capabilities.GL_ARB_clip_control, "OpenGL", 1.0F, new DeviceLimits(maxSupportedAnisotropy, GL11.glGetInteger(35380), getMaxSupportedTextureSize()), Collections.unmodifiableSet(enabledExtensions));
      ...
      this.directStateAccess = DirectStateAccess.create(capabilities, enabledExtensions, workarounds);
