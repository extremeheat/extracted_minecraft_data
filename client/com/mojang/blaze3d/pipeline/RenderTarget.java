...
public abstract class RenderTarget {
   ...
   private void _blitToScreen(int var1, int var2, boolean var3) {
      ...
      var12.vertex(0.0D, (double)var8, 0.0D).method_7(0.0F, 0.0F).color(255, 255, 255, 255).endVertex();
      var12.vertex((double)var7, (double)var8, 0.0D).method_7(var9, 0.0F).color(255, 255, 255, 255).endVertex();
      var12.vertex((double)var7, 0.0D, 0.0D).method_7(var9, var10).color(255, 255, 255, 255).endVertex();
      var12.vertex(0.0D, 0.0D, 0.0D).method_7(0.0F, var10).color(255, 255, 255, 255).endVertex();
      var12.end();
