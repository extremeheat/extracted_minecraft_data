...
public abstract class StagingBuffer implements AutoCloseable {
   ...
   public static StagingBuffer create(final String name, final GpuDevice gpuDevice, final int bufferSize, final GraphicsWorkarounds workarounds) {
      return (StagingBuffer)(!workarounds.isGlOnDx12() ? new Cpu(bufferSize) : new PersistentlyMapped(name, gpuDevice, bufferSize));
   }
