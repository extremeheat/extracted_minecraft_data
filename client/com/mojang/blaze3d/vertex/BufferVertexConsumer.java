...
public interface BufferVertexConsumer extends VertexConsumer {
   ...
   default VertexConsumer method_7(float var1, float var2) {
      VertexFormatElement var3 = this.currentElement();
      if (var3.getUsage() == VertexFormatElement.Usage.field_183 && var3.getIndex() == 0) {
   ...
   default VertexConsumer uvShort(short var1, short var2, int var3) {
      ...
      if (var4.getUsage() == VertexFormatElement.Usage.field_183 && var4.getIndex() == var3) {
