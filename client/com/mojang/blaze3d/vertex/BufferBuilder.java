...
public class BufferBuilder implements VertexConsumer {
   ...
   private void endLastVertex() {
      if (this.vertices != 0) {
         if (this.elementsToFill != 0) {
            String var3 = VertexFormatElement.elementsFromMask(this.elementsToFill).map(this.format::getElementName).collect(Collectors.joining(", "));
   ...
   private static void putPackedUv(long var0, int var2) {
      if (IS_LITTLE_ENDIAN) {
         ...
         MemoryUtil.memPutShort(var0, (short)(var2 & 65535));
         MemoryUtil.memPutShort(var0 + 2L, (short)(var2 >> 16 & 65535));
      }
   }
