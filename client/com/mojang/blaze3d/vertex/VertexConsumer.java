...
public interface VertexConsumer {
   ...
   default VertexConsumer setLight(int var1) {
      return this.setUv2(var1 & 65535, var1 >> 16 & 65535);
   }

   default VertexConsumer setOverlay(int var1) {
      return this.setUv1(var1 & 65535, var1 >> 16 & 65535);
   }
      ...
      try {
         ...
         for (int var21 = 0; var21 < var16; var21++) {
            ...
            if (var10) {
               ...
               float var30 = (float)(var19.get(14) & 255);
            ...
            this.addVertex(var32.x(), var32.y(), var32.z(), var35, var37, var31, var9, var36, var14.x(), var14.y(), var14.z());
         }
