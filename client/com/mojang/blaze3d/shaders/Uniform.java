...
public class Uniform extends AbstractUniform implements AutoCloseable {
   ...
   public final void set(Vector3f var1) {
      this.floatValues.position(0);
      this.floatValues.put(0, var1.method_82());
      this.floatValues.put(1, var1.method_83());
      this.floatValues.put(2, var1.method_84());
      this.markDirty();
   }
   ...
   public final void set(Vector4f var1) {
      this.floatValues.position(0);
      this.floatValues.put(0, var1.method_66());
      this.floatValues.put(1, var1.method_67());
      this.floatValues.put(2, var1.method_68());
      this.floatValues.put(3, var1.method_69());
      this.markDirty();
   }
