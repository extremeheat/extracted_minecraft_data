...
public class RealmsBrokenWorldScreen extends RealmsScreen {
         ...
         if (var4) {
            var5 = new Button(this.getFramePositionX(var3), row(8), 80, 20, new TranslatableComponent("mco.brokenworld.play"), (var2x) -> {
               if (((RealmsWorldOptions)this.serverData.slots.get(var3)).empty) {
                  ...
                  this.minecraft.setScreen(new RealmsLongRunningMcoTaskScreen(this.lastScreen, new SwitchSlotTask(this.serverData.field_121, var3, this::doSwitchOrReset)));
               }
   ...
   private void downloadWorld(int var1) {
      ...
      try {
         WorldDownload var3 = var2.requestDownloadInfo(this.serverData.field_121, var1);
