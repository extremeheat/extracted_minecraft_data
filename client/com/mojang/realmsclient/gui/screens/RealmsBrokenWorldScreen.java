...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   public Component getNarrationMessage() {
      return ComponentUtils.formatList((Collection)Stream.concat(Stream.of(this.title), Stream.of(this.message)).collect(Collectors.toList()), (Component)Component.literal(" "));
   }
   ...
   private void addButtons() {
      ...
      while(var1.hasNext()) {
         ...
         Button var5;
         if (var4) {
            var5 = new Button(this.getFramePositionX(var3), row(8), 80, 20, Component.translatable("mco.brokenworld.play"), (var2x) -> {
            ...
            var5 = new Button(this.getFramePositionX(var3), row(8), 80, 20, Component.translatable("mco.brokenworld.download"), (var2x) -> {
         ...
         this.addRenderableWidget(new Button(this.getFramePositionX(var3), row(10), 80, 20, Component.translatable("mco.brokenworld.reset"), (var2x) -> {
