...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addRenderableWidget(new RealmsResetWorldScreen.FrameButton(this.frame(2), row(0) + 10, new TranslatableComponent("mco.reset.world.upload"), UPLOAD_LOCATION, (var1) -> {
         this.minecraft.setScreen(new RealmsSelectFileToUploadScreen(this.serverData.field_121, this.slot != -1 ? this.slot : this.serverData.activeSlot, this, this.callback));
      }));
   ...
   public void switchSlot(Runnable var1) {
      this.startTask(new SwitchSlotTask(this.serverData.field_121, this.slot, () -> {
   ...
   private void templateSelectionCallback(@Nullable WorldTemplate var1) {
      ...
      if (var1 != null) {
         this.resetWorld(() -> {
            this.startTask(new ResettingTemplateWorldTask(var1, this.serverData.field_121, this.resetTitle, this.resetWorldRunnable));
         });
      }
   ...
   private void generationSelectionCallback(@Nullable WorldGenerationInfo var1) {
      ...
      if (var1 != null) {
         this.resetWorld(() -> {
            this.startTask(new ResettingGeneratedWorldTask(var1, this.serverData.field_121, this.resetTitle, this.resetWorldRunnable));
         });
      }
