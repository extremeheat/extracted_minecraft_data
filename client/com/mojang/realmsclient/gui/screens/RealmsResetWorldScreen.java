...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addRenderableWidget(new FrameButton(this.frame(1), row(0) + 10, Component.translatable("mco.reset.world.generate"), NEW_WORLD_LOCATION, (var1) -> {
         this.minecraft.setScreen(new RealmsResetNormalWorldScreen(this::generationSelectionCallback, this.title));
      }));
      this.addRenderableWidget(new FrameButton(this.frame(2), row(0) + 10, Component.translatable("mco.reset.world.upload"), UPLOAD_LOCATION, (var1) -> {
      ...
      this.addRenderableWidget(new FrameButton(this.frame(3), row(0) + 10, Component.translatable("mco.reset.world.template"), SURVIVAL_SPAWN_LOCATION, (var1) -> {
      ...
      this.addRenderableWidget(new FrameButton(this.frame(1), row(6) + 20, Component.translatable("mco.reset.world.adventure"), ADVENTURE_MAP_LOCATION, (var1) -> {
      ...
      this.addRenderableWidget(new FrameButton(this.frame(2), row(6) + 20, Component.translatable("mco.reset.world.experience"), EXPERIENCE_LOCATION, (var1) -> {
      ...
      this.addRenderableWidget(new FrameButton(this.frame(3), row(6) + 20, Component.translatable("mco.reset.world.inspiration"), INSPIRATION_LOCATION, (var1) -> {
   ...
   class FrameButton extends Button {
      ...
      public void renderButton(PoseStack var1, int var2, int var3, float var4) {
         RealmsResetWorldScreen.this.drawFrame(var1, this.x, this.y, this.getMessage(), this.image, this.isHoveredOrFocused(), this.isMouseOver((double)var2, (double)var3));
      }
   }
}
