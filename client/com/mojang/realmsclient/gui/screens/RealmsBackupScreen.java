...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.downloadButton = this.addRenderableWidget(
         new Button(this.width - 135, row(1), 120, 20, Component.translatable("mco.backup.button.download"), var1 -> this.downloadClicked())
      );
      this.restoreButton = this.addRenderableWidget(
         new Button(this.width - 135, row(3), 120, 20, Component.translatable("mco.backup.button.restore"), var1 -> this.restoreClicked(this.selectedBackup))
      );
      this.changesButton = this.addRenderableWidget(
         new Button(this.width - 135, row(5), 120, 20, Component.translatable("mco.backup.changes.tooltip"), var1 -> {
