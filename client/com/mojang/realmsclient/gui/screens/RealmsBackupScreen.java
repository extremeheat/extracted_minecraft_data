...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      (new Thread("Realms-fetch-backups") {
         public void run() {
            ...
            try {
               List var2 = var1.backupsFor(RealmsBackupScreen.this.serverData.field_121).backups;
   ...
   private void downloadWorldData() {
      ...
      var10000.setScreen(new RealmsLongRunningMcoTaskScreen(var10003, new DownloadTask(this.serverData.field_121, this.slotId, var10008 + " (" + ((RealmsWorldOptions)this.serverData.slots.get(this.serverData.activeSlot)).getSlotName(this.serverData.activeSlot) + ")", this)));
   }

   private void restore() {
      Backup var1 = (Backup)this.backups.get(this.selectedBackup);
      this.selectedBackup = -1;
      this.minecraft.setScreen(new RealmsLongRunningMcoTaskScreen(this.lastScreen.getNewScreen(), new RestoreTask(var1, this.serverData.field_121, this.lastScreen)));
   }
