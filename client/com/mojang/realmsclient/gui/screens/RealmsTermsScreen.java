...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addRenderableWidget(new Button(this.width / 4, row(12), var1, 20, Component.translatable("mco.terms.buttons.agree"), (var1x) -> {
         this.agreedToTos();
      }));
      this.addRenderableWidget(new Button(this.width / 2 + 4, row(12), var1, 20, Component.translatable("mco.terms.buttons.disagree"), (var1x) -> {
   ...
   static {
      TERMS_LINK_TEXT = Component.literal(" ").append((Component)Component.translatable("mco.terms.sentence.2").withStyle(Style.EMPTY.withUnderlined(true)));
   }
}
