...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   class PendingInvitationSelectionListEntry extends RealmListEntry {
      ...
      private void renderPendingInvitationItem(PendingInvite var1, int var2, int var3, int var4, int var5) {
         ...
         RealmsPendingInvitesScreen.this.drawString(var1.worldOwnerName, var2 + 38, var3 + 12, 7105644);
         RealmsPendingInvitesScreen.this.drawString(RealmsPendingInvitesScreen.getAge(var1), var2 + 38, var3 + 24, 7105644);
