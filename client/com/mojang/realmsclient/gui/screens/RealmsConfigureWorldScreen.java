...
public class RealmsConfigureWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.playersButton = (Button)this.addRenderableWidget(new Button(this.centerButton(0, 3), row(0), 100, 20, Component.translatable("mco.configure.world.buttons.players"), (var1x) -> {
         this.minecraft.setScreen(new RealmsPlayerScreen(this, this.serverData));
      }));
      this.settingsButton = (Button)this.addRenderableWidget(new Button(this.centerButton(1, 3), row(0), 100, 20, Component.translatable("mco.configure.world.buttons.settings"), (var1x) -> {
         this.minecraft.setScreen(new RealmsSettingsScreen(this, this.serverData.clone()));
      }));
      this.subscriptionButton = (Button)this.addRenderableWidget(new Button(this.centerButton(2, 3), row(0), 100, 20, Component.translatable("mco.configure.world.buttons.subscription"), (var1x) -> {
      ...
      this.switchMinigameButton = (Button)this.addRenderableWidget(new Button(this.leftButton(0), row(13) - 5, 100, 20, Component.translatable("mco.configure.world.buttons.switchminigame"), (var1x) -> {
      ...
      this.optionsButton = (Button)this.addRenderableWidget(new Button(this.leftButton(0), row(13) - 5, 90, 20, Component.translatable("mco.configure.world.buttons.options"), (var1x) -> {
      ...
      this.backupButton = (Button)this.addRenderableWidget(new Button(this.leftButton(1), row(13) - 5, 90, 20, Component.translatable("mco.configure.world.backup"), (var1x) -> {
         this.minecraft.setScreen(new RealmsBackupScreen(this, this.serverData.clone(), this.serverData.activeSlot));
      }));
      this.resetWorldButton = (Button)this.addRenderableWidget(new Button(this.leftButton(2), row(13) - 5, 90, 20, Component.translatable("mco.configure.world.buttons.resetworld"), (var1x) -> {
