...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   public RealmsSelectWorldTemplateScreen(Component var1, Consumer<WorldTemplate> var2, RealmsServer.WorldType var3, @Nullable WorldTemplatePaginatedList var4) {
      ...
      if (var4 == null) {
         ...
         this.worldTemplateObjectSelectionList = new WorldTemplateObjectSelectionList(Lists.newArrayList(var4.templates));
   ...
   public void init() {
      ...
      this.trailerButton = (Button)this.addRenderableWidget(new Button(this.width / 2 - 206, this.height - 32, 100, 20, Component.translatable("mco.template.button.trailer"), (var1x) -> {
         this.onTrailer();
      }));
      this.selectButton = (Button)this.addRenderableWidget(new Button(this.width / 2 - 100, this.height - 32, 100, 20, Component.translatable("mco.template.button.select"), (var1x) -> {
         this.selectTemplate();
      }));
      ...
      this.publisherButton = (Button)this.addRenderableWidget(new Button(this.width / 2 + 112, this.height - 32, 100, 20, Component.translatable("mco.template.button.publisher"), (var1x) -> {
         this.onPublish();
      }));
   ...
   class WorldTemplateObjectSelectionList extends RealmsObjectSelectionList<Entry> {
      ...
      public WorldTemplate get(int var1) {
         return ((Entry)this.children().get(var1)).template;
      }
