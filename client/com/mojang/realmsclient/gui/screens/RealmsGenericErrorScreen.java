...
public class RealmsGenericErrorScreen extends RealmsScreen {
   ...
   private static Pair<Component, Component> errorMessage(RealmsServiceException var0) {
      if (var0.realmsError == null) {
         return Pair.of(new TextComponent("An error occurred (" + var0.httpResultCode + "):"), new TextComponent(var0.rawResponse));
      } else {
         String var1 = "mco.errorMessage." + var0.realmsError.getErrorCode();
         return Pair.of(new TextComponent("Realms (" + var0.realmsError + "):"), I18n.exists(var1) ? new TranslatableComponent(var1) : Component.nullToEmpty(var0.realmsError.getErrorMessage()));
      }
   }

   private static Pair<Component, Component> errorMessage(Component var0) {
      return Pair.of(new TextComponent("An error occurred: "), var0);
   }
