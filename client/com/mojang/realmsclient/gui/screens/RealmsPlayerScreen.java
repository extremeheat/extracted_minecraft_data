...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void render(int var1, int var2, float var3) {
      ...
      var5.vertex(0.0D, (double)this.height(), 0.0D).tex(0.0D, (double)((float)(this.height() - var4) / 32.0F + 0.0F)).color(64, 64, 64, 255).endVertex();
      var5.vertex((double)this.width(), (double)this.height(), 0.0D).tex((double)((float)this.width() / 32.0F), (double)((float)(this.height() - var4) / 32.0F + 0.0F)).color(64, 64, 64, 255).endVertex();
      var5.vertex((double)this.width(), (double)var4, 0.0D).tex((double)((float)this.width() / 32.0F), 0.0D).color(64, 64, 64, 255).endVertex();
      var5.vertex(0.0D, (double)var4, 0.0D).tex(0.0D, 0.0D).color(64, 64, 64, 255).endVertex();
      var5.end();
