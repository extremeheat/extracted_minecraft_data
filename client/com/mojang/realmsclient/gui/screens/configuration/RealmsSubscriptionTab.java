...
class RealmsSubscriptionTab extends GridLayoutTab implements RealmsConfigurationTab {
   ...
   private static final Component TITLE = Component.translatable("mco.configure.world.subscription.tab");
   ...
   RealmsSubscriptionTab(RealmsConfigureWorldScreen var1, Minecraft var2, RealmsServer var3) {
      ...
      var4.addChild((new StringWidget(200, 9, SUBSCRIPTION_START_LABEL, var5)).alignLeft());
      Objects.requireNonNull(var5);
      this.startDateWidget = (StringWidget)var4.addChild((new StringWidget(200, 9, this.startDate, var5)).alignLeft());
      var4.addChild(SpacerElement.height(2));
      Objects.requireNonNull(var5);
      this.daysLeftLabelWidget = (StringWidget)var4.addChild((new StringWidget(200, 9, TIME_LEFT_LABEL, var5)).alignLeft());
      Objects.requireNonNull(var5);
      this.daysLeftWidget = (StringWidget)var4.addChild((new StringWidget(200, 9, this.daysLeft, var5)).alignLeft());
      var4.addChild(SpacerElement.height(2));
