...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   private void loadLevelList() throws Exception {
      this.levelList = (List)this.minecraft.getLevelSource().getLevelList().stream().filter((var0) -> {
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsSelectFileToUploadScreen.Entry> {
      ...
      public Entry(LevelSummary var2) {
         ...
         this.field_50 = var10001 + " (" + RealmsSelectFileToUploadScreen.formatLastPlayed(var2) + ")";
         Object var3;
         if (var2.isHardcore()) {
      ...
      protected void renderItem(PoseStack var1, int var2, int var3, int var4) {
         ...
         RealmsSelectFileToUploadScreen.this.font.draw(var1, this.field_50, (float)(var3 + 2), (float)(var4 + 12), 8421504);
