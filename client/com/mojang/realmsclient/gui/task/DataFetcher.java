...
public class DataFetcher {
   ...
   private class SubscribedTask<T> {
      ...
      SubscribedTask(Task<T> var2, Consumer<T> var3) {
         super();
         this.task = var2;
         this.output = var3;
      }
   ...
   private static record SuccessfulComputationResult<T>(T a, long b) {
      final T value;
      final long time;
   ...
   private static record ComputationResult<T>(Either<T, Exception> a, long b) {
