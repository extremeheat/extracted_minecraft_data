...
public class RealmsClient {
   ...
   // $FF: renamed from: op (long, java.lang.String) com.mojang.realmsclient.dto.Ops
   public Ops method_51(long var1, String var3) throws RealmsServiceException {
      ...
      try {
         ...
         if (var2 != 503 && var2 != 277) {
            ...
            if (var2 >= 200 && var2 < 300) {
               ...
               if (var4 != null) {
                  LOGGER.error("Realms http code: {} -  error code: {} -  message: {} - raw body: {}", var2, var4.getErrorCode(), var4.getErrorMessage(), var7);
