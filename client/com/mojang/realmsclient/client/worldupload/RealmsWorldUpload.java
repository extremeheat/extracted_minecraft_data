   ...
   public CompletableFuture<?> packAndUpload() {
      return CompletableFuture.runAsync(() -> {
         ...
         try {
            ...
            FileUpload var3 = new FileUpload(var1, this.realmId, this.slotId, var2, this.user, SharedConstants.getCurrentVersion().name(), this.worldOptions.version, this.statusCallback.getUploadStatus());
