...
public class FileDownload {
   ...
   void untarGzipArchive(String var1, @Nullable File var2, LevelStorageSource var3) throws IOException {
      ...
      try {
         Iterator var47 = var3.findLevelCandidates().iterator();

         while(var47.hasNext()) {
            LevelStorageSource.LevelDirectory var49 = (LevelStorageSource.LevelDirectory)var47.next();
            String var52 = var49.directoryName();
            if (var52.toLowerCase(Locale.ROOT).startsWith(var1.toLowerCase(Locale.ROOT))) {
               Matcher var54 = var4.matcher(var52);
               if (var54.matches()) {
                  int var11 = Integer.parseInt(var54.group(1));
                  if (var11 > var6) {
                     var6 = var11;
                  }
               } else {
         ...
         try {
            ...
            for(TarArchiveEntry var53 = var50.getNextTarEntry(); var53 != null; var53 = var50.getNextTarEntry()) {
               ...
               if (var53.isDirectory()) {
                  ...
                  var55.createNewFile();
                  FileOutputStream var58 = new FileOutputStream(var55);

                  try {
                     IOUtils.copy(var50, var58);
