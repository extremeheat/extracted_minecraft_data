...
public class RealmsServer extends ValueObject {
   ...
   public static RealmsServer parse(JsonObject var0) {
      ...
      try {
         var1.field_121 = JsonUtils.getLongOr("id", var0, -1L);
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field_121, this.name, this.motd, this.state, this.owner, this.expired});
   }
   ...
   public boolean equals(Object var1) {
      if (var1 == null) {
         ...
         return (new EqualsBuilder()).append(this.field_121, var2.field_121).append(this.name, var2.name).append(this.motd, var2.motd).append(this.state, var2.state).append(this.owner, var2.owner).append(this.expired, var2.expired).append(this.worldType, this.worldType).isEquals();
      }
   }

   public RealmsServer clone() {
      RealmsServer var1 = new RealmsServer();
      var1.field_121 = this.field_121;
   ...
   public static enum WorldType {
      ...
      private static RealmsServer.WorldType[] $values() {
         return new RealmsServer.WorldType[]{NORMAL, MINIGAME, ADVENTUREMAP, EXPERIENCE, INSPIRATION};
      }
   }
