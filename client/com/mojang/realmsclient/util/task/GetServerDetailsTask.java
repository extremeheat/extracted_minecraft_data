...
public class GetServerDetailsTask extends LongRunningTask {
      ...
      try {
         ...
         switch (var5.realmsErrorCodeOrDefault(-1)) {
            ...
            case 6006:
               ...
               setScreen((Screen)(var3 ? new RealmsBrokenWorldScreen(this.lastScreen, this.mainScreen, this.server.id, this.server.worldType == RealmsServer.WorldType.MINIGAME) : new RealmsGenericErrorScreen(Component.translatable("mco.brokenworld.nonowner.title"), Component.translatable("mco.brokenworld.nonowner.error"), this.lastScreen)));
               return;
            default:
   ...
   private RealmsLongConfirmationScreen resourcePackDownloadConfirmationScreen(RealmsServerAddress var1, Function<RealmsServerAddress, Screen> var2) {
      ...
      return new RealmsLongConfirmationScreen(var3, RealmsLongConfirmationScreen.Type.Info, Component.translatable("mco.configure.world.resourcepack.question.line1"), Component.translatable("mco.configure.world.resourcepack.question.line2"), true);
   }

   private CompletableFuture<?> scheduleResourcePackDownload(RealmsServerAddress var1) {
      try {
         return Minecraft.getInstance().getClientPackSource().downloadAndSelectResourcePack(new URL(var1.resourcePackUrl), var1.resourcePackHash, false);
