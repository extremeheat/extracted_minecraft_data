...
public class GetServerDetailsTask extends LongRunningTask {
   ...
   public void run() {
      ...
      try {
         ...
         case 6006:
            ...
            setScreen((Screen)(var3 ? new RealmsBrokenWorldScreen(this.lastScreen, this.mainScreen, this.server.field_121, this.server.worldType == RealmsServer.WorldType.MINIGAME) : new RealmsGenericErrorScreen(new TranslatableComponent("mco.brokenworld.nonowner.title"), new TranslatableComponent("mco.brokenworld.nonowner.error"), this.lastScreen)));
            return;
         default:
   ...
   private RealmsServerAddress fetchServerAddress() throws RealmsServiceException, TimeoutException, CancellationException {
      ...
      while(var2 < 40) {
         ...
         try {
            return var1.join(this.server.field_121);
