...
public class RealmsTextureManager {
   ...
   private static int getTextureId(String var0, String var1) {
      ...
      if (var2 != null && var2.image.equals(var1)) {
         ...
         RealmsTextureManager.TextureData var4 = RealmsTextureManager.TextureData.load(var1);
   ...
   static class TextureData {
      ...
      public static RealmsTextureManager.TextureData load(String var0) {
         try {
            ...
            if (var2 != null) {
               ...
               var6.put(var5);
               var6.flip();
               return new RealmsTextureManager.TextureData(var3, var4, var6);
            }
