...
public final class Matrix3f {
   ...
   private static final float field_300 = 3.0F + 2.0F * (float)Math.sqrt(2.0D);
   // $FF: renamed from: CS float
   private static final float field_301 = (float)Math.cos(0.39269908169872414D);
   // $FF: renamed from: SS float
   private static final float field_302 = (float)Math.sin(0.39269908169872414D);
   ...
   public Matrix3f(Quaternion var1) {
      super();
      float var2 = var1.method_129();
      float var3 = var1.method_130();
      float var4 = var1.method_131();
      float var5 = var1.method_132();
