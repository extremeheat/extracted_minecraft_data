...
public final class Matrix4f {
   ...
   public boolean isInteger() {
      ...
      var2.multiply(var1);
      return isInteger(var2.m00 / var2.m03)
         && isInteger(var2.m10 / var2.m13)
         && isInteger(var2.m20 / var2.m23)
         && isInteger(var2.m01 / var2.m03)
         && isInteger(var2.m11 / var2.m13)
         && isInteger(var2.m21 / var2.m23)
         && isInteger(var2.m02 / var2.m03)
         && isInteger(var2.m12 / var2.m13)
         && isInteger(var2.m22 / var2.m23);
   }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         return Float.compare(var2.m00, this.m00) == 0
            && Float.compare(var2.m01, this.m01) == 0
            && Float.compare(var2.m02, this.m02) == 0
            && Float.compare(var2.m03, this.m03) == 0
            && Float.compare(var2.m10, this.m10) == 0
            && Float.compare(var2.m11, this.m11) == 0
            && Float.compare(var2.m12, this.m12) == 0
            && Float.compare(var2.m13, this.m13) == 0
            && Float.compare(var2.m20, this.m20) == 0
            && Float.compare(var2.m21, this.m21) == 0
            && Float.compare(var2.m22, this.m22) == 0
            && Float.compare(var2.m23, this.m23) == 0
            && Float.compare(var2.m30, this.m30) == 0
            && Float.compare(var2.m31, this.m31) == 0
            && Float.compare(var2.m32, this.m32) == 0
            && Float.compare(var2.m33, this.m33) == 0;
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      ...
      return 31 * var1 + (this.m33 != 0.0F ? Float.floatToIntBits(this.m33) : 0);
   }
