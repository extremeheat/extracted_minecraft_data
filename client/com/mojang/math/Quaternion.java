...
public final class Quaternion {
   ...
   public Vector3f toXYZ() {
      ...
      return Math.abs(var6) > 0.999F * var5
         ? new Vector3f(2.0F * (float)Math.atan2((double)this.i(), (double)this.r()), var7, 0.0F)
         : new Vector3f(
            (float)Math.atan2((double)(2.0F * this.j() * this.k() + 2.0F * this.i() * this.r()), (double)(var1 - var2 - var3 + var4)),
            var7,
            (float)Math.atan2((double)(2.0F * this.i() * this.j() + 2.0F * this.r() * this.k()), (double)(var1 + var2 - var3 - var4))
         );
   }
   ...
   public Vector3f toYXZ() {
      ...
      float var7 = (float)Math.asin((double)(var6 / var5));
      return Math.abs(var6) > 0.999F * var5
         ? new Vector3f(var7, 2.0F * (float)Math.atan2((double)this.j(), (double)this.r()), 0.0F)
         : new Vector3f(
            var7,
            (float)Math.atan2((double)(2.0F * this.i() * this.k() + 2.0F * this.j() * this.r()), (double)(var1 - var2 - var3 + var4)),
            (float)Math.atan2((double)(2.0F * this.i() * this.j() + 2.0F * this.r() * this.k()), (double)(var1 - var2 + var3 - var4))
         );
   }
   ...
   public int hashCode() {
      ...
      return 31 * var1 + Float.floatToIntBits(this.r);
   }
