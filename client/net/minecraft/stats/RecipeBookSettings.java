...
public final class RecipeBookSettings {
   ...
   public RecipeBookSettings() {
      this((Map)Util.make(Maps.newEnumMap(RecipeBookType.class), (var0) -> {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            ...
            var0.put(var4, new TypeSettings(false, false));
         }
   ...
   public boolean isOpen(RecipeBookType var1) {
      return ((TypeSettings)this.states.get(var1)).open;
   }

   public void setOpen(RecipeBookType var1, boolean var2) {
      ((TypeSettings)this.states.get(var1)).open = var2;
   }

   public boolean isFiltering(RecipeBookType var1) {
      return ((TypeSettings)this.states.get(var1)).filtering;
   }

   public void setFiltering(RecipeBookType var1, boolean var2) {
      ((TypeSettings)this.states.get(var1)).filtering = var2;
   }
   ...
   public void write(FriendlyByteBuf var1) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         RecipeBookType var5 = var2[var4];
         TypeSettings var6 = (TypeSettings)this.states.get(var5);
         if (var6 == null) {
   ...
   public void write(CompoundTag var1) {
      TAG_FIELDS.forEach((var2, var3) -> {
         TypeSettings var4 = (TypeSettings)this.states.get(var2);
   ...
   public void replaceFrom(RecipeBookSettings var1) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         RecipeBookType var5 = var2[var4];
         TypeSettings var6 = (TypeSettings)var1.states.get(var5);
   ...
   static final class TypeSettings {
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            return true;
         } else if (!(var1 instanceof TypeSettings)) {
            return false;
         } else {
            TypeSettings var2 = (TypeSettings)var1;
