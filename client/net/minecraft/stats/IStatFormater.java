...
public interface IStatFormater {
   DecimalFormat DECIMAL_FORMAT = (DecimalFormat)Util.func_200696_a(new DecimalFormat("########0.00"), (var0) -> {
      var0.setDecimalFormatSymbols(DecimalFormatSymbols.getInstance(Locale.ROOT));
   });
   IStatFormater DEFAULT;
   IStatFormater DIVIDE_BY_TEN;
   IStatFormater DISTANCE;
   IStatFormater TIME;
