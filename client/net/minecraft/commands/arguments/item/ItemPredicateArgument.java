...
public class ItemPredicateArgument implements ArgumentType<Result> {
   ...
   static {
      PSEUDO_COMPONENTS = (Map)Stream.of(new ComponentWrapper(COUNT_ID, (var0) -> true, MinMaxBounds.Ints.CODEC.map((var0) -> (var1) -> var0.matches(var1.getCount())))).collect(Collectors.toUnmodifiableMap(ComponentWrapper::id, (var0) -> var0));
   ...
   static record ComponentWrapper(ResourceLocation id, Predicate<ItemStack> presenceChecker, Decoder<? extends Predicate<ItemStack>> valueChecker) {
      ...
      public static <T> ComponentWrapper create(ImmutableStringReader var0, ResourceLocation var1, DataComponentType<T> var2) throws CommandSyntaxException {
         ...
         if (var3 == null) {
            ...
            return new ComponentWrapper(var1, (var1x) -> var1x.has(var2), var3.map((var1x) -> (var2x) -> {
   ...
   static class Context implements ComponentPredicateParser.Context<Predicate<ItemStack>, ComponentWrapper, PredicateWrapper> {
      ...
      public ComponentWrapper lookupComponentType(ImmutableStringReader var1, ResourceLocation var2) throws CommandSyntaxException {
         ...
         if (var3 != null) {
            ...
            DataComponentType var4 = (DataComponentType)this.components.get(ResourceKey.create(Registries.DATA_COMPONENT_TYPE, var2)).map(Holder::value).orElseThrow(() -> ItemPredicateArgument.ERROR_UNKNOWN_COMPONENT.createWithContext(var1, var2));
