...
public class ItemParser {
   ...
   private static final DynamicCommandExceptionType ERROR_UNKNOWN_ITEM = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("argument.item.id.invalid", var0);
   });
   private static final DynamicCommandExceptionType ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("arguments.item.tag.unknown", var0);
   });
   ...
   public static ItemResult parseForItem(HolderLookup<Item> var0, StringReader var1) throws CommandSyntaxException {
      int var2 = var1.getCursor();

      try {
         ItemParser var3 = new ItemParser(var0, var1, false);
         var3.parse();
         Holder var4 = (Holder)var3.result.left().orElseThrow(() -> {
            return new IllegalStateException("Parser returned unexpected tag name");
         });
         return new ItemResult(var4, var3.nbt);
   ...
   public static Either<ItemResult, TagResult> parseForTesting(HolderLookup<Item> var0, StringReader var1) throws CommandSyntaxException {
      int var2 = var1.getCursor();

      try {
         ItemParser var3 = new ItemParser(var0, var1, true);
         var3.parse();
         return var3.result.mapBoth((var1x) -> {
            return new ItemResult(var1x, var3.nbt);
         }, (var1x) -> {
            return new TagResult(var1x, var3.nbt);
         });
   ...
   public static CompletableFuture<Suggestions> fillSuggestions(HolderLookup<Item> var0, SuggestionsBuilder var1, boolean var2) {
      ...
      return (CompletableFuture)var4.suggestions.apply(var1.createOffset(var3.getCursor()));
   }
