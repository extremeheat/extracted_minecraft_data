...
public class NbtPathArgument implements ArgumentType<NbtPath> {
   ...
   public static final DynamicCommandExceptionType ERROR_NOTHING_FOUND = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("arguments.nbtpath.nothing_found", var0);
   });
      ...
      switch (var0.peek()) {
         ...
         case '[':
            ...
            if (var4 == '{') {
               ...
               var0.expect(']');
               return new MatchElementNode(var6);
            } else {
               if (var4 == ']') {
                  var0.skip();
               ...
               var0.expect(']');
               return new IndexedElementNode(var3);
            }
         case '{':
            if (!var1) {
            ...
            return new MatchRootObjectNode(var2);
         default:
