...
public class MessageArgument implements SignedArgument<Message> {
   ...
   public static ChatMessage getChatMessage(CommandContext<CommandSourceStack> var0, String var1) throws CommandSyntaxException {
      ...
      if (var5 == null) {
         ...
         return new ChatMessage(PlayerChatMessage.system(var6));
      } else {
         return new ChatMessage(ChatDecorator.attachIfNotDecorated(var5, var3));
      }
   }
   ...
   public String getSignableText(Message var1) {
      return var1.getText();
   }
   ...
   public static record ChatMessage(PlayerChatMessage a) {
      ...
      public void resolve(CommandSourceStack var1, Consumer<PlayerChatMessage> var2) {
         ...
         var1.getChatMessageChainer().append(() -> {
            ...
            return CompletableFuture.allOf(var4, var5).thenAcceptAsync((var3x) -> {
      ...
      private CompletableFuture<FilteredText> filterPlainText(CommandSourceStack var1, String var2) {
         ...
         return var3 != null && this.signedArgument.hasSignatureFrom(var3.getUUID()) ? var3.getTextFilter().processStreamMessage(var2) : CompletableFuture.completedFuture(FilteredText.passThrough(var2));
      }
      ...
      public PlayerChatMessage signedArgument() {
