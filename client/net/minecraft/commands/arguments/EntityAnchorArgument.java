...
public class EntityAnchorArgument implements ArgumentType<EntityAnchorArgument.Anchor> {
   ...
   public static enum Anchor {
      ...
      EYES("eyes", (var0, var1) -> {
         return new Vec3(var0.field_414, var0.field_415 + (double)var1.getEyeHeight(), var0.field_416);
      });
      ...
      // $FF: synthetic method
      private static EntityAnchorArgument.Anchor[] $values() {
         return new EntityAnchorArgument.Anchor[]{FEET, EYES};
      }
   }
}
