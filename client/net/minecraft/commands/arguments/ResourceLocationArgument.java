...
public class ResourceLocationArgument implements ArgumentType<ResourceLocation> {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_ID = new DynamicCommandExceptionType((var0) -> {
      return new TranslatableComponent("argument.id.unknown", new Object[]{var0});
   });
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_ADVANCEMENT = new DynamicCommandExceptionType((var0) -> {
      return new TranslatableComponent("advancement.advancementNotFound", new Object[]{var0});
   });
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_RECIPE = new DynamicCommandExceptionType((var0) -> {
