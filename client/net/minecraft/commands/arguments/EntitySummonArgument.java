...
public class EntitySummonArgument implements ArgumentType<ResourceLocation> {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_ENTITY = new DynamicCommandExceptionType(
      var0 -> Component.translatable("entity.notFound", var0)
   );
   ...
   private static ResourceLocation verifyCanSummon(ResourceLocation var0) throws CommandSyntaxException {
      Registry.ENTITY_TYPE.getOptional(var0).filter(EntityType::canSummon).orElseThrow(() -> ERROR_UNKNOWN_ENTITY.create(var0));
      return var0;
   }
