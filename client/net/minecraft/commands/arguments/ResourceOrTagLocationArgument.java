...
public class ResourceOrTagLocationArgument<T> implements ArgumentType<Result<T>> {
   ...
   public static <T> Result<T> getRegistryType(CommandContext<CommandSourceStack> var0, String var1, ResourceKey<Registry<T>> var2, DynamicCommandExceptionType var3) throws CommandSyntaxException {
   ...
   static record TagResult<T>(TagKey<T> a) implements Result<T> {
   ...
   static record ResourceResult<T>(ResourceKey<T> a) implements Result<T> {
   ...
   public static class Info<T> implements ArgumentTypeInfo<ResourceOrTagLocationArgument<T>, Info<T>.Template> {
      ...
      public Info<T>.Template unpack(ResourceOrTagLocationArgument<T> var1) {
