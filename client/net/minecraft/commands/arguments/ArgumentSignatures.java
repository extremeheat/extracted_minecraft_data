...
public record ArgumentSignatures(long a, Map<String, byte[]> b) {
   ...
   public ArgumentSignatures(FriendlyByteBuf var1) {
      this(var1.readLong(), var1.readMap(FriendlyByteBuf.limitValue(HashMap::new, 8), var0 -> var0.readUtf(16), FriendlyByteBuf::readByteArray));
   }
   ...
   public void write(FriendlyByteBuf var1) {
      ...
      var1.writeMap(this.signatures, (var0, var1x) -> var0.writeUtf(var1x, 16), FriendlyByteBuf::writeByteArray);
   }
      ...
      for(ParsedCommandNode var4 : var1.getNodes()) {
         ...
         if (var7 instanceof ArgumentCommandNode var5) {
            ...
            if (var8 instanceof SignedArgument var6) {
               ...
               if (var9 != null) {
                  var2.put(var5.getName(), getPlainComponentUnchecked((SignedArgument)var6, var9));
               }
            }
         }
      }
