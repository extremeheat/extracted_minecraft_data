...
public class CommandFunction {
   ...
   public static CommandFunction fromLines(ResourceLocation var0, CommandDispatcher<CommandSourceStack> var1, CommandSourceStack var2, List<String> var3) {
      ...
      for(int var5 = 0; var5 < var3.size(); ++var5) {
         ...
         if (var8.canRead() && var8.peek() != '#') {
            if (var8.peek() == '/') {
               ...
               throw new IllegalArgumentException(
                  "Unknown or invalid command '" + var7 + "' on line " + var6 + " (did you mean '" + var11 + "'? Do not use a preceding forwards slash.)"
               );
            }
      ...
      return new CommandFunction(var0, var4.toArray(new CommandFunction.Entry[0]));
   }
