...
public class CommandFunction {
   ...
   final ResourceLocation field_525;
   ...
   public static class CacheableFunction {
      ...
      // $FF: renamed from: id net.minecraft.resources.ResourceLocation
      @Nullable
      private final ResourceLocation field_368;
      ...
      public Optional<CommandFunction> get(ServerFunctionManager var1) {
         if (!this.resolved) {
            if (this.field_368 != null) {
               this.function = var1.get(this.field_368);
            }
      ...
      public ResourceLocation getId() {
         return (ResourceLocation)this.function.map((var0) -> {
            return var0.field_525;
         }).orElse(this.field_368);
      }
   }
