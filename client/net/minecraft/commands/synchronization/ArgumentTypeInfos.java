...
public class ArgumentTypeInfos {
   ...
   public static ArgumentTypeInfo<?, ?> bootstrap(Registry<ArgumentTypeInfo<?, ?>> var0) {
      ...
      register(var0, "particle", ParticleArgument.class, SingletonArgumentInfo.contextFree(ParticleArgument::particle));
      ...
      register(var0, "mob_effect", MobEffectArgument.class, SingletonArgumentInfo.contextFree(MobEffectArgument::effect));
      ...
      register(var0, "item_enchantment", ItemEnchantmentArgument.class, SingletonArgumentInfo.contextFree(ItemEnchantmentArgument::enchantment));
      register(var0, "entity_summon", EntitySummonArgument.class, SingletonArgumentInfo.contextFree(EntitySummonArgument::id));
      ...
      register(var0, "resource_or_tag", fixClassType(ResourceOrTagLocationArgument.class), new ResourceOrTagLocationArgument.Info());
      register(var0, "resource", fixClassType(ResourceKeyArgument.class), new ResourceKeyArgument.Info());
   ...
   public static <A extends ArgumentType<?>> ArgumentTypeInfo<A, ?> byClass(A var0) {
      ...
      if (var1 == null) {
         throw new IllegalArgumentException("Unrecognized argument type %s (%s)".formatted(var0, var0.getClass()));
      } else {
         return var1;
      }
   }
