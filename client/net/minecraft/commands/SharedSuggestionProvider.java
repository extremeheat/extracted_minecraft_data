...
public interface SharedSuggestionProvider {
   ...
   static CompletableFuture<Suggestions> suggestCoordinates(String var0, Collection<SharedSuggestionProvider.TextCoordinates> var1, SuggestionsBuilder var2, Predicate<String> var3) {
      ...
      if (Strings.isNullOrEmpty(var0)) {
         ...
         while(var5.hasNext()) {
            ...
            String var7 = var6.field_192 + " " + var6.field_193 + " " + var6.field_194;
            if (var3.test(var7)) {
               var4.add(var6.field_192);
               var4.add(var6.field_192 + " " + var6.field_193);
               var4.add(var7);
            }
         }
      } else {
         ...
         if (var9.length == 1) {
            ...
            while(var10.hasNext()) {
               ...
               var8 = var9[0] + " " + var11.field_193 + " " + var11.field_194;
               if (var3.test(var8)) {
                  var4.add(var9[0] + " " + var11.field_193);
                  var4.add(var8);
               }
            }
            ...
            while(var10.hasNext()) {
               var11 = (SharedSuggestionProvider.TextCoordinates)var10.next();
               var8 = var9[0] + " " + var9[1] + " " + var11.field_194;
               if (var3.test(var8)) {
                  var4.add(var8);
               }
            }
   ...
   static CompletableFuture<Suggestions> suggest2DCoordinates(String var0, Collection<SharedSuggestionProvider.TextCoordinates> var1, SuggestionsBuilder var2, Predicate<String> var3) {
      ...
      if (Strings.isNullOrEmpty(var0)) {
         ...
         while(var5.hasNext()) {
            SharedSuggestionProvider.TextCoordinates var6 = (SharedSuggestionProvider.TextCoordinates)var5.next();
            String var7 = var6.field_192 + " " + var6.field_194;
            if (var3.test(var7)) {
               var4.add(var6.field_192);
               var4.add(var7);
            }
         ...
         if (var9.length == 1) {
            ...
            while(var10.hasNext()) {
               ...
               String var8 = var9[0] + " " + var11.field_194;
               if (var3.test(var8)) {
                  var4.add(var8);
               }
            }
   ...
   public static class TextCoordinates {
      ...
      public final String field_192;
      // $FF: renamed from: y java.lang.String
      public final String field_193;
      // $FF: renamed from: z java.lang.String
      public final String field_194;
