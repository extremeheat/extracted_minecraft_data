...
public class SharedConstants {
   ...
   /** @deprecated */
   @Deprecated
   public static final int WORLD_VERSION = 4886;
   /** @deprecated */
   @Deprecated
   ...
   /** @deprecated */
   @Deprecated
   public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 309;
   ...
   /** @deprecated */
   @Deprecated
   public static final int DATA_PACK_FORMAT_MAJOR = 102;
   /** @deprecated */
   @Deprecated
