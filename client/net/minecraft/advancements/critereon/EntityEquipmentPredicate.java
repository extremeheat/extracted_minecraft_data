...
public class EntityEquipmentPredicate {
   ...
   public static class Builder {
      ...
      public Builder head(ItemPredicate var1) {
         this.head = var1;
         return this;
      }

      public Builder chest(ItemPredicate var1) {
         this.chest = var1;
         return this;
      }

      public Builder legs(ItemPredicate var1) {
         this.legs = var1;
         return this;
      }

      public Builder feet(ItemPredicate var1) {
         this.feet = var1;
         return this;
      }

      public Builder mainhand(ItemPredicate var1) {
         this.mainhand = var1;
         return this;
      }

      public Builder offhand(ItemPredicate var1) {
         this.offhand = var1;
         return this;
      }
