...
public class UsingItemTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static TriggerInstance lookingAt(EntityPredicate.Builder var0, ItemPredicate.Builder var1) {
         return new TriggerInstance(EntityPredicate.Composite.wrap(var0.build()), var1.build());
      }
