...
public abstract class EntityTypePredicate {
   ...
   // $FF: renamed from: of (net.minecraft.world.entity.EntityType) net.minecraft.advancements.critereon.EntityTypePredicate
   public static EntityTypePredicate method_53(EntityType<?> var0) {
      return new EntityTypePredicate.TypePredicate(var0);
   }

   // $FF: renamed from: of (net.minecraft.tags.Tag) net.minecraft.advancements.critereon.EntityTypePredicate
   public static EntityTypePredicate method_54(Tag<EntityType<?>> var0) {
   ...
   private static class TagPredicate extends EntityTypePredicate {
      ...
      public boolean matches(EntityType<?> var1) {
         return var1.method_117(this.tag);
      }
