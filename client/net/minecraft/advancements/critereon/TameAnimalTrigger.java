...
public class TameAnimalTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static TriggerInstance tamedAnimal(EntityPredicate var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0));
      }
