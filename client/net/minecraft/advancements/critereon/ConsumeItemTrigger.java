...
public class ConsumeItemTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   ...
   public TriggerInstance createInstance(JsonObject var1, EntityPredicate.Composite var2, DeserializationContext var3) {
      return new TriggerInstance(var2, ItemPredicate.fromJson(var1.get("item")));
   }
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static TriggerInstance usedItem(ItemPredicate var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, var0);
      }

      public static TriggerInstance usedItem(ItemLike var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, new ItemPredicate((TagKey)null, ImmutableSet.of(var0.asItem()), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, EnchantmentPredicate.NONE, EnchantmentPredicate.NONE, (Potion)null, NbtPredicate.ANY));
      }
