...
public class ShotCrossbowTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static TriggerInstance shotCrossbow(ItemPredicate var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, var0);
      }

      public static TriggerInstance shotCrossbow(ItemLike var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, ItemPredicate.Builder.item().of(var0).build());
      }
