...
public class UsedExitEyeTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   public UsedExitEyeTrigger() {
      super();
   }

   public Codec<TriggerInstance> codec() {
      return UsedExitEyeTrigger.TriggerInstance.CODEC;
   }
