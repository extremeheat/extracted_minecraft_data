...
public abstract class MinMaxBounds<T extends Number> {
   ...
   protected static <T extends Number, R extends MinMaxBounds<T>> R fromJson(@Nullable JsonElement var0, R var1, BiFunction<JsonElement, String, T> var2, BoundsFactory<T, R> var3) {
   ...
   protected static <T extends Number, R extends MinMaxBounds<T>> R fromReader(StringReader var0, BoundsFromReaderFactory<T, R> var1, Function<String, T> var2, Supplier<DynamicCommandExceptionType> var3, Function<T, T> var4) throws CommandSyntaxException {
      if (!var0.canRead()) {
   ...
   public static class Doubles extends MinMaxBounds<Double> {
      ...
      private static Doubles create(StringReader var0, @Nullable Double var1, @Nullable Double var2) throws CommandSyntaxException {
      ...
      public static Doubles fromJson(@Nullable JsonElement var0) {
         return (Doubles)fromJson(var0, ANY, GsonHelper::convertToDouble, Doubles::new);
      }
      ...
      public static Doubles fromReader(StringReader var0, Function<Double, Double> var1) throws CommandSyntaxException {
         ...
         return (Doubles)fromReader(var0, var10001, var10002, var10003::readerInvalidDouble, var1);
      }
   }
   ...
   public static class Ints extends MinMaxBounds<Integer> {
      ...
      private static Ints create(StringReader var0, @Nullable Integer var1, @Nullable Integer var2) throws CommandSyntaxException {
         if (var1 != null && var2 != null && var1 > var2) {
            throw ERROR_SWAPPED.createWithContext(var0);
         } else {
      ...
      public static Ints exactly(int var0) {
         return new Ints(var0, var0);
      }

      public static Ints between(int var0, int var1) {
         return new Ints(var0, var1);
      }

      public static Ints atLeast(int var0) {
         return new Ints(var0, (Integer)null);
      }

      public static Ints atMost(int var0) {
         return new Ints((Integer)null, var0);
      }
      ...
      public static Ints fromJson(@Nullable JsonElement var0) {
         return (Ints)fromJson(var0, ANY, GsonHelper::convertToInt, Ints::new);
      }
      ...
      public static Ints fromReader(StringReader var0, Function<Integer, Integer> var1) throws CommandSyntaxException {
         ...
         BuiltInExceptionProvider var10003 = CommandSyntaxException.BUILT_IN_EXCEPTIONS;
         Objects.requireNonNull(var10003);
         return (Ints)fromReader(var0, var10001, var10002, var10003::readerInvalidInt, var1);
      }
   }
}
