...
public class LocationPredicate {
   ...
   public LocationPredicate(MinMaxBounds.Floats var1, MinMaxBounds.Floats var2, MinMaxBounds.Floats var3, @Nullable Biome var4, @Nullable StructureFeature<?> var5, @Nullable DimensionType var6) {
      super();
      this.x = var1;
      this.y = var2;
      this.z = var3;
   ...
   public static LocationPredicate inBiome(Biome var0) {
      return new LocationPredicate(MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, var0, (StructureFeature)null, (DimensionType)null);
   }

   public static LocationPredicate inDimension(DimensionType var0) {
      return new LocationPredicate(MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, (Biome)null, (StructureFeature)null, var0);
   }

   public static LocationPredicate inFeature(StructureFeature<?> var0) {
      return new LocationPredicate(MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, (Biome)null, var0, (DimensionType)null);
   }
   ...
   public boolean matches(ServerLevel var1, float var2, float var3, float var4) {
      if (!this.x.matches(var2)) {
         ...
         if (this.biome != null && this.biome != var1.getBiome(var5)) {
            return false;
         } else {
            return this.feature == null || this.feature.isInsideFeature(var1, var5);
         }
      }
   }
   ...
   static {
      ANY = new LocationPredicate(MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, MinMaxBounds.Floats.ANY, (Biome)null, (StructureFeature)null, (DimensionType)null);
   }
