...
public class LocationPredicate {
   ...
   public LocationPredicate(MinMaxBounds.Doubles var1, MinMaxBounds.Doubles var2, MinMaxBounds.Doubles var3, @Nullable ResourceKey<Biome> var4, @Nullable ResourceKey<Structure> var5, @Nullable ResourceKey<Level> var6, @Nullable Boolean var7, LightPredicate var8, BlockPredicate var9, FluidPredicate var10) {
      super();
      this.x = var1;
      this.y = var2;
      this.z = var3;
   ...
   public static LocationPredicate inBiome(ResourceKey<Biome> var0) {
      return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, var0, (ResourceKey)null, (ResourceKey)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }

   public static LocationPredicate inDimension(ResourceKey<Level> var0) {
      return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, (ResourceKey)null, (ResourceKey)null, var0, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }
   ...
   public static LocationPredicate atYLocation(MinMaxBounds.Doubles var0) {
      return new LocationPredicate(MinMaxBounds.Doubles.ANY, var0, MinMaxBounds.Doubles.ANY, (ResourceKey)null, (ResourceKey)null, (ResourceKey)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }
   ...
   public boolean matches(ServerLevel var1, double var2, double var4, double var6) {
      if (!this.x.matches(var2)) {
         ...
         if (this.biome != null && (!var9 || !var1.getBiome(var8).is(this.biome))) {
            return false;
         } else if (this.structure != null && (!var9 || !var1.structureManager().getStructureWithPieceAt(var8, this.structure).isValid())) {
            return false;
   ...
   public static LocationPredicate fromJson(@Nullable JsonElement var0) {
      if (var0 != null && !var0.isJsonNull()) {
         ...
         if (var1.has("dimension")) {
            var10000 = ResourceLocation.CODEC.parse(JsonOps.INSTANCE, var1.get("dimension"));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var14 = (ResourceKey)var10000.resultOrPartial(var10001::error).map((var0x) -> {
         ...
         ResourceKey var6 = var14;
         if (var1.has("structure")) {
            var10000 = ResourceLocation.CODEC.parse(JsonOps.INSTANCE, var1.get("structure"));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var14 = (ResourceKey)var10000.resultOrPartial(var10001::error).map((var0x) -> {
               return ResourceKey.create(Registry.STRUCTURE_REGISTRY, var0x);
            }).orElse((Object)null);
         } else {
            var14 = null;
         }

         ResourceKey var7 = var14;
   ...
   static {
      ANY = new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, (ResourceKey)null, (ResourceKey)null, (ResourceKey)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }
   ...
   public static class Builder {
      ...
      public Builder setBiome(@Nullable ResourceKey<Biome> var1) {
         this.biome = var1;
         return this;
      }

      public Builder setStructure(@Nullable ResourceKey<Structure> var1) {
         this.structure = var1;
         return this;
      }

      public Builder setDimension(@Nullable ResourceKey<Level> var1) {
         this.dimension = var1;
         return this;
      }

      public Builder setLight(LightPredicate var1) {
         this.light = var1;
         return this;
      }

      public Builder setBlock(BlockPredicate var1) {
         this.block = var1;
         return this;
      }

      public Builder setFluid(FluidPredicate var1) {
         this.fluid = var1;
         return this;
      }
