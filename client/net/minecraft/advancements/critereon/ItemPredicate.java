...
public class ItemPredicate {
   ...
   public ItemPredicate(@Nullable TagKey<Item> var1, @Nullable Set<Item> var2, MinMaxBounds.Ints var3, MinMaxBounds.Ints var4, EnchantmentPredicate[] var5, EnchantmentPredicate[] var6, @Nullable Potion var7, NbtPredicate var8) {
      super();
      this.tag = var1;
      this.items = var2;
      this.count = var3;
      ...
      if (var0 != null && !var0.isJsonNull()) {
         ...
         if (var1.has("data")) {
            ...
            if (var1.has("tag")) {
               ...
               var12 = TagKey.create(Registry.ITEM_REGISTRY, var13);
            }
   ...
   public static class Builder {
      ...
      public Builder hasDurability(MinMaxBounds.Ints var1) {
         this.durability = var1;
         return this;
      }

      public Builder isPotion(Potion var1) {
         this.potion = var1;
         return this;
      }
      ...
      public Builder hasEnchantment(EnchantmentPredicate var1) {
         this.enchantments.add(var1);
         return this;
      }

      public Builder hasStoredEnchantment(EnchantmentPredicate var1) {
