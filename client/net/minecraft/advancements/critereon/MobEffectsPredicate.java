...
public class MobEffectsPredicate {
   ...
   public MobEffectsPredicate(Map<MobEffect, MobEffectInstancePredicate> var1) {
      super();
      this.effects = var1;
   }
   ...
   public MobEffectsPredicate and(MobEffect var1) {
      this.effects.put(var1, new MobEffectInstancePredicate());
      return this;
   }

   public MobEffectsPredicate and(MobEffect var1, MobEffectInstancePredicate var2) {
   ...
   public static MobEffectsPredicate fromJson(@Nullable JsonElement var0) {
      if (var0 != null && !var0.isJsonNull()) {
         ...
         while(var3.hasNext()) {
            ...
            MobEffectInstancePredicate var7 = MobEffectsPredicate.MobEffectInstancePredicate.fromJson(GsonHelper.convertToJsonObject((JsonElement)var4.getValue(), (String)var4.getKey()));
            var2.put(var6, var7);
         }
   ...
   public JsonElement serializeToJson() {
      if (this == ANY) {
         ...
         while(var2.hasNext()) {
            ...
            var1.add(Registry.MOB_EFFECT.getKey((MobEffect)var3.getKey()).toString(), ((MobEffectInstancePredicate)var3.getValue()).serializeToJson());
         }
   ...
   public static class MobEffectInstancePredicate {
      ...
      public static MobEffectInstancePredicate fromJson(JsonObject var0) {
