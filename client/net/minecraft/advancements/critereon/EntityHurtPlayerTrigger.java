...
public class EntityHurtPlayerTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static TriggerInstance entityHurtPlayer(DamagePredicate var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, var0);
      }

      public static TriggerInstance entityHurtPlayer(DamagePredicate.Builder var0) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, var0.build());
      }
