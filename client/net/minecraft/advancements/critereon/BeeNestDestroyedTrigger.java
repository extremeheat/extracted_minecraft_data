...
public class BeeNestDestroyedTrigger extends SimpleCriterionTrigger<TriggerInstance> {
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static TriggerInstance destroyedBeeNest(Block var0, ItemPredicate.Builder var1, MinMaxBounds.Ints var2) {
         return new TriggerInstance(EntityPredicate.Composite.ANY, var0, var1.build(), var2);
      }
