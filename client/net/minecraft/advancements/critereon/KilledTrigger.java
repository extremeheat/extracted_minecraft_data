...
public class KilledTrigger extends SimpleCriterionTrigger<KilledTrigger.TriggerInstance> {
   ...
   final ResourceLocation field_78;
   ...
   public KilledTrigger.TriggerInstance createInstance(JsonObject var1, EntityPredicate.Composite var2, DeserializationContext var3) {
      return new KilledTrigger.TriggerInstance(this.field_78, var2, EntityPredicate.Composite.fromJson(var1, "entity", var3), DamageSourcePredicate.fromJson(var1.get("killing_blow")));
   }
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate var0) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0), DamageSourcePredicate.ANY);
      }

      public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate.Builder var0) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0.build()), DamageSourcePredicate.ANY);
      }

      public static KilledTrigger.TriggerInstance playerKilledEntity() {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.ANY, DamageSourcePredicate.ANY);
      }

      public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate var0, DamageSourcePredicate var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0), var1);
      }

      public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate.Builder var0, DamageSourcePredicate var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0.build()), var1);
      }

      public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate var0, DamageSourcePredicate.Builder var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0), var1.build());
      }
      ...
      public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate.Builder var0, DamageSourcePredicate.Builder var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0.build()), var1.build());
      }

      public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate var0) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0), DamageSourcePredicate.ANY);
      }

      public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate.Builder var0) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0.build()), DamageSourcePredicate.ANY);
      }

      public static KilledTrigger.TriggerInstance entityKilledPlayer() {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.ANY, DamageSourcePredicate.ANY);
      }

      public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate var0, DamageSourcePredicate var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0), var1);
      }

      public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate.Builder var0, DamageSourcePredicate var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0.build()), var1);
      }

      public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate var0, DamageSourcePredicate.Builder var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0), var1.build());
      }
      ...
      public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate.Builder var0, DamageSourcePredicate.Builder var1) {
         return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.field_78, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(var0.build()), var1.build());
      }
