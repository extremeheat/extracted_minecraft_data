...
public class UsedTotemTrigger extends SimpleCriterionTrigger<UsedTotemTrigger.TriggerInstance> {
   ...
   static final ResourceLocation field_93 = new ResourceLocation("used_totem");
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public TriggerInstance(EntityPredicate.Composite var1, ItemPredicate var2) {
         super(UsedTotemTrigger.field_93, var1);
         this.item = var2;
      }
      ...
      public static UsedTotemTrigger.TriggerInstance usedTotem(ItemLike var0) {
         return new UsedTotemTrigger.TriggerInstance(EntityPredicate.Composite.ANY, ItemPredicate.Builder.item().method_90(var0).build());
      }
