...
public enum AdvancementType implements StringRepresentable {
   ...
   private static final IntFunction<AdvancementType> BY_ID = ByIdMap.<AdvancementType>continuous((h) -> h.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
   ...
   private AdvancementType(final int id, final String name, final ChatFormatting chatColor) {
      this.id = id;
      this.name = name;
