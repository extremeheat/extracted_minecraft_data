...
public class Advancement {
   ...
   public static class Builder {
      ...
      public Builder parent(Advancement var1) {
         this.parent = var1;
         return this;
      }
      ...
      public Builder display(ItemStack var1, Component var2, Component var3, @Nullable ResourceLocation var4, FrameType var5, boolean var6, boolean var7, boolean var8) {
         return this.display(new DisplayInfo(var1, var2, var3, var4, var5, var6, var7, var8));
      }

      public Builder display(ItemLike var1, Component var2, Component var3, @Nullable ResourceLocation var4, FrameType var5, boolean var6, boolean var7, boolean var8) {
      ...
      public Builder addCriterion(String var1, CriterionTriggerInstance var2) {
      ...
      public Builder requirements(RequirementsStrategy var1) {
         this.requirementsStrategy = var1;
         return this;
      }

      public Builder requirements(String[][] var1) {
      ...
      public void serializeToNetwork(FriendlyByteBuf var1) {
         ...
         var1.writeNullable(this.display, (var0, var1x) -> {
      ...
      public static Builder fromJson(JsonObject var0, DeserializationContext var1) {
         ...
         if (var5.isEmpty()) {
            ...
            do {
               if (!var19.hasNext()) {
                  return new Builder(var2, var3, var4, var5, var7);
               }
      ...
      public static Builder fromNetwork(FriendlyByteBuf var0) {
         ResourceLocation var1 = (ResourceLocation)var0.readNullable(FriendlyByteBuf::readResourceLocation);
         DisplayInfo var2 = (DisplayInfo)var0.readNullable(DisplayInfo::fromNetwork);
         ...
         return new Builder(var1, var2, AdvancementRewards.EMPTY, var3, var4);
      }
