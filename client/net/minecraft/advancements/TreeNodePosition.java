...
public class TreeNodePosition {
   ...
   public TreeNodePosition(Advancement var1, @Nullable TreeNodePosition var2, @Nullable TreeNodePosition var3, int var4, int var5) {
      ...
      if (var1.getDisplay() == null) {
         ...
         Advancement var8;
         for(Iterator var7 = var1.getChildren().iterator(); var7.hasNext(); var6 = this.addChild(var8, var6)) {
   ...
   private TreeNodePosition addChild(Advancement var1, @Nullable TreeNodePosition var2) {
      Advancement var4;
      if (var1.getDisplay() != null) {
         var2 = new TreeNodePosition(var1, this, var2, this.children.size() + 1, this.field_134 + 1);
         this.children.add(var2);
      } else {
         for(Iterator var3 = var1.getChildren().iterator(); var3.hasNext(); var2 = this.addChild(var4, var2)) {
   ...
   private void firstWalk() {
      if (this.children.isEmpty()) {
         if (this.previousSibling != null) {
            this.field_135 = this.previousSibling.field_135 + 1.0F;
         } else {
            this.field_135 = 0.0F;
         }
         ...
         this.executeShifts();
         float var4 = (((TreeNodePosition)this.children.get(0)).field_135 + ((TreeNodePosition)this.children.get(this.children.size() - 1)).field_135) / 2.0F;
         if (this.previousSibling != null) {
            this.field_135 = this.previousSibling.field_135 + 1.0F;
            this.mod = this.field_135 - var4;
         } else {
            this.field_135 = var4;
         }
   ...
   private TreeNodePosition apportion(TreeNodePosition var1) {
      if (this.previousSibling == null) {
         ...
         for(var9 = var5.mod; var4.nextOrThread() != null && var2.previousOrThread() != null; var7 += var3.mod) {
            ...
            var3.ancestor = this;
            float var10 = var4.field_135 + var8 - (var2.field_135 + var6) + 1.0F;
            if (var10 > 0.0F) {
   ...
   private void finalizePosition() {
      if (this.advancement.getDisplay() != null) {
         this.advancement.getDisplay().setLocation((float)this.field_134, this.field_135);
      }
   ...
   public static void run(Advancement var0) {
      if (var0.getDisplay() == null) {
         ...
         var1.firstWalk();
         float var2 = var1.secondWalk(0.0F, 0, var1.field_135);
         if (var2 < 0.0F) {
            var1.thirdWalk(-var2);
         }
