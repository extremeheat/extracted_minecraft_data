...
public class DisplayInfo {
   ...
   private float field_184;
   // $FF: renamed from: y float
   private float field_185;
   ...
   public void serializeToNetwork(FriendlyByteBuf var1) {
      ...
      var1.writeFloat(this.field_184);
      var1.writeFloat(this.field_185);
   }
   ...
   public static DisplayInfo fromNetwork(FriendlyByteBuf var0) {
      ...
      FrameType var4 = (FrameType)var0.readEnum(FrameType.class);
