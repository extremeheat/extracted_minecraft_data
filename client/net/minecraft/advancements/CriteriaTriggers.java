...
public class CriteriaTriggers {
   ...
   public static final PlayerTrigger LOCATION = (PlayerTrigger)register(new PlayerTrigger(new ResourceLocation("location")));
   public static final PlayerTrigger SLEPT_IN_BED = (PlayerTrigger)register(new PlayerTrigger(new ResourceLocation("slept_in_bed")));
   ...
   public static final PlayerTrigger TICK = (PlayerTrigger)register(new PlayerTrigger(new ResourceLocation("tick")));
   ...
   public static final DistanceTrigger NETHER_TRAVEL = (DistanceTrigger)register(new DistanceTrigger(new ResourceLocation("nether_travel")));
   ...
   public static final PlayerTrigger RAID_WIN = (PlayerTrigger)register(new PlayerTrigger(new ResourceLocation("hero_of_the_village")));
   public static final PlayerTrigger BAD_OMEN = (PlayerTrigger)register(new PlayerTrigger(new ResourceLocation("voluntary_exile")));
   ...
   public static final ItemInteractWithBlockTrigger ITEM_USED_ON_BLOCK = (ItemInteractWithBlockTrigger)register(new ItemInteractWithBlockTrigger(new ResourceLocation("item_used_on_block")));
   public static final LootTableTrigger GENERATE_LOOT = (LootTableTrigger)register(new LootTableTrigger());
   public static final PickedUpItemTrigger THROWN_ITEM_PICKED_UP_BY_ENTITY = (PickedUpItemTrigger)register(new PickedUpItemTrigger(new ResourceLocation("thrown_item_picked_up_by_entity")));
   public static final PickedUpItemTrigger THROWN_ITEM_PICKED_UP_BY_PLAYER = (PickedUpItemTrigger)register(new PickedUpItemTrigger(new ResourceLocation("thrown_item_picked_up_by_player")));
   ...
   public static final DistanceTrigger FALL_FROM_HEIGHT = (DistanceTrigger)register(new DistanceTrigger(new ResourceLocation("fall_from_height")));
   public static final DistanceTrigger RIDE_ENTITY_IN_LAVA_TRIGGER = (DistanceTrigger)register(new DistanceTrigger(new ResourceLocation("ride_entity_in_lava")));
   public static final KilledTrigger KILL_MOB_NEAR_SCULK_CATALYST = (KilledTrigger)register(new KilledTrigger(new ResourceLocation("kill_mob_near_sculk_catalyst")));
   public static final ItemInteractWithBlockTrigger ALLAY_DROP_ITEM_ON_BLOCK = (ItemInteractWithBlockTrigger)register(new ItemInteractWithBlockTrigger(new ResourceLocation("allay_drop_item_on_block")));
   public static final PlayerTrigger AVOID_VIBRATION = (PlayerTrigger)register(new PlayerTrigger(new ResourceLocation("avoid_vibration")));
   ...
   @Nullable
   public static <T extends CriterionTriggerInstance> CriterionTrigger<T> getCriterion(ResourceLocation var0) {
