...
public class PathEntity {
   ...
   public Vec3 func_75881_a(Entity var1, int var2) {
      double var3 = (double)this.field_75884_a[var2].field_75839_a + (double)((int)(var1.field_70130_N + 1.0F)) * 0.5;
      double var5 = (double)this.field_75884_a[var2].field_75837_b;
      double var7 = (double)this.field_75884_a[var2].field_75838_c + (double)((int)(var1.field_70130_N + 1.0F)) * 0.5;
      return Vec3.func_72443_a(var3, var5, var7);
   }
   ...
   public boolean func_75876_a(PathEntity var1) {
      if (var1 == null) {
         ...
         for(int var2 = 0; var2 < this.field_75884_a.length; ++var2) {
            if (this.field_75884_a[var2].field_75839_a != var1.field_75884_a[var2].field_75839_a
               || this.field_75884_a[var2].field_75837_b != var1.field_75884_a[var2].field_75837_b
               || this.field_75884_a[var2].field_75838_c != var1.field_75884_a[var2].field_75838_c) {
               return false;
            }
         }
