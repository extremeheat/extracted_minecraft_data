...
public interface StructureTags {
   ...
   TagKey<Structure> ON_WOODLAND_MANSION_MAPS = create("on_woodland_mansion_maps");
   TagKey<Structure> ON_OCEAN_MONUMENT_MAPS = create("on_ocean_monument_maps");
   ...
   TagKey<Structure> ON_JUNGLE_PYRAMID_MAPS = create("on_jungle_pyramid_maps");
   TagKey<Structure> ON_SWAMP_HUT_MAPS = create("on_swamp_hut_maps");
   TagKey<Structure> ON_TREASURE_MAPS = create("on_treasure_maps");
   TagKey<Structure> ON_BURIED_TRIAL_CHAMBERS_MAPS = create("on_buried_trial_chambers_maps");
