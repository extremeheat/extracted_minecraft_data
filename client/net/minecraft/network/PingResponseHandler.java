...
public class PingResponseHandler extends ChannelInboundHandlerAdapter {
   ...
   public void channelRead(ChannelHandlerContext var1, Object var2) throws Exception {
      ...
      try {
         ...
         switch(var7) {
         case 0:
            field_151258_a.debug("Ping: (<1.3.x) from {}:{}", new Object[]{var5.getAddress(), var5.getPort()});
            var8 = String.format("%s\u00a7%d\u00a7%d", var6.func_71273_Y(), var6.func_71233_x(), var6.func_71275_y());
            this.func_151256_a(var1, this.func_151255_a(var8));
            break;
         case 1:
            ...
            field_151258_a.debug("Ping: (1.4-1.5.x) from {}:{}", new Object[]{var5.getAddress(), var5.getPort()});
            var8 = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, var6.func_71249_w(), var6.func_71273_Y(), var6.func_71233_x(), var6.func_71275_y());
            this.func_151256_a(var1, this.func_151255_a(var8));
            break;
         default:
            ...
            field_151258_a.debug("Ping: (1.6) from {}:{}", new Object[]{var5.getAddress(), var5.getPort()});
            String var10 = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, var6.func_71249_w(), var6.func_71273_Y(), var6.func_71233_x(), var6.func_71275_y());
            ByteBuf var11 = this.func_151255_a(var10);

            try {
               this.func_151256_a(var1, var11);
            } finally {
               var11.release();
            }
         }
