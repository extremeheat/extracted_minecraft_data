...
public class Style {
   ...
   public static final Codec<Style> FORMATTING_CODEC = RecordCodecBuilder.create((var0) -> {
   ...
   private static Style create(Optional<TextColor> var0, Optional<Boolean> var1, Optional<Boolean> var2, Optional<Boolean> var3, Optional<Boolean> var4, Optional<Boolean> var5, Optional<String> var6, Optional<ResourceLocation> var7) {
      return new Style((TextColor)var0.orElse((Object)null), (Boolean)var1.orElse((Object)null), (Boolean)var2.orElse((Object)null), (Boolean)var3.orElse((Object)null), (Boolean)var4.orElse((Object)null), (Boolean)var5.orElse((Object)null), (ClickEvent)null, (HoverEvent)null, (String)var6.orElse((Object)null), (ResourceLocation)var7.orElse((Object)null));
   }
