...
public record PlayerChatMessage(Component a, MessageSignature b, Optional<Component> c) {
   ...
   public static PlayerChatMessage signed(String var0, MessageSignature var1) {
      return signed(Component.literal(var0), var1);
   }
   ...
   public static FilteredText<PlayerChatMessage> filteredSigned(
      FilteredText<Component> var0, FilteredText<Component> var1, MessageSignature var2, boolean var3
   ) {
      Component var4 = (Component)var0.raw();
      Component var5 = (Component)var1.raw();
      PlayerChatMessage var6 = signed(var4, var5, var2, var3);
      if (var1.isFiltered()) {
         PlayerChatMessage var7 = Util.mapNullable((Component)var1.filtered(), PlayerChatMessage::unsigned);
   ...
   public static PlayerChatMessage unsigned(Component var0) {
      return new PlayerChatMessage((Component)var0, MessageSignature.unsigned(), Optional.empty());
   }
