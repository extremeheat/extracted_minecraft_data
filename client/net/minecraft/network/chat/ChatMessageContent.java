...
public record ChatMessageContent(String a, Component b) {
   ...
   public static ChatMessageContent read(FriendlyByteBuf var0) {
      ...
      Component var2 = (Component)var0.readNullable(FriendlyByteBuf::readComponent);
      return new ChatMessageContent(var1, (Component)Objects.requireNonNullElse(var2, Component.literal(var1)));
   }
