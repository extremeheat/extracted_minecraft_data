...
public class HoverEvent {
   ...
   public <T> T getValue(HoverEvent.Action<T> var1) {
      return (T)(this.action == var1 ? var1.cast(this.value) : null);
   }
   ...
   public static class Action<T> {
      ...
      public HoverEvent deserialize(JsonElement var1) {
         Object var2 = this.argDeserializer.apply((T)var1);
         return var2 == null ? null : new HoverEvent(this, (T)var2);
      }
   ...
   public static class EntityTooltipInfo {
      ...
      public static HoverEvent.EntityTooltipInfo create(JsonElement var0) {
         if (!var0.isJsonObject()) {
            ...
            EntityType var2 = BuiltInRegistries.ENTITY_TYPE.get(new ResourceLocation(GsonHelper.getAsString(var1, "type")));
      ...
      public JsonElement serialize() {
         JsonObject var1 = new JsonObject();
         var1.addProperty("type", BuiltInRegistries.ENTITY_TYPE.getKey(this.type).toString());
      ...
      public int hashCode() {
         ...
         return 31 * var1 + (this.name != null ? this.name.hashCode() : 0);
      }
   }
   ...
   public static class ItemStackInfo {
      ...
      public int hashCode() {
         ...
         return 31 * var1 + (this.tag != null ? this.tag.hashCode() : 0);
      }
      ...
      private static HoverEvent.ItemStackInfo create(JsonElement var0) {
         if (var0.isJsonPrimitive()) {
            return new HoverEvent.ItemStackInfo(BuiltInRegistries.ITEM.get(new ResourceLocation(var0.getAsString())), 1, null);
         } else {
            JsonObject var1 = GsonHelper.convertToJsonObject(var0, "item");
            Item var2 = BuiltInRegistries.ITEM.get(new ResourceLocation(GsonHelper.getAsString(var1, "id")));
            ...
            return new HoverEvent.ItemStackInfo(var2, var3, null);
         }
      }
      ...
      private static HoverEvent.ItemStackInfo create(Component var0) {
         try {
            CompoundTag var1 = TagParser.parseTag(var0.getString());
            return new HoverEvent.ItemStackInfo(ItemStack.of(var1));
      ...
      private JsonElement serialize() {
         JsonObject var1 = new JsonObject();
         var1.addProperty("id", BuiltInRegistries.ITEM.getKey(this.item).toString());
         if (this.count != 1) {
