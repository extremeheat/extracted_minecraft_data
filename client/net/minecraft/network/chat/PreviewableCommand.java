...
public record PreviewableCommand<S>(List<Argument<S>> a) {
   private final List<Argument<S>> arguments;

   public PreviewableCommand(List<Argument<S>> var1) {
      super();
      this.arguments = var1;
   }
   ...
   private static <S> List<Argument<S>> collectArguments(CommandContextBuilder<S> var0) {
      ...
      while(var2.hasNext()) {
         ...
         if (var6 instanceof ArgumentCommandNode var4) {
            ...
            if (var7 instanceof PreviewedArgument var5) {
               ...
               if (var8 != null) {
                  var1.add(new Argument(var4, var8, var5));
               }
            }
         }
      }
