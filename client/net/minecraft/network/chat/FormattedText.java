...
public interface FormattedText {
   ...
   // $FF: renamed from: of (java.lang.String) net.minecraft.network.chat.FormattedText
   static FormattedText method_10(final String var0) {
   ...
   // $FF: renamed from: of (java.lang.String, net.minecraft.network.chat.Style) net.minecraft.network.chat.FormattedText
   static FormattedText method_11(final String var0, final Style var1) {
      return new FormattedText() {
