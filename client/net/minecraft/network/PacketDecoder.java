         ...
         if (var7 == null) {
            ...
            if (var5.readableBytes() > 0) {
               throw new IOException(
                  "Packet "
                     + ((ConnectionProtocol)var1.channel().attr(Connection.ATTRIBUTE_PROTOCOL).get()).getId()
                     + "/"
                     + var6
                     + " ("
               ...
               if (LOGGER.isDebugEnabled()) {
                  LOGGER.debug(
                     ...
                     " IN: [{}:{}] {}",
                     new Object[]{var1.channel().attr(Connection.ATTRIBUTE_PROTOCOL).get(), var6, var7.getClass().getName()}
                  );
               }
            }
         }
