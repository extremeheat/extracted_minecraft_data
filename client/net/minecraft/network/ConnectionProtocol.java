...
public enum ConnectionProtocol {
   ...
   private ConnectionProtocol(int var3, ProtocolBuilder var4) {
      this.id = var3;
   ...
   public Integer getPacketId(PacketFlow var1, Packet<?> var2) {
      return ((PacketSet)this.flows.get(var1)).getId(var2.getClass());
   }
   ...
   public Int2ObjectMap<Class<? extends Packet<?>>> getPacketsByIds(PacketFlow var1) {
      ...
      PacketSet var3 = (PacketSet)this.flows.get(var1);
      if (var3 == null) {
   ...
   public Packet<?> createPacket(PacketFlow var1, int var2, FriendlyByteBuf var3) {
      return ((PacketSet)this.flows.get(var1)).createPacket(var2, var3);
   }
   ...
   static class ProtocolBuilder {
      ...
      public <T extends PacketListener> ProtocolBuilder addFlow(PacketFlow var1, PacketSet<T> var2) {
   ...
   private static class PacketSet<T extends PacketListener> {
      ...
      public <P extends Packet<T>> PacketSet<T> addPacket(Class<P> var1, Function<FriendlyByteBuf, P> var2) {
