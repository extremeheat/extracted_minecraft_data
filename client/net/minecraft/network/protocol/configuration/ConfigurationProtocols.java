...
public class ConfigurationProtocols {
   ...
   static {
      SERVERBOUND = ProtocolInfoBuilder.serverboundProtocol(ConnectionProtocol.CONFIGURATION, (var0) -> {
      ...
      CLIENTBOUND = ProtocolInfoBuilder.clientboundProtocol(ConnectionProtocol.CONFIGURATION, (var0) -> {
