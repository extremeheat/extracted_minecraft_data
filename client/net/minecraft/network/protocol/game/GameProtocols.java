...
public class GameProtocols {
   ...
   public static final ProtocolInfo.Unbound<ClientGamePacketListener, RegistryFriendlyByteBuf> CLIENTBOUND = ProtocolInfoBuilder.clientboundProtocolUnbound(
      ...
      var0 -> var0.withBundlePacket(GamePacketTypes.CLIENTBOUND_BUNDLE, ClientboundBundlePacket::new, new ClientboundBundleDelimiterPacket())
            ...
            .addPacket(GamePacketTypes.CLIENTBOUND_ADD_SUB_GRID, ClientboundAddSubGridPacket.STREAM_CODEC)
            ...
            .addPacket(GamePacketTypes.CLIENTBOUND_RECIPE, ClientboundRecipePacket.STREAM_CODEC)
            ...
            .addPacket(GamePacketTypes.CLIENTBOUND_SET_CARRIED_ITEM, ClientboundSetCarriedItemPacket.STREAM_CODEC)
            ...
            .addPacket(GamePacketTypes.CLIENTBOUND_SOUND_SEQUENCE, ClientboundSoundSequencePacket.STREAM_CODEC)
