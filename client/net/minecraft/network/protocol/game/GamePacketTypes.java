...
public class GamePacketTypes {
   ...
   public static final PacketType<ClientboundSetDefaultSpawnPositionPacket> CLIENTBOUND_SET_DEFAULT_SPAWN_POSITION = createClientbound("set_default_spawn_position");
   ...
   public static final PacketType<ClientboundSwingAnimationPacket> CLIENTBOUND_SWING_ANIMATION = createClientbound("swing_animation");
   ...
   public static final PacketType<ServerboundPunchPacket> SERVERBOUND_PUNCH = createServerbound("punch");
