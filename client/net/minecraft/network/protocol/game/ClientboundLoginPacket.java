...
public record ClientboundLoginPacket(int a, boolean b, GameType c, @Nullable GameType d, Set<ResourceKey<Level>> e, RegistryAccess.Frozen f, ResourceKey<DimensionType> g, ResourceKey<Level> h, long i, int j, int k, int l, boolean m, boolean n, boolean o, boolean p, Optional<GlobalPos> q) implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundLoginPacket(FriendlyByteBuf var1) {
      this(var1.readInt(), var1.readBoolean(), GameType.byId(var1.readByte()), GameType.byNullableId(var1.readByte()), (Set)var1.readCollection(Sets::newHashSetWithExpectedSize, (var0) -> {
         return var0.readResourceKey(Registry.DIMENSION_REGISTRY);
      }), ((RegistryAccess)var1.readWithCodec(RegistryAccess.NETWORK_CODEC)).freeze(), var1.readResourceKey(Registry.DIMENSION_TYPE_REGISTRY), var1.readResourceKey(Registry.DIMENSION_REGISTRY), var1.readLong(), var1.readVarInt(), var1.readVarInt(), var1.readVarInt(), var1.readBoolean(), var1.readBoolean(), var1.readBoolean(), var1.readBoolean(), var1.readOptional(FriendlyByteBuf::readGlobalPos));
   }

   public ClientboundLoginPacket(int var1, boolean var2, GameType var3, @Nullable GameType var4, Set<ResourceKey<Level>> var5, RegistryAccess.Frozen var6, ResourceKey<DimensionType> var7, ResourceKey<Level> var8, long var9, int var11, int var12, int var13, boolean var14, boolean var15, boolean var16, boolean var17, Optional<GlobalPos> var18) {
      super();
      this.playerId = var1;
      this.hardcore = var2;
      this.gameType = var3;
