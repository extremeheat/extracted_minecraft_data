...
public abstract class ServerboundMovePlayerPacket implements Packet<ServerGamePacketListener> {
   ...
   protected final double field_128;
   // $FF: renamed from: y double
   protected final double field_129;
   // $FF: renamed from: z double
   protected final double field_130;
   ...
   public double getX(double var1) {
      return this.hasPos ? this.field_128 : var1;
   }

   public double getY(double var1) {
      return this.hasPos ? this.field_129 : var1;
   }

   public double getZ(double var1) {
      return this.hasPos ? this.field_130 : var1;
   }
