...
public class ClientboundAddEntityPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundAddEntityPacket(LivingEntity var1) {
      this((LivingEntity)var1, 0);
   }

   public ClientboundAddEntityPacket(LivingEntity var1, int var2) {
      this(var1.getId(), var1.getUUID(), var1.getX(), var1.getY(), var1.getZ(), var1.getXRot(), var1.getYRot(), var1.getType(), var2, var1.getDeltaMovement(), (double)var1.yHeadRot);
   }
   ...
   public ClientboundAddEntityPacket(Entity var1, int var2) {
      this(var1.getId(), var1.getUUID(), var1.getX(), var1.getY(), var1.getZ(), var1.getXRot(), var1.getYRot(), var1.getType(), var2, var1.getDeltaMovement(), 0.0);
   }

   public ClientboundAddEntityPacket(Entity var1, int var2, BlockPos var3) {
      this(var1.getId(), var1.getUUID(), (double)var3.getX(), (double)var3.getY(), (double)var3.getZ(), var1.getXRot(), var1.getYRot(), var1.getType(), var2, var1.getDeltaMovement(), 0.0);
   }
   ...
   public ClientboundAddEntityPacket(FriendlyByteBuf var1) {
      ...
      this.type = (EntityType)var1.readById(Registry.ENTITY_TYPE);
