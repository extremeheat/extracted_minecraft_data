...
public class ClientboundUpdateTagsPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundUpdateTagsPacket(FriendlyByteBuf var1) {
      super();
      this.tags = var1.readMap(var0 -> ResourceKey.createRegistryKey(var0.readResourceLocation()), TagNetworkSerialization.NetworkPayload::read);
   }

   @Override
   public void write(FriendlyByteBuf var1) {
      var1.writeMap(this.tags, (var0, var1x) -> var0.writeResourceLocation(var1x.location()), (var0, var1x) -> var1x.write(var0));
   }
