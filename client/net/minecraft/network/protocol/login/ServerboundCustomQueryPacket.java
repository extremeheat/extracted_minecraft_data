...
public class ServerboundCustomQueryPacket implements Packet<ServerLoginPacketListener> {
   ...
   public ServerboundCustomQueryPacket(FriendlyByteBuf var1) {
      ...
      this.data = var1.readNullable(var0 -> {
         int var1x = var0.readableBytes();
         if (var1x >= 0 && var1x <= 1048576) {
            return new FriendlyByteBuf(var0.readBytes(var1x));
         } else {
   ...
   public void write(FriendlyByteBuf var1) {
      ...
      var1.writeNullable(this.data, (var0, var1x) -> var0.writeBytes(var1x.slice()));
   }
