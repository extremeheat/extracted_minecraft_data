...
public class SynchedEntityData {
   ...
   private <T> void createDataItem(EntityDataAccessor<T> var1, T var2) {
      DataItem var3 = new DataItem(var1, var2);
   ...
   private <T> DataItem<T> getItem(EntityDataAccessor<T> var1) {
      ...
      DataItem var2;
      try {
         var2 = (DataItem)this.itemsById.get(var1.getId());
   ...
   public <T> void set(EntityDataAccessor<T> var1, T var2) {
      DataItem var3 = this.getItem(var1);
   ...
   public static void pack(@Nullable List<DataItem<?>> var0, FriendlyByteBuf var1) {
      if (var0 != null) {
         Iterator var2 = var0.iterator();

         while(var2.hasNext()) {
            DataItem var3 = (DataItem)var2.next();
   ...
   private static <T> void writeDataItem(FriendlyByteBuf var0, DataItem<T> var1) {
   ...
   @Nullable
   public static List<DataItem<?>> unpack(FriendlyByteBuf var0) {
      ArrayList var1 = null;
   ...
   private static <T> DataItem<T> genericHelper(FriendlyByteBuf var0, int var1, EntityDataSerializer<T> var2) {
      return new DataItem(var2.createAccessor(var1), var2.read(var0));
   }

   public void assignValues(List<DataItem<?>> var1) {
      this.lock.writeLock().lock();
      ...
      try {
         ...
         while(var2.hasNext()) {
            DataItem var3 = (DataItem)var2.next();
            DataItem var4 = (DataItem)this.itemsById.get(var3.getAccessor().getId());
            if (var4 != null) {
   ...
   public void clearDirty() {
      ...
      while(var1.hasNext()) {
         DataItem var2 = (DataItem)var1.next();
         var2.setDirty(false);
      }
