...
public interface INetHandlerPlayServer extends INetHandler {
   ...
   void func_195518_a(CPacketTabComplete var1);

   void func_210153_a(CPacketUpdateCommandBlock var1);

   void func_210158_a(CPacketUpdateCommandMinecart var1);

   void func_210152_a(CPacketPickItem var1);

   void func_210155_a(CPacketRenameItem var1);

   void func_210154_a(CPacketUpdateBeacon var1);

   void func_210157_a(CPacketUpdateStructureBlock var1);

   void func_210159_a(CPacketSelectTrade var1);

   void func_210156_a(CPacketEditBook var1);

   void func_211526_a(CPacketNBTQueryEntity var1);

   void func_211525_a(CPacketNBTQueryTileEntity var1);
}
