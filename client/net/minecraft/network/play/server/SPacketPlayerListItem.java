...
public class SPacketPlayerListItem implements Packet<INetHandlerPlayClient> {
   ...
   public SPacketPlayerListItem(SPacketPlayerListItem.Action var1, EntityPlayerMP... var2) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         this.field_179769_b.add(new SPacketPlayerListItem.AddPlayerData(var6.func_146103_bH(), var6.field_71138_i, var6.field_71134_c.func_73081_b(), var6.func_175396_E()));
      }
   ...
   public SPacketPlayerListItem(SPacketPlayerListItem.Action var1, Iterable<EntityPlayerMP> var2) {
      ...
      while(var3.hasNext()) {
         ...
         this.field_179769_b.add(new SPacketPlayerListItem.AddPlayerData(var4.func_146103_bH(), var4.field_71138_i, var4.field_71134_c.func_73081_b(), var4.func_175396_E()));
      }

   }

   public void func_148837_a(PacketBuffer var1) throws IOException {
      this.field_179770_a = (SPacketPlayerListItem.Action)var1.func_179257_a(SPacketPlayerListItem.Action.class);
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         case ADD_PLAYER:
            ...
            var6 = GameType.func_77146_a(var1.func_150792_a());
         ...
         this.field_179769_b.add(new SPacketPlayerListItem.AddPlayerData(var4, var5, var6, var7));
      }
