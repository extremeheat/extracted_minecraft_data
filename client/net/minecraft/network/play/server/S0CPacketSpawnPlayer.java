...
public class S0CPacketSpawnPlayer extends Packet {
   ...
   public S0CPacketSpawnPlayer(EntityPlayer var1) {
      ...
      this.field_148955_b = var1.func_146103_bH();
      this.field_148956_c = MathHelper.func_76128_c(var1.field_70165_t * 32.0);
      this.field_148953_d = MathHelper.func_76128_c(var1.field_70163_u * 32.0);
      this.field_148954_e = MathHelper.func_76128_c(var1.field_70161_v * 32.0);
   ...
   public void func_148837_a(PacketBuffer var1) {
      ...
      UUID var2 = UUID.fromString(var1.func_150789_c(36));
      this.field_148955_b = new GameProfile(var2, var1.func_150789_c(16));
      int var3 = var1.func_150792_a();

      for(int var4 = 0; var4 < var3; ++var4) {
         String var5 = var1.func_150789_c(32767);
         String var6 = var1.func_150789_c(32767);
         String var7 = var1.func_150789_c(32767);
   ...
   public void func_148840_b(PacketBuffer var1) {
      ...
      var1.func_150785_a(this.field_148955_b.getName());
      var1.func_150787_b(this.field_148955_b.getProperties().size());

      for(Property var4 : this.field_148955_b.getProperties().values()) {
         var1.func_150785_a(var4.getName());
         var1.func_150785_a(var4.getValue());
         var1.func_150785_a(var4.getSignature());
      }
   ...
   public String func_148835_b() {
      return String.format(
         ...
         this.field_148957_a,
         this.field_148955_b,
         (float)this.field_148956_c / 32.0F,
         (float)this.field_148953_d / 32.0F,
         (float)this.field_148954_e / 32.0F,
         this.field_148959_h
      );
   }
