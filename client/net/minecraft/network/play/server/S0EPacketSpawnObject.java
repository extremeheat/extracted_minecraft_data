...
public class S0EPacketSpawnObject extends Packet {
   ...
   public S0EPacketSpawnObject(Entity var1, int var2, int var3) {
      ...
      this.field_149016_b = MathHelper.func_76128_c(var1.field_70165_t * 32.0);
      this.field_149017_c = MathHelper.func_76128_c(var1.field_70163_u * 32.0);
      this.field_149014_d = MathHelper.func_76128_c(var1.field_70161_v * 32.0);
      ...
      if (var3 > 0) {
         ...
         this.field_149012_f = (int)(var6 * 8000.0);
         this.field_149013_g = (int)(var8 * 8000.0);
      }
   }
   ...
   public String func_148835_b() {
      return String.format(
         ...
         this.field_149018_a,
         this.field_149019_j,
         (float)this.field_149016_b / 32.0F,
         (float)this.field_149017_c / 32.0F,
         (float)this.field_149014_d / 32.0F
      );
   }
