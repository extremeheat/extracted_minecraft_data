...
public class S12PacketEntityVelocity extends Packet {
   ...
   public S12PacketEntityVelocity(int var1, double var2, double var4, double var6) {
      ...
      this.field_149415_b = (int)(var2 * 8000.0);
      this.field_149416_c = (int)(var4 * 8000.0);
      this.field_149414_d = (int)(var6 * 8000.0);
   }
   ...
   public String func_148835_b() {
      return String.format(
         "id=%d, x=%.2f, y=%.2f, z=%.2f",
         this.field_149417_a,
         (float)this.field_149415_b / 8000.0F,
         (float)this.field_149416_c / 8000.0F,
         (float)this.field_149414_d / 8000.0F
      );
   }
