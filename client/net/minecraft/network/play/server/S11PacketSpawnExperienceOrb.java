...
public class S11PacketSpawnExperienceOrb extends Packet {
   ...
   public S11PacketSpawnExperienceOrb(EntityXPOrb var1) {
      ...
      this.field_148990_b = MathHelper.func_76128_c(var1.field_70165_t * 32.0);
      this.field_148991_c = MathHelper.func_76128_c(var1.field_70163_u * 32.0);
      this.field_148988_d = MathHelper.func_76128_c(var1.field_70161_v * 32.0);
   ...
   public String func_148835_b() {
      return String.format(
         ...
         this.field_148992_a,
         this.field_148989_e,
         (float)this.field_148990_b / 32.0F,
         (float)this.field_148991_c / 32.0F,
         (float)this.field_148988_d / 32.0F
      );
   }
