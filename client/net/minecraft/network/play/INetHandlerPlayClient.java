...
public interface INetHandlerPlayClient extends INetHandler {
   ...
   void func_199723_a(SPacketTagsList var1);
   ...
   void func_195511_a(SPacketCommandList var1);

   void func_195512_a(SPacketStopSound var1);

   void func_195510_a(SPacketTabComplete var1);

   void func_199525_a(SPacketUpdateRecipes var1);

   void func_200232_a(SPacketPlayerLook var1);

   void func_211522_a(SPacketNBTQueryResponse var1);
}
