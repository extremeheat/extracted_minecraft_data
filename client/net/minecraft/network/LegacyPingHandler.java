   ...
   public void channelRead(ChannelHandlerContext var1, Object var2) throws Exception {
      ...
      try {
         if (var3.readUnsignedByte() == 254) {
            ...
            switch(var7) {
            case 0:
               field_151258_a.debug("Ping: (<1.3.x) from {}:{}", var5.getAddress(), var5.getPort());
            ...
            case 1:
               ...
               field_151258_a.debug("Ping: (1.4-1.5.x) from {}:{}", var5.getAddress(), var5.getPort());
            ...
            default:
               ...
               field_151258_a.debug("Ping: (1.6) from {}:{}", var5.getAddress(), var5.getPort());
