...
public class ChunkLightRemoveFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkLightRemoveFix", var1, this.getOutputSchema().getType(References.CHUNK), (var1x) -> var1x.updateTyped(var3, (var0) -> var0.update(DSL.remainderFinder(), (var0x) -> var0x.remove("isLightOn"))));
   }
}
