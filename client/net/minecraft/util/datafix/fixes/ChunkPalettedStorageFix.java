...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   private static final class UpgradeChunk {
      ...
      private final int field_328;
      private final Int2ObjectMap<Dynamic<?>> blockEntities = new Int2ObjectLinkedOpenHashMap(16);

      public UpgradeChunk(Dynamic<?> var1) {
         super();
         this.level = var1;
         this.field_327 = var1.get("xPos").asInt(0) << 4;
         this.field_328 = var1.get("zPos").asInt(0) << 4;
         var1.get("TileEntities").asStreamOpt().result().ifPresent((var1x) -> {
            var1x.forEach((var1) -> {
               int var2 = var1.get("x").asInt(0) - this.field_327 & 15;
               int var3 = var1.get("y").asInt(0);
               int var4 = var1.get("z").asInt(0) - this.field_328 & 15;
               int var5 = var3 << 8 | var4 << 4 | var2;
               if (this.blockEntities.put(var5, var1) != null) {
                  ChunkPalettedStorageFix.LOGGER.warn("In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", this.field_327, this.field_328, var2, var3, var4);
               }
         ...
         var1.get("Sections").asStreamOpt().result().ifPresent((var1x) -> {
            var1x.forEach((var1) -> {
               ...
               this.sections[var2.field_104] = var2;
            });
         });
                     ...
                     case 2:
                        ...
                        while(true) {
                           do {
                              ...
                              var21 = ChunkPalettedStorageFix.getName(this.getBlock(relative(var11, ChunkPalettedStorageFix.Direction.field_484)));
                        ...
                        while(true) {
                           ...
                           if (ChunkPalettedStorageFix.getName(var12).endsWith("_door")) {
                              ...
                              if ("lower".equals(ChunkPalettedStorageFix.getProperty(var13, "half"))) {
                                 var14 = relative(var11, ChunkPalettedStorageFix.Direction.field_484);
      ...
      public Dynamic<?> write() {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (var7 != null) {
               var3.add(var7.write());
               var2 = var2.set(String.valueOf(var7.field_104), var2.createIntList(Arrays.stream(var7.update.toIntArray())));
            }
         }
   ...
   public static enum Direction {
      DOWN(ChunkPalettedStorageFix.Direction.AxisDirection.NEGATIVE, ChunkPalettedStorageFix.Direction.Axis.field_469),
      // $FF: renamed from: UP net.minecraft.util.datafix.fixes.ChunkPalettedStorageFix$Direction
      field_484(ChunkPalettedStorageFix.Direction.AxisDirection.POSITIVE, ChunkPalettedStorageFix.Direction.Axis.field_469),
      NORTH(ChunkPalettedStorageFix.Direction.AxisDirection.NEGATIVE, ChunkPalettedStorageFix.Direction.Axis.field_470),
      SOUTH(ChunkPalettedStorageFix.Direction.AxisDirection.POSITIVE, ChunkPalettedStorageFix.Direction.Axis.field_470),
      WEST(ChunkPalettedStorageFix.Direction.AxisDirection.NEGATIVE, ChunkPalettedStorageFix.Direction.Axis.field_468),
      EAST(ChunkPalettedStorageFix.Direction.AxisDirection.POSITIVE, ChunkPalettedStorageFix.Direction.Axis.field_468);
      ...
      // $FF: synthetic method
      private static ChunkPalettedStorageFix.Direction[] $values() {
         return new ChunkPalettedStorageFix.Direction[]{DOWN, field_484, NORTH, SOUTH, WEST, EAST};
      }

      public static enum Axis {
         // $FF: renamed from: X net.minecraft.util.datafix.fixes.ChunkPalettedStorageFix$Direction$Axis
         field_468,
         // $FF: renamed from: Y net.minecraft.util.datafix.fixes.ChunkPalettedStorageFix$Direction$Axis
         field_469,
         // $FF: renamed from: Z net.minecraft.util.datafix.fixes.ChunkPalettedStorageFix$Direction$Axis
         field_470;
         ...
         // $FF: synthetic method
         private static ChunkPalettedStorageFix.Direction.Axis[] $values() {
            return new ChunkPalettedStorageFix.Direction.Axis[]{field_468, field_469, field_470};
         }
      }
      ...
      public static enum AxisDirection {
         ...
         // $FF: synthetic method
         private static ChunkPalettedStorageFix.Direction.AxisDirection[] $values() {
            return new ChunkPalettedStorageFix.Direction.AxisDirection[]{POSITIVE, NEGATIVE};
         }
      }
   }
   ...
   static class Section {
      ...
      public Section(Dynamic<?> var1) {
         super();
         this.section = var1;
         this.field_104 = var1.get("Y").asInt(0);
