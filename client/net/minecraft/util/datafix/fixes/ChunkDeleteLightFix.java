...
public class ChunkDeleteLightFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkDeleteLightFix for " + this.getOutputSchema().getVersionKey(), var1, var1x -> {
         var1x = var1x.update(DSL.remainderFinder(), var0x -> var0x.remove("isLightOn"));
         return var1x.updateTyped(var2, var0x -> var0x.update(DSL.remainderFinder(), var0xx -> var0xx.remove("BlockLight").remove("SkyLight")));
      });
   }
}
