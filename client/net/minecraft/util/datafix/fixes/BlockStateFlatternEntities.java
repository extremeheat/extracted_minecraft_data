...
public class BlockStateFlatternEntities extends DataFix {
   private static final Map<String, Integer> field_199172_a = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   public BlockStateFlatternEntities(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public static int func_199171_a(String var0) {
      Integer var1 = (Integer)field_199172_a.get(var0);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function var3 = (var1x) -> {
         return this.func_211434_a(var1x, "DisplayTile", "DisplayData", "DisplayState");
      };
      Function var4 = (var1x) -> {
         return this.func_211434_a(var1x, "inTile", "inData", "inBlockState");
      };
      Type var5 = DSL.and(DSL.optional(DSL.field("inTile", DSL.named(TypeReferences.field_211300_p.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())))), DSL.remainderType());
      Function var6 = (var1x) -> {
         return var1x.update(var5.finder(), DSL.remainderType(), Pair::getSecond);
      };
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", var1.getType(TypeReferences.field_211299_o), var2.getType(TypeReferences.field_211299_o), (var4x) -> {
         var4x = this.func_211431_a(var4x, "minecraft:falling_block", this::func_211442_a);
         var4x = this.func_211431_a(var4x, "minecraft:enderman", (var1) -> {
            return this.func_211434_a(var1, "carried", "carriedData", "carriedBlockState");
         });
         var4x = this.func_211431_a(var4x, "minecraft:arrow", var4);
         var4x = this.func_211431_a(var4x, "minecraft:spectral_arrow", var4);
         var4x = this.func_211431_a(var4x, "minecraft:egg", var6);
         var4x = this.func_211431_a(var4x, "minecraft:ender_pearl", var6);
         var4x = this.func_211431_a(var4x, "minecraft:fireball", var6);
         var4x = this.func_211431_a(var4x, "minecraft:potion", var6);
         var4x = this.func_211431_a(var4x, "minecraft:small_fireball", var6);
         var4x = this.func_211431_a(var4x, "minecraft:snowball", var6);
         var4x = this.func_211431_a(var4x, "minecraft:wither_skull", var6);
         var4x = this.func_211431_a(var4x, "minecraft:xp_bottle", var6);
         var4x = this.func_211431_a(var4x, "minecraft:commandblock_minecart", var3);
         var4x = this.func_211431_a(var4x, "minecraft:minecart", var3);
         var4x = this.func_211431_a(var4x, "minecraft:chest_minecart", var3);
         var4x = this.func_211431_a(var4x, "minecraft:furnace_minecart", var3);
         var4x = this.func_211431_a(var4x, "minecraft:tnt_minecart", var3);
         var4x = this.func_211431_a(var4x, "minecraft:hopper_minecart", var3);
         var4x = this.func_211431_a(var4x, "minecraft:spawner_minecart", var3);
         return var4x;
      });
   }

   private Typed<?> func_211442_a(Typed<?> var1) {
      Type var2 = DSL.optional(DSL.field("Block", DSL.named(TypeReferences.field_211300_p.typeName(), DSL.or(DSL.intType(), DSL.namespacedString()))));
      Type var3 = DSL.optional(DSL.field("BlockState", DSL.named(TypeReferences.field_211296_l.typeName(), DSL.remainderType())));
      ...
      return var1.update(var2.finder(), var3, (var1x) -> {
         int var2 = (Integer)var1x.map((var0) -> {
            ...
            Optional var2 = var4.get("TileID").flatMap(Dynamic::getNumberValue);
            return (Integer)var2.map(Number::intValue).orElseGet(() -> {
               return var4.getByte("Tile") & 255;
            });
         });
         int var3 = var4.getInt("Data") & 15;
         return Either.left(Pair.of(TypeReferences.field_211296_l.typeName(), BlockStateFlatteningMap.func_210049_b(var2 << 4 | var3)));
      }).set(DSL.remainderFinder(), var4.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> func_211434_a(Typed<?> var1, String var2, String var3, String var4) {
      TagType var5 = DSL.field(var2, DSL.named(TypeReferences.field_211300_p.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())));
      TagType var6 = DSL.field(var4, DSL.named(TypeReferences.field_211296_l.typeName(), DSL.remainderType()));
      ...
      return var1.update(var5.finder(), var6, (var2x) -> {
         ...
         int var4 = var7.getInt(var3) & 15;
         return Pair.of(TypeReferences.field_211296_l.typeName(), BlockStateFlatteningMap.func_210049_b(var3x << 4 | var4));
      }).set(DSL.remainderFinder(), var7.remove(var3));
   }

   private Typed<?> func_211431_a(Typed<?> var1, String var2, Function<Typed<?>, Typed<?>> var3) {
      Type var4 = this.getInputSchema().getChoiceType(TypeReferences.field_211299_o, var2);
      Type var5 = this.getOutputSchema().getChoiceType(TypeReferences.field_211299_o, var2);
