...
public class LWJGL3KeyOptions extends DataFix {
   private static final Int2ObjectMap<String> field_199186_a = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (var0) -> {
   ...
   public LWJGL3KeyOptions(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(TypeReferences.field_211289_e), (var0) -> {
         return var0.update(DSL.remainderFinder(), (var0x) -> {
            return (Dynamic)var0x.getMapValues().map((var1) -> {
               return var0x.createMap((Map)var1.entrySet().stream().map((var0) -> {
                  if (((String)((Dynamic)var0.getKey()).getStringValue().orElse("")).startsWith("key_")) {
                     int var1 = Integer.parseInt((String)((Dynamic)var0.getValue()).getStringValue().orElse(""));
                     if (var1 < 0) {
                        int var4 = var1 + 100;
                        String var3;
                        if (var4 == 0) {
                        ...
                        String var2 = (String)field_199186_a.getOrDefault(var1, "key.unknown");
