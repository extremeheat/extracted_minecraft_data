...
public class ItemIntIDToString extends DataFix {
   private static final Int2ObjectMap<String> field_188221_a = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (var0) -> {
   ...
   public ItemIntIDToString(Schema var1, boolean var2) {
      super(var1, var2);
   }

   public static String func_199173_a(int var0) {
      return (String)field_188221_a.get(var0);
   }

   public TypeRewriteRule makeRule() {
      Type var1 = DSL.or(DSL.intType(), DSL.named(TypeReferences.field_211301_q.typeName(), DSL.namespacedString()));
      Type var2 = DSL.named(TypeReferences.field_211301_q.typeName(), DSL.namespacedString());
      OpticFinder var3 = DSL.fieldFinder("id", var1);
      return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(TypeReferences.field_211295_k), this.getOutputSchema().getType(TypeReferences.field_211295_k), (var2x) -> {
         return var2x.update(var3, var2, (var0) -> {
            return (Pair)var0.map((var0x) -> {
               return Pair.of(TypeReferences.field_211301_q.typeName(), func_199173_a(var0x));
            }, (var0x) -> {
               return var0x;
            });
         });
