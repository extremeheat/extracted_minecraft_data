...
public class AttributeModifierIdFix extends DataFix {
   ...
   private static Dynamic<?> fixItemStackComponents(Dynamic<?> var0) {
      return var0.update("attribute_modifiers", (var0x) -> {
