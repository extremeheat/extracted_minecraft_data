   ...
   public Dynamic<?> fixTag(Dynamic<Tag> var1) {
      ...
      if (var2.isEmpty()) {
         ...
         if (var3.isEmpty()) {
            ...
            ResourceLocation var4 = TrialSpawnerConfigInRegistryFix.VanillaTrialChambers.CONFIGS_TO_KEY.get(Pair.of((Dynamic)var2.get(), (Dynamic)var3.get()));
            return var4 == null
               ? var1
               : var1.set("normal_config", var1.createString(var4.withSuffix("/normal").toString()))
                  .set("ominous_config", var1.createString(var4.withSuffix("/ominous").toString()));
         }
      }
   }
   ...
   static final class VanillaTrialChambers {
      ...
      private static void register(ResourceLocation var0, String var1, String var2) {
         try {
            ...
            throw new IllegalStateException("Failed to parse NBT for " + var0, var8);
         }
      }
