...
public class VillagerTrades extends NamedEntityFix {
   public VillagerTrades(Schema var1, boolean var2) {
      super(var1, var2, "Villager trade fix", TypeReferences.field_211299_o, "minecraft:villager");
   }
   ...
   protected Typed<?> func_207419_a(Typed<?> var1) {
      ...
      if (!(var4 instanceof ListType)) {
         ...
         OpticFinder var11 = DSL.fieldFinder("id", DSL.named(TypeReferences.field_211301_q.typeName(), DSL.namespacedString()));
         Function var12 = (var2x) -> {
            return this.func_210482_a(var11, var2x);
         };
