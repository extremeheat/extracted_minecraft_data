...
public class RenamedRecipes extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals(var1, this.getInputSchema().getType(TypeReferences.field_211304_t))) {
         ...
         return this.fixTypeEverywhere("Recipes fix", var1, (var0) -> {
            return (var0x) -> {
               return var0x.mapSecond((var0) -> {
                  return (String)field_209673_a.getOrDefault(var0, var0);
               });
            };
         });
      }
