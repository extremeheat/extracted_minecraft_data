...
public class ItemLoreFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Item Lore componentize", var1, (var1x) -> var1x.updateTyped(var2, (var0) -> var0.update(DSL.remainderFinder(), (var0x) -> var0x.update("display", (var0) -> var0.update("Lore", (var0x) -> {
