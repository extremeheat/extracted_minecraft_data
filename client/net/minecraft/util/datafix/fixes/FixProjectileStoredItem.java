...
public class FixProjectileStoredItem extends DataFix {
   ...
   private static <T> Function<Typed<?>, Typed<?>> fixChoiceCap(String var0, FixProjectileStoredItem.SubFixer<?> var1, Type<?> var2, Type<T> var3) {
      OpticFinder var4 = DSL.namedChoice(var0, var2);
      return var3x -> var3x.updateTyped(var4, var3, var2xx -> var1.fix(var2xx, var3));
   }
