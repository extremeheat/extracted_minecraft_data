...
public class TeamDisplayName extends DataFix {
   public TeamDisplayName(Schema var1, boolean var2) {
      super(var1, var2);
   }

   protected TypeRewriteRule makeRule() {
      Type var1 = DSL.named(TypeReferences.field_211874_u.typeName(), DSL.remainderType());
      if (!Objects.equals(var1, this.getInputSchema().getType(TypeReferences.field_211874_u))) {
