...
public class ItemStackUUIDFix extends AbstractUUIDFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemStackUUIDFix", this.getInputSchema().getType(this.typeReference), (var2) -> {
         ...
         return var2.updateTyped(var3, (var3x) -> var3x.update(DSL.remainderFinder(), (var3) -> {
               var3 = this.updateAttributeModifiers(var3);
               if ((Boolean)var2.getOptional(var1).map((var0) -> "minecraft:player_head".equals(var0.getSecond())).orElse(false)) {
   ...
   private Dynamic<?> updateAttributeModifiers(Dynamic<?> var1) {
      return var1.update("AttributeModifiers", (var1x) -> var1.createList(var1x.asStream().map((var0) -> (Dynamic)replaceUUIDLeastMost(var0, "UUID", "UUID").orElse(var0))));
   }
