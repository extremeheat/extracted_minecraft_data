...
public class BiomeFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type var1 = DSL.named(References.BIOME.typeName(), DSL.namespacedString());
         ...
         return this.fixTypeEverywhere("Biomes fix", var1, (var0) -> {
            return (var0x) -> {
               return var0x.mapSecond((var0) -> {
                  return (String)BIOMES.getOrDefault(var0, var0);
               });
            };
         });
      }
