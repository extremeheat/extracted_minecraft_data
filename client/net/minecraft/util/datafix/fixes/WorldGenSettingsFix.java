...
public class WorldGenSettingsFix extends DataFix {
   ...
   private static <T> Dynamic<T> vanillaBiomeSource(Dynamic<T> var0, long var1, boolean var3, boolean var4) {
      Builder var5 = ImmutableMap.builder().put(var0.createString("type"), var0.createString("minecraft:vanilla_layered")).put(var0.createString("seed"), var0.createLong(var1)).put(var0.createString("large_biomes"), var0.createBoolean(var4));
      if (var3) {
   ...
   private static <T> Dynamic<T> fix(Dynamic<T> var0) {
      ...
      Builder var23 = ImmutableMap.builder();
