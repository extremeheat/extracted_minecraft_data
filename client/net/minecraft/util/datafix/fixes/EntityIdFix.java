...
public class EntityIdFix extends DataFix {
   private static final Map<String, String> ID_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (map) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", oldItemStackType, newItemStackType), this.fixTypeEverywhere("EntityIdFix", oldType, newType, (ops) -> (input) -> input.mapFirst((id) -> (String)ID_MAP.getOrDefault(id, id))));
   }
}
