...
public class ItemSpawnEggSplit extends DataFix {
   private static final Map<String, String> field_199421_a = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   public ItemSpawnEggSplit(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", var1, (var4x) -> {
         ...
         if (var5x.isPresent() && Objects.equals(((Pair)var5x.get()).getSecond(), "minecraft:spawn_egg")) {
            ...
            if (var8.isPresent()) {
               return var4x.set(var2, Pair.of(TypeReferences.field_211301_q.typeName(), field_199421_a.getOrDefault(var8.get(), "minecraft:pig_spawn_egg")));
            }
         }
