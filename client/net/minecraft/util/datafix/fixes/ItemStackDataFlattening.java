...
public class ItemStackDataFlattening extends DataFix {
   private static final Map<String, String> field_199176_a = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Set<String> field_199177_b;
   private static final Set<String> field_199178_c;

   public ItemStackDataFlattening(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", var1, (var2x) -> {
         ...
         if (!var3x.isPresent()) {
            ...
            int var6 = var5.getInt("Damage");
            String var7 = func_199175_a((String)((Pair)var3x.get()).getSecond(), var6);
            if (var7 != null) {
               var4 = var2x.set(var2, Pair.of(TypeReferences.field_211301_q.typeName(), var7));
            }

            if (field_199178_c.contains(((Pair)var3x.get()).getSecond())) {
            ...
            var4 = var4.set(DSL.remainderFinder(), var5.remove("Damage"));
            return var4;
         }
      });
   }
   ...
   @Nullable
   public static String func_199175_a(@Nullable String var0, int var1) {
      if (field_199177_b.contains(var0)) {
         String var2 = (String)field_199176_a.get(var0 + '.' + var1);
         return var2 == null ? (String)field_199176_a.get(var0 + ".0") : var2;
      } else {
         return null;
      }
   }
