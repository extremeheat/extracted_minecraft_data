...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (map) -> {
   ...
   public ItemIdFix(final Schema outputSchema, final boolean changesType) {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> oldItemType = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
      Type<Pair<String, String>> newItemType = DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
      OpticFinder<Either<Integer, Pair<String, String>>> id = DSL.fieldFinder("id", oldItemType);
      return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (itemStack) -> itemStack.update(id, newItemType, (oldId) -> (Pair)oldId.map((l) -> Pair.of(References.ITEM_NAME.typeName(), getItem(l)), (r) -> r)));
   }
}
