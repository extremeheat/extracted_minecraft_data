...
public class LegacyBlockPropertyRenameAndFix extends LegacyAbstractBlockPropertyFix {
   ...
   public LegacyBlockPropertyRenameAndFix(final Schema outputSchema, final String name, final String blockId, final String oldPropertyName, final String newPropertyName, final UnaryOperator<String> valueFixer) {
