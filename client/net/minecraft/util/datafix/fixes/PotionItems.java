...
public class PotionItems extends DataFix {
   private static final String[] field_188223_a = (String[])DataFixUtils.make(new String[128], (var0) -> {
   ...
   public PotionItems(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemPotionFix", var1, (var2x) -> {
         ...
         if (var3x.isPresent() && Objects.equals(((Pair)var3x.get()).getSecond(), "minecraft:potion")) {
            ...
            short var6 = ((Number)var4.get("Damage").flatMap(Dynamic::getNumberValue).orElse(0)).shortValue();
            if (var5.isPresent()) {
               Typed var7 = var2x;
               Dynamic var8 = (Dynamic)((Typed)var5.get()).get(DSL.remainderFinder());
               Optional var9 = var8.get("Potion").flatMap(Dynamic::getStringValue);
               if (!var9.isPresent()) {
                  String var10 = field_188223_a[var6 & 127];
                  ...
                  if ((var6 & 16384) == 16384) {
                     var7 = var7.set(var2, Pair.of(TypeReferences.field_211301_q.typeName(), "minecraft:splash_potion"));
                  }
               }
