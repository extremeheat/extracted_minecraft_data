...
public class EntityId extends DataFix {
   private static final Map<String, String> field_191276_a = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   public EntityId(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type var3 = this.getInputSchema().getType(TypeReferences.field_211295_k);
      Type var4 = this.getOutputSchema().getType(TypeReferences.field_211295_k);
      return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", var3, var4), this.fixTypeEverywhere("EntityIdFix", var1, var2, (var0) -> {
         return (var0x) -> {
            return var0x.mapFirst((var0) -> {
               return (String)field_191276_a.getOrDefault(var0, var0);
            });
         };
      }));
   }
