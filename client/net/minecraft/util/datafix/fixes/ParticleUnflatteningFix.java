...
public class ParticleUnflatteningFix extends DataFix {
   ...
   private <T> Dynamic<T> fix(Dynamic<T> var1) {
      ...
      if (var2.isEmpty()) {
         ...
         return switch (var5) {
            case "minecraft:item" -> var4.length > 1 ? this.updateItem(var6, var4[1]) : var6;
            case "minecraft:block", "minecraft:block_marker", "minecraft:falling_dust", "minecraft:dust_pillar" -> var4.length > 1
            ? this.updateBlock(var6, var4[1])
            : var6;
            case "minecraft:dust" -> var4.length > 1 ? this.updateDust(var6, var4[1]) : var6;
            case "minecraft:dust_color_transition" -> var4.length > 1 ? this.updateDustTransition(var6, var4[1]) : var6;
            case "minecraft:sculk_charge" -> var4.length > 1 ? this.updateSculkCharge(var6, var4[1]) : var6;
            case "minecraft:vibration" -> var4.length > 1 ? this.updateVibration(var6, var4[1]) : var6;
            case "minecraft:shriek" -> var4.length > 1 ? this.updateShriek(var6, var4[1]) : var6;
            default -> var6;
         };
      }
   }
   ...
   private static <T> Dynamic<T> readVector(Dynamic<T> var0, StringReader var1) throws CommandSyntaxException {
      ...
      return var0.createList(Stream.of(var2, var3, var4).map(var0::createFloat));
   }
   ...
   private <T> Dynamic<T> updateVibration(Dynamic<T> var1, String var2) {
      try {
         ...
         Dynamic var8 = var1.createIntList(IntStream.of(Mth.floor(var4), Mth.floor(var5), Mth.floor(var6)));
