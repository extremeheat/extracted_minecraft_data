...
public class MissingDimensionFix extends DataFix {
   ...
   protected static <A> Type<Pair<A, Dynamic<?>>> fields(String var0, Type<A> var1) {
      return DSL.and(DSL.field(var0, var1), DSL.remainderType());
   }

   protected static <A> Type<Pair<Either<A, Unit>, Dynamic<?>>> optionalFields(String var0, Type<A> var1) {
