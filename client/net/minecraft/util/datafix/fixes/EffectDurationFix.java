...
public class EffectDurationFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", var1.getType(References.ENTITY), var1x -> var1x.update(DSL.remainderFinder(), this::updateEntity)),
         new TypeRewriteRule[]{
   ...
   private Dynamic<?> updateEntity(Dynamic<?> var1) {
      ...
      return var1.update("CustomPotionEffects", this::fix);
   }
}
