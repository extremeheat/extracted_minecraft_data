...
public class SpawnEggNames extends DataFix {
   private static final String[] field_188226_a = (String[])DataFixUtils.make(new String[256], (var0) -> {
      var0[1] = "Item";
      var0[2] = "XPOrb";
      var0[7] = "ThrownEgg";
      var0[8] = "LeashKnot";
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type var2 = var1.getType(TypeReferences.field_211295_k);
      OpticFinder var3 = DSL.fieldFinder("id", DSL.named(TypeReferences.field_211301_q.typeName(), DSL.namespacedString()));
      ...
      OpticFinder var7 = DSL.typeFinder(var1.getTypeRaw(TypeReferences.field_211299_o));
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", var2, (var6x) -> {
         ...
         if (var7x.isPresent() && Objects.equals(((Pair)var7x.get()).getSecond(), "minecraft:spawn_egg")) {
            ...
            short var9 = var8.getShort("Damage");
            ...
            Typed var14 = var6x;
            String var15 = field_188226_a[var9 & 255];
            if (var15 != null && (!var13.isPresent() || !Objects.equals(var13.get(), var15))) {
               ...
               Typed var20 = (Typed)((Optional)this.getOutputSchema().getTypeRaw(TypeReferences.field_211299_o).readTyped(var19).getSecond()).orElseThrow(() -> {
