...
public class NamespacedTypeRenameFix extends DataFix {
   ...
   public NamespacedTypeRenameFix(Schema var1, String var2, TypeReference var3, UnaryOperator<String> var4) {
      super(var1, false);
      this.name = var2;
      this.type = var3;
      this.renamer = var4;
   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals(var1, this.getInputSchema().getType(this.type))) {
         ...
         return this.fixTypeEverywhere(this.name, var1, var1x -> var1xx -> var1xx.mapSecond(this.renamer));
      }
   }
}
