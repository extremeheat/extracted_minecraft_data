...
public abstract class ItemStackTagFix extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(this.name, var1, (var3x) -> {
         Optional var4 = var3x.getOptional(var2);
         return var4.isPresent() && this.idFilter.test((String)((Pair)var4.get()).getSecond()) ? var3x.updateTyped(var3, (var1) -> {
