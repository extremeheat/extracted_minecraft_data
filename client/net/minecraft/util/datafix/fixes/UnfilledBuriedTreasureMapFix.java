...
public class UnfilledBuriedTreasureMapFix extends DataFix {
   ...
   public UnfilledBuriedTreasureMapFix(final Schema outputSchema) {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("UnfilledBuriedTreasureMapFix", itemStackType, (itemStack) -> {
         ...
         return id.filter((itemId) -> itemId.equals("minecraft:map")).isPresent() ? itemStack.updateTyped(componentsFinder, UnfilledBuriedTreasureMapFix::fix) : itemStack;
      });
   }
