...
public class ItemStackCustomNameToOverrideComponentFix extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         var2x -> {
            ...
            Optional var4 = var3xx.map(Pair::getSecond);
            if (var4.filter(var0x -> var0x.equals("minecraft:white_banner")).isPresent()) {
               return var2x.updateTyped(var3, var0x -> var0x.update(DSL.remainderFinder(), ItemStackCustomNameToOverrideComponentFix::fixBanner));
            } else {
               return var4.filter(var0x -> var0x.equals("minecraft:filled_map")).isPresent()
                  ? var2x.updateTyped(var3, var0x -> var0x.update(DSL.remainderFinder(), ItemStackCustomNameToOverrideComponentFix::fixMap))
                  : var2x;
            }
         }
      );
   ...
   private static <T> Dynamic<T> fixMap(Dynamic<T> var0) {
      return fixCustomName(var0, MAP_NAMES::contains);
   }
