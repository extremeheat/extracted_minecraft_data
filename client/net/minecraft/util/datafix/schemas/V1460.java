...
public class V1460 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:arrow", var1x -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(var1)));
      ...
      var1.register(
         ...
         var1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), "Items", DSL.list(References.ITEM_STACK.in(var1)))
      );
      ...
      var1.register(
         var2,
         "minecraft:donkey",
         var1x -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(var1)), "SaddleItem", References.ITEM_STACK.in(var1), V100.equipment(var1))
      );
      ...
      var1.register(
         ...
         var1x -> DSL.optionalFields("BlockState", References.BLOCK_STATE.in(var1), "TileEntityData", References.BLOCK_ENTITY.in(var1))
      );
      ...
      var1.register(var2, "minecraft:furnace_minecart", var1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1)));
      ...
      var1.register(
         var2,
         "minecraft:horse",
         var1x -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(var1), "SaddleItem", References.ITEM_STACK.in(var1), V100.equipment(var1))
      );
      ...
      var1.register(
         ...
         var1x -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), References.UNTAGGED_SPAWNER.in(var1))
      );
      var1.register(var2, "minecraft:spectral_arrow", var1x -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(var1)));
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      ...
      var1.registerType(
         ...
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  ...
                  References.ENTITY_TREE.in(var1),
                  "recipeBook",
                  DSL.optionalFields("recipes", DSL.list(References.RECIPE.in(var1)), "toBeDisplayed", DSL.list(References.RECIPE.in(var1)))
               )
            )
      );
      var1.registerType(
         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  "Sections",
                  DSL.list(DSL.optionalFields("Palette", DSL.list(References.BLOCK_STATE.in(var1))))
               )
            )
      );
      ...
      var1.registerType(false, References.ITEM_NAME, () -> DSL.constType(namespacedString()));
      ...
      var1.registerType(
         ...
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  "Features",
                  DSL.compoundList(References.STRUCTURE_FEATURE.in(var1)),
                  "Objectives",
                  DSL.list(References.OBJECTIVE.in(var1)),
                  "Teams",
                  DSL.list(References.TEAM.in(var1))
               )
            )
      );
      ...
      var1.registerType(
         ...
         () -> DSL.hook(
               DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), var5)), V1451_6.UNPACK_OBJECTIVE_ID, V1451_6.REPACK_OBJECTIVE_ID
            )
      );
      ...
      var1.registerType(
         ...
         () -> DSL.optionalFields(
               "SpawnPotentials", DSL.list(DSL.fields("Entity", References.ENTITY_TREE.in(var1))), "SpawnData", References.ENTITY_TREE.in(var1)
            )
      );
      var1.registerType(
         false,
