...
public class V1460 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:falling_block", (var1x) -> DSL.optionalFields("BlockState", References.BLOCK_STATE.in(var1), "TileEntityData", References.BLOCK_ENTITY.in(var1)));
      ...
      var1.register(var2, "minecraft:spawner_minecart", (var1x) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), References.UNTAGGED_SPAWNER.in(var1)));
