         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "biomes",
                        DSL.optionalFields("palette", DSL.list(References.BIOME.in(var1))),
                        "block_states",
                        DSL.optionalFields("palette", DSL.list(References.BLOCK_STATE.in(var1)))
                     )
                  ),
                  "Structures",
                  DSL.optionalFields("Starts", DSL.compoundList(References.STRUCTURE_FEATURE.in(var1)))
               )
            )
      );
      var1.registerType(
                     ...
                     DSL.taggedChoiceLazy(
                        ...
                        ImmutableMap.of(
                           ...
                           (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                                 "settings",
                                 DSL.optionalFields(
                                    "biome", References.BIOME.in(var1), "layers", DSL.list(DSL.optionalFields("block", References.BLOCK_NAME.in(var1)))
                                 )
                              ),
                           "minecraft:noise",
                           (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                                 ...
                                 DSL.or(
                                    ...
                                    DSL.optionalFields("default_block", References.BLOCK_NAME.in(var1), "default_fluid", References.BLOCK_NAME.in(var1))
                                 )
                              )
                        )
                     )
