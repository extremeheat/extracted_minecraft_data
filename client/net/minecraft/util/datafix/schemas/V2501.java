...
public class V2501 extends NamespacedSchema {
   ...
   private static void registerFurnace(Schema var0, Map<String, Supplier<TypeTemplate>> var1, String var2) {
      var0.register(var1, var2, () -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(var0)), "RecipesUsed", DSL.compoundList(References.RECIPE.in(var0), DSL.constType(DSL.intType()))));
   }
