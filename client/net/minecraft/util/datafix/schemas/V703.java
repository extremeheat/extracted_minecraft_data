...
public class V703 extends Schema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(final Schema schema) {
      ...
      schema.register(map, "Donkey", () -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema)));
      schema.register(map, "Mule", () -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema)));
