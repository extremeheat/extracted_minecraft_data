...
public class V4059 extends NamespacedSchema {
   ...
   public static SequencedMap<String, Supplier<TypeTemplate>> components(Schema var0) {
      ...
      var1.put("minecraft:use_remainder", (Supplier<TypeTemplate>)() -> References.ITEM_STACK.in(var0));
      var1.put(
         "minecraft:equippable",
         (Supplier<TypeTemplate>)() -> DSL.optionalFields(
               "allowed_entities", DSL.or(References.ENTITY_NAME.in(var0), DSL.list(References.ENTITY_NAME.in(var0)))
            )
      );
      return var1;
   }
