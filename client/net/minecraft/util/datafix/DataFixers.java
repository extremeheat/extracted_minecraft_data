...
import net.minecraft.util.datafix.fixes.BlendingDataNoValueHeightFix;
...
import net.minecraft.util.datafix.fixes.BlockStateFieldNamesFix;
...
import net.minecraft.util.datafix.fixes.DebugProfileRenameEntryFix;
...
import net.minecraft.util.datafix.fixes.LegacyJigsawRotationFix;
...
import net.minecraft.util.datafix.fixes.SignsOpFlagFix;
...
import net.minecraft.util.datafix.fixes.SwingAnimationComponentSplitFix;
...
public class DataFixers {
   ...
   private static void addFixers(final DataFixerBuilder fixerUpper, final FileFixerUpper.Builder fileFixerUpper) {
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1474, "Colorless shulker block fixer", (block) -> Objects.equals(NamespacedSchema.ensureNamespaced(block), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : block));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1475, "Flowing fixer", createRenamer(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
      Schema v1480 = fixerUpper.addSchema(1480, SAME_NAMESPACED);
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1480, "Rename coral blocks", createRenamer(RenamedCoralFix.RENAMED_IDS)));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1484, "Rename seagrass blocks", createRenamer(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1487, "Rename prismarine_brick(s)_* items", createRenamer(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      Schema v1488 = fixerUpper.addSchema(1488, V1488::new);
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1488, "Rename kelp/kelptop", createRenamer(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1490, "Rename melon_block", createRenamer("minecraft:melon_block", "minecraft:melon")));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1510, "Block renamening fix", createRenamer(EntityTheRenameningFix.RENAMED_BLOCKS)));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1515, "Rename coral fan blocks", createRenamer(RenamedCoralFansFix.RENAMED_IDS)));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v1802, "Rename sign blocks & stone slabs", createRenamer(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2209, "Rename bee_hive block to beehive", beehiveRenamer));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2508, "Renamed fungi blocks to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      ...
      fixerUpper.addFixer(new LegacyJigsawRotationFix(v2518));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2528, "Rename soul fire torch and soul fire lantern", createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2680, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2690, "Renamed copper blocks to new oxidized terms", createRenamer(copperBlocksToRename)));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2691, "Rename copper blocks suffixes", createRenamer(waxedCopperRename)));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2696, "Renamed grimstone blocks to deepslate", createRenamer(grimstoneBlocksToRename)));
      Schema v2700 = fixerUpper.addSchema(2700, SAME_NAMESPACED);
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2700, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v2717, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v3692, "Rename grass block to short_grass", grassRenamer));
      ...
      fixerUpper.addFixer(new LegacyBlockPropertyRenameAndFix(v4294, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (value) -> value.equals("true") ? "awake" : "uprooted"));
      ...
      fixerUpper.addFixer(new LegacyBlockPropertyRenameAndFix(v4305, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (a) -> a));
      ...
      fixerUpper.addFixer(LegacyBlockRenameFix.create(v4541, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
      ...
      Schema v5001 = fixerUpper.addSchema(5001, SAME_NAMESPACED);
      fixerUpper.addFixer(new DebugProfileRenameEntryFix(v5001, "minecraft:post_effect", "minecraft:post_effects"));
      Schema v5002 = fixerUpper.addSchema(5002, SAME_NAMESPACED);
      fixerUpper.addFixer(new SignsOpFlagFix(v5002));
      Schema v5006 = fixerUpper.addSchema(5006, SAME_NAMESPACED);
      fixerUpper.addFixer(new BlockStateFieldNamesFix(v5006));
      Schema v5007 = fixerUpper.addSchema(5007, SAME_NAMESPACED);
      fixerUpper.addFixer(new SwingAnimationComponentSplitFix(v5007));
      Schema v5008 = fixerUpper.addSchema(5008, SAME_NAMESPACED);
      fixerUpper.addFixer(new ExplorerMapItemFix(v5008));
