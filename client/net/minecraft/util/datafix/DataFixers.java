...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(var189, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema var190 = var0.addSchema(3440, SAME_NAMESPACED);
      var0.addFixer(new NamespacedTypeRenameFix(var190, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
      var0.addFixer(new FeatureFlagRemoveFix(var190, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      ...
      var0.addFixer(new DropInvalidSignDataFix(var196, "minecraft:sign"));
      var0.addFixer(new DropInvalidSignDataFix(var196, "minecraft:hanging_sign"));
      ...
      Schema var217 = var0.addSchema(3813, V3813::new);
      ...
      Schema var252 = var0.addSchema(4290, V4290::new);
      var0.addFixer(new UnflattenTextComponentFix(var252));
      Schema var253 = var0.addSchema(4291, SAME_NAMESPACED);
      var0.addFixer(new LegacyHoverEventFix(var253));
      var0.addFixer(new TextComponentStringifiedFlagsFix(var253));
      Schema var254 = var0.addSchema(4292, V4292::new);
      var0.addFixer(new TextComponentHoverAndClickEventFix(var254));
      Schema var255 = var0.addSchema(4293, SAME_NAMESPACED);
      var0.addFixer(new DropChancesFormatFix(var255));
      Schema var256 = var0.addSchema(4294, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var256, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (var0x) -> var0x.equals("true") ? "awake" : "uprooted"));
      Schema var257 = var0.addSchema(4295, SAME_NAMESPACED);
      var0.addFixer(new BlendingDataFix(var257));
      Schema var258 = var0.addSchema(4296, SAME_NAMESPACED);
      var0.addFixer(new AreaEffectCloudDurationScaleFix(var258));
      Schema var259 = var0.addSchema(4297, SAME_NAMESPACED);
      var0.addFixer(new ForcedChunkToTicketFix(var259));
      Schema var260 = var0.addSchema(4299, SAME_NAMESPACED);
      var0.addFixer(new EntitySpawnerItemVariantComponentFix(var260));
      Schema var261 = var0.addSchema(4300, V4300::new);
      var0.addFixer(new SaddleEquipmentSlotFix(var261));
      Schema var262 = var0.addSchema(4301, V4301::new);
      var0.addFixer(new EquipmentFormatFix(var262));
      Schema var263 = var0.addSchema(4302, V4302::new);
      var0.addFixer(new AddNewChoices(var263, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
      Schema var264 = var0.addSchema(4303, SAME_NAMESPACED);
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var264, References.ENTITY));
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var264, References.PLAYER));
      Schema var265 = var0.addSchema(4305, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var265, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (var0x) -> var0x));
      Schema var266 = var0.addSchema(4306, V4306::new);
