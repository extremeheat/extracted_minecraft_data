...
public class DataFixers {
   ...
   private static synchronized DataFixer createFixerUpper() {
      ...
      SharedConstants.DATAFIXER_OPTIMIZATION_OPTION = var1 ? DataFixerOptimizationOption.INITIALIZED_OPTIMIZED : DataFixerOptimizationOption.INITIALIZED_UNOPTIMIZED;
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(new AdvancementsRenameFix(var97, false, "Rename sugar recipe advancement", createRenamer("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      ...
      var0.addFixer(new AdvancementsRenameFix(var105, false, "Composter category change", createRenamer("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      ...
      var0.addFixer(ItemRenameFix.create(var107, "Renamed fungi items to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      var0.addFixer(BlockRenameFix.create(var107, "Renamed fungi blocks to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      ...
      var0.addFixer(ItemRenameFix.create(var117, "Rename soul fire torch and soul fire lantern", createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      var0.addFixer(BlockRenameFix.create(var117, "Rename soul fire torch and soul fire lantern", createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      ...
      var0.addFixer(BlockRenameFixWithJigsaw.create(var130, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      ...
      var0.addFixer(BlockRenameFixWithJigsaw.create(var141, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      ...
      var0.addFixer(new CriteriaRenameFix(var167, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (var1x) -> {
         return (String)var168.getOrDefault(var1x, var1x);
      }));
