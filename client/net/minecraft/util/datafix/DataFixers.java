...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      Schema var121 = var0.addSchema(2538, SAME_NAMESPACED);
      var0.addFixer(new LevelLegacyWorldGenSettingsFix(var121));
      ...
      var0.addFixer(new NamespacedTypeRenameFix(var124, "Nether biome rename", References.BIOME, createRenamer("minecraft:nether", "minecraft:nether_wastes")));
      Schema var125 = var0.addSchema(2553, SAME_NAMESPACED);
      var0.addFixer(new NamespacedTypeRenameFix(var125, "Biomes fix", References.BIOME, createRenamer(BiomeFix.BIOMES)));
      ...
      var0.addFixer(BlockRenameFix.create(var130, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      ...
      ImmutableMap var135 = ImmutableMap.builder().put("minecraft:weathered_copper_block", "minecraft:oxidized_copper_block").put("minecraft:semi_weathered_copper_block", "minecraft:weathered_copper_block").put("minecraft:lightly_weathered_copper_block", "minecraft:exposed_copper_block").put("minecraft:weathered_cut_copper", "minecraft:oxidized_cut_copper").put("minecraft:semi_weathered_cut_copper", "minecraft:weathered_cut_copper").put("minecraft:lightly_weathered_cut_copper", "minecraft:exposed_cut_copper").put("minecraft:weathered_cut_copper_stairs", "minecraft:oxidized_cut_copper_stairs").put("minecraft:semi_weathered_cut_copper_stairs", "minecraft:weathered_cut_copper_stairs").put("minecraft:lightly_weathered_cut_copper_stairs", "minecraft:exposed_cut_copper_stairs").put("minecraft:weathered_cut_copper_slab", "minecraft:oxidized_cut_copper_slab").put("minecraft:semi_weathered_cut_copper_slab", "minecraft:weathered_cut_copper_slab").put("minecraft:lightly_weathered_cut_copper_slab", "minecraft:exposed_cut_copper_slab").put("minecraft:waxed_semi_weathered_copper", "minecraft:waxed_weathered_copper").put("minecraft:waxed_lightly_weathered_copper", "minecraft:waxed_exposed_copper").put("minecraft:waxed_semi_weathered_cut_copper", "minecraft:waxed_weathered_cut_copper").put("minecraft:waxed_lightly_weathered_cut_copper", "minecraft:waxed_exposed_cut_copper").put("minecraft:waxed_semi_weathered_cut_copper_stairs", "minecraft:waxed_weathered_cut_copper_stairs").put("minecraft:waxed_lightly_weathered_cut_copper_stairs", "minecraft:waxed_exposed_cut_copper_stairs").put("minecraft:waxed_semi_weathered_cut_copper_slab", "minecraft:waxed_weathered_cut_copper_slab").put("minecraft:waxed_lightly_weathered_cut_copper_slab", "minecraft:waxed_exposed_cut_copper_slab").build();
      var0.addFixer(ItemRenameFix.create(var134, "Renamed copper block items to new oxidized terms", createRenamer(var135)));
      var0.addFixer(BlockRenameFix.create(var134, "Renamed copper blocks to new oxidized terms", createRenamer(var135)));
      Schema var136 = var0.addSchema(2691, SAME_NAMESPACED);
      ImmutableMap var137 = ImmutableMap.builder().put("minecraft:waxed_copper", "minecraft:waxed_copper_block").put("minecraft:oxidized_copper_block", "minecraft:oxidized_copper").put("minecraft:weathered_copper_block", "minecraft:weathered_copper").put("minecraft:exposed_copper_block", "minecraft:exposed_copper").build();
      var0.addFixer(ItemRenameFix.create(var136, "Rename copper item suffixes", createRenamer(var137)));
      var0.addFixer(BlockRenameFix.create(var136, "Rename copper blocks suffixes", createRenamer(var137)));
      ...
      ImmutableMap var140 = ImmutableMap.builder().put("minecraft:grimstone", "minecraft:deepslate").put("minecraft:grimstone_slab", "minecraft:cobbled_deepslate_slab").put("minecraft:grimstone_stairs", "minecraft:cobbled_deepslate_stairs").put("minecraft:grimstone_wall", "minecraft:cobbled_deepslate_wall").put("minecraft:polished_grimstone", "minecraft:polished_deepslate").put("minecraft:polished_grimstone_slab", "minecraft:polished_deepslate_slab").put("minecraft:polished_grimstone_stairs", "minecraft:polished_deepslate_stairs").put("minecraft:polished_grimstone_wall", "minecraft:polished_deepslate_wall").put("minecraft:grimstone_tiles", "minecraft:deepslate_tiles").put("minecraft:grimstone_tile_slab", "minecraft:deepslate_tile_slab").put("minecraft:grimstone_tile_stairs", "minecraft:deepslate_tile_stairs").put("minecraft:grimstone_tile_wall", "minecraft:deepslate_tile_wall").put("minecraft:grimstone_bricks", "minecraft:deepslate_bricks").put("minecraft:grimstone_brick_slab", "minecraft:deepslate_brick_slab").put("minecraft:grimstone_brick_stairs", "minecraft:deepslate_brick_stairs").put("minecraft:grimstone_brick_wall", "minecraft:deepslate_brick_wall").put("minecraft:chiseled_grimstone", "minecraft:chiseled_deepslate").build();
      var0.addFixer(ItemRenameFix.create(var139, "Renamed grimstone block items to deepslate", createRenamer(var140)));
      var0.addFixer(BlockRenameFix.create(var139, "Renamed grimstone blocks to deepslate", createRenamer(var140)));
      Schema var141 = var0.addSchema(2700, SAME_NAMESPACED);
      var0.addFixer(BlockRenameFix.create(var141, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      ...
      var0.addFixer(new StatsRenameFix(var146, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
      Schema var147 = var0.addSchema(2717, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var147, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      var0.addFixer(BlockRenameFix.create(var147, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      ...
      var0.addFixer(new NamespacedTypeRenameFix(var152, "Caves and Cliffs biome renames", References.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES)));
      ...
      Objects.requireNonNull(var10008);
      var0.addFixer(new EntityVariantFix(var169, "Change frog variant type", var10005, "minecraft:frog", "Variant", var10008::get));
      Schema var170 = var0.addSchema(3090, SAME_NAMESPACED);
      var0.addFixer(new EntityFieldsRenameFix(var170, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
      Schema var171 = var0.addSchema(3093, SAME_NAMESPACED);
      var0.addFixer(new EntityGoatMissingStateFix(var171));
      Schema var172 = var0.addSchema(3094, SAME_NAMESPACED);
      var0.addFixer(new GoatHornIdFix(var172));
      Schema var173 = var0.addSchema(3097, SAME_NAMESPACED);
      var0.addFixer(new FilteredBooksFix(var173));
      var0.addFixer(new FilteredSignsFix(var173));
      ...
      var0.addFixer(new OptionsProgrammerArtFix(var176));
      Schema var177 = var0.addSchema(3202, V3202::new);
      var0.addFixer(new AddNewChoices(var177, "Added Hanging Sign", References.BLOCK_ENTITY));
      Schema var178 = var0.addSchema(3203, V3203::new);
      var0.addFixer(new AddNewChoices(var178, "Added Camel", References.ENTITY));
      Schema var179 = var0.addSchema(3204, V3204::new);
      var0.addFixer(new AddNewChoices(var179, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
      Schema var180 = var0.addSchema(3209, SAME_NAMESPACED);
      var0.addFixer(new ItemStackSpawnEggFix(var180, false, "minecraft:pig_spawn_egg"));
      Schema var181 = var0.addSchema(3214, SAME_NAMESPACED);
      var0.addFixer(new OptionsAmbientOcclusionFix(var181));
      Schema var182 = var0.addSchema(3319, SAME_NAMESPACED);
      var0.addFixer(new OptionsAccessibilityOnboardFix(var182));
      Schema var183 = var0.addSchema(3322, SAME_NAMESPACED);
      var0.addFixer(new EffectDurationFix(var183));
      Schema var184 = var0.addSchema(3325, V3325::new);
      var0.addFixer(new AddNewChoices(var184, "Added displays", References.ENTITY));
      Schema var185 = var0.addSchema(3326, V3326::new);
      var0.addFixer(new AddNewChoices(var185, "Added Sniffer", References.ENTITY));
      Schema var186 = var0.addSchema(3327, V3327::new);
      var0.addFixer(new AddNewChoices(var186, "Archaeology", References.BLOCK_ENTITY));
      Schema var187 = var0.addSchema(3328, V3328::new);
      var0.addFixer(new AddNewChoices(var187, "Added interaction", References.ENTITY));
      Schema var188 = var0.addSchema(3438, V3438::new);
      var0.addFixer(BlockEntityRenameFix.create(var188, "Rename Suspicious Sand to Brushable Block", createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block")));
      var0.addFixer(new EntityBrushableBlockFieldsRenameFix(var188));
      var0.addFixer(ItemRenameFix.create(var188, "Pottery shard renaming", createRenamer(ImmutableMap.of("minecraft:pottery_shard_archer", "minecraft:archer_pottery_shard", "minecraft:pottery_shard_prize", "minecraft:prize_pottery_shard", "minecraft:pottery_shard_arms_up", "minecraft:arms_up_pottery_shard", "minecraft:pottery_shard_skull", "minecraft:skull_pottery_shard"))));
      var0.addFixer(new AddNewChoices(var188, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
      Schema var189 = var0.addSchema(3439, V3439::new);
      var0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(var189, "Updated sign text format for Signs", "minecraft:sign"));
      Schema var190 = var0.addSchema(3439, 1, V3439_1::new);
      var0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(var190, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema var191 = var0.addSchema(3440, SAME_NAMESPACED);
      var0.addFixer(new NamespacedTypeRenameFix(var191, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
      var0.addFixer(new FeatureFlagRemoveFix(var191, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema var192 = var0.addSchema(3447, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var192, "Pottery shard item renaming to Pottery sherd", createRenamer((Map)Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), (var0x) -> var0x.replace("_pottery_shard", "_pottery_sherd"))))));
      Schema var193 = var0.addSchema(3448, V3448::new);
      var0.addFixer(new DecoratedPotFieldRenameFix(var193));
      Schema var194 = var0.addSchema(3450, SAME_NAMESPACED);
      var0.addFixer(new RemapChunkStatusFix(var194, "Remove liquid_carvers and heightmap chunk statuses", createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
      Schema var195 = var0.addSchema(3451, SAME_NAMESPACED);
      var0.addFixer(new ChunkDeleteLightFix(var195));
      Schema var196 = var0.addSchema(3459, SAME_NAMESPACED);
      var0.addFixer(new LegacyDragonFightFix(var196));
      Schema var197 = var0.addSchema(3564, SAME_NAMESPACED);
      var0.addFixer(new DropInvalidSignDataFix(var197, "minecraft:sign"));
      Schema var198 = var0.addSchema(3564, 1, SAME_NAMESPACED);
      var0.addFixer(new DropInvalidSignDataFix(var198, "minecraft:hanging_sign"));
      Schema var199 = var0.addSchema(3565, SAME_NAMESPACED);
      var0.addFixer(new RandomSequenceSettingsFix(var199));
      Schema var200 = var0.addSchema(3566, SAME_NAMESPACED);
      var0.addFixer(new ScoreboardDisplaySlotFix(var200));
      Schema var201 = var0.addSchema(3568, SAME_NAMESPACED);
      var0.addFixer(new MobEffectIdFix(var201));
      Schema var202 = var0.addSchema(3682, V3682::new);
      var0.addFixer(new AddNewChoices(var202, "Added Crafter", References.BLOCK_ENTITY));
      Schema var203 = var0.addSchema(3683, V3683::new);
      var0.addFixer(new PrimedTntBlockStateFixer(var203));
      Schema var204 = var0.addSchema(3685, V3685::new);
      var0.addFixer(new FixProjectileStoredItem(var204));
      Schema var205 = var0.addSchema(3689, V3689::new);
      var0.addFixer(new AddNewChoices(var205, "Added Breeze", References.ENTITY));
      var0.addFixer(new AddNewChoices(var205, "Added Trial Spawner", References.BLOCK_ENTITY));
      Schema var206 = var0.addSchema(3692, SAME_NAMESPACED);
      UnaryOperator var207 = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
      var0.addFixer(BlockRenameFix.create(var206, "Rename grass block to short_grass", var207));
      var0.addFixer(ItemRenameFix.create(var206, "Rename grass item to short_grass", var207));
      Schema var208 = var0.addSchema(3799, V3799::new);
      var0.addFixer(new AddNewChoices(var208, "Added Armadillo", References.ENTITY));
      Schema var209 = var0.addSchema(3800, SAME_NAMESPACED);
      UnaryOperator var210 = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      var0.addFixer(ItemRenameFix.create(var209, "Rename scute item to turtle_scute", var210));
      Schema var211 = var0.addSchema(3803, SAME_NAMESPACED);
      var0.addFixer(new RenameEnchantmentsFix(var211, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema var212 = var0.addSchema(3807, V3807::new);
      var0.addFixer(new AddNewChoices(var212, "Added Vault", References.BLOCK_ENTITY));
      Schema var213 = var0.addSchema(3807, 1, SAME_NAMESPACED);
      var0.addFixer(new MapBannerBlockPosFormatFix(var213));
      Schema var214 = var0.addSchema(3808, V3808::new);
      var0.addFixer(new HorseBodyArmorItemFix(var214, "minecraft:horse", "ArmorItem", true));
      Schema var215 = var0.addSchema(3808, 1, V3808_1::new);
      var0.addFixer(new HorseBodyArmorItemFix(var215, "minecraft:llama", "DecorItem", false));
      Schema var216 = var0.addSchema(3808, 2, V3808_2::new);
      var0.addFixer(new HorseBodyArmorItemFix(var216, "minecraft:trader_llama", "DecorItem", false));
      Schema var217 = var0.addSchema(3809, SAME_NAMESPACED);
      var0.addFixer(new ChestedHorsesInventoryZeroIndexingFix(var217));
      Schema var218 = var0.addSchema(3812, SAME_NAMESPACED);
      var0.addFixer(new FixWolfHealth(var218));
      Schema var219 = var0.addSchema(3813, V3813::new);
      var0.addFixer(new BlockPosFormatAndRenamesFix(var219));
      Schema var220 = var0.addSchema(3814, SAME_NAMESPACED);
      var0.addFixer(new AttributesRenameLegacy(var220, "Rename jump strength attribute", createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
      Schema var221 = var0.addSchema(3816, V3816::new);
      var0.addFixer(new AddNewChoices(var221, "Added Bogged", References.ENTITY));
      Schema var222 = var0.addSchema(3818, V3818::new);
      var0.addFixer(new BeehiveFieldRenameFix(var222));
      var0.addFixer(new EmptyItemInHotbarFix(var222));
      Schema var223 = var0.addSchema(3818, 1, SAME_NAMESPACED);
      var0.addFixer(new BannerPatternFormatFix(var223));
      Schema var224 = var0.addSchema(3818, 2, SAME_NAMESPACED);
      var0.addFixer(new TippedArrowPotionToItemFix(var224));
      Schema var225 = var0.addSchema(3818, 3, V3818_3::new);
      var0.addFixer(new WriteAndReadFix(var225, "Inject data component types", References.DATA_COMPONENTS));
      Schema var226 = var0.addSchema(3818, 4, V3818_4::new);
      var0.addFixer(new ParticleUnflatteningFix(var226));
      Schema var227 = var0.addSchema(3818, 5, V3818_5::new);
      var0.addFixer(new ItemStackComponentizationFix(var227));
      Schema var228 = var0.addSchema(3818, 6, SAME_NAMESPACED);
      var0.addFixer(new AreaEffectCloudPotionFix(var228));
      Schema var229 = var0.addSchema(3820, SAME_NAMESPACED);
      var0.addFixer(new PlayerHeadBlockProfileFix(var229));
      var0.addFixer(new LodestoneCompassComponentFix(var229));
      Schema var230 = var0.addSchema(3825, V3825::new);
      var0.addFixer(new ItemStackCustomNameToOverrideComponentFix(var230));
      var0.addFixer(new BannerEntityCustomNameToOverrideComponentFix(var230));
      var0.addFixer(new TrialSpawnerConfigFix(var230));
      var0.addFixer(new AddNewChoices(var230, "Added Ominous Item Spawner", References.ENTITY));
      Schema var231 = var0.addSchema(3828, SAME_NAMESPACED);
      var0.addFixer(new EmptyItemInVillagerTradeFix(var231));
      Schema var232 = var0.addSchema(3833, SAME_NAMESPACED);
      var0.addFixer(new RemoveEmptyItemInBrushableBlockFix(var232));
      Schema var233 = var0.addSchema(3938, V3938::new);
      var0.addFixer(new ProjectileStoredWeaponFix(var233));
      Schema var234 = var0.addSchema(3939, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var234, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema var235 = var0.addSchema(3943, SAME_NAMESPACED);
      var0.addFixer(new OptionsMenuBlurrinessFix(var235));
      Schema var236 = var0.addSchema(3945, SAME_NAMESPACED);
      var0.addFixer(new AttributeModifierIdFix(var236));
      var0.addFixer(new JukeboxTicksSinceSongStartedFix(var236));
      Schema var237 = var0.addSchema(4054, SAME_NAMESPACED);
      var0.addFixer(new OminousBannerRarityFix(var237));
      Schema var238 = var0.addSchema(4055, SAME_NAMESPACED);
      var0.addFixer(new AttributeIdPrefixFix(var238));
      Schema var239 = var0.addSchema(4057, SAME_NAMESPACED);
      var0.addFixer(new CarvingStepRemoveFix(var239));
      Schema var240 = var0.addSchema(4059, V4059::new);
      var0.addFixer(new FoodToConsumableFix(var240));
      Schema var241 = var0.addSchema(4061, SAME_NAMESPACED);
      var0.addFixer(new TrialSpawnerConfigInRegistryFix(var241));
      Schema var242 = var0.addSchema(4064, SAME_NAMESPACED);
      var0.addFixer(new FireResistantToDamageResistantComponentFix(var242));
      Schema var243 = var0.addSchema(4067, V4067::new);
      var0.addFixer(new BoatSplitFix(var243));
      var0.addFixer(new FeatureFlagRemoveFix(var243, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema var244 = var0.addSchema(4068, SAME_NAMESPACED);
      var0.addFixer(new LockComponentPredicateFix(var244));
      var0.addFixer(new ContainerBlockEntityLockPredicateFix(var244));
      Schema var245 = var0.addSchema(4070, V4070::new);
      var0.addFixer(new AddNewChoices(var245, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
      Schema var246 = var0.addSchema(4071, V4071::new);
      var0.addFixer(new AddNewChoices(var246, "Added Creaking", References.ENTITY));
      var0.addFixer(new AddNewChoices(var246, "Added Creaking Heart", References.BLOCK_ENTITY));
      Schema var247 = var0.addSchema(4081, SAME_NAMESPACED);
      var0.addFixer(new EntitySalmonSizeFix(var247));
      Schema var248 = var0.addSchema(4173, SAME_NAMESPACED);
      var0.addFixer(new EntityFieldsRenameFix(var248, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema var249 = var0.addSchema(4175, SAME_NAMESPACED);
      var0.addFixer(new EquippableAssetRenameFix(var249));
      var0.addFixer(new CustomModelDataExpandFix(var249));
      Schema var250 = var0.addSchema(4176, SAME_NAMESPACED);
      var0.addFixer(new InvalidBlockEntityLockFix(var250));
      var0.addFixer(new InvalidLockComponentFix(var250));
      Schema var251 = var0.addSchema(4180, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var251, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema var252 = var0.addSchema(4181, SAME_NAMESPACED);
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var252, "minecraft:furnace"));
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var252, "minecraft:smoker"));
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var252, "minecraft:blast_furnace"));
      Schema var253 = var0.addSchema(4187, SAME_NAMESPACED);
      var0.addFixer(new EntityAttributeBaseValueFix(var253, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var253, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var253, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var253, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (var0x) -> var0x == 40.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var253, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (var0x) -> var0x == 16.0 ? 12.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var253, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (var0x) -> var0x == 16.0 ? 24.0 : var0x));
      Schema var254 = var0.addSchema(4290, V4290::new);
      var0.addFixer(new UnflattenTextComponentFix(var254));
      Schema var255 = var0.addSchema(4291, SAME_NAMESPACED);
      var0.addFixer(new LegacyHoverEventFix(var255));
      var0.addFixer(new TextComponentStringifiedFlagsFix(var255));
      Schema var256 = var0.addSchema(4292, V4292::new);
      var0.addFixer(new TextComponentHoverAndClickEventFix(var256));
      Schema var257 = var0.addSchema(4293, SAME_NAMESPACED);
      var0.addFixer(new DropChancesFormatFix(var257));
      Schema var258 = var0.addSchema(4294, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var258, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (var0x) -> var0x.equals("true") ? "awake" : "uprooted"));
      Schema var259 = var0.addSchema(4295, SAME_NAMESPACED);
      var0.addFixer(new BlendingDataFix(var259));
      Schema var260 = var0.addSchema(4296, SAME_NAMESPACED);
      var0.addFixer(new AreaEffectCloudDurationScaleFix(var260));
      Schema var261 = var0.addSchema(4297, SAME_NAMESPACED);
      var0.addFixer(new ForcedChunkToTicketFix(var261));
      Schema var262 = var0.addSchema(4299, SAME_NAMESPACED);
      var0.addFixer(new EntitySpawnerItemVariantComponentFix(var262));
      Schema var263 = var0.addSchema(4300, V4300::new);
      var0.addFixer(new SaddleEquipmentSlotFix(var263));
      Schema var264 = var0.addSchema(4301, V4301::new);
      var0.addFixer(new EquipmentFormatFix(var264));
      Schema var265 = var0.addSchema(4302, V4302::new);
      var0.addFixer(new AddNewChoices(var265, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
      Schema var266 = var0.addSchema(4303, SAME_NAMESPACED);
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var266, References.ENTITY));
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var266, References.PLAYER));
      Schema var267 = var0.addSchema(4305, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var267, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (var0x) -> var0x));
      Schema var268 = var0.addSchema(4306, V4306::new);
      var0.addFixer(new ThrownPotionSplitFix(var268));
      Schema var269 = var0.addSchema(4307, V4307::new);
      var0.addFixer(new TooltipDisplayComponentFix(var269));
      Schema var270 = var0.addSchema(4309, SAME_NAMESPACED);
      var0.addFixer(new RaidRenamesDataFix(var270));
      var0.addFixer(new ChunkTicketUnpackPosFix(var270));
      Schema var271 = var0.addSchema(4311, SAME_NAMESPACED);
      var0.addFixer(new AdvancementsRenameFix(var271, false, "Use lodestone category change", createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
      Schema var272 = var0.addSchema(4312, V4312::new);
      var0.addFixer(new PlayerEquipmentFix(var272));
      Schema var273 = var0.addSchema(4314, SAME_NAMESPACED);
      var0.addFixer(new InlineBlockPosFormatFix(var273));
      Schema var274 = var0.addSchema(4420, V4420::new);
