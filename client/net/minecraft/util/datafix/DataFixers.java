...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(new JigsawRotationFix(var110));
      ...
      Set var265 = Set.of("minecraft:unemployed", "minecraft:nitwit");
      Objects.requireNonNull(var265);
      var0.addFixer(new PoiTypeRemoveFix(var172, "Remove unpopulated villager PoI types", var265::contains));
      ...
      Schema var188 = var0.addSchema(3439, V3439::new);
      ...
      var0.addFixer(ItemRenameFix.create(var190, "Pottery shard item renaming to Pottery sherd", createRenamer((Map)Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), (var0x) -> var0x.replace("_pottery_shard", "_pottery_sherd"))))));
      ...
      var0.addFixer(new RemapChunkStatusFix(var192, "Remove liquid_carvers and heightmap chunk statuses", createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
      ...
      var0.addFixer(new DropInvalidSignDataFix(var195, "minecraft:sign"));
      var0.addFixer(new DropInvalidSignDataFix(var195, "minecraft:hanging_sign"));
      ...
      Schema var199 = var0.addSchema(3682, V3682::new);
      var0.addFixer(new AddNewChoices(var199, "Added Crafter", References.BLOCK_ENTITY));
      Schema var200 = var0.addSchema(3683, V3683::new);
      var0.addFixer(new PrimedTntBlockStateFixer(var200));
      Schema var201 = var0.addSchema(3685, V3685::new);
      var0.addFixer(new FixProjectileStoredItem(var201));
      Schema var202 = var0.addSchema(3689, V3689::new);
      var0.addFixer(new AddNewChoices(var202, "Added Breeze", References.ENTITY));
      var0.addFixer(new AddNewChoices(var202, "Added Trial Spawner", References.BLOCK_ENTITY));
      Schema var203 = var0.addSchema(3692, SAME_NAMESPACED);
      UnaryOperator var204 = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
      var0.addFixer(BlockRenameFix.create(var203, "Rename grass block to short_grass", var204));
      var0.addFixer(ItemRenameFix.create(var203, "Rename grass item to short_grass", var204));
      Schema var205 = var0.addSchema(3799, V3799::new);
      var0.addFixer(new AddNewChoices(var205, "Added Armadillo", References.ENTITY));
      Schema var206 = var0.addSchema(3800, SAME_NAMESPACED);
      UnaryOperator var207 = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      var0.addFixer(ItemRenameFix.create(var206, "Rename scute item to turtle_scute", var207));
      Schema var208 = var0.addSchema(3803, SAME_NAMESPACED);
      var0.addFixer(new RenameEnchantmentsFix(var208, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema var209 = var0.addSchema(3807, V3807::new);
      var0.addFixer(new AddNewChoices(var209, "Added Vault", References.BLOCK_ENTITY));
      Schema var210 = var0.addSchema(3807, 1, SAME_NAMESPACED);
      var0.addFixer(new MapBannerBlockPosFormatFix(var210));
      Schema var211 = var0.addSchema(3808, V3808::new);
      var0.addFixer(new HorseBodyArmorItemFix(var211, "minecraft:horse", "ArmorItem", true));
      Schema var212 = var0.addSchema(3808, 1, V3808_1::new);
      var0.addFixer(new HorseBodyArmorItemFix(var212, "minecraft:llama", "DecorItem", false));
      Schema var213 = var0.addSchema(3808, 2, V3808_2::new);
      var0.addFixer(new HorseBodyArmorItemFix(var213, "minecraft:trader_llama", "DecorItem", false));
      ...
      Schema var216 = var0.addSchema(3813, V3813::new);
      var0.addFixer(new BlockPosFormatAndRenamesFix(var216));
      Schema var217 = var0.addSchema(3814, SAME_NAMESPACED);
      var0.addFixer(new AttributesRenameLegacy(var217, "Rename jump strength attribute", createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
      ...
      Schema var230 = var0.addSchema(3938, V3938::new);
      var0.addFixer(new ProjectileStoredWeaponFix(var230));
      Schema var231 = var0.addSchema(3939, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var231, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema var232 = var0.addSchema(3943, SAME_NAMESPACED);
      var0.addFixer(new OptionsMenuBlurrinessFix(var232));
      Schema var233 = var0.addSchema(3945, SAME_NAMESPACED);
      var0.addFixer(new AttributeModifierIdFix(var233));
      var0.addFixer(new JukeboxTicksSinceSongStartedFix(var233));
      Schema var234 = var0.addSchema(4054, SAME_NAMESPACED);
      var0.addFixer(new OminousBannerRarityFix(var234));
      Schema var235 = var0.addSchema(4055, SAME_NAMESPACED);
      var0.addFixer(new AttributeIdPrefixFix(var235));
      Schema var236 = var0.addSchema(4057, SAME_NAMESPACED);
      var0.addFixer(new CarvingStepRemoveFix(var236));
      Schema var237 = var0.addSchema(4059, V4059::new);
      var0.addFixer(new FoodToConsumableFix(var237));
      Schema var238 = var0.addSchema(4061, SAME_NAMESPACED);
      var0.addFixer(new TrialSpawnerConfigInRegistryFix(var238));
      Schema var239 = var0.addSchema(4064, SAME_NAMESPACED);
      var0.addFixer(new FireResistantToDamageResistantComponentFix(var239));
      Schema var240 = var0.addSchema(4067, V4067::new);
      var0.addFixer(new BoatSplitFix(var240));
      var0.addFixer(new FeatureFlagRemoveFix(var240, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema var241 = var0.addSchema(4068, SAME_NAMESPACED);
      var0.addFixer(new LockComponentPredicateFix(var241));
      var0.addFixer(new ContainerBlockEntityLockPredicateFix(var241));
      Schema var242 = var0.addSchema(4070, V4070::new);
      var0.addFixer(new AddNewChoices(var242, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
      Schema var243 = var0.addSchema(4071, V4071::new);
      var0.addFixer(new AddNewChoices(var243, "Added Creaking", References.ENTITY));
      var0.addFixer(new AddNewChoices(var243, "Added Creaking Heart", References.BLOCK_ENTITY));
      Schema var244 = var0.addSchema(4081, SAME_NAMESPACED);
      var0.addFixer(new EntitySalmonSizeFix(var244));
      Schema var245 = var0.addSchema(4173, SAME_NAMESPACED);
      var0.addFixer(new EntityFieldsRenameFix(var245, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema var246 = var0.addSchema(4175, SAME_NAMESPACED);
      var0.addFixer(new EquippableAssetRenameFix(var246));
      var0.addFixer(new CustomModelDataExpandFix(var246));
      Schema var247 = var0.addSchema(4176, SAME_NAMESPACED);
      var0.addFixer(new InvalidBlockEntityLockFix(var247));
      var0.addFixer(new InvalidLockComponentFix(var247));
      Schema var248 = var0.addSchema(4180, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var248, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema var249 = var0.addSchema(4181, SAME_NAMESPACED);
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var249, "minecraft:furnace"));
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var249, "minecraft:smoker"));
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var249, "minecraft:blast_furnace"));
      Schema var250 = var0.addSchema(4187, SAME_NAMESPACED);
      var0.addFixer(new EntityAttributeBaseValueFix(var250, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var250, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var250, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var250, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (var0x) -> var0x == 40.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var250, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (var0x) -> var0x == 16.0 ? 12.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var250, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (var0x) -> var0x == 16.0 ? 24.0 : var0x));
      Schema var251 = var0.addSchema(4290, V4290::new);
      var0.addFixer(new UnflattenTextComponentFix(var251));
      Schema var252 = var0.addSchema(4291, SAME_NAMESPACED);
      var0.addFixer(new LegacyHoverEventFix(var252));
      var0.addFixer(new TextComponentStringifiedFlagsFix(var252));
      Schema var253 = var0.addSchema(4292, V4292::new);
      var0.addFixer(new TextComponentHoverAndClickEventFix(var253));
      Schema var254 = var0.addSchema(4293, SAME_NAMESPACED);
      var0.addFixer(new DropChancesFormatFix(var254));
      Schema var255 = var0.addSchema(4294, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var255, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (var0x) -> var0x.equals("true") ? "awake" : "uprooted"));
      Schema var256 = var0.addSchema(4295, SAME_NAMESPACED);
      var0.addFixer(new BlendingDataFix(var256));
      Schema var257 = var0.addSchema(4296, SAME_NAMESPACED);
      var0.addFixer(new AreaEffectCloudDurationScaleFix(var257));
      Schema var258 = var0.addSchema(4297, SAME_NAMESPACED);
      var0.addFixer(new ForcedChunkToTicketFix(var258));
      Schema var259 = var0.addSchema(4299, SAME_NAMESPACED);
      var0.addFixer(new EntitySpawnerItemVariantComponentFix(var259));
      Schema var260 = var0.addSchema(4300, V4300::new);
      var0.addFixer(new SaddleEquipmentSlotFix(var260));
      Schema var261 = var0.addSchema(4301, V4301::new);
      var0.addFixer(new EquipmentFormatFix(var261));
      Schema var262 = var0.addSchema(4302, V4302::new);
      var0.addFixer(new AddNewChoices(var262, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
      Schema var263 = var0.addSchema(4303, SAME_NAMESPACED);
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var263, References.ENTITY));
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var263, References.PLAYER));
   }
