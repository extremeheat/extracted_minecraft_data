...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      Schema var127 = var0.addSchema(2556, SAME_NAMESPACED);
      var0.addFixer(new OptionsFancyGraphicsToGraphicsModeFix(var127));
      Schema var128 = var0.addSchema(2558, SAME_NAMESPACED);
      var0.addFixer(new MissingDimensionFix(var128, false));
      var0.addFixer(new OptionsRenameFieldFix(var128, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
      Schema var129 = var0.addSchema(2568, V2568::new);
      var0.addFixer(new AddNewChoices(var129, "Added Piglin Brute", References.ENTITY));
      Schema var130 = var0.addSchema(2571, V2571::new);
      var0.addFixer(new AddNewChoices(var130, "Added Goat", References.ENTITY));
      Schema var131 = var0.addSchema(2679, SAME_NAMESPACED);
      var0.addFixer(new CauldronRenameFix(var131, false));
      Schema var132 = var0.addSchema(2680, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var132, "Renamed grass path item to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      var0.addFixer(BlockRenameFix.create(var132, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      Schema var133 = var0.addSchema(2684, V2684::new);
      var0.addFixer(new AddNewChoices(var133, "Added Sculk Sensor", References.BLOCK_ENTITY));
      Schema var134 = var0.addSchema(2686, V2686::new);
      var0.addFixer(new AddNewChoices(var134, "Added Axolotl", References.ENTITY));
      Schema var135 = var0.addSchema(2688, V2688::new);
      var0.addFixer(new AddNewChoices(var135, "Added Glow Squid", References.ENTITY));
      var0.addFixer(new AddNewChoices(var135, "Added Glow Item Frame", References.ENTITY));
      Schema var136 = var0.addSchema(2690, SAME_NAMESPACED);
      ImmutableMap var137 = ImmutableMap.builder().put("minecraft:weathered_copper_block", "minecraft:oxidized_copper_block").put("minecraft:semi_weathered_copper_block", "minecraft:weathered_copper_block").put("minecraft:lightly_weathered_copper_block", "minecraft:exposed_copper_block").put("minecraft:weathered_cut_copper", "minecraft:oxidized_cut_copper").put("minecraft:semi_weathered_cut_copper", "minecraft:weathered_cut_copper").put("minecraft:lightly_weathered_cut_copper", "minecraft:exposed_cut_copper").put("minecraft:weathered_cut_copper_stairs", "minecraft:oxidized_cut_copper_stairs").put("minecraft:semi_weathered_cut_copper_stairs", "minecraft:weathered_cut_copper_stairs").put("minecraft:lightly_weathered_cut_copper_stairs", "minecraft:exposed_cut_copper_stairs").put("minecraft:weathered_cut_copper_slab", "minecraft:oxidized_cut_copper_slab").put("minecraft:semi_weathered_cut_copper_slab", "minecraft:weathered_cut_copper_slab").put("minecraft:lightly_weathered_cut_copper_slab", "minecraft:exposed_cut_copper_slab").put("minecraft:waxed_semi_weathered_copper", "minecraft:waxed_weathered_copper").put("minecraft:waxed_lightly_weathered_copper", "minecraft:waxed_exposed_copper").put("minecraft:waxed_semi_weathered_cut_copper", "minecraft:waxed_weathered_cut_copper").put("minecraft:waxed_lightly_weathered_cut_copper", "minecraft:waxed_exposed_cut_copper").put("minecraft:waxed_semi_weathered_cut_copper_stairs", "minecraft:waxed_weathered_cut_copper_stairs").put("minecraft:waxed_lightly_weathered_cut_copper_stairs", "minecraft:waxed_exposed_cut_copper_stairs").put("minecraft:waxed_semi_weathered_cut_copper_slab", "minecraft:waxed_weathered_cut_copper_slab").put("minecraft:waxed_lightly_weathered_cut_copper_slab", "minecraft:waxed_exposed_cut_copper_slab").build();
      var0.addFixer(ItemRenameFix.create(var136, "Renamed copper block items to new oxidized terms", createRenamer(var137)));
      var0.addFixer(BlockRenameFix.create(var136, "Renamed copper blocks to new oxidized terms", createRenamer(var137)));
      Schema var138 = var0.addSchema(2691, SAME_NAMESPACED);
      ImmutableMap var139 = ImmutableMap.builder().put("minecraft:waxed_copper", "minecraft:waxed_copper_block").put("minecraft:oxidized_copper_block", "minecraft:oxidized_copper").put("minecraft:weathered_copper_block", "minecraft:weathered_copper").put("minecraft:exposed_copper_block", "minecraft:exposed_copper").build();
      var0.addFixer(ItemRenameFix.create(var138, "Rename copper item suffixes", createRenamer(var139)));
      var0.addFixer(BlockRenameFix.create(var138, "Rename copper blocks suffixes", createRenamer(var139)));
      Schema var140 = var0.addSchema(2693, SAME_NAMESPACED);
      var0.addFixer(new AddFlagIfNotPresentFix(var140, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema var141 = var0.addSchema(2696, SAME_NAMESPACED);
      ImmutableMap var142 = ImmutableMap.builder().put("minecraft:grimstone", "minecraft:deepslate").put("minecraft:grimstone_slab", "minecraft:cobbled_deepslate_slab").put("minecraft:grimstone_stairs", "minecraft:cobbled_deepslate_stairs").put("minecraft:grimstone_wall", "minecraft:cobbled_deepslate_wall").put("minecraft:polished_grimstone", "minecraft:polished_deepslate").put("minecraft:polished_grimstone_slab", "minecraft:polished_deepslate_slab").put("minecraft:polished_grimstone_stairs", "minecraft:polished_deepslate_stairs").put("minecraft:polished_grimstone_wall", "minecraft:polished_deepslate_wall").put("minecraft:grimstone_tiles", "minecraft:deepslate_tiles").put("minecraft:grimstone_tile_slab", "minecraft:deepslate_tile_slab").put("minecraft:grimstone_tile_stairs", "minecraft:deepslate_tile_stairs").put("minecraft:grimstone_tile_wall", "minecraft:deepslate_tile_wall").put("minecraft:grimstone_bricks", "minecraft:deepslate_bricks").put("minecraft:grimstone_brick_slab", "minecraft:deepslate_brick_slab").put("minecraft:grimstone_brick_stairs", "minecraft:deepslate_brick_stairs").put("minecraft:grimstone_brick_wall", "minecraft:deepslate_brick_wall").put("minecraft:chiseled_grimstone", "minecraft:chiseled_deepslate").build();
      var0.addFixer(ItemRenameFix.create(var141, "Renamed grimstone block items to deepslate", createRenamer(var142)));
      var0.addFixer(BlockRenameFix.create(var141, "Renamed grimstone blocks to deepslate", createRenamer(var142)));
      Schema var143 = var0.addSchema(2700, SAME_NAMESPACED);
      var0.addFixer(BlockRenameFix.create(var143, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      Schema var144 = var0.addSchema(2701, SAME_NAMESPACED);
      var0.addFixer(new SavedDataFeaturePoolElementFix(var144));
      Schema var145 = var0.addSchema(2702, SAME_NAMESPACED);
      var0.addFixer(new AbstractArrowPickupFix(var145));
      Schema var146 = var0.addSchema(2704, V2704::new);
      var0.addFixer(new AddNewChoices(var146, "Added Goat", References.ENTITY));
      Schema var147 = var0.addSchema(2707, V2707::new);
      var0.addFixer(new AddNewChoices(var147, "Added Marker", References.ENTITY));
      var0.addFixer(new AddFlagIfNotPresentFix(var147, References.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
      Schema var148 = var0.addSchema(2710, SAME_NAMESPACED);
      var0.addFixer(new StatsRenameFix(var148, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
      Schema var149 = var0.addSchema(2717, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var149, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      var0.addFixer(BlockRenameFix.create(var149, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      Schema var150 = var0.addSchema(2825, SAME_NAMESPACED);
      var0.addFixer(new AddFlagIfNotPresentFix(var150, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema var151 = var0.addSchema(2831, V2831::new);
      var0.addFixer(new SpawnerDataFix(var151));
      Schema var152 = var0.addSchema(2832, V2832::new);
      var0.addFixer(new WorldGenSettingsHeightAndBiomeFix(var152));
      var0.addFixer(new ChunkHeightAndBiomeFix(var152));
      Schema var153 = var0.addSchema(2833, SAME_NAMESPACED);
      var0.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(var153));
      Schema var154 = var0.addSchema(2838, SAME_NAMESPACED);
      var0.addFixer(new NamespacedTypeRenameFix(var154, "Caves and Cliffs biome renames", References.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES)));
      Schema var155 = var0.addSchema(2841, SAME_NAMESPACED);
      var0.addFixer(new ChunkProtoTickListFix(var155));
      Schema var156 = var0.addSchema(2842, V2842::new);
      var0.addFixer(new ChunkRenamesFix(var156));
      Schema var157 = var0.addSchema(2843, SAME_NAMESPACED);
      var0.addFixer(new OverreachingTickFix(var157));
      var0.addFixer(new NamespacedTypeRenameFix(var157, "Remove Deep Warm Ocean", References.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      Schema var158 = var0.addSchema(2846, SAME_NAMESPACED);
      var0.addFixer(new AdvancementsRenameFix(var158, false, "Rename some C&C part 2 advancements", createRenamer(ImmutableMap.of("minecraft:husbandry/play_jukebox_in_meadows", "minecraft:adventure/play_jukebox_in_meadows", "minecraft:adventure/caves_and_cliff", "minecraft:adventure/fall_from_world_height", "minecraft:adventure/ride_strider_in_overworld_lava", "minecraft:nether/ride_strider_in_overworld_lava"))));
      Schema var159 = var0.addSchema(2852, SAME_NAMESPACED);
      var0.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(var159));
      Schema var160 = var0.addSchema(2967, SAME_NAMESPACED);
      var0.addFixer(new StructureSettingsFlattenFix(var160));
      Schema var161 = var0.addSchema(2970, SAME_NAMESPACED);
      var0.addFixer(new StructuresBecomeConfiguredFix(var161));
      Schema var162 = var0.addSchema(3076, V3076::new);
      var0.addFixer(new AddNewChoices(var162, "Added Sculk Catalyst", References.BLOCK_ENTITY));
      Schema var163 = var0.addSchema(3077, SAME_NAMESPACED);
      var0.addFixer(new ChunkDeleteIgnoredLightDataFix(var163));
      Schema var164 = var0.addSchema(3078, V3078::new);
      var0.addFixer(new AddNewChoices(var164, "Added Frog", References.ENTITY));
      var0.addFixer(new AddNewChoices(var164, "Added Tadpole", References.ENTITY));
      var0.addFixer(new AddNewChoices(var164, "Added Sculk Shrieker", References.BLOCK_ENTITY));
      Schema var165 = var0.addSchema(3081, V3081::new);
      var0.addFixer(new AddNewChoices(var165, "Added Warden", References.ENTITY));
      Schema var166 = var0.addSchema(3082, V3082::new);
      var0.addFixer(new AddNewChoices(var166, "Added Chest Boat", References.ENTITY));
      Schema var167 = var0.addSchema(3083, V3083::new);
      var0.addFixer(new AddNewChoices(var167, "Added Allay", References.ENTITY));
      Schema var168 = var0.addSchema(3084, SAME_NAMESPACED);
      var0.addFixer(new NamespacedTypeRenameFix(var168, "game_event_renames_3084", References.GAME_EVENT_NAME, createRenamer(ImmutableMap.builder().put("minecraft:block_press", "minecraft:block_activate").put("minecraft:block_switch", "minecraft:block_activate").put("minecraft:block_unpress", "minecraft:block_deactivate").put("minecraft:block_unswitch", "minecraft:block_deactivate").put("minecraft:drinking_finish", "minecraft:drink").put("minecraft:elytra_free_fall", "minecraft:elytra_glide").put("minecraft:entity_damaged", "minecraft:entity_damage").put("minecraft:entity_dying", "minecraft:entity_die").put("minecraft:entity_killed", "minecraft:entity_die").put("minecraft:mob_interact", "minecraft:entity_interact").put("minecraft:ravager_roar", "minecraft:entity_roar").put("minecraft:ring_bell", "minecraft:block_change").put("minecraft:shulker_close", "minecraft:container_close").put("minecraft:shulker_open", "minecraft:container_open").put("minecraft:wolf_shaking", "minecraft:entity_shake").build())));
      Schema var169 = var0.addSchema(3086, SAME_NAMESPACED);
      ...
      var0.addFixer(new EntityVariantFix(var169, "Change cat variant type", var10005, "minecraft:cat", "CatType", var10008::get));
      ...
      var0.addFixer(new CriteriaRenameFix(var169, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (var1x) -> (String)var170.getOrDefault(var1x, var1x)));
      Schema var171 = var0.addSchema(3087, SAME_NAMESPACED);
      ...
      Objects.requireNonNull(var10008);
      var0.addFixer(new EntityVariantFix(var171, "Change frog variant type", var10005, "minecraft:frog", "Variant", var10008::get));
      Schema var172 = var0.addSchema(3090, SAME_NAMESPACED);
      var0.addFixer(new EntityFieldsRenameFix(var172, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
      Schema var173 = var0.addSchema(3093, SAME_NAMESPACED);
      var0.addFixer(new EntityGoatMissingStateFix(var173));
      Schema var174 = var0.addSchema(3094, SAME_NAMESPACED);
      var0.addFixer(new GoatHornIdFix(var174));
      Schema var175 = var0.addSchema(3097, SAME_NAMESPACED);
      var0.addFixer(new FilteredBooksFix(var175));
      var0.addFixer(new FilteredSignsFix(var175));
      ...
      var0.addFixer(new OptionsProgrammerArtFix(var178));
      Schema var179 = var0.addSchema(3202, V3202::new);
      var0.addFixer(new AddNewChoices(var179, "Added Hanging Sign", References.BLOCK_ENTITY));
      Schema var180 = var0.addSchema(3203, V3203::new);
      var0.addFixer(new AddNewChoices(var180, "Added Camel", References.ENTITY));
      Schema var181 = var0.addSchema(3204, V3204::new);
      var0.addFixer(new AddNewChoices(var181, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
      Schema var182 = var0.addSchema(3209, SAME_NAMESPACED);
      var0.addFixer(new ItemStackSpawnEggFix(var182, false, "minecraft:pig_spawn_egg"));
      Schema var183 = var0.addSchema(3214, SAME_NAMESPACED);
      var0.addFixer(new OptionsAmbientOcclusionFix(var183));
      Schema var184 = var0.addSchema(3319, SAME_NAMESPACED);
      var0.addFixer(new OptionsAccessibilityOnboardFix(var184));
      Schema var185 = var0.addSchema(3322, SAME_NAMESPACED);
      var0.addFixer(new EffectDurationFix(var185));
      Schema var186 = var0.addSchema(3325, V3325::new);
      var0.addFixer(new AddNewChoices(var186, "Added displays", References.ENTITY));
      Schema var187 = var0.addSchema(3326, V3326::new);
      var0.addFixer(new AddNewChoices(var187, "Added Sniffer", References.ENTITY));
      Schema var188 = var0.addSchema(3327, V3327::new);
      var0.addFixer(new AddNewChoices(var188, "Archaeology", References.BLOCK_ENTITY));
      Schema var189 = var0.addSchema(3328, V3328::new);
      var0.addFixer(new AddNewChoices(var189, "Added interaction", References.ENTITY));
      Schema var190 = var0.addSchema(3438, V3438::new);
      var0.addFixer(BlockEntityRenameFix.create(var190, "Rename Suspicious Sand to Brushable Block", createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block")));
      var0.addFixer(new EntityBrushableBlockFieldsRenameFix(var190));
      var0.addFixer(ItemRenameFix.create(var190, "Pottery shard renaming", createRenamer(ImmutableMap.of("minecraft:pottery_shard_archer", "minecraft:archer_pottery_shard", "minecraft:pottery_shard_prize", "minecraft:prize_pottery_shard", "minecraft:pottery_shard_arms_up", "minecraft:arms_up_pottery_shard", "minecraft:pottery_shard_skull", "minecraft:skull_pottery_shard"))));
      var0.addFixer(new AddNewChoices(var190, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
      Schema var191 = var0.addSchema(3439, V3439::new);
      var0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(var191, "Updated sign text format for Signs", "minecraft:sign"));
      Schema var192 = var0.addSchema(3439, 1, V3439_1::new);
      var0.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(var192, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema var193 = var0.addSchema(3440, SAME_NAMESPACED);
      var0.addFixer(new NamespacedTypeRenameFix(var193, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
      var0.addFixer(new FeatureFlagRemoveFix(var193, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema var194 = var0.addSchema(3447, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var194, "Pottery shard item renaming to Pottery sherd", createRenamer((Map)Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), (var0x) -> var0x.replace("_pottery_shard", "_pottery_sherd"))))));
      Schema var195 = var0.addSchema(3448, V3448::new);
      var0.addFixer(new DecoratedPotFieldRenameFix(var195));
      Schema var196 = var0.addSchema(3450, SAME_NAMESPACED);
      var0.addFixer(new RemapChunkStatusFix(var196, "Remove liquid_carvers and heightmap chunk statuses", createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
      Schema var197 = var0.addSchema(3451, SAME_NAMESPACED);
      var0.addFixer(new ChunkDeleteLightFix(var197));
      Schema var198 = var0.addSchema(3459, SAME_NAMESPACED);
      var0.addFixer(new LegacyDragonFightFix(var198));
      Schema var199 = var0.addSchema(3564, SAME_NAMESPACED);
      var0.addFixer(new DropInvalidSignDataFix(var199, "minecraft:sign"));
      Schema var200 = var0.addSchema(3564, 1, SAME_NAMESPACED);
      var0.addFixer(new DropInvalidSignDataFix(var200, "minecraft:hanging_sign"));
      Schema var201 = var0.addSchema(3565, SAME_NAMESPACED);
      var0.addFixer(new RandomSequenceSettingsFix(var201));
      Schema var202 = var0.addSchema(3566, SAME_NAMESPACED);
      var0.addFixer(new ScoreboardDisplaySlotFix(var202));
      Schema var203 = var0.addSchema(3568, SAME_NAMESPACED);
      var0.addFixer(new MobEffectIdFix(var203));
      Schema var204 = var0.addSchema(3682, V3682::new);
      var0.addFixer(new AddNewChoices(var204, "Added Crafter", References.BLOCK_ENTITY));
      Schema var205 = var0.addSchema(3683, V3683::new);
      var0.addFixer(new PrimedTntBlockStateFixer(var205));
      Schema var206 = var0.addSchema(3685, V3685::new);
      var0.addFixer(new FixProjectileStoredItem(var206));
      Schema var207 = var0.addSchema(3689, V3689::new);
      var0.addFixer(new AddNewChoices(var207, "Added Breeze", References.ENTITY));
      var0.addFixer(new AddNewChoices(var207, "Added Trial Spawner", References.BLOCK_ENTITY));
      Schema var208 = var0.addSchema(3692, SAME_NAMESPACED);
      UnaryOperator var209 = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
      var0.addFixer(BlockRenameFix.create(var208, "Rename grass block to short_grass", var209));
      var0.addFixer(ItemRenameFix.create(var208, "Rename grass item to short_grass", var209));
      Schema var210 = var0.addSchema(3799, V3799::new);
      var0.addFixer(new AddNewChoices(var210, "Added Armadillo", References.ENTITY));
      Schema var211 = var0.addSchema(3800, SAME_NAMESPACED);
      UnaryOperator var212 = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      var0.addFixer(ItemRenameFix.create(var211, "Rename scute item to turtle_scute", var212));
      Schema var213 = var0.addSchema(3803, SAME_NAMESPACED);
      var0.addFixer(new RenameEnchantmentsFix(var213, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema var214 = var0.addSchema(3807, V3807::new);
      var0.addFixer(new AddNewChoices(var214, "Added Vault", References.BLOCK_ENTITY));
      Schema var215 = var0.addSchema(3807, 1, SAME_NAMESPACED);
      var0.addFixer(new MapBannerBlockPosFormatFix(var215));
      Schema var216 = var0.addSchema(3808, V3808::new);
      var0.addFixer(new HorseBodyArmorItemFix(var216, "minecraft:horse", "ArmorItem", true));
      Schema var217 = var0.addSchema(3808, 1, V3808_1::new);
      var0.addFixer(new HorseBodyArmorItemFix(var217, "minecraft:llama", "DecorItem", false));
      Schema var218 = var0.addSchema(3808, 2, V3808_2::new);
      var0.addFixer(new HorseBodyArmorItemFix(var218, "minecraft:trader_llama", "DecorItem", false));
      Schema var219 = var0.addSchema(3809, SAME_NAMESPACED);
      var0.addFixer(new ChestedHorsesInventoryZeroIndexingFix(var219));
      Schema var220 = var0.addSchema(3812, SAME_NAMESPACED);
      var0.addFixer(new FixWolfHealth(var220));
      Schema var221 = var0.addSchema(3813, V3813::new);
      var0.addFixer(new BlockPosFormatAndRenamesFix(var221));
      Schema var222 = var0.addSchema(3814, SAME_NAMESPACED);
      var0.addFixer(new AttributesRenameLegacy(var222, "Rename jump strength attribute", createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
      Schema var223 = var0.addSchema(3816, V3816::new);
      var0.addFixer(new AddNewChoices(var223, "Added Bogged", References.ENTITY));
      Schema var224 = var0.addSchema(3818, V3818::new);
      var0.addFixer(new BeehiveFieldRenameFix(var224));
      var0.addFixer(new EmptyItemInHotbarFix(var224));
      Schema var225 = var0.addSchema(3818, 1, SAME_NAMESPACED);
      var0.addFixer(new BannerPatternFormatFix(var225));
      Schema var226 = var0.addSchema(3818, 2, SAME_NAMESPACED);
      var0.addFixer(new TippedArrowPotionToItemFix(var226));
      Schema var227 = var0.addSchema(3818, 3, V3818_3::new);
      var0.addFixer(new WriteAndReadFix(var227, "Inject data component types", References.DATA_COMPONENTS));
      Schema var228 = var0.addSchema(3818, 4, V3818_4::new);
      var0.addFixer(new ParticleUnflatteningFix(var228));
      Schema var229 = var0.addSchema(3818, 5, V3818_5::new);
      var0.addFixer(new ItemStackComponentizationFix(var229));
      Schema var230 = var0.addSchema(3818, 6, SAME_NAMESPACED);
      var0.addFixer(new AreaEffectCloudPotionFix(var230));
      Schema var231 = var0.addSchema(3820, SAME_NAMESPACED);
      var0.addFixer(new PlayerHeadBlockProfileFix(var231));
      var0.addFixer(new LodestoneCompassComponentFix(var231));
      Schema var232 = var0.addSchema(3825, V3825::new);
      var0.addFixer(new ItemStackCustomNameToOverrideComponentFix(var232));
      var0.addFixer(new BannerEntityCustomNameToOverrideComponentFix(var232));
      var0.addFixer(new TrialSpawnerConfigFix(var232));
      var0.addFixer(new AddNewChoices(var232, "Added Ominous Item Spawner", References.ENTITY));
      Schema var233 = var0.addSchema(3828, SAME_NAMESPACED);
      var0.addFixer(new EmptyItemInVillagerTradeFix(var233));
      Schema var234 = var0.addSchema(3833, SAME_NAMESPACED);
      var0.addFixer(new RemoveEmptyItemInBrushableBlockFix(var234));
      Schema var235 = var0.addSchema(3938, V3938::new);
      var0.addFixer(new ProjectileStoredWeaponFix(var235));
      Schema var236 = var0.addSchema(3939, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var236, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema var237 = var0.addSchema(3943, SAME_NAMESPACED);
      var0.addFixer(new OptionsMenuBlurrinessFix(var237));
      Schema var238 = var0.addSchema(3945, SAME_NAMESPACED);
      var0.addFixer(new AttributeModifierIdFix(var238));
      var0.addFixer(new JukeboxTicksSinceSongStartedFix(var238));
      Schema var239 = var0.addSchema(4054, SAME_NAMESPACED);
      var0.addFixer(new OminousBannerRarityFix(var239));
      Schema var240 = var0.addSchema(4055, SAME_NAMESPACED);
      var0.addFixer(new AttributeIdPrefixFix(var240));
      Schema var241 = var0.addSchema(4057, SAME_NAMESPACED);
      var0.addFixer(new CarvingStepRemoveFix(var241));
      Schema var242 = var0.addSchema(4059, V4059::new);
      var0.addFixer(new FoodToConsumableFix(var242));
      Schema var243 = var0.addSchema(4061, SAME_NAMESPACED);
      var0.addFixer(new TrialSpawnerConfigInRegistryFix(var243));
      Schema var244 = var0.addSchema(4064, SAME_NAMESPACED);
      var0.addFixer(new FireResistantToDamageResistantComponentFix(var244));
      Schema var245 = var0.addSchema(4067, V4067::new);
      var0.addFixer(new BoatSplitFix(var245));
      var0.addFixer(new FeatureFlagRemoveFix(var245, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema var246 = var0.addSchema(4068, SAME_NAMESPACED);
      var0.addFixer(new LockComponentPredicateFix(var246));
      var0.addFixer(new ContainerBlockEntityLockPredicateFix(var246));
      Schema var247 = var0.addSchema(4070, V4070::new);
      var0.addFixer(new AddNewChoices(var247, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
      Schema var248 = var0.addSchema(4071, V4071::new);
      var0.addFixer(new AddNewChoices(var248, "Added Creaking", References.ENTITY));
      var0.addFixer(new AddNewChoices(var248, "Added Creaking Heart", References.BLOCK_ENTITY));
      Schema var249 = var0.addSchema(4081, SAME_NAMESPACED);
      var0.addFixer(new EntitySalmonSizeFix(var249));
      Schema var250 = var0.addSchema(4173, SAME_NAMESPACED);
      var0.addFixer(new EntityFieldsRenameFix(var250, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema var251 = var0.addSchema(4175, SAME_NAMESPACED);
      var0.addFixer(new EquippableAssetRenameFix(var251));
      var0.addFixer(new CustomModelDataExpandFix(var251));
      Schema var252 = var0.addSchema(4176, SAME_NAMESPACED);
      var0.addFixer(new InvalidBlockEntityLockFix(var252));
      var0.addFixer(new InvalidLockComponentFix(var252));
      Schema var253 = var0.addSchema(4180, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var253, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema var254 = var0.addSchema(4181, SAME_NAMESPACED);
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var254, "minecraft:furnace"));
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var254, "minecraft:smoker"));
      var0.addFixer(new BlockEntityFurnaceBurnTimeFix(var254, "minecraft:blast_furnace"));
      Schema var255 = var0.addSchema(4187, SAME_NAMESPACED);
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (var0x) -> var0x == 48.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (var0x) -> var0x == 40.0 ? 16.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (var0x) -> var0x == 16.0 ? 12.0 : var0x));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (var0x) -> var0x == 16.0 ? 24.0 : var0x));
      Schema var256 = var0.addSchema(4290, V4290::new);
      var0.addFixer(new UnflattenTextComponentFix(var256));
      Schema var257 = var0.addSchema(4291, SAME_NAMESPACED);
      var0.addFixer(new LegacyHoverEventFix(var257));
      var0.addFixer(new TextComponentStringifiedFlagsFix(var257));
      Schema var258 = var0.addSchema(4292, V4292::new);
      var0.addFixer(new TextComponentHoverAndClickEventFix(var258));
      Schema var259 = var0.addSchema(4293, SAME_NAMESPACED);
      var0.addFixer(new DropChancesFormatFix(var259));
      Schema var260 = var0.addSchema(4294, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var260, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (var0x) -> var0x.equals("true") ? "awake" : "uprooted"));
      Schema var261 = var0.addSchema(4295, SAME_NAMESPACED);
      var0.addFixer(new BlendingDataFix(var261));
      Schema var262 = var0.addSchema(4296, SAME_NAMESPACED);
      var0.addFixer(new AreaEffectCloudDurationScaleFix(var262));
      Schema var263 = var0.addSchema(4297, SAME_NAMESPACED);
      var0.addFixer(new ForcedChunkToTicketFix(var263));
      Schema var264 = var0.addSchema(4299, SAME_NAMESPACED);
      var0.addFixer(new EntitySpawnerItemVariantComponentFix(var264));
      Schema var265 = var0.addSchema(4300, V4300::new);
      var0.addFixer(new SaddleEquipmentSlotFix(var265));
      Schema var266 = var0.addSchema(4301, V4301::new);
      var0.addFixer(new EquipmentFormatFix(var266));
      Schema var267 = var0.addSchema(4302, V4302::new);
      var0.addFixer(new AddNewChoices(var267, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
      Schema var268 = var0.addSchema(4303, SAME_NAMESPACED);
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var268, References.ENTITY));
      var0.addFixer(new EntityFallDistanceFloatToDoubleFix(var268, References.PLAYER));
      Schema var269 = var0.addSchema(4305, SAME_NAMESPACED);
      var0.addFixer(new BlockPropertyRenameAndFix(var269, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (var0x) -> var0x));
      Schema var270 = var0.addSchema(4306, V4306::new);
      var0.addFixer(new ThrownPotionSplitFix(var270));
      Schema var271 = var0.addSchema(4307, V4307::new);
      var0.addFixer(new TooltipDisplayComponentFix(var271));
      Schema var272 = var0.addSchema(4309, SAME_NAMESPACED);
      var0.addFixer(new RaidRenamesDataFix(var272));
      var0.addFixer(new ChunkTicketUnpackPosFix(var272));
      Schema var273 = var0.addSchema(4311, SAME_NAMESPACED);
      var0.addFixer(new AdvancementsRenameFix(var273, false, "Use lodestone category change", createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
      Schema var274 = var0.addSchema(4312, V4312::new);
      var0.addFixer(new PlayerEquipmentFix(var274));
      Schema var275 = var0.addSchema(4314, SAME_NAMESPACED);
      var0.addFixer(new InlineBlockPosFormatFix(var275));
      Schema var276 = var0.addSchema(4420, V4420::new);
      var0.addFixer(new NamedEntityConvertUncheckedFix(var276, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
      Schema var277 = var0.addSchema(4421, V4421::new);
      var0.addFixer(new AddNewChoices(var277, "Added Happy Ghast", References.ENTITY));
      Schema var278 = var0.addSchema(4424, SAME_NAMESPACED);
      var0.addFixer(new FeatureFlagRemoveFix(var278, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
      var0.addFixer(new AddFieldFix(var278, References.PLAYER, "style", (var0x) -> var0x.createString("minecraft:default"), new String[]{"locator_bar_icon"}));
      var0.addFixer(new AddFieldFix(var278, References.ENTITY, "style", (var0x) -> var0x.createString("minecraft:default"), new String[]{"locator_bar_icon"}));
      Schema var279 = var0.addSchema(4531, V4531::new);
      var0.addFixer(new AddNewChoices(var279, "Added Copper Golem", References.ENTITY));
      Schema var280 = var0.addSchema(4532, V4532::new);
      var0.addFixer(new AddNewChoices(var280, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
      Schema var281 = var0.addSchema(4533, V4533::new);
      var0.addFixer(new AddNewChoices(var281, "Added Shelf", References.BLOCK_ENTITY));
      Schema var282 = var0.addSchema(4535, SAME_NAMESPACED);
      var0.addFixer(new CopperGolemWeatherStateFix(var282));
      Schema var283 = var0.addSchema(4537, SAME_NAMESPACED);
      var0.addFixer(new ChunkDeleteLightFix(var283));
      Schema var284 = var0.addSchema(4541, SAME_NAMESPACED);
      var0.addFixer(BlockRenameFix.create(var284, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
      var0.addFixer(ItemRenameFix.create(var284, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
      Schema var285 = var0.addSchema(4543, V4543::new);
      var0.addFixer(new AddNewChoices(var285, "Added Mannequin", References.ENTITY));
      Schema var286 = var0.addSchema(4544, SAME_NAMESPACED);
      var0.addFixer(new LegacyWorldBorderFix(var286));
      Schema var287 = var0.addSchema(4548, SAME_NAMESPACED);
      var0.addFixer(new WorldSpawnDataFix(var287));
      var0.addFixer(new PlayerRespawnDataFix(var287));
      Schema var288 = var0.addSchema(4648, V4648::new);
      var0.addFixer(new AddNewChoices(var288, "Added Nautilus and Zombie Nautilus", References.ENTITY));
      Schema var289 = var0.addSchema(4649, SAME_NAMESPACED);
      var0.addFixer(new TridentAnimationFix(var289));
      Schema var290 = var0.addSchema(4650, SAME_NAMESPACED);
      var0.addFixer(new DebugProfileOverlayReferenceFix(var290));
      Schema var291 = var0.addSchema(4651, SAME_NAMESPACED);
      var0.addFixer(new OptionsGraphicsModeSplitFix(var291, "cutoutLeaves", "false", "true", "true"));
      var0.addFixer(new OptionsGraphicsModeSplitFix(var291, "weatherRadius", "5", "10", "10"));
