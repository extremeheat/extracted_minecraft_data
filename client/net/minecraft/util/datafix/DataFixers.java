...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(BlockRenameFixWithJigsaw.create(var139, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      ...
      var0.addFixer(new StatsRenameFix(var144, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
      Schema var145 = var0.addSchema(2717, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var145, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      var0.addFixer(BlockRenameFix.create(var145, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
