...
public class FileZipper implements Closeable {
   ...
   // $FF: renamed from: fs java.nio.file.FileSystem
   private final FileSystem field_386;
   ...
   public FileZipper(Path var1) {
      ...
      try {
         this.field_386 = Util.ZIP_FILE_SYSTEM_PROVIDER.newFileSystem(this.tempFile, ImmutableMap.of("create", "true"));
   ...
   public void add(Path var1, String var2) {
      try {
         Path var3 = this.field_386.getPath(File.separator);
   ...
   public void add(Path var1) {
      try {
         Path var2 = this.field_386.getPath(File.separator);
