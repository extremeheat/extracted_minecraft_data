...
public class Vec3i implements Comparable<Vec3i> {
   ...
   public double func_185332_f(int var1, int var2, int var3) {
      double var4 = (double)(this.func_177958_n() - var1);
      double var6 = (double)(this.func_177956_o() - var2);
      double var8 = (double)(this.func_177952_p() - var3);
      return Math.sqrt(var4 * var4 + var6 * var6 + var8 * var8);
   }

   public double func_196233_m(Vec3i var1) {
      return this.func_185332_f(var1.func_177958_n(), var1.func_177956_o(), var1.func_177952_p());
   }
