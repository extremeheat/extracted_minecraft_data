...
public class MathHelper {
   ...
   private static final float[] field_76144_a = (float[])Util.func_200696_a(new float[65536], (var0x) -> {
   ...
   public static int func_207806_e(double var0) {
   ...
   public static float func_188207_b(float var0, float var1) {
      return (var0 % var1 + var1) % var1;
   }

   public static double func_191273_b(double var0, double var2) {
   ...
   public static int func_188209_b(int var0) {
      var0 %= 360;
      if (var0 >= 180) {
         var0 -= 360;
      }
   ...
   public static float func_203302_c(float var0, float var1) {
      float var2 = func_76142_g(var0 - var1);
      return var2 < 180.0F ? var2 : var2 - 360.0F;
   }

   public static float func_203301_d(float var0, float var1) {
      float var2 = func_76142_g(var0 - var1);
      return var2 < 180.0F ? func_76135_e(var2) : func_76135_e(var2 - 360.0F);
   }

   public static float func_203300_b(float var0, float var1, float var2) {
      var2 = func_76135_e(var2);
      return var0 < var1 ? func_76131_a(var0 + var2, var0, var1) : func_76131_a(var0 - var2, var1, var0);
   }

   public static float func_203303_c(float var0, float var1, float var2) {
      float var3 = func_203302_c(var1, var0);
      return func_203300_b(var0, var0 + var3, var2);
   }
   ...
   public static double func_207805_a(String var0, double var1) {
      try {
   ...
   public static double func_207804_a(String var0, double var1, double var3) {
      return Math.max(var3, func_207805_a(var0, var1));
   }
