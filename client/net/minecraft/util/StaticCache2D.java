...
public class StaticCache2D<T> {
   ...
   public static <T> StaticCache2D<T> create(int var0, int var1, int var2, StaticCache2D.Initializer<T> var3) {
      int var4 = var0 - var2;
      int var5 = var1 - var2;
      int var6 = 2 * var2 + 1;
   ...
   private StaticCache2D(int var1, int var2, int var3, int var4, StaticCache2D.Initializer<T> var5) {
      super();
      this.minX = var1;
      this.minZ = var2;
      this.sizeX = var3;
   ...
   public T get(int var1, int var2) {
      if (!this.contains(var1, var2)) {
         throw new IllegalArgumentException("Requested out of range value (" + var1 + "," + var2 + ") from " + this);
      } else {
