...
public class HoverEvent {
   ...
   public static enum Action {
      ...
      private static final Map<String, HoverEvent.Action> field_150690_d = (Map)Arrays.stream(values()).collect(Collectors.toMap(HoverEvent.Action::func_150685_b, (var0) -> {
         return var0;
      }));
