...
public class ScreenShotHelper {
   ...
   public static IChatComponent func_148260_a(File var0, int var1, int var2, Framebuffer var3) {
      return func_148259_a(var0, null, var1, var2, var3);
   }
   ...
   public static IChatComponent func_148259_a(File var0, String var1, int var2, int var3, Framebuffer var4) {
      try {
         ...
         if (OpenGlHelper.func_148822_b()) {
            GL11.glBindTexture(3553, var4.field_147617_g);
         ...
         File var13;
         if (var1 == null) {
            var13 = func_74290_a(var5);
         } else {
            var13 = new File(var5, var1);
         }

         ImageIO.write(var7, "png", var13);
         ChatComponentText var14 = new ChatComponentText(var13.getName());
         var14.func_150256_b().func_150241_a(new ClickEvent(ClickEvent$Action.OPEN_FILE, var13.getAbsolutePath()));
         var14.func_150256_b().func_150228_d(true);
         return new ChatComponentTranslation("screenshot.success", var14);
