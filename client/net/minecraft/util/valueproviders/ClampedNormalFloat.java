...
public class ClampedNormalFloat extends FloatProvider {
   ...
   // $FF: renamed from: of (float, float, float, float) net.minecraft.util.valueproviders.ClampedNormalFloat
   public static ClampedNormalFloat method_20(float var0, float var1, float var2, float var3) {
