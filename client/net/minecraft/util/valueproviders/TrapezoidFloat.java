...
public class TrapezoidFloat extends FloatProvider {
   ...
   // $FF: renamed from: of (float, float, float) net.minecraft.util.valueproviders.TrapezoidFloat
   public static TrapezoidFloat method_17(float var0, float var1, float var2) {
