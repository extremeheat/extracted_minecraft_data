...
public class ClampedInt extends IntProvider {
   ...
   // $FF: renamed from: of (net.minecraft.util.valueproviders.IntProvider, int, int) net.minecraft.util.valueproviders.ClampedInt
   public static ClampedInt method_47(IntProvider var0, int var1, int var2) {
