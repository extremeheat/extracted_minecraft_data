...
public class ClampedNormalInt extends IntProvider {
   public static final Codec<ClampedNormalInt> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(Codec.FLOAT.fieldOf("mean").forGetter((var0x) -> {
         ...
         return var0x.min_inclusive;
      }), Codec.INT.fieldOf("max_inclusive").forGetter((var0x) -> {
         return var0x.max_inclusive;
      })).apply(var0, ClampedNormalInt::new);
   }).comapFlatMap((var0) -> {
      return var0.max_inclusive < var0.min_inclusive ? DataResult.error("Max must be larger than min: [" + var0.min_inclusive + ", " + var0.max_inclusive + "]") : DataResult.success(var0);
   }, Function.identity());
   private float mean;
   ...
   // $FF: renamed from: of (float, float, int, int) net.minecraft.util.valueproviders.ClampedNormalInt
   public static ClampedNormalInt method_48(float var0, float var1, int var2, int var3) {
   ...
   public static int sample(Random var0, float var1, float var2, float var3, float var4) {
