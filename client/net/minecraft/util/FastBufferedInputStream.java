...
public class FastBufferedInputStream extends InputStream {
   ...
   private final InputStream field_375;
   ...
   public int read(byte[] var1, int var2, int var3) throws IOException {
      ...
      if (var4 <= 0) {
         if (var3 >= this.buffer.length) {
            return this.field_375.read(var1, var2, var3);
         }
   ...
   public long skip(long var1) throws IOException {
      if (var1 <= 0L) {
         ...
         if (var3 <= 0L) {
            return this.field_375.skip(var1);
         } else {
            if (var1 > var3) {
               var1 = var3;
            }
   ...
   public int available() throws IOException {
      return this.bytesInBuffer() + this.field_375.available();
   }
   ...
   private void fill() throws IOException {
      this.limit = 0;
      this.position = 0;
      int var1 = this.field_375.read(this.buffer, 0, this.buffer.length);
      if (var1 > 0) {
         this.limit = var1;
      }
