...
public class EnchantmentNameParts {
   ...
   public String func_148334_a(FontRenderer var1, int var2) {
      int var3 = this.field_148336_b.nextInt(2) + 3;
      String var4 = "";
      ...
      for(int var5 = 0; var5 < var3; ++var5) {
         ...
         var4 = var4 + this.field_148337_c[this.field_148336_b.nextInt(this.field_148337_c.length)];
      }

      List var6 = var1.func_78271_c(var4, var2);
      return org.apache.commons.lang3.StringUtils.join(var6.size() >= 2 ? var6.subList(0, 2) : var6, " ");
   }

   public void func_148335_a(long var1) {
      this.field_148336_b.setSeed(var1);
   }
}
