...
public record JfrStatsResult(Instant a, Instant b, Duration c, @Nullable Duration d, List<TickTimeStat> e, List<CpuLoadStat> f, GcHeapStat.Summary g, ThreadAllocationStat.Summary h, NetworkPacketSummary i, NetworkPacketSummary j, FileIOStat.Summary k, FileIOStat.Summary l, List<ChunkGenStat> m) {
   ...
   public JfrStatsResult(Instant var1, Instant var2, Duration var3, @Nullable Duration var4, List<TickTimeStat> var5, List<CpuLoadStat> var6, GcHeapStat.Summary var7, ThreadAllocationStat.Summary var8, NetworkPacketSummary var9, NetworkPacketSummary var10, FileIOStat.Summary var11, FileIOStat.Summary var12, List<ChunkGenStat> var13) {
      super();
