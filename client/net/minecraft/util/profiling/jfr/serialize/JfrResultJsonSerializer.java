   ...
   private JsonElement chunkGen(List<Pair<ChunkStatus, TimedStatSummary<ChunkGenStat>>> var1) {
      ...
      while(var4.hasNext()) {
         ...
         Function var9 = (var0) -> {
            ...
            var1.addProperty("chunkPosX", var0.chunkPos().field_504);
            var1.addProperty("chunkPosZ", var0.chunkPos().field_505);
            var1.addProperty("worldPosX", var0.worldPos().field_143);
            var1.addProperty("worldPosZ", var0.worldPos().field_144);
            return var1;
         };
   ...
   private JsonElement serverTicks(List<TickTimeStat> var1) {
      if (var1.isEmpty()) {
         ...
         double[] var3 = var1.stream().mapToDouble((var0) -> {
            return (double)var0.currentAverage().toNanos() / 1000000.0D;
         }).toArray();
