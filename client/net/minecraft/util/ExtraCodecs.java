...
public class ExtraCodecs {
   ...
   public static final PrimitiveCodec<Character> CHAR = new PrimitiveCodec<Character>() {
      public <T> DataResult<Character> read(DynamicOps<T> var1, T var2) {
         return var1.getStringValue(var2).map(var0 -> var0.charAt(0));
      }

      public <T> T write(DynamicOps<T> var1, Character var2) {
         return (T)var1.createString(String.valueOf(var2));
      }
