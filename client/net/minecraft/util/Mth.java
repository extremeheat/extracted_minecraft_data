...
public class Mth {
   ...
   public static double[] cumulativeSum(double... var0) {
      ...
      for(var8 = 0; var8 < var0.length; ++var8) {
         var0[var8] += var8 == 0 ? 0.0 : var0[var8 - 1];
      }
   ...
   public static double[] binBiModalNormalDistribution(double var0, double var2, double var4, double var6, double var8, double var10, int var12, int var13) {
      ...
      for(int var16 = var12; var16 <= var13; ++var16) {
         var14[var15] = Math.max(0.0, var0 * StrictMath.exp(-((double)var16 - var4) * ((double)var16 - var4) / (2.0 * var2 * var2)) + var6 * StrictMath.exp(-((double)var16 - var10) * ((double)var16 - var10) / (2.0 * var8 * var8)));
         ++var15;
      }
