...
public class Mth {
   ...
   public static final float field_10 = 3.1415927F;
   ...
   public static Vec3 catmullRomSplinePos(Vec3 var0, Vec3 var1, Vec3 var2, Vec3 var3, double var4) {
      ...
      return new Vec3(var0.field_414 * var6 + var1.field_414 * var8 + var2.field_414 * var10 + var3.field_414 * var12, var0.field_415 * var6 + var1.field_415 * var8 + var2.field_415 * var10 + var3.field_415 * var12, var0.field_416 * var6 + var1.field_416 * var8 + var2.field_416 * var10 + var3.field_416 * var12);
   }
   ...
   public static boolean rayIntersectsAABB(Vec3 var0, Vec3 var1, AABB var2) {
      ...
      double var7 = var0.field_414 - var3;
      if (Math.abs(var7) > var5 && var7 * var1.field_414 >= 0.0D) {
         return false;
      } else {
         double var9 = (var2.minY + var2.maxY) * 0.5D;
         double var11 = (var2.maxY - var2.minY) * 0.5D;
         double var13 = var0.field_415 - var9;
         if (Math.abs(var13) > var11 && var13 * var1.field_415 >= 0.0D) {
            return false;
         } else {
            double var15 = (var2.minZ + var2.maxZ) * 0.5D;
            double var17 = (var2.maxZ - var2.minZ) * 0.5D;
            double var19 = var0.field_416 - var15;
            if (Math.abs(var19) > var17 && var19 * var1.field_416 >= 0.0D) {
               return false;
            } else {
               double var21 = Math.abs(var1.field_414);
               double var23 = Math.abs(var1.field_415);
               double var25 = Math.abs(var1.field_416);
               double var27 = var1.field_415 * var19 - var1.field_416 * var13;
               if (Math.abs(var27) > var11 * var25 + var17 * var23) {
                  return false;
               } else {
                  var27 = var1.field_416 * var7 - var1.field_414 * var19;
                  if (Math.abs(var27) > var5 * var25 + var17 * var21) {
                     return false;
                  } else {
                     var27 = var1.field_414 * var13 - var1.field_415 * var7;
