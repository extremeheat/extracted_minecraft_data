...
public class DamageSource {
   ...
   public static DamageSource func_76362_a(EntityFireball var0, Entity var1) {
      return var1 == null
         ? new EntityDamageSourceIndirect("onFire", var0, var0).func_76361_j().func_76349_b()
         : new EntityDamageSourceIndirect("fireball", var0, var1).func_76361_j().func_76349_b();
   }
   ...
   public static DamageSource func_92087_a(Entity var0) {
      return new EntityDamageSource("thorns", var0).func_82726_p();
   }

   public static DamageSource func_94539_a(Explosion var0) {
      return var0 != null && var0.func_94613_c() != null
         ? new EntityDamageSource("explosion.player", var0.func_94613_c()).func_76351_m().func_94540_d()
         : new DamageSource("explosion").func_76351_m().func_94540_d();
   }
   ...
   public IChatComponent func_151519_b(EntityLivingBase var1) {
      ...
      return var2 != null && StatCollector.func_94522_b(var4)
         ? new ChatComponentTranslation(var4, var1.func_145748_c_(), var2.func_145748_c_())
         : new ChatComponentTranslation(var3, var1.func_145748_c_());
   }
