...
public class DamageSource {
   ...
   public static DamageSource func_188403_a(Entity var0, EntityLivingBase var1) {
   ...
   public static DamageSource func_76353_a(EntityArrow var0, @Nullable Entity var1) {
      return (new EntityDamageSourceIndirect("arrow", var0, var1)).func_76349_b();
   }

   public static DamageSource func_203096_a(Entity var0, @Nullable Entity var1) {
      return (new EntityDamageSourceIndirect("trident", var0, var1)).func_76349_b();
   }

   public static DamageSource func_76362_a(EntityFireball var0, @Nullable Entity var1) {
   ...
   public static DamageSource func_76356_a(Entity var0, @Nullable Entity var1) {
      return (new EntityDamageSourceIndirect("thrown", var0, var1)).func_76349_b();
   }

   public static DamageSource func_76354_b(Entity var0, @Nullable Entity var1) {
   ...
   public static DamageSource func_94539_a(@Nullable Explosion var0) {
   ...
   public static DamageSource func_188405_b(@Nullable EntityLivingBase var0) {
      return var0 != null ? (new EntityDamageSource("explosion.player", var0)).func_76351_m().func_94540_d() : (new DamageSource("explosion")).func_76351_m().func_94540_d();
   }
   ...
   public ITextComponent func_151519_b(EntityLivingBase var1) {
      ...
      return var2 != null ? new TextComponentTranslation(var4, new Object[]{var1.func_145748_c_(), var2.func_145748_c_()}) : new TextComponentTranslation(var3, new Object[]{var1.func_145748_c_()});
   }
