...
public enum FrontAndTop implements StringRepresentable {
   ...
   UP_EAST("up_east", Direction.field_526, Direction.EAST),
   UP_NORTH("up_north", Direction.field_526, Direction.NORTH),
   UP_SOUTH("up_south", Direction.field_526, Direction.SOUTH),
   UP_WEST("up_west", Direction.field_526, Direction.WEST),
   WEST_UP("west_up", Direction.WEST, Direction.field_526),
   EAST_UP("east_up", Direction.EAST, Direction.field_526),
   NORTH_UP("north_up", Direction.NORTH, Direction.field_526),
   SOUTH_UP("south_up", Direction.SOUTH, Direction.field_526);
