...
public class DustColorTransitionOptions extends DustParticleOptionsBase {
   ...
   public void writeToNetwork(FriendlyByteBuf var1) {
      ...
      var1.writeFloat(this.toColor.method_82());
      var1.writeFloat(this.toColor.method_83());
      var1.writeFloat(this.toColor.method_84());
   }

   public String writeToString() {
      return String.format(Locale.ROOT, "%s %.2f %.2f %.2f %.2f %.2f %.2f %.2f", Registry.PARTICLE_TYPE.getKey(this.getType()), this.color.method_82(), this.color.method_83(), this.color.method_84(), this.scale, this.toColor.method_82(), this.toColor.method_83(), this.toColor.method_84());
   }
