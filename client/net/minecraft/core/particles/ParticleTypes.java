...
public class ParticleTypes {
   ...
   private static <T extends ParticleOptions> ParticleType<T> register(String var0, boolean var1, ParticleOptions.Deserializer<T> var2, final Function<ParticleType<T>, Codec<T>> var3) {
      return (ParticleType)Registry.register(Registry.PARTICLE_TYPE, (String)var0, new ParticleType<T>(var1, var2) {
   ...
   static {
      BLOCK = register("block", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::codec);
      BLOCK_MARKER = register("block_marker", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::codec);
      ...
      FALLING_DUST = register("falling_dust", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::codec);
      ...
      ITEM = register("item", false, ItemParticleOption.DESERIALIZER, ItemParticleOption::codec);
