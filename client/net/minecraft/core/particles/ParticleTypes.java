...
public class ParticleTypes {
   ...
   public static final ParticleType<DustParticleOptions> DUST = register("dust", false, DustParticleOptions.DESERIALIZER, var0 -> DustParticleOptions.CODEC);
   public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register(
      "dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, var0 -> DustColorTransitionOptions.CODEC
   );
   ...
   public static final SimpleParticleType DRIPPING_CHERRY_LEAVES = register("dripping_cherry_leaves", false);
   public static final SimpleParticleType FALLING_CHERRY_LEAVES = register("falling_cherry_leaves", false);
   public static final SimpleParticleType LANDING_CHERRY_LEAVES = register("landing_cherry_leaves", false);
   ...
   public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register(
      "sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, var0 -> SculkChargeParticleOptions.CODEC
   );
   ...
   public static final ParticleType<VibrationParticleOption> VIBRATION = register(
      "vibration", true, VibrationParticleOption.DESERIALIZER, var0 -> VibrationParticleOption.CODEC
   );
   ...
   public static final ParticleType<ShriekParticleOption> SHRIEK = register(
      "shriek", false, ShriekParticleOption.DESERIALIZER, var0 -> ShriekParticleOption.CODEC
   );
   ...
   private static SimpleParticleType register(String var0, boolean var1) {
      return Registry.register(BuiltInRegistries.PARTICLE_TYPE, var0, new SimpleParticleType(var1));
   }

   private static <T extends ParticleOptions> ParticleType<T> register(
      String var0, boolean var1, ParticleOptions.Deserializer<T> var2, final Function<ParticleType<T>, Codec<T>> var3
   ) {
      return Registry.register(BuiltInRegistries.PARTICLE_TYPE, var0, new ParticleType<T>(var1, var2) {
         @Override
