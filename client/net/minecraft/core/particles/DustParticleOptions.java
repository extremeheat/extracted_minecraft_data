...
public class DustParticleOptions extends ScalableParticleOptionsBase {
   ...
   public static final MapCodec<DustParticleOptions> CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(ExtraCodecs.RGB_COLOR_CODEC.fieldOf("color").forGetter((o) -> o.color), SCALE.fieldOf("scale").forGetter(ScalableParticleOptionsBase::getScale)).apply(i, DustParticleOptions::new));
