...
public class ProjectileDispenseBehavior extends DefaultDispenseItemBehavior {
   ...
   public ProjectileDispenseBehavior(Item var1) {
      ...
      if (var1 instanceof ProjectileItem var2) {
         this.projectileItem = (ProjectileItem)var2;
         this.dispenseConfig = ((ProjectileItem)var2).createDispenseConfig();
      } else {
   ...
   public ItemStack execute(BlockSource var1, ItemStack var2) {
      ...
      this.projectileItem
         .shoot(var6, (double)var4.getStepX(), (double)var4.getStepY(), (double)var4.getStepZ(), this.dispenseConfig.power(), this.dispenseConfig.uncertainty());
