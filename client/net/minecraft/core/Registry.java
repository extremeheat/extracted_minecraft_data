...
public abstract class Registry<T> implements Keyable, IdMap<T> {
   ...
   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> var0, String var1, Function<T, Holder.Reference<T>> var2, RegistryBootstrap<T> var3) {
   ...
   private static <T> Registry<T> registerSimple(ResourceKey<? extends Registry<T>> var0, Lifecycle var1, Function<T, Holder.Reference<T>> var2, RegistryBootstrap<T> var3) {
      return internalRegister(var0, new MappedRegistry(var0, var1, var2), var3, var1);
   }

   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> var0, String var1, Lifecycle var2, RegistryBootstrap<T> var3) {
      return (DefaultedRegistry)internalRegister(var0, new DefaultedRegistry(var1, var0, var2, (Function)null), var3, var2);
   }

   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> var0, String var1, Lifecycle var2, Function<T, Holder.Reference<T>> var3, RegistryBootstrap<T> var4) {
