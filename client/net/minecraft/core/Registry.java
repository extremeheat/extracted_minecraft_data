...
public abstract class Registry<T> implements Codec<T>, Keyable, IdMap<T> {
   ...
   public <U> DataResult<Pair<T, U>> decode(DynamicOps<U> var1, U var2) {
      return var1.compressMaps() ? var1.getNumberValue(var2).flatMap((var1x) -> {
         Object var2 = this.byId(var1x.intValue());
         return var2 == null ? DataResult.error("Unknown registry id: " + var1x) : DataResult.success(var2, this.lifecycle(var2));
      }).map((var1x) -> {
         return Pair.of(var1x, var1.empty());
      }) : ResourceLocation.CODEC.decode(var1, var2).flatMap((var1x) -> {
         Object var2 = this.get((ResourceLocation)var1x.getFirst());
         return var2 == null ? DataResult.error("Unknown registry key: " + var1x.getFirst()) : DataResult.success(Pair.of(var2, var1x.getSecond()), this.lifecycle(var2));
      });
   }
