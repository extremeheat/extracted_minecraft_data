...
public class BlockPos extends Vec3i {
   ...
   public BlockPos(Vec3 var1) {
      this(var1.field_414, var1.field_415, var1.field_416);
   }

   public BlockPos(Position var1) {
      this(var1.method_2(), var1.method_3(), var1.method_4());
   }
   ...
   // $FF: renamed from: of (long) net.minecraft.core.BlockPos
   public static BlockPos method_81(long var0) {
   ...
   public BlockPos above() {
      return this.relative(Direction.field_526);
   }
         ...
         return new AbstractIterator<BlockPos>() {
            ...
            protected BlockPos computeNext() {
               if (this.zMirror) {
                  ...
                  for(var1x = null; var1x == null; ++this.field_371) {
                     if (this.field_371 > this.maxY) {
                        ++this.field_370;
                        if (this.field_370 > this.maxX) {
                           ++this.currentDepth;
                           ...
                           this.field_370 = -this.maxX;
                        }

                        this.maxY = Math.min(var3, this.currentDepth - Math.abs(this.field_370));
                        this.field_371 = -this.maxY;
                     }

                     int var2x = this.field_370;
                     int var3x = this.field_371;
   ...
   public static class MutableBlockPos extends BlockPos {
      ...
      public BlockPos.MutableBlockPos set(AxisCycle var1, int var2, int var3, int var4) {
         return this.set(var1.cycle(var2, var3, var4, Direction.Axis.field_500), var1.cycle(var2, var3, var4, Direction.Axis.field_501), var1.cycle(var2, var3, var4, Direction.Axis.field_502));
      }
