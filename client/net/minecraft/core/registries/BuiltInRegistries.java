...
public class BuiltInRegistries {
   ...
   public static final Registry<MapCodec<? extends SurfaceRules.ConditionSource>> MATERIAL_CONDITION_TYPE;
   public static final Registry<MapCodec<? extends SurfaceRules.RuleSource>> MATERIAL_RULE_TYPE;
   ...
   static {
      ...
      ENTITY_TYPE = registerDefaultedWithIntrusiveHolders(Registries.ENTITY_TYPE, "pig", (registry) -> EntityTypes.PIG);
      ...
      BLOCK_ENTITY_TYPE = registerSimpleWithIntrusiveHolders(Registries.BLOCK_ENTITY_TYPE, (registry) -> BlockEntityTypes.FURNACE);
      ...
      LOOT_NUMBER_PROVIDER_TYPE = registerSimple(Registries.LOOT_NUMBER_PROVIDER_TYPE, NumberProviderTypes::bootstrap);
      ...
      MATERIAL_CONDITION_TYPE = registerSimple(Registries.MATERIAL_CONDITION_TYPE, SurfaceRules.ConditionSource::bootstrap);
      MATERIAL_RULE_TYPE = registerSimple(Registries.MATERIAL_RULE_TYPE, SurfaceRules.RuleSource::bootstrap);
