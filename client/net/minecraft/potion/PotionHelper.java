...
public class PotionHelper {
   ...
   private static final String[] field_77926_o = new String[]{
   ...
   public static int func_77911_a(Collection var0) {
      int var1 = 3694022;
   ...
   public static int func_77915_a(int var0, boolean var1) {
      if (!var1) {
         if (field_77925_n.containsKey(var0)) {
            return field_77925_n.get(var0);
         } else {
            int var2 = func_77911_a(func_77917_b(var0, false));
            field_77925_n.put(var0, var2);
            return var2;
         }
      } else {
         return func_77911_a(func_77917_b(var0, var1));
      }
   }
   ...
   private static int func_77912_a(String var0, int var1, int var2, int var3) {
      if (var1 < var0.length() && var2 >= 0 && var1 < var2) {
         ...
         if (var4 >= 0 && var4 < var2) {
            int var17 = func_77912_a(var0, var1, var4 - 1, var3);
            if (var17 > 0) {
               return var17;
            } else {
               int var19 = func_77912_a(var0, var4 + 1, var2, var3);
               return var19 > 0 ? var19 : 0;
            }
         } else {
            int var5 = var0.indexOf(38, var1);
            if (var5 >= 0 && var5 < var2) {
               int var18 = func_77912_a(var0, var1, var5 - 1, var3);
               if (var18 <= 0) {
                  return 0;
               } else {
                  int var20 = func_77912_a(var0, var5 + 1, var2, var3);
                  if (var20 <= 0) {
                     return 0;
                  } else {
   ...
   public static List func_77917_b(int var0, boolean var1) {
      ArrayList var2 = null;

      for(Potion var6 : Potion.field_76425_a) {
         if (var6 != null && (!var6.func_76395_i() || var1)) {
            String var7 = (String)field_77927_l.get(var6.func_76396_c());
            if (var7 != null) {
               int var8 = func_77912_a(var7, 0, var7.length(), var0);
               if (var8 > 0) {
                  int var9 = 0;
                  String var10 = (String)field_77928_m.get(var6.func_76396_c());
                  if (var10 != null) {
   ...
   public static int func_77908_a(int var0, int var1, int var2, int var3, int var4, int var5) {
      return (func_77914_a(var0, var1) ? 16 : 0)
         | (func_77914_a(var0, var2) ? 8 : 0)
         | (func_77914_a(var0, var3) ? 4 : 0)
         | (func_77914_a(var0, var4) ? 2 : 0)
         | (func_77914_a(var0, var5) ? 1 : 0);
   }

   static {
      field_77927_l.put(Potion.field_76428_l.func_76396_c(), "0 & !1 & !2 & !3 & 0+6");
      field_77927_l.put(Potion.field_76424_c.func_76396_c(), "!0 & 1 & !2 & !3 & 1+6");
      field_77927_l.put(Potion.field_76426_n.func_76396_c(), "0 & 1 & !2 & !3 & 0+6");
      field_77927_l.put(Potion.field_76432_h.func_76396_c(), "0 & !1 & 2 & !3");
      field_77927_l.put(Potion.field_76436_u.func_76396_c(), "!0 & !1 & 2 & !3 & 2+6");
      field_77927_l.put(Potion.field_76437_t.func_76396_c(), "!0 & !1 & !2 & 3 & 3+6");
      field_77927_l.put(Potion.field_76433_i.func_76396_c(), "!0 & !1 & 2 & 3");
      field_77927_l.put(Potion.field_76421_d.func_76396_c(), "!0 & 1 & !2 & 3 & 3+6");
      field_77927_l.put(Potion.field_76420_g.func_76396_c(), "0 & !1 & !2 & 3 & 3+6");
      field_77927_l.put(Potion.field_76439_r.func_76396_c(), "!0 & 1 & 2 & !3 & 2+6");
      field_77927_l.put(Potion.field_76441_p.func_76396_c(), "!0 & 1 & 2 & 3 & 2+6");
      field_77927_l.put(Potion.field_76427_o.func_76396_c(), "0 & !1 & 2 & 3 & 2+6");
      field_77928_m.put(Potion.field_76424_c.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76422_e.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76420_g.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76428_l.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76433_i.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76432_h.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76429_m.func_76396_c(), "5");
      field_77928_m.put(Potion.field_76436_u.func_76396_c(), "5");
   }
}
