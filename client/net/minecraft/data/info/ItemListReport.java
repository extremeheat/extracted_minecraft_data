      ...
      return this.registries
         .thenCompose(
            var2x -> {
               ...
               var2x.lookupOrThrow(Registries.ITEM)
                  .listElements()
                  .forEach(
                     var2xx -> {
                        ...
                        var3x.add(
                           ...
                           (JsonElement)DataComponentMap.CODEC
                              .encodeStart(var4, var2xx.value().components())
                              .getOrThrow(var0xx -> new IllegalStateException("Failed to encode components: " + var0xx))
                        );
