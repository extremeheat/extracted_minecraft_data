...
public class OverworldMaterialRules {
   ...
   private static SurfaceRules.RuleSource registerSurface(final BootstrapContext<SurfaceRules.RuleSource> context, final SurfaceRules.RuleSource sulfurCaveBands) {
      ...
      SurfaceRules.RuleSource defaultBiomeSurface = SurfaceRules.registerAndWrap(context, DEFAULT_BIOME_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(notUnderwater, GRASS_BLOCK), DIRT));
      ...
      SurfaceRules.RuleSource powderSnowUnderRule = SurfaceRules.registerAndWrap(context, POWDER_SNOW_UNDER_SURFACE, SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.POWDER_SNOW, 0.45, 0.58), SurfaceRules.ifTrue(notUnderwater, POWDER_SNOW)));
      SurfaceRules.RuleSource powderSnowSurfaceRule = SurfaceRules.registerAndWrap(context, POWDER_SNOW_SURFACE, SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.POWDER_SNOW, 0.35, 0.6), SurfaceRules.ifTrue(notUnderwater, POWDER_SNOW)));
      SurfaceRules.RuleSource underBiomeSurfaceRule = SurfaceRules.registerAndWrap(context, UNDER_BIOME_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.FROZEN_PEAKS), SurfaceRules.registerAndWrap(context, FROZEN_PEAKS_UNDER_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(steep, PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.PACKED_ICE, -0.5, 0.2), PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.ICE, -0.0625, 0.025), ICE), SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.SNOWY_SLOPES), SurfaceRules.registerAndWrap(context, SNOWY_SLOPES_UNDER_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(steep, STONE), powderSnowUnderRule, SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.JAGGED_PEAKS), SurfaceRules.registerAndWrap(context, JAGGED_PEAKS_UNDER_SURFACE, STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.GROVE), SurfaceRules.registerAndWrap(context, GROVE_UNDER_SURFACE, SurfaceRules.sequence(powderSnowUnderRule, DIRT))), commonSurfaceAndUnderRules, SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.WINDSWEPT_SAVANNA), SurfaceRules.registerAndWrap(context, WINDSWEPT_SAVANNA_UNDER_SURFACE, SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), STONE))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.WINDSWEPT_GRAVELLY_HILLS), SurfaceRules.registerAndWrap(context, WINDSWEPT_GRAVELLY_HILLS_UNDER_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(2.0), gravelOrStoneIfCeiling), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), STONE), SurfaceRules.ifTrue(surfaceNoiseAbove(-1.0), DIRT), gravelOrStoneIfCeiling))), SurfaceRules.registerAndWrap(context, DEFAULT_UNDER_BIOME_SURFACE, DIRT)));
      SurfaceRules.RuleSource biomeSurfaceRule = SurfaceRules.registerAndWrap(context, BIOME_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.FROZEN_PEAKS), SurfaceRules.registerAndWrap(context, FROZEN_PEAKS_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(steep, PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.PACKED_ICE, 0.0, 0.2), PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.ICE, 0.0, 0.025), ICE), SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.SNOWY_SLOPES), SurfaceRules.registerAndWrap(context, SNOWY_SLOPES_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(steep, STONE), powderSnowSurfaceRule, SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.JAGGED_PEAKS), SurfaceRules.registerAndWrap(context, JAGGED_PEAKS_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(steep, STONE), SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.GROVE), SurfaceRules.registerAndWrap(context, GROVE_SURFACE, SurfaceRules.sequence(powderSnowSurfaceRule, SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK)))), commonSurfaceAndUnderRules, SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.WINDSWEPT_SAVANNA), SurfaceRules.registerAndWrap(context, WINDSWEPT_SAVANNA_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), STONE), SurfaceRules.ifTrue(surfaceNoiseAbove(-0.5), COARSE_DIRT)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.WINDSWEPT_GRAVELLY_HILLS), SurfaceRules.registerAndWrap(context, WINDSWEPT_GRAVELLY_HILLS_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(2.0), gravelOrStoneIfCeiling), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), STONE), SurfaceRules.ifTrue(surfaceNoiseAbove(-1.0), defaultBiomeSurface), gravelOrStoneIfCeiling))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA), SurfaceRules.registerAndWrap(context, OLD_GROWTH_PINE_TAIGA_SURFACE, SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), COARSE_DIRT), SurfaceRules.ifTrue(surfaceNoiseAbove(-0.95), PODZOL)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.ICE_SPIKES), SurfaceRules.registerAndWrap(context, ICE_SPIKES_SURFACE, SurfaceRules.ifTrue(notUnderwater, SNOW_BLOCK))), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.MUSHROOM_FIELDS), SurfaceRules.registerAndWrap(context, MUSHROOM_FIELDS_SURFACE, MYCELIUM)), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.DAPPLED_FOREST), SurfaceRules.registerAndWrap(context, DAPPLED_FOREST_SURFACE, SurfaceRules.ifTrue(SurfaceRules.noiseCondition2d(Noises.SMALL_PATCH, 1.2000000476837158), COARSE_DIRT))), defaultBiomeSurface));
