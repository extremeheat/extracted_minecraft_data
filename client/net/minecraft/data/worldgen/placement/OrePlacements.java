...
public class OrePlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> var0) {
      ...
      Holder.Reference var22 = var1.getOrThrow(OreFeatures.ORE_DIAMOND_LARGE);
      Holder.Reference var23 = var1.getOrThrow(OreFeatures.ORE_DIAMOND_BURIED);
      Holder.Reference var24 = var1.getOrThrow(OreFeatures.ORE_LAPIS);
      Holder.Reference var25 = var1.getOrThrow(OreFeatures.ORE_LAPIS_BURIED);
      Holder.Reference var26 = var1.getOrThrow(OreFeatures.ORE_INFESTED);
      Holder.Reference var27 = var1.getOrThrow(OreFeatures.ORE_EMERALD);
      Holder.Reference var28 = var1.getOrThrow(OreFeatures.ORE_ANCIENT_DEBRIS_LARGE);
      Holder.Reference var29 = var1.getOrThrow(OreFeatures.ORE_ANCIENT_DEBRIS_SMALL);
      Holder.Reference var30 = var1.getOrThrow(OreFeatures.ORE_COPPPER_SMALL);
      Holder.Reference var31 = var1.getOrThrow(OreFeatures.ORE_COPPER_LARGE);
      Holder.Reference var32 = var1.getOrThrow(OreFeatures.ORE_CLAY);
      ...
      PlacementUtils.register(
         var0, ORE_DIRT, var8, commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(160)))
      );
      ...
      PlacementUtils.register(
         var0, ORE_GRANITE_UPPER, var10, rareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))
      );
      PlacementUtils.register(
         var0, ORE_GRANITE_LOWER, var10, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))
      );
      PlacementUtils.register(
         var0, ORE_DIORITE_UPPER, var11, rareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))
      );
      PlacementUtils.register(
         var0, ORE_DIORITE_LOWER, var11, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))
      );
      PlacementUtils.register(
         var0, ORE_ANDESITE_UPPER, var12, rareOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))
      );
      PlacementUtils.register(
         var0, ORE_ANDESITE_LOWER, var12, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))
      );
      ...
      PlacementUtils.register(
         var0, ORE_COAL_UPPER, var14, commonOrePlacement(30, HeightRangePlacement.uniform(VerticalAnchor.absolute(136), VerticalAnchor.top()))
      );
      PlacementUtils.register(
         var0, ORE_COAL_LOWER, var15, commonOrePlacement(20, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(192)))
      );
      PlacementUtils.register(
         var0, ORE_IRON_UPPER, var16, commonOrePlacement(90, HeightRangePlacement.triangle(VerticalAnchor.absolute(80), VerticalAnchor.absolute(384)))
      );
      PlacementUtils.register(
         var0, ORE_IRON_MIDDLE, var16, commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.absolute(-24), VerticalAnchor.absolute(56)))
      );
      PlacementUtils.register(
         var0, ORE_IRON_SMALL, var17, commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(72)))
      );
      PlacementUtils.register(
         var0, ORE_GOLD_EXTRA, var18, commonOrePlacement(50, HeightRangePlacement.uniform(VerticalAnchor.absolute(32), VerticalAnchor.absolute(256)))
      );
      PlacementUtils.register(
         var0, ORE_GOLD, var19, commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(32)))
      );
      PlacementUtils.register(
         var0,
         ORE_GOLD_LOWER,
      ...
      PlacementUtils.register(
         var0, ORE_DIAMOND_LARGE, var22, rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))
      );
      PlacementUtils.register(
         var0,
         ORE_DIAMOND_BURIED,
      ...
      PlacementUtils.register(
         var0, ORE_LAPIS, var24, commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32)))
      );
      PlacementUtils.register(
         var0, ORE_LAPIS_BURIED, var25, commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64)))
      );
      PlacementUtils.register(
         var0, ORE_INFESTED, var26, commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(63)))
      );
      PlacementUtils.register(
         var0, ORE_EMERALD, var27, commonOrePlacement(100, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(480)))
      );
      PlacementUtils.register(
         var0,
      ...
      PlacementUtils.register(
         var0, ORE_COPPER, var30, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112)))
      );
      PlacementUtils.register(
         var0, ORE_COPPER_LARGE, var31, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112)))
      );
      PlacementUtils.register(var0, ORE_CLAY, var32, commonOrePlacement(46, PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT));
   }
}
