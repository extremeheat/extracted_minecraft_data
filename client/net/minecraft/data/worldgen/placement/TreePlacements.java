...
public class TreePlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, PALE_OAK_CHECKED, var6, PlacementUtils.filteredByBlockSurvival(Blocks.PALE_OAK_SAPLING));
      PlacementUtils.register(var0, PALE_OAK_CREAKING_CHECKED, var7, PlacementUtils.filteredByBlockSurvival(Blocks.PALE_OAK_SAPLING));
      PlacementUtils.register(var0, BIRCH_CHECKED, var8, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, ACACIA_CHECKED, var9, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
      ...
      List var32 = List.of(
         ...
         BlockPredicateFilter.forPredicate(var31)
      );
      PlacementUtils.register(var0, PINE_ON_SNOW, var13, var32);
      PlacementUtils.register(var0, SPRUCE_ON_SNOW, var10, var32);
      ...
      PlacementUtils.register(var0, MEGA_JUNGLE_TREE_CHECKED, var16, PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING));
      PlacementUtils.register(var0, MEGA_SPRUCE_CHECKED, var17, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(var0, MEGA_PINE_CHECKED, var18, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(var0, TALL_MANGROVE_CHECKED, var19, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
      PlacementUtils.register(var0, JUNGLE_BUSH, var20, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, SUPER_BIRCH_BEES_0002, var21, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, SUPER_BIRCH_BEES, var22, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, OAK_BEES_0002, var23, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, OAK_BEES_002, var24, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, BIRCH_BEES_0002_PLACED, var25, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, BIRCH_BEES_002, var26, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, FANCY_OAK_BEES_0002, var27, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, FANCY_OAK_BEES_002, var28, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, FANCY_OAK_BEES, var29, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, CHERRY_BEES_005, var30, PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING));
   }
}
