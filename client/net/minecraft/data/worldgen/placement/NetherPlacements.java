...
public class NetherPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(
         var0, GLOWSTONE_EXTRA, var7, CountPlacement.of(BiasedToBottomInt.of(0, 9)), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()
      );
      ...
      PlacementUtils.register(
         var0, SPRING_CLOSED_DOUBLE, var16, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()
      );
