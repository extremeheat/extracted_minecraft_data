...
public class NetherPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, SMALL_BASALT_COLUMNS, var3, CountOnEveryLayerPlacement.of(4), BiomeFilter.biome());
      PlacementUtils.register(var0, LARGE_BASALT_COLUMNS, var4, CountOnEveryLayerPlacement.of(2), BiomeFilter.biome());
      PlacementUtils.register(var0, BASALT_BLOBS, var5, CountPlacement.of(75), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, BLACKSTONE_BLOBS, var6, CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, GLOWSTONE_EXTRA, var7, CountPlacement.of(BiasedToBottomInt.of(0, 9)), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome());
      PlacementUtils.register(var0, GLOWSTONE, var7, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, CRIMSON_FOREST_VEGETATION, var8, CountOnEveryLayerPlacement.of(6), BiomeFilter.biome());
      PlacementUtils.register(var0, WARPED_FOREST_VEGETATION, var9, CountOnEveryLayerPlacement.of(5), BiomeFilter.biome());
      PlacementUtils.register(var0, NETHER_SPROUTS, var10, CountOnEveryLayerPlacement.of(4), BiomeFilter.biome());
      PlacementUtils.register(var0, TWISTING_VINES, var11, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, WEEPING_VINES, var12, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_CRIMSON_ROOTS, var13, PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, BASALT_PILLAR, var14, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, SPRING_DELTA, var15, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome());
      PlacementUtils.register(var0, SPRING_CLOSED, var16, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
      PlacementUtils.register(var0, SPRING_CLOSED_DOUBLE, var16, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
      PlacementUtils.register(var0, SPRING_OPEN, var17, CountPlacement.of(8), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome());
      ...
      PlacementUtils.register(var0, PATCH_SOUL_FIRE, var18, var20);
      PlacementUtils.register(var0, PATCH_FIRE, var19, var20);
   }
}
