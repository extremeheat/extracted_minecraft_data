...
public class CavePlacements {
   public static final Holder<PlacedFeature> MONSTER_ROOM = PlacementUtils.register(
      "monster_room",
   ...
   public static final Holder<PlacedFeature> MONSTER_ROOM_DEEP = PlacementUtils.register(
      "monster_room_deep",
      CaveFeatures.MONSTER_ROOM,
      CountPlacement.of(4),
      InSquarePlacement.spread(),
   ...
   public static final Holder<PlacedFeature> FOSSIL_UPPER = PlacementUtils.register(
      "fossil_upper",
   ...
   public static final Holder<PlacedFeature> FOSSIL_LOWER = PlacementUtils.register(
      "fossil_lower",
   ...
   public static final Holder<PlacedFeature> DRIPSTONE_CLUSTER = PlacementUtils.register(
      "dripstone_cluster",
   ...
   public static final Holder<PlacedFeature> LARGE_DRIPSTONE = PlacementUtils.register(
      "large_dripstone",
   ...
   public static final Holder<PlacedFeature> POINTED_DRIPSTONE = PlacementUtils.register(
      "pointed_dripstone",
   ...
   public static final Holder<PlacedFeature> UNDERWATER_MAGMA = PlacementUtils.register(
      "underwater_magma",
   ...
   public static final Holder<PlacedFeature> GLOW_LICHEN = PlacementUtils.register(
      "glow_lichen",
   ...
   public static final Holder<PlacedFeature> ROOTED_AZALEA_TREE = PlacementUtils.register(
      "rooted_azalea_tree",
   ...
   public static final Holder<PlacedFeature> LUSH_CAVES_VEGETATION = PlacementUtils.register(
   ...
   public static final Holder<PlacedFeature> LUSH_CAVES_CLAY = PlacementUtils.register(
      "lush_caves_clay",
   ...
   public static final Holder<PlacedFeature> LUSH_CAVES_CEILING_VEGETATION = PlacementUtils.register(
   ...
   public static final Holder<PlacedFeature> SPORE_BLOSSOM = PlacementUtils.register(
      "spore_blossom",
   ...
   public static final Holder<PlacedFeature> CLASSIC_VINES = PlacementUtils.register(
   ...
   public static final Holder<PlacedFeature> AMETHYST_GEODE = PlacementUtils.register(
      "amethyst_geode",
   ...
   public static final Holder<PlacedFeature> SCULK_PATCH_ANCIENT_CITY = PlacementUtils.register(
      "sculk_patch_ancient_city", CaveFeatures.SCULK_PATCH_ANCIENT_CITY
   );
