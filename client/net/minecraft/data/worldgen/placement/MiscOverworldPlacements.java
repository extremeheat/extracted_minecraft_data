...
public class MiscOverworldPlacements {
   ...
   public static final Holder<PlacedFeature> ICEBERG_PACKED = PlacementUtils.register(
      "iceberg_packed", MiscOverworldFeatures.ICEBERG_PACKED, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), BiomeFilter.biome()
   );
   public static final Holder<PlacedFeature> ICEBERG_BLUE = PlacementUtils.register(
      "iceberg_blue", MiscOverworldFeatures.ICEBERG_BLUE, RarityFilter.onAverageOnceEvery(200), InSquarePlacement.spread(), BiomeFilter.biome()
   );
   public static final Holder<PlacedFeature> BLUE_ICE = PlacementUtils.register(
      "blue_ice",
   ...
   public static final Holder<PlacedFeature> LAKE_LAVA_UNDERGROUND = PlacementUtils.register(
      ...
      SurfaceRelativeThresholdFilter.of(Heightmap.Types.OCEAN_FLOOR_WG, -2147483648, -5),
      BiomeFilter.biome()
   );
   public static final Holder<PlacedFeature> LAKE_LAVA_SURFACE = PlacementUtils.register(
      "lake_lava_surface",
      MiscOverworldFeatures.LAKE_LAVA,
   ...
   public static final Holder<PlacedFeature> VOID_START_PLATFORM = PlacementUtils.register(
      "void_start_platform", MiscOverworldFeatures.VOID_START_PLATFORM, BiomeFilter.biome()
   );
   public static final Holder<PlacedFeature> DESERT_WELL = PlacementUtils.register(
      "desert_well",
   ...
   public static final Holder<PlacedFeature> SPRING_LAVA = PlacementUtils.register(
      "spring_lava",
   ...
   public static final Holder<PlacedFeature> SPRING_LAVA_FROZEN = PlacementUtils.register(
      "spring_lava_frozen",
   ...
   public static final Holder<PlacedFeature> SPRING_WATER = PlacementUtils.register(
      "spring_water",
