...
public class VegetationPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, TREES_PLAINS, var27, (PlacementModifier[])(PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), var51, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome()));
      PlacementUtils.register(var0, DARK_FOREST_VEGETATION, var28, (PlacementModifier[])(CountPlacement.of(16), InSquarePlacement.spread(), var51, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome()));
      PlacementUtils.register(var0, FLOWER_FOREST_FLOWERS, var29, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-1, 3), 0, 3)), BiomeFilter.biome()));
      PlacementUtils.register(var0, FOREST_FLOWERS, var29, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome()));
      PlacementUtils.register(var0, TREES_FLOWER_FOREST, var30, (List)treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_MEADOW, var31, (List)treePlacement(RarityFilter.onAverageOnceEvery(100)));
      PlacementUtils.register(var0, TREES_CHERRY, var36, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
      PlacementUtils.register(var0, TREES_TAIGA, var32, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_GROVE, var33, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BADLANDS, var34, (List)treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, TREES_SNOWY, var35, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(var0, TREES_SWAMP, var37, (PlacementModifier[])(PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO))));
      PlacementUtils.register(var0, TREES_WINDSWEPT_SAVANNA, var38, (List)treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_SAVANNA, var38, (List)treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
      PlacementUtils.register(var0, BIRCH_TALL, var39, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BIRCH, var40, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, TREES_WINDSWEPT_FOREST, var41, (List)treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_WINDSWEPT_HILLS, var41, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_WATER, var42, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BIRCH_AND_OAK, var43, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_SPARSE_JUNGLE, var44, (List)treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_OLD_GROWTH_SPRUCE_TAIGA, var45, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_OLD_GROWTH_PINE_TAIGA, var46, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_JUNGLE, var47, (List)treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
      PlacementUtils.register(var0, BAMBOO_VEGETATION, var48, (List)treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
      PlacementUtils.register(var0, MUSHROOM_ISLAND_VEGETATION, var49, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
      PlacementUtils.register(var0, TREES_MANGROVE, var50, (PlacementModifier[])(CountPlacement.of(25), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(5), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.defaultBlockState(), BlockPos.ZERO))));
   }
}
