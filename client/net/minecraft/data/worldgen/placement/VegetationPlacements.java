...
public class VegetationPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      Holder.Reference var27 = var1.getOrThrow(VegetationFeatures.FLOWER_PALE_GARDEN);
      Holder.Reference var28 = var1.getOrThrow(VegetationFeatures.TREES_PLAINS);
      Holder.Reference var29 = var1.getOrThrow(VegetationFeatures.DARK_FOREST_VEGETATION);
      Holder.Reference var30 = var1.getOrThrow(VegetationFeatures.PALE_GARDEN_VEGETATION);
      Holder.Reference var31 = var1.getOrThrow(VegetationFeatures.FOREST_FLOWERS);
      Holder.Reference var32 = var1.getOrThrow(VegetationFeatures.PALE_FOREST_FLOWERS);
      Holder.Reference var33 = var1.getOrThrow(VegetationFeatures.PALE_MOSS_PATCH);
      Holder.Reference var34 = var1.getOrThrow(VegetationFeatures.TREES_FLOWER_FOREST);
      Holder.Reference var35 = var1.getOrThrow(VegetationFeatures.MEADOW_TREES);
      Holder.Reference var36 = var1.getOrThrow(VegetationFeatures.TREES_TAIGA);
      Holder.Reference var37 = var1.getOrThrow(VegetationFeatures.TREES_GROVE);
      Holder.Reference var38 = var1.getOrThrow(TreeFeatures.OAK);
      Holder.Reference var39 = var1.getOrThrow(TreeFeatures.SPRUCE);
      Holder.Reference var40 = var1.getOrThrow(TreeFeatures.CHERRY_BEES_005);
      Holder.Reference var41 = var1.getOrThrow(TreeFeatures.SWAMP_OAK);
      Holder.Reference var42 = var1.getOrThrow(VegetationFeatures.TREES_SAVANNA);
      Holder.Reference var43 = var1.getOrThrow(VegetationFeatures.BIRCH_TALL);
      Holder.Reference var44 = var1.getOrThrow(TreeFeatures.BIRCH_BEES_0002);
      Holder.Reference var45 = var1.getOrThrow(VegetationFeatures.TREES_WINDSWEPT_HILLS);
      Holder.Reference var46 = var1.getOrThrow(VegetationFeatures.TREES_WATER);
      Holder.Reference var47 = var1.getOrThrow(VegetationFeatures.TREES_BIRCH_AND_OAK);
      Holder.Reference var48 = var1.getOrThrow(VegetationFeatures.TREES_SPARSE_JUNGLE);
      Holder.Reference var49 = var1.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
      Holder.Reference var50 = var1.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
      Holder.Reference var51 = var1.getOrThrow(VegetationFeatures.TREES_JUNGLE);
      Holder.Reference var52 = var1.getOrThrow(VegetationFeatures.BAMBOO_VEGETATION);
      Holder.Reference var53 = var1.getOrThrow(VegetationFeatures.MUSHROOM_ISLAND_VEGETATION);
      Holder.Reference var54 = var1.getOrThrow(VegetationFeatures.MANGROVE_VEGETATION);
      ...
      PlacementUtils.register(var0, PATCH_MELON, var12, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_MELON_SPARSE, var12, RarityFilter.onAverageOnceEvery(64), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_BERRY_COMMON, var13, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_BERRY_RARE, var13, RarityFilter.onAverageOnceEvery(384), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_WATERLILY, var14, worldSurfaceSquaredWithCount(4));
      PlacementUtils.register(var0, PATCH_TALL_GRASS_2, var15, NoiseThresholdCountPlacement.of(-0.8, 0, 7), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_TALL_GRASS, var15, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_LARGE_FERN, var16, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_CACTUS_DESERT, var17, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_CACTUS_DECORATED, var17, RarityFilter.onAverageOnceEvery(13), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_SUGAR_CANE_SWAMP, var18, RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      ...
      PlacementUtils.register(var0, PATCH_SUGAR_CANE_BADLANDS, var18, RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, PATCH_SUGAR_CANE, var18, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, BROWN_MUSHROOM_NETHER, var19, RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, RED_MUSHROOM_NETHER, var20, RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
      PlacementUtils.register(var0, BROWN_MUSHROOM_NORMAL, var19, getMushroomPlacement(256, (PlacementModifier)null));
      PlacementUtils.register(var0, RED_MUSHROOM_NORMAL, var20, getMushroomPlacement(512, (PlacementModifier)null));
      PlacementUtils.register(var0, BROWN_MUSHROOM_TAIGA, var19, getMushroomPlacement(4, (PlacementModifier)null));
      PlacementUtils.register(var0, RED_MUSHROOM_TAIGA, var20, getMushroomPlacement(256, (PlacementModifier)null));
      PlacementUtils.register(var0, BROWN_MUSHROOM_OLD_GROWTH, var19, getMushroomPlacement(4, CountPlacement.of(3)));
      PlacementUtils.register(var0, RED_MUSHROOM_OLD_GROWTH, var20, getMushroomPlacement(171, (PlacementModifier)null));
      PlacementUtils.register(var0, BROWN_MUSHROOM_SWAMP, var19, getMushroomPlacement(0, CountPlacement.of(2)));
      PlacementUtils.register(var0, RED_MUSHROOM_SWAMP, var20, getMushroomPlacement(64, (PlacementModifier)null));
      PlacementUtils.register(var0, FLOWER_WARM, var21, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_DEFAULT, var21, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_FLOWER_FOREST, var22, CountPlacement.of(3), RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_SWAMP, var23, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_PLAINS, var24, NoiseThresholdCountPlacement.of(-0.8, 15, 4), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_CHERRY, var26, NoiseThresholdCountPlacement.of(-0.8, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_MEADOW, var25, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_PALE_GARDEN, var27, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      SurfaceWaterDepthFilter var55 = SurfaceWaterDepthFilter.forMaxDepth(0);
      PlacementUtils.register(var0, TREES_PLAINS, var28, PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), var55, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome());
      PlacementUtils.register(var0, DARK_FOREST_VEGETATION, var29, CountPlacement.of(16), InSquarePlacement.spread(), var55, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
      PlacementUtils.register(var0, PALE_GARDEN_VEGETATION, var30, CountPlacement.of(16), InSquarePlacement.spread(), var55, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
      PlacementUtils.register(var0, FLOWER_FOREST_FLOWERS, var31, RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-1, 3), 0, 3)), BiomeFilter.biome());
      PlacementUtils.register(var0, FOREST_FLOWERS, var31, RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome());
      PlacementUtils.register(var0, PALE_GARDEN_FLOWERS, var32, RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome());
      PlacementUtils.register(var0, PALE_MOSS_PATCH, var33, CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome());
      PlacementUtils.register(var0, TREES_FLOWER_FOREST, var34, treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_MEADOW, var35, treePlacement(RarityFilter.onAverageOnceEvery(100)));
      PlacementUtils.register(var0, TREES_CHERRY, var40, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
      PlacementUtils.register(var0, TREES_TAIGA, var36, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_GROVE, var37, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BADLANDS, var38, treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, TREES_SNOWY, var39, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(var0, TREES_SWAMP, var41, PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO)));
      PlacementUtils.register(var0, TREES_WINDSWEPT_SAVANNA, var42, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_SAVANNA, var42, treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
      PlacementUtils.register(var0, BIRCH_TALL, var43, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BIRCH, var44, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, TREES_WINDSWEPT_FOREST, var45, treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_WINDSWEPT_HILLS, var45, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_WATER, var46, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BIRCH_AND_OAK, var47, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_SPARSE_JUNGLE, var48, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_OLD_GROWTH_SPRUCE_TAIGA, var49, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_OLD_GROWTH_PINE_TAIGA, var50, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_JUNGLE, var51, treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
      PlacementUtils.register(var0, BAMBOO_VEGETATION, var52, treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
      PlacementUtils.register(var0, MUSHROOM_ISLAND_VEGETATION, var53, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
      PlacementUtils.register(var0, TREES_MANGROVE, var54, CountPlacement.of(25), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(5), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.defaultBlockState(), BlockPos.ZERO)));
   }
}
