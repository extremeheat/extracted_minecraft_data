...
public class VegetationPlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, FLOWER_PALE_GARDEN, var27, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
      SurfaceWaterDepthFilter var55 = SurfaceWaterDepthFilter.forMaxDepth(0);
      PlacementUtils.register(var0, TREES_PLAINS, var28, (PlacementModifier[])(PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), var55, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome()));
      PlacementUtils.register(var0, DARK_FOREST_VEGETATION, var29, (PlacementModifier[])(CountPlacement.of(16), InSquarePlacement.spread(), var55, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome()));
      PlacementUtils.register(var0, PALE_GARDEN_VEGETATION, var30, (PlacementModifier[])(CountPlacement.of(16), InSquarePlacement.spread(), var55, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome()));
      PlacementUtils.register(var0, FLOWER_FOREST_FLOWERS, var31, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-1, 3), 0, 3)), BiomeFilter.biome()));
      PlacementUtils.register(var0, FOREST_FLOWERS, var31, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome()));
      PlacementUtils.register(var0, PALE_GARDEN_FLOWERS, var32, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome()));
      PlacementUtils.register(var0, PALE_MOSS_PATCH, var33, (PlacementModifier[])(CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome()));
      PlacementUtils.register(var0, TREES_FLOWER_FOREST, var34, (List)treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_MEADOW, var35, (List)treePlacement(RarityFilter.onAverageOnceEvery(100)));
      PlacementUtils.register(var0, TREES_CHERRY, var40, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
      PlacementUtils.register(var0, TREES_TAIGA, var36, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_GROVE, var37, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BADLANDS, var38, (List)treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
      PlacementUtils.register(var0, TREES_SNOWY, var39, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(var0, TREES_SWAMP, var41, (PlacementModifier[])(PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO))));
      PlacementUtils.register(var0, TREES_WINDSWEPT_SAVANNA, var42, (List)treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_SAVANNA, var42, (List)treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
      PlacementUtils.register(var0, BIRCH_TALL, var43, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BIRCH, var44, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
      PlacementUtils.register(var0, TREES_WINDSWEPT_FOREST, var45, (List)treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_WINDSWEPT_HILLS, var45, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_WATER, var46, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_BIRCH_AND_OAK, var47, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_SPARSE_JUNGLE, var48, (List)treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_OLD_GROWTH_SPRUCE_TAIGA, var49, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_OLD_GROWTH_PINE_TAIGA, var50, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
      PlacementUtils.register(var0, TREES_JUNGLE, var51, (List)treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
      PlacementUtils.register(var0, BAMBOO_VEGETATION, var52, (List)treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
      PlacementUtils.register(var0, MUSHROOM_ISLAND_VEGETATION, var53, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
      PlacementUtils.register(var0, TREES_MANGROVE, var54, (PlacementModifier[])(CountPlacement.of(25), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(5), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.defaultBlockState(), BlockPos.ZERO))));
   }
}
