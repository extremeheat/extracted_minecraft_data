...
public class AquaticPlacements {
   ...
   public static void bootstrap(final BootstrapContext<PlacedFeature> context) {
      ...
      Holder.Reference<Feature> seagrassTall = configuredFeatures.getOrThrow(AquaticFeatures.SEAGRASS_TALL);
      Holder.Reference<Feature> seaPickle = configuredFeatures.getOrThrow(AquaticFeatures.SEA_PICKLE);
      Holder.Reference<Feature> kelp = configuredFeatures.getOrThrow(AquaticFeatures.KELP);
      Holder.Reference<Feature> warmOceanVegetation = configuredFeatures.getOrThrow(AquaticFeatures.WARM_OCEAN_VEGETATION);
      ...
      BlockPredicateFilter kelpPlacementFilter = BlockPredicateFilter.forPredicate(BlockPredicate.allOf(BlockPredicate.matchesBlocks(Blocks.WATER), BlockPredicate.matchesBlocks((Directional)Direction.UP, Blocks.WATER), BlockPredicate.hasSturdyFace(Direction.DOWN, Direction.UP), BlockPredicate.not(BlockPredicate.matchesTag((Directional)Direction.DOWN, BlockTags.CANNOT_SUPPORT_KELP))));
      PlacementUtils.register(context, KELP_COLD, kelp, NoiseBasedCountPlacement.of(120, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, kelpPlacementFilter, BiomeFilter.biome());
      PlacementUtils.register(context, KELP_WARM, kelp, NoiseBasedCountPlacement.of(80, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, kelpPlacementFilter, BiomeFilter.biome());
