...
public class AquaticPlacements {
   ...
   public static final Holder<PlacedFeature> SEAGRASS_NORMAL = PlacementUtils.register(
      "seagrass_normal", AquaticFeatures.SEAGRASS_SHORT, seagrassPlacement(48)
   );
   ...
   public static final Holder<PlacedFeature> SEAGRASS_RIVER = PlacementUtils.register(
      "seagrass_river", AquaticFeatures.SEAGRASS_SLIGHTLY_LESS_SHORT, seagrassPlacement(48)
   );
   ...
   public static final Holder<PlacedFeature> SEAGRASS_DEEP_WARM = PlacementUtils.register(
      "seagrass_deep_warm", AquaticFeatures.SEAGRASS_TALL, seagrassPlacement(80)
   );
   ...
   public static final Holder<PlacedFeature> SEAGRASS_DEEP_COLD = PlacementUtils.register(
      "seagrass_deep_cold", AquaticFeatures.SEAGRASS_TALL, seagrassPlacement(40)
   );
   public static final Holder<PlacedFeature> SEAGRASS_SIMPLE = PlacementUtils.register(
      "seagrass_simple",
   ...
   public static final Holder<PlacedFeature> SEA_PICKLE = PlacementUtils.register(
      "sea_pickle",
   ...
   public static final Holder<PlacedFeature> KELP_COLD = PlacementUtils.register(
      "kelp_cold",
   ...
   public static final Holder<PlacedFeature> KELP_WARM = PlacementUtils.register(
      "kelp_warm",
      AquaticFeatures.KELP,
   ...
   public static final Holder<PlacedFeature> WARM_OCEAN_VEGETATION = PlacementUtils.register(
