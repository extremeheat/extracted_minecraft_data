...
public class ProcessorLists {
   ...
   public static void bootstrap(BootstrapContext<StructureProcessorList> var0) {
      ...
      register(
         ...
         ImmutableList.of(
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.TATERSTONE, 0.8F), AlwaysTrueTest.INSTANCE, Blocks.EXPIRED_BAKED_POTATO_BRICKS.defaultBlockState()
                  ),
                  new ProcessorRule(new TagMatchTest(BlockTags.DOORS), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                  new ProcessorRule(new BlockMatchTest(Blocks.TORCH), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                  new ProcessorRule(new BlockMatchTest(Blocks.WALL_TORCH), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                  ...
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.EXPIRED_BAKED_POTATO_BRICKS, 0.07F), AlwaysTrueTest.INSTANCE, Blocks.COBWEB.defaultBlockState()
                  ),
                  new ProcessorRule(new RandomBlockMatchTest(Blocks.WHITE_TERRACOTTA, 0.07F), AlwaysTrueTest.INSTANCE, Blocks.COBWEB.defaultBlockState()),
      ...
      register(
         ...
         ImmutableList.of(
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.TATERSTONE, 0.1F), AlwaysTrueTest.INSTANCE, Blocks.EXPIRED_BAKED_POTATO_BRICKS.defaultBlockState()
                  )
               )
            )
         )
      ...
      register(
         ...
         ImmutableList.of(
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.TATERSTONE, 0.2F), AlwaysTrueTest.INSTANCE, Blocks.EXPIRED_BAKED_POTATO_BRICKS.defaultBlockState()
                  )
               )
            )
         )
      ...
      register(
         ...
         ImmutableList.of(
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.TATERSTONE, 0.7F), AlwaysTrueTest.INSTANCE, Blocks.EXPIRED_BAKED_POTATO_BRICKS.defaultBlockState()
                  )
               )
            )
         )
      ...
      register(var0, OUTPOST_ROT, ImmutableList.of(new BlockRotProcessor(0.05F)));
      register(
         var0,
         BOTTOM_RAMPART,
         ImmutableList.of(
      ...
      register(var0, FOSSIL_ROT, ImmutableList.of(new BlockRotProcessor(0.9F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE)));
      register(var0, FOSSIL_COAL, ImmutableList.of(new BlockRotProcessor(0.1F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE)));
      register(
         var0,
         COLOSSEUM_VEINS,
         ImmutableList.of(
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.BAKED_POTATO_BRICKS, 0.2F),
                     AlwaysTrueTest.INSTANCE,
                     Blocks.EXPIRED_BAKED_POTATO_BRICKS.defaultBlockState()
                  ),
      ...
      register(
         ...
         ImmutableList.of(
            new BlockRotProcessor(var1.getOrThrow(BlockTags.ANCIENT_CITY_REPLACEABLE), 0.95F),
            new RuleProcessor(
               ImmutableList.of(
                  new ProcessorRule(
                     new RandomBlockMatchTest(Blocks.DEEPSLATE_BRICKS, 0.3F), AlwaysTrueTest.INSTANCE, Blocks.CRACKED_DEEPSLATE_BRICKS.defaultBlockState()
