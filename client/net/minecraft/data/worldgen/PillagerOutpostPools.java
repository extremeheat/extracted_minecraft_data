   ...
   public static void bootstrap(BootstrapContext<StructureTemplatePool> var0) {
      ...
      var0.register(
         ...
         new StructureTemplatePool(
            var4, ImmutableList.of(Pair.of(StructurePoolElement.legacy("pillager_outpost/base_plate"), 1)), StructureTemplatePool.Projection.RIGID
         )
      );
      Pools.register(
         var0,
            ...
            ImmutableList.of(
               Pair.of(
                  StructurePoolElement.list(
                     ImmutableList.of(
                        StructurePoolElement.legacy("pillager_outpost/watchtower"), StructurePoolElement.legacy("pillager_outpost/watchtower_overgrown", var2)
                     )
                  ),
                  1
               )
