...
public class OreFeatures {
   ...
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_MAGMA;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_SOUL_SAND;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_NETHER_GOLD;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_QUARTZ;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_GRAVEL_NETHER;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_BLACKSTONE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_DIRT;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_GRAVEL;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_GRANITE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_DIORITE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_ANDESITE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_TUFF;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_COAL;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_COAL_BURIED;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_IRON;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_IRON_SMALL;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_GOLD;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_GOLD_BURIED;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_REDSTONE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_DIAMOND_SMALL;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_DIAMOND_LARGE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_DIAMOND_BURIED;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_LAPIS;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_LAPIS_BURIED;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_INFESTED;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_EMERALD;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_ANCIENT_DEBRIS_LARGE;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_ANCIENT_DEBRIS_SMALL;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_COPPPER_SMALL;
   public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_COPPER_LARGE;
