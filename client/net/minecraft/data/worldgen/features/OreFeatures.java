...
public class OreFeatures {
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> var0) {
      ...
      FeatureUtils.register(
         ...
         new OreConfiguration(
            List.of(
               OreConfiguration.target(var2, Blocks.INFESTED_STONE.defaultBlockState()),
               OreConfiguration.target(var3, Blocks.INFESTED_DEEPSLATE.defaultBlockState())
            ),
            9
         )
      );
      FeatureUtils.register(
         ...
         new OreConfiguration(
            List.of(
               OreConfiguration.target(var2, Blocks.EMERALD_ORE.defaultBlockState()),
               OreConfiguration.target(var3, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())
            ),
            3
         )
      );
