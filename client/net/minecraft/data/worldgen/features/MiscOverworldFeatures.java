...
public class MiscOverworldFeatures {
   ...
   public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> DISK_GRASS;
   ...
   static {
      ...
      ICE_PATCH = FeatureUtils.register("ice_patch", Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.PACKED_ICE), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.MYCELIUM, Blocks.SNOW_BLOCK, Blocks.ICE)), UniformInt.of(2, 3), 1));
