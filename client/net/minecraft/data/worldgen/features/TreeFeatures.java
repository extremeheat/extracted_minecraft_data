...
public class TreeFeatures {
   ...
   private static TreeConfiguration.TreeConfigurationBuilder createStraightBlobTree(final Block oakLog, final Block oakLeaves, final int baseHeight, final int heightRandA, final int heightRandB, final int blobRadius, final BlockStateProvider belowTrunkProvider) {
      return new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(oakLog), new StraightTrunkPlacer(baseHeight, heightRandA, heightRandB), BlockStateProvider.simple(oakLeaves), new BlobFoliagePlacer(ConstantInt.of(blobRadius), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1), belowTrunkProvider);
   }
   ...
   public static void bootstrap(final BootstrapContext<ConfiguredFeature<?, ?>> context) {
      ...
      FeatureUtils.register(context, PALE_OAK_CREAKING, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.PALE_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.PALE_OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()), belowTrunkProvider)).decorators(ImmutableList.of(new PaleMossDecorator(0.15F, 0.4F, 0.8F), new CreakingHeartDecorator(1.0F))).ignoreVines().build());
      FeatureUtils.register(context, BIRCH, Feature.TREE, createBirch(belowTrunkProvider).build());
      FeatureUtils.register(context, ACACIA, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.ACACIA_LOG), new ForkingTrunkPlacer(5, 2, 2), BlockStateProvider.simple(Blocks.ACACIA_LEAVES), new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2), belowTrunkProvider)).ignoreVines().build());
      ...
      FeatureUtils.register(context, SPRUCE, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new StraightTrunkPlacer(5, 2, 1), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new SpruceFoliagePlacer(UniformInt.of(2, 3), UniformInt.of(0, 2), UniformInt.of(1, 2)), new TwoLayersFeatureSize(2, 0, 2), belowTrunkProvider)).ignoreVines().build());
      ...
      FeatureUtils.register(context, JUNGLE_TREE, Feature.TREE, createJungleTree(belowTrunkProvider).decorators(ImmutableList.of(new CocoaDecorator(0.2F), TrunkVineDecorator.INSTANCE, new LeaveVineDecorator(0.25F))).ignoreVines().build());
      ...
      FeatureUtils.register(context, MEGA_JUNGLE_TREE, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.JUNGLE_LOG), new MegaJungleTrunkPlacer(10, 2, 19), BlockStateProvider.simple(Blocks.JUNGLE_LEAVES), new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2), belowTrunkProvider)).decorators(ImmutableList.of(TrunkVineDecorator.INSTANCE, new LeaveVineDecorator(0.25F))).build());
      FeatureUtils.register(context, MEGA_SPRUCE, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new GiantTrunkPlacer(13, 2, 14), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(13, 17)), new TwoLayersFeatureSize(1, 1, 2), belowTrunkProvider)).decorators(ImmutableList.of(new AlterGroundDecorator(RuleBasedStateProvider.ifTrueThenProvide(BlockPredicate.matchesTag(BlockTags.BENEATH_TREE_PODZOL_REPLACEABLE), Blocks.PODZOL)))).build());
      FeatureUtils.register(context, MEGA_PINE, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new GiantTrunkPlacer(13, 2, 14), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(3, 7)), new TwoLayersFeatureSize(1, 1, 2), belowTrunkProvider)).decorators(ImmutableList.of(new AlterGroundDecorator(RuleBasedStateProvider.ifTrueThenProvide(BlockPredicate.matchesTag(BlockTags.BENEATH_TREE_PODZOL_REPLACEABLE), Blocks.PODZOL)))).build());
      FeatureUtils.register(context, SUPER_BIRCH_BEES_0002, Feature.TREE, createSuperBirch(belowTrunkProvider).decorators(ImmutableList.of(beehive0002)).build());
      ...
      FeatureUtils.register(context, SWAMP_OAK, Feature.TREE, createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3, belowTrunkProvider).decorators(ImmutableList.of(new LeaveVineDecorator(0.25F))).build());
      FeatureUtils.register(context, JUNGLE_BUSH, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.JUNGLE_LOG), new StraightTrunkPlacer(1, 0, 0), BlockStateProvider.simple(Blocks.OAK_LEAVES), new BushFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2), new TwoLayersFeatureSize(0, 0, 0), belowTrunkProvider)).build());
      ...
      FeatureUtils.register(context, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, createBirch(belowTrunkProvider).decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build());
      ...
      FeatureUtils.register(context, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createFancyOak(belowTrunkProvider).decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build());
      ...
      FeatureUtils.register(context, OAK_LEAF_LITTER, Feature.TREE, createOak(belowTrunkProvider).decorators(ImmutableList.of(sparseLeafLitter, thickLeafLitter)).build());
      FeatureUtils.register(context, DARK_OAK_LEAF_LITTER, Feature.TREE, createDarkOak(belowTrunkProvider).ignoreVines().decorators(ImmutableList.of(sparseLeafLitter, thickLeafLitter)).build());
      FeatureUtils.register(context, BIRCH_LEAF_LITTER, Feature.TREE, createBirch(belowTrunkProvider).decorators(ImmutableList.of(sparseLeafLitter, thickLeafLitter)).build());
      FeatureUtils.register(context, FANCY_OAK_LEAF_LITTER, Feature.TREE, createFancyOak(belowTrunkProvider).decorators(List.of(sparseLeafLitter, thickLeafLitter)).build());
