...
public class NetherFeatures {
   ...
   public static void bootstrap(final BootstrapContext<Feature> context) {
      ...
      context.register(GLOWSTONE_EXTRA, new RandomNeighborSpreadFeature(BlockStateProvider.holderOf(Blocks.GLOWSTONE), HolderSet.direct(blocks.getOrThrow(BlockItemIds.GLOWSTONE.block())), BlockPredicate.ONLY_IN_AIR_PREDICATE, ConstantInt.of(1500), TrapezoidInt.triangle(7), UniformInt.of(-11, 0)));
   ...
   private static Feature createVines(final int minHeight, final int maxHeight, final Direction direction, final Block mainBlock, final Block tipBlock) {
      ...
      return new BlockColumnFeature(List.of(BlockColumnFeature.layer(mainHeight, BlockStateProvider.of(mainBlock)), BlockColumnFeature.layer(ConstantInt.of(1), new RandomizedIntStateProvider(BlockStateProvider.of(tipBlock), GrowingPlantHeadBlock.AGE, UniformInt.of(17, 25)))), direction, BlockPredicate.ONLY_IN_AIR_PREDICATE, true);
   }
}
