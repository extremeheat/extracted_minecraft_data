...
public class Structures {
      ...
      new JigsawStructure(
         structure(
            ...
            Arrays.stream(MobCategory.values())
               .collect(
                  Collectors.toMap(
                     var0 -> var0, var0 -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedRandomList.create())
                  )
               ),
            GenerationStep.Decoration.UNDERGROUND_DECORATION,
   ...
   private static Structure.StructureSettings structure(
      TagKey<Biome> var0, Map<MobCategory, StructureSpawnOverride> var1, GenerationStep.Decoration var2, TerrainAdjustment var3
   ) {
   ...
   private static Holder<Structure> register(ResourceKey<Structure> var0, Structure var1) {
      return BuiltinRegistries.register(BuiltinRegistries.STRUCTURES, var0, var1);
   }
