...
public class Structures {
   ...
   public static void bootstrap(BootstrapContext<Structure> var0) {
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_PILLAGER_OUTPOST))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
      ...
      var0.register(
         ...
         new MineshaftStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_MINESHAFT))
      ...
      var0.register(
         ...
         new MineshaftStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_MINESHAFT_MESA))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
               .build(),
      ...
      var0.register(
         BuiltinStructures.WOODLAND_MANSION, new WoodlandMansionStructure(new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_WOODLAND_MANSION)))
      );
      ...
      var0.register(
         BuiltinStructures.DESERT_PYRAMID, new DesertPyramidStructure(new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_DESERT_PYRAMID)))
      );
      ...
      var0.register(
         BuiltinStructures.SHIPWRECK_BEACHED, new ShipwreckStructure(new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_SHIPWRECK_BEACHED)), true)
      );
      var0.register(
         BuiltinStructures.SWAMP_HUT,
         new SwampHutStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_SWAMP_HUT))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
                     new StructureSpawnOverride(
      ...
      var0.register(
         ...
         new StrongholdStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_STRONGHOLD)).terrainAdapation(TerrainAdjustment.BURY).build()
         )
      );
      var0.register(
         BuiltinStructures.OCEAN_MONUMENT,
         new OceanMonumentStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_OCEAN_MONUMENT))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
                     new StructureSpawnOverride(
      ...
      var0.register(
         ...
         new OceanRuinStructure(new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_OCEAN_RUIN_COLD)), OceanRuinStructure.Type.COLD, 0.3F, 0.9F)
      );
      var0.register(
         BuiltinStructures.OCEAN_RUIN_WARM,
         new OceanRuinStructure(new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_OCEAN_RUIN_WARM)), OceanRuinStructure.Type.WARM, 0.3F, 0.9F)
      );
      var0.register(
         BuiltinStructures.FORTRESS,
         new NetherFortressStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_NETHER_FORTRESS))
               .spawnOverrides(
                  Map.of(
      ...
      var0.register(
         ...
         new NetherFossilStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_NETHER_FOSSIL))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_DECORATION)
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      var0.register(
         ...
         new BuriedTreasureStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_BURIED_TREASURE))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
               .build()
         )
      );
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_BASTION_REMNANT)),
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_VILLAGE_PLAINS)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_VILLAGE_DESERT)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_VILLAGE_SAVANNA)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_VILLAGE_SNOWY)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_VILLAGE_TAIGA)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      var0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_DESERT)),
      ...
      var0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_JUNGLE)),
      ...
      var0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_SWAMP)),
      ...
      var0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_MOUNTAIN)),
            List.of(
      ...
      var0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_OCEAN)),
      ...
      var0.register(
         ...
         new RuinedPortalStructure(
            new Structure.StructureSettings(var1.getOrThrow(BiomeTags.HAS_RUINED_PORTAL_NETHER)),
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_ANCIENT_CITY))
               .spawnOverrides(
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_TRAIL_RUINS))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
      ...
      var0.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(var1.getOrThrow(BiomeTags.HAS_TRIAL_CHAMBERS))
               .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
