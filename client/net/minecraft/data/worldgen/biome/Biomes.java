...
public abstract class Biomes {
   ...
   private static Biome register(ResourceKey<Biome> var0, Biome var1) {
      return (Biome)BuiltinRegistries.registerMapping(BuiltinRegistries.BIOME, var0, var1);
   }

   static {
      THE_VOID = register(net.minecraft.world.level.biome.Biomes.THE_VOID, OverworldBiomes.theVoid());
      PLAINS = register(net.minecraft.world.level.biome.Biomes.PLAINS, OverworldBiomes.plains(false, false, false));
