...
public class NetherBiomes {
   ...
   public static Biome netherWastes(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      MobSpawnSettings mobSpawnSettings = (new MobSpawnSettings.Builder()).addSpawn(EntityTypes.GHAST, 50, 4, 4).addSpawn(EntityTypes.ZOMBIFIED_PIGLIN, 100, 4, 4).addSpawn(EntityTypes.MAGMA_CUBE, 2, 4, 4).addSpawn(EntityTypes.ENDERMAN, 1, 4, 4).addSpawn(EntityTypes.PIGLIN, 15, 4, 4).addSpawn(EntityTypes.STRIDER, 60, 1, 2).build();
   ...
   public static Biome soulSandValley(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      ...
      MobSpawnSettings mobSpawnSettings = (new MobSpawnSettings.Builder()).addSpawn(EntityTypes.SKELETON, 20, 5, 5).addSpawn(EntityTypes.GHAST, 50, 4, 4).addSpawn(EntityTypes.ENDERMAN, 1, 4, 4).addSpawn(EntityTypes.STRIDER, 60, 1, 2).addMobSpawnCost(EntityTypes.SKELETON, 0.7, 0.15).addMobSpawnCost(EntityTypes.GHAST, 0.7, 0.15).addMobSpawnCost(EntityTypes.ENDERMAN, 0.7, 0.15).addMobSpawnCost(EntityTypes.STRIDER, 0.7, 0.15).build();
      ...
      BiomeDefaultFeatures.addNetherDefaultOres(generation);
      return baseBiome().setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(-14989499)).setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_SOUL_SAND_VALLEY)).modifyAttribute(EnvironmentAttributes.AMBIENT_PARTICLES, ListModifier.append(), AmbientParticle.of(ParticleTypes.ASH, 0.00625F)).setAttribute(EnvironmentAttributes.AMBIENT_SOUNDS, new AmbientSounds(Optional.of(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_LOOP), Optional.of(new AmbientMoodSettings(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_MOOD, 6000, 8, 2.0)), List.of(new AmbientAdditionsSettings(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_ADDITIONS, 0.0111)))).mobSpawnSettings(mobSpawnSettings).generationSettings(generation.build()).build();
   }

   public static Biome basaltDeltas(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      MobSpawnSettings mobSpawnSettings = (new MobSpawnSettings.Builder()).addSpawn(EntityTypes.GHAST, 40, 1, 1).addSpawn(EntityTypes.MAGMA_CUBE, 100, 2, 5).addSpawn(EntityTypes.STRIDER, 60, 1, 2).build();
   ...
   public static Biome crimsonForest(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      ...
      BiomeDefaultFeatures.addNetherDefaultOres(generation);
      return baseBiome().setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(-13434109)).setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_CRIMSON_FOREST)).modifyAttribute(EnvironmentAttributes.AMBIENT_PARTICLES, ListModifier.append(), AmbientParticle.of(ParticleTypes.CRIMSON_SPORE, 0.025F)).setAttribute(EnvironmentAttributes.AMBIENT_SOUNDS, new AmbientSounds(Optional.of(SoundEvents.AMBIENT_CRIMSON_FOREST_LOOP), Optional.of(new AmbientMoodSettings(SoundEvents.AMBIENT_CRIMSON_FOREST_MOOD, 6000, 8, 2.0)), List.of(new AmbientAdditionsSettings(SoundEvents.AMBIENT_CRIMSON_FOREST_ADDITIONS, 0.0111)))).mobSpawnSettings(mobSpawnSettings).generationSettings(generation.build()).build();
   }

   public static Biome warpedForest(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      MobSpawnSettings mobSpawnSettings = (new MobSpawnSettings.Builder()).addSpawn(EntityTypes.ENDERMAN, 1, 4, 4).addSpawn(EntityTypes.STRIDER, 60, 1, 2).addMobSpawnCost(EntityTypes.ENDERMAN, 1.0, 0.12).build();
      BiomeGenerationSettings.Builder generation = (new BiomeGenerationSettings.Builder(placedFeatures, carvers)).addCarver(Carvers.NETHER_CAVE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, MiscOverworldPlacements.SPRING_LAVA);
      BiomeDefaultFeatures.addDefaultMushrooms(generation);
