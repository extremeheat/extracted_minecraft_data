...
public class OverworldBiomes {
   ...
   private static Biome biome(Biome.Precipitation var0, Biome.BiomeCategory var1, float var2, float var3, MobSpawnSettings.Builder var4, BiomeGenerationSettings.Builder var5, @Nullable Music var6) {
      return biome(var0, var1, var2, var3, 4159204, 329011, var4, var5, var6);
   }

   private static Biome biome(Biome.Precipitation var0, Biome.BiomeCategory var1, float var2, float var3, int var4, int var5, MobSpawnSettings.Builder var6, BiomeGenerationSettings.Builder var7, @Nullable Music var8) {
      return (new Biome.BiomeBuilder()).precipitation(var0).biomeCategory(var1).temperature(var2).downfall(var3).specialEffects((new BiomeSpecialEffects.Builder()).waterColor(var4).waterFogColor(var5).fogColor(12638463).skyColor(calculateSkyColor(var2)).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).backgroundMusic(var8).build()).mobSpawnSettings(var6.build()).generationSettings(var7.build()).build();
   }
   ...
   public static Biome oldGrowthTaiga(boolean var0) {
      ...
      return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, var0 ? 0.25F : 0.3F, 0.8F, var1, var2, NORMAL_MUSIC);
   }
   ...
   private static Biome baseJungle(float var0, boolean var1, boolean var2, boolean var3, MobSpawnSettings.Builder var4) {
      ...
      return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.JUNGLE, 0.95F, var0, var4, var5, NORMAL_MUSIC);
   }
   ...
   public static Biome windsweptHills(boolean var0) {
      ...
      return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.2F, 0.3F, var1, var2, NORMAL_MUSIC);
   }
   ...
   public static Biome plains(boolean var0, boolean var1, boolean var2) {
      ...
      return biome(var1 ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, var1 ? Biome.BiomeCategory.ICY : Biome.BiomeCategory.PLAINS, var5, var1 ? 0.5F : 0.4F, var3, var4, NORMAL_MUSIC);
   }
   ...
   public static Biome savanna(boolean var0, boolean var1) {
      ...
      return biome(Biome.Precipitation.NONE, Biome.BiomeCategory.SAVANNA, 2.0F, 0.0F, var3, var2, NORMAL_MUSIC);
   }
   ...
   private static Biome baseOcean(MobSpawnSettings.Builder var0, int var1, int var2, BiomeGenerationSettings.Builder var3) {
      return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.OCEAN, 0.5F, 0.5F, var1, var2, var0, var3, NORMAL_MUSIC);
   }
   ...
   public static Biome forest(boolean var0, boolean var1, boolean var2) {
      ...
      return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, var5, var0 ? 0.6F : 0.8F, var4, var3, NORMAL_MUSIC);
   }
   ...
   public static Biome taiga(boolean var0) {
      ...
      return biome(var0 ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, Biome.BiomeCategory.TAIGA, var2, var0 ? 0.4F : 0.8F, var0 ? 4020182 : 4159204, 329011, var1, var3, NORMAL_MUSIC);
   }
   ...
   public static Biome river(boolean var0) {
      ...
      return biome(var0 ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, Biome.BiomeCategory.RIVER, var3, 0.5F, var0 ? 3750089 : 4159204, 329011, var1, var2, NORMAL_MUSIC);
   }
   ...
   public static Biome beach(boolean var0, boolean var1) {
      ...
      return biome(var0 ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, Biome.BiomeCategory.BEACH, var5, var3 ? 0.4F : 0.3F, var0 ? 4020182 : 4159204, 329011, var2, var4, NORMAL_MUSIC);
   }
