...
public class SurfaceRuleData {
   ...
   public static SurfaceRules.RuleSource overworldLike(final HolderGetter<Biome> biomes, final boolean doPreliminarySurfaceCheck, final boolean bedrockRoof, final boolean bedrockFloor) {
      ...
      SurfaceRules.RuleSource commonSurfaceAndUnderRules = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.STONY_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.CALCITE, -0.0125, 0.0125), CALCITE), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.STONY_SHORE), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.GRAVEL, -0.05, 0.05), gravelOrStoneIfCeiling), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.WINDSWEPT_HILLS), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), STONE)), SurfaceRules.ifTrue(biomesWithSandAndSandstone, sandOrSandstoneIfCeiling), SurfaceRules.ifTrue(biomesWithSandAndVeryDeepSandstone, sandOrSandstoneIfCeiling), SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.DRIPSTONE_CAVES), STONE));
      ...
      builder.add(SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.SULFUR_CAVES), SurfaceRules.noiseGradient(Noises.SULFUR_CAVE_GRADIENT, List.of(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(TUFF), Optional.of(CINNABAR), Optional.of(CINNABAR), Optional.of(GRANITE), Optional.of(SULFUR), Optional.of(SULFUR), Optional.of(SULFUR), Optional.of(SULFUR), Optional.of(SULFUR), Optional.of(SULFUR)))));
