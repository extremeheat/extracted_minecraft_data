...
public class SurfaceRuleData {
   ...
   public static SurfaceRules.RuleSource overworldLike(boolean var0, boolean var1, boolean var2) {
      ...
      SurfaceRules.RuleSource var21 = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.STONY_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.CALCITE, -0.0125, 0.0125), CALCITE), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.STONY_SHORE), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.GRAVEL, -0.05, 0.05), var18), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_HILLS), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), STONE)), SurfaceRules.ifTrue(var19, var17), SurfaceRules.ifTrue(var20, var17), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.DRIPSTONE_CAVES), STONE));
      ...
      SurfaceRules.RuleSource var24 = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.FROZEN_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(var15, PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.PACKED_ICE, -0.5, 0.2), PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.ICE, -0.0625, 0.025), ICE), SurfaceRules.ifTrue(var11, SNOW_BLOCK))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.SNOWY_SLOPES), SurfaceRules.sequence(SurfaceRules.ifTrue(var15, STONE), var22, SurfaceRules.ifTrue(var11, SNOW_BLOCK))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.JAGGED_PEAKS), STONE), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.GROVE), SurfaceRules.sequence(var22, DIRT)), var21, SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_SAVANNA), SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_GRAVELLY_HILLS), SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(2.0), var18), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), STONE), SurfaceRules.ifTrue(surfaceNoiseAbove(-1.0), DIRT), var18)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.MANGROVE_SWAMP), MUD), DIRT);
      SurfaceRules.ConditionSource var25 = SurfaceRules.yBlockCheck(VerticalAnchor.absolute(31), 0);
      SurfaceRules.ConditionSource var26 = SurfaceRules.yBlockCheck(VerticalAnchor.absolute(32), 0);
      SurfaceRules.ConditionSource var27 = SurfaceRules.yStartCheck(VerticalAnchor.absolute(30), 0);
      SurfaceRules.ConditionSource var28 = SurfaceRules.not(SurfaceRules.yStartCheck(VerticalAnchor.absolute(35), 0));
      SurfaceRules.ConditionSource var29 = SurfaceRules.noiseCondition(Noises.SOUL_SAND_LAYER, -0.012);
      SurfaceRules.ConditionSource var30 = SurfaceRules.noiseCondition(Noises.GRAVEL_LAYER, -0.012);
      SurfaceRules.ConditionSource var31 = SurfaceRules.noiseCondition(Noises.PATCH, -0.012);
      SurfaceRules.ConditionSource var32 = SurfaceRules.noiseCondition(Noises.NETHERRACK, 0.54);
      SurfaceRules.ConditionSource var33 = SurfaceRules.noiseCondition(Noises.NETHER_WART, 1.17);
      SurfaceRules.ConditionSource var34 = SurfaceRules.noiseCondition(Noises.NETHER_STATE_SELECTOR, 0.0);
      SurfaceRules.RuleSource var35 = SurfaceRules.ifTrue(var31, SurfaceRules.ifTrue(var27, SurfaceRules.ifTrue(var28, GRAVEL)));
      SurfaceRules.RuleSource var36 = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.FROZEN_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(var15, PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.PACKED_ICE, 0.0, 0.2), PACKED_ICE), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.ICE, 0.0, 0.025), ICE), SurfaceRules.ifTrue(var11, SNOW_BLOCK))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.SNOWY_SLOPES), SurfaceRules.sequence(SurfaceRules.ifTrue(var15, STONE), var23, SurfaceRules.ifTrue(var11, SNOW_BLOCK))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.JAGGED_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(var15, STONE), SurfaceRules.ifTrue(var11, SNOW_BLOCK))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.GROVE), SurfaceRules.sequence(var23, SurfaceRules.ifTrue(var11, SNOW_BLOCK))), var21, SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_SAVANNA), SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), STONE), SurfaceRules.ifTrue(surfaceNoiseAbove(-0.5), COARSE_DIRT))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_GRAVELLY_HILLS), SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(2.0), var18), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), STONE), SurfaceRules.ifTrue(surfaceNoiseAbove(-1.0), var16), var18)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA), SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), COARSE_DIRT), SurfaceRules.ifTrue(surfaceNoiseAbove(-0.95), PODZOL))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.ICE_SPIKES), SurfaceRules.ifTrue(var11, SNOW_BLOCK)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.MANGROVE_SWAMP), MUD), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.MUSHROOM_FIELDS), MYCELIUM), var16);
      SurfaceRules.ConditionSource var37 = SurfaceRules.noiseCondition(Noises.SURFACE, -0.909, -0.5454);
      SurfaceRules.ConditionSource var38 = SurfaceRules.noiseCondition(Noises.SURFACE, -0.1818, 0.1818);
      SurfaceRules.ConditionSource var39 = SurfaceRules.noiseCondition(Noises.SURFACE, 0.5454, 0.909);
      SurfaceRules.RuleSource var40 = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.NETHER_WASTES), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.ifTrue(var29, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.not(var13), SurfaceRules.ifTrue(var27, SurfaceRules.ifTrue(var28, SOUL_SAND))), NETHERRACK))), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.ifTrue(var25, SurfaceRules.ifTrue(var28, SurfaceRules.ifTrue(var30, SurfaceRules.sequence(SurfaceRules.ifTrue(var26, GRAVEL), SurfaceRules.ifTrue(SurfaceRules.not(var13), GRAVEL)))))), NETHERRACK)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.BASALT_DELTAS), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.UNDER_CEILING, BASALT), SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.sequence(var35, SurfaceRules.ifTrue(var34, BASALT), BLACKSTONE)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.SOUL_SAND_VALLEY), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.UNDER_CEILING, SurfaceRules.sequence(SurfaceRules.ifTrue(var34, SOUL_SAND), SOUL_SOIL)), SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.sequence(var35, SurfaceRules.ifTrue(var34, SOUL_SAND), SOUL_SOIL)), NETHERRACK)), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.not(var26), SurfaceRules.ifTrue(var13, LAVA)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WARPED_FOREST), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.not(var32), SurfaceRules.ifTrue(var25, SurfaceRules.sequence(SurfaceRules.ifTrue(var33, WARPED_WART_BLOCK), WARPED_NYLIUM))), NETHERRACK)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.CRIMSON_FOREST), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.not(var32), SurfaceRules.ifTrue(var25, SurfaceRules.sequence(SurfaceRules.ifTrue(var33, NETHER_WART_BLOCK), CRIMSON_NYLIUM))), NETHERRACK)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.THE_END), ENDSTONE), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.END_HIGHLANDS), ENDSTONE), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.END_MIDLANDS), ENDSTONE), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.END_BARRENS), ENDSTONE), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.SMALL_END_ISLANDS), ENDSTONE), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WOODED_BADLANDS), SurfaceRules.ifTrue(var3, SurfaceRules.sequence(SurfaceRules.ifTrue(var37, COARSE_DIRT), SurfaceRules.ifTrue(var38, COARSE_DIRT), SurfaceRules.ifTrue(var39, COARSE_DIRT), var16))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.SWAMP), SurfaceRules.ifTrue(var8, SurfaceRules.ifTrue(SurfaceRules.not(var9), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0), WATER)))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.MANGROVE_SWAMP), SurfaceRules.ifTrue(var7, SurfaceRules.ifTrue(SurfaceRules.not(var9), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0), WATER)))))), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.BADLANDS, Biomes.ERODED_BADLANDS, Biomes.WOODED_BADLANDS), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(var4, ORANGE_TERRACOTTA), SurfaceRules.ifTrue(var6, SurfaceRules.sequence(SurfaceRules.ifTrue(var37, TERRACOTTA), SurfaceRules.ifTrue(var38, TERRACOTTA), SurfaceRules.ifTrue(var39, TERRACOTTA), SurfaceRules.bandlands())), SurfaceRules.ifTrue(var10, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_CEILING, RED_SANDSTONE), RED_SAND)), SurfaceRules.ifTrue(SurfaceRules.not(var13), ORANGE_TERRACOTTA), SurfaceRules.ifTrue(var12, WHITE_TERRACOTTA), var18)), SurfaceRules.ifTrue(var5, SurfaceRules.sequence(SurfaceRules.ifTrue(var9, SurfaceRules.ifTrue(SurfaceRules.not(var6), ORANGE_TERRACOTTA)), SurfaceRules.bandlands())), SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.ifTrue(var12, WHITE_TERRACOTTA)))), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.ifTrue(var10, SurfaceRules.sequence(SurfaceRules.ifTrue(var14, SurfaceRules.ifTrue(var13, SurfaceRules.sequence(SurfaceRules.ifTrue(var11, AIR), SurfaceRules.ifTrue(SurfaceRules.temperature(), ICE), WATER))), var36))), SurfaceRules.ifTrue(var12, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.ifTrue(var14, SurfaceRules.ifTrue(var13, WATER))), SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, var24), SurfaceRules.ifTrue(var19, SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR, SANDSTONE)), SurfaceRules.ifTrue(var20, SurfaceRules.ifTrue(SurfaceRules.VERY_DEEP_UNDER_FLOOR, SANDSTONE)))), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS), STONE), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN), var17), var18)));
      ImmutableList.Builder var41 = ImmutableList.builder();
      if (var1) {
         var41.add(SurfaceRules.ifTrue(SurfaceRules.not(SurfaceRules.verticalGradient("bedrock_roof", VerticalAnchor.belowTop(5), VerticalAnchor.top())), BEDROCK));
      }

      if (var2) {
         var41.add(SurfaceRules.ifTrue(SurfaceRules.verticalGradient("bedrock_floor", VerticalAnchor.bottom(), VerticalAnchor.aboveBottom(5)), BEDROCK));
      }

      SurfaceRules.RuleSource var42 = SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), var40);
      var41.add(var0 ? var42 : var40);
      var41.add(SurfaceRules.ifTrue(SurfaceRules.verticalGradient("deepslate", VerticalAnchor.absolute(0), VerticalAnchor.absolute(8)), DEEPSLATE));
      return SurfaceRules.sequence((SurfaceRules.RuleSource[])var41.build().toArray((var0x) -> new SurfaceRules.RuleSource[var0x]));
   }
