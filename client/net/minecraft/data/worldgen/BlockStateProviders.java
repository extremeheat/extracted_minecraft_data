...
public interface BlockStateProviders {
   ResourceKey<BlockStateProvider> CAVE_VINES_BODY = key("cave_vines_body");
   ResourceKey<BlockStateProvider> CAVE_VINES_HEAD = key("cave_vines_head");
   ResourceKey<BlockStateProvider> FLOWER_FLOWER_FOREST = key("flower_flower_forest");
   ResourceKey<BlockStateProvider> FLOWER_MEADOW = key("flower_meadow");
   ResourceKey<BlockStateProvider> FLOWER_PLAIN = key("flower_plain");
   ResourceKey<BlockStateProvider> MANGROVE_PROPAGULE = key("mangrove_propagule");
   ResourceKey<BlockStateProvider> PODZOL_BENEATH_TREE = key("podzol_beneath_tree");
   ResourceKey<BlockStateProvider> SOIL_BENEATH_TREE = key("soil_beneath_tree");

   static void bootstrap(final BootstrapContext<BlockStateProvider> context) {
   ...
   private static ResourceKey<BlockStateProvider> key(final String id) {
