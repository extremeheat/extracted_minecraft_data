...
public class DimensionTypes {
   ...
   public static void bootstrap(final BootstrapContext<DimensionType> context) {
      HolderGetter<Timeline> timelines = context.<Timeline>lookup(Registries.TIMELINE);
