...
public interface StructureSets {
   static void bootstrap(BootstrapContext<StructureSet> var0) {
      ...
      Holder.Reference var3 = var0.register(BuiltinStructureSets.VILLAGES, new StructureSet(List.of(StructureSet.entry(var1.getOrThrow(BuiltinStructures.VILLAGE_PLAINS)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.VILLAGE_DESERT)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.VILLAGE_SAVANNA)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.VILLAGE_SNOWY)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.VILLAGE_TAIGA))), new RandomSpreadStructurePlacement(34, 8, RandomSpreadType.LINEAR, 10387312)));
      ...
      var0.register(BuiltinStructureSets.OCEAN_MONUMENTS, new StructureSet(var1.getOrThrow(BuiltinStructures.OCEAN_MONUMENT), new RandomSpreadStructurePlacement(32, 5, RandomSpreadType.TRIANGULAR, 10387313)));
      var0.register(BuiltinStructureSets.WOODLAND_MANSIONS, new StructureSet(var1.getOrThrow(BuiltinStructures.WOODLAND_MANSION), new RandomSpreadStructurePlacement(80, 20, RandomSpreadType.TRIANGULAR, 10387319)));
      var0.register(BuiltinStructureSets.BURIED_TREASURES, new StructureSet(var1.getOrThrow(BuiltinStructures.BURIED_TREASURE), new RandomSpreadStructurePlacement(new Vec3i(9, 0, 9), StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2, 0.01F, 0, Optional.empty(), 1, 0, RandomSpreadType.LINEAR)));
      var0.register(BuiltinStructureSets.MINESHAFTS, new StructureSet(List.of(StructureSet.entry(var1.getOrThrow(BuiltinStructures.MINESHAFT)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.MINESHAFT_MESA))), new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_3, 0.004F, 0, Optional.empty(), 1, 0, RandomSpreadType.LINEAR)));
      var0.register(BuiltinStructureSets.RUINED_PORTALS, new StructureSet(List.of(StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_STANDARD)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_DESERT)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_JUNGLE)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_SWAMP)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_MOUNTAIN)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_OCEAN)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.RUINED_PORTAL_NETHER))), new RandomSpreadStructurePlacement(40, 15, RandomSpreadType.LINEAR, 34222645)));
      var0.register(BuiltinStructureSets.SHIPWRECKS, new StructureSet(List.of(StructureSet.entry(var1.getOrThrow(BuiltinStructures.SHIPWRECK)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.SHIPWRECK_BEACHED))), new RandomSpreadStructurePlacement(24, 4, RandomSpreadType.LINEAR, 165745295)));
      var0.register(BuiltinStructureSets.OCEAN_RUINS, new StructureSet(List.of(StructureSet.entry(var1.getOrThrow(BuiltinStructures.OCEAN_RUIN_COLD)), StructureSet.entry(var1.getOrThrow(BuiltinStructures.OCEAN_RUIN_WARM))), new RandomSpreadStructurePlacement(20, 8, RandomSpreadType.LINEAR, 14357621)));
