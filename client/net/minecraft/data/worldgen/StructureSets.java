...
public interface StructureSets {
   ...
   Holder<StructureSet> BURIED_TREASURES = register(BuiltinStructureSets.BURIED_TREASURES, Structures.BURIED_TREASURE, new RandomSpreadStructurePlacement(new Vec3i(9, 0, 9), StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2, 0.01F, 0, Optional.empty(), 1, 0, RandomSpreadType.LINEAR));
   Holder<StructureSet> MINESHAFTS = register(BuiltinStructureSets.MINESHAFTS, new StructureSet(List.of(StructureSet.entry(Structures.MINESHAFT), StructureSet.entry(Structures.MINESHAFT_MESA)), new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_3, 0.004F, 0, Optional.empty(), 1, 0, RandomSpreadType.LINEAR)));
   ...
   static Holder<StructureSet> bootstrap(Registry<StructureSet> var0) {
      return (Holder)var0.holders().iterator().next();
   }

   static Holder<StructureSet> register(ResourceKey<StructureSet> var0, StructureSet var1) {
      return BuiltinRegistries.register(BuiltinRegistries.STRUCTURE_SETS, (ResourceKey)var0, var1);
   }

   static Holder<StructureSet> register(ResourceKey<StructureSet> var0, Holder<Structure> var1, StructurePlacement var2) {
      return register(var0, new StructureSet(var1, var2));
   }
}
