...
public class Main {
   ...
   public static DataGenerator createStandardGenerator(
      ...
      CompletableFuture var16 = CompletableFuture.supplyAsync(VanillaRegistries::createLookup, Util.backgroundExecutor());
      ...
      var13.addProvider(bindRegistries(RegistriesDatapackGenerator::new, var16));
      var13.addProvider(bindRegistries(VanillaAdvancementProvider::create, var16));
      var13.addProvider(VanillaLootTableProvider::create);
      var13.addProvider(VanillaRecipeProvider::new);
      TagsProvider var17 = var13.addProvider(bindRegistries(VanillaBlockTagsProvider::new, var16));
      TagsProvider var12 = var13.addProvider(var2x -> new VanillaItemTagsProvider(var2x, var16, var17.contentsGetter()));
      var13.addProvider(bindRegistries(BannerPatternTagsProvider::new, var16));
      var13.addProvider(bindRegistries(BiomeTagsProvider::new, var16));
      var13.addProvider(bindRegistries(CatVariantTagsProvider::new, var16));
      var13.addProvider(bindRegistries(DamageTypeTagsProvider::new, var16));
      var13.addProvider(bindRegistries(EntityTypeTagsProvider::new, var16));
      var13.addProvider(bindRegistries(FlatLevelGeneratorPresetTagsProvider::new, var16));
      var13.addProvider(bindRegistries(FluidTagsProvider::new, var16));
      var13.addProvider(bindRegistries(GameEventTagsProvider::new, var16));
      var13.addProvider(bindRegistries(InstrumentTagsProvider::new, var16));
      var13.addProvider(bindRegistries(PaintingVariantTagsProvider::new, var16));
      var13.addProvider(bindRegistries(PoiTypeTagsProvider::new, var16));
      var13.addProvider(bindRegistries(StructureTagsProvider::new, var16));
      var13.addProvider(bindRegistries(WorldPresetTagsProvider::new, var16));
      var13 = var9.getVanillaPack(var4);
      var13.addProvider(var1x -> new NbtToSnbt(var1x, var1));
      var13 = var9.getVanillaPack(var5);
      var13.addProvider(bindRegistries(BiomeParametersDumpReport::new, var16));
      var13.addProvider(BlockListReport::new);
      var13.addProvider(bindRegistries(CommandsReport::new, var16));
      ...
      CompletableFuture var21 = UpdateOneTwentyRegistries.createLookup(var16);
      DataGenerator.PackGenerator var14 = var9.getBuiltinDatapack(var3, "update_1_20");
      var14.addProvider(UpdateOneTwentyRecipeProvider::new);
      TagsProvider var15 = var14.addProvider(var2x -> new UpdateOneTwentyBlockTagsProvider(var2x, var21, var17.contentsGetter()));
      var14.addProvider(var3x -> new UpdateOneTwentyItemTagsProvider(var3x, var21, var12.contentsGetter(), var15.contentsGetter()));
      var14.addProvider(bindRegistries(UpdateOneTwentyBiomeTagsProvider::new, var21));
      var14.addProvider(UpdateOneTwentyLootTableProvider::create);
      var14.addProvider(bindRegistries(UpdateOneTwentyVanillaAdvancementProvider::create, var21));
      var14.addProvider(bindRegistries(RegistriesDatapackGenerator::new, var21));
      var14.addProvider(
