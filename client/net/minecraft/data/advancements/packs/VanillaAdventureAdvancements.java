...
public class VanillaAdventureAdvancements implements AdvancementSubProvider {
   ...
   private static Advancement.Builder smithingWithStyle(Advancement.Builder var0) {
      ...
      VanillaRecipeProvider.smithingTrims().filter((var1x) -> var1.contains(var1x.template())).forEach((var1x) -> var0.addCriterion("armor_trimmed_" + String.valueOf(var1x.id().location()), RecipeCraftedTrigger.TriggerInstance.craftedItem(var1x.id())));
      return var0;
   }
   ...
   private static Advancement.Builder craftingANewLook(Advancement.Builder var0) {
      ...
      VanillaRecipeProvider.smithingTrims().map(VanillaRecipeProvider.TrimTemplate::id).forEach((var1) -> var0.addCriterion("armor_trimmed_" + String.valueOf(var1.location()), RecipeCraftedTrigger.TriggerInstance.craftedItem(var1)));
      return var0;
   }
