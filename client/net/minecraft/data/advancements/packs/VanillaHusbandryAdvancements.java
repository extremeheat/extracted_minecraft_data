...
public class VanillaHusbandryAdvancements extends AdvancementSubProvider {
   ...
   public void generate() {
      ...
      this.addFood(Advancement.Builder.advancement()).parent(plantSeed).display((ItemLike)Items.APPLE, Component.translatable("advancements.husbandry.balanced_diet.title"), Component.translatable("advancements.husbandry.balanced_diet.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(this.output, "husbandry/balanced_diet");
      ...
      AdvancementHolder fishyBusiness = this.addFish(Advancement.Builder.advancement()).parent(root).requirements(AdvancementRequirements.Strategy.OR).display((ItemLike)Items.FISHING_ROD, Component.translatable("advancements.husbandry.fishy_business.title"), Component.translatable("advancements.husbandry.fishy_business.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/fishy_business");
      AdvancementHolder tacticalFishing = this.addFishBuckets(Advancement.Builder.advancement()).parent(fishyBusiness).requirements(AdvancementRequirements.Strategy.OR).display((ItemLike)Items.PUFFERFISH_BUCKET, Component.translatable("advancements.husbandry.tactical_fishing.title"), Component.translatable("advancements.husbandry.tactical_fishing.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/tactical_fishing");
      AdvancementHolder theCutestPredetor = Advancement.Builder.advancement().parent(tacticalFishing).requirements(AdvancementRequirements.Strategy.OR).addCriterion(BuiltInRegistries.ITEM.getKey(Items.AXOLOTL_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(this.items, Items.AXOLOTL_BUCKET))).display((ItemLike)Items.AXOLOTL_BUCKET, Component.translatable("advancements.husbandry.axolotl_in_a_bucket.title"), Component.translatable("advancements.husbandry.axolotl_in_a_bucket.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/axolotl_in_a_bucket");
      Advancement.Builder.advancement().parent(theCutestPredetor).addCriterion("kill_axolotl_target", EffectsChangedTrigger.TriggerInstance.gotEffectsFrom(EntityPredicate.Builder.entity().of(this.entityTypes, EntityTypes.AXOLOTL))).display((ItemLike)Items.TROPICAL_FISH_BUCKET, Component.translatable("advancements.husbandry.kill_axolotl_target.title"), Component.translatable("advancements.husbandry.kill_axolotl_target.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/kill_axolotl_target");
      this.addCatVariants(Advancement.Builder.advancement()).parent(tameAnAnimal).display((ItemLike)Items.COD, Component.translatable("advancements.husbandry.complete_catalogue.title"), Component.translatable("advancements.husbandry.complete_catalogue.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(this.output, "husbandry/complete_catalogue");
      this.addTamedWolfVariants(Advancement.Builder.advancement()).parent(tameAnAnimal).display((ItemLike)Items.BONE, Component.translatable("advancements.husbandry.whole_pack.title"), Component.translatable("advancements.husbandry.whole_pack.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(this.output, "husbandry/whole_pack");
      AdvancementHolder safelyHarvestHoney = Advancement.Builder.advancement().parent(root).addCriterion("safely_harvest_honey", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(this.blocks, BlockTags.BEEHIVES)).setSmokey(true), ItemPredicate.Builder.item().of(this.items, Items.GLASS_BOTTLE))).display((ItemLike)Items.HONEY_BOTTLE, Component.translatable("advancements.husbandry.safely_harvest_honey.title"), Component.translatable("advancements.husbandry.safely_harvest_honey.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/safely_harvest_honey");
      ...
      AdvancementHolder tadpoleInABucket = Advancement.Builder.advancement().parent(root).addCriterion(BuiltInRegistries.ITEM.getKey(Items.TADPOLE_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(this.items, Items.TADPOLE_BUCKET))).display((ItemLike)Items.TADPOLE_BUCKET, Component.translatable("advancements.husbandry.tadpole_in_a_bucket.title"), Component.translatable("advancements.husbandry.tadpole_in_a_bucket.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/tadpole_in_a_bucket");
      AdvancementHolder allFrogsOnALeash = this.addLeashedFrogVariants(Advancement.Builder.advancement()).parent(tadpoleInABucket).display((ItemLike)Items.LEAD, Component.translatable("advancements.husbandry.leash_all_frog_variants.title"), Component.translatable("advancements.husbandry.leash_all_frog_variants.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/leash_all_frog_variants");
      ...
      Advancement.Builder.advancement().parent(root).addCriterion("silk_touch_nest", BeeNestDestroyedTrigger.TriggerInstance.destroyedBeeNest(Blocks.BEE_NEST, ItemPredicate.Builder.item().withComponents(DataComponentMatchers.Builder.components().partial(DataComponentPredicates.ENCHANTMENTS, EnchantmentsPredicate.enchantments(List.of(new EnchantmentPredicate(this.enchantments.getOrThrow(Enchantments.SILK_TOUCH), MinMaxBounds.Ints.atLeast(1))))).build()), MinMaxBounds.Ints.exactly(3))).display((ItemLike)Blocks.BEE_NEST, Component.translatable("advancements.husbandry.silk_touch_nest.title"), Component.translatable("advancements.husbandry.silk_touch_nest.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/silk_touch_nest");
   ...
   public AdvancementHolder createBreedAllAnimalsAdvancement(final AdvancementHolder parent, final Stream<EntityType<?>> breedable, final Stream<EntityType<?>> indirectlyBreedable) {
      return this.addBreedable(Advancement.Builder.advancement(), breedable, indirectlyBreedable).parent(parent).display((ItemLike)Items.GOLDEN_CARROT, Component.translatable("advancements.husbandry.breed_all_animals.title"), Component.translatable("advancements.husbandry.breed_all_animals.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(this.output, "husbandry/bred_all_animals");
   }
