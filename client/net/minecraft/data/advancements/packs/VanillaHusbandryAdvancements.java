...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider var1, Consumer<AdvancementHolder> var2) {
      ...
      AdvancementHolder var17 = Advancement.Builder.advancement().parent(var10).addCriterion("safely_harvest_honey", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(var5, (TagKey)BlockTags.BEEHIVES)).setSmokey(true), ItemPredicate.Builder.item().of(var4, Items.GLASS_BOTTLE))).display((ItemLike)Items.HONEY_BOTTLE, Component.translatable("advancements.husbandry.safely_harvest_honey.title"), Component.translatable("advancements.husbandry.safely_harvest_honey.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(var2, "husbandry/safely_harvest_honey");
      ...
      AdvancementHolder var19 = Advancement.Builder.advancement().parent(var10).addCriterion(BuiltInRegistries.ITEM.getKey(Items.TADPOLE_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(var4, Items.TADPOLE_BUCKET))).display((ItemLike)Items.TADPOLE_BUCKET, Component.translatable("advancements.husbandry.tadpole_in_a_bucket.title"), Component.translatable("advancements.husbandry.tadpole_in_a_bucket.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(var2, "husbandry/tadpole_in_a_bucket");
      ...
      Advancement.Builder.advancement().parent(var10).display((ItemLike)Items.OAK_BOAT, Component.translatable("advancements.husbandry.ride_a_boat_with_a_goat.title"), Component.translatable("advancements.husbandry.ride_a_boat_with_a_goat.description"), (Identifier)null, AdvancementType.TASK, true, true, false).addCriterion("ride_a_boat_with_a_goat", StartRidingTrigger.TriggerInstance.playerStartsRiding(EntityPredicate.Builder.entity().vehicle(EntityPredicate.Builder.entity().of(var3, EntityTypeTags.BOAT).passenger(EntityPredicate.Builder.entity().of(var3, EntityType.GOAT))))).save(var2, "husbandry/ride_a_boat_with_a_goat");
      ...
      AdvancementHolder var23 = Advancement.Builder.advancement().parent(var22).display((ItemLike)Items.TORCHFLOWER_SEEDS, Component.translatable("advancements.husbandry.feed_snifflet.title"), Component.translatable("advancements.husbandry.feed_snifflet.description"), (Identifier)null, AdvancementType.TASK, true, true, true).addCriterion("feed_snifflet", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(var4, (TagKey)ItemTags.SNIFFER_FOOD), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(var3, EntityType.SNIFFER).flags(EntityFlagsPredicate.Builder.flags().setIsBaby(true)))))).save(var2, "husbandry/feed_snifflet");
   ...
   private static Advancement.Builder addLeashedFrogVariants(HolderGetter<EntityType<?>> var0, HolderGetter<Item> var1, HolderLookup<FrogVariant> var2, Advancement.Builder var3) {
      sortedVariants(var2).forEach((var3x) -> var3.addCriterion(var3x.key().identifier().toString(), PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(var1, Items.LEAD), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(var0, EntityType.FROG).components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.FROG_VARIANT, var3x)).build()))))));
      return var3;
   }
   ...
   private static Advancement.Builder addCatVariants(Advancement.Builder var0, HolderLookup<CatVariant> var1) {
      sortedVariants(var1).forEach((var1x) -> var0.addCriterion(var1x.key().identifier().toString(), TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.CAT_VARIANT, var1x)).build()))));
      return var0;
   }

   private static Advancement.Builder addTamedWolfVariants(Advancement.Builder var0, HolderLookup<WolfVariant> var1) {
      sortedVariants(var1).forEach((var1x) -> var0.addCriterion(var1x.key().identifier().toString(), TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.WOLF_VARIANT, var1x)).build()))));
      return var0;
   }
   ...
   static {
      ...
      HOLDER_KEY_COMPARATOR = Comparator.comparing((var0) -> var0.key().identifier());
   }
}
