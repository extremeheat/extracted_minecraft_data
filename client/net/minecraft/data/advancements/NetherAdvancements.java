...
public class NetherAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> var1) {
      ...
      Advancement var3 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/return_to_sender");
      Advancement var4 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/find_fortress");
      ...
      Advancement var5 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/get_wither_skull");
      ...
      Advancement var7 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/obtain_blaze_rod");
      Advancement var8 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/create_beacon");
      Advancement.Builder.advancement()
         .parent(var8)
         .display(
            Blocks.BEACON,
         ...
         .save(var1, "nether/create_full_beacon");
      ...
      Advancement var11 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/obtain_ancient_debris");
      Advancement.Builder.advancement()
         .parent(var11)
         .display(
         ...
         .save(var1, "nether/netherite_armor");
      Advancement.Builder.advancement()
         .parent(var11)
         .display(
            Items.LODESTONE,
         ...
         .save(var1, "nether/use_lodestone");
      Advancement var12 = Advancement.Builder.advancement()
         ...
         .save(var1, "nether/obtain_crying_obsidian");
      Advancement.Builder.advancement()
         .parent(var12)
         .display(
         ...
         .save(var1, "nether/charge_respawn_anchor");
      ...
      Advancement.Builder.advancement()
         ...
         .save(var1, "nether/ride_strider_in_overworld_lava");
      AdventureAdvancements.addBiomes(Advancement.Builder.advancement(), EXPLORABLE_BIOMES)
         ...
         .save(var1, "nether/explore_nether");
      ...
      Advancement.Builder.advancement()
         ...
         .save(var1, "nether/distract_piglin");
   }
}
