...
public class RecipeProvider implements DataProvider {
   ...
   private static void buildCraftingRecipes(Consumer<FinishedRecipe> var0) {
      ...
      chiseledBuilder(Blocks.CHISELED_QUARTZ_BLOCK, Ingredient.method_110(Blocks.QUARTZ_SLAB)).unlockedBy("has_chiseled_quartz_block", has((ItemLike)Blocks.CHISELED_QUARTZ_BLOCK)).unlockedBy("has_quartz_block", has((ItemLike)Blocks.QUARTZ_BLOCK)).unlockedBy("has_quartz_pillar", has((ItemLike)Blocks.QUARTZ_PILLAR)).save(var0);
      chiseledBuilder(Blocks.CHISELED_STONE_BRICKS, Ingredient.method_110(Blocks.STONE_BRICK_SLAB)).unlockedBy("has_tag", has((Tag)ItemTags.STONE_BRICKS)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.DAYLIGHT_DETECTOR).define('Q', (ItemLike)Items.QUARTZ).define('G', (ItemLike)Blocks.GLASS).define('W', Ingredient.method_113(ItemTags.WOODEN_SLABS)).pattern("GGG").pattern("QQQ").pattern("WWW").unlockedBy("has_quartz", has((ItemLike)Items.QUARTZ)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.FIRE_CHARGE, 3).requires((ItemLike)Items.GUNPOWDER).requires((ItemLike)Items.BLAZE_POWDER).requires(Ingredient.method_110(Items.COAL, Items.CHARCOAL)).unlockedBy("has_blaze_powder", has((ItemLike)Items.BLAZE_POWDER)).save(var0);
      ...
      doorBuilder(Blocks.IRON_DOOR, Ingredient.method_110(Items.IRON_INGOT)).unlockedBy(getHasName(Items.IRON_INGOT), has((ItemLike)Items.IRON_INGOT)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Items.PAINTING).define('#', (ItemLike)Items.STICK).define('X', Ingredient.method_113(ItemTags.WOOL)).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_wool", has((Tag)ItemTags.WOOL)).save(var0);
      ...
      slabBuilder(Blocks.PURPUR_SLAB, Ingredient.method_110(Blocks.PURPUR_BLOCK, Blocks.PURPUR_PILLAR)).unlockedBy("has_purpur_block", has((ItemLike)Blocks.PURPUR_BLOCK)).save(var0);
      stairBuilder(Blocks.PURPUR_STAIRS, Ingredient.method_110(Blocks.PURPUR_BLOCK, Blocks.PURPUR_PILLAR)).unlockedBy("has_purpur_block", has((ItemLike)Blocks.PURPUR_BLOCK)).save(var0);
      ...
      slabBuilder(Blocks.QUARTZ_SLAB, Ingredient.method_110(Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_PILLAR)).unlockedBy("has_chiseled_quartz_block", has((ItemLike)Blocks.CHISELED_QUARTZ_BLOCK)).unlockedBy("has_quartz_block", has((ItemLike)Blocks.QUARTZ_BLOCK)).unlockedBy("has_quartz_pillar", has((ItemLike)Blocks.QUARTZ_PILLAR)).save(var0);
      stairBuilder(Blocks.QUARTZ_STAIRS, Ingredient.method_110(Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_PILLAR)).unlockedBy("has_chiseled_quartz_block", has((ItemLike)Blocks.CHISELED_QUARTZ_BLOCK)).unlockedBy("has_quartz_block", has((ItemLike)Blocks.QUARTZ_BLOCK)).unlockedBy("has_quartz_pillar", has((ItemLike)Blocks.QUARTZ_PILLAR)).save(var0);
      ...
      slabBuilder(Blocks.RED_SANDSTONE_SLAB, Ingredient.method_110(Blocks.RED_SANDSTONE, Blocks.CHISELED_RED_SANDSTONE)).unlockedBy("has_red_sandstone", has((ItemLike)Blocks.RED_SANDSTONE)).unlockedBy("has_chiseled_red_sandstone", has((ItemLike)Blocks.CHISELED_RED_SANDSTONE)).save(var0);
      stairBuilder(Blocks.RED_SANDSTONE_STAIRS, Ingredient.method_110(Blocks.RED_SANDSTONE, Blocks.CHISELED_RED_SANDSTONE, Blocks.CUT_RED_SANDSTONE)).unlockedBy("has_red_sandstone", has((ItemLike)Blocks.RED_SANDSTONE)).unlockedBy("has_chiseled_red_sandstone", has((ItemLike)Blocks.CHISELED_RED_SANDSTONE)).unlockedBy("has_cut_red_sandstone", has((ItemLike)Blocks.CUT_RED_SANDSTONE)).save(var0);
      ...
      slabBuilder(Blocks.SANDSTONE_SLAB, Ingredient.method_110(Blocks.SANDSTONE, Blocks.CHISELED_SANDSTONE)).unlockedBy("has_sandstone", has((ItemLike)Blocks.SANDSTONE)).unlockedBy("has_chiseled_sandstone", has((ItemLike)Blocks.CHISELED_SANDSTONE)).save(var0);
      stairBuilder(Blocks.SANDSTONE_STAIRS, Ingredient.method_110(Blocks.SANDSTONE, Blocks.CHISELED_SANDSTONE, Blocks.CUT_SANDSTONE)).unlockedBy("has_sandstone", has((ItemLike)Blocks.SANDSTONE)).unlockedBy("has_chiseled_sandstone", has((ItemLike)Blocks.CHISELED_SANDSTONE)).unlockedBy("has_cut_sandstone", has((ItemLike)Blocks.CUT_SANDSTONE)).save(var0);
      ...
      slabBuilder(Blocks.STONE_BRICK_SLAB, Ingredient.method_110(Blocks.STONE_BRICKS)).unlockedBy("has_stone_bricks", has((Tag)ItemTags.STONE_BRICKS)).save(var0);
      stairBuilder(Blocks.STONE_BRICK_STAIRS, Ingredient.method_110(Blocks.STONE_BRICKS)).unlockedBy("has_stone_bricks", has((Tag)ItemTags.STONE_BRICKS)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.TNT).define('#', Ingredient.method_110(Blocks.SAND, Blocks.RED_SAND)).define('X', (ItemLike)Items.GUNPOWDER).pattern("X#X").pattern("#X#").pattern("X#X").unlockedBy("has_gunpowder", has((ItemLike)Items.GUNPOWDER)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.TORCH, 4).define('#', (ItemLike)Items.STICK).define('X', Ingredient.method_110(Items.COAL, Items.CHARCOAL)).pattern("X").pattern("#").unlockedBy("has_stone_pickaxe", has((ItemLike)Items.STONE_PICKAXE)).save(var0);
      ShapedRecipeBuilder.shaped(Blocks.SOUL_TORCH, 4).define('X', Ingredient.method_110(Items.COAL, Items.CHARCOAL)).define('#', (ItemLike)Items.STICK).define('S', (Tag)ItemTags.SOUL_FIRE_BASE_BLOCKS).pattern("X").pattern("#").pattern("S").unlockedBy("has_soul_sand", has((Tag)ItemTags.SOUL_FIRE_BASE_BLOCKS)).save(var0);
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.POTATO), Items.BAKED_POTATO, 0.35F, 200).unlockedBy("has_potato", has((ItemLike)Items.POTATO)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.CLAY_BALL), Items.BRICK, 0.3F, 200).unlockedBy("has_clay_ball", has((ItemLike)Items.CLAY_BALL)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_113(ItemTags.LOGS_THAT_BURN), Items.CHARCOAL, 0.15F, 200).unlockedBy("has_log", has((Tag)ItemTags.LOGS_THAT_BURN)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.CHORUS_FRUIT), Items.POPPED_CHORUS_FRUIT, 0.1F, 200).unlockedBy("has_chorus_fruit", has((ItemLike)Items.CHORUS_FRUIT)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.BEEF), Items.COOKED_BEEF, 0.35F, 200).unlockedBy("has_beef", has((ItemLike)Items.BEEF)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.CHICKEN), Items.COOKED_CHICKEN, 0.35F, 200).unlockedBy("has_chicken", has((ItemLike)Items.CHICKEN)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.COD), Items.COOKED_COD, 0.35F, 200).unlockedBy("has_cod", has((ItemLike)Items.COD)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.KELP), Items.DRIED_KELP, 0.1F, 200).unlockedBy("has_kelp", has((ItemLike)Blocks.KELP)).save(var0, getSmeltingRecipeName(Items.DRIED_KELP));
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.SALMON), Items.COOKED_SALMON, 0.35F, 200).unlockedBy("has_salmon", has((ItemLike)Items.SALMON)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.MUTTON), Items.COOKED_MUTTON, 0.35F, 200).unlockedBy("has_mutton", has((ItemLike)Items.MUTTON)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.PORKCHOP), Items.COOKED_PORKCHOP, 0.35F, 200).unlockedBy("has_porkchop", has((ItemLike)Items.PORKCHOP)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.RABBIT), Items.COOKED_RABBIT, 0.35F, 200).unlockedBy("has_rabbit", has((ItemLike)Items.RABBIT)).save(var0);
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_113(ItemTags.SAND), Blocks.GLASS.asItem(), 0.1F, 200).unlockedBy("has_sand", has((Tag)ItemTags.SAND)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.SEA_PICKLE), Items.LIME_DYE, 0.1F, 200).unlockedBy("has_sea_pickle", has((ItemLike)Blocks.SEA_PICKLE)).save(var0, getSmeltingRecipeName(Items.LIME_DYE));
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.CACTUS.asItem()), Items.GREEN_DYE, 1.0F, 200).unlockedBy("has_cactus", has((ItemLike)Blocks.CACTUS)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_AXE, Items.GOLDEN_HOE, Items.GOLDEN_SWORD, Items.GOLDEN_HELMET, Items.GOLDEN_CHESTPLATE, Items.GOLDEN_LEGGINGS, Items.GOLDEN_BOOTS, Items.GOLDEN_HORSE_ARMOR), Items.GOLD_NUGGET, 0.1F, 200).unlockedBy("has_golden_pickaxe", has((ItemLike)Items.GOLDEN_PICKAXE)).unlockedBy("has_golden_shovel", has((ItemLike)Items.GOLDEN_SHOVEL)).unlockedBy("has_golden_axe", has((ItemLike)Items.GOLDEN_AXE)).unlockedBy("has_golden_hoe", has((ItemLike)Items.GOLDEN_HOE)).unlockedBy("has_golden_sword", has((ItemLike)Items.GOLDEN_SWORD)).unlockedBy("has_golden_helmet", has((ItemLike)Items.GOLDEN_HELMET)).unlockedBy("has_golden_chestplate", has((ItemLike)Items.GOLDEN_CHESTPLATE)).unlockedBy("has_golden_leggings", has((ItemLike)Items.GOLDEN_LEGGINGS)).unlockedBy("has_golden_boots", has((ItemLike)Items.GOLDEN_BOOTS)).unlockedBy("has_golden_horse_armor", has((ItemLike)Items.GOLDEN_HORSE_ARMOR)).save(var0, getSmeltingRecipeName(Items.GOLD_NUGGET));
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Items.IRON_PICKAXE, Items.IRON_SHOVEL, Items.IRON_AXE, Items.IRON_HOE, Items.IRON_SWORD, Items.IRON_HELMET, Items.IRON_CHESTPLATE, Items.IRON_LEGGINGS, Items.IRON_BOOTS, Items.IRON_HORSE_ARMOR, Items.CHAINMAIL_HELMET, Items.CHAINMAIL_CHESTPLATE, Items.CHAINMAIL_LEGGINGS, Items.CHAINMAIL_BOOTS), Items.IRON_NUGGET, 0.1F, 200).unlockedBy("has_iron_pickaxe", has((ItemLike)Items.IRON_PICKAXE)).unlockedBy("has_iron_shovel", has((ItemLike)Items.IRON_SHOVEL)).unlockedBy("has_iron_axe", has((ItemLike)Items.IRON_AXE)).unlockedBy("has_iron_hoe", has((ItemLike)Items.IRON_HOE)).unlockedBy("has_iron_sword", has((ItemLike)Items.IRON_SWORD)).unlockedBy("has_iron_helmet", has((ItemLike)Items.IRON_HELMET)).unlockedBy("has_iron_chestplate", has((ItemLike)Items.IRON_CHESTPLATE)).unlockedBy("has_iron_leggings", has((ItemLike)Items.IRON_LEGGINGS)).unlockedBy("has_iron_boots", has((ItemLike)Items.IRON_BOOTS)).unlockedBy("has_iron_horse_armor", has((ItemLike)Items.IRON_HORSE_ARMOR)).unlockedBy("has_chainmail_helmet", has((ItemLike)Items.CHAINMAIL_HELMET)).unlockedBy("has_chainmail_chestplate", has((ItemLike)Items.CHAINMAIL_CHESTPLATE)).unlockedBy("has_chainmail_leggings", has((ItemLike)Items.CHAINMAIL_LEGGINGS)).unlockedBy("has_chainmail_boots", has((ItemLike)Items.CHAINMAIL_BOOTS)).save(var0, getSmeltingRecipeName(Items.IRON_NUGGET));
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.CLAY), Blocks.TERRACOTTA.asItem(), 0.35F, 200).unlockedBy("has_clay_block", has((ItemLike)Blocks.CLAY)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.NETHERRACK), Items.NETHER_BRICK, 0.1F, 200).unlockedBy("has_netherrack", has((ItemLike)Blocks.NETHERRACK)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.NETHER_QUARTZ_ORE), Items.QUARTZ, 0.2F, 200).unlockedBy("has_nether_quartz_ore", has((ItemLike)Blocks.NETHER_QUARTZ_ORE)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.WET_SPONGE), Blocks.SPONGE.asItem(), 0.15F, 200).unlockedBy("has_wet_sponge", has((ItemLike)Blocks.WET_SPONGE)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.COBBLESTONE), Blocks.STONE.asItem(), 0.1F, 200).unlockedBy("has_cobblestone", has((ItemLike)Blocks.COBBLESTONE)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.STONE), Blocks.SMOOTH_STONE.asItem(), 0.1F, 200).unlockedBy("has_stone", has((ItemLike)Blocks.STONE)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.SANDSTONE), Blocks.SMOOTH_SANDSTONE.asItem(), 0.1F, 200).unlockedBy("has_sandstone", has((ItemLike)Blocks.SANDSTONE)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.RED_SANDSTONE), Blocks.SMOOTH_RED_SANDSTONE.asItem(), 0.1F, 200).unlockedBy("has_red_sandstone", has((ItemLike)Blocks.RED_SANDSTONE)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.QUARTZ_BLOCK), Blocks.SMOOTH_QUARTZ.asItem(), 0.1F, 200).unlockedBy("has_quartz_block", has((ItemLike)Blocks.QUARTZ_BLOCK)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.STONE_BRICKS), Blocks.CRACKED_STONE_BRICKS.asItem(), 0.1F, 200).unlockedBy("has_stone_bricks", has((ItemLike)Blocks.STONE_BRICKS)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.BLACK_TERRACOTTA), Blocks.BLACK_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_black_terracotta", has((ItemLike)Blocks.BLACK_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.BLUE_TERRACOTTA), Blocks.BLUE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_blue_terracotta", has((ItemLike)Blocks.BLUE_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.BROWN_TERRACOTTA), Blocks.BROWN_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_brown_terracotta", has((ItemLike)Blocks.BROWN_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.CYAN_TERRACOTTA), Blocks.CYAN_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_cyan_terracotta", has((ItemLike)Blocks.CYAN_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.GRAY_TERRACOTTA), Blocks.GRAY_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_gray_terracotta", has((ItemLike)Blocks.GRAY_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.GREEN_TERRACOTTA), Blocks.GREEN_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_green_terracotta", has((ItemLike)Blocks.GREEN_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.LIGHT_BLUE_TERRACOTTA), Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_light_blue_terracotta", has((ItemLike)Blocks.LIGHT_BLUE_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.LIGHT_GRAY_TERRACOTTA), Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_light_gray_terracotta", has((ItemLike)Blocks.LIGHT_GRAY_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.LIME_TERRACOTTA), Blocks.LIME_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_lime_terracotta", has((ItemLike)Blocks.LIME_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.MAGENTA_TERRACOTTA), Blocks.MAGENTA_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_magenta_terracotta", has((ItemLike)Blocks.MAGENTA_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.ORANGE_TERRACOTTA), Blocks.ORANGE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_orange_terracotta", has((ItemLike)Blocks.ORANGE_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.PINK_TERRACOTTA), Blocks.PINK_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_pink_terracotta", has((ItemLike)Blocks.PINK_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.PURPLE_TERRACOTTA), Blocks.PURPLE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_purple_terracotta", has((ItemLike)Blocks.PURPLE_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.RED_TERRACOTTA), Blocks.RED_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_red_terracotta", has((ItemLike)Blocks.RED_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.WHITE_TERRACOTTA), Blocks.WHITE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_white_terracotta", has((ItemLike)Blocks.WHITE_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.YELLOW_TERRACOTTA), Blocks.YELLOW_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_yellow_terracotta", has((ItemLike)Blocks.YELLOW_TERRACOTTA)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.ANCIENT_DEBRIS), Items.NETHERITE_SCRAP, 2.0F, 200).unlockedBy("has_ancient_debris", has((ItemLike)Blocks.ANCIENT_DEBRIS)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.BASALT), Blocks.SMOOTH_BASALT, 0.1F, 200).unlockedBy("has_basalt", has((ItemLike)Blocks.BASALT)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(Blocks.COBBLED_DEEPSLATE), Blocks.DEEPSLATE, 0.1F, 200).unlockedBy("has_cobbled_deepslate", has((ItemLike)Blocks.COBBLED_DEEPSLATE)).save(var0);
      ...
      SimpleCookingRecipeBuilder.blasting(Ingredient.method_110(Blocks.NETHER_QUARTZ_ORE), Items.QUARTZ, 0.2F, 100).unlockedBy("has_nether_quartz_ore", has((ItemLike)Blocks.NETHER_QUARTZ_ORE)).save(var0, getBlastingRecipeName(Items.QUARTZ));
      SimpleCookingRecipeBuilder.blasting(Ingredient.method_110(Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_AXE, Items.GOLDEN_HOE, Items.GOLDEN_SWORD, Items.GOLDEN_HELMET, Items.GOLDEN_CHESTPLATE, Items.GOLDEN_LEGGINGS, Items.GOLDEN_BOOTS, Items.GOLDEN_HORSE_ARMOR), Items.GOLD_NUGGET, 0.1F, 100).unlockedBy("has_golden_pickaxe", has((ItemLike)Items.GOLDEN_PICKAXE)).unlockedBy("has_golden_shovel", has((ItemLike)Items.GOLDEN_SHOVEL)).unlockedBy("has_golden_axe", has((ItemLike)Items.GOLDEN_AXE)).unlockedBy("has_golden_hoe", has((ItemLike)Items.GOLDEN_HOE)).unlockedBy("has_golden_sword", has((ItemLike)Items.GOLDEN_SWORD)).unlockedBy("has_golden_helmet", has((ItemLike)Items.GOLDEN_HELMET)).unlockedBy("has_golden_chestplate", has((ItemLike)Items.GOLDEN_CHESTPLATE)).unlockedBy("has_golden_leggings", has((ItemLike)Items.GOLDEN_LEGGINGS)).unlockedBy("has_golden_boots", has((ItemLike)Items.GOLDEN_BOOTS)).unlockedBy("has_golden_horse_armor", has((ItemLike)Items.GOLDEN_HORSE_ARMOR)).save(var0, getBlastingRecipeName(Items.GOLD_NUGGET));
      SimpleCookingRecipeBuilder.blasting(Ingredient.method_110(Items.IRON_PICKAXE, Items.IRON_SHOVEL, Items.IRON_AXE, Items.IRON_HOE, Items.IRON_SWORD, Items.IRON_HELMET, Items.IRON_CHESTPLATE, Items.IRON_LEGGINGS, Items.IRON_BOOTS, Items.IRON_HORSE_ARMOR, Items.CHAINMAIL_HELMET, Items.CHAINMAIL_CHESTPLATE, Items.CHAINMAIL_LEGGINGS, Items.CHAINMAIL_BOOTS), Items.IRON_NUGGET, 0.1F, 100).unlockedBy("has_iron_pickaxe", has((ItemLike)Items.IRON_PICKAXE)).unlockedBy("has_iron_shovel", has((ItemLike)Items.IRON_SHOVEL)).unlockedBy("has_iron_axe", has((ItemLike)Items.IRON_AXE)).unlockedBy("has_iron_hoe", has((ItemLike)Items.IRON_HOE)).unlockedBy("has_iron_sword", has((ItemLike)Items.IRON_SWORD)).unlockedBy("has_iron_helmet", has((ItemLike)Items.IRON_HELMET)).unlockedBy("has_iron_chestplate", has((ItemLike)Items.IRON_CHESTPLATE)).unlockedBy("has_iron_leggings", has((ItemLike)Items.IRON_LEGGINGS)).unlockedBy("has_iron_boots", has((ItemLike)Items.IRON_BOOTS)).unlockedBy("has_iron_horse_armor", has((ItemLike)Items.IRON_HORSE_ARMOR)).unlockedBy("has_chainmail_helmet", has((ItemLike)Items.CHAINMAIL_HELMET)).unlockedBy("has_chainmail_chestplate", has((ItemLike)Items.CHAINMAIL_CHESTPLATE)).unlockedBy("has_chainmail_leggings", has((ItemLike)Items.CHAINMAIL_LEGGINGS)).unlockedBy("has_chainmail_boots", has((ItemLike)Items.CHAINMAIL_BOOTS)).save(var0, getBlastingRecipeName(Items.IRON_NUGGET));
      SimpleCookingRecipeBuilder.blasting(Ingredient.method_110(Blocks.ANCIENT_DEBRIS), Items.NETHERITE_SCRAP, 2.0F, 100).unlockedBy("has_ancient_debris", has((ItemLike)Blocks.ANCIENT_DEBRIS)).save(var0, getBlastingRecipeName(Items.NETHERITE_SCRAP));
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.STONE), Blocks.CHISELED_STONE_BRICKS).unlockedBy("has_stone", has((ItemLike)Blocks.STONE)).save(var0, "chiseled_stone_bricks_stone_from_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.STONE), Blocks.STONE_BRICK_WALL).unlockedBy("has_stone", has((ItemLike)Blocks.STONE)).save(var0, "stone_brick_walls_from_stone_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.QUARTZ_BLOCK), Blocks.QUARTZ_SLAB, 2).unlockedBy("has_quartz_block", has((ItemLike)Blocks.QUARTZ_BLOCK)).save(var0, "quartz_slab_from_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.STONE_BRICKS), Blocks.STONE_BRICK_WALL).unlockedBy("has_stone_bricks", has((ItemLike)Blocks.STONE_BRICKS)).save(var0, "stone_brick_wall_from_stone_bricks_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.PRISMARINE_BRICKS), Blocks.PRISMARINE_BRICK_SLAB, 2).unlockedBy("has_prismarine_brick", has((ItemLike)Blocks.PRISMARINE_BRICKS)).save(var0, "prismarine_brick_slab_from_prismarine_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.PRISMARINE_BRICKS), Blocks.PRISMARINE_BRICK_STAIRS).unlockedBy("has_prismarine_brick", has((ItemLike)Blocks.PRISMARINE_BRICKS)).save(var0, "prismarine_brick_stairs_from_prismarine_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.MOSSY_STONE_BRICKS), Blocks.MOSSY_STONE_BRICK_SLAB, 2).unlockedBy("has_mossy_stone_bricks", has((ItemLike)Blocks.MOSSY_STONE_BRICKS)).save(var0, "mossy_stone_brick_slab_from_mossy_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.MOSSY_STONE_BRICKS), Blocks.MOSSY_STONE_BRICK_STAIRS).unlockedBy("has_mossy_stone_bricks", has((ItemLike)Blocks.MOSSY_STONE_BRICKS)).save(var0, "mossy_stone_brick_stairs_from_mossy_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.MOSSY_STONE_BRICKS), Blocks.MOSSY_STONE_BRICK_WALL).unlockedBy("has_mossy_stone_bricks", has((ItemLike)Blocks.MOSSY_STONE_BRICKS)).save(var0, "mossy_stone_brick_wall_from_mossy_stone_brick_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.END_STONE_BRICKS), Blocks.END_STONE_BRICK_SLAB, 2).unlockedBy("has_end_stone_brick", has((ItemLike)Blocks.END_STONE_BRICKS)).save(var0, "end_stone_brick_slab_from_end_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.END_STONE_BRICKS), Blocks.END_STONE_BRICK_STAIRS).unlockedBy("has_end_stone_brick", has((ItemLike)Blocks.END_STONE_BRICKS)).save(var0, "end_stone_brick_stairs_from_end_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(Blocks.END_STONE_BRICKS), Blocks.END_STONE_BRICK_WALL).unlockedBy("has_end_stone_brick", has((ItemLike)Blocks.END_STONE_BRICKS)).save(var0, "end_stone_brick_wall_from_end_stone_brick_stonecutting");
   ...
   private static void oreCooking(Consumer<FinishedRecipe> var0, SimpleCookingSerializer<?> var1, List<ItemLike> var2, ItemLike var3, float var4, int var5, String var6, String var7) {
      ...
      while(var8.hasNext()) {
         ...
         SimpleCookingRecipeBuilder.cooking(Ingredient.method_110(var9), var3, var4, var5, var1).group(var6).unlockedBy(getHasName(var9), has(var9)).save(var0, getItemName(var3) + var7 + "_" + getItemName(var9));
      }

   }

   private static void netheriteSmithing(Consumer<FinishedRecipe> var0, Item var1, Item var2) {
      UpgradeRecipeBuilder.smithing(Ingredient.method_110(var1), Ingredient.method_110(Items.NETHERITE_INGOT), var2).unlocks("has_netherite_ingot", has((ItemLike)Items.NETHERITE_INGOT)).save(var0, getItemName(var2) + "_smithing");
   }
   ...
   private static void pressurePlate(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      pressurePlateBuilder(var1, Ingredient.method_110(var2)).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   private static void slab(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      slabBuilder(var1, Ingredient.method_110(var2)).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   public static void wall(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      wallBuilder(var1, Ingredient.method_110(var2)).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   public static void polished(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      polishedBuilder(var1, Ingredient.method_110(var2)).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   public static void cut(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      cutBuilder(var1, Ingredient.method_110(var2)).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   public static void chiseled(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      chiseledBuilder(var1, Ingredient.method_110(var2)).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   private static void stonecutterResultFromBase(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2, int var3) {
      SingleItemRecipeBuilder var10000 = SingleItemRecipeBuilder.stonecutting(Ingredient.method_110(var2), var1, var3).unlockedBy(getHasName(var2), has(var2));
   ...
   private static void smeltingResultFromBase(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      SimpleCookingRecipeBuilder.smelting(Ingredient.method_110(var2), var1, 0.1F, 200).unlockedBy(getHasName(var2), has(var2)).save(var0);
   }
   ...
   private static void simpleCookingRecipe(Consumer<FinishedRecipe> var0, String var1, SimpleCookingSerializer<?> var2, int var3, ItemLike var4, ItemLike var5, float var6) {
      SimpleCookingRecipeBuilder var10000 = SimpleCookingRecipeBuilder.cooking(Ingredient.method_110(var4), var5, var6, var3, var2).unlockedBy(getHasName(var4), has(var4));
   ...
   private static InventoryChangeTrigger.TriggerInstance has(MinMaxBounds.Ints var0, ItemLike var1) {
      return inventoryTrigger(ItemPredicate.Builder.item().method_90(var1).withCount(var0).build());
   }

   private static InventoryChangeTrigger.TriggerInstance has(ItemLike var0) {
      return inventoryTrigger(ItemPredicate.Builder.item().method_90(var0).build());
   }

   private static InventoryChangeTrigger.TriggerInstance has(Tag<Item> var0) {
      return inventoryTrigger(ItemPredicate.Builder.item().method_91(var0).build());
   }
   ...
   static {
      ...
      shapeBuilders = ImmutableMap.builder().put(BlockFamily.Variant.BUTTON, (var0, var1) -> {
         return buttonBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.CHISELED, (var0, var1) -> {
         return chiseledBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.CUT, (var0, var1) -> {
         return cutBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.DOOR, (var0, var1) -> {
         return doorBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.FENCE, (var0, var1) -> {
         return fenceBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.FENCE_GATE, (var0, var1) -> {
         return fenceGateBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.SIGN, (var0, var1) -> {
         return signBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.SLAB, (var0, var1) -> {
         return slabBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.STAIRS, (var0, var1) -> {
         return stairBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.PRESSURE_PLATE, (var0, var1) -> {
         return pressurePlateBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.POLISHED, (var0, var1) -> {
         return polishedBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.TRAPDOOR, (var0, var1) -> {
         return trapdoorBuilder(var0, Ingredient.method_110(var1));
      }).put(BlockFamily.Variant.WALL, (var0, var1) -> {
         return wallBuilder(var0, Ingredient.method_110(var1));
      }).build();
   }
}
