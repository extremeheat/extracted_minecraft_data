...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   VanillaRecipeProvider(HolderLookup.Provider var1, RecipeOutput var2) {
      super(var1, var2);
   }
   ...
   protected void buildRecipes() {
      ...
      this.colorBlockWithDye(var1, var2, "wool");
      this.colorBlockWithDye(var1, var3, "bed");
      this.colorBlockWithDye(var1, var4, "carpet");
      ...
      this.shapeless(RecipeCategory.FOOD, Items.MUSHROOM_STEW)
         ...
         .unlockedBy("has_red_mushroom", this.has(Blocks.RED_MUSHROOM))
         .save(this.output);
      BuiltInRegistries.ITEM.stream().forEach(var1x -> {
         SuspiciousEffectHolder var2x = SuspiciousEffectHolder.tryGet(var1x);
         if (var2x != null) {
            this.suspiciousStew(var1x, var2x);
         }
      });
   ...
   public static class Runner extends RecipeProvider.Runner {
      ...
      protected RecipeProvider createRecipeProvider(HolderLookup.Provider var1, RecipeOutput var2) {
         return new VanillaRecipeProvider(var1, var2);
      }
