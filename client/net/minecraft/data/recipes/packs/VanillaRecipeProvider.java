...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   protected void buildRecipes() {
      ...
      List var1 = List.of(Items.BLACK_DYE, Items.BLUE_DYE, Items.BROWN_DYE, Items.CYAN_DYE, Items.GRAY_DYE, Items.GREEN_DYE, Items.LIGHT_BLUE_DYE, Items.LIGHT_GRAY_DYE, Items.LIME_DYE, Items.MAGENTA_DYE, Items.ORANGE_DYE, Items.PINK_DYE, Items.PURPLE_DYE, Items.RED_DYE, Items.YELLOW_DYE, Items.WHITE_DYE);
      List var2 = List.of(Items.BLACK_WOOL, Items.BLUE_WOOL, Items.BROWN_WOOL, Items.CYAN_WOOL, Items.GRAY_WOOL, Items.GREEN_WOOL, Items.LIGHT_BLUE_WOOL, Items.LIGHT_GRAY_WOOL, Items.LIME_WOOL, Items.MAGENTA_WOOL, Items.ORANGE_WOOL, Items.PINK_WOOL, Items.PURPLE_WOOL, Items.RED_WOOL, Items.YELLOW_WOOL, Items.WHITE_WOOL);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Items.CANDLE).define('S', (ItemLike)Items.STRING).define('H', (ItemLike)Items.HONEYCOMB).pattern("S").pattern("H").unlockedBy("has_string", this.has(Items.STRING)).unlockedBy("has_honeycomb", this.has(Items.HONEYCOMB)).save(this.output);
      ...
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.PACKED_MUD, 1).requires((ItemLike)Blocks.MUD).requires((ItemLike)Items.WHEAT).unlockedBy("has_mud", this.has(Blocks.MUD)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.MUD_BRICKS, 4).define('#', (ItemLike)Blocks.PACKED_MUD).pattern("##").pattern("##").unlockedBy("has_packed_mud", this.has(Blocks.PACKED_MUD)).save(this.output);
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.MUDDY_MANGROVE_ROOTS, 1).requires((ItemLike)Blocks.MUD).requires((ItemLike)Items.MANGROVE_ROOTS).unlockedBy("has_mangrove_roots", this.has(Blocks.MANGROVE_ROOTS)).save(this.output);
      this.shaped(RecipeCategory.TRANSPORTATION, Blocks.ACTIVATOR_RAIL, 6).define('#', (ItemLike)Blocks.REDSTONE_TORCH).define('S', (ItemLike)Items.STICK).define('X', (ItemLike)Items.IRON_INGOT).pattern("XSX").pattern("X#X").pattern("XSX").unlockedBy("has_rail", this.has(Blocks.RAIL)).save(this.output);
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.ANDESITE, 2).requires((ItemLike)Blocks.DIORITE).requires((ItemLike)Blocks.COBBLESTONE).unlockedBy("has_stone", this.has(Blocks.DIORITE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.ANVIL).define('I', (ItemLike)Blocks.IRON_BLOCK).define('i', (ItemLike)Items.IRON_INGOT).pattern("III").pattern(" i ").pattern("iii").unlockedBy("has_iron_block", this.has(Blocks.IRON_BLOCK)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Items.ARMOR_STAND).define('/', (ItemLike)Items.STICK).define('_', (ItemLike)Blocks.SMOOTH_STONE_SLAB).pattern("///").pattern(" / ").pattern("/_/").unlockedBy("has_stone_slab", this.has(Blocks.SMOOTH_STONE_SLAB)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.ARROW, 4).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.FLINT).define('Y', (ItemLike)Items.FEATHER).pattern("X").pattern("#").pattern("Y").unlockedBy("has_feather", this.has(Items.FEATHER)).unlockedBy("has_flint", this.has(Items.FLINT)).save(this.output);
      ...
      this.shaped(RecipeCategory.MISC, Blocks.BEACON).define('S', (ItemLike)Items.NETHER_STAR).define('G', (ItemLike)Blocks.GLASS).define('O', (ItemLike)Blocks.OBSIDIAN).pattern("GGG").pattern("GSG").pattern("OOO").unlockedBy("has_nether_star", this.has(Items.NETHER_STAR)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.BEEHIVE).define('P', ItemTags.PLANKS).define('H', (ItemLike)Items.HONEYCOMB).pattern("PPP").pattern("HHH").pattern("PPP").unlockedBy("has_honeycomb", this.has(Items.HONEYCOMB)).save(this.output);
      this.shapeless(RecipeCategory.FOOD, Items.BEETROOT_SOUP).requires((ItemLike)Items.BOWL).requires((ItemLike)Items.BEETROOT, 6).unlockedBy("has_beetroot", this.has(Items.BEETROOT)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.BLACK_DYE).requires((ItemLike)Items.INK_SAC).group("black_dye").unlockedBy("has_ink_sac", this.has(Items.INK_SAC)).save(this.output);
      this.oneToOneConversionRecipe(Items.BLACK_DYE, Blocks.WITHER_ROSE, "black_dye");
      this.shapeless(RecipeCategory.BREWING, Items.BLAZE_POWDER, 2).requires((ItemLike)Items.BLAZE_ROD).unlockedBy("has_blaze_rod", this.has(Items.BLAZE_ROD)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.BLUE_DYE).requires((ItemLike)Items.LAPIS_LAZULI).group("blue_dye").unlockedBy("has_lapis_lazuli", this.has(Items.LAPIS_LAZULI)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.BONE_MEAL, 3).requires((ItemLike)Items.BONE).group("bonemeal").unlockedBy("has_bone", this.has(Items.BONE)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.BOOK).requires((ItemLike)Items.PAPER, 3).requires((ItemLike)Items.LEATHER).unlockedBy("has_paper", this.has(Items.PAPER)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.BOOKSHELF).define('#', ItemTags.PLANKS).define('X', (ItemLike)Items.BOOK).pattern("###").pattern("XXX").pattern("###").unlockedBy("has_book", this.has(Items.BOOK)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.BOW).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.STRING).pattern(" #X").pattern("# X").pattern(" #X").unlockedBy("has_string", this.has(Items.STRING)).save(this.output);
      ...
      this.shaped(RecipeCategory.FOOD, Items.BREAD).define('#', (ItemLike)Items.WHEAT).pattern("###").unlockedBy("has_wheat", this.has(Items.WHEAT)).save(this.output);
      this.shaped(RecipeCategory.BREWING, Blocks.BREWING_STAND).define('B', (ItemLike)Items.BLAZE_ROD).define('#', ItemTags.STONE_CRAFTING_MATERIALS).pattern(" B ").pattern("###").unlockedBy("has_blaze_rod", this.has(Items.BLAZE_ROD)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.BRICKS).define('#', (ItemLike)Items.BRICK).pattern("##").pattern("##").unlockedBy("has_brick", this.has(Items.BRICK)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.BROWN_DYE).requires((ItemLike)Items.COCOA_BEANS).group("brown_dye").unlockedBy("has_cocoa_beans", this.has(Items.COCOA_BEANS)).save(this.output);
      this.shaped(RecipeCategory.MISC, Items.BUCKET).define('#', (ItemLike)Items.IRON_INGOT).pattern("# #").pattern(" # ").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.FOOD, Blocks.CAKE).define('A', (ItemLike)Items.MILK_BUCKET).define('B', (ItemLike)Items.SUGAR).define('C', (ItemLike)Items.WHEAT).define('E', (ItemLike)Items.EGG).pattern("AAA").pattern("BEB").pattern("CCC").unlockedBy("has_egg", this.has(Items.EGG)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.CAMPFIRE).define('L', ItemTags.LOGS).define('S', (ItemLike)Items.STICK).define('C', ItemTags.COALS).pattern(" S ").pattern("SCS").pattern("LLL").unlockedBy("has_stick", this.has(Items.STICK)).unlockedBy("has_coal", this.has(ItemTags.COALS)).save(this.output);
      this.shaped(RecipeCategory.TRANSPORTATION, Items.CARROT_ON_A_STICK).define('#', (ItemLike)Items.FISHING_ROD).define('X', (ItemLike)Items.CARROT).pattern("# ").pattern(" X").unlockedBy("has_carrot", this.has(Items.CARROT)).save(this.output);
      this.shaped(RecipeCategory.TRANSPORTATION, Items.WARPED_FUNGUS_ON_A_STICK).define('#', (ItemLike)Items.FISHING_ROD).define('X', (ItemLike)Items.WARPED_FUNGUS).pattern("# ").pattern(" X").unlockedBy("has_warped_fungus", this.has(Items.WARPED_FUNGUS)).save(this.output);
      this.shaped(RecipeCategory.BREWING, Blocks.CAULDRON).define('#', (ItemLike)Items.IRON_INGOT).pattern("# #").pattern("# #").pattern("###").unlockedBy("has_water_bucket", this.has(Items.WATER_BUCKET)).save(this.output);
      ...
      this.shapeless(RecipeCategory.TRANSPORTATION, Items.CHEST_MINECART).requires((ItemLike)Blocks.CHEST).requires((ItemLike)Items.MINECART).unlockedBy("has_minecart", this.has(Items.MINECART)).save(this.output);
      ...
      this.shaped(RecipeCategory.TOOLS, Items.CLOCK).define('#', (ItemLike)Items.GOLD_INGOT).define('X', (ItemLike)Items.REDSTONE).pattern(" # ").pattern("#X#").pattern(" # ").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
      this.nineBlockStorageRecipes(RecipeCategory.MISC, Items.COAL, RecipeCategory.BUILDING_BLOCKS, Items.COAL_BLOCK);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.COARSE_DIRT, 4).define('D', (ItemLike)Blocks.DIRT).define('G', (ItemLike)Blocks.GRAVEL).pattern("DG").pattern("GD").unlockedBy("has_gravel", this.has(Blocks.GRAVEL)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.COMPARATOR).define('#', (ItemLike)Blocks.REDSTONE_TORCH).define('X', (ItemLike)Items.QUARTZ).define('I', (ItemLike)Blocks.STONE).pattern(" # ").pattern("#X#").pattern("III").unlockedBy("has_quartz", this.has(Items.QUARTZ)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.COMPASS).define('#', (ItemLike)Items.IRON_INGOT).define('X', (ItemLike)Items.REDSTONE).pattern(" # ").pattern("#X#").pattern(" # ").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
      this.shaped(RecipeCategory.FOOD, Items.COOKIE, 8).define('#', (ItemLike)Items.WHEAT).define('X', (ItemLike)Items.COCOA_BEANS).pattern("#X#").unlockedBy("has_cocoa", this.has(Items.COCOA_BEANS)).save(this.output);
      ...
      this.shaped(RecipeCategory.COMBAT, Items.CROSSBOW).define('~', (ItemLike)Items.STRING).define('#', (ItemLike)Items.STICK).define('&', (ItemLike)Items.IRON_INGOT).define('$', (ItemLike)Blocks.TRIPWIRE_HOOK).pattern("#&#").pattern("~$~").pattern(" # ").unlockedBy("has_string", this.has(Items.STRING)).unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).unlockedBy("has_tripwire_hook", this.has(Blocks.TRIPWIRE_HOOK)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.LOOM).define('#', ItemTags.PLANKS).define('@', (ItemLike)Items.STRING).pattern("@@").pattern("##").unlockedBy("has_string", this.has(Items.STRING)).save(this.output);
      ...
      this.nineBlockStorageRecipesRecipesWithCustomUnpacking(RecipeCategory.MISC, Items.COPPER_INGOT, RecipeCategory.BUILDING_BLOCKS, Items.COPPER_BLOCK, getSimpleRecipeName(Items.COPPER_INGOT), getItemName(Items.COPPER_INGOT));
      this.shapeless(RecipeCategory.MISC, Items.COPPER_INGOT, 9).requires((ItemLike)Blocks.WAXED_COPPER_BLOCK).group(getItemName(Items.COPPER_INGOT)).unlockedBy(getHasName(Blocks.WAXED_COPPER_BLOCK), this.has(Blocks.WAXED_COPPER_BLOCK)).save(this.output, getConversionRecipeName(Items.COPPER_INGOT, Blocks.WAXED_COPPER_BLOCK));
      this.waxRecipes(FeatureFlagSet.of(FeatureFlags.VANILLA));
      this.shapeless(RecipeCategory.MISC, Items.CYAN_DYE, 2).requires((ItemLike)Items.BLUE_DYE).requires((ItemLike)Items.GREEN_DYE).group("cyan_dye").unlockedBy("has_green_dye", this.has(Items.GREEN_DYE)).unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DARK_PRISMARINE).define('S', (ItemLike)Items.PRISMARINE_SHARD).define('I', (ItemLike)Items.BLACK_DYE).pattern("SSS").pattern("SIS").pattern("SSS").unlockedBy("has_prismarine_shard", this.has(Items.PRISMARINE_SHARD)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.DAYLIGHT_DETECTOR).define('Q', (ItemLike)Items.QUARTZ).define('G', (ItemLike)Blocks.GLASS).define('W', ItemTags.WOODEN_SLABS).pattern("GGG").pattern("QQQ").pattern("WWW").unlockedBy("has_quartz", this.has(Items.QUARTZ)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DEEPSLATE_BRICKS, 4).define('S', (ItemLike)Blocks.POLISHED_DEEPSLATE).pattern("SS").pattern("SS").unlockedBy("has_polished_deepslate", this.has(Blocks.POLISHED_DEEPSLATE)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DEEPSLATE_TILES, 4).define('S', (ItemLike)Blocks.DEEPSLATE_BRICKS).pattern("SS").pattern("SS").unlockedBy("has_deepslate_bricks", this.has(Blocks.DEEPSLATE_BRICKS)).save(this.output);
      this.shaped(RecipeCategory.TRANSPORTATION, Blocks.DETECTOR_RAIL, 6).define('R', (ItemLike)Items.REDSTONE).define('#', (ItemLike)Blocks.STONE_PRESSURE_PLATE).define('X', (ItemLike)Items.IRON_INGOT).pattern("X X").pattern("X#X").pattern("XRX").unlockedBy("has_rail", this.has(Blocks.RAIL)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.DIAMOND_AXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.DIAMOND_TOOL_MATERIALS).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_diamond", this.has(ItemTags.DIAMOND_TOOL_MATERIALS)).save(this.output);
      this.nineBlockStorageRecipes(RecipeCategory.MISC, Items.DIAMOND, RecipeCategory.BUILDING_BLOCKS, Items.DIAMOND_BLOCK);
      this.shaped(RecipeCategory.COMBAT, Items.DIAMOND_BOOTS).define('X', (ItemLike)Items.DIAMOND).pattern("X X").pattern("X X").unlockedBy("has_diamond", this.has(Items.DIAMOND)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.DIAMOND_CHESTPLATE).define('X', (ItemLike)Items.DIAMOND).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_diamond", this.has(Items.DIAMOND)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.DIAMOND_HELMET).define('X', (ItemLike)Items.DIAMOND).pattern("XXX").pattern("X X").unlockedBy("has_diamond", this.has(Items.DIAMOND)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.DIAMOND_HOE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.DIAMOND_TOOL_MATERIALS).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_diamond", this.has(ItemTags.DIAMOND_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.DIAMOND_LEGGINGS).define('X', (ItemLike)Items.DIAMOND).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_diamond", this.has(Items.DIAMOND)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.DIAMOND_PICKAXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.DIAMOND_TOOL_MATERIALS).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_diamond", this.has(ItemTags.DIAMOND_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.DIAMOND_SHOVEL).define('#', (ItemLike)Items.STICK).define('X', ItemTags.DIAMOND_TOOL_MATERIALS).pattern("X").pattern("#").pattern("#").unlockedBy("has_diamond", this.has(ItemTags.DIAMOND_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.DIAMOND_SWORD).define('#', (ItemLike)Items.STICK).define('X', ItemTags.DIAMOND_TOOL_MATERIALS).pattern("X").pattern("X").pattern("#").unlockedBy("has_diamond", this.has(ItemTags.DIAMOND_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DIORITE, 2).define('Q', (ItemLike)Items.QUARTZ).define('C', (ItemLike)Blocks.COBBLESTONE).pattern("CQ").pattern("QC").unlockedBy("has_quartz", this.has(Items.QUARTZ)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.DISPENSER).define('R', (ItemLike)Items.REDSTONE).define('#', (ItemLike)Blocks.COBBLESTONE).define('X', (ItemLike)Items.BOW).pattern("###").pattern("#X#").pattern("#R#").unlockedBy("has_bow", this.has(Items.BOW)).save(this.output);
      this.twoByTwoPacker(RecipeCategory.BUILDING_BLOCKS, Blocks.DRIPSTONE_BLOCK, Items.POINTED_DRIPSTONE);
      this.shaped(RecipeCategory.REDSTONE, Blocks.DROPPER).define('R', (ItemLike)Items.REDSTONE).define('#', (ItemLike)Blocks.COBBLESTONE).pattern("###").pattern("# #").pattern("#R#").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
      this.nineBlockStorageRecipes(RecipeCategory.MISC, Items.EMERALD, RecipeCategory.BUILDING_BLOCKS, Items.EMERALD_BLOCK);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.ENCHANTING_TABLE).define('B', (ItemLike)Items.BOOK).define('#', (ItemLike)Blocks.OBSIDIAN).define('D', (ItemLike)Items.DIAMOND).pattern(" B ").pattern("D#D").pattern("###").unlockedBy("has_obsidian", this.has(Blocks.OBSIDIAN)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.ENDER_CHEST).define('#', (ItemLike)Blocks.OBSIDIAN).define('E', (ItemLike)Items.ENDER_EYE).pattern("###").pattern("#E#").pattern("###").unlockedBy("has_ender_eye", this.has(Items.ENDER_EYE)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.ENDER_EYE).requires((ItemLike)Items.ENDER_PEARL).requires((ItemLike)Items.BLAZE_POWDER).unlockedBy("has_blaze_powder", this.has(Items.BLAZE_POWDER)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.END_STONE_BRICKS, 4).define('#', (ItemLike)Blocks.END_STONE).pattern("##").pattern("##").unlockedBy("has_end_stone", this.has(Blocks.END_STONE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Items.END_CRYSTAL).define('T', (ItemLike)Items.GHAST_TEAR).define('E', (ItemLike)Items.ENDER_EYE).define('G', (ItemLike)Blocks.GLASS).pattern("GGG").pattern("GEG").pattern("GTG").unlockedBy("has_ender_eye", this.has(Items.ENDER_EYE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.END_ROD, 4).define('#', (ItemLike)Items.POPPED_CHORUS_FRUIT).define('/', (ItemLike)Items.BLAZE_ROD).pattern("/").pattern("#").unlockedBy("has_chorus_fruit_popped", this.has(Items.POPPED_CHORUS_FRUIT)).save(this.output);
      this.shapeless(RecipeCategory.BREWING, Items.FERMENTED_SPIDER_EYE).requires((ItemLike)Items.SPIDER_EYE).requires((ItemLike)Blocks.BROWN_MUSHROOM).requires((ItemLike)Items.SUGAR).unlockedBy("has_spider_eye", this.has(Items.SPIDER_EYE)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.FIRE_CHARGE, 3).requires((ItemLike)Items.GUNPOWDER).requires((ItemLike)Items.BLAZE_POWDER).requires(Ingredient.of(Items.COAL, Items.CHARCOAL)).unlockedBy("has_blaze_powder", this.has(Items.BLAZE_POWDER)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.FIREWORK_ROCKET, 3).requires((ItemLike)Items.GUNPOWDER).requires((ItemLike)Items.PAPER).unlockedBy("has_gunpowder", this.has(Items.GUNPOWDER)).save(this.output, "firework_rocket_simple");
      this.shaped(RecipeCategory.TOOLS, Items.FISHING_ROD).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.STRING).pattern("  #").pattern(" #X").pattern("# X").unlockedBy("has_string", this.has(Items.STRING)).save(this.output);
      this.shapeless(RecipeCategory.TOOLS, Items.FLINT_AND_STEEL).requires((ItemLike)Items.IRON_INGOT).requires((ItemLike)Items.FLINT).unlockedBy("has_flint", this.has(Items.FLINT)).unlockedBy("has_obsidian", this.has(Blocks.OBSIDIAN)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.FLOWER_POT).define('#', (ItemLike)Items.BRICK).pattern("# #").pattern(" # ").unlockedBy("has_brick", this.has(Items.BRICK)).save(this.output);
      ...
      this.shapeless(RecipeCategory.TRANSPORTATION, Items.FURNACE_MINECART).requires((ItemLike)Blocks.FURNACE).requires((ItemLike)Items.MINECART).unlockedBy("has_minecart", this.has(Items.MINECART)).save(this.output);
      this.shaped(RecipeCategory.BREWING, Items.GLASS_BOTTLE, 3).define('#', (ItemLike)Blocks.GLASS).pattern("# #").pattern(" # ").unlockedBy("has_glass", this.has(Blocks.GLASS)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.GLASS_PANE, 16).define('#', (ItemLike)Blocks.GLASS).pattern("###").pattern("###").unlockedBy("has_glass", this.has(Blocks.GLASS)).save(this.output);
      this.twoByTwoPacker(RecipeCategory.BUILDING_BLOCKS, Blocks.GLOWSTONE, Items.GLOWSTONE_DUST);
      this.shapeless(RecipeCategory.DECORATIONS, Items.GLOW_ITEM_FRAME).requires((ItemLike)Items.ITEM_FRAME).requires((ItemLike)Items.GLOW_INK_SAC).unlockedBy("has_item_frame", this.has(Items.ITEM_FRAME)).unlockedBy("has_glow_ink_sac", this.has(Items.GLOW_INK_SAC)).save(this.output);
      this.shaped(RecipeCategory.FOOD, Items.GOLDEN_APPLE).define('#', (ItemLike)Items.GOLD_INGOT).define('X', (ItemLike)Items.APPLE).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_gold_ingot", this.has(Items.GOLD_INGOT)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.GOLDEN_AXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.GOLD_TOOL_MATERIALS).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_gold_ingot", this.has(ItemTags.GOLD_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.GOLDEN_BOOTS).define('X', (ItemLike)Items.GOLD_INGOT).pattern("X X").pattern("X X").unlockedBy("has_gold_ingot", this.has(Items.GOLD_INGOT)).save(this.output);
      this.shaped(RecipeCategory.BREWING, Items.GOLDEN_CARROT).define('#', (ItemLike)Items.GOLD_NUGGET).define('X', (ItemLike)Items.CARROT).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_gold_nugget", this.has(Items.GOLD_NUGGET)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.GOLDEN_CHESTPLATE).define('X', (ItemLike)Items.GOLD_INGOT).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_gold_ingot", this.has(Items.GOLD_INGOT)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.GOLDEN_HELMET).define('X', (ItemLike)Items.GOLD_INGOT).pattern("XXX").pattern("X X").unlockedBy("has_gold_ingot", this.has(Items.GOLD_INGOT)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.GOLDEN_HOE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.GOLD_TOOL_MATERIALS).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_gold_ingot", this.has(ItemTags.GOLD_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.GOLDEN_LEGGINGS).define('X', (ItemLike)Items.GOLD_INGOT).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_gold_ingot", this.has(Items.GOLD_INGOT)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.GOLDEN_PICKAXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.GOLD_TOOL_MATERIALS).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_gold_ingot", this.has(ItemTags.GOLD_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.TRANSPORTATION, Blocks.POWERED_RAIL, 6).define('R', (ItemLike)Items.REDSTONE).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.GOLD_INGOT).pattern("X X").pattern("X#X").pattern("XRX").unlockedBy("has_rail", this.has(Blocks.RAIL)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.GOLDEN_SHOVEL).define('#', (ItemLike)Items.STICK).define('X', ItemTags.GOLD_TOOL_MATERIALS).pattern("X").pattern("#").pattern("#").unlockedBy("has_gold_ingot", this.has(ItemTags.GOLD_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.GOLDEN_SWORD).define('#', (ItemLike)Items.STICK).define('X', ItemTags.GOLD_TOOL_MATERIALS).pattern("X").pattern("X").pattern("#").unlockedBy("has_gold_ingot", this.has(ItemTags.GOLD_TOOL_MATERIALS)).save(this.output);
      ...
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.GRANITE).requires((ItemLike)Blocks.DIORITE).requires((ItemLike)Items.QUARTZ).unlockedBy("has_quartz", this.has(Items.QUARTZ)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.GRAY_DYE, 2).requires((ItemLike)Items.BLACK_DYE).requires((ItemLike)Items.WHITE_DYE).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).unlockedBy("has_black_dye", this.has(Items.BLACK_DYE)).save(this.output);
      ...
      this.shapeless(RecipeCategory.FOOD, Items.HONEY_BOTTLE, 4).requires((ItemLike)Items.HONEY_BLOCK).requires((ItemLike)Items.GLASS_BOTTLE, 4).unlockedBy("has_honey_block", this.has(Blocks.HONEY_BLOCK)).save(this.output);
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.HOPPER).define('C', (ItemLike)Blocks.CHEST).define('I', (ItemLike)Items.IRON_INGOT).pattern("I I").pattern("ICI").pattern(" I ").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shapeless(RecipeCategory.TRANSPORTATION, Items.HOPPER_MINECART).requires((ItemLike)Blocks.HOPPER).requires((ItemLike)Items.MINECART).unlockedBy("has_minecart", this.has(Items.MINECART)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.IRON_AXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.IRON_TOOL_MATERIALS).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_iron_ingot", this.has(ItemTags.IRON_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.IRON_BARS, 16).define('#', (ItemLike)Items.IRON_INGOT).pattern("###").pattern("###").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.IRON_BOOTS).define('X', (ItemLike)Items.IRON_INGOT).pattern("X X").pattern("X X").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.IRON_CHESTPLATE).define('X', (ItemLike)Items.IRON_INGOT).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      ...
      this.shaped(RecipeCategory.COMBAT, Items.IRON_HELMET).define('X', (ItemLike)Items.IRON_INGOT).pattern("XXX").pattern("X X").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.IRON_HOE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.IRON_TOOL_MATERIALS).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_iron_ingot", this.has(ItemTags.IRON_TOOL_MATERIALS)).save(this.output);
      ...
      this.shaped(RecipeCategory.COMBAT, Items.IRON_LEGGINGS).define('X', (ItemLike)Items.IRON_INGOT).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.IRON_PICKAXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.IRON_TOOL_MATERIALS).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_iron_ingot", this.has(ItemTags.IRON_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.IRON_SHOVEL).define('#', (ItemLike)Items.STICK).define('X', ItemTags.IRON_TOOL_MATERIALS).pattern("X").pattern("#").pattern("#").unlockedBy("has_iron_ingot", this.has(ItemTags.IRON_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.IRON_SWORD).define('#', (ItemLike)Items.STICK).define('X', ItemTags.IRON_TOOL_MATERIALS).pattern("X").pattern("X").pattern("#").unlockedBy("has_iron_ingot", this.has(ItemTags.IRON_TOOL_MATERIALS)).save(this.output);
      this.twoByTwoPacker(RecipeCategory.REDSTONE, Blocks.IRON_TRAPDOOR, Items.IRON_INGOT);
      this.shaped(RecipeCategory.DECORATIONS, Items.ITEM_FRAME).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.LEATHER).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_leather", this.has(Items.LEATHER)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.JUKEBOX).define('#', ItemTags.PLANKS).define('X', (ItemLike)Items.DIAMOND).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_diamond", this.has(Items.DIAMOND)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.LADDER, 3).define('#', (ItemLike)Items.STICK).pattern("# #").pattern("###").pattern("# #").unlockedBy("has_stick", this.has(Items.STICK)).save(this.output);
      this.nineBlockStorageRecipes(RecipeCategory.MISC, Items.LAPIS_LAZULI, RecipeCategory.BUILDING_BLOCKS, Items.LAPIS_BLOCK);
      this.shaped(RecipeCategory.TOOLS, Items.LEAD, 2).define('~', (ItemLike)Items.STRING).define('O', (ItemLike)Items.SLIME_BALL).pattern("~~ ").pattern("~O ").pattern("  ~").unlockedBy("has_slime_ball", this.has(Items.SLIME_BALL)).save(this.output);
      this.twoByTwoPacker(RecipeCategory.MISC, Items.LEATHER, Items.RABBIT_HIDE);
      this.shaped(RecipeCategory.COMBAT, Items.LEATHER_BOOTS).define('X', (ItemLike)Items.LEATHER).pattern("X X").pattern("X X").unlockedBy("has_leather", this.has(Items.LEATHER)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.LEATHER_CHESTPLATE).define('X', (ItemLike)Items.LEATHER).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_leather", this.has(Items.LEATHER)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.LEATHER_HELMET).define('X', (ItemLike)Items.LEATHER).pattern("XXX").pattern("X X").unlockedBy("has_leather", this.has(Items.LEATHER)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.LEATHER_LEGGINGS).define('X', (ItemLike)Items.LEATHER).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_leather", this.has(Items.LEATHER)).save(this.output);
      this.shaped(RecipeCategory.MISC, Items.LEATHER_HORSE_ARMOR).define('X', (ItemLike)Items.LEATHER).pattern("X X").pattern("XXX").pattern("X X").unlockedBy("has_leather", this.has(Items.LEATHER)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.LECTERN).define('S', ItemTags.WOODEN_SLABS).define('B', (ItemLike)Blocks.BOOKSHELF).pattern("SSS").pattern(" B ").pattern(" S ").unlockedBy("has_book", this.has(Items.BOOK)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.LEVER).define('#', (ItemLike)Blocks.COBBLESTONE).define('X', (ItemLike)Items.STICK).pattern("X").pattern("#").unlockedBy("has_cobblestone", this.has(Blocks.COBBLESTONE)).save(this.output);
      this.oneToOneConversionRecipe(Items.LIGHT_BLUE_DYE, Blocks.BLUE_ORCHID, "light_blue_dye");
      this.shapeless(RecipeCategory.MISC, Items.LIGHT_BLUE_DYE, 2).requires((ItemLike)Items.BLUE_DYE).requires((ItemLike)Items.WHITE_DYE).group("light_blue_dye").unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output, "light_blue_dye_from_blue_white_dye");
      this.oneToOneConversionRecipe(Items.LIGHT_GRAY_DYE, Blocks.AZURE_BLUET, "light_gray_dye");
      this.shapeless(RecipeCategory.MISC, Items.LIGHT_GRAY_DYE, 2).requires((ItemLike)Items.GRAY_DYE).requires((ItemLike)Items.WHITE_DYE).group("light_gray_dye").unlockedBy("has_gray_dye", this.has(Items.GRAY_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output, "light_gray_dye_from_gray_white_dye");
      this.shapeless(RecipeCategory.MISC, Items.LIGHT_GRAY_DYE, 3).requires((ItemLike)Items.BLACK_DYE).requires((ItemLike)Items.WHITE_DYE, 2).group("light_gray_dye").unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).unlockedBy("has_black_dye", this.has(Items.BLACK_DYE)).save(this.output, "light_gray_dye_from_black_white_dye");
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.LIGHTNING_ROD).define('#', (ItemLike)Items.COPPER_INGOT).pattern("#").pattern("#").pattern("#").unlockedBy("has_copper_ingot", this.has(Items.COPPER_INGOT)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.LIME_DYE, 2).requires((ItemLike)Items.GREEN_DYE).requires((ItemLike)Items.WHITE_DYE).unlockedBy("has_green_dye", this.has(Items.GREEN_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.JACK_O_LANTERN).define('A', (ItemLike)Blocks.CARVED_PUMPKIN).define('B', (ItemLike)Blocks.TORCH).pattern("A").pattern("B").unlockedBy("has_carved_pumpkin", this.has(Blocks.CARVED_PUMPKIN)).save(this.output);
      this.oneToOneConversionRecipe(Items.MAGENTA_DYE, Blocks.ALLIUM, "magenta_dye");
      this.shapeless(RecipeCategory.MISC, Items.MAGENTA_DYE, 4).requires((ItemLike)Items.BLUE_DYE).requires((ItemLike)Items.RED_DYE, 2).requires((ItemLike)Items.WHITE_DYE).group("magenta_dye").unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_rose_red", this.has(Items.RED_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output, "magenta_dye_from_blue_red_white_dye");
      this.shapeless(RecipeCategory.MISC, Items.MAGENTA_DYE, 3).requires((ItemLike)Items.BLUE_DYE).requires((ItemLike)Items.RED_DYE).requires((ItemLike)Items.PINK_DYE).group("magenta_dye").unlockedBy("has_pink_dye", this.has(Items.PINK_DYE)).unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_red_dye", this.has(Items.RED_DYE)).save(this.output, "magenta_dye_from_blue_red_pink");
      this.oneToOneConversionRecipe(Items.MAGENTA_DYE, Blocks.LILAC, "magenta_dye", 2);
      this.shapeless(RecipeCategory.MISC, Items.MAGENTA_DYE, 2).requires((ItemLike)Items.PURPLE_DYE).requires((ItemLike)Items.PINK_DYE).group("magenta_dye").unlockedBy("has_pink_dye", this.has(Items.PINK_DYE)).unlockedBy("has_purple_dye", this.has(Items.PURPLE_DYE)).save(this.output, "magenta_dye_from_purple_and_pink");
      this.twoByTwoPacker(RecipeCategory.BUILDING_BLOCKS, Blocks.MAGMA_BLOCK, Items.MAGMA_CREAM);
      this.shapeless(RecipeCategory.BREWING, Items.MAGMA_CREAM).requires((ItemLike)Items.BLAZE_POWDER).requires((ItemLike)Items.SLIME_BALL).unlockedBy("has_blaze_powder", this.has(Items.BLAZE_POWDER)).save(this.output);
      this.shaped(RecipeCategory.MISC, Items.MAP).define('#', (ItemLike)Items.PAPER).define('X', (ItemLike)Items.COMPASS).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_compass", this.has(Items.COMPASS)).save(this.output);
      this.threeByThreePacker(RecipeCategory.BUILDING_BLOCKS, Blocks.MELON, Items.MELON_SLICE, "has_melon");
      this.shapeless(RecipeCategory.MISC, Items.MELON_SEEDS).requires((ItemLike)Items.MELON_SLICE).unlockedBy("has_melon", this.has(Items.MELON_SLICE)).save(this.output);
      this.shaped(RecipeCategory.TRANSPORTATION, Items.MINECART).define('#', (ItemLike)Items.IRON_INGOT).pattern("# #").pattern("###").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_COBBLESTONE).requires((ItemLike)Blocks.COBBLESTONE).requires((ItemLike)Blocks.VINE).group("mossy_cobblestone").unlockedBy("has_vine", this.has(Blocks.VINE)).save(this.output, getConversionRecipeName(Blocks.MOSSY_COBBLESTONE, Blocks.VINE));
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_STONE_BRICKS).requires((ItemLike)Blocks.STONE_BRICKS).requires((ItemLike)Blocks.VINE).group("mossy_stone_bricks").unlockedBy("has_vine", this.has(Blocks.VINE)).save(this.output, getConversionRecipeName(Blocks.MOSSY_STONE_BRICKS, Blocks.VINE));
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_COBBLESTONE).requires((ItemLike)Blocks.COBBLESTONE).requires((ItemLike)Blocks.MOSS_BLOCK).group("mossy_cobblestone").unlockedBy("has_moss_block", this.has(Blocks.MOSS_BLOCK)).save(this.output, getConversionRecipeName(Blocks.MOSSY_COBBLESTONE, Blocks.MOSS_BLOCK));
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_STONE_BRICKS).requires((ItemLike)Blocks.STONE_BRICKS).requires((ItemLike)Blocks.MOSS_BLOCK).group("mossy_stone_bricks").unlockedBy("has_moss_block", this.has(Blocks.MOSS_BLOCK)).save(this.output, getConversionRecipeName(Blocks.MOSSY_STONE_BRICKS, Blocks.MOSS_BLOCK));
      this.shapeless(RecipeCategory.FOOD, Items.MUSHROOM_STEW).requires((ItemLike)Blocks.BROWN_MUSHROOM).requires((ItemLike)Blocks.RED_MUSHROOM).requires((ItemLike)Items.BOWL).unlockedBy("has_mushroom_stew", this.has(Items.MUSHROOM_STEW)).unlockedBy("has_bowl", this.has(Items.BOWL)).unlockedBy("has_brown_mushroom", this.has(Blocks.BROWN_MUSHROOM)).unlockedBy("has_red_mushroom", this.has(Blocks.RED_MUSHROOM)).save(this.output);
      BuiltInRegistries.ITEM.stream().forEach((var1x) -> {
         SuspiciousEffectHolder var2 = SuspiciousEffectHolder.tryGet(var1x);
         if (var2 != null) {
            this.suspiciousStew(var1x, var2);
         }
      ...
      this.shapeless(RecipeCategory.MISC, Items.ORANGE_DYE, 2).requires((ItemLike)Items.RED_DYE).requires((ItemLike)Items.YELLOW_DYE).group("orange_dye").unlockedBy("has_red_dye", this.has(Items.RED_DYE)).unlockedBy("has_yellow_dye", this.has(Items.YELLOW_DYE)).save(this.output, "orange_dye_from_red_yellow");
      this.shaped(RecipeCategory.DECORATIONS, Items.PAINTING).define('#', (ItemLike)Items.STICK).define('X', ItemTags.WOOL).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_wool", this.has(ItemTags.WOOL)).save(this.output);
      this.shaped(RecipeCategory.MISC, Items.PAPER, 3).define('#', (ItemLike)Blocks.SUGAR_CANE).pattern("###").unlockedBy("has_reeds", this.has(Blocks.SUGAR_CANE)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.QUARTZ_PILLAR, 2).define('#', (ItemLike)Blocks.QUARTZ_BLOCK).pattern("#").pattern("#").unlockedBy("has_chiseled_quartz_block", this.has(Blocks.CHISELED_QUARTZ_BLOCK)).unlockedBy("has_quartz_block", this.has(Blocks.QUARTZ_BLOCK)).unlockedBy("has_quartz_pillar", this.has(Blocks.QUARTZ_PILLAR)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.PINK_DYE, 2).requires((ItemLike)Items.RED_DYE).requires((ItemLike)Items.WHITE_DYE).group("pink_dye").unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).unlockedBy("has_red_dye", this.has(Items.RED_DYE)).save(this.output, "pink_dye_from_red_white_dye");
      this.shaped(RecipeCategory.REDSTONE, Blocks.PISTON).define('R', (ItemLike)Items.REDSTONE).define('#', (ItemLike)Blocks.COBBLESTONE).define('T', ItemTags.PLANKS).define('X', (ItemLike)Items.IRON_INGOT).pattern("TTT").pattern("#X#").pattern("#R#").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
      ...
      this.shapeless(RecipeCategory.FOOD, Items.PUMPKIN_PIE).requires((ItemLike)Blocks.PUMPKIN).requires((ItemLike)Items.SUGAR).requires((ItemLike)Items.EGG).unlockedBy("has_carved_pumpkin", this.has(Blocks.CARVED_PUMPKIN)).unlockedBy("has_pumpkin", this.has(Blocks.PUMPKIN)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.PUMPKIN_SEEDS, 4).requires((ItemLike)Blocks.PUMPKIN).unlockedBy("has_pumpkin", this.has(Blocks.PUMPKIN)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.PURPLE_DYE, 2).requires((ItemLike)Items.BLUE_DYE).requires((ItemLike)Items.RED_DYE).unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_red_dye", this.has(Items.RED_DYE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SHULKER_BOX).define('#', (ItemLike)Blocks.CHEST).define('-', (ItemLike)Items.SHULKER_SHELL).pattern("-").pattern("#").pattern("-").unlockedBy("has_shulker_shell", this.has(Items.SHULKER_SHELL)).save(this.output);
      this.shulkerBoxRecipes();
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.PURPUR_BLOCK, 4).define('F', (ItemLike)Items.POPPED_CHORUS_FRUIT).pattern("FF").pattern("FF").unlockedBy("has_chorus_fruit_popped", this.has(Items.POPPED_CHORUS_FRUIT)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.PURPUR_PILLAR).define('#', (ItemLike)Blocks.PURPUR_SLAB).pattern("#").pattern("#").unlockedBy("has_purpur_block", this.has(Blocks.PURPUR_BLOCK)).save(this.output);
      ...
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.QUARTZ_BRICKS, 4).define('#', (ItemLike)Blocks.QUARTZ_BLOCK).pattern("##").pattern("##").unlockedBy("has_quartz_block", this.has(Blocks.QUARTZ_BLOCK)).save(this.output);
      ...
      this.shapeless(RecipeCategory.FOOD, Items.RABBIT_STEW).requires((ItemLike)Items.BAKED_POTATO).requires((ItemLike)Items.COOKED_RABBIT).requires((ItemLike)Items.BOWL).requires((ItemLike)Items.CARROT).requires((ItemLike)Blocks.BROWN_MUSHROOM).group("rabbit_stew").unlockedBy("has_cooked_rabbit", this.has(Items.COOKED_RABBIT)).save(this.output, getConversionRecipeName(Items.RABBIT_STEW, Items.BROWN_MUSHROOM));
      this.shapeless(RecipeCategory.FOOD, Items.RABBIT_STEW).requires((ItemLike)Items.BAKED_POTATO).requires((ItemLike)Items.COOKED_RABBIT).requires((ItemLike)Items.BOWL).requires((ItemLike)Items.CARROT).requires((ItemLike)Blocks.RED_MUSHROOM).group("rabbit_stew").unlockedBy("has_cooked_rabbit", this.has(Items.COOKED_RABBIT)).save(this.output, getConversionRecipeName(Items.RABBIT_STEW, Items.RED_MUSHROOM));
      this.shaped(RecipeCategory.TRANSPORTATION, Blocks.RAIL, 16).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.IRON_INGOT).pattern("X X").pattern("X#X").pattern("X X").unlockedBy("has_minecart", this.has(Items.MINECART)).save(this.output);
      this.nineBlockStorageRecipes(RecipeCategory.REDSTONE, Items.REDSTONE, RecipeCategory.REDSTONE, Items.REDSTONE_BLOCK);
      this.shaped(RecipeCategory.REDSTONE, Blocks.REDSTONE_LAMP).define('R', (ItemLike)Items.REDSTONE).define('G', (ItemLike)Blocks.GLOWSTONE).pattern(" R ").pattern("RGR").pattern(" R ").unlockedBy("has_glowstone", this.has(Blocks.GLOWSTONE)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.REDSTONE_TORCH).define('#', (ItemLike)Items.STICK).define('X', (ItemLike)Items.REDSTONE).pattern("X").pattern("#").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.REPEATER).define('#', (ItemLike)Blocks.REDSTONE_TORCH).define('X', (ItemLike)Items.REDSTONE).define('I', (ItemLike)Blocks.STONE).pattern("#X#").pattern("III").unlockedBy("has_redstone_torch", this.has(Blocks.REDSTONE_TORCH)).save(this.output);
      ...
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.SEA_LANTERN).define('S', (ItemLike)Items.PRISMARINE_SHARD).define('C', (ItemLike)Items.PRISMARINE_CRYSTALS).pattern("SCS").pattern("CCC").pattern("SCS").unlockedBy("has_prismarine_crystals", this.has(Items.PRISMARINE_CRYSTALS)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.SHEARS).define('#', (ItemLike)Items.IRON_INGOT).pattern(" #").pattern("# ").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.SHIELD).define('W', ItemTags.WOODEN_TOOL_MATERIALS).define('o', (ItemLike)Items.IRON_INGOT).pattern("WoW").pattern("WWW").pattern(" W ").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SNOW, 6).define('#', (ItemLike)Blocks.SNOW_BLOCK).pattern("###").unlockedBy("has_snowball", this.has(Items.SNOWBALL)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SOUL_CAMPFIRE).define('L', ItemTags.LOGS).define('S', (ItemLike)Items.STICK).define('#', ItemTags.SOUL_FIRE_BASE_BLOCKS).pattern(" S ").pattern("S#S").pattern("LLL").unlockedBy("has_soul_sand", this.has(ItemTags.SOUL_FIRE_BASE_BLOCKS)).save(this.output);
      this.shaped(RecipeCategory.BREWING, Items.GLISTERING_MELON_SLICE).define('#', (ItemLike)Items.GOLD_NUGGET).define('X', (ItemLike)Items.MELON_SLICE).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_melon", this.has(Items.MELON_SLICE)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.SPECTRAL_ARROW, 2).define('#', (ItemLike)Items.GLOWSTONE_DUST).define('X', (ItemLike)Items.ARROW).pattern(" # ").pattern("#X#").pattern(" # ").unlockedBy("has_glowstone_dust", this.has(Items.GLOWSTONE_DUST)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.SPYGLASS).define('#', (ItemLike)Items.AMETHYST_SHARD).define('X', (ItemLike)Items.COPPER_INGOT).pattern(" # ").pattern(" X ").pattern(" X ").unlockedBy("has_amethyst_shard", this.has(Items.AMETHYST_SHARD)).save(this.output);
      ...
      this.shaped(RecipeCategory.MISC, Items.STICK, 1).define('#', (ItemLike)Blocks.BAMBOO).pattern("#").pattern("#").group("sticks").unlockedBy("has_bamboo", this.has(Blocks.BAMBOO)).save(this.output, "stick_from_bamboo_item");
      this.shaped(RecipeCategory.REDSTONE, Blocks.STICKY_PISTON).define('P', (ItemLike)Blocks.PISTON).define('S', (ItemLike)Items.SLIME_BALL).pattern("S").pattern("P").unlockedBy("has_slime_ball", this.has(Items.SLIME_BALL)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.STONE_BRICKS, 4).define('#', (ItemLike)Blocks.STONE).pattern("##").pattern("##").unlockedBy("has_stone", this.has(Blocks.STONE)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.STONE_AXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.STONE_TOOL_MATERIALS).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      ...
      this.shaped(RecipeCategory.TOOLS, Items.STONE_HOE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.STONE_TOOL_MATERIALS).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.STONE_PICKAXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.STONE_TOOL_MATERIALS).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.STONE_SHOVEL).define('#', (ItemLike)Items.STICK).define('X', ItemTags.STONE_TOOL_MATERIALS).pattern("X").pattern("#").pattern("#").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      this.slab(RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_STONE_SLAB, Blocks.SMOOTH_STONE);
      this.shaped(RecipeCategory.COMBAT, Items.STONE_SWORD).define('#', (ItemLike)Items.STICK).define('X', ItemTags.STONE_TOOL_MATERIALS).pattern("X").pattern("X").pattern("#").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.WHITE_WOOL).define('#', (ItemLike)Items.STRING).pattern("##").pattern("##").unlockedBy("has_string", this.has(Items.STRING)).save(this.output, getConversionRecipeName(Blocks.WHITE_WOOL, Items.STRING));
      this.oneToOneConversionRecipe(Items.SUGAR, Blocks.SUGAR_CANE, "sugar");
      this.shapeless(RecipeCategory.MISC, Items.SUGAR, 3).requires((ItemLike)Items.HONEY_BOTTLE).group("sugar").unlockedBy("has_honey_bottle", this.has(Items.HONEY_BOTTLE)).save(this.output, getConversionRecipeName(Items.SUGAR, Items.HONEY_BOTTLE));
      this.shaped(RecipeCategory.REDSTONE, Blocks.TARGET).define('H', (ItemLike)Items.HAY_BLOCK).define('R', (ItemLike)Items.REDSTONE).pattern(" R ").pattern("RHR").pattern(" R ").unlockedBy("has_redstone", this.has(Items.REDSTONE)).unlockedBy("has_hay_block", this.has(Blocks.HAY_BLOCK)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.TNT).define('#', Ingredient.of(Blocks.SAND, Blocks.RED_SAND)).define('X', (ItemLike)Items.GUNPOWDER).pattern("X#X").pattern("#X#").pattern("X#X").unlockedBy("has_gunpowder", this.has(Items.GUNPOWDER)).save(this.output);
      this.shapeless(RecipeCategory.TRANSPORTATION, Items.TNT_MINECART).requires((ItemLike)Blocks.TNT).requires((ItemLike)Items.MINECART).unlockedBy("has_minecart", this.has(Items.MINECART)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.TORCH, 4).define('#', (ItemLike)Items.STICK).define('X', Ingredient.of(Items.COAL, Items.CHARCOAL)).pattern("X").pattern("#").unlockedBy("has_stone_pickaxe", this.has(Items.STONE_PICKAXE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SOUL_TORCH, 4).define('X', Ingredient.of(Items.COAL, Items.CHARCOAL)).define('#', (ItemLike)Items.STICK).define('S', ItemTags.SOUL_FIRE_BASE_BLOCKS).pattern("X").pattern("#").pattern("S").unlockedBy("has_soul_sand", this.has(ItemTags.SOUL_FIRE_BASE_BLOCKS)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.LANTERN).define('#', (ItemLike)Items.TORCH).define('X', (ItemLike)Items.IRON_NUGGET).pattern("XXX").pattern("X#X").pattern("XXX").unlockedBy("has_iron_nugget", this.has(Items.IRON_NUGGET)).unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SOUL_LANTERN).define('#', (ItemLike)Items.SOUL_TORCH).define('X', (ItemLike)Items.IRON_NUGGET).pattern("XXX").pattern("X#X").pattern("XXX").unlockedBy("has_soul_torch", this.has(Items.SOUL_TORCH)).save(this.output);
      this.shapeless(RecipeCategory.REDSTONE, Blocks.TRAPPED_CHEST).requires((ItemLike)Blocks.CHEST).requires((ItemLike)Blocks.TRIPWIRE_HOOK).unlockedBy("has_tripwire_hook", this.has(Blocks.TRIPWIRE_HOOK)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Blocks.TRIPWIRE_HOOK, 2).define('#', ItemTags.PLANKS).define('S', (ItemLike)Items.STICK).define('I', (ItemLike)Items.IRON_INGOT).pattern("I").pattern("S").pattern("#").unlockedBy("has_string", this.has(Items.STRING)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.TURTLE_HELMET).define('X', (ItemLike)Items.TURTLE_SCUTE).pattern("XXX").pattern("X X").unlockedBy("has_turtle_scute", this.has(Items.TURTLE_SCUTE)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.WOLF_ARMOR).define('X', (ItemLike)Items.ARMADILLO_SCUTE).pattern("X  ").pattern("XXX").pattern("X X").unlockedBy("has_armadillo_scute", this.has(Items.ARMADILLO_SCUTE)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.WHEAT, 9).requires((ItemLike)Blocks.HAY_BLOCK).unlockedBy("has_hay_block", this.has(Blocks.HAY_BLOCK)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.WHITE_DYE).requires((ItemLike)Items.BONE_MEAL).group("white_dye").unlockedBy("has_bone_meal", this.has(Items.BONE_MEAL)).save(this.output);
      this.oneToOneConversionRecipe(Items.WHITE_DYE, Blocks.LILY_OF_THE_VALLEY, "white_dye");
      this.shaped(RecipeCategory.TOOLS, Items.WOODEN_AXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.WOODEN_TOOL_MATERIALS).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_stick", this.has(Items.STICK)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.WOODEN_HOE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.WOODEN_TOOL_MATERIALS).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_stick", this.has(Items.STICK)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.WOODEN_PICKAXE).define('#', (ItemLike)Items.STICK).define('X', ItemTags.WOODEN_TOOL_MATERIALS).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_stick", this.has(Items.STICK)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.WOODEN_SHOVEL).define('#', (ItemLike)Items.STICK).define('X', ItemTags.WOODEN_TOOL_MATERIALS).pattern("X").pattern("#").pattern("#").unlockedBy("has_stick", this.has(Items.STICK)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.WOODEN_SWORD).define('#', (ItemLike)Items.STICK).define('X', ItemTags.WOODEN_TOOL_MATERIALS).pattern("X").pattern("X").pattern("#").unlockedBy("has_stick", this.has(Items.STICK)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.WRITABLE_BOOK).requires((ItemLike)Items.BOOK).requires((ItemLike)Items.INK_SAC).requires((ItemLike)Items.FEATHER).unlockedBy("has_book", this.has(Items.BOOK)).save(this.output);
      ...
      this.shaped(RecipeCategory.MISC, Blocks.CONDUIT).define('#', (ItemLike)Items.NAUTILUS_SHELL).define('X', (ItemLike)Items.HEART_OF_THE_SEA).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_nautilus_core", this.has(Items.HEART_OF_THE_SEA)).unlockedBy("has_nautilus_shell", this.has(Items.NAUTILUS_SHELL)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.FIELD_MASONED_BANNER_PATTERN).requires((ItemLike)Items.PAPER).requires((ItemLike)Blocks.BRICKS).unlockedBy("has_bricks", this.has(Blocks.BRICKS)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.BORDURE_INDENTED_BANNER_PATTERN).requires((ItemLike)Items.PAPER).requires((ItemLike)Blocks.VINE).unlockedBy("has_vines", this.has(Blocks.VINE)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.CREEPER_BANNER_PATTERN).requires((ItemLike)Items.PAPER).requires((ItemLike)Items.CREEPER_HEAD).unlockedBy("has_creeper_head", this.has(Items.CREEPER_HEAD)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.SKULL_BANNER_PATTERN).requires((ItemLike)Items.PAPER).requires((ItemLike)Items.WITHER_SKELETON_SKULL).unlockedBy("has_wither_skeleton_skull", this.has(Items.WITHER_SKELETON_SKULL)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.FLOWER_BANNER_PATTERN).requires((ItemLike)Items.PAPER).requires((ItemLike)Blocks.OXEYE_DAISY).unlockedBy("has_oxeye_daisy", this.has(Blocks.OXEYE_DAISY)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.MOJANG_BANNER_PATTERN).requires((ItemLike)Items.PAPER).requires((ItemLike)Items.ENCHANTED_GOLDEN_APPLE).unlockedBy("has_enchanted_golden_apple", this.has(Items.ENCHANTED_GOLDEN_APPLE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SCAFFOLDING, 6).define('~', (ItemLike)Items.STRING).define('I', (ItemLike)Blocks.BAMBOO).pattern("I~I").pattern("I I").pattern("I I").unlockedBy("has_bamboo", this.has(Blocks.BAMBOO)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.GRINDSTONE).define('I', (ItemLike)Items.STICK).define('-', (ItemLike)Blocks.STONE_SLAB).define('#', ItemTags.PLANKS).pattern("I-I").pattern("# #").unlockedBy("has_stone_slab", this.has(Blocks.STONE_SLAB)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.BLAST_FURNACE).define('#', (ItemLike)Blocks.SMOOTH_STONE).define('X', (ItemLike)Blocks.FURNACE).define('I', (ItemLike)Items.IRON_INGOT).pattern("III").pattern("IXI").pattern("###").unlockedBy("has_smooth_stone", this.has(Blocks.SMOOTH_STONE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SMOKER).define('#', ItemTags.LOGS).define('X', (ItemLike)Blocks.FURNACE).pattern(" # ").pattern("#X#").pattern(" # ").unlockedBy("has_furnace", this.has(Blocks.FURNACE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.CARTOGRAPHY_TABLE).define('#', ItemTags.PLANKS).define('@', (ItemLike)Items.PAPER).pattern("@@").pattern("##").pattern("##").unlockedBy("has_paper", this.has(Items.PAPER)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.SMITHING_TABLE).define('#', ItemTags.PLANKS).define('@', (ItemLike)Items.IRON_INGOT).pattern("@@").pattern("##").pattern("##").unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.FLETCHING_TABLE).define('#', ItemTags.PLANKS).define('@', (ItemLike)Items.FLINT).pattern("@@").pattern("##").pattern("##").unlockedBy("has_flint", this.has(Items.FLINT)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.STONECUTTER).define('I', (ItemLike)Items.IRON_INGOT).define('#', (ItemLike)Blocks.STONE).pattern(" I ").pattern("###").unlockedBy("has_stone", this.has(Blocks.STONE)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.LODESTONE).define('S', (ItemLike)Items.CHISELED_STONE_BRICKS).define('#', (ItemLike)Items.NETHERITE_INGOT).pattern("SSS").pattern("S#S").pattern("SSS").unlockedBy("has_netherite_ingot", this.has(Items.NETHERITE_INGOT)).save(this.output);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Blocks.RESPAWN_ANCHOR).define('O', (ItemLike)Blocks.CRYING_OBSIDIAN).define('G', (ItemLike)Blocks.GLOWSTONE).pattern("OOO").pattern("GGG").pattern("OOO").unlockedBy("has_obsidian", this.has(Blocks.CRYING_OBSIDIAN)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Blocks.CHAIN).define('I', (ItemLike)Items.IRON_INGOT).define('N', (ItemLike)Items.IRON_NUGGET).pattern("N").pattern("I").pattern("N").unlockedBy("has_iron_nugget", this.has(Items.IRON_NUGGET)).unlockedBy("has_iron_ingot", this.has(Items.IRON_INGOT)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.TINTED_GLASS, 2).define('G', (ItemLike)Blocks.GLASS).define('S', (ItemLike)Items.AMETHYST_SHARD).pattern(" S ").pattern("SGS").pattern(" S ").unlockedBy("has_amethyst_shard", this.has(Items.AMETHYST_SHARD)).save(this.output);
      this.twoByTwoPacker(RecipeCategory.BUILDING_BLOCKS, Blocks.AMETHYST_BLOCK, Items.AMETHYST_SHARD);
      this.shaped(RecipeCategory.TOOLS, Items.RECOVERY_COMPASS).define('C', (ItemLike)Items.COMPASS).define('S', (ItemLike)Items.ECHO_SHARD).pattern("SSS").pattern("SCS").pattern("SSS").unlockedBy("has_echo_shard", this.has(Items.ECHO_SHARD)).save(this.output);
      this.shaped(RecipeCategory.REDSTONE, Items.CALIBRATED_SCULK_SENSOR).define('#', (ItemLike)Items.AMETHYST_SHARD).define('X', (ItemLike)Items.SCULK_SENSOR).pattern(" # ").pattern("#X#").unlockedBy("has_amethyst_shard", this.has(Items.AMETHYST_SHARD)).save(this.output);
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.POTATO), RecipeCategory.FOOD, Items.BAKED_POTATO, 0.35F, 200).unlockedBy("has_potato", this.has(Items.POTATO)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.CLAY_BALL), RecipeCategory.MISC, Items.BRICK, 0.3F, 200).unlockedBy("has_clay_ball", this.has(Items.CLAY_BALL)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(this.tag(ItemTags.LOGS_THAT_BURN), RecipeCategory.MISC, Items.CHARCOAL, 0.15F, 200).unlockedBy("has_log", this.has(ItemTags.LOGS_THAT_BURN)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.CHORUS_FRUIT), RecipeCategory.MISC, Items.POPPED_CHORUS_FRUIT, 0.1F, 200).unlockedBy("has_chorus_fruit", this.has(Items.CHORUS_FRUIT)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.BEEF), RecipeCategory.FOOD, Items.COOKED_BEEF, 0.35F, 200).unlockedBy("has_beef", this.has(Items.BEEF)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.CHICKEN), RecipeCategory.FOOD, Items.COOKED_CHICKEN, 0.35F, 200).unlockedBy("has_chicken", this.has(Items.CHICKEN)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.COD), RecipeCategory.FOOD, Items.COOKED_COD, 0.35F, 200).unlockedBy("has_cod", this.has(Items.COD)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.KELP), RecipeCategory.FOOD, Items.DRIED_KELP, 0.1F, 200).unlockedBy("has_kelp", this.has(Blocks.KELP)).save(this.output, getSmeltingRecipeName(Items.DRIED_KELP));
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.SALMON), RecipeCategory.FOOD, Items.COOKED_SALMON, 0.35F, 200).unlockedBy("has_salmon", this.has(Items.SALMON)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.MUTTON), RecipeCategory.FOOD, Items.COOKED_MUTTON, 0.35F, 200).unlockedBy("has_mutton", this.has(Items.MUTTON)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.PORKCHOP), RecipeCategory.FOOD, Items.COOKED_PORKCHOP, 0.35F, 200).unlockedBy("has_porkchop", this.has(Items.PORKCHOP)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Items.RABBIT), RecipeCategory.FOOD, Items.COOKED_RABBIT, 0.35F, 200).unlockedBy("has_rabbit", this.has(Items.RABBIT)).save(this.output);
      ...
      SimpleCookingRecipeBuilder.smelting(this.tag(ItemTags.SMELTS_TO_GLASS), RecipeCategory.BUILDING_BLOCKS, Blocks.GLASS.asItem(), 0.1F, 200).unlockedBy("has_smelts_to_glass", this.has(ItemTags.SMELTS_TO_GLASS)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.SEA_PICKLE), RecipeCategory.MISC, Items.LIME_DYE, 0.1F, 200).unlockedBy("has_sea_pickle", this.has(Blocks.SEA_PICKLE)).save(this.output, getSmeltingRecipeName(Items.LIME_DYE));
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.CACTUS.asItem()), RecipeCategory.MISC, Items.GREEN_DYE, 1.0F, 200).unlockedBy("has_cactus", this.has(Blocks.CACTUS)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_AXE, Items.GOLDEN_HOE, Items.GOLDEN_SWORD, Items.GOLDEN_HELMET, Items.GOLDEN_CHESTPLATE, Items.GOLDEN_LEGGINGS, Items.GOLDEN_BOOTS, Items.GOLDEN_HORSE_ARMOR), RecipeCategory.MISC, Items.GOLD_NUGGET, 0.1F, 200).unlockedBy("has_golden_pickaxe", this.has(Items.GOLDEN_PICKAXE)).unlockedBy("has_golden_shovel", this.has(Items.GOLDEN_SHOVEL)).unlockedBy("has_golden_axe", this.has(Items.GOLDEN_AXE)).unlockedBy("has_golden_hoe", this.has(Items.GOLDEN_HOE)).unlockedBy("has_golden_sword", this.has(Items.GOLDEN_SWORD)).unlockedBy("has_golden_helmet", this.has(Items.GOLDEN_HELMET)).unlockedBy("has_golden_chestplate", this.has(Items.GOLDEN_CHESTPLATE)).unlockedBy("has_golden_leggings", this.has(Items.GOLDEN_LEGGINGS)).unlockedBy("has_golden_boots", this.has(Items.GOLDEN_BOOTS)).unlockedBy("has_golden_horse_armor", this.has(Items.GOLDEN_HORSE_ARMOR)).save(this.output, getSmeltingRecipeName(Items.GOLD_NUGGET));
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.STONE), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_STONE.asItem(), 0.1F, 200).unlockedBy("has_stone", this.has(Blocks.STONE)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.SANDSTONE), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_SANDSTONE.asItem(), 0.1F, 200).unlockedBy("has_sandstone", this.has(Blocks.SANDSTONE)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.RED_SANDSTONE), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_RED_SANDSTONE.asItem(), 0.1F, 200).unlockedBy("has_red_sandstone", this.has(Blocks.RED_SANDSTONE)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.QUARTZ_BLOCK), RecipeCategory.BUILDING_BLOCKS, Blocks.SMOOTH_QUARTZ.asItem(), 0.1F, 200).unlockedBy("has_quartz_block", this.has(Blocks.QUARTZ_BLOCK)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.CRACKED_STONE_BRICKS.asItem(), 0.1F, 200).unlockedBy("has_stone_bricks", this.has(Blocks.STONE_BRICKS)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.BLACK_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.BLACK_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_black_terracotta", this.has(Blocks.BLACK_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.BLUE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.BLUE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_blue_terracotta", this.has(Blocks.BLUE_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.BROWN_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.BROWN_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_brown_terracotta", this.has(Blocks.BROWN_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.CYAN_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.CYAN_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_cyan_terracotta", this.has(Blocks.CYAN_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.GRAY_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.GRAY_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_gray_terracotta", this.has(Blocks.GRAY_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.GREEN_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.GREEN_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_green_terracotta", this.has(Blocks.GREEN_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.LIGHT_BLUE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_light_blue_terracotta", this.has(Blocks.LIGHT_BLUE_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.LIGHT_GRAY_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_light_gray_terracotta", this.has(Blocks.LIGHT_GRAY_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.LIME_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.LIME_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_lime_terracotta", this.has(Blocks.LIME_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.MAGENTA_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.MAGENTA_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_magenta_terracotta", this.has(Blocks.MAGENTA_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.ORANGE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.ORANGE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_orange_terracotta", this.has(Blocks.ORANGE_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.PINK_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.PINK_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_pink_terracotta", this.has(Blocks.PINK_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.PURPLE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.PURPLE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_purple_terracotta", this.has(Blocks.PURPLE_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.RED_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.RED_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_red_terracotta", this.has(Blocks.RED_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.WHITE_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.WHITE_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_white_terracotta", this.has(Blocks.WHITE_TERRACOTTA)).save(this.output);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike)Blocks.YELLOW_TERRACOTTA), RecipeCategory.DECORATIONS, Blocks.YELLOW_GLAZED_TERRACOTTA.asItem(), 0.1F, 200).unlockedBy("has_yellow_terracotta", this.has(Blocks.YELLOW_TERRACOTTA)).save(this.output);
      ...
      SimpleCookingRecipeBuilder.blasting(Ingredient.of((ItemLike)Blocks.NETHER_QUARTZ_ORE), RecipeCategory.MISC, Items.QUARTZ, 0.2F, 100).unlockedBy("has_nether_quartz_ore", this.has(Blocks.NETHER_QUARTZ_ORE)).save(this.output, getBlastingRecipeName(Items.QUARTZ));
      SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_AXE, Items.GOLDEN_HOE, Items.GOLDEN_SWORD, Items.GOLDEN_HELMET, Items.GOLDEN_CHESTPLATE, Items.GOLDEN_LEGGINGS, Items.GOLDEN_BOOTS, Items.GOLDEN_HORSE_ARMOR), RecipeCategory.MISC, Items.GOLD_NUGGET, 0.1F, 100).unlockedBy("has_golden_pickaxe", this.has(Items.GOLDEN_PICKAXE)).unlockedBy("has_golden_shovel", this.has(Items.GOLDEN_SHOVEL)).unlockedBy("has_golden_axe", this.has(Items.GOLDEN_AXE)).unlockedBy("has_golden_hoe", this.has(Items.GOLDEN_HOE)).unlockedBy("has_golden_sword", this.has(Items.GOLDEN_SWORD)).unlockedBy("has_golden_helmet", this.has(Items.GOLDEN_HELMET)).unlockedBy("has_golden_chestplate", this.has(Items.GOLDEN_CHESTPLATE)).unlockedBy("has_golden_leggings", this.has(Items.GOLDEN_LEGGINGS)).unlockedBy("has_golden_boots", this.has(Items.GOLDEN_BOOTS)).unlockedBy("has_golden_horse_armor", this.has(Items.GOLDEN_HORSE_ARMOR)).save(this.output, getBlastingRecipeName(Items.GOLD_NUGGET));
      SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.IRON_PICKAXE, Items.IRON_SHOVEL, Items.IRON_AXE, Items.IRON_HOE, Items.IRON_SWORD, Items.IRON_HELMET, Items.IRON_CHESTPLATE, Items.IRON_LEGGINGS, Items.IRON_BOOTS, Items.IRON_HORSE_ARMOR, Items.CHAINMAIL_HELMET, Items.CHAINMAIL_CHESTPLATE, Items.CHAINMAIL_LEGGINGS, Items.CHAINMAIL_BOOTS), RecipeCategory.MISC, Items.IRON_NUGGET, 0.1F, 100).unlockedBy("has_iron_pickaxe", this.has(Items.IRON_PICKAXE)).unlockedBy("has_iron_shovel", this.has(Items.IRON_SHOVEL)).unlockedBy("has_iron_axe", this.has(Items.IRON_AXE)).unlockedBy("has_iron_hoe", this.has(Items.IRON_HOE)).unlockedBy("has_iron_sword", this.has(Items.IRON_SWORD)).unlockedBy("has_iron_helmet", this.has(Items.IRON_HELMET)).unlockedBy("has_iron_chestplate", this.has(Items.IRON_CHESTPLATE)).unlockedBy("has_iron_leggings", this.has(Items.IRON_LEGGINGS)).unlockedBy("has_iron_boots", this.has(Items.IRON_BOOTS)).unlockedBy("has_iron_horse_armor", this.has(Items.IRON_HORSE_ARMOR)).unlockedBy("has_chainmail_helmet", this.has(Items.CHAINMAIL_HELMET)).unlockedBy("has_chainmail_chestplate", this.has(Items.CHAINMAIL_CHESTPLATE)).unlockedBy("has_chainmail_leggings", this.has(Items.CHAINMAIL_LEGGINGS)).unlockedBy("has_chainmail_boots", this.has(Items.CHAINMAIL_BOOTS)).save(this.output, getBlastingRecipeName(Items.IRON_NUGGET));
      SimpleCookingRecipeBuilder.blasting(Ingredient.of((ItemLike)Blocks.ANCIENT_DEBRIS), RecipeCategory.MISC, Items.NETHERITE_SCRAP, 2.0F, 100).unlockedBy("has_ancient_debris", this.has(Blocks.ANCIENT_DEBRIS)).save(this.output, getBlastingRecipeName(Items.NETHERITE_SCRAP));
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.STONE), RecipeCategory.BUILDING_BLOCKS, Blocks.CHISELED_STONE_BRICKS).unlockedBy("has_stone", this.has(Blocks.STONE)).save(this.output, "chiseled_stone_bricks_stone_from_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.STONE), RecipeCategory.DECORATIONS, Blocks.STONE_BRICK_WALL).unlockedBy("has_stone", this.has(Blocks.STONE)).save(this.output, "stone_brick_walls_from_stone_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.QUARTZ_BLOCK), RecipeCategory.BUILDING_BLOCKS, Blocks.QUARTZ_SLAB, 2).unlockedBy("has_quartz_block", this.has(Blocks.QUARTZ_BLOCK)).save(this.output, "quartz_slab_from_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.STONE_BRICKS), RecipeCategory.DECORATIONS, Blocks.STONE_BRICK_WALL).unlockedBy("has_stone_bricks", this.has(Blocks.STONE_BRICKS)).save(this.output, "stone_brick_wall_from_stone_bricks_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.PRISMARINE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.PRISMARINE_BRICK_SLAB, 2).unlockedBy("has_prismarine_brick", this.has(Blocks.PRISMARINE_BRICKS)).save(this.output, "prismarine_brick_slab_from_prismarine_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.PRISMARINE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.PRISMARINE_BRICK_STAIRS).unlockedBy("has_prismarine_brick", this.has(Blocks.PRISMARINE_BRICKS)).save(this.output, "prismarine_brick_stairs_from_prismarine_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.MOSSY_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_STONE_BRICK_SLAB, 2).unlockedBy("has_mossy_stone_bricks", this.has(Blocks.MOSSY_STONE_BRICKS)).save(this.output, "mossy_stone_brick_slab_from_mossy_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.MOSSY_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.MOSSY_STONE_BRICK_STAIRS).unlockedBy("has_mossy_stone_bricks", this.has(Blocks.MOSSY_STONE_BRICKS)).save(this.output, "mossy_stone_brick_stairs_from_mossy_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.MOSSY_STONE_BRICKS), RecipeCategory.DECORATIONS, Blocks.MOSSY_STONE_BRICK_WALL).unlockedBy("has_mossy_stone_bricks", this.has(Blocks.MOSSY_STONE_BRICKS)).save(this.output, "mossy_stone_brick_wall_from_mossy_stone_brick_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.END_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.END_STONE_BRICK_SLAB, 2).unlockedBy("has_end_stone_brick", this.has(Blocks.END_STONE_BRICKS)).save(this.output, "end_stone_brick_slab_from_end_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.END_STONE_BRICKS), RecipeCategory.BUILDING_BLOCKS, Blocks.END_STONE_BRICK_STAIRS).unlockedBy("has_end_stone_brick", this.has(Blocks.END_STONE_BRICKS)).save(this.output, "end_stone_brick_stairs_from_end_stone_brick_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of((ItemLike)Blocks.END_STONE_BRICKS), RecipeCategory.DECORATIONS, Blocks.END_STONE_BRICK_WALL).unlockedBy("has_end_stone_brick", this.has(Blocks.END_STONE_BRICKS)).save(this.output, "end_stone_brick_wall_from_end_stone_brick_stonecutting");
      ...
      smithingTrims().forEach((var1x) -> {
         this.trimSmithing(var1x.template(), var1x.id());
      });
      ...
      this.shaped(RecipeCategory.TOOLS, Items.BRUSH).define('X', (ItemLike)Items.FEATHER).define('#', (ItemLike)Items.COPPER_INGOT).define('I', (ItemLike)Items.STICK).pattern("X").pattern("#").pattern("I").unlockedBy("has_copper_ingot", this.has(Items.COPPER_INGOT)).save(this.output);
      this.shaped(RecipeCategory.DECORATIONS, Items.DECORATED_POT).define('#', (ItemLike)Items.BRICK).pattern(" # ").pattern("# #").pattern(" # ").unlockedBy("has_brick", this.has(ItemTags.DECORATED_POT_INGREDIENTS)).save(this.output, "decorated_pot_simple");
      SpecialRecipeBuilder.special(DecoratedPotRecipe::new).save(this.output, "decorated_pot");
      this.shaped(RecipeCategory.REDSTONE, Blocks.CRAFTER).define('#', (ItemLike)Items.IRON_INGOT).define('C', (ItemLike)Items.CRAFTING_TABLE).define('R', (ItemLike)Items.REDSTONE).define('D', (ItemLike)Items.DROPPER).pattern("###").pattern("#C#").pattern("RDR").unlockedBy("has_dropper", this.has(Items.DROPPER)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.WIND_CHARGE, 4).requires((ItemLike)Items.BREEZE_ROD).unlockedBy("has_breeze_rod", this.has(Items.BREEZE_ROD)).save(this.output);
      this.shaped(RecipeCategory.COMBAT, Items.MACE, 1).define('I', (ItemLike)Items.BREEZE_ROD).define('#', (ItemLike)Blocks.HEAVY_CORE).pattern(" # ").pattern(" I ").unlockedBy("has_breeze_rod", this.has(Items.BREEZE_ROD)).unlockedBy("has_heavy_core", this.has(Blocks.HEAVY_CORE)).save(this.output);
      this.doorBuilder(Blocks.COPPER_DOOR, Ingredient.of((ItemLike)Items.COPPER_INGOT)).unlockedBy(getHasName(Items.COPPER_INGOT), this.has(Items.COPPER_INGOT)).save(this.output);
      this.trapdoorBuilder(Blocks.COPPER_TRAPDOOR, Ingredient.of((ItemLike)Items.COPPER_INGOT)).unlockedBy(getHasName(Items.COPPER_INGOT), this.has(Items.COPPER_INGOT)).save(this.output);
      this.shaped(RecipeCategory.TOOLS, Items.BUNDLE).define('-', (ItemLike)Items.STRING).define('#', (ItemLike)Items.LEATHER).pattern("-").pattern("#").unlockedBy("has_string", this.has(Items.STRING)).save(this.output);
      this.bundleRecipes();
   }
   ...
   public static Stream<TrimTemplate> smithingTrims() {
      return Stream.of(Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE, Items.COAST_ARMOR_TRIM_SMITHING_TEMPLATE, Items.DUNE_ARMOR_TRIM_SMITHING_TEMPLATE, Items.EYE_ARMOR_TRIM_SMITHING_TEMPLATE, Items.FLOW_ARMOR_TRIM_SMITHING_TEMPLATE, Items.HOST_ARMOR_TRIM_SMITHING_TEMPLATE, Items.RAISER_ARMOR_TRIM_SMITHING_TEMPLATE, Items.RIB_ARMOR_TRIM_SMITHING_TEMPLATE, Items.SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE, Items.SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE, Items.SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE, Items.SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE, Items.SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE, Items.TIDE_ARMOR_TRIM_SMITHING_TEMPLATE, Items.VEX_ARMOR_TRIM_SMITHING_TEMPLATE, Items.WARD_ARMOR_TRIM_SMITHING_TEMPLATE, Items.WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE, Items.WILD_ARMOR_TRIM_SMITHING_TEMPLATE).map((var0) -> {
         return new TrimTemplate(var0, ResourceKey.create(Registries.RECIPE, ResourceLocation.withDefaultNamespace(getItemName(var0) + "_smithing_trim")));
      });
   }
   ...
   private void shulkerBoxRecipes() {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         TransmuteRecipeBuilder.transmute(RecipeCategory.DECORATIONS, var1, Ingredient.of((ItemLike)DyeItem.byColor(var5)), ShulkerBoxBlock.getBlockByColor(var5).asItem()).group("shulker_box_dye").unlockedBy("has_shulker_box", this.has(ItemTags.SHULKER_BOXES)).save(this.output);
      }
   ...
   private void bundleRecipes() {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         TransmuteRecipeBuilder.transmute(RecipeCategory.TOOLS, var1, Ingredient.of((ItemLike)var6), BundleItem.getByColor(var5)).group("bundle_dye").unlockedBy(getHasName(var6), this.has(var6)).save(this.output);
      }
