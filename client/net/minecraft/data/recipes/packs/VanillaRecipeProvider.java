...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   protected void buildRecipes() {
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.DISPENSER).define('R', Items.REDSTONE).define('#', ItemTags.STONE_TOOL_MATERIALS).define('X', Items.BOW).pattern("###").pattern("#X#").pattern("#R#").unlockedBy("has_bow", this.has(Items.BOW)).save(this.output);
      this.twoByTwoPacker(RecipeCategory.BUILDING_BLOCKS, Blocks.DRIPSTONE_BLOCK, Items.POINTED_DRIPSTONE);
      this.shaped(RecipeCategory.REDSTONE, Blocks.DROPPER).define('R', Items.REDSTONE).define('#', ItemTags.STONE_TOOL_MATERIALS).pattern("###").pattern("# #").pattern("#R#").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Blocks.ENDER_CHEST).define('#', Blocks.OBSIDIAN).define('E', Items.EXIT_EYE).pattern("###").pattern("#E#").pattern("###").unlockedBy("has_exit_eye", this.has(Items.EXIT_EYE)).save(this.output);
      this.shaped(RecipeCategory.MISC, Items.EXIT_EYE).define('I', Items.IRON_INGOT).define('C', Items.COPPER_INGOT).pattern("CCC").pattern("CIC").pattern("CCC").unlockedBy("has_dirt", this.has(Items.DIRT)).unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).unlockedBy("has_ender_iron_ore", this.has(Items.RAW_IRON)).unlockedBy("has_ender_copper_ore", this.has(Items.RAW_COPPER)).save(this.output);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Items.END_CRYSTAL).define('T', Items.GHAST_TEAR).define('E', Items.EXIT_EYE).define('G', Blocks.GLASS).pattern("GGG").pattern("GEG").pattern("GTG").unlockedBy("has_exit_eye", this.has(Items.EXIT_EYE)).save(this.output);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Blocks.FURNACE).define('#', ItemTags.STONE_CRAFTING_MATERIALS).pattern("###").pattern("# #").pattern("###").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.LEVER).define('#', ItemTags.STONE_TOOL_MATERIALS).define('X', Items.STICK).pattern("X").pattern("#").unlockedBy("has_cobblestone", this.has(ItemTags.STONE_TOOL_MATERIALS)).save(this.output);
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.OBSERVER).define('Q', Items.QUARTZ).define('R', Items.REDSTONE).define('#', ItemTags.STONE_TOOL_MATERIALS).pattern("###").pattern("RRQ").pattern("###").unlockedBy("has_quartz", this.has(Items.QUARTZ)).save(this.output);
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.PISTON).define('R', Items.REDSTONE).define('#', ItemTags.STONE_TOOL_MATERIALS).define('T', ItemTags.PLANKS).define('X', Items.IRON_INGOT).pattern("TTT").pattern("#X#").pattern("#R#").unlockedBy("has_redstone", this.has(Items.REDSTONE)).save(this.output);
