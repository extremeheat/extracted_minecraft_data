...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   protected void buildRecipes() {
      ...
      this.shapeless(RecipeCategory.MISC, Items.BLACK_DYE).requires(Items.INK_SAC).group("black_dye").unlockedBy("has_ink_sac", this.has(Items.INK_SAC)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.BLUE_DYE).requires(Items.LAPIS_LAZULI).group("blue_dye").unlockedBy("has_lapis_lazuli", this.has(Items.LAPIS_LAZULI)).save(this.output);
      ...
      this.shaped(RecipeCategory.DECORATIONS, Blocks.COPPER_CHEST).define('#', Items.COPPER_INGOT).define('X', Items.CHEST).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_copper_chest", this.has(Items.COPPER_CHEST)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.COPPER_INGOT, 9).requires(Blocks.WAXED_COPPER_BLOCK).group(getItemName(Items.COPPER_INGOT)).unlockedBy(getHasName(Blocks.WAXED_COPPER_BLOCK), this.has(Blocks.WAXED_COPPER_BLOCK)).save(this.output, getConversionRecipeName(Items.COPPER_INGOT, Blocks.WAXED_COPPER_BLOCK));
      this.waxRecipes(FeatureFlagSet.of(FeatureFlags.VANILLA));
      this.shapeless(RecipeCategory.MISC, Items.CYAN_DYE, 2).requires(Items.BLUE_DYE).requires(Items.GREEN_DYE).group("cyan_dye").unlockedBy("has_green_dye", this.has(Items.GREEN_DYE)).unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DARK_PRISMARINE).define('S', Items.PRISMARINE_SHARD).define('I', Items.BLACK_DYE).pattern("SSS").pattern("SIS").pattern("SSS").unlockedBy("has_prismarine_shard", this.has(Items.PRISMARINE_SHARD)).save(this.output);
      ...
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DEEPSLATE_BRICKS, 4).define('S', Blocks.POLISHED_DEEPSLATE).pattern("SS").pattern("SS").unlockedBy("has_polished_deepslate", this.has(Blocks.POLISHED_DEEPSLATE)).save(this.output);
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.DEEPSLATE_TILES, 4).define('S', Blocks.DEEPSLATE_BRICKS).pattern("SS").pattern("SS").unlockedBy("has_deepslate_bricks", this.has(Blocks.DEEPSLATE_BRICKS)).save(this.output);
      ...
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.END_STONE_BRICKS, 4).define('#', Blocks.END_STONE).pattern("##").pattern("##").unlockedBy("has_end_stone", this.has(Blocks.END_STONE)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.LIGHT_BLUE_DYE, 2).requires(Items.BLUE_DYE).requires(Items.WHITE_DYE).group("light_blue_dye").unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output, "light_blue_dye_from_blue_white_dye");
      this.oneToOneConversionRecipe(Items.LIGHT_GRAY_DYE, Blocks.AZURE_BLUET, "light_gray_dye");
      this.shapeless(RecipeCategory.MISC, Items.LIGHT_GRAY_DYE, 2).requires(Items.GRAY_DYE).requires(Items.WHITE_DYE).group("light_gray_dye").unlockedBy("has_gray_dye", this.has(Items.GRAY_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output, "light_gray_dye_from_gray_white_dye");
      this.shapeless(RecipeCategory.MISC, Items.LIGHT_GRAY_DYE, 3).requires(Items.BLACK_DYE).requires((ItemLike)Items.WHITE_DYE, 2).group("light_gray_dye").unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).unlockedBy("has_black_dye", this.has(Items.BLACK_DYE)).save(this.output, "light_gray_dye_from_black_white_dye");
      ...
      this.shaped(RecipeCategory.REDSTONE, Blocks.LIGHTNING_ROD).define('#', Items.COPPER_INGOT).pattern("#").pattern("#").pattern("#").unlockedBy("has_copper_ingot", this.has(Items.COPPER_INGOT)).save(this.output);
      this.shapeless(RecipeCategory.MISC, Items.LIME_DYE, 2).requires(Items.GREEN_DYE).requires(Items.WHITE_DYE).unlockedBy("has_green_dye", this.has(Items.GREEN_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output);
      ...
      this.shapeless(RecipeCategory.MISC, Items.MAGENTA_DYE, 4).requires(Items.BLUE_DYE).requires((ItemLike)Items.RED_DYE, 2).requires(Items.WHITE_DYE).group("magenta_dye").unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_rose_red", this.has(Items.RED_DYE)).unlockedBy("has_white_dye", this.has(Items.WHITE_DYE)).save(this.output, "magenta_dye_from_blue_red_white_dye");
      this.shapeless(RecipeCategory.MISC, Items.MAGENTA_DYE, 3).requires(Items.BLUE_DYE).requires(Items.RED_DYE).requires(Items.PINK_DYE).group("magenta_dye").unlockedBy("has_pink_dye", this.has(Items.PINK_DYE)).unlockedBy("has_blue_dye", this.has(Items.BLUE_DYE)).unlockedBy("has_red_dye", this.has(Items.RED_DYE)).save(this.output, "magenta_dye_from_blue_red_pink");
      this.oneToOneConversionRecipe(Items.MAGENTA_DYE, Blocks.LILAC, "magenta_dye", 2);
      this.shapeless(RecipeCategory.MISC, Items.MAGENTA_DYE, 2).requires(Items.PURPLE_DYE).requires(Items.PINK_DYE).group("magenta_dye").unlockedBy("has_pink_dye", this.has(Items.PINK_DYE)).unlockedBy("has_purple_dye", this.has(Items.PURPLE_DYE)).save(this.output, "magenta_dye_from_purple_and_pink");
      ...
      this.shapeless(RecipeCategory.MISC, Items.ORANGE_DYE, 2).requires(Items.RED_DYE).requires(Items.YELLOW_DYE).group("orange_dye").unlockedBy("has_red_dye", this.has(Items.RED_DYE)).unlockedBy("has_yellow_dye", this.has(Items.YELLOW_DYE)).save(this.output, "orange_dye_from_red_yellow");
      ...
      this.shapeless(RecipeCategory.MISC, Items.RED_DYE).requires(Blocks.RED_TULIP).group("red_dye").unlockedBy("has_red_flower", this.has(Blocks.RED_TULIP)).save(this.output, "red_dye_from_tulip");
      ...
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.STONE_BRICKS, 4).define('#', Blocks.STONE).pattern("##").pattern("##").unlockedBy("has_stone", this.has(Blocks.STONE)).save(this.output);
      ...
      this.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.WHITE_WOOL).define('#', Items.STRING).pattern("##").pattern("##").unlockedBy("has_string", this.has(Items.STRING)).save(this.output, getConversionRecipeName(Blocks.WHITE_WOOL, Items.STRING));
      ...
      this.shapeless(RecipeCategory.MISC, Items.WHITE_DYE).requires(Items.BONE_MEAL).group("white_dye").unlockedBy("has_bone_meal", this.has(Items.BONE_MEAL)).save(this.output);
