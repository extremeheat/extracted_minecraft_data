...
public class BlockModelGenerators {
   ...
   private static BlockStateGenerator createNorthWestMirroredCubeGenerator(Block var0, ResourceLocation var1, TextureMapping var2, BiConsumer<ResourceLocation, Supplier<JsonElement>> var3) {
   ...
   private BlockEntityModelGenerator blockEntityModels(ResourceLocation var1, Block var2) {
      return new BlockEntityModelGenerator(var1, var2);
   }

   private BlockEntityModelGenerator blockEntityModels(Block var1, Block var2) {
      return new BlockEntityModelGenerator(ModelLocationUtils.getModelLocation(var1), var2);
   }
   ...
   private class BlockFamilyProvider {
      ...
      public BlockFamilyProvider fullBlockCopies(Block... var1) {
   ...
   private class BlockEntityModelGenerator {
      ...
      public BlockEntityModelGenerator create(Block... var1) {
         Block[] var2 = var1;
         int var3 = var1.length;
      ...
      public BlockEntityModelGenerator createWithoutBlockItem(Block... var1) {
         Block[] var2 = var1;
         int var3 = var1.length;
      ...
      public BlockEntityModelGenerator createWithCustomBlockItemModel(ModelTemplate var1, Block... var2) {
         Block[] var3 = var2;
         int var4 = var2.length;
