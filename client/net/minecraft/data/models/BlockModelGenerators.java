...
public class BlockModelGenerators {
   ...
   private static PropertyDispatch.class_286<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> configureDoorHalf(PropertyDispatch.class_286<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> var0, DoubleBlockHalf var1, ResourceLocation var2, ResourceLocation var3) {
   ...
   private static PropertyDispatch createRotatedPillar() {
      return PropertyDispatch.property(BlockStateProperties.AXIS).select(Direction.Axis.field_501, (Variant)Variant.variant()).select(Direction.Axis.field_502, (Variant)Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)).select(Direction.Axis.field_500, (Variant)Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90));
   }
   ...
   static BlockStateGenerator createRotatedPillarWithHorizontalVariant(Block var0, ResourceLocation var1, ResourceLocation var2) {
      return MultiVariantGenerator.multiVariant(var0).with(PropertyDispatch.property(BlockStateProperties.AXIS).select(Direction.Axis.field_501, (Variant)Variant.variant().with(VariantProperties.MODEL, var1)).select(Direction.Axis.field_502, (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)).select(Direction.Axis.field_500, (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)));
   }
   ...
   private void createRedstoneWire() {
      ...
      this.blockStateOutput.accept(MultiPartGenerator.multiPart(Blocks.REDSTONE_WIRE).with(Condition.method_9(Condition.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.NONE).term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.NONE).term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.NONE).term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.NONE), Condition.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318).term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), Condition.condition().term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318).term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), Condition.condition().term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318).term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), Condition.condition().term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318).term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318)), Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_dot"))).with(Condition.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_side0"))).with(Condition.condition().term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_side_alt0"))).with(Condition.condition().term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_side_alt1")).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).with(Condition.condition().term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_side1")).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).with(Condition.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_up"))).with(Condition.condition().term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_up")).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with(Condition.condition().term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_up")).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).with(Condition.condition().term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.field_318), (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.decorateBlockModelLocation("redstone_dust_up")).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)));
   }
   ...
   private void createMushroomBlock(Block var1) {
      ...
      this.blockStateOutput.accept(MultiPartGenerator.multiPart(var1).with(Condition.condition().term(BlockStateProperties.NORTH, true), (Variant)Variant.variant().with(VariantProperties.MODEL, var2)).with(Condition.condition().term(BlockStateProperties.EAST, true), (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.SOUTH, true), (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.WEST, true), (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.field_246, true), (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.X_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.DOWN, true), (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.NORTH, false), (Variant)Variant.variant().with(VariantProperties.MODEL, var3)).with(Condition.condition().term(BlockStateProperties.EAST, false), (Variant)Variant.variant().with(VariantProperties.MODEL, var3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.SOUTH, false), (Variant)Variant.variant().with(VariantProperties.MODEL, var3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.WEST, false), (Variant)Variant.variant().with(VariantProperties.MODEL, var3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.field_246, false), (Variant)Variant.variant().with(VariantProperties.MODEL, var3).with(VariantProperties.X_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, false)).with(Condition.condition().term(BlockStateProperties.DOWN, false), (Variant)Variant.variant().with(VariantProperties.MODEL, var3).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, false)));
   ...
   private void createPointedDripstone() {
      ...
      PropertyDispatch.class_288 var1 = PropertyDispatch.properties(BlockStateProperties.VERTICAL_DIRECTION, BlockStateProperties.DRIPSTONE_THICKNESS);
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         var5 = var2[var4];
         var1.select(Direction.field_526, var5, (Variant)this.createPointedDripstoneVariant(Direction.field_526, var5));
      }
   ...
   private void createFire() {
      Condition.TerminalCondition var1 = Condition.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.field_246, false);
      ...
      this.blockStateOutput.accept(MultiPartGenerator.multiPart(Blocks.FIRE).with(var1, (List)wrapModels(var2, (var0) -> {
         return var0;
      })).with(Condition.method_9(Condition.condition().term(BlockStateProperties.NORTH, true), var1), wrapModels(var3, (var0) -> {
         return var0;
      })).with(Condition.method_9(Condition.condition().term(BlockStateProperties.EAST, true), var1), wrapModels(var3, (var0) -> {
         return var0.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90);
      })).with(Condition.method_9(Condition.condition().term(BlockStateProperties.SOUTH, true), var1), wrapModels(var3, (var0) -> {
         return var0.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180);
      })).with(Condition.method_9(Condition.condition().term(BlockStateProperties.WEST, true), var1), wrapModels(var3, (var0) -> {
         return var0.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270);
      })).with(Condition.condition().term(BlockStateProperties.field_246, true), (List)wrapModels(var4, (var0) -> {
         return var0;
      })));
   }
   ...
   private void createNetherPortalBlock() {
      this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.NETHER_PORTAL).with(PropertyDispatch.property(BlockStateProperties.HORIZONTAL_AXIS).select(Direction.Axis.field_500, (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.NETHER_PORTAL, "_ns"))).select(Direction.Axis.field_502, (Variant)Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.NETHER_PORTAL, "_ew")))));
   }
   ...
   private void createMultiface(Block var1) {
      ...
      Condition.TerminalCondition var4 = (Condition.TerminalCondition)Util.make(Condition.condition(), (var1x) -> {
         MULTIFACE_GENERATOR.forEach((var2, var3) -> {
      ...
      MULTIFACE_GENERATOR.forEach((var4x, var5) -> {
         if (var1.defaultBlockState().hasProperty(var4x)) {
            var3.with(Condition.condition().term(var4x, true), (Variant)((Variant)var5.apply(var2)));
            var3.with(var4, (Variant)((Variant)var5.apply(var2)));
         }
   ...
   private void createJigsaw() {
      ...
      TextureMapping var5 = (new TextureMapping()).put(TextureSlot.DOWN, var3).put(TextureSlot.WEST, var3).put(TextureSlot.EAST, var3).put(TextureSlot.PARTICLE, var1).put(TextureSlot.NORTH, var1).put(TextureSlot.SOUTH, var2).put(TextureSlot.field_353, var4);
   ...
   private void createLightBlock() {
      ...
      PropertyDispatch.class_284 var1 = PropertyDispatch.property(BlockStateProperties.LEVEL);

      for(int var2 = 0; var2 < 16; ++var2) {
         String var3 = String.format("_%02d", var2);
         ResourceLocation var4 = TextureMapping.getItemTexture(Items.LIGHT, var3);
         var1.select(var2, (Variant)Variant.variant().with(VariantProperties.MODEL, ModelTemplates.PARTICLE_ONLY.createWithSuffix(Blocks.LIGHT, var3, TextureMapping.particle(var4), this.modelOutput)));
   ...
   static {
      ...
      MULTIFACE_GENERATOR = (Map)Util.make(Maps.newHashMap(), (var0) -> {
         ...
         var0.put(BlockStateProperties.field_246, (var0x) -> {
   ...
   private static enum TintState {
      ...
      // $FF: synthetic method
      private static BlockModelGenerators.TintState[] $values() {
         return new BlockModelGenerators.TintState[]{TINTED, NOT_TINTED};
      }
   }
