...
public class TextureMapping {
   ...
   public static TextureMapping craftingTable(Block var0, Block var1) {
      return (new TextureMapping()).put(TextureSlot.PARTICLE, getBlockTexture(var0, "_front")).put(TextureSlot.DOWN, getBlockTexture(var1)).put(TextureSlot.field_353, getBlockTexture(var0, "_top")).put(TextureSlot.NORTH, getBlockTexture(var0, "_front")).put(TextureSlot.EAST, getBlockTexture(var0, "_side")).put(TextureSlot.SOUTH, getBlockTexture(var0, "_side")).put(TextureSlot.WEST, getBlockTexture(var0, "_front"));
   }

   public static TextureMapping fletchingTable(Block var0, Block var1) {
      return (new TextureMapping()).put(TextureSlot.PARTICLE, getBlockTexture(var0, "_front")).put(TextureSlot.DOWN, getBlockTexture(var1)).put(TextureSlot.field_353, getBlockTexture(var0, "_top")).put(TextureSlot.NORTH, getBlockTexture(var0, "_front")).put(TextureSlot.SOUTH, getBlockTexture(var0, "_front")).put(TextureSlot.EAST, getBlockTexture(var0, "_side")).put(TextureSlot.WEST, getBlockTexture(var0, "_side"));
   }
