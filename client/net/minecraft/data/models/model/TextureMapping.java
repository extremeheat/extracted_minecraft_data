...
public class TextureMapping {
   ...
   public static TextureMapping pottedAzalea(Block var0) {
      return new TextureMapping()
         .put(TextureSlot.PLANT, getBlockTexture(var0, "_plant"))
   ...
   public static TextureMapping commandBlock(Block var0) {
      return new TextureMapping()
         .put(TextureSlot.SIDE, getBlockTexture(var0, "_side"))
         .put(TextureSlot.FRONT, getBlockTexture(var0, "_front"))
         .put(TextureSlot.BACK, getBlockTexture(var0, "_back"));
   }
   ...
   public static TextureMapping orientableCubeSameEnds(Block var0) {
      return new TextureMapping()
         .put(TextureSlot.SIDE, getBlockTexture(var0, "_side"))
         .put(TextureSlot.FRONT, getBlockTexture(var0, "_front"))
         .put(TextureSlot.END, getBlockTexture(var0, "_end"));
   }
   ...
   public static TextureMapping craftingTable(Block var0, Block var1) {
      return new TextureMapping()
         .put(TextureSlot.PARTICLE, getBlockTexture(var0, "_front"))
         .put(TextureSlot.DOWN, getBlockTexture(var1))
         .put(TextureSlot.UP, getBlockTexture(var0, "_top"))
         .put(TextureSlot.NORTH, getBlockTexture(var0, "_front"))
         .put(TextureSlot.EAST, getBlockTexture(var0, "_side"))
         .put(TextureSlot.SOUTH, getBlockTexture(var0, "_side"))
         .put(TextureSlot.WEST, getBlockTexture(var0, "_front"));
   }
   ...
   public static TextureMapping fletchingTable(Block var0, Block var1) {
      return new TextureMapping()
         ...
         .put(TextureSlot.UP, getBlockTexture(var0, "_top"))
         .put(TextureSlot.NORTH, getBlockTexture(var0, "_front"))
         .put(TextureSlot.SOUTH, getBlockTexture(var0, "_front"))
         .put(TextureSlot.EAST, getBlockTexture(var0, "_side"))
         .put(TextureSlot.WEST, getBlockTexture(var0, "_side"));
   }

   public static TextureMapping snifferEgg(String var0) {
      return new TextureMapping()
         .put(TextureSlot.PARTICLE, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_north"))
         .put(TextureSlot.BOTTOM, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_bottom"))
         .put(TextureSlot.TOP, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_top"))
         .put(TextureSlot.NORTH, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_north"))
         .put(TextureSlot.SOUTH, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_south"))
         .put(TextureSlot.EAST, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_east"))
         .put(TextureSlot.WEST, getBlockTexture(Blocks.SNIFFER_EGG, var0 + "_west"));
   }
   ...
   public static TextureMapping candleCake(Block var0, boolean var1) {
      return new TextureMapping()
         ...
         .put(TextureSlot.CANDLE, getBlockTexture(var0, var1 ? "_lit" : ""));
   }
   ...
   public static TextureMapping sculkShrieker(boolean var0) {
      ...
      return new TextureMapping()
         ...
         .put(TextureSlot.INNER_TOP, getBlockTexture(Blocks.SCULK_SHRIEKER, var1 + "_inner_top"))
