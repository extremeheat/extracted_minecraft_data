...
public class BlockFamilies {
   ...
   static {
      ACACIA_PLANKS = familyBuilder(Blocks.ACACIA_PLANKS).log(Blocks.ACACIA_LOG).strippedLog(Blocks.STRIPPED_ACACIA_LOG).button(Blocks.ACACIA_BUTTON).fence(Blocks.ACACIA_FENCE).fenceGate(Blocks.ACACIA_FENCE_GATE).hangingSign(Blocks.ACACIA_HANGING_SIGN, Blocks.ACACIA_WALL_HANGING_SIGN).pressurePlate(Blocks.ACACIA_PRESSURE_PLATE).sign(Blocks.ACACIA_SIGN, Blocks.ACACIA_WALL_SIGN).slab(Blocks.ACACIA_SLAB).stairs(Blocks.ACACIA_STAIRS).door(Blocks.ACACIA_DOOR).trapdoor(Blocks.ACACIA_TRAPDOOR).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
      CHERRY_PLANKS = familyBuilder(Blocks.CHERRY_PLANKS).log(Blocks.CHERRY_LOG).strippedLog(Blocks.STRIPPED_CHERRY_LOG).button(Blocks.CHERRY_BUTTON).fence(Blocks.CHERRY_FENCE).fenceGate(Blocks.CHERRY_FENCE_GATE).hangingSign(Blocks.CHERRY_HANGING_SIGN, Blocks.CHERRY_WALL_HANGING_SIGN).pressurePlate(Blocks.CHERRY_PRESSURE_PLATE).sign(Blocks.CHERRY_SIGN, Blocks.CHERRY_WALL_SIGN).slab(Blocks.CHERRY_SLAB).stairs(Blocks.CHERRY_STAIRS).door(Blocks.CHERRY_DOOR).trapdoor(Blocks.CHERRY_TRAPDOOR).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
      BIRCH_PLANKS = familyBuilder(Blocks.BIRCH_PLANKS).log(Blocks.BIRCH_LOG).strippedLog(Blocks.STRIPPED_BIRCH_LOG).button(Blocks.BIRCH_BUTTON).fence(Blocks.BIRCH_FENCE).fenceGate(Blocks.BIRCH_FENCE_GATE).hangingSign(Blocks.BIRCH_HANGING_SIGN, Blocks.BIRCH_WALL_HANGING_SIGN).pressurePlate(Blocks.BIRCH_PRESSURE_PLATE).sign(Blocks.BIRCH_SIGN, Blocks.BIRCH_WALL_SIGN).slab(Blocks.BIRCH_SLAB).stairs(Blocks.BIRCH_STAIRS).door(Blocks.BIRCH_DOOR).trapdoor(Blocks.BIRCH_TRAPDOOR).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
      CRIMSON_PLANKS = familyBuilder(Blocks.CRIMSON_PLANKS).log(Blocks.CRIMSON_STEM).strippedLog(Blocks.STRIPPED_CRIMSON_STEM).button(Blocks.CRIMSON_BUTTON).fence(Blocks.CRIMSON_FENCE).fenceGate(Blocks.CRIMSON_FENCE_GATE).hangingSign(Blocks.CRIMSON_HANGING_SIGN, Blocks.CRIMSON_WALL_HANGING_SIGN).pressurePlate(Blocks.CRIMSON_PRESSURE_PLATE).sign(Blocks.CRIMSON_SIGN, Blocks.CRIMSON_WALL_SIGN).slab(Blocks.CRIMSON_SLAB).stairs(Blocks.CRIMSON_STAIRS).door(Blocks.CRIMSON_DOOR).trapdoor(Blocks.CRIMSON_TRAPDOOR).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
      JUNGLE_PLANKS = familyBuilder(Blocks.JUNGLE_PLANKS).log(Blocks.JUNGLE_LOG).strippedLog(Blocks.STRIPPED_JUNGLE_LOG).button(Blocks.JUNGLE_BUTTON).fence(Blocks.JUNGLE_FENCE).fenceGate(Blocks.JUNGLE_FENCE_GATE).hangingSign(Blocks.JUNGLE_HANGING_SIGN, Blocks.JUNGLE_WALL_HANGING_SIGN).pressurePlate(Blocks.JUNGLE_PRESSURE_PLATE).sign(Blocks.JUNGLE_SIGN, Blocks.JUNGLE_WALL_SIGN).slab(Blocks.JUNGLE_SLAB).stairs(Blocks.JUNGLE_STAIRS).door(Blocks.JUNGLE_DOOR).trapdoor(Blocks.JUNGLE_TRAPDOOR).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
      ...
      BAMBOO_PLANKS = familyBuilder(Blocks.BAMBOO_PLANKS).log(Blocks.BAMBOO_BLOCK).strippedLog(Blocks.STRIPPED_BAMBOO_BLOCK).button(Blocks.BAMBOO_BUTTON).slab(Blocks.BAMBOO_SLAB).stairs(Blocks.BAMBOO_STAIRS).customFence(Blocks.BAMBOO_FENCE).customFenceGate(Blocks.BAMBOO_FENCE_GATE).customHangingSign(Blocks.BAMBOO_HANGING_SIGN, Blocks.BAMBOO_WALL_HANGING_SIGN).pressurePlate(Blocks.BAMBOO_PRESSURE_PLATE).sign(Blocks.BAMBOO_SIGN, Blocks.BAMBOO_WALL_SIGN).door(Blocks.BAMBOO_DOOR).trapdoor(Blocks.BAMBOO_TRAPDOOR).mosaic(Blocks.BAMBOO_MOSAIC).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
      ...
      CUT_COPPER = WeatheringCopperCollection.createFamily((prefix, state) -> familyBuilder(Blocks.CUT_COPPER.waxed().pick(state)).slab(Blocks.CUT_COPPER_SLAB.waxed().pick(state)).stairs(Blocks.CUT_COPPER_STAIRS.waxed().pick(state)).recipeGroupPrefix(prefix + "cut_copper").dontGenerateModel().generateStonecutterRecipe().getFamily(), (var0, state) -> familyBuilder(Blocks.CUT_COPPER.weathering().pick(state)).slab(Blocks.CUT_COPPER_SLAB.weathering().pick(state)).stairs(Blocks.CUT_COPPER_STAIRS.weathering().pick(state)).chiseled(Blocks.CHISELED_COPPER.weathering().pick(state)).dontGenerateModel().generateStonecutterRecipe().getFamily());
      COPPER_BLOCK = WeatheringCopperCollection.createFamily((prefix, state) -> familyBuilder(Blocks.COPPER_BLOCK.waxed().pick(state)).cut(Blocks.CUT_COPPER.waxed().pick(state)).recipeGroupPrefix(prefix + "cut_copper").dontGenerateModel().getFamily(), (var0, state) -> familyBuilder(Blocks.COPPER_BLOCK.weathering().pick(state)).cut(Blocks.CUT_COPPER.weathering().pick(state)).dontGenerateModel().getFamily());
