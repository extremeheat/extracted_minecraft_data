...
public class BlockFamilies {
   ...
   public static final BlockFamily DARK_OAK_PLANKS = familyBuilder(Blocks.DARK_OAK_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final BlockFamily PALE_OAK_PLANKS = familyBuilder(Blocks.PALE_OAK_PLANKS)
      .button(Blocks.PALE_OAK_BUTTON)
      .fence(Blocks.PALE_OAK_FENCE)
      .fenceGate(Blocks.PALE_OAK_FENCE_GATE)
      .pressurePlate(Blocks.PALE_OAK_PRESSURE_PLATE)
      .sign(Blocks.PALE_OAK_SIGN, Blocks.PALE_OAK_WALL_SIGN)
      .slab(Blocks.PALE_OAK_SLAB)
      .stairs(Blocks.PALE_OAK_STAIRS)
      .door(Blocks.PALE_OAK_DOOR)
      .trapdoor(Blocks.PALE_OAK_TRAPDOOR)
      .recipeGroupPrefix("wooden")
      .recipeUnlockedBy("has_planks")
      .getFamily();
   ...
   private static BlockFamily.Builder familyBuilder(Block var0) {
      ...
      BlockFamily var2 = MAP.put(var0, var1.getFamily());
      if (var2 != null) {
         throw new IllegalStateException("Duplicate family definition for " + BuiltInRegistries.BLOCK.getKey(var0));
      } else {
         return var1;
      }
   }
