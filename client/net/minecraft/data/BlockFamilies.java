...
public class BlockFamilies {
   ...
   private static BlockFamily.Builder familyBuilder(Block var0) {
      ...
      if (var2 != null) {
         throw new IllegalStateException("Duplicate family definition for " + Registry.BLOCK.getKey(var0));
      } else {
         return var1;
      }
   }
   ...
   static {
      ...
      EXPOSED_CUT_COPPER = familyBuilder(Blocks.EXPOSED_CUT_COPPER).slab(Blocks.EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.EXPOSED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
      ...
      WEATHERED_CUT_COPPER = familyBuilder(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
      ...
      OXIDIZED_CUT_COPPER = familyBuilder(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).dontGenerateModel().getFamily();
