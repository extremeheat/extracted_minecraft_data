...
public class BlockFamilies {
   ...
   static {
      ...
      COPPER_BLOCK = familyBuilder(Blocks.COPPER_BLOCK).cut(Blocks.CUT_COPPER).door(Blocks.COPPER_DOOR).trapdoor(Blocks.COPPER_TRAPDOOR).dontGenerateModel().getFamily();
      ...
      WAXED_COPPER_BLOCK = familyBuilder(Blocks.WAXED_COPPER_BLOCK).cut(Blocks.WAXED_CUT_COPPER).door(Blocks.WAXED_COPPER_DOOR).trapdoor(Blocks.WAXED_COPPER_TRAPDOOR).recipeGroupPrefix("waxed_cut_copper").dontGenerateModel().getFamily();
      WAXED_CUT_COPPER = familyBuilder(Blocks.WAXED_CUT_COPPER).slab(Blocks.WAXED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_CHISELED_COPPER).recipeGroupPrefix("waxed_cut_copper").dontGenerateModel().getFamily();
      EXPOSED_COPPER = familyBuilder(Blocks.EXPOSED_COPPER).cut(Blocks.EXPOSED_CUT_COPPER).door(Blocks.EXPOSED_COPPER_DOOR).trapdoor(Blocks.EXPOSED_COPPER_TRAPDOOR).dontGenerateModel().getFamily();
      ...
      WAXED_EXPOSED_COPPER = familyBuilder(Blocks.WAXED_EXPOSED_COPPER).cut(Blocks.WAXED_EXPOSED_CUT_COPPER).door(Blocks.WAXED_EXPOSED_COPPER_DOOR).trapdoor(Blocks.WAXED_EXPOSED_COPPER_TRAPDOOR).recipeGroupPrefix("waxed_exposed_cut_copper").dontGenerateModel().getFamily();
      WAXED_EXPOSED_CUT_COPPER = familyBuilder(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_EXPOSED_CHISELED_COPPER).recipeGroupPrefix("waxed_exposed_cut_copper").dontGenerateModel().getFamily();
      WEATHERED_COPPER = familyBuilder(Blocks.WEATHERED_COPPER).cut(Blocks.WEATHERED_CUT_COPPER).door(Blocks.WEATHERED_COPPER_DOOR).trapdoor(Blocks.WEATHERED_COPPER_TRAPDOOR).dontGenerateModel().getFamily();
      ...
      WAXED_WEATHERED_COPPER = familyBuilder(Blocks.WAXED_WEATHERED_COPPER).cut(Blocks.WAXED_WEATHERED_CUT_COPPER).door(Blocks.WAXED_WEATHERED_COPPER_DOOR).trapdoor(Blocks.WAXED_WEATHERED_COPPER_TRAPDOOR).recipeGroupPrefix("waxed_weathered_cut_copper").dontGenerateModel().getFamily();
      WAXED_WEATHERED_CUT_COPPER = familyBuilder(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_WEATHERED_CHISELED_COPPER).recipeGroupPrefix("waxed_weathered_cut_copper").dontGenerateModel().getFamily();
      OXIDIZED_COPPER = familyBuilder(Blocks.OXIDIZED_COPPER).cut(Blocks.OXIDIZED_CUT_COPPER).door(Blocks.OXIDIZED_COPPER_DOOR).trapdoor(Blocks.OXIDIZED_COPPER_TRAPDOOR).dontGenerateModel().getFamily();
      ...
      WAXED_OXIDIZED_COPPER = familyBuilder(Blocks.WAXED_OXIDIZED_COPPER).cut(Blocks.WAXED_OXIDIZED_CUT_COPPER).door(Blocks.WAXED_OXIDIZED_COPPER_DOOR).trapdoor(Blocks.WAXED_OXIDIZED_COPPER_TRAPDOOR).recipeGroupPrefix("waxed_oxidized_cut_copper").dontGenerateModel().getFamily();
      WAXED_OXIDIZED_CUT_COPPER = familyBuilder(Blocks.WAXED_OXIDIZED_CUT_COPPER).slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_OXIDIZED_CHISELED_COPPER).recipeGroupPrefix("waxed_oxidized_cut_copper").dontGenerateModel().getFamily();
