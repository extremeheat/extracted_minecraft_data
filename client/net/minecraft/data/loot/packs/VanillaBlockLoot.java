...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      this.add(Blocks.TNT, LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionCondition(Blocks.TNT, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(Blocks.TNT).when(MatchBlock.blockMatches(this.blocks, Blocks.TNT, StatePropertiesPredicate.Builder.properties().hasProperty(TntBlock.UNSTABLE, false)))))));
      this.add(Blocks.COCOA, (block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, LootItem.lootTableItem(Items.COCOA_BEANS).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantValue.exactly(3.0F)).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(CocoaBlock.AGE, 2))))))));
      this.add(Blocks.SHELF_MUSHROOM, (block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, LootItem.lootTableItem(Items.SHELF_MUSHROOM).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(ShelfMushroomBlock.AGE, 1))))))));
      this.add(Blocks.SEA_PICKLE, (block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(Blocks.SEA_PICKLE, LootItem.lootTableItem(block).apply(List.of(2, 3, 4), (count) -> (LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantValue.exactly((float)count)).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, count))))))));
      this.add(Blocks.COMPOSTER, (block) -> LootTable.lootTable().withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, LootItem.lootTableItem(Items.COMPOSTER)))).withPool((LootPool.Builder)LootPool.lootPool().add(LootItem.lootTableItem(Items.BONE_MEAL)).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(ComposterBlock.LEVEL, 8)))));
      ...
      this.add(Blocks.PLAYER_HEAD, (block) -> LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.PROFILE).include(DataComponents.NOTE_BLOCK_SOUND).include(DataComponents.CUSTOM_NAME))))));
      ...
      LootItemCondition.Builder isBeetrootMaxAge = MatchBlock.blockMatches(this.blocks, Blocks.BEETROOTS, StatePropertiesPredicate.Builder.properties().hasProperty(BeetrootBlock.AGE, 3));
      this.add(Blocks.BEETROOTS, this.createCropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, isBeetrootMaxAge));
      LootItemCondition.Builder isWheatMaxAge = MatchBlock.blockMatches(this.blocks, Blocks.WHEAT, StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7));
      this.add(Blocks.WHEAT, this.createCropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, isWheatMaxAge));
      LootItemCondition.Builder isCarrotMaxAge = MatchBlock.blockMatches(this.blocks, Blocks.CARROTS, StatePropertiesPredicate.Builder.properties().hasProperty(CarrotBlock.AGE, 7));
      LootItemCondition.Builder isMangrovePropaguleMaxAge = MatchBlock.blockMatches(this.blocks, Blocks.MANGROVE_PROPAGULE, StatePropertiesPredicate.Builder.properties().hasProperty(MangrovePropaguleBlock.AGE, 4));
      this.add(Blocks.MANGROVE_PROPAGULE, (LootTable.Builder)this.applyExplosionDecay(Blocks.MANGROVE_PROPAGULE, LootTable.lootTable().withPool(((LootPool.Builder)LootPool.lootPool().when(isMangrovePropaguleMaxAge)).add(LootItem.lootTableItem(Items.MANGROVE_PROPAGULE)))));
      ...
      this.add(Blocks.PITCHER_PLANT, (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_PLANT, LootTable.lootTable().withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(Items.PITCHER_PLANT).when(MatchBlock.blockMatches(this.blocks, Blocks.PITCHER_PLANT, StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER)))))));
      this.add(Blocks.CARROTS, (LootTable.Builder)this.applyExplosionDecay(Blocks.CARROTS, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CARROT))).withPool(((LootPool.Builder)LootPool.lootPool().when(isCarrotMaxAge)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(Items.CARROT).apply(ApplyBonusCount.addBonusBinomialDistributionCount(this.enchantments.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3))))));
      LootItemCondition.Builder isPotatoMaxAge = MatchBlock.blockMatches(this.blocks, Blocks.POTATOES, StatePropertiesPredicate.Builder.properties().hasProperty(PotatoBlock.AGE, 7));
      this.add(Blocks.POTATOES, (LootTable.Builder)this.applyExplosionDecay(Blocks.POTATOES, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.POTATO))).withPool(((LootPool.Builder)LootPool.lootPool().when(isPotatoMaxAge)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(this.enchantments.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3)))).withPool(((LootPool.Builder)LootPool.lootPool().when(isPotatoMaxAge)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02F))))));
      this.add(Blocks.SWEET_BERRY_BUSH, (block) -> (LootTable.Builder)this.applyExplosionDecay(block, LootTable.lootTable().withPool((LootPool.Builder)((LootPool.Builder)((LootPool.Builder)LootPool.lootPool().when(MatchBlock.blockMatches(this.blocks, Blocks.SWEET_BERRY_BUSH, StatePropertiesPredicate.Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 3)))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F)))).apply(ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)))).withPool((LootPool.Builder)((LootPool.Builder)((LootPool.Builder)LootPool.lootPool().when(MatchBlock.blockMatches(this.blocks, Blocks.SWEET_BERRY_BUSH, StatePropertiesPredicate.Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 2)))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))).apply(ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE))))));
      ...
      this.add(Blocks.CHORUS_FLOWER, (block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)this.applyExplosionCondition(block, LootItem.lootTableItem(block))).when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS)))));
      this.add(Blocks.FERN, (x$0) -> this.createGrassDrops(x$0));
      this.add(Blocks.SHORT_GRASS, (x$0) -> this.createGrassDrops(x$0));
      this.add(Blocks.GLOWSTONE, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.GLOWSTONE_DUST).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)))).apply(ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.range(1, 4))))));
      this.add(Blocks.MELON, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.MELON_SLICE).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 7.0F)))).apply(ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.upperBound(9))))));
      ...
      this.add(Blocks.SEA_LANTERN, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.PRISMARINE_CRYSTALS).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F)))).apply(ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.range(1, 5))))));
      this.add(Blocks.CREAKING_HEART, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.RESIN_CLUMP).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F)))).apply(ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.upperBound(9))))));
      this.add(Blocks.NETHER_WART, (block) -> LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionDecay(block, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.NETHER_WART).apply((LootItemFunction.Builder)SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))))))));
      this.add(Blocks.SNOW, (block) -> LootTable.lootTable().withPool(((LootPool.Builder)LootPool.lootPool().when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS))).add(AlternativesEntry.alternatives((LootPoolEntryContainer.Builder)AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), (layers) -> (LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, layers)))).apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)layers)))).when(this.doesNotHaveSilkTouch()), AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), (layers) -> (LootPoolEntryContainer.Builder)(layers == 8 ? LootItem.lootTableItem(Blocks.SNOW_BLOCK) : (LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Blocks.SNOW).apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)layers)))).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, layers)))))))));
      this.add(Blocks.GRAVEL, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(block, ((UniformContainerBase.Builder)LootItem.lootTableItem(Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance(this.enchantments.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F))).otherwise(LootItem.lootTableItem(block)))));
      this.add(Blocks.CAMPFIRE, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(block, (ConditionUserBuilder)LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))))));
      this.add(Blocks.GILDED_BLACKSTONE, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(block, ((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 5.0F)))).when(BonusLevelTableCondition.bonusLevelFlatChance(this.enchantments.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F))).otherwise(LootItem.lootTableItem(block)))));
      this.add(Blocks.SOUL_CAMPFIRE, (block) -> this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(block, (ConditionUserBuilder)LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))));
      this.add(Blocks.AMETHYST_CLUSTER, (block) -> this.createSilkTouchDispatchTable(block, ((UniformContainerBase.Builder)((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F)))).apply(ApplyBonusCount.addOreBonusCount(this.enchantments.getOrThrow(Enchantments.FORTUNE)))).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(this.items, ItemTags.CLUSTER_MAX_HARVESTABLES)))).otherwise((LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))))));
   ...
   private LootTable.Builder createDecoratedPotTable(final Block original) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(((UniformContainerBase.Builder)DynamicLoot.dynamicEntry(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID).when(MatchBlock.blockMatches(this.blocks, original, StatePropertiesPredicate.Builder.properties().hasProperty(DecoratedPotBlock.CRACKED, true)))).otherwise((LootPoolEntryContainer.Builder)LootItem.lootTableItem(original).apply(CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.POT_DECORATIONS)))));
   }
   ...
   private LootTable.Builder createPitcherCropLoot() {
      return (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.lootTable().withPool(LootPool.lootPool().add(AlternativesEntry.alternatives(PitcherCropBlock.AGE.getPossibleValues(), (age) -> {
         LootItemCondition.Builder isLowerPart = MatchBlock.blockMatches(this.blocks, Blocks.PITCHER_CROP, StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
         LootItemCondition.Builder isAge = MatchBlock.blockMatches(this.blocks, Blocks.PITCHER_CROP, StatePropertiesPredicate.Builder.properties().hasProperty(PitcherCropBlock.AGE, age));
         return age == 4 ? (LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.PITCHER_PLANT).when(isAge)).when(isLowerPart)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))) : (LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.PITCHER_POD).when(isAge)).when(isLowerPart)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)));
      }))));
   }

   private LootTable.Builder createMobSkullDrop(final Block block) {
      return LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem(block).apply(CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.CUSTOM_NAME)))));
   }
