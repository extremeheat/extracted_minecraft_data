...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   public VanillaBlockLoot(final HolderLookup.Provider registries) {
   ...
   protected void generate() {
      ...
      this.dropSelf(Blocks.PINK_PETALS);
      this.dropSelf(Blocks.WILDFLOWERS);
      this.add(Blocks.LEAF_LITTER, noDrop());
      ...
      this.dropSelf(Blocks.TUFF_SLAB);
      this.dropSelf(Blocks.TUFF_BRICK_SLAB);
      this.dropSelf(Blocks.POLISHED_TUFF_SLAB);
      ...
      this.add(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (x$0) -> this.createCopperGolemStatueBlock(x$0));
      this.add(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (x$0) -> this.createCopperGolemStatueBlock(x$0));
      this.add(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (x$0) -> this.createCopperGolemStatueBlock(x$0));
      this.add(Blocks.WAXED_COPPER_GOLEM_STATUE, (x$0) -> this.createCopperGolemStatueBlock(x$0));
      this.add(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (x$0) -> this.createCopperGolemStatueBlock(x$0));
      this.add(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (x$0) -> this.createCopperGolemStatueBlock(x$0));
      ...
      this.dropSelf(Blocks.IRON_TRAP);
      Blocks.COPPER_TRAP.forEach((x$0) -> this.dropSelf(x$0));
      ...
      this.dropSelf(Blocks.OAK_SLAB);
      this.dropSelf(Blocks.PETRIFIED_OAK_SLAB);
      this.dropSelf(Blocks.SPRUCE_SLAB);
      this.dropSelf(Blocks.BIRCH_SLAB);
      this.dropSelf(Blocks.JUNGLE_SLAB);
      this.dropSelf(Blocks.ACACIA_SLAB);
      this.dropSelf(Blocks.DARK_OAK_SLAB);
      this.dropSelf(Blocks.PALE_OAK_SLAB);
      this.dropSelf(Blocks.MANGROVE_SLAB);
      this.dropSelf(Blocks.CHERRY_SLAB);
      this.dropSelf(Blocks.BAMBOO_SLAB);
      this.dropSelf(Blocks.BAMBOO_MOSAIC_SLAB);
      this.dropSelf(Blocks.BRICK_SLAB);
      this.dropSelf(Blocks.COBBLESTONE_SLAB);
      this.dropSelf(Blocks.DARK_PRISMARINE_SLAB);
      this.dropSelf(Blocks.NETHER_BRICK_SLAB);
      this.dropSelf(Blocks.PRISMARINE_BRICK_SLAB);
      this.dropSelf(Blocks.PRISMARINE_SLAB);
      this.dropSelf(Blocks.PURPUR_SLAB);
      this.dropSelf(Blocks.QUARTZ_SLAB);
      this.dropSelf(Blocks.RED_SANDSTONE_SLAB);
      this.dropSelf(Blocks.SANDSTONE_SLAB);
      this.dropSelf(Blocks.CUT_RED_SANDSTONE_SLAB);
      this.dropSelf(Blocks.CUT_SANDSTONE_SLAB);
      this.dropSelf(Blocks.STONE_BRICK_SLAB);
      this.dropSelf(Blocks.STONE_SLAB);
      this.dropSelf(Blocks.SMOOTH_STONE_SLAB);
      this.dropSelf(Blocks.POLISHED_GRANITE_SLAB);
      this.dropSelf(Blocks.SMOOTH_RED_SANDSTONE_SLAB);
      this.dropSelf(Blocks.MOSSY_STONE_BRICK_SLAB);
      this.dropSelf(Blocks.POLISHED_DIORITE_SLAB);
      this.dropSelf(Blocks.MOSSY_COBBLESTONE_SLAB);
      this.dropSelf(Blocks.END_STONE_BRICK_SLAB);
      this.dropSelf(Blocks.SMOOTH_SANDSTONE_SLAB);
      this.dropSelf(Blocks.SMOOTH_QUARTZ_SLAB);
      this.dropSelf(Blocks.GRANITE_SLAB);
      this.dropSelf(Blocks.ANDESITE_SLAB);
      this.dropSelf(Blocks.RED_NETHER_BRICK_SLAB);
      this.dropSelf(Blocks.POLISHED_ANDESITE_SLAB);
      this.dropSelf(Blocks.DIORITE_SLAB);
      this.dropSelf(Blocks.CRIMSON_SLAB);
      this.dropSelf(Blocks.WARPED_SLAB);
      this.dropSelf(Blocks.BLACKSTONE_SLAB);
      this.dropSelf(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB);
      this.dropSelf(Blocks.POLISHED_BLACKSTONE_SLAB);
      this.dropSelf(Blocks.OXIDIZED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.WEATHERED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.EXPOSED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.CUT_COPPER_SLAB);
      this.dropSelf(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.WAXED_CUT_COPPER_SLAB);
      this.dropSelf(Blocks.COBBLED_DEEPSLATE_SLAB);
      this.dropSelf(Blocks.POLISHED_DEEPSLATE_SLAB);
      this.dropSelf(Blocks.DEEPSLATE_TILE_SLAB);
      this.dropSelf(Blocks.DEEPSLATE_BRICK_SLAB);
      this.dropSelf(Blocks.MUD_BRICK_SLAB);
      ...
      this.add(Blocks.COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.EXPOSED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.WEATHERED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.OXIDIZED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.WAXED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, (x$0) -> this.createDoorTable(x$0));
      ...
      this.dropSelf(Blocks.SEA_PICKLE);
      this.dropSelf(Blocks.COMPOSTER);
      ...
      this.dropSelf(Blocks.CANDLE);
      this.dropSelf(Blocks.WHITE_CANDLE);
      this.dropSelf(Blocks.ORANGE_CANDLE);
      this.dropSelf(Blocks.MAGENTA_CANDLE);
      this.dropSelf(Blocks.LIGHT_BLUE_CANDLE);
      this.dropSelf(Blocks.YELLOW_CANDLE);
      this.dropSelf(Blocks.LIME_CANDLE);
      this.dropSelf(Blocks.PINK_CANDLE);
      this.dropSelf(Blocks.GRAY_CANDLE);
      this.dropSelf(Blocks.LIGHT_GRAY_CANDLE);
      this.dropSelf(Blocks.CYAN_CANDLE);
      this.dropSelf(Blocks.PURPLE_CANDLE);
      this.dropSelf(Blocks.BLUE_CANDLE);
      this.dropSelf(Blocks.BROWN_CANDLE);
      this.dropSelf(Blocks.GREEN_CANDLE);
      this.dropSelf(Blocks.RED_CANDLE);
      this.dropSelf(Blocks.BLACK_CANDLE);
      ...
      this.add(Blocks.COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      this.add(Blocks.EXPOSED_COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      this.add(Blocks.WEATHERED_COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      this.add(Blocks.OXIDIZED_COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      this.add(Blocks.WAXED_COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      this.add(Blocks.WAXED_EXPOSED_COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      this.add(Blocks.WAXED_WEATHERED_COPPER_CHEST, (x$0) -> this.createNameableBlockEntityTable(x$0));
      ...
      this.add(Blocks.BLACK_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.BLUE_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.BROWN_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.CYAN_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.GRAY_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.GREEN_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.LIGHT_BLUE_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.LIGHT_GRAY_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.LIME_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.MAGENTA_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.ORANGE_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.PINK_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.PURPLE_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.RED_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      this.add(Blocks.WHITE_SHULKER_BOX, (x$0) -> this.createShulkerBoxDrop(x$0));
      ...
      this.add(Blocks.BLUE_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.BROWN_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.CYAN_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.GRAY_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.GREEN_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.LIGHT_BLUE_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.LIGHT_GRAY_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.LIME_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.MAGENTA_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.ORANGE_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.PINK_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.PURPLE_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.RED_BANNER, (x$0) -> this.createBannerDrop(x$0));
      this.add(Blocks.WHITE_BANNER, (x$0) -> this.createBannerDrop(x$0));
      ...
      this.add(Blocks.POTATOES, (LootTable.Builder)this.applyExplosionDecay(Blocks.POTATOES, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.POTATO))).withPool(LootPool.lootPool().when(isPotatoMaxAge).add(LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(enchantments.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3)))).withPool(LootPool.lootPool().when(isPotatoMaxAge).add(LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02F))))));
      ...
      this.add(Blocks.GLOW_LICHEN, (x$0) -> this.createShearsOnlyDrop(x$0));
      this.dropSelf(Blocks.RESIN_CLUMP);
      ...
      this.add(Blocks.NETHER_WART, (block) -> LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionDecay(block, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.NETHER_WART).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3)))).apply(ApplyBonusCount.addUniformBonusCount(enchantments.getOrThrow(Enchantments.FORTUNE)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))))))));
