...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      this.add(Blocks.OXIDIZED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.WEATHERED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.EXPOSED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      this.add(Blocks.WAXED_CUT_COPPER_SLAB, (x$0) -> this.createSlabItemTable(x$0));
      ...
      this.add(Blocks.WHITE_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.ORANGE_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.MAGENTA_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.LIGHT_BLUE_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.YELLOW_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.LIME_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.PINK_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.GRAY_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.LIGHT_GRAY_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.CYAN_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.PURPLE_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.BLUE_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.BROWN_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.GREEN_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.RED_CANDLE, (x$0) -> this.createCandleDrops(x$0));
      this.add(Blocks.BLACK_CANDLE, (x$0) -> this.createCandleDrops(x$0));
