...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      this.add(Blocks.SCULK_VEIN, var1x -> this.createMultifaceBlockDrops(var1x, this.hasSilkTouch()));
      ...
      this.add(Blocks.TUFF_SLAB, var1x -> this.createSlabItemTable(var1x));
      this.add(Blocks.TUFF_BRICK_SLAB, var1x -> this.createSlabItemTable(var1x));
      this.add(Blocks.POLISHED_TUFF_SLAB, var1x -> this.createSlabItemTable(var1x));
      ...
      this.add(Blocks.COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.EXPOSED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.WEATHERED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.OXIDIZED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.WAXED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, var1x -> this.createDoorTable(var1x));
      ...
      this.add(
         Blocks.COMPOSTER,
         var1x -> LootTable.lootTable()
               .withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(var1x, LootItem.lootTableItem(Items.COMPOSTER))))
               .withPool(
                  LootPool.lootPool()
      ...
      this.add(Blocks.CAVE_VINES, var1x -> this.createCaveVinesDrop(var1x));
      this.add(Blocks.CAVE_VINES_PLANT, var1x -> this.createCaveVinesDrop(var1x));
      ...
      this.add(
         ...
         var2x -> this.applyExplosionDecay(
               var2x,
               LootTable.lootTable()
                  .withPool(
                     LootPool.lootPool()
                        ...
                        .apply(ApplyBonusCount.addUniformBonusCount(var1.getOrThrow(Enchantments.FORTUNE)))
                  )
                  .withPool(
                     LootPool.lootPool()
                        .when(
      ...
      this.add(
         Blocks.COBWEB,
         var1x -> this.createSilkTouchOrShearsDispatchTable(
               var1x, (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(var1x, LootItem.lootTableItem(Items.STRING))
            )
      );
      this.add(
         Blocks.DEAD_BUSH,
         var1x -> this.createShearsDispatchTable(
               var1x,
               (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                  var1x, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F)))
               )
            )
      );
         ...
         var1x -> LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ConstantValue.exactly(1.0F))
                     .add(
                        ((LootPoolSingletonContainer.Builder)this.applyExplosionCondition(var1x, LootItem.lootTableItem(var1x)))
                           ...
                           LootItem.lootTableItem(Items.NETHER_WART)
                              .apply(
                                 SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                    .when(
                                       LootItemBlockStatePropertyCondition.hasBlockStateProperties(var2x)
                                          .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))
                                    )
                              )
                              .apply(
                                 ApplyBonusCount.addUniformBonusCount(var1.getOrThrow(Enchantments.FORTUNE))
                                    .when(
                                       LootItemBlockStatePropertyCondition.hasBlockStateProperties(var2x)
                                          .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))
                                    )
                     ...
                     .add(
                        AlternativesEntry.alternatives(
                           AlternativesEntry.alternatives(
                                 ...
                                 var1xx -> LootItem.lootTableItem(Items.SNOWBALL)
                                       .when(
                                          LootItemBlockStatePropertyCondition.hasBlockStateProperties(var1x)
                                             .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, var1xx.intValue()))
                                       )
                                       .apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)var1xx.intValue())))
                              )
         ...
         var2x -> this.createSilkTouchDispatchTable(
               ...
               this.applyExplosionCondition(
                  ...
                  LootItem.lootTableItem(Items.FLINT)
                     .when(BonusLevelTableCondition.bonusLevelFlatChance(var1.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F))
                     .otherwise(LootItem.lootTableItem(var2x))
               )
            )
      );
      this.add(
         Blocks.CAMPFIRE,
         var1x -> this.createSilkTouchDispatchTable(
               var1x,
               (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(
                  var1x, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
               )
            )
      );
      this.add(
      ...
      this.add(
         ...
         var1x -> this.createSilkTouchDispatchTable(
               var1x,
               (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(
                  var1x, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
               )
            )
      );
      this.add(
