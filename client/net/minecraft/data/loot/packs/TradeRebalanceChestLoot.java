               ...
               LootPool.lootPool()
                  ...
                  .add(
                     LootItem.lootTableItem(Items.BOOK)
                        .setWeight(1)
                        .apply(new EnchantRandomlyFunction.Builder().withEnchantment(var2.getOrThrow(Enchantments.EFFICIENCY)))
                  )
            )
      );
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(2)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(var1.getOrThrow(Enchantments.QUICK_CHARGE)))
               )
         );
   }
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(2)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(var1.getOrThrow(Enchantments.UNBREAKING)))
               )
         );
   }
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(4)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(var1.getOrThrow(Enchantments.MENDING)))
               )
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               .setRolls(ConstantValue.exactly(1.0F))
               .add(EmptyLootItem.emptyItem().setWeight(1))
               .add(LootItem.lootTableItem(Items.BOOK).apply(new EnchantRandomlyFunction.Builder().withEnchantment(var1.getOrThrow(Enchantments.UNBREAKING))))
         );
   }
}
