...
public class TradeRebalanceChestLoot implements LootTableSubProvider {
   public TradeRebalanceChestLoot() {
      super();
   }
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(2).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.QUICK_CHARGE)))
         );
   }
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(2).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.UNBREAKING)))
         );
   }
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))
               )
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(4).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.MENDING)))
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               .setRolls(ConstantValue.exactly(1.0F))
               .add(EmptyLootItem.emptyItem().setWeight(1))
               .add(LootItem.lootTableItem(Items.BOOK).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.UNBREAKING)))
         );
   }
}
