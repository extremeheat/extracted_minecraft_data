...
public class VanillaEquipmentLoot implements LootTableSubProvider {
   ...
   public void run() {
      ...
      this.output.accept(BuiltInLootTables.EQUIPMENT_TRIAL_CHAMBER_MELEE, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(NestedLootTable.lootTableReference(BuiltInLootTables.EQUIPMENT_TRIAL_CHAMBER))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.IRON_SWORD).setWeight(4)).add(LootItem.lootTableItem(Items.IRON_SWORD).apply((new SetEnchantmentsFunction.Builder()).withEnchantment(this.enchantments.getOrThrow(Enchantments.SHARPNESS), ConstantValue.exactly(1.0F)))).add(LootItem.lootTableItem(Items.IRON_SWORD).apply((new SetEnchantmentsFunction.Builder()).withEnchantment(this.enchantments.getOrThrow(Enchantments.KNOCKBACK), ConstantValue.exactly(1.0F)))).add(LootItem.lootTableItem(Items.DIAMOND_SWORD))));
      this.output.accept(BuiltInLootTables.EQUIPMENT_TRIAL_CHAMBER_RANGED, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(NestedLootTable.lootTableReference(BuiltInLootTables.EQUIPMENT_TRIAL_CHAMBER))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.BOW).setWeight(2)).add(LootItem.lootTableItem(Items.BOW).apply((new SetEnchantmentsFunction.Builder()).withEnchantment(this.enchantments.getOrThrow(Enchantments.POWER), ConstantValue.exactly(1.0F)))).add(LootItem.lootTableItem(Items.BOW).apply((new SetEnchantmentsFunction.Builder()).withEnchantment(this.enchantments.getOrThrow(Enchantments.PUNCH), ConstantValue.exactly(1.0F))))));
   }

   public LootTable.Builder trialChamberEquipment(final Item helmet, final Item chestplate, final ArmorTrim trim) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).when(LootItemRandomChanceCondition.randomChance(0.5F)).add(LootItem.lootTableItem(helmet).apply(SetComponentsFunction.setComponent(DataComponents.TRIM, trim)).apply((new SetEnchantmentsFunction.Builder()).withEnchantment(this.enchantments.getOrThrow(Enchantments.PROTECTION), ConstantValue.exactly(4.0F)).withEnchantment(this.enchantments.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantValue.exactly(4.0F)).withEnchantment(this.enchantments.getOrThrow(Enchantments.FIRE_PROTECTION), ConstantValue.exactly(4.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).when(LootItemRandomChanceCondition.randomChance(0.5F)).add(LootItem.lootTableItem(chestplate).apply(SetComponentsFunction.setComponent(DataComponents.TRIM, trim)).apply((new SetEnchantmentsFunction.Builder()).withEnchantment(this.enchantments.getOrThrow(Enchantments.PROTECTION), ConstantValue.exactly(4.0F)).withEnchantment(this.enchantments.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantValue.exactly(4.0F)).withEnchantment(this.enchantments.getOrThrow(Enchantments.FIRE_PROTECTION), ConstantValue.exactly(4.0F)))));
   }
}
