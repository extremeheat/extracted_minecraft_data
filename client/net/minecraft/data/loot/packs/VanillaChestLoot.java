         ...
         LootTable.lootTable()
            ...
            .withPool(
               LootPool.lootPool()
                  ...
                  .add(LootItem.lootTableItem(Items.BUCKET).setWeight(10))
                  .add(
                     LootItem.lootTableItem(Items.POISONOUS_POTATO_OIL)
                        .setWeight(15)
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.POISONOUS_POTATO_PLANT).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))
               )
