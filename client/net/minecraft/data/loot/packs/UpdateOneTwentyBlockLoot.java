...
public class UpdateOneTwentyBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      LootItemBlockStatePropertyCondition.Builder var1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.TORCHFLOWER_CROP)
         ...
         this.applyExplosionDecay(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .add(
                        ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.TORCHFLOWER).when(var1))
                           .otherwise(LootItem.lootTableItem(Items.TORCHFLOWER_SEEDS))
                     )
               )
         )
      );
