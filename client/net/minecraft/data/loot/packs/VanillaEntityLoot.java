...
public class VanillaEntityLoot extends EntityLootSubProvider {
   public VanillaEntityLoot(HolderLookup.Provider var1) {
      super(FeatureFlags.REGISTRY.allFlags(), var1);
   }

   @Override
   public void generate() {
      HolderLookup.RegistryLookup var1 = this.registries.lookupOrThrow(Registries.ENTITY_TYPE);
               ...
               LootPool.lootPool()
                  ...
                  .when(
                     LootItemEntityPropertyCondition.hasProperties(
                        LootContext.EntityTarget.ATTACKER, EntityPredicate.Builder.entity().of(var1, EntityTypeTags.SKELETONS)
                     )
                  )
            )
      );
               ...
               LootPool.lootPool()
                  ...
                  .add(
                     LootItem.lootTableItem(Items.MAGMA_CREAM)
                        ...
                        .apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0.0F, 1.0F)))
                        .when(this.killedByFrog(var1).invert())
                        .when(
                           LootItemEntityPropertyCondition.hasProperties(
                  ...
                  .add(
                     LootItem.lootTableItem(Items.PEARLESCENT_FROGLIGHT)
                        ...
                        .when(this.killedByFrogVariant(var1, FrogVariant.WARM))
                  )
                  .add(
                     LootItem.lootTableItem(Items.VERDANT_FROGLIGHT)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                        .when(this.killedByFrogVariant(var1, FrogVariant.COLD))
                  )
                  .add(
                     LootItem.lootTableItem(Items.OCHRE_FROGLIGHT)
                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                        .when(this.killedByFrogVariant(var1, FrogVariant.TEMPERATE))
                  )
            )
      );
      this.add(
         ...
         LootTable.lootTable()
            .withPool(
               LootPool.lootPool()
                  ...
                  .add(LootItem.lootTableItem(Items.SLIME_BALL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(this.killedByFrog(var1)))
                  .when(
                     LootItemEntityPropertyCondition.hasProperties(
