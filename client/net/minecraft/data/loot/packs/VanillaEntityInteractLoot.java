...
public class VanillaEntityInteractLoot implements LootTableSubProvider {
   ...
   public void run() {
      this.output.accept(BuiltInLootTables.ARMADILLO_BRUSH, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.ARMADILLO_SCUTE))));
   }
}
