...
public class UpdateOneTwentyOneBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      this.add(Blocks.TUFF_SLAB, var1 -> this.createSlabItemTable(var1));
      this.add(Blocks.TUFF_BRICK_SLAB, var1 -> this.createSlabItemTable(var1));
      this.add(Blocks.POLISHED_TUFF_SLAB, var1 -> this.createSlabItemTable(var1));
      ...
      this.add(Blocks.COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.EXPOSED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.WEATHERED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.OXIDIZED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.WAXED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
      this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, var1 -> this.createDoorTable(var1));
