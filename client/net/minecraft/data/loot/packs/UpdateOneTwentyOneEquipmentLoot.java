...
public class UpdateOneTwentyOneEquipmentLoot implements LootTableSubProvider {
   ...
   public void generate(HolderLookup.Provider var1, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> var2) {
      ...
      ArmorTrim var5 = new ArmorTrim(
         (Holder<TrimMaterial>)var4.get(TrimMaterials.COPPER).orElseThrow(), (Holder<TrimPattern>)var3.get(TrimPatterns.FLOW).orElseThrow()
      );
      ArmorTrim var6 = new ArmorTrim(
         (Holder<TrimMaterial>)var4.get(TrimMaterials.COPPER).orElseThrow(), (Holder<TrimPattern>)var3.get(TrimPatterns.BOLT).orElseThrow()
      );
      var2.accept(
