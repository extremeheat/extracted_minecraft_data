...
public class ItemTagsProvider extends TagsProvider<Item> {
   ...
   protected void addTags() {
      ...
      this.tag(ItemTags.BOATS).add((Object[])(Items.OAK_BOAT, Items.SPRUCE_BOAT, Items.BIRCH_BOAT, Items.JUNGLE_BOAT, Items.ACACIA_BOAT, Items.DARK_OAK_BOAT, Items.MANGROVE_BOAT)).addTag(ItemTags.CHEST_BOATS);
      this.tag(ItemTags.CHEST_BOATS).add((Object[])(Items.OAK_CHEST_BOAT, Items.SPRUCE_CHEST_BOAT, Items.BIRCH_CHEST_BOAT, Items.JUNGLE_CHEST_BOAT, Items.ACACIA_CHEST_BOAT, Items.DARK_OAK_CHEST_BOAT, Items.MANGROVE_CHEST_BOAT));
      ...
      this.tag(ItemTags.MUSIC_DISCS).addTag(ItemTags.CREEPER_DROP_MUSIC_DISCS).add((Object)Items.MUSIC_DISC_PIGSTEP).add((Object)Items.MUSIC_DISC_OTHERSIDE).add((Object)Items.MUSIC_DISC_5);
   ...
   protected void copy(TagKey<Block> var1, TagKey<Item> var2) {
      ...
      TagBuilder var4 = (TagBuilder)this.blockTags.apply(var1);
      List var10000 = var4.build();
