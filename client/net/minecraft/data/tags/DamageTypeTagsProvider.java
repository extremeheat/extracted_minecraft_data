...
public class DamageTypeTagsProvider extends TagsProvider<DamageType> {
   ...
   protected void addTags(final HolderLookup.Provider registries) {
      ...
      this.tag(DamageTypeTags.BYPASSES_SHIELD).addTag(DamageTypeTags.BYPASSES_ARMOR).add(DamageTypes.CACTUS, DamageTypes.CAMPFIRE, DamageTypes.DRY_OUT, DamageTypes.FALLING_ANVIL, DamageTypes.FALLING_STALACTITE, DamageTypes.HOT_FLOOR, DamageTypes.SULFUR_CUBE_HOT, DamageTypes.IN_FIRE, DamageTypes.LAVA, DamageTypes.LIGHTNING_BOLT, DamageTypes.SWEET_BERRY_BUSH);
      ...
      this.tag(DamageTypeTags.IS_FIRE).add(DamageTypes.IN_FIRE, DamageTypes.CAMPFIRE, DamageTypes.ON_FIRE, DamageTypes.LAVA, DamageTypes.HOT_FLOOR, DamageTypes.SULFUR_CUBE_HOT, DamageTypes.UNATTRIBUTED_FIREBALL, DamageTypes.FIREBALL);
      this.tag(DamageTypeTags.IS_PROJECTILE).add(DamageTypes.ARROW, DamageTypes.TRIDENT, DamageTypes.MOB_PROJECTILE, DamageTypes.UNATTRIBUTED_FIREBALL, DamageTypes.FIREBALL, DamageTypes.WITHER_SKULL, DamageTypes.THROWN, DamageTypes.WIND_CHARGE);
      ...
      this.tag(DamageTypeTags.SULFUR_CUBE_WITH_BLOCK_IMMUNE_TO).add(DamageTypes.ARROW, DamageTypes.CACTUS, DamageTypes.DRY_OUT, DamageTypes.FALL, DamageTypes.FALLING_ANVIL, DamageTypes.FALLING_BLOCK, DamageTypes.FALLING_STALACTITE, DamageTypes.FREEZE, DamageTypes.MACE_SMASH, DamageTypes.HOT_FLOOR, DamageTypes.MOB_ATTACK, DamageTypes.MOB_ATTACK_NO_AGGRO, DamageTypes.MOB_PROJECTILE, DamageTypes.PLAYER_ATTACK, DamageTypes.SPEAR, DamageTypes.SPIT, DamageTypes.STALAGMITE, DamageTypes.STING, DamageTypes.SULFUR_CUBE_HOT, DamageTypes.SWEET_BERRY_BUSH, DamageTypes.THROWN, DamageTypes.TRIDENT, DamageTypes.WIND_CHARGE).addTag(DamageTypeTags.IS_EXPLOSION);
      ...
      this.tag(DamageTypeTags.NO_KNOCKBACK).add(DamageTypes.EXPLOSION, DamageTypes.PLAYER_EXPLOSION, DamageTypes.BAD_RESPAWN_POINT, DamageTypes.IN_FIRE, DamageTypes.LIGHTNING_BOLT, DamageTypes.ON_FIRE, DamageTypes.LAVA, DamageTypes.HOT_FLOOR, DamageTypes.SULFUR_CUBE_HOT, DamageTypes.IN_WALL, DamageTypes.CRAMMING, DamageTypes.DROWN, DamageTypes.STARVE, DamageTypes.CACTUS, DamageTypes.FALL, DamageTypes.ENDER_PEARL, DamageTypes.FLY_INTO_WALL, DamageTypes.FELL_OUT_OF_WORLD, DamageTypes.GENERIC, DamageTypes.MAGIC, DamageTypes.WITHER, DamageTypes.DRAGON_BREATH, DamageTypes.DRY_OUT, DamageTypes.SWEET_BERRY_BUSH, DamageTypes.FREEZE, DamageTypes.STALAGMITE, DamageTypes.OUTSIDE_BORDER, DamageTypes.GENERIC_KILL, DamageTypes.CAMPFIRE, DamageTypes.SPEAR);
      this.tag(DamageTypeTags.ALWAYS_KILLS_ARMOR_STANDS).add(DamageTypes.ARROW, DamageTypes.TRIDENT, DamageTypes.FIREBALL, DamageTypes.WITHER_SKULL, DamageTypes.WIND_CHARGE);
