...
public class UpdateOneTwentyBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
   public UpdateOneTwentyBlockTagsProvider(
      PackOutput var1, CompletableFuture<HolderLookup.Provider> var2, CompletableFuture<TagsProvider.TagLookup<Block>> var3
   ) {
      super(var1, Registries.BLOCK, var2, var3, var0 -> var0.builtInRegistryHolder().key());
   }
   ...
   protected void addTags(HolderLookup.Provider var1) {
      ...
      this.tag(BlockTags.SNIFFER_DIGGABLE_BLOCK)
         .add(
            Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.ROOTED_DIRT, Blocks.MOSS_BLOCK, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS
         );
