...
public class BiomeTagsProvider extends TagsProvider<Biome> {
   ...
   protected void addTags(HolderLookup.Provider var1) {
      ...
      this.tag(BiomeTags.SPAWNS_WARM_VARIANT_FARM_ANIMALS).add(Biomes.SAVANNA).add(Biomes.SAVANNA_PLATEAU).add(Biomes.WINDSWEPT_SAVANNA).add(Biomes.JUNGLE).add(Biomes.SPARSE_JUNGLE).add(Biomes.BAMBOO_JUNGLE).add(Biomes.ERODED_BADLANDS).add(Biomes.WOODED_BADLANDS).add(Biomes.BADLANDS);
