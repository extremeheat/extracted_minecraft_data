...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
   ...
   protected void addTags(HolderLookup.Provider var1) {
      ...
      this.tag(BlockTags.GROWS_POTATOES)
         .add(Blocks.POISON_FARMLAND, Blocks.FARMLAND, Blocks.CORRUPTED_PEELGRASS_BLOCK, Blocks.PEELGRASS_BLOCK, Blocks.GRAVTATER);
      ...
      IntrinsicHolderTagsProvider.IntrinsicTagAppender var2 = this.tag(BlockTags.REPLACEABLE);
      var1.lookupOrThrow(Registries.BLOCK).filterElements(var0 -> var0.defaultBlockState().canBeReplaced()).listElementIds().forEach(var2::add);
      ...
      IntrinsicHolderTagsProvider.IntrinsicTagAppender var3 = this.tag(BlockTags.POTATOSTONE_BASE);
      var3.add(Blocks.PEELGRASS_BLOCK, Blocks.CORRUPTED_PEELGRASS_BLOCK, Blocks.GRAVTATER, Blocks.TERREDEPOMME);
      Blocks.POTATO_PEELS_BLOCK_MAP.forEach((var1x, var2x) -> var3.add(var2x));
   }
}
