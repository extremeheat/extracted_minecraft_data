...
public class UpdateOneTwentyOneEnchantmentTagsProvider extends EnchantmentTagsProvider {
   public UpdateOneTwentyOneEnchantmentTagsProvider(PackOutput var1, CompletableFuture<HolderLookup.Provider> var2) {
      super(var1, var2, FeatureFlagSet.of(FeatureFlags.VANILLA, FeatureFlags.UPDATE_1_21));
   }
