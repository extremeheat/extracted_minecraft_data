...
public class VanillaEnchantmentTagsProvider extends EnchantmentTagsProvider {
   ...
   protected void addTags(HolderLookup.Provider var1) {
      ...
      this.tag(EnchantmentTags.DAMAGE_EXCLUSIVE).add(Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.IMPALING, Enchantments.DENSITY, Enchantments.BREACH);
      ...
      this.tag(EnchantmentTags.ON_RANDOM_LOOT).addTag(EnchantmentTags.NON_TREASURE).add(Enchantments.BINDING_CURSE, Enchantments.VANISHING_CURSE, Enchantments.FROST_WALKER, Enchantments.MENDING);
      this.tag(EnchantmentTags.TRADEABLE).addTag(EnchantmentTags.NON_TREASURE).add(Enchantments.BINDING_CURSE, Enchantments.VANISHING_CURSE, Enchantments.FROST_WALKER, Enchantments.MENDING);
