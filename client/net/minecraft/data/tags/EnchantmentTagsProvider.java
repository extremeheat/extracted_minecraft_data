...
public abstract class EnchantmentTagsProvider extends IntrinsicHolderTagsProvider<Enchantment> {
   ...
   public EnchantmentTagsProvider(PackOutput var1, CompletableFuture<HolderLookup.Provider> var2, FeatureFlagSet var3) {
      super(var1, Registries.ENCHANTMENT, var2, (var0) -> {
   ...
   protected void tooltipOrder(HolderLookup.Provider var1, Enchantment... var2) {
      this.tag(EnchantmentTags.TOOLTIP_ORDER).add((Object[])var2);
      Set var3 = Set.of(var2);
      List var4 = (List)var1.lookupOrThrow(Registries.ENCHANTMENT).listElements().filter((var1x) -> {
         return ((Enchantment)var1x.value()).requiredFeatures().isSubsetOf(this.enabledFeatures);
      }).filter((var1x) -> {
         return !var3.contains(var1x.value());
