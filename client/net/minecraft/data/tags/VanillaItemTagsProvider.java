...
public class VanillaItemTagsProvider extends TagsProvider<Item> {
   ...
   protected void addTags(final HolderLookup.Provider registries) {
      ...
      this.tag(ItemTags.BOATS).add(ItemIds.OAK_BOAT, ItemIds.SPRUCE_BOAT, ItemIds.BIRCH_BOAT, ItemIds.JUNGLE_BOAT, ItemIds.ACACIA_BOAT, ItemIds.DARK_OAK_BOAT, ItemIds.PALE_OAK_BOAT, ItemIds.MANGROVE_BOAT, ItemIds.BAMBOO_RAFT, ItemIds.CHERRY_BOAT).addTag(ItemTags.CHEST_BOATS);
      this.tag(ItemTags.BUNDLES).add(ItemIds.BUNDLE).addAll(ItemIds.DYED_BUNDLE);
      this.tag(ItemTags.CHEST_BOATS).add(ItemIds.OAK_CHEST_BOAT, ItemIds.SPRUCE_CHEST_BOAT, ItemIds.BIRCH_CHEST_BOAT, ItemIds.JUNGLE_CHEST_BOAT, ItemIds.ACACIA_CHEST_BOAT, ItemIds.DARK_OAK_CHEST_BOAT, ItemIds.PALE_OAK_CHEST_BOAT, ItemIds.MANGROVE_CHEST_BOAT, ItemIds.BAMBOO_CHEST_RAFT, ItemIds.CHERRY_CHEST_BOAT);
      ...
      this.tag(ItemTags.SKULLS).add(BlockItemIds.PLAYER_HEAD, BlockItemIds.CREEPER_HEAD, BlockItemIds.ZOMBIE_HEAD, BlockItemIds.SKELETON_SKULL, BlockItemIds.WITHER_SKELETON_SKULL, BlockItemIds.DRAGON_HEAD, BlockItemIds.PIGLIN_HEAD);
      ...
      this.tag(ItemTags.SULFUR_CUBE_ARCHETYPE_REGULAR).add(BlockItemIds.DEEPSLATE, BlockItemIds.CHISELED_DEEPSLATE, BlockItemIds.POLISHED_DEEPSLATE, BlockItemIds.COBBLED_DEEPSLATE, BlockItemIds.CRACKED_DEEPSLATE_BRICKS, BlockItemIds.CRACKED_DEEPSLATE_TILES, BlockItemIds.DEEPSLATE_BRICKS, BlockItemIds.DEEPSLATE_TILES).add(BlockItemIds.NETHER_BRICKS, BlockItemIds.RED_NETHER_BRICKS, BlockItemIds.CHISELED_NETHER_BRICKS, BlockItemIds.CRACKED_NETHER_BRICKS).add(BlockItemIds.BLACKSTONE, BlockItemIds.GILDED_BLACKSTONE, BlockItemIds.POLISHED_BLACKSTONE, BlockItemIds.CHISELED_POLISHED_BLACKSTONE, BlockItemIds.CRACKED_POLISHED_BLACKSTONE_BRICKS, BlockItemIds.POLISHED_BLACKSTONE_BRICKS).add(BlockItemIds.QUARTZ_BLOCK, BlockItemIds.SMOOTH_QUARTZ, BlockItemIds.CHISELED_QUARTZ_BLOCK, BlockItemIds.QUARTZ_BRICKS, BlockItemIds.QUARTZ_PILLAR).add(BlockItemIds.SANDSTONE, BlockItemIds.RED_SANDSTONE, BlockItemIds.CHISELED_RED_SANDSTONE, BlockItemIds.CHISELED_SANDSTONE, BlockItemIds.CUT_RED_SANDSTONE, BlockItemIds.CUT_SANDSTONE, BlockItemIds.SMOOTH_RED_SANDSTONE, BlockItemIds.SMOOTH_SANDSTONE).add(BlockItemIds.STONE, BlockItemIds.COBBLESTONE, BlockItemIds.SMOOTH_STONE, BlockItemIds.MOSSY_COBBLESTONE, BlockItemIds.MOSSY_STONE_BRICKS, BlockItemIds.CRACKED_STONE_BRICKS, BlockItemIds.STONE_BRICKS, BlockItemIds.CHISELED_STONE_BRICKS).add(BlockItemIds.TUFF, BlockItemIds.TUFF_BRICKS, BlockItemIds.CHISELED_TUFF, BlockItemIds.CHISELED_TUFF_BRICKS, BlockItemIds.POLISHED_TUFF).add(BlockItemIds.CINNABAR, BlockItemIds.CHISELED_CINNABAR, BlockItemIds.POLISHED_CINNABAR, BlockItemIds.CINNABAR_BRICKS).add(BlockItemIds.SULFUR, BlockItemIds.POLISHED_SULFUR, BlockItemIds.CHISELED_SULFUR, BlockItemIds.SULFUR_BRICKS).add(BlockItemIds.BASALT, BlockItemIds.POLISHED_BASALT, BlockItemIds.SMOOTH_BASALT).add(BlockItemIds.DIORITE, BlockItemIds.POLISHED_DIORITE, BlockItemIds.GRANITE, BlockItemIds.POLISHED_GRANITE, BlockItemIds.ANDESITE, BlockItemIds.POLISHED_ANDESITE, BlockItemIds.CALCITE, BlockItemIds.DRIPSTONE_BLOCK).add(BlockItemIds.MUD, BlockItemIds.MUDDY_MANGROVE_ROOTS, BlockItemIds.MUD_BRICKS, BlockItemIds.PACKED_MUD).addTag(ItemTags.TERRACOTTA).addTag(ItemTags.GLAZED_TERRACOTTA).addTag(ItemTags.CONCRETE).addTag(ItemTags.CONCRETE_POWDERS).addTag(ItemTags.COAL_ORES).addTag(ItemTags.LAPIS_ORES).addTag(ItemTags.REDSTONE_ORES).addTag(ItemTags.DIAMOND_ORES).addTag(ItemTags.EMERALD_ORES).add(BlockItemIds.COAL_BLOCK, BlockItemIds.LAPIS_BLOCK, BlockItemIds.REDSTONE_BLOCK, BlockItemIds.DIAMOND_BLOCK, BlockItemIds.EMERALD_BLOCK).add(BlockItemIds.NETHERRACK, BlockItemIds.NETHER_QUARTZ_ORE, BlockItemIds.CRIMSON_NYLIUM, BlockItemIds.WARPED_NYLIUM, BlockItemIds.GLOWSTONE).add(BlockItemIds.PRISMARINE, BlockItemIds.PRISMARINE_BRICKS, BlockItemIds.DARK_PRISMARINE, BlockItemIds.SEA_LANTERN).add(BlockItemIds.END_STONE, BlockItemIds.END_STONE_BRICKS, BlockItemIds.PURPUR_BLOCK, BlockItemIds.PURPUR_PILLAR).add(BlockItemIds.DIRT, BlockItemIds.COARSE_DIRT, BlockItemIds.ROOTED_DIRT, BlockItemIds.PODZOL, BlockItemIds.GRASS_BLOCK, BlockItemIds.CLAY).add(BlockItemIds.GRAVEL, BlockItemIds.SAND, BlockItemIds.RED_SAND).add(BlockItemIds.OBSIDIAN, BlockItemIds.CRYING_OBSIDIAN, BlockItemIds.BONE_BLOCK, BlockItemIds.AMETHYST_BLOCK, BlockItemIds.BRICKS, BlockItemIds.MAGMA_BLOCK);
