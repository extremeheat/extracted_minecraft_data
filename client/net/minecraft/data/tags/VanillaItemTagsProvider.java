...
public class VanillaItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {
   ...
   protected void addTags(final HolderLookup.Provider registries) {
      ...
      this.tag(ItemTags.BLOCK_PLACERS).add(Items.REDSTONE, Items.STRING, Items.WHEAT_SEEDS, Items.CARROT, Items.POTATO, Items.BEETROOT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.NETHER_WART, Items.TORCHFLOWER_SEEDS, Items.PITCHER_POD, Items.SWEET_BERRIES, Items.GLOW_BERRIES, Items.RESIN_CLUMP, Items.POWDER_SNOW_BUCKET);
