...
public class Village {
   ...
   public void func_75560_a(int var1) {
      ...
      if (this.field_75587_j < var2 && this.field_75584_b.size() > 20 && this.field_75586_a.field_73012_v.nextInt(7000) == 0) {
         Entity var3 = this.func_208059_f(this.field_75582_d);
         if (var3 != null) {
            ++this.field_75587_j;
         }
      }
   ...
   private Entity func_208059_f(BlockPos var1) {
      for(int var2 = 0; var2 < 10; ++var2) {
         BlockPos var3 = var1.func_177982_a(this.field_75586_a.field_73012_v.nextInt(16) - 8, this.field_75586_a.field_73012_v.nextInt(6) - 3, this.field_75586_a.field_73012_v.nextInt(16) - 8);
         if (this.func_179866_a(var3)) {
            EntityIronGolem var4 = (EntityIronGolem)EntityType.field_200757_aw.func_210761_b(this.field_75586_a, (NBTTagCompound)null, (ITextComponent)null, (EntityPlayer)null, var3, false, false);
            if (var4 != null) {
               if (var4.func_205020_a(this.field_75586_a, false) && var4.func_205019_a(this.field_75586_a)) {
   ...
   public VillageDoorInfo func_179863_c(BlockPos var1) {
      ...
      while(var4.hasNext()) {
         ...
         if (var6 < var3) {
            BlockPos var7 = var5.func_179852_d();
            EnumFacing var8 = var5.func_188567_j();
            if (this.field_75586_a.func_180495_p(var7.func_177967_a(var8, 1)).func_196957_g(this.field_75586_a, var7.func_177967_a(var8, 1), PathType.LAND) && this.field_75586_a.func_180495_p(var7.func_177967_a(var8, -1)).func_196957_g(this.field_75586_a, var7.func_177967_a(var8, -1), PathType.LAND) && this.field_75586_a.func_180495_p(var7.func_177984_a().func_177967_a(var8, 1)).func_196957_g(this.field_75586_a, var7.func_177984_a().func_177967_a(var8, 1), PathType.LAND) && this.field_75586_a.func_180495_p(var7.func_177984_a().func_177967_a(var8, -1)).func_196957_g(this.field_75586_a, var7.func_177984_a().func_177967_a(var8, -1), PathType.LAND)) {
               var2 = var5;
               var3 = var6;
            }
         }
   ...
   public EntityLivingBase func_75571_b(EntityLivingBase var1) {
      ...
      return var4 == null ? null : var4.field_75592_a;
   }
   ...
   private boolean func_179860_f(BlockPos var1) {
      IBlockState var2 = this.field_75586_a.func_180495_p(var1);
      Block var3 = var2.func_177230_c();
      if (var3 instanceof BlockDoor) {
         return var2.func_185904_a() == Material.field_151575_d;
      } else {
         return false;
      }
   }
   ...
   public void func_82690_a(NBTTagCompound var1) {
      ...
      for(int var9 = 0; var9 < var8.size(); ++var9) {
         ...
         if (var10.func_74764_b("UUID") && this.field_75586_a != null && this.field_75586_a.func_73046_m() != null) {
            PlayerProfileCache var6 = this.field_75586_a.func_73046_m().func_152358_ax();
   ...
   public void func_82689_b(NBTTagCompound var1) {
      ...
      Iterator var11 = this.field_82693_j.keySet().iterator();

      while(var11.hasNext()) {
         String var12 = (String)var11.next();
         NBTTagCompound var6 = new NBTTagCompound();
         PlayerProfileCache var7 = this.field_75586_a.func_73046_m().func_152358_ax();

         try {
            GameProfile var8 = var7.func_152655_a(var12);
            if (var8 != null) {
               var6.func_74778_a("UUID", var8.getId().toString());
               var6.func_74768_a("S", (Integer)this.field_82693_j.get(var12));
               var10.add((INBTBase)var6);
            }
         } catch (RuntimeException var9) {
         }
      }

      var1.func_74782_a("Players", var10);
   }
