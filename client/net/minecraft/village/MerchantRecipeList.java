...
public class MerchantRecipeList extends ArrayList {
   ...
   public MerchantRecipe func_77203_a(ItemStack var1, ItemStack var2, int var3) {
      if (var3 > 0 && var3 < this.size()) {
         ...
         return var1.func_77973_b() != var6.func_77394_a().func_77973_b()
               || (var2 != null || var6.func_77398_c()) && (!var6.func_77398_c() || var2 == null || var6.func_77396_b().func_77973_b() != var2.func_77973_b())
               || var1.field_77994_a < var6.func_77394_a().field_77994_a
               || var6.func_77398_c() && var2.field_77994_a < var6.func_77396_b().field_77994_a
            ? null
            : var6;
      } else {
         for(int var4 = 0; var4 < this.size(); ++var4) {
            MerchantRecipe var5 = (MerchantRecipe)this.get(var4);
            if (var1.func_77973_b() == var5.func_77394_a().func_77973_b()
               && var1.field_77994_a >= var5.func_77394_a().field_77994_a
               && (
                  !var5.func_77398_c() && var2 == null
                     || var5.func_77398_c()
                        && var2 != null
                        && var5.func_77396_b().func_77973_b() == var2.func_77973_b()
                        && var2.field_77994_a >= var5.func_77396_b().field_77994_a
               )) {
               return var5;
            }
         }
   ...
   public void func_77205_a(MerchantRecipe var1) {
      for(int var2 = 0; var2 < this.size(); ++var2) {
         MerchantRecipe var3 = (MerchantRecipe)this.get(var2);
         if (var1.func_77393_a(var3)) {
            if (var1.func_77391_b(var3)) {
               this.set(var2, var1);
            }
