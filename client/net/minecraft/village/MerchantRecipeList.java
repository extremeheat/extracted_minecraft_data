...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
   ...
   public MerchantRecipe func_77203_a(ItemStack var1, ItemStack var2, int var3) {
      if (var3 > 0 && var3 < this.size()) {
         ...
         return !this.func_181078_a(var1, var6.func_77394_a()) || (!var2.func_190926_b() || var6.func_77398_c()) && (!var6.func_77398_c() || !this.func_181078_a(var2, var6.func_77396_b())) || var1.func_190916_E() < var6.func_77394_a().func_190916_E() || var6.func_77398_c() && var2.func_190916_E() < var6.func_77396_b().func_190916_E() ? null : var6;
      } else {
         for(int var4 = 0; var4 < this.size(); ++var4) {
            MerchantRecipe var5 = (MerchantRecipe)this.get(var4);
            if (this.func_181078_a(var1, var5.func_77394_a()) && var1.func_190916_E() >= var5.func_77394_a().func_190916_E() && (!var5.func_77398_c() && var2.func_190926_b() || var5.func_77398_c() && this.func_181078_a(var2, var5.func_77396_b()) && var2.func_190916_E() >= var5.func_77396_b().func_190916_E())) {
               return var5;
            }
         }
   ...
   private boolean func_181078_a(ItemStack var1, ItemStack var2) {
      ...
      if (var3.func_77973_b().func_77645_m()) {
         var3.func_196085_b(var3.func_77952_i());
      }

      return ItemStack.func_179545_c(var3, var2) && (!var2.func_77942_o() || var3.func_77942_o() && NBTUtil.func_181123_a(var2.func_77978_p(), var3.func_77978_p(), false));
   }
   ...
   public void func_151391_a(PacketBuffer var1) {
      ...
      for(int var2 = 0; var2 < this.size(); ++var2) {
         ...
         var1.writeBoolean(!var4.func_190926_b());
   ...
   public NBTTagCompound func_77202_a() {
      ...
      for(int var3 = 0; var3 < this.size(); ++var3) {
         ...
         var2.add((INBTBase)var4.func_77395_g());
      }
