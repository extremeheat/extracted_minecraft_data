...
public class CartographyTableMenu extends AbstractContainerMenu {
   ...
   public CartographyTableMenu(int var1, Inventory var2, final ContainerLevelAccess var3) {
      ...
      this.addSlot(new Slot(this.container, 0, 15, 15) {
         public boolean mayPlace(ItemStack var1) {
            return var1.method_87(Items.FILLED_MAP);
         }
      });
      this.addSlot(new Slot(this.container, 1, 15, 52) {
         public boolean mayPlace(ItemStack var1) {
            return var1.method_87(Items.PAPER) || var1.method_87(Items.MAP) || var1.method_87(Items.GLASS_PANE);
         }
      });
   ...
   private void setupResultSlot(ItemStack var1, ItemStack var2, ItemStack var3) {
      this.access.execute((var4, var5) -> {
         ...
         if (var6 != null) {
            ItemStack var7;
            if (var2.method_87(Items.PAPER) && !var6.locked && var6.scale < 4) {
               var7 = var1.copy();
               var7.setCount(1);
               var7.getOrCreateTag().putInt("map_scale_direction", 1);
               this.broadcastChanges();
            } else if (var2.method_87(Items.GLASS_PANE) && !var6.locked) {
               var7 = var1.copy();
               var7.setCount(1);
               var7.getOrCreateTag().putBoolean("map_to_lock", true);
               this.broadcastChanges();
            } else {
               if (!var2.method_87(Items.MAP)) {
                  this.resultContainer.removeItemNoUpdate(2);
                  this.broadcastChanges();
                  return;
               }
   ...
   public ItemStack quickMoveStack(Player var1, int var2) {
      ...
      if (var4 != null && var4.hasItem()) {
         ...
         if (var2 == 2) {
            ...
            } else if (!var5.method_87(Items.PAPER) && !var5.method_87(Items.MAP) && !var5.method_87(Items.GLASS_PANE)) {
               if (var2 >= 3 && var2 < 30) {
