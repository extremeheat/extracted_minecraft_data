...
public class AnvilMenu extends ItemCombinerMenu {
   ...
   public void createResult() {
      ...
      if (var1.isEmpty()) {
         ...
         if (!var6.isEmpty()) {
            boolean var8 = var6.method_87(Items.ENCHANTED_BOOK) && !EnchantedBookItem.getEnchantments(var6).isEmpty();
            int var9;
            int var10;
            int var11;
            if (var5.isDamageableItem() && var5.getItem().isValidRepairItem(var1, var6)) {
               ...
               if (!var8 && (!var5.method_87(var6.getItem()) || !var5.isDamageableItem())) {
                  this.resultSlots.setItem(0, ItemStack.EMPTY);
                  this.cost.set(0);
                  return;
               }
               ...
               while(true) {
                  ...
                  if (this.player.getAbilities().instabuild || var1.method_87(Items.ENCHANTED_BOOK)) {
                     var16 = true;
                  }
