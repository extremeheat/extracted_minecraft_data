...
public class CartographyMenu extends AbstractContainerMenu {
   ...
   public CartographyMenu(int var1, Inventory var2) {
      this(var1, var2, ContainerLevelAccess.NULL);
   }

   public CartographyMenu(int var1, Inventory var2, final ContainerLevelAccess var3) {
      ...
      this.addSlot(new Slot(this.resultContainer, 2, 145, 39) {
         ...
         public ItemStack remove(int var1) {
            ...
            ItemStack var3x = (ItemStack)var3.evaluate((var2x, var3xx) -> {
               if (!CartographyMenu.this.quickMoved && CartographyMenu.this.container.getItem(1).getItem() == Items.GLASS_PANE) {
                  ItemStack var4 = MapItem.lockMap(var2x, CartographyMenu.this.container.getItem(0));
                  if (var4 != null) {
                     var4.setCount(1);
                     return var4;
                  }
         ...
         public ItemStack onTake(Player var1, ItemStack var2) {
            ...
            var3.execute((var0, var1x) -> {
               var0.playSound((Player)null, (BlockPos)var1x, SoundEvents.UI_CARTOGRAPHY_TABLE_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
            });
