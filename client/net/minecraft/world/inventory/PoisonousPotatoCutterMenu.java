...
public class PoisonousPotatoCutterMenu extends AbstractContainerMenu {
   ...
   private List<RecipeHolder<PoisonousPotatoCutterRecipe>> recipes = Lists.newArrayList();
   ...
   public final Container container = new SimpleContainer(1) {
      ...
      public void setChanged() {
         super.setChanged();
         PoisonousPotatoCutterMenu.this.slotsChanged(this);
         PoisonousPotatoCutterMenu.this.slotUpdateListener.run();
      }
   };
   final ResultContainer resultContainer = new ResultContainer();

   public PoisonousPotatoCutterMenu(int var1, Inventory var2) {
      this(var1, var2, ContainerLevelAccess.NULL);
   }

   public PoisonousPotatoCutterMenu(int var1, Inventory var2, final ContainerLevelAccess var3) {
      ...
      this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
         ...
         public void onTake(Player var1, ItemStack var2) {
            ...
            PoisonousPotatoCutterMenu.this.resultContainer.awardUsedRecipes(var1, this.getRelevantItems());
            ItemStack var3x = PoisonousPotatoCutterMenu.this.inputSlot.remove(1);
            if (!var3x.isEmpty()) {
               PoisonousPotatoCutterMenu.this.setupResultSlot();
            }

            var3.execute((var1x, var2x) -> {
               long var3xxxx = var1x.getGameTime();
               if (PoisonousPotatoCutterMenu.this.lastSoundTime != var3xxxx) {
                  var1x.playSound(null, var2x, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                  PoisonousPotatoCutterMenu.this.lastSoundTime = var3xxxx;
               }
            });
         ...
         private List<ItemStack> getRelevantItems() {
            return List.of(PoisonousPotatoCutterMenu.this.inputSlot.getItem());
         }
      });
   ...
   public List<RecipeHolder<PoisonousPotatoCutterRecipe>> getRecipes() {
      return this.recipes;
   }
   ...
   public boolean stillValid(Player var1) {
      return stillValid(this.access, var1, Blocks.POISONOUS_POTATO_CUTTER);
   }
   ...
   private void setupRecipeList(Container var1, ItemStack var2) {
      ...
      if (!var2.isEmpty()) {
         this.recipes = this.level.getRecipeManager().getRecipesFor(RecipeType.POISONOUS_POTATO_CUTTING, var1, this.level);
      }
   }
   ...
   void setupResultSlot() {
      if (!this.recipes.isEmpty() && this.isValidRecipeIndex(this.selectedRecipeIndex.get())) {
         ...
         ItemStack var2 = ((PoisonousPotatoCutterRecipe)var1.value()).assemble(this.container, this.level.registryAccess());
   ...
   public MenuType<?> getType() {
      return MenuType.POISONOUS_POTATO_CUTTER;
   }
   ...
   public ItemStack quickMoveStack(Player var1, int var2) {
      ...
      if (var4 != null && var4.hasItem()) {
         ...
         } else if (this.level.getRecipeManager().getRecipeFor(RecipeType.POISONOUS_POTATO_CUTTING, new SimpleContainer(var5), this.level).isPresent()) {
