...
public class EntityDamageSource extends DamageSource {
   ...
   public Component getLocalizedDeathMessage(LivingEntity var1) {
      ...
      return !var2.isEmpty() && var2.hasCustomHoverName() ? Component.translatable(var3 + ".item", var1.getDisplayName(), this.entity.getDisplayName(), var2.getDisplayName()) : Component.translatable(var3, var1.getDisplayName(), this.entity.getDisplayName());
   }
