...
public class IndirectEntityDamageSource extends EntityDamageSource {
   ...
   public Component getLocalizedDeathMessage(LivingEntity var1) {
      ...
      return !var3.isEmpty() && var3.hasCustomHoverName() ? Component.translatable(var5, var1.getDisplayName(), var2, var3.getDisplayName()) : Component.translatable(var4, var1.getDisplayName(), var2);
   }
}
