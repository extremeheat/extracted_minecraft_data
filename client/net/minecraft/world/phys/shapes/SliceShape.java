...
public class SliceShape extends VoxelShape {
   ...
   private static DiscreteVoxelShape makeSlice(DiscreteVoxelShape var0, Direction.Axis var1, int var2) {
      return new SubShape(
         var0,
         var1.choose(var2, 0, 0),
         var1.choose(0, var2, 0),
         var1.choose(0, 0, var2),
         var1.choose(var2 + 1, var0.xSize, var0.xSize),
         var1.choose(var0.ySize, var2 + 1, var0.ySize),
         var1.choose(var0.zSize, var0.zSize, var2 + 1)
      );
   }
