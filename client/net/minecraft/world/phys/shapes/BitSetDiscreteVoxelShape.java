...
public final class BitSetDiscreteVoxelShape extends DiscreteVoxelShape {
   ...
   public BitSetDiscreteVoxelShape(DiscreteVoxelShape var1) {
      ...
      this.xMin = var1.firstFull(Direction.Axis.field_500);
      this.yMin = var1.firstFull(Direction.Axis.field_501);
      this.zMin = var1.firstFull(Direction.Axis.field_502);
      this.xMax = var1.lastFull(Direction.Axis.field_500);
      this.yMax = var1.lastFull(Direction.Axis.field_501);
      this.zMax = var1.lastFull(Direction.Axis.field_502);
   }
