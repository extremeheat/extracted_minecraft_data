...
public abstract class VoxelShape {
   ...
   public AABB bounds() {
      if (this.isEmpty()) {
         ...
         return new AABB(this.min(Direction.Axis.field_500), this.min(Direction.Axis.field_501), this.min(Direction.Axis.field_502), this.max(Direction.Axis.field_500), this.max(Direction.Axis.field_501), this.max(Direction.Axis.field_502));
      }
   }
   ...
   public VoxelShape move(double var1, double var3, double var5) {
      return (VoxelShape)(this.isEmpty() ? Shapes.empty() : new ArrayVoxelShape(this.shape, new OffsetDoubleList(this.getCoords(Direction.Axis.field_500), var1), new OffsetDoubleList(this.getCoords(Direction.Axis.field_501), var3), new OffsetDoubleList(this.getCoords(Direction.Axis.field_502), var5)));
   }

   public VoxelShape optimize() {
      VoxelShape[] var1 = new VoxelShape[]{Shapes.empty()};
      this.forAllBoxes((var1x, var3, var5, var7, var9, var11) -> {
         var1[0] = Shapes.joinUnoptimized(var1[0], Shapes.box(var1x, var3, var5, var7, var9, var11), BooleanOp.field_1);
      });
      return var1[0];
   }
   ...
   public void forAllEdges(Shapes.DoubleLineConsumer var1) {
      this.shape.forAllEdges((var2, var3, var4, var5, var6, var7) -> {
         var1.consume(this.get(Direction.Axis.field_500, var2), this.get(Direction.Axis.field_501, var3), this.get(Direction.Axis.field_502, var4), this.get(Direction.Axis.field_500, var5), this.get(Direction.Axis.field_501, var6), this.get(Direction.Axis.field_502, var7));
      }, true);
   }

   public void forAllBoxes(Shapes.DoubleLineConsumer var1) {
      DoubleList var2 = this.getCoords(Direction.Axis.field_500);
      DoubleList var3 = this.getCoords(Direction.Axis.field_501);
      DoubleList var4 = this.getCoords(Direction.Axis.field_502);
   ...
   public double max(Direction.Axis var1, double var2, double var4) {
      ...
      return var10 <= 0 ? -1.0D / 0.0 : this.get(var1, var10);
   }
   ...
   public BlockHitResult clip(Vec3 var1, Vec3 var2, BlockPos var3) {
      if (this.isEmpty()) {
         ...
         if (var4.lengthSqr() < 1.0E-7D) {
            ...
            return this.shape.isFullWide(this.findIndex(Direction.Axis.field_500, var5.field_414 - (double)var3.getX()), this.findIndex(Direction.Axis.field_501, var5.field_415 - (double)var3.getY()), this.findIndex(Direction.Axis.field_502, var5.field_416 - (double)var3.getZ())) ? new BlockHitResult(var5, Direction.getNearest(var4.field_414, var4.field_415, var4.field_416).getOpposite(), var3, true) : AABB.clip(this.toAabbs(), var1, var2, var3);
         }
      }
   }
   ...
   public Optional<Vec3> closestPointTo(Vec3 var1) {
      if (this.isEmpty()) {
         ...
         this.forAllBoxes((var2x, var4, var6, var8, var10, var12) -> {
            double var14 = Mth.clamp(var1.method_2(), var2x, var8);
            double var16 = Mth.clamp(var1.method_3(), var4, var10);
            double var18 = Mth.clamp(var1.method_4(), var6, var12);
   ...
   public double collide(Direction.Axis var1, AABB var2, double var3) {
      return this.collideX(AxisCycle.between(var1, Direction.Axis.field_500), var2, var3);
   }
   ...
   protected double collideX(AxisCycle var1, AABB var2, double var3) {
      if (this.isEmpty()) {
         ...
         Direction.Axis var6 = var5.cycle(Direction.Axis.field_500);
         Direction.Axis var7 = var5.cycle(Direction.Axis.field_501);
         Direction.Axis var8 = var5.cycle(Direction.Axis.field_502);
