...
public abstract class DiscreteVoxelShape {
   ...
   public boolean isFullWide(AxisCycle var1, int var2, int var3, int var4) {
      return this.isFullWide(var1.cycle(var2, var3, var4, Direction.Axis.field_500), var1.cycle(var2, var3, var4, Direction.Axis.field_501), var1.cycle(var2, var3, var4, Direction.Axis.field_502));
   }
   ...
   public boolean isFull(AxisCycle var1, int var2, int var3, int var4) {
      return this.isFull(var1.cycle(var2, var3, var4, Direction.Axis.field_500), var1.cycle(var2, var3, var4, Direction.Axis.field_501), var1.cycle(var2, var3, var4, Direction.Axis.field_502));
   }
   ...
   public int firstFull(Direction.Axis var1, int var2, int var3) {
      ...
      if (var2 >= 0 && var3 >= 0) {
         ...
         if (var2 < this.getSize(var5) && var3 < this.getSize(var6)) {
            AxisCycle var7 = AxisCycle.between(Direction.Axis.field_500, var1);
   ...
   public int getXSize() {
      return this.getSize(Direction.Axis.field_500);
   }

   public int getYSize() {
      return this.getSize(Direction.Axis.field_501);
   }

   public int getZSize() {
      return this.getSize(Direction.Axis.field_502);
   }
   ...
   private void forAllAxisEdges(DiscreteVoxelShape.IntLineConsumer var1, AxisCycle var2, boolean var3) {
      ...
      int var6 = this.getSize(var5.cycle(Direction.Axis.field_500));
      int var7 = this.getSize(var5.cycle(Direction.Axis.field_501));
      int var8 = this.getSize(var5.cycle(Direction.Axis.field_502));
            ...
            for(int var11 = 0; var11 <= var8; ++var11) {
               ...
               if (var12 == 1 || var12 == 3 || var12 == 2 && (var13 & 1) == 0) {
                  if (var3) {
                     ...
                     var1.consume(var5.cycle(var9, var10, var11, Direction.Axis.field_500), var5.cycle(var9, var10, var11, Direction.Axis.field_501), var5.cycle(var9, var10, var11, Direction.Axis.field_502), var5.cycle(var9, var10, var11 + 1, Direction.Axis.field_500), var5.cycle(var9, var10, var11 + 1, Direction.Axis.field_501), var5.cycle(var9, var10, var11 + 1, Direction.Axis.field_502));
                  }
               } else if (var4 != -1) {
                  var1.consume(var5.cycle(var9, var10, var4, Direction.Axis.field_500), var5.cycle(var9, var10, var4, Direction.Axis.field_501), var5.cycle(var9, var10, var4, Direction.Axis.field_502), var5.cycle(var9, var10, var11, Direction.Axis.field_500), var5.cycle(var9, var10, var11, Direction.Axis.field_501), var5.cycle(var9, var10, var11, Direction.Axis.field_502));
                  var4 = -1;
               }
            }
         }
   ...
   private void forAllAxisFaces(DiscreteVoxelShape.IntFaceConsumer var1, AxisCycle var2) {
      ...
      Direction.Axis var4 = var3.cycle(Direction.Axis.field_502);
      int var5 = this.getSize(var3.cycle(Direction.Axis.field_500));
      int var6 = this.getSize(var3.cycle(Direction.Axis.field_501));
      ...
      for(int var10 = 0; var10 < var5; ++var10) {
         for(int var11 = 0; var11 < var6; ++var11) {
            ...
            for(int var13 = 0; var13 <= var7; ++var13) {
               ...
               if (!var12 && var14) {
                  var1.consume(var8, var3.cycle(var10, var11, var13, Direction.Axis.field_500), var3.cycle(var10, var11, var13, Direction.Axis.field_501), var3.cycle(var10, var11, var13, Direction.Axis.field_502));
               }

               if (var12 && !var14) {
                  var1.consume(var9, var3.cycle(var10, var11, var13 - 1, Direction.Axis.field_500), var3.cycle(var10, var11, var13 - 1, Direction.Axis.field_501), var3.cycle(var10, var11, var13 - 1, Direction.Axis.field_502));
               }
