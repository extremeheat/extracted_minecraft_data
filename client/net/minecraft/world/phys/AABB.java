...
public class AABB {
   ...
   public AABB(Vec3 var1, Vec3 var2) {
      this(var1.field_414, var1.field_415, var1.field_416, var2.field_414, var2.field_415, var2.field_416);
   }

   // $FF: renamed from: of (net.minecraft.world.level.levelgen.structure.BoundingBox) net.minecraft.world.phys.AABB
   public static AABB method_92(BoundingBox var0) {
   ...
   public static AABB unitCubeFromLowerCorner(Vec3 var0) {
      return new AABB(var0.field_414, var0.field_415, var0.field_416, var0.field_414 + 1.0D, var0.field_415 + 1.0D, var0.field_416 + 1.0D);
   }
   ...
   public AABB expandTowards(Vec3 var1) {
      return this.expandTowards(var1.field_414, var1.field_415, var1.field_416);
   }
   ...
   public AABB move(Vec3 var1) {
      return this.move(var1.field_414, var1.field_415, var1.field_416);
   }
   ...
   public boolean intersects(Vec3 var1, Vec3 var2) {
      return this.intersects(Math.min(var1.field_414, var2.field_414), Math.min(var1.field_415, var2.field_415), Math.min(var1.field_416, var2.field_416), Math.max(var1.field_414, var2.field_414), Math.max(var1.field_415, var2.field_415), Math.max(var1.field_416, var2.field_416));
   }

   public boolean contains(Vec3 var1) {
      return this.contains(var1.field_414, var1.field_415, var1.field_416);
   }
   ...
   public Optional<Vec3> clip(Vec3 var1, Vec3 var2) {
      ...
      double var4 = var2.field_414 - var1.field_414;
      double var6 = var2.field_415 - var1.field_415;
      double var8 = var2.field_416 - var1.field_416;
   ...
   public static BlockHitResult clip(Iterable<AABB> var0, Vec3 var1, Vec3 var2, BlockPos var3) {
      ...
      Direction var5 = null;
      double var6 = var2.field_414 - var1.field_414;
      double var8 = var2.field_415 - var1.field_415;
      double var10 = var2.field_416 - var1.field_416;
   ...
   private static Direction getDirection(AABB var0, Vec3 var1, double[] var2, @Nullable Direction var3, double var4, double var6, double var8) {
      if (var4 > 1.0E-7D) {
         var3 = clipPoint(var2, var3, var4, var6, var8, var0.minX, var0.minY, var0.maxY, var0.minZ, var0.maxZ, Direction.WEST, var1.field_414, var1.field_415, var1.field_416);
      } else if (var4 < -1.0E-7D) {
         var3 = clipPoint(var2, var3, var4, var6, var8, var0.maxX, var0.minY, var0.maxY, var0.minZ, var0.maxZ, Direction.EAST, var1.field_414, var1.field_415, var1.field_416);
      }

      if (var6 > 1.0E-7D) {
         var3 = clipPoint(var2, var3, var6, var8, var4, var0.minY, var0.minZ, var0.maxZ, var0.minX, var0.maxX, Direction.DOWN, var1.field_415, var1.field_416, var1.field_414);
      } else if (var6 < -1.0E-7D) {
         var3 = clipPoint(var2, var3, var6, var8, var4, var0.maxY, var0.minZ, var0.maxZ, var0.minX, var0.maxX, Direction.field_526, var1.field_415, var1.field_416, var1.field_414);
      }

      if (var8 > 1.0E-7D) {
         var3 = clipPoint(var2, var3, var8, var4, var6, var0.minZ, var0.minX, var0.maxX, var0.minY, var0.maxY, Direction.NORTH, var1.field_416, var1.field_414, var1.field_415);
      } else if (var8 < -1.0E-7D) {
         var3 = clipPoint(var2, var3, var8, var4, var6, var0.maxZ, var0.minX, var0.maxX, var0.minY, var0.maxY, Direction.SOUTH, var1.field_416, var1.field_414, var1.field_415);
      }
   ...
   public static AABB ofSize(Vec3 var0, double var1, double var3, double var5) {
      return new AABB(var0.field_414 - var1 / 2.0D, var0.field_415 - var3 / 2.0D, var0.field_416 - var5 / 2.0D, var0.field_414 + var1 / 2.0D, var0.field_415 + var3 / 2.0D, var0.field_416 + var5 / 2.0D);
   }
}
