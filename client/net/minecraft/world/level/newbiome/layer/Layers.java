...
public class Layers {
   ...
   public static <T extends Area, C extends BigContext<T>> ImmutableList<AreaFactory<T>> getDefaultLayers(LevelType var0, OverworldGeneratorSettings var1, LongFunction<C> var2) {
      ...
      int var6 = var5;
      if (var1 != null) {
         var5 = var1.getBiomeSize();
         var6 = var1.getRiverSize();
      }

      if (var0 == LevelType.LARGE_BIOMES) {
         var5 = 6;
      }

      AreaFactory var7 = zoom(1000L, ZoomLayer.NORMAL, var3, 0, var2);
      var7 = RiverInitLayer.INSTANCE.run((BigContext)var2.apply(100L), var7);
      AreaFactory var8 = (new BiomeInitLayer(var0, var1)).run((BigContext)var2.apply(200L), var3);
      ...
      AreaFactory var11 = VoronoiZoom.INSTANCE.run((BigContext)var2.apply(10L), var8);
      return ImmutableList.of(var8, var11, var8);
   }

   public static Layer[] getDefaultLayers(long var0, LevelType var2, OverworldGeneratorSettings var3) {
      boolean var4 = true;
      ImmutableList var5 = getDefaultLayers(var2, var3, (var2x) -> {
