...
public class AmphibiousNodeEvaluator extends WalkNodeEvaluator {
   ...
   public int getNeighbors(Node[] var1, Node var2) {
      ...
      Node var9 = this.findAcceptedNode(var2.field_333, var2.field_334 + 1, var2.field_335, Math.max(0, var4 - 1), var7, Direction.field_526, var6);
      Node var10 = this.findAcceptedNode(var2.field_333, var2.field_334 - 1, var2.field_335, var4, var7, Direction.DOWN, var6);
      ...
      for(int var11 = 0; var11 < var3; ++var11) {
         ...
         if (var12.type == BlockPathTypes.WATER && this.prefersShallowSwimming && var12.field_334 < this.mob.level.getSeaLevel() - 10) {
            ++var12.costMalus;
         }
      }
