...
public class PathFinder {
   ...
   private Path findPath(ProfilerFiller var1, Node var2, Map<Target, BlockPos> var3, float var4, int var5, float var6) {
      ...
      var2.field_336 = 0.0F;
      var2.field_337 = this.getBestH(var2, var7);
      var2.field_338 = var2.field_337;
      this.openSet.clear();
      ...
      while(!this.openSet.isEmpty()) {
         ...
         if (!(var12.distanceTo(var2) >= var4)) {
            ...
            for(int var21 = 0; var21 < var19; ++var21) {
               ...
               float var17 = var12.field_336 + var16 + var15.costMalus;
               if (var15.walkedDistance < var4 && (!var15.inOpenSet() || var17 < var15.field_336)) {
                  var15.cameFrom = var12;
                  var15.field_336 = var17;
                  var15.field_337 = this.getBestH(var15, var7) * 1.5F;
                  if (var15.inOpenSet()) {
                     this.openSet.changeCost(var15, var15.field_336 + var15.field_337);
                  } else {
                     var15.field_338 = var15.field_336 + var15.field_337;
