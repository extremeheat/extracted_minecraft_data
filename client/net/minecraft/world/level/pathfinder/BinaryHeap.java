...
public class BinaryHeap {
   ...
   public void remove(Node var1) {
      ...
      if (this.size > var1.heapIdx) {
         if (this.heap[var1.heapIdx].field_338 < var1.field_338) {
   ...
   private void upHeap(int var1) {
      ...
      int var4;
      for(float var3 = var2.field_338; var1 > 0; var1 = var4) {
         var4 = var1 - 1 >> 1;
         Node var5 = this.heap[var4];
         if (!(var3 < var5.field_338)) {
            break;
         }
