...
public class Path {
   ...
   public Vec3 getEntityPosAtNode(Entity var1, int var2) {
      ...
      double var4 = (double)var3.field_333 + (double)((int)(var1.getBbWidth() + 1.0F)) * 0.5D;
      double var6 = (double)var3.field_334;
      double var8 = (double)var3.field_335 + (double)((int)(var1.getBbWidth() + 1.0F)) * 0.5D;
   ...
   public boolean sameAs(@Nullable Path var1) {
      if (var1 == null) {
         ...
         for(int var2 = 0; var2 < this.nodes.size(); ++var2) {
            ...
            if (var3.field_333 != var4.field_333 || var3.field_334 != var4.field_334 || var3.field_335 != var4.field_335) {
               return false;
            }
         }
