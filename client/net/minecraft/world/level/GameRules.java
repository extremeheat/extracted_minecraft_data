...
public class GameRules {
   ...
   public CompoundTag createTag() {
      ...
      this.rules.forEach((var1x, var2) -> {
         var1.putString(var1x.field_278, var2.serialize());
      });
      return var1;
   }
   ...
   private void loadFromTag(DynamicLike<?> var1) {
      this.rules.forEach((var1x, var2) -> {
         Optional var10000 = var1.get(var1x.field_278).asString().result();
   ...
   public static final class Key<T extends GameRules.Value<T>> {
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            ...
            return var1 instanceof GameRules.Key && ((GameRules.Key)var1).field_278.equals(this.field_278);
         }
      }

      public int hashCode() {
         return this.field_278.hashCode();
      }
      ...
      public String getDescriptionId() {
         return "gamerule." + this.field_278;
      }
