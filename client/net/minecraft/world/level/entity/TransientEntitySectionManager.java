...
public class TransientEntitySectionManager<T extends EntityAccess> {
   ...
   class Callback implements EntityInLevelCallback {
      ...
      public void onMove() {
         ...
         if (var2 != this.currentSectionKey) {
            ...
            if (!this.currentSection.remove(this.entity)) {
               TransientEntitySectionManager.LOGGER.warn("Entity {} wasn't found in section {} (moving to {})", this.entity, SectionPos.method_74(this.currentSectionKey), var2);
            }
      ...
      public void onRemove(Entity.RemovalReason var1) {
         if (!this.currentSection.remove(this.entity)) {
            TransientEntitySectionManager.LOGGER.warn("Entity {} wasn't found in section {} (destroying due to {})", this.entity, SectionPos.method_74(this.currentSectionKey), var1);
         }
