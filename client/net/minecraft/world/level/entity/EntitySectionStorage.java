...
public class EntitySectionStorage<T extends EntityAccess> {
   ...
   public void forEachAccessibleNonEmptySection(AABB var1, Consumer<EntitySection<T>> var2) {
      ...
      for(int var9 = var3; var9 <= var6; ++var9) {
         ...
         while(var14.hasNext()) {
            ...
            int var17 = SectionPos.method_76(var15);
            int var18 = SectionPos.method_77(var15);
   ...
   private static long getChunkKeyFromSectionKey(long var0) {
      return ChunkPos.asLong(SectionPos.method_75(var0), SectionPos.method_77(var0));
   }
   ...
   public <U extends T> void getEntities(EntityTypeTest<T, U> var1, AABB var2, Consumer<U> var3) {
      this.forEachAccessibleNonEmptySection(var2, (var3x) -> {
         var3x.getEntities(var1, var2, var3);
      });
   }
