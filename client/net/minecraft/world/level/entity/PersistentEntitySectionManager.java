...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
   ...
   public void dumpSections(Writer var1) throws IOException {
      ...
      this.sectionStorage.getAllChunksWithExistingSections().forEach((var2x) -> {
         ...
         this.sectionStorage.getExistingSectionPositionsInChunk(var2x).forEach((var3) -> {
            ...
            if (var5 != null) {
               try {
                  var2.writeRow(SectionPos.method_75(var3), SectionPos.method_76(var3), SectionPos.method_77(var3), var5.getStatus(), var4, var5.size());
   ...
   static enum ChunkLoadStatus {
      ...
      // $FF: synthetic method
      private static PersistentEntitySectionManager.ChunkLoadStatus[] $values() {
         return new PersistentEntitySectionManager.ChunkLoadStatus[]{FRESH, PENDING, LOADED};
      }
   }
   ...
   class Callback implements EntityInLevelCallback {
      ...
      public void onMove() {
         ...
         if (var2 != this.currentSectionKey) {
            ...
            if (!this.currentSection.remove(this.entity)) {
               PersistentEntitySectionManager.LOGGER.warn("Entity {} wasn't found in section {} (moving to {})", this.entity, SectionPos.method_74(this.currentSectionKey), var2);
            }
      ...
      public void onRemove(Entity.RemovalReason var1) {
         if (!this.currentSection.remove(this.entity)) {
            PersistentEntitySectionManager.LOGGER.warn("Entity {} wasn't found in section {} (destroying due to {})", this.entity, SectionPos.method_74(this.currentSectionKey), var1);
         }
