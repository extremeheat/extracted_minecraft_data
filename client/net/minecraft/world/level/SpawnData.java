...
public record SpawnData(CompoundTag d, Optional<CustomSpawnRules> e) {
   ...
   public SpawnData() {
      this((CompoundTag)Util.make(new CompoundTag(), (var0) -> {
         var0.putString("id", "minecraft:pig");
      }), Optional.empty());
   }

   public SpawnData(CompoundTag var1, Optional<CustomSpawnRules> var2) {
      super();
   ...
   public static record CustomSpawnRules(InclusiveRange<Integer> b, InclusiveRange<Integer> c) {
      ...
      public static final Codec<CustomSpawnRules> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(InclusiveRange.INT.optionalFieldOf("block_light_limit", LIGHT_RANGE).flatXmap(CustomSpawnRules::checkLightBoundaries, CustomSpawnRules::checkLightBoundaries).forGetter((var0x) -> {
            return var0x.blockLightLimit;
         }), InclusiveRange.INT.optionalFieldOf("sky_light_limit", LIGHT_RANGE).flatXmap(CustomSpawnRules::checkLightBoundaries, CustomSpawnRules::checkLightBoundaries).forGetter((var0x) -> {
