...
public class LootContext {
   ...
   LootContext(RandomSource var1, float var2, ServerLevel var3, Function<ResourceLocation, LootTable> var4, Function<ResourceLocation, LootItemCondition> var5, Map<LootContextParam<?>, Object> var6, Map<ResourceLocation, DynamicDrop> var7) {
      super();
      this.random = var1;
      this.luck = var2;
      this.level = var3;
   ...
   public static enum EntityTarget {
      ...
      public static class Serializer extends TypeAdapter<EntityTarget> {
         ...
         public void write(JsonWriter var1, EntityTarget var2) throws IOException {
            var1.value(var2.name);
         }

         public EntityTarget read(JsonReader var1) throws IOException {
         ...
         public void write(JsonWriter var1, Object var2) throws IOException {
            this.write(var1, (EntityTarget)var2);
         }
      }
   }
   ...
   public static class Builder {
      ...
      public Builder withRandom(RandomSource var1) {
         this.random = var1;
         return this;
      }
      ...
      public Builder withOptionalRandomSeed(long var1, RandomSource var3) {
         if (var1 == 0L) {
            this.random = var3;
         } else {
            this.random = RandomSource.create(var1);
      ...
      public <T> Builder withParameter(LootContextParam<T> var1, T var2) {
         this.params.put(var1, var2);
         return this;
      }

      public <T> Builder withOptionalParameter(LootContextParam<T> var1, @Nullable T var2) {
         if (var2 == null) {
      ...
      public LootContext create(LootContextParamSet var1) {
         Sets.SetView var2 = Sets.difference(this.params.keySet(), var1.getAllowed());
         if (!var2.isEmpty()) {
            throw new IllegalArgumentException("Parameters not allowed in this parameter set: " + var2);
         } else {
            Sets.SetView var3 = Sets.difference(var1.getRequired(), this.params.keySet());
            if (!var3.isEmpty()) {
