...
public class GsonAdapterFactory {
   ...
   public static <E, T extends SerializerType<E>> Builder<E, T> builder(Registry<T> var0, String var1, String var2, Function<E, T> var3) {
      return new Builder(var0, var1, var2, var3);
   }
   ...
   public static class Builder<E, T extends SerializerType<E>> {
      ...
      public Builder<E, T> withInlineSerializer(T var1, InlineSerializer<? extends E> var2) {
         this.inlineType = Pair.of(var1, var2);
         return this;
      }

      public Builder<E, T> withDefaultType(T var1) {
   ...
   private static class JsonAdapter<E, T extends SerializerType<E>> implements JsonDeserializer<E>, JsonSerializer<E> {
      ...
      JsonAdapter(Registry<T> var1, String var2, String var3, Function<E, T> var4, @Nullable T var5, @Nullable Pair<T, InlineSerializer<? extends E>> var6) {
         super();
         this.registry = var1;
         this.elementName = var2;
         this.typeKey = var3;
      ...
      public E deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         if (var1.isJsonObject()) {
            ...
            return ((InlineSerializer)this.inlineType.getSecond()).deserialize(var1, var3);
         }
      }
      ...
      public JsonElement serialize(E var1, Type var2, JsonSerializationContext var3) {
         ...
         if (this.inlineType != null && this.inlineType.getFirst() == var4) {
            return ((InlineSerializer)this.inlineType.getSecond()).serialize(var1, var3);
         } else if (var4 == null) {
