...
public class ValidationContext {
   ...
   public ValidationContext(Multimap<String, String> var1, Supplier<String> var2, LootContextParamSet var3, Function<ResourceLocation, LootItemCondition> var4, Set<ResourceLocation> var5, Function<ResourceLocation, LootTable> var6, Set<ResourceLocation> var7) {
      super();
      this.problems = var1;
      this.context = var2;
      this.params = var3;
