      ...
      var1.forEach((var1x, var2x) -> {
         try {
            if (var2x.isJsonArray()) {
               LootItemCondition[] var3x = (LootItemCondition[])GSON.fromJson(var2x, LootItemCondition[].class);
               var4.put(var1x, new PredicateManager.CompositePredicate(var3x));
            } else {
               LootItemCondition var5x = (LootItemCondition)GSON.fromJson(var2x, LootItemCondition.class);
