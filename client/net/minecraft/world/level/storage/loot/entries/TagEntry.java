...
public class TagEntry extends LootPoolSingletonContainer {
   public static final MapCodec<TagEntry> CODEC = RecordCodecBuilder.mapCodec((var0) -> var0.group(TagKey.codec(Registries.ITEM).fieldOf("name").forGetter((var0x) -> var0x.tag), Codec.BOOL.fieldOf("expand").forGetter((var0x) -> var0x.expand)).and(singletonFields(var0)).apply(var0, TagEntry::new));
