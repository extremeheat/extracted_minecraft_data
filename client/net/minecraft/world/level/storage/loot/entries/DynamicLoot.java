...
public class DynamicLoot extends SingleEntryContainerBase {
   public static final MapCodec<DynamicLoot> MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Identifier.CODEC.fieldOf("name").forGetter((e) -> e.name)).and(uniformFields(i)).apply(i, DynamicLoot::new));
   private final Identifier name;

   private DynamicLoot(final Identifier name, final int weight, final int quality, final Optional<Holder<LootItemCondition>> condition, final Optional<Holder<LootItemFunction>> modifier) {
