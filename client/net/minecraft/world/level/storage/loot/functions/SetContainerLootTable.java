...
public class SetContainerLootTable extends LootItemConditionalFunction {
   public static final MapCodec<SetContainerLootTable> CODEC = RecordCodecBuilder.mapCodec((var0) -> commonFields(var0).and(var0.group(LootTable.KEY_CODEC.fieldOf("name").forGetter((var0x) -> var0x.name), Codec.LONG.optionalFieldOf("seed", 0L).forGetter((var0x) -> var0x.seed), BuiltInRegistries.BLOCK_ENTITY_TYPE.holderByNameCodec().fieldOf("type").forGetter((var0x) -> var0x.type))).apply(var0, SetContainerLootTable::new));
