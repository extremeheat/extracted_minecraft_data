...
public class EnchantRandomlyFunction extends LootItemConditionalFunction {
      ...
      var0 -> commonFields(var0)
            .and(
               var0.group(
                  ...
                  Codec.BOOL.optionalFieldOf("only_compatible", true).forGetter(var0x -> var0x.onlyCompatible)
               )
            )
   ...
   public ItemStack run(ItemStack var1, LootContext var2) {
      ...
      if (var8.isEmpty()) {
         ...
         return enchantItem(var1, (Holder<Enchantment>)var8.get(), var3);
      }
   }
   ...
   public static EnchantRandomlyFunction.Builder randomApplicableEnchantment(HolderLookup.Provider var0) {
   ...
   public static class Builder extends LootItemConditionalFunction.Builder<EnchantRandomlyFunction.Builder> {
      ...
      public EnchantRandomlyFunction.Builder withEnchantment(Holder<Enchantment> var1) {
         this.options = Optional.of(HolderSet.direct(var1));
         return this;
      }

      public EnchantRandomlyFunction.Builder withOneOf(HolderSet<Enchantment> var1) {
