...
public class EnchantedCountIncreaseFunction extends LootItemConditionalFunction {
   ...
   public static final MapCodec<EnchantedCountIncreaseFunction> CODEC = RecordCodecBuilder.mapCodec(
      var0 -> commonFields(var0)
            .and(
               var0.group(
                  Enchantment.CODEC.fieldOf("enchantment").forGetter(var0x -> var0x.enchantment),
                  NumberProviders.CODEC.fieldOf("count").forGetter(var0x -> var0x.value),
                  Codec.INT.optionalFieldOf("limit", 0).forGetter(var0x -> var0x.limit)
               )
            )
   ...
   public static EnchantedCountIncreaseFunction.Builder lootingMultiplier(HolderLookup.Provider var0, NumberProvider var1) {
      HolderLookup.RegistryLookup var2 = var0.lookupOrThrow(Registries.ENCHANTMENT);
      return new EnchantedCountIncreaseFunction.Builder(var2.getOrThrow(Enchantments.LOOTING), var1);
   }
   ...
   public static class Builder extends LootItemConditionalFunction.Builder<EnchantedCountIncreaseFunction.Builder> {
      ...
      public EnchantedCountIncreaseFunction.Builder setLimit(int var1) {
         this.limit = var1;
         return this;
      }
