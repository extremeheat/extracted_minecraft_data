...
public class SetItemDamageFunction extends LootItemConditionalFunction {
   ...
   public static final MapCodec<SetItemDamageFunction> MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> commonFields(i).and(i.group(NumberProviders.DIRECT_CODEC.fieldOf("damage").forGetter((f) -> f.damage), Codec.BOOL.optionalFieldOf("add", false).forGetter((f) -> f.add))).apply(i, SetItemDamageFunction::new));
