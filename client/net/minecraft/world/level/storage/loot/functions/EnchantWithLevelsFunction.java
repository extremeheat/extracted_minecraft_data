...
public class EnchantWithLevelsFunction extends LootItemConditionalFunction {
   ...
   private EnchantWithLevelsFunction(final Optional<Holder<LootItemCondition>> condition, final Holder<NumberProvider> levels, final Optional<HolderSet<Enchantment>> options, final boolean includeAdditionalCostComponent) {
      super(condition);
      this.levels = levels;
   ...
   public static Builder enchantWithLevels(final HolderGetter<Enchantment> enchantments, final Holder<NumberProvider> levels) {
