...
public class ApplyBonusCount extends LootItemConditionalFunction {
   ...
   ApplyBonusCount(LootItemCondition[] var1, Enchantment var2, Formula var3) {
      super(var1);
   ...
   static {
      FORMULAS.put(ApplyBonusCount.BinomialWithBonusCount.TYPE, BinomialWithBonusCount::deserialize);
      FORMULAS.put(ApplyBonusCount.OreDrops.TYPE, OreDrops::deserialize);
      FORMULAS.put(ApplyBonusCount.UniformBonusCount.TYPE, UniformBonusCount::deserialize);
   }
   ...
   static final class UniformBonusCount implements Formula {
      ...
      public static Formula deserialize(JsonObject var0, JsonDeserializationContext var1) {
         int var2 = GsonHelper.getAsInt(var0, "bonusMultiplier");
         return new UniformBonusCount(var2);
      }
   ...
   private static final class BinomialWithBonusCount implements Formula {
      ...
      public static Formula deserialize(JsonObject var0, JsonDeserializationContext var1) {
         ...
         return new BinomialWithBonusCount(var2, var3);
      }
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<ApplyBonusCount> {
      ...
      public ApplyBonusCount deserialize(JsonObject var1, JsonDeserializationContext var2, LootItemCondition[] var3) {
         ...
         FormulaDeserializer var7 = (FormulaDeserializer)ApplyBonusCount.FORMULAS.get(var6);
         if (var7 == null) {
