...
public class SetAttributesFunction extends LootItemConditionalFunction {
   ...
   SetAttributesFunction(LootItemCondition[] var1, List<Modifier> var2) {
      super(var1);
   ...
   public ItemStack run(ItemStack var1, LootContext var2) {
      ...
      while(var4.hasNext()) {
         Modifier var5 = (Modifier)var4.next();
         UUID var6 = var5.id;
         if (var6 == null) {
   ...
   public static ModifierBuilder modifier(String var0, Attribute var1, AttributeModifier.Operation var2, NumberProvider var3) {
   ...
   private static class Modifier {
      ...
      public static Modifier deserialize(JsonObject var0, JsonDeserializationContext var1) {
         ...
         if (var4 == null) {
            ...
            return new Modifier(var2, var4, var5, var6, var7, var8);
         }
      }
   ...
   public static class ModifierBuilder {
      ...
      public ModifierBuilder forSlot(EquipmentSlot var1) {
         this.slots.add(var1);
         return this;
      }
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<SetAttributesFunction> {
      ...
      public void serialize(JsonObject var1, SetAttributesFunction var2, JsonSerializationContext var3) {
         ...
         while(var5.hasNext()) {
            Modifier var6 = (Modifier)var5.next();
