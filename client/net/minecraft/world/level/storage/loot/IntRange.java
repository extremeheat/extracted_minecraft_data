...
public class IntRange {
   ...
   private IntRange(Optional<NumberProvider> var1, Optional<NumberProvider> var2) {
      this((NumberProvider)var1.orElse((Object)null), (NumberProvider)var2.orElse((Object)null));
   }
   ...
   private OptionalInt unpackExact() {
      if (Objects.equals(this.min, this.max)) {
         ...
         if (var2 instanceof ConstantValue) {
            ConstantValue var1 = (ConstantValue)var2;
            if (Math.floor((double)var1.value()) == (double)var1.value()) {
