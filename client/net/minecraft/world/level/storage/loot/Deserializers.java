...
public class Deserializers {
   ...
   public static GsonBuilder createConditionSerializer() {
      return new GsonBuilder()
         .registerTypeAdapter(IntRange.class, new IntRange.Serializer())
         ...
         .registerTypeHierarchyAdapter(ScoreboardNameProvider.class, ScoreboardNameProviders.createGsonAdapter())
