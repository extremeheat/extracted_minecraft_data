...
public class LootContextParamSets {
   ...
   static {
      ...
      FISHING = register("fishing", (var0) -> var0.required(LootContextParams.ORIGIN).required(LootContextParams.TOOL).optional(LootContextParams.THIS_ENTITY));
      ENTITY = register("entity", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ORIGIN).required(LootContextParams.DAMAGE_SOURCE).optional(LootContextParams.ATTACKING_ENTITY).optional(LootContextParams.DIRECT_ATTACKING_ENTITY).optional(LootContextParams.LAST_DAMAGE_PLAYER));
      EQUIPMENT = register("equipment", (var0) -> var0.required(LootContextParams.ORIGIN).required(LootContextParams.THIS_ENTITY));
      ARCHAEOLOGY = register("archaeology", (var0) -> var0.required(LootContextParams.ORIGIN).required(LootContextParams.THIS_ENTITY).required(LootContextParams.TOOL));
      GIFT = register("gift", (var0) -> var0.required(LootContextParams.ORIGIN).required(LootContextParams.THIS_ENTITY));
      PIGLIN_BARTER = register("barter", (var0) -> var0.required(LootContextParams.THIS_ENTITY));
      VAULT = register("vault", (var0) -> var0.required(LootContextParams.ORIGIN).optional(LootContextParams.THIS_ENTITY).optional(LootContextParams.TOOL));
      ADVANCEMENT_REWARD = register("advancement_reward", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ORIGIN));
      ADVANCEMENT_ENTITY = register("advancement_entity", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ORIGIN));
      ADVANCEMENT_LOCATION = register("advancement_location", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ORIGIN).required(LootContextParams.TOOL).required(LootContextParams.BLOCK_STATE));
      BLOCK_USE = register("block_use", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ORIGIN).required(LootContextParams.BLOCK_STATE));
      ...
      ENCHANTED_ENTITY = register("enchanted_entity", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ENCHANTMENT_LEVEL).required(LootContextParams.ORIGIN));
      HIT_BLOCK = register("hit_block", (var0) -> var0.required(LootContextParams.THIS_ENTITY).required(LootContextParams.ENCHANTMENT_LEVEL).required(LootContextParams.ORIGIN).required(LootContextParams.BLOCK_STATE));
   }
}
