...
public class LootParams {
   ...
   public LootParams(ServerLevel var1, ContextMap var2, Map<ResourceLocation, LootParams.DynamicDrop> var3, float var4) {
      super();
      this.level = var1;
      this.params = var2;
   ...
   public static class Builder {
      ...
      public <T> LootParams.Builder withParameter(ContextKey<T> var1, T var2) {
         this.params.withParameter(var1, var2);
         return this;
      }

      public <T> LootParams.Builder withOptionalParameter(ContextKey<T> var1, @Nullable T var2) {
