...
public interface ContainerComponentManipulator<T> {
   ...
   default void setContents(ItemStack var1, T var2, Stream<ItemStack> var3) {
      Object var4 = var1.getOrDefault(this.type(), (T)var2);
      Object var5 = this.setContents((T)var4, var3);
      var1.set(this.type(), (T)var5);
   }
   ...
   default void modifyItems(ItemStack var1, UnaryOperator<ItemStack> var2) {
      ...
      if (var3 != null) {
         UnaryOperator var4 = var1x -> var1x.isEmpty() ? var1x : var2.apply(var1x);
         this.setContents(var1, this.getContents((T)var3).map(var4));
      }
   }
}
