...
public class PrimaryLevelData implements ServerLevelData, WorldData {
   ...
   public PrimaryLevelData(LevelSettings var1, WorldGenSettings var2, Lifecycle var3) {
      this((DataFixer)null, SharedConstants.getCurrentVersion().getWorldVersion(), (CompoundTag)null, false, 0, 0, 0, 0.0F, 0L, 0L, 19133, 0, 0, false, 0, false, false, false, WorldBorder.DEFAULT_SETTINGS, 0, 0, (UUID)null, Sets.newLinkedHashSet(), new TimerQueue(TimerCallbacks.SERVER_CALLBACKS), (CompoundTag)null, new CompoundTag(), var1.copy(), var2, var3);
   }
   ...
   private void setTagData(RegistryAccess var1, CompoundTag var2, @Nullable CompoundTag var3) {
      ...
      DataPackConfig.CODEC.encodeStart(NbtOps.INSTANCE, this.settings.getDataPackConfig()).result().ifPresent((var1x) -> {
         var2.put("DataPacks", var1x);
      });
