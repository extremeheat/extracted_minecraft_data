...
public class NormalDimension extends Dimension {
   ...
   public ChunkGenerator<? extends ChunkGeneratorSettings> createRandomLevelGenerator() {
      ...
      if (var1 == LevelType.FLAT) {
         ...
         FixedBiomeSourceSettings var20 = ((FixedBiomeSourceSettings)var7.createSettings()).setBiome(var23.getBiome());
         return var2.create(this.level, var7.create(var20), var23);
      } else if (var1 == LevelType.DEBUG_ALL_BLOCK_STATES) {
         FixedBiomeSourceSettings var22 = ((FixedBiomeSourceSettings)var7.createSettings()).setBiome(Biomes.PLAINS);
         ...
         OverworldBiomeSourceSettings var19 = ((OverworldBiomeSourceSettings)var8.createSettings()).setLevelData(this.level.getLevelData()).setGeneratorSettings(var21);
         ...
         if (var13 != null && var13.has("type") && var13.has("options")) {
            ...
            if (BiomeSourceType.FIXED == var14) {
               FixedBiomeSourceSettings var27 = ((FixedBiomeSourceSettings)var7.createSettings()).setBiome(var16[0]);
            ...
            if (BiomeSourceType.CHECKERBOARD == var14) {
               ...
               CheckerboardBiomeSourceSettings var31 = ((CheckerboardBiomeSourceSettings)var9.createSettings()).setAllowedBiomes(var16).setSize(var28);
               var10 = var9.create(var31);
            }

            if (BiomeSourceType.VANILLA_LAYERED == var14) {
               OverworldBiomeSourceSettings var29 = ((OverworldBiomeSourceSettings)var8.createSettings()).setGeneratorSettings(new OverworldGeneratorSettings()).setLevelData(this.level.getLevelData());
