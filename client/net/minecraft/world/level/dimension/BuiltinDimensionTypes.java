...
public class BuiltinDimensionTypes {
   ...
   public static final ResourceKey<DimensionType> GENERATED = register("generated");
   ...
   public static final ResourceLocation HUB_EFFECTS = ResourceLocation.withDefaultNamespace("hub");
   ...
   private static ResourceKey<DimensionType> register(String var0) {
      return ResourceKey.create(Registries.DIMENSION_TYPE, ResourceLocation.withDefaultNamespace(var0));
   }
}
