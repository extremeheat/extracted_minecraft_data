...
public record LevelStem(Holder<DimensionType> f, ChunkGenerator g) {
   ...
   public static final ResourceKey<LevelStem> POTATO = ResourceKey.create(Registries.LEVEL_STEM, new ResourceLocation("potato"));
