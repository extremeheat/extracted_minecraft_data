...
public class CollectingNeighborUpdater implements NeighborUpdater {
   ...
   public void shapeUpdate(Direction var1, BlockState var2, BlockPos var3, BlockPos var4, int var5, int var6) {
      this.addAndRun(var3, new ShapeUpdate(var1, var2, var3.immutable(), var4.immutable(), var5));
   }
   ...
   private static record ShapeUpdate(Direction a, BlockState b, BlockPos c, BlockPos d, int e) implements NeighborUpdates {
   ...
   static record SimpleNeighborUpdate(BlockPos a, Block b, BlockPos c) implements NeighborUpdates {
      private final BlockPos pos;
   ...
   static record FullNeighborUpdate(BlockState a, BlockPos b, Block c, BlockPos d, boolean e) implements NeighborUpdates {
      private final BlockState state;
      private final BlockPos pos;
      private final Block block;
      private final BlockPos neighborPos;
