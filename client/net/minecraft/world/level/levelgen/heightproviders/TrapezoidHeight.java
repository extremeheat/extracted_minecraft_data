...
public class TrapezoidHeight extends HeightProvider {
   ...
   // $FF: renamed from: of (net.minecraft.world.level.levelgen.VerticalAnchor, net.minecraft.world.level.levelgen.VerticalAnchor, int) net.minecraft.world.level.levelgen.heightproviders.TrapezoidHeight
   public static TrapezoidHeight method_25(VerticalAnchor var0, VerticalAnchor var1, int var2) {
      return new TrapezoidHeight(var0, var1, var2);
   }

   // $FF: renamed from: of (net.minecraft.world.level.levelgen.VerticalAnchor, net.minecraft.world.level.levelgen.VerticalAnchor) net.minecraft.world.level.levelgen.heightproviders.TrapezoidHeight
   public static TrapezoidHeight method_26(VerticalAnchor var0, VerticalAnchor var1) {
      return method_25(var0, var1, 0);
   }
