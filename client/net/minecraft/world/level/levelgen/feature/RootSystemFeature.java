...
public class RootSystemFeature extends Feature<RootSystemConfiguration> {
   ...
   private static boolean isAllowedTreeSpace(BlockState var0, int var1, int var2) {
      if (var0.isAir()) {
         ...
         int var3 = var1 + 1;
         return var3 <= var2 && var0.getFluidState().method_56(FluidTags.WATER);
      }
   }

   private static boolean placeDirtAndTree(WorldGenLevel var0, ChunkGenerator var1, RootSystemConfiguration var2, Random var3, BlockPos.MutableBlockPos var4, BlockPos var5) {
      for(int var6 = 0; var6 < var2.rootColumnMaxHeight; ++var6) {
         ...
         if (var2.allowedTreePosition.test(var0, var4) && spaceForTree(var0, var2, var4)) {
            ...
            if (var0.getFluidState(var7).method_56(FluidTags.LAVA) || !var0.getBlockState(var7).getMaterial().isSolid()) {
               return false;
            }

            if (((PlacedFeature)var2.treeFeature.get()).place(var0, var1, var3, var4)) {
   ...
   private static void placeDirt(BlockPos var0, int var1, WorldGenLevel var2, RootSystemConfiguration var3, Random var4) {
      int var5 = var0.getX();
      int var6 = var0.getZ();
   ...
   private static void placeRootedDirt(WorldGenLevel var0, RootSystemConfiguration var1, Random var2, int var3, int var4, BlockPos.MutableBlockPos var5) {
      int var6 = var1.rootRadius;
      Tag var7 = BlockTags.getAllTags().getTag(var1.rootReplaceable);
      Predicate var8 = var7 == null ? (var0x) -> {
         return true;
      } : (var1x) -> {
         return var1x.is(var7);
      };

      for(int var9 = 0; var9 < var1.rootPlacementAttempts; ++var9) {
         var5.setWithOffset(var5, var2.nextInt(var6) - var2.nextInt(var6), 0, var2.nextInt(var6) - var2.nextInt(var6));
         if (var8.test(var0.getBlockState(var5))) {
   ...
   private static void placeRoots(WorldGenLevel var0, RootSystemConfiguration var1, Random var2, BlockPos var3, BlockPos.MutableBlockPos var4) {
