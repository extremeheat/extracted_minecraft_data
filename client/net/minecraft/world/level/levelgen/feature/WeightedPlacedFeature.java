...
public class WeightedPlacedFeature {
   public static final Codec<WeightedPlacedFeature> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(PlacedFeature.CODEC.fieldOf("feature").flatXmap(ExtraCodecs.nonNullSupplierCheck(), ExtraCodecs.nonNullSupplierCheck()).forGetter((var0x) -> {
   ...
   public WeightedPlacedFeature(PlacedFeature var1, float var2) {
      this(() -> {
         return var1;
      }, var2);
   }

   private WeightedPlacedFeature(Supplier<PlacedFeature> var1, float var2) {
      super();
      this.feature = var1;
      this.chance = var2;
   }
   ...
   public boolean place(WorldGenLevel var1, ChunkGenerator var2, Random var3, BlockPos var4) {
      return ((PlacedFeature)this.feature.get()).place(var1, var2, var3, var4);
   }
}
