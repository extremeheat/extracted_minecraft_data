...
public class TaigaGrassFeature extends Feature<NoneFeatureConfiguration> {
   public TaigaGrassFeature(Function<Dynamic<?>, ? extends NoneFeatureConfiguration> var1) {
      super(var1);
   }

   public BlockState getState(Random var1) {
      return var1.nextInt(5) > 0 ? Blocks.FERN.defaultBlockState() : Blocks.GRASS.defaultBlockState();
   }
   ...
   public boolean place(LevelAccessor var1, ChunkGenerator<? extends ChunkGeneratorSettings> var2, Random var3, BlockPos var4, NoneFeatureConfiguration var5) {
      ...
      for(int var9 = 0; var9 < 128; ++var9) {
         ...
         if (var1.isEmptyBlock(var10) && var6.canSurvive(var1, var10)) {
