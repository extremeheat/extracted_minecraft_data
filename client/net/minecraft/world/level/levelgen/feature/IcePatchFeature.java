...
public class IcePatchFeature extends Feature<FeatureRadius> {
   ...
   public IcePatchFeature(Function<Dynamic<?>, ? extends FeatureRadius> var1) {
      super(var1);
      this.block = Blocks.PACKED_ICE;
   }

   public boolean place(LevelAccessor var1, ChunkGenerator<? extends ChunkGeneratorSettings> var2, Random var3, BlockPos var4, FeatureRadius var5) {
