...
public class PaleMossDecorator extends TreeDecorator {
   public static final MapCodec<PaleMossDecorator> CODEC = RecordCodecBuilder.mapCodec(
      var0 -> var0.group(
               Codec.floatRange(0.0F, 1.0F).fieldOf("leaves_probability").forGetter(var0x -> var0x.leavesProbability),
               Codec.floatRange(0.0F, 1.0F).fieldOf("trunk_probability").forGetter(var0x -> var0x.trunkProbability),
               Codec.floatRange(0.0F, 1.0F).fieldOf("ground_probability").forGetter(var0x -> var0x.groundProbability)
            )
   ...
   private static void addMossHanger(BlockPos var0, TreeDecorator.Context var1) {
      while (var1.isAir(var0.below()) && !((double)var1.random().nextFloat() < 0.5)) {
         var1.setBlock(var0, Blocks.PALE_HANGING_MOSS.defaultBlockState().setValue(HangingMossBlock.TIP, Boolean.valueOf(false)));
         var0 = var0.below();
      }

      var1.setBlock(var0, Blocks.PALE_HANGING_MOSS.defaultBlockState().setValue(HangingMossBlock.TIP, Boolean.valueOf(true)));
   }
}
