...
public class StrongholdFeature extends StructureFeature<NoneFeatureConfiguration> {
   ...
   public StrongholdFeature(Function<Dynamic<?>, ? extends NoneFeatureConfiguration> var1) {
      super(var1);
   }
   ...
   public boolean isFeatureChunk(ChunkGenerator<?> var1, Random var2, int var3, int var4) {
      ...
      ChunkPos[] var5 = this.strongholdPos;
   ...
   private void generatePositions(ChunkGenerator<?> var1) {
      ...
      while(var3.hasNext()) {
         ...
         if (var4 != null && var1.isBiomeValidStartForStructure(var4, Feature.STRONGHOLD)) {
            var2.add(var4);
         }
      }
      ...
      if (var6 < this.strongholdPos.length) {
         ...
         for(int var13 = 0; var13 < this.strongholdPos.length; ++var13) {
            ...
            BlockPos var18 = var1.getBiomeSource().findBiome((var16 << 4) + 8, (var17 << 4) + 8, 112, var2, var21);
            if (var18 != null) {
               var16 = var18.getX() >> 4;
               var17 = var18.getZ() >> 4;
            }
   ...
   public static class StrongholdStart extends StructureStart {
      public StrongholdStart(StructureFeature<?> var1, int var2, int var3, Biome var4, BoundingBox var5, int var6, long var7) {
