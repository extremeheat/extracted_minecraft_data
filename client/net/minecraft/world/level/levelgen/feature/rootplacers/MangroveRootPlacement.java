...
public record MangroveRootPlacement(HolderSet<Block> canGrowThrough, HolderSet<Block> muddyRootsIn, Holder<BlockStateProvider> muddyRootsProvider, int maxRootWidth, int maxRootLength, float randomSkewChance) {
