...
public class UnderwaterMagmaConfiguration implements FeatureConfiguration {
   public static final Codec<UnderwaterMagmaConfiguration> CODEC = RecordCodecBuilder.create((var0) -> var0.group(Codec.intRange(0, 512).fieldOf("floor_search_range").forGetter((var0x) -> var0x.floorSearchRange), Codec.intRange(0, 64).fieldOf("placement_radius_around_floor").forGetter((var0x) -> var0x.placementRadiusAroundFloor), Codec.floatRange(0.0F, 1.0F).fieldOf("placement_probability_per_valid_position").forGetter((var0x) -> var0x.placementProbabilityPerValidPosition)).apply(var0, UnderwaterMagmaConfiguration::new));
