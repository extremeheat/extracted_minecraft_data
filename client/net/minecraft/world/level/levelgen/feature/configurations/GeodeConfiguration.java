...
public class GeodeConfiguration implements FeatureConfiguration {
   ...
   public static final Codec<GeodeConfiguration> CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      }), IntProvider.codec(1, 20).fieldOf("outer_wall_distance").orElse(UniformInt.method_45(4, 5)).forGetter((var0x) -> {
         return var0x.outerWallDistance;
      }), IntProvider.codec(1, 20).fieldOf("distribution_points").orElse(UniformInt.method_45(3, 4)).forGetter((var0x) -> {
         return var0x.distributionPoints;
      }), IntProvider.codec(0, 10).fieldOf("point_offset").orElse(UniformInt.method_45(1, 2)).forGetter((var0x) -> {
