...
public class NetherForestVegetationConfig extends BlockPileConfiguration {
   public static final Codec<NetherForestVegetationConfig> CODEC = RecordCodecBuilder.create((var0) -> var0.group(BlockStateProvider.CODEC.fieldOf("state_provider").forGetter((var0x) -> var0x.stateProvider), ExtraCodecs.POSITIVE_INT.fieldOf("spread_width").forGetter((var0x) -> var0x.spreadWidth), ExtraCodecs.POSITIVE_INT.fieldOf("spread_height").forGetter((var0x) -> var0x.spreadHeight)).apply(var0, NetherForestVegetationConfig::new));
