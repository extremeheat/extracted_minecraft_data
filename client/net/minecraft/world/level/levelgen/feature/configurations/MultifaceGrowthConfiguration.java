   ...
   public static final Codec<MultifaceGrowthConfiguration> CODEC = RecordCodecBuilder.create(
      var0 -> var0.group(
               Registry.BLOCK
                  ...
                  .forGetter(var0x -> var0x.placeBlock),
               Codec.intRange(1, 64).fieldOf("search_range").orElse(10).forGetter(var0x -> var0x.searchRange),
               Codec.BOOL.fieldOf("can_place_on_floor").orElse(false).forGetter(var0x -> var0x.canPlaceOnFloor),
