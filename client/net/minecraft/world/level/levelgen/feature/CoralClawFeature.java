...
public class CoralClawFeature extends CoralFeature {
   ...
   protected boolean placeFeature(LevelAccessor var1, Random var2, BlockPos var3, BlockState var4) {
      if (!this.placeCoralBlock(var1, var2, var3, var4)) {
         ...
         ArrayList var7 = Lists.newArrayList(new Direction[]{var5, var5.getClockWise(), var5.getCounterClockWise()});
         ...
         while(var9.hasNext()) {
            ...
            if (var10 == var5) {
               ...
               var11.move(Direction.field_526);
               Direction[] var15 = new Direction[]{var10, Direction.field_526};
