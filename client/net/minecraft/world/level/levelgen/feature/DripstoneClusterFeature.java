...
public class DripstoneClusterFeature extends Feature<DripstoneClusterConfiguration> {
      ...
      if (var12.isPresent()) {
         ...
         if (var13.isPresent() || var14.isPresent()) {
            ...
            if (var13.isPresent() && var19 && !this.isLava(var1, var3.atY(var13.getAsInt()))) {
               ...
               this.replaceBlocksWithDripstoneBlocks(var1, var3.atY(var13.getAsInt()), var20, Direction.field_526);
               int var21;
               if (var30.isPresent()) {
            ...
            if (var30.isPresent() && var31 && !this.isLava(var1, var3.atY(var30.getAsInt()))) {
               ...
               if (var13.isPresent()) {
                  ...
                  var20 = this.getDripstoneHeight(var2, var4, var5, var10, var9, var11);
               }
            } else {
               var20 = 0;
            }
            ...
            if (var30.isPresent()) {
               DripstoneUtils.growPointedDripstone(var1, var3.atY(var30.getAsInt() + 1), Direction.field_526, var23, var32);
            }
   ...
   private boolean canBeAdjacentToWater(LevelAccessor var1, BlockPos var2) {
      BlockState var3 = var1.getBlockState(var2);
      return var3.is(BlockTags.BASE_STONE_OVERWORLD) || var3.getFluidState().method_56(FluidTags.WATER);
   }
   ...
   private double getChanceOfStalagmiteOrStalactite(int var1, int var2, int var3, int var4, DripstoneClusterConfiguration var5) {
      ...
      return (double)Mth.clampedMap((float)var8, 0.0F, (float)var5.maxDistanceFromEdgeAffectingChanceOfDripstoneColumn, var5.chanceOfDripstoneColumnAtMaxDistanceFromCenter, 1.0F);
   }
