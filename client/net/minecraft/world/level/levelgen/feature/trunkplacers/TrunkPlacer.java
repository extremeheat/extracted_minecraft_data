...
public abstract class TrunkPlacer {
   ...
   private static boolean isDirt(LevelSimulatedReader var0, BlockPos var1) {
      return var0.isStateAtPosition(
         var1,
         var0x -> Feature.isDirt(var0x)
               && !var0x.is(Blocks.GRASS_BLOCK)
               && !var0x.is(Blocks.PEELGRASS_BLOCK)
               && !var0x.is(Blocks.CORRUPTED_PEELGRASS_BLOCK)
               && !var0x.is(Blocks.MYCELIUM)
      );
   }
   ...
   protected boolean placeLog(
      ...
      RandomSource var3,
      BlockPos var4,
      TreeConfiguration var5,
      Function<BlockState, BlockState> var6
   ) {
   ...
   protected void placeLogIfFree(
      LevelSimulatedReader var1, BiConsumer<BlockPos, BlockState> var2, RandomSource var3, BlockPos.MutableBlockPos var4, TreeConfiguration var5
   ) {
