...
public class PointedDripstoneFeature extends Feature<PointedDripstoneConfiguration> {
   ...
   private static Optional<Direction> getTipDirection(LevelAccessor var0, BlockPos var1, Random var2) {
      ...
      if (var3 && var4) {
         return Optional.of(var2.nextBoolean() ? Direction.DOWN : Direction.field_526);
      } else if (var3) {
         return Optional.of(Direction.DOWN);
      } else {
         return var4 ? Optional.of(Direction.field_526) : Optional.empty();
      }
   }

   private static void createPatchOfDripstoneBlocks(LevelAccessor var0, Random var1, BlockPos var2, PointedDripstoneConfiguration var3) {
