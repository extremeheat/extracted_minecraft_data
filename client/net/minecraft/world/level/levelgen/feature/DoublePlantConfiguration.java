...
public class DoublePlantConfiguration implements FeatureConfiguration {
   public final BlockState state;

   public DoublePlantConfiguration(BlockState var1) {
      super();
      this.state = var1;
   }
   ...
   public static <T> DoublePlantConfiguration deserialize(Dynamic<T> var0) {
      BlockState var1 = (BlockState)var0.get("state").map(BlockState::deserialize).orElse(Blocks.AIR.defaultBlockState());
      return new DoublePlantConfiguration(var1);
   }
}
