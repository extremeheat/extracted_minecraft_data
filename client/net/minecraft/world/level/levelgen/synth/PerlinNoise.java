...
public class PerlinNoise {
   ...
   /** @deprecated */
   @Deprecated
   public static PerlinNoise createLegacyForLegacyNormalNoise(RandomSource var0, int var1, DoubleList var2) {
   ...
   public double getValue(double var1, double var3, double var5, double var7, double var9, boolean var11) {
      ...
      for(int var18 = 0; var18 < this.noiseLevels.length; ++var18) {
         ...
         if (var19 != null) {
            double var20 = var19.noise(wrap(var1 * var14), var11 ? -var19.field_432 : wrap(var3 * var14), wrap(var5 * var14), var7 * var14, var9 * var14);
