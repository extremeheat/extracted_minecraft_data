...
public class PerlinSimplexNoise implements SurfaceNoise {
   ...
   private PerlinSimplexNoise(WorldgenRandom var1, IntSortedSet var2) {
      ...
      if (var2.isEmpty()) {
         ...
         if (var5 < 1) {
            ...
            if (var4 > 0) {
               long var12 = (long)(var6.getValue(var6.xo, var6.yo, var6.zo) * 9.223372036854776E18D);
   ...
   public double getValue(double var1, double var3, boolean var5) {
      ...
      for(int var14 = 0; var14 < var13; ++var14) {
         ...
         if (var15 != null) {
            var6 += var15.getValue(var1 * var8 + (var5 ? var15.xo : 0.0D), var3 * var8 + (var5 ? var15.yo : 0.0D)) * var10;
         }
