...
public class BlendedNoise implements DensityFunction.SimpleFunction {
   ...
   public void parityConfigString(StringBuilder var1) {
      ...
      var1.append(String.format(", xzScale=%.3f, yScale=%.3f, xzMainScale=%.3f, yMainScale=%.3f, cellWidth=4, cellHeight=8", 684.412, 684.412, 8.555150000000001, 4.277575000000001)).append('}');
   }
