...
public class WorldGenSettings {
   ...
   public static WorldGenSettings demoSettings(RegistryAccess var0) {
      ...
      return new WorldGenSettings((long)var1, true, true, withOverworld((Registry)var0.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY), (MappedRegistry)DimensionType.defaultDimensions(var0, (long)var1), makeDefaultOverworld(var0, (long)var1)));
   }

   public static WorldGenSettings makeDefault(RegistryAccess var0) {
      long var1 = (new Random()).nextLong();
      return new WorldGenSettings(var1, true, false, withOverworld((Registry)var0.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY), (MappedRegistry)DimensionType.defaultDimensions(var0, var1), makeDefaultOverworld(var0, var1)));
   }
   ...
   public static NoiseBasedChunkGenerator makeOverworld(RegistryAccess var0, long var1, ResourceKey<NoiseGeneratorSettings> var3, boolean var4) {
      return new NoiseBasedChunkGenerator(var0.registryOrThrow(Registry.NOISE_REGISTRY), MultiNoiseBiomeSource.Preset.OVERWORLD.biomeSource(var0.registryOrThrow(Registry.BIOME_REGISTRY), var4), var1, () -> {
   ...
   public static WorldGenSettings create(RegistryAccess var0, Properties var1) {
      ...
      Registry var18 = var0.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY);
      Registry var11 = var0.registryOrThrow(Registry.BIOME_REGISTRY);
      MappedRegistry var12 = DimensionType.defaultDimensions(var0, var8);
      byte var14 = -1;
      ...
      switch(var14) {
      case 0:
         JsonObject var15 = !var2.isEmpty() ? GsonHelper.parse(var2) : new JsonObject();
         Dynamic var16 = new Dynamic(JsonOps.INSTANCE, var15);
         DataResult var10009 = FlatLevelGeneratorSettings.CODEC.parse(var16);
         Logger var10010 = LOGGER;
         Objects.requireNonNull(var10010);
         return new WorldGenSettings(var8, var5, false, withOverworld((Registry)var18, (MappedRegistry)var12, new FlatLevelSource((FlatLevelGeneratorSettings)var10009.resultOrPartial(var10010::error).orElseGet(() -> {
            return FlatLevelGeneratorSettings.getDefault(var11);
         }))));
      case 1:
         return new WorldGenSettings(var8, var5, false, withOverworld((Registry)var18, (MappedRegistry)var12, new DebugLevelSource(var11)));
      case 2:
         return new WorldGenSettings(var8, var5, false, withOverworld((Registry)var18, (MappedRegistry)var12, makeOverworld(var0, var8, NoiseGeneratorSettings.AMPLIFIED)));
      case 3:
         return new WorldGenSettings(var8, var5, false, withOverworld((Registry)var18, (MappedRegistry)var12, makeOverworld(var0, var8, NoiseGeneratorSettings.LARGE_BIOMES)));
      default:
         return new WorldGenSettings(var8, var5, false, withOverworld((Registry)var18, (MappedRegistry)var12, makeDefaultOverworld(var0, var8)));
      }
   }
