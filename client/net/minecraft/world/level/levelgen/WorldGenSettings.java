...
public class WorldGenSettings {
   ...
   public WorldGenSettings(long var1, boolean var3, boolean var4, Registry<LevelStem> var5) {
      ...
      LevelStem var6 = var5.get(LevelStem.OVERWORLD);
      if (var6 == null) {
   ...
   public static Registry<LevelStem> withOverworld(Registry<LevelStem> var0, Holder<DimensionType> var1, ChunkGenerator var2) {
      MappedRegistry var3 = new MappedRegistry<>(Registry.LEVEL_STEM_REGISTRY, Lifecycle.experimental(), null);
   ...
   public WorldGenSettings withSeed(boolean var1, OptionalLong var2) {
      ...
      Object var6;
      if (var2.isPresent()) {
         MappedRegistry var7 = new MappedRegistry<>(Registry.LEVEL_STEM_REGISTRY, Lifecycle.experimental(), null);

         for(Entry var9 : this.dimensions.entrySet()) {
            ResourceKey var10 = (ResourceKey)var9.getKey();
            var7.register(
               var10,
               new LevelStem(((LevelStem)var9.getValue()).typeHolder(), ((LevelStem)var9.getValue()).generator()),
               this.dimensions.lifecycle((LevelStem)var9.getValue())
            );
         }
      ...
      if (this.isDebug()) {
         var3 = new WorldGenSettings(var4, false, false, (Registry<LevelStem>)var6);
      } else {
         var3 = new WorldGenSettings(var4, this.generateStructures(), this.generateBonusChest() && !var1, (Registry<LevelStem>)var6);
      }
