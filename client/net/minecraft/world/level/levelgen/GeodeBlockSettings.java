...
public class GeodeBlockSettings {
   ...
   public static final Codec<GeodeBlockSettings> CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      }), TagKey.hashedCodec(Registry.BLOCK_REGISTRY).fieldOf("cannot_replace").forGetter((var0x) -> {
         return var0x.cannotReplace;
      }), TagKey.hashedCodec(Registry.BLOCK_REGISTRY).fieldOf("invalid_blocks").forGetter((var0x) -> {
