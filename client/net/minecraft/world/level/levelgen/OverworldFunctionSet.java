...
public record OverworldFunctionSet<T>(T temperature, T vegetation, T continents, T erosion, T offset, T factor, T jaggedness, T depth, T slopedCheese, T preliminarySurfaceLevel, T finalDensity) {
