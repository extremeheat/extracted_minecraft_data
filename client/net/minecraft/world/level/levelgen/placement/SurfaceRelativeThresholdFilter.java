...
public class SurfaceRelativeThresholdFilter extends PlacementFilter {
   public static final Codec<SurfaceRelativeThresholdFilter> CODEC = RecordCodecBuilder.create((var0) -> {
   ...
   // $FF: renamed from: of (net.minecraft.world.level.levelgen.Heightmap$Types, int, int) net.minecraft.world.level.levelgen.placement.SurfaceRelativeThresholdFilter
   public static SurfaceRelativeThresholdFilter method_41(Heightmap.Types var0, int var1, int var2) {
