...
public class RandomOffsetPlacement extends PlacementModifier {
   public static final Codec<RandomOffsetPlacement> CODEC = RecordCodecBuilder.create((var0) -> {
   ...
   // $FF: renamed from: of (net.minecraft.util.valueproviders.IntProvider, net.minecraft.util.valueproviders.IntProvider) net.minecraft.world.level.levelgen.placement.RandomOffsetPlacement
   public static RandomOffsetPlacement method_40(IntProvider var0, IntProvider var1) {
      return new RandomOffsetPlacement(var0, var1);
   }

   public static RandomOffsetPlacement vertical(IntProvider var0) {
      return new RandomOffsetPlacement(ConstantInt.method_49(0), var0);
   }

   public static RandomOffsetPlacement horizontal(IntProvider var0) {
      return new RandomOffsetPlacement(var0, ConstantInt.method_49(0));
   }
