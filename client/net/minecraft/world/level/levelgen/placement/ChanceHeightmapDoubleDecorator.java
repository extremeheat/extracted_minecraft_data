...
public class ChanceHeightmapDoubleDecorator extends FeatureDecorator<DecoratorChance> {
   public ChanceHeightmapDoubleDecorator(Function<Dynamic<?>, ? extends DecoratorChance> var1) {
      super(var1);
   }
   ...
   public Stream<BlockPos> getPositions(LevelAccessor var1, ChunkGenerator<? extends ChunkGeneratorSettings> var2, Random var3, DecoratorChance var4, BlockPos var5) {
      if (var3.nextFloat() < 1.0F / (float)var4.chance) {
         ...
         int var8 = var1.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING, var5.offset(var6, 0, var7)).getY() * 2;
         if (var8 <= 0) {
            return Stream.empty();
         } else {
            int var9 = var3.nextInt(var8);
