...
public class CountOnEveryLayerPlacement extends PlacementModifier {
   public static final Codec<CountOnEveryLayerPlacement> CODEC = IntProvider.codec(0, 256).fieldOf("count").xmap(CountOnEveryLayerPlacement::new, (var0) -> {
      return var0.count;
   }).codec();
   ...
   // $FF: renamed from: of (net.minecraft.util.valueproviders.IntProvider) net.minecraft.world.level.levelgen.placement.CountOnEveryLayerPlacement
   public static CountOnEveryLayerPlacement method_33(IntProvider var0) {
      return new CountOnEveryLayerPlacement(var0);
   }

   // $FF: renamed from: of (int) net.minecraft.world.level.levelgen.placement.CountOnEveryLayerPlacement
   public static CountOnEveryLayerPlacement method_34(int var0) {
      return method_33(ConstantInt.method_49(var0));
   }
