...
public final class DensityFunctions {
   ...
   interface TwoArgumentSimpleFunction extends DensityFunction {
      ...
      static TwoArgumentSimpleFunction create(Type var0, DensityFunction var1, DensityFunction var2) {
         ...
         double var17;
         switch (var0.ordinal()) {
            case 0 -> var17 = var3 + var5;
            case 1 -> var17 = var3 > 0.0 && var5 > 0.0 ? var3 * var5 : (var7 < 0.0 && var9 < 0.0 ? var7 * var9 : Math.min(var3 * var9, var7 * var5));
            case 2 -> var17 = Math.min(var3, var5);
            case 3 -> var17 = Math.max(var3, var5);
            default -> throw new MatchException((String)null, (Throwable)null);
         }

         double var16 = var17;
         switch (var0.ordinal()) {
            case 0 -> var17 = var7 + var9;
            case 1 -> var17 = var3 > 0.0 && var5 > 0.0 ? var7 * var9 : (var7 < 0.0 && var9 < 0.0 ? var3 * var5 : Math.max(var3 * var5, var7 * var9));
            case 2 -> var17 = Math.min(var7, var9);
            case 3 -> var17 = Math.max(var7, var9);
            default -> throw new MatchException((String)null, (Throwable)null);
         }
         ...
         switch (this.type.ordinal()) {
            ...
            case 1:
               for(int var8 = 0; var8 < var1.length; ++var8) {
                  ...
                  var1[var8] = var4 == 0.0 ? 0.0 : var4 * this.argument2.compute(var2.forIndex(var8));
               }

               return;
            case 2:
               var3 = this.argument2.minValue();

               for(var5 = 0; var5 < var1.length; ++var5) {
                  var6 = var1[var5];
                  var1[var5] = var6 < var3 ? var6 : Math.min(var6, this.argument2.compute(var2.forIndex(var5)));
               }

               return;
            case 3:
               var3 = this.argument2.maxValue();
