...
public class Heightmap {
   ...
   public static enum Types implements StringRepresentable {
      ...
      private static Heightmap.Types[] $values() {
         return new Heightmap.Types[]{WORLD_SURFACE_WG, WORLD_SURFACE, OCEAN_FLOOR_WG, OCEAN_FLOOR, MOTION_BLOCKING, MOTION_BLOCKING_NO_LEAVES};
      }
   }
   ...
   public static enum Usage {
      ...
      // $FF: synthetic method
      private static Heightmap.Usage[] $values() {
         return new Heightmap.Usage[]{WORLDGEN, LIVE_WORLD, CLIENT};
      }
   }
}
