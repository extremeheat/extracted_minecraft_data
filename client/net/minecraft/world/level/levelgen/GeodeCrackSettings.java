...
public class GeodeCrackSettings {
   public static final Codec<GeodeCrackSettings> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(GeodeConfiguration.CHANCE_RANGE.fieldOf("generate_crack_chance").orElse(1.0).forGetter((var0x) -> {
         return var0x.generateCrackChance;
      }), Codec.doubleRange(0.0, 5.0).fieldOf("base_crack_size").orElse(2.0).forGetter((var0x) -> {
