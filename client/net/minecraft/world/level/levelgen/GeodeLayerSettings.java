...
public class GeodeLayerSettings {
   ...
   public static final Codec<GeodeLayerSettings> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(LAYER_RANGE.fieldOf("filling").orElse(1.7).forGetter((var0x) -> {
         return var0x.filling;
      }), LAYER_RANGE.fieldOf("inner_layer").orElse(2.2).forGetter((var0x) -> {
         return var0x.innerLayer;
      }), LAYER_RANGE.fieldOf("middle_layer").orElse(3.2).forGetter((var0x) -> {
         return var0x.middleLayer;
      }), LAYER_RANGE.fieldOf("outer_layer").orElse(4.2).forGetter((var0x) -> {
