...
public class NoiseChunk implements DensityFunction.ContextProvider, DensityFunction.FunctionContext {
   ...
   public NoiseChunk(int var1, RandomState var2, int var3, int var4, NoiseSettings var5, DensityFunctions.BeardifierOrMarker var6, NoiseGeneratorSettings var7, Aquifer.FluidPicker var8, Blender var9) {
      super();
      ...
      this.cellCountY = Mth.intFloorDiv(var5.height(), this.cellHeight);
      this.cellNoiseMinY = Mth.intFloorDiv(var5.minY(), this.cellHeight);
      ...
      ImmutableList.Builder var19 = ImmutableList.builder();
      ...
      this.blockStateRule = new MaterialRuleList(var19.build());
   ...
   public void selectCellYZ(int var1, int var2) {
      ...
      while(var3.hasNext()) {
         CacheAllInCell var4 = (CacheAllInCell)var3.next();
   ...
   private DensityFunction wrapNew(DensityFunction var1) {
      if (var1 instanceof DensityFunctions.Marker) {
         ...
         switch (var3.type()) {
            case Interpolated:
               var10000 = new NoiseInterpolator(var3.wrapped());
               break;
            case FlatCache:
               var10000 = new FlatCache(var3.wrapped(), true);
               break;
            case Cache2D:
               var10000 = new Cache2D(var3.wrapped());
               break;
            case CacheOnce:
               var10000 = new CacheOnce(var3.wrapped());
               break;
            case CacheAllInCell:
               var10000 = new CacheAllInCell(var3.wrapped());
               break;
            default:
