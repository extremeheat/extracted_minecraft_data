...
public interface BuiltinStructures {
   ...
   ResourceKey<Structure> ABANDONDED_CAMP_BAMBOO_JUNGLE = createKey("abandoned_camp_bamboo_jungle");
   ResourceKey<Structure> ABANDONDED_CAMP_BIRCH_FOREST = createKey("abandoned_camp_birch_forest");
   ResourceKey<Structure> ABANDONDED_CAMP_CHERRY_GROVE = createKey("abandoned_camp_cherry_grove");
   ResourceKey<Structure> ABANDONDED_CAMP_DAPPLED_FOREST = createKey("abandoned_camp_dappled_forest");
   ResourceKey<Structure> ABANDONDED_CAMP_FLOWER_FOREST = createKey("abandoned_camp_flower_forest");
   ResourceKey<Structure> ABANDONDED_CAMP_FOREST = createKey("abandoned_camp_forest");
   ResourceKey<Structure> ABANDONDED_CAMP_MEADOW = createKey("abandoned_camp_meadow");
   ResourceKey<Structure> ABANDONDED_CAMP_OLD_GROWTH_BIRCH_FOREST = createKey("abandoned_camp_old_growth_birch_forest");
   ResourceKey<Structure> ABANDONDED_CAMP_OLD_GROWTH_PINE_TAIGA = createKey("abandoned_camp_old_growth_pine_taiga");
   ResourceKey<Structure> ABANDONDED_CAMP_OLD_GROWTH_SPRUCE_TAIGA = createKey("abandoned_camp_old_growth_spruce_taiga");
   ResourceKey<Structure> ABANDONDED_CAMP_PALE_GARDEN = createKey("abandoned_camp_pale_garden");
   ResourceKey<Structure> ABANDONDED_CAMP_SAVANNA = createKey("abandoned_camp_savanna");
   ResourceKey<Structure> ABANDONDED_CAMP_SNOWY_TAIGA = createKey("abandoned_camp_snowy_taiga");
   ResourceKey<Structure> ABANDONDED_CAMP_SPARSE_JUNGLE = createKey("abandoned_camp_sparse_jungle");
   ResourceKey<Structure> ABANDONDED_CAMP_SWAMP = createKey("abandoned_camp_swamp");
   ResourceKey<Structure> ABANDONDED_CAMP_TAIGA = createKey("abandoned_camp_taiga");
   ResourceKey<Structure> ABANDONDED_CAMP_WINDSWEPT_FOREST = createKey("abandoned_camp_windswept_forest");
   ResourceKey<Structure> ABANDONDED_CAMP_WOODED_BADLANDS = createKey("abandoned_camp_wooded_badlands");
