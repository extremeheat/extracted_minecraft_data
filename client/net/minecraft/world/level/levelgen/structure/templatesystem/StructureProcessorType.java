...
public interface StructureProcessorType<P extends StructureProcessor> {
   ...
   Codec<StructureProcessorList> DIRECT_CODEC = ExtraCodecs.withAlternative(LIST_OBJECT_CODEC.fieldOf("processors").codec(), LIST_OBJECT_CODEC);
   ...
   static <P extends StructureProcessor> StructureProcessorType<P> register(String var0, Codec<P> var1) {
      return Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, var0, () -> var1);
   }
}
