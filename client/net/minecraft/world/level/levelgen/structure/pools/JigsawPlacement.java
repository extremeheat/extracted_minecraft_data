...
public class JigsawPlacement {
   ...
   public static Optional<Structure.GenerationStub> addPieces(Structure.GenerationContext var0, Holder<StructureTemplatePool> var1, Optional<ResourceLocation> var2, int var3, BlockPos var4, boolean var5, Optional<Heightmap.Types> var6, int var7) {
      ...
      Registry var13 = var8.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY);
      ...
      if (var16 == EmptyPoolElement.INSTANCE) {
         ...
         if (var2.isPresent()) {
            ...
            if (var19.isEmpty()) {
               LOGGER.error("No starting jigsaw {} found in start pool {}", var18, ((ResourceKey)var1.unwrapKey().get()).location());
               return Optional.empty();
            }
         ...
         PoolElementStructurePiece var20 = new PoolElementStructurePiece(var10, var16, var28, var16.getGroundLevelDelta(), var14, var16.getBoundingBox(var10, var28, var14));
         ...
         return Optional.of(new Structure.GenerationStub(new BlockPos(var22, var26, var23), (var14x) -> {
            ArrayList var15 = Lists.newArrayList();
            var15.add(var20);
            if (var3 > 0) {
               AABB var16 = new AABB((double)(var22 - var7), (double)(var26 - var7), (double)(var23 - var7), (double)(var22 + var7 + 1), (double)(var26 + var7 + 1), (double)(var23 + var7 + 1));
               VoxelShape var17 = Shapes.join(Shapes.create(var16), Shapes.create(AABB.of(var21)), BooleanOp.ONLY_FIRST);
               addPieces(var0.randomState(), var3, var5, var9, var10, var11, var12, var13, var20, var15, var17);
               Objects.requireNonNull(var14x);
               var15.forEach(var14x::addPiece);
            }
         }));
      }
   }
   ...
   private static void addPieces(RandomState var0, int var1, boolean var2, ChunkGenerator var3, StructureTemplateManager var4, LevelHeightAccessor var5, RandomSource var6, Registry<StructureTemplatePool> var7, PoolElementStructurePiece var8, List<PoolElementStructurePiece> var9, VoxelShape var10) {
      Placer var11 = new Placer(var7, var1, var3, var4, var9, var6);
      var11.placing.addLast(new PieceState(var8, new MutableObject(var10), 0));

      while(!var11.placing.isEmpty()) {
         PieceState var12 = (PieceState)var11.placing.removeFirst();
   ...
   private static final class Placer {
      ...
      void tryPlacingChildren(PoolElementStructurePiece var1, MutableObject<VoxelShape> var2, int var3, boolean var4, LevelHeightAccessor var5, RandomState var6) {
         ...
         Iterator var15 = var7.getShuffledJigsawBlocks(this.structureTemplateManager, var8, var9, this.random).iterator();
                     ...
                     if (var23.isPresent() && (((StructureTemplatePool)var23.get()).size() != 0 || Objects.equals(var22, Pools.EMPTY.location()))) {
                        ...
                        if (var25.isPresent() && (((StructureTemplatePool)var25.get()).size() != 0 || Objects.equals(var24, Pools.EMPTY.location()))) {
                           ...
                           if (var3 != this.maxDepth) {
                              var28.addAll(((StructureTemplatePool)var23.get()).getShuffledTemplates(this.random));
                           }

                           var28.addAll(((StructureTemplatePool)var25.get()).getShuffledTemplates(this.random));
                           ...
                           while(var29.hasNext()) {
                              ...
                              while(var31.hasNext()) {
                                    ...
                                    var35 = var33.stream().mapToInt((var2x) -> {
                                       if (!var34.isInside(var2x.pos.relative(JigsawBlock.getFrontFacing(var2x.state)))) {
                                          ...
                                          int var6 = (Integer)var4.map((var1) -> {
                                             return var1.getMaxSize(this.structureTemplateManager);
                                          }).orElse(0);
                                 ...
                                 do {
                                    ...
                                    } while(!JigsawBlock.canAttach(var16, var37));
                                    ...
                                    var44 = var38.getY();
                                    var45 = var20 - var44 + JigsawBlock.getFrontFacing(var16.state).getStepY();
                                    if (var11 && var43) {
                                       var46 = var14 + var45;
                                    } else {
                                       if (var21 == -1) {
                                          var21 = this.chunkGenerator.getFirstFreeHeight(var18.getX(), var18.getZ(), Heightmap.Types.WORLD_SURFACE_WG, var5, var6);
                                       }
                                    ...
                                    if (var35 > 0) {
                                       var50 = Math.max(var35 + 1, var48.maxY() - var48.minY());
                                       var48.encapsulate(new BlockPos(var48.minX(), var48.minY() + var50, var48.minZ()));
                                    }
                                 } while(Shapes.joinIsNotEmpty((VoxelShape)var26.getValue(), Shapes.create(AABB.of(var48).deflate(0.25)), BooleanOp.ONLY_SECOND));
                                 ...
                                 PoolElementStructurePiece var52 = new PoolElementStructurePiece(this.structureTemplateManager, var30, var49, var51, var32, var48);
                                 int var53;
                                 if (var11) {
                                    var53 = var14 + var20;
                                 } else if (var43) {
                                 ...
                                 var1.addJunction(new JigsawJunction(var19.getX(), var53 - var20 + var50, var19.getZ(), var45, var42));
                                 ...
                                 if (var3 + 1 <= this.maxDepth) {
                                    this.placing.addLast(new PieceState(var52, var26, var3 + 1));
                                 }
                                 continue label93;
                              }
                           }
