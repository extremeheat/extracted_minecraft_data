...
public class JigsawJunction {
   ...
   public <T> Dynamic<T> serialize(DynamicOps<T> var1) {
      ...
      var2.put(var1.createString("source_x"), var1.createInt(this.sourceX))
         .put(var1.createString("source_ground_y"), var1.createInt(this.sourceGroundY))
         .put(var1.createString("source_z"), var1.createInt(this.sourceZ))
         .put(var1.createString("delta_y"), var1.createInt(this.deltaY))
         .put(var1.createString("dest_proj"), var1.createString(this.destProjection.getName()));
   ...
   public static <T> JigsawJunction deserialize(Dynamic<T> var0) {
      return new JigsawJunction(
         ...
         StructureTemplatePool.Projection.byName(var0.get("dest_proj").asString(""))
      );
   }
   ...
   public int hashCode() {
      ...
      return 31 * var1 + this.destProjection.hashCode();
   }
