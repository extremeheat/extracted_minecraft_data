...
public abstract class Structure {
   ...
   public static <S extends Structure> Codec<S> simpleCodec(Function<StructureSettings, S> var0) {
   ...
   public StructureStart generate(RegistryAccess var1, ChunkGenerator var2, BiomeSource var3, RandomState var4, StructureTemplateManager var5, long var6, ChunkPos var8, int var9, LevelHeightAccessor var10, Predicate<Holder<Biome>> var11) {
      Optional var12 = this.findGenerationPoint(new GenerationContext(var1, var2, var3, var4, var5, var6, var8, var10, var11));
      if (var12.isPresent() && isValidBiome((GenerationStub)var12.get(), var2, var4, var11)) {
         StructurePiecesBuilder var13 = ((GenerationStub)var12.get()).getPiecesBuilder();
   ...
   private static boolean isValidBiome(GenerationStub var0, ChunkGenerator var1, RandomState var2, Predicate<Holder<Biome>> var3) {
   ...
   public abstract Optional<GenerationStub> findGenerationPoint(GenerationContext var1);

   public abstract StructureType<?> type();

   static {
      DIRECT_CODEC = Registry.STRUCTURE_TYPES.byNameCodec().dispatch(Structure::type, StructureType::codec);
      CODEC = RegistryFileCodec.create(Registry.STRUCTURE_REGISTRY, DIRECT_CODEC);
   }
