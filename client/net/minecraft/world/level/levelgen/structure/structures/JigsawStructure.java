...
public final class JigsawStructure extends Structure {
   ...
   public static final MapCodec<JigsawStructure> CODEC = RecordCodecBuilder.mapCodec((var0) -> {
   ...
   public JigsawStructure(Structure.StructureSettings var1, Holder<StructureTemplatePool> var2, Optional<ResourceLocation> var3, int var4, HeightProvider var5, boolean var6, Optional<Heightmap.Types> var7, int var8, List<PoolAliasBinding> var9) {
      super(var1);
      this.startPool = var2;
   ...
   public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext var1) {
      ...
      return JigsawPlacement.addPieces(var1, this.startPool, this.startJigsawName, this.maxDepth, var4, this.useExpansionHack, this.projectStartToHeightmap, this.maxDistanceFromCenter, PoolAliasLookup.create(this.poolAliases, var4, var1.seed()));
   }
