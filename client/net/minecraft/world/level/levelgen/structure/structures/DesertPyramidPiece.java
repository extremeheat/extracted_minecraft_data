...
public class DesertPyramidPiece extends ScatteredFeaturePiece {
   ...
   public void postProcess(WorldGenLevel var1, StructureManager var2, ChunkGenerator var3, RandomSource var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
      if (this.updateHeightPositionToLowestGroundHeight(var1, -var4.nextInt(3))) {
         ...
         BlockState var17 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairBlock.FACING, Direction.NORTH);
         BlockState var18 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairBlock.FACING, Direction.SOUTH);
         BlockState var19 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairBlock.FACING, Direction.EAST);
         BlockState var11 = Blocks.SANDSTONE_STAIRS.defaultBlockState().setValue(StairBlock.FACING, Direction.WEST);
         ...
         this.generateBox(
            var1, var5, this.width - 4, 10, 1, this.width - 2, 10, 3, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
         );
         ...
         this.generateBox(
            var1, var5, 5, 4, 5, this.width - 6, 4, this.depth - 6, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
         );
         ...
         this.generateBox(
            var1, var5, this.width - 5, 1, 5, this.width - 2, 4, 11, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
         );
         this.generateBox(var1, var5, 6, 7, 9, 6, 7, 11, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false);
         this.generateBox(
            var1, var5, this.width - 7, 7, 9, this.width - 7, 7, 11, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
         );
         ...
         this.generateBox(
            var1, var5, this.width - 6, 5, 9, this.width - 6, 7, 11, Blocks.CUT_SANDSTONE.defaultBlockState(), Blocks.CUT_SANDSTONE.defaultBlockState(), false
         );
         ...
         this.generateBox(
            var1, var5, this.width - 3, 1, 3, this.width - 2, 2, 3, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
         );
         ...
         this.generateBox(
            var1, var5, this.width - 5, 3, 5, this.width - 5, 3, 17, Blocks.SANDSTONE.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), false
         );
         ...
         this.generateBox(
            var1, var5, 8, -10, 8, 12, -10, 12, Blocks.CHISELED_SANDSTONE.defaultBlockState(), Blocks.CHISELED_SANDSTONE.defaultBlockState(), false
         );
   ...
   private void addCellarStairs(BlockPos var1, WorldGenLevel var2, BoundingBox var3) {
      ...
      this.placeBlock(var2, var7.rotate(Rotation.COUNTERCLOCKWISE_90), 12, 0, 17, var3);
      ...
      this.placeBlock(var2, var8, var4 - 1, var5 + 3, var6 + 4, var3);
      this.placeBlock(var2, var8, var4, var5 + 3, var6 + 4, var3);
      this.placeBlock(var2, var8, var4 - 1, var5 + 2, var6 + 4, var3);
      this.placeBlock(var2, var10 ? var8 : var9, var4, var5 + 2, var6 + 4, var3);
      this.placeBlock(var2, var10 ? var8 : var9, var4, var5 + 1, var6 + 4, var3);
   }
   ...
   private void addCellarRoom(BlockPos var1, WorldGenLevel var2, BoundingBox var3) {
      ...
      this.placeSandBox(var3, var4 - 2, var5 + 1, var6 - 2, var4 + 2, var5 + 3, var6 + 2);
      ...
      this.placeSand(var4 + 3, var5 + 1, var6, var3);
      this.placeSand(var4 + 3, var5 + 2, var6, var3);
      ...
      this.placeSand(var4, var5 + 1, var6 + 3, var3);
      this.placeSand(var4, var5 + 2, var6 + 3, var3);
      this.placeBlock(var2, var9, var4, var5, var6 - 3, var3);
      this.placeSand(var4, var5 + 1, var6 - 3, var3);
      this.placeSand(var4, var5 + 2, var6 - 3, var3);
   ...
   private void placeSand(int var1, int var2, int var3, BoundingBox var4) {
      BlockPos.MutableBlockPos var5 = this.getWorldPos(var1, var2, var3);
      if (var4.isInside(var5)) {
         this.potentialSuspiciousSandWorldPositions.add(var5);
      }
   }

   private void placeSandBox(BoundingBox var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      for(int var8 = var3; var8 <= var6; ++var8) {
         for(int var9 = var2; var9 <= var5; ++var9) {
            for(int var10 = var4; var10 <= var7; ++var10) {
               this.placeSand(var9, var8, var10, var1);
            }
         }
      }
   }
