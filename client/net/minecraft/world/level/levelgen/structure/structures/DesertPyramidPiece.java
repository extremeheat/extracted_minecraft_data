...
public class DesertPyramidPiece extends ScatteredFeaturePiece {
   ...
   public void postProcess(final WorldGenLevel level, final StructureManager structureManager, final ChunkGenerator generator, final RandomSource random, final BoundingBox chunkBB, final ChunkPos chunkPos, final BlockPos referencePos) {
      if (this.updateHeightPositionToLowestGroundHeight(level, -random.nextInt(3))) {
         ...
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 10, 0, 7, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 10, 0, 8, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 9, 0, 9, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 11, 0, 9, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 8, 0, 10, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 12, 0, 10, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 7, 0, 10, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 13, 0, 10, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 9, 0, 11, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 11, 0, 11, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 10, 0, 12, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 10, 0, 13, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.blue()).defaultBlockState(), 10, 0, 10, chunkBB);

         for(int x = 0; x <= this.width - 1; x += this.width - 1) {
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x, 2, 1, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 2, 2, chunkBB);
            ...
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 3, 2, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x, 3, 3, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 4, 1, chunkBB);
            this.placeBlock(level, Blocks.CHISELED_SANDSTONE.defaultBlockState(), x, 4, 2, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 4, 3, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x, 5, 1, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 5, 2, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x, 5, 3, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 6, 1, chunkBB);
            this.placeBlock(level, Blocks.CHISELED_SANDSTONE.defaultBlockState(), x, 6, 2, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 6, 3, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 7, 1, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 7, 2, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 7, 3, chunkBB);
         ...
         for(int x = 2; x <= this.width - 3; x += this.width - 3 - 2) {
            ...
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 2, 0, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x + 1, 2, 0, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x - 1, 3, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 3, 0, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x + 1, 3, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x - 1, 4, 0, chunkBB);
            ...
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 5, 0, chunkBB);
            this.placeBlock(level, Blocks.CUT_SANDSTONE.defaultBlockState(), x + 1, 5, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x - 1, 6, 0, chunkBB);
            this.placeBlock(level, Blocks.CHISELED_SANDSTONE.defaultBlockState(), x, 6, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x + 1, 6, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x - 1, 7, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x, 7, 0, chunkBB);
            this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), x + 1, 7, 0, chunkBB);
         ...
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 9, 5, 0, chunkBB);
         this.placeBlock(level, Blocks.CHISELED_SANDSTONE.defaultBlockState(), 10, 5, 0, chunkBB);
         this.placeBlock(level, ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState(), 11, 5, 0, chunkBB);
   ...
   private void addCellarRoom(final BlockPos roomCenter, final WorldGenLevel level, final BoundingBox chunkBB) {
      ...
      BlockState orangeTeracotta = ((Block)Blocks.DYED_TERRACOTTA.orange()).defaultBlockState();
      BlockState blueTeracotta = ((Block)Blocks.DYED_TERRACOTTA.blue()).defaultBlockState();
