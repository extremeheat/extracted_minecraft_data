...
public class OceanMonumentPieces {
   ...
   static class FitDoubleYZRoom implements MonumentRoomFitter {
      ...
      public boolean fits(RoomDefinition var1) {
         if (var1.hasOpening[Direction.NORTH.get3DDataValue()] && !var1.connections[Direction.NORTH.get3DDataValue()].claimed && var1.hasOpening[Direction.UP.get3DDataValue()] && !var1.connections[Direction.UP.get3DDataValue()].claimed) {
            RoomDefinition var2 = var1.connections[Direction.NORTH.get3DDataValue()];
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         ...
         return new OceanMonumentDoubleYZRoom(var1, var2);
      }
   }
   ...
   static class FitDoubleXYRoom implements MonumentRoomFitter {
      ...
      public boolean fits(RoomDefinition var1) {
         if (var1.hasOpening[Direction.EAST.get3DDataValue()] && !var1.connections[Direction.EAST.get3DDataValue()].claimed && var1.hasOpening[Direction.UP.get3DDataValue()] && !var1.connections[Direction.UP.get3DDataValue()].claimed) {
            RoomDefinition var2 = var1.connections[Direction.EAST.get3DDataValue()];
            return var2.hasOpening[Direction.UP.get3DDataValue()] && !var2.connections[Direction.UP.get3DDataValue()].claimed;
         } else {
            return false;
         }
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         ...
         return new OceanMonumentDoubleXYRoom(var1, var2);
      }
   }
   ...
   static class FitDoubleZRoom implements MonumentRoomFitter {
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         ...
         return new OceanMonumentDoubleZRoom(var1, var4);
      }
   }
   ...
   private static class FitDoubleXRoom implements MonumentRoomFitter {
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         var2.claimed = true;
         var2.connections[Direction.EAST.get3DDataValue()].claimed = true;
         return new OceanMonumentDoubleXRoom(var1, var2);
      }
   }
   ...
   static class FitDoubleYRoom implements MonumentRoomFitter {
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         var2.claimed = true;
         var2.connections[Direction.UP.get3DDataValue()].claimed = true;
         return new OceanMonumentDoubleYRoom(var1, var2);
      }
   }
   ...
   private static class FitSimpleTopRoom implements MonumentRoomFitter {
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         var2.claimed = true;
         return new OceanMonumentSimpleTopRoom(var1, var2);
      }
   }
   ...
   static class FitSimpleRoom implements MonumentRoomFitter {
      ...
      public OceanMonumentPiece create(Direction var1, RoomDefinition var2, RandomSource var3) {
         var2.claimed = true;
         return new OceanMonumentSimpleRoom(var1, var2, var3);
      }
   }
   ...
   private static class RoomDefinition {
      ...
      public void setConnection(Direction var1, RoomDefinition var2) {
   ...
   public static class OceanMonumentCoreRoom extends OceanMonumentPiece {
      public OceanMonumentCoreRoom(Direction var1, RoomDefinition var2) {
   ...
   public static class OceanMonumentDoubleYZRoom extends OceanMonumentPiece {
      public OceanMonumentDoubleYZRoom(Direction var1, RoomDefinition var2) {
      ...
      public void postProcess(WorldGenLevel var1, StructureManager var2, ChunkGenerator var3, RandomSource var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         RoomDefinition var8 = this.roomDefinition.connections[Direction.NORTH.get3DDataValue()];
         RoomDefinition var9 = this.roomDefinition;
         RoomDefinition var10 = var8.connections[Direction.UP.get3DDataValue()];
         RoomDefinition var11 = var9.connections[Direction.UP.get3DDataValue()];
   ...
   public static class OceanMonumentDoubleXYRoom extends OceanMonumentPiece {
      public OceanMonumentDoubleXYRoom(Direction var1, RoomDefinition var2) {
      ...
      public void postProcess(WorldGenLevel var1, StructureManager var2, ChunkGenerator var3, RandomSource var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         RoomDefinition var8 = this.roomDefinition.connections[Direction.EAST.get3DDataValue()];
         RoomDefinition var9 = this.roomDefinition;
         RoomDefinition var10 = var9.connections[Direction.UP.get3DDataValue()];
         RoomDefinition var11 = var8.connections[Direction.UP.get3DDataValue()];
         if (this.roomDefinition.index / 25 > 0) {
   ...
   public static class OceanMonumentDoubleZRoom extends OceanMonumentPiece {
      public OceanMonumentDoubleZRoom(Direction var1, RoomDefinition var2) {
   ...
   public static class OceanMonumentDoubleXRoom extends OceanMonumentPiece {
      public OceanMonumentDoubleXRoom(Direction var1, RoomDefinition var2) {
   ...
   public static class OceanMonumentDoubleYRoom extends OceanMonumentPiece {
      public OceanMonumentDoubleYRoom(Direction var1, RoomDefinition var2) {
      ...
      public void postProcess(WorldGenLevel var1, StructureManager var2, ChunkGenerator var3, RandomSource var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         RoomDefinition var8 = this.roomDefinition.connections[Direction.UP.get3DDataValue()];
         if (var8.connections[Direction.UP.get3DDataValue()] == null) {
   ...
   public static class OceanMonumentSimpleTopRoom extends OceanMonumentPiece {
      public OceanMonumentSimpleTopRoom(Direction var1, RoomDefinition var2) {
   ...
   public static class OceanMonumentSimpleRoom extends OceanMonumentPiece {
      ...
      public OceanMonumentSimpleRoom(Direction var1, RoomDefinition var2, RandomSource var3) {
   ...
   public static class OceanMonumentEntryRoom extends OceanMonumentPiece {
      public OceanMonumentEntryRoom(Direction var1, RoomDefinition var2) {
   ...
   public static class MonumentBuilding extends OceanMonumentPiece {
      ...
      public MonumentBuilding(RandomSource var1, int var2, int var3, Direction var4) {
         ...
         this.childPieces.add(new OceanMonumentEntryRoom(var4, this.sourceRoom));
         this.childPieces.add(new OceanMonumentCoreRoom(var4, this.coreRoom));
         ArrayList var6 = Lists.newArrayList();
         var6.add(new FitDoubleXYRoom());
         var6.add(new FitDoubleYZRoom());
         var6.add(new FitDoubleZRoom());
         var6.add(new FitDoubleXRoom());
         var6.add(new FitDoubleYRoom());
         var6.add(new FitSimpleTopRoom());
         var6.add(new FitSimpleRoom());
         ...
         while(true) {
            while(true) {
               ...
               do {
                  do {
                     if (!var7.hasNext()) {
                        ...
                        while(var13.hasNext()) {
                           OceanMonumentPiece var15 = (OceanMonumentPiece)var13.next();
                        ...
                        this.childPieces.add(new OceanMonumentWingRoom(var4, var14, var11++));
                        this.childPieces.add(new OceanMonumentWingRoom(var4, var16, var11++));
                        this.childPieces.add(new OceanMonumentPenthouse(var4, var17));
                        return;
                     }

                     var8 = (RoomDefinition)var7.next();
                  } while(var8.claimed);
               ...
               while(var9.hasNext()) {
                  MonumentRoomFitter var10 = (MonumentRoomFitter)var9.next();
                  if (var10.fits(var8)) {
      ...
      private List<RoomDefinition> generateRoomGraph(RandomSource var1) {
         RoomDefinition[] var2 = new RoomDefinition[75];
         ...
         RoomDefinition var15 = new RoomDefinition(1003);
         RoomDefinition var17 = new RoomDefinition(1001);
         RoomDefinition var18 = new RoomDefinition(1002);
         ...
         RoomDefinition[] var20 = var2;
         var8 = var2.length;

         for(var9 = 0; var9 < var8; ++var9) {
            RoomDefinition var23 = var20[var9];
            if (var23 != null) {
         ...
         Util.shuffle(var19, var1);
         int var21 = 1;
         ObjectListIterator var22 = var19.iterator();

         label95:
         while(var22.hasNext()) {
            RoomDefinition var24 = (RoomDefinition)var22.next();
            int var25 = 0;
            var11 = 0;
      ...
      public void postProcess(WorldGenLevel var1, StructureManager var2, ChunkGenerator var3, RandomSource var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         while(var15.hasNext()) {
            OceanMonumentPiece var16 = (OceanMonumentPiece)var15.next();
   ...
   protected abstract static class OceanMonumentPiece extends StructurePiece {
      ...
      protected OceanMonumentPiece(StructurePieceType var1, int var2, Direction var3, RoomDefinition var4, int var5, int var6, int var7) {
      ...
      protected void spawnElder(WorldGenLevel var1, BoundingBox var2, int var3, int var4, int var5) {
         ...
         if (var2.isInside(var6)) {
            ElderGuardian var7 = (ElderGuardian)EntityType.ELDER_GUARDIAN.create(var1.getLevel(), EntitySpawnReason.STRUCTURE);
            if (var7 != null) {
               var7.heal(var7.getMaxHealth());
               var7.moveTo((double)((BlockPos)var6).getX() + 0.5, (double)((BlockPos)var6).getY(), (double)((BlockPos)var6).getZ() + 0.5, 0.0F, 0.0F);
               var7.finalizeSpawn(var1, var1.getCurrentDifficultyAt(var7.blockPosition()), EntitySpawnReason.STRUCTURE, (SpawnGroupData)null);
