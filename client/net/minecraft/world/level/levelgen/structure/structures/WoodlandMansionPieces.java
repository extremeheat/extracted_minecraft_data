...
public class WoodlandMansionPieces {
   ...
   public static void main(String[] var0) {
      ...
      var1.setSeed(var2);
      MansionGrid var4 = new MansionGrid(var1);
      var4.print();
   }
   ...
   private static class MansionGrid {
      ...
      private void identifyRooms(SimpleGrid var1, SimpleGrid var2) {
         ...
         var4 = 10;
         ObjectListIterator var19 = var3.iterator();
      ...
      public void print() {
         for(int var1 = 0; var1 < 2; ++var1) {
            SimpleGrid var2 = var1 == 0 ? this.baseGrid : this.thirdFloorGrid;
   ...
   static class MansionPiecePlacer {
      ...
      public void createMansion(BlockPos var1, Rotation var2, List<WoodlandMansionPiece> var3, MansionGrid var4) {
         ...
         for(var14 = 0; var14 < 3; ++var14) {
            ...
            SimpleGrid var16 = var4.floorRooms[var14];
            SimpleGrid var17 = var14 == 2 ? var8 : var7;
               ...
               for(int var24 = 0; var24 < var17.width; ++var24) {
                  ...
                  if (var17.get(var24, var23) == 2 || var25) {
                     ...
                     if (WoodlandMansionPieces.MansionGrid.isHouse(var17, var24 - 1, var23) && !var4.isRoomId(var17, var24 - 1, var23, var14, var28)) {
                        var3.add(new WoodlandMansionPiece(this.structureTemplateManager, var37 == Direction.WEST ? var35 : var34, var38, var2));
                     }

                     BlockPos var31;
                     if (var17.get(var24 + 1, var23) == 1 && !var25) {
                        var31 = var38.relative((Direction)var2.rotate(Direction.EAST), 8);
                        var3.add(new WoodlandMansionPiece(this.structureTemplateManager, var37 == Direction.EAST ? var35 : var34, var31, var2));
                     }
                     ...
                     if (WoodlandMansionPieces.MansionGrid.isHouse(var17, var24, var23 + 1) && !var4.isRoomId(var17, var24, var23 + 1, var14, var28)) {
                        ...
                        var3.add(new WoodlandMansionPiece(this.structureTemplateManager, var37 == Direction.SOUTH ? var35 : var34, var31, var2.getRotated(Rotation.CLOCKWISE_90)));
                     }

                     if (var17.get(var24, var23 - 1) == 1 && !var25) {
                        var31 = var38.relative((Direction)var2.rotate(Direction.NORTH), 1);
                        var31 = var31.relative((Direction)var2.rotate(Direction.EAST), 7);
                        var3.add(new WoodlandMansionPiece(this.structureTemplateManager, var37 == Direction.NORTH ? var35 : var34, var31, var2.getRotated(Rotation.CLOCKWISE_90)));
                     }
            ...
            for(var7 = 0; var7 < var4.width; ++var7) {
               ...
               if (WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6) && !var9) {
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 - 1, var6)) {
                     ...
                     var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_front", var10, var3.getRotated(Rotation.CLOCKWISE_180)));
                  }

                  if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 - 1)) {
                     var10 = var8.relative((Direction)var3.rotate(Direction.WEST), 1);
                     var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_front", var10, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                  }

                  if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 + 1)) {
                     var10 = var8.relative((Direction)var3.rotate(Direction.EAST), 6);
                     var10 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 6);
                     var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_front", var10, var3.getRotated(Rotation.CLOCKWISE_90)));
                  }
               }
            }
         }
               ...
               for(var7 = 0; var7 < var4.width; ++var7) {
                  ...
                  if (WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6) && var9) {
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 + 1, var6)) {
                        ...
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall", var10, var3));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 - 1, var6)) {
                        var10 = var8.relative((Direction)var3.rotate(Direction.WEST), 1);
                        var10 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 6);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall", var10, var3.getRotated(Rotation.CLOCKWISE_180)));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 - 1)) {
                        var10 = var8.relative((Direction)var3.rotate(Direction.WEST), 0);
                        var10 = var10.relative((Direction)var3.rotate(Direction.NORTH), 1);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall", var10, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 + 1)) {
                        var10 = var8.relative((Direction)var3.rotate(Direction.EAST), 6);
                        var10 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 7);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall", var10, var3.getRotated(Rotation.CLOCKWISE_90)));
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 + 1, var6)) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 - 1)) {
                           ...
                           var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", var10, var3));
                        }

                        if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 + 1)) {
                           var10 = var8.relative((Direction)var3.rotate(Direction.EAST), 8);
                           var10 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 7);
                           var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", var10, var3.getRotated(Rotation.CLOCKWISE_90)));
                        }
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 - 1, var6)) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 - 1)) {
                           ...
                           var10 = var10.relative((Direction)var3.rotate(Direction.NORTH), 1);
                           var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", var10, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                        }

                        if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 + 1)) {
                           var10 = var8.relative((Direction)var3.rotate(Direction.WEST), 1);
                           var10 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 8);
                           var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", var10, var3.getRotated(Rotation.CLOCKWISE_180)));
                        }
                     }
                  }
               }
               ...
               if (WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6) && !var9) {
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 + 1, var6)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 + 1)) {
                        ...
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", var11, var3));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 - 1)) {
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", var10, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 + 1, var6 - 1)) {
                        var11 = var8.relative((Direction)var3.rotate(Direction.EAST), 9);
                        var11 = var11.relative((Direction)var3.rotate(Direction.NORTH), 2);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", var11, var3.getRotated(Rotation.CLOCKWISE_90)));
                     }
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 - 1, var6)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 + 1)) {
                        var11 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 6);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", var11, var3.getRotated(Rotation.CLOCKWISE_90)));
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 - 1, var6 + 1)) {
                        var11 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 8);
                        var11 = var11.relative((Direction)var3.rotate(Direction.WEST), 3);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", var11, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(var4, var7, var6 - 1)) {
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", var10, var3.getRotated(Rotation.CLOCKWISE_180)));
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(var4, var7 - 1, var6 - 1)) {
                        var11 = var10.relative((Direction)var3.rotate(Direction.SOUTH), 1);
                        var1.add(new WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", var11, var3.getRotated(Rotation.CLOCKWISE_180)));
                     }
                  }
               }
            }
      ...
      private void addRoom1x2(List<WoodlandMansionPiece> var1, BlockPos var2, Rotation var3, Direction var4, Direction var5, FloorRoomCollection var6, boolean var7) {
         ...
         if (var5 == Direction.EAST && var4 == Direction.SOUTH) {
            ...
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3));
         } else if (var5 == Direction.EAST && var4 == Direction.NORTH) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 1);
            var8 = var8.relative((Direction)var3.rotate(Direction.SOUTH), 6);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3, Mirror.LEFT_RIGHT));
         } else if (var5 == Direction.WEST && var4 == Direction.NORTH) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 7);
            var8 = var8.relative((Direction)var3.rotate(Direction.SOUTH), 6);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3.getRotated(Rotation.CLOCKWISE_180)));
         } else if (var5 == Direction.WEST && var4 == Direction.SOUTH) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 7);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3, Mirror.FRONT_BACK));
         } else if (var5 == Direction.SOUTH && var4 == Direction.EAST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 1);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3.getRotated(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
         } else if (var5 == Direction.SOUTH && var4 == Direction.WEST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 7);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3.getRotated(Rotation.CLOCKWISE_90)));
         } else if (var5 == Direction.NORTH && var4 == Direction.WEST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 7);
            var8 = var8.relative((Direction)var3.rotate(Direction.SOUTH), 6);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3.getRotated(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
         } else if (var5 == Direction.NORTH && var4 == Direction.EAST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 1);
            var8 = var8.relative((Direction)var3.rotate(Direction.SOUTH), 6);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2SideEntrance(this.random, var7), var8, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
         } else if (var5 == Direction.SOUTH && var4 == Direction.NORTH) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 1);
            var8 = var8.relative((Direction)var3.rotate(Direction.NORTH), 8);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2FrontEntrance(this.random, var7), var8, var3));
         } else if (var5 == Direction.NORTH && var4 == Direction.SOUTH) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 7);
            var8 = var8.relative((Direction)var3.rotate(Direction.SOUTH), 14);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2FrontEntrance(this.random, var7), var8, var3.getRotated(Rotation.CLOCKWISE_180)));
         } else if (var5 == Direction.WEST && var4 == Direction.EAST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 15);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2FrontEntrance(this.random, var7), var8, var3.getRotated(Rotation.CLOCKWISE_90)));
         } else if (var5 == Direction.EAST && var4 == Direction.WEST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.WEST), 7);
            var8 = var8.relative((Direction)var3.rotate(Direction.SOUTH), 6);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2FrontEntrance(this.random, var7), var8, var3.getRotated(Rotation.COUNTERCLOCKWISE_90)));
         } else if (var5 == Direction.UP && var4 == Direction.EAST) {
            var8 = var2.relative((Direction)var3.rotate(Direction.EAST), 15);
            var1.add(new WoodlandMansionPiece(this.structureTemplateManager, var6.get1x2Secret(this.random), var8, var3.getRotated(Rotation.CLOCKWISE_90)));
   ...
   public static class WoodlandMansionPiece extends TemplateStructurePiece {
      ...
      protected void handleDataMarker(String var1, BlockPos var2, ServerLevelAccessor var3, RandomSource var4, BoundingBox var5) {
         if (var1.startsWith("Chest")) {
            ...
            while(var7.hasNext()) {
               Mob var13 = (Mob)var7.next();
               var13.setPersistenceRequired();
               var13.moveTo(var2, 0.0F, 0.0F);
               var13.finalizeSpawn(var3, var3.getCurrentDifficultyAt(var13.blockPosition()), MobSpawnType.STRUCTURE, (SpawnGroupData)null, (CompoundTag)null);
