...
public class OceanMonumentPieces {
   ...
   private static class FitDoubleYZRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public boolean fits(OceanMonumentPieces.RoomDefinition var1) {
         if (var1.hasOpening[Direction.NORTH.get3DDataValue()] && !var1.connections[Direction.NORTH.get3DDataValue()].claimed && var1.hasOpening[Direction.field_526.get3DDataValue()] && !var1.connections[Direction.field_526.get3DDataValue()].claimed) {
            OceanMonumentPieces.RoomDefinition var2 = var1.connections[Direction.NORTH.get3DDataValue()];
            return var2.hasOpening[Direction.field_526.get3DDataValue()] && !var2.connections[Direction.field_526.get3DDataValue()].claimed;
         } else {
            return false;
         }
      }
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction var1, OceanMonumentPieces.RoomDefinition var2, Random var3) {
         ...
         var2.connections[Direction.field_526.get3DDataValue()].claimed = true;
         var2.connections[Direction.NORTH.get3DDataValue()].connections[Direction.field_526.get3DDataValue()].claimed = true;
   ...
   private static class FitDoubleXYRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public boolean fits(OceanMonumentPieces.RoomDefinition var1) {
         if (var1.hasOpening[Direction.EAST.get3DDataValue()] && !var1.connections[Direction.EAST.get3DDataValue()].claimed && var1.hasOpening[Direction.field_526.get3DDataValue()] && !var1.connections[Direction.field_526.get3DDataValue()].claimed) {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction var1, OceanMonumentPieces.RoomDefinition var2, Random var3) {
         ...
         var2.connections[Direction.field_526.get3DDataValue()].claimed = true;
         var2.connections[Direction.EAST.get3DDataValue()].connections[Direction.field_526.get3DDataValue()].claimed = true;
   ...
   private static class FitDoubleYRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public boolean fits(OceanMonumentPieces.RoomDefinition var1) {
         return var1.hasOpening[Direction.field_526.get3DDataValue()] && !var1.connections[Direction.field_526.get3DDataValue()].claimed;
      }
   ...
   private static class FitSimpleTopRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public boolean fits(OceanMonumentPieces.RoomDefinition var1) {
         return !var1.hasOpening[Direction.WEST.get3DDataValue()] && !var1.hasOpening[Direction.EAST.get3DDataValue()] && !var1.hasOpening[Direction.NORTH.get3DDataValue()] && !var1.hasOpening[Direction.SOUTH.get3DDataValue()] && !var1.hasOpening[Direction.field_526.get3DDataValue()];
      }
   ...
   public static class OceanMonumentDoubleYZRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         OceanMonumentPieces.RoomDefinition var10 = var8.connections[Direction.field_526.get3DDataValue()];
         OceanMonumentPieces.RoomDefinition var11 = var9.connections[Direction.field_526.get3DDataValue()];
         ...
         if (var11.connections[Direction.field_526.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(var1, var5, 1, 8, 1, 6, 8, 7, BASE_GRAY);
         }

         if (var10.connections[Direction.field_526.get3DDataValue()] == null) {
   ...
   public static class OceanMonumentDoubleXYRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         OceanMonumentPieces.RoomDefinition var9 = this.roomDefinition;
         OceanMonumentPieces.RoomDefinition var10 = var9.connections[Direction.field_526.get3DDataValue()];
         OceanMonumentPieces.RoomDefinition var11 = var8.connections[Direction.field_526.get3DDataValue()];
         if (this.roomDefinition.index / 25 > 0) {
   ...
   public static class OceanMonumentDoubleZRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         if (var9.connections[Direction.field_526.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(var1, var5, 1, 4, 1, 6, 4, 7, BASE_GRAY);
         }

         if (var8.connections[Direction.field_526.get3DDataValue()] == null) {
   ...
   public static class OceanMonumentDoubleYRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         OceanMonumentPieces.RoomDefinition var8 = this.roomDefinition.connections[Direction.field_526.get3DDataValue()];
         if (var8.connections[Direction.field_526.get3DDataValue()] == null) {
   ...
   public static class OceanMonumentSimpleTopRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         if (this.roomDefinition.connections[Direction.field_526.get3DDataValue()] == null) {
   ...
   public static class OceanMonumentSimpleRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public void postProcess(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6, BlockPos var7) {
         ...
         boolean var8 = this.mainDesign != 0 && var4.nextBoolean() && !this.roomDefinition.hasOpening[Direction.DOWN.get3DDataValue()] && !this.roomDefinition.hasOpening[Direction.field_526.get3DDataValue()] && this.roomDefinition.countOpenings() > 1;
         if (this.mainDesign == 0) {
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      private List<OceanMonumentPieces.RoomDefinition> generateRoomGraph(Random var1) {
         ...
         var2[GRIDROOM_TOP_CONNECT_INDEX].setConnection(Direction.field_526, var15);
         ...
         this.coreRoom.connections[Direction.field_526.get3DDataValue()].claimed = true;
         this.coreRoom.connections[Direction.EAST.get3DDataValue()].connections[Direction.field_526.get3DDataValue()].claimed = true;
         this.coreRoom.connections[Direction.NORTH.get3DDataValue()].connections[Direction.field_526.get3DDataValue()].claimed = true;
         this.coreRoom.connections[Direction.EAST.get3DDataValue()].connections[Direction.NORTH.get3DDataValue()].connections[Direction.field_526.get3DDataValue()].claimed = true;
