...
public class LegacyStructureDataHandler {
   ...
   public CompoundTag updateFromLegacy(CompoundTag var1) {
      ...
      if (this.isUnhandledStructureStart(var3.field_504, var3.field_505)) {
      ...
      while(true) {
         ...
         for(int var11 = var3.field_504 - 8; var11 <= var3.field_504 + 8; ++var11) {
            for(int var12 = var3.field_505 - 8; var12 <= var3.field_505 + 8; ++var12) {
