...
public abstract class StructurePlacement {
   ...
   public boolean isStructureChunk(ChunkGenerator var1, RandomState var2, long var3, int var5, int var6) {
      if (!this.isPlacementChunk(var1, var2, var3, var5, var6)) {
         ...
         return !this.exclusionZone.isPresent() || !((ExclusionZone)this.exclusionZone.get()).isPlacementForbidden(var1, var2, var3, var5, var6);
      }
   }
   ...
   static {
      CODEC = Registry.STRUCTURE_PLACEMENT_TYPE.byNameCodec().dispatch(StructurePlacement::type, StructurePlacementType::codec);
   }
   ...
   public static enum FrequencyReductionMethod implements StringRepresentable {
      ...
      private FrequencyReductionMethod(String var3, FrequencyReducer var4) {
         this.name = var3;
         this.reducer = var4;
      }
   ...
   public static record ExclusionZone(Holder<StructureSet> b, int c) {
      ...
      public static final Codec<ExclusionZone> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(RegistryFileCodec.create(Registry.STRUCTURE_SET_REGISTRY, StructureSet.DIRECT_CODEC, false).fieldOf("other_set").forGetter(ExclusionZone::otherSet), Codec.intRange(1, 16).fieldOf("chunk_count").forGetter(ExclusionZone::chunkCount)).apply(var0, ExclusionZone::new);
      });
