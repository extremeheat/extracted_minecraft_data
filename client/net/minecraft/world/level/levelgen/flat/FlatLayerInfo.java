...
public class FlatLayerInfo {
   public static final Codec<FlatLayerInfo> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(Codec.intRange(0, DimensionType.Y_SIZE).fieldOf("height").forGetter(FlatLayerInfo::getHeight), Registry.BLOCK.byNameCodec().fieldOf("block").orElse(Blocks.AIR).forGetter((var0x) -> {
