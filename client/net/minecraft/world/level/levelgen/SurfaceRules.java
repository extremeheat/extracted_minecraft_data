...
public class SurfaceRules {
   ...
   public static ConditionSource verticalGradient(String var0, VerticalAnchor var1, VerticalAnchor var2) {
      return new VerticalGradientConditionSource(new ResourceLocation(var0), var1, var2);
   }
   ...
   private static record StoneDepthCheck(int a, boolean c, int d, CaveSurface e) implements ConditionSource {
      final int offset;
   ...
   static record NotConditionSource(ConditionSource a) implements ConditionSource {
   ...
   public interface ConditionSource extends Function<Context, Condition> {
      Codec<ConditionSource> CODEC = Registry.CONDITION.byNameCodec().dispatch((var0) -> {
         return var0.codec().codec();
      }, Function.identity());

      static Codec<? extends ConditionSource> bootstrap(Registry<Codec<? extends ConditionSource>> var0) {
   ...
   private static record YConditionSource(VerticalAnchor a, int c, boolean d) implements ConditionSource {
   ...
   private static record WaterConditionSource(int a, int c, boolean d) implements ConditionSource {
      final int offset;
      final int surfaceDepthMultiplier;
      final boolean addStoneDepth;
   ...
   static final class BiomeConditionSource implements ConditionSource {
      ...
      static {
         CODEC = KeyDispatchDataCodec.of(ResourceKey.codec(Registry.BIOME_REGISTRY).listOf().fieldOf("biome_is").xmap(SurfaceRules::isBiome, (var0) -> {
            return var0.biomes;
         }));
      }
   }

   private static record NoiseThresholdConditionSource(ResourceKey<NormalNoise.NoiseParameters> a, double c, double d) implements ConditionSource {
      ...
      static final KeyDispatchDataCodec<NoiseThresholdConditionSource> CODEC = KeyDispatchDataCodec.of(RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(ResourceKey.codec(Registry.NOISE_REGISTRY).fieldOf("noise").forGetter(NoiseThresholdConditionSource::noise), Codec.DOUBLE.fieldOf("min_threshold").forGetter(NoiseThresholdConditionSource::minThreshold), Codec.DOUBLE.fieldOf("max_threshold").forGetter(NoiseThresholdConditionSource::maxThreshold)).apply(var0, NoiseThresholdConditionSource::new);
      }));
   ...
   static record VerticalGradientConditionSource(ResourceLocation a, VerticalAnchor c, VerticalAnchor d) implements ConditionSource {
   ...
   private static record TestRuleSource(ConditionSource a, RuleSource c) implements RuleSource {
   ...
   public interface RuleSource extends Function<Context, SurfaceRule> {
      Codec<RuleSource> CODEC = Registry.RULE.byNameCodec().dispatch((var0) -> {
         return var0.codec().codec();
      }, Function.identity());

      static Codec<? extends RuleSource> bootstrap(Registry<Codec<? extends RuleSource>> var0) {
   ...
   private static record SequenceRuleSource(List<RuleSource> a) implements RuleSource {
   ...
   static record BlockRuleSource(BlockState a, StateRule c) implements RuleSource {
   ...
   private static record SequenceRule(List<SurfaceRule> a) implements SurfaceRule {
   ...
   private static record TestRule(Condition a, SurfaceRule b) implements SurfaceRule {
   ...
   static record StateRule(BlockState a) implements SurfaceRule {
   ...
   private static record NotCondition(Condition a) implements Condition {
