...
public class MatchingFluidsPredicate extends StateTestingPredicate {
   public static final MapCodec<MatchingFluidsPredicate> CODEC = RecordCodecBuilder.mapCodec((i) -> stateTestingCodec(i).and(RegistryCodecs.holderSet(Registries.FLUID).fieldOf("fluids").forGetter((c) -> c.fluids)).apply(i, MatchingFluidsPredicate::new));
