...
public class DataPackConfig {
   ...
   public static final Codec<DataPackConfig> CODEC = RecordCodecBuilder.create((var0) -> var0.group(Codec.STRING.listOf().fieldOf("Enabled").forGetter((var0x) -> var0x.enabled), Codec.STRING.listOf().fieldOf("Disabled").forGetter((var0x) -> var0x.disabled)).apply(var0, DataPackConfig::new));
