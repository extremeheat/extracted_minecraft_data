...
public class ChunkStatus {
   ...
   private static ChunkStatus registerSimple(String var0, @Nullable ChunkStatus var1, int var2, EnumSet<Heightmap.Types> var3, ChunkType var4, SimpleGenerationTask var5) {
      return register(var0, var1, var2, var3, var4, var5);
   }

   private static ChunkStatus register(String var0, @Nullable ChunkStatus var1, int var2, EnumSet<Heightmap.Types> var3, ChunkType var4, GenerationTask var5) {
      return register(var0, var1, var2, var3, var4, var5, PASSTHROUGH_LOAD_TASK);
   }

   private static ChunkStatus register(String var0, @Nullable ChunkStatus var1, int var2, EnumSet<Heightmap.Types> var3, ChunkType var4, GenerationTask var5, LoadingTask var6) {
   ...
   ChunkStatus(String var1, @Nullable ChunkStatus var2, int var3, EnumSet<Heightmap.Types> var4, ChunkType var5, GenerationTask var6, LoadingTask var7) {
      super();
      this.name = var1;
   ...
   public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> generate(Executor var1, ServerLevel var2, ChunkGenerator var3, StructureTemplateManager var4, ThreadedLevelLightEngine var5, Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> var6, List<ChunkAccess> var7, boolean var8) {
   ...
   static {
      ...
      BIOMES = register("biomes", STRUCTURE_REFERENCES, 8, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3, var4, var5, var6, var7, var8, var9) -> {
         if (!var9 && var8.getStatus().isOrAfter(var0)) {
            ...
            return var3.createBiomes(var2.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY), var1, var2.getChunkSource().randomState(), Blender.of(var10), var2.structureManager().forWorldGenRegion(var10), var8).thenApply((var1x) -> {
      ...
      NOISE = register("noise", BIOMES, 8, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3, var4, var5, var6, var7, var8, var9) -> {
         if (!var9 && var8.getStatus().isOrAfter(var0)) {
            ...
            return var3.fillFromNoise(var1, Blender.of(var10), var2.getChunkSource().randomState(), var2.structureManager().forWorldGenRegion(var10), var8).thenApply((var1x) -> {
               if (var1x instanceof ProtoChunk var2) {
      ...
      FEATURES = register("features", LIQUID_CARVERS, 8, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3, var4, var5, var6, var7, var8, var9) -> {
         ...
         return var3.retainData(var5).thenApply(Either::left);
      });
   ...
   private interface GenerationTask {
      CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> doWork(ChunkStatus var1, Executor var2, ServerLevel var3, ChunkGenerator var4, StructureTemplateManager var5, ThreadedLevelLightEngine var6, Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> var7, List<ChunkAccess> var8, ChunkAccess var9, boolean var10);
   }
   ...
   private interface SimpleGenerationTask extends GenerationTask {
      default CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> doWork(ChunkStatus var1, Executor var2, ServerLevel var3, ChunkGenerator var4, StructureTemplateManager var5, ThreadedLevelLightEngine var6, Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> var7, List<ChunkAccess> var8, ChunkAccess var9, boolean var10) {
         if (var10 || !var9.getStatus().isOrAfter(var1)) {
            this.doWork(var1, var3, var4, var8, var9);
            if (var9 instanceof ProtoChunk) {
               ProtoChunk var11 = (ProtoChunk)var9;
