...
public final class Material {
   ...
   public static final Material REPLACEABLE_PLANT = new Material.Builder(MaterialColor.PLANT)
      .noCollider()
      .notSolidBlocking()
      .nonSolid()
      .destroyOnPush()
   ...
   public static final Material BUBBLE_COLUMN = new Material.Builder(MaterialColor.WATER)
      ...
      .liquid()
      .build();
   public static final Material LAVA = new Material.Builder(MaterialColor.FIRE)
      .noCollider()
      .notSolidBlocking()
      .nonSolid()
      .destroyOnPush()
      ...
      .liquid()
      .build();
   public static final Material TOP_SNOW = new Material.Builder(MaterialColor.SNOW)
      .noCollider()
      .notSolidBlocking()
      .nonSolid()
      .destroyOnPush()
