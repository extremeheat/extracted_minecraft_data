...
public class MaterialColor {
   ...
   public int calculateRGBColor(MaterialColor.Brightness var1) {
      if (this == NONE) {
         return 0;
      } else {
   ...
   public byte getPackedId(MaterialColor.Brightness var1) {
      return (byte)(this.field_244 << 2 | var1.field_409 & 3);
   }
   ...
   public static enum Brightness {
      ...
      // $FF: synthetic method
      private static MaterialColor.Brightness[] $values() {
         return new MaterialColor.Brightness[]{LOW, NORMAL, HIGH, LOWEST};
      }
   }
}
