...
public interface ChangeOverTimeBlock<T extends Enum<T>> {
   ...
   default void onRandomTick(BlockState var1, ServerLevel var2, BlockPos var3, RandomSource var4) {
   ...
   default void applyChangeOverTime(BlockState var1, ServerLevel var2, BlockPos var3, RandomSource var4) {
      ...
      if (var4.nextFloat() < var16) {
         this.getNext(var1).ifPresent(var2x -> var2.setBlockAndUpdate(var3, var2x));
      }
   }
}
