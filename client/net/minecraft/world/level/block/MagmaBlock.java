...
public class MagmaBlock extends Block {
   ...
   public void randomTick(BlockState var1, Level var2, BlockPos var3, Random var4) {
      ...
      if (var2.getFluidState(var3).is(FluidTags.WATER)) {
         var2.playSound((Player)null, (BlockPos)var3, SoundEvents.FIRE_EXTINGUISH, SoundSource.BLOCKS, 0.5F, 2.6F + (var2.random.nextFloat() - var2.random.nextFloat()) * 0.8F);
         if (var2 instanceof ServerLevel) {
            ((ServerLevel)var2).sendParticles(ParticleTypes.LARGE_SMOKE, (double)var5.getX() + 0.5D, (double)var5.getY() + 0.25D, (double)var5.getZ() + 0.5D, 8, 0.5D, 0.25D, 0.5D, 0.0D);
         }
      }
