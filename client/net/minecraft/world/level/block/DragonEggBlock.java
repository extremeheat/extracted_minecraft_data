         ...
         if (var2.getBlockState(var6).isAir() && var4.isWithinBounds(var6)) {
            if (var2.isClientSide) {
               for(int var7 = 0; var7 < 128; ++var7) {
                  ...
                  double var13 = Mth.lerp(var8, (double)var6.getX(), (double)var3.getX()) + (var2.random.nextDouble() - 0.5D) + 0.5D;
                  double var15 = Mth.lerp(var8, (double)var6.getY(), (double)var3.getY()) + var2.random.nextDouble() - 0.5D;
                  double var17 = Mth.lerp(var8, (double)var6.getZ(), (double)var3.getZ()) + (var2.random.nextDouble() - 0.5D) + 0.5D;
