...
public class PistonStructureResolver {
      ...
      if (var3.isAir()) {
         ...
         if (var5 + this.toPush.size() > 12) {
            ...
            for(var7 = var5 - 1; var7 >= 0; --var7) {
               this.toPush.add(var1.relative(this.pushDirection.getOpposite(), var7));
               ++var12;
            }
            ...
            while(true) {
               BlockPos var8 = var1.relative(this.pushDirection, var7);
   ...
   private boolean addBranchingBlocks(BlockPos var1) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         if (var5.getAxis() != this.pushDirection.getAxis() && !this.addBlockLine(var1.relative(var5), var5)) {
            return false;
         }
      }
