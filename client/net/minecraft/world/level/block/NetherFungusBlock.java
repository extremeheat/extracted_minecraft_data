...
public class NetherFungusBlock extends VegetationBlock implements BonemealableBlock {
   ...
   protected NetherFungusBlock(final ResourceKey<ConfiguredFeature<?, ?>> feature, final Block requiredBlock, final TagKey<Block> supportBlocks, final BlockBehaviour.Properties properties) {
      super(properties);
