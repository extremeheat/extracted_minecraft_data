...
public class SoundType {
   public static final SoundType EMPTY;
   ...
   public static final SoundType TUFF_BRICKS;
   public static final SoundType POLISHED_TUFF;
   ...
   public static final SoundType PINK_PETALS;
   public static final SoundType LEAF_LITTER;
   ...
   public static final SoundType HANGING_SIGN;
   public static final SoundType NETHER_WOOD_HANGING_SIGN;
   public static final SoundType BAMBOO_WOOD_HANGING_SIGN;
   public static final SoundType BAMBOO_WOOD;
   public static final SoundType NETHER_WOOD;
   public static final SoundType CHERRY_WOOD;
   public static final SoundType CHERRY_SAPLING;
   ...
   public static final SoundType DECORATED_POT_CRACKED;
   public static final SoundType TRIAL_SPAWNER;
   ...
   public SoundType(final float volume, final float pitch, final SoundEvent breakSound, final SoundEvent stepSound, final SoundEvent placeSound, final SoundEvent hitSound, final SoundEvent fallSound) {
      super();
      this.volume = volume;
      this.pitch = pitch;
   ...
   static {
      EMPTY = new SoundType(1.0F, 1.0F, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.EMPTY);
      ...
      LILY_PAD = new SoundType(1.0F, 1.0F, SoundEvents.BIG_DRIPLEAF_BREAK, SoundEvents.BIG_DRIPLEAF_STEP, SoundEvents.LILY_PAD_PLACE, SoundEvents.BIG_DRIPLEAF_HIT, SoundEvents.BIG_DRIPLEAF_FALL);
      ...
      TUFF_BRICKS = new SoundType(1.0F, 1.0F, SoundEvents.TUFF_BRICKS_BREAK, SoundEvents.TUFF_BRICKS_STEP, SoundEvents.TUFF_BRICKS_PLACE, SoundEvents.TUFF_BRICKS_HIT, SoundEvents.TUFF_BRICKS_FALL);
      POLISHED_TUFF = new SoundType(1.0F, 1.0F, SoundEvents.POLISHED_TUFF_BREAK, SoundEvents.POLISHED_TUFF_STEP, SoundEvents.POLISHED_TUFF_PLACE, SoundEvents.POLISHED_TUFF_HIT, SoundEvents.POLISHED_TUFF_FALL);
      ...
      PINK_PETALS = new SoundType(1.0F, 1.0F, SoundEvents.PINK_PETALS_BREAK, SoundEvents.PINK_PETALS_STEP, SoundEvents.PINK_PETALS_PLACE, SoundEvents.PINK_PETALS_HIT, SoundEvents.PINK_PETALS_FALL);
      LEAF_LITTER = new SoundType(1.0F, 1.0F, SoundEvents.LEAF_LITTER_BREAK, SoundEvents.LEAF_LITTER_STEP, SoundEvents.LEAF_LITTER_PLACE, SoundEvents.LEAF_LITTER_HIT, SoundEvents.LEAF_LITTER_FALL);
      ...
      HANGING_SIGN = new SoundType(1.0F, 1.0F, SoundEvents.HANGING_SIGN_BREAK, SoundEvents.HANGING_SIGN_STEP, SoundEvents.HANGING_SIGN_PLACE, SoundEvents.HANGING_SIGN_HIT, SoundEvents.HANGING_SIGN_FALL);
      NETHER_WOOD_HANGING_SIGN = new SoundType(1.0F, 1.0F, SoundEvents.NETHER_WOOD_HANGING_SIGN_BREAK, SoundEvents.NETHER_WOOD_HANGING_SIGN_STEP, SoundEvents.NETHER_WOOD_HANGING_SIGN_PLACE, SoundEvents.NETHER_WOOD_HANGING_SIGN_HIT, SoundEvents.NETHER_WOOD_HANGING_SIGN_FALL);
      BAMBOO_WOOD_HANGING_SIGN = new SoundType(1.0F, 1.0F, SoundEvents.BAMBOO_WOOD_HANGING_SIGN_BREAK, SoundEvents.BAMBOO_WOOD_HANGING_SIGN_STEP, SoundEvents.BAMBOO_WOOD_HANGING_SIGN_PLACE, SoundEvents.BAMBOO_WOOD_HANGING_SIGN_HIT, SoundEvents.BAMBOO_WOOD_HANGING_SIGN_FALL);
      BAMBOO_WOOD = new SoundType(1.0F, 1.0F, SoundEvents.BAMBOO_WOOD_BREAK, SoundEvents.BAMBOO_WOOD_STEP, SoundEvents.BAMBOO_WOOD_PLACE, SoundEvents.BAMBOO_WOOD_HIT, SoundEvents.BAMBOO_WOOD_FALL);
      NETHER_WOOD = new SoundType(1.0F, 1.0F, SoundEvents.NETHER_WOOD_BREAK, SoundEvents.NETHER_WOOD_STEP, SoundEvents.NETHER_WOOD_PLACE, SoundEvents.NETHER_WOOD_HIT, SoundEvents.NETHER_WOOD_FALL);
      CHERRY_WOOD = new SoundType(1.0F, 1.0F, SoundEvents.CHERRY_WOOD_BREAK, SoundEvents.CHERRY_WOOD_STEP, SoundEvents.CHERRY_WOOD_PLACE, SoundEvents.CHERRY_WOOD_HIT, SoundEvents.CHERRY_WOOD_FALL);
      CHERRY_SAPLING = new SoundType(1.0F, 1.0F, SoundEvents.CHERRY_SAPLING_BREAK, SoundEvents.CHERRY_SAPLING_STEP, SoundEvents.CHERRY_SAPLING_PLACE, SoundEvents.CHERRY_SAPLING_HIT, SoundEvents.CHERRY_SAPLING_FALL);
      ...
      DECORATED_POT_CRACKED = new SoundType(1.0F, 1.0F, SoundEvents.DECORATED_POT_SHATTER, SoundEvents.DECORATED_POT_STEP, SoundEvents.DECORATED_POT_PLACE, SoundEvents.DECORATED_POT_HIT, SoundEvents.DECORATED_POT_FALL);
      TRIAL_SPAWNER = new SoundType(1.0F, 1.0F, SoundEvents.TRIAL_SPAWNER_BREAK, SoundEvents.TRIAL_SPAWNER_STEP, SoundEvents.TRIAL_SPAWNER_PLACE, SoundEvents.TRIAL_SPAWNER_HIT, SoundEvents.TRIAL_SPAWNER_FALL);
