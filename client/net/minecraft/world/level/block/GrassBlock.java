      ...
      for(int var7 = 0; var7 < 128; ++var7) {
         ...
         if (var12.isAir()) {
            ...
            if (var2.nextInt(8) == 0) {
               ...
               var10 = (PlacedFeature)((RandomPatchConfiguration)((ConfiguredFeature)var11.get(0)).config()).feature().get();
            } else {
               var10 = VegetationPlacements.GRASS_BONEMEAL;
            }

            var10.place(var1, var1.getChunkSource().getGenerator(), var2, var8);
         }
      }
