...
public class BlockPattern {
   ...
   public static class BlockPatternMatch {
      ...
      private final Direction field_127;
      ...
      public String toString() {
         return MoreObjects.toStringHelper(this).add("up", this.field_127).add("forwards", this.forwards).add("frontTopLeft", this.frontTopLeft).toString();
      }
   }
