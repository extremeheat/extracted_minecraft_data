...
public class BlockStateProperties {
   ...
   public static final BooleanProperty field_246;
   ...
   static {
      HORIZONTAL_AXIS = EnumProperty.create("axis", Direction.Axis.class, (Enum[])(Direction.Axis.field_500, Direction.Axis.field_502));
      AXIS = EnumProperty.create("axis", Direction.Axis.class);
      field_246 = BooleanProperty.create("up");
      ...
      FACING = DirectionProperty.create("facing", Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.field_526, Direction.DOWN);
      FACING_HOPPER = DirectionProperty.create("facing", (var0) -> {
         return var0 != Direction.field_526;
      });
      ...
      VERTICAL_DIRECTION = DirectionProperty.create("vertical_direction", Direction.field_526, Direction.DOWN);
