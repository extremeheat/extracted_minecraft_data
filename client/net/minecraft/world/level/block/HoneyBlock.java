...
public class HoneyBlock extends HalfTransparentBlock {
   ...
   private boolean isSlidingDown(BlockPos var1, Entity var2) {
      if (var2.isOnGround()) {
         ...
         return false;
      } else if (var2.getDeltaMovement().field_415 >= -0.08D) {
         return false;
      } else {
   ...
   private void doSlideMovement(Entity var1) {
      ...
      if (var2.field_415 < -0.13D) {
         double var3 = -0.05D / var2.field_415;
         var1.setDeltaMovement(new Vec3(var2.field_414 * var3, -0.05D, var2.field_416 * var3));
      } else {
         var1.setDeltaMovement(new Vec3(var2.field_414, -0.05D, var2.field_416));
      }
