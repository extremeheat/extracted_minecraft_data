   ...
   public InteractionResult use(BlockState var1, Level var2, BlockPos var3, Player var4, InteractionHand var5, BlockHitResult var6) {
      ...
      if (var7.is(Items.SHEARS)) {
         if (!var2.isClientSide) {
            ...
            ItemEntity var10 = new ItemEntity(var2, (double)var3.getX() + 0.5 + (double)var9.getStepX() * 0.65, (double)var3.getY() + 0.1, (double)var3.getZ() + 0.5 + (double)var9.getStepZ() * 0.65, new ItemStack(Items.PUMPKIN_SEEDS, 4));
            var10.setDeltaMovement(0.05 * (double)var9.getStepX() + var2.random.nextDouble() * 0.02, 0.05, 0.05 * (double)var9.getStepZ() + var2.random.nextDouble() * 0.02);
