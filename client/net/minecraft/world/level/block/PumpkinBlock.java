...
public class PumpkinBlock extends Block {
   ...
   protected ItemInteractionResult useItemOn(ItemStack var1, BlockState var2, Level var3, BlockPos var4, Player var5, InteractionHand var6, BlockHitResult var7) {
      if (!var1.is(Items.SHEARS)) {
         ...
         var3.playSound(null, var4, SoundEvents.PUMPKIN_CARVE, SoundSource.BLOCKS, 1.0F, 1.0F);
         var3.setBlock(var4, Blocks.CARVED_PUMPKIN.defaultBlockState().setValue(CarvedPumpkinBlock.FACING, var9), 11);
         ItemEntity var10 = new ItemEntity(
            var3,
            (double)var4.getX() + 0.5 + (double)var9.getStepX() * 0.65,
            (double)var4.getY() + 0.1,
            (double)var4.getZ() + 0.5 + (double)var9.getStepZ() * 0.65,
            new ItemStack(Items.PUMPKIN_SEEDS, 4)
         );
         var10.setDeltaMovement(
            0.05 * (double)var9.getStepX() + var3.random.nextDouble() * 0.02, 0.05, 0.05 * (double)var9.getStepZ() + var3.random.nextDouble() * 0.02
         );
