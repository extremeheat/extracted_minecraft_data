...
public class NyliumBlock extends Block implements BonemealableBlock {
   ...
   private static boolean canBeNylium(BlockState var0, LevelReader var1, BlockPos var2) {
      ...
      int var5 = LayerLightEngine.getLightBlockInto(var1, var0, var2, var4, var3, Direction.field_526, var4.getLightBlock(var1, var3));
   ...
   public void performBonemeal(ServerLevel var1, Random var2, BlockPos var3, BlockState var4) {
      ...
      if (var5.is(Blocks.CRIMSON_NYLIUM)) {
         NetherFeatures.CRIMSON_FOREST_VEGETATION_BONEMEAL.place(var1, var7, var2, var6);
      } else if (var5.is(Blocks.WARPED_NYLIUM)) {
         NetherFeatures.WARPED_FOREST_VEGETATION_BONEMEAL.place(var1, var7, var2, var6);
         NetherFeatures.NETHER_SPROUTS_BONEMEAL.place(var1, var7, var2, var6);
         if (var2.nextInt(8) == 0) {
            NetherFeatures.TWISTING_VINES_BONEMEAL.place(var1, var7, var2, var6);
         }
      }
