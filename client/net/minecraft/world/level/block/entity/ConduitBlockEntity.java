   ...
   private static void animationTick(Level var0, BlockPos var1, List<BlockPos> var2, @Nullable Entity var3, int var4) {
      ...
      while(var9.hasNext()) {
         ...
         if (var5.nextInt(50) == 0) {
            ...
            var0.addParticle(ParticleTypes.NAUTILUS, var8.field_414, var8.field_415, var8.field_416, (double)var12, (double)var13, (double)var14);
         }
      }
      ...
      if (var3 != null) {
         ...
         var0.addParticle(ParticleTypes.NAUTILUS, var18.field_414, var18.field_415, var18.field_416, var17.field_414, var17.field_415, var17.field_416);
      }
