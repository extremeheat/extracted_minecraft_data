   ...
   private final Container bookAccess = new Container() {
      ...
      public boolean stillValid(Player var1) {
         if (LecternBlockEntity.this.level.getBlockEntity(LecternBlockEntity.this.worldPosition) != LecternBlockEntity.this) {
            ...
            return var1.distanceToSqr((double)LecternBlockEntity.this.worldPosition.getX() + 0.5, (double)LecternBlockEntity.this.worldPosition.getY() + 0.5, (double)LecternBlockEntity.this.worldPosition.getZ() + 0.5) > 64.0 ? false : LecternBlockEntity.this.hasBook();
         }
      }
