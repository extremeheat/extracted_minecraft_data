...
public class LecternBlockEntity extends BlockEntity implements Clearable, MenuProvider {
   ...
   public boolean hasBook() {
      return this.book.method_87(Items.WRITABLE_BOOK) || this.book.method_87(Items.WRITTEN_BOOK);
   }
   ...
   private ItemStack resolveBook(ItemStack var1, @Nullable Player var2) {
      if (this.level instanceof ServerLevel && var1.method_87(Items.WRITTEN_BOOK)) {
   ...
   public void load(CompoundTag var1) {
      ...
      if (var1.contains("Book", 10)) {
         this.book = this.resolveBook(ItemStack.method_85(var1.getCompound("Book")), (Player)null);
      } else {
         this.book = ItemStack.EMPTY;
      }
