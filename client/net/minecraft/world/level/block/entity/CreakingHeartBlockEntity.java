...
public class CreakingHeartBlockEntity extends BlockEntity {
         ...
         if (var3.creaking != null) {
            if (CreakingHeartBlock.canSummonCreaking(var0) && !(var3.distanceToCreaking() > 34.0)) {
               ...
               if (!CreakingHeartBlock.hasRequiredLogs(var2, var0, var1) && var3.creaking == null) {
                  var0.setBlock(var1, (BlockState)var2.setValue(CreakingHeartBlock.CREAKING, CreakingHeartBlock.CreakingHeartState.DISABLED), 3);
               }
            ...
            if (!CreakingHeartBlock.canSummonCreaking(var0)) {
               if (var2.getValue(CreakingHeartBlock.CREAKING) == CreakingHeartBlock.CreakingHeartState.ACTIVE) {
                  var0.setBlock(var1, (BlockState)var2.setValue(CreakingHeartBlock.CREAKING, CreakingHeartBlock.CreakingHeartState.DORMANT), 3);
                  return;
               }
            } else if (var2.getValue(CreakingHeartBlock.CREAKING) == CreakingHeartBlock.CreakingHeartState.DORMANT) {
               var0.setBlock(var1, (BlockState)var2.setValue(CreakingHeartBlock.CREAKING, CreakingHeartBlock.CreakingHeartState.ACTIVE), 3);
               return;
            }
   ...
   private static CreakingTransient spawnProtector(ServerLevel var0, CreakingHeartBlockEntity var1) {
      ...
      Optional var3 = SpawnUtil.trySpawnMob(EntityType.CREAKING_TRANSIENT, EntitySpawnReason.SPAWNER, var0, var2, 5, 16, 8, SpawnUtil.Strategy.ON_TOP_OF_COLLIDER_NO_LEAVES);
      if (var3.isEmpty()) {
         return null;
      } else {
