...
public class HopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
   ...
   public static List<ItemEntity> getItemsAtAndAbove(Level var0, Hopper var1) {
      return (List)var1.getSuckShape().toAabbs().stream().flatMap((var2) -> {
         return var0.getEntitiesOfClass(ItemEntity.class, var2.move(var1.getLevelX() - 0.5, var1.getLevelY() - 0.5, var1.getLevelZ() - 0.5), EntitySelector.ENTITY_STILL_ALIVE).stream();
   ...
   private static Container getContainerAt(Level var0, double var1, double var3, double var5) {
      ...
      if (var7 == null) {
         List var12 = var0.getEntities((Entity)null, new AABB(var1 - 0.5, var3 - 0.5, var5 - 0.5, var1 + 0.5, var3 + 0.5, var5 + 0.5), EntitySelector.CONTAINER_ENTITY_SELECTOR);
         if (!var12.isEmpty()) {
