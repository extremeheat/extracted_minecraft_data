...
public class EnderChestBlockEntity extends BlockEntity implements LidBlockEntity {
   ...
   private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
      protected void onOpen(Level var1, BlockPos var2, BlockState var3) {
         var1.playSound((Entity)null, (double)var2.getX() + 0.5, (double)var2.getY() + 0.5, (double)var2.getZ() + 0.5, SoundEvents.ENDER_CHEST_OPEN, SoundSource.BLOCKS, 0.5F, var1.random.nextFloat() * 0.1F + 0.9F);
      }

      protected void onClose(Level var1, BlockPos var2, BlockState var3) {
         var1.playSound((Entity)null, (double)var2.getX() + 0.5, (double)var2.getY() + 0.5, (double)var2.getZ() + 0.5, SoundEvents.ENDER_CHEST_CLOSE, SoundSource.BLOCKS, 0.5F, var1.random.nextFloat() * 0.1F + 0.9F);
      }
