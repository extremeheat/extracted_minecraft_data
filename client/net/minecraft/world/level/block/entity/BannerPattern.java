...
public class BannerPattern {
   ...
   public static Holder<BannerPattern> byHash(String var0) {
      return (Holder)Registry.BANNER_PATTERN.holders().filter((var1) -> {
   ...
   public static class Builder {
      ...
      public Builder addPattern(ResourceKey<BannerPattern> var1, DyeColor var2) {
      ...
      public Builder addPattern(Pair<Holder<BannerPattern>, DyeColor> var1) {
