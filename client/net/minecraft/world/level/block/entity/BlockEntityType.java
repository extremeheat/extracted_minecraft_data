...
public class BlockEntityType<T extends BlockEntity> {
   ...
   private static <T extends BlockEntity> BlockEntityType<T> register(String var0, BlockEntityType.BlockEntitySupplier<? extends T> var1, Block... var2) {
      if (var2.length == 0) {
      ...
      return Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, var0, new BlockEntityType<>(var1, Set.of(var2)));
   }

   private BlockEntityType(BlockEntityType.BlockEntitySupplier<? extends T> var1, Set<Block> var2) {
      super();
      this.factory = var1;
   ...
   public T create(BlockPos var1, BlockState var2) {
      return (T)this.factory.create(var1, var2);
   }
