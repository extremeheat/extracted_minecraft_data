   ...
   private void showBellParticles(Level var1) {
      if (var1.isClientSide) {
         ...
         this.nearbyEntities.stream().filter(this::isRaiderWithinRange).forEach((var4x) -> {
            float var5 = 1.0F;
            float var6 = Mth.sqrt((var4x.x - (double)var2.getX()) * (var4x.x - (double)var2.getX()) + (var4x.z - (double)var2.getZ()) * (var4x.z - (double)var2.getZ()));
            double var7 = (double)((float)var2.getX() + 0.5F) + (double)(1.0F / var6) * (var4x.x - (double)var2.getX());
            double var9 = (double)((float)var2.getZ() + 0.5F) + (double)(1.0F / var6) * (var4x.z - (double)var2.getZ());
