...
public class BellBlockEntity extends BlockEntity {
   ...
   private static boolean areRaidersNearby(BlockPos var0, List<LivingEntity> var1) {
      ...
      } while(!var3.isAlive() || var3.isRemoved() || !var0.closerThan(var3.position(), 32.0D) || !var3.getType().method_117(EntityTypeTags.RAIDERS));
   ...
   private static boolean isRaiderWithinRange(BlockPos var0, LivingEntity var1) {
      return var1.isAlive() && !var1.isRemoved() && var0.closerThan(var1.position(), 48.0D) && var1.getType().method_117(EntityTypeTags.RAIDERS);
   }
