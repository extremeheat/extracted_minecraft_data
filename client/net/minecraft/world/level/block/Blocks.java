...
public class Blocks {
   ...
   public static final Block JIGSAW_BLOCK;
   ...
   static {
      ...
      OAK_LEAVES = register("oak_leaves", new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.GRASS)));
      SPRUCE_LEAVES = register("spruce_leaves", new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.GRASS)));
      BIRCH_LEAVES = register("birch_leaves", new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.GRASS)));
      JUNGLE_LEAVES = register("jungle_leaves", new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.GRASS)));
      ACACIA_LEAVES = register("acacia_leaves", new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.GRASS)));
      DARK_OAK_LEAVES = register("dark_oak_leaves", new LeavesBlock(Block.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.GRASS)));
      ...
      GLASS = register("glass", new GlassBlock(Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      ...
      WHITE_BED = register("white_bed", new BedBlock(DyeColor.WHITE, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      ORANGE_BED = register("orange_bed", new BedBlock(DyeColor.ORANGE, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      MAGENTA_BED = register("magenta_bed", new BedBlock(DyeColor.MAGENTA, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      LIGHT_BLUE_BED = register("light_blue_bed", new BedBlock(DyeColor.LIGHT_BLUE, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      YELLOW_BED = register("yellow_bed", new BedBlock(DyeColor.YELLOW, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      LIME_BED = register("lime_bed", new BedBlock(DyeColor.LIME, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      PINK_BED = register("pink_bed", new BedBlock(DyeColor.PINK, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      GRAY_BED = register("gray_bed", new BedBlock(DyeColor.GRAY, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      LIGHT_GRAY_BED = register("light_gray_bed", new BedBlock(DyeColor.LIGHT_GRAY, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      CYAN_BED = register("cyan_bed", new BedBlock(DyeColor.CYAN, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      PURPLE_BED = register("purple_bed", new BedBlock(DyeColor.PURPLE, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      BLUE_BED = register("blue_bed", new BedBlock(DyeColor.BLUE, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      BROWN_BED = register("brown_bed", new BedBlock(DyeColor.BROWN, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      GREEN_BED = register("green_bed", new BedBlock(DyeColor.GREEN, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      RED_BED = register("red_bed", new BedBlock(DyeColor.RED, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      BLACK_BED = register("black_bed", new BedBlock(DyeColor.BLACK, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F)));
      ...
      MOVING_PISTON = register("moving_piston", new MovingPistonBlock(Block.Properties.of(Material.PISTON).strength(-1.0F).dynamicShape().noDrops()));
      ...
      SPAWNER = register("spawner", new SpawnerBlock(Block.Properties.of(Material.STONE).strength(5.0F).sound(SoundType.METAL)));
      ...
      OAK_SIGN = register("oak_sign", new StandingSignBlock(Block.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD)));
      SPRUCE_SIGN = register("spruce_sign", new StandingSignBlock(Block.Properties.of(Material.WOOD, SPRUCE_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD)));
      BIRCH_SIGN = register("birch_sign", new StandingSignBlock(Block.Properties.of(Material.WOOD, MaterialColor.SAND).noCollission().strength(1.0F).sound(SoundType.WOOD)));
      ACACIA_SIGN = register("acacia_sign", new StandingSignBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).noCollission().strength(1.0F).sound(SoundType.WOOD)));
      JUNGLE_SIGN = register("jungle_sign", new StandingSignBlock(Block.Properties.of(Material.WOOD, JUNGLE_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD)));
      DARK_OAK_SIGN = register("dark_oak_sign", new StandingSignBlock(Block.Properties.of(Material.WOOD, DARK_OAK_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD)));
      OAK_DOOR = register("oak_door", new DoorBlock(Block.Properties.of(Material.WOOD, OAK_PLANKS.materialColor).strength(3.0F).sound(SoundType.WOOD)));
      LADDER = register("ladder", new LadderBlock(Block.Properties.of(Material.DECORATION).strength(0.4F).sound(SoundType.LADDER)));
      ...
      OAK_WALL_SIGN = register("oak_wall_sign", new WallSignBlock(Block.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD).dropsLike(OAK_SIGN)));
      SPRUCE_WALL_SIGN = register("spruce_wall_sign", new WallSignBlock(Block.Properties.of(Material.WOOD, SPRUCE_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD).dropsLike(SPRUCE_SIGN)));
      BIRCH_WALL_SIGN = register("birch_wall_sign", new WallSignBlock(Block.Properties.of(Material.WOOD, MaterialColor.SAND).noCollission().strength(1.0F).sound(SoundType.WOOD).dropsLike(BIRCH_SIGN)));
      ACACIA_WALL_SIGN = register("acacia_wall_sign", new WallSignBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).noCollission().strength(1.0F).sound(SoundType.WOOD).dropsLike(ACACIA_SIGN)));
      JUNGLE_WALL_SIGN = register("jungle_wall_sign", new WallSignBlock(Block.Properties.of(Material.WOOD, JUNGLE_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD).dropsLike(JUNGLE_SIGN)));
      DARK_OAK_WALL_SIGN = register("dark_oak_wall_sign", new WallSignBlock(Block.Properties.of(Material.WOOD, DARK_OAK_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD).dropsLike(DARK_OAK_SIGN)));
      ...
      IRON_DOOR = register("iron_door", new DoorBlock(Block.Properties.of(Material.METAL, MaterialColor.METAL).strength(5.0F).sound(SoundType.METAL)));
      ...
      ICE = register("ice", new IceBlock(Block.Properties.of(Material.ICE).friction(0.98F).randomTicks().strength(0.5F).sound(SoundType.GLASS)));
      ...
      SOUL_SAND = register("soul_sand", new SoulsandBlock(Block.Properties.of(Material.SAND, MaterialColor.COLOR_BROWN).randomTicks().strength(0.5F).sound(SoundType.SAND)));
      ...
      WHITE_STAINED_GLASS = register("white_stained_glass", new StainedGlassBlock(DyeColor.WHITE, Block.Properties.of(Material.GLASS, DyeColor.WHITE).strength(0.3F).sound(SoundType.GLASS)));
      ORANGE_STAINED_GLASS = register("orange_stained_glass", new StainedGlassBlock(DyeColor.ORANGE, Block.Properties.of(Material.GLASS, DyeColor.ORANGE).strength(0.3F).sound(SoundType.GLASS)));
      MAGENTA_STAINED_GLASS = register("magenta_stained_glass", new StainedGlassBlock(DyeColor.MAGENTA, Block.Properties.of(Material.GLASS, DyeColor.MAGENTA).strength(0.3F).sound(SoundType.GLASS)));
      LIGHT_BLUE_STAINED_GLASS = register("light_blue_stained_glass", new StainedGlassBlock(DyeColor.LIGHT_BLUE, Block.Properties.of(Material.GLASS, DyeColor.LIGHT_BLUE).strength(0.3F).sound(SoundType.GLASS)));
      YELLOW_STAINED_GLASS = register("yellow_stained_glass", new StainedGlassBlock(DyeColor.YELLOW, Block.Properties.of(Material.GLASS, DyeColor.YELLOW).strength(0.3F).sound(SoundType.GLASS)));
      LIME_STAINED_GLASS = register("lime_stained_glass", new StainedGlassBlock(DyeColor.LIME, Block.Properties.of(Material.GLASS, DyeColor.LIME).strength(0.3F).sound(SoundType.GLASS)));
      PINK_STAINED_GLASS = register("pink_stained_glass", new StainedGlassBlock(DyeColor.PINK, Block.Properties.of(Material.GLASS, DyeColor.PINK).strength(0.3F).sound(SoundType.GLASS)));
      GRAY_STAINED_GLASS = register("gray_stained_glass", new StainedGlassBlock(DyeColor.GRAY, Block.Properties.of(Material.GLASS, DyeColor.GRAY).strength(0.3F).sound(SoundType.GLASS)));
      LIGHT_GRAY_STAINED_GLASS = register("light_gray_stained_glass", new StainedGlassBlock(DyeColor.LIGHT_GRAY, Block.Properties.of(Material.GLASS, DyeColor.LIGHT_GRAY).strength(0.3F).sound(SoundType.GLASS)));
      CYAN_STAINED_GLASS = register("cyan_stained_glass", new StainedGlassBlock(DyeColor.CYAN, Block.Properties.of(Material.GLASS, DyeColor.CYAN).strength(0.3F).sound(SoundType.GLASS)));
      PURPLE_STAINED_GLASS = register("purple_stained_glass", new StainedGlassBlock(DyeColor.PURPLE, Block.Properties.of(Material.GLASS, DyeColor.PURPLE).strength(0.3F).sound(SoundType.GLASS)));
      BLUE_STAINED_GLASS = register("blue_stained_glass", new StainedGlassBlock(DyeColor.BLUE, Block.Properties.of(Material.GLASS, DyeColor.BLUE).strength(0.3F).sound(SoundType.GLASS)));
      BROWN_STAINED_GLASS = register("brown_stained_glass", new StainedGlassBlock(DyeColor.BROWN, Block.Properties.of(Material.GLASS, DyeColor.BROWN).strength(0.3F).sound(SoundType.GLASS)));
      GREEN_STAINED_GLASS = register("green_stained_glass", new StainedGlassBlock(DyeColor.GREEN, Block.Properties.of(Material.GLASS, DyeColor.GREEN).strength(0.3F).sound(SoundType.GLASS)));
      RED_STAINED_GLASS = register("red_stained_glass", new StainedGlassBlock(DyeColor.RED, Block.Properties.of(Material.GLASS, DyeColor.RED).strength(0.3F).sound(SoundType.GLASS)));
      BLACK_STAINED_GLASS = register("black_stained_glass", new StainedGlassBlock(DyeColor.BLACK, Block.Properties.of(Material.GLASS, DyeColor.BLACK).strength(0.3F).sound(SoundType.GLASS)));
      OAK_TRAPDOOR = register("oak_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.WOOD)));
      SPRUCE_TRAPDOOR = register("spruce_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(3.0F).sound(SoundType.WOOD)));
      BIRCH_TRAPDOOR = register("birch_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.WOOD, MaterialColor.SAND).strength(3.0F).sound(SoundType.WOOD)));
      JUNGLE_TRAPDOOR = register("jungle_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.WOOD, MaterialColor.DIRT).strength(3.0F).sound(SoundType.WOOD)));
      ACACIA_TRAPDOOR = register("acacia_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).strength(3.0F).sound(SoundType.WOOD)));
      DARK_OAK_TRAPDOOR = register("dark_oak_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(3.0F).sound(SoundType.WOOD)));
      ...
      IRON_BARS = register("iron_bars", new IronBarsBlock(Block.Properties.of(Material.METAL, MaterialColor.NONE).strength(5.0F, 6.0F).sound(SoundType.METAL)));
      GLASS_PANE = register("glass_pane", new IronBarsBlock(Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      ...
      LILY_PAD = register("lily_pad", new WaterlilyBlock(Block.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS)));
      ...
      BREWING_STAND = register("brewing_stand", new BrewingStandBlock(Block.Properties.of(Material.METAL).strength(0.5F).lightLevel(1)));
      CAULDRON = register("cauldron", new CauldronBlock(Block.Properties.of(Material.METAL, MaterialColor.STONE).strength(2.0F)));
      ...
      DRAGON_EGG = register("dragon_egg", new DragonEggBlock(Block.Properties.of(Material.EGG, MaterialColor.COLOR_BLACK).strength(3.0F, 9.0F).lightLevel(1)));
      ...
      COCOA = register("cocoa", new CocoaBlock(Block.Properties.of(Material.PLANT).randomTicks().strength(0.2F, 3.0F).sound(SoundType.WOOD)));
      ...
      BEACON = register("beacon", new BeaconBlock(Block.Properties.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0F).lightLevel(15)));
      ...
      FLOWER_POT = register("flower_pot", new FlowerPotBlock(AIR, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_OAK_SAPLING = register("potted_oak_sapling", new FlowerPotBlock(OAK_SAPLING, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_SPRUCE_SAPLING = register("potted_spruce_sapling", new FlowerPotBlock(SPRUCE_SAPLING, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_BIRCH_SAPLING = register("potted_birch_sapling", new FlowerPotBlock(BIRCH_SAPLING, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_JUNGLE_SAPLING = register("potted_jungle_sapling", new FlowerPotBlock(JUNGLE_SAPLING, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_ACACIA_SAPLING = register("potted_acacia_sapling", new FlowerPotBlock(ACACIA_SAPLING, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_DARK_OAK_SAPLING = register("potted_dark_oak_sapling", new FlowerPotBlock(DARK_OAK_SAPLING, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_FERN = register("potted_fern", new FlowerPotBlock(FERN, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_DANDELION = register("potted_dandelion", new FlowerPotBlock(DANDELION, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_POPPY = register("potted_poppy", new FlowerPotBlock(POPPY, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_BLUE_ORCHID = register("potted_blue_orchid", new FlowerPotBlock(BLUE_ORCHID, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_ALLIUM = register("potted_allium", new FlowerPotBlock(ALLIUM, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_AZURE_BLUET = register("potted_azure_bluet", new FlowerPotBlock(AZURE_BLUET, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_RED_TULIP = register("potted_red_tulip", new FlowerPotBlock(RED_TULIP, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_ORANGE_TULIP = register("potted_orange_tulip", new FlowerPotBlock(ORANGE_TULIP, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_WHITE_TULIP = register("potted_white_tulip", new FlowerPotBlock(WHITE_TULIP, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_PINK_TULIP = register("potted_pink_tulip", new FlowerPotBlock(PINK_TULIP, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_OXEYE_DAISY = register("potted_oxeye_daisy", new FlowerPotBlock(OXEYE_DAISY, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_CORNFLOWER = register("potted_cornflower", new FlowerPotBlock(CORNFLOWER, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_LILY_OF_THE_VALLEY = register("potted_lily_of_the_valley", new FlowerPotBlock(LILY_OF_THE_VALLEY, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_WITHER_ROSE = register("potted_wither_rose", new FlowerPotBlock(WITHER_ROSE, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_RED_MUSHROOM = register("potted_red_mushroom", new FlowerPotBlock(RED_MUSHROOM, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_BROWN_MUSHROOM = register("potted_brown_mushroom", new FlowerPotBlock(BROWN_MUSHROOM, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_DEAD_BUSH = register("potted_dead_bush", new FlowerPotBlock(DEAD_BUSH, Block.Properties.of(Material.DECORATION).instabreak()));
      POTTED_CACTUS = register("potted_cactus", new FlowerPotBlock(CACTUS, Block.Properties.of(Material.DECORATION).instabreak()));
      ...
      HOPPER = register("hopper", new HopperBlock(Block.Properties.of(Material.METAL, MaterialColor.STONE).strength(3.0F, 4.8F).sound(SoundType.METAL)));
      ...
      WHITE_STAINED_GLASS_PANE = register("white_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.WHITE, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      ORANGE_STAINED_GLASS_PANE = register("orange_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.ORANGE, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      MAGENTA_STAINED_GLASS_PANE = register("magenta_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.MAGENTA, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      LIGHT_BLUE_STAINED_GLASS_PANE = register("light_blue_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIGHT_BLUE, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      YELLOW_STAINED_GLASS_PANE = register("yellow_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.YELLOW, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      LIME_STAINED_GLASS_PANE = register("lime_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIME, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      PINK_STAINED_GLASS_PANE = register("pink_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.PINK, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      GRAY_STAINED_GLASS_PANE = register("gray_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.GRAY, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      LIGHT_GRAY_STAINED_GLASS_PANE = register("light_gray_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.LIGHT_GRAY, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      CYAN_STAINED_GLASS_PANE = register("cyan_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.CYAN, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      PURPLE_STAINED_GLASS_PANE = register("purple_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.PURPLE, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      BLUE_STAINED_GLASS_PANE = register("blue_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.BLUE, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      BROWN_STAINED_GLASS_PANE = register("brown_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.BROWN, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      GREEN_STAINED_GLASS_PANE = register("green_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.GREEN, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      RED_STAINED_GLASS_PANE = register("red_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.RED, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      BLACK_STAINED_GLASS_PANE = register("black_stained_glass_pane", new StainedGlassPaneBlock(DyeColor.BLACK, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS)));
      ...
      SLIME_BLOCK = register("slime_block", new SlimeBlock(Block.Properties.of(Material.CLAY, MaterialColor.GRASS).friction(0.8F).sound(SoundType.SLIME_BLOCK)));
      BARRIER = register("barrier", new BarrierBlock(Block.Properties.of(Material.BARRIER).strength(-1.0F, 3600000.8F).noDrops()));
      IRON_TRAPDOOR = register("iron_trapdoor", new TrapDoorBlock(Block.Properties.of(Material.METAL).strength(5.0F).sound(SoundType.METAL)));
      ...
      SPRUCE_DOOR = register("spruce_door", new DoorBlock(Block.Properties.of(Material.WOOD, SPRUCE_PLANKS.materialColor).strength(3.0F).sound(SoundType.WOOD)));
      BIRCH_DOOR = register("birch_door", new DoorBlock(Block.Properties.of(Material.WOOD, BIRCH_PLANKS.materialColor).strength(3.0F).sound(SoundType.WOOD)));
      JUNGLE_DOOR = register("jungle_door", new DoorBlock(Block.Properties.of(Material.WOOD, JUNGLE_PLANKS.materialColor).strength(3.0F).sound(SoundType.WOOD)));
      ACACIA_DOOR = register("acacia_door", new DoorBlock(Block.Properties.of(Material.WOOD, ACACIA_PLANKS.materialColor).strength(3.0F).sound(SoundType.WOOD)));
      DARK_OAK_DOOR = register("dark_oak_door", new DoorBlock(Block.Properties.of(Material.WOOD, DARK_OAK_PLANKS.materialColor).strength(3.0F).sound(SoundType.WOOD)));
      END_ROD = register("end_rod", new EndRodBlock(Block.Properties.of(Material.DECORATION).instabreak().lightLevel(14).sound(SoundType.WOOD)));
      CHORUS_PLANT = register("chorus_plant", new ChorusPlantBlock(Block.Properties.of(Material.PLANT, MaterialColor.COLOR_PURPLE).strength(0.4F).sound(SoundType.WOOD)));
      CHORUS_FLOWER = register("chorus_flower", new ChorusFlowerBlock((ChorusPlantBlock)CHORUS_PLANT, Block.Properties.of(Material.PLANT, MaterialColor.COLOR_PURPLE).randomTicks().strength(0.4F).sound(SoundType.WOOD)));
      ...
      END_STONE_BRICKS = register("end_stone_bricks", new Block(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(0.8F)));
      ...
      FROSTED_ICE = register("frosted_ice", new FrostedIceBlock(Block.Properties.of(Material.ICE).friction(0.98F).randomTicks().strength(0.5F).sound(SoundType.GLASS)));
      ...
      SHULKER_BOX = register("shulker_box", new ShulkerBoxBlock((DyeColor)null, Block.Properties.of(Material.SHULKER_SHELL).strength(2.0F).dynamicShape()));
      WHITE_SHULKER_BOX = register("white_shulker_box", new ShulkerBoxBlock(DyeColor.WHITE, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.SNOW).strength(2.0F).dynamicShape()));
      ORANGE_SHULKER_BOX = register("orange_shulker_box", new ShulkerBoxBlock(DyeColor.ORANGE, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_ORANGE).strength(2.0F).dynamicShape()));
      MAGENTA_SHULKER_BOX = register("magenta_shulker_box", new ShulkerBoxBlock(DyeColor.MAGENTA, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_MAGENTA).strength(2.0F).dynamicShape()));
      LIGHT_BLUE_SHULKER_BOX = register("light_blue_shulker_box", new ShulkerBoxBlock(DyeColor.LIGHT_BLUE, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_LIGHT_BLUE).strength(2.0F).dynamicShape()));
      YELLOW_SHULKER_BOX = register("yellow_shulker_box", new ShulkerBoxBlock(DyeColor.YELLOW, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_YELLOW).strength(2.0F).dynamicShape()));
      LIME_SHULKER_BOX = register("lime_shulker_box", new ShulkerBoxBlock(DyeColor.LIME, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_LIGHT_GREEN).strength(2.0F).dynamicShape()));
      PINK_SHULKER_BOX = register("pink_shulker_box", new ShulkerBoxBlock(DyeColor.PINK, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_PINK).strength(2.0F).dynamicShape()));
      GRAY_SHULKER_BOX = register("gray_shulker_box", new ShulkerBoxBlock(DyeColor.GRAY, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_GRAY).strength(2.0F).dynamicShape()));
      LIGHT_GRAY_SHULKER_BOX = register("light_gray_shulker_box", new ShulkerBoxBlock(DyeColor.LIGHT_GRAY, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_LIGHT_GRAY).strength(2.0F).dynamicShape()));
      CYAN_SHULKER_BOX = register("cyan_shulker_box", new ShulkerBoxBlock(DyeColor.CYAN, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_CYAN).strength(2.0F).dynamicShape()));
      PURPLE_SHULKER_BOX = register("purple_shulker_box", new ShulkerBoxBlock(DyeColor.PURPLE, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.TERRACOTTA_PURPLE).strength(2.0F).dynamicShape()));
      BLUE_SHULKER_BOX = register("blue_shulker_box", new ShulkerBoxBlock(DyeColor.BLUE, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_BLUE).strength(2.0F).dynamicShape()));
      BROWN_SHULKER_BOX = register("brown_shulker_box", new ShulkerBoxBlock(DyeColor.BROWN, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_BROWN).strength(2.0F).dynamicShape()));
      GREEN_SHULKER_BOX = register("green_shulker_box", new ShulkerBoxBlock(DyeColor.GREEN, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_GREEN).strength(2.0F).dynamicShape()));
      RED_SHULKER_BOX = register("red_shulker_box", new ShulkerBoxBlock(DyeColor.RED, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_RED).strength(2.0F).dynamicShape()));
      BLACK_SHULKER_BOX = register("black_shulker_box", new ShulkerBoxBlock(DyeColor.BLACK, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_BLACK).strength(2.0F).dynamicShape()));
      ...
      TURTLE_EGG = register("turtle_egg", new TurtleEggBlock(Block.Properties.of(Material.EGG, MaterialColor.SAND).strength(0.5F).sound(SoundType.METAL).randomTicks()));
      ...
      SEA_PICKLE = register("sea_pickle", new SeaPickleBlock(Block.Properties.of(Material.WATER_PLANT, MaterialColor.COLOR_GREEN).lightLevel(3).sound(SoundType.SLIME_BLOCK)));
      ...
      CONDUIT = register("conduit", new ConduitBlock(Block.Properties.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0F).lightLevel(15)));
      ...
      BAMBOO = register("bamboo", new BambooBlock(Block.Properties.of(Material.BAMBOO, MaterialColor.PLANT).randomTicks().instabreak().strength(1.0F).sound(SoundType.BAMBOO)));
      POTTED_BAMBOO = register("potted_bamboo", new FlowerPotBlock(BAMBOO, Block.Properties.of(Material.DECORATION).instabreak()));
      ...
      LANTERN = register("lantern", new Lantern(Block.Properties.of(Material.METAL).strength(3.5F).sound(SoundType.LANTERN).lightLevel(15)));
      CAMPFIRE = register("campfire", new CampfireBlock(Block.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(2.0F).sound(SoundType.WOOD).lightLevel(15).randomTicks()));
      ...
      JIGSAW_BLOCK = register("jigsaw", new JigsawBlock(Block.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_GRAY).strength(-1.0F, 3600000.0F).noDrops()));
