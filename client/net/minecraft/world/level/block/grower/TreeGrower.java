...
public final class TreeGrower {
   ...
   public TreeGrower(
      ...
      Optional<ResourceKey<ConfiguredFeature<?, ?>>> var7,
      Optional<ResourceKey<ConfiguredFeature<?, ?>>> var8
   ) {
      super();
      this.name = var1;
   ...
   private ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource var1, boolean var2) {
      ...
      return var2 && this.flowers.isPresent() ? this.flowers.get() : this.tree.orElse(null);
   }

   @Nullable
   private ResourceKey<ConfiguredFeature<?, ?>> getConfiguredMegaFeature(RandomSource var1) {
      return this.secondaryMegaTree.isPresent() && var1.nextFloat() < this.secondaryChance ? this.secondaryMegaTree.get() : this.megaTree.orElse(null);
   }
   ...
   public boolean growTree(ServerLevel var1, ChunkGenerator var2, BlockPos var3, BlockState var4, RandomSource var5) {
      ...
      if (var6 != null) {
         Holder var7 = var1.registryAccess().lookupOrThrow(Registries.CONFIGURED_FEATURE).get(var6).orElse(null);
         if (var7 != null) {
      ...
      if (var12 == null) {
         ...
         Holder var13 = var1.registryAccess().lookupOrThrow(Registries.CONFIGURED_FEATURE).get(var12).orElse(null);
         if (var13 == null) {
            return false;
         } else {
   ...
   private static boolean isTwoByTwoSapling(BlockState var0, BlockGetter var1, BlockPos var2, int var3, int var4) {
      ...
      return var1.getBlockState(var2.offset(var3, 0, var4)).is(var5)
         && var1.getBlockState(var2.offset(var3 + 1, 0, var4)).is(var5)
         && var1.getBlockState(var2.offset(var3, 0, var4 + 1)).is(var5)
         && var1.getBlockState(var2.offset(var3 + 1, 0, var4 + 1)).is(var5);
   }
