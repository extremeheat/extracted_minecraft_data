...
public abstract class GrowingPlantBlock extends Block {
   ...
   public BlockState getStateForPlacement(BlockPlaceContext var1) {
      ...
      return !var2.is(this.getHeadBlock()) && !var2.is(this.getBodyBlock())
         ? this.getStateForPlacement(var1.getLevel().random)
   ...
   protected boolean canSurvive(BlockState var1, LevelReader var2, BlockPos var3) {
      ...
      return !this.canAttachTo(var5)
         ? false
         : var5.is(this.getHeadBlock()) || var5.is(this.getBodyBlock()) || var5.isFaceSturdy(var2, var4, this.growthDirection);
   }
