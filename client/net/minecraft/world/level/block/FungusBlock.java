...
public class FungusBlock extends BushBlock implements BonemealableBlock {
   ...
   public boolean isValidBonemealTarget(BlockGetter var1, BlockPos var2, BlockState var3, boolean var4) {
      Block var5 = ((HugeFungusConfiguration)((ConfiguredFeature)((Holder)this.feature.get()).value()).config()).validBaseState.getBlock();
   ...
   public void performBonemeal(ServerLevel var1, RandomSource var2, BlockPos var3, BlockState var4) {
      ((ConfiguredFeature)((Holder)this.feature.get()).value()).place(var1, var1.getChunkSource().getGenerator(), var2, var3);
   }
}
