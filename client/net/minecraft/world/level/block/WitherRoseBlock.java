...
public class WitherRoseBlock extends FlowerBlock {
   ...
   public void animateTick(BlockState var1, Level var2, BlockPos var3, RandomSource var4) {
      ...
      for(int var11 = 0; var11 < 3; ++var11) {
         if (var4.nextBoolean()) {
            var2.addParticle(ParticleTypes.SMOKE, var7 + var4.nextDouble() / 5.0, (double)var3.getY() + (0.5 - var4.nextDouble()), var9 + var4.nextDouble() / 5.0, 0.0, 0.0, 0.0);
         }
      }
   ...
   protected void entityInside(BlockState var1, Level var2, BlockPos var3, Entity var4) {
      if (!var2.isClientSide && var2.getDifficulty() != Difficulty.PEACEFUL) {
         if (var4 instanceof LivingEntity) {
            ...
            if (!var5.isInvulnerableTo(var2.damageSources().wither())) {
