...
public class ServerExplosion implements Explosion {
   ...
   public ServerExplosion(
      ...
      float var6,
      boolean var7,
      Explosion.BlockInteraction var8
   ) {
      super();
      this.level = var1;
      this.source = var2;
         ...
         if (!var10.ignoreExplosion(this)) {
            ...
            if (var11 <= 1.0) {
               ...
               if (var19 != 0.0) {
                  ...
                  if (var21) {
                     var10.hurt(this.damageSource, this.damageCalculator.getEntityDamageAmount(this, var10, var23));
                  }
                  ...
                  var10.setDeltaMovement(var10.getDeltaMovement().add(var36));
   ...
   private void interactWithBlocks(List<BlockPos> var1) {
      ...
      for (ServerExplosion.StackCollector var6 : var2) {
   ...
   private static void addOrAppendStack(List<ServerExplosion.StackCollector> var0, ItemStack var1, BlockPos var2) {
      for (ServerExplosion.StackCollector var4 : var0) {
         var4.tryMerge(var1);
         if (var1.isEmpty()) {
            return;
         }
   ...
   public boolean shouldAffectBlocklikeEntities() {
      ...
      return var1 ? var2 && var3 : this.blockInteraction.shouldAffectBlocklikeEntities() && var2 && var3;
   }
