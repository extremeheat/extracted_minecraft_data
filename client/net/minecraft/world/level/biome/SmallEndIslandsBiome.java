...
public class SmallEndIslandsBiome extends Biome {
   public SmallEndIslandsBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.RAW_GENERATION, makeComposite(Feature.END_ISLAND, FeatureConfiguration.NONE, FeatureDecorator.END_ISLAND, DecoratorConfiguration.NONE));
