...
public class BiomeSpecialEffects {
   ...
   BiomeSpecialEffects(int var1, int var2, int var3, int var4, Optional<Integer> var5, Optional<Integer> var6, GrassColorModifier var7, Optional<AmbientParticleSettings> var8, Optional<SoundEvent> var9, Optional<AmbientMoodSettings> var10, Optional<AmbientAdditionsSettings> var11, Optional<Music> var12) {
      super();
      this.fogColor = var1;
   ...
   public static class Builder {
      ...
      public Builder ambientLoopSound(SoundEvent var1) {
