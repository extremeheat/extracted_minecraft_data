...
public class BiomeGenerationSettings {
   ...
   public static class Builder {
      ...
      public Builder addFeature(GenerationStep.Decoration var1, Holder<PlacedFeature> var2) {
         return this.addFeature(var1.ordinal(), var2);
      }

      public Builder addFeature(int var1, Holder<PlacedFeature> var2) {
         this.addFeatureStepsUpTo(var1);
         ((List)this.features.get(var1)).add(var2);
         return this;
      }

      public Builder addCarver(GenerationStep.Carving var1, Holder<? extends ConfiguredWorldCarver<?>> var2) {
         ((List)this.carvers.computeIfAbsent(var1, (var0) -> {
            return Lists.newArrayList();
         })).add(Holder.hackyErase(var2));
         return this;
      }
