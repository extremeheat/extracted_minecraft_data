...
public final class SunflowerPlainsBiome extends Biome {
   protected SunflowerPlainsBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.DOUBLE_PLANT, new DoublePlantConfiguration(Blocks.SUNFLOWER.defaultBlockState()), FeatureDecorator.COUNT_HEIGHTMAP_32, new DecoratorFrequency(10)));
      BiomeDefaultFeatures.addDefaultUndergroundVariety(this);
      BiomeDefaultFeatures.addDefaultOres(this);
      BiomeDefaultFeatures.addDefaultSoftDisks(this);
      BiomeDefaultFeatures.addPlainVegetation(this);
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.REED, FeatureConfiguration.NONE, FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE, new DecoratorFrequency(10)));
      BiomeDefaultFeatures.addDefaultMushrooms(this);
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.PUMPKIN, FeatureConfiguration.NONE, FeatureDecorator.CHANCE_HEIGHTMAP_DOUBLE, new DecoratorChance(32)));
