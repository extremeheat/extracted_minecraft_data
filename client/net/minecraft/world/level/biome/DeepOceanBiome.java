...
public final class DeepOceanBiome extends Biome {
   public DeepOceanBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.SEAGRASS, new SeagrassFeatureConfiguration(48, 0.8D), FeatureDecorator.TOP_SOLID_HEIGHTMAP, DecoratorConfiguration.NONE));
