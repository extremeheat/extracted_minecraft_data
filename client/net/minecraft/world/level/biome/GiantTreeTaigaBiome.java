...
public final class GiantTreeTaigaBiome extends Biome {
   public GiantTreeTaigaBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.TAIGA).depth(0.2F).scale(0.2F).temperature(0.3F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent((String)null));
      ...
      this.addSpawn(MobCategory.MONSTER, new Biome.SpawnerData(EntityType.ZOMBIE_VILLAGER, 25, 1, 1));
