...
public class FeatureSorter {
      ...
      while(var21.hasNext()) {
         ...
         if (!var19.contains(var23)) {
            ...
            if (Graph.depthFirstSearch(var6, var19, var20, var10::add, var23)) {
               ...
               throw new IllegalStateException("Feature order cycle found, involved sources: " + var25);
            }
         }
      }
   ...
   public static record StepFeatureData(List<PlacedFeature> a, ToIntFunction<PlacedFeature> b) {
      ...
      StepFeatureData(List<PlacedFeature> var1) {
         this(var1, Util.createIndexLookup(var1, (var0) -> {
            return new Object2IntOpenCustomHashMap(var0, Util.identityStrategy());
         }));
      }
