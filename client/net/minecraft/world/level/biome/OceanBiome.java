...
public final class OceanBiome extends Biome {
   public OceanBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.SEAGRASS, new SeagrassFeatureConfiguration(48, 0.3D), FeatureDecorator.TOP_SOLID_HEIGHTMAP, DecoratorConfiguration.NONE));
