...
public class EndHighlandsBiome extends Biome {
   public EndHighlandsBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, makeComposite(Feature.END_GATEWAY, EndGatewayConfiguration.knownExit(TheEndDimension.END_SPAWN_POINT, true), FeatureDecorator.END_GATEWAY, DecoratorConfiguration.NONE));
      BiomeDefaultFeatures.addEndCity(this);
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.CHORUS_PLANT, FeatureConfiguration.NONE, FeatureDecorator.CHORUS_PLANT, DecoratorConfiguration.NONE));
