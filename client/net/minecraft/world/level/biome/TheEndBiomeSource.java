...
public class TheEndBiomeSource extends BiomeSource {
   ...
   public TheEndBiomeSource(Registry<Biome> var1) {
      this(var1.getOrCreateHolderOrThrow(Biomes.THE_END), var1.getOrCreateHolderOrThrow(Biomes.END_HIGHLANDS), var1.getOrCreateHolderOrThrow(Biomes.END_MIDLANDS), var1.getOrCreateHolderOrThrow(Biomes.SMALL_END_ISLANDS), var1.getOrCreateHolderOrThrow(Biomes.END_BARRENS));
   }

   private TheEndBiomeSource(Holder<Biome> var1, Holder<Biome> var2, Holder<Biome> var3, Holder<Biome> var4, Holder<Biome> var5) {
      super((List)ImmutableList.of(var1, var2, var3, var4, var5));
      this.end = var1;
      this.highlands = var2;
      this.midlands = var3;
      this.islands = var4;
