...
public final class IceSpikesBiome extends Biome {
   public IceSpikesBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, makeComposite(Feature.ICE_SPIKE, FeatureConfiguration.NONE, FeatureDecorator.COUNT_HEIGHTMAP, new DecoratorFrequency(3)));
      this.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, makeComposite(Feature.ICE_PATCH, new FeatureRadius(2), FeatureDecorator.COUNT_HEIGHTMAP, new DecoratorFrequency(2)));
