...
public abstract class Biome {
   ...
   public static <F extends FeatureConfiguration, D extends DecoratorConfiguration> ConfiguredFeature<?> makeComposite(Feature<F> var0, F var1, FeatureDecorator<D> var2, D var3) {
      Feature var4 = var0 instanceof FlowerFeature ? Feature.DECORATED_FLOWER : Feature.DECORATED;
      return new ConfiguredFeature(var4, new DecoratedFeatureConfiguration(var0, var1, var2, var3));
   }
   ...
   public <C extends FeatureConfiguration> void addStructureStart(StructureFeature<C> var1, C var2) {
      this.validFeatureStarts.put(var1, var2);
   }
   ...
   public int getGrassColor(BlockPos var1) {
      double var2 = (double)Mth.clamp(this.getTemperature(var1), 0.0F, 1.0F);
   ...
   public static enum BiomeTempCategory {
      ...
      private static final Map<String, Biome.BiomeTempCategory> BY_NAME = (Map)Arrays.stream(values()).collect(Collectors.toMap(Biome.BiomeTempCategory::getName, (var0) -> {
         return var0;
      }));
      private final String name;
