...
public final class Biome {
   ...
   private static record ClimateSettings(Precipitation b, float c, TemperatureModifier d, float e) {
      ...
      ClimateSettings(Precipitation var1, float var2, TemperatureModifier var3, float var4) {
         super();
   ...
   public static class BiomeBuilder {
      ...
      public BiomeBuilder precipitation(Precipitation var1) {
         this.precipitation = var1;
         return this;
      }
      ...
      public Biome build() {
         if (this.precipitation != null && this.temperature != null && this.downfall != null && this.specialEffects != null && this.mobSpawnSettings != null && this.generationSettings != null) {
            return new Biome(new ClimateSettings(this.precipitation, this.temperature, this.temperatureModifier, this.downfall), this.specialEffects, this.generationSettings, this.mobSpawnSettings);
         } else {
