...
public final class TallBirchForestBiome extends Biome {
   public TallBirchForestBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.FOREST).depth(0.2F).scale(0.4F).temperature(0.6F).downfall(0.6F).waterColor(4159204).waterFogColor(329011).parent("birch_forest"));
