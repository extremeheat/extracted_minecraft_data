...
public class DeepColdOceanBiome extends Biome {
   public DeepColdOceanBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.SEAGRASS, new SeagrassFeatureConfiguration(40, 0.8D), FeatureDecorator.TOP_SOLID_HEIGHTMAP, DecoratorConfiguration.NONE));
