...
public class WarmOceanBiome extends Biome {
   public WarmOceanBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.SIMPLE_RANDOM_SELECTOR, new SimpleRandomFeatureConfig(new Feature[]{Feature.CORAL_TREE, Feature.CORAL_CLAW, Feature.CORAL_MUSHROOM}, new FeatureConfiguration[]{FeatureConfiguration.NONE, FeatureConfiguration.NONE, FeatureConfiguration.NONE}), FeatureDecorator.TOP_SOLID_HEIGHTMAP_NOISE_BIASED, new DecoratorNoiseCountFactor(20, 400.0D, 0.0D, Heightmap.Types.OCEAN_FLOOR_WG)));
      BiomeDefaultFeatures.addWarmSeagrass(this);
      this.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, makeComposite(Feature.SEA_PICKLE, new CountFeatureConfiguration(20), FeatureDecorator.CHANCE_TOP_SOLID_HEIGHTMAP, new DecoratorChance(16)));
