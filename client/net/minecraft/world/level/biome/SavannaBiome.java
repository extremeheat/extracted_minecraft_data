...
public final class SavannaBiome extends Biome {
   protected SavannaBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.SAVANNA).depth(0.125F).scale(0.05F).temperature(1.2F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent((String)null));
      this.addStructureStart(Feature.VILLAGE, new VillageConfiguration("village/savanna/town_centers", 6));
