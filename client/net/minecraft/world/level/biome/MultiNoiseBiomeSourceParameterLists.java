...
public class MultiNoiseBiomeSourceParameterLists {
   ...
   public static void nextUpdate(BootstapContext<MultiNoiseBiomeSourceParameterList> var0) {
      HolderGetter var1 = var0.lookup(Registries.BIOME);
      var0.register(OVERWORLD, new MultiNoiseBiomeSourceParameterList(MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD_UPDATE_1_20, var1));
   }
