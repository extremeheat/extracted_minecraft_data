...
public class Climate {
   ...
   public static Climate.TargetPoint target(float var0, float var1, float var2, float var3, float var4, float var5) {
      return new Climate.TargetPoint(quantizeCoord(var0), quantizeCoord(var1), quantizeCoord(var2), quantizeCoord(var3), quantizeCoord(var4), quantizeCoord(var5));
   }
   ...
   public static Climate.ParameterPoint parameters(float var0, float var1, float var2, float var3, float var4, float var5, float var6) {
      return new Climate.ParameterPoint(Climate.Parameter.point(var0), Climate.Parameter.point(var1), Climate.Parameter.point(var2), Climate.Parameter.point(var3), Climate.Parameter.point(var4), Climate.Parameter.point(var5), quantizeCoord(var6));
   }

   public static Climate.ParameterPoint parameters(Climate.Parameter var0, Climate.Parameter var1, Climate.Parameter var2, Climate.Parameter var3, Climate.Parameter var4, Climate.Parameter var5, float var6) {
   ...
   public static BlockPos findSpawnPosition(List<Climate.ParameterPoint> var0, NoiseSampler var1) {
   ...
   public static record ParameterPoint(Climate.Parameter b, Climate.Parameter c, Climate.Parameter d, Climate.Parameter e, Climate.Parameter f, Climate.Parameter g, long h) {
      ...
      public static final Codec<Climate.ParameterPoint> CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      public ParameterPoint(Climate.Parameter var1, Climate.Parameter var2, Climate.Parameter var3, Climate.Parameter var4, Climate.Parameter var5, Climate.Parameter var6, long var7) {
         super();
         this.temperature = var1;
         this.humidity = var2;
   ...
   public static record Parameter(long b, long c) {
      ...
      public static final Codec<Climate.Parameter> CODEC = ExtraCodecs.intervalCodec(Codec.floatRange(-2.0F, 2.0F), "min", "max", (var0, var1) -> {
         return var0.compareTo(var1) > 0 ? DataResult.error("Cannon construct interval, min > max (" + var0 + " > " + var1 + ")") : DataResult.success(new Climate.Parameter(Climate.quantizeCoord(var0), Climate.quantizeCoord(var1)));
      }, (var0) -> {
   ...
   private static class SpawnFinder {
      ...
      SpawnFinder(List<Climate.ParameterPoint> var1, NoiseSampler var2) {
         super();
      ...
      private void radialSearch(List<Climate.ParameterPoint> var1, NoiseSampler var2, float var3, float var4) {
         float var5 = 0.0F;
         float var6 = var4;
         ...
         while(var6 <= var3) {
            ...
            var5 += var4 / var6;
            if ((double)var5 > 6.283185307179586D) {
               var5 = 0.0F;
               var6 += var4;
            }
         }
      ...
      private static Climate.SpawnFinder.Result getSpawnPositionAndFitness(List<Climate.ParameterPoint> var0, NoiseSampler var1, int var2, int var3) {
         double var4 = Mth.square(2500.0D);
         boolean var6 = true;
         long var7 = (long)((double)Mth.square(10000.0F) * Math.pow((double)(Mth.square((long)var2) + Mth.square((long)var3)) / var4, 2.0D));
   ...
   public static class ParameterList<T> {
      ...
      public T findValue(Climate.TargetPoint var1, T var2) {
         return this.findValueIndex(var1);
      }

      @VisibleForTesting
      public T findValueBruteForce(Climate.TargetPoint var1, T var2) {
   ...
   protected static final class RTree<T> {
         ...
         if (var0.isEmpty()) {
            ...
            if (var1 != 7) {
               ...
               List var2 = (List)var0.stream().map((var0x) -> {
                  return new Climate.RTree.Leaf((Climate.ParameterPoint)var0x.getFirst(), var0x.getSecond());
      ...
      private static <T> Climate.RTree.Node<T> build(int var0, List<? extends Climate.RTree.Node<T>> var1) {
         if (var1.isEmpty()) {
            ...
            return (Climate.RTree.Node)var1.get(0);
         } else if (var1.size() <= 10) {
            var1.sort(Comparator.comparingLong((var1x) -> {
               long var2 = 0L;

               for(int var4 = 0; var4 < var0; ++var4) {
                  Climate.Parameter var5 = var1x.parameterSpace[var4];
            ...
            return new Climate.RTree.SubTree((List)var5.stream().map((var1x) -> {
      ...
      private static <T> List<Climate.RTree.SubTree<T>> bucketize(List<? extends Climate.RTree.Node<T>> var0) {
         ...
         int var3 = (int)Math.pow(10.0D, Math.floor(Math.log((double)var0.size() - 0.01D) / Math.log(10.0D)));
         Iterator var4 = var0.iterator();

         while(var4.hasNext()) {
            Climate.RTree.Node var5 = (Climate.RTree.Node)var4.next();
            var2.add(var5);
            if (var2.size() >= var3) {
      ...
      private static long cost(Climate.Parameter[] var0) {
         long var1 = 0L;
         Climate.Parameter[] var3 = var0;
         int var4 = var0.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            Climate.Parameter var6 = var3[var5];
      ...
      static <T> List<Climate.Parameter> buildParameterSpace(List<? extends Climate.RTree.Node<T>> var0) {
         if (var0.isEmpty()) {
            ...
            while(var6.hasNext()) {
               Climate.RTree.Node var4 = (Climate.RTree.Node)var6.next();
      ...
      public T search(Climate.TargetPoint var1, Climate.DistanceMetric<T> var2) {
         ...
         Climate.RTree.Leaf var4 = this.root.search(var3, (Climate.RTree.Leaf)this.lastResult.get(), var2);
      ...
      abstract static class Node<T> {
         ...
         protected Node(List<Climate.Parameter> var1) {
            super();
            this.parameterSpace = (Climate.Parameter[])var1.toArray(new Climate.Parameter[0]);
         }
      ...
      private static final class SubTree<T> extends Climate.RTree.Node<T> {
         ...
         protected SubTree(List<Climate.Parameter> var1, List<? extends Climate.RTree.Node<T>> var2) {
            super(var1);
            this.children = (Climate.RTree.Node[])var2.toArray(new Climate.RTree.Node[0]);
         }
         ...
         protected Climate.RTree.Leaf<T> search(long[] var1, @Nullable Climate.RTree.Leaf<T> var2, Climate.DistanceMetric<T> var3) {
            ...
            Climate.RTree.Node[] var7 = this.children;
            int var8 = var7.length;

            for(int var9 = 0; var9 < var8; ++var9) {
               Climate.RTree.Node var10 = var7[var9];
