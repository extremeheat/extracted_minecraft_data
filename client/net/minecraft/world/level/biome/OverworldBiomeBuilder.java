...
public final class OverworldBiomeBuilder {
   ...
   protected void addBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1) {
      if (SharedConstants.debugGenerateSquareTerrainWithoutNoise) {
         TerrainProvider.overworld(false).addDebugBiomesToVisualizeSplinePoints(var1);
      } else {
   ...
   private void addPeaks(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1, Climate.Parameter var2) {
      for(int var3 = 0; var3 < this.temperatures.length; ++var3) {
         ...
         for(int var5 = 0; var5 < this.humidities.length; ++var5) {
            ...
            ResourceKey var11 = this.pickExtremeHillsBiome(var3, var5, var2);
            ResourceKey var12 = this.maybePickShatteredBiome(var3, var5, var2, var11);
   ...
   private void addHighSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1, Climate.Parameter var2) {
      for(int var3 = 0; var3 < this.temperatures.length; ++var3) {
         ...
         for(int var5 = 0; var5 < this.humidities.length; ++var5) {
            ...
            ResourceKey var10 = this.pickPlateauBiome(var3, var5, var2);
            ResourceKey var11 = this.pickExtremeHillsBiome(var3, var5, var2);
            ResourceKey var12 = this.maybePickShatteredBiome(var3, var5, var2, var7);
   ...
   private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1, Climate.Parameter var2) {
      ...
      this.addSurfaceBiome(var1, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], var2, 0.0F, Biomes.SWAMP);
      ...
      for(int var3 = 0; var3 < this.temperatures.length; ++var3) {
         ...
         for(int var5 = 0; var5 < this.humidities.length; ++var5) {
            ...
            ResourceKey var8 = this.pickMiddleBiomeOrBadlandsIfHot(var3, var5, var2);
            ResourceKey var9 = this.pickMiddleBiomeOrBadlandsIfHotOrSlopeIfCold(var3, var5, var2);
            ResourceKey var10 = this.pickExtremeHillsBiome(var3, var5, var2);
            ResourceKey var11 = this.pickPlateauBiome(var3, var5, var2);
            ResourceKey var12 = this.pickBeachBiome(var3, var5);
            ResourceKey var13 = this.maybePickShatteredBiome(var3, var5, var2, var7);
   ...
   private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1, Climate.Parameter var2) {
      ...
      for(int var3 = 0; var3 < this.temperatures.length; ++var3) {
         ...
         for(int var5 = 0; var5 < this.humidities.length; ++var5) {
            ...
            ResourceKey var11 = this.maybePickShatteredBiome(var3, var5, var2, var7);
   ...
   private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1, Climate.Parameter var2) {
      ...
      this.addSurfaceBiome(var1, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], var2, 0.0F, Biomes.SWAMP);
   ...
   private ResourceKey<Biome> maybePickShatteredBiome(int var1, int var2, Climate.Parameter var3, ResourceKey<Biome> var4) {
   ...
   private ResourceKey<Biome> pickShatteredCoastBiome(int var1, int var2, Climate.Parameter var3) {
      ...
      return this.maybePickShatteredBiome(var1, var2, var3, var4);
   }
   ...
   private ResourceKey<Biome> pickBadlandsBiome(int var1, Climate.Parameter var2) {
      if (var1 < 2) {
         return var2.max() < 0L ? Biomes.ERODED_BADLANDS : Biomes.BADLANDS;
      } else {
   ...
   private ResourceKey<Biome> pickExtremeHillsBiome(int var1, int var2, Climate.Parameter var3) {
      ResourceKey var4 = this.EXTREME_HILLS[var1][var2];
   ...
   public static String getDebugStringForPeaksAndValleys(double var0) {
      if (var0 < (double)TerrainShaper.peaksAndValleys(0.05F)) {
         return "Valley";
      } else if (var0 < (double)TerrainShaper.peaksAndValleys(0.26666668F)) {
         return "Low";
      } else if (var0 < (double)TerrainShaper.peaksAndValleys(0.4F)) {
         return "Mid";
      } else {
         return var0 < (double)TerrainShaper.peaksAndValleys(0.56666666F) ? "High" : "Peak";
      }
   }
   ...
   private static String getDebugStringForNoiseValue(double var0, Climate.Parameter[] var2) {
      ...
      for(int var5 = 0; var5 < var2.length; ++var5) {
         if (var3 < (double)var2[var5].max()) {
            return var5.makeConcatWithConstants<invokedynamic>(var5);
         }
      }
