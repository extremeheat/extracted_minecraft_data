            ...
            for(int var4 = 0; var4 < this.spawnCount; ++var4) {
               ...
               if (var1.noCollision(((EntityType)var6.get()).getAABB(var10, var12, var14))) {
                  ...
                  if (this.nextSpawnData.getCustomSpawnRules().isPresent()) {
                     ...
                     SpawnData.CustomSpawnRules var17 = (SpawnData.CustomSpawnRules)this.nextSpawnData.getCustomSpawnRules().get();
                     if (!var17.blockLightLimit().isValueInRange(var1.getBrightness(LightLayer.BLOCK, var16)) || !var17.skyLightLimit().isValueInRange(var1.getBrightness(LightLayer.SKY, var16))) {
                        continue;
                     }
                  ...
                  int var18 = var1.getEntitiesOfClass(var20.getClass(), (new AABB((double)var2.getX(), (double)var2.getY(), (double)var2.getZ(), (double)(var2.getX() + 1), (double)(var2.getY() + 1), (double)(var2.getZ() + 1))).inflate((double)this.spawnRange)).size();
                  ...
                  if (var20 instanceof Mob) {
                     Mob var19 = (Mob)var20;
                     if (this.nextSpawnData.getCustomSpawnRules().isEmpty() && !var19.checkSpawnRules(var1, MobSpawnType.SPAWNER) || !var19.checkSpawnObstruction(var1)) {
                        continue;
                     }

                     if (this.nextSpawnData.getEntityToSpawn().size() == 1 && this.nextSpawnData.getEntityToSpawn().contains("id", 8)) {
                        ((Mob)var20).finalizeSpawn(var1, var1.getCurrentDifficultyAt(var20.blockPosition()), MobSpawnType.SPAWNER, (SpawnGroupData)null, (CompoundTag)null);
                     }
                  }
   ...
   public void load(@Nullable Level var1, BlockPos var2, CompoundTag var3) {
      ...
      if (!var4) {
         ...
         if (var5) {
            ...
            this.spawnPotentials.getRandom(var1.getRandom()).ifPresent((var3x) -> {
               this.setNextSpawnData(var1, var2, (SpawnData)var3x.getData());
            });
         }
      }
