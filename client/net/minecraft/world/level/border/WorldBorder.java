...
public class WorldBorder {
   ...
   public boolean isWithinBounds(ChunkPos var1) {
      return this.isWithinBounds((double)var1.getMinBlockX(), (double)var1.getMinBlockZ())
         && this.isWithinBounds((double)var1.getMaxBlockX(), (double)var1.getMaxBlockZ());
   }
   ...
   public Vec3 clampVec3ToBound(double var1, double var3, double var5) {
      return new Vec3(
         Mth.clamp(var1, this.getMinX(), this.getMaxX() - 9.999999747378752E-6), var3, Mth.clamp(var5, this.getMinZ(), this.getMaxZ() - 9.999999747378752E-6)
      );
   }
   ...
   class MovingBorderExtent implements WorldBorder.BorderExtent {
      ...
      MovingBorderExtent(final double nullx, final double nullxx, final long nullxxx) {
         ...
         this.from = nullx;
         this.to = nullxx;
         this.lerpDuration = (double)nullxxx;
         this.lerpBegin = Util.getMillis();
         this.lerpEnd = this.lerpBegin + nullxxx;
      }
