...
public class WorldBorder {
   ...
   public BlockPos clampToBounds(double var1, double var3, double var5) {
      return new BlockPos(Mth.clamp(var1, this.getMinX(), this.getMaxX()), var3, Mth.clamp(var5, this.getMinZ(), this.getMaxZ()));
   }
   ...
   class MovingBorderExtent implements WorldBorder.BorderExtent {
      ...
      private final double field_438;
      ...
      public double getSize() {
         ...
         return var1 < 1.0D ? Mth.lerp(var1, this.from, this.field_438) : this.field_438;
      }

      public double getLerpSpeed() {
         return Math.abs(this.from - this.field_438) / (double)(this.lerpEnd - this.lerpBegin);
      }
      ...
      public BorderStatus getStatus() {
         return this.field_438 < this.from ? BorderStatus.SHRINKING : BorderStatus.GROWING;
      }
      ...
      public WorldBorder.BorderExtent update() {
         return (WorldBorder.BorderExtent)(this.getLerpRemainingTime() <= 0L ? WorldBorder.this.new StaticBorderExtent(this.field_438) : this);
      }
   ...
   public static class Settings {
      ...
      public static WorldBorder.Settings read(DynamicLike<?> var0, WorldBorder.Settings var1) {
         double var2 = Mth.clamp(var0.get("BorderCenterX").asDouble(var1.centerX), -2.9999984E7D, 2.9999984E7D);
         double var4 = Mth.clamp(var0.get("BorderCenterZ").asDouble(var1.centerZ), -2.9999984E7D, 2.9999984E7D);
