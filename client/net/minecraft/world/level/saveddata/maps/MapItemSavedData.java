...
public class MapItemSavedData extends SavedData {
   ...
   public final int field_181;
   // $FF: renamed from: z int
   public final int field_182;
   ...
   public CompoundTag save(CompoundTag var1) {
      ...
      var1.putInt("xCenter", this.field_181);
      var1.putInt("zCenter", this.field_182);
   ...
   public MapItemSavedData locked() {
      MapItemSavedData var1 = new MapItemSavedData(this.field_181, this.field_182, this.scale, this.trackingPosition, this.unlimitedTracking, true, this.dimension);
   ...
   public MapItemSavedData scaled(int var1) {
      return createFresh((double)this.field_181, (double)this.field_182, (byte)Mth.clamp((int)(this.scale + var1), (int)0, (int)4), this.trackingPosition, this.unlimitedTracking, this.dimension);
   }
   ...
   private void addDecoration(MapDecoration.Type var1, @Nullable LevelAccessor var2, String var3, double var4, double var6, double var8, @Nullable Component var10) {
      ...
      float var12 = (float)(var4 - (double)this.field_181) / (float)var11;
      float var13 = (float)(var6 - (double)this.field_182) / (float)var11;
   ...
   public boolean toggleBanner(LevelAccessor var1, BlockPos var2) {
      ...
      double var8 = (var3 - (double)this.field_181) / (double)var7;
      double var10 = (var5 - (double)this.field_182) / (double)var7;
      boolean var12 = true;
