...
public abstract class LayerLightSectionStorage<M extends DataLayerStorageMap<M>> extends SectionTracker {
   ...
   protected void setStoredLevel(long var1, int var3) {
      ...
      SectionPos.aroundAndAtBlockPos(var1, var10001::add);
   }
   ...
   protected void setLevel(long var1, int var3) {
      ...
      if (var4 >= 2 && var3 != 2) {
         if (this.toRemove.contains(var1)) {
            ...
            int var5 = SectionPos.method_75(var1);
            int var6 = SectionPos.method_76(var1);
            int var7 = SectionPos.method_77(var1);
   ...
   protected void clearQueuedSectionBlocks(LayerLightEngine<?, ?> var1, long var2) {
      if (var1.getQueueSize() != 0) {
         if (var1.getQueueSize() < 8192) {
            ...
            int var4 = SectionPos.sectionToBlockCoord(SectionPos.method_75(var2));
            int var5 = SectionPos.sectionToBlockCoord(SectionPos.method_76(var2));
            int var6 = SectionPos.sectionToBlockCoord(SectionPos.method_77(var2));
   ...
   protected void swapSectionMap() {
      ...
      if (!this.sectionsAffectedByLightUpdates.isEmpty()) {
         ...
         while(var4.hasNext()) {
            ...
            this.chunkSource.onLightUpdate(this.layer, SectionPos.method_74(var2));
         }
