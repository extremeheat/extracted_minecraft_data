...
public class SkyLightSectionStorage extends LayerLightSectionStorage<SkyDataLayerStorageMap> {
   ...
   protected void onNodeAdded(long var1) {
      ...
      if (var6 < var3 + 1) {
         ...
         if (this.columnsWithSkySources.contains(var4)) {
            ...
            if (var6 > ((SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY) {
   ...
   protected void onNodeRemoved(long var1) {
      ...
      if (((SkyDataLayerStorageMap)this.updatingSectionData).topSections.get(var3) == var6 + 1) {
         long var7;
         ...
         if (this.storingLightForSection(var7)) {
            ((SkyDataLayerStorageMap)this.updatingSectionData).topSections.put(var3, var6 + 1);
            if (var5) {
   ...
   protected void enableLightSources(long var1, boolean var3) {
      ...
      if (var3 && this.columnsWithSkySources.add(var1)) {
         int var4 = ((SkyDataLayerStorageMap)this.updatingSectionData).topSections.get(var1);
   ...
   protected DataLayer createDataLayer(long var1) {
      ...
      if (var3 != null) {
         ...
         int var6 = ((SkyDataLayerStorageMap)this.updatingSectionData).topSections.get(SectionPos.getZeroNode(var1));
         if (var6 != ((SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY && SectionPos.y(var4) < var6) {
            DataLayer var7;
   ...
   protected void markNewInconsistencies(LayerLightEngine<SkyDataLayerStorageMap, ?> var1, boolean var2, boolean var3) {
               ...
               while(true) {
                  ...
                  if (var7 == 1) {
                     ...
                     if (this.changedSections.add(var5)) {
                        ((SkyDataLayerStorageMap)this.updatingSectionData).copyDataLayer(var5);
                     }
