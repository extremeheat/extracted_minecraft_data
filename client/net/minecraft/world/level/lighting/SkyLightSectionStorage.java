...
public class SkyLightSectionStorage extends LayerLightSectionStorage<SkyLightSectionStorage.SkyDataLayerStorageMap> {
   ...
   protected int getLightValue(long var1, boolean var3) {
      ...
      int var6 = SectionPos.method_76(var4);
      ...
      if (var8 != var7.currentLowestY && var6 < var8) {
         ...
         if (var9 == null) {
            for(var1 = BlockPos.getFlatIndex(var1); var9 == null; var9 = this.getDataLayer(var7, var4)) {
               ...
               var4 = SectionPos.offset(var4, Direction.field_526);
            }
         }
   ...
   protected void onNodeAdded(long var1) {
      int var3 = SectionPos.method_76(var1);
      ...
      if (var6 < var3 + 1) {
         ...
         if (this.columnsWithSkySources.contains(var4)) {
            ...
            if (var6 > ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY) {
               long var7 = SectionPos.asLong(SectionPos.method_75(var1), var6 - 1, SectionPos.method_77(var1));
   ...
   protected void onNodeRemoved(long var1) {
      ...
      int var6 = SectionPos.method_76(var1);
   ...
   protected void enableLightSources(long var1, boolean var3) {
      ...
      if (var3 && this.columnsWithSkySources.add(var1)) {
         ...
         if (var4 != ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY) {
            long var5 = SectionPos.asLong(SectionPos.method_75(var1), var4 - 1, SectionPos.method_77(var1));
   ...
   protected DataLayer createDataLayer(long var1) {
      ...
      if (var3 != null) {
         ...
         long var4 = SectionPos.offset(var1, Direction.field_526);
         ...
         if (var6 != ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY && SectionPos.method_76(var4) < var6) {
            DataLayer var7;
            ...
            while(true) {
               while(true) {
                  ...
                  if (var7 == 1) {
                     ...
                     var8 = SectionPos.sectionToBlockCoord(SectionPos.method_75(var5));
                     var9 = SectionPos.sectionToBlockCoord(SectionPos.method_76(var5));
                     int var24 = SectionPos.sectionToBlockCoord(SectionPos.method_77(var5));
                     ...
                     for(int var25 = 0; var25 < 16; ++var25) {
                        for(var12 = 0; var12 < 16; ++var12) {
                           long var26 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.method_75(var5), var25), SectionPos.sectionToBlockCoord(SectionPos.method_76(var5)), SectionPos.sectionToBlockCoord(SectionPos.method_77(var5), var12));
                           var15 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.method_75(var5), var25), SectionPos.sectionToBlockCoord(SectionPos.method_76(var5)) - 1, SectionPos.sectionToBlockCoord(SectionPos.method_77(var5), var12));
                     ...
                     for(var8 = 0; var8 < 16; ++var8) {
                        for(var9 = 0; var9 < 16; ++var9) {
                           long var10 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.method_75(var5), var8), SectionPos.sectionToBlockCoord(SectionPos.method_76(var5), 15), SectionPos.sectionToBlockCoord(SectionPos.method_77(var5), var9));
         ...
         if (!this.sectionsToRemoveSourcesFrom.isEmpty()) {
            ...
            while(true) {
               ...
               for(var7 = 0; var7 < 16; ++var7) {
                  for(var8 = 0; var8 < 16; ++var8) {
                     long var23 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.method_75(var5), var7), SectionPos.sectionToBlockCoord(SectionPos.method_76(var5), 15), SectionPos.sectionToBlockCoord(SectionPos.method_77(var5), var8));
   ...
   protected boolean isAboveData(long var1) {
      ...
      return var5 == ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY || SectionPos.method_76(var1) >= var5;
   }
