...
public class SaveFormatOld implements ISaveFormat {
         ...
         if (var4 != null) {
            var1.add(
               new SaveFormatComparator(
                  var3, "", var4.func_76057_l(), var4.func_76092_g(), var4.func_76077_q(), false, var4.func_76093_s(), var4.func_76086_u()
               )
            );
         }
      }
   ...
   public WorldInfo func_75803_c(String var1) {
      ...
      if (!var2.exists()) {
         ...
         if (var3.exists()) {
            try {
               NBTTagCompound var9 = CompressedStreamTools.func_74796_a(new FileInputStream(var3));
               NBTTagCompound var10 = var9.func_74775_l("Data");
         ...
         if (var3.exists()) {
            try {
               NBTTagCompound var4 = CompressedStreamTools.func_74796_a(new FileInputStream(var3));
               NBTTagCompound var5 = var4.func_74775_l("Data");
