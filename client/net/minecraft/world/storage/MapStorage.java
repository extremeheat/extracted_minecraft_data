...
public class MapStorage {
   ...
   public WorldSavedData func_75742_a(Class var1, String var2) {
      ...
      if (this.field_75751_a == null) {
         ...
         try {
            ...
            if (var3 != null) {
               ...
               for(String var6 : this.field_75748_d.keySet()) {
                  short var7 = this.field_75748_d.get(var6);
                  var4.func_74777_a(var6, var7);
               }

               DataOutputStream var10 = new DataOutputStream(new FileOutputStream(var3));
               CompressedStreamTools.func_74800_a(var4, var10);
               var10.close();
            }
         } catch (Exception var8) {
            var8.printStackTrace();
