...
public class ObjectiveCriteria {
   ...
   public static Optional<ObjectiveCriteria> byName(String var0) {
      ...
      if (var1 != null) {
         ...
         return var2 < 0 ? Optional.empty() : Registry.STAT_TYPE.getOptional(ResourceLocation.method_104(var0.substring(0, var2), '.')).flatMap((var2x) -> {
            return getStat(var2x, ResourceLocation.method_104(var0.substring(var2 + 1), '.'));
         });
      }
   }
   ...
   public static enum RenderType {
      ...
      private final String field_211;
      ...
      // $FF: synthetic method
      private static ObjectiveCriteria.RenderType[] $values() {
         return new ObjectiveCriteria.RenderType[]{INTEGER, HEARTS};
      }
