...
public final class JungleHillsBiome extends Biome {
   public JungleHillsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.JUNGLE).func_205421_a(0.45F).func_205420_b(0.3F).func_205414_c(0.95F).func_205417_d(0.9F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202331_i, new JunglePyramidConfig());
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202292_al, new RandomDefaultFeatureListConfig(new Feature[]{Feature.field_202339_q, Feature.field_202342_t, Feature.field_202302_B}, new IFeatureConfig[]{IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e}, new float[]{0.1F, 0.5F, 0.33333334F}, Feature.field_202343_u, IFeatureConfig.field_202429_e), field_201922_q, new AtSurfaceWithExtraConfig(50, 0.1F, 1)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201861_a(Feature.field_202305_E, field_201912_g, new FrequencyConfig(4)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202309_I, IFeatureConfig.field_202429_e, field_201913_h, new FrequencyConfig(25)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202322_V, IFeatureConfig.field_202429_e, field_201913_h, new FrequencyConfig(1)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202326_Z, IFeatureConfig.field_202429_e, field_201914_i, new FrequencyConfig(50)));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200783_W, 10, 1, 1));
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200795_i, 10, 4, 4));
      ...
      this.func_201866_a(EnumCreatureType.MONSTER, new Biome.SpawnListEntry(EntityType.field_200781_U, 2, 1, 1));
   }
}
