...
public final class ShatteredSavannaBiome extends Biome {
   public ShatteredSavannaBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_201900_T, field_203961_Z)).func_205415_a(Biome.RainType.NONE).func_205419_a(Biome.Category.SAVANNA).func_205421_a(0.3625F).func_205420_b(1.225F).func_205414_c(1.1F).func_205417_d(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("savanna"));
