...
public final class FrozenRiverBiome extends Biome {
   public FrozenRiverBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.SNOW).func_205419_a(Biome.Category.RIVER).func_205421_a(-0.5F).func_205420_b(0.0F).func_205414_c(0.0F).func_205417_d(0.5F).func_205412_a(3750089).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_201866_a(EnumCreatureType.MONSTER, new Biome.SpawnListEntry(EntityType.field_204724_o, 1, 1, 1));
