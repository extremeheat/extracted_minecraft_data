...
public final class BirchForestHillsBiome extends Biome {
   public BirchForestHillsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.FOREST).func_205421_a(0.45F).func_205420_b(0.3F).func_205414_c(0.6F).func_205417_d(0.6F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202340_r, IFeatureConfig.field_202429_e, field_201922_q, new AtSurfaceWithExtraConfig(10, 0.1F, 1)));
