...
public final class WoodedMountainsBiome extends Biome {
   protected WoodedMountainsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.EXTREME_HILLS).func_205421_a(1.0F).func_205420_b(0.5F).func_205414_c(0.2F).func_205417_d(0.3F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202292_al, new RandomDefaultFeatureListConfig(new Feature[]{Feature.field_202347_y, Feature.field_202339_q}, new IFeatureConfig[]{IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e}, new float[]{0.666F, 0.1F}, Feature.field_202301_A, IFeatureConfig.field_202429_e), field_201922_q, new AtSurfaceWithExtraConfig(3, 0.1F, 1)));
      ...
      this.func_203611_a(GenerationStage.Decoration.UNDERGROUND_ORES, func_201864_a(Feature.field_202294_an, new ReplaceBlockConfig(BlockMatcher.func_177642_a(Blocks.field_150348_b), Blocks.field_150412_bA.func_176223_P()), field_201882_B, IPlacementConfig.field_202468_e));
      this.func_203611_a(GenerationStage.Decoration.UNDERGROUND_DECORATION, func_201864_a(Feature.field_202290_aj, new MinableConfig(MinableConfig.field_202441_a, Blocks.field_196686_dc.func_176223_P(), 9), field_201923_r, new CountRangeConfig(7, 0, 0, 64)));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200769_I, 5, 4, 6));
