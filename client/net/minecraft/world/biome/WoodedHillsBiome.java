...
public final class WoodedHillsBiome extends Biome {
   public WoodedHillsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.FOREST).func_205421_a(0.45F).func_205420_b(0.3F).func_205414_c(0.7F).func_205417_d(0.8F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202292_al, new RandomDefaultFeatureListConfig(new Feature[]{Feature.field_202340_r, Feature.field_202339_q}, new IFeatureConfig[]{IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e}, new float[]{0.2F, 0.1F}, Feature.field_202301_A, IFeatureConfig.field_202429_e), field_201922_q, new AtSurfaceWithExtraConfig(10, 0.1F, 1)));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200724_aC, 5, 4, 4));
