...
public class LukewarmOceanBiome extends Biome {
   public LukewarmOceanBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203951_af)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.OCEAN).func_205421_a(-1.0F).func_205420_b(0.1F).func_205414_c(0.5F).func_205417_d(0.5F).func_205412_a(4566514).func_205413_b(267827).func_205418_a((String)null));
      ...
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_200749_ao, 10, 1, 2));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_203780_j, 15, 3, 6));
