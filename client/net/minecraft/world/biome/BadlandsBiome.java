...
public final class BadlandsBiome extends Biome {
   public BadlandsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_201904_X, field_203953_ah)).func_205415_a(Biome.RainType.NONE).func_205419_a(Biome.Category.MESA).func_205421_a(0.1F).func_205420_b(0.2F).func_205414_c(2.0F).func_205417_d(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
