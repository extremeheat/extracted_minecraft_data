...
public class DeepWarmOceanBiome extends Biome {
   public DeepWarmOceanBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203950_ae)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.OCEAN).func_205421_a(-1.8F).func_205420_b(0.1F).func_205414_c(0.5F).func_205417_d(0.5F).func_205412_a(4445678).func_205413_b(270131).func_205418_a((String)null));
      ...
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_200749_ao, 5, 1, 4));
