...
public class WarmOceanBiome extends Biome {
   public WarmOceanBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203950_ae)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.OCEAN).func_205421_a(-1.0F).func_205420_b(0.1F).func_205414_c(0.5F).func_205417_d(0.5F).func_205412_a(4445678).func_205413_b(270131).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_204620_ao, new RandomFeatureWithConfigConfig(new Feature[]{Feature.field_204621_ay, Feature.field_204619_aA, Feature.field_204622_az}, new IFeatureConfig[]{IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e}), field_204618_C, new TopSolidWithNoiseConfig(20, 400.0D)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203234_at, new SeaGrassConfig(80, 0.3D), field_203197_y, IPlacementConfig.field_202468_e));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_204914_aC, new CountConfig(20), field_204908_s, new ChanceConfig(16)));
      ...
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_200749_ao, 10, 4, 4));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_203779_Z, 15, 1, 3));
