...
public final class DeepOceanBiome extends Biome {
   public DeepOceanBiome() {
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203234_at, new SeaGrassConfig(48, 0.8D), field_203197_y, IPlacementConfig.field_202468_e));
      ...
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_203780_j, 10, 3, 6));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_205137_n, 1, 1, 2));
