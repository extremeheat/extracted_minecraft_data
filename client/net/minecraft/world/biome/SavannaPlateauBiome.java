...
public final class SavannaPlateauBiome extends Biome {
   protected SavannaPlateauBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.NONE).func_205419_a(Biome.Category.SAVANNA).func_205421_a(1.5F).func_205420_b(0.025F).func_205414_c(1.0F).func_205417_d(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202286_af, new DoublePlantConfig(Blocks.field_196804_gh.func_176223_P()), field_201912_g, new FrequencyConfig(7)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202292_al, new RandomDefaultFeatureListConfig(new Feature[]{Feature.field_202346_x}, new IFeatureConfig[]{IFeatureConfig.field_202429_e}, new float[]{0.8F}, Feature.field_202301_A, IFeatureConfig.field_202429_e), field_201922_q, new AtSurfaceWithExtraConfig(1, 0.1F, 1)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202311_K, new TallGrassConfig(Blocks.field_150349_c.func_176223_P()), field_201913_h, new FrequencyConfig(20)));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200762_B, 1, 2, 6));
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200798_l, 1, 1, 1));
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200769_I, 8, 4, 4));
