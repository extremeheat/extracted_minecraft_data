...
public final class MushroomFieldShoreBiome extends Biome {
   public MushroomFieldShoreBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203954_ai)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.MUSHROOM).func_205421_a(0.0F).func_205420_b(0.025F).func_205414_c(0.9F).func_205417_d(1.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202293_am, new TwoFeatureChoiceConfig(Feature.field_202318_R, IFeatureConfig.field_202429_e, Feature.field_202319_S, IFeatureConfig.field_202429_e), field_201910_e, new FrequencyConfig(1)));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200780_T, 8, 4, 8));
