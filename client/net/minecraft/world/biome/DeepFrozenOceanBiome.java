...
public class DeepFrozenOceanBiome extends Biome {
   ...
   public DeepFrozenOceanBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_205160_ax, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.OCEAN).func_205421_a(-1.8F).func_205420_b(0.1F).func_205414_c(0.5F).func_205417_d(0.5F).func_205412_a(3750089).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_204029_o, new OceanRuinConfig(OceanRuinStructure.Type.COLD, 0.3F, 0.9F));
      this.func_201865_a(Feature.field_202336_n, new OceanMonumentConfig());
      ...
      this.func_203609_a(GenerationStage.Carving.AIR, func_203606_a(field_201907_b, new ProbabilityConfig(0.06666667F)));
      this.func_203609_a(GenerationStage.Carving.AIR, func_203606_a(field_201909_d, new ProbabilityConfig(0.02F)));
      this.func_203609_a(GenerationStage.Carving.LIQUID, func_203606_a(field_203612_e, new ProbabilityConfig(0.02F)));
      this.func_203609_a(GenerationStage.Carving.LIQUID, func_203606_a(field_203613_f, new ProbabilityConfig(0.06666667F)));
      this.func_203605_a();
      ...
      this.func_203611_a(GenerationStage.Decoration.LOCAL_MODIFICATIONS, func_201864_a(Feature.field_205172_ag, new IcebergConfig(Blocks.field_150403_cj.func_176223_P()), field_205161_N, new ChanceConfig(16)));
      this.func_203611_a(GenerationStage.Decoration.LOCAL_MODIFICATIONS, func_201864_a(Feature.field_205172_ag, new IcebergConfig(Blocks.field_205164_gk.func_176223_P()), field_205161_N, new ChanceConfig(200)));
      ...
      this.func_203611_a(GenerationStage.Decoration.SURFACE_STRUCTURES, func_201864_a(Feature.field_205171_af, IFeatureConfig.field_202429_e, field_205162_x, new CountRangeConfig(20, 30, 32, 64)));
   ...
   public float func_180626_a(BlockPos var1) {
      float var2 = this.func_185353_n();
      double var3 = field_206856_bb.func_151601_a((double)var1.func_177958_n() * 0.05D, (double)var1.func_177952_p() * 0.05D);
      double var5 = field_180281_af.func_151601_a((double)var1.func_177958_n() * 0.2D, (double)var1.func_177952_p() * 0.2D);
      double var7 = var3 + var5;
      if (var7 < 0.3D) {
         double var9 = field_180281_af.func_151601_a((double)var1.func_177958_n() * 0.09D, (double)var1.func_177952_p() * 0.09D);
         if (var9 < 0.8D) {
            var2 = 0.2F;
         }
      }
      ...
      if (var1.func_177956_o() > 64) {
         float var11 = (float)(field_150605_ac.func_151601_a((double)((float)var1.func_177958_n() / 8.0F), (double)((float)var1.func_177952_p() / 8.0F)) * 4.0D);
         return var2 - (var11 + (float)var1.func_177956_o() - 64.0F) * 0.05F / 30.0F;
      } else {
         return var2;
      }
   }
