...
public final class DesertBiome extends Biome {
   public DesertBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203952_ag)).func_205415_a(Biome.RainType.NONE).func_205419_a(Biome.Category.DESERT).func_205421_a(0.125F).func_205420_b(0.05F).func_205414_c(2.0F).func_205417_d(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202328_f, new VillageConfig(0, VillagePieces.Type.SANDSTONE));
      this.func_201865_a(Feature.field_202332_j, new DesertPyramidConfig());
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202314_N, IFeatureConfig.field_202429_e, field_201913_h, new FrequencyConfig(2)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202324_X, IFeatureConfig.field_202429_e, field_201913_h, new FrequencyConfig(60)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202313_M, IFeatureConfig.field_202429_e, field_201913_h, new FrequencyConfig(10)));
      ...
      this.func_203611_a(GenerationStage.Decoration.SURFACE_STRUCTURES, func_201864_a(Feature.field_202315_O, IFeatureConfig.field_202429_e, field_201919_n, new ChanceConfig(1000)));
      ...
      this.func_201866_a(EnumCreatureType.MONSTER, new Biome.SpawnListEntry(EntityType.field_200725_aD, 19, 4, 4));
      this.func_201866_a(EnumCreatureType.MONSTER, new Biome.SpawnListEntry(EntityType.field_200727_aF, 1, 1, 1));
      this.func_201866_a(EnumCreatureType.MONSTER, new Biome.SpawnListEntry(EntityType.field_200763_C, 80, 4, 4));
   }
}
