...
public final class SunflowerPlainsBiome extends Biome {
   protected SunflowerPlainsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.PLAINS).func_205421_a(0.125F).func_205420_b(0.05F).func_205414_c(0.8F).func_205417_d(0.4F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("plains"));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202286_af, new DoublePlantConfig(Blocks.field_196804_gh.func_176223_P()), field_201915_j, new NoiseDependant(-0.8D, 0, 7)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202286_af, new DoublePlantConfig(Blocks.field_196800_gd.func_176223_P()), field_201912_g, new FrequencyConfig(10)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202292_al, new RandomDefaultFeatureListConfig(new Feature[]{Feature.field_202339_q}, new IFeatureConfig[]{IFeatureConfig.field_202429_e}, new float[]{0.33333334F}, Feature.field_202301_A, IFeatureConfig.field_202429_e), field_201922_q, new AtSurfaceWithExtraConfig(0, 0.05F, 1)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201861_a(Feature.field_202307_G, field_201915_j, new NoiseDependant(-0.8D, 15, 4)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202311_K, new TallGrassConfig(Blocks.field_150349_c.func_176223_P()), field_201916_k, new NoiseDependant(-0.8D, 5, 10)));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200762_B, 5, 2, 6));
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_200798_l, 1, 1, 3));
