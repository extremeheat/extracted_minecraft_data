...
public class DeepColdOceanBiome extends Biome {
   public DeepColdOceanBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.OCEAN).func_205421_a(-1.8F).func_205420_b(0.1F).func_205414_c(0.5F).func_205417_d(0.5F).func_205412_a(4020182).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203234_at, new SeaGrassConfig(40, 0.8D), field_203197_y, IPlacementConfig.field_202468_e));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203235_au, IFeatureConfig.field_202429_e, field_204618_C, new TopSolidWithNoiseConfig(120, 80.0D)));
      ...
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_200749_ao, 3, 1, 4));
