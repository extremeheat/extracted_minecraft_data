...
public final class GravellyMountainsBiome extends Biome {
   protected GravellyMountainsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_201901_U, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.EXTREME_HILLS).func_205421_a(1.0F).func_205420_b(0.5F).func_205414_c(0.2F).func_205417_d(0.3F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("mountains"));
