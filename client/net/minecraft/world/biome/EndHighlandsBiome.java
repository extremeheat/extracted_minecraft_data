...
public class EndHighlandsBiome extends Biome {
   public EndHighlandsBiome() {
      ...
      this.func_201865_a(Feature.field_202338_p, new EndCityConfig());
      this.func_203611_a(GenerationStage.Decoration.SURFACE_STRUCTURES, func_201864_a(Feature.field_202299_as, new EndGatewayConfig(true), field_201891_K, IPlacementConfig.field_202468_e));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202298_ar, IFeatureConfig.field_202429_e, field_201890_J, IPlacementConfig.field_202468_e));
