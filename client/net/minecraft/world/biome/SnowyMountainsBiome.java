...
public final class SnowyMountainsBiome extends Biome {
   public SnowyMountainsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.SNOW).func_205419_a(Biome.Category.ICY).func_205421_a(0.45F).func_205420_b(0.3F).func_205414_c(0.0F).func_205417_d(0.5F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
