...
public class WorldChunkManager {
   ...
   private BiomeCache field_76942_f = new BiomeCache(this);
   private List field_76943_g = new ArrayList();
   ...
   public WorldChunkManager(long var1, WorldType var3) {
      this();
      GenLayer[] var4 = GenLayer.func_75901_a(var1, var3);
      this.field_76944_d = var4[0];
      this.field_76945_e = var4[1];
   }

   public WorldChunkManager(World var1) {
      this(var1.func_72905_C(), var1.func_72912_H().func_76067_t());
   }
   ...
   public BiomeGenBase func_76935_a(int var1, int var2) {
      return this.field_76942_f.func_76837_b(var1, var2);
   }
   ...
   public BiomeGenBase[] func_76937_a(BiomeGenBase[] var1, int var2, int var3, int var4, int var5) {
      ...
      try {
         for(int var7 = 0; var7 < var4 * var5; ++var7) {
            var1[var7] = BiomeGenBase.func_150568_d(var6[var7]);
         }
   ...
   public BiomeGenBase[] func_76931_a(BiomeGenBase[] var1, int var2, int var3, int var4, int var5, boolean var6) {
      ...
      if (var6 && var4 == 16 && var5 == 16 && (var2 & 15) == 0 && (var3 & 15) == 0) {
         ...
         for(int var8 = 0; var8 < var4 * var5; ++var8) {
            var1[var8] = BiomeGenBase.func_150568_d(var7[var8]);
         }
