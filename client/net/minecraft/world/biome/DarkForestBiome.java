...
public final class DarkForestBiome extends Biome {
   public DarkForestBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.FOREST).func_205421_a(0.1F).func_205420_b(0.2F).func_205414_c(0.7F).func_205417_d(0.8F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202330_h, new WoodlandMansionConfig());
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202292_al, new RandomDefaultFeatureListConfig(new Feature[]{Feature.field_202319_S, Feature.field_202318_R, Feature.field_202345_w, Feature.field_202339_q}, new IFeatureConfig[]{IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e, IFeatureConfig.field_202429_e}, new float[]{0.025F, 0.05F, 0.6666667F, 0.1F}, Feature.field_202301_A, IFeatureConfig.field_202429_e), field_201886_F, IPlacementConfig.field_202468_e));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202291_ak, new RandomFeatureListConfig(new Feature[]{Feature.field_202286_af, Feature.field_202286_af, Feature.field_202286_af}, new IFeatureConfig[]{new DoublePlantConfig(Blocks.field_196801_ge.func_176223_P()), new DoublePlantConfig(Blocks.field_196802_gf.func_176223_P()), new DoublePlantConfig(Blocks.field_196803_gg.func_176223_P())}, 0), field_201912_g, new FrequencyConfig(5)));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202311_K, new TallGrassConfig(Blocks.field_150349_c.func_176223_P()), field_201913_h, new FrequencyConfig(2)));
   ...
   public int func_180627_b(BlockPos var1) {
      ...
      return (var2 & 16711422) + 2634762 >> 1;
   }
}
