...
public class DeepLukewarmOceanBiome extends Biome {
   public DeepLukewarmOceanBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203951_af)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.OCEAN).func_205421_a(-1.8F).func_205420_b(0.1F).func_205414_c(0.5F).func_205417_d(0.5F).func_205412_a(4566514).func_205413_b(267827).func_205418_a((String)null));
      this.func_201865_a(Feature.field_204029_o, new OceanRuinConfig(OceanRuinStructure.Type.WARM, 0.3F, 0.9F));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203234_at, new SeaGrassConfig(80, 0.8D), field_203197_y, IPlacementConfig.field_202468_e));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_206922_aF, new BlockWithContextConfig(Blocks.field_203198_aQ.func_176223_P(), new IBlockState[]{Blocks.field_150348_b.func_176223_P()}, new IBlockState[]{Blocks.field_150355_j.func_176223_P()}, new IBlockState[]{Blocks.field_150355_j.func_176223_P()}), field_206855_F, new CaveEdgeConfig(GenerationStage.Carving.LIQUID, 0.1F)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203235_au, IFeatureConfig.field_202429_e, field_204618_C, new TopSolidWithNoiseConfig(80, 80.0D)));
      ...
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_200749_ao, 8, 1, 4));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_203780_j, 8, 3, 6));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_203779_Z, 5, 1, 3));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_204262_at, 25, 8, 8));
      this.func_201866_a(EnumCreatureType.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.field_205137_n, 2, 1, 2));
