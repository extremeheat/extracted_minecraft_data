...
public final class SnowyBeachBiome extends Biome {
   public SnowyBeachBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203952_ag)).func_205415_a(Biome.RainType.SNOW).func_205419_a(Biome.Category.BEACH).func_205421_a(0.0F).func_205420_b(0.025F).func_205414_c(0.05F).func_205417_d(0.3F).func_205412_a(4020182).func_205413_b(329011).func_205418_a((String)null));
