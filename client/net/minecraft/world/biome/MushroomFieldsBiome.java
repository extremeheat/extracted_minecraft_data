...
public final class MushroomFieldsBiome extends Biome {
   public MushroomFieldsBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203954_ai)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.MUSHROOM).func_205421_a(0.2F).func_205420_b(0.3F).func_205414_c(0.9F).func_205417_d(1.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
