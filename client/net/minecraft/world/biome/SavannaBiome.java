...
public final class SavannaBiome extends Biome {
   protected SavannaBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.NONE).func_205419_a(Biome.Category.SAVANNA).func_205421_a(0.125F).func_205420_b(0.05F).func_205414_c(1.2F).func_205417_d(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202328_f, new VillageConfig(0, VillagePieces.Type.ACACIA));
