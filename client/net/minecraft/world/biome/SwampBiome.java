...
public final class SwampBiome extends Biome {
   protected SwampBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_201903_W, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.SWAMP).func_205421_a(-0.2F).func_205420_b(0.1F).func_205414_c(0.8F).func_205417_d(0.9F).func_205412_a(6388580).func_205413_b(2302743).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202334_l, new SwampHutConfig());
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_203234_at, new SeaGrassConfig(64, 0.6D), field_203197_y, IPlacementConfig.field_202468_e));
