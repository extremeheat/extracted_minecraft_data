...
public final class TaigaBiome extends Biome {
   public TaigaBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203961_Z)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.TAIGA).func_205421_a(0.2F).func_205420_b(0.2F).func_205414_c(0.25F).func_205417_d(0.8F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202328_f, new VillageConfig(0, VillagePieces.Type.SPRUCE));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202310_J, IFeatureConfig.field_202429_e, field_201913_h, new FrequencyConfig(1)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202284_ad, new BushConfig(Blocks.field_150338_P), field_201927_v, new HeightWithChanceConfig(1, 0.25F)));
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202284_ad, new BushConfig(Blocks.field_150337_Q), field_201928_w, new HeightWithChanceConfig(1, 0.125F)));
