...
public final class ModifiedWoodedBadlandsPlateauBiome extends Biome {
   public ModifiedWoodedBadlandsPlateauBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_201905_Y, field_203953_ah)).func_205415_a(Biome.RainType.NONE).func_205419_a(Biome.Category.MESA).func_205421_a(0.45F).func_205420_b(0.3F).func_205414_c(2.0F).func_205417_d(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("wooded_badlands_plateau"));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, func_201864_a(Feature.field_202301_A, IFeatureConfig.field_202429_e, field_201922_q, new AtSurfaceWithExtraConfig(5, 0.1F, 1)));
