...
public final class BeachBiome extends Biome {
   public BeachBiome() {
      super((new Biome.BiomeBuilder()).func_205416_a(new CompositeSurfaceBuilder(field_203955_aj, field_203952_ag)).func_205415_a(Biome.RainType.RAIN).func_205419_a(Biome.Category.BEACH).func_205421_a(0.0F).func_205420_b(0.025F).func_205414_c(0.8F).func_205417_d(0.4F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      this.func_201865_a(Feature.field_202329_g, new MineshaftConfig(0.004D, MineshaftStructure.Type.NORMAL));
      this.func_201865_a(Feature.field_204292_r, new BuriedTreasureConfig(0.01F));
      this.func_201865_a(Feature.field_204751_l, new ShipwreckConfig(true));
      ...
      this.func_201866_a(EnumCreatureType.CREATURE, new Biome.SpawnListEntry(EntityType.field_203099_aq, 5, 2, 5));
