...
public class CompoundContainer implements Container {
   ...
   public ItemStack removeItem(int var1, int var2) {
      return var1 >= this.container1.getContainerSize()
         ? this.container2.removeItem(var1 - this.container1.getContainerSize(), var2)
         : this.container1.removeItem(var1, var2);
   }

   @Override
   public ItemStack removeItemNoUpdate(int var1) {
      return var1 >= this.container1.getContainerSize()
         ? this.container2.removeItemNoUpdate(var1 - this.container1.getContainerSize())
         : this.container1.removeItemNoUpdate(var1);
   }
   ...
   public boolean canPlaceItem(int var1, ItemStack var2) {
      return var1 >= this.container1.getContainerSize()
         ? this.container2.canPlaceItem(var1 - this.container1.getContainerSize(), var2)
         : this.container1.canPlaceItem(var1, var2);
   }
