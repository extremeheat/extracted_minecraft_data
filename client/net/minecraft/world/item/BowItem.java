   ...
   public void releaseUsing(ItemStack var1, Level var2, LivingEntity var3, int var4) {
      if (var3 instanceof Player) {
         ...
         if (!var7.isEmpty() || var6) {
            ...
            if (!((double)var9 < 0.1D)) {
               boolean var10 = var6 && var7.method_87(Items.ARROW);
               if (!var2.isClientSide) {
                  ...
                  if (var10 || var5.getAbilities().instabuild && (var7.method_87(Items.SPECTRAL_ARROW) || var7.method_87(Items.TIPPED_ARROW))) {
