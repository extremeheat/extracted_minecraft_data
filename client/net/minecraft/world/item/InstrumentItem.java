...
public class InstrumentItem extends Item {
   ...
   public int getUseDuration(ItemStack var1, LivingEntity var2) {
      ...
      return var3.<Integer>map(var0 -> Mth.floor(((Instrument)var0.value()).useDuration() * 20.0F)).orElse(0);
   }

   private Optional<Holder<Instrument>> getInstrument(ItemStack var1, HolderLookup.Provider var2) {
      Holder var3 = var1.get(DataComponents.INSTRUMENT);
      if (var3 != null) {
         ...
         if (var4.isPresent()) {
            ...
            if (var5.hasNext()) {
               return Optional.of((Holder<Instrument>)var5.next());
            }
         }
