...
public class InstrumentItem extends Item {
   ...
   public static void setRandom(ItemStack var0, TagKey<Instrument> var1, RandomSource var2) {
      Optional var3 = Registry.INSTRUMENT.getTag(var1).flatMap((var1x) -> {
         return var1x.getRandomElement(var2);
      });
      if (var3.isPresent()) {
         setSoundVariantId(var0, (Holder)var3.get());
      }
   ...
   private static void setSoundVariantId(ItemStack var0, Holder<Instrument> var1) {
      ...
      var2.putString("instrument", ((ResourceKey)var1.unwrapKey().orElseThrow(() -> {
   ...
   public void fillItemCategory(CreativeModeTab var1, NonNullList<ItemStack> var2) {
      if (this.allowedIn(var1)) {
         Iterator var3 = Registry.INSTRUMENT.getTagOrEmpty(this.instruments).iterator();
   ...
   private Optional<Holder<Instrument>> getInstrument(ItemStack var1) {
      ...
      return var4.hasNext() ? Optional.of((Holder)var4.next()) : Optional.empty();
   }
