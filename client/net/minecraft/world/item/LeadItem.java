...
public class LeadItem extends Item {
   ...
   public InteractionResult useOn(UseOnContext var1) {
      ...
      if (var4.is(BlockTags.FENCES)) {
         ...
         var2.gameEvent(GameEvent.BLOCK_ATTACH, var3, GameEvent.Context.of((Entity)var5));
   ...
   public static InteractionResult bindPlayerMobs(Player var0, Level var1, BlockPos var2) {
      ...
      int var8 = var2.getY();
      int var9 = var2.getZ();
      List var10 = var1.getEntitiesOfClass(Mob.class, new AABB((double)var7 - 7.0, (double)var8 - 7.0, (double)var9 - 7.0, (double)var7 + 7.0, (double)var8 + 7.0, (double)var9 + 7.0));
