...
public class MerchantOffer {
   ...
   public MerchantOffer(CompoundTag var1) {
      ...
      this.rewardExp = true;
      this.field_372 = 1;
      this.baseCostA = ItemStack.method_85(var1.getCompound("buy"));
      this.costB = ItemStack.method_85(var1.getCompound("buyB"));
      this.result = ItemStack.method_85(var1.getCompound("sell"));
   ...
   public boolean satisfiedBy(ItemStack var1, ItemStack var2) {
      return this.isRequiredItem(var1, this.getCostA()) && var1.getCount() >= this.getCostA().getCount() && this.isRequiredItem(var2, this.costB) && var2.getCount() >= this.costB.getCount();
   }
