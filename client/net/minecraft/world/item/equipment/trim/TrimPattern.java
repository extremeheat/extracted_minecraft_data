...
public record TrimPattern(Identifier assetId, Component description, boolean decal) {
   ...
   public TrimPattern(Identifier var1, Component var2, boolean var3) {
      super();
      this.assetId = var1;
