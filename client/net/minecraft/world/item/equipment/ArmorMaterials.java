...
public interface ArmorMaterials {
   ArmorMaterial LEATHER = new ArmorMaterial(5, Util.make(new EnumMap<>(ArmorType.class), var0 -> {
   ...
   ArmorMaterial DIAMOND = new ArmorMaterial(33, Util.make(new EnumMap<>(ArmorType.class), var0 -> {
   ...
   ArmorMaterial TURTLE_SCUTE = new ArmorMaterial(25, Util.make(new EnumMap<>(ArmorType.class), var0 -> {
      var0.put(ArmorType.BOOTS, 2);
      var0.put(ArmorType.LEGGINGS, 5);
      var0.put(ArmorType.CHESTPLATE, 6);
      var0.put(ArmorType.HELMET, 2);
   ...
   ArmorMaterial NETHERITE = new ArmorMaterial(37, Util.make(new EnumMap<>(ArmorType.class), var0 -> {
      var0.put(ArmorType.BOOTS, 3);
      var0.put(ArmorType.LEGGINGS, 6);
      var0.put(ArmorType.CHESTPLATE, 8);
      var0.put(ArmorType.HELMET, 3);
   ...
   ArmorMaterial ARMADILLO_SCUTE = new ArmorMaterial(4, Util.make(new EnumMap<>(ArmorType.class), var0 -> {
      var0.put(ArmorType.BOOTS, 3);
      var0.put(ArmorType.LEGGINGS, 6);
      var0.put(ArmorType.CHESTPLATE, 8);
      var0.put(ArmorType.HELMET, 3);
