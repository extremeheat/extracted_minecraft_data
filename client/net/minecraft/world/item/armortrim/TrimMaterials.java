...
public class TrimMaterials {
   ...
   public static void bootstrap(BootstrapContext<TrimMaterial> var0) {
      ...
      register(var0, IRON, Items.IRON_INGOT, Style.EMPTY.withColor(15527148), 0.02F, Map.of(ArmorMaterials.IRON, "iron_darker"));
      register(var0, NETHERITE, Items.NETHERITE_INGOT, Style.EMPTY.withColor(6445145), 0.03F, Map.of(ArmorMaterials.NETHERITE, "netherite_darker"));
      ...
      register(var0, GOLD, Items.GOLD_INGOT, Style.EMPTY.withColor(14594349), 0.06F, Map.of(ArmorMaterials.GOLD, "gold_darker"));
      register(var0, EMERALD, Items.EMERALD, Style.EMPTY.withColor(1155126), 0.07F);
      register(var0, DIAMOND, Items.DIAMOND, Style.EMPTY.withColor(7269586), 0.08F, Map.of(ArmorMaterials.DIAMOND, "diamond_darker"));
      ...
      register(var0, AMBER, Items.AMBER_GEM, Style.EMPTY.withColor(15042820), 1.0F);
   }
