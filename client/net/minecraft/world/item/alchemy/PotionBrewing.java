...
public class PotionBrewing {
   ...
   public static boolean isBrewablePotion(Potion var0) {
      ...
      for(int var2 = POTION_MIXES.size(); var1 < var2; ++var1) {
         if (((PotionBrewing.Mix)POTION_MIXES.get(var1)).field_348 == var0) {
            return true;
         }
      }
      ...
      if (!var1.isEmpty()) {
         ...
         for(var5 = CONTAINER_MIXES.size(); var4 < var5; ++var4) {
            ...
            if (var6.from == var3 && var6.ingredient.test(var0)) {
               return PotionUtils.setPotion(new ItemStack((ItemLike)var6.field_348), var2);
            }
         }
         ...
         for(var5 = POTION_MIXES.size(); var4 < var5; ++var4) {
            ...
            if (var6.from == var2 && var6.ingredient.test(var0)) {
               return PotionUtils.setPotion(new ItemStack(var3), (Potion)var6.field_348);
            }
         }
      }
   ...
   private static void addContainerRecipe(Item var0, Item var1, Item var2) {
      if (!(var0 instanceof PotionItem)) {
         ...
         CONTAINER_MIXES.add(new PotionBrewing.Mix(var0, Ingredient.method_110(var1), var2));
      }
   }
   ...
   private static void addContainer(Item var0) {
      if (!(var0 instanceof PotionItem)) {
         ...
         ALLOWED_CONTAINERS.add(Ingredient.method_110(var0));
      }
   }

   private static void addMix(Potion var0, Item var1, Potion var2) {
      POTION_MIXES.add(new PotionBrewing.Mix(var0, Ingredient.method_110(var1), var2));
   }

   static class Mix<T> {
      final T from;
      final Ingredient ingredient;
      // $FF: renamed from: to java.lang.Object
      final T field_348;
