...
public class Potions {
   ...
   static {
      ...
      LEAPING = register("leaping", new Potion("leaping", new MobEffectInstance[]{new MobEffectInstance(MobEffects.JUMP, 3600)}));
      ...
      SWIFTNESS = register("swiftness", new Potion("swiftness", new MobEffectInstance[]{new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 3600)}));
      ...
      SLOWNESS = register("slowness", new Potion("slowness", new MobEffectInstance[]{new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 1800)}));
      ...
      HEALING = register("healing", new Potion("healing", new MobEffectInstance[]{new MobEffectInstance(MobEffects.HEAL, 1)}));
      ...
      HARMING = register("harming", new Potion("harming", new MobEffectInstance[]{new MobEffectInstance(MobEffects.HARM, 1)}));
      ...
      STRENGTH = register("strength", new Potion("strength", new MobEffectInstance[]{new MobEffectInstance(MobEffects.DAMAGE_BOOST, 3600)}));
