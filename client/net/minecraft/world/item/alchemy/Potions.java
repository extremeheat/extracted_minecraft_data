...
public class Potions {
   ...
   public static final Potion STRONG_SWIFTNESS = register(
   ...
   public static final Potion STRONG_SLOWNESS = register(
   ...
   private static Potion register(ResourceKey<Potion> var0, Potion var1) {
      return Registry.register(BuiltInRegistries.POTION, var0, var1);
   }
}
