...
public class FireworkRocketItem extends Item {
   ...
   public void appendHoverText(ItemStack var1, @Nullable Level var2, List<Component> var3, TooltipFlag var4) {
      ...
      if (var5 != null) {
         if (var5.contains("Flight", 99)) {
            var3.add(Component.translatable("item.minecraft.firework_rocket.flight").append(" ").append(String.valueOf(var5.getByte("Flight"))).withStyle(ChatFormatting.GRAY));
         }
   ...
   public static enum Shape {
      ...
      private static final Shape[] BY_ID = (Shape[])Arrays.stream(values()).sorted(Comparator.comparingInt((var0) -> {
         return var0.id;
      })).toArray((var0) -> {
         return new Shape[var0];
      });
