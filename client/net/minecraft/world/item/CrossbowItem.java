...
public class CrossbowItem extends ProjectileWeaponItem implements Vanishable {
      ...
      if (var2 != null && var2.contains("ChargedProjectiles", 9)) {
         ...
         if (var3 != null) {
            for(int var4 = 0; var4 < var3.size(); ++var4) {
               ...
               var1.add(ItemStack.method_85(var5));
            }
         }
      }
   ...
   private static void shootProjectile(Level var0, LivingEntity var1, InteractionHand var2, ItemStack var3, ItemStack var4, float var5, boolean var6, float var7, float var8, float var9) {
      if (!var0.isClientSide) {
         boolean var10 = var4.method_87(Items.FIREWORK_ROCKET);
         Object var11;
         if (var10) {
         ...
         if (var1 instanceof CrossbowAttackMob) {
            ...
            ((Projectile)var11).shoot((double)var15.method_82(), (double)var15.method_83(), (double)var15.method_84(), var7, var8);
         }
   ...
   public void appendHoverText(ItemStack var1, @Nullable Level var2, List<Component> var3, TooltipFlag var4) {
      ...
      if (isCharged(var1) && !var5.isEmpty()) {
         ...
         if (var4.isAdvanced() && var6.method_87(Items.FIREWORK_ROCKET)) {
