...
public record ItemAttributeModifiers(List<Entry> modifiers, boolean showInTooltip) {
   ...
   public static record Entry(Holder<Attribute> attribute, AttributeModifier modifier, EquipmentSlotGroup slot) {
      ...
      public static final Codec<Entry> CODEC = RecordCodecBuilder.create((var0) -> var0.group(Attribute.CODEC.fieldOf("type").forGetter(Entry::attribute), AttributeModifier.MAP_CODEC.forGetter(Entry::modifier), EquipmentSlotGroup.CODEC.optionalFieldOf("slot", EquipmentSlotGroup.ANY).forGetter(Entry::slot)).apply(var0, Entry::new));
