...
public class Items {
   ...
   static {
      ...
      MUSIC_DISC_5 = registerItem((String)"music_disc_5", new RecordItem(15, SoundEvents.MUSIC_DISC_5, (new Item.Properties()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
