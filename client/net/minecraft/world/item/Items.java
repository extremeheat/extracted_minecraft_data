...
public class Items {
   ...
   public static final Item SCAFFOLDING = registerBlock(
      new ScaffoldingBlockItem(Blocks.SCAFFOLDING, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS))
   );
   ...
   public static final Item DARK_OAK_DOOR = registerBlock(
      new DoubleHighBlockItem(Blocks.DARK_OAK_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE))
   );
   public static final Item MANGROVE_DOOR = registerBlock(
      new DoubleHighBlockItem(Blocks.MANGROVE_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE))
   );
   ...
   public static final Item NETHERITE_INGOT = registerItem(
      "netherite_ingot", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS).fireResistant())
   );
   public static final Item NETHERITE_SCRAP = registerItem(
      "netherite_scrap", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS).fireResistant())
   );
   ...
   public static final Item DIAMOND_HOE = registerItem(
      "diamond_hoe", new HoeItem(Tiers.DIAMOND, -3, 0.0F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS))
   );
   ...
   public static final Item NETHERITE_CHESTPLATE = registerItem(
      ...
      new ArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant())
   );
   ...
   public static final Item RECOVERY_COMPASS = registerItem("recovery_compass", new Item(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
   public static final Item BUNDLE = registerItem(
      "bundle", new BundleItem(new Item.Properties().stacksTo(1).tab(ifPart2(CreativeModeTab.TAB_TOOLS).orElse(null)))
   );
   ...
   public static final Item MAGENTA_BED = registerBlock(
      new BedItem(Blocks.MAGENTA_BED, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))
   );
   ...
   public static final Item WRITABLE_BOOK = registerItem(
      "writable_book", new WritableBookItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC))
   );
   ...
   public static final Item ZOMBIE_HEAD = registerBlock(
      new StandingAndWallBlockItem(
         Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON)
      )
   );
   ...
   public static final Item DRAGON_HEAD = registerBlock(
      new StandingAndWallBlockItem(
         Blocks.DRAGON_HEAD, Blocks.DRAGON_WALL_HEAD, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON)
      )
   );
   ...
   public static final Item ORANGE_BANNER = registerItem(
      "orange_banner",
      new BannerItem(Blocks.ORANGE_BANNER, Blocks.ORANGE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS))
   );
   public static final Item MAGENTA_BANNER = registerItem(
      "magenta_banner",
      new BannerItem(Blocks.MAGENTA_BANNER, Blocks.MAGENTA_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS))
   );
   ...
   public static final Item YELLOW_BANNER = registerItem(
      "yellow_banner",
      new BannerItem(Blocks.YELLOW_BANNER, Blocks.YELLOW_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS))
   );
   ...
   public static final Item PURPLE_BANNER = registerItem(
      "purple_banner",
      new BannerItem(Blocks.PURPLE_BANNER, Blocks.PURPLE_WALL_BANNER, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS))
   );
   ...
   public static final Item MUSIC_DISC_13 = registerItem(
      "music_disc_13", new RecordItem(1, SoundEvents.MUSIC_DISC_13, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 178)
   );
   public static final Item MUSIC_DISC_CAT = registerItem(
      "music_disc_cat",
      new RecordItem(2, SoundEvents.MUSIC_DISC_CAT, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 185)
   );
   public static final Item MUSIC_DISC_BLOCKS = registerItem(
      "music_disc_blocks",
      new RecordItem(3, SoundEvents.MUSIC_DISC_BLOCKS, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 345)
   );
   public static final Item MUSIC_DISC_CHIRP = registerItem(
      "music_disc_chirp",
      new RecordItem(4, SoundEvents.MUSIC_DISC_CHIRP, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 185)
   );
   public static final Item MUSIC_DISC_FAR = registerItem(
      "music_disc_far",
      new RecordItem(5, SoundEvents.MUSIC_DISC_FAR, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 174)
   );
   public static final Item MUSIC_DISC_MALL = registerItem(
      "music_disc_mall",
      new RecordItem(6, SoundEvents.MUSIC_DISC_MALL, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 197)
   );
   public static final Item MUSIC_DISC_MELLOHI = registerItem(
      "music_disc_mellohi",
      new RecordItem(7, SoundEvents.MUSIC_DISC_MELLOHI, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 96)
   );
   public static final Item MUSIC_DISC_STAL = registerItem(
      "music_disc_stal",
      new RecordItem(8, SoundEvents.MUSIC_DISC_STAL, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 150)
   );
   public static final Item MUSIC_DISC_STRAD = registerItem(
      "music_disc_strad",
      new RecordItem(9, SoundEvents.MUSIC_DISC_STRAD, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 188)
   );
   public static final Item MUSIC_DISC_WARD = registerItem(
      "music_disc_ward",
      new RecordItem(10, SoundEvents.MUSIC_DISC_WARD, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 251)
   );
   public static final Item MUSIC_DISC_11 = registerItem(
      "music_disc_11", new RecordItem(11, SoundEvents.MUSIC_DISC_11, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 71)
   );
   public static final Item MUSIC_DISC_WAIT = registerItem(
      "music_disc_wait",
      new RecordItem(12, SoundEvents.MUSIC_DISC_WAIT, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 238)
   );
   public static final Item MUSIC_DISC_OTHERSIDE = registerItem(
      "music_disc_otherside",
      new RecordItem(14, SoundEvents.MUSIC_DISC_OTHERSIDE, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 195)
   );
   public static final Item MUSIC_DISC_5 = registerItem(
      "music_disc_5", new RecordItem(15, SoundEvents.MUSIC_DISC_5, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 178)
   );
   public static final Item MUSIC_DISC_PIGSTEP = registerItem(
      "music_disc_pigstep",
      new RecordItem(13, SoundEvents.MUSIC_DISC_PIGSTEP, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 149)
   );
   public static final Item DISC_FRAGMENT_5 = registerItem("disc_fragment_5", new DiscFragmentItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
   ...
   public static final Item HONEY_BOTTLE = registerItem(
      "honey_bottle",
      new HoneyBottleItem(new Item.Properties().craftRemainder(GLASS_BOTTLE).food(Foods.HONEY_BOTTLE).tab(CreativeModeTab.TAB_FOOD).stacksTo(16))
   );
   ...
   public static final Item ECHO_SHARD = registerItem("echo_shard", new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
   ...
   private static Item registerBlock(Block var0, Optional<CreativeModeTab> var1) {
      return var1.<Item>map(var1x -> registerBlock(var0, var1x)).orElseGet(() -> registerBlock(var0));
   }
