...
public class Items {
   ...
   public static final Item TORCH = registerBlock(Blocks.TORCH, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.WALL_TORCH, Direction.DOWN, var1));
   ...
   public static final Item CARVED_PUMPKIN = registerBlock(Blocks.CARVED_PUMPKIN, var0 -> var0.equippableUnswappable(EquipmentSlot.HEAD));
   ...
   public static final Item SOUL_TORCH = registerBlock(
      Blocks.SOUL_TORCH, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.SOUL_WALL_TORCH, Direction.DOWN, var1)
   );
   ...
   public static final Item WHITE_CARPET = registerBlock(
      Blocks.WHITE_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE))
   );
   public static final Item ORANGE_CARPET = registerBlock(
      Blocks.ORANGE_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE))
   );
   public static final Item MAGENTA_CARPET = registerBlock(
      Blocks.MAGENTA_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA))
   );
   public static final Item LIGHT_BLUE_CARPET = registerBlock(
      Blocks.LIGHT_BLUE_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE))
   );
   public static final Item YELLOW_CARPET = registerBlock(
      Blocks.YELLOW_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW))
   );
   public static final Item LIME_CARPET = registerBlock(
      Blocks.LIME_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME))
   );
   public static final Item PINK_CARPET = registerBlock(
      Blocks.PINK_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK))
   );
   public static final Item GRAY_CARPET = registerBlock(
      Blocks.GRAY_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY))
   );
   public static final Item LIGHT_GRAY_CARPET = registerBlock(
      Blocks.LIGHT_GRAY_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY))
   );
   public static final Item CYAN_CARPET = registerBlock(
      Blocks.CYAN_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN))
   );
   public static final Item PURPLE_CARPET = registerBlock(
      Blocks.PURPLE_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE))
   );
   public static final Item BLUE_CARPET = registerBlock(
      Blocks.BLUE_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE))
   );
   public static final Item BROWN_CARPET = registerBlock(
      Blocks.BROWN_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN))
   );
   public static final Item GREEN_CARPET = registerBlock(
      Blocks.GREEN_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN))
   );
   public static final Item RED_CARPET = registerBlock(Blocks.RED_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)));
   public static final Item BLACK_CARPET = registerBlock(
      Blocks.BLACK_CARPET, var0 -> var0.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK))
   );
   ...
   public static final Item SNIFFER_EGG = registerBlock(Blocks.SNIFFER_EGG, var0 -> var0.rarity(Rarity.UNCOMMON));
   ...
   public static final Item TUBE_CORAL_FAN = registerBlock(
      Blocks.TUBE_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item BRAIN_CORAL_FAN = registerBlock(
      Blocks.BRAIN_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item BUBBLE_CORAL_FAN = registerBlock(
      Blocks.BUBBLE_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item FIRE_CORAL_FAN = registerBlock(
      Blocks.FIRE_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item HORN_CORAL_FAN = registerBlock(
      Blocks.HORN_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(
      Blocks.DEAD_TUBE_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(
      Blocks.DEAD_BRAIN_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(
      Blocks.DEAD_BUBBLE_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(
      Blocks.DEAD_FIRE_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   public static final Item DEAD_HORN_CORAL_FAN = registerBlock(
      Blocks.DEAD_HORN_CORAL_FAN, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, var1)
   );
   ...
   public static final Item REDSTONE_TORCH = registerBlock(
      Blocks.REDSTONE_TORCH, (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, var1)
   );
   ...
   public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem(
      "warped_fungus_on_a_stick", var0 -> new FoodOnAStickItem<>(EntityType.STRIDER, 1, var0), new Item.Properties().durability(100)
   );
   ...
   public static final Item OAK_BOAT = registerItem("oak_boat", var0 -> new BoatItem(false, Boat.Type.OAK, var0), new Item.Properties().stacksTo(1));
   public static final Item OAK_CHEST_BOAT = registerItem("oak_chest_boat", var0 -> new BoatItem(true, Boat.Type.OAK, var0), new Item.Properties().stacksTo(1));
   public static final Item SPRUCE_BOAT = registerItem("spruce_boat", var0 -> new BoatItem(false, Boat.Type.SPRUCE, var0), new Item.Properties().stacksTo(1));
   public static final Item SPRUCE_CHEST_BOAT = registerItem(
      "spruce_chest_boat", var0 -> new BoatItem(true, Boat.Type.SPRUCE, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item BIRCH_BOAT = registerItem("birch_boat", var0 -> new BoatItem(false, Boat.Type.BIRCH, var0), new Item.Properties().stacksTo(1));
   public static final Item BIRCH_CHEST_BOAT = registerItem(
      "birch_chest_boat", var0 -> new BoatItem(true, Boat.Type.BIRCH, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item JUNGLE_BOAT = registerItem("jungle_boat", var0 -> new BoatItem(false, Boat.Type.JUNGLE, var0), new Item.Properties().stacksTo(1));
   public static final Item JUNGLE_CHEST_BOAT = registerItem(
      "jungle_chest_boat", var0 -> new BoatItem(true, Boat.Type.JUNGLE, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item ACACIA_BOAT = registerItem("acacia_boat", var0 -> new BoatItem(false, Boat.Type.ACACIA, var0), new Item.Properties().stacksTo(1));
   public static final Item ACACIA_CHEST_BOAT = registerItem(
      "acacia_chest_boat", var0 -> new BoatItem(true, Boat.Type.ACACIA, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item CHERRY_BOAT = registerItem("cherry_boat", var0 -> new BoatItem(false, Boat.Type.CHERRY, var0), new Item.Properties().stacksTo(1));
   public static final Item CHERRY_CHEST_BOAT = registerItem(
      "cherry_chest_boat", var0 -> new BoatItem(true, Boat.Type.CHERRY, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item DARK_OAK_BOAT = registerItem(
      "dark_oak_boat", var0 -> new BoatItem(false, Boat.Type.DARK_OAK, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item DARK_OAK_CHEST_BOAT = registerItem(
      "dark_oak_chest_boat", var0 -> new BoatItem(true, Boat.Type.DARK_OAK, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item MANGROVE_BOAT = registerItem(
      "mangrove_boat", var0 -> new BoatItem(false, Boat.Type.MANGROVE, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item MANGROVE_CHEST_BOAT = registerItem(
      "mangrove_chest_boat", var0 -> new BoatItem(true, Boat.Type.MANGROVE, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", var0 -> new BoatItem(false, Boat.Type.BAMBOO, var0), new Item.Properties().stacksTo(1));
   public static final Item BAMBOO_CHEST_RAFT = registerItem(
      "bamboo_chest_raft", var0 -> new BoatItem(true, Boat.Type.BAMBOO, var0), new Item.Properties().stacksTo(1)
   );
   ...
   public static final Item TURTLE_HELMET = registerItem("turtle_helmet", var0 -> new ArmorItem(ArmorMaterials.TURTLE_SCUTE, ArmorType.HELMET, var0));
   ...
   public static final Item WOLF_ARMOR = registerItem(
      "wolf_armor", var0 -> new AnimalArmorItem(ArmorMaterials.ARMADILLO_SCUTE, AnimalArmorItem.BodyType.CANINE, var0)
   );
   ...
   public static final Item WOODEN_SWORD = registerItem("wooden_sword", var0 -> new SwordItem(ToolMaterial.WOOD, 3.0F, -2.4F, var0));
   public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", var0 -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, var0));
   public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", var0 -> new PickaxeItem(ToolMaterial.WOOD, 1.0F, -2.8F, var0));
   public static final Item WOODEN_AXE = registerItem("wooden_axe", var0 -> new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, var0));
   public static final Item WOODEN_HOE = registerItem("wooden_hoe", var0 -> new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, var0));
   public static final Item STONE_SWORD = registerItem("stone_sword", var0 -> new SwordItem(ToolMaterial.STONE, 3.0F, -2.4F, var0));
   public static final Item STONE_SHOVEL = registerItem("stone_shovel", var0 -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, var0));
   public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", var0 -> new PickaxeItem(ToolMaterial.STONE, 1.0F, -2.8F, var0));
   public static final Item STONE_AXE = registerItem("stone_axe", var0 -> new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, var0));
   public static final Item STONE_HOE = registerItem("stone_hoe", var0 -> new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, var0));
   public static final Item GOLDEN_SWORD = registerItem("golden_sword", var0 -> new SwordItem(ToolMaterial.GOLD, 3.0F, -2.4F, var0));
   public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", var0 -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, var0));
   public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", var0 -> new PickaxeItem(ToolMaterial.GOLD, 1.0F, -2.8F, var0));
   public static final Item GOLDEN_AXE = registerItem("golden_axe", var0 -> new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, var0));
   public static final Item GOLDEN_HOE = registerItem("golden_hoe", var0 -> new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, var0));
   public static final Item IRON_SWORD = registerItem("iron_sword", var0 -> new SwordItem(ToolMaterial.IRON, 3.0F, -2.4F, var0));
   public static final Item IRON_SHOVEL = registerItem("iron_shovel", var0 -> new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, var0));
   public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", var0 -> new PickaxeItem(ToolMaterial.IRON, 1.0F, -2.8F, var0));
   public static final Item IRON_AXE = registerItem("iron_axe", var0 -> new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, var0));
   public static final Item IRON_HOE = registerItem("iron_hoe", var0 -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, var0));
   public static final Item DIAMOND_SWORD = registerItem("diamond_sword", var0 -> new SwordItem(ToolMaterial.DIAMOND, 3.0F, -2.4F, var0));
   public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", var0 -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, var0));
   public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", var0 -> new PickaxeItem(ToolMaterial.DIAMOND, 1.0F, -2.8F, var0));
   public static final Item DIAMOND_AXE = registerItem("diamond_axe", var0 -> new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, var0));
   public static final Item DIAMOND_HOE = registerItem("diamond_hoe", var0 -> new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, var0));
   public static final Item NETHERITE_SWORD = registerItem(
      "netherite_sword", var0 -> new SwordItem(ToolMaterial.NETHERITE, 3.0F, -2.4F, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_SHOVEL = registerItem(
      "netherite_shovel", var0 -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_PICKAXE = registerItem(
      "netherite_pickaxe", var0 -> new PickaxeItem(ToolMaterial.NETHERITE, 1.0F, -2.8F, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_AXE = registerItem(
      "netherite_axe", var0 -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_HOE = registerItem(
      "netherite_hoe", var0 -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, var0), new Item.Properties().fireResistant()
   );
   ...
   public static final Item LEATHER_HELMET = registerItem("leather_helmet", var0 -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.HELMET, var0));
   public static final Item LEATHER_CHESTPLATE = registerItem("leather_chestplate", var0 -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.CHESTPLATE, var0));
   public static final Item LEATHER_LEGGINGS = registerItem("leather_leggings", var0 -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.LEGGINGS, var0));
   public static final Item LEATHER_BOOTS = registerItem("leather_boots", var0 -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.BOOTS, var0));
   public static final Item CHAINMAIL_HELMET = registerItem(
      "chainmail_helmet", var0 -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.HELMET, var0), new Item.Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item CHAINMAIL_CHESTPLATE = registerItem(
      "chainmail_chestplate", var0 -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.CHESTPLATE, var0), new Item.Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item CHAINMAIL_LEGGINGS = registerItem(
      "chainmail_leggings", var0 -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS, var0), new Item.Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item CHAINMAIL_BOOTS = registerItem(
      "chainmail_boots", var0 -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.BOOTS, var0), new Item.Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item IRON_HELMET = registerItem("iron_helmet", var0 -> new ArmorItem(ArmorMaterials.IRON, ArmorType.HELMET, var0));
   public static final Item IRON_CHESTPLATE = registerItem("iron_chestplate", var0 -> new ArmorItem(ArmorMaterials.IRON, ArmorType.CHESTPLATE, var0));
   public static final Item IRON_LEGGINGS = registerItem("iron_leggings", var0 -> new ArmorItem(ArmorMaterials.IRON, ArmorType.LEGGINGS, var0));
   public static final Item IRON_BOOTS = registerItem("iron_boots", var0 -> new ArmorItem(ArmorMaterials.IRON, ArmorType.BOOTS, var0));
   public static final Item DIAMOND_HELMET = registerItem("diamond_helmet", var0 -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.HELMET, var0));
   public static final Item DIAMOND_CHESTPLATE = registerItem("diamond_chestplate", var0 -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.CHESTPLATE, var0));
   public static final Item DIAMOND_LEGGINGS = registerItem("diamond_leggings", var0 -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.LEGGINGS, var0));
   public static final Item DIAMOND_BOOTS = registerItem("diamond_boots", var0 -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.BOOTS, var0));
   public static final Item GOLDEN_HELMET = registerItem("golden_helmet", var0 -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.HELMET, var0));
   public static final Item GOLDEN_CHESTPLATE = registerItem("golden_chestplate", var0 -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.CHESTPLATE, var0));
   public static final Item GOLDEN_LEGGINGS = registerItem("golden_leggings", var0 -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.LEGGINGS, var0));
   public static final Item GOLDEN_BOOTS = registerItem("golden_boots", var0 -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.BOOTS, var0));
   public static final Item NETHERITE_HELMET = registerItem(
      "netherite_helmet", var0 -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.HELMET, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_CHESTPLATE = registerItem(
      "netherite_chestplate", var0 -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.CHESTPLATE, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_LEGGINGS = registerItem(
      "netherite_leggings", var0 -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.LEGGINGS, var0), new Item.Properties().fireResistant()
   );
   public static final Item NETHERITE_BOOTS = registerItem(
      "netherite_boots", var0 -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.BOOTS, var0), new Item.Properties().fireResistant()
   );
   ...
   public static final Item PAINTING = registerItem("painting", var0 -> new HangingEntityItem(EntityType.PAINTING, var0));
   ...
   public static final Item OAK_SIGN = registerBlock(
      Blocks.OAK_SIGN, (var0, var1) -> new SignItem(var0, Blocks.OAK_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item SPRUCE_SIGN = registerBlock(
      Blocks.SPRUCE_SIGN, (var0, var1) -> new SignItem(var0, Blocks.SPRUCE_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item BIRCH_SIGN = registerBlock(
      Blocks.BIRCH_SIGN, (var0, var1) -> new SignItem(var0, Blocks.BIRCH_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item JUNGLE_SIGN = registerBlock(
      Blocks.JUNGLE_SIGN, (var0, var1) -> new SignItem(var0, Blocks.JUNGLE_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item ACACIA_SIGN = registerBlock(
      Blocks.ACACIA_SIGN, (var0, var1) -> new SignItem(var0, Blocks.ACACIA_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item CHERRY_SIGN = registerBlock(
      Blocks.CHERRY_SIGN, (var0, var1) -> new SignItem(var0, Blocks.CHERRY_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   ...
   public static final Item BAMBOO_SIGN = registerBlock(
      Blocks.BAMBOO_SIGN, (var0, var1) -> new SignItem(var0, Blocks.BAMBOO_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item CRIMSON_SIGN = registerBlock(
      Blocks.CRIMSON_SIGN, (var0, var1) -> new SignItem(var0, Blocks.CRIMSON_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item WARPED_SIGN = registerBlock(
      Blocks.WARPED_SIGN, (var0, var1) -> new SignItem(var0, Blocks.WARPED_WALL_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item OAK_HANGING_SIGN = registerBlock(
      Blocks.OAK_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.OAK_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item SPRUCE_HANGING_SIGN = registerBlock(
      Blocks.SPRUCE_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.SPRUCE_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item BIRCH_HANGING_SIGN = registerBlock(
      Blocks.BIRCH_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.BIRCH_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item JUNGLE_HANGING_SIGN = registerBlock(
      Blocks.JUNGLE_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.JUNGLE_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item ACACIA_HANGING_SIGN = registerBlock(
      Blocks.ACACIA_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.ACACIA_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item CHERRY_HANGING_SIGN = registerBlock(
      Blocks.CHERRY_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.CHERRY_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   ...
   public static final Item BAMBOO_HANGING_SIGN = registerBlock(
      Blocks.BAMBOO_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.BAMBOO_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item CRIMSON_HANGING_SIGN = registerBlock(
      Blocks.CRIMSON_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.CRIMSON_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item WARPED_HANGING_SIGN = registerBlock(
      Blocks.WARPED_HANGING_SIGN, (var0, var1) -> new HangingSignItem(var0, Blocks.WARPED_WALL_HANGING_SIGN, var1), new Item.Properties().stacksTo(16)
   );
   public static final Item BUCKET = registerItem("bucket", var0 -> new BucketItem(Fluids.EMPTY, var0), new Item.Properties().stacksTo(16));
   public static final Item WATER_BUCKET = registerItem(
      "water_bucket", var0 -> new BucketItem(Fluids.WATER, var0), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
   );
   public static final Item LAVA_BUCKET = registerItem(
      "lava_bucket", var0 -> new BucketItem(Fluids.LAVA, var0), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
   );
   public static final Item POWDER_SNOW_BUCKET = registerItem(
      "powder_snow_bucket",
      var0 -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, var0),
   ...
   public static final Item PUFFERFISH_BUCKET = registerItem(
      "pufferfish_bucket",
      var0 -> new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item SALMON_BUCKET = registerItem(
      "salmon_bucket",
      var0 -> new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item COD_BUCKET = registerItem(
      "cod_bucket",
      var0 -> new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item TROPICAL_FISH_BUCKET = registerItem(
      "tropical_fish_bucket",
      var0 -> new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item AXOLOTL_BUCKET = registerItem(
      "axolotl_bucket",
      var0 -> new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, var0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   public static final Item TADPOLE_BUCKET = registerItem(
      "tadpole_bucket",
      var0 -> new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, var0),
      new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
   );
   ...
   public static final Item WHITE_DYE = registerItem("white_dye", var0 -> new DyeItem(DyeColor.WHITE, var0));
   public static final Item ORANGE_DYE = registerItem("orange_dye", var0 -> new DyeItem(DyeColor.ORANGE, var0));
   public static final Item MAGENTA_DYE = registerItem("magenta_dye", var0 -> new DyeItem(DyeColor.MAGENTA, var0));
   public static final Item LIGHT_BLUE_DYE = registerItem("light_blue_dye", var0 -> new DyeItem(DyeColor.LIGHT_BLUE, var0));
   public static final Item YELLOW_DYE = registerItem("yellow_dye", var0 -> new DyeItem(DyeColor.YELLOW, var0));
   public static final Item LIME_DYE = registerItem("lime_dye", var0 -> new DyeItem(DyeColor.LIME, var0));
   public static final Item PINK_DYE = registerItem("pink_dye", var0 -> new DyeItem(DyeColor.PINK, var0));
   public static final Item GRAY_DYE = registerItem("gray_dye", var0 -> new DyeItem(DyeColor.GRAY, var0));
   public static final Item LIGHT_GRAY_DYE = registerItem("light_gray_dye", var0 -> new DyeItem(DyeColor.LIGHT_GRAY, var0));
   public static final Item CYAN_DYE = registerItem("cyan_dye", var0 -> new DyeItem(DyeColor.CYAN, var0));
   public static final Item PURPLE_DYE = registerItem("purple_dye", var0 -> new DyeItem(DyeColor.PURPLE, var0));
   public static final Item BLUE_DYE = registerItem("blue_dye", var0 -> new DyeItem(DyeColor.BLUE, var0));
   public static final Item BROWN_DYE = registerItem("brown_dye", var0 -> new DyeItem(DyeColor.BROWN, var0));
   public static final Item GREEN_DYE = registerItem("green_dye", var0 -> new DyeItem(DyeColor.GREEN, var0));
   public static final Item RED_DYE = registerItem("red_dye", var0 -> new DyeItem(DyeColor.RED, var0));
   public static final Item BLACK_DYE = registerItem("black_dye", var0 -> new DyeItem(DyeColor.BLACK, var0));
   ...
   public static final Item ARMADILLO_SPAWN_EGG = registerItem("armadillo_spawn_egg", var0 -> new SpawnEggItem(EntityType.ARMADILLO, 11366765, 8538184, var0));
   public static final Item ALLAY_SPAWN_EGG = registerItem("allay_spawn_egg", var0 -> new SpawnEggItem(EntityType.ALLAY, 56063, 44543, var0));
   public static final Item AXOLOTL_SPAWN_EGG = registerItem("axolotl_spawn_egg", var0 -> new SpawnEggItem(EntityType.AXOLOTL, 16499171, 10890612, var0));
   public static final Item BAT_SPAWN_EGG = registerItem("bat_spawn_egg", var0 -> new SpawnEggItem(EntityType.BAT, 4996656, 986895, var0));
   public static final Item BEE_SPAWN_EGG = registerItem("bee_spawn_egg", var0 -> new SpawnEggItem(EntityType.BEE, 15582019, 4400155, var0));
   public static final Item BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", var0 -> new SpawnEggItem(EntityType.BLAZE, 16167425, 16775294, var0));
   public static final Item BOGGED_SPAWN_EGG = registerItem("bogged_spawn_egg", var0 -> new SpawnEggItem(EntityType.BOGGED, 9084018, 3231003, var0));
   public static final Item BREEZE_SPAWN_EGG = registerItem("breeze_spawn_egg", var0 -> new SpawnEggItem(EntityType.BREEZE, 11506911, 9529055, var0));
   public static final Item CAT_SPAWN_EGG = registerItem("cat_spawn_egg", var0 -> new SpawnEggItem(EntityType.CAT, 15714446, 9794134, var0));
   public static final Item CAMEL_SPAWN_EGG = registerItem("camel_spawn_egg", var0 -> new SpawnEggItem(EntityType.CAMEL, 16565097, 13341495, var0));
   public static final Item CAVE_SPIDER_SPAWN_EGG = registerItem(
      "cave_spider_spawn_egg", var0 -> new SpawnEggItem(EntityType.CAVE_SPIDER, 803406, 11013646, var0)
   );
   public static final Item CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", var0 -> new SpawnEggItem(EntityType.CHICKEN, 10592673, 16711680, var0));
   public static final Item COD_SPAWN_EGG = registerItem("cod_spawn_egg", var0 -> new SpawnEggItem(EntityType.COD, 12691306, 15058059, var0));
   public static final Item COW_SPAWN_EGG = registerItem("cow_spawn_egg", var0 -> new SpawnEggItem(EntityType.COW, 4470310, 10592673, var0));
   public static final Item CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", var0 -> new SpawnEggItem(EntityType.CREEPER, 894731, 0, var0));
   public static final Item DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", var0 -> new SpawnEggItem(EntityType.DOLPHIN, 2243405, 16382457, var0));
   public static final Item DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", var0 -> new SpawnEggItem(EntityType.DONKEY, 5457209, 8811878, var0));
   public static final Item DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", var0 -> new SpawnEggItem(EntityType.DROWNED, 9433559, 7969893, var0));
   public static final Item ELDER_GUARDIAN_SPAWN_EGG = registerItem(
      "elder_guardian_spawn_egg", var0 -> new SpawnEggItem(EntityType.ELDER_GUARDIAN, 13552826, 7632531, var0)
   );
   public static final Item ENDER_DRAGON_SPAWN_EGG = registerItem(
      "ender_dragon_spawn_egg", var0 -> new SpawnEggItem(EntityType.ENDER_DRAGON, 1842204, 14711290, var0)
   );
   public static final Item ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", var0 -> new SpawnEggItem(EntityType.ENDERMAN, 1447446, 0, var0));
   public static final Item ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", var0 -> new SpawnEggItem(EntityType.ENDERMITE, 1447446, 7237230, var0));
   public static final Item EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", var0 -> new SpawnEggItem(EntityType.EVOKER, 9804699, 1973274, var0));
   public static final Item FOX_SPAWN_EGG = registerItem("fox_spawn_egg", var0 -> new SpawnEggItem(EntityType.FOX, 14005919, 13396256, var0));
   public static final Item FROG_SPAWN_EGG = registerItem("frog_spawn_egg", var0 -> new SpawnEggItem(EntityType.FROG, 13661252, 16762748, var0));
   public static final Item GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", var0 -> new SpawnEggItem(EntityType.GHAST, 16382457, 12369084, var0));
   public static final Item GLOW_SQUID_SPAWN_EGG = registerItem("glow_squid_spawn_egg", var0 -> new SpawnEggItem(EntityType.GLOW_SQUID, 611926, 8778172, var0));
   public static final Item GOAT_SPAWN_EGG = registerItem("goat_spawn_egg", var0 -> new SpawnEggItem(EntityType.GOAT, 10851452, 5589310, var0));
   public static final Item GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", var0 -> new SpawnEggItem(EntityType.GUARDIAN, 5931634, 15826224, var0));
   public static final Item HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", var0 -> new SpawnEggItem(EntityType.HOGLIN, 13004373, 6251620, var0));
   public static final Item HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", var0 -> new SpawnEggItem(EntityType.HORSE, 12623485, 15656192, var0));
   public static final Item HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", var0 -> new SpawnEggItem(EntityType.HUSK, 7958625, 15125652, var0));
   public static final Item IRON_GOLEM_SPAWN_EGG = registerItem(
      "iron_golem_spawn_egg", var0 -> new SpawnEggItem(EntityType.IRON_GOLEM, 14405058, 7643954, var0)
   );
   public static final Item LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", var0 -> new SpawnEggItem(EntityType.LLAMA, 12623485, 10051392, var0));
   public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem(
      "magma_cube_spawn_egg", var0 -> new SpawnEggItem(EntityType.MAGMA_CUBE, 3407872, 16579584, var0)
   );
   public static final Item MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", var0 -> new SpawnEggItem(EntityType.MOOSHROOM, 10489616, 12040119, var0));
   public static final Item MULE_SPAWN_EGG = registerItem("mule_spawn_egg", var0 -> new SpawnEggItem(EntityType.MULE, 1769984, 5321501, var0));
   public static final Item OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", var0 -> new SpawnEggItem(EntityType.OCELOT, 15720061, 5653556, var0));
   public static final Item PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", var0 -> new SpawnEggItem(EntityType.PANDA, 15198183, 1776418, var0));
   public static final Item PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", var0 -> new SpawnEggItem(EntityType.PARROT, 894731, 16711680, var0));
   public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", var0 -> new SpawnEggItem(EntityType.PHANTOM, 4411786, 8978176, var0));
   public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", var0 -> new SpawnEggItem(EntityType.PIG, 15771042, 14377823, var0));
   public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", var0 -> new SpawnEggItem(EntityType.PIGLIN, 10051392, 16380836, var0));
   public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem(
      "piglin_brute_spawn_egg", var0 -> new SpawnEggItem(EntityType.PIGLIN_BRUTE, 5843472, 16380836, var0)
   );
   public static final Item PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", var0 -> new SpawnEggItem(EntityType.PILLAGER, 5451574, 9804699, var0));
   public static final Item POLAR_BEAR_SPAWN_EGG = registerItem(
      "polar_bear_spawn_egg", var0 -> new SpawnEggItem(EntityType.POLAR_BEAR, 15658718, 14014157, var0)
   );
   public static final Item PUFFERFISH_SPAWN_EGG = registerItem(
      "pufferfish_spawn_egg", var0 -> new SpawnEggItem(EntityType.PUFFERFISH, 16167425, 3654642, var0)
   );
   public static final Item RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", var0 -> new SpawnEggItem(EntityType.RABBIT, 10051392, 7555121, var0));
   public static final Item RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", var0 -> new SpawnEggItem(EntityType.RAVAGER, 7697520, 5984329, var0));
   public static final Item SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", var0 -> new SpawnEggItem(EntityType.SALMON, 10489616, 951412, var0));
   public static final Item SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", var0 -> new SpawnEggItem(EntityType.SHEEP, 15198183, 16758197, var0));
   public static final Item SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", var0 -> new SpawnEggItem(EntityType.SHULKER, 9725844, 5060690, var0));
   public static final Item SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", var0 -> new SpawnEggItem(EntityType.SILVERFISH, 7237230, 3158064, var0));
   public static final Item SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", var0 -> new SpawnEggItem(EntityType.SKELETON, 12698049, 4802889, var0));
   public static final Item SKELETON_HORSE_SPAWN_EGG = registerItem(
      "skeleton_horse_spawn_egg", var0 -> new SpawnEggItem(EntityType.SKELETON_HORSE, 6842447, 15066584, var0)
   );
   public static final Item SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", var0 -> new SpawnEggItem(EntityType.SLIME, 5349438, 8306542, var0));
   public static final Item SNIFFER_SPAWN_EGG = registerItem("sniffer_spawn_egg", var0 -> new SpawnEggItem(EntityType.SNIFFER, 8855049, 2468720, var0));
   public static final Item SNOW_GOLEM_SPAWN_EGG = registerItem(
      "snow_golem_spawn_egg", var0 -> new SpawnEggItem(EntityType.SNOW_GOLEM, 14283506, 8496292, var0)
   );
   public static final Item SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", var0 -> new SpawnEggItem(EntityType.SPIDER, 3419431, 11013646, var0));
   public static final Item SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", var0 -> new SpawnEggItem(EntityType.SQUID, 2243405, 7375001, var0));
   public static final Item STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", var0 -> new SpawnEggItem(EntityType.STRAY, 6387319, 14543594, var0));
   public static final Item STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", var0 -> new SpawnEggItem(EntityType.STRIDER, 10236982, 5065037, var0));
   public static final Item TADPOLE_SPAWN_EGG = registerItem("tadpole_spawn_egg", var0 -> new SpawnEggItem(EntityType.TADPOLE, 7164733, 1444352, var0));
   public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem(
      "trader_llama_spawn_egg", var0 -> new SpawnEggItem(EntityType.TRADER_LLAMA, 15377456, 4547222, var0)
   );
   public static final Item TROPICAL_FISH_SPAWN_EGG = registerItem(
      "tropical_fish_spawn_egg", var0 -> new SpawnEggItem(EntityType.TROPICAL_FISH, 15690005, 16775663, var0)
   );
   public static final Item TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", var0 -> new SpawnEggItem(EntityType.TURTLE, 15198183, 44975, var0));
   public static final Item VEX_SPAWN_EGG = registerItem("vex_spawn_egg", var0 -> new SpawnEggItem(EntityType.VEX, 8032420, 15265265, var0));
   public static final Item VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", var0 -> new SpawnEggItem(EntityType.VILLAGER, 5651507, 12422002, var0));
   public static final Item VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", var0 -> new SpawnEggItem(EntityType.VINDICATOR, 9804699, 2580065, var0));
   public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem(
      "wandering_trader_spawn_egg", var0 -> new SpawnEggItem(EntityType.WANDERING_TRADER, 4547222, 15377456, var0)
   );
   public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", var0 -> new SpawnEggItem(EntityType.WARDEN, 1001033, 3790560, var0));
   public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", var0 -> new SpawnEggItem(EntityType.WITCH, 3407872, 5349438, var0));
   public static final Item WITHER_SPAWN_EGG = registerItem("wither_spawn_egg", var0 -> new SpawnEggItem(EntityType.WITHER, 1315860, 5075616, var0));
   public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem(
      "wither_skeleton_spawn_egg", var0 -> new SpawnEggItem(EntityType.WITHER_SKELETON, 1315860, 4672845, var0)
   );
   ...
   public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = registerItem(
      "zombie_villager_spawn_egg", var0 -> new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, 5651507, 7969893, var0)
   );
   public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem(
      "zombified_piglin_spawn_egg", var0 -> new SpawnEggItem(EntityType.ZOMBIFIED_PIGLIN, 15373203, 5009705, var0)
   );
   ...
   public static final Item ITEM_FRAME = registerItem("item_frame", var0 -> new ItemFrameItem(EntityType.ITEM_FRAME, var0));
   public static final Item GLOW_ITEM_FRAME = registerItem("glow_item_frame", var0 -> new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, var0));
   ...
   public static final Item SKELETON_SKULL = registerBlock(
      ...
      (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, var1),
   ...
   public static final Item WITHER_SKELETON_SKULL = registerBlock(
      ...
      (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, var1),
   ...
   public static final Item PLAYER_HEAD = registerBlock(
      Blocks.PLAYER_HEAD,
      (var0, var1) -> new PlayerHeadItem(var0, Blocks.PLAYER_WALL_HEAD, var1),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item ZOMBIE_HEAD = registerBlock(
      Blocks.ZOMBIE_HEAD,
      (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, var1),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item CREEPER_HEAD = registerBlock(
      Blocks.CREEPER_HEAD,
      (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, var1),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item DRAGON_HEAD = registerBlock(
      Blocks.DRAGON_HEAD,
      (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, var1),
   ...
   public static final Item PIGLIN_HEAD = registerBlock(
      Blocks.PIGLIN_HEAD,
      (var0, var1) -> new StandingAndWallBlockItem(var0, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, var1),
      new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   ...
   public static final Item IRON_HORSE_ARMOR = registerItem(
      "iron_horse_armor", var0 -> new AnimalArmorItem(ArmorMaterials.IRON, AnimalArmorItem.BodyType.EQUESTRIAN, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item GOLDEN_HORSE_ARMOR = registerItem(
      "golden_horse_armor", var0 -> new AnimalArmorItem(ArmorMaterials.GOLD, AnimalArmorItem.BodyType.EQUESTRIAN, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item DIAMOND_HORSE_ARMOR = registerItem(
      "diamond_horse_armor", var0 -> new AnimalArmorItem(ArmorMaterials.DIAMOND, AnimalArmorItem.BodyType.EQUESTRIAN, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item LEATHER_HORSE_ARMOR = registerItem(
      "leather_horse_armor", var0 -> new AnimalArmorItem(ArmorMaterials.LEATHER, AnimalArmorItem.BodyType.EQUESTRIAN, var0), new Item.Properties().stacksTo(1)
   );
   ...
   public static final Item WHITE_BANNER = registerBlock(
      Blocks.WHITE_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.WHITE_WALL_BANNER, var1),
   ...
   public static final Item ORANGE_BANNER = registerBlock(
      ...
      (var0, var1) -> new BannerItem(var0, Blocks.ORANGE_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item MAGENTA_BANNER = registerBlock(
      Blocks.MAGENTA_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.MAGENTA_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item LIGHT_BLUE_BANNER = registerBlock(
      Blocks.LIGHT_BLUE_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.LIGHT_BLUE_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item YELLOW_BANNER = registerBlock(
      Blocks.YELLOW_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.YELLOW_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item LIME_BANNER = registerBlock(
      Blocks.LIME_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.LIME_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item PINK_BANNER = registerBlock(
      Blocks.PINK_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.PINK_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item GRAY_BANNER = registerBlock(
      Blocks.GRAY_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.GRAY_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item LIGHT_GRAY_BANNER = registerBlock(
      Blocks.LIGHT_GRAY_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.LIGHT_GRAY_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item CYAN_BANNER = registerBlock(
      Blocks.CYAN_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.CYAN_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item PURPLE_BANNER = registerBlock(
      Blocks.PURPLE_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.PURPLE_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item BLUE_BANNER = registerBlock(
      Blocks.BLUE_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.BLUE_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item BROWN_BANNER = registerBlock(
      Blocks.BROWN_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.BROWN_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item GREEN_BANNER = registerBlock(
      Blocks.GREEN_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.GREEN_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item RED_BANNER = registerBlock(
      Blocks.RED_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.RED_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   public static final Item BLACK_BANNER = registerBlock(
      Blocks.BLACK_BANNER,
      (var0, var1) -> new BannerItem(var0, Blocks.BLACK_WALL_BANNER, var1),
      new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   ...
   public static final Item FLOWER_BANNER_PATTERN = registerItem(
      "flower_banner_pattern", var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FLOWER, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item CREEPER_BANNER_PATTERN = registerItem(
      "creeper_banner_pattern",
      var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_CREEPER, var0),
      new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)
   );
   public static final Item SKULL_BANNER_PATTERN = registerItem(
      "skull_banner_pattern", var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_SKULL, var0), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
   );
   public static final Item MOJANG_BANNER_PATTERN = registerItem(
      "mojang_banner_pattern",
      var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_MOJANG, var0),
      new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
   );
   public static final Item GLOBE_BANNER_PATTERN = registerItem(
      "globe_banner_pattern", var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_GLOBE, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item PIGLIN_BANNER_PATTERN = registerItem(
      "piglin_banner_pattern",
      var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_PIGLIN, var0),
      new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)
   );
   public static final Item FLOW_BANNER_PATTERN = registerItem(
      "flow_banner_pattern", var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FLOW, var0), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
   );
   public static final Item GUSTER_BANNER_PATTERN = registerItem(
      "guster_banner_pattern",
      var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_GUSTER, var0),
      new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
   );
   public static final Item FIELD_MASONED_BANNER_PATTERN = registerItem(
      "field_masoned_banner_pattern", var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FIELD_MASONED, var0), new Item.Properties().stacksTo(1)
   );
   public static final Item BORDURE_INDENTED_BANNER_PATTERN = registerItem(
      "bordure_indented_banner_pattern",
      var0 -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_BORDURE_INDENTED, var0),
      new Item.Properties().stacksTo(1)
   );
   public static final Item GOAT_HORN = registerItem(
      "goat_horn", var0 -> new InstrumentItem(InstrumentTags.GOAT_HORNS, var0), new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1)
   );
   ...
   public static Item registerBlock(Block var0, UnaryOperator<Item.Properties> var1) {
      return registerBlock(var0, (var1x, var2) -> new BlockItem(var1x, var1.apply(var2)));
   }
   ...
   public static Item registerBlock(Block var0, BiFunction<Block, Item.Properties, Item> var1, Item.Properties var2) {
      return registerItem(blockIdToItemId(var0.builtInRegistryHolder().key()), var2x -> (Item)var1.apply(var0, var2x), var2.useBlockDescriptionPrefix());
   }
   ...
   public static Item registerItem(ResourceKey<Item> var0, Function<Item.Properties, Item> var1, Item.Properties var2) {
      ...
      return Registry.register(BuiltInRegistries.ITEM, var0, var3);
   }
}
