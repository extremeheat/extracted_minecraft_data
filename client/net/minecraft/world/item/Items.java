...
public class Items {
   ...
   static {
      ...
      WIND_CHARGE = registerItem((String)"wind_charge", new WindChargeItem((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      ...
      MACE = registerItem((String)"mace", new MaceItem((new Item.Properties()).durability(250).component(DataComponents.TOOL, MaceItem.createToolProperties()).attributes(MaceItem.createAttributes()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      ...
      FLOW_BANNER_PATTERN = registerItem((String)"flow_banner_pattern", new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FLOW, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      GUSTER_BANNER_PATTERN = registerItem((String)"guster_banner_pattern", new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_GUSTER, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      ...
      FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem((String)"flow_armor_trim_smithing_template", SmithingTemplateItem.createArmorTrimTemplate(TrimPatterns.FLOW, FeatureFlags.UPDATE_1_21));
      BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem((String)"bolt_armor_trim_smithing_template", SmithingTemplateItem.createArmorTrimTemplate(TrimPatterns.BOLT, FeatureFlags.UPDATE_1_21));
      ...
      FLOW_POTTERY_SHERD = registerItem("flow_pottery_sherd", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      FRIEND_POTTERY_SHERD = registerItem("friend_pottery_sherd", new Item(new Item.Properties()));
      GUSTER_POTTERY_SHERD = registerItem("guster_pottery_sherd", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      ...
      SCRAPE_POTTERY_SHERD = registerItem("scrape_pottery_sherd", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      ...
      TRIAL_KEY = registerItem("trial_key", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      OMINOUS_TRIAL_KEY = registerItem("ominous_trial_key", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      VAULT = registerBlock(Blocks.VAULT);
      OMINOUS_BOTTLE = registerItem((String)"ominous_bottle", new OminousBottleItem((new Item.Properties()).food(Foods.OMINOUS_BOTTLE).component(DataComponents.OMINOUS_BOTTLE_AMPLIFIER, 0).requiredFeatures(FeatureFlags.UPDATE_1_21)));
      BREEZE_ROD = registerItem("breeze_rod", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_21)));
   }
}
