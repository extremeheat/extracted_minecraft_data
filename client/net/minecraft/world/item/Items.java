...
public class Items {
   ...
   static {
      ...
      SULFUR = registerBlock(Blocks.SULFUR);
      POTENT_SULFUR = registerBlock(Blocks.POTENT_SULFUR);
      SULFUR_SLAB = registerBlock(Blocks.SULFUR_SLAB);
      SULFUR_STAIRS = registerBlock(Blocks.SULFUR_STAIRS);
      SULFUR_WALL = registerBlock(Blocks.SULFUR_WALL);
      POLISHED_SULFUR = registerBlock(Blocks.POLISHED_SULFUR);
      POLISHED_SULFUR_SLAB = registerBlock(Blocks.POLISHED_SULFUR_SLAB);
      POLISHED_SULFUR_STAIRS = registerBlock(Blocks.POLISHED_SULFUR_STAIRS);
      POLISHED_SULFUR_WALL = registerBlock(Blocks.POLISHED_SULFUR_WALL);
      SULFUR_BRICKS = registerBlock(Blocks.SULFUR_BRICKS);
      SULFUR_BRICK_SLAB = registerBlock(Blocks.SULFUR_BRICK_SLAB);
      SULFUR_BRICK_STAIRS = registerBlock(Blocks.SULFUR_BRICK_STAIRS);
      SULFUR_BRICK_WALL = registerBlock(Blocks.SULFUR_BRICK_WALL);
      CHISELED_SULFUR = registerBlock(Blocks.CHISELED_SULFUR);
      CINNABAR = registerBlock(Blocks.CINNABAR);
      CINNABAR_SLAB = registerBlock(Blocks.CINNABAR_SLAB);
      CINNABAR_STAIRS = registerBlock(Blocks.CINNABAR_STAIRS);
      CINNABAR_WALL = registerBlock(Blocks.CINNABAR_WALL);
      POLISHED_CINNABAR = registerBlock(Blocks.POLISHED_CINNABAR);
      POLISHED_CINNABAR_SLAB = registerBlock(Blocks.POLISHED_CINNABAR_SLAB);
      POLISHED_CINNABAR_STAIRS = registerBlock(Blocks.POLISHED_CINNABAR_STAIRS);
      POLISHED_CINNABAR_WALL = registerBlock(Blocks.POLISHED_CINNABAR_WALL);
      CINNABAR_BRICKS = registerBlock(Blocks.CINNABAR_BRICKS);
      CINNABAR_BRICK_SLAB = registerBlock(Blocks.CINNABAR_BRICK_SLAB);
      CINNABAR_BRICK_STAIRS = registerBlock(Blocks.CINNABAR_BRICK_STAIRS);
      CINNABAR_BRICK_WALL = registerBlock(Blocks.CINNABAR_BRICK_WALL);
      CHISELED_CINNABAR = registerBlock(Blocks.CHISELED_CINNABAR);
      ...
      COPPER_BLOCK = WeatheringCopperCollection.registerItems(Blocks.COPPER_BLOCK, Items::registerBlock);
      ...
      CHISELED_COPPER = WeatheringCopperCollection.registerItems(Blocks.CHISELED_COPPER, Items::registerBlock);
      CUT_COPPER = WeatheringCopperCollection.registerItems(Blocks.CUT_COPPER, Items::registerBlock);
      CUT_COPPER_STAIRS = WeatheringCopperCollection.registerItems(Blocks.CUT_COPPER_STAIRS, Items::registerBlock);
      CUT_COPPER_SLAB = WeatheringCopperCollection.registerItems(Blocks.CUT_COPPER_SLAB, Items::registerBlock);
      ...
      WOOL = ColorCollection.registerItems(Blocks.WOOL, (block, var1) -> registerBlock(block));
      ...
      COPPER_BARS = WeatheringCopperCollection.registerItems(Blocks.COPPER_BARS, Items::registerBlock);
      IRON_CHAIN = registerBlock(Blocks.IRON_CHAIN);
      COPPER_CHAIN = WeatheringCopperCollection.registerItems(Blocks.COPPER_CHAIN, Items::registerBlock);
      ...
      DYED_TERRACOTTA = ColorCollection.registerItems(Blocks.DYED_TERRACOTTA, (block, var1) -> registerBlock(block));
      ...
      CARPET = ColorCollection.registerItems(Blocks.CARPET, (block, color) -> registerBlock(block, (UnaryOperator)((p) -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(color)))));
      ...
      STAINED_GLASS = ColorCollection.registerItems(Blocks.STAINED_GLASS, (block, var1) -> registerBlock(block));
      STAINED_GLASS_PANE = ColorCollection.registerItems(Blocks.STAINED_GLASS_PANE, (block, var1) -> registerBlock(block));
      ...
      DYED_SHULKER_BOX = ColorCollection.registerItems(Blocks.DYED_SHULKER_BOX, (block, var1) -> registerBlock(block, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)));
      GLAZED_TERRACOTTA = ColorCollection.registerItems(Blocks.GLAZED_TERRACOTTA, (block, var1) -> registerBlock(block));
      CONCRETE = ColorCollection.registerItems(Blocks.CONCRETE, (block, var1) -> registerBlock(block));
      CONCRETE_POWDER = ColorCollection.registerItems(Blocks.CONCRETE_POWDER, (block, var1) -> registerBlock(block));
      ...
      LIGHTNING_ROD = WeatheringCopperCollection.registerItems(Blocks.LIGHTNING_ROD, Items::registerBlock);
      ...
      COPPER_DOOR = WeatheringCopperCollection.registerItems(Blocks.COPPER_DOOR, (block) -> registerBlock(block, DoubleHighBlockItem::new));
      ...
      COPPER_TRAPDOOR = WeatheringCopperCollection.registerItems(Blocks.COPPER_TRAPDOOR, Items::registerBlock);
      ...
      HARNESS = ColorCollection.registerItems("harness", (name, color) -> registerItem(name, (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(color))));
      ...
      SULFUR_CUBE_BUCKET = registerItem("sulfur_cube_bucket", (p) -> new MobBucketItem(EntityType.SULFUR_CUBE, Fluids.EMPTY, SoundEvents.EMPTY, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
      ...
      DYED_BUNDLE = ColorCollection.registerItems("bundle", (name, var1) -> registerItem(name, BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)));
      ...
      DYE = ColorCollection.<Item>make((color) -> registerItem(color.getName() + "_dye", DyeItem::new, (new Item.Properties()).component(DataComponents.DYE, color)));
      ...
      BED = ColorCollection.registerItems(Blocks.BED, (block, color) -> registerBlock(block, BedItem::new, (new Item.Properties()).stacksTo(1)));
      ...
      CHICKEN_SPAWN_EGG = registerSpawnEgg(EntityType.CHICKEN);
      COW_SPAWN_EGG = registerSpawnEgg(EntityType.COW);
      PIG_SPAWN_EGG = registerSpawnEgg(EntityType.PIG);
      SHEEP_SPAWN_EGG = registerSpawnEgg(EntityType.SHEEP);
      CAMEL_SPAWN_EGG = registerSpawnEgg(EntityType.CAMEL);
      DONKEY_SPAWN_EGG = registerSpawnEgg(EntityType.DONKEY);
      HORSE_SPAWN_EGG = registerSpawnEgg(EntityType.HORSE);
      MULE_SPAWN_EGG = registerSpawnEgg(EntityType.MULE);
      CAT_SPAWN_EGG = registerSpawnEgg(EntityType.CAT);
      PARROT_SPAWN_EGG = registerSpawnEgg(EntityType.PARROT);
      WOLF_SPAWN_EGG = registerSpawnEgg(EntityType.WOLF);
      ARMADILLO_SPAWN_EGG = registerSpawnEgg(EntityType.ARMADILLO);
      BAT_SPAWN_EGG = registerSpawnEgg(EntityType.BAT);
      BEE_SPAWN_EGG = registerSpawnEgg(EntityType.BEE);
      FOX_SPAWN_EGG = registerSpawnEgg(EntityType.FOX);
      GOAT_SPAWN_EGG = registerSpawnEgg(EntityType.GOAT);
      LLAMA_SPAWN_EGG = registerSpawnEgg(EntityType.LLAMA);
      OCELOT_SPAWN_EGG = registerSpawnEgg(EntityType.OCELOT);
      PANDA_SPAWN_EGG = registerSpawnEgg(EntityType.PANDA);
      POLAR_BEAR_SPAWN_EGG = registerSpawnEgg(EntityType.POLAR_BEAR);
      RABBIT_SPAWN_EGG = registerSpawnEgg(EntityType.RABBIT);
      AXOLOTL_SPAWN_EGG = registerSpawnEgg(EntityType.AXOLOTL);
      COD_SPAWN_EGG = registerSpawnEgg(EntityType.COD);
      DOLPHIN_SPAWN_EGG = registerSpawnEgg(EntityType.DOLPHIN);
      FROG_SPAWN_EGG = registerSpawnEgg(EntityType.FROG);
      GLOW_SQUID_SPAWN_EGG = registerSpawnEgg(EntityType.GLOW_SQUID);
      NAUTILUS_SPAWN_EGG = registerSpawnEgg(EntityType.NAUTILUS);
      PUFFERFISH_SPAWN_EGG = registerSpawnEgg(EntityType.PUFFERFISH);
      SALMON_SPAWN_EGG = registerSpawnEgg(EntityType.SALMON);
      SQUID_SPAWN_EGG = registerSpawnEgg(EntityType.SQUID);
      TADPOLE_SPAWN_EGG = registerSpawnEgg(EntityType.TADPOLE);
      TROPICAL_FISH_SPAWN_EGG = registerSpawnEgg(EntityType.TROPICAL_FISH);
      TURTLE_SPAWN_EGG = registerSpawnEgg(EntityType.TURTLE);
      ALLAY_SPAWN_EGG = registerSpawnEgg(EntityType.ALLAY);
      MOOSHROOM_SPAWN_EGG = registerSpawnEgg(EntityType.MOOSHROOM);
      SNIFFER_SPAWN_EGG = registerSpawnEgg(EntityType.SNIFFER);
      SULFUR_CUBE_SPAWN_EGG = registerSpawnEgg(EntityType.SULFUR_CUBE);
      COPPER_GOLEM_SPAWN_EGG = registerSpawnEgg(EntityType.COPPER_GOLEM);
      IRON_GOLEM_SPAWN_EGG = registerSpawnEgg(EntityType.IRON_GOLEM);
      SNOW_GOLEM_SPAWN_EGG = registerSpawnEgg(EntityType.SNOW_GOLEM);
      TRADER_LLAMA_SPAWN_EGG = registerSpawnEgg(EntityType.TRADER_LLAMA);
      VILLAGER_SPAWN_EGG = registerSpawnEgg(EntityType.VILLAGER);
      WANDERING_TRADER_SPAWN_EGG = registerSpawnEgg(EntityType.WANDERING_TRADER);
      BOGGED_SPAWN_EGG = registerSpawnEgg(EntityType.BOGGED);
      CAMEL_HUSK_SPAWN_EGG = registerSpawnEgg(EntityType.CAMEL_HUSK);
      DROWNED_SPAWN_EGG = registerSpawnEgg(EntityType.DROWNED);
      HUSK_SPAWN_EGG = registerSpawnEgg(EntityType.HUSK);
      PARCHED_SPAWN_EGG = registerSpawnEgg(EntityType.PARCHED);
      SKELETON_SPAWN_EGG = registerSpawnEgg(EntityType.SKELETON);
      SKELETON_HORSE_SPAWN_EGG = registerSpawnEgg(EntityType.SKELETON_HORSE);
      STRAY_SPAWN_EGG = registerSpawnEgg(EntityType.STRAY);
      WITHER_SPAWN_EGG = registerSpawnEgg(EntityType.WITHER);
      WITHER_SKELETON_SPAWN_EGG = registerSpawnEgg(EntityType.WITHER_SKELETON);
      ZOMBIE_SPAWN_EGG = registerSpawnEgg(EntityType.ZOMBIE);
      ZOMBIE_HORSE_SPAWN_EGG = registerSpawnEgg(EntityType.ZOMBIE_HORSE);
      ZOMBIE_NAUTILUS_SPAWN_EGG = registerSpawnEgg(EntityType.ZOMBIE_NAUTILUS);
      ZOMBIE_VILLAGER_SPAWN_EGG = registerSpawnEgg(EntityType.ZOMBIE_VILLAGER);
      CAVE_SPIDER_SPAWN_EGG = registerSpawnEgg(EntityType.CAVE_SPIDER);
      SPIDER_SPAWN_EGG = registerSpawnEgg(EntityType.SPIDER);
      BREEZE_SPAWN_EGG = registerSpawnEgg(EntityType.BREEZE);
      CREAKING_SPAWN_EGG = registerSpawnEgg(EntityType.CREAKING);
      CREEPER_SPAWN_EGG = registerSpawnEgg(EntityType.CREEPER);
      ELDER_GUARDIAN_SPAWN_EGG = registerSpawnEgg(EntityType.ELDER_GUARDIAN);
      GUARDIAN_SPAWN_EGG = registerSpawnEgg(EntityType.GUARDIAN);
      PHANTOM_SPAWN_EGG = registerSpawnEgg(EntityType.PHANTOM);
      SILVERFISH_SPAWN_EGG = registerSpawnEgg(EntityType.SILVERFISH);
      SLIME_SPAWN_EGG = registerSpawnEgg(EntityType.SLIME);
      WARDEN_SPAWN_EGG = registerSpawnEgg(EntityType.WARDEN);
      WITCH_SPAWN_EGG = registerSpawnEgg(EntityType.WITCH);
      EVOKER_SPAWN_EGG = registerSpawnEgg(EntityType.EVOKER);
      PILLAGER_SPAWN_EGG = registerSpawnEgg(EntityType.PILLAGER);
      RAVAGER_SPAWN_EGG = registerSpawnEgg(EntityType.RAVAGER);
      VINDICATOR_SPAWN_EGG = registerSpawnEgg(EntityType.VINDICATOR);
      VEX_SPAWN_EGG = registerSpawnEgg(EntityType.VEX);
      BLAZE_SPAWN_EGG = registerSpawnEgg(EntityType.BLAZE);
      GHAST_SPAWN_EGG = registerSpawnEgg(EntityType.GHAST);
      HAPPY_GHAST_SPAWN_EGG = registerSpawnEgg(EntityType.HAPPY_GHAST);
      HOGLIN_SPAWN_EGG = registerSpawnEgg(EntityType.HOGLIN);
      MAGMA_CUBE_SPAWN_EGG = registerSpawnEgg(EntityType.MAGMA_CUBE);
      PIGLIN_SPAWN_EGG = registerSpawnEgg(EntityType.PIGLIN);
      PIGLIN_BRUTE_SPAWN_EGG = registerSpawnEgg(EntityType.PIGLIN_BRUTE);
      STRIDER_SPAWN_EGG = registerSpawnEgg(EntityType.STRIDER);
      ZOGLIN_SPAWN_EGG = registerSpawnEgg(EntityType.ZOGLIN);
      ZOMBIFIED_PIGLIN_SPAWN_EGG = registerSpawnEgg(EntityType.ZOMBIFIED_PIGLIN);
      ENDER_DRAGON_SPAWN_EGG = registerSpawnEgg(EntityType.ENDER_DRAGON);
      ENDERMAN_SPAWN_EGG = registerSpawnEgg(EntityType.ENDERMAN);
      ENDERMITE_SPAWN_EGG = registerSpawnEgg(EntityType.ENDERMITE);
      SHULKER_SPAWN_EGG = registerSpawnEgg(EntityType.SHULKER);
      ...
      NETHERITE_HORSE_ARMOR = registerItem("netherite_horse_armor", (new Item.Properties()).horseArmor(ArmorMaterials.NETHERITE).fireResistant());
      ...
      BANNER = ColorCollection.registerItems(Blocks.BANNER, (block, color) -> registerBlock(block, (b, p) -> new BannerItem(b, Blocks.WALL_BANNER.pick(color), p), (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)));
      ...
      COPPER_LANTERN = WeatheringCopperCollection.registerItems(Blocks.COPPER_LANTERN, Items::registerBlock);
      ...
      DYED_CANDLE = ColorCollection.registerItems(Blocks.DYED_CANDLE, (block, var1) -> registerBlock(block));
      ...
      COPPER_GRATE = WeatheringCopperCollection.registerItems(Blocks.COPPER_GRATE, Items::registerBlock);
      COPPER_BULB = WeatheringCopperCollection.registerItems(Blocks.COPPER_BULB, Items::registerBlock);
      COPPER_CHEST = WeatheringCopperCollection.registerItems(Blocks.COPPER_CHEST, Items::registerBlock);
      COPPER_GOLEM_STATUE = WeatheringCopperCollection.registerItems(Blocks.COPPER_GOLEM_STATUE, (block) -> registerBlock(block, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))));
