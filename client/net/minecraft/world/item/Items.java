...
public class Items {
   ...
   public static final Item EXPOSED_LIGHTNING_ROD;
   public static final Item WEATHERED_LIGHTNING_ROD;
   public static final Item OXIDIZED_LIGHTNING_ROD;
   public static final Item WAXED_LIGHTNING_ROD;
   public static final Item WAXED_EXPOSED_LIGHTNING_ROD;
   public static final Item WAXED_WEATHERED_LIGHTNING_ROD;
   public static final Item WAXED_OXIDIZED_LIGHTNING_ROD;
   ...
   public static final Item EXPOSED_COPPER_CHEST;
   public static final Item WEATHERED_COPPER_CHEST;
   public static final Item OXIDIZED_COPPER_CHEST;
   public static final Item WAXED_COPPER_CHEST;
   public static final Item WAXED_EXPOSED_COPPER_CHEST;
   public static final Item WAXED_WEATHERED_COPPER_CHEST;
   public static final Item WAXED_OXIDIZED_COPPER_CHEST;
   public static final Item COPPER_GOLEM_STATUE;
   public static final Item EXPOSED_COPPER_GOLEM_STATUE;
   public static final Item WEATHERED_COPPER_GOLEM_STATUE;
   public static final Item OXIDIZED_COPPER_GOLEM_STATUE;
   public static final Item WAXED_COPPER_GOLEM_STATUE;
   public static final Item WAXED_EXPOSED_COPPER_GOLEM_STATUE;
   public static final Item WAXED_WEATHERED_COPPER_GOLEM_STATUE;
   public static final Item WAXED_OXIDIZED_COPPER_GOLEM_STATUE;
   ...
   static {
      ...
      PUFFERFISH_BUCKET = registerItem("pufferfish_bucket", (var0) -> new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).food(Foods.PUFFERFISH));
      SALMON_BUCKET = registerItem("salmon_bucket", (var0) -> new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).food(Foods.SALMON));
      COD_BUCKET = registerItem("cod_bucket", (var0) -> new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).food(Foods.COD));
      TROPICAL_FISH_BUCKET = registerItem("tropical_fish_bucket", (var0) -> new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, var0), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).food(Foods.TROPICAL_FISH));
      ...
      COPPER_GOLEM_STATUE = registerBlock(Blocks.COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
