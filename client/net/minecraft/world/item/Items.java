...
public class Items {
   ...
   public static final Item MUSIC_DISC_BLOCKS = registerItem(
      "music_disc_blocks",
      new RecordItem(3, SoundEvents.MUSIC_DISC_BLOCKS, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE))
   );
   ...
   public static final Item MUSIC_DISC_MELLOHI = registerItem(
      "music_disc_mellohi",
      new RecordItem(7, SoundEvents.MUSIC_DISC_MELLOHI, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE))
   );
   ...
   public static final Item MUSIC_DISC_5 = registerItem(
      "music_disc_5", new RecordItem(15, SoundEvents.MUSIC_DISC_5, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE))
   );
