...
public class BlockPlaceContext extends UseOnContext {
   ...
   // $FF: renamed from: at (net.minecraft.world.item.context.BlockPlaceContext, net.minecraft.core.BlockPos, net.minecraft.core.Direction) net.minecraft.world.item.context.BlockPlaceContext
   public static BlockPlaceContext method_123(BlockPlaceContext var0, BlockPos var1, Direction var2) {
      return new BlockPlaceContext(var0.getLevel(), var0.getPlayer(), var0.getHand(), var0.getItemInHand(), new BlockHitResult(new Vec3((double)var1.getX() + 0.5D + (double)var2.getStepX() * 0.5D, (double)var1.getY() + 0.5D + (double)var2.getStepY() * 0.5D, (double)var1.getZ() + 0.5D + (double)var2.getStepZ() * 0.5D), var2, var1, false));
   }
   ...
   public Direction getNearestLookingVerticalDirection() {
      return Direction.getFacingAxis(this.getPlayer(), Direction.Axis.field_501);
   }
