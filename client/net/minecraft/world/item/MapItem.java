...
public class MapItem extends ComplexItem {
   ...
   public void update(Level var1, Entity var2, MapItemSavedData var3) {
      if (var1.dimension() == var3.dimension && var2 instanceof Player) {
         ...
         int var5 = var3.field_181;
         int var6 = var3.field_182;
               ...
               for(int var15 = var8 - var9 - 1; var15 < var8 + var9; ++var15) {
                  if (var12 >= 0 && var15 >= -1 && var12 < 128 && var15 < 128) {
                     ...
                     if (!var22.isEmpty()) {
                        ...
                        var26 /= var4 * var4;
                        MaterialColor var38 = (MaterialColor)Iterables.getFirst(Multisets.copyHighestCountFirst(var21), MaterialColor.NONE);
                        MaterialColor.Brightness var39;
                        double var40;
                        if (var38 == MaterialColor.WATER) {
                           var40 = (double)var26 * 0.1D + (double)(var12 + var15 & 1) * 0.2D;
                           if (var40 < 0.5D) {
                              var39 = MaterialColor.Brightness.HIGH;
                           } else if (var40 > 0.9D) {
                              var39 = MaterialColor.Brightness.LOW;
                           } else {
                              var39 = MaterialColor.Brightness.NORMAL;
                           }
                        } else {
                           var40 = (var27 - var13) * 4.0D / (double)(var4 + 4) + ((double)(var12 + var15 & 1) - 0.5D) * 0.4D;
                           if (var40 > 0.6D) {
                              var39 = MaterialColor.Brightness.HIGH;
                           } else if (var40 < -0.6D) {
                              var39 = MaterialColor.Brightness.LOW;
                        ...
                        if (var15 >= 0 && var16 * var16 + var17 * var17 < var9 * var9 && (!var18 || (var12 + var15 & 1) != 0)) {
                           var11 |= var3.updateColor(var12, var15, var38.getPackedId(var39));
                        }
                     }
                  }
               }
   ...
   private BlockState getCorrectStateForFluidBlock(Level var1, BlockState var2, BlockPos var3) {
      ...
      return !var4.isEmpty() && !var2.isFaceSturdy(var1, var3, Direction.field_526) ? var4.createLegacyBlock() : var2;
   }
   ...
   public static void renderBiomePreviewMap(ServerLevel var0, ItemStack var1) {
      ...
      if (var2 != null) {
         if (var0.dimension() == var2.dimension) {
            ...
            int var4 = var2.field_181;
            int var5 = var2.field_182;
            ...
            for(var7 = 0; var7 < 128 * var3; ++var7) {
               for(var8 = 0; var8 < 128 * var3; ++var8) {
                  Biome.BiomeCategory var9 = var0.getBiome(new BlockPos((var4 / var3 - 64) * var3 + var8, 0, (var5 / var3 - 64) * var3 + var7)).getBiomeCategory();
                  var6[var7 * 128 * var3 + var8] = var9 == Biome.BiomeCategory.OCEAN || var9 == Biome.BiomeCategory.RIVER || var9 == Biome.BiomeCategory.SWAMP;
               }
            }
            ...
            for(var7 = 0; var7 < 128; ++var7) {
               for(var8 = 0; var8 < 128; ++var8) {
                  if (var7 > 0 && var8 > 0 && var7 < 127 && var8 < 127) {
                     int var12 = 8;
                     if (!isBiomeWatery(var6, var3, var7 - 1, var8 - 1)) {
                        --var12;
                     }
                     ...
                     if (!isBiomeWatery(var6, var3, var7 - 1, var8)) {
                        --var12;
                     }
                     ...
                     if (!isBiomeWatery(var6, var3, var7, var8 - 1)) {
                        --var12;
                     }
                     ...
                     MaterialColor.Brightness var10 = MaterialColor.Brightness.LOWEST;
                     MaterialColor var11 = MaterialColor.NONE;
                     if (isBiomeWatery(var6, var3, var7, var8)) {
                        var11 = MaterialColor.COLOR_ORANGE;
                        if (var12 > 7 && var8 % 2 == 0) {
                           switch((var7 + (int)(Mth.sin((float)var8 + 0.0F) * 7.0F)) / 8 % 5) {
                           case 0:
                           case 4:
                              var10 = MaterialColor.Brightness.LOW;
                              break;
                           case 1:
                           case 3:
                              var10 = MaterialColor.Brightness.NORMAL;
                              break;
                           case 2:
                              var10 = MaterialColor.Brightness.HIGH;
                           }
                        } else if (var12 > 7) {
                           var11 = MaterialColor.NONE;
                        } else if (var12 > 5) {
                           var10 = MaterialColor.Brightness.NORMAL;
                        } else if (var12 > 3) {
                           var10 = MaterialColor.Brightness.LOW;
                        ...
                        var11 = MaterialColor.COLOR_BROWN;
                        if (var12 > 3) {
                           var10 = MaterialColor.Brightness.NORMAL;
                        } else {
                           var10 = MaterialColor.Brightness.LOWEST;
                        }
                     }

                     if (var11 != MaterialColor.NONE) {
