...
public class SuspiciousStewRecipe extends CustomRecipe {
   ...
   public boolean matches(CraftingContainer var1, Level var2) {
      ...
      for(int var7 = 0; var7 < var1.getContainerSize(); ++var7) {
         ...
         if (!var8.isEmpty()) {
            if (var8.method_87(Blocks.BROWN_MUSHROOM.asItem()) && !var5) {
               var5 = true;
            } else if (var8.method_87(Blocks.RED_MUSHROOM.asItem()) && !var4) {
               var4 = true;
            } else if (var8.method_86(ItemTags.SMALL_FLOWERS) && !var3) {
               var3 = true;
            } else {
               if (!var8.method_87(Items.BOWL) || var6) {
                  return false;
               }
   ...
   public ItemStack assemble(CraftingContainer var1) {
      ...
      for(int var3 = 0; var3 < var1.getContainerSize(); ++var3) {
         ...
         if (!var4.isEmpty() && var4.method_86(ItemTags.SMALL_FLOWERS)) {
            var2 = var4;
            break;
         }
      }
