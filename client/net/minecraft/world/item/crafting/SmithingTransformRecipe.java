...
public class SmithingTransformRecipe implements SmithingRecipe {
   ...
   public SmithingTransformRecipe(Optional<Ingredient> var1, Optional<Ingredient> var2, Optional<Ingredient> var3, TransmuteResult var4) {
      super();
      this.template = var1;
      this.base = var2;
      this.addition = var3;
   ...
   public List<RecipeDisplay> display() {
      return List.of(new SmithingRecipeDisplay(Ingredient.optionalIngredientToDisplay(this.template), Ingredient.optionalIngredientToDisplay(this.base), Ingredient.optionalIngredientToDisplay(this.addition), this.result.display(), new SlotDisplay.ItemSlotDisplay(Items.SMITHING_TABLE)));
   }
   ...
   public static class Serializer implements RecipeSerializer<SmithingTransformRecipe> {
      ...
      static {
         STREAM_CODEC = StreamCodec.composite(Ingredient.OPTIONAL_CONTENTS_STREAM_CODEC, (var0) -> var0.template, Ingredient.OPTIONAL_CONTENTS_STREAM_CODEC, (var0) -> var0.base, Ingredient.OPTIONAL_CONTENTS_STREAM_CODEC, (var0) -> var0.addition, TransmuteResult.STREAM_CODEC, (var0) -> var0.result, SmithingTransformRecipe::new);
      }
   }
}
