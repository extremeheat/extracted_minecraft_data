...
public interface SlotDisplay {
   ...
   public static record WithRemainder(SlotDisplay input, SlotDisplay remainder) implements SlotDisplay {
      public static final MapCodec<WithRemainder> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(SlotDisplay.CODEC.fieldOf("input").forGetter(WithRemainder::input), SlotDisplay.CODEC.fieldOf("remainder").forGetter(WithRemainder::remainder)).apply(var0, WithRemainder::new);
      });
   ...
   public static record Composite(List<SlotDisplay> contents) implements SlotDisplay {
      public static final MapCodec<Composite> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(SlotDisplay.CODEC.listOf().fieldOf("contents").forGetter(Composite::contents)).apply(var0, Composite::new);
      });
   ...
   public static record TagSlotDisplay(TagKey<Item> tag) implements SlotDisplay {
      public static final MapCodec<TagSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(TagKey.codec(Registries.ITEM).fieldOf("tag").forGetter(TagSlotDisplay::tag)).apply(var0, TagSlotDisplay::new);
      });
   ...
   public static record ItemStackSlotDisplay(ItemStack stack) implements SlotDisplay {
      public static final MapCodec<ItemStackSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(ItemStack.STRICT_CODEC.fieldOf("item").forGetter(ItemStackSlotDisplay::stack)).apply(var0, ItemStackSlotDisplay::new);
      });
   ...
   public static record ItemSlotDisplay(Holder<Item> item) implements SlotDisplay {
      public static final MapCodec<ItemSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(Item.CODEC.fieldOf("item").forGetter(ItemSlotDisplay::item)).apply(var0, ItemSlotDisplay::new);
      });
   ...
   public static record SmithingTrimDemoSlotDisplay(SlotDisplay base, SlotDisplay material, SlotDisplay pattern) implements SlotDisplay {
      public static final MapCodec<SmithingTrimDemoSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(SlotDisplay.CODEC.fieldOf("base").forGetter(SmithingTrimDemoSlotDisplay::base), SlotDisplay.CODEC.fieldOf("material").forGetter(SmithingTrimDemoSlotDisplay::material), SlotDisplay.CODEC.fieldOf("pattern").forGetter(SmithingTrimDemoSlotDisplay::pattern)).apply(var0, SmithingTrimDemoSlotDisplay::new);
      });
