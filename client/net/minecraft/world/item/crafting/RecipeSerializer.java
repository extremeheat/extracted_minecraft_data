...
public interface RecipeSerializer<T extends Recipe<?>> {
   ...
   RecipeSerializer<FireworkStarFadeRecipe> FIREWORK_STAR_FADE = register("crafting_special_firework_star_fade", new CustomRecipe.Serializer(FireworkStarFadeRecipe::new));
   ...
   RecipeSerializer<BannerDuplicateRecipe> BANNER_DUPLICATE = register("crafting_special_bannerduplicate", new CustomRecipe.Serializer(BannerDuplicateRecipe::new));
   RecipeSerializer<ShieldDecorationRecipe> SHIELD_DECORATION = register("crafting_special_shielddecoration", new CustomRecipe.Serializer(ShieldDecorationRecipe::new));
