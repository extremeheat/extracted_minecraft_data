...
public class RecipeManager extends SimpleJsonResourceReloadListener {
   ...
   protected void apply(Map<ResourceLocation, JsonElement> var1, ResourceManager var2, ProfilerFiller var3) {
      ...
      for(Entry var7 : var1.entrySet()) {
         ...
         try {
            ...
            ((Builder)var4.computeIfAbsent(var9.getType(), var0 -> ImmutableMap.builder())).put(var8, var9);
            var5.put(var8, var9);
   ...
   public <C extends Container, T extends Recipe<C>> Optional<T> getRecipeFor(RecipeType<T> var1, C var2, Level var3) {
      return this.byType(var1).values().stream().filter(var2x -> var2x.matches((C)var2, var3)).findFirst();
   }
   ...
   public <C extends Container, T extends Recipe<C>> Optional<Pair<ResourceLocation, T>> getRecipeFor(
      ...
      return var5.entrySet()
         .stream()
         .filter(var2x -> ((Recipe)var2x.getValue()).matches(var2, var3))
         .findFirst()
         .map(var0 -> Pair.of((ResourceLocation)var0.getKey(), (Recipe)var0.getValue()));
   }
   ...
   public <C extends Container, T extends Recipe<C>> List<T> getRecipesFor(RecipeType<T> var1, C var2, Level var3) {
      return this.byType(var1)
         .values()
         .stream()
         .filter(var2x -> var2x.matches(var2, var3))
         .sorted(Comparator.comparing(var1x -> var1x.getResultItem(var3.registryAccess()).getDescriptionId()))
   ...
   public static Recipe<?> fromJson(ResourceLocation var0, JsonObject var1) {
      ...
      return BuiltInRegistries.RECIPE_SERIALIZER
         ...
         .orElseThrow(() -> new JsonSyntaxException("Invalid or unsupported recipe type '" + var2 + "'"))
         .fromJson(var0, var1);
   }
   ...
   public void replaceRecipes(Iterable<Recipe<?>> var1) {
      ...
      var1.forEach(var2x -> {
         Map var3x = var2.computeIfAbsent(var2x.getType(), var0x -> Maps.newHashMap());
         ResourceLocation var4 = var2x.getId();
         Recipe var5 = var3x.put(var4, var2x);
         var3.put(var4, var2x);
         if (var5 != null) {
      ...
      return new RecipeManager.CachedCheck<C, T>() {
         ...
         public Optional<T> getRecipeFor(C var1, Level var2) {
            ...
            if (var4.isPresent()) {
               ...
               return Optional.of((T)var5.getSecond());
            } else {
