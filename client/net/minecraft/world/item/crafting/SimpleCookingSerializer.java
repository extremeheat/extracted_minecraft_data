...
public class SimpleCookingSerializer<T extends AbstractCookingRecipe> implements RecipeSerializer<T> {
   ...
   public T fromJson(ResourceLocation var1, JsonObject var2) {
      ...
      Object var4 = GsonHelper.isArrayNode(var2, "ingredient")
      ...
      ItemStack var8 = new ItemStack(Registry.ITEM.getOptional(var7).orElseThrow(() -> new IllegalStateException("Item: " + var6 + " does not exist")));
