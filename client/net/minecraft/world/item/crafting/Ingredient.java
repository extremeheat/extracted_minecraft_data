...
public final class Ingredient implements Predicate<ItemStack> {
      ...
      if (var1 == null) {
         ...
         if (this.itemStacks.length == 0) {
            ...
            for(int var4 = 0; var4 < var3; ++var4) {
               ...
               if (var5.method_87(var1.getItem())) {
                  return true;
               }
            }
   ...
   // $FF: renamed from: of () net.minecraft.world.item.crafting.Ingredient
   public static Ingredient method_109() {
      return EMPTY;
   }

   // $FF: renamed from: of (net.minecraft.world.level.ItemLike[]) net.minecraft.world.item.crafting.Ingredient
   public static Ingredient method_110(ItemLike... var0) {
      return method_112(Arrays.stream(var0).map(ItemStack::new));
   }

   // $FF: renamed from: of (net.minecraft.world.item.ItemStack[]) net.minecraft.world.item.crafting.Ingredient
   public static Ingredient method_111(ItemStack... var0) {
      return method_112(Arrays.stream(var0));
   }

   // $FF: renamed from: of (java.util.stream.Stream) net.minecraft.world.item.crafting.Ingredient
   public static Ingredient method_112(Stream<ItemStack> var0) {
      return fromValues(var0.filter((var0x) -> {
         return !var0x.isEmpty();
      }).map(Ingredient.ItemValue::new));
   }

   // $FF: renamed from: of (net.minecraft.tags.Tag) net.minecraft.world.item.crafting.Ingredient
   public static Ingredient method_113(Tag<Item> var0) {
