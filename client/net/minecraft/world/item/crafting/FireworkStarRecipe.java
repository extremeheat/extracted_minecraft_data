...
public class FireworkStarRecipe extends CustomRecipe {
   ...
   static {
      SHAPE_INGREDIENT = Ingredient.method_110(Items.FIRE_CHARGE, Items.FEATHER, Items.GOLD_NUGGET, Items.SKELETON_SKULL, Items.WITHER_SKELETON_SKULL, Items.CREEPER_HEAD, Items.PLAYER_HEAD, Items.DRAGON_HEAD, Items.ZOMBIE_HEAD);
      TRAIL_INGREDIENT = Ingredient.method_110(Items.DIAMOND);
      FLICKER_INGREDIENT = Ingredient.method_110(Items.GLOWSTONE_DUST);
      ...
      GUNPOWDER_INGREDIENT = Ingredient.method_110(Items.GUNPOWDER);
   }
}
