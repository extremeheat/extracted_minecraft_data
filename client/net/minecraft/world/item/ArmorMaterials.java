...
public class ArmorMaterials {
   ...
   }), SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, var0 -> var0.is(Items.IRON_INGOT));
   ...
   }), SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, var0 -> var0.is(Items.IRON_INGOT));
   ...
   }), SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, var0 -> var0.is(Items.GOLD_INGOT));
   ...
   }), SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, var0 -> var0.is(Items.DIAMOND));
   public static final Holder<ArmorMaterial> TURTLE = register("turtle", Util.make(new EnumMap<>(ArmorItem.Type.class), var0 -> {
      ...
      var0.put(ArmorItem.Type.HELMET, 2);
      var0.put(ArmorItem.Type.BODY, 5);
   }), SoundEvents.ARMOR_EQUIP_TURTLE, 0.0F, 0.0F, var0 -> var0.is(Items.TURTLE_SCUTE));
   public static final Holder<ArmorMaterial> NETHERITE = register("netherite", Util.make(new EnumMap<>(ArmorItem.Type.class), var0 -> {
      ...
      var0.put(ArmorItem.Type.HELMET, 3);
      var0.put(ArmorItem.Type.BODY, 11);
   }), SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, var0 -> var0.is(Items.NETHERITE_INGOT));
   public static final Holder<ArmorMaterial> ARMADILLO = register("armadillo", Util.make(new EnumMap<>(ArmorItem.Type.class), var0 -> {
      ...
      var0.put(ArmorItem.Type.HELMET, 3);
      var0.put(ArmorItem.Type.BODY, 11);
   }), SoundEvents.ARMOR_EQUIP_WOLF, 0.0F, 0.0F, var0 -> var0.is(Items.ARMADILLO_SCUTE));
   ...
   private static Holder<ArmorMaterial> register(
      String var0, EnumMap<ArmorItem.Type, Integer> var1, Holder<SoundEvent> var2, float var3, float var4, Predicate<ItemStack> var5
   ) {
      List var6 = List.of(new ArmorMaterial.Layer(ResourceLocation.withDefaultNamespace(var0)));
      return register(var0, var1, var2, var3, var4, var5, var6);
   }

   private static Holder<ArmorMaterial> register(
      String var0,
      EnumMap<ArmorItem.Type, Integer> var1,
      Holder<SoundEvent> var2,
      float var3,
      float var4,
      Predicate<ItemStack> var5,
      List<ArmorMaterial.Layer> var6
   ) {
      EnumMap var7 = new EnumMap<>(ArmorItem.Type.class);

      for (ArmorItem.Type var11 : ArmorItem.Type.values()) {
         var7.put(var11, (Integer)var1.get(var11));
      }

      return Registry.registerForHolder(
         BuiltInRegistries.ARMOR_MATERIAL, ResourceLocation.withDefaultNamespace(var0), new ArmorMaterial(var7, var2, var5, var6, var3, var4)
      );
   }
}
