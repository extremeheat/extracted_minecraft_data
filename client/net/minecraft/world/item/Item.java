...
public class Item implements ItemLike {
   ...
   public Item(Properties var1) {
      super();
      this.builtInRegistryHolder = Registry.ITEM.createIntrusiveHolder(this);
   ...
   public static class Properties {
      ...
      public Properties defaultDurability(int var1) {
      ...
      public Properties tab(CreativeModeTab var1) {
         this.category = var1;
         return this;
      }
