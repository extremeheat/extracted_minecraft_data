...
public abstract class Enchantment {
   ...
   protected Enchantment(Rarity var1, EnchantmentCategory var2, EquipmentSlot[] var3) {
      super();
      this.rarity = var1;
      this.category = var2;
      this.slots = var3;
   ...
   public Component getFullname(int var1) {
      ...
      if (var1 != 1 || this.getMaxLevel() != 1) {
         var2.append(" ").append((Component)Component.translatable("enchantment.level." + var1));
      }
