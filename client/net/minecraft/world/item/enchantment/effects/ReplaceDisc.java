...
public record ReplaceDisc(LevelBasedValue radius, LevelBasedValue height, Vec3i offset, Optional<BlockPredicate> predicate, BlockStateProvider blockState) implements EnchantmentEntityEffect {
   public static final MapCodec<ReplaceDisc> CODEC = RecordCodecBuilder.mapCodec((var0) -> {
      return var0.group(LevelBasedValue.CODEC.fieldOf("radius").forGetter(ReplaceDisc::radius), LevelBasedValue.CODEC.fieldOf("height").forGetter(ReplaceDisc::height), Vec3i.CODEC.optionalFieldOf("offset", Vec3i.ZERO).forGetter(ReplaceDisc::offset), BlockPredicate.CODEC.optionalFieldOf("predicate").forGetter(ReplaceDisc::predicate), BlockStateProvider.CODEC.fieldOf("block_state").forGetter(ReplaceDisc::blockState)).apply(var0, ReplaceDisc::new);
   });
   ...
   public void apply(ServerLevel var1, int var2, EnchantedItemInUse var3, Entity var4, Vec3 var5) {
      ...
      while(var10.hasNext()) {
         ...
         if (var11.closerToCenterThan(var5, (double)var8) && (Boolean)this.predicate.map((var2x) -> {
