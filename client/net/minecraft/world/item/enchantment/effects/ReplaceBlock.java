...
public record ReplaceBlock(Vec3i offset, Optional<BlockPredicate> predicate, BlockStateProvider blockState, Optional<Holder<GameEvent>> triggerGameEvent)
   ...
   public ReplaceBlock(Vec3i offset, Optional<BlockPredicate> predicate, BlockStateProvider blockState, Optional<Holder<GameEvent>> triggerGameEvent) {
      super();
      this.offset = offset;
   ...
   public void apply(ServerLevel var1, int var2, EnchantedItemInUse var3, Entity var4, Vec3 var5) {
      ...
      if (this.predicate.map(var2x -> var2x.test(var1, var6)).orElse(true) && var1.setBlockAndUpdate(var6, this.blockState.getState(var4.getRandom(), var6))) {
         this.triggerGameEvent.ifPresent(var3x -> var1.gameEvent(var4, (Holder<GameEvent>)var3x, var6));
      }
   }
