...
public record ExplodeEffect(
   ...
   public void apply(ServerLevel var1, int var2, EnchantedItemInUse var3, Entity var4, Vec3 var5) {
      ...
      var1.explode(
         this.attributeToUser ? var4 : null,
         this.getDamageSource(var4, var6),
         new SimpleExplosionDamageCalculator(
            this.blockInteraction != Level.ExplosionInteraction.NONE,
            this.damageType.isPresent(),
            this.knockbackMultiplier.map(var1x -> var1x.calculate(var2)),
            this.immuneBlocks
         ),
         var6.x(),
         var6.y(),
         var6.z(),
         Math.max(this.radius.calculate(var2), 0.0F),
         this.createFire,
   ...
   private DamageSource getDamageSource(Entity var1, Vec3 var2) {
      if (this.damageType.isEmpty()) {
         ...
         return this.attributeToUser ? new DamageSource(this.damageType.get(), var1) : new DamageSource(this.damageType.get(), var2);
      }
   }
