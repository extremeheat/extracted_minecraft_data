...
public class WindBurstEnchantment extends Enchantment {
   private static final WindBurstEnchantmentDamageCalculator[] damageCalculators = new WindBurstEnchantmentDamageCalculator[]{new WindBurstEnchantmentDamageCalculator(0.5F), new WindBurstEnchantmentDamageCalculator(0.75F), new WindBurstEnchantmentDamageCalculator(1.0F)};
   ...
   public void doPostItemStackHurt(LivingEntity var1, Entity var2, int var3) {
      var1.level().explode((Entity)null, (DamageSource)null, damageCalculators[var3 - 1], var1.getX(), var1.getY(), var1.getZ(), 3.5F, false, Level.ExplosionInteraction.BLOW, ParticleTypes.GUST_EMITTER_SMALL, ParticleTypes.GUST_EMITTER_LARGE, SoundEvents.WIND_CHARGE_BURST);
   }
