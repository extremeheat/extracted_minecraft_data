   ...
   public static synchronized int[] func_76445_a(int var0) {
      if (var0 <= 256) {
         if (field_76449_b.isEmpty()) {
            ...
            field_76450_c.add(var5);
            return var5;
         } else {
            int[] var4 = (int[])field_76449_b.remove(field_76449_b.size() - 1);
            field_76450_c.add(var4);
            return var4;
         }
         ...
         field_76447_d.clear();
         field_76448_e.clear();
         int[] var3 = new int[field_76451_a];
         field_76448_e.add(var3);
         return var3;
      } else if (field_76447_d.isEmpty()) {
         int[] var2 = new int[field_76451_a];
         field_76448_e.add(var2);
         return var2;
      } else {
         int[] var1 = (int[])field_76447_d.remove(field_76447_d.size() - 1);
