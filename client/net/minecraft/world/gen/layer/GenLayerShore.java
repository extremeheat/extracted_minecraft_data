...
public class GenLayerShore extends GenLayer {
      ...
      for(int var7 = 0; var7 < var4; ++var7) {
         for(int var8 = 0; var8 < var3; ++var8) {
            ...
            if (var9 == BiomeGenBase.field_76789_p.field_76756_M) {
               ...
               if (var11 != BiomeGenBase.field_76771_b.field_76756_M
                  && var12 != BiomeGenBase.field_76771_b.field_76756_M
                  && var13 != BiomeGenBase.field_76771_b.field_76756_M
                  && var14 != BiomeGenBase.field_76771_b.field_76756_M) {
               ...
               if (!this.func_151631_c(var17) || !this.func_151631_c(var20) || !this.func_151631_c(var23) || !this.func_151631_c(var26)) {
                  var6[var8 + var7 * var3] = BiomeGenBase.field_150574_L.field_76756_M;
               } else if (!func_151618_b(var17) && !func_151618_b(var20) && !func_151618_b(var23) && !func_151618_b(var26)) {
                  var6[var8 + var7 * var3] = var9;
               } else {
                  var6[var8 + var7 * var3] = BiomeGenBase.field_76787_r.field_76756_M;
               }
            } else if (var9 == BiomeGenBase.field_76770_e.field_76756_M
               || var9 == BiomeGenBase.field_150580_W.field_76756_M
               || var9 == BiomeGenBase.field_76783_v.field_76756_M) {
               this.func_151632_a(var5, var6, var8, var7, var3, var9, BiomeGenBase.field_150576_N.field_76756_M);
            } else if (var10 != null && var10.func_150559_j()) {
               ...
               if (func_151618_b(var16) || func_151618_b(var19) || func_151618_b(var22) || func_151618_b(var25)) {
                  var6[var8 + var7 * var3] = var9;
               } else if (this.func_151633_d(var16) && this.func_151633_d(var19) && this.func_151633_d(var22) && this.func_151633_d(var25)) {
                  var6[var8 + var7 * var3] = var9;
               } else {
                  var6[var8 + var7 * var3] = BiomeGenBase.field_76769_d.field_76756_M;
               }
            } else if (var9 != BiomeGenBase.field_76771_b.field_76756_M
               && var9 != BiomeGenBase.field_150575_M.field_76756_M
               && var9 != BiomeGenBase.field_76781_i.field_76756_M
               && var9 != BiomeGenBase.field_76780_h.field_76756_M) {
               ...
               if (!func_151618_b(var15) && !func_151618_b(var18) && !func_151618_b(var21) && !func_151618_b(var24)) {
                  var6[var8 + var7 * var3] = var9;
               } else {
                  var6[var8 + var7 * var3] = BiomeGenBase.field_76787_r.field_76756_M;
               }
   ...
   private boolean func_151631_c(int var1) {
      if (BiomeGenBase.func_150568_d(var1) != null && BiomeGenBase.func_150568_d(var1).func_150562_l() == BiomeGenJungle.class) {
         ...
         return var1 == BiomeGenBase.field_150574_L.field_76756_M
            || var1 == BiomeGenBase.field_76782_w.field_76756_M
            || var1 == BiomeGenBase.field_76792_x.field_76756_M
            || var1 == BiomeGenBase.field_76767_f.field_76756_M
            || var1 == BiomeGenBase.field_76768_g.field_76756_M
            || func_151618_b(var1);
      }
   }

   private boolean func_151633_d(int var1) {
      return BiomeGenBase.func_150568_d(var1) != null && BiomeGenBase.func_150568_d(var1) instanceof BiomeGenMesa;
   }
}
