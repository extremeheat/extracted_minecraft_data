   ...
   public int[] func_75904_a(int var1, int var2, int var3, int var4) {
      ...
      for(int var13 = 0; var13 < var8 - 1; ++var13) {
         ...
         for(int var16 = var9[var14 + 0 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14) {
            ...
            double var19 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6;
            double var21 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6;
            this.func_75903_a((long)(var14 + var5 + 1 << 2), (long)(var13 + var6 << 2));
            double var23 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6 + 4.0;
            double var25 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6;
            this.func_75903_a((long)(var14 + var5 << 2), (long)(var13 + var6 + 1 << 2));
            double var27 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6;
            double var29 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6 + 4.0;
            this.func_75903_a((long)(var14 + var5 + 1 << 2), (long)(var13 + var6 + 1 << 2));
            double var31 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6 + 4.0;
            double var33 = ((double)this.func_75902_a(1024) / 1024.0 - 0.5) * 3.6 + 4.0;
      ...
      int[] var50 = IntCache.func_76445_a(var3 * var4);
