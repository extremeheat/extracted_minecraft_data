...
public class StructureOceanMonumentPieces {
   ...
   static class YZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
      ...
      public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition var1) {
         if (var1.field_175966_c[EnumFacing.NORTH.func_176745_a()] && !var1.field_175965_b[EnumFacing.NORTH.func_176745_a()].field_175963_d && var1.field_175966_c[EnumFacing.UP.func_176745_a()] && !var1.field_175965_b[EnumFacing.UP.func_176745_a()].field_175963_d) {
            StructureOceanMonumentPieces.RoomDefinition var2 = var1.field_175965_b[EnumFacing.NORTH.func_176745_a()];
   ...
   static class XYDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
      ...
      public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition var1) {
         if (var1.field_175966_c[EnumFacing.EAST.func_176745_a()] && !var1.field_175965_b[EnumFacing.EAST.func_176745_a()].field_175963_d && var1.field_175966_c[EnumFacing.UP.func_176745_a()] && !var1.field_175965_b[EnumFacing.UP.func_176745_a()].field_175963_d) {
            StructureOceanMonumentPieces.RoomDefinition var2 = var1.field_175965_b[EnumFacing.EAST.func_176745_a()];
            return var2.field_175966_c[EnumFacing.UP.func_176745_a()] && !var2.field_175965_b[EnumFacing.UP.func_176745_a()].field_175963_d;
         } else {
            return false;
         }
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         ...
         for(var7 = 1; var7 <= 6; ++var7) {
            ...
            for(int var6 = 0; var6 <= 15; var6 += 15) {
               this.func_175804_a(var1, var3, var6, var7, 0, var6, var7, 1, var5, var5, false);
               this.func_175804_a(var1, var3, var6, var7, 6, var6, var7, 9, var5, var5, false);
               this.func_175804_a(var1, var3, var6, var7, 14, var6, var7, 15, var5, var5, false);
            }

            this.func_175804_a(var1, var3, 1, var7, 0, 1, var7, 0, var5, var5, false);
            this.func_175804_a(var1, var3, 6, var7, 0, 9, var7, 0, var5, var5, false);
            this.func_175804_a(var1, var3, 14, var7, 0, 14, var7, 0, var5, var5, false);
            this.func_175804_a(var1, var3, 1, var7, 15, 14, var7, 15, var5, var5, false);
         }
         ...
         for(var7 = 3; var7 <= 6; var7 += 3) {
            for(int var8 = 6; var8 <= 9; var8 += 3) {
               this.func_175811_a(var1, field_175825_e, var8, var7, 6, var3);
               this.func_175811_a(var1, field_175825_e, var8, var7, 9, var3);
            }
         }
   ...
   public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         StructureOceanMonumentPieces.RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.NORTH.func_176745_a()];
         StructureOceanMonumentPieces.RoomDefinition var5 = this.field_175830_k;
         StructureOceanMonumentPieces.RoomDefinition var6 = var4.field_175965_b[EnumFacing.UP.func_176745_a()];
         StructureOceanMonumentPieces.RoomDefinition var7 = var5.field_175965_b[EnumFacing.UP.func_176745_a()];
         if (this.field_175830_k.field_175967_a / 25 > 0) {
            this.func_175821_a(var1, var3, 0, 8, var4.field_175966_c[EnumFacing.DOWN.func_176745_a()]);
            this.func_175821_a(var1, var3, 0, 0, var5.field_175966_c[EnumFacing.DOWN.func_176745_a()]);
         }
         ...
         if (var4.field_175966_c[EnumFacing.NORTH.func_176745_a()]) {
            this.func_181655_a(var1, var3, 3, 1, 15, 4, 2, 15, false);
         }

         if (var4.field_175966_c[EnumFacing.WEST.func_176745_a()]) {
            this.func_181655_a(var1, var3, 0, 1, 11, 0, 2, 12, false);
         }

         if (var4.field_175966_c[EnumFacing.EAST.func_176745_a()]) {
   ...
   public static class DoubleXYRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         StructureOceanMonumentPieces.RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.EAST.func_176745_a()];
         StructureOceanMonumentPieces.RoomDefinition var5 = this.field_175830_k;
         StructureOceanMonumentPieces.RoomDefinition var6 = var5.field_175965_b[EnumFacing.UP.func_176745_a()];
         StructureOceanMonumentPieces.RoomDefinition var7 = var4.field_175965_b[EnumFacing.UP.func_176745_a()];
         if (this.field_175830_k.field_175967_a / 25 > 0) {
            this.func_175821_a(var1, var3, 8, 0, var4.field_175966_c[EnumFacing.DOWN.func_176745_a()]);
            this.func_175821_a(var1, var3, 0, 0, var5.field_175966_c[EnumFacing.DOWN.func_176745_a()]);
         }
         ...
         if (var4.field_175966_c[EnumFacing.SOUTH.func_176745_a()]) {
   ...
   public static class DoubleZRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         ...
         if (var4.field_175965_b[EnumFacing.UP.func_176745_a()] == null) {
   ...
   public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         ...
         StructureOceanMonumentPieces.RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.UP.func_176745_a()];
         if (var4.field_175965_b[EnumFacing.UP.func_176745_a()] == null) {
         ...
         for(int var4 = 1; var4 <= 6; ++var4) {
            for(int var5 = 1; var5 <= 6; ++var5) {
               if (var2.nextInt(3) != 0) {
                  ...
                  this.func_175804_a(var1, var3, var4, var6, var5, var4, 3, var5, Blocks.field_150360_v.func_176203_a(1), Blocks.field_150360_v.func_176203_a(1), false);
               }
            }
         }
   ...
   public static class SimpleRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         ...
         boolean var4 = this.field_175833_o != 0 && var2.nextBoolean() && !this.field_175830_k.field_175966_c[EnumFacing.DOWN.func_176745_a()] && !this.field_175830_k.field_175966_c[EnumFacing.UP.func_176745_a()] && this.field_175830_k.func_175960_c() > 1;
   ...
   public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
      ...
      public MonumentBuilding(Random var1, int var2, int var3, EnumFacing var4) {
         ...
         case NORTH:
         case SOUTH:
            this.field_74887_e = new StructureBoundingBox(var2, 39, var3, var2 + 58 - 1, 61, var3 + 58 - 1);
            break;
         default:
            this.field_74887_e = new StructureBoundingBox(var2, 39, var3, var2 + 58 - 1, 61, var3 + 58 - 1);
         }
         ...
         this.field_175843_q.add(new StructureOceanMonumentPieces.MonumentCoreRoom(this.field_74885_f, this.field_175844_p, var1));
         ...
         while(true) {
            while(true) {
               ...
               do {
                  do {
                     if (!var7.hasNext()) {
                        int var14 = this.field_74887_e.field_78895_b;
                        int var15 = this.func_74865_a(9, 22);
                        int var16 = this.func_74873_b(9, 22);
                        ...
                        while(var17.hasNext()) {
                           ...
                           var11.func_74874_b().func_78886_a(var15, var14, var16);
                        }

                        StructureBoundingBox var18 = StructureBoundingBox.func_175899_a(this.func_74865_a(1, 1), this.func_74862_a(1), this.func_74873_b(1, 1), this.func_74865_a(23, 21), this.func_74862_a(8), this.func_74873_b(23, 21));
                        StructureBoundingBox var19 = StructureBoundingBox.func_175899_a(this.func_74865_a(34, 1), this.func_74862_a(1), this.func_74873_b(34, 1), this.func_74865_a(56, 21), this.func_74862_a(8), this.func_74873_b(56, 21));
                        StructureBoundingBox var12 = StructureBoundingBox.func_175899_a(this.func_74865_a(22, 22), this.func_74862_a(13), this.func_74873_b(22, 22), this.func_74865_a(35, 35), this.func_74862_a(17), this.func_74873_b(35, 35));
                        int var13 = var1.nextInt();
                        this.field_175843_q.add(new StructureOceanMonumentPieces.WingRoom(this.field_74885_f, var18, var13++));
                        this.field_175843_q.add(new StructureOceanMonumentPieces.WingRoom(this.field_74885_f, var19, var13++));
                        this.field_175843_q.add(new StructureOceanMonumentPieces.Penthouse(this.field_74885_f, var12));
                        return;
                     }
               ...
               while(var9.hasNext()) {
                  ...
                  if (var10.func_175969_a(var8)) {
                     this.field_175843_q.add(var10.func_175968_a(this.field_74885_f, var8, var1));
                     break;
                  }
               }
            }
      ...
      private List<StructureOceanMonumentPieces.RoomDefinition> func_175836_a(Random var1) {
         ...
         for(var9 = 0; var9 < var8; ++var9) {
            StructureOceanMonumentPieces.RoomDefinition var23 = var20[var9];
            if (var23 != null) {
               var23.func_175958_a();
               var19.add(var23);
            }
         ...
         label95:
         while(var22.hasNext()) {
            StructureOceanMonumentPieces.RoomDefinition var24 = (StructureOceanMonumentPieces.RoomDefinition)var22.next();
            int var25 = 0;
            var11 = 0;
      ...
      public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
         int var4 = Math.max(var1.func_181545_F(), 64) - this.field_74887_e.field_78895_b;
               ...
               while(true) {
                  ...
                  for(int var9 = 0; var9 < 4; ++var9) {
                     for(int var10 = 0; var10 < 4; ++var10) {
                        this.func_175811_a(var1, field_175826_b, var7 + var9, 0, var8 + var10, var3);
                        this.func_175808_b(var1, field_175826_b, var7 + var9, -1, var8 + var10, var3);
                     }
                  }
         ...
         while(var11.hasNext()) {
            ...
            if (var12.func_74874_b().func_78884_a(var3)) {
               var12.func_74875_a(var1, var2, var3);
            }
         }
   ...
   public abstract static class Piece extends StructureComponent {
      ...
      protected Piece(int var1, EnumFacing var2, StructureOceanMonumentPieces.RoomDefinition var3, int var4, int var5, int var6) {
         ...
         if (var2 != EnumFacing.NORTH && var2 != EnumFacing.SOUTH) {
            this.field_74887_e = new StructureBoundingBox(0, 0, 0, var6 * 8 - 1, var5 * 4 - 1, var4 * 8 - 1);
         } else {
            this.field_74887_e = new StructureBoundingBox(0, 0, 0, var4 * 8 - 1, var5 * 4 - 1, var6 * 8 - 1);
         }
         ...
         for(int var10 = var4; var10 <= var7; ++var10) {
            for(int var11 = var3; var11 <= var6; ++var11) {
               for(int var12 = var5; var12 <= var8; ++var12) {
                  if (!var9 || this.func_175807_a(var1, var11, var10, var12, var2).func_177230_c().func_149688_o() != Material.field_151579_a) {
                     if (this.func_74862_a(var10) >= var1.func_181545_F()) {
                        this.func_175811_a(var1, Blocks.field_150350_a.func_176223_P(), var11, var10, var12, var2);
                     } else {
                        this.func_175811_a(var1, field_175822_f, var11, var10, var12, var2);
                     }
                  }
               }
            }
      ...
      protected boolean func_175817_a(World var1, StructureBoundingBox var2, int var3, int var4, int var5) {
         ...
         if (var2.func_175898_b(new BlockPos(var6, var7, var8))) {
            ...
            var9.func_180482_a(var1.func_175649_E(new BlockPos(var9)), (IEntityLivingData)null);
      ...
      static {
         field_175828_a = Blocks.field_180397_cI.func_176203_a(BlockPrismarine.field_176331_b);
         field_175826_b = Blocks.field_180397_cI.func_176203_a(BlockPrismarine.field_176333_M);
         field_175827_c = Blocks.field_180397_cI.func_176203_a(BlockPrismarine.field_176334_N);
