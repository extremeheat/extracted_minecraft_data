...
public class StructureVillagePieces$Field2 extends StructureVillagePieces$Village {
   ...
   public static StructureVillagePieces$Field2 func_74902_a(
      StructureVillagePieces$Start var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7
   ) {
      StructureBoundingBox var8 = StructureBoundingBox.func_78889_a(var3, var4, var5, 0, 0, 0, 7, 4, 9, var6);
   ...
   public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
      ...
      this.func_151549_a(var1, var3, 0, 1, 0, 6, 4, 8, Blocks.field_150350_a, Blocks.field_150350_a, false);
      ...
      this.func_151549_a(var1, var3, 1, 0, 0, 5, 0, 0, Blocks.field_150364_r, Blocks.field_150364_r, false);
      this.func_151549_a(var1, var3, 1, 0, 8, 5, 0, 8, Blocks.field_150364_r, Blocks.field_150364_r, false);
      this.func_151549_a(var1, var3, 3, 0, 1, 3, 0, 7, Blocks.field_150355_j, Blocks.field_150355_j, false);

      for(int var4 = 1; var4 <= 7; ++var4) {
         this.func_151550_a(var1, this.field_82675_b, MathHelper.func_76136_a(var2, 2, 7), 1, 1, var4, var3);
         this.func_151550_a(var1, this.field_82675_b, MathHelper.func_76136_a(var2, 2, 7), 2, 1, var4, var3);
         this.func_151550_a(var1, this.field_82676_c, MathHelper.func_76136_a(var2, 2, 7), 4, 1, var4, var3);
         this.func_151550_a(var1, this.field_82676_c, MathHelper.func_76136_a(var2, 2, 7), 5, 1, var4, var3);
      }
