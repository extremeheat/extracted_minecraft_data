...
public class StructureNetherBridgePieces$Corridor extends StructureNetherBridgePieces$Piece {
   ...
   public static StructureNetherBridgePieces$Corridor func_74978_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public boolean func_74875_a(World var1, Random var2, StructureBoundingBox var3) {
      ...
      this.func_151549_a(var1, var3, 4, 2, 0, 4, 5, 4, Blocks.field_150385_bj, Blocks.field_150385_bj, false);
      this.func_151549_a(var1, var3, 4, 3, 1, 4, 4, 1, Blocks.field_150386_bk, Blocks.field_150386_bk, false);
      this.func_151549_a(var1, var3, 4, 3, 3, 4, 4, 3, Blocks.field_150386_bk, Blocks.field_150386_bk, false);
      this.func_151549_a(var1, var3, 0, 2, 0, 0, 5, 0, Blocks.field_150385_bj, Blocks.field_150385_bj, false);
      this.func_151549_a(var1, var3, 0, 2, 4, 3, 5, 4, Blocks.field_150385_bj, Blocks.field_150385_bj, false);
      ...
      if (this.field_111021_b) {
         ...
         if (var3.func_78890_b(var5, var4, var6)) {
            ...
            this.func_74879_a(var1, var3, var2, 3, 2, 3, field_111019_a, 2 + var2.nextInt(4));
         }
      }
