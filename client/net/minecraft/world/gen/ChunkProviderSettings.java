...
public class ChunkProviderSettings {
   ...
   public static class Serializer implements JsonDeserializer<ChunkProviderSettings.Factory>, JsonSerializer<ChunkProviderSettings.Factory> {
      ...
      public ChunkProviderSettings.Factory deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         ...
         try {
            var5.field_177899_b = JsonUtils.func_151221_a(var4, "coordinateScale", var5.field_177899_b);
            var5.field_177900_c = JsonUtils.func_151221_a(var4, "heightScale", var5.field_177900_c);
            var5.field_177898_e = JsonUtils.func_151221_a(var4, "lowerLimitScale", var5.field_177898_e);
            var5.field_177896_d = JsonUtils.func_151221_a(var4, "upperLimitScale", var5.field_177896_d);
            var5.field_177893_f = JsonUtils.func_151221_a(var4, "depthNoiseScaleX", var5.field_177893_f);
            var5.field_177894_g = JsonUtils.func_151221_a(var4, "depthNoiseScaleZ", var5.field_177894_g);
            var5.field_177915_h = JsonUtils.func_151221_a(var4, "depthNoiseScaleExponent", var5.field_177915_h);
            var5.field_177917_i = JsonUtils.func_151221_a(var4, "mainNoiseScaleX", var5.field_177917_i);
            var5.field_177911_j = JsonUtils.func_151221_a(var4, "mainNoiseScaleY", var5.field_177911_j);
            var5.field_177913_k = JsonUtils.func_151221_a(var4, "mainNoiseScaleZ", var5.field_177913_k);
            var5.field_177907_l = JsonUtils.func_151221_a(var4, "baseSize", var5.field_177907_l);
            var5.field_177909_m = JsonUtils.func_151221_a(var4, "stretchY", var5.field_177909_m);
            var5.field_177903_n = JsonUtils.func_151221_a(var4, "biomeDepthWeight", var5.field_177903_n);
            var5.field_177905_o = JsonUtils.func_151221_a(var4, "biomeDepthOffset", var5.field_177905_o);
            var5.field_177933_p = JsonUtils.func_151221_a(var4, "biomeScaleWeight", var5.field_177933_p);
            var5.field_177931_q = JsonUtils.func_151221_a(var4, "biomeScaleOffset", var5.field_177931_q);
            var5.field_177929_r = JsonUtils.func_151208_a(var4, "seaLevel", var5.field_177929_r);
            var5.field_177927_s = JsonUtils.func_151209_a(var4, "useCaves", var5.field_177927_s);
            var5.field_177925_t = JsonUtils.func_151209_a(var4, "useDungeons", var5.field_177925_t);
            var5.field_177923_u = JsonUtils.func_151208_a(var4, "dungeonChance", var5.field_177923_u);
            var5.field_177921_v = JsonUtils.func_151209_a(var4, "useStrongholds", var5.field_177921_v);
            var5.field_177919_w = JsonUtils.func_151209_a(var4, "useVillages", var5.field_177919_w);
            var5.field_177944_x = JsonUtils.func_151209_a(var4, "useMineShafts", var5.field_177944_x);
            var5.field_177942_y = JsonUtils.func_151209_a(var4, "useTemples", var5.field_177942_y);
            var5.field_177940_z = JsonUtils.func_151209_a(var4, "useMonuments", var5.field_177940_z);
            var5.field_177870_A = JsonUtils.func_151209_a(var4, "useRavines", var5.field_177870_A);
            var5.field_177871_B = JsonUtils.func_151209_a(var4, "useWaterLakes", var5.field_177871_B);
            var5.field_177872_C = JsonUtils.func_151208_a(var4, "waterLakeChance", var5.field_177872_C);
            var5.field_177866_D = JsonUtils.func_151209_a(var4, "useLavaLakes", var5.field_177866_D);
            var5.field_177867_E = JsonUtils.func_151208_a(var4, "lavaLakeChance", var5.field_177867_E);
            var5.field_177868_F = JsonUtils.func_151209_a(var4, "useLavaOceans", var5.field_177868_F);
            var5.field_177869_G = JsonUtils.func_151208_a(var4, "fixedBiome", var5.field_177869_G);
            if (var5.field_177869_G < 38 && var5.field_177869_G >= -1) {
               if (var5.field_177869_G >= BiomeGenBase.field_76778_j.field_76756_M) {
            ...
            var5.field_177877_H = JsonUtils.func_151208_a(var4, "biomeSize", var5.field_177877_H);
            var5.field_177878_I = JsonUtils.func_151208_a(var4, "riverSize", var5.field_177878_I);
            var5.field_177879_J = JsonUtils.func_151208_a(var4, "dirtSize", var5.field_177879_J);
            var5.field_177880_K = JsonUtils.func_151208_a(var4, "dirtCount", var5.field_177880_K);
            var5.field_177873_L = JsonUtils.func_151208_a(var4, "dirtMinHeight", var5.field_177873_L);
            var5.field_177874_M = JsonUtils.func_151208_a(var4, "dirtMaxHeight", var5.field_177874_M);
            var5.field_177875_N = JsonUtils.func_151208_a(var4, "gravelSize", var5.field_177875_N);
            var5.field_177876_O = JsonUtils.func_151208_a(var4, "gravelCount", var5.field_177876_O);
            var5.field_177886_P = JsonUtils.func_151208_a(var4, "gravelMinHeight", var5.field_177886_P);
            var5.field_177885_Q = JsonUtils.func_151208_a(var4, "gravelMaxHeight", var5.field_177885_Q);
            var5.field_177888_R = JsonUtils.func_151208_a(var4, "graniteSize", var5.field_177888_R);
            var5.field_177887_S = JsonUtils.func_151208_a(var4, "graniteCount", var5.field_177887_S);
            var5.field_177882_T = JsonUtils.func_151208_a(var4, "graniteMinHeight", var5.field_177882_T);
            var5.field_177881_U = JsonUtils.func_151208_a(var4, "graniteMaxHeight", var5.field_177881_U);
            var5.field_177884_V = JsonUtils.func_151208_a(var4, "dioriteSize", var5.field_177884_V);
            var5.field_177883_W = JsonUtils.func_151208_a(var4, "dioriteCount", var5.field_177883_W);
            var5.field_177891_X = JsonUtils.func_151208_a(var4, "dioriteMinHeight", var5.field_177891_X);
            var5.field_177890_Y = JsonUtils.func_151208_a(var4, "dioriteMaxHeight", var5.field_177890_Y);
            var5.field_177892_Z = JsonUtils.func_151208_a(var4, "andesiteSize", var5.field_177892_Z);
            var5.field_177936_aa = JsonUtils.func_151208_a(var4, "andesiteCount", var5.field_177936_aa);
            var5.field_177937_ab = JsonUtils.func_151208_a(var4, "andesiteMinHeight", var5.field_177937_ab);
            var5.field_177934_ac = JsonUtils.func_151208_a(var4, "andesiteMaxHeight", var5.field_177934_ac);
            var5.field_177935_ad = JsonUtils.func_151208_a(var4, "coalSize", var5.field_177935_ad);
            var5.field_177941_ae = JsonUtils.func_151208_a(var4, "coalCount", var5.field_177941_ae);
            var5.field_177943_af = JsonUtils.func_151208_a(var4, "coalMinHeight", var5.field_177943_af);
            var5.field_177938_ag = JsonUtils.func_151208_a(var4, "coalMaxHeight", var5.field_177938_ag);
            var5.field_177939_ah = JsonUtils.func_151208_a(var4, "ironSize", var5.field_177939_ah);
            var5.field_177922_ai = JsonUtils.func_151208_a(var4, "ironCount", var5.field_177922_ai);
            var5.field_177924_aj = JsonUtils.func_151208_a(var4, "ironMinHeight", var5.field_177924_aj);
            var5.field_177918_ak = JsonUtils.func_151208_a(var4, "ironMaxHeight", var5.field_177918_ak);
            var5.field_177920_al = JsonUtils.func_151208_a(var4, "goldSize", var5.field_177920_al);
            var5.field_177930_am = JsonUtils.func_151208_a(var4, "goldCount", var5.field_177930_am);
            var5.field_177932_an = JsonUtils.func_151208_a(var4, "goldMinHeight", var5.field_177932_an);
            var5.field_177926_ao = JsonUtils.func_151208_a(var4, "goldMaxHeight", var5.field_177926_ao);
            var5.field_177928_ap = JsonUtils.func_151208_a(var4, "redstoneSize", var5.field_177928_ap);
            var5.field_177908_aq = JsonUtils.func_151208_a(var4, "redstoneCount", var5.field_177908_aq);
            var5.field_177906_ar = JsonUtils.func_151208_a(var4, "redstoneMinHeight", var5.field_177906_ar);
            var5.field_177904_as = JsonUtils.func_151208_a(var4, "redstoneMaxHeight", var5.field_177904_as);
            var5.field_177902_at = JsonUtils.func_151208_a(var4, "diamondSize", var5.field_177902_at);
            var5.field_177916_au = JsonUtils.func_151208_a(var4, "diamondCount", var5.field_177916_au);
            var5.field_177914_av = JsonUtils.func_151208_a(var4, "diamondMinHeight", var5.field_177914_av);
            var5.field_177912_aw = JsonUtils.func_151208_a(var4, "diamondMaxHeight", var5.field_177912_aw);
            var5.field_177910_ax = JsonUtils.func_151208_a(var4, "lapisSize", var5.field_177910_ax);
            var5.field_177897_ay = JsonUtils.func_151208_a(var4, "lapisCount", var5.field_177897_ay);
            var5.field_177895_az = JsonUtils.func_151208_a(var4, "lapisCenterHeight", var5.field_177895_az);
            var5.field_177889_aA = JsonUtils.func_151208_a(var4, "lapisSpread", var5.field_177889_aA);
   ...
   public static class Factory {
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            ...
            if (this.field_177936_aa != var2.field_177936_aa) {
               return false;
            } else if (this.field_177934_ac != var2.field_177934_ac) {
               return false;
            } else if (this.field_177937_ab != var2.field_177937_ab) {
               return false;
            } else if (this.field_177892_Z != var2.field_177892_Z) {
               return false;
            } else if (Float.compare(var2.field_177907_l, this.field_177907_l) != 0) {
               return false;
            } else if (Float.compare(var2.field_177905_o, this.field_177905_o) != 0) {
               return false;
            } else if (Float.compare(var2.field_177903_n, this.field_177903_n) != 0) {
               return false;
            } else if (Float.compare(var2.field_177931_q, this.field_177931_q) != 0) {
               return false;
            } else if (Float.compare(var2.field_177933_p, this.field_177933_p) != 0) {
               return false;
            } else if (this.field_177877_H != var2.field_177877_H) {
               return false;
            } else if (this.field_177941_ae != var2.field_177941_ae) {
               return false;
            } else if (this.field_177938_ag != var2.field_177938_ag) {
               return false;
            } else if (this.field_177943_af != var2.field_177943_af) {
               return false;
            } else if (this.field_177935_ad != var2.field_177935_ad) {
               return false;
            } else if (Float.compare(var2.field_177899_b, this.field_177899_b) != 0) {
               return false;
            } else if (Float.compare(var2.field_177915_h, this.field_177915_h) != 0) {
               return false;
            } else if (Float.compare(var2.field_177893_f, this.field_177893_f) != 0) {
               return false;
            } else if (Float.compare(var2.field_177894_g, this.field_177894_g) != 0) {
               return false;
            } else if (this.field_177916_au != var2.field_177916_au) {
               return false;
            } else if (this.field_177912_aw != var2.field_177912_aw) {
               return false;
            } else if (this.field_177914_av != var2.field_177914_av) {
               return false;
            } else if (this.field_177902_at != var2.field_177902_at) {
               return false;
            } else if (this.field_177883_W != var2.field_177883_W) {
               return false;
            } else if (this.field_177890_Y != var2.field_177890_Y) {
               return false;
            } else if (this.field_177891_X != var2.field_177891_X) {
               return false;
            } else if (this.field_177884_V != var2.field_177884_V) {
               return false;
            } else if (this.field_177880_K != var2.field_177880_K) {
               return false;
            } else if (this.field_177874_M != var2.field_177874_M) {
               return false;
            } else if (this.field_177873_L != var2.field_177873_L) {
               return false;
            } else if (this.field_177879_J != var2.field_177879_J) {
               return false;
            } else if (this.field_177923_u != var2.field_177923_u) {
               return false;
            } else if (this.field_177869_G != var2.field_177869_G) {
               return false;
            } else if (this.field_177930_am != var2.field_177930_am) {
               return false;
            } else if (this.field_177926_ao != var2.field_177926_ao) {
               return false;
            } else if (this.field_177932_an != var2.field_177932_an) {
               return false;
            } else if (this.field_177920_al != var2.field_177920_al) {
               return false;
            } else if (this.field_177887_S != var2.field_177887_S) {
               return false;
            } else if (this.field_177881_U != var2.field_177881_U) {
               return false;
            } else if (this.field_177882_T != var2.field_177882_T) {
               return false;
            } else if (this.field_177888_R != var2.field_177888_R) {
               return false;
            } else if (this.field_177876_O != var2.field_177876_O) {
               return false;
            } else if (this.field_177885_Q != var2.field_177885_Q) {
               return false;
            } else if (this.field_177886_P != var2.field_177886_P) {
               return false;
            } else if (this.field_177875_N != var2.field_177875_N) {
               return false;
            } else if (Float.compare(var2.field_177900_c, this.field_177900_c) != 0) {
               return false;
            } else if (this.field_177922_ai != var2.field_177922_ai) {
               return false;
            } else if (this.field_177918_ak != var2.field_177918_ak) {
               return false;
            } else if (this.field_177924_aj != var2.field_177924_aj) {
               return false;
            } else if (this.field_177939_ah != var2.field_177939_ah) {
               return false;
            } else if (this.field_177895_az != var2.field_177895_az) {
               return false;
            } else if (this.field_177897_ay != var2.field_177897_ay) {
               return false;
            } else if (this.field_177910_ax != var2.field_177910_ax) {
               return false;
            } else if (this.field_177889_aA != var2.field_177889_aA) {
               return false;
            } else if (this.field_177867_E != var2.field_177867_E) {
               return false;
            } else if (Float.compare(var2.field_177898_e, this.field_177898_e) != 0) {
               return false;
            } else if (Float.compare(var2.field_177917_i, this.field_177917_i) != 0) {
               return false;
            } else if (Float.compare(var2.field_177911_j, this.field_177911_j) != 0) {
               return false;
            } else if (Float.compare(var2.field_177913_k, this.field_177913_k) != 0) {
               return false;
            } else if (this.field_177908_aq != var2.field_177908_aq) {
               return false;
            } else if (this.field_177904_as != var2.field_177904_as) {
               return false;
            } else if (this.field_177906_ar != var2.field_177906_ar) {
               return false;
            } else if (this.field_177928_ap != var2.field_177928_ap) {
               return false;
            } else if (this.field_177878_I != var2.field_177878_I) {
               return false;
            } else if (this.field_177929_r != var2.field_177929_r) {
               return false;
            } else if (Float.compare(var2.field_177909_m, this.field_177909_m) != 0) {
               return false;
            } else if (Float.compare(var2.field_177896_d, this.field_177896_d) != 0) {
               return false;
            } else if (this.field_177927_s != var2.field_177927_s) {
               return false;
            } else if (this.field_177925_t != var2.field_177925_t) {
               return false;
            } else if (this.field_177866_D != var2.field_177866_D) {
               return false;
            } else if (this.field_177868_F != var2.field_177868_F) {
               return false;
            } else if (this.field_177944_x != var2.field_177944_x) {
               return false;
            } else if (this.field_177870_A != var2.field_177870_A) {
               return false;
            } else if (this.field_177921_v != var2.field_177921_v) {
               return false;
            } else if (this.field_177942_y != var2.field_177942_y) {
               return false;
            } else if (this.field_177940_z != var2.field_177940_z) {
               return false;
            } else if (this.field_177919_w != var2.field_177919_w) {
               return false;
            } else if (this.field_177871_B != var2.field_177871_B) {
               return false;
            } else {
               return this.field_177872_C == var2.field_177872_C;
            }
         } else {
            return false;
         }
