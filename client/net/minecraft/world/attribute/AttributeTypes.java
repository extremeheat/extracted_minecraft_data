...
public interface AttributeTypes {
   ...
   AttributeType<Float> FLOAT = register("float", AttributeType.ofInterpolated(Codec.FLOAT, AttributeModifier.FLOAT_LIBRARY, LerpFunction.ofFloat(), LerpFunction.ofFloat(), (value) -> value, (ToIntFunction)null));
   AttributeType<Float> ANGLE_DEGREES = register("angle_degrees", AttributeType.ofInterpolated(Codec.FLOAT, AttributeModifier.FLOAT_LIBRARY, LerpFunction.ofFloat(), LerpFunction.ofDegrees(90.0F), (value) -> value, (ToIntFunction)null));
   ...
   AttributeType<Integer> INTEGER = register("integer", AttributeType.ofInterpolated(Codec.INT, AttributeModifier.INTEGER_LIBRARY, LerpFunction.ofInteger(), LerpFunction.ofInteger(), (value) -> (float)value, (value) -> value));
