...
public interface EnvironmentAttributes {
   EnvironmentAttribute<Vector3fc> FOG_COLOR = register("visual/fog_color", EnvironmentAttribute.builder(AttributeTypes.RGB_COLOR).defaultValue(ARGB.vector3fFromRGB24(0)).spatiallyInterpolated().syncable());
   ...
   EnvironmentAttribute<Vector3fc> WATER_FOG_COLOR = register("visual/water_fog_color", EnvironmentAttribute.builder(AttributeTypes.RGB_COLOR).defaultValue(ARGB.vector3fFromRGB24(-16448205)).spatiallyInterpolated().syncable());
   ...
   EnvironmentAttribute<Vector3fc> SKY_COLOR = register("visual/sky_color", EnvironmentAttribute.builder(AttributeTypes.RGB_COLOR).defaultValue(ARGB.vector3fFromRGB24(0)).spatiallyInterpolated().syncable());
   EnvironmentAttribute<Vector4fc> SUNRISE_SUNSET_COLOR = register("visual/sunrise_sunset_color", EnvironmentAttribute.builder(AttributeTypes.ARGB_COLOR).defaultValue(ARGB.vector4fFromARGB32(0)).spatiallyInterpolated().syncable());
   EnvironmentAttribute<Vector4fc> CLOUD_COLOR = register("visual/cloud_color", EnvironmentAttribute.builder(AttributeTypes.ARGB_COLOR).defaultValue(ARGB.vector4fFromARGB32(0)).spatiallyInterpolated().syncable());
   ...
   EnvironmentAttribute<Vector3fc> NIGHT_VISION_COLOR = register("visual/night_vision_color", EnvironmentAttribute.builder(AttributeTypes.RGB_COLOR).defaultValue(ARGB.vector3fFromRGB24(-6710887)).spatiallyInterpolated().syncable());
   EnvironmentAttribute<Vector3fc> AMBIENT_LIGHT_COLOR = register("visual/ambient_light_color", EnvironmentAttribute.builder(AttributeTypes.RGB_COLOR).defaultValue(ARGB.vector3fFromRGB24(-16777216)).spatiallyInterpolated().syncable());
   ...
   EnvironmentAttribute<MobSpawnSettings> NATURAL_MOB_SPAWNS = register("gameplay/natural_mob_spawns", EnvironmentAttribute.builder(AttributeTypes.MOB_SPAWN_SETTINGS).defaultValue(MobSpawnSettings.EMPTY).fullResolutionBiomes());
