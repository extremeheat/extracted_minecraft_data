...
public class FoodProperties {
   ...
   FoodProperties(int var1, float var2, boolean var3, boolean var4, boolean var5, List<Pair<MobEffectInstance, Float>> var6) {
      super();
      this.nutrition = var1;
   ...
   public static class Builder {
      ...
      public Builder saturationMod(float var1) {
