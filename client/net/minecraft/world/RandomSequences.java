...
public class RandomSequences extends SavedData {
   public static final Codec<RandomSequences> CODEC = RecordCodecBuilder.create((var0) -> var0.group(Codec.INT.fieldOf("salt").forGetter(RandomSequences::salt), Codec.BOOL.optionalFieldOf("include_world_seed", true).forGetter(RandomSequences::includeWorldSeed), Codec.BOOL.optionalFieldOf("include_sequence_id", true).forGetter(RandomSequences::includeSequenceId), Codec.unboundedMap(ResourceLocation.CODEC, RandomSequence.CODEC).fieldOf("sequences").forGetter((var0x) -> var0x.sequences)).apply(var0, RandomSequences::new));
   ...
   private RandomSequences(int var1, boolean var2, boolean var3, Map<ResourceLocation, RandomSequence> var4) {
      super();
      this.salt = var1;
   ...
   public RandomSource get(ResourceLocation var1, long var2) {
   ...
   private RandomSequence createSequence(ResourceLocation var1, long var2) {
      return this.createSequence(var1, var2, this.salt, this.includeWorldSeed, this.includeSequenceId);
   }

   private RandomSequence createSequence(ResourceLocation var1, long var2, int var4, boolean var5, boolean var6) {
   ...
   public void reset(ResourceLocation var1, long var2) {
      this.sequences.put(var1, this.createSequence(var1, var2));
   }

   public void reset(ResourceLocation var1, long var2, int var4, boolean var5, boolean var6) {
