...
public class PetFrog extends AbstractPet {
   protected static final ImmutableList<SensorType<? extends Sensor<? super PetFrog>>> SENSOR_TYPES;
   ...
   public PetFrog(EntityType<? extends AbstractPet> var1, Level var2) {
      super(var1, var2);
   ...
   public static AttributeSupplier.Builder createAttributes() {
      return Animal.createAnimalAttributes().add(Attributes.MOVEMENT_SPEED, 3.0).add(Attributes.MAX_HEALTH, 10.0).add(Attributes.ATTACK_DAMAGE, 10.0).add(Attributes.STEP_HEIGHT, 1.0);
   }
   ...
   static {
      ...
      DATA_VARIANT_ID = SynchedEntityData.<Holder<FrogVariant>>defineId(PetFrog.class, EntityDataSerializers.FROG_VARIANT);
      DATA_TONGUE_TARGET_ID = SynchedEntityData.<OptionalInt>defineId(PetFrog.class, EntityDataSerializers.OPTIONAL_UNSIGNED_INT);
   ...
   class FrogLookControl extends LookControl {
      ...
      protected boolean resetXRotOnTick() {
         return PetFrog.this.getTongueTarget().isEmpty();
      }
   }

   static class FrogPathNavigation extends AmphibiousPathNavigation {
      FrogPathNavigation(PetFrog var1, Level var2) {
         super(var1, var2);
      }
