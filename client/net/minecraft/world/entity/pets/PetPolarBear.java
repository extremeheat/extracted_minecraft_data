...
public class PetPolarBear extends AbstractPet {
   ...
   public PetPolarBear(EntityType<? extends PetPolarBear> var1, Level var2) {
      super(var1, var2);
   }
   ...
   public static boolean checkPolarBearSpawnRules(EntityType<PetPolarBear> var0, LevelAccessor var1, EntitySpawnReason var2, BlockPos var3, RandomSource var4) {
   ...
   static {
      DATA_STANDING_ID = SynchedEntityData.<Boolean>defineId(PetPolarBear.class, EntityDataSerializers.BOOLEAN);
      PERSISTENT_ANGER_TIME = TimeUtil.rangeOfSeconds(20, 39);
   }

   class PolarBearHurtByTargetGoal extends HurtByTargetGoal {
      public PolarBearHurtByTargetGoal() {
         super(PetPolarBear.this);
      }

      public void start() {
         super.start();
         if (PetPolarBear.this.isBaby()) {
            this.alertOthers();
            this.stop();
         }
      ...
      protected void alertOther(Mob var1, LivingEntity var2) {
         if (var1 instanceof PetPolarBear && !var1.isBaby()) {
   ...
   class PolarBearAttackPlayersGoal extends NearestAttackableTargetGoal<Player> {
      public PolarBearAttackPlayersGoal() {
         super(PetPolarBear.this, Player.class, 20, true, true, (TargetingConditions.Selector)null);
      }
      ...
      public boolean canUse() {
         if (PetPolarBear.this.isBaby()) {
            ...
            if (super.canUse()) {
               for(PetPolarBear var3 : PetPolarBear.this.level().getEntitiesOfClass(PetPolarBear.class, PetPolarBear.this.getBoundingBox().inflate(8.0, 4.0, 8.0))) {
                  if (var3.isBaby()) {
                     return true;
                  }
               }
   ...
   class PolarBearMeleeAttackGoal extends MeleeAttackGoal {
      public PolarBearMeleeAttackGoal() {
         super(PetPolarBear.this, 1.25, true);
      }
      ...
      protected void checkAndPerformAttack(LivingEntity var1) {
         if (this.canPerformAttack(var1)) {
            ...
            PetPolarBear.this.setStanding(false);
            ...
            if (this.getTicksUntilNextAttack() <= 10) {
               PetPolarBear.this.setStanding(true);
               PetPolarBear.this.playWarningSound();
            }
         } else {
            this.resetAttackCooldown();
            PetPolarBear.this.setStanding(false);
