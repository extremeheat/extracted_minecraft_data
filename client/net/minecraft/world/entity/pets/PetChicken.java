...
public class PetChicken extends AbstractPet {
   ...
   public PetChicken(EntityType<? extends PetChicken> var1, Level var2) {
      super(var1, var2);
   ...
   static {
      ...
      DATA_VARIANT_ID = SynchedEntityData.<Holder<ChickenVariant>>defineId(PetChicken.class, EntityDataSerializers.CHICKEN_VARIANT);
   }
}
