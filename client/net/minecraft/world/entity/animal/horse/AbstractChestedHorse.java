...
public abstract class AbstractChestedHorse extends AbstractHorse {
      ...
      if (this.hasChest()) {
         ...
         for(int var3 = 0; var3 < var2.size(); ++var3) {
            ...
            if (var5 >= 2 && var5 < this.inventory.getContainerSize()) {
               this.inventory.setItem(var5, ItemStack.method_85(var4));
            }
         }
      }
      ...
      return var1 == 499 ? new SlotAccess() {
         ...
         public boolean set(ItemStack var1) {
            if (var1.isEmpty()) {
               ...
               return true;
            } else if (var1.method_87(Items.CHEST)) {
               if (!AbstractChestedHorse.this.hasChest()) {
   ...
   public InteractionResult mobInteract(Player var1, InteractionHand var2) {
      ...
      if (!var3.isEmpty()) {
         ...
         if (!this.hasChest() && var3.method_87(Blocks.CHEST.asItem())) {
            this.setChest(true);
         ...
         if (!this.isBaby() && !this.isSaddled() && var3.method_87(Items.SADDLE)) {
            this.openInventory(var1);
            return InteractionResult.sidedSuccess(this.level.isClientSide);
         }
      }
