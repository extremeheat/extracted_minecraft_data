...
public class Llama extends AbstractChestedHorse implements RangedAttackMob {
   ...
   public void readAdditionalSaveData(CompoundTag var1) {
      ...
      if (var1.contains("DecorItem", 10)) {
         this.inventory.setItem(1, ItemStack.method_85(var1.getCompound("DecorItem")));
      }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(5, new TemptGoal(this, 1.25D, Ingredient.method_110(Items.HAY_BLOCK), false));
   ...
   public boolean isArmor(ItemStack var1) {
      return var1.method_86(ItemTags.CARPETS);
   }
   ...
   static {
      FOOD_ITEMS = Ingredient.method_110(Items.WHEAT, Blocks.HAY_BLOCK.asItem());
