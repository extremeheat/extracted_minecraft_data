...
public class PigVariants {
   ...
   private static ResourceKey<PigVariant> createKey(ResourceLocation var0) {
   ...
   public static Optional<Holder.Reference<PigVariant>> selectVariantToSpawn(RandomSource var0, RegistryAccess var1, SpawnContext var2) {
      return PriorityProvider.pick(var1.lookupOrThrow(Registries.PIG_VARIANT).listElements(), Holder::value, var0, var2);
   }
