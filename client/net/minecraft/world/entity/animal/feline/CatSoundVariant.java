...
public record CatSoundVariant(CatSoundSet adultSounds, CatSoundSet babySounds) {
   ...
   public static record CatSoundSet(Holder<SoundEvent> ambientSound, Holder<SoundEvent> strayAmbientSound, Holder<SoundEvent> hissSound, Holder<SoundEvent> hurtSound, Holder<SoundEvent> deathSound, Holder<SoundEvent> eatSound, Holder<SoundEvent> begForFoodSound, Holder<SoundEvent> purrSound, Holder<SoundEvent> purreowSound) {
      private static Codec<CatSoundSet> CODEC = RecordCodecBuilder.create((i) -> i.group(SoundEvent.CODEC.fieldOf("ambient_sound").forGetter(CatSoundSet::ambientSound), SoundEvent.CODEC.fieldOf("stray_ambient_sound").forGetter(CatSoundSet::ambientSound), SoundEvent.CODEC.fieldOf("hiss_sound").forGetter(CatSoundSet::hissSound), SoundEvent.CODEC.fieldOf("hurt_sound").forGetter(CatSoundSet::hurtSound), SoundEvent.CODEC.fieldOf("death_sound").forGetter(CatSoundSet::deathSound), SoundEvent.CODEC.fieldOf("eat_sound").forGetter(CatSoundSet::eatSound), SoundEvent.CODEC.fieldOf("beg_for_food_sound").forGetter(CatSoundSet::begForFoodSound), SoundEvent.CODEC.fieldOf("purr_sound").forGetter(CatSoundSet::purrSound), SoundEvent.CODEC.fieldOf("purreow_sound").forGetter(CatSoundSet::purrSound)).apply(i, CatSoundSet::new));
