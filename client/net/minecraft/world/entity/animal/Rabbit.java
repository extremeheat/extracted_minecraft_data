...
public class Rabbit extends Animal {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new TemptGoal(this, 1.0D, Ingredient.method_110(Items.CARROT, Items.GOLDEN_CARROT, Blocks.DANDELION), false));
   ...
   protected float getJumpPower() {
      if (!this.horizontalCollision && (!this.moveControl.hasWanted() || !(this.moveControl.getWantedY() > this.getY() + 0.5D))) {
         ...
         if (var1 != null && !var1.isDone()) {
            ...
            if (var2.field_415 > this.getY() + 0.5D) {
               return 0.5F;
            }
         }
      ...
      if (this.onGround) {
         ...
         if (!var4.wantJump()) {
            if (this.moveControl.hasWanted() && this.jumpDelayTicks == 0) {
               ...
               this.facePoint(var3.field_414, var3.field_416);
               this.startJumping();
            }
   ...
   private static boolean isTemptingItem(ItemStack var0) {
      return var0.method_87(Items.CARROT) || var0.method_87(Items.GOLDEN_CARROT) || var0.method_87(Blocks.DANDELION.asItem());
   }
