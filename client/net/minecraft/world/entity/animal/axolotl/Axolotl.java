...
public class Axolotl extends Animal implements LerpingModel, Bucketable {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4, @Nullable CompoundTag var5) {
      ...
      if (var3 == MobSpawnType.BUCKET) {
         ...
         if (var4 instanceof AxolotlGroupData) {
            ...
            var4 = new AxolotlGroupData(new Variant[]{Axolotl.Variant.getCommonSpawnVariant(var7), Axolotl.Variant.getCommonSpawnVariant(var7)});
         }

         this.setVariant(((AxolotlGroupData)var4).getVariant(var7));
         if (var6) {
            this.setAge(-24000);
         }
   ...
   public static boolean checkAxolotlSpawnRules(EntityType<? extends LivingEntity> var0, ServerLevelAccessor var1, MobSpawnType var2, BlockPos var3, RandomSource var4) {
   ...
   public static enum Variant {
      ...
      public static final Variant[] BY_ID = (Variant[])Arrays.stream(values()).sorted(Comparator.comparingInt(Variant::getId)).toArray((var0) -> {
      ...
      private static Variant getSpawnVariant(RandomSource var0, boolean var1) {
         Variant[] var2 = (Variant[])Arrays.stream(BY_ID).filter((var1x) -> {
