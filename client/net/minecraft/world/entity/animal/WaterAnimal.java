...
public abstract class WaterAnimal extends PathfinderMob {
   ...
   public static boolean checkSurfaceWaterAnimalSpawnRules(EntityType<? extends WaterAnimal> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      int var5 = var1.getSeaLevel();
      int var6 = var5 - 13;
      return var1.getFluidState(var3.below()).method_56(FluidTags.WATER) && var1.getBlockState(var3.above()).is(Blocks.WATER) && var3.getY() >= var6 && var3.getY() <= var5;
   }
}
