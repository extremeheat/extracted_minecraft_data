...
public class Panda extends Animal {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new TemptGoal(this, 1.0D, Ingredient.method_110(Blocks.BAMBOO.asItem()), false));
   ...
   private void addEatingParticles() {
      if (this.getEatCounter() % 5 == 0) {
         ...
         for(int var1 = 0; var1 < 6; ++var1) {
            ...
            this.level.addParticle(new ItemParticleOption(ParticleTypes.ITEM, this.getItemBySlot(EquipmentSlot.MAINHAND)), var5.field_414, var5.field_415, var5.field_416, var2.field_414, var2.field_415 + 0.05D, var2.field_416);
         }
      }
      ...
      if (this.rollCounter > 32) {
         ...
         if (!this.level.isClientSide) {
            ...
            if (this.rollCounter == 1) {
               ...
               this.rollDelta = new Vec3(var1.field_414 + (double)(-Mth.sin(var2) * var3), 0.0D, var1.field_416 + (double)(Mth.cos(var2) * var3));
               ...
               this.setDeltaMovement(this.rollDelta.field_414, var1.field_415, this.rollDelta.field_416);
            } else {
               this.setDeltaMovement(0.0D, this.onGround ? 0.27D : var1.field_415, 0.0D);
            }
         }
   ...
   private void afterSneeze() {
      Vec3 var1 = this.getDeltaMovement();
      this.level.addParticle(ParticleTypes.SNEEZE, this.getX() - (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)Mth.sin(this.yBodyRot * 0.017453292F), this.getEyeY() - 0.10000000149011612D, this.getZ() + (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)Mth.cos(this.yBodyRot * 0.017453292F), var1.field_414, 0.0D, var1.field_416);
   ...
   public boolean isFood(ItemStack var1) {
      return var1.method_87(Blocks.BAMBOO.asItem());
   }

   private boolean isFoodOrCake(ItemStack var1) {
      return this.isFood(var1) || var1.method_87(Blocks.CAKE.asItem());
   }
   ...
   static {
      ...
      PANDA_ITEMS = (var0) -> {
         ...
         return (var1.method_87(Blocks.BAMBOO.asItem()) || var1.method_87(Blocks.CAKE.asItem())) && var0.isAlive() && !var0.hasPickUpDelay();
      };
   }
   ...
   public static enum Gene {
      ...
      // $FF: synthetic method
      private static Panda.Gene[] $values() {
         return new Panda.Gene[]{NORMAL, LAZY, WORRIED, PLAYFUL, BROWN, WEAK, AGGRESSIVE};
      }
   }
