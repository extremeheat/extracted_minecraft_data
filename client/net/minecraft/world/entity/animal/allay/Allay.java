...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationListener.VibrationListenerConfig {
   ...
   public static AttributeSupplier.Builder createAttributes() {
      return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 20.0).add(Attributes.FLYING_SPEED, 0.10000000149011612).add(Attributes.MOVEMENT_SPEED, 0.10000000149011612).add(Attributes.ATTACK_DAMAGE, 2.0).add(Attributes.FOLLOW_RANGE, 48.0);
   }
   ...
   public void addAdditionalSaveData(CompoundTag var1) {
      ...
      DataResult var10000 = VibrationListener.codec(this).encodeStart(NbtOps.INSTANCE, (VibrationListener)this.dynamicGameEventListener.getListener());
