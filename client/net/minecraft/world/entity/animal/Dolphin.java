...
public class Dolphin extends WaterAnimal {
   ...
   private static class DolphinSwimToTreasureGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         ...
         return !(new BlockPos((double)var1.getX(), this.dolphin.getY(), (double)var1.getZ())).closerToCenterThan(this.dolphin.position(), 4.0) && !this.stuck && this.dolphin.getAirSupply() >= 100;
      }
