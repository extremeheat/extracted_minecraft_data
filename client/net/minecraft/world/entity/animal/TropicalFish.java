...
public class TropicalFish extends AbstractSchoolingFish {
   ...
   public static boolean checkTropicalFishSpawnRules(EntityType<TropicalFish> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      return var1.getFluidState(var3.below()).method_56(FluidTags.WATER) && (Objects.equals(var1.getBiomeName(var3), Optional.of(Biomes.LUSH_CAVES)) || WaterAnimal.checkSurfaceWaterAnimalSpawnRules(var0, var1, var2, var3, var4));
   }
