...
public class Sheep extends Animal implements Shearable {
   ...
   private static int createSheepColor(DyeColor var0) {
      if (var0 == DyeColor.WHITE) {
         ...
         float var2 = 0.75F;
         return FastColor.ARGB32.color(255, Mth.floor((float)FastColor.ARGB32.red(var1) * 0.75F), Mth.floor((float)FastColor.ARGB32.green(var1) * 0.75F), Mth.floor((float)FastColor.ARGB32.blue(var1) * 0.75F));
      }
   }
   ...
   public Sheep getBreedOffspring(ServerLevel var1, AgeableMob var2) {
      Sheep var3 = (Sheep)EntityType.SHEEP.create(var1);
      if (var3 != null) {
