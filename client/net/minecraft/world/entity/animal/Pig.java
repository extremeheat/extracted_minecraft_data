...
public class Pig extends Animal implements ItemSteerable, Saddleable {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new TemptGoal(this, 1.2D, Ingredient.method_110(Items.CARROT_ON_A_STICK), false));
   ...
   public boolean canBeControlledByRider() {
      ...
      if (!(var1 instanceof Player)) {
         ...
         return var2.getMainHandItem().method_87(Items.CARROT_ON_A_STICK) || var2.getOffhandItem().method_87(Items.CARROT_ON_A_STICK);
      }
   }
   ...
   static {
      ...
      FOOD_ITEMS = Ingredient.method_110(Items.CARROT, Items.POTATO, Items.BEETROOT);
   }
}
