...
public class GoatAi {
   ...
   private static final UniformInt ADULT_FOLLOW_RANGE = UniformInt.method_45(5, 16);
   ...
   private static final UniformInt TIME_BETWEEN_LONG_JUMPS = UniformInt.method_45(600, 1200);
   ...
   private static final UniformInt TIME_BETWEEN_RAMS = UniformInt.method_45(600, 6000);
   private static final UniformInt TIME_BETWEEN_RAMS_SCREAMER = UniformInt.method_45(100, 300);
   ...
   private static void initIdleActivity(Brain<Goat> var0) {
      var0.addActivityWithConditions(Activity.IDLE, ImmutableList.of(Pair.of(0, new RunSometimes(new SetEntityLookTarget(EntityType.PLAYER, 6.0F), UniformInt.method_45(30, 60))), Pair.of(0, new AnimalMakeLove(EntityType.GOAT, 1.0F)), Pair.of(1, new FollowTemptation((var0x) -> {
         return 1.25F;
   ...
   public static Ingredient getTemptations() {
      return Ingredient.method_110(Items.WHEAT);
   }
}
