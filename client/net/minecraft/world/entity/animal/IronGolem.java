...
public class IronGolem extends AbstractGolem implements NeutralMob {
   ...
   public void aiStep() {
      ...
      if (this.getDeltaMovement().horizontalDistanceSqr() > 2.500000277905201E-7 && this.random.nextInt(5) == 0) {
         ...
         if (!var4.isAir()) {
            this.level.addParticle(new BlockParticleOption(ParticleTypes.BLOCK, var4), this.getX() + ((double)this.random.nextFloat() - 0.5) * (double)this.getBbWidth(), this.getY() + 0.1, this.getZ() + ((double)this.random.nextFloat() - 0.5) * (double)this.getBbWidth(), 4.0 * ((double)this.random.nextFloat() - 0.5), 0.5, ((double)this.random.nextFloat() - 0.5) * 4.0);
         }
      }
   ...
   public boolean hurt(DamageSource var1, float var2) {
      Crackiness var3 = this.getCrackiness();
   ...
   public static enum Crackiness {
      ...
      private static final List<Crackiness> BY_DAMAGE = (List)Stream.of(values()).sorted(Comparator.comparingDouble((var0) -> {
      ...
      public static Crackiness byFraction(float var0) {
      ...
      // $FF: synthetic method
      private static Crackiness[] $values() {
