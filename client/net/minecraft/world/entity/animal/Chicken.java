...
public class Chicken extends Animal {
   ...
   public void aiStep() {
      ...
      if (!this.onGround && var1.field_415 < 0.0D) {
   ...
   protected int getExperienceReward(Player var1) {
      return this.isChickenJockey() ? 10 : super.getExperienceReward(var1);
   }
   ...
   static {
      FOOD_ITEMS = Ingredient.method_110(Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS);
   }
}
