...
public class Zoglin extends Monster implements Enemy, HoglinBase {
   ...
   private static void initIdleActivity(Brain<Zoglin> var0) {
      var0.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking(Zoglin::findNearestValidAttackTarget), new RunSometimes(new SetEntityLookTarget(8.0F), UniformInt.method_45(30, 60)), new RunOne(ImmutableList.of(Pair.of(new RandomStroll(0.4F), 2), Pair.of(new SetWalkTargetFromLookTarget(0.4F, 3), 2), Pair.of(new DoNothing(30, 60), 1)))));
   }
   ...
   public boolean hurt(DamageSource var1, float var2) {
      ...
      if (this.level.isClientSide) {
         ...
         if (this.canAttack(var4) && !BehaviorUtils.isOtherTargetMuchFurtherAwayThanCurrentAttackTarget(this, var4, 4.0D)) {
