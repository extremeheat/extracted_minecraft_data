...
public class Blaze extends Monster {
   ...
   public void aiStep() {
      if (!this.onGround && this.getDeltaMovement().field_415 < 0.0D) {
   ...
   protected void customServerAiStep() {
      ...
      if (var1 != null && var1.getEyeY() > this.getEyeY() + (double)this.allowedHeightOffset && this.canAttack(var1)) {
         ...
         this.setDeltaMovement(this.getDeltaMovement().add(0.0D, (0.30000001192092896D - var2.field_415) * 0.30000001192092896D, 0.0D));
