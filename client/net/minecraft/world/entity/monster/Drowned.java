...
public class Drowned extends Zombie implements RangedAttackMob {
   ...
   public static boolean checkDrownedSpawnRules(EntityType<Drowned> var0, ServerLevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      if (!var1.getFluidState(var3.below()).method_56(FluidTags.WATER)) {
         return false;
      } else {
         Optional var5 = var1.getBiomeName(var3);
         boolean var6 = var1.getDifficulty() != Difficulty.PEACEFUL && isDarkEnoughToSpawn(var1, var3, var4) && (var2 == MobSpawnType.SPAWNER || var1.getFluidState(var3).method_56(FluidTags.WATER));
   ...
   protected boolean canReplaceCurrentItem(ItemStack var1, ItemStack var2) {
      if (var2.method_87(Items.NAUTILUS_SHELL)) {
         return false;
      } else if (var2.method_87(Items.TRIDENT)) {
         ...
         return var1.method_87(Items.TRIDENT) ? true : super.canReplaceCurrentItem(var1, var2);
      }
   }
      ...
      public boolean canUse() {
         if (!this.level.isDay()) {
            ...
            if (var1 == null) {
               ...
               this.wantedX = var1.field_414;
               this.wantedY = var1.field_415;
               this.wantedZ = var1.field_416;
               return true;
            }
         }
      }
   ...
   static class DrownedTridentAttackGoal extends RangedAttackGoal {
      ...
      public boolean canUse() {
         return super.canUse() && this.drowned.getMainHandItem().method_87(Items.TRIDENT);
      }
   ...
   static class DrownedSwimUpGoal extends Goal {
      ...
      public void tick() {
         if (this.drowned.getY() < (double)(this.seaLevel - 1) && (this.drowned.getNavigation().isDone() || this.drowned.closeToNextPos())) {
            ...
            this.drowned.getNavigation().moveTo(var1.field_414, var1.field_415, var1.field_416, this.speedModifier);
         }
