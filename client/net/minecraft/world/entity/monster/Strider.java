...
public class Strider extends Animal implements ItemSteerable, Saddleable {
   ...
   public static boolean checkStriderSpawnRules(EntityType<Strider> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      ...
      } while(var1.getFluidState(var5).method_56(FluidTags.LAVA));
   ...
   public boolean canStandOnFluid(Fluid var1) {
      return var1.method_30(FluidTags.LAVA);
   }
   ...
   public boolean canBeControlledByRider() {
      ...
      if (!(var1 instanceof Player)) {
         ...
         return var2.getMainHandItem().method_87(Items.WARPED_FUNGUS_ON_A_STICK) || var2.getOffhandItem().method_87(Items.WARPED_FUNGUS_ON_A_STICK);
      }
   }
   ...
   public Vec3 getDismountLocationForPassenger(LivingEntity var1) {
      ...
      for(int var11 = 0; var11 < var10; ++var11) {
         ...
         var8.set(this.getX() + var12.field_414, var4, this.getZ() + var12.field_416);
      ...
      while(true) {
         ...
         do {
            ...
            } while(this.level.getFluidState(var18).method_56(FluidTags.LAVA));
   ...
   private void floatStrider() {
      if (this.isInLava()) {
         CollisionContext var1 = CollisionContext.method_14(this);
         if (var1.isAbove(LiquidBlock.STABLE_SHAPE, this.blockPosition(), true) && !this.level.getFluidState(this.blockPosition().above()).method_56(FluidTags.LAVA)) {
            this.onGround = true;
         } else {
   ...
   public float getWalkTargetValue(BlockPos var1, LevelReader var2) {
      if (var2.getBlockState(var1).getFluidState().method_56(FluidTags.LAVA)) {
         return 10.0F;
      } else {
   ...
   public InteractionResult mobInteract(Player var1, InteractionHand var2) {
      ...
      if (!var3 && this.isSaddled() && !this.isVehicle() && !var1.isSecondaryUseActive()) {
         ...
         if (!var4.consumesAction()) {
            ...
            return var5.method_87(Items.SADDLE) ? var5.interactLivingEntity(var1, this, var2) : InteractionResult.PASS;
         } else {
   ...
   static {
      FOOD_ITEMS = Ingredient.method_110(Items.WARPED_FUNGUS);
      TEMPT_ITEMS = Ingredient.method_110(Items.WARPED_FUNGUS, Items.WARPED_FUNGUS_ON_A_STICK);
