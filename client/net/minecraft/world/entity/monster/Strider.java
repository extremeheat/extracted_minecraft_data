   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4, @Nullable CompoundTag var5) {
      if (this.isBaby()) {
         ...
         if (var6.nextInt(30) == 0) {
            Mob var7 = (Mob)EntityType.ZOMBIFIED_PIGLIN.create(var1.getLevel());
            ...
            AgeableMob var9 = (AgeableMob)EntityType.STRIDER.create(var1.getLevel());
            var9.setAge(-24000);
            var8 = this.spawnJockey(var1, var2, var9, (SpawnGroupData)null);
         } else {
