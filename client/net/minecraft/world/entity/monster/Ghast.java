   ...
   static class GhastLookGoal extends Goal {
      ...
      public void tick() {
         if (this.ghast.getTarget() == null) {
            ...
            this.ghast.setYRot(-((float)Mth.atan2(var1.field_414, var1.field_416)) * 57.295776F);
         ...
         if (var1 != null) {
            ...
            if (var1.distanceToSqr(this.ghast) < 4096.0D && this.ghast.hasLineOfSight(var1)) {
               ...
               if (this.chargeTime == 20) {
                  ...
                  double var8 = var1.getX() - (this.ghast.getX() + var7.field_414 * 4.0D);
                  double var10 = var1.getY(0.5D) - (0.5D + this.ghast.getY(0.5D));
                  double var12 = var1.getZ() - (this.ghast.getZ() + var7.field_416 * 4.0D);
                  ...
                  var14.setPos(this.ghast.getX() + var7.field_414 * 4.0D, this.ghast.getY(0.5D) + 0.5D, var14.getZ() + var7.field_416 * 4.0D);
