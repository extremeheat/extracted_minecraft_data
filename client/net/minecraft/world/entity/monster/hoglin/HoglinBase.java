...
public interface HoglinBase {
   ...
   static void throwTarget(LivingEntity var0, LivingEntity var1) {
      ...
      if (!(var6 <= 0.0D)) {
         ...
         Vec3 var15 = (new Vec3(var8, 0.0D, var10)).normalize().scale(var13).yRot(var12);
         double var16 = var6 * (double)var0.level.random.nextFloat() * 0.5D;
         var1.push(var15.field_414, var16, var15.field_416);
