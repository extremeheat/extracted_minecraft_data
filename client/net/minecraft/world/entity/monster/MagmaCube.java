...
public class MagmaCube extends Slime {
   ...
   protected void jumpFromGround() {
      ...
      this.setDeltaMovement(var1.field_414, (double)(this.getJumpPower() + (float)this.getSize() * 0.1F), var1.field_416);
   ...
   protected void jumpInLiquid(Tag<Fluid> var1) {
      if (var1 == FluidTags.LAVA) {
         ...
         this.setDeltaMovement(var2.field_414, (double)(0.22F + (float)this.getSize() * 0.05F), var2.field_416);
         this.hasImpulse = true;
      } else {
