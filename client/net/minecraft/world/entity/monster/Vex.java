         ...
         if (this.operation == MoveControl.Operation.MOVE_TO) {
            ...
            if (var2 < Vex.this.getBoundingBox().getSize()) {
               ...
               if (Vex.this.getTarget() == null) {
                  ...
                  Vex.this.setYRot(-((float)Mth.atan2(var4.field_414, var4.field_416)) * 57.295776F);
   ...
   class VexChargeAttackGoal extends Goal {
      ...
      public void start() {
         ...
         if (var1 != null) {
            ...
            Vex.this.moveControl.setWantedPosition(var2.field_414, var2.field_415, var2.field_416, 1.0D);
         }
         ...
         if (var1 != null) {
            if (Vex.this.getBoundingBox().intersects(var1.getBoundingBox())) {
               ...
               if (var2 < 9.0D) {
                  ...
                  Vex.this.moveControl.setWantedPosition(var4.field_414, var4.field_415, var4.field_416, 1.0D);
               }
            }
