...
public class Guardian extends Monster {
   ...
   public LivingEntity getActiveAttackTarget() {
      if (!this.hasActiveAttackTarget()) {
         ...
         if (this.clientSideCachedAttackTarget != null) {
            ...
            Entity var1 = this.level().getEntity(this.entityData.get(DATA_ID_ATTACK_TARGET));
   ...
   public static boolean checkGuardianSpawnRules(
      EntityType<? extends Guardian> var0, LevelAccessor var1, EntitySpawnReason var2, BlockPos var3, RandomSource var4
   ) {
   ...
   public boolean hurtServer(ServerLevel var1, DamageSource var2, float var3) {
      if (!this.isMoving()
         && !var2.is(DamageTypeTags.AVOIDS_GUARDIAN_THORNS)
         && !var2.is(DamageTypes.THORNS)
         && var2.getDirectEntity() instanceof LivingEntity var4) {
   ...
   static class GuardianMoveControl extends MoveControl {
      ...
      public void tick() {
         if (this.operation == MoveControl.Operation.MOVE_TO && !this.guardian.getNavigation().isDone()) {
            ...
            this.guardian
               .setDeltaMovement(
                  this.guardian.getDeltaMovement().add(var13 * var15, var19 * (var17 + var15) * 0.25 + (double)var12 * var6 * 0.1, var13 * var17)
               );
