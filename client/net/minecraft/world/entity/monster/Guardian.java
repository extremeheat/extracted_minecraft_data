...
public class Guardian extends Monster {
   ...
   public float getWalkTargetValue(BlockPos var1, LevelReader var2) {
      return var2.getFluidState(var1).method_56(FluidTags.WATER) ? 10.0F + var2.getBrightness(var1) - 0.5F : super.getWalkTargetValue(var1, var2);
   }
      ...
      if (this.isAlive()) {
         if (this.level.isClientSide) {
            ...
            if (!this.isInWater()) {
               ...
               if (var1.field_415 > 0.0D && this.clientSideTouchedGround && !this.isSilent()) {
                  this.level.playLocalSound(this.getX(), this.getY(), this.getZ(), this.getFlopSound(), this.getSoundSource(), 1.0F, 1.0F, false);
               }

               this.clientSideTouchedGround = var1.field_415 < 0.0D && this.level.loadedAndEntityCanStandOn(this.blockPosition().below(), this);
            ...
            if (this.isMoving() && this.isInWater()) {
               ...
               for(int var2 = 0; var2 < 2; ++var2) {
                  this.level.addParticle(ParticleTypes.BUBBLE, this.getRandomX(0.5D) - var1.field_414 * 1.5D, this.getRandomY() - var1.field_415 * 1.5D, this.getRandomZ(0.5D) - var1.field_416 * 1.5D, 0.0D, 0.0D, 0.0D);
               }
            }
   ...
   public static boolean checkGuardianSpawnRules(EntityType<? extends Guardian> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      return (var4.nextInt(20) == 0 || !var1.canSeeSkyFromBelowWater(var3)) && var1.getDifficulty() != Difficulty.PEACEFUL && (var2 == MobSpawnType.SPAWNER || var1.getFluidState(var3).method_56(FluidTags.WATER)) && var1.getFluidState(var3.below()).method_56(FluidTags.WATER);
   }

   public boolean hurt(DamageSource var1, float var2) {
      if (!this.isMoving() && !var1.isMagic() && var1.getDirectEntity() instanceof LivingEntity) {
         LivingEntity var3 = (LivingEntity)var1.getDirectEntity();
         if (!var1.isExplosion()) {
   ...
   static class GuardianMoveControl extends MoveControl {
      ...
      public void tick() {
         if (this.operation == MoveControl.Operation.MOVE_TO && !this.guardian.getNavigation().isDone()) {
            ...
            double var4 = var1.field_414 / var2;
            double var6 = var1.field_415 / var2;
            double var8 = var1.field_416 / var2;
            float var10 = (float)(Mth.atan2(var1.field_416, var1.field_414) * 57.2957763671875D) - 90.0F;
