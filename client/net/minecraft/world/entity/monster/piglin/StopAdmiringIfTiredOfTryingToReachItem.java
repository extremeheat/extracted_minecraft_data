...
public class StopAdmiringIfTiredOfTryingToReachItem {
   ...
   public static BehaviorControl<LivingEntity> create(int var0, int var1) {
      return BehaviorBuilder.create(
         var2 -> var2.group(
                  var2.present(MemoryModuleType.ADMIRING_ITEM),
                  var2.present(MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM),
                  var2.registered(MemoryModuleType.TIME_TRYING_TO_REACH_ADMIRE_ITEM),
                  var2.registered(MemoryModuleType.DISABLE_WALK_TO_ADMIRE_ITEM)
               )
