...
public class PiglinAi {
   ...
   protected static void updateActivity(Piglin var0) {
      ...
      if (var2 != var3) {
         ...
         var10000.ifPresent(var0::playSoundEvent);
      }
   ...
   private static List<ItemStack> getBarterResponseItems(Piglin var0) {
      ...
      ObjectArrayList var2 = var1.getRandomItems((new LootContext.Builder((ServerLevel)var0.level)).withParameter(LootContextParams.THIS_ENTITY, var0).withRandom(var0.level.random).create(LootContextParamSets.PIGLIN_BARTER));
      return var2;
   }
