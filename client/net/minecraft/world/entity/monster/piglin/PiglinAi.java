...
public class PiglinAi {
   ...
   private static RunOne<Piglin> createIdleMovementBehaviors() {
      return new RunOne(ImmutableList.of(Pair.of(new RandomStroll(0.6F), 2), Pair.of(InteractWith.method_15(EntityType.PIGLIN, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), Pair.of(new RunIf(PiglinAi::doesntSeeAnyPlayerHoldingLovedItem, new SetWalkTargetFromLookTarget(0.6F, 3)), 2), Pair.of(new DoNothing(30, 60), 1)));
   }
   ...
   protected static void pickUpItem(Piglin var0, ItemEntity var1) {
      stopWalking(var0);
      ItemStack var2;
      if (var1.getItem().method_87(Items.GOLD_NUGGET)) {
   ...
   protected static boolean wantsToPickup(Piglin var0, ItemStack var1) {
      if (var0.isBaby() && var1.method_86(ItemTags.IGNORED_BY_PIGLIN_BABIES)) {
         return false;
      } else if (var1.method_86(ItemTags.PIGLIN_REPELLENTS)) {
         return false;
         ...
         if (var1.method_87(Items.GOLD_NUGGET)) {
            return var2;
         } else if (isFood(var1)) {
   ...
   protected static boolean isLovedItem(ItemStack var0) {
      return var0.method_86(ItemTags.PIGLIN_LOVED);
   }
   ...
   private static boolean isBarterCurrency(ItemStack var0) {
      return var0.method_87(BARTERING_ITEM);
   }

   private static boolean isFood(ItemStack var0) {
      return var0.method_86(ItemTags.PIGLIN_FOOD);
   }
