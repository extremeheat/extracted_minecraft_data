...
public class PiglinBruteAi {
   ...
   protected static void initMemories(PiglinBrute var0) {
      GlobalPos var1 = GlobalPos.method_122(var0.level.dimension(), var0.blockPosition());
   ...
   private static RunOne<PiglinBrute> createIdleMovementBehaviors() {
      return new RunOne(ImmutableList.of(Pair.of(new RandomStroll(0.6F), 2), Pair.of(InteractWith.method_15(EntityType.PIGLIN, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), Pair.of(InteractWith.method_15(EntityType.PIGLIN_BRUTE, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), Pair.of(new StrollToPoi(MemoryModuleType.HOME, 0.6F, 2, 100), 2), Pair.of(new StrollAroundPoi(MemoryModuleType.HOME, 0.6F, 5), 2), Pair.of(new DoNothing(30, 60), 1)));
   }
