...
public class Slime extends Mob implements Enemy {
   ...
   public static boolean checkSlimeSpawnRules(EntityType<Slime> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      if (var1.getDifficulty() != Difficulty.PEACEFUL) {
         ...
         boolean var6 = WorldgenRandom.seedSlimeChunk(var5.field_504, var5.field_505, ((WorldGenLevel)var1).getSeed(), 987234911L).nextInt(10) == 0;
   ...
   protected void jumpFromGround() {
      ...
      this.setDeltaMovement(var1.field_414, (double)this.getJumpPower(), var1.field_416);
