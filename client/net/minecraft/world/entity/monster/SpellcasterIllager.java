...
public abstract class SpellcasterIllager extends AbstractIllager {
   ...
   public void tick() {
      ...
      if (this.level.isClientSide && this.isCastingSpell()) {
         ...
         this.level.addParticle(ParticleTypes.ENTITY_EFFECT, this.getX() + (double)var9 * 0.6, this.getY() + 1.8, this.getZ() + (double)var10 * 0.6, var2, var4, var6);
         this.level.addParticle(ParticleTypes.ENTITY_EFFECT, this.getX() - (double)var9 * 0.6, this.getY() + 1.8, this.getZ() - (double)var10 * 0.6, var2, var4, var6);
      }
   ...
   protected static enum IllagerSpell {
      ...
      public static IllagerSpell byId(int var0) {
         IllagerSpell[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            IllagerSpell var4 = var1[var3];
            if (var0 == var4.id) {
               return var4;
            }
         }
