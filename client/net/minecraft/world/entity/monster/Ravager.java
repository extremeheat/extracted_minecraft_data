...
public class Ravager extends Raider {
   ...
   protected void updateControlFlags() {
      boolean var1 = !(this.getControllingPassenger() instanceof Mob) || this.getControllingPassenger().getType().method_117(EntityTypeTags.RAIDERS);
   ...
   private void roar() {
      if (this.isAlive()) {
         ...
         for(int var11 = 0; var11 < 40; ++var11) {
            ...
            this.level.addParticle(ParticleTypes.POOF, var10.field_414, var10.field_415, var10.field_416, var4, var6, var8);
         }
