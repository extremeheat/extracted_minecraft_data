...
public class WardenAi {
   ...
   private static void initFightActivity(Warden var0, Brain<Warden> var1) {
      var1.addActivityAndRemoveMemoryWhenStopped(
         ...
         ImmutableList.of(
            DIG_COOLDOWN_SETTER,
            new StopAttackingIfTargetInvalid<>(var1x -> !var0.getAngerLevel().isAngry() || !var0.canTargetEntity(var1x), WardenAi::onTargetInvalid, false),
            new SetEntityLookTarget(var1x -> isTarget(var0, var1x), (float)var0.getAttributeValue(Attributes.FOLLOW_RANGE)),
   ...
   public static void setDisturbanceLocation(Warden var0, BlockPos var1) {
      if (var0.level.getWorldBorder().isWithinBounds(var1)
         && !var0.getEntityAngryAt().isPresent()
         && !var0.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).isPresent()) {
         setDigCooldown(var0);
