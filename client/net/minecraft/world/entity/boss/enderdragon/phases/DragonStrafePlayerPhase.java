...
public class DragonStrafePlayerPhase extends AbstractDragonPhaseInstance {
   ...
   public void doServerTick() {
      if (this.attackTarget == null) {
         ...
         if (this.currentPath != null && this.currentPath.isDone()) {
            var1 = this.attackTarget.x;
            var3 = this.attackTarget.z;
            double var5 = var1 - this.dragon.x;
            double var7 = var3 - this.dragon.z;
            var9 = (double)Mth.sqrt(var5 * var5 + var7 * var7);
            double var11 = Math.min(0.4000000059604645D + var9 / 80.0D - 1.0D, 10.0D);
            this.targetLocation = new Vec3(var1, this.attackTarget.y + var11, var3);
         }

         var1 = this.targetLocation == null ? 0.0D : this.targetLocation.distanceToSqr(this.dragon.x, this.dragon.y, this.dragon.z);
         ...
         if (this.attackTarget.distanceToSqr(this.dragon) < 4096.0D) {
            if (this.dragon.canSee(this.attackTarget)) {
               ++this.fireballCharge;
               Vec3 var25 = (new Vec3(this.attackTarget.x - this.dragon.x, 0.0D, this.attackTarget.z - this.dragon.z)).normalize();
               ...
               if (this.fireballCharge >= 5 && var8 >= 0.0F && var8 < 10.0F) {
                  ...
                  double var12 = this.dragon.head.x - var27.x * 1.0D;
                  double var14 = this.dragon.head.y + (double)(this.dragon.head.getBbHeight() / 2.0F) + 0.5D;
                  double var16 = this.dragon.head.z - var27.z * 1.0D;
                  double var18 = this.attackTarget.x - var12;
                  double var20 = this.attackTarget.y + (double)(this.attackTarget.getBbHeight() / 2.0F) - (var14 + (double)(this.dragon.head.getBbHeight() / 2.0F));
                  double var22 = this.attackTarget.z - var16;
   ...
   public void setTarget(LivingEntity var1) {
      ...
      int var3 = this.dragon.findClosestNode(this.attackTarget.x, this.attackTarget.y, this.attackTarget.z);
      int var4 = Mth.floor(this.attackTarget.x);
      int var5 = Mth.floor(this.attackTarget.z);
      double var6 = (double)var4 - this.dragon.x;
      double var8 = (double)var5 - this.dragon.z;
      double var10 = (double)Mth.sqrt(var6 * var6 + var8 * var8);
      double var12 = Math.min(0.4000000059604645D + var10 / 80.0D - 1.0D, 10.0D);
      int var14 = Mth.floor(this.attackTarget.y + var12);
