...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      if (this.isDeadOrDying()) {
         ...
         this.level.addParticle(ParticleTypes.EXPLOSION, this.getX() + (double)var24, this.getY() + 2.0 + (double)var2, this.getZ() + (double)var30, 0.0, 0.0, 0.0);
      } else {
         this.checkCrystals();
         Vec3 var1 = this.getDeltaMovement();
         var2 = 0.2F / ((float)var1.horizontalDistance() * 10.0F + 1.0F);
         var2 *= (float)Math.pow(2.0, var1.y);
         ...
         if (this.isNoAi()) {
            ...
            if (this.level.isClientSide) {
               ...
               if (var4 != null) {
                  ...
                  if (Math.abs(var5) > 9.999999747378752E-6 || Math.abs(var9) > 9.999999747378752E-6) {
                     ...
                     this.yRotA *= 0.8F;
                     this.yRotA += var19 * var26.getTurnSpeed();
            ...
            this.tickPart(this.body, (double)(var8 * 0.5F), 0.0, (double)(-var33 * 0.5F));
            this.tickPart(this.wing1, (double)(var33 * 4.5F), 2.0, (double)(var8 * 4.5F));
            this.tickPart(this.wing2, (double)(var33 * -4.5F), 2.0, (double)(var8 * -4.5F));
            if (!this.level.isClientSide && this.hurtTime == 0) {
               this.knockBack(this.level.getEntities((Entity)this, this.wing1.getBoundingBox().inflate(4.0, 2.0, 4.0).move(0.0, -2.0, 0.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
               this.knockBack(this.level.getEntities((Entity)this, this.wing2.getBoundingBox().inflate(4.0, 2.0, 4.0).move(0.0, -2.0, 0.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
               this.hurt(this.level.getEntities((Entity)this, this.head.getBoundingBox().inflate(1.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
               this.hurt(this.level.getEntities((Entity)this, this.neck.getBoundingBox().inflate(1.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
            }
            ...
            for(var36 = 0; var36 < 3; ++var36) {
               ...
               var19 = Mth.cos(var38);
               var20 = 1.5F;
               float var39 = (float)(var36 + 1) * 2.0F;
               this.tickPart(var15, (double)(-(var8 * 1.5F + var18 * var39) * var31), var37[1] - var35[1] - (double)((var39 + 1.5F) * var6) + 1.5, (double)((var33 * 1.5F + var19 * var39) * var31));
            }
            ...
            for(var36 = 0; var36 < this.subEntities.length; ++var36) {
               this.subEntities[var36].xo = var28[var36].x;
               this.subEntities[var36].yo = var28[var36].y;
               this.subEntities[var36].zo = var28[var36].z;
               this.subEntities[var36].xOld = var28[var36].x;
               this.subEntities[var36].yOld = var28[var36].y;
               this.subEntities[var36].zOld = var28[var36].z;
            }
