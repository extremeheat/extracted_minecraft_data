...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      float var2;
      if (this.isDeadOrDying()) {
         float var24 = (this.random.nextFloat() - 0.5F) * 8.0F;
         var2 = (this.random.nextFloat() - 0.5F) * 4.0F;
         float var30 = (this.random.nextFloat() - 0.5F) * 8.0F;
         this.level.addParticle(ParticleTypes.EXPLOSION, this.getX() + (double)var24, this.getY() + 2.0D + (double)var2, this.getZ() + (double)var30, 0.0D, 0.0D, 0.0D);
      } else {
         this.checkCrystals();
         Vec3 var1 = this.getDeltaMovement();
         var2 = 0.2F / ((float)var1.horizontalDistance() * 10.0F + 1.0F);
         var2 *= (float)Math.pow(2.0D, var1.field_415);
         ...
         if (this.isNoAi()) {
            ...
            if (this.level.isClientSide) {
               if (this.lerpSteps > 0) {
                  double var25 = this.getX() + (this.lerpX - this.getX()) / (double)this.lerpSteps;
                  ...
                  --this.lerpSteps;
                  this.setPos(var25, var5, var7);
                  this.setRot(this.getYRot(), this.getXRot());
               }

               this.phaseManager.getCurrentPhase().doClientTick();
            } else {
               DragonPhaseInstance var26 = this.phaseManager.getCurrentPhase();
               var26.doServerTick();
               if (this.phaseManager.getCurrentPhase() != var26) {
                  var26 = this.phaseManager.getCurrentPhase();
                  var26.doServerTick();
               }

               Vec3 var4 = var26.getFlyTargetLocation();
               if (var4 != null) {
                  var5 = var4.field_414 - this.getX();
                  var7 = var4.field_415 - this.getY();
                  var9 = var4.field_416 - this.getZ();
                  double var11 = var5 * var5 + var7 * var7 + var9 * var9;
                  float var13 = var26.getFlySpeed();
                  ...
                  Vec3 var17 = (new Vec3((double)Mth.sin(this.getYRot() * 0.017453292F), this.getDeltaMovement().field_415, (double)(-Mth.cos(this.getYRot() * 0.017453292F)))).normalize();
                  var18 = Math.max(((float)var17.dot(var16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs(var5) > 9.999999747378752E-6D || Math.abs(var9) > 9.999999747378752E-6D) {
                     double var19 = Mth.clamp(Mth.wrapDegrees(180.0D - Mth.atan2(var5, var9) * 57.2957763671875D - (double)this.getYRot()), -50.0D, 50.0D);
                     this.yRotA *= 0.8F;
                     this.yRotA = (float)((double)this.yRotA + var19 * (double)var26.getTurnSpeed());
                     this.setYRot(this.getYRot() + this.yRotA * 0.1F);
                  }

                  var39 = (float)(2.0D / (var11 + 1.0D));
                  var20 = 0.06F;
                  this.moveRelative(0.06F * (var18 * var39 + (1.0F - var39)), new Vec3(0.0D, 0.0D, -1.0D));
                  if (this.inWall) {
                  ...
                  double var22 = 0.8D + 0.15D * (var21.dot(var17) + 1.0D) / 2.0D;
                  this.setDeltaMovement(this.getDeltaMovement().multiply(var22, 0.9100000262260437D, var22));
               }
            }
            ...
            for(int var27 = 0; var27 < this.subEntities.length; ++var27) {
               var28[var27] = new Vec3(this.subEntities[var27].getX(), this.subEntities[var27].getY(), this.subEntities[var27].getZ());
            }

            float var29 = (float)(this.getLatencyPos(5, 1.0F)[1] - this.getLatencyPos(10, 1.0F)[1]) * 10.0F * 0.017453292F;
            float var31 = Mth.cos(var29);
            float var6 = Mth.sin(var29);
            float var32 = this.getYRot() * 0.017453292F;
            float var8 = Mth.sin(var32);
            float var33 = Mth.cos(var32);
            this.tickPart(this.body, (double)(var8 * 0.5F), 0.0D, (double)(-var33 * 0.5F));
            this.tickPart(this.wing1, (double)(var33 * 4.5F), 2.0D, (double)(var8 * 4.5F));
            this.tickPart(this.wing2, (double)(var33 * -4.5F), 2.0D, (double)(var8 * -4.5F));
            ...
            float var34 = Mth.cos(this.getYRot() * 0.017453292F - this.yRotA * 0.01F);
            float var12 = this.getHeadYOffset();
            this.tickPart(this.head, (double)(var10 * 6.5F * var31), (double)(var12 + var6 * 6.5F), (double)(-var34 * 6.5F * var31));
            this.tickPart(this.neck, (double)(var10 * 5.5F * var31), (double)(var12 + var6 * 5.5F), (double)(-var34 * 5.5F * var31));
            ...
            for(var36 = 0; var36 < 3; ++var36) {
               ...
               double[] var37 = this.getLatencyPos(12 + var36 * 2, 1.0F);
               float var38 = this.getYRot() * 0.017453292F + this.rotWrap(var37[0] - var35[0]) * 0.017453292F;
               var18 = Mth.sin(var38);
               var39 = Mth.cos(var38);
               var20 = 1.5F;
               float var40 = (float)(var36 + 1) * 2.0F;
               this.tickPart(var15, (double)(-(var8 * 1.5F + var18 * var40) * var31), var37[1] - var35[1] - (double)((var40 + 1.5F) * var6) + 1.5D, (double)((var33 * 1.5F + var39 * var40) * var31));
            }
            ...
            for(var36 = 0; var36 < this.subEntities.length; ++var36) {
               this.subEntities[var36].xo = var28[var36].field_414;
               this.subEntities[var36].yo = var28[var36].field_415;
               this.subEntities[var36].zo = var28[var36].field_416;
               this.subEntities[var36].xOld = var28[var36].field_414;
               this.subEntities[var36].yOld = var28[var36].field_415;
               this.subEntities[var36].zOld = var28[var36].field_416;
            }
   ...
   public Path findPath(int var1, int var2, @Nullable Node var3) {
      ...
      var13.field_336 = 0.0F;
      var13.field_337 = var13.distanceTo(var5);
      var13.field_338 = var13.field_337;
      this.openSet.clear();
      ...
      while(!this.openSet.isEmpty()) {
         ...
         for(var10 = var7; var10 < 24; ++var10) {
            if ((this.nodeAdjacency[var9] & 1 << var10) > 0) {
               ...
               if (!var11.closed) {
                  float var12 = var8.field_336 + var8.distanceTo(var11);
                  if (!var11.inOpenSet() || var12 < var11.field_336) {
                     var11.cameFrom = var8;
                     var11.field_336 = var12;
                     var11.field_337 = var11.distanceTo(var5);
                     if (var11.inOpenSet()) {
                        this.openSet.changeCost(var11, var11.field_336 + var11.field_337);
                     } else {
                        var11.field_338 = var11.field_336 + var11.field_337;
   ...
   private Path reconstructPath(Node var1, Node var2) {
      ...
      return new Path(var3, new BlockPos(var2.field_333, var2.field_334, var2.field_335), true);
   }
