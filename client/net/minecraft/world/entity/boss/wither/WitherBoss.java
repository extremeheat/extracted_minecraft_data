...
public class WitherBoss extends Monster implements PowerableMob, RangedAttackMob {
   ...
   public void aiStep() {
      ...
      for(var23 = 0; var23 < 3; ++var23) {
         ...
         this.level.addParticle(ParticleTypes.SMOKE, var24 + this.random.nextGaussian() * 0.30000001192092896, var26 + this.random.nextGaussian() * 0.30000001192092896, var8 + this.random.nextGaussian() * 0.30000001192092896, 0.0, 0.0, 0.0);
         if (var22 && this.level.random.nextInt(4) == 0) {
            this.level.addParticle(ParticleTypes.ENTITY_EFFECT, var24 + this.random.nextGaussian() * 0.30000001192092896, var26 + this.random.nextGaussian() * 0.30000001192092896, var8 + this.random.nextGaussian() * 0.30000001192092896, 0.699999988079071, 0.699999988079071, 0.5);
         }
      }
         ...
         for(var1 = 1; var1 < 3; ++var1) {
            if (this.tickCount >= this.nextHeadUpdate[var1 - 1]) {
               ...
               if (var13 > 0) {
                  ...
                  if (var16 != null && this.canAttack(var16) && !(this.distanceToSqr(var16) > 900.0) && this.hasLineOfSight(var16)) {
