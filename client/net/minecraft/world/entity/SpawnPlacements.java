...
public class SpawnPlacements {
   ...
   private static <T extends Mob> void register(EntityType<T> var0, Type var1, Heightmap.Types var2, SpawnPredicate<T> var3) {
   ...
   public static Type getPlacementType(EntityType<?> var0) {
   ...
   private static class Data {
      ...
      public Data(Heightmap.Types var1, Type var2, SpawnPredicate<?> var3) {
         super();
         this.heightMap = var1;
         this.placement = var2;
         this.predicate = var3;
