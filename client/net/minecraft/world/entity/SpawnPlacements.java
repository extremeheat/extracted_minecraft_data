...
public class SpawnPlacements {
   ...
   public static <T extends Entity> boolean checkSpawnRules(
      EntityType<T> var0, ServerLevelAccessor var1, EntitySpawnReason var2, BlockPos var3, RandomSource var4
   ) {
   ...
   static {
      ...
      register(EntityType.CREAKING_TRANSIENT, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Monster::checkMonsterSpawnRules);
