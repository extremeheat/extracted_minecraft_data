...
public class ExperienceOrb extends Entity {
   ...
   public void tick() {
      ...
      if (this.level.getFluidState(this.blockPosition()).method_56(FluidTags.LAVA)) {
   ...
   public static void award(ServerLevel var0, Vec3 var1, int var2) {
      while(var2 > 0) {
         ...
         if (!tryMergeToExisting(var0, var1, var3)) {
            var0.addFreshEntity(new ExperienceOrb(var0, var1.method_2(), var1.method_3(), var1.method_4(), var3));
         }
      }
   ...
   private void setUnderwaterMovement() {
      ...
      this.setDeltaMovement(var1.field_414 * 0.9900000095367432D, Math.min(var1.field_415 + 5.000000237487257E-4D, 0.05999999865889549D), var1.field_416 * 0.9900000095367432D);
   }
