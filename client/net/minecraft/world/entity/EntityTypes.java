...
public class EntityTypes {
   ...
   static {
      ...
      AREA_EFFECT_CLOUD = register(EntityTypeIds.AREA_EFFECT_CLOUD, EntityType.Builder.of(AreaEffectCloud::new, MobCategory.MISC).noLootTable().fireImmune().sized(6.0F, 0.5F).clientTrackingRange(10).noUpdateInterval());
      ...
      END_CRYSTAL = register(EntityTypeIds.END_CRYSTAL, EntityType.Builder.of(EndCrystal::new, MobCategory.MISC).noLootTable().fireImmune().sized(2.0F, 2.0F).clientTrackingRange(16).noUpdateInterval().dontTrackDeltas());
      ...
      GLOW_ITEM_FRAME = register(EntityTypeIds.GLOW_ITEM_FRAME, EntityType.Builder.of(GlowItemFrame::new, MobCategory.MISC).noLootTable().sized(0.5F, 0.5F).eyeHeight(0.0F).clientTrackingRange(10).noUpdateInterval().dontTrackDeltas());
      ...
      ITEM_FRAME = register(EntityTypeIds.ITEM_FRAME, EntityType.Builder.of(ItemFrame::new, MobCategory.MISC).noLootTable().sized(0.5F, 0.5F).eyeHeight(0.0F).clientTrackingRange(10).noUpdateInterval().dontTrackDeltas());
      ...
      LEASH_KNOT = register(EntityTypeIds.LEASH_KNOT, EntityType.Builder.of(LeashFenceKnotEntity::new, MobCategory.MISC).noLootTable().noSave().sized(0.375F, 0.5F).eyeHeight(0.0625F).clientTrackingRange(10).noUpdateInterval().dontTrackDeltas());
      LIGHTNING_BOLT = register(EntityTypeIds.LIGHTNING_BOLT, EntityType.Builder.of(LightningBolt::new, MobCategory.MISC).noLootTable().noSave().sized(0.0F, 0.0F).clientTrackingRange(16).noUpdateInterval());
      ...
      PAINTING = register(EntityTypeIds.PAINTING, EntityType.Builder.of(Painting::new, MobCategory.MISC).noLootTable().sized(0.5F, 0.5F).clientTrackingRange(10).noUpdateInterval().dontTrackDeltas());
