...
public class WanderingTrader extends AbstractVillager {
   ...
   public InteractionResult mobInteract(Player var1, InteractionHand var2) {
      ...
      if (!var3.method_87(Items.VILLAGER_SPAWN_EGG) && this.isAlive() && !this.isTrading() && !this.isBaby()) {
   ...
   protected SoundEvent getDrinkingSound(ItemStack var1) {
      return var1.method_87(Items.MILK_BUCKET) ? SoundEvents.WANDERING_TRADER_DRINK_MILK : SoundEvents.WANDERING_TRADER_DRINK_POTION;
   }
   ...
   private class WanderToPositionGoal extends Goal {
      ...
      public void tick() {
         ...
         if (var1 != null && WanderingTrader.this.navigation.isDone()) {
            if (this.isTooFarAway(var1, 10.0D)) {
               ...
               WanderingTrader.this.navigation.moveTo(var3.field_414, var3.field_415, var3.field_416, this.speedModifier);
            } else {
      ...
      private boolean isTooFarAway(BlockPos var1, double var2) {
         return !var1.closerThan(this.trader.position(), var2);
      }
   }
}
