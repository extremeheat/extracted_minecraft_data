...
public record VillagerProfession(String q, Predicate<Holder<PoiType>> r, Predicate<Holder<PoiType>> s, ImmutableSet<Item> t, ImmutableSet<Block> u, @Nullable SoundEvent v) {
   ...
   private static VillagerProfession register(String var0, Predicate<Holder<PoiType>> var1, Predicate<Holder<PoiType>> var2, ImmutableSet<Item> var3, ImmutableSet<Block> var4, @Nullable SoundEvent var5) {
      return (VillagerProfession)Registry.register(Registry.VILLAGER_PROFESSION, (ResourceLocation)(new ResourceLocation(var0)), new VillagerProfession(var0, var1, var2, var3, var4, var5));
   }
