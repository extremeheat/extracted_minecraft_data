...
public class GlowSquid extends Squid {
   ...
   public static boolean checkGlowSquideSpawnRules(EntityType<? extends LivingEntity> var0, ServerLevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      return var1.getBlockState(var3).is(Blocks.WATER) && var3.getY() <= var1.getSeaLevel() - 33;
   }
