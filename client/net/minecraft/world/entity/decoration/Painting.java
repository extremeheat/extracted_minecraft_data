...
public class Painting extends HangingEntity implements VariantHolder<Holder<PaintingVariant>> {
   ...
   protected void defineSynchedData(SynchedEntityData.Builder var1) {
      var1.define(DATA_PAINTING_VARIANT_ID, (Holder)this.registryAccess().registryOrThrow(Registries.PAINTING_VARIANT).getAny().orElseThrow());
   }
   ...
   public static Optional<Painting> create(Level var0, BlockPos var1, Direction var2) {
      ...
      Iterable var10000 = var0.registryAccess().registryOrThrow(Registries.PAINTING_VARIANT).getTagOrEmpty(PaintingVariantTags.PLACEABLE);
