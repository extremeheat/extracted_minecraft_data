...
public abstract class HangingEntity extends Entity {
   ...
   protected void recalculateBoundingBox() {
      if (this.direction != null) {
         ...
         if (this.direction.getAxis() == Direction.Axis.field_502) {
            var18 = 1.0D;
         } else {
            var14 = 1.0D;
         }
      ...
      if (!this.level.noCollision(this)) {
         ...
         for(int var6 = 0; var6 < var1; ++var6) {
            for(int var7 = 0; var7 < var2; ++var7) {
               int var8 = (var1 - 1) / -2;
               int var9 = (var2 - 1) / -2;
               var5.set(var3).move(var4, var6 + var8).move(Direction.field_526, var7 + var9);
   ...
   public boolean skipAttackInteraction(Entity var1) {
      if (var1 instanceof Player) {
         ...
         return !this.level.mayInteract(var2, this.pos) ? true : this.hurt(DamageSource.playerAttack(var2), 0.0F);
      } else {
         return false;
      }
   }
   ...
   public float rotate(Rotation var1) {
      if (this.direction.getAxis() != Direction.Axis.field_501) {
         switch(var1) {
         case CLOCKWISE_180:
