   ...
   private static void register(BootstrapContext<PaintingVariant> var0, ResourceKey<PaintingVariant> var1, int var2, int var3, boolean var4) {
      var0.register(
         ...
         new PaintingVariant(
            ...
            var3,
            var1.location(),
            Optional.of(Component.translatable(var1.location().toLanguageKey("painting", "title")).withStyle(ChatFormatting.YELLOW)),
            var4 ? Optional.of(Component.translatable(var1.location().toLanguageKey("painting", "author")).withStyle(ChatFormatting.GRAY)) : Optional.empty()
         )
      );
   }
