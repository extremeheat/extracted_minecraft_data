...
public abstract class Raider extends PatrollingMonster {
   ...
   public void die(DamageSource var1) {
      if (this.level() instanceof ServerLevel) {
         ...
         if (!this.level().enabledFeatures().contains(FeatureFlags.UPDATE_1_21) && this.isPatrolLeader() && var3 == null && ((ServerLevel)this.level()).getRaidAt(this.blockPosition()) == null) {
            ...
            if (!var4.isEmpty() && ItemStack.matches(var4, Raid.getLeaderBannerInstance(this.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN))) && var5 != null) {
   ...
   public class ObtainRaidLeaderBannerGoal<T extends Raider> extends Goal {
      ...
      public ObtainRaidLeaderBannerGoal(Raider var1, Raider var2) {
         super();
         this.mob = var2;
   ...
   protected class HoldGroundAttackGoal extends Goal {
      ...
      public HoldGroundAttackGoal(Raider var1, AbstractIllager var2, float var3) {
         super();
         this.mob = var2;
