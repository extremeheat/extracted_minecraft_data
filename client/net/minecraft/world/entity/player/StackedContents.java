...
public class StackedContents<T> {
   ...
   public boolean tryPick(List<StackedContents.IngredientInfo<T>> var1, int var2, @Nullable StackedContents.Output<T> var3) {
      return new StackedContents.RecipePicker(var1).tryPick(var2, var3);
   }

   public int tryPickAll(List<StackedContents.IngredientInfo<T>> var1, int var2, @Nullable StackedContents.Output<T> var3) {
   ...
   class RecipePicker {
      ...
      public RecipePicker(final List<StackedContents.IngredientInfo<T>> nullx) {
         super();
         this.ingredients = nullx;
      ...
      private void setInitialConnections() {
         for (int var1 = 0; var1 < this.ingredientCount; var1++) {
            List var2 = this.ingredients.get(var1).allowedItems();
      ...
      private List<T> getUniqueAvailableIngredientItems() {
         ...
         for (StackedContents.IngredientInfo var3 : this.ingredients) {
            var1.addAll(var3.allowedItems());
         }

         var1.removeIf(var1x -> !StackedContents.this.hasAnyAmount((T)var1x));
      ...
      private int getMinIngredientCount() {
         ...
         for (StackedContents.IngredientInfo var3 : this.ingredients) {
            ...
            for (Object var6 : var3.allowedItems()) {
               var4 = Math.max(var4, StackedContents.this.amounts.getInt(var6));
            }
