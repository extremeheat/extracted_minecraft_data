...
public class MinecartTNT extends AbstractMinecart {
   ...
   public boolean hurt(DamageSource var1, float var2) {
      ...
      if (var3 instanceof AbstractArrow var4) {
         if (var4.isOnFire()) {
   ...
   public void destroy(DamageSource var1) {
      ...
      if (!var1.isFire() && !var1.isExplosion() && !(var2 >= 0.009999999776482582)) {
         super.destroy(var1);
      } else {
         if (this.fuse < 0) {
            this.primeFuse();
   ...
   protected void explode(double var1) {
      if (!this.level.isClientSide) {
         ...
         this.level.explode(this, this.getX(), this.getY(), this.getZ(), (float)(4.0 + this.random.nextDouble() * 1.5 * var3), Explosion.BlockInteraction.BREAK);
         this.discard();
      }
