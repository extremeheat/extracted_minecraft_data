...
public class Attributes {
   ...
   public static final Holder<Attribute> FLYING_SPEED = register(
      "generic.flying_speed", new RangedAttribute("attribute.name.generic.flying_speed", 0.4000000059604645, 0.0, 1024.0).setSyncable(true)
   );
   ...
   public static final Holder<Attribute> JUMP_STRENGTH = register(
      "generic.jump_strength", new RangedAttribute("attribute.name.generic.jump_strength", 0.41999998688697815, 0.0, 32.0).setSyncable(true)
   );
   ...
   public static final Holder<Attribute> MOVEMENT_SPEED = register(
      "generic.movement_speed", new RangedAttribute("attribute.name.generic.movement_speed", 0.699999988079071, 0.0, 1024.0).setSyncable(true)
   );
