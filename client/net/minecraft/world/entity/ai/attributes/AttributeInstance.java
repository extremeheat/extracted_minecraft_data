...
public class AttributeInstance {
   ...
   public Set<AttributeModifier> getModifiers(AttributeModifier.Operation var1) {
      return (Set)this.modifiersByOperation.computeIfAbsent(var1, (var0) -> {
   ...
   private void addModifier(AttributeModifier var1) {
      AttributeModifier var2 = (AttributeModifier)this.modifierById.putIfAbsent(var1.getId(), var1);
      if (var2 != null) {
   ...
   private double calculateValue() {
      ...
      for(Iterator var3 = this.getModifiersOrEmpty(AttributeModifier.Operation.ADDITION).iterator(); var3.hasNext(); var1 += var4.getAmount()) {
      ...
      for(var5 = this.getModifiersOrEmpty(AttributeModifier.Operation.MULTIPLY_BASE).iterator(); var5.hasNext(); var7 += var1 * var6.getAmount()) {
         var6 = (AttributeModifier)var5.next();
      }

      for(var5 = this.getModifiersOrEmpty(AttributeModifier.Operation.MULTIPLY_TOTAL).iterator(); var5.hasNext(); var7 *= 1.0D + var6.getAmount()) {
         var6 = (AttributeModifier)var5.next();
      }
   ...
   private Collection<AttributeModifier> getModifiersOrEmpty(AttributeModifier.Operation var1) {
      return (Collection)this.modifiersByOperation.getOrDefault(var1, Collections.emptySet());
   }
   ...
   public void replaceFrom(AttributeInstance var1) {
      ...
      var1.modifiersByOperation.forEach((var1x, var2) -> {
         this.getModifiers(var1x).addAll(var2);
      });
      this.setDirty();
   }
   ...
   public CompoundTag save() {
      ...
      var1.putString("Name", Registry.ATTRIBUTE.getKey(this.attribute).toString());
