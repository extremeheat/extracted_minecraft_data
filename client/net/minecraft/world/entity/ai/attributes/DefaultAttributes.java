...
public class DefaultAttributes {
   ...
   public static void validate() {
      Stream var10000 = BuiltInRegistries.ENTITY_TYPE.stream().filter((var0) -> {
