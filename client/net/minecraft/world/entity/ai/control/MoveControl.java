...
public class MoveControl implements Control {
   ...
   public void tick() {
      ...
      if (this.operation == MoveControl.Operation.STRAFE) {
         ...
         if (var15 > (double)this.mob.maxUpStep && var13 * var13 + var14 * var14 < (double)Math.max(1.0F, this.mob.getBbWidth()) || !var12.isEmpty() && this.mob.getY() < var12.max(Direction.Axis.field_501) + (double)var10.getY() && !var11.is(BlockTags.DOORS) && !var11.is(BlockTags.FENCES)) {
   ...
   protected static enum Operation {
      ...
      // $FF: synthetic method
      private static MoveControl.Operation[] $values() {
         return new MoveControl.Operation[]{WAIT, MOVE_TO, STRAFE, JUMPING};
      }
   }
}
