...
public class VillageSiege implements CustomSpawner {
   ...
   private void trySpawn(ServerLevel var1) {
      ...
      if (var2 != null) {
         ...
         var3.moveTo(var2.field_414, var2.field_415, var2.field_416, var1.random.nextFloat() * 360.0F, 0.0F);
   ...
   private static enum State {
      ...
      // $FF: synthetic method
      private static VillageSiege.State[] $values() {
         return new VillageSiege.State[]{SIEGE_CAN_ACTIVATE, SIEGE_TONIGHT, SIEGE_DONE};
      }
   }
}
