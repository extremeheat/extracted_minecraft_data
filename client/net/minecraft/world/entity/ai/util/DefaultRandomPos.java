...
public class DefaultRandomPos {
   ...
   public static Vec3 getPosTowards(PathfinderMob var0, int var1, int var2, Vec3 var3, double var4) {
      ...
      return RandomPos.generateRandomPos(var0, () -> {
         BlockPos var7x = RandomPos.generateRandomDirectionWithinRadians(var0.getRandom(), var1, var2, 0, var6.field_414, var6.field_416, var4);
   ...
   public static Vec3 getPosAway(PathfinderMob var0, int var1, int var2, Vec3 var3) {
      ...
      return RandomPos.generateRandomPos(var0, () -> {
         BlockPos var5x = RandomPos.generateRandomDirectionWithinRadians(var0.getRandom(), var1, var2, 0, var4.field_414, var4.field_416, 1.5707963705062866D);
