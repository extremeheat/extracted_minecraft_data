...
public class GoToClosestVillage extends Behavior<Villager> {
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      ...
      int var6 = var5.sectionsToVillage(SectionPos.method_71(var2.blockPosition()));
      Vec3 var7 = null;

      for(int var8 = 0; var8 < 5; ++var8) {
         Vec3 var9 = LandRandomPos.getPos(var2, 15, 7, (var1x) -> {
            return (double)(-var5.sectionsToVillage(SectionPos.method_71(var1x)));
         });
         if (var9 != null) {
            int var10 = var5.sectionsToVillage(SectionPos.method_71(new BlockPos(var9)));
            if (var10 < var6) {
               var7 = var9;
               break;
            }
