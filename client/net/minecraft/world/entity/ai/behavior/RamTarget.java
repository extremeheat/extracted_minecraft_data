...
public class RamTarget extends Behavior<Goat> {
   ...
   protected void tick(ServerLevel var1, Goat var2, long var3) {
      ...
      if (!var5.isEmpty()) {
         ...
         if (var13) {
            var1.playSound((Player)null, var2, (SoundEvent)this.getHornBreakSound.apply(var2), SoundSource.HOSTILE, 1.0F, 1.0F);
         }
         ...
         boolean var16 = !var14.isPresent() || !var15.isPresent() || ((WalkTarget)var14.get()).getTarget().currentPosition().closerThan((Position)var15.get(), 0.25);
         if (var16) {
            this.finishRam(var1, var2);
         }
      }
   ...
   protected boolean canStillUse(ServerLevel var1, LivingEntity var2, long var3) {
      return this.canStillUse(var1, (Goat)var2, var3);
   }

   // $FF: synthetic method
   protected void tick(ServerLevel var1, LivingEntity var2, long var3) {
      this.tick(var1, (Goat)var2, var3);
   }
