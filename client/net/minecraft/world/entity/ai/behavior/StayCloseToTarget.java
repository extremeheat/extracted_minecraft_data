...
public class StayCloseToTarget<E extends LivingEntity> extends Behavior<E> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, E var2) {
      Optional var3 = this.targetPositionGetter.apply(var2);
      if (var3.isEmpty()) {
         return false;
      } else {
   ...
   protected void start(ServerLevel var1, E var2, long var3) {
      BehaviorUtils.setWalkAndLookTargetMemories(var2, this.targetPositionGetter.apply(var2).get(), this.speedModifier, this.closeEnough);
   }
}
