...
public class CopyMemoryWithExpiry {
   ...
   public static <E extends LivingEntity, T> BehaviorControl<E> create(
      ...
      return BehaviorBuilder.create(var4 -> var4.group(var4.present(var1), var4.absent(var2)).apply(var4, (var3xx, var4x) -> (var5, var6, var7) -> {
               if (!var0.test(var6)) {
                  return false;
               } else {
                  var4x.setWithExpiry(var4.get(var3xx), (long)var3.sample(var5.random));
                  return true;
               }
            }));
   }
