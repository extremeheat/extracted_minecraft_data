...
public class SetEntityLookTargetSometimes {
   ...
   private static BehaviorControl<LivingEntity> create(float var0, UniformInt var1, Predicate<LivingEntity> var2) {
      ...
      SetEntityLookTargetSometimes.Ticker var4 = new SetEntityLookTargetSometimes.Ticker(var1);
      return BehaviorBuilder.create(
         var3x -> var3x.group(var3x.absent(MemoryModuleType.LOOK_TARGET), var3x.present(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES))
               .apply(var3x, (var4x, var5) -> (var6, var7, var8) -> {
                     Optional var10 = var3x.<NearestVisibleLivingEntities>get(var5)
                        .findClosest(var2.and(var2xxxx -> var2xxxx.distanceToSqr(var7) <= (double)var3));
                     if (var10.isEmpty()) {
                        return false;
