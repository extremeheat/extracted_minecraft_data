...
public class MoveToSkySeeingSpot extends Behavior<LivingEntity> {
   ...
   public static boolean hasNoBlocksAbove(ServerLevel var0, LivingEntity var1) {
      return var0.canSeeSky(new BlockPos(var1)) && (double)var0.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING, new BlockPos(var1)).getY() <= var1.y;
   }
}
