...
public class StartAttacking {
   ...
   public static <E extends Mob> BehaviorControl<E> create(StartAttacking.TargetFinder<E> var0) {
      return create((var0x, var1) -> true, var0);
   }

   public static <E extends Mob> BehaviorControl<E> create(StartAttacking.StartAttackingCondition<E> var0, StartAttacking.TargetFinder<E> var1) {
