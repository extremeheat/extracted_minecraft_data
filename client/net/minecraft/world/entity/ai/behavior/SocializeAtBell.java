...
public class SocializeAtBell extends Behavior<LivingEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
      ...
      return var1.getRandom().nextInt(100) == 0 && var4.isPresent() && var1.dimension() == ((GlobalPos)var4.get()).dimension() && ((GlobalPos)var4.get()).pos().closerThan(var2.position(), 4.0D) && ((NearestVisibleLivingEntities)var3.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get()).contains((var0) -> {
   ...
   protected void start(ServerLevel var1, LivingEntity var2, long var3) {
      ...
      var5.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).flatMap((var1x) -> {
         return var1x.findClosest((var1) -> {
            return EntityType.VILLAGER.equals(var1.getType()) && var1.distanceToSqr(var2) <= 32.0D;
         });
      }).ifPresent((var1x) -> {
