...
public class GoToTargetLocation<E extends Mob> extends Behavior<E> {
   ...
   public GoToTargetLocation(MemoryModuleType<BlockPos> var1, int var2, float var3) {
      super(ImmutableMap.of(var1, MemoryStatus.VALUE_PRESENT, MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_ABSENT, MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED));
   ...
   private BlockPos getTargetLocation(Mob var1) {
      return (BlockPos)var1.getBrain().getMemory(this.locationMemory).get();
   }
}
