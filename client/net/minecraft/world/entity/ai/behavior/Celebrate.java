...
public class Celebrate extends Behavior<Villager> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, Villager var2) {
      this.currentRaid = var1.getRaidAt(new BlockPos(var2));
      return this.currentRaid != null && this.currentRaid.isVictory() && MoveToSkySeeingSpot.hasNoBlocksAbove(var1, var2);
   }
   ...
   protected void tick(ServerLevel var1, Villager var2, long var3) {
      ...
      if (var5.nextInt(200) == 0 && MoveToSkySeeingSpot.hasNoBlocksAbove(var1, var2)) {
         ...
         FireworkRocketEntity var9 = new FireworkRocketEntity(var2.level, var2.x, var2.y + (double)var2.getEyeHeight(), var2.z, var8);
