...
public class PoiCompetitorScan extends Behavior<Villager> {
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      GlobalPos var5 = var2.getBrain().getMemory(MemoryModuleType.JOB_SITE).get();
      var1.getPoiManager()
         .getType(var5.pos())
         .ifPresent(
            var3x -> BehaviorUtils.getNearbyVillagersWithCondition(var2, var3xx -> this.competesForSameJobsite(var5, var3x, var3xx))
   ...
   private boolean competesForSameJobsite(GlobalPos var1, Holder<PoiType> var2, Villager var3) {
      return this.hasJobSite(var3)
         && var1.equals(var3.getBrain().getMemory(MemoryModuleType.JOB_SITE).get())
         && this.hasMatchingProfession(var2, var3.getVillagerData().getProfession());
   }

   private boolean hasMatchingProfession(Holder<PoiType> var1, VillagerProfession var2) {
      return var2.heldJobSite().test(var1);
   }
