...
public class YieldJobSite extends Behavior<Villager> {
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      ...
      if (var6.isPresent()) {
         BehaviorUtils.getNearbyVillagersWithCondition(var2, (var3x) -> {
            return this.nearbyWantsJobsite((PoiType)var6.get(), var3x, var5);
   ...
   private boolean nearbyWantsJobsite(PoiType var1, Villager var2, BlockPos var3) {
      ...
      if (var4) {
         ...
         if (var2.getVillagerData().getProfession() != VillagerProfession.NONE && var6.getJobPoiType().getPredicate().test(var1)) {
            return !var5.isPresent() ? this.canReachPos(var2, var3, var1) : ((GlobalPos)var5.get()).pos().equals(var3);
         } else {
            return false;
         }
      }
   ...
   private void yieldJobSite(ServerLevel var1, Villager var2, Villager var3, BlockPos var4, boolean var5) {
      ...
      if (!var5) {
         ...
         var3.getBrain().setMemory(MemoryModuleType.POTENTIAL_JOB_SITE, (Object)GlobalPos.method_122(var1.dimension(), var4));
   ...
   private boolean canReachPos(Villager var1, BlockPos var2, PoiType var3) {
      Path var4 = var1.getNavigation().createPath(var2, var3.getValidRange());
