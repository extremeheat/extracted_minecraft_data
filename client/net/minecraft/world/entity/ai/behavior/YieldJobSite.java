...
public class YieldJobSite extends Behavior<Villager> {
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      BlockPos var5 = var2.getBrain().getMemory(MemoryModuleType.POTENTIAL_JOB_SITE).get().pos();
      Optional var6 = var1.getPoiManager().getType(var5);
      if (var6.isPresent()) {
         BehaviorUtils.getNearbyVillagersWithCondition(var2, var3x -> this.nearbyWantsJobsite((Holder<PoiType>)var6.get(), var3x, var5))
            .findFirst()
            .ifPresent(var4 -> this.yieldJobSite(var1, var2, var4, var5, var4.getBrain().getMemory(MemoryModuleType.JOB_SITE).isPresent()));
      }
   }
   ...
   private void yieldJobSite(ServerLevel var1, Villager var2, Villager var3, BlockPos var4, boolean var5) {
      ...
      if (!var5) {
         BehaviorUtils.setWalkAndLookTargetMemories(var3, var4, this.speedModifier, 1);
         var3.getBrain().setMemory(MemoryModuleType.POTENTIAL_JOB_SITE, GlobalPos.of(var1.dimension(), var4));
