...
public class SetRoarTarget<E extends Warden> extends Behavior<E> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, E var2) {
      Optional var10000 = (Optional)this.targetFinderFunction.apply(var2);
      Objects.requireNonNull(var2);
      return var10000.filter(var2::canTargetEntity).isPresent();
   }

   protected void start(ServerLevel var1, E var2, long var3) {
      ((Optional)this.targetFinderFunction.apply(var2)).ifPresent((var1x) -> {
         var2.getBrain().setMemory(MemoryModuleType.ROAR_TARGET, (Object)var1x);
