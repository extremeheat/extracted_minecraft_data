...
public class VillageBoundRandomStroll extends Behavior<PathfinderMob> {
   ...
   private void setTargetedPos(PathfinderMob var1, SectionPos var2) {
      Optional var3 = Optional.ofNullable(DefaultRandomPos.getPosTowards(var1, this.maxXyDist, this.maxYDist, Vec3.atBottomCenterOf(var2.center()), 1.5707963705062866));
