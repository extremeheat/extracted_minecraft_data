...
public class RandomStroll {
   ...
   public static OneShot<PathfinderMob> stroll(float var0, boolean var1) {
      return strollFlyOrSwim(var0, (var0x) -> {
         return LandRandomPos.getPos(var0x, 10, 7);
      }, var1 ? (var0x) -> {
         return true;
      } : (var0x) -> {
         return !var0x.isInWaterOrBubble();
      });
   }

   public static BehaviorControl<PathfinderMob> stroll(float var0, int var1, int var2) {
      return strollFlyOrSwim(var0, (var2x) -> {
         return LandRandomPos.getPos(var2x, var1, var2);
      }, (var0x) -> {
         return true;
      });
   }
   ...
   public static BehaviorControl<PathfinderMob> fly(float var0) {
      return strollFlyOrSwim(var0, (var0x) -> {
         return getTargetFlyPos(var0x, 10, 7);
      }, (var0x) -> {
         return true;
      });
   }
         ...
         return var3.group(var3.absent(MemoryModuleType.WALK_TARGET)).apply(var3, (var3x) -> {
            return (var4, var5, var6) -> {
               if (!var2.test(var5)) {
                  ...
                  var3x.setOrErase(var8.map((var1x) -> {
