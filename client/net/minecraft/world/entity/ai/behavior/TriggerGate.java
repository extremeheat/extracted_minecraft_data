...
public class TriggerGate {
   ...
   public static <E extends LivingEntity> OneShot<E> triggerGate(
      List<Pair<? extends Trigger<? super E>, Integer>> var0, GateBehavior.OrderPolicy var1, GateBehavior.RunningPolicy var2
   ) {
      ShufflingList var3 = new ShufflingList();
      var0.forEach(var1x -> var3.add((Trigger)var1x.getFirst(), var1x.getSecond()));
      return BehaviorBuilder.create(var3x -> var3x.point((var3xx, var4, var5) -> {
