   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, Villager var2) {
      ...
      if (var3.isPresent() && var4.isPresent()) {
         ...
         if (!var5.isEmpty()) {
            ...
            return this.targetPos != null && var1.dimension() == this.targetPos.dimension() && ((GlobalPos)var4.get()).pos().closerToCenterThan(var2.position(), (double)this.maxDistanceFromPoi);
         }
      }
