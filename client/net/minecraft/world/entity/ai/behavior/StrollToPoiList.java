...
public class StrollToPoiList extends Behavior<Villager> {
      ...
      if (var3.isPresent() && var4.isPresent()) {
         ...
         if (!var5.isEmpty()) {
            ...
            return this.targetPos != null
               && var1.dimension() == this.targetPos.dimension()
               && ((GlobalPos)var4.get()).pos().closerToCenterThan(var2.position(), (double)this.maxDistanceFromPoi);
         }
      }
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      if (var3 > this.nextOkStartTime && this.targetPos != null) {
         var2.getBrain().setMemory(MemoryModuleType.WALK_TARGET, new WalkTarget(this.targetPos.pos(), this.speedModifier, this.closeEnoughDist));
