...
public class StrollToPoiList {
   ...
   public static BehaviorControl<Villager> create(MemoryModuleType<List<GlobalPos>> var0, float var1, int var2, int var3, MemoryModuleType<GlobalPos> var4) {
      ...
      return BehaviorBuilder.create(
         var6 -> var6.group(var6.registered(MemoryModuleType.WALK_TARGET), var6.present(var0), var6.present(var4))
               .apply(var6, (var5xx, var6x, var7) -> (var8, var9, var10) -> {
                     List var12 = var6.get(var6x);
                     GlobalPos var13 = var6.get(var7);
                     if (var12.isEmpty()) {
                        return false;
                     } else {
