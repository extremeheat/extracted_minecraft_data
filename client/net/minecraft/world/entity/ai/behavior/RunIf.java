...
public class RunIf<E extends LivingEntity> extends Behavior<E> {
   ...
   public RunIf(Map<MemoryModuleType<?>, MemoryStatus> var1, Behavior<? super E> var2) {
      this(var1, var0 -> true, var2, false);
   }

   @Override
   protected boolean checkExtraStartConditions(ServerLevel var1, E var2) {
      return this.predicate.test((E)var2) && this.wrappedBehavior.checkExtraStartConditions(var1, (E)var2);
   }

   @Override
   protected boolean canStillUse(ServerLevel var1, E var2, long var3) {
      return this.checkWhileRunningAlso && this.predicate.test((E)var2) && this.wrappedBehavior.canStillUse(var1, (E)var2, var3);
   }
   ...
   protected void start(ServerLevel var1, E var2, long var3) {
      this.wrappedBehavior.start(var1, (E)var2, var3);
   }

   @Override
   protected void tick(ServerLevel var1, E var2, long var3) {
      this.wrappedBehavior.tick(var1, (E)var2, var3);
   }

   @Override
   protected void stop(ServerLevel var1, E var2, long var3) {
      this.wrappedBehavior.stop(var1, (E)var2, var3);
   }
