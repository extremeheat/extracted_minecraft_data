...
public class StrollToPoi extends Behavior<PathfinderMob> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, PathfinderMob var2) {
      ...
      return var3.isPresent() && var1.dimension() == ((GlobalPos)var3.get()).dimension() && ((GlobalPos)var3.get()).pos().closerToCenterThan(var2.position(), (double)this.maxDistanceFromPoi);
   }
