...
public class BecomePassiveIfMemoryPresent extends Behavior<LivingEntity> {
   ...
   public BecomePassiveIfMemoryPresent(MemoryModuleType<?> var1, int var2) {
      super(ImmutableMap.of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.REGISTERED, MemoryModuleType.PACIFIED, MemoryStatus.VALUE_ABSENT, var1, MemoryStatus.VALUE_PRESENT));
