...
public class MemoryModuleType<U> {
   ...
   static {
      ...
      BREEZE_JUMP_COOLDOWN = register("breeze_jump_cooldown", Codec.unit(Unit.INSTANCE));
      BREEZE_SHOOT = register("breeze_shoot", Codec.unit(Unit.INSTANCE));
      BREEZE_SHOOT_CHARGING = register("breeze_shoot_charging", Codec.unit(Unit.INSTANCE));
      BREEZE_SHOOT_RECOVERING = register("breeze_shoot_recover", Codec.unit(Unit.INSTANCE));
      BREEZE_SHOOT_COOLDOWN = register("breeze_shoot_cooldown", Codec.unit(Unit.INSTANCE));
      BREEZE_JUMP_INHALING = register("breeze_jump_inhaling", Codec.unit(Unit.INSTANCE));
      BREEZE_JUMP_TARGET = register("breeze_jump_target", BlockPos.CODEC);
      BREEZE_LEAVING_WATER = register("breeze_leaving_water", Codec.unit(Unit.INSTANCE));
   }
}
