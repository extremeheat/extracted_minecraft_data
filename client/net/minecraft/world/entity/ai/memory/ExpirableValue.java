...
public class ExpirableValue<T> {
   ...
   // $FF: renamed from: of (java.lang.Object) net.minecraft.world.entity.ai.memory.ExpirableValue
   public static <T> ExpirableValue<T> method_94(T var0) {
      return new ExpirableValue(var0, 9223372036854775807L);
   }

   // $FF: renamed from: of (java.lang.Object, long) net.minecraft.world.entity.ai.memory.ExpirableValue
   public static <T> ExpirableValue<T> method_95(T var0, long var1) {
