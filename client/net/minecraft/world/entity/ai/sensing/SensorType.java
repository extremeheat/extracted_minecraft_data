...
public class SensorType<U extends Sensor<?>> {
   ...
   public static final SensorType<MobSensor<Armadillo>> ARMADILLO_SCARE_DETECTED = register("armadillo_scare_detected", () -> new MobSensor(5, Armadillo::isScaredBy, Armadillo::canStayRolledUp, MemoryModuleType.DANGER_DETECTED_RECENTLY, 80));
