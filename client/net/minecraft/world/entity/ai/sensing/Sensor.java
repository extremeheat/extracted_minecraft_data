...
public abstract class Sensor<E extends LivingEntity> {
   ...
   public final void tick(ServerLevel var1, E var2) {
      if (--this.timeToTick <= 0L) {
         ...
         this.updateTargetingConditionRanges(var2);
   ...
   public static boolean isEntityTargetable(ServerLevel var0, LivingEntity var1, LivingEntity var2) {
      return var1.getBrain().isMemoryValue(MemoryModuleType.ATTACK_TARGET, var2) ? TARGET_CONDITIONS_IGNORE_INVISIBILITY_TESTING.test(var0, var1, var2) : TARGET_CONDITIONS.test(var0, var1, var2);
   }

   public static boolean isEntityAttackable(ServerLevel var0, LivingEntity var1, LivingEntity var2) {
      return var1.getBrain().isMemoryValue(MemoryModuleType.ATTACK_TARGET, var2) ? ATTACK_TARGET_CONDITIONS_IGNORE_INVISIBILITY_TESTING.test(var0, var1, var2) : ATTACK_TARGET_CONDITIONS.test(var0, var1, var2);
   }
   ...
   public static boolean isEntityAttackableIgnoringLineOfSight(ServerLevel var0, LivingEntity var1, LivingEntity var2) {
      return var1.getBrain().isMemoryValue(MemoryModuleType.ATTACK_TARGET, var2) ? ATTACK_TARGET_CONDITIONS_IGNORE_INVISIBILITY_AND_LINE_OF_SIGHT.test(var0, var1, var2) : ATTACK_TARGET_CONDITIONS_IGNORE_LINE_OF_SIGHT.test(var0, var1, var2);
   }
