...
public class GossipContainer {
   ...
   static class GossipEntry {
      ...
      public <T> Dynamic<T> store(DynamicOps<T> var1) {
         return new Dynamic(var1, var1.createMap(ImmutableMap.of(var1.createString("Target"), SerializableUUID.CODEC.encodeStart(var1, this.target).result().orElseThrow(RuntimeException::new), var1.createString("Type"), var1.createString(this.type.field_270), var1.createString("Value"), var1.createInt(this.value))));
      }
