...
public class SpearUseGoal<T extends Monster> extends Goal {
   ...
   public void tick() {
      ...
      boolean var4 = this.mob.isPassenger();
      float var5 = var4 ? 1.4F : 1.0F;
      ...
      if (this.engageTime > 0) {
         ...
         if (this.engageTime == 0) {
            ...
            this.awayPos = LandRandomPos.getPosAway(this.mob, Math.max(0.0, 10.0 - var6), Math.max(1.0, 14.0 - var6), 7, var1.position());
            this.fleeingTime = 1;
         }
      }
      ...
      if (this.awayPos != null) {
         ...
         if (var2 < this.targetInRangeSqr || this.mob.getNavigation().isDone()) {
            ...
            this.awayPos = LandRandomPos.getPosAway(this.mob, 6.0 - var8, 9.0 - var8, 7, var1.position());
         }
      }
