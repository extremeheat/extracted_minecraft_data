...
public class HurtByTargetGoal extends TargetGoal {
   ...
   protected void alertOthers() {
      ...
      List var3 = this.mob.level.getLoadedEntitiesOfClass(this.mob.getClass(), (new AABB(this.mob.x, this.mob.y, this.mob.z, this.mob.x + 1.0D, this.mob.y + 1.0D, this.mob.z + 1.0D)).inflate(var1, 10.0D, var1));
