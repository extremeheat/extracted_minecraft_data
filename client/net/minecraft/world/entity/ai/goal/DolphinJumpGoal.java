...
public class DolphinJumpGoal extends JumpGoal {
   ...
   private boolean waterIsClear(BlockPos var1, int var2, int var3, int var4) {
      ...
      return this.dolphin.level.getFluidState(var5).method_56(FluidTags.WATER) && !this.dolphin.level.getBlockState(var5).getMaterial().blocksMotion();
   }
   ...
   public boolean canContinueToUse() {
      double var1 = this.dolphin.getDeltaMovement().field_415;
   ...
   public void tick() {
      ...
      if (!var1) {
         ...
         this.breached = var2.method_56(FluidTags.WATER);
      }
      ...
      if (var7.field_415 * var7.field_415 < 0.029999999329447746D && this.dolphin.getXRot() != 0.0F) {
         ...
         double var5 = Math.atan2(-var7.field_415, var3) * 57.2957763671875D;
