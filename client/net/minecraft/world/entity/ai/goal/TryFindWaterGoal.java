...
public class TryFindWaterGoal extends Goal {
   ...
   public boolean canUse() {
      return this.mob.isOnGround() && !this.mob.level.getFluidState(this.mob.blockPosition()).method_56(FluidTags.WATER);
   }
   ...
   public void start() {
      ...
      while(var3.hasNext()) {
         ...
         if (this.mob.level.getFluidState(var4).method_56(FluidTags.WATER)) {
            var1 = var4;
            break;
         }
      }
