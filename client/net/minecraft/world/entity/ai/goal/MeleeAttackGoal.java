...
public class MeleeAttackGoal extends Goal {
      ...
      if (var1 - this.lastUpdate < 20L) {
         ...
         if (var3 == null) {
            ...
            if (this.path != null) {
               ...
               return this.getAttackReachSqr(var3) >= this.mob.distanceToSqr(var3.x, var3.getBoundingBox().minY, var3.z);
            }
         }
      }
   }
   ...
   public void tick() {
      ...
      double var2 = this.mob.distanceToSqr(var1.x, var1.getBoundingBox().minY, var1.z);
      ...
      if ((this.trackTarget || this.mob.getSensing().canSee(var1)) && this.timeToRecalcPath <= 0 && (this.pathedTargetX == 0.0D && this.pathedTargetY == 0.0D && this.pathedTargetZ == 0.0D || var1.distanceToSqr(this.pathedTargetX, this.pathedTargetY, this.pathedTargetZ) >= 1.0D || this.mob.getRandom().nextFloat() < 0.05F)) {
         this.pathedTargetX = var1.x;
         this.pathedTargetY = var1.getBoundingBox().minY;
         this.pathedTargetZ = var1.z;
