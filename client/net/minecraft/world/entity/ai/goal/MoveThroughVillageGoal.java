               ...
               if (var3 == null) {
                  ...
                  if (!var4.isPresent()) {
                     ...
                     if (this.path == null) {
                        ...
                        var5.setCanOpenDoors(this.canDealWithDoors.getAsBoolean());
                        this.path = this.mob.getNavigation().createPath(var7.field_414, var7.field_415, var7.field_416, 0);
                        var5.setCanOpenDoors(var6);
                        if (this.path == null) {
                           return false;
                        }
                     ...
                     for(int var10 = 0; var10 < this.path.getNodeCount(); ++var10) {
                        ...
                        BlockPos var9 = new BlockPos(var8.field_333, var8.field_334 + 1, var8.field_335);
                        if (DoorBlock.isWoodenDoor(this.mob.level, var9)) {
                           this.path = this.mob.getNavigation().createPath((double)var8.field_333, (double)var8.field_334, (double)var8.field_335, 0);
                           break;
                        }
                     }
