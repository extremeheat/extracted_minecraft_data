...
public class RangedCrossbowAttackGoal<T extends Monster & RangedAttackMob & CrossbowAttackMob> extends Goal {
   ...
   private static enum CrossbowState {
      ...
      // $FF: synthetic method
      private static RangedCrossbowAttackGoal.CrossbowState[] $values() {
         return new RangedCrossbowAttackGoal.CrossbowState[]{UNCHARGED, CHARGING, CHARGED, READY_TO_ATTACK};
      }
   }
}
