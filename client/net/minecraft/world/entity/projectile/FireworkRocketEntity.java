...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
   ...
   public void tick() {
      ...
      if (this.isAttachedToEntity()) {
         ...
         if (this.attachedToEntity != null) {
            if (this.attachedToEntity.isFallFlying()) {
               ...
               this.attachedToEntity.setDeltaMovement(var6.add(var1.field_414 * 0.1D + (var1.field_414 * 1.5D - var6.field_414) * 0.5D, var1.field_415 * 0.1D + (var1.field_415 * 1.5D - var6.field_415) * 0.5D, var1.field_416 * 0.1D + (var1.field_416 * 1.5D - var6.field_416) * 0.5D));
            }
      ...
      if (this.level.isClientSide && this.life % 2 < 2) {
         this.level.addParticle(ParticleTypes.FIREWORK, this.getX(), this.getY() - 0.3D, this.getZ(), this.random.nextGaussian() * 0.05D, -this.getDeltaMovement().field_415 * 0.5D, this.random.nextGaussian() * 0.05D);
      }
   ...
   public void handleEntityEvent(byte var1) {
      if (var1 == 17 && this.level.isClientSide) {
         if (!this.hasExplosion()) {
            ...
            this.level.createFireworks(this.getX(), this.getY(), this.getZ(), var4.field_414, var4.field_415, var4.field_416, var3);
         }
      }
   ...
   public void readAdditionalSaveData(CompoundTag var1) {
      ...
      ItemStack var2 = ItemStack.method_85(var1.getCompound("FireworksItem"));
      if (!var2.isEmpty()) {
