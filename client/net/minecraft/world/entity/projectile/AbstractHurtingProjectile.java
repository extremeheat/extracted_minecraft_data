...
public abstract class AbstractHurtingProjectile extends Projectile {
   ...
   public void tick() {
      ...
      if (this.level.isClientSide || (var1 == null || !var1.isRemoved()) && this.level.hasChunkAt(this.blockPosition())) {
         ...
         double var4 = this.getX() + var3.field_414;
         double var6 = this.getY() + var3.field_415;
         double var8 = this.getZ() + var3.field_416;
         ProjectileUtil.rotateTowardsMovement(this, 0.2F);
         float var10 = this.getInertia();
         if (this.isInWater()) {
            for(int var11 = 0; var11 < 4; ++var11) {
               float var12 = 0.25F;
               this.level.addParticle(ParticleTypes.BUBBLE, var4 - var3.field_414 * 0.25D, var6 - var3.field_415 * 0.25D, var8 - var3.field_416 * 0.25D, var3.field_414, var3.field_415, var3.field_416);
            }
   ...
   public boolean hurt(DamageSource var1, float var2) {
      if (this.isInvulnerableTo(var1)) {
         ...
         if (var3 != null) {
            ...
            this.xPower = var4.field_414 * 0.1D;
            this.yPower = var4.field_415 * 0.1D;
            this.zPower = var4.field_416 * 0.1D;
            this.setOwner(var3);
            return true;
         } else {
            return false;
