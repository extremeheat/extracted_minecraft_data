...
public abstract class AbstractArrow extends Projectile {
      ...
      if (this.inGround && !var1) {
         ...
         if (this.isCritArrow()) {
            for(int var14 = 0; var14 < 4; ++var14) {
               this.level.addParticle(ParticleTypes.CRIT, this.getX() + var30 * (double)var14 / 4.0, this.getY() + var31 * (double)var14 / 4.0, this.getZ() + var12 * (double)var14 / 4.0, -var30, -var31 + 0.2, -var12);
            }
         }
         ...
         if (var1) {
            this.setYRot((float)(Mth.atan2(-var30, -var12) * 57.2957763671875));
         } else {
            this.setYRot((float)(Mth.atan2(var30, var12) * 57.2957763671875));
         }
         ...
         if (this.isInWater()) {
            for(int var24 = 0; var24 < 4; ++var24) {
               float var25 = 0.25F;
               this.level.addParticle(ParticleTypes.BUBBLE, var32 - var30 * 0.25, var16 - var31 * 0.25, var18 - var12 * 0.25, var30, var31, var12);
            }
         ...
         if (!this.isNoGravity() && !var1) {
            ...
            this.setDeltaMovement(var33.x, var33.y - 0.05000000074505806, var33.z);
         }
   ...
   protected void onHitEntity(EntityHitResult var1) {
      ...
      DamageSource var13;
      if (var6 == null) {
         var13 = DamageSource.arrow(this, this);
      } else {
         var13 = DamageSource.arrow(this, var6);
      ...
      if (var2.hurt(var13, (float)var4)) {
         ...
         if (var2 instanceof LivingEntity) {
            ...
            if (!this.level.isClientSide && var6 instanceof ServerPlayer) {
               ServerPlayer var14 = (ServerPlayer)var6;
