...
public class ShulkerBullet extends Projectile {
   ...
   public ShulkerBullet(Level var1, LivingEntity var2, Entity var3, Direction.Axis var4) {
      ...
      this.currentMoveDirection = Direction.field_526;
   ...
   private void selectNextMoveDirection(@Nullable Direction.Axis var1) {
      ...
      if (!var2.closerThan(this.position(), 2.0D)) {
         ...
         if (var1 != Direction.Axis.field_500) {
   ...
   public void tick() {
      ...
      if (!this.level.isClientSide) {
         ...
         if (this.finalTarget == null || !this.finalTarget.isAlive() || this.finalTarget instanceof Player && this.finalTarget.isSpectator()) {
            ...
            this.setDeltaMovement(var1.add((this.targetDeltaX - var1.field_414) * 0.2D, (this.targetDeltaY - var1.field_415) * 0.2D, (this.targetDeltaZ - var1.field_416) * 0.2D));
         }
      ...
      var1 = this.getDeltaMovement();
      this.setPos(this.getX() + var1.field_414, this.getY() + var1.field_415, this.getZ() + var1.field_416);
      ProjectileUtil.rotateTowardsMovement(this, 0.5F);
      if (this.level.isClientSide) {
         this.level.addParticle(ParticleTypes.END_ROD, this.getX() - var1.field_414, this.getY() - var1.field_415 + 0.15D, this.getZ() - var1.field_416, 0.0D, 0.0D, 0.0D);
         ...
         if (this.currentMoveDirection != null) {
            ...
            if (this.level.loadedAndEntityCanStandOn(var2.relative(this.currentMoveDirection), this)) {
               ...
               if (var3 == Direction.Axis.field_500 && var2.getX() == var4.getX() || var3 == Direction.Axis.field_502 && var2.getZ() == var4.getZ() || var3 == Direction.Axis.field_501 && var2.getY() == var4.getY()) {
                  this.selectNextMoveDirection(var3);
               }
            }
         }
