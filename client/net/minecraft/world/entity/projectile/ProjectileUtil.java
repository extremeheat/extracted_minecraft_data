...
public final class ProjectileUtil {
   ...
   public static void rotateTowardsMovement(Entity var0, float var1) {
      ...
      if (var2.lengthSqr() != 0.0D) {
         ...
         var0.setYRot((float)(Mth.atan2(var2.field_416, var2.field_414) * 57.2957763671875D) + 90.0F);
         var0.setXRot((float)(Mth.atan2(var3, var2.field_415) * 57.2957763671875D) - 90.0F);
   ...
   public static InteractionHand getWeaponHoldingHand(LivingEntity var0, Item var1) {
      return var0.getMainHandItem().method_87(var1) ? InteractionHand.MAIN_HAND : InteractionHand.OFF_HAND;
   }
   ...
   public static AbstractArrow getMobArrow(LivingEntity var0, ItemStack var1, float var2) {
      ...
      if (var1.method_87(Items.TIPPED_ARROW) && var4 instanceof Arrow) {
