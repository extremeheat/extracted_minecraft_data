...
public class MobEffectInstance implements Comparable<MobEffectInstance> {
   ...
   public MobEffectInstance(MobEffect var1, int var2, int var3, boolean var4, boolean var5, boolean var6) {
      this(var1, var2, var3, var4, var5, var6, (MobEffectInstance)null, var1.createFactorData());
   }

   public MobEffectInstance(MobEffect var1, int var2, int var3, boolean var4, boolean var5, boolean var6, @Nullable MobEffectInstance var7, Optional<FactorData> var8) {
      super();
      this.effect = var1;
      this.duration = var2;
      this.amplifier = var3;
   ...
   public boolean update(MobEffectInstance var1) {
      ...
      if (var2 != this.duration) {
         this.factorData.ifPresent((var2x) -> {
            var2x.effectChangedTimestamp += this.duration - var2;
         });
         var3 = true;
      }
   ...
   public boolean tick(LivingEntity var1, Runnable var2) {
      ...
      this.factorData.ifPresent((var1x) -> {
         var1x.update(this);
      });
   ...
   private void writeDetailsTo(CompoundTag var1) {
      ...
      this.factorData.ifPresent((var1x) -> {
         DataResult var10000 = MobEffectInstance.FactorData.CODEC.encodeStart(NbtOps.INSTANCE, var1x);
         Logger var10001 = LOGGER;
         Objects.requireNonNull(var10001);
         var10000.resultOrPartial(var10001::error).ifPresent((var1xx) -> {
            var1.put("FactorCalculationData", var1xx);
         });
      });
   }
   ...
   private static MobEffectInstance loadSpecifiedEffect(MobEffect var0, CompoundTag var1) {
      ...
      if (var1.contains("FactorCalculationData", 10)) {
         DataResult var10000 = MobEffectInstance.FactorData.CODEC.parse(new Dynamic(NbtOps.INSTANCE, var1.getCompound("FactorCalculationData")));
         Logger var10001 = LOGGER;
         Objects.requireNonNull(var10001);
         var8 = var10000.resultOrPartial(var10001::error);
      } else {
         var8 = Optional.empty();
      }
   ...
   public static class FactorData {
      public static final Codec<FactorData> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(ExtraCodecs.NON_NEGATIVE_INT.fieldOf("padding_duration").forGetter((var0x) -> {
            return var0x.paddingDuration;
         }), Codec.FLOAT.fieldOf("factor_start").orElse(0.0F).forGetter((var0x) -> {
            return var0x.factorStart;
         }), Codec.FLOAT.fieldOf("factor_target").orElse(1.0F).forGetter((var0x) -> {
            return var0x.factorTarget;
         }), Codec.FLOAT.fieldOf("factor_current").orElse(0.0F).forGetter((var0x) -> {
            return var0x.factorCurrent;
         }), ExtraCodecs.NON_NEGATIVE_INT.fieldOf("effect_changed_timestamp").orElse(0).forGetter((var0x) -> {
            return var0x.effectChangedTimestamp;
         }), Codec.FLOAT.fieldOf("factor_previous_frame").orElse(0.0F).forGetter((var0x) -> {
            return var0x.factorPreviousFrame;
         }), Codec.BOOL.fieldOf("had_effect_last_tick").orElse(false).forGetter((var0x) -> {
            return var0x.hadEffectLastTick;
         })).apply(var0, FactorData::new);
      });
