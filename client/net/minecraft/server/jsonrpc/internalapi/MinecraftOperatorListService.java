...
public class MinecraftOperatorListService {
   private final MinecraftServer minecraftServer;
   private final JsonRpcLogger jsonrpcLogger;

   public MinecraftOperatorListService(MinecraftServer var1, JsonRpcLogger var2) {
      super();
   ...
   public void op(NameAndId var1, Optional<Integer> var2, Optional<Boolean> var3, ClientInfo var4) {
      this.jsonrpcLogger.log(var4, "Op '{}'", var1);
      this.minecraftServer.getPlayerList().op(var1, var2, var3);
   }
