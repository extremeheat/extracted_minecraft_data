...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage {
   ...
   protected void func_71237_c(String var1) {
      if (this.func_71254_M().func_75801_b(var1)) {
         ...
         this.func_71254_M().func_75805_a(var1, new MinecraftServer$1(this));
      }
   }
      ...
      for(int var10 = 0; var10 < this.field_71305_c.length; ++var10) {
         ...
         if (var10 == 0) {
            if (this.func_71242_L()) {
               this.field_71305_c[var10] = new DemoWorldServer(this, var7, var2, var11, this.field_71304_b);
            } else {
               this.field_71305_c[var10] = new WorldServer(this, var7, var2, var11, var8, this.field_71304_b);
            }
         } else {
            this.field_71305_c[var10] = new WorldServerMulti(this, var7, var2, var11, var8, this.field_71305_c[0], this.field_71304_b);
         }
   ...
   protected void func_71267_a(boolean var1) {
      if (!this.field_71290_O) {
         for(WorldServer var5 : this.field_71305_c) {
            if (var5 != null) {
               if (!var1) {
   ...
   public void func_71190_q() {
      ...
      for(int var1 = 0; var1 < this.field_71305_c.length; ++var1) {
         ...
         if (var1 == 0 || this.func_71255_r()) {
            ...
            if (this.field_71315_w % 20 == 0) {
               ...
               this.field_71318_t
                  .func_148537_a(
                     new S03PacketTimeUpdate(var4.func_82737_E(), var4.func_72820_D(), var4.func_82736_K().func_82766_b("doDaylightCycle")),
                     var4.field_73011_w.field_76574_g
                  );
               this.field_71304_b.func_76319_b();
            }
            ...
            try {
               ...
               CrashReport var6 = CrashReport.func_85055_a(var8, "Exception ticking world");
            ...
            try {
               ...
               CrashReport var10 = CrashReport.func_85055_a(var7, "Exception ticking world entities");
               var4.func_72914_a(var10);
      ...
      for(int var9 = 0; var9 < this.field_71322_p.size(); ++var9) {
         ((IUpdatePlayerListBox)this.field_71322_p.get(var9)).func_73660_a();
      }
   ...
   public CrashReport func_71230_b(CrashReport var1) {
      var1.func_85056_g().func_71500_a("Profiler Position", new MinecraftServer$4(this));
      if (this.field_71305_c != null && this.field_71305_c.length > 0 && this.field_71305_c[0] != null) {
         var1.func_85056_g().func_71500_a("Vec3 Pool Size", new MinecraftServer$5(this));
      }

      if (this.field_71318_t != null) {
         var1.func_85056_g().func_71500_a("Player Count", new MinecraftServer$6(this));
      }

      return var1;
   }

   public List func_71248_a(ICommandSender var1, String var2) {
      ArrayList var3 = new ArrayList();
      if (var2.startsWith("/")) {
         var2 = var2.substring(1);
         boolean var11 = !var2.contains(" ");
         List var12 = this.field_71321_q.func_71558_b(var1, var2);
         if (var12 != null) {
         ...
         for(String var9 : this.field_71318_t.func_72369_d()) {
   ...
   public void func_70000_a(PlayerUsageSnooper var1) {
      ...
      var1.func_152768_a("avg_tick_ms", (int)(MathHelper.func_76127_a(this.field_71311_j) * 1.0E-6));
      int var2 = 0;
      ...
      for(int var3 = 0; var3 < this.field_71305_c.length; ++var3) {
         if (this.field_71305_c[var3] != null) {
            ...
            var1.func_152768_a("world[" + var2 + "][dimension]", var4.field_73011_w.field_76574_g);
            var1.func_152768_a("world[" + var2 + "][mode]", var5.func_76077_q());
            var1.func_152768_a("world[" + var2 + "][difficulty]", var4.field_73013_u);
