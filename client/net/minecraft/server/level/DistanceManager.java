...
public abstract class DistanceManager {
   ...
   protected DistanceManager(Executor var1, Executor var2) {
      ...
      ProcessorHandle var3 = ProcessorHandle.method_1("player ticket throttler", var2::execute);
   ...
   public boolean inEntityTickingRange(long var1) {
      return this.tickingTicketsTracker.getLevel(var1) < 32;
   }

   public boolean inBlockTickingRange(long var1) {
      return this.tickingTicketsTracker.getLevel(var1) < 33;
   }
         ...
         try {
            ...
            while(var3.hasNext()) {
               ...
               while(var6.hasNext()) {
                  ...
                  int var10001 = var5.field_504;
                  var2.write((var10001 + "\t" + var5.field_505 + "\t" + var7.getType() + "\t" + var7.getTicketLevel() + "\t\n").getBytes(StandardCharsets.UTF_8));
               }
            }
         ...
         try {
            ...
            try {
               ...
               while(var3.hasNext()) {
                  ...
                  var2.write((var5.field_504 + "\t" + var5.field_505 + "\t" + var6 + "\n").getBytes(StandardCharsets.UTF_8));
               }
            } catch (Throwable var8) {
               try {
                  var2.close();
