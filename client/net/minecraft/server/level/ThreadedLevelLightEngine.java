...
public class ThreadedLevelLightEngine extends LevelLightEngine implements AutoCloseable {
   ...
   protected void updateChunkStatus(ChunkPos var1) {
      this.addTask(var1.field_504, var1.field_505, () -> {
         return 0;
         ...
         for(var2 = this.getMinLightSection(); var2 < this.getMaxLightSection(); ++var2) {
            super.queueSectionData(LightLayer.BLOCK, SectionPos.method_72(var1, var2), (DataLayer)null, true);
            super.queueSectionData(LightLayer.SKY, SectionPos.method_72(var1, var2), (DataLayer)null, true);
         }

         for(var2 = this.levelHeightAccessor.getMinSection(); var2 < this.levelHeightAccessor.getMaxSection(); ++var2) {
            super.updateSectionStatus(SectionPos.method_72(var1, var2), true);
         }
   ...
   public void updateSectionStatus(SectionPos var1, boolean var2) {
      this.addTask(var1.method_78(), var1.method_80(), () -> {
         return 0;
      }, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> {
   ...
   public void enableLightSources(ChunkPos var1, boolean var2) {
      this.addTask(var1.field_504, var1.field_505, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> {
   ...
   public void queueSectionData(LightLayer var1, SectionPos var2, @Nullable DataLayer var3, boolean var4) {
      this.addTask(var2.method_78(), var2.method_80(), () -> {
         return 0;
      }, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> {
   ...
   public CompletableFuture<ChunkAccess> lightChunk(ChunkAccess var1, boolean var2) {
      ...
      this.addTask(var3.field_504, var3.field_505, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> {
         ...
         for(int var5 = 0; var5 < var1.getSectionsCount(); ++var5) {
            ...
            if (!var6.hasOnlyAir()) {
               ...
               super.updateSectionStatus(SectionPos.method_72(var3, var7), false);
            }
         }
      ...
      return CompletableFuture.supplyAsync(() -> {
         ...
         this.addTask(var3.field_504, var3.field_505, ThreadedLevelLightEngine.TaskType.POST_UPDATE, var2x);
      });
   }
   ...
   static enum TaskType {
      ...
      // $FF: synthetic method
      private static ThreadedLevelLightEngine.TaskType[] $values() {
         return new ThreadedLevelLightEngine.TaskType[]{PRE_UPDATE, POST_UPDATE};
      }
   }
}
