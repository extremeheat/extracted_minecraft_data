...
public class ServerChunkCache extends ChunkSource {
   ...
   public ServerChunkCache(ServerLevel var1, LevelStorageSource.LevelStorageAccess var2, DataFixer var3, StructureManager var4, Executor var5, ChunkGenerator var6, int var7, int var8, boolean var9, ChunkProgressListener var10, ChunkStatusUpdateListener var11, Supplier<DimensionDataStorage> var12) {
      super();
      this.level = var1;
         ...
         while(true) {
            ...
            do {
               do {
                  ...
                  ServerChunkCache.ChunkAndHolder var20 = (ServerChunkCache.ChunkAndHolder)var19.next();
                  var16 = var20.chunk;
                  var17 = var16.getPos();
               } while(!this.level.isPositionEntityTicking(var17));
   ...
   public void onLightUpdate(LightLayer var1, SectionPos var2) {
      this.mainThreadProcessor.execute(() -> {
         ...
         if (var3 != null) {
            var3.sectionLightChanged(var1, var2.method_79());
         }
   ...
   public void move(ServerPlayer var1) {
      if (var1.isRemoved()) {
         LOGGER.info("Skipping update from removed player '{}'", var1);
      } else {
