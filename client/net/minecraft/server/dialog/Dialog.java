...
public interface Dialog {
   ...
   Codec<Holder<Dialog>> CODEC = RegistryCodecs.holder(Registries.DIALOG, DIRECT_CODEC);
   Codec<HolderSet<Dialog>> LIST_CODEC = RegistryCodecs.holderSet(Registries.DIALOG, DIRECT_CODEC);
