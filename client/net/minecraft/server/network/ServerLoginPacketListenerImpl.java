...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener {
         ...
         if (this.server.getCompressionThreshold() >= 0 && !this.connection.isMemoryConnection()) {
            this.connection
               .send(
                  ...
                  (ChannelFutureListener)var1x -> this.connection.setupCompression(this.server.getCompressionThreshold(), true)
               );
         }
   ...
   @Nullable
   private static ProfilePublicKey validatePublicKey(ServerboundHelloPacket var0, SignatureValidator var1, boolean var2) throws ServerLoginPacketListenerImpl.PublicKeyParseException {
      try {
