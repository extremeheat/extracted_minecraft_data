...
public class LegacyTextFilter extends ServerTextFilter {
   ...
   private LegacyTextFilter(
      ...
      URL var3,
      LegacyTextFilter.JoinOrLeaveEncoder var4,
      URL var5,
      LegacyTextFilter.JoinOrLeaveEncoder var6,
      String var7,
      ServerTextFilter.IgnoreStrategy var8,
   ...
   public static ServerTextFilter createTextFilterFromConfig(String var0) {
      try {
         ...
         if (var3.isEmpty()) {
            ...
            LegacyTextFilter.JoinOrLeaveEncoder var15 = var2x -> {
   ...
   void processJoinOrLeave(GameProfile var1, URL var2, LegacyTextFilter.JoinOrLeaveEncoder var3, Executor var4) {
      var4.execute(() -> {
   ...
   protected FilteredText filterText(String var1, ServerTextFilter.IgnoreStrategy var2, JsonObject var3) {
      ...
      if (var4) {
         ...
         String var5 = GsonHelper.getAsString(var3, "hashed", null);
         if (var5 == null) {
