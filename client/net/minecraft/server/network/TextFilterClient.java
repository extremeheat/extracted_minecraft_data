...
public class TextFilterClient implements AutoCloseable {
   ...
   private TextFilterClient(URL var1, MessageEncoder var2, URL var3, JoinOrLeaveEncoder var4, URL var5, JoinOrLeaveEncoder var6, String var7, IgnoreStrategy var8, int var9) {
      super();
      this.authKey = var7;
      ...
      if (Strings.isNullOrEmpty(var0)) {
         ...
         try {
            ...
            if (var3.isEmpty()) {
               ...
               IgnoreStrategy var20 = TextFilterClient.IgnoreStrategy.select(var7);
      ...
      return var2.isEmpty() ? CompletableFuture.completedFuture(FilteredText.EMPTY) : CompletableFuture.supplyAsync(() -> {
         ...
         try {
            ...
            if (var6) {
               ...
               String var7 = GsonHelper.getAsString(var5, "hashed", (String)null);
               if (var7 == null) {
   ...
   class PlayerContext implements TextFilter {
      ...
      PlayerContext(final GameProfile var2) {
         super();
         this.profile = var2;
