         ...
         if (var3.readUnsignedByte() == 254) {
            ...
            switch (var7) {
               case 0:
                  ...
                  var8 = String.format(Locale.ROOT, "%s\u00a7%d\u00a7%d", var6.getMotd(), var6.getPlayerCount(), var6.getMaxPlayers());
               ...
               case 1:
                  ...
                  var8 = String.format(Locale.ROOT, "\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, var6.getServerVersion(), var6.getMotd(), var6.getPlayerCount(), var6.getMaxPlayers());
                  this.sendFlushAndClose(var1, this.createReply(var8));
                  break;
               default:
                  ...
                  String var10 = String.format(Locale.ROOT, "\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, var6.getServerVersion(), var6.getMotd(), var6.getPlayerCount(), var6.getMaxPlayers());
