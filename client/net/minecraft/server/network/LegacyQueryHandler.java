         ...
         try {
            ...
            switch(var7) {
               case 0:
                  ...
                  String var23 = String.format(Locale.ROOT, "%s\u00a7%d\u00a7%d", var6.getMotd(), var6.getPlayerCount(), var6.getMaxPlayers());
                  this.sendFlushAndClose(var1, this.createReply(var23));
                  break;
               case 1:
               ...
               default:
                  ...
                  var24 &= "MC|PingHost".equals(new String(var3.readBytes(var3.readShort() * 2).array(), StandardCharsets.UTF_16BE));
