...
public class PlayerSafetyServiceTextFilter extends ServerTextFilter {
   ...
   private PlayerSafetyServiceTextFilter(
      URL var1,
      ServerTextFilter.MessageEncoder var2,
      ServerTextFilter.IgnoreStrategy var3,
      ExecutorService var4,
      ConfidentialClientApplication var5,
      ClientCredentialParameters var6,
      Set<String> var7,
      int var8
   ) {
   ...
   public static ServerTextFilter createTextFilterFromConfig(String var0) {
      ...
      ServerTextFilter.MessageEncoder var17 = (var2x, var3x) -> {
         ...
         var4x.addProperty("userId", var2x.getId().toString());
         var4x.addProperty("userDisplayName", var2x.getName());
         var4x.addProperty("server", var5);
         var4x.addProperty("room", var8);
         var4x.addProperty("area", "JavaChatRealms");
         var4x.addProperty("data", var3x);
         var4x.addProperty("language", "*");
         return var4x;
      };
      ...
      try (InputStream var21 = Files.newInputStream(Path.of(var9))) {
      ...
      try {
         var29 = ((Builder)((Builder)ConfidentialClientApplication.builder(var6, var20).sendX5c(true).executorService(var19))
               .authority(String.format(Locale.ROOT, "https://login.microsoftonline.com/%s/", var7)))
            .build();
   ...
   protected FilteredText filterText(String var1, ServerTextFilter.IgnoreStrategy var2, JsonObject var3) {
      JsonObject var4 = GsonHelper.getAsJsonObject(var3, "result", null);
      if (var4 == null) {
