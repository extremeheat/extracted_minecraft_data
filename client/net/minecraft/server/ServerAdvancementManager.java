...
public class ServerAdvancementManager extends SimpleJsonResourceReloadListener {
   ...
   protected void apply(Map<ResourceLocation, JsonElement> var1, ResourceManager var2, ProfilerFiller var3) {
      ...
      var1.forEach((var3x, var4x) -> {
         try {
            ...
            LOGGER.error("Parsing error loading custom advancement {}: {}", var3x, var6.getMessage());
         }
      ...
      Iterator var7 = var6.roots().iterator();

      while(var7.hasNext()) {
         AdvancementNode var8 = (AdvancementNode)var7.next();
   ...
   private void validate(ResourceLocation var1, Advancement var2) {
      ...
      if (!var4.isEmpty()) {
         String var5 = (String)var4.asMap().entrySet().stream().map((var0) -> {
