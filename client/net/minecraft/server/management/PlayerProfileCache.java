...
public class PlayerProfileCache {
   ...
   private void func_152651_a(GameProfile var1, Date var2) {
      ...
      PlayerProfileCache.ProfileEntry var6 = new PlayerProfileCache.ProfileEntry(var1, var2);
      if (this.field_152662_d.containsKey(var3)) {
         PlayerProfileCache.ProfileEntry var5 = (PlayerProfileCache.ProfileEntry)this.field_152662_d.get(var3);
         this.field_152661_c.remove(var5.func_152668_a().getName().toLowerCase(Locale.ROOT));
         this.field_152663_e.remove(var1);
      }

      this.field_152661_c.put(var1.getName().toLowerCase(Locale.ROOT), var6);
   ...
   public GameProfile func_152655_a(String var1) {
      ...
      if (var3 != null) {
         ...
         var4 = func_187319_a(this.field_187323_g, var2);
         if (var4 != null) {
   ...
   public void func_152657_b() {
      ...
      try {
         var1 = Files.newReader(this.field_152665_g, StandardCharsets.UTF_8);
         List var2 = (List)JsonUtils.func_193841_a(this.field_152660_b, var1, field_152666_h);
   ...
   public void func_152658_c() {
      ...
      try {
         var2 = Files.newWriter(this.field_152665_g, StandardCharsets.UTF_8);
         var2.write(var1);
         return;
         ...
         if (var1.isJsonObject()) {
            ...
            if (var5 != null && var6 != null) {
               ...
               if (var9 != null && var8 != null) {
                  ...
                  return PlayerProfileCache.this.new ProfileEntry(new GameProfile(var11, var9), var10);
               } else {
                  return null;
               }
            } else {
