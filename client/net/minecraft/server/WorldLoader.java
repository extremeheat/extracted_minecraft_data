...
public class WorldLoader {
   ...
   public static <D, R> CompletableFuture<R> load(InitConfig var0, WorldDataSupplier<D> var1, ResultFactory<D, R> var2, Executor var3, Executor var4) {
      try {
         ...
         return ReloadableServerResources.loadResources(var6, var9, var0.commandSelection(), var0.functionCompilationLevel(), var3, var4).whenComplete((var1x, var2x) -> {
            if (var2x != null) {
               var6.close();
            }
            ...
            return var2.create(var6, var4x, var9, var8);
         }, var4);
   ...
   public static record InitConfig(PackConfig a, Commands.CommandSelection b, int c) {
