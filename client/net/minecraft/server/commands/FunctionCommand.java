...
public class FunctionCommand {
   private static final DynamicCommandExceptionType ERROR_ARGUMENT_NOT_COMPOUND = new DynamicCommandExceptionType(
      var0 -> Component.translatableEscape("commands.function.error.argument_not_compound", var0)
   );
   static final DynamicCommandExceptionType ERROR_NO_FUNCTIONS = new DynamicCommandExceptionType(
      var0 -> Component.translatableEscape("commands.function.scheduled.no_functions", var0)
   );
   @VisibleForTesting
   public static final Dynamic2CommandExceptionType ERROR_FUNCTION_INSTANTATION_FAILURE = new Dynamic2CommandExceptionType(
      (var0, var1) -> Component.translatableEscape("commands.function.instantiationFailure", var0, var1)
   );
   ...
   public static <T extends ExecutionCommandSource<T>> void queueFunctions(
      Collection<CommandFunction<T>> var0,
      @Nullable CompoundTag var1,
      T var2,
      T var3,
      ExecutionControl<T> var4,
      FunctionCommand.Callbacks<T> var5,
      ChainModifiers var6
   ) throws CommandSyntaxException {
      if (var6.isReturn()) {
         queueFunctionsAsReturn(var0, var1, (T)var2, (T)var3, var4, var5);
      } else {
         queueFunctionsNoReturn(var0, var1, (T)var2, (T)var3, var4, var5);
      }
   }

   private static <T extends ExecutionCommandSource<T>> void instantiateAndQueueFunctions(
      @Nullable CompoundTag var0,
      ExecutionControl<T> var1,
      CommandDispatcher<T> var2,
      T var3,
      CommandFunction<T> var4,
      ResourceLocation var5,
      CommandResultCallback var6,
      boolean var7
   ) throws CommandSyntaxException {
      try {
   ...
   private static <T extends ExecutionCommandSource<T>> CommandResultCallback decorateOutputIfNeeded(
      T var0, FunctionCommand.Callbacks<T> var1, ResourceLocation var2, CommandResultCallback var3
   ) {
   ...
   private static <T extends ExecutionCommandSource<T>> void queueFunctionsAsReturn(
      Collection<CommandFunction<T>> var0, @Nullable CompoundTag var1, T var2, T var3, ExecutionControl<T> var4, FunctionCommand.Callbacks<T> var5
   ) throws CommandSyntaxException {
   ...
   abstract static class FunctionCustomExecutor
      ...
      public void runGuarded(CommandSourceStack var1, ContextChain<CommandSourceStack> var2, ChainModifiers var3, ExecutionControl<CommandSourceStack> var4) throws CommandSyntaxException {
         ...
         if (var7.isEmpty()) {
            ...
            if (var7.size() == 1) {
               var1.sendSuccess(
                  () -> Component.translatable("commands.function.scheduled.single", Component.translationArg(((CommandFunction)var7.iterator().next()).id())),
                  true
               );
            } else {
               var1.sendSuccess(
                  () -> Component.translatable(
                        ...
                        ComponentUtils.formatList(var7.stream().map(CommandFunction::id).toList(), Component::translationArg)
                     ),
                  true
               );
            }
