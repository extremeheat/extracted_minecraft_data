...
public class ExperienceCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      LiteralCommandNode var1 = var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("experience").requires(Commands.hasPermission(2))).then(Commands.literal("add").then(Commands.argument("target", EntityArgument.players()).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("amount", IntegerArgumentType.integer()).executes((var0x) -> addExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "target"), IntegerArgumentType.getInteger(var0x, "amount"), ExperienceCommand.Type.POINTS))).then(Commands.literal("points").executes((var0x) -> addExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "target"), IntegerArgumentType.getInteger(var0x, "amount"), ExperienceCommand.Type.POINTS)))).then(Commands.literal("levels").executes((var0x) -> addExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "target"), IntegerArgumentType.getInteger(var0x, "amount"), ExperienceCommand.Type.LEVELS))))))).then(Commands.literal("set").then(Commands.argument("target", EntityArgument.players()).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("amount", IntegerArgumentType.integer(0)).executes((var0x) -> setExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "target"), IntegerArgumentType.getInteger(var0x, "amount"), ExperienceCommand.Type.POINTS))).then(Commands.literal("points").executes((var0x) -> setExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "target"), IntegerArgumentType.getInteger(var0x, "amount"), ExperienceCommand.Type.POINTS)))).then(Commands.literal("levels").executes((var0x) -> setExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "target"), IntegerArgumentType.getInteger(var0x, "amount"), ExperienceCommand.Type.LEVELS))))))).then(Commands.literal("query").then(((RequiredArgumentBuilder)Commands.argument("target", EntityArgument.player()).then(Commands.literal("points").executes((var0x) -> queryExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayer(var0x, "target"), ExperienceCommand.Type.POINTS)))).then(Commands.literal("levels").executes((var0x) -> queryExperience((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayer(var0x, "target"), ExperienceCommand.Type.LEVELS))))));
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("xp").requires(Commands.hasPermission(2))).redirect(var1));
   }
