...
public class SeedCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, boolean var1) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("seed").requires((var1x) -> {
         ...
         MutableComponent var3 = ComponentUtils.wrapInSquareBrackets(Component.literal(String.valueOf(var1)).withStyle((var2) -> {
            return var2.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, String.valueOf(var1))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.translatable("chat.copy.click"))).withInsertion(String.valueOf(var1));
         }));
