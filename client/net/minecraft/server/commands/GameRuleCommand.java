...
public class GameRuleCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, CommandBuildContext var1) {
      final LiteralArgumentBuilder var2 = (LiteralArgumentBuilder)Commands.literal("gamerule").requires((var0x) -> {
      ...
      (new GameRules(var1.enabledFeatures())).visitGameRuleTypes(new GameRules.GameRuleTypeVisitor() {
         public <T extends GameRules.Value<T>> void visit(GameRules.Key<T> var1, GameRules.Type<T> var2x) {
            ...
            var2.then(((LiteralArgumentBuilder)var3.executes((var1x) -> {
               return GameRuleCommand.queryRule((CommandSourceStack)var1x.getSource(), var1);
            })).then(var2x.createArgument("value").executes((var1x) -> {
               return GameRuleCommand.setRule(var1x, var1);
            })));
         }
      });
      var0.register(var2);
