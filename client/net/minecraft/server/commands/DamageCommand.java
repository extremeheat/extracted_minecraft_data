...
public class DamageCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, CommandBuildContext var1) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("damage").requires(var0x -> var0x.hasPermission(2)))
            .then(
                     ...
                     ((RequiredArgumentBuilder)Commands.argument("amount", FloatArgumentType.floatArg(0.0F))
                           .executes(
                              var0x -> damage(
                                    ...
                                    ((CommandSourceStack)var0x.getSource()).getLevel().damageSources().generic()
                                 )
                           ))
                        .then(
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument(
                                       "damageType", ResourceArgument.resource(var1, Registries.DAMAGE_TYPE)
                                    )
                                    .executes(
                                       var0x -> damage(
                                             (CommandSourceStack)var0x.getSource(),
                                             EntityArgument.getEntity(var0x, "target"),
                                             FloatArgumentType.getFloat(var0x, "amount"),
                                             new DamageSource(ResourceArgument.getResource(var0x, "damageType", Registries.DAMAGE_TYPE))
                                          )
                                    ))
                                 .then(
                                    Commands.literal("at")
                                          ...
                                          Commands.argument("location", Vec3Argument.vec3())
                                             .executes(
                                                var0x -> damage(
                                                      ...
                                                      FloatArgumentType.getFloat(var0x, "amount"),
                                                      new DamageSource(
                                                         ResourceArgument.getResource(var0x, "damageType", Registries.DAMAGE_TYPE),
                                                         Vec3Argument.getVec3(var0x, "location")
                                                      )
                                                   )
                                             )
                                       )
                                       ...
                                       ((RequiredArgumentBuilder)Commands.argument("entity", EntityArgument.entity())
                                             .executes(
                                                var0x -> damage(
                                                      ...
                                                      new DamageSource(
                                                         ResourceArgument.getResource(var0x, "damageType", Registries.DAMAGE_TYPE),
                                                         EntityArgument.getEntity(var0x, "entity")
                                                      )
                                                   )
                                             ))
                                          .then(
                                                      ...
                                                      .executes(
                                                         var0x -> damage(
                                                               ...
                                                               new DamageSource(
                                                                  ResourceArgument.getResource(var0x, "damageType", Registries.DAMAGE_TYPE),
                                                                  EntityArgument.getEntity(var0x, "entity"),
                                                                  EntityArgument.getEntity(var0x, "cause")
                                                               )
                                                            )
                                                      )
                                                )
