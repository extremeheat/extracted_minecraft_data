...
public class ClearInventoryCommands {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, CommandBuildContext var1) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("clear").requires((var0x) -> var0x.hasPermission(2))).executes((var0x) -> clearUnlimited((CommandSourceStack)var0x.getSource(), Collections.singleton(((CommandSourceStack)var0x.getSource()).getPlayerOrException()), (var0) -> true))).then(((RequiredArgumentBuilder)Commands.argument("targets", EntityArgument.players()).executes((var0x) -> clearUnlimited((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), (var0) -> true))).then(((RequiredArgumentBuilder)Commands.argument("item", ItemPredicateArgument.itemPredicate(var1)).executes((var0x) -> clearUnlimited((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ItemPredicateArgument.getItemPredicate(var0x, "item")))).then(Commands.argument("maxCount", IntegerArgumentType.integer(0)).executes((var0x) -> clearInventory((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ItemPredicateArgument.getItemPredicate(var0x, "item"), IntegerArgumentType.getInteger(var0x, "maxCount")))))));
   }
