...
public class PlaySoundCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      RequiredArgumentBuilder var1 = Commands.argument("sound", ResourceLocationArgument.method_50()).suggests(SuggestionProviders.AVAILABLE_SOUNDS);
   ...
   private static int playSound(CommandSourceStack var0, Collection<ServerPlayer> var1, ResourceLocation var2, SoundSource var3, Vec3 var4, float var5, float var6, float var7) throws CommandSyntaxException {
      ...
      while(true) {
         ...
         while(true) {
            ...
            double var13 = var4.field_414 - var12.getX();
            double var15 = var4.field_415 - var12.getY();
            double var17 = var4.field_416 - var12.getZ();
