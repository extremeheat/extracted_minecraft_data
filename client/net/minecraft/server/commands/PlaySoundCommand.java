...
public class PlaySoundCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      RequiredArgumentBuilder var1 = (RequiredArgumentBuilder)Commands.argument("sound", ResourceLocationArgument.id()).suggests(SuggestionProviders.AVAILABLE_SOUNDS).executes((var0x) -> {
         return playSound((CommandSourceStack)var0x.getSource(), getCallingPlayerAsCollection(((CommandSourceStack)var0x.getSource()).getPlayer()), ResourceLocationArgument.getId(var0x, "sound"), SoundSource.MASTER, ((CommandSourceStack)var0x.getSource()).getPosition(), 1.0F, 1.0F, 0.0F);
      });
   ...
   private static LiteralArgumentBuilder<CommandSourceStack> source(SoundSource var0) {
      return (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal(var0.getName()).executes((var1) -> {
         return playSound((CommandSourceStack)var1.getSource(), getCallingPlayerAsCollection(((CommandSourceStack)var1.getSource()).getPlayer()), ResourceLocationArgument.getId(var1, "sound"), var0, ((CommandSourceStack)var1.getSource()).getPosition(), 1.0F, 1.0F, 0.0F);
      ...
      while(true) {
         ...
         while(true) {
            if (!var14.hasNext()) {
               ...
               if (var1.size() == 1) {
                  var0.sendSuccess(() -> {
                     return Component.translatable("commands.playsound.success.single", Component.translationArg(var2), ((ServerPlayer)var1.iterator().next()).getDisplayName());
                  }, true);
               } else {
                  var0.sendSuccess(() -> {
                     return Component.translatable("commands.playsound.success.multiple", Component.translationArg(var2), var1.size());
                  }, true);
               }
