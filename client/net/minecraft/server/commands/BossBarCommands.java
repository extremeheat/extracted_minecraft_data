...
public class BossBarCommands {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      })).then(Commands.literal("add").then(Commands.argument("id", ResourceLocationArgument.method_50()).then(Commands.argument("name", ComponentArgument.textComponent()).executes((var0x) -> {
      ...
      }))))).then(Commands.literal("remove").then(Commands.argument("id", ResourceLocationArgument.method_50()).suggests(SUGGEST_BOSS_BAR).executes((var0x) -> {
      ...
      }))).then(Commands.literal("set").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.method_50()).suggests(SUGGEST_BOSS_BAR).then(Commands.literal("name").then(Commands.argument("name", ComponentArgument.textComponent()).executes((var0x) -> {
      ...
      })))))).then(Commands.literal("get").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.method_50()).suggests(SUGGEST_BOSS_BAR).then(Commands.literal("value").executes((var0x) -> {
