...
public class BossBarCommands {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, CommandBuildContext var1) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("bossbar").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("add").then(Commands.argument("id", ResourceLocationArgument.id()).then(Commands.argument("name", ComponentArgument.textComponent(var1)).executes((var0x) -> createBar((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "id"), ComponentArgument.getResolvedComponent(var0x, "name"))))))).then(Commands.literal("remove").then(Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).executes((var0x) -> removeBar((CommandSourceStack)var0x.getSource(), getBossBar(var0x)))))).then(Commands.literal("list").executes((var0x) -> listBars((CommandSourceStack)var0x.getSource())))).then(Commands.literal("set").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).then(Commands.literal("name").then(Commands.argument("name", ComponentArgument.textComponent(var1)).executes((var0x) -> setName((CommandSourceStack)var0x.getSource(), getBossBar(var0x), ComponentArgument.getResolvedComponent(var0x, "name")))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("color").then(Commands.literal("pink").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.PINK)))).then(Commands.literal("blue").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.BLUE)))).then(Commands.literal("red").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.RED)))).then(Commands.literal("green").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.GREEN)))).then(Commands.literal("yellow").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.YELLOW)))).then(Commands.literal("purple").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.PURPLE)))).then(Commands.literal("white").executes((var0x) -> setColor((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.WHITE))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("style").then(Commands.literal("progress").executes((var0x) -> setStyle((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.PROGRESS)))).then(Commands.literal("notched_6").executes((var0x) -> setStyle((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.NOTCHED_6)))).then(Commands.literal("notched_10").executes((var0x) -> setStyle((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.NOTCHED_10)))).then(Commands.literal("notched_12").executes((var0x) -> setStyle((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.NOTCHED_12)))).then(Commands.literal("notched_20").executes((var0x) -> setStyle((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.NOTCHED_20))))).then(Commands.literal("value").then(Commands.argument("value", IntegerArgumentType.integer(0)).executes((var0x) -> setValue((CommandSourceStack)var0x.getSource(), getBossBar(var0x), IntegerArgumentType.getInteger(var0x, "value")))))).then(Commands.literal("max").then(Commands.argument("max", IntegerArgumentType.integer(1)).executes((var0x) -> setMax((CommandSourceStack)var0x.getSource(), getBossBar(var0x), IntegerArgumentType.getInteger(var0x, "max")))))).then(Commands.literal("visible").then(Commands.argument("visible", BoolArgumentType.bool()).executes((var0x) -> setVisible((CommandSourceStack)var0x.getSource(), getBossBar(var0x), BoolArgumentType.getBool(var0x, "visible")))))).then(((LiteralArgumentBuilder)Commands.literal("players").executes((var0x) -> setPlayers((CommandSourceStack)var0x.getSource(), getBossBar(var0x), Collections.emptyList()))).then(Commands.argument("targets", EntityArgument.players()).executes((var0x) -> setPlayers((CommandSourceStack)var0x.getSource(), getBossBar(var0x), EntityArgument.getOptionalPlayers(var0x, "targets")))))))).then(Commands.literal("get").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).then(Commands.literal("value").executes((var0x) -> getValue((CommandSourceStack)var0x.getSource(), getBossBar(var0x))))).then(Commands.literal("max").executes((var0x) -> getMax((CommandSourceStack)var0x.getSource(), getBossBar(var0x))))).then(Commands.literal("visible").executes((var0x) -> getVisible((CommandSourceStack)var0x.getSource(), getBossBar(var0x))))).then(Commands.literal("players").executes((var0x) -> getPlayers((CommandSourceStack)var0x.getSource(), getBossBar(var0x)))))));
   }
