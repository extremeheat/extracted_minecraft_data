...
public class BossBarCommands {
   private static final DynamicCommandExceptionType ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType(
      var0 -> Component.translatableEscape("commands.bossbar.create.failed", var0)
   );
   private static final DynamicCommandExceptionType ERROR_DOESNT_EXIST = new DynamicCommandExceptionType(
      var0 -> Component.translatableEscape("commands.bossbar.unknown", var0)
   );
   ...
   public static final SuggestionProvider<CommandSourceStack> SUGGEST_BOSS_BAR = (var0, var1) -> SharedSuggestionProvider.suggestResource(
         ((CommandSourceStack)var0.getSource()).getServer().getCustomBossEvents().getIds(), var1
      );
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal(
                        ...
                        Commands.literal("remove")
                           .then(
                              Commands.argument("id", ResourceLocationArgument.id())
                                 ...
                                 .executes(var0x -> removeBar((CommandSourceStack)var0x.getSource(), getBossBar(var0x)))
                           )
                     ))
                  .then(Commands.literal("list").executes(var0x -> listBars((CommandSourceStack)var0x.getSource()))))
               .then(
                  Commands.literal("set")
                     .then(
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument(
                                                "id", ResourceLocationArgument.id()
                                             )
                                             .suggests(SUGGEST_BOSS_BAR)
                                             .then(
                                             ...
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal(
                                                         ...
                                                         .then(
                                                            Commands.literal("green")
                                                               .executes(
                                                                  var0x -> setColor(
                                                                        (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.GREEN
                                                                     )
                                                               )
                                                         ))
                                                      .then(
                                                         Commands.literal("yellow")
                                                            .executes(
                                                               var0x -> setColor(
                                                                     (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.YELLOW
                                                                  )
                                                            )
                                                      ))
                                                   .then(
                                                      Commands.literal("purple")
                                                         .executes(
                                                            var0x -> setColor(
                                                                  (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.PURPLE
                                                               )
                                                         )
                                                   ))
                                                .then(
                                                   Commands.literal("white")
                                                      .executes(
                                                         var0x -> setColor(
                                                               (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarColor.WHITE
                                                            )
                                                      )
                                                )
                                          ))
                                          ...
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal(
                                                ...
                                                .then(
                                                   Commands.literal("notched_12")
                                                      .executes(
                                                         var0x -> setStyle(
                                                               (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.NOTCHED_12
                                                            )
                                                      )
                                                ))
                                             .then(
                                                Commands.literal("notched_20")
                                                   .executes(
                                                      var0x -> setStyle(
                                                            (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BossEvent.BossBarOverlay.NOTCHED_20
                                                         )
                                                   )
                                             )
                                       ))
                                    ...
                                    Commands.literal("max")
                                       .then(
                                          Commands.argument("max", IntegerArgumentType.integer(1))
                                             .executes(
                                                var0x -> setMax(
                                                      (CommandSourceStack)var0x.getSource(), getBossBar(var0x), IntegerArgumentType.getInteger(var0x, "max")
                                                   )
                                             )
                                       )
                                 ))
                                 ...
                                 Commands.literal("visible")
                                    .then(
                                       Commands.argument("visible", BoolArgumentType.bool())
                                          .executes(
                                             var0x -> setVisible(
                                                   (CommandSourceStack)var0x.getSource(), getBossBar(var0x), BoolArgumentType.getBool(var0x, "visible")
                                                )
                                          )
                                    )
                              ))
                           .then(
                              ((LiteralArgumentBuilder)Commands.literal("players")
                                    .executes(var0x -> setPlayers((CommandSourceStack)var0x.getSource(), getBossBar(var0x), Collections.emptyList())))
                                 .then(
                                    Commands.argument("targets", EntityArgument.players())
                                       .executes(
                                          var0x -> setPlayers(
                                                (CommandSourceStack)var0x.getSource(), getBossBar(var0x), EntityArgument.getOptionalPlayers(var0x, "targets")
                                             )
                                       )
                                 )
                           )
            ...
            .then(
               Commands.literal("get")
                  .then(
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.id())
                                 .suggests(SUGGEST_BOSS_BAR)
                                 .then(Commands.literal("value").executes(var0x -> getValue((CommandSourceStack)var0x.getSource(), getBossBar(var0x)))))
                              .then(Commands.literal("max").executes(var0x -> getMax((CommandSourceStack)var0x.getSource(), getBossBar(var0x)))))
                           .then(Commands.literal("visible").executes(var0x -> getVisible((CommandSourceStack)var0x.getSource(), getBossBar(var0x)))))
                        .then(Commands.literal("players").executes(var0x -> getPlayers((CommandSourceStack)var0x.getSource(), getBossBar(var0x))))
                  )
            )
      );
   }
