                                    ...
                                    ((RequiredArgumentBuilder)Commands.argument("facingEntity", EntityArgument.entity())
                                          .executes(
                                             var0x -> rotate(
                                                   (CommandSourceStack)var0x.getSource(),
                                                   EntityArgument.getEntity(var0x, "target"),
                                                   new LookAt.LookAtEntity(EntityArgument.getEntity(var0x, "facingEntity"), EntityAnchorArgument.Anchor.FEET)
                                                )
                                          ))
                                       .then(
                                             ...
                                             .executes(
                                                var0x -> rotate(
                                                      ...
                                                      new LookAt.LookAtEntity(
                                                         EntityArgument.getEntity(var0x, "facingEntity"), EntityAnchorArgument.getAnchor(var0x, "facingAnchor")
                                                      )
                                                   )
                                             )
                                       )
