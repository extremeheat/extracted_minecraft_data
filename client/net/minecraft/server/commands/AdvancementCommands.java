...
public class AdvancementCommands {
   ...
   private static int perform(CommandSourceStack var0, Collection<ServerPlayer> var1, Action var2, Collection<Advancement> var3) {
      int var4 = 0;
      ...
      if (var4 == 0) {
         if (var3.size() == 1) {
            if (var1.size() == 1) {
               throw new CommandRuntimeException(Component.translatable(var2.getKey() + ".one.to.one.failure", ((Advancement)var3.iterator().next()).getChatComponent(), ((ServerPlayer)var1.iterator().next()).getDisplayName()));
            } else {
               throw new CommandRuntimeException(Component.translatable(var2.getKey() + ".one.to.many.failure", ((Advancement)var3.iterator().next()).getChatComponent(), var1.size()));
            }
         } else if (var1.size() == 1) {
            throw new CommandRuntimeException(Component.translatable(var2.getKey() + ".many.to.one.failure", var3.size(), ((ServerPlayer)var1.iterator().next()).getDisplayName()));
         } else {
         ...
         if (var3.size() == 1) {
            if (var1.size() == 1) {
               var0.sendSuccess(Component.translatable(var2.getKey() + ".one.to.one.success", ((Advancement)var3.iterator().next()).getChatComponent(), ((ServerPlayer)var1.iterator().next()).getDisplayName()), true);
            } else {
               var0.sendSuccess(Component.translatable(var2.getKey() + ".one.to.many.success", ((Advancement)var3.iterator().next()).getChatComponent(), var1.size()), true);
            }
         } else if (var1.size() == 1) {
   ...
   private static int performCriterion(CommandSourceStack var0, Collection<ServerPlayer> var1, Action var2, Advancement var3, String var4) {
      int var5 = 0;
      if (!var3.getCriteria().containsKey(var4)) {
         ...
         if (var5 == 0) {
            if (var1.size() == 1) {
               throw new CommandRuntimeException(Component.translatable(var2.getKey() + ".criterion.to.one.failure", var4, var3.getChatComponent(), ((ServerPlayer)var1.iterator().next()).getDisplayName()));
            } else {
               throw new CommandRuntimeException(Component.translatable(var2.getKey() + ".criterion.to.many.failure", var4, var3.getChatComponent(), var1.size()));
            }
         } else {
            if (var1.size() == 1) {
               var0.sendSuccess(Component.translatable(var2.getKey() + ".criterion.to.one.success", var4, var3.getChatComponent(), ((ServerPlayer)var1.iterator().next()).getDisplayName()), true);
            } else {
   ...
   private static List<Advancement> getAdvancements(Advancement var0, Mode var1) {
