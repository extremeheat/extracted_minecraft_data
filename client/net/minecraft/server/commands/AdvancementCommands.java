...
public class AdvancementCommands {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      })).then(Commands.literal("grant").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("targets", EntityArgument.players()).then(Commands.literal("only").then(((RequiredArgumentBuilder)Commands.argument("advancement", ResourceLocationArgument.method_50()).suggests(SUGGEST_ADVANCEMENTS).executes((var0x) -> {
      ...
      }))))).then(Commands.literal("from").then(Commands.argument("advancement", ResourceLocationArgument.method_50()).suggests(SUGGEST_ADVANCEMENTS).executes((var0x) -> {
      ...
      })))).then(Commands.literal("until").then(Commands.argument("advancement", ResourceLocationArgument.method_50()).suggests(SUGGEST_ADVANCEMENTS).executes((var0x) -> {
      ...
      })))).then(Commands.literal("through").then(Commands.argument("advancement", ResourceLocationArgument.method_50()).suggests(SUGGEST_ADVANCEMENTS).executes((var0x) -> {
      ...
      }))))).then(Commands.literal("revoke").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("targets", EntityArgument.players()).then(Commands.literal("only").then(((RequiredArgumentBuilder)Commands.argument("advancement", ResourceLocationArgument.method_50()).suggests(SUGGEST_ADVANCEMENTS).executes((var0x) -> {
