...
public class StorageDataAccessor implements DataAccessor {
   ...
   public static final Function<String, DataCommands.DataProvider> PROVIDER = (var0) -> {
      return new DataCommands.DataProvider() {
         ...
         public ArgumentBuilder<CommandSourceStack, ?> wrap(ArgumentBuilder<CommandSourceStack, ?> var1, Function<ArgumentBuilder<CommandSourceStack, ?>, ArgumentBuilder<CommandSourceStack, ?>> var2) {
            return var1.then(Commands.literal("storage").then((ArgumentBuilder)var2.apply(Commands.argument(var0, ResourceLocationArgument.method_50()).suggests(StorageDataAccessor.SUGGEST_STORAGE))));
         }
      };
   };
   private final CommandStorage storage;
   // $FF: renamed from: id net.minecraft.resources.ResourceLocation
   private final ResourceLocation field_231;
   ...
   public void setData(CompoundTag var1) {
      this.storage.set(this.field_231, var1);
   }

   public CompoundTag getData() {
      return this.storage.get(this.field_231);
   }

   public Component getModifiedSuccess() {
      return new TranslatableComponent("commands.data.storage.modified", new Object[]{this.field_231});
   }

   public Component getPrintSuccess(Tag var1) {
      return new TranslatableComponent("commands.data.storage.query", new Object[]{this.field_231, NbtUtils.toPrettyComponent(var1)});
   }

   public Component getPrintSuccess(NbtPathArgument.NbtPath var1, double var2, int var4) {
      return new TranslatableComponent("commands.data.storage.get", new Object[]{var1, this.field_231, String.format(Locale.ROOT, "%.2f", var2), var4});
   }
}
