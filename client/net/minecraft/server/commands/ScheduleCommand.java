...
public class ScheduleCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("schedule").requires(var0x -> var0x.hasPermission(2)))
               .then(
               ...
               Commands.literal("clear")
                  .then(
                     Commands.argument("function", StringArgumentType.greedyString())
                        ...
                        .executes(var0x -> remove((CommandSourceStack)var0x.getSource(), StringArgumentType.getString(var0x, "function")))
                  )
            )
      );
   }
