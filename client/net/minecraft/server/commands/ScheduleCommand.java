...
public class ScheduleCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_CANT_REMOVE = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.schedule.cleared.failure", var0);
   });
   ...
   private static int schedule(CommandSourceStack var0, Pair<ResourceLocation, Either<CommandFunction, Collection<CommandFunction>>> var1, int var2, boolean var3) throws CommandSyntaxException {
      if (var2 == 0) {
