...
public class TimeCommand {
   ...
   private static int queryTime(CommandSourceStack var0, int var1) {
      var0.sendSuccess(new TranslatableComponent("commands.time.query", new Object[]{var1}), false);
      return var1;
   }
   ...
   public static int setTime(CommandSourceStack var0, int var1) {
      ...
      var0.sendSuccess(new TranslatableComponent("commands.time.set", new Object[]{var1}), true);
   ...
   public static int addTime(CommandSourceStack var0, int var1) {
      ...
      var0.sendSuccess(new TranslatableComponent("commands.time.set", new Object[]{var4}), true);
      return var4;
   }
}
