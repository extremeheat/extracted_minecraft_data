         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("time")
                  ...
                  .then(
                     ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("set")
                                    .then(Commands.literal("day").executes(var0x -> setTime((CommandSourceStack)var0x.getSource(), 1000))))
                                 .then(Commands.literal("noon").executes(var0x -> setTime((CommandSourceStack)var0x.getSource(), 6000))))
                              .then(Commands.literal("night").executes(var0x -> setTime((CommandSourceStack)var0x.getSource(), 13000))))
                           .then(Commands.literal("midnight").executes(var0x -> setTime((CommandSourceStack)var0x.getSource(), 18000))))
                        .then(
                           Commands.argument("time", TimeArgument.time())
                              .executes(var0x -> setTime((CommandSourceStack)var0x.getSource(), IntegerArgumentType.getInteger(var0x, "time")))
                        )
                  ))
               .then(
                  Commands.literal("add")
                     .then(
                        Commands.argument("time", TimeArgument.time())
                           .executes(var0x -> addTime((CommandSourceStack)var0x.getSource(), IntegerArgumentType.getInteger(var0x, "time")))
                     )
               ))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("query")
                        .then(
                           Commands.literal("daytime")
                              .executes(
                                 var0x -> queryTime((CommandSourceStack)var0x.getSource(), getDayTime(((CommandSourceStack)var0x.getSource()).getLevel()))
                              )
                        ))
                     .then(
                        Commands.literal("gametime")
                           .executes(
                              var0x -> queryTime(
                                    ...
                                    (int)(((CommandSourceStack)var0x.getSource()).getLevel().getGameTime() % 2147483647L)
                                 )
                           )
                     ))
                  .then(
                     Commands.literal("day")
                        .executes(
                           var0x -> queryTime(
                                 (CommandSourceStack)var0x.getSource(),
                                 (int)(((CommandSourceStack)var0x.getSource()).getLevel().getDayTime() / 24000L % 2147483647L)
                              )
                        )
                  )
            )
