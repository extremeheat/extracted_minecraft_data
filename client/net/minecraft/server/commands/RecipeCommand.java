...
public class RecipeCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("recipe").requires(Commands.hasPermission(2))).then(Commands.literal("give").then(((RequiredArgumentBuilder)Commands.argument("targets", EntityArgument.players()).then(Commands.argument("recipe", ResourceKeyArgument.key(Registries.RECIPE)).executes((var0x) -> giveRecipes((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), Collections.singleton(ResourceKeyArgument.getRecipe(var0x, "recipe")))))).then(Commands.literal("*").executes((var0x) -> giveRecipes((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ((CommandSourceStack)var0x.getSource()).getServer().getRecipeManager().getRecipes())))))).then(Commands.literal("take").then(((RequiredArgumentBuilder)Commands.argument("targets", EntityArgument.players()).then(Commands.argument("recipe", ResourceKeyArgument.key(Registries.RECIPE)).executes((var0x) -> takeRecipes((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), Collections.singleton(ResourceKeyArgument.getRecipe(var0x, "recipe")))))).then(Commands.literal("*").executes((var0x) -> takeRecipes((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ((CommandSourceStack)var0x.getSource()).getServer().getRecipeManager().getRecipes()))))));
   }
