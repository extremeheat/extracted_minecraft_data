...
public class LocateCommand {
   private static final DynamicCommandExceptionType ERROR_STRUCTURE_NOT_FOUND = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.locate.structure.not_found", var0);
   });
   private static final DynamicCommandExceptionType ERROR_STRUCTURE_INVALID = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.locate.structure.invalid", var0);
   });
   private static final DynamicCommandExceptionType ERROR_BIOME_NOT_FOUND = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.locate.biome.not_found", var0);
   });
   private static final DynamicCommandExceptionType ERROR_BIOME_INVALID = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.locate.biome.invalid", var0);
   });
   private static final DynamicCommandExceptionType ERROR_POI_NOT_FOUND = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.locate.poi.not_found", var0);
   });
   private static final DynamicCommandExceptionType ERROR_POI_INVALID = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.locate.poi.invalid", var0);
   });
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      })).then(Commands.literal("structure").then(Commands.argument("structure", ResourceOrTagLocationArgument.resourceOrTag(Registry.STRUCTURE_REGISTRY)).executes((var0x) -> {
         return locateStructure((CommandSourceStack)var0x.getSource(), ResourceOrTagLocationArgument.getRegistryType(var0x, "structure", Registry.STRUCTURE_REGISTRY, ERROR_STRUCTURE_INVALID));
      })))).then(Commands.literal("biome").then(Commands.argument("biome", ResourceOrTagLocationArgument.resourceOrTag(Registry.BIOME_REGISTRY)).executes((var0x) -> {
         return locateBiome((CommandSourceStack)var0x.getSource(), ResourceOrTagLocationArgument.getRegistryType(var0x, "biome", Registry.BIOME_REGISTRY, ERROR_BIOME_INVALID));
      })))).then(Commands.literal("poi").then(Commands.argument("poi", ResourceOrTagLocationArgument.resourceOrTag(Registry.POINT_OF_INTEREST_TYPE_REGISTRY)).executes((var0x) -> {
         return locatePoi((CommandSourceStack)var0x.getSource(), ResourceOrTagLocationArgument.getRegistryType(var0x, "poi", Registry.POINT_OF_INTEREST_TYPE_REGISTRY, ERROR_POI_INVALID));
      }))));
   }

   private static Optional<? extends HolderSet.ListBacked<Structure>> getHolders(ResourceOrTagLocationArgument.Result<Structure> var0, Registry<Structure> var1) {
   ...
   public static int showLocateResult(CommandSourceStack var0, ResourceOrTagLocationArgument.Result<?> var1, BlockPos var2, Pair<BlockPos, ? extends Holder<?>> var3, String var4, boolean var5) {
      ...
      MutableComponent var10 = ComponentUtils.wrapInSquareBrackets(Component.translatable("chat.coordinates", var6.getX(), var9, var6.getZ())).withStyle((var2x) -> {
         return var2x.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/tp @s " + var6.getX() + " " + var9 + " " + var6.getZ())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.translatable("chat.coordinates.tooltip")));
      });
