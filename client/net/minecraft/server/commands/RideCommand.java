...
public class RideCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("ride").requires((var0x) -> var0x.hasPermission(2))).then(((RequiredArgumentBuilder)Commands.argument("target", EntityArgument.entity()).then(Commands.literal("mount").then(Commands.argument("vehicle", EntityArgument.entity()).executes((var0x) -> mount((CommandSourceStack)var0x.getSource(), EntityArgument.getEntity(var0x, "target"), EntityArgument.getEntity(var0x, "vehicle")))))).then(Commands.literal("dismount").executes((var0x) -> dismount((CommandSourceStack)var0x.getSource(), EntityArgument.getEntity(var0x, "target"))))));
   }
