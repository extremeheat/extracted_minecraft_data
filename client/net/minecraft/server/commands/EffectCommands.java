...
public class EffectCommands {
   ...
   private static int giveEffect(CommandSourceStack var0, Collection<? extends Entity> var1, MobEffect var2, @Nullable Integer var3, int var4, boolean var5) throws CommandSyntaxException {
      ...
      if (var6 == 0) {
         ...
         if (var1.size() == 1) {
            var0.sendSuccess(Component.translatable("commands.effect.give.success.single", var2.getDisplayName(), ((Entity)var1.iterator().next()).getDisplayName(), var7 / 20), true);
         } else {
   ...
   private static int clearEffect(CommandSourceStack var0, Collection<? extends Entity> var1, MobEffect var2) throws CommandSyntaxException {
      ...
      if (var3 == 0) {
         ...
         if (var1.size() == 1) {
            var0.sendSuccess(Component.translatable("commands.effect.clear.specific.success.single", var2.getDisplayName(), ((Entity)var1.iterator().next()).getDisplayName()), true);
         } else {
