...
public class ResetChunksCommand {
   ...
   private static int resetChunks(CommandSourceStack var0, int var1, boolean var2) {
      ...
      int var7 = var6.field_505 - var1;
      int var8 = var6.field_505 + var1;
      int var9 = var6.field_504 - var1;
      int var10 = var6.field_504 + var1;
      ...
      while(var33.hasNext()) {
         ...
         for(int var20 = var6.field_505 - var1; var20 <= var6.field_505 + var1; ++var20) {
            for(int var21 = var6.field_504 - var1; var21 <= var6.field_504 + var1; ++var21) {
               ...
               if (var23 != null && (!var2 || !var23.isOldNoiseGeneration())) {
                  ...
                  for(int var26 = var22.field_505 - var25; var26 <= var22.field_505 + var25; ++var26) {
                     for(int var27 = var22.field_504 - var25; var27 <= var22.field_504 + var25; ++var27) {
      ...
      for(int var38 = var6.field_505 - var1; var38 <= var6.field_505 + var1; ++var38) {
         for(int var18 = var6.field_504 - var1; var18 <= var6.field_504 + var1; ++var18) {
      ...
      var0.sendSuccess(new TextComponent(String.format("%d chunks have been reset. This took %d ms for %d chunks, or %02f ms per chunk", var32, var17, var32, (float)var17 / (float)var32)), true);
      return 1;
   }
}
