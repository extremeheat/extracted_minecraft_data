...
public class SaveAllCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("save-all").requires(var0x -> var0x.hasPermission(4)))
               .executes(var0x -> saveAll((CommandSourceStack)var0x.getSource(), false)))
            .then(Commands.literal("flush").executes(var0x -> saveAll((CommandSourceStack)var0x.getSource(), true)))
      );
   }
