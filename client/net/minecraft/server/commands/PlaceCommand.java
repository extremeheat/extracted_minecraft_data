...
public class PlaceCommand {
   ...
   private static final DynamicCommandExceptionType ERROR_TEMPLATE_INVALID = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("commands.place.template.invalid", var0);
   });
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("place").requires((var0x) -> {
      ...
      })).then(Commands.literal("feature").then(((RequiredArgumentBuilder)Commands.argument("feature", ResourceKeyArgument.key(Registry.CONFIGURED_FEATURE_REGISTRY)).executes((var0x) -> {
      ...
      }))))).then(Commands.literal("jigsaw").then(Commands.argument("pool", ResourceKeyArgument.key(Registry.TEMPLATE_POOL_REGISTRY)).then(Commands.argument("target", ResourceLocationArgument.id()).then(((RequiredArgumentBuilder)Commands.argument("max_depth", IntegerArgumentType.integer(1, 7)).executes((var0x) -> {
         return placeJigsaw((CommandSourceStack)var0x.getSource(), ResourceKeyArgument.getStructureTemplatePool(var0x, "pool"), ResourceLocationArgument.getId(var0x, "target"), IntegerArgumentType.getInteger(var0x, "max_depth"), new BlockPos(((CommandSourceStack)var0x.getSource()).getPosition()));
      ...
      }))))))).then(Commands.literal("structure").then(((RequiredArgumentBuilder)Commands.argument("structure", ResourceKeyArgument.key(Registry.STRUCTURE_REGISTRY)).executes((var0x) -> {
         return placeStructure((CommandSourceStack)var0x.getSource(), ResourceKeyArgument.getStructure(var0x, "structure"), new BlockPos(((CommandSourceStack)var0x.getSource()).getPosition()));
      })).then(Commands.argument("pos", BlockPosArgument.blockPos()).executes((var0x) -> {
         ...
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), new BlockPos(((CommandSourceStack)var0x.getSource()).getPosition()), Rotation.NONE, Mirror.NONE, 1.0F, 0);
   ...
   public static int placeFeature(CommandSourceStack var0, Holder<ConfiguredFeature<?, ?>> var1, BlockPos var2) throws CommandSyntaxException {
      ...
      if (!var4.place(var3, var3.getChunkSource().getGenerator(), var3.getRandom(), var2)) {
         ...
         String var6 = (String)var1.unwrapKey().map((var0x) -> {
   ...
   public static int placeStructure(CommandSourceStack var0, Holder<Structure> var1, BlockPos var2) throws CommandSyntaxException {
      ...
      if (!var6.isValid()) {
         ...
         String var10 = (String)var1.unwrapKey().map((var0x) -> {
            return var0x.location().toString();
         }).orElse("[unregistered]");
