...
public class SpreadPlayersCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spreadplayers").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.argument("center", Vec2Argument.vec2()).then(Commands.argument("spreadDistance", FloatArgumentType.floatArg(0.0F)).then(((RequiredArgumentBuilder)Commands.argument("maxRange", FloatArgumentType.floatArg(1.0F)).then(Commands.argument("respectTeams", BoolArgumentType.bool()).then(Commands.argument("targets", EntityArgument.entities()).executes((var0x) -> spreadPlayers((CommandSourceStack)var0x.getSource(), Vec2Argument.getVec2(var0x, "center"), FloatArgumentType.getFloat(var0x, "spreadDistance"), FloatArgumentType.getFloat(var0x, "maxRange"), ((CommandSourceStack)var0x.getSource()).getLevel().getMaxY() + 1, BoolArgumentType.getBool(var0x, "respectTeams"), EntityArgument.getEntities(var0x, "targets")))))).then(Commands.literal("under").then(Commands.argument("maxHeight", IntegerArgumentType.integer()).then(Commands.argument("respectTeams", BoolArgumentType.bool()).then(Commands.argument("targets", EntityArgument.entities()).executes((var0x) -> spreadPlayers((CommandSourceStack)var0x.getSource(), Vec2Argument.getVec2(var0x, "center"), FloatArgumentType.getFloat(var0x, "spreadDistance"), FloatArgumentType.getFloat(var0x, "maxRange"), IntegerArgumentType.getInteger(var0x, "maxHeight"), BoolArgumentType.getBool(var0x, "respectTeams"), EntityArgument.getEntities(var0x, "targets")))))))))));
   }
   ...
   private static void spreadPositions(Vec2 var0, double var1, ServerLevel var3, RandomSource var4, double var5, double var7, double var9, double var11, int var13, Position[] var14, boolean var15) throws CommandSyntaxException {
      boolean var16 = true;
   ...
   private static double setPlayerPositions(Collection<? extends Entity> var0, ServerLevel var1, Position[] var2, int var3, boolean var4) {
      double var5 = 0.0;
      int var7 = 0;
   ...
   private static Position[] createInitialPositions(RandomSource var0, int var1, double var2, double var4, double var6, double var8) {
      Position[] var10 = new Position[var1];

      for(int var11 = 0; var11 < var10.length; ++var11) {
         Position var12 = new Position();
   ...
   static class Position {
      ...
      public void moveAway(Position var1) {
         this.x -= var1.x;
         this.z -= var1.z;
      }
      ...
      public int getSpawnY(BlockGetter var1, int var2) {
         ...
         boolean var6;
         for(boolean var5 = var1.getBlockState(var3).isAir(); var3.getY() > var1.getMinY(); var5 = var6) {
            var3.move(Direction.DOWN);
