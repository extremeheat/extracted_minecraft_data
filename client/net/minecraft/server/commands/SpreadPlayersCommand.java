...
public class SpreadPlayersCommand {
   ...
   private static int spreadPlayers(CommandSourceStack var0, Vec2 var1, float var2, float var3, int var4, boolean var5, Collection<? extends Entity> var6) throws CommandSyntaxException {
      ...
      double var8 = (double)(var1.field_412 - var3);
      double var10 = (double)(var1.field_413 - var3);
      double var12 = (double)(var1.field_412 + var3);
      double var14 = (double)(var1.field_413 + var3);
      ...
      var0.sendSuccess(new TranslatableComponent("commands.spreadplayers.success." + (var5 ? "teams" : "entities"), new Object[]{var16.length, var1.field_412, var1.field_413, String.format(Locale.ROOT, "%.2f", var17)}), true);
      return var16.length;
   }
   ...
   private static void spreadPositions(Vec2 var0, double var1, ServerLevel var3, Random var4, double var5, double var7, double var9, double var11, int var13, SpreadPlayersCommand.Position[] var14, boolean var15) throws CommandSyntaxException {
         ...
         for(int var20 = 0; var20 < var14.length; ++var20) {
            ...
            for(int var24 = 0; var24 < var14.length; ++var24) {
               if (var20 != var24) {
                  ...
                  if (var26 < var1) {
                     ++var22;
                     var23.field_440 += var25.field_440 - var21.field_440;
                     var23.field_441 += var25.field_441 - var21.field_441;
                  }
               }
            }

            if (var22 > 0) {
               var23.field_440 /= (double)var22;
               var23.field_441 /= (double)var22;
      ...
      if (var17 >= 10000) {
         if (var15) {
            throw ERROR_FAILED_TO_SPREAD_TEAMS.create(var14.length, var0.field_412, var0.field_413, String.format(Locale.ROOT, "%.2f", var18));
         } else {
            throw ERROR_FAILED_TO_SPREAD_ENTITIES.create(var14.length, var0.field_412, var0.field_413, String.format(Locale.ROOT, "%.2f", var18));
         }
      }
   }
   ...
   private static double setPlayerPositions(Collection<? extends Entity> var0, ServerLevel var1, SpreadPlayersCommand.Position[] var2, int var3, boolean var4) {
      ...
      for(Iterator var9 = var0.iterator(); var9.hasNext(); var5 += var20) {
         ...
         var10.teleportToWithTicket((double)Mth.floor(var11.field_440) + 0.5D, (double)var11.getSpawnY(var1, var3), (double)Mth.floor(var11.field_441) + 0.5D);
   ...
   private static class Position {
      ...
      double dist(SpreadPlayersCommand.Position var1) {
         double var2 = this.field_440 - var1.field_440;
         double var4 = this.field_441 - var1.field_441;
      ...
      double getLength() {
         return Math.sqrt(this.field_440 * this.field_440 + this.field_441 * this.field_441);
      }

      public void moveAway(SpreadPlayersCommand.Position var1) {
         this.field_440 -= var1.field_440;
         this.field_441 -= var1.field_441;
      }
      ...
      public boolean clamp(double var1, double var3, double var5, double var7) {
         ...
         if (this.field_440 < var1) {
            this.field_440 = var1;
            var9 = true;
         } else if (this.field_440 > var5) {
            this.field_440 = var5;
            var9 = true;
         }

         if (this.field_441 < var3) {
            this.field_441 = var3;
            var9 = true;
         } else if (this.field_441 > var7) {
            this.field_441 = var7;
            var9 = true;
         }
      ...
      public int getSpawnY(BlockGetter var1, int var2) {
         BlockPos.MutableBlockPos var3 = new BlockPos.MutableBlockPos(this.field_440, (double)(var2 + 1), this.field_441);
      ...
      public boolean isSafe(BlockGetter var1, int var2) {
         BlockPos var3 = new BlockPos(this.field_440, (double)(this.getSpawnY(var1, var2) - 1), this.field_441);
      ...
      public void randomize(Random var1, double var2, double var4, double var6, double var8) {
         this.field_440 = Mth.nextDouble(var1, var2, var6);
         this.field_441 = Mth.nextDouble(var1, var4, var8);
      }
   }
}
