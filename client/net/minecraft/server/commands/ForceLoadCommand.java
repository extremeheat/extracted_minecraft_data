...
public class ForceLoadCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType(
      (var0, var1) -> Component.translatable("commands.forceload.toobig", var0, var1)
   );
   private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType(
      (var0, var1) -> Component.translatable("commands.forceload.query.failure", var0, var1)
   );
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("forceload")
                           ...
                           ((RequiredArgumentBuilder)Commands.argument("from", ColumnPosArgument.columnPos())
                                 .executes(
                                    var0x -> changeForceLoad(
                                          ...
                                          ColumnPosArgument.getColumnPos(var0x, "from"),
                                          ColumnPosArgument.getColumnPos(var0x, "from"),
                                          true
                                       )
                                 ))
                                 ...
                                 Commands.argument("to", ColumnPosArgument.columnPos())
                                    .executes(
                                       var0x -> changeForceLoad(
                                             (CommandSourceStack)var0x.getSource(),
                                             ColumnPosArgument.getColumnPos(var0x, "from"),
                                             ColumnPosArgument.getColumnPos(var0x, "to"),
                                             true
                                          )
                                    )
                              )
               ...
               .then(
                  ((LiteralArgumentBuilder)Commands.literal("remove")
                     ...
                     .then(Commands.literal("all").executes(var0x -> removeAll((CommandSourceStack)var0x.getSource())))
               ))
            .then(
               ((LiteralArgumentBuilder)Commands.literal("query").executes(var0x -> listForceLoad((CommandSourceStack)var0x.getSource())))
                  .then(
                     Commands.argument("pos", ColumnPosArgument.columnPos())
                        .executes(var0x -> queryForceLoad((CommandSourceStack)var0x.getSource(), ColumnPosArgument.getColumnPos(var0x, "pos")))
                  )
            )
      );
   }
   ...
   private static int queryForceLoad(CommandSourceStack var0, ColumnPos var1) throws CommandSyntaxException {
      ...
      if (var5) {
         var0.sendSuccess(Component.translatable("commands.forceload.query.success", var2, var4.location()), false);
         return 1;
      } else {
   ...
   private static int listForceLoad(CommandSourceStack var0) {
      ...
      if (var4 > 0) {
         ...
         if (var4 == 1) {
            var0.sendSuccess(Component.translatable("commands.forceload.list.single", var2.location(), var5), false);
         } else {
            var0.sendSuccess(Component.translatable("commands.forceload.list.multiple", var4, var2.location(), var5), false);
         }
      } else {
         var0.sendFailure(Component.translatable("commands.forceload.added.none", var2.location()));
      }
   ...
   private static int removeAll(CommandSourceStack var0) {
      ...
      var0.sendSuccess(Component.translatable("commands.forceload.removed.all", var2.location()), true);
      return 0;
   }
      ...
      if (var4 >= -30000000 && var5 >= -30000000 && var6 < 30000000 && var7 < 30000000) {
         ...
         if (var12 > 256L) {
            ...
            if (var17 == 0) {
               ...
               if (var17 == 1) {
                  var0.sendSuccess(Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".single", var16, var15.location()), true);
               } else {
                  ChunkPos var21 = new ChunkPos(var8, var9);
                  ChunkPos var22 = new ChunkPos(var10, var11);
                  var0.sendSuccess(
                     Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".multiple", var17, var15.location(), var21, var22), true
                  );
               }
