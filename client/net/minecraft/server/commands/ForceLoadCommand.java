...
public class ForceLoadCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType((var0, var1) -> {
      return Component.translatable("commands.forceload.toobig", var0, var1);
   });
   private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType((var0, var1) -> {
      return Component.translatable("commands.forceload.query.failure", var0, var1);
   });
         ...
         if (var12 > 256L) {
            ...
            if (var17 == 0) {
               ...
               if (var17 == 1) {
                  ...
                  var0.sendSuccess(Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".multiple", var17, var15.location(), var21, var22), true);
               }
