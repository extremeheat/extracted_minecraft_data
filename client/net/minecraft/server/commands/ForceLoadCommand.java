...
public class ForceLoadCommand {
   ...
   private static int queryForceLoad(CommandSourceStack var0, ColumnPos var1) throws CommandSyntaxException {
      ChunkPos var2 = new ChunkPos(SectionPos.blockToSectionCoord(var1.field_143), SectionPos.blockToSectionCoord(var1.field_144));
   ...
   private static int changeForceLoad(CommandSourceStack var0, ColumnPos var1, ColumnPos var2, boolean var3) throws CommandSyntaxException {
      int var4 = Math.min(var1.field_143, var2.field_143);
      int var5 = Math.min(var1.field_144, var2.field_144);
      int var6 = Math.max(var1.field_143, var2.field_143);
      int var7 = Math.max(var1.field_144, var2.field_144);
