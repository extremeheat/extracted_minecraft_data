         ...
         while(true) {
            while(true) {
               while(true) {
                  ...
                  if (var1.size() == 1) {
                     var0.sendSuccess(Component.translatable("commands.enchant.success.single", var2.getFullname(var3), ((Entity)var1.iterator().next()).getDisplayName()), true);
                  } else {
