...
public class ListPlayersCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("list").executes(var0x -> listPlayers((CommandSourceStack)var0x.getSource())))
            .then(Commands.literal("uuids").executes(var0x -> listPlayersWithUuids((CommandSourceStack)var0x.getSource())))
      );
   }
   ...
   private static int listPlayersWithUuids(CommandSourceStack var0) {
      return format(var0, var0x -> Component.translatable("commands.list.nameAndId", var0x.getName(), var0x.getGameProfile().getId()));
   }
