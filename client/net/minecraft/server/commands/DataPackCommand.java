...
public class DataPackCommand {
   ...
   private static int listAvailablePacks(CommandSourceStack var0) {
      ...
      if (var4.isEmpty()) {
         ...
         var0.sendSuccess(Component.translatable("commands.datapack.list.available.success", var4.size(), ComponentUtils.formatList(var4, (Function)((var0x) -> {
   ...
   private static int listEnabledPacks(CommandSourceStack var0) {
      ...
      if (var2.isEmpty()) {
         ...
         var0.sendSuccess(Component.translatable("commands.datapack.list.enabled.success", var2.size(), ComponentUtils.formatList(var2, (var0x) -> {
