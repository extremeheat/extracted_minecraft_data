...
public class WorldBorderCommand {
   ...
   private static int setCenter(CommandSourceStack var0, Vec2 var1) throws CommandSyntaxException {
      WorldBorder var2 = var0.getServer().overworld().getWorldBorder();
      if (var2.getCenterX() == (double)var1.field_412 && var2.getCenterZ() == (double)var1.field_413) {
         throw ERROR_SAME_CENTER.create();
      } else if (!((double)Math.abs(var1.field_412) > 2.9999984E7D) && !((double)Math.abs(var1.field_413) > 2.9999984E7D)) {
         var2.setCenter((double)var1.field_412, (double)var1.field_413);
         var0.sendSuccess(new TranslatableComponent("commands.worldborder.center.success", new Object[]{String.format(Locale.ROOT, "%.2f", var1.field_412), String.format("%.2f", var1.field_413)}), true);
         return 0;
      } else {
