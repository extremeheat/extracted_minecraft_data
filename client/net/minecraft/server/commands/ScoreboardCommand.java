...
public class ScoreboardCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_NO_VALUE = new Dynamic2CommandExceptionType((var0, var1) -> {
      return Component.translatable("commands.scoreboard.players.get.null", var0, var1);
   });
   ...
   private static int performOperation(CommandSourceStack var0, Collection<String> var1, Objective var2, OperationArgument.Operation var3, Collection<String> var4, Objective var5) throws CommandSyntaxException {
      ...
      if (var1.size() == 1) {
         var0.sendSuccess(Component.translatable("commands.scoreboard.players.operation.success.single", var2.getFormattedDisplayName(), var1.iterator().next(), var7), true);
      } else {
   ...
   private static int enableTrigger(CommandSourceStack var0, Collection<String> var1, Objective var2) throws CommandSyntaxException {
      if (var2.getCriteria() != ObjectiveCriteria.TRIGGER) {
         ...
         if (var4 == 0) {
            ...
            if (var1.size() == 1) {
               var0.sendSuccess(Component.translatable("commands.scoreboard.players.enable.success.single", var2.getFormattedDisplayName(), var1.iterator().next()), true);
            } else {
   ...
   private static int resetScore(CommandSourceStack var0, Collection<String> var1, Objective var2) {
      ...
      if (var1.size() == 1) {
         var0.sendSuccess(Component.translatable("commands.scoreboard.players.reset.specific.single", var2.getFormattedDisplayName(), var1.iterator().next()), true);
      } else {
   ...
   private static int setScore(CommandSourceStack var0, Collection<String> var1, Objective var2, int var3) {
      ...
      if (var1.size() == 1) {
         var0.sendSuccess(Component.translatable("commands.scoreboard.players.set.success.single", var2.getFormattedDisplayName(), var1.iterator().next(), var3), true);
      } else {
   ...
   private static int addScore(CommandSourceStack var0, Collection<String> var1, Objective var2, int var3) {
      ...
      if (var1.size() == 1) {
         var0.sendSuccess(Component.translatable("commands.scoreboard.players.add.success.single", var3, var2.getFormattedDisplayName(), var1.iterator().next(), var5), true);
      } else {
   ...
   private static int removeScore(CommandSourceStack var0, Collection<String> var1, Objective var2, int var3) {
      ...
      if (var1.size() == 1) {
         var0.sendSuccess(Component.translatable("commands.scoreboard.players.remove.success.single", var3, var2.getFormattedDisplayName(), var1.iterator().next(), var5), true);
      } else {
   ...
   private static int listTrackedPlayerScores(CommandSourceStack var0, String var1) {
      ...
      if (var2.isEmpty()) {
         ...
         while(var3.hasNext()) {
            ...
            var0.sendSuccess(Component.translatable("commands.scoreboard.players.list.entity.entry", ((Objective)var4.getKey()).getFormattedDisplayName(), ((Score)var4.getValue()).getScore()), false);
         }
      }
   ...
   private static int setDisplaySlot(CommandSourceStack var0, int var1, Objective var2) throws CommandSyntaxException {
      ...
      if (var3.getDisplayObjective(var1) == var2) {
         ...
         var0.sendSuccess(Component.translatable("commands.scoreboard.objectives.display.set", Scoreboard.getDisplaySlotNames()[var1], var2.getDisplayName()), true);
         return 0;
      }
   }
