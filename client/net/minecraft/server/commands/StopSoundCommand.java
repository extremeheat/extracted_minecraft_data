...
public class StopSoundCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      })).then(Commands.literal("*").then(Commands.argument("sound", ResourceLocationArgument.method_50()).suggests(SuggestionProviders.AVAILABLE_SOUNDS).executes((var0x) -> {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         })).then(Commands.argument("sound", ResourceLocationArgument.method_50()).suggests(SuggestionProviders.AVAILABLE_SOUNDS).executes((var1x) -> {
   ...
   private static int stopSound(CommandSourceStack var0, Collection<ServerPlayer> var1, @Nullable SoundSource var2, @Nullable ResourceLocation var3) {
      ...
      if (var2 != null) {
         if (var3 != null) {
            var0.sendSuccess(new TranslatableComponent("commands.stopsound.success.source.sound", new Object[]{var3, var2.getName()}), true);
         } else {
            var0.sendSuccess(new TranslatableComponent("commands.stopsound.success.source.any", new Object[]{var2.getName()}), true);
         }
      } else if (var3 != null) {
