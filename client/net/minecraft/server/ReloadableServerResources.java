...
public class ReloadableServerResources {
   ...
   public static CompletableFuture<ReloadableServerResources> loadResources(ResourceManager var0, RegistryAccess.Frozen var1, Commands.CommandSelection var2, int var3, Executor var4, Executor var5) {
      ReloadableServerResources var6 = new ReloadableServerResources(var1, var2, var3);
      return SimpleReloadInstance.create(var0, var6.listeners(), var4, var5, DATA_RELOAD_INITIAL_TASK, LOGGER.isDebugEnabled()).done().whenComplete((var1x, var2x) -> {
         var6.commandBuildContext.missingTagAccessPolicy(CommandBuildContext.MissingTagAccessPolicy.FAIL);
      }).thenApply((var1x) -> {
         return var6;
      });
   }
