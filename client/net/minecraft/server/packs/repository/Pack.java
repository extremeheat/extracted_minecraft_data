...
public class Pack implements AutoCloseable {
   ...
   private final String field_197;
   ...
   public Component getChatLink(boolean var1) {
      return ComponentUtils.wrapInSquareBrackets(this.packSource.decorate(new TextComponent(this.field_197))).withStyle((var2) -> {
         return var2.withColor(var1 ? ChatFormatting.GREEN : ChatFormatting.RED).withInsertion(StringArgumentType.escapeIfRequired(this.field_197)).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, (new TextComponent("")).append(this.title).append("\n").append(this.description)));
      });
   }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         Pack var2 = (Pack)var1;
         return this.field_197.equals(var2.field_197);
      }
   }

   public int hashCode() {
      return this.field_197.hashCode();
   }
