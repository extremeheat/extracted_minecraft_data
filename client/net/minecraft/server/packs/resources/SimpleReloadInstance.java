...
public class SimpleReloadInstance<S> implements ReloadInstance {
   ...
   // $FF: renamed from: of (net.minecraft.server.packs.resources.ResourceManager, java.util.List, java.util.concurrent.Executor, java.util.concurrent.Executor, java.util.concurrent.CompletableFuture) net.minecraft.server.packs.resources.SimpleReloadInstance
   public static SimpleReloadInstance<Void> method_96(ResourceManager var0, List<PreparableReloadListener> var1, Executor var2, Executor var3, CompletableFuture<Unit> var4) {
