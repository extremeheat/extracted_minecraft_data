...
public class EntityTracker {
   ...
   public EntityTracker(WorldServer var1) {
      ...
      this.field_72792_d = var1.func_73046_m().func_184103_al().func_72372_a();
   }

   public static long func_187253_a(double var0) {
      return MathHelper.func_76124_d(var0 * 4096.0D);
   }

   public static void func_187254_a(Entity var0, double var1, double var3, double var5) {
      var0.field_70118_ct = func_187253_a(var1);
      var0.field_70117_cu = func_187253_a(var3);
      var0.field_70116_cv = func_187253_a(var5);
   }
   ...
   public void func_72786_a(Entity var1) {
      if (var1 instanceof EntityPlayerMP) {
         ...
         this.func_72785_a(var1, 64, 10, true);
      } else if (var1 instanceof EntityLlamaSpit) {
         this.func_72785_a(var1, 64, 10, false);
         ...
         this.func_72785_a(var1, 160, 2147483647, true);
      } else if (var1 instanceof EntityEnderCrystal) {
         this.func_72785_a(var1, 256, 2147483647, false);
      } else if (var1 instanceof EntityEvokerFangs) {
         this.func_72785_a(var1, 160, 2, false);
      }
   ...
   public void func_72785_a(Entity var1, int var2, int var3, boolean var4) {
      try {
         ...
         EntityTrackerEntry var5 = new EntityTrackerEntry(var1, var2, this.field_72792_d, var3, var4);
         ...
         CrashReport var6 = CrashReport.func_85055_a(var10, "Adding entity to track");
         CrashReportCategory var7 = var6.func_85058_a("Entity To Track");
         var7.func_71507_a("Tracking range", var2 + " blocks");
         var7.func_189529_a("Update interval", () -> {
         ...
         ((EntityTrackerEntry)this.field_72794_c.func_76041_a(var1.func_145782_y())).func_187260_b().func_85029_a(var6.func_85058_a("Entity That Is Already Tracked"));
   ...
   public void func_72788_a() {
      ...
      while(var2.hasNext()) {
         ...
         if (var3.field_73133_n) {
            Entity var4 = var3.func_187260_b();
      ...
      for(int var6 = 0; var6 < var1.size(); ++var6) {
         ...
         Iterator var8 = this.field_72793_b.iterator();

         while(var8.hasNext()) {
            EntityTrackerEntry var5 = (EntityTrackerEntry)var8.next();
            if (var5.func_187260_b() != var7) {
   ...
   public void func_85172_a(EntityPlayerMP var1, Chunk var2) {
      ...
      while(var5.hasNext()) {
         ...
         Entity var7 = var6.func_187260_b();
         if (var7 != var1 && var7.field_70176_ah == var2.field_76635_g && var7.field_70164_aj == var2.field_76647_h) {
            var6.func_73117_b(var1);
            if (var7 instanceof EntityLiving && ((EntityLiving)var7).func_110166_bE() != null) {
               var3.add(var7);
            }

            if (!var7.func_184188_bt().isEmpty()) {
               var4.add(var7);
            }
         }
      }
      ...
      if (!var3.isEmpty()) {
         ...
         while(var5.hasNext()) {
            ...
            var1.field_71135_a.func_147359_a(new SPacketEntityAttach(var8, ((EntityLiving)var8).func_110166_bE()));
         }
      }
      ...
      if (!var4.isEmpty()) {
         ...
         while(var5.hasNext()) {
            var8 = (Entity)var5.next();
            var1.field_71135_a.func_147359_a(new SPacketSetPassengers(var8));
         }
      }
   ...
   public void func_187252_a(int var1) {
      this.field_72792_d = (var1 - 1) * 16;
      Iterator var2 = this.field_72793_b.iterator();

      while(var2.hasNext()) {
         EntityTrackerEntry var3 = (EntityTrackerEntry)var2.next();
         var3.func_187259_a(this.field_72792_d);
      }
