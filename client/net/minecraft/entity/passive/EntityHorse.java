...
public class EntityHorse extends EntityAnimal implements IInvBasic {
   private static final IEntitySelector field_110276_bu = new EntityHorse$1();
   private static final IAttribute field_110271_bv = new RangedAttribute("horse.jumpStrength", 0.7, 0.0, 2.0)
      .func_111117_a("Jump Strength")
      .func_111112_a(true);
   private static final String[] field_110270_bw = new String[]{
      null,
   ...
   protected void func_70069_a(float var1) {
      ...
      int var2 = MathHelper.func_76123_f(var1 * 0.5F - 3.0F);
      if (var2 > 0) {
         ...
         Block var3 = this.field_70170_p
            .func_147439_a(
               MathHelper.func_76128_c(this.field_70165_t),
               MathHelper.func_76128_c(this.field_70163_u - 0.2 - (double)this.field_70126_B),
               MathHelper.func_76128_c(this.field_70161_v)
            );
         if (var3.func_149688_o() != Material.field_151579_a) {
            Block$SoundType var4 = var3.field_149762_H;
            this.field_70170_p.func_72956_a(this, var4.func_150498_e(), var4.func_150497_c() * 0.5F, var4.func_150494_d() * 0.75F);
         }
      }
   }
   ...
   protected EntityHorse func_110250_a(Entity var1, double var2) {
      ...
      for(Entity var9 : this.field_70170_p.func_94576_a(var1, var1.field_70121_D.func_72321_a(var2, var2, var2), field_110276_bu)) {
   ...
   protected Item func_146068_u() {
      ...
      if (var2 == 4) {
         ...
         return var1 ? Item.func_150899_d(0) : Items.field_151078_bh;
      } else {
   ...
   protected void func_145780_a(int var1, int var2, int var3, Block var4) {
      ...
      if (!var4.func_149688_o().func_76224_d()) {
         int var6 = this.func_110265_bP();
         if (this.field_70153_n != null && var6 != 1 && var6 != 2) {
            ++this.field_110285_bP;
            if (this.field_110285_bP > 5 && this.field_110285_bP % 3 == 0) {
               this.func_85030_a("mob.horse.gallop", var5.func_150497_c() * 0.15F, var5.func_150494_d());
               if (var6 == 0 && this.field_70146_Z.nextInt(10) == 0) {
                  this.func_85030_a("mob.horse.breathe", var5.func_150497_c() * 0.6F, var5.func_150494_d());
               }
            } else if (this.field_110285_bP <= 5) {
               this.func_85030_a("mob.horse.wood", var5.func_150497_c() * 0.15F, var5.func_150494_d());
            }
         } else if (var5 == Block.field_149766_f) {
            this.func_85030_a("mob.horse.wood", var5.func_150497_c() * 0.15F, var5.func_150494_d());
         } else {
            this.func_85030_a("mob.horse.soft", var5.func_150497_c() * 0.15F, var5.func_150494_d());
         }
      }
   }
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.22499999403953552);
   }
   ...
   private void func_110247_cG() {
      ...
      int var5 = this.func_110241_cb();
      this.field_110280_bR[2] = field_110270_bw[var5];
      this.field_110286_bQ = this.field_110286_bQ + field_110273_bx[var5];
   }
   ...
   public boolean func_70085_c(EntityPlayer var1) {
      ...
      if (var2 != null && var2.func_77973_b() == Items.field_151063_bx) {
         ...
         if (var2 != null) {
            ...
            if (!var3 && !this.func_110256_cu()) {
               ...
               if (var2.func_77973_b() == Items.field_151015_O) {
                  ...
                  var5 = 30;
                  var6 = 3;
               } else if (var2.func_77973_b() == Items.field_151025_P) {
                  var7 = 7.0F;
                  var5 = 180;
                  var6 = 3;
         ...
         if (!this.func_110253_bW() || this.field_70153_n != null) {
            return super.func_70085_c(var1);
         } else if (var2 != null && var2.func_111282_a(var1, this)) {
            return true;
         } else {
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (!this.func_110204_cc()
            ...
            && this.field_70170_p
                  .func_147439_a(
                     MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.field_70163_u) - 1, MathHelper.func_76128_c(this.field_70161_v)
                  )
         ...
         if (this.func_110205_ce() && !this.func_110228_bR() && !this.func_110204_cc()) {
            EntityHorse var1 = this.func_110250_a(this, 16.0);
            if (var1 != null && this.func_70068_e(var1) > 4.0) {
   ...
   public void func_70612_e(float var1, float var2) {
      if (this.field_70153_n != null && this.field_70153_n instanceof EntityLivingBase && this.func_110257_ck()) {
         ...
         float var7 = MathHelper.func_76133_a(var10 * var10 + var5 * var5) * 4.0F;
         if (var7 > 1.0F) {
            var7 = 1.0F;
         }
   ...
   public void func_70037_a(NBTTagCompound var1) {
      ...
      if (var1.func_150297_b("OwnerUUID", 8)) {
         this.func_152120_b(var1.func_74779_i("OwnerUUID"));
      }

      IAttributeInstance var2 = this.func_110140_aT().func_111152_a("Speed");
      if (var2 != null) {
         this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(var2.func_111125_b() * 0.25);
      }

      if (this.func_110261_ca()) {
         NBTTagList var3 = var1.func_150295_c("Items", 10);
         this.func_110226_cD();
      ...
      if (var1.func_150297_b("ArmorItem", 10)) {
         ItemStack var7 = ItemStack.func_77949_a(var1.func_74775_l("ArmorItem"));
         if (var7 != null && func_146085_a(var7.func_77973_b())) {
            this.field_110296_bG.func_70299_a(1, var7);
         }
      }

      if (var1.func_150297_b("SaddleItem", 10)) {
         ItemStack var8 = ItemStack.func_77949_a(var1.func_74775_l("SaddleItem"));
         if (var8 != null && var8.func_77973_b() == Items.field_151141_av) {
            this.field_110296_bG.func_70299_a(0, var8);
         }
   ...
   public EntityAgeable func_90011_a(EntityAgeable var1) {
      ...
      if (var6 == 0) {
         ...
         int var7;
         if (var8 < 4) {
            var7 = this.func_110202_bQ() & 0xFF;
         } else if (var8 < 8) {
            var7 = var2.func_110202_bQ() & 0xFF;
         } else {
         ...
         if (var9 < 2) {
            var7 |= this.func_110202_bQ() & 0xFF00;
         } else if (var9 < 4) {
            var7 |= var2.func_110202_bQ() & 0xFF00;
         } else {
            var7 |= this.field_70146_Z.nextInt(5) << 8 & 0xFF00;
         }
      ...
      double var14 = this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111125_b()
         + var1.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111125_b()
         + (double)this.func_110267_cL();
      var3.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(var14 / 3.0);
      double var15 = this.func_110148_a(field_110271_bv).func_111125_b() + var1.func_110148_a(field_110271_bv).func_111125_b() + this.func_110245_cM();
      var3.func_110148_a(field_110271_bv).func_111128_a(var15 / 3.0);
      double var11 = this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111125_b()
         + var1.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111125_b()
         + this.func_110203_cN();
      var3.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(var11 / 3.0);
      return var3;
   }
   ...
   public IEntityLivingData func_110161_a(IEntityLivingData var1) {
      ...
      int var2 = 0;
      int var3 = 0;
      if (var1 instanceof EntityHorse$GroupData) {
         var2 = ((EntityHorse$GroupData)var1).field_111107_a;
         var3 = ((EntityHorse$GroupData)var1).field_111106_b & 0xFF | this.field_70146_Z.nextInt(5) << 8;
      } else {
         ...
         var1 = new EntityHorse$GroupData(var2, var3);
      }

      this.func_110214_p(var2);
      ...
      if (var2 != 4 && var2 != 3) {
         ...
         if (var2 == 0) {
            ...
            this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.17499999701976776);
         }
      } else {
   ...
   public void func_70043_V() {
      ...
      if (this.field_110282_bM > 0.0F) {
         ...
         this.field_70153_n
            .func_70107_b(
               this.field_70165_t + (double)(var3 * var1),
               this.field_70163_u + this.func_70042_X() + this.field_70153_n.func_70033_W() + (double)var4,
               this.field_70161_v - (double)(var3 * var2)
            );
   ...
   private double func_110245_cM() {
      return 0.4000000059604645 + this.field_70146_Z.nextDouble() * 0.2 + this.field_70146_Z.nextDouble() * 0.2 + this.field_70146_Z.nextDouble() * 0.2;
   }

   private double func_110203_cN() {
      return (0.44999998807907104 + this.field_70146_Z.nextDouble() * 0.3 + this.field_70146_Z.nextDouble() * 0.3 + this.field_70146_Z.nextDouble() * 0.3)
         * 0.25;
   }
