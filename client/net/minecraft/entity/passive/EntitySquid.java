...
public class EntitySquid extends EntityWaterMob {
   ...
   public void func_70636_d() {
      ...
      if (this.field_70171_ac) {
         ...
         this.field_70761_aq += (-((float)MathHelper.func_181159_b(this.field_70159_w, this.field_70179_y)) * 180.0F / 3.1415927F - this.field_70761_aq) * 0.1F;
         this.field_70177_z = this.field_70761_aq;
         this.field_70859_f = (float)((double)this.field_70859_f + 3.141592653589793D * (double)this.field_70871_bB * 1.5D);
         this.field_70861_d += (-((float)MathHelper.func_181159_b((double)var1, this.field_70181_x)) * 180.0F / 3.1415927F - this.field_70861_d) * 0.1F;
      } else {
