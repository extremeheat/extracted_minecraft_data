...
public class DataWatcher {
   ...
   public void func_75682_a(int var1, Object var2) {
   ...
   public byte func_75683_a(int var1) {
      return this.func_75691_i(var1).func_75669_b();
   }
   ...
   public void func_75692_b(int var1, Object var2) {
   ...
   public void func_82708_h(int var1) {
      DataWatcher$WatchableObject.access$002(this.func_75691_i(var1), true);
      this.field_75696_c = true;
   }
   ...
   public static void func_151507_a(List var0, PacketBuffer var1) {
      if (var0 != null) {
   ...
   public List func_75688_b() {
      ...
      if (this.field_75696_c) {
         ...
         for(DataWatcher$WatchableObject var3 : this.field_75695_b.values()) {
   ...
   private static void func_151510_a(PacketBuffer var0, DataWatcher$WatchableObject var1) {
      int var2 = (var1.func_75674_c() << 5 | var1.func_75672_a() & 31) & 0xFF;
      var0.writeByte(var2);
      switch(var1.func_75674_c()) {
         case 0:
            var0.writeByte(var1.func_75669_b());
            break;
         case 1:
            var0.writeShort(var1.func_75669_b());
            break;
         case 2:
            var0.writeInt(var1.func_75669_b());
            break;
         case 3:
            var0.writeFloat(var1.func_75669_b());
            break;
         case 4:
            var0.func_150785_a((String)var1.func_75669_b());
            break;
         case 5:
            ItemStack var4 = (ItemStack)var1.func_75669_b();
            var0.func_150788_a(var4);
            break;
         case 6:
            ChunkCoordinates var3 = (ChunkCoordinates)var1.func_75669_b();
            var0.writeInt(var3.field_71574_a);
            var0.writeInt(var3.field_71572_b);
            var0.writeInt(var3.field_71573_c);
      }
   }

   public static List func_151508_b(PacketBuffer var0) {
      ArrayList var1 = null;
   ...
   public void func_75687_a(List var1) {
      this.field_75694_d.writeLock().lock();
