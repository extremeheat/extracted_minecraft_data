...
public class SharedMonsterAttributes {
   ...
   public static final IAttribute field_111267_a = new RangedAttribute("generic.maxHealth", 20.0, 0.0, 1.7976931348623157E308)
      .func_111117_a("Max Health")
      .func_111112_a(true);
   public static final IAttribute field_111265_b = new RangedAttribute("generic.followRange", 32.0, 0.0, 2048.0).func_111117_a("Follow Range");
   public static final IAttribute field_111266_c = new RangedAttribute("generic.knockbackResistance", 0.0, 0.0, 1.0).func_111117_a("Knockback Resistance");
   public static final IAttribute field_111263_d = new RangedAttribute("generic.movementSpeed", 0.699999988079071, 0.0, 1.7976931348623157E308)
      .func_111117_a("Movement Speed")
      .func_111112_a(true);
   public static final IAttribute field_111264_e = new RangedAttribute("generic.attackDamage", 2.0, 0.0, 1.7976931348623157E308);

   public static NBTTagList func_111257_a(BaseAttributeMap var0) {
      NBTTagList var1 = new NBTTagList();

      for(IAttributeInstance var3 : var0.func_111146_a()) {
