...
public class EntityCreeper extends EntityMob {
   ...
   public EntityCreeper(World var1) {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityAIAttackOnCollide(this, 1.0, false));
   ...
   protected boolean func_70085_c(EntityPlayer var1) {
      ...
      if (var2 != null && var2.func_77973_b() == Items.field_151033_d) {
         this.field_70170_p
            .func_72908_a(
               this.field_70165_t + 0.5, this.field_70163_u + 0.5, this.field_70161_v + 0.5, "fire.ignite", 1.0F, this.field_70146_Z.nextFloat() * 0.4F + 0.8F
            );
         var1.func_71038_i();
   ...
   private void func_146077_cc() {
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (this.func_70830_n()) {
            this.field_70170_p.func_72876_a(this, this.field_70165_t, this.field_70163_u, this.field_70161_v, (float)(this.field_82226_g * 2), var1);
         } else {
            this.field_70170_p.func_72876_a(this, this.field_70165_t, this.field_70163_u, this.field_70161_v, (float)this.field_82226_g, var1);
         }
