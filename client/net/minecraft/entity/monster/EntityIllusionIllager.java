...
public class EntityIllusionIllager extends EntitySpellcasterIllager implements IRangedAttackMob {
   ...
   public EntityIllusionIllager(World var1) {
      super(EntityType.field_200764_D, var1);
      this.func_70105_a(0.6F, 1.95F);
      this.field_70728_aV = 5;
      this.field_193100_bx = new Vec3d[2][4];

      for(int var2 = 0; var2 < 4; ++var2) {
         this.field_193100_bx[0][var2] = new Vec3d(0.0D, 0.0D, 0.0D);
         this.field_193100_bx[1][var2] = new Vec3d(0.0D, 0.0D, 0.0D);
      }
         ...
         if (this.field_70737_aN != 1 && this.field_70173_aa % 1200 != 0) {
            if (this.field_70737_aN == this.field_70738_aO - 1) {
               ...
               for(int var4 = 0; var4 < 4; ++var4) {
                  this.field_193100_bx[0][var4] = this.field_193100_bx[1][var4];
                  this.field_193100_bx[1][var4] = new Vec3d(0.0D, 0.0D, 0.0D);
               }
            }
         } else {
            this.field_193099_c = 3;
            ...
            for(var3 = 0; var3 < 4; ++var3) {
               this.field_193100_bx[0][var3] = this.field_193100_bx[1][var3];
               this.field_193100_bx[1][var3] = new Vec3d((double)(-6.0F + (float)this.field_70146_Z.nextInt(13)) * 0.5D, (double)Math.max(0, this.field_70146_Z.nextInt(6) - 4), (double)(-6.0F + (float)this.field_70146_Z.nextInt(13)) * 0.5D);
            }

            for(var3 = 0; var3 < 16; ++var3) {
               this.field_70170_p.func_195594_a(Particles.field_197613_f, this.field_70165_t + (this.field_70146_Z.nextDouble() - 0.5D) * (double)this.field_70130_N, this.field_70163_u + this.field_70146_Z.nextDouble() * (double)this.field_70131_O, this.field_70161_v + (this.field_70146_Z.nextDouble() - 0.5D) * (double)this.field_70130_N, 0.0D, 0.0D, 0.0D);
            }
   ...
   public Vec3d[] func_193098_a(float var1) {
      if (this.field_193099_c <= 0) {
         ...
         double var2 = (double)(((float)this.field_193099_c - var1) / 3.0F);
         var2 = Math.pow(var2, 0.25D);
         Vec3d[] var4 = new Vec3d[4];

         for(int var5 = 0; var5 < 4; ++var5) {
            var4[var5] = this.field_193100_bx[1][var5].func_186678_a(1.0D - var2).func_178787_e(this.field_193100_bx[0][var5].func_186678_a(var2));
         }
   ...
   public void func_82196_d(EntityLivingBase var1, float var2) {
      EntityArrow var3 = this.func_193097_t(var2);
