...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
   ...
   private static final Item[] field_82199_d = new Item[]{
      Items.field_151114_aO,
      Items.field_151102_aT,
      Items.field_151137_ax,
      Items.field_151070_bp,
      Items.field_151069_bo,
      Items.field_151016_H,
      Items.field_151055_y,
      Items.field_151055_y
   };
   ...
   public EntityWitch(World var1) {
      ...
      this.field_70714_bg.func_75776_a(2, new EntityAIArrowAttack(this, 1.0, 60, 10.0F));
      ...
      if (!this.field_70170_p.field_72995_K) {
         if (this.func_82198_m()) {
            if (this.field_82200_e-- <= 0) {
               ...
               ItemStack var5 = this.func_70694_bm();
               this.func_70062_b(0, null);
               if (var5 != null && var5.func_77973_b() == Items.field_151068_bn) {
                  List var6 = Items.field_151068_bn.func_77832_l(var5);
                  if (var6 != null) {
            ...
            if (this.field_70146_Z.nextFloat() < 0.15F && this.func_70055_a(Material.field_151586_h) && !this.func_70644_a(Potion.field_76427_o)) {
               ...
               && !this.func_70644_a(Potion.field_76424_c)
      ...
      if (var1 == 15) {
         for(int var2 = 0; var2 < this.field_70146_Z.nextInt(35) + 10; ++var2) {
            this.field_70170_p
               .func_72869_a(
                  "witchMagic",
                  this.field_70165_t + this.field_70146_Z.nextGaussian() * 0.12999999523162842,
                  this.field_70121_D.field_72337_e + 0.5 + this.field_70146_Z.nextGaussian() * 0.12999999523162842,
                  this.field_70161_v + this.field_70146_Z.nextGaussian() * 0.12999999523162842,
                  0.0,
                  0.0,
                  0.0
               );
   ...
   public void func_82196_d(EntityLivingBase var1, float var2) {
      if (!this.func_82198_m()) {
         ...
         double var4 = var1.field_70165_t + var1.field_70159_w - this.field_70165_t;
         double var6 = var1.field_70163_u + (double)var1.func_70047_e() - 1.100000023841858 - this.field_70163_u;
         double var8 = var1.field_70161_v + var1.field_70179_y - this.field_70161_v;
         float var10 = MathHelper.func_76133_a(var4 * var4 + var8 * var8);
         if (var10 >= 8.0F && !var1.func_70644_a(Potion.field_76421_d)) {
            var3.func_82340_a(32698);
         } else if (var1.func_110143_aJ() >= 8.0F && !var1.func_70644_a(Potion.field_76436_u)) {
            var3.func_82340_a(32660);
         } else if (var10 <= 3.0F && !var1.func_70644_a(Potion.field_76437_t) && this.field_70146_Z.nextFloat() < 0.25F) {
