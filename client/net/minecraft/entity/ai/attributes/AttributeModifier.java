...
public class AttributeModifier {
   ...
   public String toString() {
      return "AttributeModifier{amount=" + this.field_111174_a + ", operation=" + this.field_111172_b + ", name='" + (String)this.field_111173_c.get() + '\'' + ", id=" + this.field_111170_d + ", serialize=" + this.field_111171_e + '}';
   }
}
