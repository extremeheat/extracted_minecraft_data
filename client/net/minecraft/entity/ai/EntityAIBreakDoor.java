...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
   ...
   public boolean func_75253_b() {
      ...
      return this.field_75359_i <= 240 && !this.func_195922_f() && var1 < 4.0D;
   }
   ...
   public void func_75246_d() {
      ...
      if (this.field_75359_i == 240 && this.field_75356_a.field_70170_p.func_175659_aa() == EnumDifficulty.HARD) {
         ...
         this.field_75356_a.field_70170_p.func_175718_b(2001, this.field_179507_b, Block.func_196246_j(this.field_75356_a.field_70170_p.func_180495_p(this.field_179507_b)));
      }
