...
public class EntityAIFollowGolem extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75294_a.func_70874_b() >= 0) {
         ...
         List var1 = this.field_75294_a.field_70170_p.func_72872_a(EntityIronGolem.class, this.field_75294_a.field_70121_D.func_72314_b(6.0, 2.0, 6.0));
         if (var1.isEmpty()) {
            return false;
         } else {
   ...
   public void func_75246_d() {
      ...
      if (this.field_75292_b.func_70853_p() == this.field_75293_c) {
         this.field_75294_a.func_70661_as().func_75497_a(this.field_75292_b, 0.5);
         this.field_75291_d = true;
      }

      if (this.field_75291_d && this.field_75294_a.func_70068_e(this.field_75292_b) < 4.0) {
