...
public class EntityAIMoveIndoors extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      ...
      if ((!this.field_75424_a.field_70170_p.func_72935_r() || this.field_75424_a.field_70170_p.func_72896_J() && this.field_75424_a.field_70170_p.func_180494_b(var1).func_201851_b() != Biome.RainType.RAIN) && this.field_75424_a.field_70170_p.field_73011_w.func_191066_m()) {
   ...
   public void func_75249_e() {
      ...
      if (this.field_75424_a.func_174818_b(var1) > 256.0D) {
         Vec3d var5 = RandomPositionGenerator.func_75464_a(this.field_75424_a, 14, 3, new Vec3d((double)var2 + 0.5D, (double)var3, (double)var4 + 0.5D));
         if (var5 != null) {
