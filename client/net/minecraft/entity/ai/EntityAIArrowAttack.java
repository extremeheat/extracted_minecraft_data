...
public class EntityAIArrowAttack extends EntityAIBase {
   ...
   public void func_75246_d() {
      double var1 = this.field_75322_b
         .func_70092_e(this.field_75323_c.field_70165_t, this.field_75323_c.field_70121_D.field_72338_b, this.field_75323_c.field_70161_v);
      ...
      if (--this.field_75320_d == 0) {
         ...
         float var4 = MathHelper.func_76133_a(var1) / this.field_96562_i;
         float var5 = var4;
         if (var4 < 0.1F) {
            var5 = 0.1F;
         }
         ...
         float var6 = MathHelper.func_76133_a(var1) / this.field_96562_i;
         this.field_75320_d = MathHelper.func_76141_d(var6 * (float)(this.field_75325_h - this.field_96561_g) + (float)this.field_96561_g);
      }
   }
}
