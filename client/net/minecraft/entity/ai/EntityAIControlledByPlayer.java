...
public class EntityAIControlledByPlayer extends EntityAIBase {
   ...
   public EntityAIControlledByPlayer(EntityLiving var1, float var2) {
      super();
      this.field_82640_a = var1;
      this.field_82638_b = var2;
      this.func_75248_a(7);
   }
   ...
   public boolean func_75250_a() {
      return this.field_82640_a.func_70089_S()
         && this.field_82640_a.field_70153_n != null
         && this.field_82640_a.field_70153_n instanceof EntityPlayer
         && (this.field_82636_d || this.field_82640_a.func_82171_bF());
   }
   ...
   public void func_75246_d() {
      ...
      if (this.field_82640_a.field_70122_E) {
         var8 = this.field_82640_a
               .field_70170_p
               .func_147439_a(MathHelper.func_76141_d((float)var4), MathHelper.func_76141_d((float)var5) - 1, MathHelper.func_76141_d((float)var6))
               .field_149765_K
            * 0.91F;
      }
      ...
      PathPoint var19 = new PathPoint(
         MathHelper.func_76141_d(this.field_82640_a.field_70130_N + 1.0F),
         MathHelper.func_76141_d(this.field_82640_a.field_70131_O + var1.field_70131_O + 1.0F),
         MathHelper.func_76141_d(this.field_82640_a.field_70130_N + 1.0F)
      );
      if (var4 != var17 || var6 != var18) {
         Block var20 = this.field_82640_a.field_70170_p.func_147439_a(var4, var5, var6);
         boolean var21 = !this.func_151498_a(var20)
            && (var20.func_149688_o() != Material.field_151579_a || !this.func_151498_a(this.field_82640_a.field_70170_p.func_147439_a(var4, var5 - 1, var6)));
         if (var21
            && PathFinder.func_82565_a(this.field_82640_a, var17, var5, var18, var19, false, false, true) == 0
            && PathFinder.func_82565_a(this.field_82640_a, var4, var5 + 1, var6, var19, false, false, true) == 1
            && PathFinder.func_82565_a(this.field_82640_a, var17, var5 + 1, var18, var19, false, false, true) == 1) {
            var2.func_70683_ar().func_75660_a();
         }
      }

      if (!var1.field_71075_bZ.field_75098_d
         && this.field_82639_c >= this.field_82638_b * 0.5F
         && this.field_82640_a.func_70681_au().nextFloat() < 0.006F
         && !this.field_82636_d) {
         ItemStack var23 = var1.func_70694_bm();
         if (var23 != null && var23.func_77973_b() == Items.field_151146_bM) {
            var23.func_77972_a(1, var1);
            if (var23.field_77994_a == 0) {
               ItemStack var24 = new ItemStack(Items.field_151112_aM);
               var24.func_77982_d(var23.field_77990_d);
               var1.field_71071_by.field_70462_a[var1.field_71071_by.field_70461_c] = var24;
            }
         }
      }
   ...
   private boolean func_151498_a(Block var1) {
      return var1.func_149645_b() == 10 || var1 instanceof BlockSlab;
   }
