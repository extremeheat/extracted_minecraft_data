...
public class EntityAIMoveThroughVillage extends EntityAIBase {
         ...
         if (var1 == null) {
            ...
            if (this.field_75416_d == null) {
               ...
               if (this.field_75419_c != null) {
                  ...
                  Vec3d var4 = RandomPositionGenerator.func_75464_a(this.field_75420_a, 10, 7, new Vec3d((double)this.field_75416_d.func_179852_d().func_177958_n(), (double)this.field_75416_d.func_179852_d().func_177956_o(), (double)this.field_75416_d.func_179852_d().func_177952_p()));
                  if (var4 == null) {
                     return false;
                  } else {
                     var2.func_179688_b(false);
   ...
   private boolean func_75413_a(VillageDoorInfo var1) {
      ...
      } while(!var1.func_179852_d().equals(var3.func_179852_d()));
