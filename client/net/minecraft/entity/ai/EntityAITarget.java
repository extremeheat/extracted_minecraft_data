...
public abstract class EntityAITarget extends EntityAIBase {
      ...
      if (var1 == null) {
         ...
         if (var2 != null && var3 == var2) {
            ...
            if (this.field_75299_d.func_70068_e(var1) > var4 * var4) {
               ...
               if (var1 instanceof EntityPlayer && ((EntityPlayer)var1).field_71075_bZ.field_75102_a) {
                  return false;
               } else {
                  this.field_75299_d.func_70624_b(var1);
                  return true;
               }
            }
         }
   ...
   public static boolean func_179445_a(EntityLiving var0, @Nullable EntityLivingBase var1, boolean var2, boolean var3) {
      if (var1 == null) {
         ...
         return false;
      } else if (var0.func_184191_r(var1)) {
         return false;
      } else {
         if (var0 instanceof IEntityOwnable && ((IEntityOwnable)var0).func_184753_b() != null) {
            if (var1 instanceof IEntityOwnable && ((IEntityOwnable)var0).func_184753_b().equals(((IEntityOwnable)var1).func_184753_b())) {
               return false;
            }
   ...
   private boolean func_75295_a(EntityLivingBase var1) {
      ...
      Path var2 = this.field_75299_d.func_70661_as().func_75494_a(var1);
      if (var2 == null) {
         return false;
      } else {
