      ...
      this.field_179443_c = new Predicate<EntityLivingBase>() {
         public boolean apply(EntityLivingBase var1) {
            ...
            if (var1.func_82150_aj()) {
               ...
               return (double)var1.func_70032_d(EntityAIFindEntityNearest.this.field_179442_b) > var2 ? false : EntityAITarget.func_179445_a(EntityAIFindEntityNearest.this.field_179442_b, var1, false, true);
            }
         }
