...
public class EntityLookHelper {
   ...
   public void func_75651_a(Entity var1, float var2, float var3) {
      ...
      if (var1 instanceof EntityLivingBase) {
         ...
         this.field_75653_f = (var1.field_70121_D.field_72338_b + var1.field_70121_D.field_72337_e) / 2.0;
      }
   ...
   public void func_75649_a() {
      ...
      if (this.field_75655_d) {
         ...
         float var9 = (float)(Math.atan2(var5, var1) * 180.0 / 3.1415927410125732) - 90.0F;
         float var10 = (float)(-(Math.atan2(var3, var7) * 180.0 / 3.1415927410125732));
