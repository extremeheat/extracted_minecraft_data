...
public class EntityAIAttackRangedBow<T extends EntityMob & IRangedAttackMob> extends EntityAIBase {
   ...
   public EntityAIAttackRangedBow(T var1, double var2, int var4, float var5) {
      super();
      this.field_188499_a = var1;
      this.field_188500_b = var2;
      this.field_188501_c = var4;
      this.field_188502_d = var5 * var5;
      this.func_75248_a(3);
   }

   public void func_189428_b(int var1) {
      this.field_188501_c = var1;
   }
   ...
   public void func_75246_d() {
      EntityLivingBase var1 = this.field_188499_a.func_70638_az();
      if (var1 != null) {
         double var2 = this.field_188499_a.func_70092_e(var1.field_70165_t, var1.func_174813_aQ().field_72338_b, var1.field_70161_v);
         boolean var4 = this.field_188499_a.func_70635_at().func_75522_a(var1);
         boolean var5 = this.field_188504_f > 0;
         if (var4 != var5) {
            this.field_188504_f = 0;
         }
         ...
         if (var2 <= (double)this.field_188502_d && this.field_188504_f >= 20) {
            this.field_188499_a.func_70661_as().func_75499_g();
            ++this.field_188507_i;
         } else {
            this.field_188499_a.func_70661_as().func_75497_a(var1, this.field_188500_b);
         ...
         if (this.field_188507_i > -1) {
            if (var2 > (double)(this.field_188502_d * 0.75F)) {
               this.field_188506_h = false;
            } else if (var2 < (double)(this.field_188502_d * 0.25F)) {
            ...
            this.field_188499_a.func_70625_a(var1, 30.0F, 30.0F);
         } else {
            this.field_188499_a.func_70671_ap().func_75651_a(var1, 30.0F, 30.0F);
         }

         if (this.field_188499_a.func_184587_cr()) {
            if (!var4 && this.field_188504_f < -60) {
               this.field_188499_a.func_184602_cy();
            } else if (var4) {
               int var6 = this.field_188499_a.func_184612_cw();
               if (var6 >= 20) {
                  this.field_188499_a.func_184602_cy();
                  ((IRangedAttackMob)this.field_188499_a).func_82196_d(var1, ItemBow.func_185059_b(var6));
