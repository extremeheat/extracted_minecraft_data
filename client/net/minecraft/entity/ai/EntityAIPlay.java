...
public class EntityAIPlay extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75262_a.func_70874_b() >= 0) {
         ...
         if (this.field_75260_b == null) {
            Vec3d var8 = RandomPositionGenerator.func_75463_a(this.field_75262_a, 16, 3);
            if (var8 == null) {
               return false;
            }
         }
   ...
   public void func_75246_d() {
      ...
      if (this.field_75260_b != null) {
         ...
         Vec3d var1 = RandomPositionGenerator.func_75463_a(this.field_75262_a, 16, 3);
         if (var1 == null) {
            return;
         }
