...
public class EntityAIMoveTowardsTarget extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      ...
      if (this.field_75429_b == null) {
         ...
         Vec3 var1 = RandomPositionGenerator.func_75464_a(
            this.field_75431_a, 16, 7, Vec3.func_72443_a(this.field_75429_b.field_70165_t, this.field_75429_b.field_70163_u, this.field_75429_b.field_70161_v)
         );
         if (var1 == null) {
            return false;
         } else {
   ...
   public boolean func_75253_b() {
      return !this.field_75431_a.func_70661_as().func_75500_f()
         && this.field_75429_b.func_70089_S()
         && this.field_75429_b.func_70068_e(this.field_75431_a) < (double)(this.field_75426_g * this.field_75426_g);
   }
