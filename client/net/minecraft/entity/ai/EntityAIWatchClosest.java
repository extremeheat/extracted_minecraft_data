   ...
   public boolean func_75250_a() {
      if (this.field_75332_b.func_70681_au().nextFloat() >= this.field_75331_e) {
         ...
         if (this.field_75329_f == EntityPlayer.class) {
            this.field_75334_a = this.field_75332_b.field_70170_p.func_190525_a(this.field_75332_b.field_70165_t, this.field_75332_b.field_70163_u, this.field_75332_b.field_70161_v, (double)this.field_75333_c, EntitySelectors.field_180132_d.and(EntitySelectors.func_200820_b(this.field_75332_b)));
         } else {
