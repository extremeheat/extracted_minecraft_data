...
public class EntityAIWatchClosest extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75332_b.func_70681_au().nextFloat() >= this.field_75331_e) {
         ...
         if (this.field_75329_f == EntityPlayer.class) {
            ...
            this.field_75334_a = this.field_75332_b
               .field_70170_p
               .func_72857_a(
                  this.field_75329_f,
                  this.field_75332_b.field_70121_D.func_72314_b((double)this.field_75333_c, 3.0, (double)this.field_75333_c),
                  this.field_75332_b
               );
         }
   ...
   public void func_75246_d() {
      this.field_75332_b
         .func_70671_ap()
         .func_75650_a(
            this.field_75334_a.field_70165_t,
            this.field_75334_a.field_70163_u + (double)this.field_75334_a.func_70047_e(),
            this.field_75334_a.field_70161_v,
            10.0F,
            (float)this.field_75332_b.func_70646_bf()
         );
      --this.field_75330_d;
   }
}
