...
public class EntityAIEatGrass extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_151500_b.func_70681_au().nextInt(this.field_151500_b.func_70631_g_() ? 50 : 1000) != 0) {
         ...
         if (field_179505_b.apply(this.field_151501_c.func_180495_p(var1))) {
            ...
            return this.field_151501_c.func_180495_p(var1.func_177977_b()).func_177230_c() == Blocks.field_150349_c;
         }
      }
   }
   ...
   static {
      field_179505_b = BlockStateHelper.func_177638_a(Blocks.field_150329_H).func_177637_a(BlockTallGrass.field_176497_a, Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
   }
}
