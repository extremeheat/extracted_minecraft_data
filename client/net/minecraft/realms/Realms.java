...
public class Realms {
   ...
   public static <V> CompletableFuture<V> execute(Supplier<V> var0) {
   ...
   public static void narrateNow(Iterable<String> var0) {
      narrateNow(joinNarrations(var0));
   }

   public static String joinNarrations(Iterable<String> var0) {
