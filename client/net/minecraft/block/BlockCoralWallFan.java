...
public class BlockCoralWallFan extends BlockCoralWallFanDead {
   ...
   public void func_196267_b(IBlockState var1, World var2, BlockPos var3, Random var4) {
      if (!func_212557_b_(var1, var2, var3)) {
         var2.func_180501_a(var3, (IBlockState)((IBlockState)this.field_211886_c.func_176223_P().func_206870_a(field_212560_b, false)).func_206870_a(field_211884_b, var1.func_177229_b(field_211884_b)), 2);
      }

   }

   public IBlockState func_196271_a(IBlockState var1, EnumFacing var2, IBlockState var3, IWorld var4, BlockPos var5, BlockPos var6) {
      if (var2.func_176734_d() == var1.func_177229_b(field_211884_b) && !var1.func_196955_c(var4, var5)) {
