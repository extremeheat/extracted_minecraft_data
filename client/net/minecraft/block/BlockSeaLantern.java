...
public class BlockSeaLantern extends Block {
   public BlockSeaLantern(Block.Properties var1) {
      super(var1);
   }

   public int func_196251_a(IBlockState var1, int var2, World var3, BlockPos var4, Random var5) {
      return MathHelper.func_76125_a(this.func_196264_a(var1, var5) + var5.nextInt(var2 + 1), 1, 5);
   }
