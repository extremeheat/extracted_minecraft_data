...
public class BlockOldLog extends BlockLog {
   public static final PropertyEnum<BlockPlanks.EnumType> field_176301_b = PropertyEnum.func_177708_a("variant", BlockPlanks.EnumType.class, new Predicate<BlockPlanks.EnumType>() {
   ...
   public MapColor func_180659_g(IBlockState var1) {
      BlockPlanks.EnumType var2 = (BlockPlanks.EnumType)var1.func_177229_b(field_176301_b);
   ...
   public IBlockState func_176203_a(int var1) {
      IBlockState var2 = this.func_176223_P().func_177226_a(field_176301_b, BlockPlanks.EnumType.func_176837_a((var1 & 3) % 4));
      switch(var1 & 12) {
      case 0:
   ...
   public int func_176201_c(IBlockState var1) {
      byte var2 = 0;
      int var3 = var2 | ((BlockPlanks.EnumType)var1.func_177229_b(field_176301_b)).func_176839_a();
      switch((BlockLog.EnumAxis)var1.func_177229_b(field_176299_a)) {
      case X:
         var3 |= 4;
         break;
   ...
   protected ItemStack func_180643_i(IBlockState var1) {
      return new ItemStack(Item.func_150898_a(this), 1, ((BlockPlanks.EnumType)var1.func_177229_b(field_176301_b)).func_176839_a());
   }

   public int func_180651_a(IBlockState var1) {
      return ((BlockPlanks.EnumType)var1.func_177229_b(field_176301_b)).func_176839_a();
   }
}
