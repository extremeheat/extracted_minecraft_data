...
public class CommandDebug extends CommandBase {
   ...
   private void func_147205_a(long var1, int var3) {
      File var4 = new File(
         MinecraftServer.func_71276_C().func_71209_f("debug"), "profile-results-" + new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss").format(new Date()) + ".txt"
      );
   ...
   private String func_147204_b(long var1, int var3) {
      ...
      var4.append("// This is approximately ")
         .append(String.format("%.2f", (float)var3 / ((float)var1 / 1000.0F)))
