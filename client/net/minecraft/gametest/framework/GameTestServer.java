...
public class GameTestServer extends MinecraftServer {
   ...
   public static GameTestServer create(Thread var0, LevelStorageSource.LevelStorageAccess var1, PackRepository var2, Collection<GameTestBatch> var3, BlockPos var4) {
      if (var3.isEmpty()) {
         ...
         try {
            ...
            WorldStem var8 = (WorldStem)Util.blockUntilDone((var1x) -> {
               return WorldStem.load(var6, (var0, var1) -> {
                  RegistryAccess.Frozen var2 = (RegistryAccess.Frozen)RegistryAccess.BUILTIN.get();
                  WorldGenSettings var3 = ((WorldPreset)var2.registryOrThrow(Registry.WORLD_PRESET_REGISTRY).getHolderOrThrow(WorldPresets.FLAT).value()).createWorldGenSettings(0L, false, false);
                  PrimaryLevelData var4 = new PrimaryLevelData(TEST_SETTINGS, var3, Lifecycle.stable());
                  return Pair.of(var4, var2);
               }, Util.backgroundExecutor(), var1x);
            }).get();
            var7.stop();
   ...
   static {
      NO_SERVICES = new Services((MinecraftSessionService)null, SignatureValidator.NO_VALIDATION, (GameProfileRepository)null, (GameProfileCache)null);
