...
public class TestCommand {
   ...
   private static int clearAllTests(CommandSourceStack var0, int var1) {
      ServerLevel var2 = var0.getLevel();
      GameTestRunner.clearMarkers(var2);
      BlockPos var3 = new BlockPos(var0.getPosition().field_414, (double)var0.getLevel().getHeightmapPos(Heightmap.Types.WORLD_SURFACE, new BlockPos(var0.getPosition())).getY(), var0.getPosition().field_416);
