...
public record TestData<EnvironmentType>(EnvironmentType environment, ResourceLocation structure, int maxTicks, int setupTicks, boolean required, Rotation rotation, boolean manualOnly, int maxAttempts, int requiredSuccesses, boolean skyAccess) {
   public static final MapCodec<TestData<Holder<TestEnvironmentDefinition>>> CODEC = RecordCodecBuilder.mapCodec((var0) -> var0.group(TestEnvironmentDefinition.CODEC.fieldOf("batch").forGetter(TestData::environment), ResourceLocation.CODEC.fieldOf("structure").forGetter(TestData::structure), ExtraCodecs.POSITIVE_INT.fieldOf("max_ticks").forGetter(TestData::maxTicks), ExtraCodecs.NON_NEGATIVE_INT.optionalFieldOf("setup_ticks", 0).forGetter(TestData::setupTicks), Codec.BOOL.optionalFieldOf("required", true).forGetter(TestData::required), Rotation.CODEC.optionalFieldOf("rotation", Rotation.NONE).forGetter(TestData::rotation), Codec.BOOL.optionalFieldOf("manual_only", false).forGetter(TestData::manualOnly), ExtraCodecs.POSITIVE_INT.optionalFieldOf("max_attempts", 1).forGetter(TestData::maxAttempts), ExtraCodecs.POSITIVE_INT.optionalFieldOf("required_successes", 1).forGetter(TestData::requiredSuccesses), Codec.BOOL.optionalFieldOf("sky_accesss", false).forGetter(TestData::skyAccess)).apply(var0, TestData::new));

   public TestData(EnvironmentType var1, ResourceLocation var2, int var3, int var4, boolean var5, Rotation var6) {
      this(var1, var2, var3, var4, var5, var6, false, 1, 1, false);
   }

   public TestData(EnvironmentType var1, ResourceLocation var2, int var3, int var4, boolean var5) {
      this(var1, var2, var3, var4, var5, Rotation.NONE);
   }

   public TestData(EnvironmentType var1, ResourceLocation var2, int var3, int var4, boolean var5, Rotation var6, boolean var7, int var8, int var9, boolean var10) {
      super();
