...
public class RegistryLoader {
   ...
   public <E> DataResult<? extends Registry<E>> overrideRegistryFromResources(WritableRegistry<E> var1, ResourceKey<? extends Registry<E>> var2, Codec<E> var3, DynamicOps<JsonElement> var4) {
      ...
      Map.Entry var8;
      for(Iterator var7 = var5.entrySet().iterator(); var7.hasNext(); var6 = var6.flatMap((var5x) -> {
         return this.overrideElementFromResources(var5x, var2, var3, (ResourceKey)var8.getKey(), Optional.of((RegistryResourceAccess.EntryThunk)var8.getValue()), var4).map((var1) -> {
            return var5x;
         });
      })) {
   ...
   private <E> DataResult<Holder<E>> overrideElementFromResources(WritableRegistry<E> var1, ResourceKey<? extends Registry<E>> var2, Codec<E> var3, ResourceKey<E> var4, Optional<RegistryResourceAccess.EntryThunk<E>> var5, DynamicOps<JsonElement> var6) {
      ReadCache var7 = this.readCache(var2);
   ...
   private <E> ReadCache<E> readCache(ResourceKey<? extends Registry<E>> var1) {
      return (ReadCache)this.readCache.computeIfAbsent(var1, (var0) -> {
         return new ReadCache();
      });
   }

   public Bound bind(RegistryAccess.Writable var1) {
      return new Bound(var1, this);
   }
