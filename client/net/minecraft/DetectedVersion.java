...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(final String id, final String name, final boolean stable) {
      return new WorldVersion.Simple(id, name, new DataVersion(4890, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(86, 2), PackFormat.of(105, 0), new Date(), stable);
   }
