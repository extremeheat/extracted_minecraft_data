...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(final String id, final String name, final boolean stable) {
      return new WorldVersion.Simple(id, name, new DataVersion(4774, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(80, 0), PackFormat.of(99, 0), new Date(), stable);
   }
