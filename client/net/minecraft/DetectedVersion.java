...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(final String id, final String name, final boolean stable) {
      return new WorldVersion.Simple(id, name, new DataVersion(4775, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(81, 0), PackFormat.of(99, 1), new Date(), stable);
   }
