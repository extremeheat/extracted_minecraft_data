...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(String var0, String var1, boolean var2) {
      return new WorldVersion.Simple(var0, var1, new DataVersion(4542, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(67, 0), PackFormat.of(85, 0), new Date(), var2);
   }
