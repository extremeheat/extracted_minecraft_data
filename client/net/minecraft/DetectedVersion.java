...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(final String id, final String name, final boolean stable) {
      return new WorldVersion.Simple(id, name, new DataVersion(5011, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(96, 0), PackFormat.of(117, 0), new Date(), stable);
   }
