...
public class DetectedVersion {
   ...
   private static WorldVersion createFromConstants() {
      return new WorldVersion.Simple(UUID.randomUUID().toString().replaceAll("-", ""), "25w15a", new DataVersion(4422, "main"), SharedConstants.getProtocolVersion(), 56, 72, new Date(), false);
   }
