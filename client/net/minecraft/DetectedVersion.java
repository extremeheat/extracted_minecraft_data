...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(final String id, final String name, final boolean stable) {
      return new WorldVersion.Simple(id, name, new DataVersion(4776, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(81, 1), PackFormat.of(99, 2), new Date(), stable);
   }
