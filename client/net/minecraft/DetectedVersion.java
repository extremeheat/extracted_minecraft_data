...
public class DetectedVersion {
   ...
   public static WorldVersion createBuiltIn(final String id, final String name, final boolean stable) {
      return new WorldVersion.Simple(id, name, new DataVersion(4883, "main"), SharedConstants.getProtocolVersion(), PackFormat.of(85, 0), PackFormat.of(101, 2), new Date(), stable);
   }
