...
public class ItemPickaxe extends ItemTool {
   ...
   public boolean func_150897_b(Block var1) {
      ...
      } else if (var1 == Blocks.field_150412_bA || var1 == Blocks.field_150475_bE) {
         return this.field_77862_b.func_77996_d() >= 2;
      } else if (var1 == Blocks.field_150340_R || var1 == Blocks.field_150352_o) {
         return this.field_77862_b.func_77996_d() >= 2;
      } else if (var1 == Blocks.field_150339_S || var1 == Blocks.field_150366_p) {
         return this.field_77862_b.func_77996_d() >= 1;
      } else if (var1 == Blocks.field_150368_y || var1 == Blocks.field_150369_x) {
         return this.field_77862_b.func_77996_d() >= 1;
      } else if (var1 != Blocks.field_150450_ax && var1 != Blocks.field_150439_ay) {
   ...
   public float func_150893_a(ItemStack var1, Block var2) {
      return var2.func_149688_o() != Material.field_151573_f
            && var2.func_149688_o() != Material.field_151574_g
            && var2.func_149688_o() != Material.field_151576_e
         ? super.func_150893_a(var1, var2)
         : this.field_77864_a;
   }
}
