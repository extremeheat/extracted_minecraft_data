...
public final class ItemStack {
   ...
   public boolean func_77943_a(EntityPlayer var1, World var2, int var3, int var4, int var5, int var6, float var7, float var8, float var9) {
      boolean var10 = this.func_77973_b().func_77648_a(this, var1, var2, var3, var4, var5, var6, var7, var8, var9);
      if (var10) {
         var1.func_71064_a(StatList.field_75929_E[Item.func_150891_b(this.field_151002_e)], 1);
      }
   ...
   public NBTTagCompound func_77955_b(NBTTagCompound var1) {
      var1.func_74777_a("id", (short)Item.func_150891_b(this.field_151002_e));
   ...
   public boolean func_77984_f() {
      if (this.field_151002_e.func_77612_l() <= 0) {
         return false;
      } else {
   ...
   public void func_77961_a(EntityLivingBase var1, EntityPlayer var2) {
      ...
      if (var3) {
         var2.func_71064_a(StatList.field_75929_E[Item.func_150891_b(this.field_151002_e)], 1);
      }
   }

   public void func_150999_a(World var1, Block var2, int var3, int var4, int var5, EntityPlayer var6) {
      boolean var7 = this.field_151002_e.func_150894_a(this, var1, var2, var3, var4, var5, var6);
      if (var7) {
         var6.func_71064_a(StatList.field_75929_E[Item.func_150891_b(this.field_151002_e)], 1);
      }
   }
   ...
   public static boolean func_77970_a(ItemStack var0, ItemStack var1) {
      if (var0 == null && var1 == null) {
         ...
         return false;
      } else if (var0.field_77990_d == null && var1.field_77990_d != null) {
         return false;
      } else {
   ...
   public boolean func_77969_a(ItemStack var1) {
      return this.field_151002_e == var1.field_151002_e && this.field_77991_e == var1.field_77991_e;
   }
   ...
   public List func_82840_a(EntityPlayer var1, boolean var2) {
      ...
      if (this.func_77942_o()) {
         NBTTagList var13 = this.func_77986_q();
         if (var13 != null) {
            for(int var15 = 0; var15 < var13.func_74745_c(); ++var15) {
               short var7 = var13.func_150305_b(var15).func_74765_d("id");
               short var8 = var13.func_150305_b(var15).func_74765_d("lvl");
               if (Enchantment.field_77331_b[var7] != null) {
                  var3.add(Enchantment.field_77331_b[var7].func_77316_c(var8));
               }
            }
         }
         ...
         if (this.field_77990_d.func_150297_b("display", 10)) {
            ...
            if (var16.func_150299_b("Lore") == 9) {
               NBTTagList var18 = var16.func_150295_c("Lore", 8);
      ...
      Multimap var14 = this.func_111283_C();
      if (!var14.isEmpty()) {
         var3.add("");

         for(Entry var19 : var14.entries()) {
            AttributeModifier var21 = (AttributeModifier)var19.getValue();
            double var9 = var21.func_111164_d();
            if (var21.func_111167_a() == Item.field_111210_e) {
            ...
            if (var9 > 0.0) {
               var3.add(
                  EnumChatFormatting.BLUE
                     + StatCollector.func_74837_a(
                        "attribute.modifier.plus." + var21.func_111169_c(),
                        field_111284_a.format(var11),
                        StatCollector.func_74838_a("attribute.name." + (String)var19.getKey())
                     )
               );
            } else if (var9 < 0.0) {
               var11 *= -1.0;
               var3.add(
                  EnumChatFormatting.RED
                     + StatCollector.func_74837_a(
                        "attribute.modifier.take." + var21.func_111169_c(),
                        field_111284_a.format(var11),
                        StatCollector.func_74838_a("attribute.name." + (String)var19.getKey())
                     )
               );
      ...
      if (this.func_77942_o() && this.field_77990_d.func_150297_b("AttributeModifiers", 9)) {
         ...
         for(int var3 = 0; var3 < var2.func_74745_c(); ++var3) {
            ...
            if (var5.func_111167_a().getLeastSignificantBits() != 0L && var5.func_111167_a().getMostSignificantBits() != 0L) {
               var1.put(var4.func_74779_i("AttributeName"), var5);
            }
         }
      } else {
