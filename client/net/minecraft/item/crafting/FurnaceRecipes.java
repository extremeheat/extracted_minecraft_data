...
public class FurnaceRecipes {
   ...
   private FurnaceRecipes() {
      ...
      for(ItemFishFood$FishType var4 : ItemFishFood$FishType.values()) {
         if (var4.func_150973_i()) {
            this.func_151394_a(
               new ItemStack(Items.field_151115_aP, 1, var4.func_150976_a()), new ItemStack(Items.field_151101_aQ, 1, var4.func_150976_a()), 0.35F
            );
         }
      }
   ...
   public ItemStack func_151395_a(ItemStack var1) {
      for(Entry var3 : this.field_77604_b.entrySet()) {
   ...
   public float func_151398_b(ItemStack var1) {
      for(Entry var3 : this.field_77605_c.entrySet()) {
         if (this.func_151397_a(var1, (ItemStack)var3.getKey())) {
