...
public class SlotMerchantResult extends Slot {
   ...
   public ItemStack func_75209_a(int var1) {
      if (this.func_75216_d()) {
         this.field_75231_g += Math.min(var1, this.func_75211_c().field_77994_a);
      }
   ...
   public void func_82870_a(EntityPlayer var1, ItemStack var2) {
      ...
      if (var3 != null) {
         ...
         if (this.func_75230_a(var3, var4, var5) || this.func_75230_a(var3, var5, var4)) {
            ...
            var1.func_71029_a(StatList.field_180206_G);
   ...
   private boolean func_75230_a(MerchantRecipe var1, ItemStack var2, ItemStack var3) {
      ...
      if (var2 != null && var2.func_77973_b() == var4.func_77973_b()) {
         if (var5 != null && var3 != null && var5.func_77973_b() == var3.func_77973_b()) {
            var2.field_77994_a -= var4.field_77994_a;
            var3.field_77994_a -= var5.field_77994_a;
            return true;
         }
