...
public class ContainerEnchantment extends Container {
   ...
   public ContainerEnchantment(InventoryPlayer var1, World var2, BlockPos var3) {
      super();
      this.field_75168_e = new InventoryBasic(new TextComponentString("Enchant"), 2) {
      ...
      this.func_75146_a(new Slot(this.field_75168_e, 1, 35, 47) {
         public boolean func_75214_a(ItemStack var1) {
            return var1.func_77973_b() == Items.field_196128_bn;
         }
      });
   ...
   protected void func_185000_c(IContainerListener var1) {
      ...
      var1.func_71112_a(this, 4, this.field_185001_h[0]);
      var1.func_71112_a(this, 5, this.field_185001_h[1]);
      var1.func_71112_a(this, 6, this.field_185001_h[2]);
      var1.func_71112_a(this, 7, this.field_185002_i[0]);
      var1.func_71112_a(this, 8, this.field_185002_i[1]);
      var1.func_71112_a(this, 9, this.field_185002_i[2]);
   }

   public void func_75132_a(IContainerListener var1) {
      super.func_75132_a(var1);
      this.func_185000_c(var1);
   }
   ...
   public void func_75137_b(int var1, int var2) {
      if (var1 >= 0 && var1 <= 2) {
         ...
         this.field_185001_h[var1 - 4] = var2;
      } else if (var1 >= 7 && var1 <= 9) {
         this.field_185002_i[var1 - 7] = var2;
      } else {
   ...
   public void func_75130_a(IInventory var1) {
      if (var1 == this.field_75168_e) {
         ...
         int var3;
         if (!var2.func_190926_b() && var2.func_77956_u()) {
            if (!this.field_75172_h.field_72995_K) {
               ...
               for(var4 = 0; var4 < 3; ++var4) {
                  ...
                  this.field_185001_h[var4] = -1;
                  this.field_185002_i[var4] = -1;
               ...
               for(var4 = 0; var4 < 3; ++var4) {
                  if (this.field_75167_g[var4] > 0) {
                     ...
                     if (var7 != null && !var7.isEmpty()) {
                        ...
                        this.field_185001_h[var4] = IRegistry.field_212628_q.func_148757_b(var6.field_76302_b);
                        this.field_185002_i[var4] = var6.field_76303_c;
                     }
                  }
               }
            ...
            for(var3 = 0; var3 < 3; ++var3) {
               ...
               this.field_185001_h[var3] = -1;
               this.field_185002_i[var3] = -1;
            }
         }
      }
   ...
   public boolean func_75140_a(EntityPlayer var1, int var2) {
      ...
      int var5 = var2 + 1;
      if ((var4.func_190926_b() || var4.func_190916_E() < var5) && !var1.field_71075_bZ.field_75098_d) {
         return false;
      } else if (this.field_75167_g[var2] <= 0 || var3.func_190926_b() || (var1.field_71068_ca < var5 || var1.field_71068_ca < this.field_75167_g[var2]) && !var1.field_71075_bZ.field_75098_d) {
         return false;
      } else {
         if (!this.field_75172_h.field_72995_K) {
            List var6 = this.func_178148_a(var3, var2, this.field_75167_g[var2]);
            if (!var6.isEmpty()) {
               var1.func_192024_a(var3, var5);
               boolean var7 = var3.func_77973_b() == Items.field_151122_aG;
               if (var7) {
                  var3 = new ItemStack(Items.field_151134_bR);
                  this.field_75168_e.func_70299_a(0, var3);
               }

               for(int var8 = 0; var8 < var6.size(); ++var8) {
                  EnchantmentData var9 = (EnchantmentData)var6.get(var8);
                  if (var7) {
                     ItemEnchantedBook.func_92115_a(var3, var9);
                  } else {
               ...
               if (!var1.field_71075_bZ.field_75098_d) {
                  var4.func_190918_g(var5);
                  if (var4.func_190926_b()) {
                     this.field_75168_e.func_70299_a(1, ItemStack.field_190927_a);
                  }
               }

               var1.func_195066_a(StatList.field_188091_Y);
               if (var1 instanceof EntityPlayerMP) {
                  CriteriaTriggers.field_192129_i.func_192190_a((EntityPlayerMP)var1, var3, var5);
               }
   ...
   private List<EnchantmentData> func_178148_a(ItemStack var1, int var2, int var3) {
      ...
      List var4 = EnchantmentHelper.func_77513_b(this.field_75169_l, var1, var3, false);
      if (var1.func_77973_b() == Items.field_151122_aG && var4.size() > 1) {
   ...
   public int func_178147_e() {
      ...
      return var1.func_190926_b() ? 0 : var1.func_190916_E();
   }

   public void func_75134_a(EntityPlayer var1) {
      super.func_75134_a(var1);
      if (!this.field_75172_h.field_72995_K) {
         this.func_193327_a(var1, var1.field_70170_p, this.field_75168_e);
      }
   }
   ...
   public ItemStack func_82846_b(EntityPlayer var1, int var2) {
      ...
      if (var4 != null && var4.func_75216_d()) {
         ...
         if (var2 == 0) {
         ...
         } else if (var5.func_77973_b() == Items.field_196128_bn) {
            ...
            if (var5.func_77942_o() && var5.func_190916_E() == 1) {
               ((Slot)this.field_75151_b.get(0)).func_75215_d(var5.func_77946_l());
               var5.func_190920_e(0);
            } else if (!var5.func_190926_b()) {
               ((Slot)this.field_75151_b.get(0)).func_75215_d(new ItemStack(var5.func_77973_b()));
