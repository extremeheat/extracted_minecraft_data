...
public class SoundEvents {
   ...
   public static final SoundEvent ARMADILLO_HURT_REDUCED = register("entity.armadillo.hurt_reduced");
   ...
   public static final SoundEvent ARMADILLO_UNROLL_FINISH = register("entity.armadillo.unroll_finish");
   public static final SoundEvent ARMADILLO_PEEK = register("entity.armadillo.peek");
   public static final SoundEvent ARMADILLO_UNROLL_START = register("entity.armadillo.unroll_start");
   public static final SoundEvent ARMADILLO_BRUSH = register("entity.armadillo.brush");
   public static final Holder<SoundEvent> ARMOR_EQUIP_CHAIN = registerForHolder("item.armor.equip_chain");
   public static final Holder<SoundEvent> ARMOR_EQUIP_DIAMOND = registerForHolder("item.armor.equip_diamond");
   public static final Holder<SoundEvent> ARMOR_EQUIP_ELYTRA = registerForHolder("item.armor.equip_elytra");
   public static final Holder<SoundEvent> ARMOR_EQUIP_GENERIC = registerForHolder("item.armor.equip_generic");
   public static final Holder<SoundEvent> ARMOR_EQUIP_GOLD = registerForHolder("item.armor.equip_gold");
   public static final Holder<SoundEvent> ARMOR_EQUIP_IRON = registerForHolder("item.armor.equip_iron");
   ...
   public static final Holder.Reference<SoundEvent> ARMOR_EQUIP_NAUTILUS = registerForHolder("item.armor.equip_nautilus");
   ...
   public static final SoundEvent BABY_NAUTILUS_AMBIENT_ON_LAND = register("entity.baby_nautilus.ambient_land");
   public static final SoundEvent BABY_NAUTILUS_DEATH = register("entity.baby_nautilus.death");
   public static final SoundEvent BABY_NAUTILUS_DEATH_ON_LAND = register("entity.baby_nautilus.death_land");
   ...
   public static final SoundEvent BABY_NAUTILUS_HURT_ON_LAND = register("entity.baby_nautilus.hurt_land");
   ...
   public static final SoundEvent BOGGED_SHEAR = register("entity.bogged.shear");
   ...
   public static final SoundEvent BREEZE_SHOOT = register("entity.breeze.shoot");
   public static final SoundEvent BREEZE_JUMP = register("entity.breeze.jump");
   public static final SoundEvent BREEZE_LAND = register("entity.breeze.land");
   ...
   public static final Holder.Reference<SoundEvent> BREEZE_WIND_CHARGE_BURST = registerForHolder("entity.breeze.wind_burst");
   ...
   public static final SoundEvent COPPER_BULB_BREAK = register("block.copper_bulb.break");
   public static final SoundEvent COPPER_BULB_STEP = register("block.copper_bulb.step");
   public static final SoundEvent COPPER_BULB_PLACE = register("block.copper_bulb.place");
   public static final SoundEvent COPPER_BULB_HIT = register("block.copper_bulb.hit");
   public static final SoundEvent COPPER_BULB_FALL = register("block.copper_bulb.fall");
   public static final SoundEvent COPPER_BULB_TURN_ON = register("block.copper_bulb.turn_on");
   public static final SoundEvent COPPER_BULB_TURN_OFF = register("block.copper_bulb.turn_off");
   ...
   public static final SoundEvent COPPER_TRAPDOOR_CLOSE = register("block.copper_trapdoor.close");
   public static final SoundEvent COPPER_TRAPDOOR_OPEN = register("block.copper_trapdoor.open");
   ...
   public static final SoundEvent CREAKING_ATTACK = register("entity.creaking.attack");
   public static final SoundEvent CREAKING_DEATH = register("entity.creaking.death");
   public static final SoundEvent CREAKING_STEP = register("entity.creaking.step");
   public static final SoundEvent CREAKING_FREEZE = register("entity.creaking.freeze");
   ...
   public static final SoundEvent CREAKING_HEART_HURT = register("block.creaking_heart.hurt");
   public static final SoundEvent CREAKING_HEART_PLACE = register("block.creaking_heart.place");
   public static final SoundEvent CREAKING_HEART_STEP = register("block.creaking_heart.step");
   public static final SoundEvent CREAKING_HEART_IDLE = register("block.creaking_heart.idle");
   public static final SoundEvent CREAKING_HEART_SPAWN = register("block.creaking_heart.spawn");
   ...
   public static final SoundEvent DECORATED_POT_INSERT = register("block.decorated_pot.insert");
   public static final SoundEvent DECORATED_POT_INSERT_FAIL = register("block.decorated_pot.insert_fail");
   ...
   public static final SoundEvent GOLDEN_DANDELION_USE = register("item.golden_dandelion.use");
   public static final SoundEvent GOLDEN_DANDELION_UNUSE = register("item.golden_dandelion.unuse");
   ...
   public static final SoundEvent TRIAL_SPAWNER_BREAK = register("block.trial_spawner.break");
   public static final SoundEvent TRIAL_SPAWNER_STEP = register("block.trial_spawner.step");
   public static final SoundEvent TRIAL_SPAWNER_PLACE = register("block.trial_spawner.place");
   ...
   public static final SoundEvent HORSE_AMBIENT_BABY = register("entity.baby_horse.ambient");
   public static final SoundEvent HORSE_ANGRY = register("entity.horse.angry");
   public static final SoundEvent HORSE_ANGRY_BABY = register("entity.baby_horse.angry");
   ...
   public static final SoundEvent HORSE_BREATHE_BABY = register("entity.baby_horse.breathe");
   public static final SoundEvent HORSE_DEATH = register("entity.horse.death");
   public static final SoundEvent HORSE_DEATH_BABY = register("entity.baby_horse.death");
   public static final SoundEvent HORSE_EAT = register("entity.horse.eat");
   public static final SoundEvent HORSE_EAT_BABY = register("entity.baby_horse.eat");
   ...
   public static final SoundEvent HORSE_HURT_BABY = register("entity.baby_horse.hurt");
   ...
   public static final SoundEvent HORSE_LAND_BABY = register("entity.baby_horse.land");
   ...
   public static final SoundEvent HORSE_STEP_BABY = register("entity.baby_horse.step");
   ...
   public static final Holder<SoundEvent> LUNGE_1 = registerForHolder("item.spear.lunge_1");
   public static final Holder<SoundEvent> LUNGE_2 = registerForHolder("item.spear.lunge_2");
   public static final Holder<SoundEvent> LUNGE_3 = registerForHolder("item.spear.lunge_3");
   ...
   public static final SoundEvent NAUTILUS_DASH = register("entity.nautilus.dash");
   public static final SoundEvent NAUTILUS_DASH_ON_LAND = register("entity.nautilus.dash_land");
   public static final SoundEvent NAUTILUS_DASH_READY = register("entity.nautilus.dash_ready");
   public static final SoundEvent NAUTILUS_DASH_READY_ON_LAND = register("entity.nautilus.dash_ready_land");
   public static final SoundEvent NAUTILUS_DEATH = register("entity.nautilus.death");
   public static final SoundEvent NAUTILUS_DEATH_ON_LAND = register("entity.nautilus.death_land");
   public static final SoundEvent NAUTILUS_EAT = register("entity.nautilus.eat");
   public static final SoundEvent NAUTILUS_HURT = register("entity.nautilus.hurt");
   public static final SoundEvent NAUTILUS_HURT_ON_LAND = register("entity.nautilus.hurt_land");
   ...
   public static final SoundEvent PALE_HANGING_MOSS_IDLE = register("block.pale_hanging_moss.idle");
   ...
   public static final SoundEvent PLAYER_TELEPORT = register("entity.player.teleport");
   ...
   public static final SoundEvent SHELF_ACTIVATE = register("block.shelf.activate");
   public static final SoundEvent SHELF_BREAK = register("block.shelf.break");
   public static final SoundEvent SHELF_DEACTIVATE = register("block.shelf.deactivate");
   public static final SoundEvent SHELF_FALL = register("block.shelf.fall");
   public static final SoundEvent SHELF_HIT = register("block.shelf.hit");
   public static final SoundEvent SHELF_MULTI_SWAP = register("block.shelf.multi_swap");
   public static final SoundEvent SHELF_PLACE = register("block.shelf.place");
   ...
   public static final SoundEvent SPAWNER_BREAK = register("block.spawner.break");
   public static final SoundEvent SPAWNER_FALL = register("block.spawner.fall");
   ...
   public static final Holder<SoundEvent> SPEAR_USE = registerForHolder("item.spear.use");
   public static final Holder<SoundEvent> SPEAR_HIT = registerForHolder("item.spear.hit");
   public static final Holder<SoundEvent> SPEAR_ATTACK = registerForHolder("item.spear.attack");
   public static final Holder<SoundEvent> SPEAR_WOOD_USE = registerForHolder("item.spear_wood.use");
   public static final Holder<SoundEvent> SPEAR_WOOD_HIT = registerForHolder("item.spear_wood.hit");
   public static final Holder<SoundEvent> SPEAR_WOOD_ATTACK = registerForHolder("item.spear_wood.attack");
   ...
   public static final SoundEvent VAULT_INSERT_ITEM_FAIL = register("block.vault.insert_item_fail");
   public static final SoundEvent VAULT_OPEN_SHUTTER = register("block.vault.open_shutter");
   public static final SoundEvent VAULT_PLACE = register("block.vault.place");
   public static final SoundEvent VAULT_STEP = register("block.vault.step");
   ...
   public static final SoundEvent WET_SPONGE_DRIES = register("block.wet_sponge.dries");
   ...
   public static final Holder.Reference<SoundEvent> WIND_CHARGE_BURST = registerForHolder("entity.wind_charge.wind_burst");
   public static final SoundEvent WIND_CHARGE_THROW = register("entity.wind_charge.throw");
   ...
   public static final Holder.Reference<SoundEvent> WOLF_AMBIENT_BABY = registerForHolder("entity.baby_wolf.ambient");
   ...
   public static final Holder.Reference<SoundEvent> WOLF_DEATH_BABY = registerForHolder("entity.baby_wolf.death");
   public static final Holder.Reference<SoundEvent> WOLF_GROWL_BABY = registerForHolder("entity.baby_wolf.growl");
   public static final Holder.Reference<SoundEvent> WOLF_HURT_BABY = registerForHolder("entity.baby_wolf.hurt");
   public static final Holder.Reference<SoundEvent> WOLF_PANT_BABY = registerForHolder("entity.baby_wolf.pant");
   public static final SoundEvent WOLF_SHAKE = register("entity.wolf.shake");
   public static final Holder.Reference<SoundEvent> WOLF_STEP = registerForHolder("entity.wolf.step");
   public static final Holder.Reference<SoundEvent> WOLF_STEP_BABY = registerForHolder("entity.baby_wolf.step");
   public static final Holder.Reference<SoundEvent> WOLF_WHINE_BABY = registerForHolder("entity.baby_wolf.whine");
   ...
   public static final SoundEvent ZOMBIE_NAUTILUS_AMBIENT_ON_LAND = register("entity.zombie_nautilus.ambient_land");
   public static final SoundEvent ZOMBIE_NAUTILUS_DASH = register("entity.zombie_nautilus.dash");
   public static final SoundEvent ZOMBIE_NAUTILUS_DASH_ON_LAND = register("entity.zombie_nautilus.dash_land");
   public static final SoundEvent ZOMBIE_NAUTILUS_DASH_READY = register("entity.zombie_nautilus.dash_ready");
   public static final SoundEvent ZOMBIE_NAUTILUS_DASH_READY_ON_LAND = register("entity.zombie_nautilus.dash_ready_land");
   public static final SoundEvent ZOMBIE_NAUTILUS_DEATH = register("entity.zombie_nautilus.death");
   public static final SoundEvent ZOMBIE_NAUTILUS_DEATH_ON_LAND = register("entity.zombie_nautilus.death_land");
   ...
   private static Holder.Reference<SoundEvent> registerForHolder(final String id) {
      return registerForHolder(Identifier.withDefaultNamespace(id));
   }
   ...
   private static SoundEvent register(final Identifier id, final Identifier soundId) {
      return (SoundEvent)Registry.register(BuiltInRegistries.SOUND_EVENT, (Identifier)id, SoundEvent.createVariableRangeEvent(soundId));
   }
   ...
   private static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
      return (ImmutableList)IntStream.range(0, 8).mapToObj((i) -> registerForHolder("item.goat_horn.sound." + i)).collect(ImmutableList.toImmutableList());
   }

   private static Map<WolfSoundVariants.SoundSet, WolfSoundVariant> registerWolfSoundVariants() {
      return (Map)Stream.of(WolfSoundVariants.SoundSet.values()).collect(Collectors.toMap((soundSet) -> soundSet, (soundSet) -> {
