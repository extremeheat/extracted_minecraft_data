...
public class SoundEvents {
   ...
   private static SoundEvent register(String var0, float var1) {
      return (SoundEvent)Registry.register(Registry.SOUND_EVENT, (String)var0, new SoundEvent(new ResourceLocation(var0), var1));
   }
   ...
   private static ImmutableList<SoundEvent> registerGoatHornSoundVariants() {
      return (ImmutableList)IntStream.range(0, 8).mapToObj((var0) -> {
         return register("item.goat_horn.sound." + var0);
