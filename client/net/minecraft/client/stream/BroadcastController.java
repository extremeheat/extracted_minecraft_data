...
public class BroadcastController implements IStatCallbacks, IStreamCallbacks {
   ...
   public void requestAuthTokenCallback(ErrorCode var1, AuthToken var2) {
      ...
      try {
         if (this.field_152867_c != null) {
            this.field_152867_c.func_152900_a(var1, var2);
         }
   ...
   public void loginCallback(ErrorCode var1, ChannelInfo var2) {
      ...
      try {
         if (this.field_152867_c != null) {
            this.field_152867_c.func_152897_a(var1);
         }
      } catch (Exception var4) {
         this.func_152820_d(var4.toString());
      }
   ...
   public void getIngestServersCallback(ErrorCode var1, IngestList var2) {
      if (ErrorCode.succeeded(var1)) {
         ...
         try {
            if (this.field_152867_c != null) {
               this.field_152867_c.func_152896_a(var2);
            }
         } catch (Exception var4) {
            this.func_152820_d(var4.toString());
         }
   ...
   public void getStreamInfoCallback(ErrorCode var1, StreamInfo var2) {
      if (ErrorCode.succeeded(var1)) {
         this.field_152888_x = var2;

         try {
            if (this.field_152867_c != null) {
               this.field_152867_c.func_152894_a(var2);
            }
         } catch (Exception var4) {
            this.func_152820_d(var4.toString());
         }
   ...
   public void getGameNameListCallback(ErrorCode var1, GameInfoList var2) {
      ...
      try {
         if (this.field_152867_c != null) {
            this.field_152867_c.func_152898_a(var1, var2 == null ? new GameInfo[0] : var2.list);
         }
      } catch (Exception var4) {
         this.func_152820_d(var4.toString());
      }
   ...
   public void startCallback(ErrorCode var1) {
      if (ErrorCode.succeeded(var1)) {
         ...
         String var2 = ErrorCode.getString(var1);
         this.field_152867_c.func_152892_c(var1);
   ...
   public void sendActionMetaDataCallback(ErrorCode var1) {
      if (ErrorCode.failed(var1)) {
         this.func_152832_e("Failed sending action metadata: " + ErrorCode.getString(var1));
      }
   }

   public void sendStartSpanMetaDataCallback(ErrorCode var1) {
      if (ErrorCode.failed(var1)) {
         this.func_152832_e("Failed sending span metadata start: " + ErrorCode.getString(var1));
      }
   }

   public void sendEndSpanMetaDataCallback(ErrorCode var1) {
      if (ErrorCode.failed(var1)) {
         this.func_152832_e("Failed sending span metadata end: " + ErrorCode.getString(var1));
      }
   }
