...
public class StringSplitter {
      ...
      return (FormattedText)var1.visit(new FormattedText.StyledContentConsumer<FormattedText>() {
         ...
         public Optional<FormattedText> accept(Style var1, String var2) {
            ...
            if (!StringDecomposer.iterateFormatted((String)var2, var1, var4)) {
               ...
               if (!var3.isEmpty()) {
                  this.collector.append(FormattedText.method_11(var3, var1));
               }

               return Optional.of(this.collector.getResultOrEmpty());
            } else {
               if (!var2.isEmpty()) {
                  this.collector.append(FormattedText.method_11(var2, var1));
               }
   ...
   public List<FormattedText> splitLines(String var1, int var2, Style var3) {
      ...
      this.splitLines(var1, var2, var3, false, (var2x, var3x, var4x) -> {
         var4.add(FormattedText.method_11(var1.substring(var3x, var4x), var2x));
      });
      return var4;
   }
   ...
   public void splitLines(FormattedText var1, int var2, Style var3, BiConsumer<FormattedText, Boolean> var4) {
      ...
      while(true) {
         while(var7) {
            ...
            while(var11.hasNext()) {
               StringSplitter.LineComponent var12 = (StringSplitter.LineComponent)var11.next();
         ...
         while(var5.hasNext()) {
            ...
            if (!var7) {
               if (var6 > var10) {
                  ...
                  if (!var11.isEmpty()) {
                     var4.append(FormattedText.method_11(var11, var8.style));
                  }
