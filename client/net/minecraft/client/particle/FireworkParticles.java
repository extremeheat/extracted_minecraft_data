      ...
      public void tick() {
         ...
         if (this.life % 2 == 0 && this.explosions != null && this.life / 2 < this.explosions.size()) {
            ...
            switch (var18) {
               case SMALL_BALL:
               default:
                  this.createParticleBall(0.25, 2, var6, var7, var17, var5);
                  break;
               case LARGE_BALL:
                  this.createParticleBall(0.5, 4, var6, var7, var17, var5);
                  break;
               case STAR:
                  this.createParticleShape(0.5, new double[][]{{0.0, 1.0}, {0.3455, 0.309}, {0.9511, 0.309}, {0.3795918367346939, -0.12653061224489795}, {0.6122448979591837, -0.8040816326530612}, {0.0, -0.35918367346938773}}, var6, var7, var17, var5, false);
                  break;
               case CREEPER:
                  this.createParticleShape(0.5, new double[][]{{0.0, 0.2}, {0.2, 0.2}, {0.2, 0.6}, {0.6, 0.6}, {0.6, 0.2}, {0.2, 0.2}, {0.2, 0.0}, {0.4, 0.0}, {0.4, -0.6}, {0.2, -0.6}, {0.2, -0.4}, {0.0, -0.4}}, var6, var7, var17, var5, true);
                  break;
               case BURST:
