...
public class BreakingItemParticle extends TextureSheetParticle {
   ...
   protected BreakingItemParticle(ClientLevel var1, double var2, double var4, double var6, ItemStack var8) {
      ...
      this.gravity = 1.0F;
      this.quadSize /= 2.0F;
      this.field_117 = this.random.nextFloat() * 3.0F;
      this.field_118 = this.random.nextFloat() * 3.0F;
   }

   protected float getU0() {
      return this.sprite.getU((double)((this.field_117 + 1.0F) / 4.0F * 16.0F));
   }

   protected float getU1() {
      return this.sprite.getU((double)(this.field_117 / 4.0F * 16.0F));
   }

   protected float getV0() {
      return this.sprite.getV((double)(this.field_118 / 4.0F * 16.0F));
   }

   protected float getV1() {
      return this.sprite.getV((double)((this.field_118 + 1.0F) / 4.0F * 16.0F));
   }
