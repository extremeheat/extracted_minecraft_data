...
public class MineTravelParticle extends TextureSheetParticle {
   private final double xStart;
   private final double yStart;
   private final double zStart;

   protected MineTravelParticle(ClientLevel var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      ...
      this.yStart = this.y;
      this.zStart = this.z;
      this.quadSize = 0.1F * (this.random.nextFloat() * 0.4F + 0.2F);
      float var14 = this.random.nextFloat() * 0.6F + 0.4F;
      if (this.random.nextBoolean()) {
         this.rCol = var14 * 0.2F;
         this.gCol = var14 * 0.3F;
         this.bCol = var14;
      } else {
         this.rCol = var14 * 0.2F;
         this.gCol = var14;
         this.bCol = var14 * 0.2F;
      }

      this.lifetime = (int)(Math.random() * 20.0) + 50;
   }
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType var1, ClientLevel var2, double var3, double var5, double var7, double var9, double var11, double var13) {
         MineTravelParticle var15 = new MineTravelParticle(var2, var3, var5, var7, var9, var11, var13);
