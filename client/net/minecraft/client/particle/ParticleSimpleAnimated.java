...
public class ParticleSimpleAnimated extends Particle {
   protected final int field_187147_a;
   protected final int field_187148_G;
   ...
   public ParticleSimpleAnimated(World var1, double var2, double var4, double var6, int var8, int var9, float var10) {
      ...
      this.field_187147_a = var8;
      this.field_187148_G = var9;
      this.field_187149_H = var10;
   }

   public void func_187146_c(int var1) {
      float var2 = (float)((var1 & 16711680) >> 16) / 255.0F;
      float var3 = (float)((var1 & '\uff00') >> 8) / 255.0F;
      float var4 = (float)((var1 & 255) >> 0) / 255.0F;
      float var5 = 1.0F;
      this.func_70538_b(var2 * 1.0F, var3 * 1.0F, var4 * 1.0F);
   }

   public void func_187145_d(int var1) {
      this.field_187150_I = (float)((var1 & 16711680) >> 16) / 255.0F;
      this.field_187151_J = (float)((var1 & '\uff00') >> 8) / 255.0F;
      this.field_187152_K = (float)((var1 & 255) >> 0) / 255.0F;
   ...
   protected void func_191238_f(float var1) {
      this.field_191239_M = var1;
   }
}
