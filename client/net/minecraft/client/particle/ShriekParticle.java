...
public class ShriekParticle extends TextureSheetParticle {
   ...
   public void render(VertexConsumer var1, Camera var2, float var3) {
      if (this.delay <= 0) {
         ...
         this.renderRotatedParticle(var1, var2, var3, var0 -> {
            var0.mul(Vector3f.YP.rotation(0.0F));
            var0.mul(Vector3f.XP.rotation(-1.0472F));
         });
         this.renderRotatedParticle(var1, var2, var3, var0 -> {
            var0.mul(Vector3f.YP.rotation(-3.1415927F));
            var0.mul(Vector3f.XP.rotation(1.0472F));
         });
      }
   }

   private void renderRotatedParticle(VertexConsumer var1, Camera var2, float var3, Consumer<Quaternion> var4) {
      ...
      Quaternion var9 = new Quaternion(ROTATION_VECTOR, 0.0F, true);
      var4.accept(var9);
      TRANSFORM_VECTOR.transform(var9);
      ...
      for(int var12 = 0; var12 < 4; ++var12) {
         ...
         var13.transform(var9);
         var13.mul(var11);
         var13.add(var6, var7, var8);
      }

      int var14 = this.getLightColor(var3);
      this.makeCornerVertex(var1, var10[0], this.getU1(), this.getV1(), var14);
      this.makeCornerVertex(var1, var10[1], this.getU1(), this.getV0(), var14);
      this.makeCornerVertex(var1, var10[2], this.getU0(), this.getV0(), var14);
      this.makeCornerVertex(var1, var10[3], this.getU0(), this.getV1(), var14);
   }
   ...
   public static class Provider implements ParticleProvider<ShriekParticleOption> {
      ...
      public Particle createParticle(
         ShriekParticleOption var1, ClientLevel var2, double var3, double var5, double var7, double var9, double var11, double var13
      ) {
