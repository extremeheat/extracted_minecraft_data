...
public class EntityReddustFX extends EntityFX {
   ...
   public EntityReddustFX(World var1, double var2, double var4, double var6, float var8, float var9, float var10, float var11) {
      ...
      this.field_70552_h = ((float)(Math.random() * 0.20000000298023224) + 0.8F) * var9 * var12;
      this.field_70553_i = ((float)(Math.random() * 0.20000000298023224) + 0.8F) * var10 * var12;
      this.field_70551_j = ((float)(Math.random() * 0.20000000298023224) + 0.8F) * var11 * var12;
