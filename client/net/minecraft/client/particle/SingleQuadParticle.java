...
public abstract class SingleQuadParticle extends Particle {
   ...
   public void render(VertexConsumer var1, Camera var2, float var3) {
      ...
      var1.vertex((double)var10[0].x(), (double)var10[0].y(), (double)var10[0].z())
         .uv(var19, var15)
         .color(this.rCol, this.gCol, this.bCol, this.alpha)
         .uv2(var16)
         .endVertex();
      var1.vertex((double)var10[1].x(), (double)var10[1].y(), (double)var10[1].z())
         .uv(var19, var14)
         .color(this.rCol, this.gCol, this.bCol, this.alpha)
         .uv2(var16)
         .endVertex();
      var1.vertex((double)var10[2].x(), (double)var10[2].y(), (double)var10[2].z())
         .uv(var18, var14)
         .color(this.rCol, this.gCol, this.bCol, this.alpha)
         .uv2(var16)
         .endVertex();
      var1.vertex((double)var10[3].x(), (double)var10[3].y(), (double)var10[3].z())
         .uv(var18, var15)
         .color(this.rCol, this.gCol, this.bCol, this.alpha)
         .uv2(var16)
         .endVertex();
