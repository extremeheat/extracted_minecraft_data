...
public class TerrainParticle extends TextureSheetParticle {
   ...
   // $FF: renamed from: uo float
   private final float field_119;
   // $FF: renamed from: vo float
   private final float field_120;
   ...
   public TerrainParticle(ClientLevel var1, double var2, double var4, double var6, double var8, double var10, double var12, BlockState var14, BlockPos var15) {
      ...
      this.quadSize /= 2.0F;
      this.field_119 = this.random.nextFloat() * 3.0F;
      this.field_120 = this.random.nextFloat() * 3.0F;
   }
   ...
   protected float getU0() {
      return this.sprite.getU((double)((this.field_119 + 1.0F) / 4.0F * 16.0F));
   }

   protected float getU1() {
      return this.sprite.getU((double)(this.field_119 / 4.0F * 16.0F));
   }

   protected float getV0() {
      return this.sprite.getV((double)(this.field_120 / 4.0F * 16.0F));
   }

   protected float getV1() {
      return this.sprite.getV((double)((this.field_120 + 1.0F) / 4.0F * 16.0F));
   }
