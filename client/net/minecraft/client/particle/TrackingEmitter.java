...
public class TrackingEmitter extends NoRenderParticle {
   ...
   private TrackingEmitter(ClientLevel var1, Entity var2, ParticleOptions var3, int var4, Vec3 var5) {
      super(var1, var2.getX(), var2.getY(0.5D), var2.getZ(), var5.field_414, var5.field_415, var5.field_416);
      this.entity = var2;
      this.lifeTime = var4;
   ...
   public void tick() {
      for(int var1 = 0; var1 < 16; ++var1) {
         ...
         if (!(var2 * var2 + var4 * var4 + var6 * var6 > 1.0D)) {
            double var8 = this.entity.getX(var2 / 4.0D);
            double var10 = this.entity.getY(0.5D + var4 / 4.0D);
            double var12 = this.entity.getZ(var6 / 4.0D);
