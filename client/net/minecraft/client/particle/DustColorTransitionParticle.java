...
public class DustColorTransitionParticle extends DustParticleBase<DustColorTransitionOptions> {
   ...
   private Vector3f randomizeColor(Vector3f var1, float var2) {
      return new Vector3f(this.randomizeColor(var1.method_82(), var2), this.randomizeColor(var1.method_83(), var2), this.randomizeColor(var1.method_84(), var2));
   }

   private void lerpColors(float var1) {
      float var2 = ((float)this.age + var1) / ((float)this.lifetime + 1.0F);
      Vector3f var3 = this.fromColor.copy();
      var3.lerp(this.toColor, var2);
      this.rCol = var3.method_82();
      this.gCol = var3.method_83();
      this.bCol = var3.method_84();
   }
