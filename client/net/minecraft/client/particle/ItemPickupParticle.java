...
public class ItemPickupParticle extends Particle {
   ...
   private ItemPickupParticle(EntityRenderDispatcher var1, RenderBuffers var2, ClientLevel var3, Entity var4, Entity var5, Vec3 var6) {
      super(var3, var4.getX(), var4.getY(), var4.getZ(), var6.field_414, var6.field_415, var6.field_416);
   ...
   public void render(VertexConsumer var1, Camera var2, float var3) {
      ...
      this.entityRenderDispatcher.render(this.itemEntity, var11 - var18.method_2(), var13 - var18.method_3(), var15 - var18.method_4(), this.itemEntity.getYRot(), var3, new PoseStack(), var17, this.entityRenderDispatcher.getPackedLightCoords(this.itemEntity, var3));
      var17.endBatch();
   }
