...
public class WaterDropParticle extends TextureSheetParticle {
   ...
   public void tick() {
      ...
      if (this.lifetime-- <= 0) {
         ...
         double var2 = Math.max(this.level.getBlockState(var1).getCollisionShape(this.level, var1).max(Direction.Axis.field_501, this.x - (double)var1.getX(), this.z - (double)var1.getZ()), (double)this.level.getFluidState(var1).getHeight(this.level, var1));
