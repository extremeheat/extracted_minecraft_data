...
public class KeyMapping implements Comparable<KeyMapping> {
   ...
   public int compareTo(KeyMapping var1) {
      return this.category.equals(var1.category)
         ? I18n.get(this.name).compareTo(I18n.get(var1.name))
         : CATEGORY_SORT_ORDER.get(this.category).compareTo(CATEGORY_SORT_ORDER.get(var1.category));
   }

   public static Supplier<Component> createNameSupplier(String var0) {
      KeyMapping var1 = ALL.get(var0);
      return var1 == null ? () -> Component.translatable(var0) : var1::getTranslatedKeyMessage;
   }
