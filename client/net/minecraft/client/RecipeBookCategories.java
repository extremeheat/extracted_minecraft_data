...
public enum RecipeBookCategories {
   ...
   public static List<RecipeBookCategories> getCategories(RecipeBookType var0) {
      List var10000;
      switch (var0) {
         case CRAFTING -> var10000 = CRAFTING_CATEGORIES;
         case FURNACE -> var10000 = FURNACE_CATEGORIES;
         case BLAST_FURNACE -> var10000 = BLAST_FURNACE_CATEGORIES;
         case SMOKER -> var10000 = SMOKER_CATEGORIES;
