...
public class Gui extends GuiComponent {
   ...
   public void render(PoseStack var1, float var2) {
      ...
      if (this.minecraft.options.getCameraType().isFirstPerson()) {
         if (this.minecraft.player.isScoping()) {
            ...
            if (var5.method_87(Blocks.CARVED_PUMPKIN.asItem())) {
      ...
      if (var2.getCameraType().isFirstPerson()) {
         if (this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR || this.canRenderCrosshairForSpectator(this.minecraft.hitResult)) {
            if (var2.renderDebug && !var2.hideGui && !this.minecraft.player.isReducedDebugInfo() && !var2.reducedDebugInfo) {
               ...
               var10.mulPose(Vector3f.field_289.rotationDegrees(var9.getXRot()));
               var10.mulPose(Vector3f.field_292.rotationDegrees(var9.getYRot()));
   ...
   protected void renderEffects(PoseStack var1) {
      ...
      while(var7.hasNext()) {
         ...
         if (var8.showIcon()) {
            ...
            var6.add(() -> {
               RenderSystem.setShaderTexture(0, var19.atlas().location());
               RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, var12);
               blit(var1, var10 + 3, var11 + 3, this.getBlitOffset(), 18, 18, var19);
            });
         }
      }
   ...
   private void renderTextureOverlay(ResourceLocation var1, float var2) {
      ...
      var4.vertex(0.0D, (double)this.screenHeight, -90.0D).method_7(0.0F, 1.0F).endVertex();
      var4.vertex((double)this.screenWidth, (double)this.screenHeight, -90.0D).method_7(1.0F, 1.0F).endVertex();
      var4.vertex((double)this.screenWidth, 0.0D, -90.0D).method_7(1.0F, 0.0F).endVertex();
      var4.vertex(0.0D, 0.0D, -90.0D).method_7(0.0F, 0.0F).endVertex();
      var3.end();
   ...
   private void renderSpyglassOverlay(float var1) {
      ...
      var3.vertex((double)var9, (double)var12, -90.0D).method_7(0.0F, 1.0F).endVertex();
      var3.vertex((double)var11, (double)var12, -90.0D).method_7(1.0F, 1.0F).endVertex();
      var3.vertex((double)var11, (double)var10, -90.0D).method_7(1.0F, 0.0F).endVertex();
      var3.vertex((double)var9, (double)var10, -90.0D).method_7(0.0F, 0.0F).endVertex();
      var2.end();
   ...
   private void renderVignette(Entity var1) {
      ...
      var9.vertex(0.0D, (double)this.screenHeight, -90.0D).method_7(0.0F, 1.0F).endVertex();
      var9.vertex((double)this.screenWidth, (double)this.screenHeight, -90.0D).method_7(1.0F, 1.0F).endVertex();
      var9.vertex((double)this.screenWidth, 0.0D, -90.0D).method_7(1.0F, 0.0F).endVertex();
      var9.vertex(0.0D, 0.0D, -90.0D).method_7(0.0F, 0.0F).endVertex();
      var10.end();
      RenderSystem.depthMask(true);
      RenderSystem.enableDepthTest();
      RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void renderPortalOverlay(float var1) {
      ...
      var8.vertex(0.0D, (double)this.screenHeight, -90.0D).method_7(var3, var6).endVertex();
      var8.vertex((double)this.screenWidth, (double)this.screenHeight, -90.0D).method_7(var5, var6).endVertex();
      var8.vertex((double)this.screenWidth, 0.0D, -90.0D).method_7(var5, var4).endVertex();
      var8.vertex(0.0D, 0.0D, -90.0D).method_7(var3, var4).endVertex();
      var7.end();
      RenderSystem.depthMask(true);
      RenderSystem.enableDepthTest();
      RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void tick() {
      ...
      if (this.minecraft.player != null) {
         ...
         } else if (!this.lastToolHighlight.isEmpty() && var2.method_87(this.lastToolHighlight.getItem()) && var2.getHoverName().equals(this.lastToolHighlight.getHoverName())) {
