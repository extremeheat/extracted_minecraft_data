...
public abstract class Gui {
   ...
   public void func_73729_b(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      var10.func_181662_b((double)(var1 + 0), (double)(var2 + var6), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + 0) * 0.00390625F), (double)((float)(var4 + var6) * 0.00390625F)).func_181675_d();
      var10.func_181662_b((double)(var1 + var5), (double)(var2 + var6), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + var5) * 0.00390625F), (double)((float)(var4 + var6) * 0.00390625F)).func_181675_d();
      var10.func_181662_b((double)(var1 + var5), (double)(var2 + 0), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + var5) * 0.00390625F), (double)((float)(var4 + 0) * 0.00390625F)).func_181675_d();
      var10.func_181662_b((double)(var1 + 0), (double)(var2 + 0), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + 0) * 0.00390625F), (double)((float)(var4 + 0) * 0.00390625F)).func_181675_d();
      var9.func_78381_a();
   }
   ...
   public void func_175174_a(float var1, float var2, int var3, int var4, int var5, int var6) {
      ...
      BufferBuilder var10 = var9.func_178180_c();
      var10.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      var10.func_181662_b((double)(var1 + 0.0F), (double)(var2 + (float)var6), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + 0) * 0.00390625F), (double)((float)(var4 + var6) * 0.00390625F)).func_181675_d();
      var10.func_181662_b((double)(var1 + (float)var5), (double)(var2 + (float)var6), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + var5) * 0.00390625F), (double)((float)(var4 + var6) * 0.00390625F)).func_181675_d();
      var10.func_181662_b((double)(var1 + (float)var5), (double)(var2 + 0.0F), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + var5) * 0.00390625F), (double)((float)(var4 + 0) * 0.00390625F)).func_181675_d();
      var10.func_181662_b((double)(var1 + 0.0F), (double)(var2 + 0.0F), (double)this.field_73735_i).func_187315_a((double)((float)(var3 + 0) * 0.00390625F), (double)((float)(var4 + 0) * 0.00390625F)).func_181675_d();
      var9.func_78381_a();
   }
   ...
   public void func_175175_a(int var1, int var2, TextureAtlasSprite var3, int var4, int var5) {
      ...
      var7.func_181662_b((double)(var1 + 0), (double)(var2 + var5), (double)this.field_73735_i).func_187315_a((double)var3.func_94209_e(), (double)var3.func_94210_h()).func_181675_d();
      var7.func_181662_b((double)(var1 + var4), (double)(var2 + var5), (double)this.field_73735_i).func_187315_a((double)var3.func_94212_f(), (double)var3.func_94210_h()).func_181675_d();
      var7.func_181662_b((double)(var1 + var4), (double)(var2 + 0), (double)this.field_73735_i).func_187315_a((double)var3.func_94212_f(), (double)var3.func_94206_g()).func_181675_d();
      var7.func_181662_b((double)(var1 + 0), (double)(var2 + 0), (double)this.field_73735_i).func_187315_a((double)var3.func_94209_e(), (double)var3.func_94206_g()).func_181675_d();
      var6.func_78381_a();
   }
   ...
   public static void func_146110_a(int var0, int var1, float var2, float var3, int var4, int var5, float var6, float var7) {
      ...
      var11.func_181662_b((double)var0, (double)(var1 + var5), 0.0D).func_187315_a((double)(var2 * var8), (double)((var3 + (float)var5) * var9)).func_181675_d();
      var11.func_181662_b((double)(var0 + var4), (double)(var1 + var5), 0.0D).func_187315_a((double)((var2 + (float)var4) * var8), (double)((var3 + (float)var5) * var9)).func_181675_d();
      var11.func_181662_b((double)(var0 + var4), (double)var1, 0.0D).func_187315_a((double)((var2 + (float)var4) * var8), (double)(var3 * var9)).func_181675_d();
      var11.func_181662_b((double)var0, (double)var1, 0.0D).func_187315_a((double)(var2 * var8), (double)(var3 * var9)).func_181675_d();
      var10.func_78381_a();
   }
   ...
   public static void func_152125_a(int var0, int var1, float var2, float var3, int var4, int var5, int var6, int var7, float var8, float var9) {
      ...
      var13.func_181662_b((double)var0, (double)(var1 + var7), 0.0D).func_187315_a((double)(var2 * var10), (double)((var3 + (float)var5) * var11)).func_181675_d();
      var13.func_181662_b((double)(var0 + var6), (double)(var1 + var7), 0.0D).func_187315_a((double)((var2 + (float)var4) * var10), (double)((var3 + (float)var5) * var11)).func_181675_d();
      var13.func_181662_b((double)(var0 + var6), (double)var1, 0.0D).func_187315_a((double)((var2 + (float)var4) * var10), (double)(var3 * var11)).func_181675_d();
      var13.func_181662_b((double)var0, (double)var1, 0.0D).func_187315_a((double)(var2 * var10), (double)(var3 * var11)).func_181675_d();
      var12.func_78381_a();
   }
}
