...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
   ...
   public void func_175264_a(ScaledResolution var1, float var2) {
      if (this.field_175271_i != null) {
         ...
         if (var3 <= 0.0F) {
            ...
            float var6 = (float)var1.func_78328_b() - 22.0F * var3;
   ...
   protected void func_175258_a(ScaledResolution var1, float var2, int var3, float var4, SpectatorDetails var5) {
      ...
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, var2);
      this.field_175268_g.func_110434_K().func_110577_a(field_175267_f);
      this.func_175174_a((float)(var3 - 91), var4, 0, 0, 182, 22);
      if (var5.func_178681_b() >= 0) {
         this.func_175174_a((float)(var3 - 91 - 1 + var5.func_178681_b() * 20), var4 - 1.0F, 0, 22, 24, 22);
      }

      RenderHelper.func_74520_c();

      for(int var6 = 0; var6 < 9; ++var6) {
         this.func_175266_a(var6, var1.func_78326_a() / 2 - 90 + var6 * 20 + 2, var4 + 3.0F, var2, var5.func_178680_a(var6));
      }
   ...
   private void func_175266_a(int var1, int var2, float var3, float var4, ISpectatorMenuObject var5) {
      ...
      if (var5 != SpectatorMenu.field_178657_a) {
         ...
         String var8 = String.valueOf(GameSettings.func_74298_c(this.field_175268_g.field_71474_y.field_151456_ac[var1].func_151463_i()));
   ...
   public void func_175263_a(ScaledResolution var1) {
      ...
      if (var2 > 3 && this.field_175271_i != null) {
         ...
         if (var4 != null) {
            int var5 = (var1.func_78326_a() - this.field_175268_g.field_71466_p.func_78256_a(var4)) / 2;
            int var6 = var1.func_78328_b() - 35;
            GlStateManager.func_179094_E();
            GlStateManager.func_179147_l();
            GlStateManager.func_179120_a(770, 771, 1, 0);
   ...
   public void func_175259_b(int var1) {
      int var2;
      for(var2 = this.field_175271_i.func_178648_e() + var1; var2 >= 0 && var2 <= 8 && (this.field_175271_i.func_178643_a(var2) == SpectatorMenu.field_178657_a || !this.field_175271_i.func_178643_a(var2).func_178662_A_()); var2 += var1) {
      }
