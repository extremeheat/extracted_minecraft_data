...
public class GuiBannerResultRenderer extends PictureInPictureRenderer<GuiBannerResultRenderState> {
   ...
   protected void renderToTexture(GuiBannerResultRenderState var1, PoseStack var2) {
      ...
      BannerRenderer.submitPatterns(this.materials, var2, var4, 15728880, OverlayTexture.NO_OVERLAY, var1.flag(), 0.0F, ModelBakery.BANNER_BASE, true, var1.baseColor(), var1.resultBannerPatterns(), (ModelFeatureRenderer.CrumblingOverlay)null);
