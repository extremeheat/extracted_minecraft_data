...
public class BitmapProvider implements GlyphProvider {
   ...
   BitmapProvider(NativeImage var1, Int2ObjectMap<Glyph> var2) {
      super();
      this.image = var1;
      this.glyphs = var2;
   }
   ...
   public static class Builder implements GlyphProviderBuilder {
      ...
      public static Builder fromJson(JsonObject var0) {
         ...
         if (var2 > var1) {
            ...
            if (!var3.isEmpty() && ((int[])var3.get(0)).length != 0) {
               return new Builder(new ResourceLocation(GsonHelper.getAsString(var0, "file")), var1, var2, var3);
            } else {
      ...
      public GlyphProvider create(ResourceManager var1) {
         try {
            InputStream var2 = var1.open(this.texture);
               ...
               while(true) {
                  ...
                  for(int var14 = 0; var14 < var13; ++var14) {
                     ...
                     if (var15 != 0) {
                        ...
                        Glyph var18 = (Glyph)var9.put(var15, new Glyph(var8, var3, var16 * var6, var10 * var7, var6, var7, (int)(0.5 + (double)((float)var17 * var8)) + 1, this.ascent));
                        if (var18 != null) {
