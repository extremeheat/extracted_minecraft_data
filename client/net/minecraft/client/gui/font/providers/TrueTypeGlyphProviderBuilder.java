...
public class TrueTypeGlyphProviderBuilder implements GlyphProviderBuilder {
   ...
   public static GlyphProviderBuilder fromJson(JsonObject var0) {
      ...
      return new TrueTypeGlyphProviderBuilder(new ResourceLocation(GsonHelper.getAsString(var0, "file")), GsonHelper.getAsFloat(var0, "size", 11.0F), GsonHelper.getAsFloat(var0, "oversample", 1.0F), var1, var2, var7.toString());
   }
   ...
   public GlyphProvider create(ResourceManager var1) {
      ...
      try {
         InputStream var4 = var1.open(new ResourceLocation(this.location.getNamespace(), "font/" + this.location.getPath()));
