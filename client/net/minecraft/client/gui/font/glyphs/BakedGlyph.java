...
public class BakedGlyph {
   ...
   private void extract(GuiRenderState var1, RenderType var2, boolean var3, float var4, float var5, int var6, boolean var7, boolean var8, GuiTextRenderState var9) {
      ...
      float var16 = var8 ? 0.1F : 0.0F;
      var1.submitGuiElement(new GlyphRenderState(var2.getRenderPipeline(), TextureSetup.singleTextureWithLightmap(this.texture), var9.pose(), var10 - var16, var12 - var16, var11 + var16, var13 + var16, var14, var15, var7 ? var9.textShadowZ() : var9.textZ(), this.u0, this.u1, this.v0, this.v1, var6, var9.textRenderState().packedLightCoords(), var9.layer(), var9.scissorArea()));
   }
   ...
   public void extractEffect(GuiRenderState var1, RenderType var2, Effect var3, boolean var4, GuiTextRenderState var5) {
      ...
      var1.submitGuiElement(new GlyphRenderState(var2.getRenderPipeline(), TextureSetup.singleTextureWithLightmap(this.texture), var5.pose(), var3.x0 + var6, var3.y0 + var6, var3.x1 + var6, var3.y1 + var6, 0.0F, 0.0F, var4 ? var5.effectShadowZ() : var5.effectZ(), this.u0, this.u1, this.v0, this.v1, var4 ? var3.shadowColor() : var3.color(), var5.textRenderState().packedLightCoords(), var5.layer(), var5.scissorArea()));
   }

   public void extractBackground(GuiRenderState var1, RenderType var2, Effect var3, GuiTextRenderState var4) {
      var1.submitGuiElement(new GlyphRenderState(var2.getRenderPipeline(), TextureSetup.singleTextureWithLightmap(this.texture), var4.pose(), var3.x0, var3.y0, var3.x1, var3.y1, 0.0F, 0.0F, var4.backgroundZ(), this.u0, this.u1, this.v0, this.v1, var3.color, var4.textRenderState().packedLightCoords(), var4.layer(), var4.scissorArea()));
   }
