...
public abstract class GuiComponent {
   ...
   private static void innerBlit(Matrix4f var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, float var9) {
      ...
      var10.vertex(var0, (float)var1, (float)var4, (float)var5).method_7(var6, var9).endVertex();
      var10.vertex(var0, (float)var2, (float)var4, (float)var5).method_7(var7, var9).endVertex();
      var10.vertex(var0, (float)var2, (float)var3, (float)var5).method_7(var7, var8).endVertex();
      var10.vertex(var0, (float)var1, (float)var3, (float)var5).method_7(var6, var8).endVertex();
      var10.end();
      BufferUploader.end(var10);
   }
