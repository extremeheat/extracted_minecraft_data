...
public class GuiTextField extends Gui {
   ...
   public GuiTextField(FontRenderer var1, int var2, int var3, int var4, int var5) {
      ...
      this.field_146209_f = var2;
      this.field_146210_g = var3;
      this.field_146218_h = var4;
      this.field_146219_i = var5;
   }
   ...
   public int func_146183_a(int var1, int var2) {
      return this.func_146197_a(var1, this.func_146198_h(), true);
   }
   ...
   public boolean func_146201_a(char var1, int var2) {
   ...
   public void func_146192_a(int var1, int var2, int var3) {
      boolean var4 = var1 >= this.field_146209_f
         && var1 < this.field_146209_f + this.field_146218_h
         && var2 >= this.field_146210_g
         && var2 < this.field_146210_g + this.field_146219_i;
      if (this.field_146212_n) {
         this.func_146195_b(var4);
      }

      if (this.field_146213_o && var3 == 0) {
         int var5 = var1 - this.field_146209_f;
   ...
   public void func_146194_f() {
      if (this.func_146176_q()) {
         ...
         if (var4.length() > 0) {
            ...
            var9 = this.field_146211_a.func_78261_a(var10, var7, var8, var1);
         }

         boolean var14 = this.field_146224_r < this.field_146216_j.length() || this.field_146216_j.length() >= this.func_146208_g();
         int var11 = var9;
         if (!var5) {
         ...
         if (var4.length() > 0 && var5 && var2 < var4.length()) {
            var9 = this.field_146211_a.func_78261_a(var4.substring(var2), var9, var8, var1);
         }
         ...
         if (var6) {
            if (var14) {
               ...
               this.field_146211_a.func_78261_a("_", var11, var8, var1);
            }
         }
