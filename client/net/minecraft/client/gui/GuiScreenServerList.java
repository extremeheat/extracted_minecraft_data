...
public class GuiScreenServerList extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      ((GuiButton)this.field_146292_n.get(0)).field_146124_l = this.field_146302_g.func_146179_b().length() > 0
         && this.field_146302_g.func_146179_b().split(":").length > 0;
   }
   ...
   protected void func_73869_a(char var1, int var2) {
      if (this.field_146302_g.func_146201_a(var1, var2)) {
         ((GuiButton)this.field_146292_n.get(0)).field_146124_l = this.field_146302_g.func_146179_b().length() > 0
            && this.field_146302_g.func_146179_b().split(":").length > 0;
   ...
   protected void func_73864_a(int var1, int var2, int var3) {
      ...
      this.field_146302_g.func_146192_a(var1, var2, var3);
   }
