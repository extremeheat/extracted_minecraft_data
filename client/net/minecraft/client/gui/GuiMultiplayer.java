...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_146794_g() {
      this.field_146292_n
         .add(this.field_146810_r = new GuiButton(7, this.field_146294_l / 2 - 154, this.field_146295_m - 28, 70, 20, I18n.func_135052_a("selectServer.edit")));
      this.field_146292_n
         .add(
            this.field_146808_t = new GuiButton(2, this.field_146294_l / 2 - 74, this.field_146295_m - 28, 70, 20, I18n.func_135052_a("selectServer.delete"))
         );
      this.field_146292_n
         .add(
            this.field_146809_s = new GuiButton(1, this.field_146294_l / 2 - 154, this.field_146295_m - 52, 100, 20, I18n.func_135052_a("selectServer.select"))
         );
   ...
   protected void func_146284_a(GuiButton var1) {
      if (var1.field_146124_l) {
         GuiListExtended$IGuiListEntry var2 = this.field_146803_h.func_148193_k() < 0
            ? null
         ...
         if (var1.field_146127_k == 2 && var2 instanceof ServerListEntryNormal) {
            ...
            this.field_146297_k
               .func_147108_a(new GuiScreenServerList(this, this.field_146811_z = new ServerData(I18n.func_135052_a("selectServer.defaultName"), "")));
         } else if (var1.field_146127_k == 3) {
            this.field_146806_v = true;
            this.field_146297_k
               .func_147108_a(new GuiScreenAddServer(this, this.field_146811_z = new ServerData(I18n.func_135052_a("selectServer.defaultName"), "")));
   ...
   public void func_73878_a(boolean var1, int var2) {
      GuiListExtended$IGuiListEntry var3 = this.field_146803_h.func_148193_k() < 0
         ? null
         : this.field_146803_h.func_148180_b(this.field_146803_h.func_148193_k());
   ...
   public void func_146796_h() {
      GuiListExtended$IGuiListEntry var1 = this.field_146803_h.func_148193_k() < 0
         ? null
         : this.field_146803_h.func_148180_b(this.field_146803_h.func_148193_k());
