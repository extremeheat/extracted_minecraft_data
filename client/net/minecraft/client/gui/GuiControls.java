...
public class GuiControls extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n
         .add(
            this.field_146493_s = new GuiButton(
               201, this.field_146294_l / 2 - 155 + 160, this.field_146295_m - 29, 150, 20, I18n.func_135052_a("controls.resetAll")
            )
         );
      ...
      for(GameSettings$Options var5 : field_146492_g) {
         if (var5.func_74380_a()) {
            ...
            this.field_146292_n
               .add(
                  new GuiOptionButton(
                     var5.func_74381_c(), this.field_146294_l / 2 - 155 + var1 % 2 * 160, 18 + 24 * (var1 >> 1), var5, this.field_146497_i.func_74297_c(var5)
                  )
               );
         }
   ...
   protected void func_146284_a(GuiButton var1) {
      if (var1.field_146127_k == 200) {
         ...
         for(KeyBinding var5 : this.field_146297_k.field_71474_y.field_74324_K) {
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      for(KeyBinding var8 : this.field_146497_i.field_74324_K) {
