...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject {
   ...
   class TeamSelectionObject implements ISpectatorMenuObject {
      ...
      public void func_178663_a(float var1, int var2) {
         int var3 = -1;
         String var4 = FontRenderer.func_78282_e(this.field_178676_b.func_96668_e());
         if (var4.length() >= 2) {
            var3 = Minecraft.func_71410_x().field_71466_p.func_175064_b(var4.charAt(1));
         }
         ...
         if (var3 >= 0) {
            ...
            Gui.func_73734_a(1, 1, 15, 15, MathHelper.func_180183_b(var5 * var1, var6 * var1, var7 * var1) | var2 << 24);
         }
