...
public class SpectatorMenu {
   ...
   public ISpectatorMenuObject func_178643_a(int var1) {
      ...
      if (this.field_178658_j > 0 && var1 == 0) {
         ...
         return var2 >= 0 && var2 < this.field_178659_h.func_178669_a().size() ? (ISpectatorMenuObject)Objects.firstNonNull(this.field_178659_h.func_178669_a().get(var2), field_178657_a) : field_178657_a;
      }
   }
