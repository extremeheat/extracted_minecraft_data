...
public class ChatPreviewRequests {
   ...
   public boolean trySendRequest(String var1, long var2) {
      ...
      if (var4 == null) {
         ...
         return true;
      } else if (this.isRequestReady(var2)) {
         PendingPreview var5 = new PendingPreview(this.queryIdGenerator.next(), var1);
         this.pending = var5;
         this.lastRequestTime = var2;
         var4.send((Packet)(new ServerboundChatPreviewPacket(var5.id(), var5.query())));
         return true;
      } else {
         return false;
      }
   ...
   private static record PendingPreview(int a, String b) {
