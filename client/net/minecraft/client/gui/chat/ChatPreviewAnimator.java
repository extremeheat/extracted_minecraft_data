...
public class ChatPreviewAnimator {
   ...
   public State get(long var1, @Nullable Component var3) {
      long var4 = var1 - this.lastTime;
      this.lastTime = var1;
      return var3 != null ? this.getEnabled(var4, var3) : this.getDisabled(var4);
   }

   private State getEnabled(long var1, Component var3) {
      this.residualPreview = var3;
      if (this.fadeTime < 200L) {
         this.fadeTime = Math.min(this.fadeTime + var1, 200L);
      }

      return new State(var3, alpha(this.fadeTime));
   }

   private State getDisabled(long var1) {
      if (this.fadeTime > 0L) {
         this.fadeTime = Math.max(this.fadeTime - var1, 0L);
      }

      return this.fadeTime > 0L ? new State(this.residualPreview, alpha(this.fadeTime)) : ChatPreviewAnimator.State.DISABLED;
   }
   ...
   public static record State(@Nullable Component b, float c) {
      ...
      public static final State DISABLED = new State((Component)null, 0.0F);
