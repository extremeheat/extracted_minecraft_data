...
public class GuiCommandBlock extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n
         .add(
            this.field_146490_i = new GuiButton(
               0, this.field_146294_l / 2 - 4 - 150, this.field_146295_m / 4 + 120 + 12, 150, 20, I18n.func_135052_a("gui.done")
            )
         );
      this.field_146292_n
         .add(
            this.field_146487_r = new GuiButton(1, this.field_146294_l / 2 + 4, this.field_146295_m / 4 + 120 + 12, 150, 20, I18n.func_135052_a("gui.cancel"))
         );
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      this.func_73731_b(
         this.field_146289_q,
         I18n.func_135052_a("advMode.nearestPlayer"),
         this.field_146294_l / 2 - 150,
         var4 + var5++ * this.field_146289_q.field_78288_b,
         10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         I18n.func_135052_a("advMode.randomPlayer"),
         this.field_146294_l / 2 - 150,
         var4 + var5++ * this.field_146289_q.field_78288_b,
         10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         I18n.func_135052_a("advMode.allPlayers"),
         this.field_146294_l / 2 - 150,
         var4 + var5++ * this.field_146289_q.field_78288_b,
         10526880
      );
      if (this.field_146486_g.func_146179_b().length() > 0) {
         var4 += var5 * this.field_146289_q.field_78288_b + 20;
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.previousOutput"), this.field_146294_l / 2 - 150, var4, 10526880);
