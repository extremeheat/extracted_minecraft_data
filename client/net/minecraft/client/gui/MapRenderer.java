...
public class MapRenderer implements AutoCloseable {
   ...
   private MapInstance getOrCreateMapInstance(int var1, MapItemSavedData var2) {
      return (MapInstance)this.maps.compute(var1, (var2x, var3) -> {
         if (var3 == null) {
      ...
      void draw(PoseStack var1, MultiBufferSource var2, boolean var3, int var4) {
         ...
         while(true) {
            ...
            if (var12.getName() != null) {
               ...
               var1.pushPose();
               var1.translate((double)(0.0F + (float)var12.getX() / 2.0F + 64.0F - var23 * var24 / 2.0F), (double)(0.0F + (float)var12.getY() / 2.0F + 64.0F + 4.0F), -0.02500000037252903);
