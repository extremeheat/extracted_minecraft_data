...
public class GuiScreenDemo extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      byte var1 = -16;
      this.field_146292_n
         .add(new GuiButton(1, this.field_146294_l / 2 - 116, this.field_146295_m / 2 + 62 + var1, 114, 20, I18n.func_135052_a("demo.help.buy")));
      this.field_146292_n
         .add(new GuiButton(2, this.field_146294_l / 2 + 2, this.field_146295_m / 2 + 62 + var1, 114, 20, I18n.func_135052_a("demo.help.later")));
   }
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      this.field_146289_q
         .func_78276_b(I18n.func_135052_a("demo.help.jump", GameSettings.func_74298_c(var6.field_74314_A.func_151463_i())), var4, var5 + 24, 5197647);
      this.field_146289_q
         .func_78276_b(I18n.func_135052_a("demo.help.inventory", GameSettings.func_74298_c(var6.field_151445_Q.func_151463_i())), var4, var5 + 36, 5197647);
