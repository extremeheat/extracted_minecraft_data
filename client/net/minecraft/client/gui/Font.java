...
public class Font {
   ...
   public int drawInBatch(String var1, float var2, float var3, int var4, boolean var5, Matrix4f var6, MultiBufferSource var7, DisplayMode var8, int var9, int var10, boolean var11) {
   ...
   private int drawInternal(FormattedCharSequence var1, float var2, float var3, int var4, boolean var5, Matrix4f var6, MultiBufferSource var7, DisplayMode var8, int var9, int var10) {
      var4 = adjustColor(var4);
   ...
   private float renderText(String var1, float var2, float var3, int var4, boolean var5, Matrix4f var6, MultiBufferSource var7, DisplayMode var8, int var9, int var10) {
      StringRenderOutput var11 = new StringRenderOutput(var7, var2, var3, var4, var5, var6, var8, var10);
      StringDecomposer.iterateFormatted((String)var1, Style.EMPTY, var11);
      return var11.finish(var9, var2);
   }

   private float renderText(FormattedCharSequence var1, float var2, float var3, int var4, boolean var5, Matrix4f var6, MultiBufferSource var7, DisplayMode var8, int var9, int var10) {
      StringRenderOutput var11 = new StringRenderOutput(var7, var2, var3, var4, var5, var6, var8, var10);
      var1.accept(var11);
      return var11.finish(var9, var2);
   }
