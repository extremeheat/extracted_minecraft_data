...
public class Font {
         ...
         for(int var12 = -1; var12 <= 1; ++var12) {
            if (var11 != 0 || var12 != 0) {
               ...
               var1.accept((var7x, var8x, var9x) -> {
                  ...
                  var10.field_494 = var13[0] + (float)var11 * var12x.getShadowOffset();
                  var10.field_495 = var3 + (float)var12 * var12x.getShadowOffset();
   ...
   private class StringRenderOutput implements FormattedCharSink {
      ...
      private final float field_490;
      // $FF: renamed from: g float
      private final float field_491;
      // $FF: renamed from: b float
      private final float field_492;
      // $FF: renamed from: a float
      private final float field_493;
      ...
      public StringRenderOutput(MultiBufferSource var2, float var3, float var4, int var5, boolean var6, Matrix4f var7, Font.DisplayMode var8, int var9) {
         ...
         this.field_490 = (float)(var5 >> 16 & 255) / 255.0F * this.dimFactor;
         this.field_491 = (float)(var5 >> 8 & 255) / 255.0F * this.dimFactor;
         this.field_492 = (float)(var5 & 255) / 255.0F * this.dimFactor;
         this.field_493 = (float)(var5 >> 24 & 255) / 255.0F;
         this.pose = var7;
         this.mode = var8;
      ...
      public boolean accept(int var1, Style var2, int var3) {
         ...
         if (!(var6 instanceof EmptyGlyph)) {
            ...
            Font.this.renderChar(var6, var7, var2.isItalic(), var16, this.field_494 + var14, this.field_495 + var14, this.pose, var15, var8, var9, var10, var11, this.packedLightCoords);
         }

         var16 = var5.getAdvance(var7);
         var14 = this.dropShadow ? 1.0F : 0.0F;
         if (var2.isStrikethrough()) {
            this.addEffect(new BakedGlyph.Effect(this.field_494 + var14 - 1.0F, this.field_495 + var14 + 4.5F, this.field_494 + var14 + var16, this.field_495 + var14 + 4.5F - 1.0F, 0.01F, var8, var9, var10, var11));
         }

         if (var2.isUnderlined()) {
            this.addEffect(new BakedGlyph.Effect(this.field_494 + var14 - 1.0F, this.field_495 + var14 + 9.0F, this.field_494 + var14 + var16, this.field_495 + var14 + 9.0F - 1.0F, 0.01F, var8, var9, var10, var11));
         }

         this.field_494 += var16;
         return true;
      }
      ...
      public float finish(int var1, float var2) {
         if (var1 != 0) {
            ...
            this.addEffect(new BakedGlyph.Effect(var2 - 1.0F, this.field_495 + 9.0F, this.field_494 + 1.0F, this.field_495 - 1.0F, 0.01F, var4, var5, var6, var3));
         }
