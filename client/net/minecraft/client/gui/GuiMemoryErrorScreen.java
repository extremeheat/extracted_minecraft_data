...
public class GuiMemoryErrorScreen extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(new GuiOptionButton(0, this.field_146294_l / 2 - 155, this.field_146295_m / 4 + 120 + 12, I18n.func_135052_a("gui.toMenu")));
      this.field_146292_n
         .add(new GuiOptionButton(1, this.field_146294_l / 2 - 155 + 160, this.field_146295_m / 4 + 120 + 12, I18n.func_135052_a("menu.quit")));
   }
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      this.func_73731_b(
         this.field_146289_q, "Minecraft has run out of memory.", this.field_146294_l / 2 - 140, this.field_146295_m / 4 - 60 + 60 + 0, 10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         "This could be caused by a bug in the game or by the",
         this.field_146294_l / 2 - 140,
         this.field_146295_m / 4 - 60 + 60 + 18,
         10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         ...
         this.field_146294_l / 2 - 140,
         this.field_146295_m / 4 - 60 + 60 + 27,
         10526880
      );
      ...
      this.func_73731_b(
         ...
         this.field_146294_l / 2 - 140,
         this.field_146295_m / 4 - 60 + 60 + 54,
         10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         ...
         this.field_146294_l / 2 - 140,
         this.field_146295_m / 4 - 60 + 60 + 63,
         10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         ...
         this.field_146294_l / 2 - 140,
         this.field_146295_m / 4 - 60 + 60 + 72,
         10526880
      );
      this.func_73731_b(
         this.field_146289_q,
         ...
         this.field_146294_l / 2 - 140,
         this.field_146295_m / 4 - 60 + 60 + 81,
         10526880
      );
