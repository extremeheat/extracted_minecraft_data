...
class GuiStats$StatsBlock$1 implements Comparator {
   ...
   public int compare(StatCrafting var1, StatCrafting var2) {
      ...
      if (var5 != null || var6 != null) {
         ...
         int var7 = GuiStats.access$200(this.field_148340_b.field_148221_k).func_77444_a(var5);
         int var8 = GuiStats.access$200(this.field_148340_b.field_148221_k).func_77444_a(var6);
         if (var7 != var8) {
