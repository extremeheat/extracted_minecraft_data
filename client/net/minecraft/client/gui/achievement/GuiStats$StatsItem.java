...
class GuiStats$StatsItem extends GuiStats$Stats {
   public GuiStats$StatsItem(GuiStats var1) {
      ...
      for(StatCrafting var3 : StatList.field_75938_d) {
         boolean var4 = false;
         int var5 = Item.func_150891_b(var3.func_150959_a());
         if (GuiStats.access$200(var1).func_77444_a(var3) > 0) {
            var4 = true;
         } else if (StatList.field_75930_F[var5] != null && GuiStats.access$200(var1).func_77444_a(StatList.field_75930_F[var5]) > 0) {
            var4 = true;
      ...
      this.field_148216_n = new GuiStats$StatsItem$1(this, var1);
   }
   ...
   protected void func_148126_a(int var1, int var2, int var3, int var4, Tessellator var5, int var6, int var7) {
      ...
      this.func_148209_a(StatList.field_75930_F[var10], var2 + 115, var3, var1 % 2 == 0);
      this.func_148209_a(StatList.field_75928_D[var10], var2 + 165, var3, var1 % 2 == 0);
