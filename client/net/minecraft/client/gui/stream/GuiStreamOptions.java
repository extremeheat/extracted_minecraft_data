...
public class GuiStreamOptions extends GuiScreen {
   ...
   public void func_73866_w_() {
            ...
            this.field_146292_n
               .add(
                  new GuiOptionButton(
                     ...
                     var5,
                     this.field_152318_h.func_74297_c(var5)
                  )
               );
         }
      ...
      for(GameSettings$Options var11 : field_152316_f) {
         if (var11.func_74380_a()) {
            this.field_146292_n
               .add(
                  new GuiOptionSlider(var11.func_74381_c(), this.field_146294_l / 2 - 155 + var1 % 2 * 160, this.field_146295_m / 6 + 24 * (var1 >> 1), var11)
               );
         } else {
            this.field_146292_n
               .add(
                  new GuiOptionButton(
                     ...
                     this.field_146295_m / 6 + 24 * (var1 >> 1),
                     var11,
                     this.field_152318_h.func_74297_c(var11)
                  )
               );
         }
      ...
      GuiButton var8 = new GuiButton(
         201, this.field_146294_l / 2 + 5, this.field_146295_m / 6 + 168, 150, 20, I18n.func_135052_a("options.stream.ingestSelection")
      );
      var8.field_146124_l = this.field_146297_k.func_152346_Z().func_152924_m() && this.field_146297_k.func_152346_Z().func_152925_v().length > 0
         || this.field_146297_k.func_152346_Z().func_152908_z();
   ...
   protected void func_146284_a(GuiButton var1) {
      if (var1.field_146124_l) {
         if (var1.field_146127_k < 100 && var1 instanceof GuiOptionButton) {
            ...
            if (this.field_146297_k.func_152346_Z().func_152934_n()
   ...
   public void func_73863_a(int var1, int var2, float var3) {
      ...
      if (this.field_152315_t) {
         this.func_73732_a(
            this.field_146289_q,
            EnumChatFormatting.RED + I18n.func_135052_a("options.stream.changes"),
            this.field_146294_l / 2,
            20 + this.field_146289_q.field_78288_b,
            16777215
         );
      }
