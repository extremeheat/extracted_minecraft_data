...
public class AdvancementWidget extends GuiComponent {
   ...
   private final int field_26;
   // $FF: renamed from: y int
   private final int field_27;
   ...
   public AdvancementWidget(AdvancementTab var1, Minecraft var2, Advancement var3, DisplayInfo var4) {
      ...
      this.field_26 = Mth.floor(var4.getX() * 28.0F);
      this.field_27 = Mth.floor(var4.getY() * 27.0F);
   ...
   public void drawConnectivity(PoseStack var1, int var2, int var3, boolean var4) {
      if (this.parent != null) {
         int var5 = var2 + this.parent.field_26 + 13;
         int var6 = var2 + this.parent.field_26 + 26 + 4;
         int var7 = var3 + this.parent.field_27 + 13;
         int var8 = var2 + this.field_26 + 13;
         int var9 = var3 + this.field_27 + 13;
   ...
   public void draw(PoseStack var1, int var2, int var3) {
      if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
         ...
         this.blit(var1, var2 + this.field_26 + 3, var3 + this.field_27, this.display.getFrame().getTexture(), 128 + var5.getIndex() * 26, 26, 26);
         this.minecraft.getItemRenderer().renderAndDecorateFakeItem(this.display.getIcon(), var2 + this.field_26 + 8, var3 + this.field_27 + 5);
      }
   ...
   public void drawHover(PoseStack var1, int var2, int var3, float var4, int var5, int var6) {
      ...
      int var17 = var3 + this.field_27;
      int var18;
      if (var7) {
         var18 = var2 + this.field_26 - this.width + 26 + 6;
      } else {
         var18 = var2 + this.field_26;
      }
      ...
      this.blit(var1, var2 + this.field_26 + 3, var3 + this.field_27, this.display.getFrame().getTexture(), 128 + var14.getIndex() * 26, 26, 26);
      if (var7) {
         this.minecraft.font.drawShadow(var1, (FormattedCharSequence)this.title, (float)(var18 + 5), (float)(var3 + this.field_27 + 9), -1);
         if (var8 != null) {
            this.minecraft.font.drawShadow(var1, (String)var8, (float)(var2 + this.field_26 - var9), (float)(var3 + this.field_27 + 9), -1);
         }
      } else {
         this.minecraft.font.drawShadow(var1, (FormattedCharSequence)this.title, (float)(var2 + this.field_26 + 32), (float)(var3 + this.field_27 + 9), -1);
         if (var8 != null) {
            this.minecraft.font.drawShadow(var1, (String)var8, (float)(var2 + this.field_26 + this.width - var9 - 5), (float)(var3 + this.field_27 + 9), -1);
         }
      }
      ...
      if (var10) {
         ...
         for(var20 = 0; var20 < this.description.size(); ++var20) {
            ...
            var22 = (FormattedCharSequence)this.description.get(var20);
            var10003 = (float)(var18 + 5);
            var10004 = var3 + this.field_27 + 9 + 17;
            Objects.requireNonNull(this.minecraft.font);
            var21.draw(var1, var22, var10003, (float)(var10004 + var20 * 9), -5592406);
         }
      }
   ...
   public boolean isMouseOver(int var1, int var2, int var3, int var4) {
      if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
         int var5 = var1 + this.field_26;
         int var6 = var5 + 26;
         int var7 = var2 + this.field_27;
         int var8 = var7 + 26;
