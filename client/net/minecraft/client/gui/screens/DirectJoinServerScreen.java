...
public class DirectJoinServerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.selectButton = (Button)this.addRenderableWidget(new Button(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20, Component.translatable("selectServer.select"), (var1) -> {
         this.onSelect();
      }));
