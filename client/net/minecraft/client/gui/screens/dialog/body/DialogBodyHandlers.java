...
public class DialogBodyHandlers {
   ...
   @Nullable
   public static <B extends DialogBody> LayoutElement createBodyElement(Screen var0, B var1) {
   ...
   static class PlainMessageHandler implements DialogBodyHandler<PlainMessage> {
      ...
      public LayoutElement createControls(Screen var1, PlainMessage var2) {
         return (new FocusableTextWidget(var2.width(), var2.contents(), var1.getFont(), false, false, 4)).setCentered(true);
      }
   }
   ...
   static class ItemHandler implements DialogBodyHandler<ItemBody> {
      ...
      public LayoutElement createControls(Screen var1, ItemBody var2) {
