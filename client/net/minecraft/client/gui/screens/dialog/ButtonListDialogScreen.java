...
public abstract class ButtonListDialogScreen<T extends ButtonListDialog> extends DialogScreen<T> {
   ...
   public ButtonListDialogScreen(@Nullable Screen var1, T var2) {
      super(var1, var2);
   }

   protected void populateBodyElements(LinearLayout var1, T var2) {
      List var3 = this.createListActions(var2).map((var1x) -> this.createClickActionButton(var1x).build()).toList();
      var1.addChild(packControlsIntoColumns(var3, var2.columns()));
   }

   protected abstract Stream<ClickAction> createListActions(T var1);
