...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      if (this.minecraft.level != null && this.minecraft.hasSingleplayerServer()) {
         ...
         this.addRenderableWidget(new Button(this.width / 2 + 5, this.height / 6 - 12 + 24 * (var1 >> 1), 150, 20, new TranslatableComponent("options.online"), (var1x) -> {
   ...
   public static CycleButton<Difficulty> createDifficultyButton(int var0, int var1, int var2, String var3, Minecraft var4) {
      return CycleButton.builder(Difficulty::getDisplayName).withValues((Object[])Difficulty.values()).withInitialValue(var4.level.getDifficulty()).create(var1 / 2 - 155 + var0 % 2 * 160, var2 / 6 - 12 + 24 * (var0 >> 1), 150, 20, new TranslatableComponent(var3), (var1x, var2x) -> {
