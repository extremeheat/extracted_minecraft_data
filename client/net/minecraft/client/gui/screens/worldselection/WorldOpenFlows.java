...
public class WorldOpenFlows {
   ...
   public void createFreshLevel(String var1, LevelSettings var2, RegistryAccess var3, WorldGenSettings var4) {
      ...
      if (var5 != null) {
         ...
         try {
            ...
            WorldStem var9 = this.loadWorldStem(var8, (var3x, var4x) -> Pair.of(new PrimaryLevelData(var2, var4, Lifecycle.stable()), var3.freeze()));
   ...
   public void createLevelFromExistingSettings(
      LevelStorageSource.LevelStorageAccess var1, ReloadableServerResources var2, RegistryAccess.Frozen var3, WorldData var4
   ) {
      PackRepository var5 = createPackRepository(var1);
      CloseableResourceManager var6 = (CloseableResourceManager)new WorldLoader.PackConfig(var5, var4.getDataPackConfig(), false)
   ...
   private static PackRepository createPackRepository(LevelStorageSource.LevelStorageAccess var0) {
      return new PackRepository(
         PackType.SERVER_DATA, new ServerPacksSource(), new FolderRepositorySource(var0.getLevelPath(LevelResource.DATAPACK_DIR).toFile(), PackSource.WORLD)
      );
   }
   ...
   private WorldStem loadWorldStem(LevelStorageSource.LevelStorageAccess var1, boolean var2, PackRepository var3) throws Exception {
      ...
      if (var4 == null) {
         ...
         return this.loadWorldStem(var5, (var1x, var2x) -> {
            RegistryAccess.Writable var3x = RegistryAccess.builtinCopy();
            RegistryOps var4x = RegistryOps.createAndLoad(NbtOps.INSTANCE, var3x, var1x);
            WorldData var5x = var1.getDataTag(var4x, var2x, var3x.allElementsLifecycle());
            if (var5x == null) {
               throw new IllegalStateException("Failed to load world");
            } else {
               return Pair.of(var5x, var3x.freeze());
            }
         });
      }
   }
   ...
   private WorldStem loadWorldStem(WorldLoader.PackConfig var1, WorldLoader.WorldDataSupplier<WorldData> var2) throws Exception {
      ...
      this.minecraft.managedBlock(var4::isDone);
   ...
   private void doLoadLevel(Screen var1, String var2, boolean var3, boolean var4) {
      ...
      if (var5 != null) {
         ...
         if (!var4 || !var9 && !var10) {
            this.minecraft.getClientPackSource().loadBundledResourcePack(var5).thenApply(var0 -> true).exceptionallyComposeAsync(var1x -> {
               ...
               if (var6x) {
                  ...
                  var7.close();
                  safeCloseAccess(var5, var2);
                  this.minecraft.getClientPackSource().clearServerPack().thenRunAsync(() -> this.minecraft.setScreen(var1), this.minecraft);
               }
