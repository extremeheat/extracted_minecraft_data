...
public class CreateWorldScreen extends Screen {
   ...
   public static void openFresh(Minecraft var0, @Nullable Screen var1) {
      ...
      PackRepository var2 = new PackRepository(PackType.SERVER_DATA, new RepositorySource[]{new ServerPacksSource()});
      ...
      CompletableFuture var4 = WorldLoader.load(var3, (var0x, var1x) -> {
         RegistryAccess.Frozen var2 = RegistryAccess.builtinCopy().freeze();
         WorldGenSettings var3 = WorldPresets.createNormalWorldFromPreset(var2);
      ...
      var0.setScreen(new CreateWorldScreen(var1, DataPackConfig.DEFAULT, new WorldGenSettingsComponent((WorldCreationContext)var4.join(), Optional.of(WorldPresets.NORMAL), OptionalLong.empty())));
   }
   ...
   public static CreateWorldScreen createFromExisting(@Nullable Screen var0, WorldStem var1, @Nullable Path var2) {
      ...
      CreateWorldScreen var9 = new CreateWorldScreen(var0, var8, new WorldGenSettingsComponent(var7, WorldPresets.fromSettings(var5), OptionalLong.of(var5.seed())));
      var9.initName = var4.levelName();
      var9.commands = var4.allowCommands();
      var9.commandsChanged = true;
      var9.difficulty = var4.difficulty();
      var9.gameRules.assignFrom(var4.gameRules(), (MinecraftServer)null);
      if (var4.hardcore()) {
   ...
   protected void init() {
      ...
      this.modeButton = (CycleButton)this.addRenderableWidget(CycleButton.builder(SelectedGameMode::getDisplayName).withValues((Object[])(CreateWorldScreen.SelectedGameMode.SURVIVAL, CreateWorldScreen.SelectedGameMode.HARDCORE, CreateWorldScreen.SelectedGameMode.CREATIVE)).withInitialValue(this.gameMode).withCustomNarration((var1x) -> {
      ...
      this.difficultyButton = (CycleButton)this.addRenderableWidget(CycleButton.builder(Difficulty::getDisplayName).withValues((Object[])Difficulty.values()).withInitialValue(this.getEffectiveDifficulty()).create(var2, 100, 150, 20, Component.translatable("options.difficulty"), (var1x, var2x) -> {
      ...
      this.commandsButton = (CycleButton)this.addRenderableWidget(CycleButton.onOffBuilder(this.commands && !this.hardCore).withCustomNarration((var0) -> {
         return CommonComponents.joinForNarration(var0.createDefaultNarrationMessage(), Component.translatable("selectWorld.allowCommands.info"));
      }).create(var1, 151, 150, 20, Component.translatable("selectWorld.allowCommands"), (var1x, var2x) -> {
         this.commandsChanged = true;
         this.commands = var2x;
      }));
      this.dataPacksButton = (Button)this.addRenderableWidget(new Button(var2, 151, 150, 20, Component.translatable("selectWorld.dataPacks"), (var1x) -> {
         this.openDataPackSelectionScreen();
      }));
      this.gameRulesButton = (Button)this.addRenderableWidget(new Button(var1, 185, 150, 20, Component.translatable("selectWorld.gameRules"), (var1x) -> {
      ...
      this.moreOptionsButton = (Button)this.addRenderableWidget(new Button(var2, 185, 150, 20, Component.translatable("selectWorld.moreWorldOptions"), (var1x) -> {
         this.toggleWorldGenSettingsVisibility();
      }));
      this.createButton = (Button)this.addRenderableWidget(new Button(var1, this.height - 28, 150, 20, Component.translatable("selectWorld.create"), (var1x) -> {
         this.onCreate();
      }));
   ...
   private void createNewWorld() {
      ...
      if (!var1.isEmpty()) {
         ...
         this.minecraft.createWorldOpenFlows().createLevelFromExistingSettings((LevelStorageSource.LevelStorageAccess)var1.get(), var2.dataPackResources(), var2.registryAccess(), var4);
      }
   }
   ...
   private LevelSettings createLevelSettings(boolean var1) {
      ...
      if (var1) {
         ...
         return new LevelSettings(var2, this.gameMode.gameType, this.hardCore, this.getEffectiveDifficulty(), this.commands && !this.hardCore, this.gameRules, this.dataPacks);
      }
   }
   ...
   private void setGameMode(SelectedGameMode var1) {
   ...
   private void openDataPackSelectionScreen() {
      ...
      if (var1 != null) {
         this.minecraft.setScreen(new PackSelectionScreen(this, (PackRepository)var1.getSecond(), this::tryApplyNewDataPacks, (File)var1.getFirst(), Component.translatable("dataPack.title")));
      }
   ...
   private void tryApplyNewDataPacks(PackRepository var1) {
      ...
      if (var2.equals(this.dataPacks.getEnabled())) {
         ...
         WorldLoader.load(var5, (var1x, var2x) -> {
            WorldCreationContext var3 = this.worldGenSettingsComponent.settings();
            RegistryAccess.Frozen var4 = var3.registryAccess();
            RegistryAccess.Writable var5 = RegistryAccess.builtinCopy();
            RegistryOps var6 = RegistryOps.create(JsonOps.INSTANCE, var4);
            RegistryOps var7 = RegistryOps.createAndLoad(JsonOps.INSTANCE, var5, (ResourceManager)var1x);
            DataResult var8 = WorldGenSettings.CODEC.encodeStart(var6, var3.worldGenSettings()).setLifecycle(Lifecycle.stable());
            DataResult var9 = var8.flatMap((var1) -> {
               return WorldGenSettings.CODEC.parse(var7, var1);
            });
            RegistryAccess.Frozen var10 = var5.freeze();
            Lifecycle var11 = var9.lifecycle().add(var10.allElementsLifecycle());
            Logger var10003 = LOGGER;
            Objects.requireNonNull(var10003);
            WorldGenSettings var12 = (WorldGenSettings)var9.getOrThrow(false, Util.prefix("Error parsing worldgen settings after loading data packs: ", var10003::error));
         ...
         }, Util.backgroundExecutor(), this.minecraft).thenAcceptAsync((var2x) -> {
            this.dataPacks = var4;
