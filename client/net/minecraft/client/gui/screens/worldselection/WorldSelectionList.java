...
public class WorldSelectionList extends ObjectSelectionList<Entry> {
   ...
   private static final Duration MAX_LOAD_BLOCK_TIME;
   ...
   public WorldSelectionList(SelectWorldScreen var1, Minecraft var2, int var3, int var4, int var5, int var6, int var7, Supplier<String> var8, @Nullable WorldSelectionList var9) {
      ...
      if (var9 != null) {
         this.levelsFuture = var9.levelsFuture;
         this.refreshList((String)var8.get());
      } else {
         this.reloadLevels(var8);
      }

   }

   public void reloadLevels(Supplier<String> var1) {
      this.levelsFuture = this.loadLevels();
      List var2 = this.pollReadyLevels(this.levelsFuture, MAX_LOAD_BLOCK_TIME);
      if (var2 != null) {
         this.fillLevels((String)var1.get(), var2);
      } else {
         this.fillLoadingLevels();
         this.levelsFuture.thenAcceptAsync((var2x) -> {
            this.fillLevels((String)var1.get(), var2x);
         }, this.minecraft);
      }

   }

   public void refreshList(String var1) {
      if (this.levelsFuture == null) {
         this.clearEntries();
      } else {
         List var2 = this.pollReadyLevels(this.levelsFuture, Duration.ZERO);
         if (var2 != null) {
            this.fillLevels(var1, var2);
         } else {
            this.fillLoadingLevels();
         }
   ...
   @Nullable
   private List<LevelSummary> pollReadyLevels(CompletableFuture<List<LevelSummary>> var1, Duration var2) {
      List var3 = null;

      try {
         var3 = (List)var1.get(var2.toMillis(), TimeUnit.MILLISECONDS);
   ...
   protected void moveSelection(AbstractSelectionList.SelectionDirection var1) {
      this.moveSelection(var1, Entry::isSelectable);
   }
   ...
   static {
      ...
      MAX_LOAD_BLOCK_TIME = Duration.ofMillis(100L);
   }
   ...
   public final class WorldListEntry extends Entry implements AutoCloseable {
      ...
      public Component getNarration() {
         MutableComponent var1 = Component.translatable("narrator.select.world", this.summary.getLevelName(), new Date(this.summary.getLastPlayed()), this.summary.isHardcore() ? Component.translatable("gameMode.hardcore") : Component.translatable("gameMode." + this.summary.getGameMode().getName()), this.summary.hasCheats() ? Component.translatable("selectWorld.cheats") : CommonComponents.EMPTY, this.summary.getWorldVersionName());
      ...
      public void recreateWorld() {
         ...
         try {
            ...
            try {
               WorldStem var2 = this.minecraft.createWorldOpenFlows().loadWorldStem(var1, false);
               ...
               try {
                  ...
                  if (var3.isOldCustomizedWorld()) {
                     this.minecraft.setScreen(new ConfirmScreen((var3x) -> {
                        this.minecraft.setScreen((Screen)(var3x ? CreateWorldScreen.createFromExisting(this.screen, var2, var4) : this.screen));
