...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      Button var5 = var4.addChild(this.openScreenButton(TELEMETRY, () -> new TelemetryInfoScreen(this, this.options)));
   ...
   private LayoutElement createOnlineButton() {
      if (this.minecraft.level != null && this.minecraft.hasSingleplayerServer()) {
         ...
         return Button.builder(Component.translatable("options.online"), var1x -> this.minecraft.setScreen(new OnlineOptionsScreen(this, this.options)))
