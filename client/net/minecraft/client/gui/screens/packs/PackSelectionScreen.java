...
public class PackSelectionScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addRenderableWidget(new Button(this.width / 2 - 154, this.height - 48, 150, 20, Component.translatable("pack.openFolder"), (var1) -> {
   ...
   static class Watcher implements AutoCloseable {
      ...
      @Nullable
      public static Watcher create(File var0) {
         try {
