...
public class AccessibilityOptionsScreen extends SimpleOptionsSubScreen {
   ...
   private static OptionInstance<?>[] options(Options var0) {
      return new OptionInstance[]{var0.narrator(), var0.showSubtitles(), var0.textBackgroundOpacity(), var0.backgroundForChatOnly(), var0.chatOpacity(), var0.chatLineSpacing(), var0.chatDelay(), var0.autoJump(), var0.toggleCrouch(), var0.toggleSprint(), var0.screenEffectScale(), var0.fovEffectScale(), var0.darkMojangStudiosBackground(), var0.hideLightningFlash(), var0.darknessEffectScale()};
   }
   ...
   protected void createFooter() {
      this.addRenderableWidget(new Button(this.width / 2 - 155, this.height - 27, 150, 20, Component.translatable("options.accessibility.link"), (var1) -> {
