...
public class ConnectScreen extends Screen {
      ...
      Thread var3 = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.send(new ServerboundHelloPacket(var1.getUser().getName(), var1.getProfileKeyPairManager().profilePublicKeyData()));
               ...
               String var7 = var1x == null ? var3.getMessage() : var3.getMessage().replaceAll(var1x.getHostName() + ":" + var1x.getPort(), "").replaceAll(var1x.toString(), "");
               var1.execute(() -> {
                  var1.setScreen(new DisconnectedScreen(ConnectScreen.this.parent, CommonComponents.CONNECT_FAILED, Component.translatable("disconnect.genericReason", var7)));
               });
            }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (var5 - this.lastNarration > 2000L) {
         ...
         NarratorChatListener.INSTANCE.sayNow((Component)Component.translatable("narrator.joining"));
      }
