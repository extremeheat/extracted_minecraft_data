      ...
      Thread var3 = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.send(new ServerboundHelloPacket(var1.getUser().getName(), var1.getProfileKeyPairManager().profilePublicKeyData(), Optional.ofNullable(var1.getUser().getProfileId())));
