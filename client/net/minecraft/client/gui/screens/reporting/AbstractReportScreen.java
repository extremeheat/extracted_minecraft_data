...
public abstract class AbstractReportScreen<B extends Report.Builder<?>> extends Screen {
   ...
   protected void createFooter() {
      this.attestation = (Checkbox)this.layout.addChild(Checkbox.builder(ATTESTATION_CHECKBOX, this.font).selected(this.reportBuilder.attested()).maxWidth(280).tooltip(Tooltip.create(ATTESTATION_CHECKBOX)).onValueChange((checkbox, value) -> {
