...
public class OnlineOptionsScreen extends SimpleOptionsSubScreen {
   ...
   protected void createFooter() {
      if (this.minecraft.level != null) {
         CycleButton var1 = (CycleButton)this.addRenderableWidget(OptionsScreen.createDifficultyButton(this.smallOptions.length, this.width, this.height, "options.difficulty.online", this.minecraft));
         var1.active = false;
      }
