...
public enum UnlockTabType {
   ...
   private UnlockTabType(final Sprites var3, final Sprites var4, final int var5, final int var6, final int var7) {
   ...
   public void draw(GuiGraphics var1, int var2, int var3, boolean var4, int var5, int var6, int var7) {
      Sprites var8 = var4 ? this.selectedSprites : this.unselectedSprites;
      ...
      var1.blitSprite(RenderType::guiTextured, var9, var2 + this.getX(var5, var6), var3 + this.getY(var5, var7), this.width, this.height);
   }

   public void drawIcon(GuiGraphics var1, int var2, int var3, int var4, ItemStack var5, int var6, int var7) {
      int var8 = var2 + this.getX(var4, var6);
      int var9 = var3 + this.getY(var4, var7);
      switch (this.ordinal()) {
         case 0:
            var8 += 6;
            var9 += 9;
      ...
      var1.renderFakeItem(var5, var8, var9);
   }
   ...
   public boolean isMouseOver(int var1, int var2, int var3, double var4, double var6, int var8, int var9) {
      int var10 = var1 + this.getX(var3, var8);
      int var11 = var2 + this.getY(var3, var9);
      return var4 > (double)var10 && var4 < (double)(var10 + this.width) && var6 > (double)var11 && var6 < (double)(var11 + this.height);
   }

   // $FF: synthetic method
   private static UnlockTabType[] $values() {
      return new UnlockTabType[]{ABOVE, BELOW, LEFT, RIGHT};
   }
