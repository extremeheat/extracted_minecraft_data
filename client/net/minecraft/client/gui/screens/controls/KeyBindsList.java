...
public class KeyBindsList extends ContainerObjectSelectionList<Entry> {
   ...
   public class KeyEntry extends Entry {
      ...
      KeyEntry(final KeyMapping var2, final Component var3) {
         ...
         this.changeButton = new Button(0, 0, 75, 20, var3, (var2x) -> {
            ...
            protected MutableComponent createNarrationMessage() {
               return var2.isUnbound() ? Component.translatable("narrator.controls.unbound", var3) : Component.translatable("narrator.controls.bound", var3, super.createNarrationMessage());
            }
         };
      ...
      public void render(PoseStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
         ...
         if (var11) {
            this.changeButton.setMessage(Component.literal("> ").append((Component)this.changeButton.getMessage().copy().withStyle(ChatFormatting.YELLOW)).append(" <").withStyle(ChatFormatting.YELLOW));
         } else if (var12) {
