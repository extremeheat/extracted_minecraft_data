...
public class BackupConfirmScreen extends Screen {
   ...
   public BackupConfirmScreen(Screen var1, Listener var2, Component var3, Component var4, boolean var5) {
      super(var3);
   ...
   protected void init() {
      ...
      int var1 = var10000 * 9;
      this.addRenderableWidget(new Button(this.width / 2 - 155, 100 + var1, 150, 20, Component.translatable("selectWorld.backupJoinConfirmButton"), (var1x) -> {
         this.listener.proceed(true, this.eraseCache.selected());
      }));
      this.addRenderableWidget(new Button(this.width / 2 - 155 + 160, 100 + var1, 150, 20, Component.translatable("selectWorld.backupJoinSkipButton"), (var1x) -> {
