...
public class ServerSelectionList extends ObjectSelectionList<Entry> {
   ...
   protected void moveSelection(AbstractSelectionList.SelectionDirection var1) {
      this.moveSelection(var1, (var0) -> {
         return !(var0 instanceof LANHeader);
      });
   }
   ...
   public void updateNetworkServers(List<LanServer> var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.networkServers.add(new NetworkServerEntry(this.screen, var3));
      }
   ...
   static {
      ...
      CANT_RESOLVE_TEXT = Component.translatable("multiplayer.status.cannot_resolve").withStyle(ChatFormatting.DARK_RED);
      CANT_CONNECT_TEXT = Component.translatable("multiplayer.status.cannot_connect").withStyle(ChatFormatting.DARK_RED);
      INCOMPATIBLE_TOOLTIP = Component.translatable("multiplayer.status.incompatible");
      NO_CONNECTION_TOOLTIP = Component.translatable("multiplayer.status.no_connection");
      PINGING_TOOLTIP = Component.translatable("multiplayer.status.pinging");
   }
