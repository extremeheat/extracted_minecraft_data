...
public abstract class RecipeBookComponent<T extends RecipeBookMenu> implements Renderable, GuiEventListener, NarratableEntry, RecipeShownListener {
   ...
   private void initVisuals() {
      ...
      this.searchBox = new EditBox(this.minecraft.font, var2 + 25, var3 + 13, 81, 9 + 5, Component.translatable("itemGroup.search"));
   ...
   public void renderGhostRecipe(GuiGraphics var1, int var2, int var3, boolean var4) {
      this.ghostSlots.render(var1, this.minecraft, var2, var3, var4);
   }
