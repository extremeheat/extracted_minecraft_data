...
public class OverlayRecipeComponent extends GuiComponent implements Widget, GuiEventListener {
   ...
   public void init(Minecraft var1, RecipeCollection var2, int var3, int var4, int var5, int var6, float var7) {
      ...
      this.field_29 = var4;
      boolean var15 = true;
      float var16 = (float)(this.field_28 + Math.min(var12, var13) * 25);
      float var17 = (float)(var5 + 50);
      if (var16 > var17) {
         this.field_28 = (int)((float)this.field_28 - var7 * (float)((int)((var16 - var17) / var7)));
      }

      float var18 = (float)(this.field_29 + var14 * 25);
      float var19 = (float)(var6 + 50);
      if (var18 > var19) {
         this.field_29 = (int)((float)this.field_29 - var7 * (float)Mth.ceil((var18 - var19) / var7));
      }

      float var20 = (float)this.field_29;
      float var21 = (float)(var6 - 100);
      if (var20 < var21) {
         this.field_29 = (int)((float)this.field_29 - var7 * (float)Mth.ceil((var20 - var21) / var7));
      }
      ...
      for(int var22 = 0; var22 < var12; ++var22) {
         ...
         int var25 = this.field_28 + 4 + 25 * (var22 % var13);
         int var26 = this.field_29 + 5 + 25 * (var22 / var13);
   ...
   private void nineInchSprite(PoseStack var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      this.blit(var1, this.field_28, this.field_29, var6, var7, var5, var5);
      this.blit(var1, this.field_28 + var5 * 2 + var2 * var4, this.field_29, var6 + var4 + var5, var7, var5, var5);
      this.blit(var1, this.field_28, this.field_29 + var5 * 2 + var3 * var4, var6, var7 + var4 + var5, var5, var5);
      this.blit(var1, this.field_28 + var5 * 2 + var2 * var4, this.field_29 + var5 * 2 + var3 * var4, var6 + var4 + var5, var7 + var4 + var5, var5, var5);

      for(int var8 = 0; var8 < var2; ++var8) {
         this.blit(var1, this.field_28 + var5 + var8 * var4, this.field_29, var6 + var5, var7, var4, var5);
         this.blit(var1, this.field_28 + var5 + (var8 + 1) * var4, this.field_29, var6 + var5, var7, var5, var5);

         for(int var9 = 0; var9 < var3; ++var9) {
            if (var8 == 0) {
               this.blit(var1, this.field_28, this.field_29 + var5 + var9 * var4, var6, var7 + var5, var5, var4);
               this.blit(var1, this.field_28, this.field_29 + var5 + (var9 + 1) * var4, var6, var7 + var5, var5, var5);
            }

            this.blit(var1, this.field_28 + var5 + var8 * var4, this.field_29 + var5 + var9 * var4, var6 + var5, var7 + var5, var4, var4);
            this.blit(var1, this.field_28 + var5 + (var8 + 1) * var4, this.field_29 + var5 + var9 * var4, var6 + var5, var7 + var5, var5, var4);
            this.blit(var1, this.field_28 + var5 + var8 * var4, this.field_29 + var5 + (var9 + 1) * var4, var6 + var5, var7 + var5, var4, var5);
            this.blit(var1, this.field_28 + var5 + (var8 + 1) * var4 - 1, this.field_29 + var5 + (var9 + 1) * var4 - 1, var6 + var5, var7 + var5, var5 + 1, var5 + 1);
            if (var8 == var2 - 1) {
               this.blit(var1, this.field_28 + var5 * 2 + var2 * var4, this.field_29 + var5 + var9 * var4, var6 + var4 + var5, var7 + var5, var5, var4);
               this.blit(var1, this.field_28 + var5 * 2 + var2 * var4, this.field_29 + var5 + (var9 + 1) * var4, var6 + var4 + var5, var7 + var5, var5, var5);
            }
         }

         this.blit(var1, this.field_28 + var5 + var8 * var4, this.field_29 + var5 * 2 + var3 * var4, var6 + var5, var7 + var4 + var5, var4, var5);
         this.blit(var1, this.field_28 + var5 + (var8 + 1) * var4, this.field_29 + var5 * 2 + var3 * var4, var6 + var5, var7 + var4 + var5, var5, var5);
      }
   ...
   private class OverlayRecipeButton extends AbstractWidget implements PlaceRecipe<Ingredient> {
      ...
      public void renderButton(PoseStack var1, int var2, int var3, float var4) {
         ...
         while(var8.hasNext()) {
            ...
            var7.pushPose();
            var7.translate((double)var9.field_186, (double)var9.field_187, 0.0D);
      ...
      protected class Pos {
         ...
         // $FF: renamed from: x int
         public final int field_186;
         // $FF: renamed from: y int
         public final int field_187;
