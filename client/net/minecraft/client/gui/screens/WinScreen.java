...
public class WinScreen extends Screen {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      var12.vertex(0.0, (double)var14, (double)this.getBlitOffset()).uv(0.0F, 1.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      var12.vertex((double)var9, (double)var14, (double)this.getBlitOffset()).uv(1.0F, 1.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      var12.vertex((double)var9, 0.0, (double)this.getBlitOffset()).uv(1.0F, 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
