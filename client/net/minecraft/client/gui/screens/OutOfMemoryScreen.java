...
public class OutOfMemoryScreen extends Screen {
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, I18n.get("gui.toTitle"), (var1) -> {
         this.minecraft.setScreen(new TitleScreen());
      }));
      this.addButton(new Button(this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, 150, 20, I18n.get("menu.quit"), (var1) -> {
         this.minecraft.stop();
      }));
   }
