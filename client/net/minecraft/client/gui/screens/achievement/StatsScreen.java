...
public class StatsScreen extends Screen implements StatsUpdateListener {
   ...
   public void initButtons() {
      this.addRenderableWidget(new Button(this.width / 2 - 120, this.height - 52, 80, 20, Component.translatable("stat.generalButton"), (var1x) -> {
         this.setActiveList(this.statsList);
      }));
      Button var1 = (Button)this.addRenderableWidget(new Button(this.width / 2 - 40, this.height - 52, 80, 20, Component.translatable("stat.itemsButton"), (var1x) -> {
         this.setActiveList(this.itemStatsList);
      }));
      Button var2 = (Button)this.addRenderableWidget(new Button(this.width / 2 + 40, this.height - 52, 80, 20, Component.translatable("stat.mobsButton"), (var1x) -> {
