...
public class ConfirmLinkScreen extends ConfirmScreen {
   ...
   protected static MutableComponent confirmMessage(boolean var0, String var1) {
      return confirmMessage(var0).append(" ").append((Component)Component.literal(var1));
   }
   ...
   protected void addButtons(int var1) {
      this.addRenderableWidget(new Button(this.width / 2 - 50 - 105, var1, 100, 20, this.yesButton, (var1x) -> {
      ...
      this.addRenderableWidget(new Button(this.width / 2 - 50 + 105, var1, 100, 20, this.noButton, (var1x) -> {
         this.callback.accept(false);
      }));
   }
