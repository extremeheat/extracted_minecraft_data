...
public class StructureBlockEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.saveButton = (Button)this.addRenderableWidget(new Button(this.width / 2 + 4 + 100, 185, 50, 20, Component.translatable("structure_block.button.save"), (var1x) -> {
      ...
      this.loadButton = (Button)this.addRenderableWidget(new Button(this.width / 2 + 4 + 100, 185, 50, 20, Component.translatable("structure_block.button.load"), (var1x) -> {
      ...
      this.detectButton = (Button)this.addRenderableWidget(new Button(this.width / 2 + 4 + 100, 120, 50, 20, Component.translatable("structure_block.button.detect_size"), (var1x) -> {
         if (this.structure.getMode() == StructureMode.SAVE) {
      ...
      this.rot0Button = (Button)this.addRenderableWidget(new Button(this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, Component.literal("0"), (var1x) -> {
         this.structure.setRotation(Rotation.NONE);
         this.updateDirectionButtons();
      }));
      this.rot90Button = (Button)this.addRenderableWidget(new Button(this.width / 2 - 1 - 40 - 20, 185, 40, 20, Component.literal("90"), (var1x) -> {
         this.structure.setRotation(Rotation.CLOCKWISE_90);
         this.updateDirectionButtons();
      }));
      this.rot180Button = (Button)this.addRenderableWidget(new Button(this.width / 2 + 1 + 20, 185, 40, 20, Component.literal("180"), (var1x) -> {
         this.structure.setRotation(Rotation.CLOCKWISE_180);
         this.updateDirectionButtons();
      }));
      this.rot270Button = (Button)this.addRenderableWidget(new Button(this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, Component.literal("270"), (var1x) -> {
