...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      for(int var8 = 0; var8 < this.menu.slots.size(); ++var8) {
         ...
         if (this.isHovering(var9, (double)var2, (double)var3) && var9.isActive()) {
            ...
            var10 = var9.field_137;
            var11 = var9.field_138;
      ...
      if (!this.snapbackItem.isEmpty()) {
         ...
         var10 = this.snapbackEnd.field_137 - this.snapbackStartX;
         var11 = this.snapbackEnd.field_138 - this.snapbackStartY;
   ...
   private void renderSlot(PoseStack var1, Slot var2) {
      int var3 = var2.field_137;
      int var4 = var2.field_138;
      ...
      if (!var7) {
         ...
         RenderSystem.enableDepthTest();
         this.itemRenderer.renderAndDecorateItem(this.minecraft.player, var5, var3, var4, var2.field_137 + var2.field_138 * this.imageWidth);
   ...
   private boolean isHovering(Slot var1, double var2, double var4) {
      return this.isHovering(var1.field_137, var1.field_138, 16, 16, var2, var4);
   }
