...
public class CartographyTableScreen extends AbstractContainerScreen<CartographyTableMenu> {
   ...
   protected void renderBg(PoseStack var1, float var2, int var3, int var4) {
      ...
      boolean var8 = var7.method_87(Items.MAP);
      boolean var9 = var7.method_87(Items.PAPER);
      boolean var10 = var7.method_87(Items.GLASS_PANE);
      ItemStack var11 = ((CartographyTableMenu)this.menu).getSlot(0).getItem();
      boolean var14 = false;
      Integer var12;
      MapItemSavedData var13;
      if (var11.method_87(Items.FILLED_MAP)) {
