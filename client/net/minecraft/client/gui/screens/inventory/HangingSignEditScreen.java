...
public class HangingSignEditScreen extends AbstractSignEditScreen {
   ...
   public HangingSignEditScreen(SignBlockEntity var1, boolean var2) {
      super(var1, var2, Component.translatable("hanging_sign.edit"));
   }

   @Override
   protected void offsetSign(PoseStack var1, BlockState var2) {
      var1.translate((float)this.width / 2.0F, 125.0F, 50.0F);
   }
