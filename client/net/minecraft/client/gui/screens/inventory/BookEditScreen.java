...
public class BookEditScreen extends Screen {
   ...
   public BookEditScreen(Player var1, ItemStack var2, InteractionHand var3) {
      ...
      this.ownerText = (new TranslatableComponent("book.byAuthor", new Object[]{var1.getName()})).withStyle(ChatFormatting.DARK_GRAY);
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.isSigning) {
         ...
         this.font.draw(var1, (Component)EDIT_TITLE_LABEL, (float)(var5 + 36 + (114 - var9) / 2), 34.0F, 0);
         var10 = this.font.width(var8);
         this.font.draw(var1, (FormattedCharSequence)var8, (float)(var5 + 36 + (114 - var10) / 2), 50.0F, 0);
         var11 = this.font.width((FormattedText)this.ownerText);
         this.font.draw(var1, (Component)this.ownerText, (float)(var5 + 36 + (114 - var11) / 2), 60.0F, 0);
         this.font.drawWordWrap(FINALIZE_WARNING_LABEL, var5 + 36, 82, 114, 0);
      } else {
         int var13 = this.font.width((FormattedText)this.pageMsg);
         this.font.draw(var1, (Component)this.pageMsg, (float)(var5 - var13 + 192 - 44), 18.0F, 0);
         ...
         for(var11 = 0; var11 < var10; ++var11) {
            ...
            this.font.draw(var1, var12.asComponent, (float)var12.field_403, (float)var12.field_404, -16777216);
         }

         this.renderHighlight(var14.selection);
   ...
   private void renderCursor(PoseStack var1, BookEditScreen.Pos2i var2, boolean var3) {
      if (this.frameTick / 6 % 2 == 0) {
         ...
         if (!var3) {
            int var10001 = var2.field_417;
            int var10002 = var2.field_418 - 1;
            int var10003 = var2.field_417 + 1;
            int var10004 = var2.field_418;
            Objects.requireNonNull(this.font);
            GuiComponent.fill(var1, var10001, var10002, var10003, var10004 + 9, -16777216);
         } else {
            this.font.draw(var1, (String)"_", (float)var2.field_417, (float)var2.field_418, 0);
         }
      }
   ...
   private BookEditScreen.Pos2i convertScreenToLocal(BookEditScreen.Pos2i var1) {
      return new BookEditScreen.Pos2i(var1.field_417 - (this.width - 192) / 2 - 36, var1.field_418 - 32);
   }
   ...
   private BookEditScreen.DisplayCache rebuildDisplayCache() {
      ...
      if (var1.isEmpty()) {
         ...
         var8.splitLines(var1, 114, Style.EMPTY, true, (var6x, var7x, var8x) -> {
            ...
            var4.add(var7x);
            var5.add(new BookEditScreen.LineInfo(var6x, var11, var13.field_417, var13.field_418));
         });
   ...
   private Rect2i createSelection(BookEditScreen.Pos2i var1, BookEditScreen.Pos2i var2) {
      ...
      int var5 = Math.min(var3.field_417, var4.field_417);
      int var6 = Math.max(var3.field_417, var4.field_417);
      int var7 = Math.min(var3.field_418, var4.field_418);
      int var8 = Math.max(var3.field_418, var4.field_418);
   ...
   static class DisplayCache {
      ...
      public int getIndexAtPosition(Font var1, BookEditScreen.Pos2i var2) {
         ...
         if (var3 < 0) {
            ...
            return this.lineStarts[var3] + var1.getSplitter().plainIndexAtWidth(var4.contents, var2.field_417, var4.style);
         }
      }
   ...
   private static class Pos2i {
      // $FF: renamed from: x int
      public final int field_417;
      // $FF: renamed from: y int
      public final int field_418;
