...
public class BookEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.signButton = (Button)this.addRenderableWidget(new Button(this.width / 2 - 100, 196, 98, 20, Component.translatable("book.signButton"), (var1x) -> {
         this.isSigning = true;
      ...
      this.finalizeButton = (Button)this.addRenderableWidget(new Button(this.width / 2 - 100, 196, 98, 20, Component.translatable("book.finalizeButton"), (var1x) -> {
         if (this.isSigning) {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.isSigning) {
         ...
         for(var11 = 0; var11 < var10; ++var11) {
            ...
            this.font.draw(var1, var12.asComponent, (float)var12.x, (float)var12.y, -16777216);
         }
   ...
   private void renderCursor(PoseStack var1, Pos2i var2, boolean var3) {
   ...
   private void renderHighlight(Rect2i[] var1) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         var3.vertex((double)var8, (double)var11, 0.0).endVertex();
         var3.vertex((double)var10, (double)var11, 0.0).endVertex();
         var3.vertex((double)var10, (double)var9, 0.0).endVertex();
         var3.vertex((double)var8, (double)var9, 0.0).endVertex();
      }
