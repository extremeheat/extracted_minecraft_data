...
public class HorseInventoryScreen extends AbstractContainerScreen<HorseInventoryMenu> {
   ...
   protected void renderBg(GuiGraphics var1, float var2, int var3, int var4) {
      ...
      if (this.horse.isSaddleable()) {
         var1.blitSprite(RenderType::guiTextured, (ResourceLocation)SADDLE_SLOT_SPRITE, var5 + 7, var6 + 35 - 18, 18, 18);
      }

      if (this.horse.canUseSlot(EquipmentSlot.BODY)) {
         if (this.horse instanceof Llama) {
            var1.blitSprite(RenderType::guiTextured, (ResourceLocation)LLAMA_ARMOR_SLOT_SPRITE, var5 + 7, var6 + 35, 18, 18);
         } else {
            var1.blitSprite(RenderType::guiTextured, (ResourceLocation)ARMOR_SLOT_SPRITE, var5 + 7, var6 + 35, 18, 18);
         }
      }
