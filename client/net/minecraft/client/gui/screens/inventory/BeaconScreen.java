...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
   ...
   protected void init() {
      ...
      BeaconUpgradePowerButton var8 = new BeaconUpgradePowerButton(this.leftPos + 167 + (var2 - 1) * 24 - var3 / 2, this.topPos + 47, BeaconBlockEntity.BEACON_EFFECTS[0][0]);
      var8.visible = false;
   ...
   protected void renderLabels(PoseStack var1, int var2, int var3) {
      ...
      while(var4.hasNext()) {
         BeaconButton var5 = (BeaconButton)var4.next();
   ...
   private abstract class BeaconSpriteScreenButton extends BeaconScreenButton {
