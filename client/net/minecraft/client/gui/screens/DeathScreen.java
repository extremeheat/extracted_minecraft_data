...
public class DeathScreen extends Screen {
   ...
   protected void init() {
      ...
      String var2;
      if (this.hardcore) {
         var1 = I18n.get("deathScreen.spectate");
         var2 = I18n.get("deathScreen." + (this.minecraft.isLocalServer() ? "deleteWorld" : "leaveServer"));
      } else {
         var1 = I18n.get("deathScreen.respawn");
         var2 = I18n.get("deathScreen.titleScreen");
      }

      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 72, 200, 20, var1, (var1x) -> {
         this.minecraft.player.respawn();
         this.minecraft.setScreen((Screen)null);
      }));
      Button var3 = (Button)this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 96, 200, 20, var2, (var1x) -> {
         if (this.hardcore) {
      ...
      AbstractWidget var5;
      for(Iterator var4 = this.buttons.iterator(); var4.hasNext(); var5.active = false) {
         var5 = (AbstractWidget)var4.next();
      }
