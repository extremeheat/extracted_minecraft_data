...
public class GuiRepair extends GuiContainer implements ICrafting {
   ...
   public GuiRepair(InventoryPlayer var1, World var2, int var3, int var4, int var5) {
      super(new ContainerRepair(var1, var2, var3, var4, var5, Minecraft.func_71410_x().field_71439_g));
   ...
   public void func_73866_w_() {
      ...
      this.field_147091_w = new GuiTextField(this.field_146289_q, var1 + 62, var2 + 24, 103, 12);
   ...
   private void func_147090_g() {
      ...
      this.field_146297_k.field_71439_g.field_71174_a.func_147297_a(new C17PacketCustomPayload("MC|ItemName", var1.getBytes(Charsets.UTF_8)));
   }
