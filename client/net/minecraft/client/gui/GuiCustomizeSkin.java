...
public class GuiCustomizeSkin extends GuiScreen {
   ...
   protected void func_73866_w_() {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         this.func_189646_b(new GuiCustomizeSkin.ButtonPart(var5.func_179328_b(), this.field_146294_l / 2 - 155 + var1 % 2 * 160, this.field_146295_m / 6 + 24 * (var1 >> 1), 150, 20, var5));
         ++var1;
      }

      this.func_189646_b(new GuiOptionButton(199, this.field_146294_l / 2 - 155 + var1 % 2 * 160, this.field_146295_m / 6 + 24 * (var1 >> 1), GameSettings.Options.MAIN_HAND, this.field_146297_k.field_71474_y.func_74297_c(GameSettings.Options.MAIN_HAND)) {
      ...
      this.func_189646_b(new GuiButton(200, this.field_146294_l / 2 - 100, this.field_146295_m / 6 + 24 * (var1 >> 1), I18n.func_135052_a("gui.done")) {
         public void func_194829_a(double var1, double var3) {
