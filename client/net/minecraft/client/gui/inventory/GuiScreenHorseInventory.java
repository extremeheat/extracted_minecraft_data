...
public class GuiScreenHorseInventory extends GuiContainer {
   ...
   protected void func_146979_b(int var1, int var2) {
      this.field_146289_q
         .func_78276_b(
            this.field_147029_w.func_145818_k_() ? this.field_147029_w.func_145825_b() : I18n.func_135052_a(this.field_147029_w.func_145825_b()),
            8,
            6,
            4210752
         );
      this.field_146289_q
         .func_78276_b(
            this.field_147030_v.func_145818_k_() ? this.field_147030_v.func_145825_b() : I18n.func_135052_a(this.field_147030_v.func_145825_b()),
            8,
            this.field_147000_g - 96 + 2,
            4210752
         );
   }
   ...
   protected void func_146976_a(float var1, int var2, int var3) {
      ...
      GuiInventory.func_147046_a(
         var4 + 51, var5 + 60, 17, (float)(var4 + 51) - this.field_147033_y, (float)(var5 + 75 - 50) - this.field_147032_z, this.field_147034_x
      );
   }
