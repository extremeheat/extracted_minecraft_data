...
public class GridLayout extends AbstractLayout {
   ...
   public void arrangeElements() {
      ...
      for(CellInhabitant var4 : this.cellInhabitants) {
      ...
      for(CellInhabitant var6 : this.cellInhabitants) {
      ...
      for(CellInhabitant var19 : this.cellInhabitants) {
         int var21 = 0;
   ...
   public <T extends LayoutElement> T addChild(T var1, int var2, int var3, int var4, int var5, Consumer<LayoutSettings> var6) {
      return (T)this.addChild(var1, var2, var3, var4, var5, (LayoutSettings)Util.make(this.newCellSettings(), var6));
   }
   ...
   public final class RowHelper {
      ...
      public <T extends LayoutElement> T addChild(T var1, int var2, LayoutSettings var3) {
         ...
         this.index += var2;
         return (T)GridLayout.this.addChild(var1, var4, var5, 1, var2, var3);
      }
