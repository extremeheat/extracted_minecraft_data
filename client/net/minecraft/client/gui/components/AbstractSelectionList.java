      ...
      for(int var10 = 0; var10 < var7; ++var10) {
         ...
         if (var12 >= this.y0 && var11 <= this.y1) {
            ...
            if (this.renderSelection && this.isSelectedItem(var10)) {
               int var17 = this.x0 + this.width / 2 - var16 / 2;
            ...
            int var20 = this.getRowLeft();
            var15.render(var1, var10, var11, var20, var16, var14, var4, var5, Objects.equals(this.hovered, var15), var6);
         }
      }
   }
