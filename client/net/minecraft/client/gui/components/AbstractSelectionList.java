...
public abstract class AbstractSelectionList<E extends Entry<E>> extends AbstractContainerEventHandler implements Widget, NarratableEntry {
   ...
   protected final E getEntryAtPosition(double var1, double var3) {
      ...
      return var1 < (double)this.getScrollbarPosition() && var1 >= (double)var7 && var1 <= (double)var8 && var10 >= 0 && var9 >= 0 && var10 < this.getItemCount() ? (Entry)this.children().get(var10) : null;
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.renderBackground) {
         ...
         var8.vertex((double)this.x0, (double)this.y1, 0.0).uv((float)this.x0 / 32.0F, (float)(this.y1 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var8.vertex((double)this.x1, (double)this.y1, 0.0).uv((float)this.x1 / 32.0F, (float)(this.y1 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var8.vertex((double)this.x1, (double)this.y0, 0.0).uv((float)this.x1 / 32.0F, (float)(this.y0 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var8.vertex((double)this.x0, (double)this.y0, 0.0).uv((float)this.x0 / 32.0F, (float)(this.y0 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var7.end();
      }
      ...
      if (this.renderTopAndBottom) {
         ...
         var8.vertex((double)(this.x0 + this.width), (double)this.y0, -100.0).uv((float)this.width / 32.0F, (float)this.y0 / 32.0F).color(64, 64, 64, 255).endVertex();
         ...
         var8.vertex((double)(this.x0 + this.width), (double)this.height, -100.0).uv((float)this.width / 32.0F, (float)this.height / 32.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)(this.x0 + this.width), (double)this.y1, -100.0).uv((float)this.width / 32.0F, (float)this.y1 / 32.0F).color(64, 64, 64, 255).endVertex();
      ...
      if (var15 > 0) {
         ...
         var8.vertex((double)var5, (double)(var17 + var16), 0.0).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var6, (double)(var17 + var16), 0.0).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var6, (double)var17, 0.0).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var5, (double)var17, 0.0).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var5, (double)(var17 + var16 - 1), 0.0).color(192, 192, 192, 255).endVertex();
         var8.vertex((double)(var6 - 1), (double)(var17 + var16 - 1), 0.0).color(192, 192, 192, 255).endVertex();
         var8.vertex((double)(var6 - 1), (double)var17, 0.0).color(192, 192, 192, 255).endVertex();
         var8.vertex((double)var5, (double)var17, 0.0).color(192, 192, 192, 255).endVertex();
         var7.end();
      }
   ...
   protected void moveSelection(SelectionDirection var1) {
   ...
   protected boolean moveSelection(SelectionDirection var1, Predicate<E> var2) {
      ...
      if (!this.children().isEmpty()) {
         ...
         while(true) {
            ...
            Entry var6 = (Entry)this.children().get(var5);
            if (var2.test(var6)) {
   ...
   protected static enum SelectionDirection {
      ...
      // $FF: synthetic method
      private static SelectionDirection[] $values() {
