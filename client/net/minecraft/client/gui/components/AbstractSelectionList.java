...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>>
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.renderTopAndBottom) {
         ...
         blit(var1, this.x0, 0, -100, 0.0F, 0.0F, this.width, this.y0, 32, 32);
         blit(var1, this.x0, this.y1, -100, 0.0F, (float)this.y1, this.width, this.height - this.y1, 32, 32);
         RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
         ...
         boolean var11 = true;
         this.fillGradient(var1, this.x0, this.y0, this.x1, this.y0 + 4, -16777216, 0);
         this.fillGradient(var1, this.x0, this.y1 - 4, this.x1, this.y1, 0, -16777216);
      }
      ...
      if (var13 > 0) {
         ...
         int var16 = (int)this.getScrollAmount() * (this.y1 - this.y0 - var14) / var13 + this.y0;
         if (var16 < this.y0) {
            var16 = this.y0;
         }

         fill(var1, var5, this.y0, var6, this.y1, -16777216);
         fill(var1, var5, var16, var6, var16 + var14, -8355712);
         fill(var1, var5, var16, var6 - 1, var16 + var14 - 1, -4144960);
      }
