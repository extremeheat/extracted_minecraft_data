...
public class TutorialToast implements Toast {
   ...
   public TutorialToast(TutorialToast.Icons var1, Component var2, @Nullable Component var3, boolean var4, int var5) {
      super();
      this.icon = var1;
      this.title = var2;
      this.message = var3;
   ...
   public void render(GuiGraphics var1, Font var2, long var3) {
      ...
      if (this.message == null) {
         var1.drawString(var2, this.title, 30, 12, -11534256, false);
      } else {
         var1.drawString(var2, this.title, 30, 7, -11534256, false);
         var1.drawString(var2, this.message, 30, 18, -16777216, false);
      }
   ...
   public static enum Icons {
      ...
      public void render(GuiGraphics var1, int var2, int var3) {
         var1.blitSprite(RenderType::guiTextured, this.sprite, var2, var3, 20, 20);
      }
   }
}
