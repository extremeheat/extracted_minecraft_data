...
public class SystemToast implements Toast {
   ...
   public SystemToast(SystemToastIds var1, Component var2, @Nullable Component var3) {
   ...
   public static SystemToast multiline(Minecraft var0, SystemToastIds var1, Component var2, Component var3) {
      Font var4 = var0.font;
   ...
   private SystemToast(SystemToastIds var1, Component var2, List<FormattedCharSequence> var3, int var4) {
      super();
      this.id = var1;
      this.title = var2;
   ...
   public static void add(ToastComponent var0, SystemToastIds var1, Component var2, @Nullable Component var3) {
      var0.addToast(new SystemToast(var1, var2, var3));
   }

   public static void addOrUpdate(ToastComponent var0, SystemToastIds var1, Component var2, @Nullable Component var3) {
   ...
   public static enum SystemToastIds {
      ...
      // $FF: synthetic method
      private static SystemToastIds[] $values() {
         return new SystemToastIds[]{TUTORIAL_HINT, NARRATOR_TOGGLE, WORLD_BACKUP, WORLD_GEN_SETTINGS_TRANSFER, PACK_LOAD_FAILURE, WORLD_ACCESS_FAILURE, PACK_COPY_FAILURE, PERIODIC_NOTIFICATION, CHAT_PREVIEW_WARNING};
      }
   }
}
