...
public class SystemToast implements Toast {
   ...
   public void render(GuiGraphics var1, Font var2, long var3) {
      ...
      if (var5 == 160 && this.messageLines.size() <= 1) {
         var1.blitSprite(RenderType::guiTextured, BACKGROUND_SPRITE, 0, 0, var5, this.height());
      } else {
      ...
      if (this.messageLines.isEmpty()) {
         var1.drawString(var2, this.title, 18, 12, -256, false);
      } else {
         var1.drawString(var2, this.title, 18, 7, -256, false);

         for (int var10 = 0; var10 < this.messageLines.size(); var10++) {
            var1.drawString(var2, this.messageLines.get(var10), 18, 18 + var10 * 12, -1, false);
         }
      }
   }
   ...
   private void renderBackgroundRow(GuiGraphics var1, int var2, int var3, int var4, int var5) {
      ...
      var1.blitSprite(RenderType::guiTextured, var8, 160, 32, 0, var3, 0, var4, var6, var5);

      for (int var9 = var6; var9 < var2 - var7; var9 += 64) {
         var1.blitSprite(RenderType::guiTextured, var8, 160, 32, 32, var3, var9, var4, Math.min(64, var2 - var9 - var7), var5);
      }

      var1.blitSprite(RenderType::guiTextured, var8, 160, 32, 160 - var7, var3, var2 - var7, var4, var7, var5);
   }
   ...
   public static void add(ToastManager var0, SystemToast.SystemToastId var1, Component var2, @Nullable Component var3) {
      var0.addToast(new SystemToast(var1, var2, var3));
   }

   public static void addOrUpdate(ToastManager var0, SystemToast.SystemToastId var1, Component var2, @Nullable Component var3) {
   ...
   public static void forceHide(ToastManager var0, SystemToast.SystemToastId var1) {
