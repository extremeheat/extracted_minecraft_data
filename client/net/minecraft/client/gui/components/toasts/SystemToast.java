...
public class SystemToast implements Toast {
   ...
   // $FF: renamed from: id net.minecraft.client.gui.components.toasts.SystemToast$SystemToastIds
   private final SystemToast.SystemToastIds field_346;
   ...
   public static enum SystemToastIds {
      ...
      private static SystemToast.SystemToastIds[] $values() {
         return new SystemToast.SystemToastIds[]{TUTORIAL_HINT, NARRATOR_TOGGLE, WORLD_BACKUP, WORLD_GEN_SETTINGS_TRANSFER, PACK_LOAD_FAILURE, WORLD_ACCESS_FAILURE, PACK_COPY_FAILURE};
      }
   }
}
