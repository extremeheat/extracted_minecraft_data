   ...
   public void render(PoseStack var1) {
      ...
      if (this.isListening && !this.subtitles.isEmpty()) {
         ...
         for(var8 = this.subtitles.iterator(); var8.hasNext(); ++var6) {
            ...
            var1.pushPose();
            var1.translate((double)((float)this.minecraft.getWindow().getGuiScaledWidth() - (float)var18 * 1.0F - 2.0F), (double)((float)(this.minecraft.getWindow().getGuiScaledHeight() - 35) - (float)(var6 * (var19 + 1)) * 1.0F), 0.0);
   ...
   public void onPlaySound(SoundInstance var1, WeighedSoundEvents var2) {
      if (var2.getSubtitle() != null) {
         ...
         if (!this.subtitles.isEmpty()) {
            ...
            while(var4.hasNext()) {
               Subtitle var5 = (Subtitle)var4.next();
