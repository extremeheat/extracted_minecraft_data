         ...
         if (!this.audibleSubtitles.isEmpty()) {
            ...
            while(var11.hasNext()) {
               ...
               if (!var12.isStillActive()) {
                  ...
                  var31 = Math.max(var31, this.minecraft.font.width((FormattedText)var12.getText()));
               }
            }
            ...
            while(var11.hasNext()) {
               ...
               if (var15 != null) {
                  ...
                  var1.pose().pushPose();
                  var1.pose().translate((float)var1.guiWidth() - (float)var22 * 1.0F - 2.0F, (float)(var1.guiHeight() - 35) - (float)(var30 * (var23 + 1)) * 1.0F, 0.0F);
