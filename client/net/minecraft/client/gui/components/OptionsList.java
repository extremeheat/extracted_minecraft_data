...
public class OptionsList extends ContainerObjectSelectionList<Entry> {
   ...
   protected static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
      ...
      public static Entry big(Options var0, int var1, OptionInstance<?> var2) {
         return new Entry(ImmutableMap.of(var2, var2.createButton(var0, var1 / 2 - 155, 0, 310)));
      }

      public static Entry small(Options var0, int var1, OptionInstance<?> var2, @Nullable OptionInstance<?> var3) {
         AbstractWidget var4 = var2.createButton(var0, var1 / 2 - 155, 0, 150);
         return var3 == null ? new Entry(ImmutableMap.of(var2, var4)) : new Entry(ImmutableMap.of(var2, var4, var3, var3.createButton(var0, var1 / 2 - 155 + 160, 0, 150)));
      }
