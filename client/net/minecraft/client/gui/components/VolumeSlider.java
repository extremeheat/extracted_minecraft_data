...
public class VolumeSlider extends AbstractOptionSliderButton {
   ...
   protected void updateMessage() {
      Object var1 = (float)this.value == (float)this.getYImage(false) ? CommonComponents.OPTION_OFF : Component.literal((int)(this.value * 100.0) + "%");
      this.setMessage(Component.translatable("soundCategory." + this.source.getName()).append(": ").append((Component)var1));
   }
