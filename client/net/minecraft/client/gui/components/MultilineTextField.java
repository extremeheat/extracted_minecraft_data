...
public class MultilineTextField {
   ...
   public void deleteText(int var1) {
      if (!this.hasSelection()) {
         this.selectCursor = Mth.clamp((int)(this.cursor + var1), (int)0, (int)this.value.length());
      }
   ...
   public StringView getLineView(int var1) {
      return (StringView)this.displayLines.get(Mth.clamp((int)var1, (int)0, (int)(this.displayLines.size() - 1)));
   }
   ...
   public void seekCursorToPoint(double var1, double var3) {
      ...
      StringView var7 = (StringView)this.displayLines.get(Mth.clamp((int)var6, (int)0, (int)(this.displayLines.size() - 1)));
   ...
   private StringView getCursorLineView(int var1) {
      ...
      if (var2 < 0) {
         ...
         return (StringView)this.displayLines.get(Mth.clamp((int)(var2 + var1), (int)0, (int)(this.displayLines.size() - 1)));
      }
   }
   ...
   public StringView getPreviousWord() {
      if (this.value.isEmpty()) {
         ...
         int var1;
         for(var1 = Mth.clamp((int)this.cursor, (int)0, (int)(this.value.length() - 1)); var1 > 0 && Character.isWhitespace(this.value.charAt(var1 - 1)); --var1) {
         }
   ...
   public StringView getNextWord() {
      if (this.value.isEmpty()) {
         ...
         int var1;
         for(var1 = Mth.clamp((int)this.cursor, (int)0, (int)(this.value.length() - 1)); var1 < this.value.length() && !Character.isWhitespace(this.value.charAt(var1)); ++var1) {
         }
