...
public class ChatComponent {
   ...
   public void render(GuiGraphics var1, int var2, int var3, int var4, boolean var5) {
      if (!this.isChatHidden()) {
         ...
         if (var7 > 0) {
            ...
            double var14 = this.minecraft.options.chatOpacity().get() * 0.8999999761581421 + 0.10000000149011612;
            double var16 = this.minecraft.options.textBackgroundOpacity().get();
            double var18 = this.minecraft.options.chatLineSpacing().get();
            ...
            for (int var23 = 0; var23 + this.chatScrollbarPos < this.trimmedMessages.size() && var23 < var6; var23++) {
               ...
               GuiMessage.Line var25 = this.trimmedMessages.get(var24);
               if (var25 != null) {
                  ...
                  if (var26 < 200 || var5) {
                     ...
                     if (var29 > 3) {
                        ...
                        var1.drawString(this.minecraft.font, var25.content(), 0, var33, 16777215 + (var29 << 24));
                        var1.pose().popPose();
                     }
                  }
               }
            ...
            if (var38 > 0L) {
               ...
               var1.pose().translate(0.0F, 0.0F, 50.0F);
               var1.drawString(this.minecraft.font, Component.translatable("chat.queue", var38), 0, 1, 16777215 + (var39 << 24));
               var1.pose().popPose();
            }
   ...
   private void logChatMessage(GuiMessage var1) {
      ...
      String var3 = Optionull.map(var1.tag(), GuiMessageTag::logTag);
      if (var3 != null) {
   ...
   private void processMessageDeletionQueue() {
      ...
      this.messageDeletionQueue.removeIf(var2 -> var1 >= var2.deletableAfter() ? this.deleteMessageOrDelay(var2.signature()) == null : false);
   }
