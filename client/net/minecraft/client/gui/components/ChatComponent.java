...
public class ChatComponent extends GuiComponent {
   ...
   public void render(PoseStack var1, int var2) {
      if (!this.isChatHidden()) {
         ...
         if (var4 > 0) {
            ...
            for(int var18 = 0; var18 + this.chatScrollbarPos < this.trimmedMessages.size() && var18 < var3; ++var18) {
               ...
               if (var19 != null) {
                  ...
                  if (var20 < 200 || var5) {
                     ...
                     var23 = (int)(255.0 * var21 * var8);
                     var24 = (int)(255.0 * var21 * var10);
                     ++var17;
                     if (var23 > 3) {
                        boolean var25 = false;
                        var26 = -var18 * var14;
            ...
            int var33;
            if (var32 > 0L) {
               var20 = (int)(128.0 * var8);
               var33 = (int)(255.0 * var10);
               var1.pushPose();
               var1.translate(0.0, 0.0, 50.0);
   ...
   private double screenToChatY(double var1) {
      ...
      return var3 / (this.getScale() * ((Double)this.minecraft.options.chatLineSpacing().get() + 1.0));
   }
