...
public final class OptionInstance<T> {
   ...
   public static record IntRange(int minInclusive, int maxInclusive) implements IntRangeBase {
   ...
   private static final class OptionInstanceSliderButton<N> extends AbstractOptionSliderButton {
      ...
      OptionInstanceSliderButton(Options var1, int var2, int var3, int var4, int var5, OptionInstance<N> var6, SliderableValueSet<N> var7, TooltipSupplier<N> var8, Consumer<N> var9) {
   ...
   interface SliderableValueSet<T> extends ValueSet<T> {
      ...
      default Function<OptionInstance<T>, AbstractWidget> createButton(TooltipSupplier<T> var1, Options var2, int var3, int var4, int var5, Consumer<T> var6) {
         return (var7) -> {
            return new OptionInstanceSliderButton(var2, var3, var4, var5, 20, var7, this, var1, var6);
         };
      }
   }
}
