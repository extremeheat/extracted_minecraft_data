...
public class OcelotModel<T extends Entity> extends AgeableListModel<T> {
   ...
   private static final float field_44 = 0.0F;
   // $FF: renamed from: YO float
   private static final float field_45 = 16.0F;
   // $FF: renamed from: ZO float
   private static final float field_46 = -9.0F;
   ...
   public void prepareMobModel(T var1, float var2, float var3, float var4) {
      this.body.field_306 = 12.0F;
      this.body.field_307 = -10.0F;
      this.head.field_306 = 15.0F;
      this.head.field_307 = -9.0F;
      this.tail1.field_306 = 15.0F;
      this.tail1.field_307 = 8.0F;
      this.tail2.field_306 = 20.0F;
      this.tail2.field_307 = 14.0F;
      this.leftFrontLeg.field_306 = 14.1F;
      this.leftFrontLeg.field_307 = -5.0F;
      this.rightFrontLeg.field_306 = 14.1F;
      this.rightFrontLeg.field_307 = -5.0F;
      this.leftHindLeg.field_306 = 18.0F;
      this.leftHindLeg.field_307 = 5.0F;
      this.rightHindLeg.field_306 = 18.0F;
      this.rightHindLeg.field_307 = 5.0F;
      ...
      if (var1.isCrouching()) {
         ...
         this.tail2.field_306 = this.tail1.field_306;
         var10000 = this.tail2;
         var10000.field_307 += 2.0F;
         this.tail1.xRot = 1.5707964F;
         this.tail2.xRot = 1.5707964F;
