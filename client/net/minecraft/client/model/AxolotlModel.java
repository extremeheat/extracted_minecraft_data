...
public class AxolotlModel<T extends Axolotl & LerpingModel> extends AgeableListModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var1.isPlayingDead()) {
         ...
         boolean var7 = var1.getDeltaMovement().horizontalDistanceSqr() > 1.0E-7 || var1.getXRot() != var1.xRotO || var1.getYRot() != var1.yRotO || var1.xOld != var1.getX() || var1.zOld != var1.getZ();
