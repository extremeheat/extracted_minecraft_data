   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var1 instanceof AbstractPiglin) {
         ...
         if (var11 == PiglinArmPose.DANCING) {
            ...
            this.head.field_305 = Mth.sin(var12 * 10.0F);
            this.head.field_306 = Mth.sin(var12 * 40.0F) + 0.4F;
            this.rightArm.zRot = 0.017453292F * (70.0F + Mth.cos(var12 * 40.0F) * 10.0F);
            this.leftArm.zRot = this.rightArm.zRot * -1.0F;
            this.rightArm.field_306 = Mth.sin(var12 * 40.0F) * 0.5F + 1.5F;
            this.leftArm.field_306 = Mth.sin(var12 * 40.0F) * 0.5F + 1.5F;
            this.body.field_306 = Mth.sin(var12 * 40.0F) * 0.35F;
