...
public class PiglinModel extends AbstractPiglinModel<PiglinRenderState> {
   ...
   public void setupAnim(PiglinRenderState var1) {
      ...
      if (var4 == PiglinArmPose.DANCING) {
         ...
         this.head.x = this.head.x + Mth.sin(var5 * 10.0F);
         this.head.y = this.head.y + Mth.sin(var5 * 40.0F) + 0.4F;
         this.rightArm.zRot = 0.017453292F * (70.0F + Mth.cos(var5 * 40.0F) * 10.0F);
         this.leftArm.zRot = this.rightArm.zRot * -1.0F;
         this.rightArm.y = this.rightArm.y + (Mth.sin(var5 * 40.0F) * 0.5F - 0.5F);
         this.leftArm.y = this.leftArm.y + Mth.sin(var5 * 40.0F) * 0.5F + 0.5F;
         this.body.y = this.body.y + Mth.sin(var5 * 40.0F) * 0.35F;
         ...
         AnimationUtils.animateCrossbowCharge(
            this.rightArm, this.leftArm, var1.maxCrossbowChageDuration, var1.ticksUsingItem, var1.mainArm == HumanoidArm.RIGHT
         );
