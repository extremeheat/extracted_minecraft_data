...
public class PlayerModel<T extends LivingEntity> extends HumanoidModel<T> {
   ...
   public void renderEars(PoseStack var1, VertexConsumer var2, int var3, int var4) {
      ...
      this.ear.field_305 = 0.0F;
      this.ear.field_306 = 0.0F;
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var1.getItemBySlot(EquipmentSlot.CHEST).isEmpty()) {
         if (var1.isCrouching()) {
            this.cloak.field_307 = 1.4F;
            this.cloak.field_306 = 1.85F;
         } else {
            this.cloak.field_307 = 0.0F;
            this.cloak.field_306 = 0.0F;
         }
      } else if (var1.isCrouching()) {
         this.cloak.field_307 = 0.3F;
         this.cloak.field_306 = 0.8F;
      } else {
         this.cloak.field_307 = -1.1F;
         this.cloak.field_306 = -0.85F;
      }
