...
public class EndermanModel<T extends LivingEntity> extends HumanoidModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      boolean var7 = true;
      this.body.xRot = 0.0F;
      this.body.field_306 = -14.0F;
      this.body.field_307 = -0.0F;
      ...
      this.rightLeg.field_307 = 0.0F;
      this.leftLeg.field_307 = 0.0F;
      this.rightLeg.field_306 = -5.0F;
      this.leftLeg.field_306 = -5.0F;
      this.head.field_307 = -0.0F;
      this.head.field_306 = -13.0F;
      this.hat.field_305 = this.head.field_305;
      this.hat.field_306 = this.head.field_306;
      this.hat.field_307 = this.head.field_307;
