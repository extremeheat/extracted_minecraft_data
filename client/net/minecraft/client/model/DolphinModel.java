...
public class DolphinModel extends EntityModel<DolphinRenderState> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      var4.addOrReplaceChild(
         "back_fin", CubeListBuilder.create().texOffs(51, 0).addBox(-0.5F, 0.0F, 8.0F, 1.0F, 4.0F, 5.0F), PartPose.rotation(1.0471976F, 0.0F, 0.0F)
      );
      var4.addOrReplaceChild(
         "left_fin",
         CubeListBuilder.create().texOffs(48, 20).mirror().addBox(-0.5F, -4.0F, 0.0F, 1.0F, 4.0F, 7.0F),
         PartPose.offsetAndRotation(2.0F, -2.0F, 4.0F, 1.0471976F, 0.0F, 2.0943952F)
      );
      var4.addOrReplaceChild(
         "right_fin",
