...
public class AllayModel extends HierarchicalModel<Allay> implements ArmedModel {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      var3.addOrReplaceChild("right_wing", CubeListBuilder.create().texOffs(16, 14).addBox(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 0.0F, 0.65F));
      var3.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(16, 14).addBox(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 0.0F, 0.65F));
   ...
   public void setupAnim(Allay var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var1.isDancing()) {
         ...
         var17 = Mth.cos(var14) * 14.0F * 0.017453292F;
      ...
      var14 = var11 * 0.6981317F;
      this.body.xRot = var14;
      var15 = Mth.lerp(var13, var14, Mth.lerp(var11, -1.0471976F, -0.7853982F));
      ...
      var16 = var12 * (1.0F - var13);
      var17 = 0.43633232F - Mth.cos(var10 + 4.712389F) * 3.1415927F * 0.075F * var16;
