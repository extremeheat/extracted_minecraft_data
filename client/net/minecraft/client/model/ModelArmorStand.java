...
public class ModelArmorStand extends ModelArmorStandArmor {
   ...
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      ...
      if (var7 instanceof EntityArmorStand) {
         ...
         float var9 = (var8.func_175403_w().func_179415_b() + var8.func_175407_x().func_179415_b()) / 2.0F;
         float var10 = (var8.func_175403_w().func_179416_c() + var8.func_175407_x().func_179416_c()) / 2.0F;
         float var11 = (var8.func_175403_w().func_179413_d() + var8.func_175407_x().func_179413_d()) / 2.0F;
   ...
   public void func_178718_a(float var1) {
      boolean var2 = this.field_178723_h.field_78806_j;
      this.field_178723_h.field_78806_j = true;
      super.func_178718_a(var1);
      this.field_178723_h.field_78806_j = var2;
   }
}
