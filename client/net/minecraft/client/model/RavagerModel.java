...
public class RavagerModel extends HierarchicalModel<Ravager> {
   ...
   public void prepareMobModel(Ravager var1, float var2, float var3, float var4) {
      ...
      if (var8 > 0) {
         ...
         this.neck.field_307 = -6.5F + var12;
         this.neck.field_306 = -7.0F - var13;
         ...
         this.neck.field_305 = 0.0F;
         this.neck.field_306 = -7.0F - var11;
         this.neck.field_307 = 5.5F;
         ...
         if (var15) {
            ...
            this.neck.field_305 = (float)Math.sin(var16 * 10.0D) * 3.0F;
         } else if (var6 > 0) {
