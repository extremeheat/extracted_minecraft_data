...
public class RavagerModel extends EntityModel<Ravager> {
   ...
   public RavagerModel() {
      ...
      var4.texOffs(74, 55).addBox(0.0F, -14.0F, -2.0F, 2, 14, 4, 0.0F);
   ...
   public void render(Ravager var1, float var2, float var3, float var4, float var5, float var6, float var7) {
   ...
   public void setupAnim(Ravager var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.head.xRot = var6 * 0.017453292F;
      this.head.yRot = var5 * 0.017453292F;
      this.body.xRot = 1.5707964F;
      float var8 = 0.4F * var3;
      this.leg0.xRot = Mth.cos(var2 * 0.6662F) * var8;
      this.leg1.xRot = Mth.cos(var2 * 0.6662F + 3.1415927F) * var8;
      this.leg2.xRot = Mth.cos(var2 * 0.6662F + 3.1415927F) * var8;
      this.leg3.xRot = Mth.cos(var2 * 0.6662F) * var8;
   }
   ...
   public void setupAnim(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim((Ravager)var1, var2, var3, var4, var5, var6, var7);
   }

   // $FF: synthetic method
   public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.render((Ravager)var1, var2, var3, var4, var5, var6, var7);
   }
}
