...
public class ChestRaftModel extends RaftModel {
   ...
   public static LayerDefinition createBodyModel() {
      ...
      var1.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-2.0F, -10.0F, -6.0F, 0.0F, -1.5707964F, 0.0F)
      );
      var1.addOrReplaceChild(
         "chest_lid",
         CubeListBuilder.create().texOffs(0, 59).addBox(0.0F, 0.0F, 0.0F, 12.0F, 4.0F, 12.0F),
         PartPose.offsetAndRotation(-2.0F, -14.0F, -6.0F, 0.0F, -1.5707964F, 0.0F)
      );
      var1.addOrReplaceChild(
         "chest_lock",
         CubeListBuilder.create().texOffs(0, 59).addBox(0.0F, 0.0F, 0.0F, 2.0F, 4.0F, 1.0F),
         PartPose.offsetAndRotation(-1.0F, -11.0F, -1.0F, 0.0F, -1.5707964F, 0.0F)
      );
