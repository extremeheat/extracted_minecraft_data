...
public class PlayerCapeModel<T extends PlayerRenderState> extends HumanoidModel<T> {
   ...
   public static LayerDefinition createCapeLayer() {
      ...
      var3.addOrReplaceChild("cape", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, 0.0F, -1.0F, 10.0F, 16.0F, 1.0F, CubeDeformation.NONE, 1.0F, 0.5F), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 0.0F, 3.1415927F, 0.0F));
