...
public class ModelBlaze extends ModelBase {
   ...
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      ...
      for(int var12 = 4; var12 < 8; ++var12) {
         this.field_78106_a[var12].field_78797_d = 2.0F + MathHelper.func_76134_b(((float)(var12 * 2) + var3) * 0.25F);
         this.field_78106_a[var12].field_78800_c = MathHelper.func_76134_b(var8) * 7.0F;
         this.field_78106_a[var12].field_78798_e = MathHelper.func_76126_a(var8) * 7.0F;
         ++var8;
      }
      ...
      for(int var13 = 8; var13 < 12; ++var13) {
         this.field_78106_a[var13].field_78797_d = 11.0F + MathHelper.func_76134_b(((float)var13 * 1.5F + var3) * 0.5F);
         this.field_78106_a[var13].field_78800_c = MathHelper.func_76134_b(var8) * 5.0F;
         this.field_78106_a[var13].field_78798_e = MathHelper.func_76126_a(var8) * 5.0F;
         ++var8;
      }
