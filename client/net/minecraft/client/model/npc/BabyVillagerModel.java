...
public class BabyVillagerModel extends VillagerModel {
   ...
   public static MeshDefinition createBodyModel() {
      ...
      root.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(8, 23).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.offset(-0.5F, 21.5F, 0.0F));
      root.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 23).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.offset(0.5F, 21.5F, 0.0F));
