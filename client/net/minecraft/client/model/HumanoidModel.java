...
public class HumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.body.yRot = 0.0F;
      this.rightArm.field_307 = 0.0F;
      this.rightArm.field_305 = -5.0F;
      this.leftArm.field_307 = 0.0F;
      this.leftArm.field_305 = 5.0F;
      float var9 = 1.0F;
      if (var7) {
      ...
      if (this.crouching) {
         ...
         var10000 = this.leftArm;
         var10000.xRot += 0.4F;
         this.rightLeg.field_307 = 4.0F;
         this.leftLeg.field_307 = 4.0F;
         this.rightLeg.field_306 = 12.2F;
         this.leftLeg.field_306 = 12.2F;
         this.head.field_306 = 4.2F;
         this.body.field_306 = 3.2F;
         this.leftArm.field_306 = 5.2F;
         this.rightArm.field_306 = 5.2F;
      } else {
         this.body.xRot = 0.0F;
         this.rightLeg.field_307 = 0.1F;
         this.leftLeg.field_307 = 0.1F;
         this.rightLeg.field_306 = 12.0F;
         this.leftLeg.field_306 = 12.0F;
         this.head.field_306 = 0.0F;
         this.body.field_306 = 0.0F;
         this.leftArm.field_306 = 2.0F;
         this.rightArm.field_306 = 2.0F;
      }
   ...
   protected void setupAttackAnimation(T var1, float var2) {
      if (!(this.attackTime <= 0.0F)) {
         ...
         this.rightArm.field_307 = Mth.sin(this.body.yRot) * 5.0F;
         this.rightArm.field_305 = -Mth.cos(this.body.yRot) * 5.0F;
         this.leftArm.field_307 = -Mth.sin(this.body.yRot) * 5.0F;
         this.leftArm.field_305 = Mth.cos(this.body.yRot) * 5.0F;
         var10000 = this.rightArm;
   ...
   public static enum ArmPose {
      ...
      private static HumanoidModel.ArmPose[] $values() {
         return new HumanoidModel.ArmPose[]{EMPTY, ITEM, BLOCK, BOW_AND_ARROW, THROW_SPEAR, CROSSBOW_CHARGE, CROSSBOW_HOLD, SPYGLASS};
      }
   }
}
