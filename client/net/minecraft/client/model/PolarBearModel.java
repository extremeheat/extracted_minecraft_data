...
public class PolarBearModel<T extends PolarBear> extends QuadrupedModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.body.field_306 = 9.0F * var9 + 11.0F * var8;
      this.rightFrontLeg.field_306 = 14.0F * var9 - 6.0F * var8;
      this.rightFrontLeg.field_307 = -8.0F * var9 - 4.0F * var8;
      ModelPart var10000 = this.rightFrontLeg;
      var10000.xRot -= var8 * 3.1415927F * 0.45F;
      this.leftFrontLeg.field_306 = this.rightFrontLeg.field_306;
      this.leftFrontLeg.field_307 = this.rightFrontLeg.field_307;
      var10000 = this.leftFrontLeg;
      var10000.xRot -= var8 * 3.1415927F * 0.45F;
      if (this.young) {
         this.head.field_306 = 10.0F * var9 - 9.0F * var8;
         this.head.field_307 = -16.0F * var9 - 7.0F * var8;
      } else {
         this.head.field_306 = 10.0F * var9 - 14.0F * var8;
         this.head.field_307 = -16.0F * var9 - 3.0F * var8;
      }
