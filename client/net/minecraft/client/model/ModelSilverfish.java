...
public class ModelSilverfish extends ModelBase {
   ...
   public ModelSilverfish() {
      ...
      for(int var2 = 0; var2 < this.field_78171_a.length; ++var2) {
         ...
         this.field_78171_a[var2]
            .func_78789_a(
               (float)field_78167_d[var2][0] * -0.5F,
               0.0F,
               (float)field_78167_d[var2][2] * -0.5F,
               field_78167_d[var2][0],
               field_78167_d[var2][1],
               field_78167_d[var2][2]
            );
   ...
   public void func_78088_a(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      for(int var8 = 0; var8 < this.field_78171_a.length; ++var8) {
         this.field_78171_a[var8].func_78785_a(var7);
      }

      for(int var9 = 0; var9 < this.field_78169_b.length; ++var9) {
         this.field_78169_b[var9].func_78785_a(var7);
      }
   }
   ...
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      for(int var8 = 0; var8 < this.field_78171_a.length; ++var8) {
         this.field_78171_a[var8].field_78796_g = MathHelper.func_76134_b(var3 * 0.9F + (float)var8 * 0.15F * 3.1415927F)
            * 3.1415927F
            * 0.05F
            * (float)(1 + Math.abs(var8 - 2));
         this.field_78171_a[var8].field_78800_c = MathHelper.func_76126_a(var3 * 0.9F + (float)var8 * 0.15F * 3.1415927F)
            * 3.1415927F
            * 0.2F
