...
public class BlazeModel<T extends Entity> extends HierarchicalModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      for(var8 = 0; var8 < 4; ++var8) {
         this.upperBodyParts[var8].field_306 = -2.0F + Mth.cos(((float)(var8 * 2) + var4) * 0.25F);
         this.upperBodyParts[var8].field_305 = Mth.cos(var7) * 9.0F;
         this.upperBodyParts[var8].field_307 = Mth.sin(var7) * 9.0F;
         ++var7;
      }
      ...
      for(var8 = 4; var8 < 8; ++var8) {
         this.upperBodyParts[var8].field_306 = 2.0F + Mth.cos(((float)(var8 * 2) + var4) * 0.25F);
         this.upperBodyParts[var8].field_305 = Mth.cos(var7) * 7.0F;
         this.upperBodyParts[var8].field_307 = Mth.sin(var7) * 7.0F;
         ++var7;
      }
      ...
      for(var8 = 8; var8 < 12; ++var8) {
         this.upperBodyParts[var8].field_306 = 11.0F + Mth.cos(((float)var8 * 1.5F + var4) * 0.5F);
         this.upperBodyParts[var8].field_305 = Mth.cos(var7) * 5.0F;
         this.upperBodyParts[var8].field_307 = Mth.sin(var7) * 5.0F;
         ++var7;
      }
