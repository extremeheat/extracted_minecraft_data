...
public class AdultStriderModel extends StriderModel {
   ...
   protected void customAnimations(final float animationPos, final float animationSpeed, final float ageInTicks) {
      ...
      this.animateBristle(ageInTicks, bristleFlow, this.rightTopBristle, this.rightMiddleBristle, this.rightBottomBristle, (modelPart, rotation) -> modelPart.zRot += rotation);
      this.animateBristle(ageInTicks, bristleFlow, this.leftTopBristle, this.leftMiddleBristle, this.leftBottomBristle, (modelPart, rotation) -> modelPart.zRot += rotation);
      this.body.y = 2.0F;
