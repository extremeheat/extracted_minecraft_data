...
public class PiglinModel extends AbstractPiglinModel<PiglinRenderState> {
   ...
   public void setupAnim(PiglinRenderState var1) {
      ...
      if (var4 == PiglinArmPose.DANCING) {
         ...
         this.rightEar.zRot = 0.5235988F + 0.017453292F * Mth.sin((double)(var5 * 30.0F)) * 10.0F;
         this.leftEar.zRot = -0.5235988F - 0.017453292F * Mth.cos((double)(var5 * 30.0F)) * 10.0F;
         ModelPart var10000 = this.head;
         var10000.x += Mth.sin((double)(var5 * 10.0F));
         var10000 = this.head;
         var10000.y += Mth.sin((double)(var5 * 40.0F)) + 0.4F;
         this.rightArm.zRot = 0.017453292F * (70.0F + Mth.cos((double)(var5 * 40.0F)) * 10.0F);
         this.leftArm.zRot = this.rightArm.zRot * -1.0F;
         var10000 = this.rightArm;
         var10000.y += Mth.sin((double)(var5 * 40.0F)) * 0.5F - 0.5F;
         var10000 = this.leftArm;
         var10000.y += Mth.sin((double)(var5 * 40.0F)) * 0.5F + 0.5F;
         var10000 = this.body;
         var10000.y += Mth.sin((double)(var5 * 40.0F)) * 0.35F;
