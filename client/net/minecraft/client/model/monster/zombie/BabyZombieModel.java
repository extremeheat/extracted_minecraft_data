...
public class BabyZombieModel<S extends ZombieRenderState> extends ZombieModel<S> {
   ...
   public static LayerDefinition createBodyLayer(final CubeDeformation g) {
      ...
      PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.25F, -4.0F, 8.0F, 8.0F, 8.0F, g).texOffs(32, 0).addBox(-4.0F, -8.15F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 15.25F, 0.0F));
