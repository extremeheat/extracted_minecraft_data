...
public class SpiderModel extends EntityModel<LivingEntityRenderState> {
   ...
   public void setupAnim(LivingEntityRenderState var1) {
      ...
      float var4 = -(Mth.cos((double)(var2 * 2.0F + 0.0F)) * 0.4F) * var3;
      float var5 = -(Mth.cos((double)(var2 * 2.0F + 3.1415927F)) * 0.4F) * var3;
      float var6 = -(Mth.cos((double)(var2 * 2.0F + 1.5707964F)) * 0.4F) * var3;
      float var7 = -(Mth.cos((double)(var2 * 2.0F + 4.712389F)) * 0.4F) * var3;
      float var8 = Math.abs(Mth.sin((double)(var2 + 0.0F)) * 0.4F) * var3;
      float var9 = Math.abs(Mth.sin((double)(var2 + 3.1415927F)) * 0.4F) * var3;
      float var10 = Math.abs(Mth.sin((double)(var2 + 1.5707964F)) * 0.4F) * var3;
      float var11 = Math.abs(Mth.sin((double)(var2 + 4.712389F)) * 0.4F) * var3;
