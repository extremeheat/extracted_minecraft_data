...
public class StriderModel<T extends Strider> extends HierarchicalModel<T> {
   ...
   public void setupAnim(Strider var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.body.field_306 = 2.0F;
      ModelPart var10000 = this.body;
      var10000.field_306 -= 2.0F * Mth.cos(var2 * 1.5F) * 2.0F * var3;
      ...
      this.leftLeg.field_306 = 8.0F + 2.0F * Mth.sin(var2 * 1.5F * 0.5F + 3.1415927F) * 2.0F * var3;
      this.rightLeg.field_306 = 8.0F + 2.0F * Mth.sin(var2 * 1.5F * 0.5F) * 2.0F * var3;
