...
public class HoglinModel extends EntityModel<HoglinRenderState> {
   ...
   private static MeshDefinition createMesh() {
      ...
      var2.addOrReplaceChild("mane", CubeListBuilder.create().texOffs(90, 33).addBox(0.0F, 0.0F, -9.0F, 0.0F, 10.0F, 19.0F, new CubeDeformation(0.001F)), PartPose.offset(0.0F, -14.0F, -7.0F));
   ...
   public static LayerDefinition createBabyLayer() {
      ...
      var1.addOrReplaceChild("mane", CubeListBuilder.create().texOffs(90, 33).addBox(0.0F, 0.0F, -9.0F, 0.0F, 10.0F, 19.0F, new CubeDeformation(0.001F)), PartPose.offset(0.0F, -14.0F, -3.0F));
