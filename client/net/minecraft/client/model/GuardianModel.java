...
public class GuardianModel extends HierarchicalModel<Guardian> {
   ...
   public void setupAnim(Guardian var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var9 != null) {
         ...
         double var12 = var10.field_415 - var11.field_415;
         if (var12 > 0.0D) {
            this.eye.field_306 = 0.0F;
         } else {
            this.eye.field_306 = 1.0F;
         }

         Vec3 var14 = var1.getViewVector(0.0F);
         var14 = new Vec3(var14.field_414, 0.0D, var14.field_416);
         Vec3 var15 = (new Vec3(var11.field_414 - var10.field_414, 0.0D, var11.field_416 - var10.field_416)).normalize().yRot(1.5707964F);
         double var16 = var14.dot(var15);
         this.eye.field_305 = Mth.sqrt((float)Math.abs(var16)) * 2.0F * (float)Math.signum(var16);
      }
   ...
   private void setupSpikes(float var1, float var2) {
      for(int var3 = 0; var3 < 12; ++var3) {
         this.spikeParts[var3].field_305 = getSpikeX(var3, var1, var2);
         this.spikeParts[var3].field_306 = getSpikeY(var3, var1, var2);
         this.spikeParts[var3].field_307 = getSpikeZ(var3, var1, var2);
      }
