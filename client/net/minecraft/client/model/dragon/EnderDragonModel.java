...
public class EnderDragonModel extends EntityModel<EnderDragonRenderState> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition var17 = var1.addOrReplaceChild(
         "body",
         CubeListBuilder.create()
      ...
      PartDefinition var6 = var17.addOrReplaceChild(
         "left_wing",
      ...
      PartDefinition var7 = var17.addOrReplaceChild(
         "left_front_leg",
      ...
      PartDefinition var9 = var17.addOrReplaceChild(
         "left_hind_leg",
      ...
      PartDefinition var10 = var9.addOrReplaceChild(
         "left_hind_leg_tip",
      ...
      PartDefinition var11 = var17.addOrReplaceChild(
         "right_wing",
      ...
      PartDefinition var12 = var17.addOrReplaceChild(
         "right_front_leg",
         CubeListBuilder.create().addBox("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104),
         PartPose.offsetAndRotation(-12.0F, 17.0F, -6.0F, 1.3F, 0.0F, 0.0F)
      );
      ...
      PartDefinition var14 = var17.addOrReplaceChild(
         "right_hind_leg",
         CubeListBuilder.create().addBox("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0),
         PartPose.offsetAndRotation(-16.0F, 13.0F, 34.0F, 1.0F, 0.0F, 0.0F)
      );
      PartDefinition var15 = var14.addOrReplaceChild(
         "right_hind_leg_tip",
         CubeListBuilder.create().addBox("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0),
         PartPose.offsetAndRotation(0.0F, 32.0F, -4.0F, 0.5F, 0.0F, 0.0F)
      );
