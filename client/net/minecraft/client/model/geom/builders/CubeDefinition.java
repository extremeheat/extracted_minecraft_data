...
public final class CubeDefinition {
   ...
   public ModelPart.Cube bake(int var1, int var2) {
      return new ModelPart.Cube((int)this.texCoord.u(), (int)this.texCoord.v(), this.origin.x(), this.origin.y(), this.origin.z(), this.dimensions.x(), this.dimensions.y(), this.dimensions.z(), this.grow.growX, this.grow.growY, this.grow.growZ, this.mirror, (float)var1 * this.texScale.u(), (float)var2 * this.texScale.v());
   }
}
