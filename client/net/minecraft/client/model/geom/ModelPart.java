...
public final class ModelPart {
   ...
   public float field_305;
   // $FF: renamed from: y float
   public float field_306;
   // $FF: renamed from: z float
   public float field_307;
   public float xRot;
   public float yRot;
   public float zRot;
   ...
   public PartPose storePose() {
      return PartPose.offsetAndRotation(this.field_305, this.field_306, this.field_307, this.xRot, this.yRot, this.zRot);
   }

   public void loadPose(PartPose var1) {
      this.field_305 = var1.field_262;
      this.field_306 = var1.field_263;
      this.field_307 = var1.field_264;
      this.xRot = var1.xRot;
      this.yRot = var1.yRot;
      this.zRot = var1.zRot;
   }
   ...
   public void copyFrom(ModelPart var1) {
      ...
      this.yRot = var1.yRot;
      this.zRot = var1.zRot;
      this.field_305 = var1.field_305;
      this.field_306 = var1.field_306;
      this.field_307 = var1.field_307;
   }
   ...
   public void translateAndRotate(PoseStack var1) {
      var1.translate((double)(this.field_305 / 16.0F), (double)(this.field_306 / 16.0F), (double)(this.field_307 / 16.0F));
      if (this.zRot != 0.0F) {
         var1.mulPose(Vector3f.field_294.rotation(this.zRot));
      }

      if (this.yRot != 0.0F) {
         var1.mulPose(Vector3f.field_292.rotation(this.yRot));
      }

      if (this.xRot != 0.0F) {
         var1.mulPose(Vector3f.field_290.rotation(this.xRot));
      }
   ...
   public static class Cube {
      ...
      public Cube(int var1, int var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, boolean var12, float var13, float var14) {
         ...
         this.polygons[3] = new ModelPart.Polygon(new ModelPart.Vertex[]{var20, var21, var25, var24}, var28, var33, var29, var32, var13, var14, var12, Direction.field_526);
      ...
      public void compile(PoseStack.Pose var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
         ...
         for(int var13 = 0; var13 < var12; ++var13) {
            ...
            float var16 = var15.method_82();
            float var17 = var15.method_83();
            float var18 = var15.method_84();
            ModelPart.Vertex[] var19 = var14.vertices;
            int var20 = var19.length;

            for(int var21 = 0; var21 < var20; ++var21) {
               ModelPart.Vertex var22 = var19[var21];
               float var23 = var22.pos.method_82() / 16.0F;
               float var24 = var22.pos.method_83() / 16.0F;
               float var25 = var22.pos.method_84() / 16.0F;
               Vector4f var26 = new Vector4f(var23, var24, var25, 1.0F);
               var26.transform(var9);
               var2.vertex(var26.method_66(), var26.method_67(), var26.method_68(), var5, var6, var7, var8, var22.field_238, var22.field_239, var4, var3, var16, var17, var18);
            }
         }
   ...
   static class Vertex {
      ...
      public final float field_238;
      // $FF: renamed from: v float
      public final float field_239;
