...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      Boat.Type[] var21 = Boat.Type.values();
      int var22 = var21.length;

      for(int var23 = 0; var23 < var22; ++var23) {
         Boat.Type var24 = var21[var23];
      ...
      WoodType.values().forEach((var2x) -> {
         var0.put(ModelLayers.createSignModelName(var2x), var25);
      });
      ImmutableMap var26 = var0.build();
      List var27 = (List)ModelLayers.getKnownLocations().filter((var1x) -> {
         return !var26.containsKey(var1x);
