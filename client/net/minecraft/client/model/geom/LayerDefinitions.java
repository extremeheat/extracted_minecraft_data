...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      LayerDefinition var16 = LayerDefinition.create(FelineModel.createBodyMesh(CubeDeformation.NONE), 64, 32);
      LayerDefinition var17 = var16.apply(FelineModel.BABY_TRANSFORMER);
      LayerDefinition var18 = LayerDefinition.create(FelineModel.createBodyMesh(new CubeDeformation(0.01F)), 64, 32);
      ...
      LayerDefinition var36 = ColdPigModel.createBodyLayer(CubeDeformation.NONE);
      LayerDefinition var37 = PigModel.createSaddleLayer(new CubeDeformation(0.5F));
      LayerDefinition var38 = PolarBearModel.createBodyLayer();
      LayerDefinition var39 = SheepModel.createBodyLayer();
      LayerDefinition var40 = SheepFurModel.createFurLayer();
      LayerDefinition var41 = SnifferModel.createBodyLayer();
      LayerDefinition var42 = TurtleModel.createBodyLayer();
      LayerDefinition var43 = LayerDefinition.create(WolfModel.createMeshDefinition(CubeDeformation.NONE), 64, 32);
      LayerDefinition var44 = LayerDefinition.create(WolfModel.createMeshDefinition(new CubeDeformation(0.2F)), 64, 32);
      LayerDefinition var45 = ZombieVillagerModel.createBodyLayer();
      LayerDefinition var46 = ArmorStandModel.createBodyLayer();
      LayerDefinition var47 = ArmorStandArmorModel.createBodyLayer(INNER_ARMOR_DEFORMATION);
      LayerDefinition var48 = ArmorStandArmorModel.createBodyLayer(OUTER_ARMOR_DEFORMATION);
      LayerDefinition var49 = DrownedModel.createBodyLayer(CubeDeformation.NONE);
      LayerDefinition var50 = DrownedModel.createBodyLayer(new CubeDeformation(0.25F));
      LayerDefinition var51 = SquidModel.createBodyLayer();
      LayerDefinition var52 = DolphinModel.createBodyLayer();
      LayerDefinition var53 = SalmonModel.createBodyLayer();
      ...
      var0.put(ModelLayers.ARMOR_STAND, var46);
      var0.put(ModelLayers.ARMOR_STAND_INNER_ARMOR, var47);
      var0.put(ModelLayers.ARMOR_STAND_OUTER_ARMOR, var48);
      var0.put(ModelLayers.ARMOR_STAND_SMALL, var46.apply(HumanoidModel.BABY_TRANSFORMER));
      var0.put(ModelLayers.ARMOR_STAND_SMALL_INNER_ARMOR, var47.apply(HumanoidModel.BABY_TRANSFORMER));
      var0.put(ModelLayers.ARMOR_STAND_SMALL_OUTER_ARMOR, var48.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.CAT, var16.apply(CatModel.CAT_TRANSFORMER));
      var0.put(ModelLayers.CAT_BABY, var17.apply(CatModel.CAT_TRANSFORMER));
      var0.put(ModelLayers.CAT_COLLAR, var18.apply(CatModel.CAT_TRANSFORMER));
      var0.put(ModelLayers.CAT_BABY_COLLAR, var18.apply(FelineModel.BABY_TRANSFORMER).apply(CatModel.CAT_TRANSFORMER));
      ...
      var0.put(ModelLayers.COLD_PIG, var36);
      var0.put(ModelLayers.COLD_PIG_BABY, var36.apply(PigModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.DOLPHIN, var52);
      var0.put(ModelLayers.DOLPHIN_BABY, var52.apply(DolphinModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.DROWNED, var49);
      var0.put(ModelLayers.DROWNED_INNER_ARMOR, var4);
      var0.put(ModelLayers.DROWNED_OUTER_ARMOR, var4);
      var0.put(ModelLayers.DROWNED_OUTER_LAYER, var50);
      var0.put(ModelLayers.DROWNED_BABY, var49.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.DROWNED_BABY_OUTER_LAYER, var50.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      MeshTransformer var54 = MeshTransformer.scaling(6.0F);
      var0.put(ModelLayers.GIANT, var1.apply(var54));
      var0.put(ModelLayers.GIANT_INNER_ARMOR, var4.apply(var54));
      var0.put(ModelLayers.GIANT_OUTER_ARMOR, var2.apply(var54));
      var0.put(ModelLayers.GLOW_SQUID, var51);
      var0.put(ModelLayers.GLOW_SQUID_BABY, var51.apply(SquidModel.BABY_TRANSFORMER));
      ...
      MeshTransformer var55 = MeshTransformer.scaling(1.1F);
      var0.put(ModelLayers.HORSE, var7.apply(var55));
      var0.put(ModelLayers.HORSE_BABY, var8.apply(var55));
      var0.put(ModelLayers.HORSE_ARMOR, LayerDefinition.create(AbstractEquineModel.createBodyMesh(new CubeDeformation(0.1F)), 64, 64).apply(var55));
      var0.put(ModelLayers.HORSE_BABY_ARMOR, LayerDefinition.create(AbstractEquineModel.createBabyMesh(new CubeDeformation(0.1F)), 64, 64).apply(var55));
      MeshTransformer var56 = MeshTransformer.scaling(1.0625F);
      var0.put(ModelLayers.HUSK, var1.apply(var56));
      var0.put(ModelLayers.HUSK_INNER_ARMOR, var4.apply(var56));
      var0.put(ModelLayers.HUSK_OUTER_ARMOR, var2.apply(var56));
      var0.put(ModelLayers.HUSK_BABY, var1.apply(HumanoidModel.BABY_TRANSFORMER).apply(var56));
      var0.put(ModelLayers.HUSK_BABY_INNER_ARMOR, var4.apply(HumanoidModel.BABY_TRANSFORMER).apply(var56));
      var0.put(ModelLayers.HUSK_BABY_OUTER_ARMOR, var2.apply(HumanoidModel.BABY_TRANSFORMER).apply(var56));
      ...
      var0.put(ModelLayers.OCELOT_BABY, var17);
      ...
      var0.put(ModelLayers.PIG_SADDLE, var37);
      var0.put(ModelLayers.PIG_BABY_SADDLE, var37.apply(PigModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.POLAR_BEAR, var38);
      var0.put(ModelLayers.POLAR_BEAR_BABY, var38.apply(PolarBearModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.SALMON, var53);
      var0.put(ModelLayers.SALMON_SMALL, var53.apply(SalmonModel.SMALL_TRANSFORMER));
      var0.put(ModelLayers.SALMON_LARGE, var53.apply(SalmonModel.LARGE_TRANSFORMER));
      var0.put(ModelLayers.SHEEP, var39);
      var0.put(ModelLayers.SHEEP_BABY, var39.apply(SheepModel.BABY_TRANSFORMER));
      var0.put(ModelLayers.SHEEP_WOOL, var40);
      var0.put(ModelLayers.SHEEP_BABY_WOOL, var40.apply(SheepModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.SNIFFER, var41);
      var0.put(ModelLayers.SNIFFER_BABY, var41.apply(SnifferModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.SQUID, var51);
      var0.put(ModelLayers.SQUID_BABY, var51.apply(SquidModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.STRIDER_BABY, var24.apply(StriderModel.BABY_TRANSFORMER));
      var0.put(ModelLayers.STRIDER_BABY_SADDLE, var24.apply(StriderModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.TURTLE, var42);
      var0.put(ModelLayers.TURTLE_BABY, var42.apply(TurtleModel.BABY_TRANSFORMER));
      var0.put(ModelLayers.VEX, VexModel.createBodyLayer());
      var0.put(ModelLayers.VILLAGER, var28);
      var0.put(ModelLayers.VILLAGER_BABY, var28.apply(VillagerModel.BABY_TRANSFORMER));
      ...
      MeshTransformer var57 = MeshTransformer.scaling(1.2F);
      var0.put(ModelLayers.WITHER_SKELETON, var27.apply(var57));
      var0.put(ModelLayers.WITHER_SKELETON_INNER_ARMOR, var4.apply(var57));
      var0.put(ModelLayers.WITHER_SKELETON_OUTER_ARMOR, var2.apply(var57));
      var0.put(ModelLayers.WITHER_SKELETON_SKULL, var6);
      var0.put(ModelLayers.WOLF, var43);
      var0.put(ModelLayers.WOLF_ARMOR, var44);
      var0.put(ModelLayers.WOLF_BABY, var43.apply(WolfModel.BABY_TRANSFORMER));
      var0.put(ModelLayers.WOLF_BABY_ARMOR, var44.apply(WolfModel.BABY_TRANSFORMER));
      ...
      var0.put(ModelLayers.ZOMBIE_VILLAGER, var45);
      ...
      var0.put(ModelLayers.ZOMBIE_VILLAGER_BABY, var45.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      LayerDefinition var58 = BoatModel.createBoatModel();
      LayerDefinition var59 = BoatModel.createChestBoatModel();
      var0.put(ModelLayers.OAK_BOAT, var58);
      var0.put(ModelLayers.OAK_CHEST_BOAT, var59);
      var0.put(ModelLayers.SPRUCE_BOAT, var58);
      var0.put(ModelLayers.SPRUCE_CHEST_BOAT, var59);
      var0.put(ModelLayers.BIRCH_BOAT, var58);
      var0.put(ModelLayers.BIRCH_CHEST_BOAT, var59);
      var0.put(ModelLayers.JUNGLE_BOAT, var58);
      var0.put(ModelLayers.JUNGLE_CHEST_BOAT, var59);
      var0.put(ModelLayers.ACACIA_BOAT, var58);
      var0.put(ModelLayers.ACACIA_CHEST_BOAT, var59);
      var0.put(ModelLayers.CHERRY_BOAT, var58);
      var0.put(ModelLayers.CHERRY_CHEST_BOAT, var59);
      var0.put(ModelLayers.DARK_OAK_BOAT, var58);
      var0.put(ModelLayers.DARK_OAK_CHEST_BOAT, var59);
      var0.put(ModelLayers.PALE_OAK_BOAT, var58);
      var0.put(ModelLayers.PALE_OAK_CHEST_BOAT, var59);
      var0.put(ModelLayers.MANGROVE_BOAT, var58);
      var0.put(ModelLayers.MANGROVE_CHEST_BOAT, var59);
      LayerDefinition var60 = SignRenderer.createSignLayer(true);
      LayerDefinition var61 = SignRenderer.createSignLayer(false);
      WoodType.values().forEach((var3x) -> {
         var0.put(ModelLayers.createStandingSignModelName(var3x), var60);
         var0.put(ModelLayers.createWallSignModelName(var3x), var61);
      ...
      ImmutableMap var62 = var0.build();
      List var63 = (List)ModelLayers.getKnownLocations().filter((var1x) -> !var62.containsKey(var1x)).collect(Collectors.toList());
      if (!var63.isEmpty()) {
         throw new IllegalStateException("Missing layer definitions: " + String.valueOf(var63));
      } else {
         return var62;
      }
   }
