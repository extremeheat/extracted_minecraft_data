...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, ModelPart> createRoots() {
      ...
      Boat.Type[] var20 = Boat.Type.values();
      int var21 = var20.length;

      for(int var22 = 0; var22 < var21; ++var22) {
         Boat.Type var23 = var20[var22];
      ...
      WoodType.values().forEach((var2x) -> {
         var0.put(ModelLayers.createSignModelName(var2x), var24);
      });
      ImmutableMap var25 = var0.build();
      List var26 = (List)ModelLayers.getKnownLocations().filter((var1x) -> {
         return !var25.containsKey(var1x);
      }).collect(Collectors.toList());
      if (!var26.isEmpty()) {
         throw new IllegalStateException("Missing layer definitions: " + var26);
      } else {
         return Maps.transformValues(var25, LayerDefinition::bakeRoot);
      }
   }
}
