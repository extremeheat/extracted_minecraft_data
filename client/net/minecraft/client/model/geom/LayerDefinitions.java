...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      ArmorModelSet<LayerDefinition> humanoidBabyArmor = humanoidArmor.<LayerDefinition>map((layer) -> layer.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      ArmorModelSet<LayerDefinition> piglinBabyArmor = piglinArmor.<LayerDefinition>map((layer) -> layer.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.ARMADILLO, armadilloBodyLayer);
      result.put(ModelLayers.ARMADILLO_BABY, armadilloBodyLayer.apply(ArmadilloModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.BEE, beeBodyLayer);
      result.put(ModelLayers.BEE_BABY, beeBodyLayer.apply(BeeModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.CAMEL_BABY, camelBodyLayer.apply(CamelModel.BABY_TRANSFORMER));
      result.put(ModelLayers.CAMEL_SADDLE, camelSaddleLayer);
      result.put(ModelLayers.CAMEL_BABY_SADDLE, camelSaddleLayer.apply(CamelModel.BABY_TRANSFORMER));
      result.put(ModelLayers.CAMEL_HUSK_SADDLE, camelSaddleLayer);
      result.put(ModelLayers.CAMEL_HUSK_BABY_SADDLE, camelSaddleLayer.apply(CamelModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.DROWNED_BABY, drownedBodyLayer.apply(HumanoidModel.BABY_TRANSFORMER));
      ModelLayers.DROWNED_BABY_ARMOR.putFrom(humanoidBabyArmor, result);
      result.put(ModelLayers.DROWNED_BABY_OUTER_LAYER, drownedOuterLayer.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.FOX, FoxModel.createBodyLayer());
      result.put(ModelLayers.FOX_BABY, FoxModel.createBodyLayer().apply(FoxModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.GOAT, goatBodyLayer);
      result.put(ModelLayers.GOAT_BABY, goatBodyLayer.apply(GoatModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.HUSK_BABY, humanoidBodyLayer.apply(HumanoidModel.BABY_TRANSFORMER).apply(huskScale));
      ...
      result.put(ModelLayers.LLAMA_BABY, llamaBodyLayer.apply(LlamaModel.BABY_TRANSFORMER));
      result.put(ModelLayers.LLAMA_DECOR, llamaDecorLayer);
      result.put(ModelLayers.LLAMA_BABY_DECOR, llamaDecorLayer.apply(LlamaModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.PANDA_BABY, pandaBodyLayer.apply(PandaModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.PIGLIN_BABY, piglinLayer.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.POLAR_BEAR, PolarBearModel.createBodyLayer(false));
      result.put(ModelLayers.POLAR_BEAR_BABY, PolarBearModel.createBodyLayer(true));
      ...
      result.put(ModelLayers.SNIFFER_BABY, snifferBodyLayer.apply(SnifferModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.STRIDER_BABY, striderLayer.apply(StriderModel.BABY_TRANSFORMER));
      result.put(ModelLayers.STRIDER_BABY_SADDLE, striderLayer.apply(StriderModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.TRADER_LLAMA_BABY, llamaBodyLayer.apply(LlamaModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.VILLAGER_BABY, villagerBodyLayer.apply(VillagerModel.BABY_TRANSFORMER));
      result.put(ModelLayers.VILLAGER_BABY_NO_HAT, villagerNoHatLayer.apply(VillagerModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.ZOMBIE_BABY, humanoidBodyLayer.apply(HumanoidModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.ZOMBIE_VILLAGER_BABY, zombieVillagerBodyLayer.apply(HumanoidModel.BABY_TRANSFORMER));
      result.put(ModelLayers.ZOMBIE_VILLAGER_BABY_NO_HAT, zombieVillagerNoHatLayer.apply(HumanoidModel.BABY_TRANSFORMER));
      ModelLayers.ZOMBIE_VILLAGER_BABY_ARMOR.putFrom(zombieVillagerArmor.map((layer) -> layer.apply(HumanoidModel.BABY_TRANSFORMER)), result);
      result.put(ModelLayers.ZOMBIFIED_PIGLIN, piglinLayer);
      ModelLayers.ZOMBIFIED_PIGLIN_ARMOR.putFrom(piglinArmor, result);
      result.put(ModelLayers.ZOMBIFIED_PIGLIN_BABY, piglinLayer.apply(HumanoidModel.BABY_TRANSFORMER));
