...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      MeshTransformer var54 = MeshTransformer.scaling(1.1F);
      var0.put(ModelLayers.HORSE, var7.apply(var54));
      var0.put(ModelLayers.HORSE_BABY, var8.apply(var54));
      var0.put(ModelLayers.HORSE_ARMOR, LayerDefinition.create(AbstractEquineModel.createBodyMesh(new CubeDeformation(0.1F)), 64, 64).apply(var54));
      var0.put(ModelLayers.HORSE_BABY_ARMOR, LayerDefinition.create(AbstractEquineModel.createBabyMesh(new CubeDeformation(0.1F)), 64, 64).apply(var54));
      MeshTransformer var55 = MeshTransformer.scaling(1.0625F);
      var0.put(ModelLayers.HUSK, var1.apply(var55));
      var0.put(ModelLayers.HUSK_INNER_ARMOR, var4.apply(var55));
      var0.put(ModelLayers.HUSK_OUTER_ARMOR, var2.apply(var55));
      var0.put(ModelLayers.HUSK_BABY, var1.apply(HumanoidModel.BABY_TRANSFORMER).apply(var55));
      var0.put(ModelLayers.HUSK_BABY_INNER_ARMOR, var4.apply(HumanoidModel.BABY_TRANSFORMER).apply(var55));
      var0.put(ModelLayers.HUSK_BABY_OUTER_ARMOR, var2.apply(HumanoidModel.BABY_TRANSFORMER).apply(var55));
      ...
      MeshTransformer var56 = MeshTransformer.scaling(1.2F);
      var0.put(ModelLayers.WITHER_SKELETON, var27.apply(var56));
      var0.put(ModelLayers.WITHER_SKELETON_INNER_ARMOR, var4.apply(var56));
      var0.put(ModelLayers.WITHER_SKELETON_OUTER_ARMOR, var2.apply(var56));
      ...
      LayerDefinition var57 = BoatModel.createBoatModel();
      LayerDefinition var58 = BoatModel.createChestBoatModel();
      var0.put(ModelLayers.OAK_BOAT, var57);
      var0.put(ModelLayers.OAK_CHEST_BOAT, var58);
      var0.put(ModelLayers.SPRUCE_BOAT, var57);
      var0.put(ModelLayers.SPRUCE_CHEST_BOAT, var58);
      var0.put(ModelLayers.BIRCH_BOAT, var57);
      var0.put(ModelLayers.BIRCH_CHEST_BOAT, var58);
      var0.put(ModelLayers.JUNGLE_BOAT, var57);
      var0.put(ModelLayers.JUNGLE_CHEST_BOAT, var58);
      var0.put(ModelLayers.ACACIA_BOAT, var57);
      var0.put(ModelLayers.ACACIA_CHEST_BOAT, var58);
      var0.put(ModelLayers.CHERRY_BOAT, var57);
      var0.put(ModelLayers.CHERRY_CHEST_BOAT, var58);
      var0.put(ModelLayers.DARK_OAK_BOAT, var57);
      var0.put(ModelLayers.DARK_OAK_CHEST_BOAT, var58);
      var0.put(ModelLayers.PALE_OAK_BOAT, var57);
      var0.put(ModelLayers.PALE_OAK_CHEST_BOAT, var58);
      var0.put(ModelLayers.MANGROVE_BOAT, var57);
      var0.put(ModelLayers.MANGROVE_CHEST_BOAT, var58);
      LayerDefinition var59 = SignRenderer.createSignLayer(true);
      LayerDefinition var60 = SignRenderer.createSignLayer(false);
