...
public class ParrotModel extends HierarchicalModel<Parrot> {
   ...
   private void setupAnim(ParrotModel.State var1, int var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      this.head.zRot = 0.0F;
      this.head.field_305 = 0.0F;
      this.body.field_305 = 0.0F;
      this.tail.field_305 = 0.0F;
      this.rightWing.field_305 = -1.5F;
      this.leftWing.field_305 = 1.5F;
      switch(var1) {
      case SITTING:
         break;
      case PARTY:
         ...
         this.head.field_305 = var8;
         this.head.field_306 = 15.69F + var9;
         this.head.xRot = 0.0F;
         this.head.yRot = 0.0F;
         this.head.zRot = Mth.sin((float)var2) * 0.4F;
         this.body.field_305 = var8;
         this.body.field_306 = 16.5F + var9;
         this.leftWing.zRot = -0.0873F - var5;
         this.leftWing.field_305 = 1.5F + var8;
         this.leftWing.field_306 = 16.94F + var9;
         this.rightWing.zRot = 0.0873F + var5;
         this.rightWing.field_305 = -1.5F + var8;
         this.rightWing.field_306 = 16.94F + var9;
         this.tail.field_305 = var8;
         this.tail.field_306 = 21.07F + var9;
         break;
      case STANDING:
      ...
      default:
         ...
         this.head.field_306 = 15.69F + var10;
         this.tail.xRot = 1.015F + Mth.cos(var3 * 0.6662F) * 0.3F * var4;
         this.tail.field_306 = 21.07F + var10;
         this.body.field_306 = 16.5F + var10;
         this.leftWing.zRot = -0.0873F - var5;
         this.leftWing.field_306 = 16.94F + var10;
         this.rightWing.zRot = 0.0873F + var5;
         this.rightWing.field_306 = 16.94F + var10;
         this.leftLeg.field_306 = 22.0F + var10;
         this.rightLeg.field_306 = 22.0F + var10;
      }
   ...
   private void prepare(ParrotModel.State var1) {
      ...
      this.leftLeg.field_306 = 22.0F;
      this.rightLeg.field_306 = 22.0F;
      this.leftLeg.zRot = 0.0F;
      this.rightLeg.zRot = 0.0F;
      switch(var1) {
      case SITTING:
         float var2 = 1.9F;
         this.head.field_306 = 17.59F;
         this.tail.xRot = 1.5388988F;
         this.tail.field_306 = 22.97F;
         this.body.field_306 = 18.4F;
         this.leftWing.zRot = -0.0873F;
         this.leftWing.field_306 = 18.84F;
         this.rightWing.zRot = 0.0873F;
         this.rightWing.field_306 = 18.84F;
         ++this.leftLeg.field_306;
         ++this.rightLeg.field_306;
         ++this.leftLeg.xRot;
         ++this.rightLeg.xRot;
         break;
      case PARTY:
