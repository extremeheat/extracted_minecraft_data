...
public class ModelSquid extends ModelBase {
   ...
   public ModelSquid() {
      ...
      for(int var2 = 0; var2 < this.field_78201_b.length; ++var2) {
         ...
         double var3 = (double)var2 * 3.141592653589793 * 2.0 / (double)this.field_78201_b.length;
         ...
         var3 = (double)var2 * 3.141592653589793 * -2.0 / (double)this.field_78201_b.length + 1.5707963267948966;
   ...
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      for(ModelRenderer var11 : this.field_78201_b) {
