...
public class DrownedModel extends ZombieModel<ZombieRenderState> {
   ...
   public void setupAnim(ZombieRenderState var1) {
      ...
      if (var2 > 0.0F) {
         ...
         this.leftLeg.xRot = this.leftLeg.xRot - var2 * 0.55F * Mth.sin(0.1F * var1.ageInTicks);
         this.rightLeg.xRot = this.rightLeg.xRot + var2 * 0.55F * Mth.sin(0.1F * var1.ageInTicks);
         this.head.xRot = 0.0F;
      }
   }
}
