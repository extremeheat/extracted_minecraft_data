...
public class HorseModel<T extends AbstractHorse> extends AgeableListModel<T> {
   ...
   public void prepareMobModel(T var1, float var2, float var3, float var4) {
      ...
      this.headParts.field_306 = 4.0F;
      this.headParts.field_307 = -12.0F;
      this.body.xRot = 0.0F;
      ...
      this.headParts.field_306 = var11 * -4.0F + var10 * 11.0F + (1.0F - Math.max(var11, var10)) * this.headParts.field_306;
      this.headParts.field_307 = var11 * -4.0F + var10 * -12.0F + (1.0F - Math.max(var11, var10)) * this.headParts.field_307;
      ...
      this.leftFrontLeg.field_306 = 2.0F * var11 + 14.0F * var12;
      this.leftFrontLeg.field_307 = -6.0F * var11 - 10.0F * var12;
      this.rightFrontLeg.field_306 = this.leftFrontLeg.field_306;
      this.rightFrontLeg.field_307 = this.leftFrontLeg.field_307;
      ...
      this.tail.field_306 = -5.0F + var3;
      this.tail.field_307 = 2.0F + var3 * 2.0F;
      if (var14) {
      ...
      this.rightHindBabyLeg.field_306 = this.rightHindLeg.field_306;
      this.rightHindBabyLeg.field_307 = this.rightHindLeg.field_307;
      this.rightHindBabyLeg.xRot = this.rightHindLeg.xRot;
      this.leftHindBabyLeg.field_306 = this.leftHindLeg.field_306;
      this.leftHindBabyLeg.field_307 = this.leftHindLeg.field_307;
      this.leftHindBabyLeg.xRot = this.leftHindLeg.xRot;
      this.rightFrontBabyLeg.field_306 = this.rightFrontLeg.field_306;
      this.rightFrontBabyLeg.field_307 = this.rightFrontLeg.field_307;
      this.rightFrontBabyLeg.xRot = this.rightFrontLeg.xRot;
      this.leftFrontBabyLeg.field_306 = this.leftFrontLeg.field_306;
      this.leftFrontBabyLeg.field_307 = this.leftFrontLeg.field_307;
      ...
      this.body.field_306 = var24 ? 10.8F : 0.0F;
   }
}
