   ...
   public static record Services(ReportEnvironment a, UserApiService b) implements AbuseReportSender {
      ...
      public CompletableFuture<Unit> send(UUID var1, AbuseReport var2) {
         return CompletableFuture.supplyAsync(() -> {
            AbuseReportRequest var3 = new AbuseReportRequest(var1, var2, this.environment.clientInfo(), this.environment.thirdPartyServerInfo(), this.environment.realmInfo());
            ...
            try {
               ...
               throw new CompletionException(new SendException(var5, var6));
            } catch (MinecraftClientException var7) {
               var5 = this.getErrorDescription(var7);
               throw new CompletionException(new SendException(var5, var7));
            }
         }, Util.ioPool());
      }
