...
public interface LoggedChatMessageLink extends LoggedChatEvent {
   static LoggedChatMessageLink.Header header(SignedMessageHeader var0, MessageSignature var1, byte[] var2) {
      return new LoggedChatMessageLink.Header(var0, var1, var2);
   }
