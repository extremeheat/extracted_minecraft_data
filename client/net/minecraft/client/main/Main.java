...
public class Main {
   ...
   public static void main(String[] var0) {
      ...
      String var30 = (String)parseArgument(var28, var8);
      Proxy var31 = Proxy.NO_PROXY;
      if (var30 != null) {
         try {
            var31 = new Proxy(Type.SOCKS, new InetSocketAddress(var30, (Integer)parseArgument(var28, var9)));
         } catch (Exception var77) {
         }
      }

      final String var32 = (String)parseArgument(var28, var10);
      final String var33 = (String)parseArgument(var28, var11);
      ...
      int var34 = (Integer)parseArgument(var28, var18);
      int var35 = (Integer)parseArgument(var28, var19);
      OptionalInt var36 = ofNullable((Integer)parseArgument(var28, var20));
      OptionalInt var37 = ofNullable((Integer)parseArgument(var28, var21));
      ...
      String var42 = (String)parseArgument(var28, var17);
      Gson var43 = (new GsonBuilder()).registerTypeAdapter(PropertyMap.class, new Serializer()).create();
      PropertyMap var44 = (PropertyMap)GsonHelper.fromJson(var43, (String)parseArgument(var28, var22), PropertyMap.class);
      PropertyMap var45 = (PropertyMap)GsonHelper.fromJson(var43, (String)parseArgument(var28, var23), PropertyMap.class);
      String var46 = (String)parseArgument(var28, var26);
      File var47 = (File)parseArgument(var28, var5);
      File var48 = var28.has(var6) ? (File)parseArgument(var28, var6) : new File(var47, "assets/");
      File var49 = var28.has(var7) ? (File)parseArgument(var28, var7) : new File(var47, "resourcepacks/");
      String var50 = var28.has(var13) ? (String)var13.value(var28) : Player.createPlayerUUID((String)var12.value(var28)).toString();
      ...
      String var54 = (String)parseArgument(var28, var3);
      Integer var55 = (Integer)parseArgument(var28, var4);
      if (var28.has(var2)) {
      ...
      User var58 = new User((String)var12.value(var28), var50, (String)var16.value(var28), emptyStringToEmptyOptional(var52), emptyStringToEmptyOptional(var53), var57);
      GameConfig var59 = new GameConfig(new GameConfig.UserData(var58, var44, var45, var31), new DisplayData(var34, var35, var36, var37, var38), new GameConfig.FolderData(var47, var49, var48, var51), new GameConfig.GameData(var39, var42, var46, var40, var41), new GameConfig.ServerData(var54, var55));
      ...
      try {
         ...
         Minecraft.fillReport((Minecraft)null, (LanguageManager)null, var59.game.launchVersion, (Options)null, var63);
