...
public class Main {
   ...
   public static void main(String[] var0) {
      ...
      File var31 = (File)parseArgument(var30, var7);
      String var32 = (String)parseArgument(var30, var19);
      ...
      try {
         ...
         String var42 = (String)parseArgument(var30, var10);
         Proxy var43 = Proxy.NO_PROXY;
         if (var42 != null) {
            try {
               var43 = new Proxy(Type.SOCKS, new InetSocketAddress(var42, (Integer)parseArgument(var30, var11)));
            } catch (Exception var78) {
            }
         }

         final String var44 = (String)parseArgument(var30, var12);
         final String var45 = (String)parseArgument(var30, var13);
         ...
         int var46 = (Integer)parseArgument(var30, var20);
         int var47 = (Integer)parseArgument(var30, var21);
         OptionalInt var48 = ofNullable((Integer)parseArgument(var30, var22));
         OptionalInt var49 = ofNullable((Integer)parseArgument(var30, var23));
         ...
         Gson var54 = (new GsonBuilder()).registerTypeAdapter(PropertyMap.class, new PropertyMap.Serializer()).create();
         PropertyMap var55 = (PropertyMap)GsonHelper.fromJson(var54, (String)parseArgument(var30, var24), PropertyMap.class);
         PropertyMap var56 = (PropertyMap)GsonHelper.fromJson(var54, (String)parseArgument(var30, var25), PropertyMap.class);
         String var57 = (String)parseArgument(var30, var28);
         File var58 = var30.has(var8) ? (File)parseArgument(var30, var8) : new File(var31, "assets/");
         File var59 = var30.has(var9) ? (File)parseArgument(var30, var9) : new File(var31, "resourcepacks/");
         UUID var60 = var30.has(var15) ? UndashedUuid.fromStringLenient((String)var15.value(var30)) : UUIDUtil.createOfflinePlayerUUID((String)var14.value(var30));
         ...
         String var64 = (String)parseArgument(var30, var3);
         String var65 = unescapeJavaArgument((String)parseArgument(var30, var4));
         String var66 = unescapeJavaArgument((String)parseArgument(var30, var5));
         String var67 = unescapeJavaArgument((String)parseArgument(var30, var6));
         User var68 = new User((String)var14.value(var30), var60, (String)var18.value(var30), emptyStringToEmptyOptional(var62), emptyStringToEmptyOptional(var63), var41);
         var34 = new GameConfig(new GameConfig.UserData(var68, var55, var56, var43), new DisplayData(var46, var47, var48, var49, var50), new GameConfig.FolderData(var31, var59, var58, var61), new GameConfig.GameData(var51, var32, var57, var52, var53), new GameConfig.QuickPlayData(var64, var65, var66, var67));
         Util.startTimerHackThread();
         var83.join();
      } catch (Throwable var79) {
         var37 = CrashReport.forThrowable(var79, var35);
         CrashReportCategory var38 = var37.addCategory("Initialization");
         NativeModuleLister.addCrashSection(var38);
         Minecraft.fillReport((Minecraft)null, (LanguageManager)null, var32, (Options)null, var37);
         Minecraft.crash((Minecraft)null, var31, var37);
         return;
      }
      ...
      try {
         ...
         Minecraft.fillReport(var37, (LanguageManager)null, var34.game.launchVersion, (Options)null, var85);
         Minecraft.crash(var37, var34.location.gameDirectory, var85);
         return;
      }
