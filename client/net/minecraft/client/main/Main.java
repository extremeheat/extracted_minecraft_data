...
public class Main {
   ...
   public static void main(String[] var0) {
      ...
      File var33 = parseArgument(var32, var9);
      String var34 = parseArgument(var32, var21);
      ...
      try {
         ...
         String var44 = parseArgument(var32, var12);
         Proxy var45 = Proxy.NO_PROXY;
         if (var44 != null) {
            try {
               var45 = new Proxy(Type.SOCKS, new InetSocketAddress(var44, parseArgument(var32, var13)));
            } catch (Exception var81) {
            }
         }

         final String var46 = parseArgument(var32, var14);
         final String var47 = parseArgument(var32, var15);
         ...
         int var48 = parseArgument(var32, var22);
         int var49 = parseArgument(var32, var23);
         OptionalInt var50 = ofNullable(parseArgument(var32, var24));
         OptionalInt var51 = ofNullable(parseArgument(var32, var25));
         ...
         Gson var57 = new GsonBuilder().registerTypeAdapter(PropertyMap.class, new Serializer()).create();
         PropertyMap var58 = GsonHelper.fromJson(var57, parseArgument(var32, var26), PropertyMap.class);
         PropertyMap var59 = GsonHelper.fromJson(var57, parseArgument(var32, var27), PropertyMap.class);
         String var60 = parseArgument(var32, var30);
         File var61 = var32.has(var10) ? parseArgument(var32, var10) : new File(var33, "assets/");
         File var62 = var32.has(var11) ? parseArgument(var32, var11) : new File(var33, "resourcepacks/");
         UUID var63 = hasValidUuid(var17, var32, var35)
         ...
         String var67 = parseArgument(var32, var5);
         String var68 = unescapeJavaArgument(parseArgument(var32, var6));
         String var69 = unescapeJavaArgument(parseArgument(var32, var7));
         String var70 = unescapeJavaArgument(parseArgument(var32, var8));
         User var71 = new User(
            (String)var16.value(var32), var63, (String)var20.value(var32), emptyStringToEmptyOptional(var65), emptyStringToEmptyOptional(var66), var43
         );
         var36 = new GameConfig(
            new GameConfig.UserData(var71, var58, var59, var45),
            new DisplayData(var48, var49, var50, var51, var52),
            new GameConfig.FolderData(var33, var62, var61, var64),
            new GameConfig.GameData(var53, var34, var60, var54, var55, var56),
            new GameConfig.QuickPlayData(var67, var68, var69, var70)
         );
         ...
         Minecraft.fillReport(null, null, var34, null, var39);
         Minecraft.crash(null, var33, var39);
         return;
      }
      ...
      try {
         ...
         Minecraft.fillReport(var85, null, var36.game.launchVersion, null, var88);
         Minecraft.crash(var85, var36.location.gameDirectory, var88);
         return;
      }
