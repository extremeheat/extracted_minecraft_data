...
public class MouseHandler {
   ...
   public void setup(long var1) {
      InputConstants.setupMouseCallbacks(var1, this::onMove, this::onPress, this::onScroll);
   }
   ...
   private void onMove(long var1, double var3, double var5) {
      if (var1 == Minecraft.getInstance().window.getWindow()) {
         ...
         if (var7 != null && this.minecraft.overlay == null) {
            double var8 = var3 * (double)this.minecraft.window.getGuiScaledWidth() / (double)this.minecraft.window.getScreenWidth();
            double var10 = var5 * (double)this.minecraft.window.getGuiScaledHeight() / (double)this.minecraft.window.getScreenHeight();
            Screen.wrapScreenError(() -> {
            ...
            if (this.activeButton != -1 && this.mousePressedTime > 0.0D) {
               double var12 = (var3 - this.xpos) * (double)this.minecraft.window.getGuiScaledWidth() / (double)this.minecraft.window.getScreenWidth();
               double var14 = (var5 - this.ypos) * (double)this.minecraft.window.getGuiScaledHeight() / (double)this.minecraft.window.getScreenHeight();
               Screen.wrapScreenError(() -> {
