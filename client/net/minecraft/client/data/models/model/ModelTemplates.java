...
public class ModelTemplates {
   ...
   static {
      ...
      SIGN_ROT_0 = create("sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
      SIGN_ROT_1 = create("sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
      SIGN_ROT_2 = create("sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
      SIGN_ROT_3 = create("sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
      WALL_SIGN = create("wall_sign", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_0 = create("hanging_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_1 = create("hanging_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_2 = create("hanging_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_3 = create("hanging_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_0 = create("attached_hanging_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_1 = create("attached_hanging_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_2 = create("attached_hanging_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_3 = create("attached_hanging_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
      WALL_HANGING_SIGN = create("wall_hanging_sign", TextureSlot.ALL, TextureSlot.PARTICLE);
