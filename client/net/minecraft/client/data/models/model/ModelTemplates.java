...
public class ModelTemplates {
   ...
   static {
      ...
      SHELF_BODY = create("template_shelf_body", TextureSlot.ALL);
      SHELF_INVENTORY = create("template_shelf_inventory", "_inventory", TextureSlot.ALL);
      SHELF_UNPOWERED = create("template_shelf_unpowered", "_unpowered", TextureSlot.ALL);
      SHELF_UNCONNECTED = create("template_shelf_unconnected", "_unconnected", TextureSlot.ALL);
      SHELF_LEFT = create("template_shelf_left", "_left", TextureSlot.ALL);
      SHELF_CENTER = create("template_shelf_center", "_center", TextureSlot.ALL);
      SHELF_RIGHT = create("template_shelf_right", "_right", TextureSlot.ALL);
