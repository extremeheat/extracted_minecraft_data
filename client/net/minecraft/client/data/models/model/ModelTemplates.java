...
public class ModelTemplates {
   ...
   public static final ModelTemplate SIGN_ROT_0;
   public static final ModelTemplate SIGN_ROT_1;
   public static final ModelTemplate SIGN_ROT_2;
   public static final ModelTemplate SIGN_ROT_3;
   public static final ModelTemplate WALL_SIGN;
   public static final ModelTemplate HANGING_SIGN_ROT_0;
   public static final ModelTemplate HANGING_SIGN_ROT_1;
   public static final ModelTemplate HANGING_SIGN_ROT_2;
   public static final ModelTemplate HANGING_SIGN_ROT_3;
   public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_0;
   public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_1;
   public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_2;
   public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_3;
   public static final ModelTemplate WALL_HANGING_SIGN;
   ...
   static {
      ...
      SIGN_ROT_0 = create("template_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
      SIGN_ROT_1 = create("template_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
      SIGN_ROT_2 = create("template_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
      SIGN_ROT_3 = create("template_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
      WALL_SIGN = create("template_wall_sign", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_0 = create("template_hanging_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_1 = create("template_hanging_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_2 = create("template_hanging_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
      HANGING_SIGN_ROT_3 = create("template_hanging_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_0 = create("template_attached_hanging_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_1 = create("template_attached_hanging_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_2 = create("template_attached_hanging_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
      ATTACHED_HANGING_SIGN_ROT_3 = create("template_attached_hanging_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
      WALL_HANGING_SIGN = create("template_wall_hanging_sign", TextureSlot.ALL, TextureSlot.PARTICLE);
      ...
      BED_HEAD = create("template_bed_head", TextureSlot.UP, TextureSlot.EAST, TextureSlot.WEST);
      BED_FOOT = create("template_bed_foot", TextureSlot.UP, TextureSlot.EAST, TextureSlot.WEST, TextureSlot.SOUTH);
