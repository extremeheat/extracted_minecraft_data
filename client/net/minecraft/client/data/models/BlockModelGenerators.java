...
public class BlockModelGenerators {
   ...
   private Identifier createSuffixedVariant(final Block block, final String suffix, final ModelTemplate template, final Function<Identifier, TextureMapping> textureMapping) {
