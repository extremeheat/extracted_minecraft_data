   ...
   private static void _grab(File var0, @Nullable String var1, RenderTarget var2, Consumer<Component> var3) {
      ...
      Util.ioPool().execute(() -> {
         try {
            ...
            MutableComponent var3x = (new TextComponent(var6.getName())).withStyle(ChatFormatting.UNDERLINE).withStyle((var1) -> {
               return var1.withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_FILE, var6.getAbsolutePath()));
            });
            var3.accept(new TranslatableComponent("screenshot.success", new Object[]{var3x}));
         } catch (Exception var7) {
            LOGGER.warn("Couldn't save screenshot", var7);
            var3.accept(new TranslatableComponent("screenshot.failure", new Object[]{var7.getMessage()}));
         } finally {
            var4.close();
         }
