   ...
   public void tick() {
      ...
      if (var1 != this.previousBiome) {
         ...
         var1.getAmbientLoop().ifPresent((var2) -> {
            this.loopSounds.compute(var1, (var2x, var3) -> {
               if (var3 == null) {
                  var3 = new LoopSoundInstance(var2);
      ...
      this.moodSettings.ifPresent((var1x) -> {
         ...
         if (this.moodiness >= 1.0F) {
            ...
            SimpleSoundInstance var22 = SimpleSoundInstance.forAmbientMood(var1x.getSoundEvent(), this.random, this.player.getX() + var12 / var18 * var20, this.player.getEyeY() + var14 / var18 * var20, this.player.getZ() + var16 / var18 * var20);
