...
public class SimpleBakedModel implements BakedModel {
   ...
   public SimpleBakedModel(
      List<BakedQuad> var1, Map<Direction, List<BakedQuad>> var2, boolean var3, boolean var4, boolean var5, TextureAtlasSprite var6, ItemTransforms var7
   ) {
      super();
      ...
      public BakedModel build() {
         if (this.particleIcon == null) {
            ...
            return new SimpleBakedModel(
               this.unculledFaces.build(), new EnumMap<>(var1), this.hasAmbientOcclusion, this.usesBlockLight, this.isGui3d, this.particleIcon, this.transforms
            );
         }
      }
   }
