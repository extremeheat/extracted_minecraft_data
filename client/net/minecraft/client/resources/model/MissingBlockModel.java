...
public class MissingBlockModel {
   ...
   public static UnbakedModel missingModel() {
      ...
      BlockModel var7 = new BlockModel((ResourceLocation)null, List.of(var6), Map.of("particle", Either.left(BlockModel.MISSING_MATERIAL)), (Boolean)null, (BlockModel.GuiLight)null, ItemTransforms.NO_TRANSFORMS, List.of());
      var7.name = "missingno";
      return var7;
   }
