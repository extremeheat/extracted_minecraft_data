...
public enum BlockModelRotation implements ModelState {
   ...
   private BlockModelRotation(int var3, int var4) {
      ...
      Quaternion var5 = Vector3f.field_292.rotationDegrees((float)(-var4));
      var5.mul(Vector3f.field_290.rotationDegrees((float)(-var3)));
   ...
   // $FF: renamed from: by (int, int) net.minecraft.client.resources.model.BlockModelRotation
   public static BlockModelRotation method_118(int var0, int var1) {
