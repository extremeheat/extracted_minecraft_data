...
public class AnimationMetadataSectionSerializer extends BaseMetadataSectionSerializer implements JsonSerializer {
   ...
   public AnimationMetadataSection deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) {
      ...
      if (var6 != 1) {
         Validate.inclusiveBetween(1, 2147483647, var6, "Invalid default frame time", new Object[0]);
      }
      ...
      int var13 = JsonUtils.func_151208_a(var5, "height", -1);
      if (var12 != -1) {
         Validate.inclusiveBetween(1, 2147483647, var12, "Invalid width", new Object[0]);
      }

      if (var13 != -1) {
         Validate.inclusiveBetween(1, 2147483647, var13, "Invalid height", new Object[0]);
      }

      return new AnimationMetadataSection(var4, var12, var13, var6);
   }
   ...
   private AnimationFrame func_110492_a(int var1, JsonElement var2) {
      if (var2.isJsonPrimitive()) {
         ...
         if (var3.has("time")) {
            Validate.inclusiveBetween(1, 2147483647, var4, "Invalid frame time", new Object[0]);
         }

         int var5 = JsonUtils.func_151203_m(var3, "index");
         Validate.inclusiveBetween(0, 2147483647, var5, "Invalid frame index", new Object[0]);
