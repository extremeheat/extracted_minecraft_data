   ...
   public FontMetadataSection deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) {
      ...
      if (var4.has("characters")) {
         ...
         if (var11.has("default")) {
            ...
            Validate.inclusiveBetween(0.0F, 3.4028235E38F, var8, "Invalid default width", new Object[0]);
            var9 = JsonUtils.func_151221_a(var12, "spacing", var9);
            Validate.inclusiveBetween(0.0F, 3.4028235E38F, var9, "Invalid default spacing", new Object[0]);
            var10 = JsonUtils.func_151221_a(var12, "left", var9);
            Validate.inclusiveBetween(0.0F, 3.4028235E38F, var10, "Invalid default left", new Object[0]);
         }
         ...
         for(int var18 = 0; var18 < 256; ++var18) {
            ...
            if (var13 != null) {
               ...
               Validate.inclusiveBetween(0.0F, 3.4028235E38F, var14, "Invalid width", new Object[0]);
               var15 = JsonUtils.func_151221_a(var17, "spacing", var9);
               Validate.inclusiveBetween(0.0F, 3.4028235E38F, var15, "Invalid spacing", new Object[0]);
               var16 = JsonUtils.func_151221_a(var17, "left", var10);
               Validate.inclusiveBetween(0.0F, 3.4028235E38F, var16, "Invalid left", new Object[0]);
            }
