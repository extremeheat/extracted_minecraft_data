...
public class LanguageManager implements IResourceManagerReloadListener {
   ...
   public void func_135043_a(List var1) {
      ...
      for(IResourcePack var3 : var1) {
         try {
            ...
            if (var4 != null) {
               for(Language var6 : var4.func_135018_a()) {
   ...
   public Language func_135041_c() {
      return this.field_135046_d.containsKey(this.field_135048_c)
         ? (Language)this.field_135046_d.get(this.field_135048_c)
         : (Language)this.field_135046_d.get("en_US");
   }
