...
public class SkyRenderer implements AutoCloseable {
   ...
   private VertexBuffer createStarBuffer() {
      VertexBuffer var1 = new VertexBuffer(BufferUsage.STATIC_WRITE);
      var1.bind();
   ...
   private void renderStars(FogParameters var1, float var2, PoseStack var3) {
      ...
      this.starBuffer.drawWithShader(var4, RenderSystem.getProjectionMatrix(), RenderSystem.getShader());
      VertexBuffer.unbind();
