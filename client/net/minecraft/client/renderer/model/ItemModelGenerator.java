...
public class ItemModelGenerator {
   ...
   public ModelBlock func_209579_a(Function<ResourceLocation, TextureAtlasSprite> var1, ModelBlock var2) {
      ...
      ModelBlock var9 = new ModelBlock((ResourceLocation)null, var4, var3, false, false, var2.func_181682_g(), var2.func_187966_f());
      var9.field_178317_b = var2.field_178317_b;
      return var9;
   }
      ...
      for(int var5 = 0; var5 < var1.func_110970_k(); ++var5) {
         for(int var6 = 0; var6 < var3; ++var6) {
            for(int var7 = 0; var7 < var2; ++var7) {
               boolean var8 = !this.func_199339_a(var1, var5, var7, var6, var2, var3);
               this.func_199338_a(ItemModelGenerator.SpanFacing.UP, var4, var1, var5, var7, var6, var2, var3, var8);
               this.func_199338_a(ItemModelGenerator.SpanFacing.DOWN, var4, var1, var5, var7, var6, var2, var3, var8);
               this.func_199338_a(ItemModelGenerator.SpanFacing.LEFT, var4, var1, var5, var7, var6, var2, var3, var8);
               this.func_199338_a(ItemModelGenerator.SpanFacing.RIGHT, var4, var1, var5, var7, var6, var2, var3, var8);
            }
         }
      }
   ...
   private void func_199338_a(ItemModelGenerator.SpanFacing var1, List<ItemModelGenerator.Span> var2, TextureAtlasSprite var3, int var4, int var5, int var6, int var7, int var8, boolean var9) {
      boolean var10 = this.func_199339_a(var3, var4, var5 + var1.func_178372_b(), var6 + var1.func_178371_c(), var7, var8) && var9;
      if (var10) {
         this.func_178395_a(var2, var1, var5, var6);
      }
   ...
   private boolean func_199339_a(TextureAtlasSprite var1, int var2, int var3, int var4, int var5, int var6) {
      return var3 >= 0 && var4 >= 0 && var3 < var5 && var4 < var6 ? var1.func_195662_a(var2, var3, var4) : true;
   }
