...
public class SpriteContents implements Stitcher.Entry, AutoCloseable {
   ...
   public SpriteContents(ResourceLocation var1, FrameSize var2, NativeImage var3, ResourceMetadata var4) {
      ...
      this.metadata = var4;
      AnimationMetadataSection var5 = var4.getSection(AnimationMetadataSection.SERIALIZER).orElse(AnimationMetadataSection.EMPTY);
   ...
   final class InterpolationData implements AutoCloseable {
      ...
      void uploadInterpolatedFrame(int var1, int var2, SpriteContents.Ticker var3) {
         ...
         int var8 = var6.index;
         int var9 = ((SpriteContents.FrameInfo)var5.get((var3.frame + 1) % var5.size())).index;
         if (var8 != var9) {
      ...
      private int getPixel(SpriteContents.AnimatedTexture var1, int var2, int var3, int var4, int var5) {
         return SpriteContents.this.byMipLevel[var3]
            .getPixel(var4 + (var1.getFrameX(var2) * SpriteContents.this.width >> var3), var5 + (var1.getFrameY(var2) * SpriteContents.this.height >> var3));
      }
