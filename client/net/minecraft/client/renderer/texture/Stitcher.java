...
public class Stitcher {
   ...
   public void gatherSprites(SpriteLoader var1) {
      Iterator var2 = this.storage.iterator();

      while(var2.hasNext()) {
         Region var3 = (Region)var2.next();
         var3.walk((var2x) -> {
            Holder var3 = var2x.getHolder();
   ...
   private boolean addToStorage(Holder var1) {
      Iterator var2 = this.storage.iterator();
   ...
   private boolean expand(Holder var1) {
      ...
      if (!var7 && !var8) {
         ...
         if (var2) {
            ...
            var11 = new Region(this.storageX, 0, var1.width, this.storageY);
            this.storageX += var1.width;
         } else {
            var11 = new Region(0, this.storageY, this.storageX, var1.height);
            this.storageY += var1.height;
         }
   ...
   public static class Region {
      ...
      public boolean add(Holder var1) {
         if (this.holder != null) {
            return false;
         } else {
            int var2 = var1.width;
      ...
      public void walk(Consumer<Region> var1) {
         if (this.holder != null) {
            var1.accept(this);
