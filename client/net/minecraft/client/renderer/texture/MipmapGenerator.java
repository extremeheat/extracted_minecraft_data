...
public class MipmapGenerator {
            ...
            if (var4 < var0.length) {
               ...
               for(int var9 = 0; var9 < var7; ++var9) {
                  for(int var10 = 0; var10 < var8; ++var10) {
                     var6.setPixel(var9, var10, alphaBlend(var5.getPixel(var9 * 2 + 0, var10 * 2 + 0), var5.getPixel(var9 * 2 + 1, var10 * 2 + 0), var5.getPixel(var9 * 2 + 0, var10 * 2 + 1), var5.getPixel(var9 * 2 + 1, var10 * 2 + 1), var3));
                  }
               }
   ...
   private static int alphaBlend(int var0, int var1, int var2, int var3, boolean var4) {
      if (var4) {
         ...
         return ARGB.color(var9, var10, var11, var12);
      } else {
         ...
         return ARGB.color(var5, var6, var7, var8);
      }
   }
