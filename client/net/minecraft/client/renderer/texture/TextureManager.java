...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
   ...
   public ResourceLocation func_130087_a(int var1) {
      return (ResourceLocation)this.field_130089_b.get(var1);
   }

   public boolean func_130088_a(ResourceLocation var1, TextureMap var2) {
      if (this.func_110580_a(var1, var2)) {
         this.field_130089_b.put(var2.func_130086_a(), var1);
         return true;
      } else {
         return false;
      }
   ...
   public boolean func_110579_a(ResourceLocation var1, ITextureObject var2) {
      ...
      try {
         ...
         var6.func_71500_a("Texture object class", new TextureManager$1(this, (ITextureObject)var2));
   ...
   public void func_110550_d() {
      for(ITickable var2 : this.field_110583_b) {
         var2.func_110550_d();
      }
   }
   ...
   public void func_110549_a(IResourceManager var1) {
      for(Entry var3 : this.field_110585_a.entrySet()) {
