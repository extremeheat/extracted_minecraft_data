...
public class TextureAtlasSprite implements AutoCloseable {
   ...
   private final int field_162;
   // $FF: renamed from: y int
   private final int field_163;
   // $FF: renamed from: u0 float
   private final float field_164;
   // $FF: renamed from: u1 float
   private final float field_165;
   // $FF: renamed from: v0 float
   private final float field_166;
   // $FF: renamed from: v1 float
   private final float field_167;
   ...
   protected TextureAtlasSprite(TextureAtlas var1, TextureAtlasSprite.Info var2, int var3, int var4, int var5, int var6, int var7, NativeImage var8) {
      ...
      this.field_162 = var6;
      this.field_163 = var7;
      this.field_164 = (float)var6 / (float)var4;
      this.field_165 = (float)(var6 + this.width) / (float)var4;
      this.field_166 = (float)var7 / (float)var5;
      this.field_167 = (float)(var7 + this.height) / (float)var5;
   ...
   void upload(int var1, int var2, NativeImage[] var3) {
      for(int var4 = 0; var4 < this.mainImage.length; ++var4) {
         var3[var4].upload(var4, this.field_162 >> var4, this.field_163 >> var4, var1 >> var4, var2 >> var4, this.width >> var4, this.height >> var4, this.mainImage.length > 1, false);
      }
   ...
   public float getU(double var1) {
      float var3 = this.field_165 - this.field_164;
      return this.field_164 + var3 * (float)var1 / 16.0F;
   }

   public float getUOffset(float var1) {
      float var2 = this.field_165 - this.field_164;
      return (var1 - this.field_164) / var2 * 16.0F;
   }
   ...
   public float getV(double var1) {
      float var3 = this.field_167 - this.field_166;
      return this.field_166 + var3 * (float)var1 / 16.0F;
   }

   public float getVOffset(float var1) {
      float var2 = this.field_167 - this.field_166;
      return (var1 - this.field_166) / var2 * 16.0F;
   }
   ...
   public String toString() {
      ...
      return "TextureAtlasSprite{name='" + var10000 + "', frameCount=" + this.getFrameCount() + ", x=" + this.field_162 + ", y=" + this.field_163 + ", height=" + this.height + ", width=" + this.width + ", u0=" + this.field_164 + ", u1=" + this.field_165 + ", v0=" + this.field_166 + ", v1=" + this.field_167 + "}";
   }
   ...
   private float atlasSize() {
      float var1 = (float)this.width / (this.field_165 - this.field_164);
      float var2 = (float)this.height / (this.field_167 - this.field_166);
