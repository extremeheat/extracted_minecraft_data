...
public class LayeredColorMaskTexture extends AbstractTexture {
   ...
   public void func_110551_a(IResourceManager var1) throws IOException {
      ...
      BufferedImage var2;
      try {
         BufferedImage var3 = TextureUtil.func_177053_a(var1.func_110536_a(this.field_174948_g).func_110527_b());
         ...
         for(int var6 = 0; var6 < 17 && var6 < this.field_174949_h.size() && var6 < this.field_174950_i.size(); ++var6) {
            ...
            if (var7 != null) {
               InputStream var9 = var1.func_110536_a(new ResourceLocation(var7)).func_110527_b();
                  ...
                  for(int var11 = 0; var11 < var10.getHeight(); ++var11) {
                     for(int var12 = 0; var12 < var10.getWidth(); ++var12) {
                        ...
                        if ((var13 & -16777216) != 0) {
                           ...
                           int var16 = MathHelper.func_180188_d(var15, var8.field_76291_p) & 16777215;
