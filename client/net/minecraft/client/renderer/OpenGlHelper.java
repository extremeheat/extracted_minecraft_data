...
public class OpenGlHelper {
   ...
   public static void func_77474_a() {
      ...
      field_148825_d = var0.GL_EXT_texture_filter_anisotropic;
      field_148826_e = (int)(field_148825_d ? GL11.glGetFloat(34047) : 0.0F);
      field_153196_B = field_153196_B + "Anisotropic filtering is " + (field_148825_d ? "" : "not ") + "supported";
      if (field_148825_d) {
         field_153196_B = field_153196_B + " and maximum anisotropy is " + field_148826_e + ".\n";
      } else {
