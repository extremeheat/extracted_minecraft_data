...
public class ItemInHandRenderer {
   ...
   private void renderMapHand(PoseStack var1, MultiBufferSource var2, int var3, HumanoidArm var4) {
      ...
      var1.mulPose(Vector3f.field_292.rotationDegrees(92.0F));
      var1.mulPose(Vector3f.field_290.rotationDegrees(45.0F));
      var1.mulPose(Vector3f.field_294.rotationDegrees(var6 * -41.0F));
   ...
   private void renderOneHandedMap(PoseStack var1, MultiBufferSource var2, int var3, float var4, HumanoidArm var5, float var6, ItemStack var7) {
      ...
      if (!this.minecraft.player.isInvisible()) {
         var1.pushPose();
         var1.mulPose(Vector3f.field_294.rotationDegrees(var8 * 10.0F));
      ...
      var1.mulPose(Vector3f.field_290.rotationDegrees(var10 * -45.0F));
      var1.mulPose(Vector3f.field_292.rotationDegrees(var8 * var10 * -30.0F));
   ...
   private void renderTwoHandedMap(PoseStack var1, MultiBufferSource var2, int var3, float var4, float var5, float var6) {
      ...
      var1.mulPose(Vector3f.field_290.rotationDegrees(var10 * -85.0F));
      if (!this.minecraft.player.isInvisible()) {
         var1.pushPose();
      ...
      var1.mulPose(Vector3f.field_290.rotationDegrees(var11 * 20.0F));
   ...
   private void renderMap(PoseStack var1, MultiBufferSource var2, int var3, ItemStack var4) {
      var1.mulPose(Vector3f.field_292.rotationDegrees(180.0F));
      ...
      var7.vertex(var8, -7.0F, 135.0F, 0.0F).color(255, 255, 255, 255).method_7(0.0F, 1.0F).uv2(var3).endVertex();
      var7.vertex(var8, 135.0F, 135.0F, 0.0F).color(255, 255, 255, 255).method_7(1.0F, 1.0F).uv2(var3).endVertex();
      var7.vertex(var8, 135.0F, -7.0F, 0.0F).color(255, 255, 255, 255).method_7(1.0F, 0.0F).uv2(var3).endVertex();
      var7.vertex(var8, -7.0F, -7.0F, 0.0F).color(255, 255, 255, 255).method_7(0.0F, 0.0F).uv2(var3).endVertex();
      if (var6 != null) {
   ...
   private void renderPlayerArm(PoseStack var1, MultiBufferSource var2, int var3, float var4, float var5, HumanoidArm var6) {
      ...
      var1.mulPose(Vector3f.field_292.rotationDegrees(var8 * 45.0F));
      float var13 = Mth.sin(var5 * var5 * 3.1415927F);
      float var14 = Mth.sin(var9 * 3.1415927F);
      var1.mulPose(Vector3f.field_292.rotationDegrees(var8 * var14 * 70.0F));
      var1.mulPose(Vector3f.field_294.rotationDegrees(var8 * var13 * -20.0F));
      ...
      var1.mulPose(Vector3f.field_294.rotationDegrees(var8 * 120.0F));
      var1.mulPose(Vector3f.field_290.rotationDegrees(200.0F));
      var1.mulPose(Vector3f.field_292.rotationDegrees(var8 * -135.0F));
   ...
   private void applyEatTransform(PoseStack var1, float var2, HumanoidArm var3, ItemStack var4) {
      ...
      var1.mulPose(Vector3f.field_292.rotationDegrees((float)var8 * var7 * 90.0F));
      var1.mulPose(Vector3f.field_290.rotationDegrees(var7 * 10.0F));
      var1.mulPose(Vector3f.field_294.rotationDegrees((float)var8 * var7 * 30.0F));
   }
   ...
   private void applyItemArmAttackTransform(PoseStack var1, HumanoidArm var2, float var3) {
      ...
      var1.mulPose(Vector3f.field_292.rotationDegrees((float)var4 * (45.0F + var5 * -20.0F)));
      float var6 = Mth.sin(Mth.sqrt(var3) * 3.1415927F);
      var1.mulPose(Vector3f.field_294.rotationDegrees((float)var4 * var6 * -20.0F));
      var1.mulPose(Vector3f.field_290.rotationDegrees(var6 * -80.0F));
      var1.mulPose(Vector3f.field_292.rotationDegrees((float)var4 * -45.0F));
   }
   ...
   public void renderHandsWithItems(float var1, PoseStack var2, MultiBufferSource.BufferSource var3, LocalPlayer var4, int var5) {
      ...
      var2.mulPose(Vector3f.field_290.rotationDegrees((var4.getViewXRot(var1) - var10) * 0.1F));
      var2.mulPose(Vector3f.field_292.rotationDegrees((var4.getViewYRot(var1) - var11) * 0.1F));
      float var12;
      float var13;
   ...
   static ItemInHandRenderer.HandRenderSelection evaluateWhichHandsToRender(LocalPlayer var0) {
      ...
      boolean var3 = var1.method_87(Items.BOW) || var2.method_87(Items.BOW);
      boolean var4 = var1.method_87(Items.CROSSBOW) || var2.method_87(Items.CROSSBOW);
      if (!var3 && !var4) {
   ...
   private static ItemInHandRenderer.HandRenderSelection selectionUsingItemWhileHoldingBowLike(LocalPlayer var0) {
      ...
      if (!var1.method_87(Items.BOW) && !var1.method_87(Items.CROSSBOW)) {
   ...
   private static boolean isChargedCrossbow(ItemStack var0) {
      return var0.method_87(Items.CROSSBOW) && CrossbowItem.isCharged(var0);
   }
   ...
   private void renderArmWithItem(AbstractClientPlayer var1, float var2, float var3, InteractionHand var4, float var5, ItemStack var6, float var7, PoseStack var8, MultiBufferSource var9, int var10) {
      if (!var1.isScoping()) {
         ...
         if (var6.isEmpty()) {
         ...
         } else if (var6.method_87(Items.FILLED_MAP)) {
            ...
            float var18;
            float var19;
            if (var6.method_87(Items.CROSSBOW)) {
               ...
               if (var1.isUsingItem() && var1.getUseItemRemainingTicks() > 0 && var1.getUsedItemHand() == var4) {
                  ...
                  var8.mulPose(Vector3f.field_290.rotationDegrees(-11.935F));
                  var8.mulPose(Vector3f.field_292.rotationDegrees((float)var15 * 65.3F));
                  var8.mulPose(Vector3f.field_294.rotationDegrees((float)var15 * -9.785F));
                  ...
                  var8.mulPose(Vector3f.field_291.rotationDegrees((float)var15 * 45.0F));
               } else {
                  ...
                  if (var13 && var5 < 0.001F && var11) {
                     ...
                     var8.mulPose(Vector3f.field_292.rotationDegrees((float)var15 * 10.0F));
                  }
               }
               ...
               if (var1.isUsingItem() && var1.getUseItemRemainingTicks() > 0 && var1.getUsedItemHand() == var4) {
                  ...
                  case BOW:
                     ...
                     var8.mulPose(Vector3f.field_290.rotationDegrees(-13.935F));
                     var8.mulPose(Vector3f.field_292.rotationDegrees((float)var21 * 35.3F));
                     var8.mulPose(Vector3f.field_294.rotationDegrees((float)var21 * -9.785F));
                     ...
                     var8.mulPose(Vector3f.field_291.rotationDegrees((float)var21 * 45.0F));
                     break;
                  case SPEAR:
                     this.applyItemArmTransform(var8, var12, var7);
                     var8.translate((double)((float)var21 * -0.5F), 0.699999988079071D, 0.10000000149011612D);
                     var8.mulPose(Vector3f.field_290.rotationDegrees(-55.0F));
                     var8.mulPose(Vector3f.field_292.rotationDegrees((float)var21 * 35.3F));
                     var8.mulPose(Vector3f.field_294.rotationDegrees((float)var21 * -9.785F));
                     var23 = (float)var6.getUseDuration() - ((float)this.minecraft.player.getUseItemRemainingTicks() - var2 + 1.0F);
                     var16 = var23 / 10.0F;
                  ...
                  var8.mulPose(Vector3f.field_292.rotationDegrees((float)var21 * 65.0F));
                  var8.mulPose(Vector3f.field_294.rotationDegrees((float)var21 * -85.0F));
               } else {
