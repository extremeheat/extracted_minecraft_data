            ...
            if (var6.is(Items.CROSSBOW)) {
               ...
               if (var1.isUsingItem() && var1.getUseItemRemainingTicks() > 0 && var1.getUsedItemHand() == var4) {
                  ...
                  switch (var6.getUseAnimation()) {
                     ...
                     case BOW:
                        this.applyItemArmTransform(var8, var12, var7);
                        var8.translate((double)((float)var21 * -0.2785682F), 0.18344387412071228, 0.15731531381607056);
                     ...
                     case SPEAR:
                        this.applyItemArmTransform(var8, var12, var7);
                        var8.translate((double)((float)var21 * -0.5F), 0.699999988079071, 0.10000000149011612);
                        ...
                        var8.translate(0.0, 0.0, (double)(var16 * 0.2F));
                        var8.scale(1.0F, 1.0F, 1.0F + var16 * 0.2F);
                        var8.mulPose(Vector3f.YN.rotationDegrees((float)var21 * 45.0F));
                  }
                  ...
                  this.applyItemArmTransform(var8, var12, var7);
                  var21 = var13 ? 1 : -1;
                  var8.translate((double)((float)var21 * -0.4F), 0.800000011920929, 0.30000001192092896);
