   ...
   public void updateLightTexture(float var1) {
      if (this.updateLightTexture) {
         ...
         if (var3 != null) {
            ...
            float var6 = this.minecraft.options.darknessEffectScale().get().floatValue();
            ...
            float var15 = this.minecraft.options.gamma().get().floatValue();
            CompiledShaderProgram var16 = Objects.requireNonNull(RenderSystem.setShader(CoreShaders.LIGHTMAP), "Lightmap shader not loaded");
