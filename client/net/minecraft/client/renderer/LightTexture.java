   ...
   private float getDarknessGamma(float var1) {
      if (this.minecraft.player.hasEffect(MobEffects.DARKNESS)) {
         ...
         if (var2 != null && var2.getFactorData().isPresent()) {
            return ((MobEffectInstance.FactorData)var2.getFactorData().get()).getFactor(this.minecraft.player, var1);
         }
      }
   ...
   public void updateLightTexture(float var1) {
      if (this.updateLightTexture) {
         ...
         if (var2 != null) {
            ...
            float var5 = ((Double)this.minecraft.options.darknessEffectScale().get()).floatValue();
            ...
            Vector3f var10 = new Vector3f(var3, var3, 1.0F);
            var10.lerp(new Vector3f(1.0F, 1.0F, 1.0F), 0.35F);
            ...
            for(int var13 = 0; var13 < 16; ++var13) {
               for(int var14 = 0; var14 < 16; ++var14) {
                  ...
                  if (var20) {
                     ...
                     var12.clamp(0.0F, 1.0F);
                  } else {
                     Vector3f var21 = var10.copy();
                     var21.mul(var15);
                     var12.add(var21);
                     var12.lerp(new Vector3f(0.75F, 0.75F, 0.75F), 0.04F);
                     if (this.renderer.getDarkenWorldAmount(var1) > 0.0F) {
                        var22 = this.renderer.getDarkenWorldAmount(var1);
                        var23 = var12.copy();
                        var23.mul(0.7F, 0.6F, 0.6F);
                  ...
                  float var27;
                  if (var8 > 0.0F) {
                     var27 = Math.max(var12.x(), Math.max(var12.y(), var12.z()));
                     if (var27 < 1.0F) {
                        var22 = 1.0F / var27;
                        var23 = var12.copy();
                        var23.mul(var22);
                        var12.lerp(var23, var8);
                     }
                  }
                  ...
                  var27 = ((Double)this.minecraft.options.gamma().get()).floatValue();
                  Vector3f var28 = var12.copy();
                  var28.map(this::notGamma);
                  var12.lerp(var28, Math.max(0.0F, var27 - var6));
                  var12.lerp(new Vector3f(0.75F, 0.75F, 0.75F), 0.04F);
                  var12.clamp(0.0F, 1.0F);
                  var12.mul(255.0F);
                  boolean var29 = true;
                  ...
                  this.lightPixels.setPixelRGBA(var14, var13, -16777216 | var26 << 16 | var25 << 8 | var24);
               }
            }
