...
public class ScreenEffectRenderer {
   ...
   private static void renderTex(TextureAtlasSprite var0, PoseStack var1) {
      ...
      var2.vertex(var13, -1.0F, -1.0F, -0.5F).color(0.1F, 0.1F, 0.1F, 1.0F).method_7(var10, var12).endVertex();
      var2.vertex(var13, 1.0F, -1.0F, -0.5F).color(0.1F, 0.1F, 0.1F, 1.0F).method_7(var9, var12).endVertex();
      var2.vertex(var13, 1.0F, 1.0F, -0.5F).color(0.1F, 0.1F, 0.1F, 1.0F).method_7(var9, var11).endVertex();
      var2.vertex(var13, -1.0F, 1.0F, -0.5F).color(0.1F, 0.1F, 0.1F, 1.0F).method_7(var10, var11).endVertex();
      var2.end();
   ...
   private static void renderWater(Minecraft var0, PoseStack var1) {
      ...
      var2.vertex(var12, -1.0F, -1.0F, -0.5F).method_7(4.0F + var10, 4.0F + var11).endVertex();
      var2.vertex(var12, 1.0F, -1.0F, -0.5F).method_7(0.0F + var10, 4.0F + var11).endVertex();
      var2.vertex(var12, 1.0F, 1.0F, -0.5F).method_7(0.0F + var10, 0.0F + var11).endVertex();
      var2.vertex(var12, -1.0F, 1.0F, -0.5F).method_7(4.0F + var10, 0.0F + var11).endVertex();
      var2.end();
      BufferUploader.end(var2);
   ...
   private static void renderFire(Minecraft var0, PoseStack var1) {
      ...
      for(int var16 = 0; var16 < 2; ++var16) {
         ...
         var1.mulPose(Vector3f.field_292.rotationDegrees((float)(var16 * 2 - 1) * 10.0F));
         Matrix4f var22 = var1.last().pose();
         var2.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_COLOR_TEX);
         var2.vertex(var22, -0.5F, -0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).method_7(var12, var14).endVertex();
         var2.vertex(var22, 0.5F, -0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).method_7(var11, var14).endVertex();
         var2.vertex(var22, 0.5F, 0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).method_7(var11, var13).endVertex();
         var2.vertex(var22, -0.5F, 0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).method_7(var12, var13).endVertex();
         var2.end();
         BufferUploader.end(var2);
         var1.popPose();
      }
