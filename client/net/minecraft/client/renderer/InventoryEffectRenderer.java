...
public abstract class InventoryEffectRenderer extends GuiContainer {
   ...
   private void func_147044_g() {
      ...
      if (!var4.isEmpty()) {
         ...
         for(Iterator var6 = Ordering.natural().sortedCopy(var4).iterator(); var6.hasNext(); var2 += var5) {
            PotionEffect var7 = (PotionEffect)var6.next();
            Potion var8 = var7.func_188419_a();
            GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            if (var8.func_76400_d()) {
               ...
               this.func_73729_b(var1 + 6, var2 + 7, var9 % 12 * 18, 198 + var9 / 12 * 18, 18, 18);
            }
            ...
            String var10 = PotionUtil.func_188410_a(var7, 1.0F);
