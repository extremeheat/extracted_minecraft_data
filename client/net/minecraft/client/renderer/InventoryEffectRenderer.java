...
public abstract class InventoryEffectRenderer extends GuiContainer {
   ...
   private void func_147044_g() {
      ...
      if (!var4.isEmpty()) {
         ...
         for(PotionEffect var7 : this.field_146297_k.field_71439_g.func_70651_bq()) {
            ...
            this.field_146289_q.func_78261_a(var11, var1 + 10 + 18, var2 + 6, 16777215);
            String var10 = Potion.func_76389_a(var7);
            this.field_146289_q.func_78261_a(var10, var1 + 10 + 18, var2 + 6 + 10, 8355711);
            var2 += var5;
         }
      }
   }
