...
public class ViewArea {
         ...
         for(int var3 = 0; var3 < this.sectionGridSizeX; ++var3) {
            for(int var4 = 0; var4 < this.sectionGridSizeY; ++var4) {
               for(int var5 = 0; var5 < this.sectionGridSizeZ; ++var5) {
                  ...
                  var10000[var6] = var1.new RenderSection(var6, SectionPos.asLong(var3, var4 + this.level.getMinSectionY(), var5));
               }
            }
         }
   ...
   private boolean containsSection(int var1, int var2, int var3) {
      if (var2 >= this.level.getMinSectionY() && var2 <= this.level.getMaxSectionY()) {
         if (var1 >= this.cameraSectionPos.x() - this.viewDistance && var1 <= this.cameraSectionPos.x() + this.viewDistance) {
            return var3 >= this.cameraSectionPos.z() - this.viewDistance && var3 <= this.cameraSectionPos.z() + this.viewDistance;
         } else {
            return false;
         }
      } else {
