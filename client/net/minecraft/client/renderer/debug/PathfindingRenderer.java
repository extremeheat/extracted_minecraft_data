...
public class PathfindingRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private static void doRenderPath(Path var0, float var1, boolean var2, boolean var3, double var4, double var6, double var8) {
      ...
      if (distanceToCamera(var10, var4, var6, var8) <= 80.0F) {
         DebugRenderer.renderFilledBox((new AABB((double)((float)var10.getX() + 0.25F), (double)((float)var10.getY() + 0.25F), (double)var10.getZ() + 0.25, (double)((float)var10.getX() + 0.75F), (double)((float)var10.getY() + 0.75F), (double)((float)var10.getZ() + 0.75F))).move(-var4, -var6, -var8), 0.0F, 1.0F, 0.0F, 0.5F);
      ...
      if (var2) {
         ...
         for(var17 = 0; var17 < var16; ++var17) {
            ...
            if (distanceToCamera(var18.asBlockPos(), var4, var6, var8) <= 80.0F) {
               DebugRenderer.renderFilledBox((new AABB((double)((float)var18.x + 0.5F - var1 / 2.0F), (double)((float)var18.y + 0.01F), (double)((float)var18.z + 0.5F - var1 / 2.0F), (double)((float)var18.x + 0.5F + var1 / 2.0F), (double)var18.y + 0.1, (double)((float)var18.z + 0.5F + var1 / 2.0F))).move(-var4, -var6, -var8), 1.0F, 0.8F, 0.8F, 0.5F);
            }
         }
         ...
         for(var17 = 0; var17 < var16; ++var17) {
            var18 = var15[var17];
            if (distanceToCamera(var18.asBlockPos(), var4, var6, var8) <= 80.0F) {
               DebugRenderer.renderFilledBox((new AABB((double)((float)var18.x + 0.5F - var1 / 2.0F), (double)((float)var18.y + 0.01F), (double)((float)var18.z + 0.5F - var1 / 2.0F), (double)((float)var18.x + 0.5F + var1 / 2.0F), (double)var18.y + 0.1, (double)((float)var18.z + 0.5F + var1 / 2.0F))).move(-var4, -var6, -var8), 0.8F, 1.0F, 1.0F, 0.5F);
            }
         }
      }
      ...
      if (var3) {
         for(var11 = 0; var11 < var0.getNodeCount(); ++var11) {
            var12 = var0.getNode(var11);
            if (distanceToCamera(var12.asBlockPos(), var4, var6, var8) <= 80.0F) {
               DebugRenderer.renderFloatingText(String.format("%s", var12.type), (double)var12.x + 0.5, (double)var12.y + 0.75, (double)var12.z + 0.5, -1, 0.02F, true, 0.0F, true);
               DebugRenderer.renderFloatingText(String.format(Locale.ROOT, "%.2f", var12.costMalus), (double)var12.x + 0.5, (double)var12.y + 0.25, (double)var12.z + 0.5, -1, 0.02F, true, 0.0F, true);
            }
         }
      }
