...
public class GoalSelectorDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void addGoalSelector(int var1, List<DebugGoal> var2) {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      this.goalSelectors.forEach((var1x, var2x) -> {
         for(int var3 = 0; var3 < var2x.size(); ++var3) {
            DebugGoal var4 = (DebugGoal)var2x.get(var3);
            if (var10.closerThan(var4.pos, 160.0)) {
               double var5 = (double)var4.pos.getX() + 0.5;
               double var7 = (double)var4.pos.getY() + 2.0 + (double)var3 * 0.25;
               double var9 = (double)var4.pos.getZ() + 0.5;
