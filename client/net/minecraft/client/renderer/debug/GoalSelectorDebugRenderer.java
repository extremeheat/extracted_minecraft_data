...
public class GoalSelectorDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7, DebugValueAccess var9) {
      ...
      BlockPos var11 = BlockPos.containing(var10.getPosition().x, 0.0, var10.getPosition().z);
      var9.forEachEntity(DebugSubscriptions.GOAL_SELECTORS, (var3x, var4) -> {
         if (var11.closerThan(var3x.blockPosition(), 160.0)) {
            for(int var5 = 0; var5 < var4.goals().size(); ++var5) {
               ...
               double var11x = (double)var3x.getBlockZ() + 0.5;
               int var13 = var6.isRunning() ? -16711936 : -3355444;
               DebugRenderer.renderFloatingText(var1, var2, var6.name(), var7, var9, var11x, var13);
            }
         }
