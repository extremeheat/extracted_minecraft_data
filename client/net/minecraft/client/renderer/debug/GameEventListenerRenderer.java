...
public class GameEventListenerRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7, DebugValueAccess var9) {
      ...
      this.forEachListener(var9, (var8, var9x) -> {
         double var10x = (double)var9x * 2.0;
         DebugRenderer.renderVoxelShape(var1, var10, Shapes.create(AABB.ofSize(var8, var10x, var10x, var10x)), -var3, -var5, -var7, 1.0F, 1.0F, 0.0F, 0.35F, true);
      });
      VertexConsumer var11 = var2.getBuffer(RenderType.debugFilledBox());
      this.forEachListener(var9, (var8, var9x) -> ShapeRenderer.addChainedFilledBoxVertices(var1, var11, var8.x() - 0.25 - var3, var8.y() - var5, var8.z() - 0.25 - var7, var8.x() + 0.25 - var3, var8.y() - var5 + 1.0, var8.z() + 0.25 - var7, 1.0F, 1.0F, 0.0F, 0.35F));
