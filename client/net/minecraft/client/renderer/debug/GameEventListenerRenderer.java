...
public class GameEventListenerRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      if (var9 == null) {
         ...
         TrackedListener var15;
         while(var14.hasNext()) {
            var15 = (TrackedListener)var14.next();
            var15.getPosition(var9).ifPresent((var7x) -> {
               Vector3f var8 = new Vector3f(1.0F, 1.0F, 0.0F);
               LevelRenderer.addChainedFilledBoxVertices(var32, var7x.x() - 0.25 - var3, var7x.y() - var5, var7x.z() - 0.25 - var7, var7x.x() + 0.25 - var3, var7x.y() - var5 + 1.0, var7x.z() + 0.25 - var7, var8.x(), var8.y(), var8.z(), 0.35F);
            });
         }
         ...
         while(var14.hasNext()) {
            TrackedGameEvent var33 = (TrackedGameEvent)var14.next();
            ...
            DebugRenderer.renderFloatingText(var33.gameEvent.getName(), var16.x, var16.y + 0.8500000238418579, var16.z, -7564911, 0.0075F);
         }
