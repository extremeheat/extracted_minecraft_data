         ...
         for (BoundingBox var14 : this.postMainBoxes.get(var10).values()) {
            if (var11.closerThan(var14.getCenter(), 500.0)) {
               LevelRenderer.renderLineBox(
                  ...
                  (double)var14.minY() - var5,
                  (double)var14.minZ() - var7,
                  (double)(var14.maxX() + 1) - var3,
                  (double)(var14.maxY() + 1) - var5,
                  (double)(var14.maxZ() + 1) - var7,
                  1.0F,
                  1.0F,
                  1.0F,
                  1.0F,
            ...
            if (var11.closerThan(var16.getCenter(), 500.0)) {
               if (var15.isStart()) {
                  LevelRenderer.renderLineBox(
                     ...
                     (double)var16.minY() - var5,
                     (double)var16.minZ() - var7,
                     (double)(var16.maxX() + 1) - var3,
                     (double)(var16.maxY() + 1) - var5,
                     (double)(var16.maxZ() + 1) - var7,
                     0.0F,
                     1.0F,
                     0.0F,
                     1.0F,
