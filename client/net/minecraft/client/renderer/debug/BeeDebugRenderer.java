...
public class BeeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void addOrUpdateHiveInfo(HiveInfo var1) {
      this.hives.put(var1.pos, var1);
   }

   public void addOrUpdateBeeInfo(BeeInfo var1) {
   ...
   private void clearRemovedBees() {
      this.beeInfosPerEntity.entrySet().removeIf((var1) -> {
         return this.minecraft.level.getEntity(((BeeInfo)var1.getValue()).id) == null;
      });
   }
   ...
   private void clearRemovedHives() {
      ...
      this.hives.entrySet().removeIf((var2) -> {
         return ((HiveInfo)var2.getValue()).lastSeen < var1;
      });
   }
   ...
   private void renderFlowerInfos() {
      HashMap var1 = Maps.newHashMap();
      this.beeInfosPerEntity.values().stream().filter(BeeInfo::hasFlower).forEach((var1x) -> {
      ...
      var1.entrySet().forEach((var0) -> {
         ...
         int var4 = 1;
         renderTextOverPos(var3.toString(), var1, var4++, -256);
         renderTextOverPos("Flower", var1, var4++, -1);
         float var5 = 0.05F;
   ...
   private void renderHiveInfo(HiveInfo var1, Collection<UUID> var2) {
      int var3 = 0;
      if (!var2.isEmpty()) {
   ...
   private void renderPath(BeeInfo var1) {
      if (var1.path != null) {
   ...
   private void renderBeeInfo(BeeInfo var1) {
      ...
      if (var1.travelTicks > 0) {
         int var6 = var1.travelTicks < 600 ? -3355444 : -23296;
         renderTextOverMob(var1.pos, var3++, "Travelling: " + var1.travelTicks + " ticks", var6, 0.02F);
      }

   }

   private static void renderTextOverHive(String var0, HiveInfo var1, int var2, int var3) {
   ...
   private boolean isBeeSelected(BeeInfo var1) {
      return Objects.equals(this.lastLookedAtUuid, var1.uuid);
   }

   private boolean isPlayerCloseEnoughToMob(BeeInfo var1) {
   ...
   private Map<BlockPos, List<String>> getGhostHives() {
      ...
      while(var2.hasNext()) {
         BeeInfo var3 = (BeeInfo)var2.next();
