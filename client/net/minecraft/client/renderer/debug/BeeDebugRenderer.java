...
public class BeeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private void clearRemovedBees() {
      this.beeInfosPerEntity.entrySet().removeIf((var1) -> {
         return this.minecraft.level.getEntity(((BeeDebugRenderer.BeeInfo)var1.getValue()).field_151) == null;
      });
   }
   ...
   private void renderPath(BeeDebugRenderer.BeeInfo var1) {
      if (var1.path != null) {
         PathfindingRenderer.renderPath(var1.path, 0.5F, false, false, this.getCamera().getPosition().method_2(), this.getCamera().getPosition().method_3(), this.getCamera().getPosition().method_4());
      }
   ...
   private static void renderTextOverMob(Position var0, int var1, String var2, int var3, float var4) {
      ...
      double var12 = var0.method_3() + 2.4D + (double)var1 * 0.25D;
   ...
   private String getPosDescription(BeeDebugRenderer.BeeInfo var1, BlockPos var2) {
      double var3 = Math.sqrt(var2.distSqr(var1.pos.method_2(), var1.pos.method_3(), var1.pos.method_4(), true));
   ...
   private boolean isPlayerCloseEnoughToMob(BeeDebugRenderer.BeeInfo var1) {
      ...
      BlockPos var3 = new BlockPos(var2.getX(), var1.pos.method_3(), var2.getZ());
