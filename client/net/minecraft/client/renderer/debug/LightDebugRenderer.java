...
public class LightDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      while(var12.hasNext()) {
         ...
         if (var11.add(var17)) {
            DebugRenderer.renderFloatingText(var9.getChunkSource().getLightEngine().getDebugData(LightLayer.SKY, SectionPos.method_74(var17)), (double)SectionPos.sectionToBlockCoord(SectionPos.method_75(var17), 8), (double)SectionPos.sectionToBlockCoord(SectionPos.method_76(var17), 8), (double)SectionPos.sectionToBlockCoord(SectionPos.method_77(var17), 8), 16711680, 0.3F);
         }
