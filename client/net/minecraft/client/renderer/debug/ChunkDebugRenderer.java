...
public class ChunkDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      if (this.data != null) {
         ...
         double var12 = this.minecraft.gameRenderer.getMainCamera().getPosition().field_415 * 0.85D;
         ...
         while(var14.hasNext()) {
            ...
            for(int var22 = 0; var22 < var21; ++var22) {
               ...
               DebugRenderer.renderFloatingText(var23, (double)SectionPos.sectionToBlockCoord(var16.field_504, 8), var12 + (double)var19, (double)SectionPos.sectionToBlockCoord(var16.field_505, 8), -1, 0.15F);
               var19 -= 2;
            }
         }
