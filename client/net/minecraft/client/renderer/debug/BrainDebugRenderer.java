...
public class BrainDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void addOrUpdateBrainDump(BrainDump var1) {
   ...
   private void clearRemovedEntities() {
      this.brainDumpsPerEntity.entrySet().removeIf((var1) -> {
         Entity var2 = this.minecraft.level.getEntity(((BrainDump)var1.getValue()).id);
   ...
   private void renderPoiInfo(PoiInfo var1) {
      int var2 = 0;
   ...
   private void renderPath(BrainDump var1, double var2, double var4, double var6) {
      if (var1.path != null) {
   ...
   private void renderBrainInfo(BrainDump var1, double var2, double var4, double var6) {
      ...
      Iterator var12;
      if (var8) {
         for(var12 = var1.behaviors.iterator(); var12.hasNext(); ++var9) {
      ...
      if (var8) {
         for(var12 = var1.activities.iterator(); var12.hasNext(); ++var9) {
            var11 = (String)var12.next();
            renderTextOverMob(var1.pos, var9, var11, -16711936, 0.02F);
         }
      }
      ...
      if (var8) {
         for(var12 = var1.gossips.iterator(); var12.hasNext(); ++var9) {
            var11 = (String)var12.next();
            if (var11.startsWith(var1.name)) {
               renderTextOverMob(var1.pos, var9, var11, -1, 0.02F);
            } else {
               renderTextOverMob(var1.pos, var9, var11, -23296, 0.02F);
            }
         }
      }

      if (var8) {
         for(var12 = Lists.reverse(var1.memories).iterator(); var12.hasNext(); ++var9) {
            var11 = (String)var12.next();
            renderTextOverMob(var1.pos, var9, var11, -3355444, 0.02F);
         }
      }
   ...
   private static void renderTextOverPoi(String var0, PoiInfo var1, int var2, int var3) {
   ...
   private boolean isMobSelected(BrainDump var1) {
      return Objects.equals(this.lastLookedAtUuid, var1.uuid);
   }

   private boolean isPlayerCloseEnoughToMob(BrainDump var1) {
   ...
   private Map<BlockPos, List<String>> getGhostPois() {
      ...
      while(var2.hasNext()) {
         BrainDump var3 = (BrainDump)var2.next();
