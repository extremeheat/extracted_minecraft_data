...
public class BrainDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private void clearRemovedEntities() {
      this.brainDumpsPerEntity.entrySet().removeIf((var1) -> {
         Entity var2 = this.minecraft.level.getEntity(((BrainDebugRenderer.BrainDump)var1.getValue()).field_428);
   ...
   private void renderBrainInfo(BrainDebugRenderer.BrainDump var1, double var2, double var4, double var6) {
      ...
      int var12 = var9 + 1;
      if (var8) {
         renderTextOverMob(var1.pos, var12, var1.profession + " " + var1.field_429 + " xp", -1, 0.02F);
         ++var12;
      }
   ...
   public static class BrainDump {
      ...
      public final int field_428;
      public final String name;
      public final String profession;
      // $FF: renamed from: xp int
      public final int field_429;
