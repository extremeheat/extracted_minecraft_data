...
public class ChunkBorderRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      for(var21 = 2; var21 < 16; var21 += 2) {
         ...
         var11.vertex(var17 + (double)var21, var12, var19 + 16.0D).color(var22).endVertex();
         var11.vertex(var17 + (double)var21, var14, var19 + 16.0D).color(var22).endVertex();
      ...
      for(var21 = 2; var21 < 16; var21 += 2) {
         ...
         var11.vertex(var17 + 16.0D, var12, var19 + (double)var21).color(var22).endVertex();
         var11.vertex(var17 + 16.0D, var14, var19 + (double)var21).color(var22).endVertex();
      ...
      for(var21 = this.minecraft.level.getMinBuildHeight(); var21 <= this.minecraft.level.getMaxBuildHeight(); var21 += 2) {
         ...
         var11.vertex(var17, var25, var19 + 16.0D).color(var24).endVertex();
         var11.vertex(var17 + 16.0D, var25, var19 + 16.0D).color(var24).endVertex();
         var11.vertex(var17 + 16.0D, var25, var19).color(var24).endVertex();
         var11.vertex(var17, var25, var19).color(var24).endVertex();
         var11.vertex(var17, var25, var19).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
      }
      ...
      for(var21 = this.minecraft.level.getMinBuildHeight(); var21 <= this.minecraft.level.getMaxBuildHeight(); var21 += 16) {
         ...
         var11.vertex(var17, var25, var19 + 16.0D).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var11.vertex(var17 + 16.0D, var25, var19 + 16.0D).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var11.vertex(var17 + 16.0D, var25, var19).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var11.vertex(var17, var25, var19).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var11.vertex(var17, var25, var19).color(0.25F, 0.25F, 1.0F, 0.0F).endVertex();
      }
