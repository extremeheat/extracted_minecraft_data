...
public class WaterDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      while(var11.hasNext()) {
         ...
         var13 = var10.getFluidState(var12);
         if (var13.is(FluidTags.WATER)) {
            DebugRenderer.renderFloatingText(String.valueOf(var13.getAmount()), (double)var12.getX() + 0.5, (double)((float)var12.getY() + var13.getHeight(var10, var12)), (double)var12.getZ() + 0.5, -16777216);
         }
      }
