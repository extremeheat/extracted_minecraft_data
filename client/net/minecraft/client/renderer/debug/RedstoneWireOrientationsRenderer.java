...
public class RedstoneWireOrientationsRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7, DebugValueAccess var9) {
      ...
      var9.forEachBlock(DebugSubscriptions.REDSTONE_WIRE_ORIENTATIONS, (var8, var9x) -> {
         Vector3f var10x = var8.getBottomCenter().subtract(var3, var5 - 0.1, var7).toVector3f();
         ShapeRenderer.renderVector(var1, var10, var10x, var9x.getFront().getUnitVec3().scale(0.5), -16776961);
         ShapeRenderer.renderVector(var1, var10, var10x, var9x.getUp().getUnitVec3().scale(0.4), -65536);
         ShapeRenderer.renderVector(var1, var10, var10x, var9x.getSide().getUnitVec3().scale(0.3), -256);
      });
   }
}
