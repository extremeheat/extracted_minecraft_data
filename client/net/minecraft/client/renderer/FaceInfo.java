...
public enum FaceInfo {
   ...
   private static final FaceInfo[] BY_FACING = (FaceInfo[])Util.make(new FaceInfo[6], (var0) -> {
      ...
      var0[FaceInfo.Constants.MAX_Y] = field_271;
   ...
   private static FaceInfo[] $values() {
      return new FaceInfo[]{DOWN, field_271, NORTH, SOUTH, WEST, EAST};
   }
   ...
   public static final class Constants {
      ...
      static {
         ...
         MAX_Y = Direction.field_526.get3DDataValue();
