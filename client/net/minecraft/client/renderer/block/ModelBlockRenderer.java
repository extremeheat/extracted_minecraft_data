...
public class ModelBlockRenderer {
   ...
   public boolean tesselateBlock(BlockAndTintGetter var1, BakedModel var2, BlockState var3, BlockPos var4, PoseStack var5, VertexConsumer var6, boolean var7, Random var8, long var9, int var11) {
      ...
      var5.translate(var13.field_414, var13.field_415, var13.field_416);
   ...
   private void calculateShape(BlockAndTintGetter var1, BlockState var2, BlockPos var3, int[] var4, Direction var5, @Nullable float[] var6, BitSet var7) {
      ...
      if (var6 != null) {
         ...
         var6[Direction.field_526.get3DDataValue()] = var12;
         ...
         var6[Direction.field_526.get3DDataValue() + var14] = 1.0F - var12;
   ...
   protected static enum AdjacencyInfo {
      ...
      private static final ModelBlockRenderer.AdjacencyInfo[] BY_FACING = (ModelBlockRenderer.AdjacencyInfo[])Util.make(new ModelBlockRenderer.AdjacencyInfo[6], (var0) -> {
         ...
         var0[Direction.field_526.get3DDataValue()] = field_210;
      ...
      private static ModelBlockRenderer.AdjacencyInfo[] $values() {
         return new ModelBlockRenderer.AdjacencyInfo[]{DOWN, field_210, NORTH, SOUTH, WEST, EAST};
      }
   }
   ...
   protected static enum SizeInfo {
      ...
      field_506(Direction.field_526, false),
      NORTH(Direction.NORTH, false),
      SOUTH(Direction.SOUTH, false),
      WEST(Direction.WEST, false),
      EAST(Direction.EAST, false),
      FLIP_DOWN(Direction.DOWN, true),
      FLIP_UP(Direction.field_526, true),
      ...
      private static ModelBlockRenderer.SizeInfo[] $values() {
         return new ModelBlockRenderer.SizeInfo[]{DOWN, field_506, NORTH, SOUTH, WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST};
      }
   }
   ...
   private static enum AmbientVertexRemap {
      ...
      private static final ModelBlockRenderer.AmbientVertexRemap[] BY_FACING = (ModelBlockRenderer.AmbientVertexRemap[])Util.make(new ModelBlockRenderer.AmbientVertexRemap[6], (var0) -> {
         var0[Direction.DOWN.get3DDataValue()] = DOWN;
         var0[Direction.field_526.get3DDataValue()] = field_355;
         var0[Direction.NORTH.get3DDataValue()] = NORTH;
         var0[Direction.SOUTH.get3DDataValue()] = SOUTH;
         var0[Direction.WEST.get3DDataValue()] = WEST;
         var0[Direction.EAST.get3DDataValue()] = EAST;
      ...
      private static ModelBlockRenderer.AmbientVertexRemap[] $values() {
         return new ModelBlockRenderer.AmbientVertexRemap[]{DOWN, field_355, NORTH, SOUTH, WEST, EAST};
      }
   }
}
