...
public class BlockElement {
   ...
   // $FF: renamed from: to com.mojang.math.Vector3f
   public final Vector3f field_315;
   ...
   private void fillUvs() {
      ...
      while(var1.hasNext()) {
         ...
         ((BlockElementFace)var2.getValue()).field_245.setMissingUv(var3);
      }
   ...
   private float[] uvsByFace(Direction var1) {
      switch(var1) {
      case DOWN:
         return new float[]{this.from.method_82(), 16.0F - this.field_315.method_84(), this.field_315.method_82(), 16.0F - this.from.method_84()};
      case field_526:
         return new float[]{this.from.method_82(), this.from.method_84(), this.field_315.method_82(), this.field_315.method_84()};
      case NORTH:
      default:
         return new float[]{16.0F - this.field_315.method_82(), 16.0F - this.field_315.method_83(), 16.0F - this.from.method_82(), 16.0F - this.from.method_83()};
      case SOUTH:
         return new float[]{this.from.method_82(), 16.0F - this.field_315.method_83(), this.field_315.method_82(), 16.0F - this.from.method_83()};
      case WEST:
         return new float[]{this.from.method_84(), 16.0F - this.field_315.method_83(), this.field_315.method_84(), 16.0F - this.from.method_83()};
      case EAST:
         return new float[]{16.0F - this.field_315.method_84(), 16.0F - this.field_315.method_83(), 16.0F - this.from.method_84(), 16.0F - this.from.method_83()};
      }
   }
   ...
   protected static class Deserializer implements JsonDeserializer<BlockElement> {
      ...
      private Vector3f getTo(JsonObject var1) {
         ...
         if (!(var2.method_82() < -16.0F) && !(var2.method_83() < -16.0F) && !(var2.method_84() < -16.0F) && !(var2.method_82() > 32.0F) && !(var2.method_83() > 32.0F) && !(var2.method_84() > 32.0F)) {
            return var2;
         } else {
