...
public class ItemTransforms {
   ...
   public static enum TransformType {
      ...
      private static ItemTransforms.TransformType[] $values() {
         return new ItemTransforms.TransformType[]{NONE, THIRD_PERSON_LEFT_HAND, THIRD_PERSON_RIGHT_HAND, FIRST_PERSON_LEFT_HAND, FIRST_PERSON_RIGHT_HAND, HEAD, GUI, GROUND, FIXED};
      }
   }
