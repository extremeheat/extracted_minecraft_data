...
public class ItemModelGenerator {
      ...
      var1.getUniqueFrames().forEach((var5) -> {
         for(int var6 = 0; var6 < var3; ++var6) {
            for(int var7 = 0; var7 < var2; ++var7) {
               ...
               this.checkTransition(ItemModelGenerator.SpanFacing.field_219, var4, var1, var5, var7, var6, var2, var3, var8);
   ...
   private static enum SpanFacing {
      // $FF: renamed from: UP net.minecraft.client.renderer.block.model.ItemModelGenerator$SpanFacing
      field_219(Direction.field_526, 0, -1),
      ...
      boolean isHorizontal() {
         return this == DOWN || this == field_219;
      }

      // $FF: synthetic method
      private static ItemModelGenerator.SpanFacing[] $values() {
         return new ItemModelGenerator.SpanFacing[]{field_219, DOWN, LEFT, RIGHT};
      }
   }
}
