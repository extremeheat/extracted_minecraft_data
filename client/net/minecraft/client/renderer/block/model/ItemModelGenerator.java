...
public class ItemModelGenerator {
   ...
   private List<Span> getSpans(TextureAtlasSprite var1) {
   ...
   private void checkTransition(SpanFacing var1, List<Span> var2, TextureAtlasSprite var3, int var4, int var5, int var6, int var7, int var8, boolean var9) {
