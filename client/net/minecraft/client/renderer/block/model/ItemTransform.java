...
public class ItemTransform {
   ...
   public void apply(boolean var1, PoseStack var2) {
      if (this != NO_TRANSFORM) {
         float var3 = this.rotation.method_82();
         float var4 = this.rotation.method_83();
         float var5 = this.rotation.method_84();
         if (var1) {
            var4 = -var4;
            var5 = -var5;
         }
         ...
         int var6 = var1 ? -1 : 1;
         var2.translate((double)((float)var6 * this.translation.method_82()), (double)this.translation.method_83(), (double)this.translation.method_84());
         var2.mulPose(new Quaternion(var3, var4, var5, true));
         var2.scale(this.scale.method_82(), this.scale.method_83(), this.scale.method_84());
      }
   }
