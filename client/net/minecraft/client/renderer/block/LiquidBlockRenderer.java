      ...
      if (var24 || var25 || var29 || var28 || var26 || var27) {
         ...
         if (var24 && !isFaceOccludedByNeighbor(var1, var2, Direction.UP, Math.min(Math.min(var36, var38), Math.min(var37, var35)), var14)) {
            ...
            if (var56.x == 0.0 && var56.z == 0.0) {
               var57 = var7[0];
               var48 = var57.getU(0.0);
               var52 = var57.getV(0.0);
               var49 = var48;
               var53 = var57.getV(16.0);
               var50 = var57.getU(16.0);
               var54 = var53;
               var51 = var50;
               var55 = var52;
            } else {
            ...
            var59 = (float)var7[0].getWidth() / (var7[0].getU1() - var7[0].getU0());
            var60 = (float)var7[0].getHeight() / (var7[0].getV1() - var7[0].getV0());
            var61 = 4.0F / Math.max(var60, var59);
            var48 = Mth.lerp(var61, var48, var81);
            var49 = Mth.lerp(var61, var49, var81);
            var50 = Mth.lerp(var61, var50, var81);
            var51 = Mth.lerp(var61, var51, var81);
            var52 = Mth.lerp(var61, var52, var58);
            var53 = Mth.lerp(var61, var53, var58);
            var54 = Mth.lerp(var61, var54, var58);
            var55 = Mth.lerp(var61, var55, var58);
         ...
         while(true) {
            ...
            BlockPos var85 = var2.relative(var77);
            TextureAtlasSprite var86 = var7[1];
            if (!var6) {
               Block var87 = var1.getBlockState(var85).getBlock();
               if (var87 instanceof HalfTransparentBlock || var87 instanceof LeavesBlock) {
                  var86 = this.waterOverlay;
               }
            }

            var64 = var86.getU(0.0);
            var65 = var86.getU(8.0);
            float var66 = var86.getV((double)((1.0F - var51) * 16.0F * 0.5F));
            float var67 = var86.getV((double)((1.0F - var52) * 16.0F * 0.5F));
            float var68 = var86.getV(8.0);
            ...
            this.vertex(var3, var79, var74 + (double)var51, var80, var70, var71, var72, var64, var66, var75);
            ...
            this.vertex(var3, var79, var74 + (double)var47, var80, var70, var71, var72, var64, var68, var75);
            if (var86 != this.waterOverlay) {
               this.vertex(var3, var79, var74 + (double)var47, var80, var70, var71, var72, var64, var68, var75);
               this.vertex(var3, var82, var74 + (double)var47, var83, var70, var71, var72, var65, var68, var75);
               this.vertex(var3, var82, var74 + (double)var52, var83, var70, var71, var72, var65, var67, var75);
               this.vertex(var3, var79, var74 + (double)var51, var80, var70, var71, var72, var64, var66, var75);
