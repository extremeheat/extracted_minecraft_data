...
public class GlobalSettingsUniform implements AutoCloseable {
   public static final int UBO_SIZE = 20;
   private final GpuBuffer buffer = RenderSystem.getDevice().createBuffer(() -> "Global Settings UBO", 136, 20);
   ...
   public void update(int var1, int var2, double var3, long var5, DeltaTracker var7, int var8) {
      ...
      try {
         ByteBuffer var10 = Std140Builder.onStack(var9, 20).putVec2((float)var1, (float)var2).putFloat((float)var3).putFloat(((float)(var5 % 24000L) + var7.getGameTimeDeltaPartialTick(false)) / 24000.0F).putInt(var8).get();
