...
public class BufferBuilder {
   ...
   private void func_181670_b(int var1) {
      if (this.field_178997_d * this.field_179011_q.func_177338_f() + var1 > this.field_179001_a.capacity()) {
         int var2 = this.field_179001_a.capacity();
         int var3 = var2 + MathHelper.func_154354_b(var1, 2097152);
         field_187316_a.debug("Needed to grow BufferBuilder buffer: Old size {} bytes, new size {} bytes.", var2, var3);
         int var4 = this.field_178999_b.position();
         ByteBuffer var5 = GLAllocation.func_74524_c(var3);
         this.field_179001_a.position(0);
         var5.put(this.field_179001_a);
         var5.rewind();
         this.field_179001_a = var5;
         this.field_179000_c = this.field_179001_a.asFloatBuffer().asReadOnlyBuffer();
         this.field_178999_b = this.field_179001_a.asIntBuffer();
         this.field_178999_b.position(var4);
         this.field_181676_c = this.field_179001_a.asShortBuffer();
         this.field_181676_c.position(var4 << 1);
      }
   }
   ...
   public BufferBuilder.State func_181672_a() {
      ...
      return new BufferBuilder.State(var2, new VertexFormat(this.field_179011_q));
   }
   ...
   public void func_178993_a(BufferBuilder.State var1) {
      ...
      this.func_181670_b(var1.func_179013_a().length * 4);
   ...
   private void func_192836_a(int var1, int var2) {
      ...
      int var5 = var1 >> 8 & 255;
      int var6 = var1 & 255;
      this.func_178972_a(var3, var4, var5, var6);
   }
   ...
   public void func_178994_b(float var1, float var2, float var3, int var4) {
      ...
      this.func_178972_a(var5, var6, var7, var8);
   }

   private void func_178972_a(int var1, int var2, int var3, int var4) {
      if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
         this.field_178999_b.put(var1, -16777216 | var4 << 16 | var3 << 8 | var2);
      } else {
         this.field_178999_b.put(var1, var2 << 24 | var3 << 16 | var4 << 8 | 255);
      }
   ...
   public void func_178981_a(int[] var1) {
      this.func_181670_b(var1.length * 4 + this.field_179011_q.func_177338_f());
   ...
   public void func_178968_d(int var1) {
      for(int var2 = 0; var2 < 4; ++var2) {
         this.func_192836_a(var1, var2 + 1);
      }
