...
public class Frustum {
   ...
   public Frustum offsetToFullyIncludeCameraCube(int var1) {
      ...
      for(double var12 = Math.ceil(this.camZ / (double)var1) * (double)var1; !this.cubeCompletelyInFrustum((float)(var2 - this.camX), (float)(var4 - this.camY), (float)(var6 - this.camZ), (float)(var8 - this.camX), (float)(var10 - this.camY), (float)(var12 - this.camZ)); this.camZ -= (double)(this.viewVector.method_68() * 4.0F)) {
         this.camX -= (double)(this.viewVector.method_66() * 4.0F);
         this.camY -= (double)(this.viewVector.method_67() * 4.0F);
      }
