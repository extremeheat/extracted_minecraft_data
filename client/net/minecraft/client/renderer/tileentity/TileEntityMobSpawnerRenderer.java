...
public class TileEntityMobSpawnerRenderer extends TileEntitySpecialRenderer<TileEntityMobSpawner> {
   ...
   public void func_180535_a(TileEntityMobSpawner var1, double var2, double var4, double var6, float var8, int var9) {
   ...
   public static void func_147517_a(MobSpawnerBaseLogic var0, double var1, double var3, double var5, float var7) {
      Entity var8 = var0.func_180612_a(var0.func_98271_a());
      if (var8 != null) {
         float var9 = 0.4375F;
         ...
         Minecraft.func_71410_x().func_175598_ae().func_147940_a(var8, 0.0D, 0.0D, 0.0D, 0.0F, var7);
      }
