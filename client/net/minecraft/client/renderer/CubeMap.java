...
public class CubeMap {
   ...
   public void render(Minecraft var1, float var2, float var3, float var4) {
      ...
      var8.pushPose();
      var8.setIdentity();
      var8.mulPose(Vector3f.field_290.rotationDegrees(180.0F));
      ...
      for(int var10 = 0; var10 < 4; ++var10) {
         ...
         var8.mulPose(Vector3f.field_290.rotationDegrees(var2));
         var8.mulPose(Vector3f.field_292.rotationDegrees(var3));
         RenderSystem.applyModelViewMatrix();
         ...
         for(int var14 = 0; var14 < 6; ++var14) {
            ...
            if (var14 == 0) {
               var6.vertex(-1.0D, -1.0D, 1.0D).method_7(0.0F, 0.0F).color(255, 255, 255, var15).endVertex();
               var6.vertex(-1.0D, 1.0D, 1.0D).method_7(0.0F, 1.0F).color(255, 255, 255, var15).endVertex();
               var6.vertex(1.0D, 1.0D, 1.0D).method_7(1.0F, 1.0F).color(255, 255, 255, var15).endVertex();
               var6.vertex(1.0D, -1.0D, 1.0D).method_7(1.0F, 0.0F).color(255, 255, 255, var15).endVertex();
            }
