...
public abstract class RenderType extends RenderStateShard {
   ...
   public void end(BufferBuilder var1, int var2, int var3, int var4) {
      if (var1.building()) {
         ...
         BufferBuilder.RenderedBuffer var5 = var1.end();
         this.setupRenderState();
         BufferUploader.drawWithShader(var5);
   ...
   static {
      ...
      ARMOR_CUTOUT_NO_CULL = Util.memoize((var0) -> {
         CompositeState var1 = RenderType.CompositeState.builder().setShaderState(RENDERTYPE_ARMOR_CUTOUT_NO_CULL_SHADER).setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(NO_TRANSPARENCY).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setLayeringState(VIEW_OFFSET_Z_LAYERING).createCompositeState(true);
   ...
   protected static final class CompositeState {
      ...
      public static class CompositeStateBuilder {
         ...
         public CompositeState createCompositeState(OutlineProperty var1) {
            return new CompositeState(this.textureState, this.shaderState, this.transparencyState, this.depthTestState, this.cullState, this.lightmapState, this.overlayState, this.layeringState, this.outputState, this.texturingState, this.writeMaskState, this.lineState, var1);
         }
      }
   }
