...
public class AtmosphericFogEnvironment extends AirBasedFogEnvironment {
   private static final float RAIN_FOG_START_OFFSET = -400.0F;
   ...
   public void setupFog(FogData var1, Entity var2, BlockPos var3, ClientLevel var4, float var5, DeltaTracker var6) {
      ...
      float var10 = (float)var4.getLightEngine().getLayerListener(LightLayer.SKY).getLightValue(var3) / 15.0F;
      ...
      var1.environmentalStart = this.rainFogMultiplier * -400.0F;
