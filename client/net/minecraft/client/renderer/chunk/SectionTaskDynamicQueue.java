...
public class SectionTaskDynamicQueue {
   ...
   public SectionTaskDynamicQueue() {
      super();
   }
   ...
   public synchronized SectionRenderDispatcher.RenderSection.@Nullable SectionTask poll(final Vec3 cameraPos) {
      ...
      while(iterator.hasNext()) {
         ...
         SectionRenderDispatcher.RenderSection.SectionTask task = (SectionRenderDispatcher.RenderSection.SectionTask)iterator.next();
   ...
   private SectionRenderDispatcher.RenderSection.@Nullable SectionTask removeTaskByIndex(final int taskIndex) {
      return taskIndex >= 0 ? (SectionRenderDispatcher.RenderSection.SectionTask)this.tasks.remove(taskIndex) : null;
   }
