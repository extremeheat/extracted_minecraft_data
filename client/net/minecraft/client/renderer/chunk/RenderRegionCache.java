...
public class RenderRegionCache {
   ...
   public RenderChunkRegion createRegion(Level var1, SectionPos var2) {
      RenderRegionCache.ChunkInfo var3 = this.getChunkInfo(var1, var2.x(), var2.z());
      if (var3.chunk().isSectionEmpty(var2.y())) {
         ...
         for (int var9 = var5; var9 <= var7; var9++) {
            for (int var10 = var4; var10 <= var6; var10++) {
               ...
               RenderRegionCache.ChunkInfo var12 = var10 == var2.x() && var9 == var2.z() ? var3 : this.getChunkInfo(var1, var10, var9);
   ...
   private RenderRegionCache.ChunkInfo getChunkInfo(Level var1, int var2, int var3) {
      return (RenderRegionCache.ChunkInfo)this.chunkInfoCache
         .computeIfAbsent(ChunkPos.asLong(var2, var3), var1x -> new RenderRegionCache.ChunkInfo(var1.getChunk(ChunkPos.getX(var1x), ChunkPos.getZ(var1x))));
   }
