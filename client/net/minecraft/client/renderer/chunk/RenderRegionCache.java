   ...
   public RenderChunkRegion createRegion(Level var1, BlockPos var2, BlockPos var3, int var4) {
      ...
      for(int var10 = var5; var10 <= var7; ++var10) {
         for(var11 = var6; var11 <= var8; ++var11) {
            var9[var10 - var5][var11 - var6] = (RenderRegionCache.ChunkInfo)this.chunkInfoCache.computeIfAbsent(ChunkPos.asLong(var10, var11), (var1x) -> {
               return new RenderRegionCache.ChunkInfo(var1.getChunk(ChunkPos.getX(var1x), ChunkPos.getZ(var1x)));
            });
         }
      }
