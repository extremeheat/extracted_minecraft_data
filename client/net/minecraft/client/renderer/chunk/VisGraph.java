...
public class VisGraph {
   ...
   private static final int field_442 = (int)Math.pow(16.0D, 0.0D);
   // $FF: renamed from: DZ int
   private static final int field_443 = (int)Math.pow(16.0D, 1.0D);
   // $FF: renamed from: DY int
   private static final int field_444 = (int)Math.pow(16.0D, 2.0D);
