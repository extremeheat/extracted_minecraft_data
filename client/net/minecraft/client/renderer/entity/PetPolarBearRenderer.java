...
public class PetPolarBearRenderer extends AgeableMobRenderer<PetPolarBear, PolarBearRenderState, PolarBearModel> {
   ...
   public PetPolarBearRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetPolarBear var1, PolarBearRenderState var2, float var3) {
