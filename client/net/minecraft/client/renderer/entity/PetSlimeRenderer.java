...
public class PetSlimeRenderer extends MobRenderer<PetSlime, SlimeRenderState, SlimeModel> {
   ...
   public PetSlimeRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetSlime var1, SlimeRenderState var2, float var3) {
