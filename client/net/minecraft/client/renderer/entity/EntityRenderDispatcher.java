...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public <E extends Entity> void render(E var1, double var2, double var4, double var6, float var8, float var9, PoseStack var10, MultiBufferSource var11, int var12) {
      ...
      try {
         ...
         double var25 = var2 + var14.method_2();
         double var26 = var4 + var14.method_3();
         double var19 = var6 + var14.method_4();
         var10.pushPose();
         ...
         var10.translate(-var14.method_2(), -var14.method_3(), -var14.method_4());
   ...
   private static void renderHitbox(PoseStack var0, VertexConsumer var1, Entity var2, float var3) {
      ...
      var1.vertex(var6, 0.0F, var2.getEyeHeight(), 0.0F).color(0, 0, 255, 255).normal(var23, (float)var22.field_414, (float)var22.field_415, (float)var22.field_416).endVertex();
      var1.vertex(var6, (float)(var22.field_414 * 2.0D), (float)((double)var2.getEyeHeight() + var22.field_415 * 2.0D), (float)(var22.field_416 * 2.0D)).color(0, 0, 255, 255).normal(var23, (float)var22.field_414, (float)var22.field_415, (float)var22.field_416).endVertex();
   }
   ...
   private void renderFlame(PoseStack var1, MultiBufferSource var2, Entity var3) {
      ...
      float var10 = 0.0F;
      var1.mulPose(Vector3f.field_292.rotationDegrees(-this.camera.getYRot()));
   ...
   private static void fireVertex(PoseStack.Pose var0, VertexConsumer var1, float var2, float var3, float var4, float var5, float var6) {
      var1.vertex(var0.pose(), var2, var3, var4).color(255, 255, 255, 255).method_7(var5, var6).overlayCoords(0, 10).uv2(240).normal(var0.normal(), 0.0F, 1.0F, 0.0F).endVertex();
   }
   ...
   private static void shadowVertex(PoseStack.Pose var0, VertexConsumer var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      var1.vertex(var0.pose(), var3, var4, var5).color(1.0F, 1.0F, 1.0F, var2).method_7(var6, var7).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(15728880).normal(var0.normal(), 0.0F, 1.0F, 0.0F).endVertex();
   }
