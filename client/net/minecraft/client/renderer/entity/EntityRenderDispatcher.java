...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   private static void renderHitbox(PoseStack var0, VertexConsumer var1, Entity var2, float var3) {
      ...
      var1.vertex(var6, (float)(var22.x * 2.0), (float)((double)var2.getEyeHeight() + var22.y * 2.0), (float)(var22.z * 2.0)).color(0, 0, 255, 255).normal(var23, (float)var22.x, (float)var22.y, (float)var22.z).endVertex();
   }
   ...
   private void renderFlame(PoseStack var1, MultiBufferSource var2, Entity var3) {
      ...
      var1.translate(0.0, 0.0, (double)(-0.3F + (float)((int)var9) * 0.02F));
      float var11 = 0.0F;
      int var12 = 0;
