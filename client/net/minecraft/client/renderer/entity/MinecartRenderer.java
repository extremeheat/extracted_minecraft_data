...
public class MinecartRenderer<T extends AbstractMinecart> extends EntityRenderer<T> {
   ...
   public void render(T var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var20 != null) {
         ...
         var4.translate(var20.field_414 - var12, (var22.field_415 + var23.field_415) / 2.0D - var14, var20.field_416 - var16);
         Vec3 var24 = var23.add(-var22.field_414, -var22.field_415, -var22.field_416);
         if (var24.length() != 0.0D) {
            var24 = var24.normalize();
            var2 = (float)(Math.atan2(var24.field_416, var24.field_414) * 180.0D / 3.141592653589793D);
            var21 = (float)(Math.atan(var24.field_415) * 73.0D);
         }
      }

      var4.translate(0.0D, 0.375D, 0.0D);
      var4.mulPose(Vector3f.field_292.rotationDegrees(180.0F - var2));
      var4.mulPose(Vector3f.field_294.rotationDegrees(-var21));
      ...
      if (var27 > 0.0F) {
         var4.mulPose(Vector3f.field_290.rotationDegrees(Mth.sin(var27) * var27 * var28 / 10.0F * (float)var1.getHurtDir()));
      }
      ...
      if (var25.getRenderShape() != RenderShape.INVISIBLE) {
         ...
         var4.mulPose(Vector3f.field_292.rotationDegrees(90.0F));
