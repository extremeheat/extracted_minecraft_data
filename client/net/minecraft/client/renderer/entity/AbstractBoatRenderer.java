...
public abstract class AbstractBoatRenderer extends EntityRenderer<AbstractBoat, BoatRenderState> {
   ...
   public void submit(BoatRenderState var1, PoseStack var2, SubmitNodeCollector var3) {
      var2.pushPose();
      var2.translate(0.0F, 0.375F, 0.0F);
      var2.mulPose((Quaternionfc)Axis.YP.rotationDegrees(180.0F - var1.yRot));
      float var4 = var1.hurtTime;
      if (var4 > 0.0F) {
         var2.mulPose((Quaternionfc)Axis.XP.rotationDegrees(Mth.sin(var4) * var4 * var1.damageTime / 10.0F * (float)var1.hurtDir));
      }
