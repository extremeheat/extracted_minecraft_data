...
public class PetCowRenderer extends MobRenderer<PetCow, CowRenderState, CowModel> {
   private final Map<CowVariant.ModelType, AdultAndBabyModelPair<CowModel>> models;

   public PetCowRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetCow var1, CowRenderState var2, float var3) {
