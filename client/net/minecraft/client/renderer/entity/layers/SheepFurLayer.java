      ...
      if (!var4.isSheared()) {
         if (var4.isInvisible()) {
            ...
            if (var4.hasCustomName() && "jeb_".equals(var4.getName().getString())) {
               ...
               float[] var20 = var4.getColorArray(DyeColor.byId(var17));
               float[] var21 = var4.getColorArray(DyeColor.byId(var18));
               var11 = var20[0] * (1.0F - var19) + var21[0] * var19;
               var12 = var20[1] * (1.0F - var19) + var21[1] * var19;
               var13 = var20[2] * (1.0F - var19) + var21[2] * var19;
            } else {
               float[] var14 = var4.getColorArray(var4.getColor());
               var11 = var14[0];
               var12 = var14[1];
               var13 = var14[2];
            }
            ...
            coloredCutoutModelCopyLayerRender(
               this.getParentModel(),
               this.model,
               var4.isPotato() ? SHEEP_FUR_LOCATION_POTATO : SHEEP_FUR_LOCATION,
               var1,
               var2,
               var3,
               var4,
