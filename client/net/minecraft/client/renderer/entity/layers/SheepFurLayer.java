   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, Sheep var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      if (!var4.isSheared()) {
         if (var4.isInvisible()) {
            ...
            boolean var21 = var20.shouldEntityAppearGlowing(var4);
            if (var21) {
               this.getParentModel().copyPropertiesTo(this.model);
               this.model.prepareMobModel(var4, var5, var6, var7);
               this.model.setupAnim(var4, var5, var6, var8, var9, var10);
               VertexConsumer var22 = var2.getBuffer(RenderType.outline(SHEEP_FUR_LOCATION));
               this.model.renderToBuffer(var1, var22, var3, LivingEntityRenderer.getOverlayCoords(var4, 0.0F), -16777216);
            }
         } else {
            int var11;
            ...
            coloredCutoutModelCopyLayerRender(
               this.getParentModel(), this.model, SHEEP_FUR_LOCATION, var1, var2, var3, var4, var5, var6, var8, var9, var10, var7, var11
            );
         }
      }
   }
