...
public class LivingEntityEmissiveLayer<S extends LivingEntityRenderState, M extends EntityModel<S>> extends RenderLayer<S, M> {
   ...
   public LivingEntityEmissiveLayer(RenderLayerParent<S, M> var1, Function<S, Identifier> var2, AlphaFunction<S> var3, M var4, Function<Identifier, RenderType> var5, boolean var6) {
      super(var1);
