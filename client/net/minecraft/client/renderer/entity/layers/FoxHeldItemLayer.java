...
public class FoxHeldItemLayer extends RenderLayer<Fox, FoxModel<Fox>> {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, Fox var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      ...
      var1.translate((double)(((FoxModel)this.getParentModel()).head.field_305 / 16.0F), (double)(((FoxModel)this.getParentModel()).head.field_306 / 16.0F), (double)(((FoxModel)this.getParentModel()).head.field_307 / 16.0F));
      var13 = var4.getHeadRollAngle(var7);
      var1.mulPose(Vector3f.field_294.rotation(var13));
      var1.mulPose(Vector3f.field_292.rotationDegrees(var9));
      var1.mulPose(Vector3f.field_290.rotationDegrees(var10));
      if (var4.isBaby()) {
         if (var11) {
