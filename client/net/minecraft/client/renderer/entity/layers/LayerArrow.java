...
public class LayerArrow implements LayerRenderer<EntityLivingBase> {
   ...
   public void func_177141_a(EntityLivingBase var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      int var9 = var1.func_85035_bI();
      if (var9 > 0) {
         EntityTippedArrow var10 = new EntityTippedArrow(var1.field_70170_p, var1.field_70165_t, var1.field_70163_u, var1.field_70161_v);
         Random var11 = new Random((long)var1.func_145782_y());
         ...
         for(int var12 = 0; var12 < var9; ++var12) {
            ...
            var10.field_70177_z = (float)(Math.atan2((double)var15, (double)var17) * 57.2957763671875D);
            var10.field_70125_A = (float)(Math.atan2((double)var16, (double)var21) * 57.2957763671875D);
            var10.field_70126_B = var10.field_70177_z;
            var10.field_70127_C = var10.field_70125_A;
            double var22 = 0.0D;
            double var24 = 0.0D;
            double var26 = 0.0D;
            this.field_177168_a.func_177068_d().func_188391_a(var10, 0.0D, 0.0D, 0.0D, 0.0F, var4, false);
