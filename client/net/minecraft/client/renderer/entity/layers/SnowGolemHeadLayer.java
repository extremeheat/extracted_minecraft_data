      ...
      if (var4.hasPumpkin()) {
         ...
         if (!var4.isInvisible() || var11) {
            ...
            if (var11) {
               ...
               this.itemRenderer.renderStatic(var4, var13, ItemTransforms.TransformType.HEAD, false, var1, var2, var4.level, var3, LivingEntityRenderer.getOverlayCoords(var4, 0.0F), var4.getId());
            }
