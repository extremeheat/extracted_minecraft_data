   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, LivingEntityRenderState var4, float var5, float var6) {
      ...
      if (var7 != null) {
         ...
         if (!var4.isInvisible || var8) {
            ...
            if (var8 && var10.getItem() instanceof BlockItem var11) {
               ...
               this.blockRenderer
                  .getModelRenderer()
                  .renderModel(var1.last(), var2.getBuffer(RenderType.outline(TextureAtlas.LOCATION_BLOCKS)), var15, var13, 0.0F, 0.0F, 0.0F, var3, var14);
            } else {
