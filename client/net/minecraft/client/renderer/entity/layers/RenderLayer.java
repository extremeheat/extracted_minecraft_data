...
public abstract class RenderLayer<S extends EntityRenderState, M extends EntityModel<? super S>> {
   ...
   protected static <S extends LivingEntityRenderState> void coloredCutoutModelCopyLayerRender(
      EntityModel<S> var0, ResourceLocation var1, PoseStack var2, MultiBufferSource var3, int var4, S var5, int var6
   ) {
      if (!var5.isInvisible) {
         var0.setupAnim(var5);
   ...
   protected static void renderColoredCutoutModel(
      EntityModel<?> var0, ResourceLocation var1, PoseStack var2, MultiBufferSource var3, int var4, LivingEntityRenderState var5, int var6
   ) {
   ...
   protected ResourceLocation getTextureLocation(S var1) {
      return this.renderer.getTextureLocation((S)var1);
   }
