...
public abstract class RenderLayer<T extends Entity, M extends EntityModel<T>> {
   ...
   protected static <T extends LivingEntity> void coloredCutoutModelCopyLayerRender(EntityModel<T> var0, EntityModel<T> var1, ResourceLocation var2, PoseStack var3, MultiBufferSource var4, int var5, T var6, float var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, float var15) {
      if (!var6.isInvisible()) {
   ...
   protected static <T extends LivingEntity> void renderColoredCutoutModel(EntityModel<T> var0, ResourceLocation var1, PoseStack var2, MultiBufferSource var3, int var4, T var5, float var6, float var7, float var8) {
