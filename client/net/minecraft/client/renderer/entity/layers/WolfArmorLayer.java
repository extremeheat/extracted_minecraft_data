...
public class WolfArmorLayer extends RenderLayer<Wolf, WolfModel<Wolf>> {
   ...
   private void maybeRenderColoredLayer(PoseStack var1, MultiBufferSource var2, int var3, ItemStack var4, AnimalArmorItem var5) {
      if (var4.is(ItemTags.DYEABLE)) {
         ...
         float var8 = (float)FastColor.ARGB32.red(var6) / 255.0F;
         float var9 = (float)FastColor.ARGB32.green(var6) / 255.0F;
         float var10 = (float)FastColor.ARGB32.blue(var6) / 255.0F;
         this.model.renderToBuffer(var1, var2.getBuffer(RenderType.entityCutoutNoCull(var7)), var3, OverlayTexture.NO_OVERLAY, var8, var9, var10, 1.0F);
      }
   ...
   private void maybeRenderCracks(PoseStack var1, MultiBufferSource var2, int var3, ItemStack var4) {
      ...
      if (var5 != Crackiness.Level.NONE) {
         ...
         this.model.renderToBuffer(var1, var7, var3, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
      }
   }

   static {
      ARMOR_CRACK_LOCATIONS = Map.of(Crackiness.Level.LOW, new ResourceLocation("textures/entity/wolf/wolf_armor_crackiness_low.png"), Crackiness.Level.MEDIUM, new ResourceLocation("textures/entity/wolf/wolf_armor_crackiness_medium.png"), Crackiness.Level.HIGH, new ResourceLocation("textures/entity/wolf/wolf_armor_crackiness_high.png"));
   }
}
