      ...
      if (var7.getItem() instanceof ArmorItem) {
         ...
         if (var8.getSlot() == var4) {
            ...
            if (var8 instanceof DyeableArmorItem) {
               ...
               this.renderModel(var1, var2, var5, var8, var10, (A)var6, var9, var12, var13, var14, null);
               this.renderModel(var1, var2, var5, var8, var10, (A)var6, var9, 1.0F, 1.0F, 1.0F, "overlay");
            } else {
               this.renderModel(var1, var2, var5, var8, var10, (A)var6, var9, 1.0F, 1.0F, 1.0F, null);
            }
         }
      }
   }
