...
public class ItemInHandLayer<S extends LivingEntityRenderState, M extends EntityModel<S> & ArmedModel> extends RenderLayer<S, M> {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, S var4, float var5, float var6) {
      this.renderArmWithItem(var4, var4.rightHandItemModel, var4.rightHandItem, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, HumanoidArm.RIGHT, var1, var2, var3);
      this.renderArmWithItem(var4, var4.leftHandItemModel, var4.leftHandItem, ItemDisplayContext.THIRD_PERSON_LEFT_HAND, HumanoidArm.LEFT, var1, var2, var3);
   }
   ...
   protected void renderArmWithItem(S var1, @Nullable BakedModel var2, ItemStack var3, ItemDisplayContext var4, HumanoidArm var5, PoseStack var6, MultiBufferSource var7, int var8) {
      if (var2 != null && !var3.isEmpty()) {
         var6.pushPose();
         ((ArmedModel)this.getParentModel()).translateToHand(var5, var6);
