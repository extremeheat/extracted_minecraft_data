...
public abstract class StuckInBodyLayer<M extends PlayerModel> extends RenderLayer<PlayerRenderState, M> {
   ...
   public StuckInBodyLayer(LivingEntityRenderer<?, PlayerRenderState, M> var1, Model var2, ResourceLocation var3, StuckInBodyLayer.PlacementStyle var4) {
      super(var1);
      this.model = var2;
      this.texture = var3;
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, PlayerRenderState var4, float var5, float var6) {
      ...
      if (var7 > 0) {
         ...
         for (int var9 = 0; var9 < var7; var9++) {
            var1.pushPose();
            ModelPart var10 = this.getParentModel().getRandomBodyPart(var8);
            ...
            var1.translate(
               Mth.lerp(var12, var11.minX, var11.maxX) / 16.0F,
               Mth.lerp(var13, var11.minY, var11.maxY) / 16.0F,
               Mth.lerp(var14, var11.minZ, var11.maxZ) / 16.0F
            );
