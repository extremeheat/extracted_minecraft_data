...
public class ParrotOnShoulderLayer extends RenderLayer<PlayerRenderState, PlayerModel> {
   ...
   private void submitOnShoulder(PoseStack var1, SubmitNodeCollector var2, int var3, PlayerRenderState var4, Parrot.Variant var5, float var6, float var7, boolean var8) {
      var1.pushPose();
      ...
      var9.yRot = var6;
      var9.xRot = var7;
      var2.submitModel(this.model, var9, var1, this.model.renderType(ParrotRenderer.getVariantTexture(var5)), var3, OverlayTexture.NO_OVERLAY, var4.outlineColor);
      var1.popPose();
   }
}
