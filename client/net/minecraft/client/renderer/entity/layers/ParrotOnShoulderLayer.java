...
public class ParrotOnShoulderLayer<T extends Player> extends RenderLayer<T, PlayerModel<T>> {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, T var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      this.render(var1, var2, var3, (T)var4, var5, var6, var9, var10, true);
      this.render(var1, var2, var3, (T)var4, var5, var6, var9, var10, false);
   }
   ...
   private void render(PoseStack var1, MultiBufferSource var2, int var3, T var4, float var5, float var6, float var7, float var8, boolean var9) {
      ...
      EntityType.byString(var10.getString("id")).filter(var0 -> var0 == EntityType.PARROT).ifPresent(var11 -> {
         var1.pushPose();
         var1.translate(var9 ? 0.4000000059604645 : -0.4000000059604645, var4.isCrouching() ? -1.2999999523162842 : -1.5, 0.0);
