...
public class ModelPufferFishBig extends ModelBase {
   ...
   public void func_78088_a(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      this.field_203741_a.func_78785_a(var7);
      this.field_203742_b.func_78785_a(var7);
      this.field_203743_c.func_78785_a(var7);
      this.field_203744_d.func_78785_a(var7);
      this.field_203745_e.func_78785_a(var7);
      this.field_203746_f.func_78785_a(var7);
      this.field_203747_g.func_78785_a(var7);
      this.field_203748_h.func_78785_a(var7);
      this.field_203749_i.func_78785_a(var7);
      this.field_203751_k.func_78785_a(var7);
      this.field_203750_j.func_78785_a(var7);
      this.field_203752_l.func_78785_a(var7);
      this.field_203753_m.func_78785_a(var7);
   }

   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      this.field_203742_b.field_78808_h = -0.2F + 0.4F * MathHelper.func_76126_a(var3 * 0.2F);
      this.field_203743_c.field_78808_h = 0.2F - 0.4F * MathHelper.func_76126_a(var3 * 0.2F);
   }
}
