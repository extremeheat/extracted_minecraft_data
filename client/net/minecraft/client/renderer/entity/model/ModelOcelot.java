...
public class ModelOcelot extends ModelBase {
   ...
   public void func_78087_a(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      this.field_78156_g.field_78795_f = var5 * 0.017453292F;
      this.field_78156_g.field_78796_g = var4 * 0.017453292F;
      if (this.field_78163_i != 3) {
         this.field_78162_h.field_78795_f = 1.5707964F;
         if (this.field_78163_i == 2) {
            this.field_78161_a.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F) * var2;
            this.field_78159_b.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F + 0.3F) * var2;
            this.field_78160_c.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F + 3.1415927F + 0.3F) * var2;
            this.field_78157_d.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F + 3.1415927F) * var2;
            this.field_78155_f.field_78795_f = 1.7278761F + 0.31415927F * MathHelper.func_76134_b(var1) * var2;
         } else {
            this.field_78161_a.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F) * var2;
            this.field_78159_b.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F + 3.1415927F) * var2;
            this.field_78160_c.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F + 3.1415927F) * var2;
            this.field_78157_d.field_78795_f = MathHelper.func_76134_b(var1 * 0.6662F) * var2;
