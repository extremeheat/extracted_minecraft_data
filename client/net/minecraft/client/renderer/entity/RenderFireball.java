...
public class RenderFireball extends Render<EntityFireball> {
   ...
   public void func_76986_a(EntityFireball var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      TextureAtlasSprite var10 = Minecraft.func_71410_x().func_175599_af().func_175037_a().func_178082_a(Items.field_151059_bz);
      ...
      var12.func_181662_b(-0.5D, -0.25D, 0.0D).func_181673_a((double)var13, (double)var16).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      var12.func_181662_b(0.5D, -0.25D, 0.0D).func_181673_a((double)var14, (double)var16).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      var12.func_181662_b(0.5D, 0.75D, 0.0D).func_181673_a((double)var14, (double)var15).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      var12.func_181662_b(-0.5D, 0.75D, 0.0D).func_181673_a((double)var13, (double)var15).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      var11.func_78381_a();
