...
public class DrownedRenderer extends AbstractZombieRenderer<Drowned, ZombieRenderState, DrownedModel> {
   ...
   public DrownedRenderer(EntityRendererProvider.Context var1) {
      super(
         ...
         new DrownedModel(var1.bakeLayer(ModelLayers.DROWNED_BABY)),
         ...
         new DrownedModel(var1.bakeLayer(ModelLayers.DROWNED_BABY_INNER_ARMOR)),
         new DrownedModel(var1.bakeLayer(ModelLayers.DROWNED_BABY_OUTER_ARMOR))
      );
