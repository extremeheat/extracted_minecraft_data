...
import net.minecraft.client.renderer.entity.layers.WolfHeldItemLayer;
...
public class PetWolfRenderer extends AgeableMobRenderer<PetWolf, WolfRenderState, WolfModel> {
   public PetWolfRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetWolf var1, WolfRenderState var2, float var3) {
