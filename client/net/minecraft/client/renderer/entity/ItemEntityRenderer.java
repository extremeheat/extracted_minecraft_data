...
public class ItemEntityRenderer extends EntityRenderer<ItemEntity> {
   ...
   public void render(ItemEntity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      float var14 = var9.getTransforms().getTransform(ItemTransforms.TransformType.GROUND).scale.method_83();
      var4.translate(0.0D, (double)(var13 + 0.25F * var14), 0.0D);
      float var15 = var1.getSpin(var3);
      var4.mulPose(Vector3f.field_292.rotation(var15));
      float var16 = var9.getTransforms().ground.scale.method_82();
      float var17 = var9.getTransforms().ground.scale.method_83();
      float var18 = var9.getTransforms().ground.scale.method_84();
      float var20;
      float var21;
      if (!var10) {
