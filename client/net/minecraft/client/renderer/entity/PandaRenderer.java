...
public class PandaRenderer extends MobRenderer<Panda, PandaModel<Panda>> {
   ...
   protected void setupRotations(Panda var1, PoseStack var2, float var3, float var4, float var5) {
      ...
      if (var1.rollCounter > 0) {
         ...
         if (var6 < 8) {
            ...
            if (var6 < 16) {
               ...
               var2.translate(0.0, (double)(var9 + 0.2F + (var9 - 0.2F) * (var10 - 90.0F) / 90.0F), 0.0);
               var2.mulPose(Vector3f.XP.rotationDegrees(-var10));
               ...
               var2.translate(0.0, (double)(var9 + var9 * (270.0F - var10) / 90.0F), 0.0);
               var2.mulPose(Vector3f.XP.rotationDegrees(-var10));
            } else if (var6 < 32) {
               ...
               var2.translate(0.0, (double)(var9 * ((360.0F - var10) / 90.0F)), 0.0);
               var2.mulPose(Vector3f.XP.rotationDegrees(-var10));
            }
         }
      }
      ...
      if (var14 > 0.0F) {
         ...
         if (var1.isScared()) {
            var15 = (float)(Math.cos((double)var1.tickCount * 1.25) * 3.141592653589793 * 0.05000000074505806);
      ...
      if (var15 > 0.0F) {
         ...
         var2.translate(0.0, (double)(var8 * var15), 0.0);
