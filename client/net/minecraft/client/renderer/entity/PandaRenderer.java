   ...
   protected void setupRotations(Panda var1, PoseStack var2, float var3, float var4, float var5) {
      ...
      if (var1.rollCounter > 0) {
         ...
         if (var6 < 8) {
            ...
            var2.mulPose(Vector3f.field_290.rotationDegrees(-var10));
         } else {
            float var13;
            if (var6 < 16) {
      ...
      if (var14 > 0.0F) {
         ...
         var2.mulPose(Vector3f.field_290.rotationDegrees(Mth.lerp(var14, var1.getXRot(), var1.getXRot() + 90.0F)));
         ...
         if (var1.isScared()) {
            ...
            var2.mulPose(Vector3f.field_292.rotationDegrees(var15));
            if (var1.isBaby()) {
      ...
      if (var15 > 0.0F) {
         ...
         var2.mulPose(Vector3f.field_290.rotationDegrees(Mth.lerp(var15, var1.getXRot(), var1.getXRot() + 180.0F)));
      }
