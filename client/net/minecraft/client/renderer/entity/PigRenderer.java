...
public class PigRenderer extends MobRenderer<Pig, PigModel<Pig>> {
   ...
   public PigRenderer(EntityRendererProvider.Context var1) {
      super(var1, new PigModel(var1.getLayer(ModelLayers.PIG)), 0.7F);
      this.addLayer(new SaddleLayer(this, new PigModel(var1.getLayer(ModelLayers.PIG_SADDLE)), new ResourceLocation("textures/entity/pig/pig_saddle.png")));
   }
