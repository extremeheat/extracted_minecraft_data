...
public abstract class LivingEntityRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements RenderLayerParent<T, M> {
   ...
   public static int getOverlayCoords(LivingEntity var0, float var1) {
      return OverlayTexture.pack(OverlayTexture.method_88(var1), OverlayTexture.method_89(var0.hurtTime > 0 || var0.deathTime > 0));
   }
   ...
   protected void setupRotations(T var1, PoseStack var2, float var3, float var4, float var5) {
      ...
      if (var6 != Pose.SLEEPING) {
         var2.mulPose(Vector3f.field_292.rotationDegrees(180.0F - var4));
      }
      ...
      if (var1.deathTime > 0) {
         ...
         var2.mulPose(Vector3f.field_294.rotationDegrees(var7 * this.getFlipDegrees(var1)));
      } else if (var1.isAutoSpinAttack()) {
         var2.mulPose(Vector3f.field_290.rotationDegrees(-90.0F - var1.getXRot()));
         var2.mulPose(Vector3f.field_292.rotationDegrees(((float)var1.tickCount + var5) * -75.0F));
      } else if (var6 == Pose.SLEEPING) {
         Direction var9 = var1.getBedOrientation();
         float var8 = var9 != null ? sleepDirectionToRotation(var9) : var4;
         var2.mulPose(Vector3f.field_292.rotationDegrees(var8));
         var2.mulPose(Vector3f.field_294.rotationDegrees(this.getFlipDegrees(var1)));
         var2.mulPose(Vector3f.field_292.rotationDegrees(270.0F));
      } else if (isEntityUpsideDown(var1)) {
         var2.translate(0.0D, (double)(var1.getBbHeight() + 0.1F), 0.0D);
         var2.mulPose(Vector3f.field_294.rotationDegrees(180.0F));
      }
