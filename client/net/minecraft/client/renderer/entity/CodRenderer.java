...
public class CodRenderer extends MobRenderer<Cod, CodModel<Cod>> {
   ...
   protected void setupRotations(Cod var1, PoseStack var2, float var3, float var4, float var5) {
      ...
      var2.mulPose(Vector3f.field_292.rotationDegrees(var6));
      if (!var1.isInWater()) {
         var2.translate(0.10000000149011612D, 0.10000000149011612D, -0.10000000149011612D);
         var2.mulPose(Vector3f.field_294.rotationDegrees(90.0F));
      }
