...
public class GiantMobRenderer extends MobRenderer<Giant, HumanoidModel<Giant>> {
   ...
   public GiantMobRenderer(EntityRendererProvider.Context var1, float var2) {
      ...
      this.addLayer(new HumanoidArmorLayer(this, new GiantZombieModel(var1.bakeLayer(ModelLayers.GIANT_INNER_ARMOR)), new GiantZombieModel(var1.bakeLayer(ModelLayers.GIANT_OUTER_ARMOR))));
   }
