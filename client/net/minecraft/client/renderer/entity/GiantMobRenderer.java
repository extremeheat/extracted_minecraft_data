...
public class GiantMobRenderer extends MobRenderer<Giant, HumanoidModel<Giant>> {
   ...
   public GiantMobRenderer(EntityRendererProvider.Context var1, float var2) {
      super(var1, new GiantZombieModel(var1.getLayer(ModelLayers.GIANT)), 0.5F * var2);
      this.scale = var2;
      this.addLayer(new ItemInHandLayer(this));
      this.addLayer(new HumanoidArmorLayer(this, new GiantZombieModel(var1.getLayer(ModelLayers.GIANT_INNER_ARMOR)), new GiantZombieModel(var1.getLayer(ModelLayers.GIANT_OUTER_ARMOR))));
   }
