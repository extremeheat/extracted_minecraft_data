...
public class RenderTNTPrimed extends Render<EntityTNTPrimed> {
   ...
   public void func_76986_a(EntityTNTPrimed var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      if ((float)var1.field_70516_a - var9 + 1.0F < 10.0F) {
         var11 = 1.0F - ((float)var1.field_70516_a - var9 + 1.0F) / 10.0F;
      ...
      var11 = (1.0F - ((float)var1.field_70516_a - var9 + 1.0F) / 100.0F) * 0.8F;
      this.func_180548_c(var1);
      GlStateManager.func_179109_b(-0.5F, -0.5F, 0.5F);
      var10.func_175016_a(Blocks.field_150335_W.func_176223_P(), var1.func_70013_c(var9));
