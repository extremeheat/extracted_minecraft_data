...
public class PufferfishRenderer extends MobRenderer<Pufferfish, EntityModel<Pufferfish>> {
   ...
   public PufferfishRenderer(EntityRendererProvider.Context var1) {
      super(var1, new PufferfishBigModel(var1.getLayer(ModelLayers.PUFFERFISH_BIG)), 0.2F);
      this.mid = new PufferfishMidModel(var1.getLayer(ModelLayers.PUFFERFISH_MEDIUM));
      this.small = new PufferfishSmallModel(var1.getLayer(ModelLayers.PUFFERFISH_SMALL));
   }
