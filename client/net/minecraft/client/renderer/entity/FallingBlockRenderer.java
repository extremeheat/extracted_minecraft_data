...
public class FallingBlockRenderer extends EntityRenderer<FallingBlockEntity, FallingBlockRenderState> {
   ...
   public boolean shouldRender(FallingBlockEntity var1, Frustum var2, double var3, double var5, double var7) {
      return !super.shouldRender(var1, var2, var3, var5, var7) ? false : var1.getBlockState() != var1.level().getBlockState(var1.blockPosition());
   }
   ...
   public void render(FallingBlockRenderState var1, PoseStack var2, MultiBufferSource var3, int var4) {
      ...
      if (var5.getRenderShape() == RenderShape.MODEL) {
         ...
         this.dispatcher
            ...
            .tesselateBlock(
               var1,
               this.dispatcher.getBlockModel(var5),
               var5,
               var1.blockPos,
               var2,
               var3.getBuffer(ItemBlockRenderTypes.getMovingBlockRenderType(var5)),
               false,
               RandomSource.create(),
               var5.getSeed(var1.startBlockPos),
   ...
   public ResourceLocation getTextureLocation(FallingBlockRenderState var1) {
