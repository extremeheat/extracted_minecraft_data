...
public class GuardianRenderer extends MobRenderer<Guardian, GuardianModel> {
   ...
   public void render(Guardian var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var7 != null) {
         ...
         float var9 = var1.getClientSideAttackTime() + var3;
         ...
         float var15 = (float)(var14.length() + 1.0);
   ...
   private static void vertex(VertexConsumer var0, PoseStack.Pose var1, float var2, float var3, float var4, int var5, int var6, int var7, float var8, float var9) {
      var0.vertex(var1, var2, var3, var4).color(var5, var6, var7, 255).uv(var8, var9).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(15728880).normal(var1, 0.0F, 1.0F, 0.0F).endVertex();
   }
