...
public class ExperienceOrbRenderer extends EntityRenderer<ExperienceOrb> {
   ...
   private static void vertex(VertexConsumer var0, Matrix4f var1, Matrix3f var2, float var3, float var4, int var5, int var6, int var7, float var8, float var9, int var10) {
      var0.vertex(var1, var3, var4, 0.0F).color(var5, var6, var7, 128).method_7(var8, var9).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(var10).normal(var2, 0.0F, 1.0F, 0.0F).endVertex();
   }
