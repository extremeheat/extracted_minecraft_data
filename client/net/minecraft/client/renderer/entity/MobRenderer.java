...
public abstract class MobRenderer<T extends Mob, M extends EntityModel<T>> extends LivingEntityRenderer<T, M> {
   ...
   private <E extends Entity> void renderLeash(T var1, float var2, PoseStack var3, MultiBufferSource var4, E var5) {
      ...
      double var10 = Math.cos(var7) * var9.field_416 + Math.sin(var7) * var9.field_414;
      double var12 = Math.sin(var7) * var9.field_416 - Math.cos(var7) * var9.field_414;
      double var14 = Mth.lerp((double)var2, var1.xo, var1.getX()) + var10;
      double var16 = Mth.lerp((double)var2, var1.yo, var1.getY()) + var9.field_415;
      double var18 = Mth.lerp((double)var2, var1.zo, var1.getZ()) + var12;
      var3.translate(var10, var9.field_415, var12);
      float var20 = (float)(var6.field_414 - var14);
      float var21 = (float)(var6.field_415 - var16);
      float var22 = (float)(var6.field_416 - var18);
      float var23 = 0.025F;
