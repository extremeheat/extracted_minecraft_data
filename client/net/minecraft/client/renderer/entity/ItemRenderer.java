...
public class ItemRenderer implements ResourceManagerReloadListener {
   ...
   public void renderBundleItem(ItemStack var1, ItemDisplayContext var2, boolean var3, PoseStack var4, MultiBufferSource var5, int var6, int var7, BakedModel var8, @Nullable Level var9, @Nullable LivingEntity var10, int var11) {
      Item var13 = var1.getItem();
      if (var13 instanceof BundleItem var12) {
   ...
   private void renderSimpleItemModel(ItemStack var1, ItemDisplayContext var2, boolean var3, PoseStack var4, MultiBufferSource var5, int var6, int var7, BakedModel var8, boolean var9) {
      if (var9) {
   ...
   private void renderItemModelRaw(ItemStack var1, ItemDisplayContext var2, boolean var3, PoseStack var4, MultiBufferSource var5, int var6, int var7, BakedModel var8, boolean var9, float var10) {
      var4.pushPose();
