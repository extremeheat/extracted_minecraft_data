...
public class RenderRabbit extends RenderLiving<EntityRabbit> {
   ...
   public RenderRabbit(RenderManager var1) {
      super(var1, new ModelRabbit(), 0.3F);
   }

   protected ResourceLocation func_110775_a(EntityRabbit var1) {
      String var2 = TextFormatting.func_110646_a(var1.func_200200_C_().getString());
