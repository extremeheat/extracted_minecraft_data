...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   ...
   public void render(EnderDragon var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      var4.mulPose(Vector3f.field_292.rotationDegrees(-var7));
      var4.mulPose(Vector3f.field_290.rotationDegrees(var8 * 10.0F));
      ...
      if (var1.dragonDeathTime > 0) {
         ...
         for(int var15 = 0; (float)var15 < (var21 + var21 * var21) / 2.0F * 60.0F; ++var15) {
            var4.mulPose(Vector3f.field_290.rotationDegrees(var13.nextFloat() * 360.0F));
            var4.mulPose(Vector3f.field_292.rotationDegrees(var13.nextFloat() * 360.0F));
            var4.mulPose(Vector3f.field_294.rotationDegrees(var13.nextFloat() * 360.0F));
            var4.mulPose(Vector3f.field_290.rotationDegrees(var13.nextFloat() * 360.0F));
            var4.mulPose(Vector3f.field_292.rotationDegrees(var13.nextFloat() * 360.0F));
            var4.mulPose(Vector3f.field_294.rotationDegrees(var13.nextFloat() * 360.0F + var21 * 90.0F));
   ...
   public static void renderCrystalBeams(float var0, float var1, float var2, float var3, int var4, PoseStack var5, MultiBufferSource var6, int var7) {
      ...
      var5.mulPose(Vector3f.field_292.rotation((float)(-Math.atan2((double)var2, (double)var0)) - 1.5707964F));
      var5.mulPose(Vector3f.field_290.rotation((float)(-Math.atan2((double)var8, (double)var1)) - 1.5707964F));
      ...
      for(int var20 = 1; var20 <= 8; ++var20) {
         ...
         var10.vertex(var18, var14 * 0.2F, var15 * 0.2F, 0.0F).color(0, 0, 0, 255).method_7(var16, var11).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(var7).normal(var19, 0.0F, -1.0F, 0.0F).endVertex();
         var10.vertex(var18, var14, var15, var9).color(255, 255, 255, 255).method_7(var16, var12).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(var7).normal(var19, 0.0F, -1.0F, 0.0F).endVertex();
         var10.vertex(var18, var21, var22, var9).color(255, 255, 255, 255).method_7(var23, var12).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(var7).normal(var19, 0.0F, -1.0F, 0.0F).endVertex();
         var10.vertex(var18, var21 * 0.2F, var22 * 0.2F, 0.0F).color(0, 0, 0, 255).method_7(var23, var11).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(var7).normal(var19, 0.0F, -1.0F, 0.0F).endVertex();
         var14 = var21;
         var15 = var22;
         var16 = var23;
      }
   ...
   public static class DragonModel extends EntityModel<EnderDragon> {
      ...
      public void renderToBuffer(PoseStack var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
         var1.pushPose();
         float var9 = Mth.lerp(this.field_40, this.entity.oFlapTime, this.entity.flapTime);
         ...
         var1.mulPose(Vector3f.field_290.rotationDegrees(var10 * 2.0F));
         float var11 = 0.0F;
         float var12 = 20.0F;
         float var13 = -12.0F;
         float var14 = 1.5F;
         double[] var15 = this.entity.getLatencyPos(6, this.field_40);
         float var16 = Mth.rotWrap(this.entity.getLatencyPos(5, this.field_40)[0] - this.entity.getLatencyPos(10, this.field_40)[0]);
         float var17 = Mth.rotWrap(this.entity.getLatencyPos(5, this.field_40)[0] + (double)(var16 / 2.0F));
         float var18 = var9 * 6.2831855F;

         float var21;
         for(int var19 = 0; var19 < 5; ++var19) {
            double[] var20 = this.entity.getLatencyPos(5 - var19, this.field_40);
            ...
            this.neck.field_306 = var12;
            this.neck.field_307 = var13;
            this.neck.field_305 = var11;
         ...
         this.head.field_306 = var12;
         this.head.field_307 = var13;
         this.head.field_305 = var11;
         double[] var23 = this.entity.getLatencyPos(0, this.field_40);
         ...
         var1.mulPose(Vector3f.field_294.rotationDegrees(-var16 * 1.5F));
         var1.translate(0.0D, -1.0D, 0.0D);
         this.body.zRot = 0.0F;
         ...
         var13 = 60.0F;
         var11 = 0.0F;
         var15 = this.entity.getLatencyPos(11, this.field_40);

         for(int var22 = 0; var22 < 12; ++var22) {
            var23 = this.entity.getLatencyPos(12 + var22, this.field_40);
