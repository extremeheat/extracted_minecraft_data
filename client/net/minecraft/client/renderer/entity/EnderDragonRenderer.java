...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon, EnderDragonRenderState> {
   ...
   public static void renderCrystalBeams(float var0, float var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      for(int var17 = 1; var17 <= 8; ++var17) {
         ...
         var9.addVertex(var16, var13 * 0.2F, var14 * 0.2F, 0.0F).setColor(-16777216).setUv(var15, var10).setOverlay(OverlayTexture.NO_OVERLAY).setLight(var6).setNormal(var16, 0.0F, -1.0F, 0.0F);
         var9.addVertex(var16, var13, var14, var8).setColor(-1).setUv(var15, var11).setOverlay(OverlayTexture.NO_OVERLAY).setLight(var6).setNormal(var16, 0.0F, -1.0F, 0.0F);
         var9.addVertex(var16, var18, var19, var8).setColor(-1).setUv(var20, var11).setOverlay(OverlayTexture.NO_OVERLAY).setLight(var6).setNormal(var16, 0.0F, -1.0F, 0.0F);
         var9.addVertex(var16, var18 * 0.2F, var19 * 0.2F, 0.0F).setColor(-16777216).setUv(var20, var10).setOverlay(OverlayTexture.NO_OVERLAY).setLight(var6).setNormal(var16, 0.0F, -1.0F, 0.0F);
         var13 = var18;
         var14 = var19;
         var15 = var20;
      }
