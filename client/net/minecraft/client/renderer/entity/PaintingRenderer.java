...
public class PaintingRenderer extends EntityRenderer<Painting, PaintingRenderState> {
   ...
   public void render(PaintingRenderState var1, PoseStack var2, MultiBufferSource var3, int var4) {
      ...
      if (var5 != null) {
         ...
         VertexConsumer var6 = var3.getBuffer(RenderType.entitySolidZOffsetForward(this.getTextureLocation(var1)));
         PaintingTextureManager var7 = Minecraft.getInstance().getPaintingTextures();
         this.renderPainting(var2, var6, var1.lightCoords, var5.width(), var5.height(), var7.get(var5), var7.getBackSprite());
         var2.popPose();
         super.render(var1, var2, var3, var4);
      }
   }

   public ResourceLocation getTextureLocation(PaintingRenderState var1) {
   ...
   public void extractRenderState(Painting var1, PaintingRenderState var2, float var3) {
      ...
      PaintingVariant var5 = var1.getVariant().value();
      var2.direction = var4;
      var2.variant = var5;
      int var6 = var5.width();
      ...
      for (int var11 = 0; var11 < var7; var11++) {
         for (int var12 = 0; var12 < var6; var12++) {
            ...
            switch (var4) {
               case NORTH:
                  var15 = Mth.floor(var1.getX() + (double)var13);
                  break;
               case WEST:
                  var17 = Mth.floor(var1.getZ() - (double)var13);
                  break;
               case SOUTH:
                  var15 = Mth.floor(var1.getX() - (double)var13);
                  break;
