...
public class PetFrogRenderer extends MobRenderer<PetFrog, FrogRenderState, FrogModel> {
   public PetFrogRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetFrog var1, FrogRenderState var2, float var3) {
