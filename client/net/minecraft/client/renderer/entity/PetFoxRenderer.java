...
public class PetFoxRenderer extends AgeableMobRenderer<PetFox, FoxRenderState, FoxModel> {
   ...
   public PetFoxRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetFox var1, FoxRenderState var2, float var3) {
