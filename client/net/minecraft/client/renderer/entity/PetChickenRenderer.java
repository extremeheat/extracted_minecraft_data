...
public class PetChickenRenderer extends MobRenderer<PetChicken, ChickenRenderState, ChickenModel> {
   private final Map<ChickenVariant.ModelType, AdultAndBabyModelPair<ChickenModel>> models;

   public PetChickenRenderer(EntityRendererProvider.Context var1) {
   ...
   public void extractRenderState(PetChicken var1, ChickenRenderState var2, float var3) {
