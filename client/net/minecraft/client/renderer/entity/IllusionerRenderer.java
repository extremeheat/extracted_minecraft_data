...
public class IllusionerRenderer extends IllagerRenderer<Illusioner> {
   ...
   public IllusionerRenderer(EntityRendererProvider.Context var1) {
      ...
      this.addLayer(new ItemInHandLayer<Illusioner, IllagerModel<Illusioner>>(this, this, var1.getItemInHandRenderer()) {
   ...
   public void render(Illusioner var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      if (var1.isInvisible()) {
         ...
         for(int var9 = 0; var9 < var7.length; ++var9) {
            var4.pushPose();
            var4.translate(var7[var9].x + (double)Mth.cos((float)var9 + var8 * 0.5F) * 0.025, var7[var9].y + (double)Mth.cos((float)var9 + var8 * 0.75F) * 0.0125, var7[var9].z + (double)Mth.cos((float)var9 + var8 * 0.7F) * 0.025);
