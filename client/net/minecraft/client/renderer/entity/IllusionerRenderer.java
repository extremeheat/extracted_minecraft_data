...
public class IllusionerRenderer extends IllagerRenderer<Illusioner, IllusionerRenderState> {
   ...
   public IllusionerRenderer(EntityRendererProvider.Context var1) {
      ...
      this.addLayer(new ItemInHandLayer<IllusionerRenderState, IllagerModel<IllusionerRenderState>>(this, var1.getItemRenderer()) {
   ...
   public void extractRenderState(Illusioner var1, IllusionerRenderState var2, float var3) {
      ...
      var2.illusionOffsets = Arrays.copyOf(var4, var4.length);
   ...
   public void render(IllusionerRenderState var1, PoseStack var2, MultiBufferSource var3, int var4) {
      if (var1.isInvisible) {
         ...
         for (int var6 = 0; var6 < var5.length; var6++) {
            var2.pushPose();
            var2.translate(
               var5[var6].x + (double)Mth.cos((float)var6 + var1.ageInTicks * 0.5F) * 0.025,
               var5[var6].y + (double)Mth.cos((float)var6 + var1.ageInTicks * 0.75F) * 0.0125,
               var5[var6].z + (double)Mth.cos((float)var6 + var1.ageInTicks * 0.7F) * 0.025
            );
