...
public class ShulkerBulletRenderer extends EntityRenderer<ShulkerBullet> {
   ...
   public void render(ShulkerBullet var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      var4.mulPose(Vector3f.field_292.rotationDegrees(Mth.sin(var9 * 0.1F) * 180.0F));
      var4.mulPose(Vector3f.field_290.rotationDegrees(Mth.cos(var9 * 0.1F) * 180.0F));
      var4.mulPose(Vector3f.field_294.rotationDegrees(Mth.sin(var9 * 0.15F) * 360.0F));
