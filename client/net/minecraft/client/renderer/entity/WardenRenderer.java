...
public class WardenRenderer extends MobRenderer<Warden, WardenModel<Warden>> {
   ...
   public WardenRenderer(EntityRendererProvider.Context var1) {
      ...
      this.addLayer(new WardenEmissiveLayer<>(this, BIOLUMINESCENT_LAYER_TEXTURE, (var0, var1x, var2) -> 1.0F, WardenModel::getBioluminescentLayerModelParts));
      this.addLayer(
         new WardenEmissiveLayer<>(
            this,
            PULSATING_SPOTS_TEXTURE_1,
            (var0, var1x, var2) -> Math.max(0.0F, Mth.cos(var2 * 0.045F) * 0.25F),
      ...
      this.addLayer(
         new WardenEmissiveLayer<>(
            ...
            (var0, var1x, var2) -> Math.max(0.0F, Mth.cos(var2 * 0.045F + 3.1415927F) * 0.25F),
            WardenModel::getPulsatingSpotsLayerModelParts
         )
      );
      this.addLayer(new WardenEmissiveLayer<>(this, TEXTURE, (var0, var1x, var2) -> var0.getTendrilAnimation(var1x), WardenModel::getTendrilsLayerModelParts));
      this.addLayer(new WardenEmissiveLayer<>(this, HEART_TEXTURE, (var0, var1x, var2) -> var0.getHeartAnimation(var1x), WardenModel::getHeartLayerModelParts));
   }
