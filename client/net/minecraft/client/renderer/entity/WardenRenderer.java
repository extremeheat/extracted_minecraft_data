...
public class WardenRenderer extends MobRenderer<Warden, WardenRenderState, WardenModel> {
   ...
   public WardenRenderer(EntityRendererProvider.Context var1) {
      ...
      this.addLayer(new LivingEntityEmissiveLayer(this, BIOLUMINESCENT_LAYER_TEXTURE, (var0, var1x) -> 1.0F, WardenModel::getBioluminescentLayerModelParts, RenderType::entityTranslucentEmissive, false));
      this.addLayer(new LivingEntityEmissiveLayer(this, PULSATING_SPOTS_TEXTURE_1, (var0, var1x) -> Math.max(0.0F, Mth.cos(var1x * 0.045F) * 0.25F), WardenModel::getPulsatingSpotsLayerModelParts, RenderType::entityTranslucentEmissive, false));
      this.addLayer(new LivingEntityEmissiveLayer(this, PULSATING_SPOTS_TEXTURE_2, (var0, var1x) -> Math.max(0.0F, Mth.cos(var1x * 0.045F + 3.1415927F) * 0.25F), WardenModel::getPulsatingSpotsLayerModelParts, RenderType::entityTranslucentEmissive, false));
      this.addLayer(new LivingEntityEmissiveLayer(this, TEXTURE, (var0, var1x) -> var0.tendrilAnimation, WardenModel::getTendrilsLayerModelParts, RenderType::entityTranslucentEmissive, false));
      this.addLayer(new LivingEntityEmissiveLayer(this, HEART_TEXTURE, (var0, var1x) -> var0.heartAnimation, WardenModel::getHeartLayerModelParts, RenderType::entityTranslucentEmissive, false));
   }
