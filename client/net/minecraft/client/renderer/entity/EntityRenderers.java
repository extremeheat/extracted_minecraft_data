...
public class EntityRenderers {
   ...
   static {
      ...
      register(EntityType.BOAT, (var0) -> {
         return new BoatRenderer(var0, false);
      });
      ...
      register(EntityType.CAMEL, (var0) -> {
         return new CamelRenderer(var0, ModelLayers.CAMEL);
      });
      register(EntityType.CAVE_SPIDER, CaveSpiderRenderer::new);
      register(EntityType.CHEST_BOAT, (var0) -> {
         return new BoatRenderer(var0, true);
      });
