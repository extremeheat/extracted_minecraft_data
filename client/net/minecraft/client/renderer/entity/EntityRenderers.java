...
public class EntityRenderers {
   ...
   static {
      ...
      register(EntityType.ANGRY_GHAST, AngryGhastRenderer::new);
      ...
      register(EntityType.PET_ARMADILLO, PetArmadilloRenderer::new);
      register(EntityType.PET_AXOLOTL, PetAxolotlRenderer::new);
      register(EntityType.PET_BEE, PetBeeRenderer::new);
      register(EntityType.PET_CAT, PetCatRenderer::new);
      register(EntityType.PET_CHICKEN, PetChickenRenderer::new);
      register(EntityType.PET_COW, PetCowRenderer::new);
      register(EntityType.PET_CREEPER, PetCreeperRenderer::new);
      register(EntityType.PET_FOX, PetFoxRenderer::new);
      register(EntityType.PET_FROG, PetFrogRenderer::new);
      register(EntityType.PET_MOOSHROOM, PetMushroomCowRenderer::new);
      register(EntityType.PET_SLIME, PetSlimeRenderer::new);
      register(EntityType.PET_TURTLE, PetTurtleRenderer::new);
      register(EntityType.PET_WOLF, PetWolfRenderer::new);
      ...
      register(EntityType.PET_POLAR_BEAR, PetPolarBearRenderer::new);
