...
public abstract class ArrowRenderer<T extends AbstractArrow> extends EntityRenderer<T> {
   ...
   public void render(T var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      var4.pushPose();
      var4.mulPose(Vector3f.field_292.rotationDegrees(Mth.lerp(var3, var1.yRotO, var1.getYRot()) - 90.0F));
      var4.mulPose(Vector3f.field_294.rotationDegrees(Mth.lerp(var3, var1.xRotO, var1.getXRot())));
      boolean var7 = false;
      float var8 = 0.0F;
      float var9 = 0.5F;
      float var10 = 0.0F;
      ...
      if (var17 > 0.0F) {
         ...
         var4.mulPose(Vector3f.field_294.rotationDegrees(var18));
      }

      var4.mulPose(Vector3f.field_290.rotationDegrees(45.0F));
      ...
      for(int var22 = 0; var22 < 4; ++var22) {
         var4.mulPose(Vector3f.field_290.rotationDegrees(90.0F));
   ...
   public void vertex(Matrix4f var1, Matrix3f var2, VertexConsumer var3, int var4, int var5, int var6, float var7, float var8, int var9, int var10, int var11, int var12) {
      var3.vertex(var1, (float)var4, (float)var5, (float)var6).color(255, 255, 255, 255).method_7(var7, var8).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(var12).normal(var2, (float)var9, (float)var11, (float)var10).endVertex();
   }
}
