...
public class SpawnerRenderer implements BlockEntityRenderer<SpawnerBlockEntity> {
   ...
   public void submit(SpawnerBlockEntity var1, float var2, PoseStack var3, int var4, int var5, Vec3 var6, @Nullable ModelFeatureRenderer.CrumblingOverlay var7, SubmitNodeCollector var8) {
      ...
      if (var9 != null) {
         ...
         if (var11 != null) {
            submitEntityInSpawner(var2, var3, var8, var11, this.entityRenderer, var10.getoSpin(), var10.getSpin());
         }

      }
   }

   public static void submitEntityInSpawner(float var0, PoseStack var1, SubmitNodeCollector var2, Entity var3, EntityRenderDispatcher var4, double var5, double var7) {
      var1.pushPose();
      ...
      var4.submit(var11, 0.0, 0.0, 0.0, var1, var2);
      var1.popPose();
   }
}
