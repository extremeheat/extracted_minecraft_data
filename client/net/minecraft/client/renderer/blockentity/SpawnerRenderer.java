...
public class SpawnerRenderer implements BlockEntityRenderer<SpawnerBlockEntity> {
   ...
   public void render(SpawnerBlockEntity var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
      ...
      if (var8 != null) {
         ...
         var3.mulPose(Vector3f.field_292.rotationDegrees((float)Mth.lerp((double)var2, var7.getoSpin(), var7.getSpin()) * 10.0F));
         var3.translate(0.0D, -0.20000000298023224D, 0.0D);
         var3.mulPose(Vector3f.field_290.rotationDegrees(-30.0F));
