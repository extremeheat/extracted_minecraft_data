...
public class ConduitRenderer implements BlockEntityRenderer<ConduitBlockEntity> {
   ...
   public void render(ConduitBlockEntity var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
      ...
      if (!var1.isActive()) {
         ...
         var3.translate(0.5D, 0.5D, 0.5D);
         if (var11 == 1) {
            var3.mulPose(Vector3f.field_290.rotationDegrees(90.0F));
         } else if (var11 == 2) {
            var3.mulPose(Vector3f.field_294.rotationDegrees(90.0F));
         }
         ...
         var3.mulPose(Vector3f.field_290.rotationDegrees(180.0F));
         var3.mulPose(Vector3f.field_294.rotationDegrees(180.0F));
         this.wind.render(var3, var12, var5, var6);
         var3.popPose();
         ...
         var3.mulPose(Vector3f.field_292.rotationDegrees(var14));
         var3.mulPose(Vector3f.field_290.rotationDegrees(var13.getXRot()));
         var3.mulPose(Vector3f.field_294.rotationDegrees(180.0F));
