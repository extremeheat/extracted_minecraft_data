...
public class ConduitRenderer implements BlockEntityRenderer<ConduitBlockEntity, CondiutRenderState> {
   ...
   public void submit(CondiutRenderState var1, PoseStack var2, SubmitNodeCollector var3) {
      if (!var1.isActive) {
         ...
         float var4 = var1.activeRotation * 57.295776F;
         float var5 = Mth.sin(var1.animTime * 0.1F) / 2.0F + 0.5F;
         var5 = var5 * var5 + var5;
         var2.pushPose();
         var2.translate(0.5F, 0.3F + var5 * 0.2F, 0.5F);
         Vector3f var6 = (new Vector3f(0.5F, 1.0F, 0.5F)).normalize();
         var2.mulPose((Quaternionfc)(new Quaternionf()).rotationAxis(var4 * 0.017453292F, var6));
         ...
         Material var7 = var1.animationPhase == 1 ? VERTICAL_WIND_TEXTURE : WIND_TEXTURE;
         RenderType var8 = var7.renderType(RenderType::entityCutoutNoCull);
         TextureAtlasSprite var9 = this.materials.get(var7);
         var3.submitModelPart(this.wind, var2, var8, var1.lightCoords, OverlayTexture.NO_OVERLAY, var9);
         var2.popPose();
         var2.pushPose();
         var2.translate(0.5F, 0.5F, 0.5F);
         ...
         var3.submitModelPart(this.wind, var2, var8, var1.lightCoords, OverlayTexture.NO_OVERLAY, var9);
         var2.popPose();
         Camera var10 = this.renderer.camera;
         var2.pushPose();
         var2.translate(0.5F, 0.3F + var5 * 0.2F, 0.5F);
         var2.scale(0.5F, 0.5F, 0.5F);
         float var11 = -var10.getYRot();
         var2.mulPose((Quaternionfc)(new Quaternionf()).rotationYXZ(var11 * 0.017453292F, var10.getXRot() * 0.017453292F, 3.1415927F));
         float var12 = 1.3333334F;
         var2.scale(1.3333334F, 1.3333334F, 1.3333334F);
         Material var13 = var1.isHunting ? OPEN_EYE_TEXTURE : CLOSED_EYE_TEXTURE;
         var3.submitModelPart(this.eye, var2, var13.renderType(RenderType::entityCutoutNoCull), var1.lightCoords, OverlayTexture.NO_OVERLAY, this.materials.get(var13));
         var2.popPose();
      }
   }
