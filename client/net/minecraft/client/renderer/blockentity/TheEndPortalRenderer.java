...
public class TheEndPortalRenderer<T extends TheEndPortalBlockEntity> implements BlockEntityRenderer<T> {
   ...
   public void render(T var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
      ...
      this.renderCube((T)var1, var7, var4.getBuffer(this.renderType()));
   }

   private void renderCube(T var1, Matrix4f var2, VertexConsumer var3) {
      float var4 = this.getOffsetDown();
      float var5 = this.getOffsetUp();
      this.renderFace((T)var1, var2, var3, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, Direction.SOUTH);
      this.renderFace((T)var1, var2, var3, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, Direction.NORTH);
      this.renderFace((T)var1, var2, var3, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, Direction.EAST);
      this.renderFace((T)var1, var2, var3, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F, Direction.WEST);
      this.renderFace((T)var1, var2, var3, 0.0F, 1.0F, var4, var4, 0.0F, 0.0F, 1.0F, 1.0F, Direction.DOWN);
      this.renderFace((T)var1, var2, var3, 0.0F, 1.0F, var5, var5, 1.0F, 1.0F, 0.0F, 0.0F, Direction.UP);
   }
