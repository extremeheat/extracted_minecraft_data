...
public class SuspiciousSandRenderer implements BlockEntityRenderer<SuspiciousSandBlockEntity> {
   ...
   public SuspiciousSandRenderer(BlockEntityRendererProvider.Context var1) {
      super();
      this.itemRenderer = var1.getItemRenderer();
   }

   public void render(SuspiciousSandBlockEntity var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
