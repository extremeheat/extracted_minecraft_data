...
public class RenderPipelines {
   ...
   private static final RenderPipeline.Snippet FOG_NO_COLOR_SNIPPET;
   ...
   private static final RenderPipeline.Snippet CODE_SNIPPET;
   private static final RenderPipeline.Snippet MATRICES_COLOR_FOG_SNIPPET;
   private static final RenderPipeline.Snippet MATRICES_COLOR_FOG_OFFSET_SNIPPET;
   private static final RenderPipeline.Snippet MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET;
   private static final RenderPipeline.Snippet TERRAIN_SNIPPET;
   private static final RenderPipeline.Snippet SKY_BLOCK_SNIPPET;
   ...
   private static final RenderPipeline.Snippet MAP_PORTAL_SNIPPET;
   ...
   public static final RenderPipeline SKY_BLOCK;
   ...
   public static final RenderPipeline VERY_BRIGHT_VERY_HOT_FIRE;
   ...
   public static final RenderPipeline MAP_GATEWAY;
   ...
   public static final RenderPipeline HUB_SKY;
   ...
   public static final RenderPipeline CODE_SKY;
   public static final RenderPipeline CODE_PANORAMA;
   public static final RenderPipeline GUI;
   public static final RenderPipeline GUI_OVERLAY;
   public static final RenderPipeline GUI_TEXT_HIGHLIGHT;
   public static final RenderPipeline GUI_GHOST_RECIPE_OVERLAY;
   public static final RenderPipeline GUI_TEXTURED;
   public static final RenderPipeline GUI_TEXTURED_OVERLAY;
   ...
   static {
      MATRICES_SNIPPET = RenderPipeline.builder().withUniform("ModelViewMat", UniformType.MATRIX4X4).withUniform("ProjMat", UniformType.MATRIX4X4).buildSnippet();
      FOG_NO_COLOR_SNIPPET = RenderPipeline.builder().withUniform("FogStart", UniformType.FLOAT).withUniform("FogEnd", UniformType.FLOAT).withUniform("FogShape", UniformType.INT).buildSnippet();
      FOG_SNIPPET = RenderPipeline.builder(FOG_NO_COLOR_SNIPPET).withUniform("FogColor", UniformType.VEC4).buildSnippet();
      MATRICES_COLOR_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET).withUniform("ColorModulator", UniformType.VEC4).buildSnippet();
      CODE_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withUniform("GameTime", UniformType.FLOAT).withUniform("ScreenSize", UniformType.VEC2).buildSnippet();
      MATRICES_COLOR_FOG_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET, FOG_SNIPPET).buildSnippet();
      MATRICES_COLOR_FOG_OFFSET_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withUniform("ModelOffset", UniformType.VEC3).buildSnippet();
      MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET, FOG_SNIPPET).withUniform("Light0_Direction", UniformType.VEC3).withUniform("Light1_Direction", UniformType.VEC3).buildSnippet();
      TERRAIN_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_OFFSET_SNIPPET).withVertexShader("core/terrain").withFragmentShader("core/terrain").withSampler("Sampler0").withSampler("Sampler2").withVertexFormat(DefaultVertexFormat.BLOCK, VertexFormat.Mode.QUADS).buildSnippet();
      SKY_BLOCK_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_OFFSET_SNIPPET).withUniform("TextureMat", UniformType.MATRIX4X4).withVertexShader("core/sky_block").withFragmentShader("core/sky_block").withSampler("Sampler0").withSampler("Sampler1").withSampler("Sampler2").withVertexFormat(DefaultVertexFormat.BLOCK, VertexFormat.Mode.QUADS).buildSnippet();
      ENTITY_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET).withVertexShader("core/entity").withFragmentShader("core/entity").withSampler("Sampler0").withSampler("Sampler2").withVertexFormat(DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS).buildSnippet();
      BEACON_BEAM_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withVertexShader("core/rendertype_beacon_beam").withFragmentShader("core/rendertype_beacon_beam").withSampler("Sampler0").withVertexFormat(DefaultVertexFormat.BLOCK, VertexFormat.Mode.QUADS).buildSnippet();
      TEXT_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withBlend(BlendFunction.TRANSLUCENT).withVertexFormat(DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS).buildSnippet();
      END_PORTAL_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET, FOG_SNIPPET).withVertexShader("core/rendertype_end_portal").withFragmentShader("core/rendertype_end_portal").withSampler("Sampler0").withSampler("Sampler1").withUniform("GameTime", UniformType.FLOAT).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS).buildSnippet();
      MAP_PORTAL_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET, FOG_SNIPPET).withVertexShader("core/rendertype_end_portal").withFragmentShader("core/rendertype_end_portal").withSampler("Sampler0").withSampler("Sampler1").withUniform("GameTime", UniformType.FLOAT).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS).buildSnippet();
      CLOUDS_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_OFFSET_SNIPPET).withVertexShader("core/rendertype_clouds").withFragmentShader("core/rendertype_clouds").withBlend(BlendFunction.TRANSLUCENT).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS).buildSnippet();
      ...
      DEBUG_FILLED_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withVertexShader("core/position_color").withFragmentShader("core/position_color").withBlend(BlendFunction.TRANSLUCENT).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS).buildSnippet();
      PARTICLE_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withVertexShader("core/particle").withFragmentShader("core/particle").withSampler("Sampler0").withSampler("Sampler2").withVertexFormat(DefaultVertexFormat.PARTICLE, VertexFormat.Mode.QUADS).buildSnippet();
      WEATHER_SNIPPET = RenderPipeline.builder(PARTICLE_SNIPPET).withBlend(BlendFunction.TRANSLUCENT).withCull(false).buildSnippet();
      GUI_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withVertexShader("core/gui").withFragmentShader("core/gui").withBlend(BlendFunction.TRANSLUCENT).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS).buildSnippet();
      GUI_TEXTURED_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withVertexShader("core/position_tex_color").withFragmentShader("core/position_tex_color").withSampler("Sampler0").withBlend(BlendFunction.TRANSLUCENT).withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS).buildSnippet();
      OUTLINE_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withVertexShader("core/rendertype_outline").withFragmentShader("core/rendertype_outline").withSampler("Sampler0").withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS).buildSnippet();
      POST_PROCESSING_SNIPPET = RenderPipeline.builder().withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS).withUniform("ProjMat", UniformType.MATRIX4X4).withUniform("OutSize", UniformType.VEC2).buildSnippet();
      SOLID = register(RenderPipeline.builder(TERRAIN_SNIPPET).withLocation("pipeline/solid").build());
      SKY_BLOCK = register(RenderPipeline.builder(SKY_BLOCK_SNIPPET).withLocation("pipeline/sky_block").build());
      ...
      LIGHTNING = register(RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withLocation("pipeline/lightning").withVertexShader("core/rendertype_lightning").withFragmentShader("core/rendertype_lightning").withBlend(BlendFunction.LIGHTNING).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS).build());
      DRAGON_RAYS = register(RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withLocation("pipeline/dragon_rays").withVertexShader("core/rendertype_lightning").withFragmentShader("core/rendertype_lightning").withDepthWrite(false).withBlend(BlendFunction.LIGHTNING).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.TRIANGLES).build());
      DRAGON_RAYS_DEPTH = register(RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withLocation("pipeline/dragon_rays_depth").withVertexShader("core/position").withFragmentShader("core/position").withColorWrite(false).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.TRIANGLES).build());
      ...
      MAP_GATEWAY = register(RenderPipeline.builder(MAP_PORTAL_SNIPPET).withLocation("pipeline/end_gateway").withShaderDefine("PORTAL_LAYERS", 16).build());
      ...
      DEBUG_LINE_STRIP = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/debug_line_strip").withVertexShader("core/position_color").withFragmentShader("core/position_color").withCull(false).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.DEBUG_LINE_STRIP).build());
      ...
      WORLD_BORDER = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/world_border").withVertexShader("core/rendertype_world_border").withFragmentShader("core/rendertype_world_border").withSampler("Sampler0").withUniform("TextureMat", UniformType.MATRIX4X4).withUniform("ModelOffset", UniformType.VEC3).withBlend(BlendFunction.OVERLAY).withCull(false).withVertexFormat(DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.QUADS).withDepthBias(-3.0F, -3.0F).build());
      ...
      SKY = register(RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withLocation("pipeline/sky").withVertexShader("core/position").withFragmentShader("core/position").withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.TRIANGLE_FAN).build());
      END_SKY = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/end_sky").withVertexShader("core/position_tex_color").withFragmentShader("core/position_tex_color").withSampler("Sampler0").withBlend(BlendFunction.TRANSLUCENT).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS).build());
      HUB_SKY = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/hub_sky").withVertexShader("core/position_tex_color").withFragmentShader("core/position_tex_color").withSampler("Sampler0").withBlend(BlendFunction.TRANSLUCENT).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS).build());
      SUNRISE_SUNSET = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/sunrise_sunset").withVertexShader("core/position_color").withFragmentShader("core/position_color").withBlend(BlendFunction.TRANSLUCENT).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.TRIANGLE_FAN).build());
      STARS = register(RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withLocation("pipeline/stars").withVertexShader("core/position").withFragmentShader("core/position").withBlend(BlendFunction.OVERLAY).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS).build());
      CELESTIAL = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/celestial").withVertexShader("core/position_tex_color").withFragmentShader("core/position_tex_color").withSampler("Sampler0").withBlend(BlendFunction.OVERLAY).withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS).build());
      CODE_SKY = register(RenderPipeline.builder(CODE_SNIPPET).withLocation("pipeline/code").withVertexShader("core/position_tex").withFragmentShader("core/rain").withSampler("Sampler0").withDepthWrite(false).withVertexFormat(DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.QUADS).build());
      CODE_PANORAMA = register(RenderPipeline.builder(CODE_SNIPPET).withLocation("pipeline/code_panorama").withVertexShader("core/position_tex").withFragmentShader("core/title_rain").withSampler("Sampler0").withDepthWrite(false).withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withColorWrite(true, false).withBlend(BlendFunction.PANORAMA).withVertexFormat(DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.QUADS).build());
      GUI = register(RenderPipeline.builder(GUI_SNIPPET).withLocation("pipeline/gui").build());
      GUI_OVERLAY = register(RenderPipeline.builder(GUI_SNIPPET).withLocation("pipeline/gui_overlay").withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).build());
      GUI_TEXT_HIGHLIGHT = register(RenderPipeline.builder(GUI_SNIPPET).withLocation("pipeline/gui_text_highlight").withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withColorLogic(LogicOp.OR_REVERSE).build());
      GUI_GHOST_RECIPE_OVERLAY = register(RenderPipeline.builder(GUI_SNIPPET).withLocation("pipeline/gui_ghost_recipe_overlay").withDepthTestFunction(DepthTestFunction.GREATER_DEPTH_TEST).withDepthWrite(false).build());
      GUI_TEXTURED = register(RenderPipeline.builder(GUI_TEXTURED_SNIPPET).withLocation("pipeline/gui_textured").build());
      GUI_TEXTURED_OVERLAY = register(RenderPipeline.builder(GUI_TEXTURED_SNIPPET).withLocation("pipeline/gui_textured_overlay").withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).build());
      ...
      GUI_NAUSEA_OVERLAY = register(RenderPipeline.builder(GUI_TEXTURED_SNIPPET).withLocation("pipeline/gui_nausea_overlay").withBlend(BlendFunction.ADDITIVE).withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).build());
      VIGNETTE = register(RenderPipeline.builder(GUI_TEXTURED_SNIPPET).withLocation("pipeline/vignette").withBlend(new BlendFunction(SourceFactor.ZERO, DestFactor.ONE_MINUS_SRC_COLOR)).withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).build());
      ...
      MOJANG_LOGO = register(RenderPipeline.builder(GUI_TEXTURED_SNIPPET).withLocation("pipeline/mojang_logo").withBlend(new BlendFunction(SourceFactor.SRC_ALPHA, DestFactor.ONE)).withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).withDepthWrite(false).build());
      ...
      PANORAMA = register(RenderPipeline.builder(MATRICES_COLOR_SNIPPET).withLocation("pipeline/panorama").withVertexShader("core/position_tex").withFragmentShader("core/position_tex").withSampler("Sampler0").withDepthWrite(false).withColorWrite(true, false).withBlend(BlendFunction.PANORAMA).withVertexFormat(DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.QUADS).build());
      ...
      LIGHTMAP = register(RenderPipeline.builder().withLocation("pipeline/lightmap").withVertexShader("core/blit_screen").withFragmentShader("core/lightmap").withUniform("AmbientLightFactor", UniformType.FLOAT).withUniform("SkyFactor", UniformType.FLOAT).withUniform("BlockFactor", UniformType.FLOAT).withUniform("UseBrightLightmap", UniformType.INT).withUniform("SkyLightColor", UniformType.VEC3).withUniform("NightVisionFactor", UniformType.FLOAT).withUniform("DarknessScale", UniformType.FLOAT).withUniform("DarkenWorldFactor", UniformType.FLOAT).withUniform("BrightnessFactor", UniformType.FLOAT).withVertexFormat(DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS).withDepthWrite(false).withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).build());
   }
}
