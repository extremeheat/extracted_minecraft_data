...
public class ClientTelemetryManager {
   ...
   public ClientTelemetryManager(Minecraft var1, UserApiService var2, Optional<String> var3, Optional<String> var4, UUID var5) {
      ...
      if (!SharedConstants.IS_RUNNING_IN_IDE) {
         ...
         this.telemetrySession.eventSetupFunction(var0 -> var0.addProperty("eventTimestampUtc", TelemetryConstants.TIMESTAMP_FORMATTER.format(Instant.now())));
      } else {
   ...
   private static void addOptionalProperty(String var0, Optional<String> var1, TelemetryPropertyContainer var2) {
      var1.ifPresentOrElse(var2x -> var2.addProperty(var0, var2x), () -> var2.addNullProperty(var0));
   }

   public void onPlayerInfoReceived(GameType var1, boolean var2) {
      this.playerInfo = new ClientTelemetryManager.PlayerInfo(var1, var2);
   ...
   private void sendWorldLoadEvent(ClientTelemetryManager.PlayerInfo var1) {
