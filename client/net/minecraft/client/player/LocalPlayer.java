...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   private void sendPosition() {
      ...
      if (this.isControlledCamera()) {
         ...
         if (this.isPassenger()) {
            ...
            this.connection.send((Packet)(new ServerboundMovePlayerPacket.PosRot(var15.field_414, -999.0D, var15.field_416, this.getYRot(), this.getXRot(), this.onGround)));
            var13 = false;
         } else if (var13 && var14) {
      ...
      if (this.suffocatesAt(var5)) {
         ...
         if (var10 != null) {
            ...
            if (var10.getAxis() == Direction.Axis.field_500) {
               this.setDeltaMovement(0.1D * (double)var10.getStepX(), var22.field_415, var22.field_416);
            } else {
               this.setDeltaMovement(var22.field_414, var22.field_415, 0.1D * (double)var10.getStepZ());
            }
         }
   ...
   public void openItemGui(ItemStack var1, InteractionHand var2) {
      if (var1.method_87(Items.WRITABLE_BOOK)) {
   ...
   public void aiStep() {
      ...
      if (this.input.jumping && !var6 && !var1 && !this.getAbilities().flying && !this.isPassenger() && !this.onClimbable()) {
         ...
         if (var8.method_87(Items.ELYTRA) && ElytraItem.isFlyEnabled(var8) && this.tryToStartFallFlying()) {
   ...
   public void rideTick() {
      ...
      if (this.getVehicle() instanceof Boat) {
         ...
         var1.setInput(this.input.left, this.input.right, this.input.field_373, this.input.down);
         this.handsBusy |= this.input.left || this.input.right || this.input.field_373 || this.input.down;
      }
   ...
   protected void updateAutoJump(float var1, float var2) {
      if (this.canAutoJump()) {
         ...
         if (var7 <= 0.001F) {
            ...
            float var9 = var6 * var8.field_412;
            float var10 = var6 * var8.field_413;
            var11 = Mth.sin(this.getYRot() * 0.017453292F);
            float var12 = Mth.cos(this.getYRot() * 0.017453292F);
            var5 = new Vec3((double)(var9 * var12 - var10 * var11), var5.field_415, (double)(var10 * var12 + var9 * var11));
         ...
         var11 = (float)(var43.field_414 * var42.field_414 + var43.field_416 * var42.field_416);
         if (!(var11 < -0.15F)) {
            CollisionContext var44 = CollisionContext.method_14(this);
                     ...
                     if (var35.intersects(var26, var27) || var35.intersects(var28, var29)) {
                        ...
                        while(true) {
                           ...
                           if (!(var34 = var39.getCollisionShape(this.level, var38, var44)).isEmpty()) {
                              var33 = (float)var34.max(Direction.Axis.field_501) + (float)var38.getY();
   ...
   protected boolean isHorizontalCollisionMinor(Vec3 var1) {
      ...
      double var13 = Mth.square(var1.field_414) + Mth.square(var1.field_416);
      if (!(var11 < 9.999999747378752E-6D) && !(var13 < 9.999999747378752E-6D)) {
         double var15 = var7 * var1.field_414 + var9 * var1.field_416;
   ...
   private boolean isMoving() {
      ...
      return var1.field_412 != 0.0F || var1.field_413 != 0.0F;
   }
