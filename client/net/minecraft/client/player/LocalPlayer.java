...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   private void sendChat(MessageSigner var1, String var2, @Nullable Component var3) {
      if (var3 != null) {
         MessageSignature var4 = this.signMessage(var1, var3);
         this.connection.send(new ServerboundChatPacket(var2, var4, true));
      } else {
         MessageSignature var5 = this.signMessage(var1, Component.literal(var2));
         this.connection.send(new ServerboundChatPacket(var2, var5, false));
      }
   }
   ...
   private void sendCommand(MessageSigner var1, String var2, @Nullable Component var3) {
      ...
      this.connection.send(new ServerboundChatCommandPacket(var2, var1.timeStamp(), var5, var3 != null));
   }
         ...
         if (var5 == null) {
            ...
            try {
               ...
               var4.forEach((var4x, var5x) -> {
                  ...
                  MessageSignature var7x = var1.sign(var5, var6x);
                  var6.put(var4x, var7x.saltSignature().signature());
               });
