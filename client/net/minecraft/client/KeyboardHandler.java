...
public class KeyboardHandler {
   ...
   private void copyCreateEntityCommand(ResourceLocation var1, Vec3 var2, @Nullable CompoundTag var3) {
      ...
      if (var3 != null) {
         ...
         var4 = String.format(Locale.ROOT, "/summon %s %.2f %.2f %.2f %s", var1.toString(), var2.field_414, var2.field_415, var2.field_416, var5);
      } else {
         var4 = String.format(Locale.ROOT, "/summon %s %.2f %.2f %.2f", var1.toString(), var2.field_414, var2.field_415, var2.field_416);
      }
   ...
   public void tick() {
      if (this.debugCrashKeyTime > 0L) {
         ...
         if (var3 < 0L) {
            ...
            CrashReport var7 = new CrashReport("Manually triggered debug crash", new Throwable());
            CrashReportCategory var8 = var7.addCategory("Manual crash details");
            NativeModuleLister.addCrashSection(var8);
