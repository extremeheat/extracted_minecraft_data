...
public class ItemColors {
   ...
   public static ItemColors createDefault(BlockColors var0) {
      ...
      var1.register((var0x, var1x) -> {
         if (var1x != 1) {
            ...
            if (var4 == 0) {
               ...
               return ARGB.opaque(var3x.getInt(0));
            } else {
               int var5 = 0;
               int var6 = 0;
               int var7 = 0;
      ...
      var1.register(
         (var0x, var1x) -> var1x > 0 ? -1 : ARGB.opaque(var0x.getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).getColor()),
         Items.POTION,
         Items.SPLASH_POTION,
      ...
      for (SpawnEggItem var3 : SpawnEggItem.eggs()) {
         var1.register((var1x, var2) -> ARGB.opaque(var3.getColor(var2)), var3);
      }
      ...
      var1.register((var0x, var1x) -> var1x == 0 ? -1 : ARGB.opaque(var0x.getOrDefault(DataComponents.MAP_COLOR, MapItemColor.DEFAULT).rgb()), Items.FILLED_MAP);
      return var1;
   }
