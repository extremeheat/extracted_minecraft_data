...
public class BlockTintCache {
   ...
   public int getColor(BlockPos var1) {
      ...
      BlockTintCache.LatestCacheInfo var4 = (BlockTintCache.LatestCacheInfo)this.latestChunkOnThread.get();
      if (var4.field_158 != var2 || var4.field_159 != var3 || var4.cache == null) {
         var4.field_158 = var2;
         var4.field_159 = var3;
   ...
   private BlockTintCache.CacheData findOrCreateChunkCache(int var1, int var2) {
      ...
      BlockTintCache.CacheData var5;
      BlockTintCache.CacheData var6;
      label125: {
         try {
            var5 = (BlockTintCache.CacheData)this.cache.get(var3);
            if (var5 == null) {
               break label125;
            }
      ...
      try {
         ...
         if (var5 == null) {
            ...
            BlockTintCache.CacheData var7 = var6;
            return var7;
         }
   ...
   static class LatestCacheInfo {
      ...
      public int field_158 = -2147483648;
      // $FF: renamed from: z int
      public int field_159 = -2147483648;
      @Nullable
