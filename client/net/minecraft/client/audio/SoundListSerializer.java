      ...
      if (var4.has("sounds")) {
         ...
         for(int var8 = 0; var8 < var7.size(); ++var8) {
            ...
            if (JsonUtils.func_151211_a(var9)) {
               ...
               if (var11.has("volume")) {
                  float var13 = JsonUtils.func_151217_k(var11, "volume");
                  Validate.isTrue(var13 > 0.0F, "Invalid volume", new Object[0]);
                  var10.func_148553_a(var13);
               }

               if (var11.has("pitch")) {
                  float var14 = JsonUtils.func_151217_k(var11, "pitch");
                  Validate.isTrue(var14 > 0.0F, "Invalid pitch", new Object[0]);
                  var10.func_148559_b(var14);
               }

               if (var11.has("weight")) {
                  int var15 = JsonUtils.func_151203_m(var11, "weight");
                  Validate.isTrue(var15 > 0, "Invalid weight", new Object[0]);
                  var10.func_148554_a(var15);
               }
