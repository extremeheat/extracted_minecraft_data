...
public class SuffixArray<T> {
   ...
   private String getString(int var1) {
      ...
      for(int var5 = 0; var3 + var5 < this.chars.size(); ++var5) {
         ...
         int var6 = this.chars.get(var3 + var5);
         if (var6 == -1) {
            break;
         }
   ...
   public List<T> search(String var1) {
      ...
      while(var3 < var4) {
         ...
         if (DEBUG_COMPARISONS) {
            LOGGER.debug("comparing lower \"{}\" with {} \"{}\": {}", var1, var5, this.getString(var5), var6);
         }
      ...
      if (var3 >= 0 && var3 < var2) {
         ...
         while(var3 < var4) {
            ...
            if (DEBUG_COMPARISONS) {
               LOGGER.debug("comparing upper \"{}\" with {} \"{}\": {}", var1, var6, this.getString(var6), var7);
            }
