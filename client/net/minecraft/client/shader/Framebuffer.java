...
public class Framebuffer {
   ...
   public void func_178038_a(int var1, int var2, boolean var3) {
      if (OpenGlHelper.func_148822_b()) {
         ...
         var9.func_181662_b(0.0D, (double)var5, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
         var9.func_181662_b((double)var4, (double)var5, 0.0D).func_181673_a((double)var6, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
         var9.func_181662_b((double)var4, 0.0D, 0.0D).func_181673_a((double)var6, (double)var7).func_181669_b(255, 255, 255, 255).func_181675_d();
         var9.func_181662_b(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, (double)var7).func_181669_b(255, 255, 255, 255).func_181675_d();
         var8.func_78381_a();
         this.func_147606_d();
