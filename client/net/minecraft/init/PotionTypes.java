...
public class PotionTypes {
   ...
   public static final PotionType field_203185_t;
   public static final PotionType field_203186_u;
   public static final PotionType field_203187_v;
   public static final PotionType field_203188_w;
   ...
   public static final PotionType field_204841_O;
   public static final PotionType field_204842_P;

   private static PotionType func_185217_a(String var0) {
      PotionType var1 = (PotionType)IRegistry.field_212621_j.func_82594_a(new ResourceLocation(var0));
      if (!field_185228_K.add(var1)) {
   ...
   static {
      if (!Bootstrap.func_179869_a()) {
         ...
         field_185228_K = Sets.newHashSet(new PotionType[]{(PotionType)null});
         ...
         field_203185_t = func_185217_a("strong_slowness");
         field_203186_u = func_185217_a("turtle_master");
         field_203187_v = func_185217_a("long_turtle_master");
         field_203188_w = func_185217_a("strong_turtle_master");
         ...
         field_204841_O = func_185217_a("slow_falling");
         field_204842_P = func_185217_a("long_slow_falling");
