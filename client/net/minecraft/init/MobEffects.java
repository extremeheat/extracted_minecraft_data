...
public class MobEffects {
   ...
   public static final Potion field_204839_B;
   public static final Potion field_205136_C;
   public static final Potion field_206827_D;

   @Nullable
   private static Potion func_188422_a(String var0) {
      Potion var1 = (Potion)IRegistry.field_212631_t.func_212608_b(new ResourceLocation(var0));
      if (var1 == null) {
   ...
   static {
      if (!Bootstrap.func_179869_a()) {
         ...
         field_204839_B = func_188422_a("slow_falling");
         field_205136_C = func_188422_a("conduit_power");
         field_206827_D = func_188422_a("dolphins_grace");
      }
   }
}
