...
public class SharedConstants {
   ...
   @Deprecated
   public static final int WORLD_VERSION = 3836;
   @Deprecated
   public static final String SERIES = "main";
   @Deprecated
   public static final String VERSION_STRING = "1.20.5-rc3";
   @Deprecated
   public static final int RELEASE_NETWORK_PROTOCOL_VERSION = 766;
   @Deprecated
   public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 191;
