...
public class V705 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(
         ...
         var1x -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(var1), "Items", DSL.list(References.ITEM_STACK.in(var1)))
      );
      registerMob(var1, var2, "minecraft:chicken");
      var1.register(var2, "minecraft:commandblock_minecart", var1x -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(var1)));
      ...
      var1.register(var2, "minecraft:enderman", var1x -> DSL.optionalFields("carried", References.BLOCK_NAME.in(var1), V100.equipment(var1)));
      ...
      var1.register(
         ...
         var1x -> DSL.optionalFields("Block", References.BLOCK_NAME.in(var1), "TileEntityData", References.BLOCK_ENTITY.in(var1))
      );
      ...
      var1.register(
         var2, "minecraft:spawner_minecart", var1x -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(var1), References.UNTAGGED_SPAWNER.in(var1))
      );
