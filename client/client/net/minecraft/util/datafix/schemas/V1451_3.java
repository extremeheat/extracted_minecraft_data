...
public class V1451_3 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:arrow", () -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(var1)));
      var1.register(var2, "minecraft:enderman", () -> DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in(var1), V100.equipment(var1)));
      var1.register(
         var2,
         "minecraft:falling_block",
         () -> DSL.optionalFields("BlockState", References.BLOCK_STATE.in(var1), "TileEntityData", References.BLOCK_ENTITY.in(var1))
      );
      var1.register(var2, "minecraft:spectral_arrow", () -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(var1)));
      var1.register(
         var2,
         "minecraft:chest_minecart",
         () -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), "Items", DSL.list(References.ITEM_STACK.in(var1)))
      );
      ...
      var1.register(
         var2, "minecraft:spawner_minecart", () -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), References.UNTAGGED_SPAWNER.in(var1))
      );
      var1.register(var2, "minecraft:tnt_minecart", () -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1)));
      return var2;
   }
}
