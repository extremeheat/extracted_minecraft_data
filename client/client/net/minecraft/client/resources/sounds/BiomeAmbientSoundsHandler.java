...
public class BiomeAmbientSoundsHandler implements AmbientSoundHandler {
   ...
   public void tick() {
      ...
      Biome var1 = this.biomeManager.getNoiseBiomeAtPosition(this.player.getX(), this.player.getY(), this.player.getZ()).value();
      ...
      this.moodSettings
         .ifPresent(
            var1x -> {
               ...
               BlockPos var4 = BlockPos.containing(
                  this.player.getX() + (double)this.random.nextInt(var3) - (double)var1x.getBlockSearchExtent(),
                  this.player.getEyeY() + (double)this.random.nextInt(var3) - (double)var1x.getBlockSearchExtent(),
                  this.player.getZ() + (double)this.random.nextInt(var3) - (double)var1x.getBlockSearchExtent()
               );
               ...
               if (this.moodiness >= 1.0F) {
                  ...
                  SimpleSoundInstance var22 = SimpleSoundInstance.forAmbientMood(
                     ...
                     this.player.getZ() + var16 / var18 * var20
                  );
