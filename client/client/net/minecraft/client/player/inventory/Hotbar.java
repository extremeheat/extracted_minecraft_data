...
public class Hotbar {
   ...
   public static final Codec<Hotbar> CODEC = Codec.PASSTHROUGH.listOf().validate(var0 -> Util.fixedSize(var0, SIZE)).xmap(Hotbar::new, var0 -> var0.items);
   ...
   public void storeFrom(Inventory var1, RegistryAccess var2) {
      ...
      for (int var5 = 0; var5 < SIZE; var5++) {
         ...
         var4.add(var7.orElse(EMPTY_STACK));
      }
