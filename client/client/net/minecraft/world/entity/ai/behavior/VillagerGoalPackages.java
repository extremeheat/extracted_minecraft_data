...
public class VillagerGoalPackages {
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getCorePackage(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(0, ValidateNearbyPoi.create(var0.heldJobSite(), MemoryModuleType.JOB_SITE)),
         Pair.of(0, ValidateNearbyPoi.create(var0.acquirableJobSite(), MemoryModuleType.POTENTIAL_JOB_SITE)),
         Pair.of(1, new MoveToTargetSink()),
         Pair.of(2, PoiCompetitorScan.create()),
         Pair.of(3, new LookAndFollowTradingPlayerSink(var1)),
         new Pair[]{
            Pair.of(5, GoToWantedItem.create(var1, false, 4)),
            Pair.of(6, AcquirePoi.create(var0.acquirableJobSite(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true, Optional.empty())),
            Pair.of(7, new GoToPotentialJobSite(var1)),
            Pair.of(8, YieldJobSite.create(var1)),
            Pair.of(10, AcquirePoi.create(var0x -> var0x.is(PoiTypes.HOME), MemoryModuleType.HOME, false, Optional.of((byte)14))),
            Pair.of(10, AcquirePoi.create(var0x -> var0x.is(PoiTypes.MEETING), MemoryModuleType.MEETING_POINT, true, Optional.of((byte)14))),
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getWorkPackage(VillagerProfession var0, float var1) {
      ...
      return ImmutableList.of(
         ...
         Pair.of(
            ...
            new RunOne(
               ImmutableList.of(
                  ...
                  Pair.of(StrollToPoiList.create(MemoryModuleType.SECONDARY_JOB_SITE, var1, 1, 6, MemoryModuleType.JOB_SITE), 5),
         ...
         Pair.of(2, SetWalkTargetFromBlockMemory.create(MemoryModuleType.JOB_SITE, var1, 9, 100, 1200)),
         ...
         Pair.of(
            ...
            new RunOne(
               ...
               ImmutableList.of(
                  ...
                  Pair.of(VillageBoundRandomStroll.create(var0), 1),
                  Pair.of(SetWalkTargetFromLookTarget.create(var0, 2), 1),
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getRestPackage(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         Pair.of(2, SetWalkTargetFromBlockMemory.create(MemoryModuleType.HOME, var1, 1, 150, 1200)),
         Pair.of(3, ValidateNearbyPoi.create(var0x -> var0x.is(PoiTypes.HOME), MemoryModuleType.HOME)),
         ...
         Pair.of(
            ...
            new RunOne(
               ...
               ImmutableList.of(
                  Pair.of(SetClosestHomeAsWalkTarget.create(var1), 1),
                  Pair.of(InsideBrownianWalk.create(var1), 4),
                  Pair.of(GoToClosestVillage.create(var1, 4), 2),
                  Pair.of(new DoNothing(20, 40), 2)
               )
            )
         ),
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getMeetPackage(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(10, new ShowTradesToPlayer(400, 1600)),
         Pair.of(10, SetLookAndInteract.create(EntityType.PLAYER, 4)),
         Pair.of(2, SetWalkTargetFromBlockMemory.create(MemoryModuleType.MEETING_POINT, var1, 6, 100, 200)),
         Pair.of(3, new GiveGiftToHero(100)),
         Pair.of(3, ValidateNearbyPoi.create(var0x -> var0x.is(PoiTypes.MEETING), MemoryModuleType.MEETING_POINT)),
         Pair.of(
            3,
            new GateBehavior(
               ImmutableMap.of(),
         ...
         Pair.of(
            ...
            new RunOne(
               ImmutableList.of(
                  ...
                  Pair.of(InteractWith.of(EntityType.VILLAGER, 8, AgeableMob::canBreed, AgeableMob::canBreed, MemoryModuleType.BREED_TARGET, var1, 2), 1),
                  Pair.of(InteractWith.of(EntityType.CAT, 8, MemoryModuleType.INTERACTION_TARGET, var1, 2), 1),
                  Pair.of(VillageBoundRandomStroll.create(var1), 1),
                  Pair.of(SetWalkTargetFromLookTarget.create(var1, 2), 1),
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getPanicPackage(VillagerProfession var0, float var1) {
      ...
      return ImmutableList.of(
         ...
         Pair.of(3, VillageBoundRandomStroll.create(var2, 2, 2)),
         getMinimalLookBehavior()
      );
   }
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getPreRaidPackage(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(
            ...
            TriggerGate.triggerOneShuffled(
               ImmutableList.of(
                  Pair.of(SetWalkTargetFromBlockMemory.create(MemoryModuleType.MEETING_POINT, var1 * 1.5F, 2, 150, 200), 6),
                  Pair.of(VillageBoundRandomStroll.create(var1 * 1.5F), 2)
               )
            )
         ),
         getMinimalLookBehavior(),
      ...
      return ImmutableList.of(
         Pair.of(
            ...
            BehaviorBuilder.sequence(
               ...
               TriggerGate.triggerOneShuffled(
                  ImmutableList.of(Pair.of(MoveToSkySeeingSpot.create(var1), 5), Pair.of(VillageBoundRandomStroll.create(var1 * 1.1F), 2))
               )
            )
         ),
         Pair.of(0, new CelebrateVillagersSurvivedRaid(600, 600)),
         Pair.of(
            2, BehaviorBuilder.sequence(BehaviorBuilder.triggerIf(VillagerGoalPackages::raidExistsAndActive), LocateHidingPlace.create(24, var1 * 1.4F, 1))
         ),
         getMinimalLookBehavior(),
         Pair.of(99, ResetRaidStatus.create())
      );
