...
public class TryToSniff {
   ...
   public static BehaviorControl<LivingEntity> create() {
      return BehaviorBuilder.create(
         var0 -> var0.group(
                  var0.registered(MemoryModuleType.IS_SNIFFING),
                  var0.registered(MemoryModuleType.WALK_TARGET),
                  var0.absent(MemoryModuleType.SNIFF_COOLDOWN),
                  var0.present(MemoryModuleType.NEAREST_ATTACKABLE),
                  var0.absent(MemoryModuleType.DISTURBANCE_LOCATION)
               )
