...
public class IcebergFeature extends Feature<BlockStateConfiguration> {
   ...
   private void generateIcebergBlock(
      ...
      double var16 = var10
         ? this.signedDistanceEllipse(var5, var7, BlockPos.ZERO, var9, this.getEllipseC(var6, var4, var11), var12)
         : this.signedDistanceCircle(var5, var7, BlockPos.ZERO, var8, var2);
      if (var16 < 0.0) {
            ...
            for (int var10 = 0; var10 <= var4; var10++) {
               ...
               if (isIcebergState(var12) || var12.is(Blocks.SNOW)) {
                  if (this.belowIsAir(var1, var11)) {
                     ...
                     BlockState[] var13 = new BlockState[]{
                        var1.getBlockState(var11.west()),
                        var1.getBlockState(var11.east()),
                        var1.getBlockState(var11.north()),
                        var1.getBlockState(var11.south())
                     };
                     int var14 = 0;
