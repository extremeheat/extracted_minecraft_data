   ...
   public static void bootstrap(BootstrapContext<StructureTemplatePool> var0) {
      ...
      var0.register(
         ...
         new StructureTemplatePool(
            var4,
            ImmutableList.of(
               Pair.of(StructurePoolElement.single("bastion/units/air_base", var2), 1),
               Pair.of(StructurePoolElement.single("bastion/hoglin_stable/air_base", var2), 1),
               Pair.of(StructurePoolElement.single("bastion/treasure/big_air_full", var2), 1),
               Pair.of(StructurePoolElement.single("bastion/bridge/starting_pieces/entrance_base", var2), 1)
            ),
