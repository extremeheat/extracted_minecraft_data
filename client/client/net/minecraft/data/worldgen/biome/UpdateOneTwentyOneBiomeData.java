...
public class UpdateOneTwentyOneBiomeData {
   ...
   public static void bootstrap(BootstrapContext<Biome> var0) {
      ...
      var0.register(Biomes.MANGROVE_SWAMP, OverworldBiomes.mangroveSwamp(var1, var2, var1x -> var1x.addSpawn(MobCategory.MONSTER, var3)));
      var0.register(Biomes.SWAMP, OverworldBiomes.swamp(var1, var2, var1x -> var1x.addSpawn(MobCategory.MONSTER, var3)));
   }
}
