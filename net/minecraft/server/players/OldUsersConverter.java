...
public class OldUsersConverter {
   ...
   static List readOldListFormat(File var0, Map var1) throws IOException {
   ...
   private static void lookupPlayers(MinecraftServer var0, Collection var1, ProfileLookupCallback var2) {
