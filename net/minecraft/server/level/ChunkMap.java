...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
   ...
   public ChunkMap(ServerLevel var1, File var2, DataFixer var3, StructureManager var4, Executor var5, BlockableEventLoop var6, LightChunkGetter var7, ChunkGenerator var8, ChunkProgressListener var9, Supplier var10, int var11) {
   ...
   private CompletableFuture getChunkRangeFuture(ChunkPos var1, int var2, IntFunction var3) {
   ...
   public CompletableFuture getEntityTickingRangeFuture(ChunkPos var1) {
   ...
   public CompletableFuture schedule(ChunkHolder var1, ChunkStatus var2) {
   ...
   private CompletableFuture scheduleChunkLoad(ChunkPos var1) {
   ...
   private CompletableFuture scheduleChunkGeneration(ChunkHolder var1, ChunkStatus var2) {
      ChunkPos var3 = var1.getPos();
   ...
   private CompletableFuture protoChunkToFullChunk(ChunkHolder var1) {
   ...
   public CompletableFuture postProcess(ChunkHolder var1) {
   ...
   public CompletableFuture unpackTicks(ChunkHolder var1) {
   ...
   private static String printFuture(CompletableFuture var0) {
      try {
   ...
   public Stream getPlayers(ChunkPos var1, boolean var2) {
   ...
   public CompletableFuture packTicks(LevelChunk var1) {
   ...
   class TrackedEntity {
      ...
      public void updatePlayers(List var1) {
