...
public class ServerChunkCache extends ChunkSource {
   ...
   public ServerChunkCache(ServerLevel var1, File var2, DataFixer var3, StructureManager var4, Executor var5, ChunkGenerator var6, int var7, ChunkProgressListener var8, Supplier var9) {
      this.level = var1;
   ...
   public CompletableFuture getChunkFuture(int var1, int var2, ChunkStatus var3, boolean var4) {
   ...
   private CompletableFuture getChunkFutureMainThread(int var1, int var2, ChunkStatus var3, boolean var4) {
   ...
   private boolean checkChunkFuture(long var1, Function var3) {
   ...
   public void addRegionTicket(TicketType var1, ChunkPos var2, int var3, Object var4) {
      this.distanceManager.addRegionTicket(var1, var2, var3, var4);
   }

   public void removeRegionTicket(TicketType var1, ChunkPos var2, int var3, Object var4) {
