...
public abstract class DistanceManager {
   ...
   private static int getTicketLevelAt(SortedArraySet var0) {
   ...
   public void addTicket(TicketType var1, ChunkPos var2, int var3, Object var4) {
      this.addTicket(var2.toLong(), new Ticket(var1, var3, var4));
   }

   public void removeTicket(TicketType var1, ChunkPos var2, int var3, Object var4) {
   ...
   private SortedArraySet getTickets(long var1) {
   ...
   class ChunkTicketTracker extends ChunkTracker {
      ...
      protected int getLevelFromSource(long var1) {
         ...
         if (var3 == null) {
            ...
            return var3.isEmpty() ? Integer.MAX_VALUE : ((Ticket)var3.first()).getTicketLevel();
         }
      }
