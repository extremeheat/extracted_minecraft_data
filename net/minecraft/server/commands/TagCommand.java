...
public class TagCommand {
   ...
   private static Collection getTags(Collection var0) {
   ...
   private static int addTag(CommandSourceStack var0, Collection var1, String var2) throws CommandSyntaxException {
      int var3 = 0;
   ...
   private static int removeTag(CommandSourceStack var0, Collection var1, String var2) throws CommandSyntaxException {
      int var3 = 0;
      Iterator var4 = var1.iterator();
   ...
   private static int listTags(CommandSourceStack var0, Collection var1) {
