...
public class DeOpCommands {
   ...
   private static int deopPlayers(CommandSourceStack var0, Collection var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (var2.isOp(var5)) {
            var2.deop(var5);
            ++var3;
            var0.sendSuccess(new TranslatableComponent("commands.deop.success", new Object[]{((GameProfile)var1.iterator().next()).getName()}), true);
         }
      }
