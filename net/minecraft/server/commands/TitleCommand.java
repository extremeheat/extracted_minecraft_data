...
public class TitleCommand {
   ...
   private static int clearTitle(CommandSourceStack var0, Collection var1) {
   ...
   private static int resetTitle(CommandSourceStack var0, Collection var1) {
   ...
   private static int showTitle(CommandSourceStack var0, Collection var1, Component var2, ClientboundSetTitlesPacket.Type var3) throws CommandSyntaxException {
   ...
   private static int setTimes(CommandSourceStack var0, Collection var1, int var2, int var3, int var4) {
