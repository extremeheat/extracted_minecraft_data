...
public class PardonCommand {
   ...
   private static int pardonPlayers(CommandSourceStack var0, Collection var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (var2.isBanned(var5)) {
            var2.remove(var5);
            ++var3;
            var0.sendSuccess(new TranslatableComponent("commands.pardon.success", new Object[]{ComponentUtils.getDisplayName(var5)}), true);
         }
      }
