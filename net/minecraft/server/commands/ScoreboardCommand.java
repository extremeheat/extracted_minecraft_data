...
public class ScoreboardCommand {
   ...
   private static CompletableFuture suggestTriggers(CommandSourceStack var0, Collection var1, SuggestionsBuilder var2) {
   ...
   private static int performOperation(CommandSourceStack var0, Collection var1, Objective var2, OperationArgument.Operation var3, Collection var4, Objective var5) throws CommandSyntaxException {
   ...
   private static int enableTrigger(CommandSourceStack var0, Collection var1, Objective var2) throws CommandSyntaxException {
   ...
   private static int resetScores(CommandSourceStack var0, Collection var1) {
   ...
   private static int resetScore(CommandSourceStack var0, Collection var1, Objective var2) {
      ServerScoreboard var3 = var0.getServer().getScoreboard();
   ...
   private static int setScore(CommandSourceStack var0, Collection var1, Objective var2, int var3) {
      ServerScoreboard var4 = var0.getServer().getScoreboard();
      Iterator var5 = var1.iterator();
   ...
   private static int addScore(CommandSourceStack var0, Collection var1, Objective var2, int var3) {
      ServerScoreboard var4 = var0.getServer().getScoreboard();
      int var5 = 0;
   ...
   private static int removeScore(CommandSourceStack var0, Collection var1, Objective var2, int var3) {
      ServerScoreboard var4 = var0.getServer().getScoreboard();
      int var5 = 0;
