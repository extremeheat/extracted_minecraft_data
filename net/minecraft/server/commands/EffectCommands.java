...
public class EffectCommands {
   ...
   private static int giveEffect(CommandSourceStack var0, Collection var1, MobEffect var2, @Nullable Integer var3, int var4, boolean var5) throws CommandSyntaxException {
      int var6 = 0;
      int var7;
      if (var3 != null) {
   ...
   private static int clearEffects(CommandSourceStack var0, Collection var1) throws CommandSyntaxException {
      int var2 = 0;
   ...
   private static int clearEffect(CommandSourceStack var0, Collection var1, MobEffect var2) throws CommandSyntaxException {
      int var3 = 0;
