...
public class ParticleCommand {
   ...
   private static int sendParticles(CommandSourceStack var0, ParticleOptions var1, Vec3 var2, Vec3 var3, float var4, int var5, boolean var6, Collection var7) throws CommandSyntaxException {
      int var8 = 0;
      ...
      if (var8 == 0) {
         ...
         var0.sendSuccess(new TranslatableComponent("commands.particle.success", new Object[]{Registry.PARTICLE_TYPE.getKey(var1.getType()).toString()}), true);
         return var8;
      }
   }
}
