...
public class WhitelistCommand {
   ...
   private static int addPlayers(CommandSourceStack var0, Collection var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (!var2.isWhiteListed(var5)) {
            ...
            var2.add(var6);
            var0.sendSuccess(new TranslatableComponent("commands.whitelist.add.success", new Object[]{ComponentUtils.getDisplayName(var5)}), true);
            ++var3;
         }
      }
   ...
   private static int removePlayers(CommandSourceStack var0, Collection var1) throws CommandSyntaxException {
      UserWhiteList var2 = var0.getServer().getPlayerList().getWhiteList();
      int var3 = 0;
      Iterator var4 = var1.iterator();
      ...
      while(var4.hasNext()) {
         ...
         if (var2.isWhiteListed(var5)) {
            UserWhiteListEntry var6 = new UserWhiteListEntry(var5);
            var2.remove(var6);
            var0.sendSuccess(new TranslatableComponent("commands.whitelist.remove.success", new Object[]{ComponentUtils.getDisplayName(var5)}), true);
            ++var3;
         }
      }
