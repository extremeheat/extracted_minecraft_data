...
public class OpCommand {
   ...
   private static int opPlayers(CommandSourceStack var0, Collection var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (!var2.isOp(var5)) {
            var2.op(var5);
            ++var3;
            var0.sendSuccess(new TranslatableComponent("commands.op.success", new Object[]{((GameProfile)var1.iterator().next()).getName()}), true);
         }
      }
