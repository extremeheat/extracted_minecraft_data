...
public class AdvancementCommands {
   private static final SuggestionProvider SUGGEST_ADVANCEMENTS = (var0, var1) -> {
   ...
   private static int perform(CommandSourceStack var0, Collection var1, AdvancementCommands.Action var2, Collection var3) {
      int var4 = 0;
   ...
   private static int performCriterion(CommandSourceStack var0, Collection var1, AdvancementCommands.Action var2, Advancement var3, String var4) {
      int var5 = 0;
   ...
   private static List getAdvancements(Advancement var0, AdvancementCommands.Mode var1) {
   ...
   private static void addChildren(Advancement var0, List var1) {
   ...
   static enum Action {
      ...
      public int perform(ServerPlayer var1, Iterable var2) {
         int var3 = 0;
