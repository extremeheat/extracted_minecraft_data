...
public class StorageDataAccessor implements DataAccessor {
   ...
   private static CommandStorage getGlobalTags(CommandContext var0) {
   ...
   // $FF: synthetic method
   StorageDataAccessor(CommandStorage var1, ResourceLocation var2, Object var3) {
      this(var1, var2);
   }
}
