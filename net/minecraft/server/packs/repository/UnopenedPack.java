...
public class UnopenedPack implements AutoCloseable {
   ...
   @Nullable
   public static UnopenedPack create(String var0, boolean var1, Supplier var2, UnopenedPack.UnopenedPackConstructor var3, UnopenedPack.Position var4) {
      try {
   ...
   public UnopenedPack(String var1, boolean var2, Supplier var3, Component var4, Component var5, PackCompatibility var6, UnopenedPack.Position var7, boolean var8) {
      this.id = var1;
      this.supplier = var3;
      this.title = var4;
   ...
   public UnopenedPack(String var1, boolean var2, Supplier var3, Pack var4, PackMetadataSection var5, UnopenedPack.Position var6) {
   ...
   public static enum Position {
      ...
      public int insert(List var1, Object var2, Function var3, boolean var4) {
