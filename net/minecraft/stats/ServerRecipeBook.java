...
public class ServerRecipeBook extends RecipeBook {
   ...
   public int addRecipes(Collection var1, ServerPlayer var2) {
   ...
   public int removeRecipes(Collection var1, ServerPlayer var2) {
      ArrayList var3 = Lists.newArrayList();
      int var4 = 0;
      Iterator var5 = var1.iterator();
   ...
   private void sendRecipes(ClientboundRecipePacket.State var1, ServerPlayer var2, List var3) {
   ...
   private void loadRecipes(ListTag var1, Consumer var2) {
