...
public class VillagerProfession {
   ...
   private final ImmutableSet requestedItems;
   private final ImmutableSet secondaryPoi;
   @Nullable
   private final SoundEvent workSound;

   private VillagerProfession(String var1, PoiType var2, ImmutableSet var3, ImmutableSet var4, @Nullable SoundEvent var5) {
      this.name = var1;
   ...
   public ImmutableSet getRequestedItems() {
      return this.requestedItems;
   }

   public ImmutableSet getSecondaryPoi() {
   ...
   static VillagerProfession register(String var0, PoiType var1, ImmutableSet var2, ImmutableSet var3, @Nullable SoundEvent var4) {
   ...
   static {
      ...
      FARMER = register("farmer", PoiType.FARMER, ImmutableSet.of(Items.WHEAT, Items.WHEAT_SEEDS, Items.BEETROOT_SEEDS), ImmutableSet.of(Blocks.FARMLAND), SoundEvents.VILLAGER_WORK_FARMER);
