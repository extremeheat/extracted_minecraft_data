...
public final class EntitySelector {
   ...
   public static final Predicate ENTITY_NOT_BEING_RIDDEN = (var0) -> {
      return var0.isAlive() && !var0.isVehicle() && !var0.isPassenger();
   };
   public static final Predicate CONTAINER_ENTITY_SELECTOR = (var0) -> {
      return var0 instanceof Container && var0.isAlive();
   };
   public static final Predicate NO_CREATIVE_OR_SPECTATOR = (var0) -> {
      return !(var0 instanceof Player) || !var0.isSpectator() && !((Player)var0).isCreative();
   };
   public static final Predicate NO_SPECTATORS = (var0) -> {
   ...
   public static Predicate pushableBy(Entity var0) {
   ...
   public static Predicate notRiding(Entity var0) {
      return (var1) -> {
         while(true) {
            if (var1.isPassenger()) {
