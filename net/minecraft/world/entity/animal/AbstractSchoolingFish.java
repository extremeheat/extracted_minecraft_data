...
public abstract class AbstractSchoolingFish extends AbstractFish {
   ...
   public AbstractSchoolingFish(EntityType var1, Level var2) {
      super(var1, var2);
   }
   ...
   public void tick() {
      ...
      if (this.hasFollowers() && this.level.random.nextInt(200) == 1) {
         List var1 = this.level.getEntitiesOfClass(this.getClass(), this.getBoundingBox().inflate(8.0D, 8.0D, 8.0D));
         if (var1.size() <= 1) {
            this.schoolSize = 1;
         }
      }
   ...
   public void addFollowers(Stream var1) {
