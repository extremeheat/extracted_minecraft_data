...
public class Wolf extends TamableAnimal {
   ...
   public static final Predicate PREY_SELECTOR;
   ...
   public Wolf(EntityType var1, Level var2) {
      super(var1, var2);
      this.setTame(false);
   }
   ...
   class WolfAvoidEntityGoal extends AvoidEntityGoal {
      ...
      public WolfAvoidEntityGoal(Wolf var2, Class var3, float var4, double var5, double var7) {
