...
public abstract class Animal extends AgableMob {
   ...
   protected Animal(EntityType var1, Level var2) {
      super(var1, var2);
   }
   ...
   public static boolean checkAnimalSpawnRules(EntityType var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
