...
public class MushroomCow extends Cow {
   ...
   public MushroomCow(EntityType var1, Level var2) {
      super(var1, var2);
   }
   ...
   public static boolean checkMushroomSpawnRules(EntityType var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
   ...
   private Pair getEffectFromItemStack(ItemStack var1) {
