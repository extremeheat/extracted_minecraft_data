...
public class Panda extends Animal {
   ...
   private static final Predicate PANDA_ITEMS;

   public Panda(EntityType var1, Level var2) {
      super(var1, var2);
   ...
   static class PandaAvoidGoal extends AvoidEntityGoal {
      private final Panda panda;

      public PandaAvoidGoal(Panda var1, Class var2, float var3, double var4, double var6) {
   ...
   static class PandaLookAtPlayerGoal extends LookAtPlayerGoal {
      ...
      public PandaLookAtPlayerGoal(Panda var1, Class var2, float var3) {
