...
public class PlayTagWithOtherKids extends Behavior {
   ...
   private Optional findSomeoneToChase(PathfinderMob var1) {
      return this.getFriendsNearby(var1).stream().findAny();
   }

   private Optional findSomeoneBeingChased(PathfinderMob var1) {
   ...
   private Map checkHowManyChasersEachFriendHas(PathfinderMob var1) {
   ...
   private List getFriendsNearby(PathfinderMob var1) {
