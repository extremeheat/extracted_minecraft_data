...
public class Celebrate extends Behavior {
   ...
   protected void tick(ServerLevel var1, Villager var2, long var3) {
      ...
      if (var5.nextInt(200) == 0 && MoveToSkySeeingSpot.hasNoBlocksAbove(var1, var2, new BlockPos(var2))) {
         ...
         FireworkRocketEntity var9 = new FireworkRocketEntity(var2.level, var2.getX(), var2.getEyeY(), var2.getZ(), var8);
