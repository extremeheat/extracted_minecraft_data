...
public class VillagerGoalPackages {
   public static ImmutableList getCorePackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getWorkPackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getPlayPackage(float var0) {
   ...
   public static ImmutableList getRestPackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getMeetPackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getIdlePackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getPanicPackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getPreRaidPackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getRaidPackage(VillagerProfession var0, float var1) {
   ...
   public static ImmutableList getHidePackage(VillagerProfession var0, float var1) {
      boolean var2 = true;
