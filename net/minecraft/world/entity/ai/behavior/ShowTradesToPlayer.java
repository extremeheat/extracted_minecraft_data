...
public class ShowTradesToPlayer extends Behavior {
   ...
   public boolean checkExtraStartConditions(ServerLevel var1, Villager var2) {
      ...
      if (!var3.getMemory(MemoryModuleType.INTERACTION_TARGET).isPresent()) {
         ...
         return var4.getType() == EntityType.PLAYER && var2.isAlive() && var4.isAlive() && !var2.isBaby() && var2.distanceToSqr(var4) <= 17.0D;
      }
   }
   ...
   private void displayFirstItem(Villager var1) {
      var1.setItemSlot(EquipmentSlot.MAINHAND, (ItemStack)this.displayItems.get(0));
   }
   ...
   private void displayCyclingItems(Villager var1) {
      if (this.displayItems.size() >= 2 && ++this.cycleCounter >= 40) {
         ...
         var1.setItemSlot(EquipmentSlot.MAINHAND, (ItemStack)this.displayItems.get(this.displayIndex));
      }
