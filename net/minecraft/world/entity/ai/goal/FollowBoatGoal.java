...
public class FollowBoatGoal extends Goal {
   ...
   public boolean canUse() {
      ...
      while(var3.hasNext()) {
         ...
         if (var5 instanceof LivingEntity && (Mth.abs(((LivingEntity)var5).xxa) > 0.0F || Mth.abs(((LivingEntity)var5).zza) > 0.0F)) {
            var2 = true;
            break;
         }
      }
   ...
   public void tick() {
      ...
      if (--this.timeToRecalcPath <= 0) {
         ...
         if (this.currentGoal == BoatGoals.GO_TO_BOAT) {
            ...
            BlockPos var4 = (new BlockPos(this.following)).relative(var5, 10);
