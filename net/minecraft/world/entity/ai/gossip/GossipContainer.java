...
public class GossipContainer {
   ...
   private Collection selectGossipsForTransfer(Random var1, int var2) {
   ...
   public int getReputation(UUID var1, Predicate var2) {
   ...
   public Dynamic store(DynamicOps var1) {
   ...
   static class EntityGossips {
      ...
      public int weightedValue(Predicate var1) {
      ...
      public Stream unpack(UUID var1) {
   ...
   static class GossipEntry {
      ...
      public static Optional load(Dynamic var0) {
