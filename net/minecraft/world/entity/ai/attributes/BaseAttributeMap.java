...
public abstract class BaseAttributeMap {
   ...
   public void addAttributeModifiers(Multimap var1) {
      Iterator var2 = var1.entries().iterator();
   ...
   public void assignValues(BaseAttributeMap var1) {
      this.getAttributes().forEach((var1x) -> {
         AttributeInstance var2 = var1.getInstance(var1x.getAttribute());
         if (var2 != null) {
            var1x.copyFrom(var2);
         }
