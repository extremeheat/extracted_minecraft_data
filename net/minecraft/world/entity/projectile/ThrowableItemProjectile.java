...
public abstract class ThrowableItemProjectile extends ThrowableProjectile implements ItemSupplier {
   ...
   public ThrowableItemProjectile(EntityType var1, Level var2) {
      super(var1, var2);
   }

   public ThrowableItemProjectile(EntityType var1, double var2, double var4, double var6, Level var8) {
      super(var1, var2, var4, var6, var8);
   }

   public ThrowableItemProjectile(EntityType var1, LivingEntity var2, Level var3) {
