...
public class Schedule {
   ...
   private final Map timelines = Maps.newHashMap();

   protected static ScheduleBuilder register(String var0) {
      Schedule var1 = (Schedule)Registry.register(Registry.SCHEDULE, (String)var0, new Schedule());
   ...
   protected List getAllTimelinesExceptFor(Activity var1) {
