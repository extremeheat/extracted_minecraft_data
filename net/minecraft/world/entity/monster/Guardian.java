...
public class Guardian extends Monster {
   ...
   public Guardian(EntityType var1, Level var2) {
      super(var1, var2);
      this.xpReward = 10;
   ...
   public float getWalkTargetValue(BlockPos var1, LevelReader var2) {
      return var2.getFluidState(var1).is(FluidTags.WATER) ? 10.0F + var2.getBrightness(var1) - 0.5F : super.getWalkTargetValue(var1, var2);
   }
   ...
   public static boolean checkGuardianSpawnRules(EntityType var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      return (var4.nextInt(20) == 0 || !var1.canSeeSkyFromBelowWater(var3)) && var1.getDifficulty() != Difficulty.PEACEFUL && (var2 == MobSpawnType.SPAWNER || var1.getFluidState(var3).is(FluidTags.WATER));
   }
