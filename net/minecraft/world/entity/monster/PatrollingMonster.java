...
public abstract class PatrollingMonster extends Monster {
   ...
   protected PatrollingMonster(EntityType var1, Level var2) {
      super(var1, var2);
   }
   ...
   public static boolean checkPatrollingMonsterSpawnRules(EntityType var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
   ...
   public static class LongDistancePatrolGoal extends Goal {
      ...
      public LongDistancePatrolGoal(PatrollingMonster var1, double var2, double var4) {
         this.mob = var1;
