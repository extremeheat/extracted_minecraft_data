...
public class PotionBrewing {
   private static final List POTION_MIXES = Lists.newArrayList();
   private static final List CONTAINER_MIXES = Lists.newArrayList();
   private static final List ALLOWED_CONTAINERS = Lists.newArrayList();
   private static final Predicate ALLOWED_CONTAINER = (var0) -> {
   ...
   static class Mix {
      ...
      public Mix(Object var1, Ingredient var2, Object var3) {
         this.from = var1;
