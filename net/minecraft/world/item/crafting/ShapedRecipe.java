...
public class ShapedRecipe implements CraftingRecipe {
   ...
   public ShapedRecipe(ResourceLocation var1, String var2, int var3, int var4, NonNullList var5, ItemStack var6) {
      this.id = var1;
      this.group = var2;
      this.width = var3;
      this.height = var4;
   ...
   private static NonNullList dissolvePattern(String[] var0, Map var1, int var2, int var3) {
   ...
   private static Map keyFromJson(JsonObject var0) {
