...
public final class Ingredient implements Predicate {
   private static final Predicate NON_ALL_EMPTY = (var0) -> {
   ...
   private Ingredient(Stream var1) {
   ...
   private static Ingredient fromValues(Stream var0) {
   ...
   public static Ingredient of(Tag var0) {
