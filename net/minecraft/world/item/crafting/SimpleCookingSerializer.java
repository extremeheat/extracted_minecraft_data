...
public class SimpleCookingSerializer implements RecipeSerializer {
   ...
   public SimpleCookingSerializer(SimpleCookingSerializer.CookieBaker var1, int var2) {
      this.defaultCookingTime = var2;
      this.factory = var1;
   }

   public AbstractCookingRecipe fromJson(ResourceLocation var1, JsonObject var2) {
   ...
   public AbstractCookingRecipe fromNetwork(ResourceLocation var1, FriendlyByteBuf var2) {
   ...
   public void toNetwork(FriendlyByteBuf var1, AbstractCookingRecipe var2) {
