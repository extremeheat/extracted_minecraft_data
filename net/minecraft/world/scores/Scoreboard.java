...
public class Scoreboard {
   ...
   public final void forAllObjectives(ObjectiveCriteria var1, String var2, Consumer var3) {
   ...
   public Collection getPlayerScores(Objective var1) {
   ...
   public Map getPlayerScores(String var1) {
