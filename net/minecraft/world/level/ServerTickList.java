...
public class ServerTickList implements TickList {
   ...
   public ServerTickList(ServerLevel var1, Predicate var2, Function var3, Function var4, Consumer var5) {
      this.ignore = var2;
      this.toId = var3;
      this.fromId = var4;
      this.level = var1;
   ...
   public List fetchTicksInChunk(ChunkPos var1, boolean var2, boolean var3) {
      int var4 = (var1.x << 4) - 2;
      int var5 = var4 + 16 + 2;
      int var6 = (var1.z << 4) - 2;
      int var7 = var6 + 16 + 2;
   ...
   public List fetchTicksInArea(BoundingBox var1, boolean var2, boolean var3) {
   ...
   @Nullable
   private List fetchTicksInArea(@Nullable List var1, Collection var2, BoundingBox var3, boolean var4) {
   ...
   public static ListTag saveTickList(Function var0, Iterable var1, long var2) {
   ...
   private void addTickData(TickNextTickData var1) {
