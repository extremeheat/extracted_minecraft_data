...
public class McRegionUpgrader {
   ...
   private static void convertRegions(File var0, Iterable var1, BiomeSource var2, int var3, int var4, ProgressListener var5) {
   ...
   private static void addRegionFiles(File var0, Collection var1) {
