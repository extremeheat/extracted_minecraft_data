...
public class LevelData {
   ...
   private final Set disabledDataPacks;
   private final Set enabledDataPacks;
   private final Map dimensionData;
   ...
   private void setTagData(CompoundTag var1, CompoundTag var2) {
      ...
      while(var7.hasNext()) {
         ...
         var11.add(StringTag.valueOf(var8));
      }
      ...
      while(var13.hasNext()) {
         ...
         var12.add(StringTag.valueOf(var9));
      }
