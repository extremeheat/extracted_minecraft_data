...
public class DimensionDataStorage {
   ...
   public SavedData computeIfAbsent(Supplier var1, String var2) {
   ...
   @Nullable
   public SavedData get(Supplier var1, String var2) {
   ...
   @Nullable
   private SavedData readSavedData(Supplier var1, String var2) {
      try {
