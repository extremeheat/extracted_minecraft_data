...
public abstract class LootPoolSingletonContainer extends LootPoolEntryContainer {
   ...
   public boolean expand(LootContext var1, Consumer var2) {
      if (this.canRun(var1)) {
   ...
   public abstract static class Serializer extends LootPoolEntryContainer.Serializer {
      ...
      public void serialize(JsonObject var1, LootPoolSingletonContainer var2, JsonSerializationContext var3) {
         if (var2.weight != 1) {
      ...
      public final LootPoolSingletonContainer deserialize(JsonObject var1, JsonDeserializationContext var2, LootItemCondition[] var3) {
   ...
   public abstract static class Builder extends LootPoolEntryContainer.Builder implements FunctionUserBuilder {
      ...
      public LootPoolSingletonContainer.Builder apply(LootItemFunction.Builder var1) {
      ...
      public LootPoolSingletonContainer.Builder setWeight(int var1) {
         this.weight = var1;
         return (LootPoolSingletonContainer.Builder)this.getThis();
      }

      public LootPoolSingletonContainer.Builder setQuality(int var1) {
         this.quality = var1;
         return (LootPoolSingletonContainer.Builder)this.getThis();
      }
