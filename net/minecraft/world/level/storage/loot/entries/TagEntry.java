...
public class TagEntry extends LootPoolSingletonContainer {
   ...
   private TagEntry(Tag var1, boolean var2, int var3, int var4, LootItemCondition[] var5, LootItemFunction[] var6) {
   ...
   private boolean expandTag(LootContext var1, Consumer var2) {
      if (!this.canRun(var1)) {
         return false;
      } else {
   ...
   public static LootPoolSingletonContainer.Builder expandTag(Tag var0) {
