...
public class LootTable {
   ...
   public static Consumer createStackSplitter(Consumer var0) {
      return (var1) -> {
   ...
   public void getRandomItemsRaw(LootContext var1, Consumer var2) {
   ...
   public void getRandomItems(LootContext var1, Consumer var2) {
      this.getRandomItemsRaw(var1, createStackSplitter(var2));
   }

   public List getRandomItems(LootContext var1) {
   ...
   public void fill(Container var1, LootContext var2) {
      List var3 = this.getRandomItems(var2);
   ...
   private void shuffleAndSplitItems(List var1, int var2, Random var3) {
   ...
   private List getAvailableSlots(Container var1, Random var2) {
   ...
   // $FF: synthetic method
   LootTable(LootContextParamSet var1, LootPool[] var2, LootItemFunction[] var3, Object var4) {
      this(var1, var2, var3);
   }
