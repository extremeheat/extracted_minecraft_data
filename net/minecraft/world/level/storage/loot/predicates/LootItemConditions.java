...
public class LootItemConditions {
   ...
   public static void register(LootItemCondition.Serializer var0) {
   ...
   public static LootItemCondition.Serializer getSerializer(LootItemCondition var0) {
   ...
   public static Predicate andConditions(Predicate[] var0) {
      switch(var0.length) {
      case 0:
         return (var0x) -> {
            return true;
   ...
   public static Predicate orConditions(Predicate[] var0) {
      switch(var0.length) {
      case 0:
         return (var0x) -> {
            return false;
