...
public class ProtoTickList implements TickList {
   ...
   public ProtoTickList(Predicate var1, ChunkPos var2) {
      this(var1, var2, new ListTag());
   }

   public ProtoTickList(Predicate var1, ChunkPos var2, ListTag var3) {
   ...
   public void copyOut(TickList var1, Function var2) {
