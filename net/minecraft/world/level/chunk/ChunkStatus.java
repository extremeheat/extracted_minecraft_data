...
public class ChunkStatus {
   private static final EnumSet PRE_FEATURES;
   private static final EnumSet POST_FEATURES;
   ...
   private static final List STATUS_BY_RANGE;
   ...
   private static CompletableFuture lightChunk(ChunkStatus var0, ThreadedLevelLightEngine var1, ChunkAccess var2) {
   ...
   private static ChunkStatus registerSimple(String var0, @Nullable ChunkStatus var1, int var2, EnumSet var3, ChunkStatus.ChunkType var4, ChunkStatus.SimpleGenerationTask var5) {
      return register(var0, var1, var2, var3, var4, var5);
   }

   private static ChunkStatus register(String var0, @Nullable ChunkStatus var1, int var2, EnumSet var3, ChunkStatus.ChunkType var4, ChunkStatus.GenerationTask var5) {
      return register(var0, var1, var2, var3, var4, var5, PASSTHROUGH_LOAD_TASK);
   }

   private static ChunkStatus register(String var0, @Nullable ChunkStatus var1, int var2, EnumSet var3, ChunkStatus.ChunkType var4, ChunkStatus.GenerationTask var5, ChunkStatus.LoadingTask var6) {
   ...
   ChunkStatus(String var1, @Nullable ChunkStatus var2, int var3, EnumSet var4, ChunkStatus.ChunkType var5, ChunkStatus.GenerationTask var6, ChunkStatus.LoadingTask var7) {
      this.name = var1;
   ...
   public CompletableFuture generate(ServerLevel var1, ChunkGenerator var2, StructureManager var3, ThreadedLevelLightEngine var4, Function var5, List var6) {
      return this.generationTask.doWork(this, var1, var2, var3, var4, var5, var6, (ChunkAccess)var6.get(var6.size() / 2));
   }

   public CompletableFuture load(ServerLevel var1, StructureManager var2, ThreadedLevelLightEngine var3, Function var4, ChunkAccess var5) {
   ...
   interface SimpleGenerationTask extends ChunkStatus.GenerationTask {
      default CompletableFuture doWork(ChunkStatus var1, ServerLevel var2, ChunkGenerator var3, StructureManager var4, ThreadedLevelLightEngine var5, Function var6, List var7, ChunkAccess var8) {
