...
public class PalettedContainer implements PaletteResize {
   ...
   private final PaletteResize dummyPaletteResize = (var0, var1x) -> {
      return 0;
   };
   ...
   public PalettedContainer(Palette var1, IdMapper var2, Function var3, Function var4, Object var5) {
   ...
   public int onResize(int var1, Object var2) {
      this.acquire();
   ...
   public void count(PalettedContainer.CountConsumer var1) {
