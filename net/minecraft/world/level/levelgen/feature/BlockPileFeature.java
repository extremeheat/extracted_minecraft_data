...
public class BlockPileFeature extends Feature {
   public BlockPileFeature(Function var1) {
      super(var1);
   }

   public boolean place(LevelAccessor var1, ChunkGenerator var2, Random var3, BlockPos var4, BlockPileConfiguration var5) {
      if (var4.getY() < 5) {
         return false;
      } else {
