...
public class CountWithExtraChanceHeightmapDecorator extends FeatureDecorator {
   public CountWithExtraChanceHeightmapDecorator(Function var1) {
      super(var1);
   }

   public Stream getPositions(LevelAccessor var1, ChunkGenerator var2, Random var3, FrequencyWithExtraChanceDecoratorConfiguration var4, BlockPos var5) {
      int var6 = var4.count;
