...
public class CarvingMaskDecorator extends FeatureDecorator {
   public CarvingMaskDecorator(Function var1) {
      super(var1);
   }

   public Stream getPositions(LevelAccessor var1, ChunkGenerator var2, Random var3, CarvingMaskDecoratorConfiguration var4, BlockPos var5) {
