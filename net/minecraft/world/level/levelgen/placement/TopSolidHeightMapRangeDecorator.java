...
public class TopSolidHeightMapRangeDecorator extends FeatureDecorator {
   public TopSolidHeightMapRangeDecorator(Function var1) {
      super(var1);
   }

   public Stream getPositions(LevelAccessor var1, ChunkGenerator var2, Random var3, RangeDecoratorConfiguration var4, BlockPos var5) {
      ...
      return IntStream.range(0, var6).mapToObj((var3x) -> {
         ...
         int var6 = var1.getHeight(Heightmap.Types.OCEAN_FLOOR_WG, var4, var5x);
