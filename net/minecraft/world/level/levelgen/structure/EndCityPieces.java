...
public class EndCityPieces {
   ...
   public static void startHouseTower(StructureManager var0, BlockPos var1, Rotation var2, List var3, Random var4) {
   ...
   private static EndCityPieces.EndCityPiece addHelper(List var0, EndCityPieces.EndCityPiece var1) {
      var0.add(var1);
      return var1;
   }

   private static boolean recursiveChildren(StructureManager var0, EndCityPieces.SectionGenerator var1, int var2, EndCityPieces.EndCityPiece var3, BlockPos var4, List var5, Random var6) {
      if (var2 > 8) {
         return false;
      } else {
   ...
   static {
      ...
      HOUSE_TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
         ...
         public boolean generate(StructureManager var1, int var2, EndCityPieces.EndCityPiece var3, BlockPos var4, List var5, Random var6) {
            if (var2 > 8) {
               return false;
            } else {
