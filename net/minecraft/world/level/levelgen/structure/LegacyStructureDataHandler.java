...
public class LegacyStructureDataHandler {
   private static final Map CURRENT_TO_LEGACY_MAP = (Map)Util.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Map LEGACY_TO_CURRENT_MAP = (Map)Util.make(Maps.newHashMap(), (var0) -> {
      var0.put("Iglu", "Igloo");
   ...
   public LegacyStructureDataHandler(@Nullable DimensionDataStorage var1, List var2, List var3) {
