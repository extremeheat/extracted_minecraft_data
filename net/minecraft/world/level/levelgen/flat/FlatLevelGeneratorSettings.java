...
public class FlatLevelGeneratorSettings extends ChunkGeneratorSettings {
   ...
   public static final Map STRUCTURE_FEATURES_STEP;
   public static final Map STRUCTURE_FEATURES;
   public static final Map STRUCTURE_FEATURES_DEFAULT;
   ...
   private static List getLayersInfoFromString(String var0) {
   ...
   public Dynamic toObject(DynamicOps var1) {
