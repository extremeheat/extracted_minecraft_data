...
public abstract class AbstractFurnaceBlockEntity extends BaseContainerBlockEntity implements WorldlyContainer, RecipeHolder, StackedContentsCompatible, TickableBlockEntity {
   ...
   private final Map recipesUsed;
   protected final RecipeType recipeType;

   protected AbstractFurnaceBlockEntity(BlockEntityType var1, RecipeType var2) {
      super(var1);
   ...
   private static void add(Map var0, Tag var1, int var2) {
   ...
   private static void add(Map var0, ItemLike var1, int var2) {
