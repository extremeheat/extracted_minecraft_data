...
public class BlockState extends AbstractStateHolder implements StateHolder {
   ...
   public BlockState(Block var1, ImmutableMap var2) {
      super(var1, var2);
   ...
   public List getDrops(LootContext.Builder var1) {
   ...
   public boolean isSuffocating(BlockGetter var1, BlockPos var2) {
      return this.getBlock().isSuffocating(this, var1, var2);
   }
   ...
   public static Dynamic serialize(DynamicOps var0, BlockState var1) {
   ...
   public static BlockState deserialize(Dynamic var0) {
