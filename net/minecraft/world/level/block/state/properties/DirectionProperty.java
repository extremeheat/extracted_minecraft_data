...
public class DirectionProperty extends EnumProperty {
   protected DirectionProperty(String var1, Collection var2) {
      super(var1, Direction.class, var2);
   }

   public static DirectionProperty create(String var0, Predicate var1) {
   ...
   public static DirectionProperty create(String var0, Collection var1) {
