...
public abstract class SpreadingSnowyDirtBlock extends SnowyDirtBlock {
   protected SpreadingSnowyDirtBlock(Block.Properties var1) {
      super(var1);
   }
   ...
   private static boolean canBeGrass(BlockState var0, LevelReader var1, BlockPos var2) {
      ...
      if (var4.getBlock() == Blocks.SNOW && (Integer)var4.getValue(SnowLayerBlock.LAYERS) == 1) {
         return true;
      } else {
      ...
      if (!canBeGrass(var1, var2, var3)) {
         ...
         if (var2.getMaxLocalRawBrightness(var3.above()) >= 9) {
            ...
            for(int var6 = 0; var6 < 4; ++var6) {
               ...
               if (var2.getBlockState(var7).getBlock() == Blocks.DIRT && canPropagate(var5, var2, var7)) {
                  var2.setBlockAndUpdate(var7, (BlockState)var5.setValue(SNOWY, var2.getBlockState(var7.above()).getBlock() == Blocks.SNOW));
               }
            }
         }
