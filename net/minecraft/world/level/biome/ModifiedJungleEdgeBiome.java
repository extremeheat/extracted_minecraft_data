...
public final class ModifiedJungleEdgeBiome extends Biome {
   public ModifiedJungleEdgeBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.JUNGLE).depth(0.2F).scale(0.4F).temperature(0.95F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent("jungle_edge"));
