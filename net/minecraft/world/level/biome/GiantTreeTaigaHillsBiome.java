...
public final class GiantTreeTaigaHillsBiome extends Biome {
   public GiantTreeTaigaHillsBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.TAIGA).depth(0.45F).scale(0.3F).temperature(0.3F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent((String)null));
