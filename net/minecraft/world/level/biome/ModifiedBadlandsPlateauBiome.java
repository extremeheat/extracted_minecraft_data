...
public final class ModifiedBadlandsPlateauBiome extends Biome {
   public ModifiedBadlandsPlateauBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.BADLANDS, SurfaceBuilder.CONFIG_BADLANDS).precipitation(Biome.Precipitation.NONE).biomeCategory(Biome.BiomeCategory.MESA).depth(0.45F).scale(0.3F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent("badlands_plateau"));
