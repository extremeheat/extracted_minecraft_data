...
public final class ModifiedJungleBiome extends Biome {
   public ModifiedJungleBiome() {
      super((new Biome.BiomeBuilder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.JUNGLE).depth(0.2F).scale(0.4F).temperature(0.95F).downfall(0.9F).waterColor(4159204).waterFogColor(329011).parent("jungle"));
