...
public final class TheEndBiome extends Biome {
   public TheEndBiome() {
      ...
      this.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.END_SPIKE.configured(new SpikeConfiguration(false, ImmutableList.of(), (BlockPos)null)).decorated(FeatureDecorator.NOPE.configured(DecoratorConfiguration.NONE)));
