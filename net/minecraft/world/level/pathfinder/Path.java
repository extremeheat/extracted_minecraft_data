...
public class Path {
   ...
   public Path(List var1, BlockPos var2, boolean var3) {
      this.nodes = var1;
      this.target = var2;
      this.distToTarget = var1.isEmpty() ? Float.MAX_VALUE : ((Node)this.nodes.get(this.nodes.size() - 1)).distanceManhattan(this.target);
      this.reached = var3;
   }
