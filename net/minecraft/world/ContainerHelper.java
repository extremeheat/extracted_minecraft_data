...
public class ContainerHelper {
   public static ItemStack removeItem(List var0, int var1, int var2) {
      return var1 >= 0 && var1 < var0.size() && !((ItemStack)var0.get(var1)).isEmpty() && var2 > 0 ? ((ItemStack)var0.get(var1)).split(var2) : ItemStack.EMPTY;
   }

   public static ItemStack takeItem(List var0, int var1) {
      return var1 >= 0 && var1 < var0.size() ? (ItemStack)var0.set(var1, ItemStack.EMPTY) : ItemStack.EMPTY;
   }

   public static CompoundTag saveAllItems(CompoundTag var0, NonNullList var1) {
      return saveAllItems(var0, var1, true);
   }

   public static CompoundTag saveAllItems(CompoundTag var0, NonNullList var1, boolean var2) {
   ...
   public static void loadAllItems(CompoundTag var0, NonNullList var1) {
