...
public class SlideDownBlockTrigger extends SimpleCriterionTrigger {
   ...
   public SlideDownBlockTrigger.TriggerInstance createInstance(JsonObject var1, JsonDeserializationContext var2) {
      ...
      return new SlideDownBlockTrigger.TriggerInstance(var3, var4);
   }
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static SlideDownBlockTrigger.TriggerInstance slidesDownBlock(Block var0) {
         return new SlideDownBlockTrigger.TriggerInstance(var0, StatePropertiesPredicate.ANY);
      }
