...
public class WrappedMinMaxBounds {
   ...
   public static WrappedMinMaxBounds fromReader(StringReader var0, boolean var1, Function var2) throws CommandSyntaxException {
      if (!var0.canRead()) {
   ...
   @Nullable
   private static Float optionallyFormat(@Nullable Float var0, Function var1) {
