...
public class LegacyResourcePackAdapter implements Pack {
   ...
   public static final Map V3 = (Map)Util.make(() -> {
   ...
   public LegacyResourcePackAdapter(Pack var1, Map var2) {
      this.source = var1;
      ...
      while(var4.hasNext()) {
         ...
         var3.put(var5);
         var3.put(toMetaLocation((ResourceLocation)var5.getKey()), toMetaLocation((ResourceLocation)var5.getValue()));
      }

      this.patches = var3.build();
   }
