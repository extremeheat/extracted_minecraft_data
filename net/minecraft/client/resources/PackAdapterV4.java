...
public class PackAdapterV4 implements Pack {
   private static final Map CHESTS = (Map)Util.make(Maps.newHashMap(), (var0) -> {
   ...
   public PackAdapterV4(Pack var1) {
      this.pack = var1;
   }
