...
public class MultiPartBakedModel implements BakedModel {
   ...
   public MultiPartBakedModel(List var1) {
      this.selectors = var1;
   ...
   public List getQuads(@Nullable BlockState var1, @Nullable Direction var2, Random var3) {
      if (var1 == null) {
         ...
         for(int var8 = 0; var8 < var4.length(); ++var8) {
            if (var4.get(var8)) {
               var9.addAll(((BakedModel)((Pair)this.selectors.get(var8)).getRight()).getQuads(var1, var2, new Random(var10)));
            }
         }
   ...
   public static class Builder {
      ...
      public void add(Predicate var1, BakedModel var2) {
