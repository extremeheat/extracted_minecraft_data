...
public class WolfModel extends ColorableAgeableListModel {
   ...
   public void prepareMobModel(Wolf var1, float var2, float var3, float var4) {
      if (var1.isAngry()) {
         this.tail.yRot = 0.0F;
      } else {
   ...
   public void setupAnim(Wolf var1, float var2, float var3, float var4, float var5, float var6) {
