...
public class BeeModel extends AgeableListModel {
   ...
   public void prepareMobModel(Bee var1, float var2, float var3, float var4) {
      super.prepareMobModel(var1, var2, var3, var4);
      this.rollAmount = var1.getRollAmount(var4);
      this.stinger.visible = !var1.hasStung();
   }

   public void setupAnim(Bee var1, float var2, float var3, float var4, float var5, float var6) {
      this.rightWing.xRot = 0.0F;
      this.leftAntenna.xRot = 0.0F;
      this.rightAntenna.xRot = 0.0F;
      this.bone.xRot = 0.0F;
      this.bone.y = 19.0F;
      boolean var7 = var1.onGround && var1.getDeltaMovement().lengthSqr() < 1.0E-7D;
      float var8;
      if (var7) {
         this.rightWing.yRot = -0.2618F;
         this.rightWing.zRot = 0.0F;
