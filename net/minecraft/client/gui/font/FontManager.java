...
public class FontManager implements AutoCloseable {
   ...
   private final Map fonts = Maps.newHashMap();
   private final Set providers = Sets.newHashSet();
   private final TextureManager textureManager;
   private boolean forceUnicode;
   private final PreparableReloadListener reloadListener = new SimplePreparableReloadListener() {
      protected Map prepare(ResourceManager var1, ProfilerFiller var2) {
         var2.startTick();
