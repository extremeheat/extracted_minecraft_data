...
public abstract class ScrolledSelectionList extends AbstractContainerEventHandler implements Widget {
   ...
   public void render(int var1, int var2, float var3) {
      if (this.visible) {
         ...
         var7.vertex((double)this.x0, (double)this.y1, 0.0D).uv((float)this.x0 / 32.0F, (float)(this.y1 + (int)this.yo) / 32.0F).color(32, 32, 32, 255).endVertex();
         var7.vertex((double)this.x1, (double)this.y1, 0.0D).uv((float)this.x1 / 32.0F, (float)(this.y1 + (int)this.yo) / 32.0F).color(32, 32, 32, 255).endVertex();
         var7.vertex((double)this.x1, (double)this.y0, 0.0D).uv((float)this.x1 / 32.0F, (float)(this.y0 + (int)this.yo) / 32.0F).color(32, 32, 32, 255).endVertex();
         var7.vertex((double)this.x0, (double)this.y0, 0.0D).uv((float)this.x0 / 32.0F, (float)(this.y0 + (int)this.yo) / 32.0F).color(32, 32, 32, 255).endVertex();
         var6.end();
   ...
   protected void renderList(int var1, int var2, int var3, int var4, float var5) {
      ...
      for(int var9 = 0; var9 < var6; ++var9) {
         ...
         if (this.renderSelection && this.isSelectedItem(var9)) {
            ...
            RenderSystem.color4f(var14, var14, var14, 1.0F);
