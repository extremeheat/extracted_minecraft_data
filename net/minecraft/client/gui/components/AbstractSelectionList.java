...
public abstract class AbstractSelectionList extends AbstractContainerEventHandler implements Widget {
   ...
   protected void replaceEntries(Collection var1) {
      this.children.clear();
      this.children.addAll(var1);
   }

   protected AbstractSelectionList.Entry getEntry(int var1) {
      return (AbstractSelectionList.Entry)this.children().get(var1);
   }

   protected int addEntry(AbstractSelectionList.Entry var1) {
   ...
   protected void centerScrollOn(AbstractSelectionList.Entry var1) {
      this.setScrollAmount((double)(this.children().indexOf(var1) * this.itemHeight + this.itemHeight / 2 - (this.y1 - this.y0) / 2));
   }

   protected void ensureVisible(AbstractSelectionList.Entry var1) {
   ...
   protected AbstractSelectionList.Entry remove(int var1) {
   ...
   protected boolean removeEntry(AbstractSelectionList.Entry var1) {
   ...
   class TrackedList extends AbstractList {
      ...
      public AbstractSelectionList.Entry get(int var1) {
      ...
      public void add(int var1, AbstractSelectionList.Entry var2) {
         this.delegate.add(var1, var2);
         var2.list = AbstractSelectionList.this;
      }

      public AbstractSelectionList.Entry remove(int var1) {
