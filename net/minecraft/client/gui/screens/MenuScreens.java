...
public class MenuScreens {
   ...
   public static void create(@Nullable MenuType var0, Minecraft var1, int var2, Component var3) {
      if (var0 == null) {
   ...
   @Nullable
   private static MenuScreens.ScreenConstructor getConstructor(MenuType var0) {
      return (MenuScreens.ScreenConstructor)SCREENS.get(var0);
   }

   private static void register(MenuType var0, MenuScreens.ScreenConstructor var1) {
   ...
   interface ScreenConstructor {
      default void fromPacket(Component var1, MenuType var2, Minecraft var3, int var4) {
