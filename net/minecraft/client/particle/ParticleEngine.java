...
public class ParticleEngine implements PreparableReloadListener {
   ...
   private void register(ParticleType var1, ParticleProvider var2) {
      this.providers.put(Registry.PARTICLE_TYPE.getId(var1), var2);
   }

   private void register(ParticleType var1, ParticleEngine.SpriteParticleRegistration var2) {
   ...
   private void loadParticleDescription(ResourceManager var1, ResourceLocation var2, Map var3) {
   ...
   @Nullable
   private Particle makeParticle(ParticleOptions var1, double var2, double var4, double var6, double var8, double var10, double var12) {
   ...
   private void tickParticleList(Collection var1) {
      if (!var1.isEmpty()) {
