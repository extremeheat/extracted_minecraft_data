...
public class Screenshot {
   ...
   public static void grab(File var0, int var1, int var2, RenderTarget var3, Consumer var4) {
      grab(var0, (String)null, var1, var2, var3, var4);
   }

   public static void grab(File var0, @Nullable String var1, int var2, int var3, RenderTarget var4, Consumer var5) {
   ...
   private static void _grab(File var0, @Nullable String var1, int var2, int var3, RenderTarget var4, Consumer var5) {
