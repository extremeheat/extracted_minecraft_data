...
public class EntityRenderDispatcher {
   ...
   public int getPackedLightCoords(Entity var1, float var2) {
      return this.getRenderer(var1).getPackedLightCoords(var1, var2);
   }

   private void register(EntityType var1, EntityRenderer var2) {
   ...
   public EntityRenderer getRenderer(Entity var1) {
   ...
   public void render(Entity var1, double var2, double var4, double var6, float var8, float var9, PoseStack var10, MultiBufferSource var11, int var12) {
