...
public class EvokerRenderer extends IllagerRenderer {
   ...
   public EvokerRenderer(EntityRenderDispatcher var1) {
      ...
      this.addLayer(new ItemInHandLayer(this) {
         public void render(PoseStack var1, MultiBufferSource var2, int var3, SpellcasterIllager var4, float var5, float var6, float var7, float var8, float var9, float var10) {
   ...
   public ResourceLocation getTextureLocation(SpellcasterIllager var1) {
