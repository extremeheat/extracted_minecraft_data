...
public abstract class LivingEntityRenderer extends EntityRenderer implements RenderLayerParent {
   ...
   public LivingEntityRenderer(EntityRenderDispatcher var1, EntityModel var2, float var3) {
      super(var1);
      this.model = var2;
      this.shadowRadius = var3;
   }

   protected final boolean addLayer(RenderLayer var1) {
   ...
   public void render(LivingEntity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      boolean var14 = var1.isGlowing();
      boolean var15 = this.isVisible(var1, false);
      boolean var16 = !var15 && !var1.isInvisibleTo(Minecraft.getInstance().player);
      this.model.setupAnim(var1, var13, var12, var11, var9, var21);
      ResourceLocation var17 = this.getTextureLocation(var1);
      RenderType var18;
      if (var16) {
         var18 = RenderType.entityTranslucent(var17);
      } else if (var15) {
         var18 = this.model.renderType(var17);
      } else {
         var18 = RenderType.outline(var17);
      }

      if (var15 || var16 || var14) {
   ...
   protected boolean isVisible(LivingEntity var1, boolean var2) {
      return !var1.isInvisible() || var2;
   }
   ...
   protected float getAttackAnim(LivingEntity var1, float var2) {
