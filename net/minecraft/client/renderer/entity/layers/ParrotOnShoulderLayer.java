...
public class ParrotOnShoulderLayer extends RenderLayer {
   ...
   public ParrotOnShoulderLayer(RenderLayerParent var1) {
      super(var1);
   }

   public void render(PoseStack var1, MultiBufferSource var2, int var3, Player var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      this.render(var1, var2, var3, var4, var5, var6, var9, var10, true);
      this.render(var1, var2, var3, var4, var5, var6, var9, var10, false);
   }

   private void render(PoseStack var1, MultiBufferSource var2, int var3, Player var4, float var5, float var6, float var7, float var8, boolean var9) {
