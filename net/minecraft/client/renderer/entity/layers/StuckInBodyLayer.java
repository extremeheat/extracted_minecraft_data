...
public abstract class StuckInBodyLayer extends RenderLayer {
   public StuckInBodyLayer(LivingEntityRenderer var1) {
      super(var1);
   }

   protected abstract int numStuck(LivingEntity var1);
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, LivingEntity var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      ...
      Random var12 = new Random((long)var4.getId());
      if (var11 > 0) {
         for(int var13 = 0; var13 < var11; ++var13) {
            ...
            var1.translate((double)var19, (double)var20, (double)var21);
