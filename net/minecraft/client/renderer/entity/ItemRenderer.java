...
public class ItemRenderer implements ResourceManagerReloadListener {
   ...
   private static final Set IGNORED;
   ...
   private void renderQuadList(PoseStack var1, VertexConsumer var2, List var3, ItemStack var4, int var5, int var6) {
   ...
   protected void renderGuiItem(ItemStack var1, int var2, int var3, BakedModel var4) {
      ...
      boolean var8 = !var4.isGui3d() || var7 == Items.SHIELD || var7 == Items.TRIDENT;
      if (var8) {
