...
public class BeeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private final Map beeInfosPerEntity = Maps.newHashMap();
   ...
   private Map createHiveBlacklistMap() {
   ...
   private static String getBeeUuidsAsString(Collection var0) {
      if (var0.isEmpty()) {
         return "-";
      } else {
   ...
   private static void addBeeToSetInMap(Map var0, BeeDebugRenderer.BeeInfo var1, BlockPos var2) {
   ...
   private void renderGhostHive(BlockPos var1, List var2) {
      float var3 = 0.05F;
   ...
   private void renderHiveInfo(BeeDebugRenderer.HiveInfo var1, Collection var2) {
      int var3 = 0;
      if (!var2.isEmpty()) {
   ...
   private Collection getHiveMembers(BlockPos var1) {
   ...
   public static class BeeInfo {
      ...
      public final List goals = Lists.newArrayList();
      public final Set blacklistedHives = Sets.newHashSet();
