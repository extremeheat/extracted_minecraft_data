...
public interface MultiBufferSource {
   ...
   static MultiBufferSource.BufferSource immediateWithBuffers(Map var0, BufferBuilder var1) {
   ...
   public static class BufferSource implements MultiBufferSource {
      ...
      protected final Map fixedBuffers;
      protected Optional lastState = Optional.empty();
      protected final Set startedBuffers = Sets.newHashSet();

      protected BufferSource(BufferBuilder var1, Map var2) {
         this.builder = var1;
      ...
      public void endBatch(RenderType var1) {
         ...
         boolean var3 = Objects.equals(this.lastState, Optional.of(var1));
