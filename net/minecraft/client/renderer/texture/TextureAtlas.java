...
public class TextureAtlas extends AbstractTexture implements Tickable {
   ...
   public TextureAtlas.Preparations prepareToStitch(ResourceManager var1, Stream var2, ProfilerFiller var3, int var4) {
      var3.push("preparing");
      ...
      var3.pop();
      return new TextureAtlas.Preparations(var5, var7.getWidth(), var7.getHeight(), var12, var13);
   }

   private Collection getBasicSpriteInfos(ResourceManager var1, Set var2) {
   ...
   private List getLoadedSprites(ResourceManager var1, Stitcher var2, int var3) {
      ConcurrentLinkedQueue var4 = new ConcurrentLinkedQueue();
   ...
   public static class Preparations {
      ...
      public Preparations(Set var1, int var2, int var3, int var4, List var5) {
         this.sprites = var1;
         this.width = var2;
         this.height = var3;
         this.mipLevel = var4;
