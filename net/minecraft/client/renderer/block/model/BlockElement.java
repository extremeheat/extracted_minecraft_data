...
public class BlockElement {
   ...
   public BlockElement(Vector3f var1, Vector3f var2, Map var3, @Nullable BlockElementRotation var4, boolean var5) {
      this.from = var1;
      this.to = var2;
      this.faces = var3;
      this.rotation = var4;
   ...
   public static class Deserializer implements JsonDeserializer {
      ...
      private Map getFaces(JsonDeserializationContext var1, JsonObject var2) {
      ...
      private Map filterNullFromFaces(JsonDeserializationContext var1, JsonObject var2) {
