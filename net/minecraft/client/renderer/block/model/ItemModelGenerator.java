...
public class ItemModelGenerator {
   ...
   public BlockModel generateBlockModel(Function var1, BlockModel var2) {
   ...
   private List processFrames(int var1, String var2, TextureAtlasSprite var3) {
   ...
   private List createSideElements(TextureAtlasSprite var1, String var2, int var3) {
   ...
   private void checkTransition(ItemModelGenerator.SpanFacing var1, List var2, TextureAtlasSprite var3, int var4, int var5, int var6, int var7, int var8, boolean var9) {
