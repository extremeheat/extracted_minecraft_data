...
public class TheEndPortalRenderer extends BlockEntityRenderer {
   ...
   private static final List RENDER_TYPES = (List)IntStream.range(0, 16).mapToObj((var0) -> {
   ...
   private void renderCube(TheEndPortalBlockEntity var1, float var2, float var3, Matrix4f var4, VertexConsumer var5) {
   ...
   private void renderFace(TheEndPortalBlockEntity var1, Matrix4f var2, VertexConsumer var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, Direction var15) {
