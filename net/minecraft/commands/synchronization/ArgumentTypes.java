...
public class ArgumentTypes {
   ...
   private static final Map BY_CLASS = Maps.newHashMap();
   private static final Map BY_NAME = Maps.newHashMap();

   public static void register(String var0, Class var1, ArgumentSerializer var2) {
   ...
   public static void serialize(FriendlyByteBuf var0, ArgumentType var1) {
   ...
   private static void serializeToJson(JsonObject var0, ArgumentType var1) {
      ArgumentTypes.Entry var2 = get(var1);
      if (var2 == null) {
   ...
   public static JsonObject serializeNodeToJson(CommandDispatcher var0, CommandNode var1) {
   ...
   static class Entry {
      ...
      public final ArgumentSerializer serializer;
      public final ResourceLocation name;

      private Entry(Class var1, ArgumentSerializer var2, ResourceLocation var3) {
         this.clazz = var1;
      ...
      // $FF: synthetic method
      Entry(Class var1, ArgumentSerializer var2, ResourceLocation var3, Object var4) {
         this(var1, var2, var3);
      }
   }
}
