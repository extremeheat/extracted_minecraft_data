...
public class NbtPathArgument implements ArgumentType {
   ...
   public static NbtPathArgument.NbtPath getPath(CommandContext var0, String var1) {
   ...
   private static Predicate createTagPredicate(CompoundTag var0) {
      return (var1) -> {
   ...
   static class MatchRootObjectNode implements NbtPathArgument.Node {
      ...
      public void getTag(Tag var1, List var2) {
      ...
      public void getOrCreateTag(Tag var1, Supplier var2, List var3) {
      ...
      public int setTag(Tag var1, Supplier var2) {
         return 0;
      }
   ...
   interface Node {
      ...
      default List get(List var1) {
         return this.collect(var1, this::getTag);
      }

      default List getOrCreate(List var1, Supplier var2) {
         return this.collect(var1, (var2x, var3) -> {
            this.getOrCreateTag(var2x, var2, var3);
         });
      }

      default List collect(List var1, BiConsumer var2) {
   ...
   public static class NbtPath {
      ...
      public NbtPath(String var1, NbtPathArgument.Node[] var2, Object2IntMap var3) {
         this.original = var1;
         this.nodes = var2;
         this.nodeToOriginalPosition = var3;
      }

      public List get(Tag var1) throws CommandSyntaxException {
      ...
      private List getOrCreateParents(Tag var1) throws CommandSyntaxException {
         List var2 = Collections.singletonList(var1);
      ...
      public List getOrCreate(Tag var1, Supplier var2) throws CommandSyntaxException {
      ...
      private static int apply(List var0, Function var1) {
         return (Integer)var0.stream().map(var1).reduce(0, (var0x, var1x) -> {
            return var0x + var1x;
         });
      }

      public int set(Tag var1, Supplier var2) throws CommandSyntaxException {
         List var3 = this.getOrCreateParents(var1);
         NbtPathArgument.Node var4 = this.nodes[this.nodes.length - 1];
