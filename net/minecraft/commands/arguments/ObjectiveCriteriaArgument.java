...
public class ObjectiveCriteriaArgument implements ArgumentType {
   ...
   public static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType((var0) -> {
      return new TranslatableComponent("argument.criteria.invalid", new Object[]{var0});
   });
   ...
   public static ObjectiveCriteria getCriteria(CommandContext var0, String var1) {
   ...
   public CompletableFuture listSuggestions(CommandContext var1, SuggestionsBuilder var2) {
      ArrayList var3 = Lists.newArrayList(ObjectiveCriteria.CRITERIA_BY_NAME.keySet());
   ...
   public String getName(StatType var1, Object var2) {
