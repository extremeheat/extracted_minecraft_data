...
public class EntityArgument implements ArgumentType {
   ...
   public static Entity getEntity(CommandContext var0, String var1) throws CommandSyntaxException {
   ...
   public static Collection getEntities(CommandContext var0, String var1) throws CommandSyntaxException {
   ...
   public static Collection getOptionalEntities(CommandContext var0, String var1) throws CommandSyntaxException {
      return ((EntitySelector)var0.getArgument(var1, EntitySelector.class)).findEntities((CommandSourceStack)var0.getSource());
   }

   public static Collection getOptionalPlayers(CommandContext var0, String var1) throws CommandSyntaxException {
   ...
   public static ServerPlayer getPlayer(CommandContext var0, String var1) throws CommandSyntaxException {
   ...
   public static Collection getPlayers(CommandContext var0, String var1) throws CommandSyntaxException {
