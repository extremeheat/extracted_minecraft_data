...
public class Vec3Argument implements ArgumentType {
   ...
   public static Vec3 getVec3(CommandContext var0, String var1) throws CommandSyntaxException {
      return ((Coordinates)var0.getArgument(var1, Coordinates.class)).getPosition((CommandSourceStack)var0.getSource());
   }

   public static Coordinates getCoordinates(CommandContext var0, String var1) {
