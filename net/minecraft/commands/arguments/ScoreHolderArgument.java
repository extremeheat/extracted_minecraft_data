...
public class ScoreHolderArgument implements ArgumentType {
   public static final SuggestionProvider SUGGEST_SCORE_HOLDERS = (var0, var1) -> {
   ...
   public static String getName(CommandContext var0, String var1) throws CommandSyntaxException {
      return (String)getNames(var0, var1).iterator().next();
   }

   public static Collection getNames(CommandContext var0, String var1) throws CommandSyntaxException {
      return getNames(var0, var1, Collections::emptyList);
   }

   public static Collection getNamesWithDefaultWildcard(CommandContext var0, String var1) throws CommandSyntaxException {
   ...
   public static Collection getNames(CommandContext var0, String var1, Supplier var2) throws CommandSyntaxException {
   ...
   public static class SelectorResult implements ScoreHolderArgument.Result {
      ...
      public Collection getNames(CommandSourceStack var1, Supplier var2) throws CommandSyntaxException {
