...
public class EntitySelectorParser {
   ...
   public static final BiConsumer ORDER_ARBITRARY = (var0, var1) -> {
   };
   public static final BiConsumer ORDER_NEAREST = (var0, var1) -> {
      var1.sort((var1x, var2) -> {
         return Doubles.compare(var1x.distanceToSqr(var0), var2.distanceToSqr(var0));
      });
   };
   public static final BiConsumer ORDER_FURTHEST = (var0, var1) -> {
      var1.sort((var1x, var2) -> {
         return Doubles.compare(var2.distanceToSqr(var0), var1x.distanceToSqr(var0));
      });
   };
   public static final BiConsumer ORDER_RANDOM = (var0, var1) -> {
      Collections.shuffle(var1);
   };
   public static final BiFunction SUGGEST_NOTHING = (var0, var1) -> {
   ...
   private Predicate createRotationPredicate(WrappedMinMaxBounds var1, ToDoubleFunction var2) {
   ...
   public void setOrder(BiConsumer var1) {
      this.order = var1;
   }
   ...
   private CompletableFuture suggestNameOrSelector(SuggestionsBuilder var1, Consumer var2) {
      var2.accept(var1);
      if (this.allowSelectors) {
   ...
   private CompletableFuture suggestName(SuggestionsBuilder var1, Consumer var2) {
      SuggestionsBuilder var3 = var1.createOffset(this.startPosition);
      var2.accept(var3);
      return var1.add(var3).buildFuture();
   }

   private CompletableFuture suggestSelector(SuggestionsBuilder var1, Consumer var2) {
   ...
   private CompletableFuture suggestOpenOptions(SuggestionsBuilder var1, Consumer var2) {
      var1.suggest(String.valueOf('['));
      return var1.buildFuture();
   }

   private CompletableFuture suggestOptionsKeyOrClose(SuggestionsBuilder var1, Consumer var2) {
      var1.suggest(String.valueOf(']'));
      EntitySelectorOptions.suggestNames(this, var1);
      return var1.buildFuture();
   }

   private CompletableFuture suggestOptionsKey(SuggestionsBuilder var1, Consumer var2) {
      EntitySelectorOptions.suggestNames(this, var1);
      return var1.buildFuture();
   }

   private CompletableFuture suggestOptionsNextOrClose(SuggestionsBuilder var1, Consumer var2) {
      var1.suggest(String.valueOf(','));
      var1.suggest(String.valueOf(']'));
      return var1.buildFuture();
   }
   ...
   public void setSuggestions(BiFunction var1) {
      this.suggestions = var1;
   }

   public CompletableFuture fillSuggestions(SuggestionsBuilder var1, Consumer var2) {
