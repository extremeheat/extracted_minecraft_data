...
public class EntityAnchorArgument implements ArgumentType {
   ...
   public static EntityAnchorArgument.Anchor getAnchor(CommandContext var0, String var1) {
   ...
   public static enum Anchor {
      ...
      private static final Map BY_NAME = (Map)Util.make(Maps.newHashMap(), (var0) -> {
