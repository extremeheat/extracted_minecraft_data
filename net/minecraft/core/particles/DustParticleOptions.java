...
public class DustParticleOptions implements ParticleOptions {
   ...
   public static final ParticleOptions.Deserializer DESERIALIZER = new ParticleOptions.Deserializer() {
      public DustParticleOptions fromCommand(ParticleType var1, StringReader var2) throws CommandSyntaxException {
         var2.expect(' ');
      ...
      public DustParticleOptions fromNetwork(ParticleType var1, FriendlyByteBuf var2) {
