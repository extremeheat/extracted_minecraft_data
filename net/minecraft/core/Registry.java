...
public abstract class Registry implements IdMap {
   ...
   public static final Registry BLOCKSTATE_PROVIDER_TYPES = registerSimple("block_state_provider_type", () -> {
      return BlockStateProviderType.SIMPLE_STATE_PROVIDER;
   });
   public static final Registry BLOCK_PLACER_TYPES = registerSimple("block_placer_type", () -> {
      return BlockPlacerType.SIMPLE_BLOCK_PLACER;
   });
   public static final Registry FOLIAGE_PLACER_TYPES = registerSimple("foliage_placer_type", () -> {
      return FoliagePlacerType.BLOB_FOLIAGE_PLACER;
   });
   public static final Registry TREE_DECORATOR_TYPES = registerSimple("tree_decorator_type", () -> {
   ...
   private static Registry registerSimple(String var0, Supplier var1) {
      return internalRegister(var0, new MappedRegistry(), var1);
   }

   private static DefaultedRegistry registerDefaulted(String var0, String var1, Supplier var2) {
      return (DefaultedRegistry)internalRegister(var0, new DefaultedRegistry(var1), var2);
   }

   private static WritableRegistry internalRegister(String var0, WritableRegistry var1, Supplier var2) {
   ...
   public static Object register(Registry var0, String var1, Object var2) {
      return register(var0, new ResourceLocation(var1), var2);
   }

   public static Object register(Registry var0, ResourceLocation var1, Object var2) {
      return ((WritableRegistry)var0).register(var1, var2);
   }

   public static Object registerMapping(Registry var0, int var1, String var2, Object var3) {
