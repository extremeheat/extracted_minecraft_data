...
public enum Direction implements StringRepresentable {
   ...
   private static final Map BY_NAME = (Map)Arrays.stream(VALUES).collect(Collectors.toMap(Direction::getName, (var0) -> {
      return var0;
   }));
   ...
   private static final Long2ObjectMap BY_NORMAL = (Long2ObjectMap)Arrays.stream(VALUES).collect(Collectors.toMap((var0) -> {
   ...
   public static enum Axis implements StringRepresentable, Predicate {
      ...
      private static final Map BY_NAME = (Map)Arrays.stream(values()).collect(Collectors.toMap(Direction.Axis::getName, (var0) -> {
         return var0;
      }));
      private final String name;
