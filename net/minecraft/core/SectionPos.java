...
public class SectionPos extends Vec3i {
   ...
   public static Stream cube(SectionPos var0, int var1) {
      int var2 = var0.x();
      int var3 = var0.y();
      int var4 = var0.z();
   ...
   public static Stream aroundChunk(ChunkPos var0, int var1) {
      int var2 = var0.x;
      int var3 = var0.z;
   ...
   public static Stream betweenClosedStream(final int var0, final int var1, final int var2, final int var3, final int var4, final int var5) {
      return StreamSupport.stream(new AbstractSpliterator((long)((var3 - var0 + 1) * (var4 - var1 + 1) * (var5 - var2 + 1)), 64) {
