...
public class ServerPlaceRecipe implements PlaceRecipe {
   ...
   public ServerPlaceRecipe(RecipeBookMenu var1) {
      this.menu = var1;
   }

   public void recipeClicked(ServerPlayer var1, @Nullable Recipe var2, boolean var3) {
   ...
   protected void handleRecipeClicked(Recipe var1, boolean var2) {
