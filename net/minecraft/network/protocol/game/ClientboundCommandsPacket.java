...
public class ClientboundCommandsPacket implements Packet {
   ...
   public ClientboundCommandsPacket(RootCommandNode var1) {
      this.root = var1;
   }
   ...
   @Nullable
   private ArgumentBuilder createBuilder(FriendlyByteBuf var1, byte var2) {
      int var3 = var2 & 3;
      if (var3 == 2) {
   ...
   private void writeNode(FriendlyByteBuf var1, CommandNode var2, Map var3) {
      byte var4 = 0;
   ...
   static class Entry {
      ...
      private Entry(@Nullable ArgumentBuilder var1, byte var2, int var3, int[] var4) {
         this.builder = var1;
         this.flags = var2;
         this.redirect = var3;
         this.children = var4;
