...
public class ClientboundLevelParticlesPacket implements Packet {
   ...
   public ClientboundLevelParticlesPacket(ParticleOptions var1, boolean var2, double var3, double var5, double var7, float var9, float var10, float var11, float var12, int var13) {
      this.particle = var1;
   ...
   private ParticleOptions readParticle(FriendlyByteBuf var1, ParticleType var2) {
