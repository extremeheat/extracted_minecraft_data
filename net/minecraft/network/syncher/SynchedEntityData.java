...
public class SynchedEntityData {
   ...
   public static EntityDataAccessor defineId(Class var0, EntityDataSerializer var1) {
   ...
   public void define(EntityDataAccessor var1, Object var2) {
      int var3 = var1.getId();
      if (var3 > 254) {
   ...
   private void createDataItem(EntityDataAccessor var1, Object var2) {
   ...
   private SynchedEntityData.DataItem getItem(EntityDataAccessor var1) {
   ...
   public Object get(EntityDataAccessor var1) {
      return this.getItem(var1).getValue();
   }

   public void set(EntityDataAccessor var1, Object var2) {
   ...
   public static void pack(List var0, FriendlyByteBuf var1) throws IOException {
      if (var0 != null) {
         int var2 = 0;
   ...
   private static void writeDataItem(FriendlyByteBuf var0, SynchedEntityData.DataItem var1) throws IOException {
   ...
   @Nullable
   public static List unpack(FriendlyByteBuf var0) throws IOException {
      ArrayList var1 = null;
   ...
   private static SynchedEntityData.DataItem genericHelper(FriendlyByteBuf var0, int var1, EntityDataSerializer var2) {
      return new SynchedEntityData.DataItem(var2.createAccessor(var1), var2.read(var0));
   }

   public void assignValues(List var1) {
      this.lock.writeLock().lock();
   ...
   public static class DataItem {
      ...
      public DataItem(EntityDataAccessor var1, Object var2) {
         this.accessor = var1;
         this.value = var2;
         this.dirty = true;
      }
