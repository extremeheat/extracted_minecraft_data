...
public class BlockLoot implements Consumer {
   ...
   private static final Set EXPLOSION_RESISTANT;
   ...
   private static Object applyExplosionDecay(ItemLike var0, FunctionUserBuilder var1) {
      return !EXPLOSION_RESISTANT.contains(var0.asItem()) ? var1.apply(ApplyExplosionDecay.explosionDecay()) : var1.unwrap();
   }

   private static Object applyExplosionCondition(ItemLike var0, ConditionUserBuilder var1) {
   ...
   private static LootTable.Builder createSinglePropConditionTable(Block var0, Property var1, Comparable var2) {
   ...
   private void add(Block var1, Function var2) {
