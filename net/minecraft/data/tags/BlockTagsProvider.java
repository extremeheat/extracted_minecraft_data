...
public class BlockTagsProvider extends TagsProvider {
   ...
   protected void addTags() {
      ...
      this.tag(BlockTags.BAMBOO_PLANTABLE_ON).add((Object)Blocks.BAMBOO).add((Object)Blocks.BAMBOO_SAPLING).add((Object)Blocks.GRAVEL).addTag(BlockTags.SAND).add((Object)Blocks.DIRT).add((Object)Blocks.GRASS_BLOCK).add((Object)Blocks.PODZOL).add((Object)Blocks.COARSE_DIRT).add((Object)Blocks.MYCELIUM);
