...
public class ShapedRecipeBuilder {
   ...
   public ShapedRecipeBuilder define(Character var1, Tag var2) {
   ...
   public void save(Consumer var1) {
      this.save(var1, Registry.ITEM.getKey(this.result));
   }

   public void save(Consumer var1, String var2) {
   ...
   public void save(Consumer var1, ResourceLocation var2) {
   ...
   class Result implements FinishedRecipe {
      ...
      public Result(ResourceLocation var2, Item var3, int var4, String var5, List var6, Map var7, Advancement.Builder var8, ResourceLocation var9) {
         this.id = var2;
         this.result = var3;
         this.count = var4;
         this.group = var5;
