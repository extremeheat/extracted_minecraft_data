...
public class ShapelessRecipeBuilder {
   ...
   public ShapelessRecipeBuilder requires(Tag var1) {
   ...
   public static class Result implements FinishedRecipe {
      ...
      public Result(ResourceLocation var1, Item var2, int var3, String var4, List var5, Advancement.Builder var6, ResourceLocation var7) {
         this.id = var1;
         this.result = var2;
         this.count = var3;
         this.group = var4;
