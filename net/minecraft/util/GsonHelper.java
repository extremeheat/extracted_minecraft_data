...
public class GsonHelper {
   ...
   public static Object convertToObject(@Nullable JsonElement var0, String var1, JsonDeserializationContext var2, Class var3) {
      if (var0 != null) {
   ...
   public static Object getAsObject(JsonObject var0, String var1, JsonDeserializationContext var2, Class var3) {
      if (var0.has(var1)) {
   ...
   public static Object getAsObject(JsonObject var0, String var1, Object var2, JsonDeserializationContext var3, Class var4) {
   ...
   @Nullable
   public static Object fromJson(Gson var0, Reader var1, Class var2, boolean var3) {
      try {
   ...
   @Nullable
   public static Object fromJson(Gson var0, Reader var1, Type var2, boolean var3) {
      try {
         JsonReader var4 = new JsonReader(var1);
         var4.setLenient(var3);
   ...
   @Nullable
   public static Object fromJson(Gson var0, String var1, Type var2, boolean var3) {
      return fromJson(var0, (Reader)(new StringReader(var1)), (Type)var2, var3);
   }

   @Nullable
   public static Object fromJson(Gson var0, String var1, Class var2, boolean var3) {
      return fromJson(var0, (Reader)(new StringReader(var1)), (Class)var2, var3);
   }

   @Nullable
   public static Object fromJson(Gson var0, Reader var1, Type var2) {
      return fromJson(var0, var1, var2, false);
   }

   @Nullable
   public static Object fromJson(Gson var0, String var1, Type var2) {
      return fromJson(var0, var1, var2, false);
   }

   @Nullable
   public static Object fromJson(Gson var0, Reader var1, Class var2) {
      return fromJson(var0, var1, var2, false);
   }

   @Nullable
   public static Object fromJson(Gson var0, String var1, Class var2) {
      return fromJson(var0, var1, var2, false);
   }
