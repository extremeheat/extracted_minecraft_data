...
public class SortedArraySet extends AbstractSet {
   ...
   private SortedArraySet(int var1, Comparator var2) {
   ...
   public static SortedArraySet create(int var0) {
      return new SortedArraySet(var0, Comparator.naturalOrder());
   }

   private static Object[] castRawArray(Object[] var0) {
      return (Object[])var0;
   }
   ...
   private void addInternal(Object var1, int var2) {
   ...
   private Object getInternal(int var1) {
      return this.contents[var1];
   }

   public Object addOrGet(Object var1) {
      int var2 = this.findIndex(var1);
      if (var2 >= 0) {
