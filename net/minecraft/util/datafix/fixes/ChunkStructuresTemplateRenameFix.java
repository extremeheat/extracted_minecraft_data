...
public class ChunkStructuresTemplateRenameFix extends DataFix {
      ...
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", var1, (var2x) -> {
         return var2x.updateTyped(var2, (var2xx) -> {
            return var2xx.update(DSL.remainderFinder(), (var2) -> {
               return this.fixTag((Dynamic)var2x.get(DSL.remainderFinder()), var2);
            });
         });
      });
   }
   ...
   private Dynamic fixTag(Dynamic var1, Dynamic var2) {
      String var3 = var1.get("id").asString("");
      if (RENAMES.containsKey(var3)) {
         Pair var4 = (Pair)RENAMES.get(var3);
         if (((String)var4.getFirst()).equals(var2.get("id").asString(""))) {
            String var5 = var2.get("Template").asString("");
