...
public class EntityIdFix extends DataFix {
   private static final Map ID_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   public EntityIdFix(Schema var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type var4 = this.getOutputSchema().getType(References.ITEM_STACK);
