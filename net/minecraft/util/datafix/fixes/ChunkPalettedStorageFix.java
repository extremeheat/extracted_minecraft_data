...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   private static final Map FLOWER_POT_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Map SKULL_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Map DOOR_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Map NOTE_BLOCK_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Int2ObjectMap DYE_COLOR_MAP = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (var0) -> {
      var0.put(0, "white");
      var0.put(1, "orange");
      var0.put(2, "magenta");
   ...
   private static final Map BED_BLOCK_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   private static final Map BANNER_BLOCK_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
      ObjectIterator var1 = DYE_COLOR_MAP.int2ObjectEntrySet().iterator();
   ...
   private static void mapSkull(Map var0, int var1, String var2, String var3) {
   ...
   private static void mapDoor(Map var0, String var1, int var2) {
   ...
   private static void addBeds(Map var0, int var1, String var2) {
   ...
   private static void addBanners(Map var0, int var1, String var2) {
   ...
   public static int idFor(CrudeIncrementalIntIdentityHashBiMap var0, Dynamic var1) {
