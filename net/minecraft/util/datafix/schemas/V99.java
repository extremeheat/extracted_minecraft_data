...
public class V99 extends Schema {
   ...
   private static final Map ITEM_TO_BLOCKENTITY = (Map)DataFixUtils.make(Maps.newHashMap(), (var0) -> {
   ...
   protected static final HookFunction ADD_NAMES = new HookFunction() {
      public Object apply(DynamicOps var1, Object var2) {
   ...
   protected static void registerThrowableProjectile(Schema var0, Map var1, String var2) {
      var0.register(var1, var2, () -> {
         return DSL.optionalFields("inTile", References.BLOCK_NAME.in(var0));
      });
   }

   protected static void registerMinecart(Schema var0, Map var1, String var2) {
      var0.register(var1, var2, () -> {
   ...
   protected static Object addNames(Dynamic var0, Map var1, String var2) {
