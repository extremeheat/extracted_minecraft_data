...
public class ObjectOpenHashSet<K> extends AbstractObjectSet<K> implements Serializable, Cloneable, Hash {
   ...
   public ObjectOpenHashSet(int var1, float var2) {
      super();
   ...
   public ObjectOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public ObjectOpenHashSet(Collection<? extends K> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ObjectOpenHashSet(Collection<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ObjectOpenHashSet(ObjectCollection<? extends K> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ObjectOpenHashSet(ObjectCollection<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ObjectOpenHashSet(Iterator<? extends K> var1, float var2) {
      this(16, var2);
   ...
   public ObjectOpenHashSet(Iterator<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ObjectOpenHashSet(K[] var1, int var2, int var3, float var4) {
   ...
   public ObjectOpenHashSet(K[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public ObjectOpenHashSet(K[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public ObjectOpenHashSet(K[] var1) {
      this(var1, 0.75F);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var7 = this.realSize(); var7-- != 0; var4[var6] = var2[var5]) {
         ...
         if (var4[var6 = HashCommon.mix(var2[var5].hashCode()) & var3] != null) {
   ...
   public ObjectOpenHashSet<K> clone() {
      ...
      try {
         var1 = (ObjectOpenHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var4 = this.size; var4-- != 0; var2[var5] = var3) {
         ...
         if (var3 == null) {
            var5 = this.n;
            this.containsNull = true;
         } else if (var2[var5 = HashCommon.mix(var3.hashCode()) & this.mask] != null) {
   ...
   private class SetIterator implements ObjectIterator<K> {
      ...
      public K next() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNull) {
               ...
               Object[] var1 = ObjectOpenHashSet.this.key;
      ...
      private final void shiftKeys(int var1) {
         Object[] var5 = ObjectOpenHashSet.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & ObjectOpenHashSet.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & ObjectOpenHashSet.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
