...
public final class Reference2ReferenceFunctions {
   ...
   public static <K, V> Reference2ReferenceFunction<K, V> singleton(K var0, V var1) {
      return new Reference2ReferenceFunctions.Singleton(var0, var1);
   }

   public static <K, V> Reference2ReferenceFunction<K, V> synchronize(Reference2ReferenceFunction<K, V> var0) {
      return new Reference2ReferenceFunctions.SynchronizedFunction(var0);
   }

   public static <K, V> Reference2ReferenceFunction<K, V> synchronize(Reference2ReferenceFunction<K, V> var0, Object var1) {
      return new Reference2ReferenceFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K, V> Reference2ReferenceFunction<K, V> unmodifiable(Reference2ReferenceFunction<K, V> var0) {
      return new Reference2ReferenceFunctions.UnmodifiableFunction(var0);
   }
   ...
   public static class UnmodifiableFunction<K, V> extends AbstractReference2ReferenceFunction<K, V> implements Serializable {
      ...
      protected UnmodifiableFunction(Reference2ReferenceFunction<K, V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K, V> implements Reference2ReferenceFunction<K, V>, Serializable {
      ...
      protected SynchronizedFunction(Reference2ReferenceFunction<K, V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Reference2ReferenceFunction<K, V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
