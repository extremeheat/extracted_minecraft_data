...
public class Object2BooleanRBTreeMap<K> extends AbstractObject2BooleanSortedMap<K> implements Serializable, Cloneable {
   ...
   public Object2BooleanRBTreeMap(Comparator<? super K> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Object2BooleanRBTreeMap(Map<? extends K, ? extends Boolean> var1) {
      this();
      this.putAll(var1);
   }

   public Object2BooleanRBTreeMap(SortedMap<K, Boolean> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2BooleanRBTreeMap(Object2BooleanMap<? extends K> var1) {
      this();
      this.putAll(var1);
   }

   public Object2BooleanRBTreeMap(Object2BooleanSortedMap<K> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2BooleanRBTreeMap(K[] var1, boolean[] var2, Comparator<? super K> var3) {
      this(var3);
   ...
   public Object2BooleanRBTreeMap(K[] var1, boolean[] var2) {
   ...
   final Object2BooleanRBTreeMap.Entry<K> findKey(K var1) {
      Object2BooleanRBTreeMap.Entry var2;
      int var3;
   ...
   final Object2BooleanRBTreeMap.Entry<K> locateKey(K var1) {
      Object2BooleanRBTreeMap.Entry var2 = this.tree;
      Object2BooleanRBTreeMap.Entry var3 = this.tree;
   ...
   public boolean put(K var1, boolean var2) {
      Object2BooleanRBTreeMap.Entry var3 = this.add(var1);
      boolean var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Object2BooleanRBTreeMap.Entry<K> add(K var1) {
      this.modified = false;
      int var2 = 0;
      Object2BooleanRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Object2BooleanRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Object2BooleanRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Object2BooleanRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Object2BooleanRBTreeMap.Entry var7;
               Object2BooleanRBTreeMap.Entry var8;
   ...
   public boolean containsValue(boolean var1) {
      Object2BooleanRBTreeMap.ValueIterator var2 = new Object2BooleanRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public boolean getBoolean(Object var1) {
      Object2BooleanRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
            final Comparator<? super Object2BooleanMap.Entry<K>> comparator = (var1x, var2) -> {
               return Object2BooleanRBTreeMap.this.actualComparator.compare(var1x.getKey(), var2.getKey());
            };
            ...
            public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> var1) {
               return Object2BooleanRBTreeMap.this.new EntryIterator(var1.getKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                     Object2BooleanRBTreeMap.Entry var3 = Object2BooleanRBTreeMap.this.findKey(var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                     ...
                     if (var3 != null && var3.getBooleanValue() == (Boolean)var2.getValue()) {
                        Object2BooleanRBTreeMap.this.removeBoolean(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> var1, Object2BooleanMap.Entry<K> var2) {
               return Object2BooleanRBTreeMap.this.subMap(var1.getKey(), var2.getKey()).object2BooleanEntrySet();
            }

            public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> var1) {
               return Object2BooleanRBTreeMap.this.headMap(var1.getKey()).object2BooleanEntrySet();
            }

            public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> var1) {
               return Object2BooleanRBTreeMap.this.tailMap(var1.getKey()).object2BooleanEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Object2BooleanRBTreeMap.this.containsValue(var1);
            }
   ...
   public Object2BooleanSortedMap<K> headMap(K var1) {
      return new Object2BooleanRBTreeMap.Submap((Object)null, true, var1, false);
   }

   public Object2BooleanSortedMap<K> tailMap(K var1) {
      return new Object2BooleanRBTreeMap.Submap(var1, false, (Object)null, true);
   }

   public Object2BooleanSortedMap<K> subMap(K var1, K var2) {
      return new Object2BooleanRBTreeMap.Submap(var1, false, var2, false);
   }

   public Object2BooleanRBTreeMap<K> clone() {
      Object2BooleanRBTreeMap var1;
      try {
         var1 = (Object2BooleanRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Object2BooleanRBTreeMap.Entry var5 = new Object2BooleanRBTreeMap.Entry();
         Object2BooleanRBTreeMap.Entry var6 = new Object2BooleanRBTreeMap.Entry();
         Object2BooleanRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Object2BooleanRBTreeMap.Entry var4 = var6;
         var6.pred((Object2BooleanRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Object2BooleanRBTreeMap.EntryIterator var3 = new Object2BooleanRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Object2BooleanRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Object2BooleanRBTreeMap.Entry<K> readTree(ObjectInputStream var1, int var2, Object2BooleanRBTreeMap.Entry<K> var3, Object2BooleanRBTreeMap.Entry<K> var4) throws IOException, ClassNotFoundException {
      Object2BooleanRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Object2BooleanRBTreeMap.Entry(var1.readObject(), var1.readBoolean());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Object2BooleanRBTreeMap.Entry(var1.readObject(), var1.readBoolean());
         var8.black(true);
         var8.right(new Object2BooleanRBTreeMap.Entry(var1.readObject(), var1.readBoolean()));
         ...
         Object2BooleanRBTreeMap.Entry var7 = new Object2BooleanRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Object2BooleanRBTreeMap.Entry)null, (Object2BooleanRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractObject2BooleanSortedMap<K> implements Serializable {
      ...
      public Submap(K var2, boolean var3, K var4, boolean var5) {
         super();
         if (!var3 && !var5 && Object2BooleanRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Object2BooleanRBTreeMap.Submap.SubmapIterator var1 = new Object2BooleanRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(K var1) {
         return (this.bottom || Object2BooleanRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Object2BooleanRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(Object var1) {
         return this.in(var1) && Object2BooleanRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(boolean var1) {
         Object2BooleanRBTreeMap.Submap.SubmapIterator var2 = new Object2BooleanRBTreeMap.Submap.SubmapIterator();
      ...
      public boolean getBoolean(Object var1) {
         Object2BooleanRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Object2BooleanRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public boolean put(K var1, boolean var2) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var3 = Object2BooleanRBTreeMap.this.put(var1, var2);
            return Object2BooleanRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public boolean removeBoolean(Object var1) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var2 = Object2BooleanRBTreeMap.this.removeBoolean(var1);
            return Object2BooleanRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Object2BooleanSortedMap<K> headMap(K var1) {
         if (this.top) {
            return Object2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Object2BooleanRBTreeMap.this.compare(var1, this.to) < 0 ? Object2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Object2BooleanSortedMap<K> tailMap(K var1) {
         if (this.bottom) {
            return Object2BooleanRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Object2BooleanRBTreeMap.this.compare(var1, this.from) > 0 ? Object2BooleanRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Object2BooleanSortedMap<K> subMap(K var1, K var2) {
         if (this.top && this.bottom) {
            return Object2BooleanRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Object2BooleanRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Object2BooleanRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Object2BooleanRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Object2BooleanRBTreeMap.Entry<K> firstEntry() {
         if (Object2BooleanRBTreeMap.this.tree == null) {
            ...
            Object2BooleanRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Object2BooleanRBTreeMap.this.firstEntry;
            } else {
               var1 = Object2BooleanRBTreeMap.this.locateKey(this.from);
               if (Object2BooleanRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Object2BooleanRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Object2BooleanRBTreeMap.Entry<K> lastEntry() {
         if (Object2BooleanRBTreeMap.this.tree == null) {
            ...
            Object2BooleanRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Object2BooleanRBTreeMap.this.lastEntry;
            } else {
               var1 = Object2BooleanRBTreeMap.this.locateKey(this.to);
               if (Object2BooleanRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Object2BooleanRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public K firstKey() {
         Object2BooleanRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public K lastKey() {
         Object2BooleanRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Object2BooleanRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Object2BooleanRBTreeMap<K>.TreeIterator {
         ...
         SubmapIterator(K var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Object2BooleanRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Object2BooleanRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Object2BooleanRBTreeMap.this.locateKey(var2);
                  if (Object2BooleanRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractObject2BooleanSortedMap<K>.KeySet {
      ...
      public ObjectBidirectionalIterator<K> iterator(K var1) {
         return Object2BooleanRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Object2BooleanRBTreeMap<K>.TreeIterator implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(K var2) {
         super();
         if ((this.next = Object2BooleanRBTreeMap.this.locateKey(var2)) != null) {
            if (Object2BooleanRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<K> extends AbstractObject2BooleanMap.BasicEntry<K> implements Cloneable {
      ...
      void pred(Object2BooleanRBTreeMap.Entry<K> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Object2BooleanRBTreeMap.Entry<K> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Object2BooleanRBTreeMap.Entry<K> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Object2BooleanRBTreeMap.Entry<K> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Object2BooleanRBTreeMap.Entry<K> next() {
         Object2BooleanRBTreeMap.Entry var1 = this.right;
      ...
      Object2BooleanRBTreeMap.Entry<K> prev() {
         Object2BooleanRBTreeMap.Entry var1 = this.left;
      ...
      public Object2BooleanRBTreeMap.Entry<K> clone() {
         Object2BooleanRBTreeMap.Entry var1;
         try {
            var1 = (Object2BooleanRBTreeMap.Entry)super.clone();
