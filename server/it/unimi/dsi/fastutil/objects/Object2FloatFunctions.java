...
public final class Object2FloatFunctions {
   ...
   public static <K> Object2FloatFunction<K> singleton(K var0, float var1) {
      return new Object2FloatFunctions.Singleton(var0, var1);
   }
   ...
   public static <K> Object2FloatFunction<K> synchronize(Object2FloatFunction<K> var0) {
      return new Object2FloatFunctions.SynchronizedFunction(var0);
   }

   public static <K> Object2FloatFunction<K> synchronize(Object2FloatFunction<K> var0, Object var1) {
      return new Object2FloatFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K> Object2FloatFunction<K> unmodifiable(Object2FloatFunction<K> var0) {
      return new Object2FloatFunctions.UnmodifiableFunction(var0);
   }

   public static <K> Object2FloatFunction<K> primitive(Function<? super K, ? extends Float> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Object2FloatFunction) {
         return (Object2FloatFunction)var0;
      } else {
         return (Object2FloatFunction)(var0 instanceof ToDoubleFunction ? (var1) -> {
            return SafeMath.safeDoubleToFloat(((ToDoubleFunction)var0).applyAsDouble(var1));
         } : new Object2FloatFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class UnmodifiableFunction<K> extends AbstractObject2FloatFunction<K> implements Serializable {
      ...
      protected UnmodifiableFunction(Object2FloatFunction<K> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K> implements Object2FloatFunction<K>, Serializable {
      ...
      protected SynchronizedFunction(Object2FloatFunction<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Object2FloatFunction<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
