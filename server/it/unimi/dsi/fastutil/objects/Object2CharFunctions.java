...
public final class Object2CharFunctions {
   ...
   public static <K> Object2CharFunction<K> singleton(K var0, char var1) {
      return new Object2CharFunctions.Singleton(var0, var1);
   }

   public static <K> Object2CharFunction<K> singleton(K var0, Character var1) {
      return new Object2CharFunctions.Singleton(var0, var1);
   }

   public static <K> Object2CharFunction<K> synchronize(Object2CharFunction<K> var0) {
      return new Object2CharFunctions.SynchronizedFunction(var0);
   }

   public static <K> Object2CharFunction<K> synchronize(Object2CharFunction<K> var0, Object var1) {
      return new Object2CharFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K> Object2CharFunction<K> unmodifiable(Object2CharFunction<K> var0) {
      return new Object2CharFunctions.UnmodifiableFunction(var0);
   }

   public static <K> Object2CharFunction<K> primitive(Function<? super K, ? extends Character> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Object2CharFunction) {
         return (Object2CharFunction)var0;
      } else {
         return (Object2CharFunction)(var0 instanceof ToIntFunction ? (var1) -> {
            return SafeMath.safeIntToChar(((ToIntFunction)var0).applyAsInt(var1));
         } : new Object2CharFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class UnmodifiableFunction<K> extends AbstractObject2CharFunction<K> implements Serializable {
      ...
      protected UnmodifiableFunction(Object2CharFunction<K> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K> implements Object2CharFunction<K>, Serializable {
      ...
      protected SynchronizedFunction(Object2CharFunction<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Object2CharFunction<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
