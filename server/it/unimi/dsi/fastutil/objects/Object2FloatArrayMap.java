...
public class Object2FloatArrayMap<K> extends AbstractObject2FloatMap<K> implements Serializable, Cloneable {
   ...
   public Object2FloatArrayMap(Object[] var1, float[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Object2FloatArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new float[var1];
   }

   public Object2FloatArrayMap(Object2FloatMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Object2FloatArrayMap(Map<? extends K, ? extends Float> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Object2FloatArrayMap(Object[] var1, float[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ObjectSet<K> keySet() {
      return new AbstractObjectSet<K>() {
         public boolean contains(Object var1) {
            return Object2FloatArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Object2FloatArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Object2FloatArrayMap.this.size - var2 - 1;
               System.arraycopy(Object2FloatArrayMap.this.key, var2 + 1, Object2FloatArrayMap.this.key, var2, var3);
               System.arraycopy(Object2FloatArrayMap.this.value, var2 + 1, Object2FloatArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Object2FloatArrayMap.this.size - this.pos;
                     System.arraycopy(Object2FloatArrayMap.this.key, this.pos, Object2FloatArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Object2FloatArrayMap.this.value, this.pos, Object2FloatArrayMap.this.value, this.pos - 1, var1);
                     Object2FloatArrayMap.this.size--;
                  }
               }
            };
   ...
   public FloatCollection values() {
      return new AbstractFloatCollection() {
         public boolean contains(float var1) {
            return Object2FloatArrayMap.this.containsValue(var1);
         }
   ...
   public Object2FloatArrayMap<K> clone() {
      Object2FloatArrayMap var1;
      try {
         var1 = (Object2FloatArrayMap)super.clone();
         ...
         return new ObjectIterator<Object2FloatMap.Entry<K>>() {
            ...
            public Object2FloatMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractObject2FloatMap.BasicEntry(Object2FloatArrayMap.this.key[this.curr = this.next], Object2FloatArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Object2FloatArrayMap.this.size-- - this.next--;
                  System.arraycopy(Object2FloatArrayMap.this.key, this.next + 1, Object2FloatArrayMap.this.key, this.next, var1);
                  System.arraycopy(Object2FloatArrayMap.this.value, this.next + 1, Object2FloatArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Object2FloatMap.Entry<K>>() {
            ...
            public Object2FloatMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Object2FloatArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Float) {
               ...
               return Object2FloatArrayMap.this.containsKey(var3) && Float.floatToIntBits(Object2FloatArrayMap.this.getFloat(var3)) == Float.floatToIntBits((Float)var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Float) {
               ...
               int var5 = Object2FloatArrayMap.this.findKey(var3);
               if (var5 != -1 && Float.floatToIntBits(var4) == Float.floatToIntBits(Object2FloatArrayMap.this.value[var5])) {
                  int var6 = Object2FloatArrayMap.this.size - var5 - 1;
                  System.arraycopy(Object2FloatArrayMap.this.key, var5 + 1, Object2FloatArrayMap.this.key, var5, var6);
                  System.arraycopy(Object2FloatArrayMap.this.value, var5 + 1, Object2FloatArrayMap.this.value, var5, var6);
                  Object2FloatArrayMap.this.size--;
                  Object2FloatArrayMap.this.key[Object2FloatArrayMap.this.size] = null;
                  return true;
               } else {
