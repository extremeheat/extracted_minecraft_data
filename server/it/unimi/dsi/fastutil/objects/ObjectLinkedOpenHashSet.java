...
public class ObjectLinkedOpenHashSet<K> extends AbstractObjectSortedSet<K> implements Serializable, Cloneable, Hash {
   ...
   public ObjectLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public ObjectLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public ObjectLinkedOpenHashSet(Collection<? extends K> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ObjectLinkedOpenHashSet(Collection<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ObjectLinkedOpenHashSet(ObjectCollection<? extends K> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ObjectLinkedOpenHashSet(ObjectCollection<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ObjectLinkedOpenHashSet(Iterator<? extends K> var1, float var2) {
      this(16, var2);
   ...
   public ObjectLinkedOpenHashSet(Iterator<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ObjectLinkedOpenHashSet(K[] var1, int var2, int var3, float var4) {
   ...
   public ObjectLinkedOpenHashSet(K[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public ObjectLinkedOpenHashSet(K[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public ObjectLinkedOpenHashSet(K[] var1) {
      this(var1, 0.75F);
   }
   ...
   public boolean add(K var1) {
      ...
      if (var1 == null) {
         ...
         Object var3;
         if ((var3 = var4[var2 = HashCommon.mix(var1.hashCode()) & this.mask]) != null) {
            if (var3.equals(var1)) {
               return false;
            }
   ...
   public boolean addAndMoveToFirst(K var1) {
      ...
      if (var1 == null) {
         ...
         for(var2 = HashCommon.mix(var1.hashCode()) & this.mask; var3[var2] != null; var2 = var2 + 1 & this.mask) {
   ...
   public ObjectListIterator<K> iterator(K var1) {
      return new ObjectLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         ...
         if (var2[var5] == null) {
            ...
            for(var9 = HashCommon.mix(var2[var5].hashCode()) & var3; var4[var9] != null; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public ObjectLinkedOpenHashSet<K> clone() {
      ObjectLinkedOpenHashSet var1;
      try {
         var1 = (ObjectLinkedOpenHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var6-- != 0) {
         ...
         if (var5 == null) {
            var7 = this.n;
            this.containsNull = true;
         } else if (var2[var7 = HashCommon.mix(var5.hashCode()) & this.mask] != null) {
   ...
   private class SetIterator implements ObjectListIterator<K> {
      ...
      SetIterator(K var2) {
         ...
         } else if (Objects.equals(ObjectLinkedOpenHashSet.this.key[ObjectLinkedOpenHashSet.this.last], var2)) {
            this.prev = ObjectLinkedOpenHashSet.this.last;
            this.index = ObjectLinkedOpenHashSet.this.size;
         } else {
            Object[] var3 = ObjectLinkedOpenHashSet.this.key;

            for(int var4 = HashCommon.mix(var2.hashCode()) & ObjectLinkedOpenHashSet.this.mask; var3[var4] != null; var4 = var4 + 1 & ObjectLinkedOpenHashSet.this.mask) {
               if (var3[var4].equals(var2)) {
                  this.next = (int)ObjectLinkedOpenHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = ObjectLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)ObjectLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            int var3 = this.curr;
            this.curr = -1;
            if (var3 == ObjectLinkedOpenHashSet.this.n) {
               ObjectLinkedOpenHashSet.this.containsNull = false;
               ObjectLinkedOpenHashSet.this.key[ObjectLinkedOpenHashSet.this.n] = null;
            } else {
               Object[] var5 = ObjectLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & ObjectLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(var4.hashCode()) & ObjectLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  ObjectLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
