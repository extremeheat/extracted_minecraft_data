...
public class Object2CharArrayMap<K> extends AbstractObject2CharMap<K> implements Serializable, Cloneable {
   ...
   public Object2CharArrayMap(Object[] var1, char[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Object2CharArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new char[var1];
   }

   public Object2CharArrayMap(Object2CharMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Object2CharArrayMap(Map<? extends K, ? extends Character> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Object2CharArrayMap(Object[] var1, char[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ObjectSet<K> keySet() {
      return new AbstractObjectSet<K>() {
         public boolean contains(Object var1) {
            return Object2CharArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Object2CharArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Object2CharArrayMap.this.size - var2 - 1;
               System.arraycopy(Object2CharArrayMap.this.key, var2 + 1, Object2CharArrayMap.this.key, var2, var3);
               System.arraycopy(Object2CharArrayMap.this.value, var2 + 1, Object2CharArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Object2CharArrayMap.this.size - this.pos;
                     System.arraycopy(Object2CharArrayMap.this.key, this.pos, Object2CharArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Object2CharArrayMap.this.value, this.pos, Object2CharArrayMap.this.value, this.pos - 1, var1);
                     Object2CharArrayMap.this.size--;
                  }
               }
            };
   ...
   public CharCollection values() {
      return new AbstractCharCollection() {
         public boolean contains(char var1) {
            return Object2CharArrayMap.this.containsValue(var1);
         }
   ...
   public Object2CharArrayMap<K> clone() {
      Object2CharArrayMap var1;
      try {
         var1 = (Object2CharArrayMap)super.clone();
         ...
         return new ObjectIterator<Object2CharMap.Entry<K>>() {
            ...
            public Object2CharMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractObject2CharMap.BasicEntry(Object2CharArrayMap.this.key[this.curr = this.next], Object2CharArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Object2CharArrayMap.this.size-- - this.next--;
                  System.arraycopy(Object2CharArrayMap.this.key, this.next + 1, Object2CharArrayMap.this.key, this.next, var1);
                  System.arraycopy(Object2CharArrayMap.this.value, this.next + 1, Object2CharArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Object2CharMap.Entry<K>>() {
            ...
            public Object2CharMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Object2CharArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               return Object2CharArrayMap.this.containsKey(var3) && Object2CharArrayMap.this.getChar(var3) == (Character)var2.getValue();
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               int var5 = Object2CharArrayMap.this.findKey(var3);
               if (var5 != -1 && var4 == Object2CharArrayMap.this.value[var5]) {
                  int var6 = Object2CharArrayMap.this.size - var5 - 1;
                  System.arraycopy(Object2CharArrayMap.this.key, var5 + 1, Object2CharArrayMap.this.key, var5, var6);
                  System.arraycopy(Object2CharArrayMap.this.value, var5 + 1, Object2CharArrayMap.this.value, var5, var6);
                  Object2CharArrayMap.this.size--;
                  Object2CharArrayMap.this.key[Object2CharArrayMap.this.size] = null;
                  return true;
               } else {
