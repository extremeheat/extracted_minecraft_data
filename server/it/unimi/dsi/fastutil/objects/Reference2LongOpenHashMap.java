...
public class Reference2LongOpenHashMap<K> extends AbstractReference2LongMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2LongOpenHashMap(int var1, float var2) {
      super();
   ...
   public Reference2LongOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Reference2LongOpenHashMap(Map<? extends K, ? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2LongOpenHashMap(Map<? extends K, ? extends Long> var1) {
      this(var1, 0.75F);
   }

   public Reference2LongOpenHashMap(Reference2LongMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2LongOpenHashMap(Reference2LongMap<K> var1) {
      this(var1, 0.75F);
   }

   public Reference2LongOpenHashMap(K[] var1, long[] var2, float var3) {
   ...
   public Reference2LongOpenHashMap(K[] var1, long[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Reference2LongOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Reference2LongOpenHashMap.this.containsNullKey) {
                  var1.accept(Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n]);
               }

               int var2 = Reference2LongOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2LongOpenHashMap.this.key[var2] != null) {
                     var1.accept(Reference2LongOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2LongOpenHashMap<K> clone() {
      Reference2LongOpenHashMap var1;
      try {
         var1 = (Reference2LongOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      long[] var3 = this.value;
      Reference2LongOpenHashMap.MapIterator var4 = new Reference2LongOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2LongOpenHashMap.this.containsNullKey) {
            var1.accept(Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n]);
         }

         int var2 = Reference2LongOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2LongOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2LongOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2LongOpenHashMap.this.size;
         Reference2LongOpenHashMap.this.removeLong(var1);
         return Reference2LongOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements Reference2LongMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               if (var3 == null) {
                  return Reference2LongOpenHashMap.this.containsNullKey && Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n] == var4;
               } else {
                  Object[] var7 = Reference2LongOpenHashMap.this.key;
                  Object var6;
                  int var8;
                  if ((var6 = var7[var8 = HashCommon.mix(System.identityHashCode(var3)) & Reference2LongOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3 == var6) {
                     return Reference2LongOpenHashMap.this.value[var8] == var4;
                  } else {
                     while((var6 = var7[var8 = var8 + 1 & Reference2LongOpenHashMap.this.mask]) != null) {
                        if (var3 == var6) {
                           return Reference2LongOpenHashMap.this.value[var8] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               long var4 = (Long)var2.getValue();
               if (var3 == null) {
                  if (Reference2LongOpenHashMap.this.containsNullKey && Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n] == var4) {
                  ...
                  if ((var6 = var7[var8 = HashCommon.mix(System.identityHashCode(var3)) & Reference2LongOpenHashMap.this.mask]) == null) {
                     ...
                     if (Reference2LongOpenHashMap.this.value[var8] == var4) {
                        Reference2LongOpenHashMap.this.removeEntry(var8);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var7[var8 = var8 + 1 & Reference2LongOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(var6 != var3 || Reference2LongOpenHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Reference2LongMap.Entry<K>> var1) {
         if (Reference2LongOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2LongMap.BasicEntry(Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n], Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2LongOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2LongMap.BasicEntry(Reference2LongOpenHashMap.this.key[var2], Reference2LongOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> var1) {
         ...
         if (Reference2LongOpenHashMap.this.containsNullKey) {
            var2.key = Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n];
            var2.value = Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2LongOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2LongOpenHashMap.this.key[var3] != null) {
               var2.key = Reference2LongOpenHashMap.this.key[var3];
               var2.value = Reference2LongOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2LongOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2LongMap.Entry<K>> {
      private final Reference2LongOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2LongOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2LongOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2LongMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2LongOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(System.identityHashCode(var2)) & Reference2LongOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Reference2LongOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2LongOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2LongOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(System.identityHashCode(var4)) & Reference2LongOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2LongOpenHashMap.this.value[var2] = Reference2LongOpenHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Reference2LongOpenHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Reference2LongOpenHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Reference2LongMap.Entry<K>, java.util.Map.Entry<K, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Reference2LongOpenHashMap.this.value[this.index];
         Reference2LongOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2LongOpenHashMap.this.key[this.index] == var2.getKey() && Reference2LongOpenHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
