...
public class Object2ReferenceRBTreeMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V> implements Serializable, Cloneable {
   ...
   public Object2ReferenceRBTreeMap(Comparator<? super K> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Object2ReferenceRBTreeMap(Map<? extends K, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Object2ReferenceRBTreeMap(SortedMap<K, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2ReferenceRBTreeMap(Object2ReferenceMap<? extends K, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Object2ReferenceRBTreeMap(Object2ReferenceSortedMap<K, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2ReferenceRBTreeMap(K[] var1, V[] var2, Comparator<? super K> var3) {
      this(var3);
   ...
   public Object2ReferenceRBTreeMap(K[] var1, V[] var2) {
   ...
   final Object2ReferenceRBTreeMap.Entry<K, V> findKey(K var1) {
      Object2ReferenceRBTreeMap.Entry var2;
      int var3;
   ...
   final Object2ReferenceRBTreeMap.Entry<K, V> locateKey(K var1) {
      Object2ReferenceRBTreeMap.Entry var2 = this.tree;
      Object2ReferenceRBTreeMap.Entry var3 = this.tree;
   ...
   public V put(K var1, V var2) {
      Object2ReferenceRBTreeMap.Entry var3 = this.add(var1);
      Object var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Object2ReferenceRBTreeMap.Entry<K, V> add(K var1) {
      this.modified = false;
      int var2 = 0;
      Object2ReferenceRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Object2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Object2ReferenceRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Object2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Object2ReferenceRBTreeMap.Entry var7;
               Object2ReferenceRBTreeMap.Entry var8;
   ...
   public boolean containsValue(Object var1) {
      Object2ReferenceRBTreeMap.ValueIterator var2 = new Object2ReferenceRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(Object var1) {
      Object2ReferenceRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
            final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator = (var1x, var2) -> {
               return Object2ReferenceRBTreeMap.this.actualComparator.compare(var1x.getKey(), var2.getKey());
            };
            ...
            public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> var1) {
               return Object2ReferenceRBTreeMap.this.new EntryIterator(var1.getKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  Object2ReferenceRBTreeMap.Entry var3 = Object2ReferenceRBTreeMap.this.findKey(var2.getKey());
            ...
            public boolean remove(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var3 != null && var3.getValue() == var2.getValue()) {
                     Object2ReferenceRBTreeMap.this.remove(var3.key);
                     return true;
                  } else {
                     return false;
                  }
            ...
            public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> var1, Object2ReferenceMap.Entry<K, V> var2) {
               return Object2ReferenceRBTreeMap.this.subMap(var1.getKey(), var2.getKey()).object2ReferenceEntrySet();
            }

            public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> var1) {
               return Object2ReferenceRBTreeMap.this.headMap(var1.getKey()).object2ReferenceEntrySet();
            }

            public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> var1) {
               return Object2ReferenceRBTreeMap.this.tailMap(var1.getKey()).object2ReferenceEntrySet();
            }
         };
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Object2ReferenceRBTreeMap.this.containsValue(var1);
            }
   ...
   public Object2ReferenceSortedMap<K, V> headMap(K var1) {
      return new Object2ReferenceRBTreeMap.Submap((Object)null, true, var1, false);
   }

   public Object2ReferenceSortedMap<K, V> tailMap(K var1) {
      return new Object2ReferenceRBTreeMap.Submap(var1, false, (Object)null, true);
   }

   public Object2ReferenceSortedMap<K, V> subMap(K var1, K var2) {
      return new Object2ReferenceRBTreeMap.Submap(var1, false, var2, false);
   }

   public Object2ReferenceRBTreeMap<K, V> clone() {
      Object2ReferenceRBTreeMap var1;
      try {
         var1 = (Object2ReferenceRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Object2ReferenceRBTreeMap.Entry var5 = new Object2ReferenceRBTreeMap.Entry();
         Object2ReferenceRBTreeMap.Entry var6 = new Object2ReferenceRBTreeMap.Entry();
         Object2ReferenceRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Object2ReferenceRBTreeMap.Entry var4 = var6;
         var6.pred((Object2ReferenceRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Object2ReferenceRBTreeMap.EntryIterator var3 = new Object2ReferenceRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Object2ReferenceRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Object2ReferenceRBTreeMap.Entry<K, V> readTree(ObjectInputStream var1, int var2, Object2ReferenceRBTreeMap.Entry<K, V> var3, Object2ReferenceRBTreeMap.Entry<K, V> var4) throws IOException, ClassNotFoundException {
      Object2ReferenceRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Object2ReferenceRBTreeMap.Entry(var1.readObject(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Object2ReferenceRBTreeMap.Entry(var1.readObject(), var1.readObject());
         var8.black(true);
         var8.right(new Object2ReferenceRBTreeMap.Entry(var1.readObject(), var1.readObject()));
         ...
         Object2ReferenceRBTreeMap.Entry var7 = new Object2ReferenceRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Object2ReferenceRBTreeMap.Entry)null, (Object2ReferenceRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractObject2ReferenceSortedMap<K, V> implements Serializable {
      ...
      public Submap(K var2, boolean var3, K var4, boolean var5) {
         super();
         if (!var3 && !var5 && Object2ReferenceRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Object2ReferenceRBTreeMap.Submap.SubmapIterator var1 = new Object2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(K var1) {
         return (this.bottom || Object2ReferenceRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Object2ReferenceRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(Object var1) {
         return this.in(var1) && Object2ReferenceRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Object2ReferenceRBTreeMap.Submap.SubmapIterator var2 = new Object2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(Object var1) {
         Object2ReferenceRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Object2ReferenceRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public V put(K var1, V var2) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Object2ReferenceRBTreeMap.this.put(var1, var2);
            return Object2ReferenceRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public V remove(Object var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var2 = Object2ReferenceRBTreeMap.this.remove(var1);
            return Object2ReferenceRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Object2ReferenceSortedMap<K, V> headMap(K var1) {
         if (this.top) {
            return Object2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Object2ReferenceRBTreeMap.this.compare(var1, this.to) < 0 ? Object2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Object2ReferenceSortedMap<K, V> tailMap(K var1) {
         if (this.bottom) {
            return Object2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Object2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? Object2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Object2ReferenceSortedMap<K, V> subMap(K var1, K var2) {
         if (this.top && this.bottom) {
            return Object2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Object2ReferenceRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Object2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Object2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Object2ReferenceRBTreeMap.Entry<K, V> firstEntry() {
         if (Object2ReferenceRBTreeMap.this.tree == null) {
            ...
            Object2ReferenceRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Object2ReferenceRBTreeMap.this.firstEntry;
            } else {
               var1 = Object2ReferenceRBTreeMap.this.locateKey(this.from);
               if (Object2ReferenceRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Object2ReferenceRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Object2ReferenceRBTreeMap.Entry<K, V> lastEntry() {
         if (Object2ReferenceRBTreeMap.this.tree == null) {
            ...
            Object2ReferenceRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Object2ReferenceRBTreeMap.this.lastEntry;
            } else {
               var1 = Object2ReferenceRBTreeMap.this.locateKey(this.to);
               if (Object2ReferenceRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Object2ReferenceRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public K firstKey() {
         Object2ReferenceRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public K lastKey() {
         Object2ReferenceRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Object2ReferenceRBTreeMap<K, V>.Submap.SubmapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Object2ReferenceRBTreeMap<K, V>.TreeIterator {
         ...
         SubmapIterator(K var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Object2ReferenceRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Object2ReferenceRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Object2ReferenceRBTreeMap.this.locateKey(var2);
                  if (Object2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractObject2ReferenceSortedMap<K, V>.KeySet {
      ...
      public ObjectBidirectionalIterator<K> iterator(K var1) {
         return Object2ReferenceRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Object2ReferenceRBTreeMap<K, V>.TreeIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(K var2) {
         super();
         if ((this.next = Object2ReferenceRBTreeMap.this.locateKey(var2)) != null) {
            if (Object2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<K, V> extends AbstractObject2ReferenceMap.BasicEntry<K, V> implements Cloneable {
      ...
      void pred(Object2ReferenceRBTreeMap.Entry<K, V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Object2ReferenceRBTreeMap.Entry<K, V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Object2ReferenceRBTreeMap.Entry<K, V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Object2ReferenceRBTreeMap.Entry<K, V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Object2ReferenceRBTreeMap.Entry<K, V> next() {
         Object2ReferenceRBTreeMap.Entry var1 = this.right;
      ...
      Object2ReferenceRBTreeMap.Entry<K, V> prev() {
         Object2ReferenceRBTreeMap.Entry var1 = this.left;
      ...
      public Object2ReferenceRBTreeMap.Entry<K, V> clone() {
         Object2ReferenceRBTreeMap.Entry var1;
         try {
            var1 = (Object2ReferenceRBTreeMap.Entry)super.clone();
