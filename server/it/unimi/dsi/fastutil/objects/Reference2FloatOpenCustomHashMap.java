...
public class Reference2FloatOpenCustomHashMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2FloatOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Reference2FloatOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2FloatOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Reference2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2FloatOpenCustomHashMap(Reference2FloatMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2FloatOpenCustomHashMap(Reference2FloatMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2FloatOpenCustomHashMap(K[] var1, float[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Reference2FloatOpenCustomHashMap(K[] var1, float[] var2, Hash.Strategy<K> var3) {
   ...
   public Reference2FloatMap.FastEntrySet<K> reference2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Reference2FloatOpenCustomHashMap.MapEntrySet();
      }
   ...
   public ReferenceSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Reference2FloatOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            public FloatIterator iterator() {
               return Reference2FloatOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(float var1) {
               return Reference2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Reference2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2FloatOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept((double)Reference2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2FloatOpenCustomHashMap<K> clone() {
      Reference2FloatOpenCustomHashMap var1;
      try {
         var1 = (Reference2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      float[] var3 = this.value;
      Reference2FloatOpenCustomHashMap.MapIterator var4 = new Reference2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator implements FloatIterator {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return Reference2FloatOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(Consumer<? super K> var1) {
         if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Reference2FloatOpenCustomHashMap.this.key[Reference2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Reference2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2FloatOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2FloatOpenCustomHashMap.this.size;
         Reference2FloatOpenCustomHashMap.this.removeFloat(var1);
         return Reference2FloatOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry<K>> implements Reference2FloatMap.FastEntrySet<K> {
      ...
      public ObjectIterator<Reference2FloatMap.Entry<K>> iterator() {
         return Reference2FloatOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Reference2FloatMap.Entry<K>> fastIterator() {
         return Reference2FloatOpenCustomHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Float) {
               ...
               if (Reference2FloatOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Reference2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4);
               } else {
                  Object[] var6 = Reference2FloatOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2FloatOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2FloatOpenCustomHashMap.this.mask]) != null) {
                        if (Reference2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Float) {
               ...
               float var4 = (Float)var2.getValue();
               if (Reference2FloatOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Reference2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4)) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2FloatOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2FloatOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                        Reference2FloatOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2FloatOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Reference2FloatOpenCustomHashMap.this.strategy.equals(var5, var3) || Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> var1) {
         if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2FloatMap.BasicEntry(Reference2FloatOpenCustomHashMap.this.key[Reference2FloatOpenCustomHashMap.this.n], Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2FloatOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2FloatMap.BasicEntry(Reference2FloatOpenCustomHashMap.this.key[var2], Reference2FloatOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2FloatMap.Entry<K>> var1) {
         ...
         if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Reference2FloatOpenCustomHashMap.this.key[Reference2FloatOpenCustomHashMap.this.n];
            var2.value = Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2FloatOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Reference2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Reference2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2FloatMap.Entry<K>> {
      private final Reference2FloatOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2FloatMap.Entry<K>> {
      ...
      public Reference2FloatOpenCustomHashMap<K>.MapEntry next() {
         return this.entry = Reference2FloatOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               return this.last = Reference2FloatOpenCustomHashMap.this.n;
            } else {
               Object[] var1 = Reference2FloatOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Reference2FloatOpenCustomHashMap.this.mask; !Reference2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Reference2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Reference2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2FloatOpenCustomHashMap.this.value[var2] = Reference2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Reference2FloatMap.Entry<K>, java.util.Map.Entry<K, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Reference2FloatOpenCustomHashMap.this.value[this.index];
         Reference2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], var2.getKey()) && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
