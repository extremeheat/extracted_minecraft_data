...
public class Object2DoubleOpenCustomHashMap<K> extends AbstractObject2DoubleMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2DoubleOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Object2DoubleOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2DoubleOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Object2DoubleOpenCustomHashMap(Map<? extends K, ? extends Double> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2DoubleOpenCustomHashMap(Map<? extends K, ? extends Double> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2DoubleOpenCustomHashMap(Object2DoubleMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2DoubleOpenCustomHashMap(Object2DoubleMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2DoubleOpenCustomHashMap(K[] var1, double[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Object2DoubleOpenCustomHashMap(K[] var1, double[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Object2DoubleOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n]);
               }

               int var2 = Object2DoubleOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2DoubleOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Object2DoubleOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2DoubleOpenCustomHashMap<K> clone() {
      Object2DoubleOpenCustomHashMap var1;
      try {
         var1 = (Object2DoubleOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      double[] var3 = this.value;
      Object2DoubleOpenCustomHashMap.MapIterator var4 = new Object2DoubleOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Object2DoubleOpenCustomHashMap.this.key[Object2DoubleOpenCustomHashMap.this.n]);
         }

         int var2 = Object2DoubleOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2DoubleOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2DoubleOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2DoubleOpenCustomHashMap.this.size;
         Object2DoubleOpenCustomHashMap.this.removeDouble(var1);
         return Object2DoubleOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>> implements Object2DoubleMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               if (Object2DoubleOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Object2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4);
               } else {
                  Object[] var7 = Object2DoubleOpenCustomHashMap.this.key;
                  Object var6;
                  int var8;
                  if ((var6 = var7[var8 = HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2DoubleOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                     return Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                  } else {
                     while((var6 = var7[var8 = var8 + 1 & Object2DoubleOpenCustomHashMap.this.mask]) != null) {
                        if (Object2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                           return Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               double var4 = (Double)var2.getValue();
               if (Object2DoubleOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Object2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                  ...
                  if ((var6 = var7[var8 = HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2DoubleOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                     if (Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                        Object2DoubleOpenCustomHashMap.this.removeEntry(var8);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var7[var8 = var8 + 1 & Object2DoubleOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Object2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3) || Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> var1) {
         if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2DoubleMap.BasicEntry(Object2DoubleOpenCustomHashMap.this.key[Object2DoubleOpenCustomHashMap.this.n], Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2DoubleOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2DoubleMap.BasicEntry(Object2DoubleOpenCustomHashMap.this.key[var2], Object2DoubleOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> var1) {
         ...
         if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
            var2.key = Object2DoubleOpenCustomHashMap.this.key[Object2DoubleOpenCustomHashMap.this.n];
            var2.value = Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2DoubleOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Object2DoubleOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Object2DoubleOpenCustomHashMap.this.key[var3];
               var2.value = Object2DoubleOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2DoubleOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2DoubleMap.Entry<K>> {
      private final Object2DoubleOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2DoubleOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2DoubleOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2DoubleMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2DoubleOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(var2)) & Object2DoubleOpenCustomHashMap.this.mask; !Object2DoubleOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Object2DoubleOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2DoubleOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2DoubleOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(var4)) & Object2DoubleOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2DoubleOpenCustomHashMap.this.value[var2] = Object2DoubleOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2DoubleMap.Entry<K>, java.util.Map.Entry<K, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Object2DoubleOpenCustomHashMap.this.value[this.index];
         Object2DoubleOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Object2DoubleOpenCustomHashMap.this.strategy.equals(Object2DoubleOpenCustomHashMap.this.key[this.index], var2.getKey()) && Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
