...
public final class Reference2ByteFunctions {
   ...
   public static <K> Reference2ByteFunction<K> singleton(K var0, byte var1) {
      return new Reference2ByteFunctions.Singleton(var0, var1);
   }
   ...
   public static <K> Reference2ByteFunction<K> synchronize(Reference2ByteFunction<K> var0) {
      return new Reference2ByteFunctions.SynchronizedFunction(var0);
   }

   public static <K> Reference2ByteFunction<K> synchronize(Reference2ByteFunction<K> var0, Object var1) {
      return new Reference2ByteFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K> Reference2ByteFunction<K> unmodifiable(Reference2ByteFunction<K> var0) {
      return new Reference2ByteFunctions.UnmodifiableFunction(var0);
   }

   public static <K> Reference2ByteFunction<K> primitive(Function<? super K, ? extends Byte> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Reference2ByteFunction) {
         return (Reference2ByteFunction)var0;
      } else {
         return (Reference2ByteFunction)(var0 instanceof ToIntFunction ? (var1) -> {
            return SafeMath.safeIntToByte(((ToIntFunction)var0).applyAsInt(var1));
         } : new Reference2ByteFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class UnmodifiableFunction<K> extends AbstractReference2ByteFunction<K> implements Serializable {
      ...
      protected UnmodifiableFunction(Reference2ByteFunction<K> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K> implements Reference2ByteFunction<K>, Serializable {
      ...
      protected SynchronizedFunction(Reference2ByteFunction<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Reference2ByteFunction<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
