...
public interface Reference2ReferenceMap<K, V> extends Reference2ReferenceFunction<K, V>, Map<K, V> {
   ...
   default V put(K var1, V var2) {
      return Reference2ReferenceFunction.super.put(var1, var2);
   }

   default V remove(Object var1) {
      return Reference2ReferenceFunction.super.remove(var1);
   }
   ...
   public interface FastEntrySet<K, V> extends ObjectSet<Reference2ReferenceMap.Entry<K, V>> {
      ...
      default void fastForEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> var1) {
         this.forEach(var1);
      }
   }
}
