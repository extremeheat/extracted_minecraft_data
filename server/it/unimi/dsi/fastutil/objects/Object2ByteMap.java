...
public interface Object2ByteMap<K> extends Object2ByteFunction<K>, Map<K, Byte> {
   ...
   default Byte put(K var1, Byte var2) {
      return Object2ByteFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Byte get(Object var1) {
      return Object2ByteFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Byte remove(Object var1) {
      return Object2ByteFunction.super.remove(var1);
   }
   ...
   default byte computeByteIfAbsentPartial(K var1, Object2ByteFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      byte var3 = this.getByte(var1);
      byte var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<K> extends ObjectSet<Object2ByteMap.Entry<K>> {
      ObjectIterator<Object2ByteMap.Entry<K>> fastIterator();

      default void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
