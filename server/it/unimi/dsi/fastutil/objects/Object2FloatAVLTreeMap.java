...
public class Object2FloatAVLTreeMap<K> extends AbstractObject2FloatSortedMap<K> implements Serializable, Cloneable {
   ...
   public Object2FloatAVLTreeMap(Comparator<? super K> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Object2FloatAVLTreeMap(Map<? extends K, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Object2FloatAVLTreeMap(SortedMap<K, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2FloatAVLTreeMap(Object2FloatMap<? extends K> var1) {
      this();
      this.putAll(var1);
   }

   public Object2FloatAVLTreeMap(Object2FloatSortedMap<K> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2FloatAVLTreeMap(K[] var1, float[] var2, Comparator<? super K> var3) {
      this(var3);
   ...
   public Object2FloatAVLTreeMap(K[] var1, float[] var2) {
   ...
   final Object2FloatAVLTreeMap.Entry<K> findKey(K var1) {
      Object2FloatAVLTreeMap.Entry var2;
      int var3;
   ...
   final Object2FloatAVLTreeMap.Entry<K> locateKey(K var1) {
      Object2FloatAVLTreeMap.Entry var2 = this.tree;
      Object2FloatAVLTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(K var1, float var2) {
      Object2FloatAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Object2FloatAVLTreeMap.Entry<K> add(K var1) {
      this.modified = false;
      Object2FloatAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Object2FloatAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Object2FloatAVLTreeMap.Entry var3 = this.tree;
         Object2FloatAVLTreeMap.Entry var4 = null;
         Object2FloatAVLTreeMap.Entry var5 = this.tree;
         Object2FloatAVLTreeMap.Entry var6 = null;
         Object2FloatAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Object2FloatAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Object2FloatAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Object2FloatAVLTreeMap.Entry<K> parent(Object2FloatAVLTreeMap.Entry<K> var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Object2FloatAVLTreeMap.Entry var3 = var1;

         Object2FloatAVLTreeMap.Entry var2;
         Object2FloatAVLTreeMap.Entry var4;
   ...
   public float removeFloat(Object var1) {
      ...
      if (this.tree == null) {
         ...
         Object2FloatAVLTreeMap.Entry var7;
         Object2FloatAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Object2FloatAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(float var1) {
      Object2FloatAVLTreeMap.ValueIterator var2 = new Object2FloatAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float getFloat(Object var1) {
      Object2FloatAVLTreeMap.Entry var2 = this.findKey(var1);
   ...
   public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
            final Comparator<? super Object2FloatMap.Entry<K>> comparator = (var1x, var2) -> {
               return Object2FloatAVLTreeMap.this.actualComparator.compare(var1x.getKey(), var2.getKey());
            };
            ...
            public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> var1) {
               return Object2FloatAVLTreeMap.this.new EntryIterator(var1.getKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Float) {
                     Object2FloatAVLTreeMap.Entry var3 = Object2FloatAVLTreeMap.this.findKey(var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Float) {
                     ...
                     if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                        Object2FloatAVLTreeMap.this.removeFloat(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> var1, Object2FloatMap.Entry<K> var2) {
               return Object2FloatAVLTreeMap.this.subMap(var1.getKey(), var2.getKey()).object2FloatEntrySet();
            }

            public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> var1) {
               return Object2FloatAVLTreeMap.this.headMap(var1.getKey()).object2FloatEntrySet();
            }

            public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> var1) {
               return Object2FloatAVLTreeMap.this.tailMap(var1.getKey()).object2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Object2FloatAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Object2FloatSortedMap<K> headMap(K var1) {
      return new Object2FloatAVLTreeMap.Submap((Object)null, true, var1, false);
   }

   public Object2FloatSortedMap<K> tailMap(K var1) {
      return new Object2FloatAVLTreeMap.Submap(var1, false, (Object)null, true);
   }

   public Object2FloatSortedMap<K> subMap(K var1, K var2) {
      return new Object2FloatAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Object2FloatAVLTreeMap<K> clone() {
      Object2FloatAVLTreeMap var1;
      try {
         var1 = (Object2FloatAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Object2FloatAVLTreeMap.Entry var5 = new Object2FloatAVLTreeMap.Entry();
         Object2FloatAVLTreeMap.Entry var6 = new Object2FloatAVLTreeMap.Entry();
         Object2FloatAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Object2FloatAVLTreeMap.Entry var4 = var6;
         var6.pred((Object2FloatAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Object2FloatAVLTreeMap.EntryIterator var3 = new Object2FloatAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Object2FloatAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Object2FloatAVLTreeMap.Entry<K> readTree(ObjectInputStream var1, int var2, Object2FloatAVLTreeMap.Entry<K> var3, Object2FloatAVLTreeMap.Entry<K> var4) throws IOException, ClassNotFoundException {
      Object2FloatAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Object2FloatAVLTreeMap.Entry(var1.readObject(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Object2FloatAVLTreeMap.Entry(var1.readObject(), var1.readFloat());
         var8.right(new Object2FloatAVLTreeMap.Entry(var1.readObject(), var1.readFloat()));
         ...
         Object2FloatAVLTreeMap.Entry var7 = new Object2FloatAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Object2FloatAVLTreeMap.Entry)null, (Object2FloatAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractObject2FloatSortedMap<K> implements Serializable {
      ...
      public Submap(K var2, boolean var3, K var4, boolean var5) {
         super();
         if (!var3 && !var5 && Object2FloatAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Object2FloatAVLTreeMap.Submap.SubmapIterator var1 = new Object2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(K var1) {
         return (this.bottom || Object2FloatAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Object2FloatAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
         if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
                  ...
                  if (!(var1 instanceof java.util.Map.Entry)) {
                     ...
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Submap.this.in(var3.key)) {
                           Submap.this.removeFloat(var3.key);
                        }
               ...
               public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> var1, Object2FloatMap.Entry<K> var2) {
                  return Submap.this.subMap(var1.getKey(), var2.getKey()).object2FloatEntrySet();
               }

               public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> var1) {
                  return Submap.this.headMap(var1.getKey()).object2FloatEntrySet();
               }

               public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> var1) {
                  return Submap.this.tailMap(var1.getKey()).object2FloatEntrySet();
               }
            };
         }
      ...
      public boolean containsKey(Object var1) {
         return this.in(var1) && Object2FloatAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Object2FloatAVLTreeMap.Submap.SubmapIterator var2 = new Object2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      public float getFloat(Object var1) {
         Object2FloatAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Object2FloatAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(K var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Object2FloatAVLTreeMap.this.put(var1, var2);
            return Object2FloatAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float removeFloat(Object var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Object2FloatAVLTreeMap.this.removeFloat(var1);
            return Object2FloatAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Object2FloatSortedMap<K> headMap(K var1) {
         if (this.top) {
            return Object2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Object2FloatAVLTreeMap.this.compare(var1, this.to) < 0 ? Object2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Object2FloatSortedMap<K> tailMap(K var1) {
         if (this.bottom) {
            return Object2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Object2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? Object2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Object2FloatSortedMap<K> subMap(K var1, K var2) {
         if (this.top && this.bottom) {
            return Object2FloatAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Object2FloatAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Object2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Object2FloatAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Object2FloatAVLTreeMap.Entry<K> firstEntry() {
         if (Object2FloatAVLTreeMap.this.tree == null) {
            ...
            Object2FloatAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Object2FloatAVLTreeMap.this.firstEntry;
            } else {
               var1 = Object2FloatAVLTreeMap.this.locateKey(this.from);
               if (Object2FloatAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Object2FloatAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Object2FloatAVLTreeMap.Entry<K> lastEntry() {
         if (Object2FloatAVLTreeMap.this.tree == null) {
            ...
            Object2FloatAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Object2FloatAVLTreeMap.this.lastEntry;
            } else {
               var1 = Object2FloatAVLTreeMap.this.locateKey(this.to);
               if (Object2FloatAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Object2FloatAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public K firstKey() {
         Object2FloatAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public K lastKey() {
         Object2FloatAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Object2FloatAVLTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2FloatMap.Entry<K>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Object2FloatAVLTreeMap<K>.TreeIterator {
         ...
         SubmapIterator(K var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Object2FloatAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Object2FloatAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Object2FloatAVLTreeMap.this.locateKey(var2);
                  if (Object2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractObject2FloatSortedMap<K>.KeySet {
      ...
      public ObjectBidirectionalIterator<K> iterator(K var1) {
         return Object2FloatAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Object2FloatAVLTreeMap<K>.TreeIterator implements ObjectListIterator<Object2FloatMap.Entry<K>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(K var2) {
         super();
         if ((this.next = Object2FloatAVLTreeMap.this.locateKey(var2)) != null) {
            if (Object2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<K> extends AbstractObject2FloatMap.BasicEntry<K> implements Cloneable {
      ...
      void pred(Object2FloatAVLTreeMap.Entry<K> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Object2FloatAVLTreeMap.Entry<K> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Object2FloatAVLTreeMap.Entry<K> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Object2FloatAVLTreeMap.Entry<K> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Object2FloatAVLTreeMap.Entry<K> next() {
         Object2FloatAVLTreeMap.Entry var1 = this.right;
      ...
      Object2FloatAVLTreeMap.Entry<K> prev() {
         Object2FloatAVLTreeMap.Entry var1 = this.left;
      ...
      public Object2FloatAVLTreeMap.Entry<K> clone() {
         Object2FloatAVLTreeMap.Entry var1;
         try {
            var1 = (Object2FloatAVLTreeMap.Entry)super.clone();
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(this.key, var2.getKey()) && Float.floatToIntBits(this.value) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
