...
public class Object2CharOpenHashMap<K> extends AbstractObject2CharMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2CharOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2CharOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2CharOpenHashMap(Map<? extends K, ? extends Character> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2CharOpenHashMap(Map<? extends K, ? extends Character> var1) {
      this(var1, 0.75F);
   }

   public Object2CharOpenHashMap(Object2CharMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2CharOpenHashMap(Object2CharMap<K> var1) {
      this(var1, 0.75F);
   }

   public Object2CharOpenHashMap(K[] var1, char[] var2, float var3) {
   ...
   public Object2CharOpenHashMap(K[] var1, char[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Object2CharOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Object2CharOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n]);
               }

               int var2 = Object2CharOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2CharOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2CharOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2CharOpenHashMap<K> clone() {
      Object2CharOpenHashMap var1;
      try {
         var1 = (Object2CharOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      char[] var3 = this.value;
      Object2CharOpenHashMap.MapIterator var4 = new Object2CharOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2CharOpenHashMap.this.containsNullKey) {
            var1.accept(Object2CharOpenHashMap.this.key[Object2CharOpenHashMap.this.n]);
         }

         int var2 = Object2CharOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2CharOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2CharOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2CharOpenHashMap.this.size;
         Object2CharOpenHashMap.this.removeChar(var1);
         return Object2CharOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<K>> implements Object2CharMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               if (var3 == null) {
                  return Object2CharOpenHashMap.this.containsNullKey && Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2CharOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2CharOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3.equals(var5)) {
                     return Object2CharOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2CharOpenHashMap.this.mask]) != null) {
                        if (var3.equals(var5)) {
                           return Object2CharOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               char var4 = (Character)var2.getValue();
               if (var3 == null) {
                  if (Object2CharOpenHashMap.this.containsNullKey && Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2CharOpenHashMap.this.mask]) == null) {
                     ...
                     if (Object2CharOpenHashMap.this.value[var7] == var4) {
                        Object2CharOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2CharOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!var5.equals(var3) || Object2CharOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2CharMap.Entry<K>> var1) {
         if (Object2CharOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2CharMap.BasicEntry(Object2CharOpenHashMap.this.key[Object2CharOpenHashMap.this.n], Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2CharOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2CharMap.BasicEntry(Object2CharOpenHashMap.this.key[var2], Object2CharOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2CharMap.Entry<K>> var1) {
         ...
         if (Object2CharOpenHashMap.this.containsNullKey) {
            var2.key = Object2CharOpenHashMap.this.key[Object2CharOpenHashMap.this.n];
            var2.value = Object2CharOpenHashMap.this.value[Object2CharOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2CharOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2CharOpenHashMap.this.key[var3] != null) {
               var2.key = Object2CharOpenHashMap.this.key[var3];
               var2.value = Object2CharOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2CharOpenHashMap<K>.MapIterator implements ObjectIterator<Object2CharMap.Entry<K>> {
      private final Object2CharOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2CharOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2CharOpenHashMap<K>.MapIterator implements ObjectIterator<Object2CharMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2CharOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2CharOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2CharOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2CharOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2CharOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & Object2CharOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2CharOpenHashMap.this.value[var2] = Object2CharOpenHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Object2CharOpenHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Object2CharOpenHashMap.this.removeChar(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Object2CharMap.Entry<K>, java.util.Map.Entry<K, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Object2CharOpenHashMap.this.value[this.index];
         Object2CharOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2CharOpenHashMap.this.key[this.index], var2.getKey()) && Object2CharOpenHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
