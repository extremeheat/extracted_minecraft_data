...
public class ObjectLinkedOpenCustomHashSet<K> extends AbstractObjectSortedSet<K> implements Serializable, Cloneable, Hash {
   ...
   public ObjectLinkedOpenCustomHashSet(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.first = -1;
      this.last = -1;
      this.strategy = var3;
   ...
   public ObjectLinkedOpenCustomHashSet(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public ObjectLinkedOpenCustomHashSet(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public ObjectLinkedOpenCustomHashSet(Collection<? extends K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public ObjectLinkedOpenCustomHashSet(Collection<? extends K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public ObjectLinkedOpenCustomHashSet(ObjectCollection<? extends K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public ObjectLinkedOpenCustomHashSet(ObjectCollection<? extends K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public ObjectLinkedOpenCustomHashSet(Iterator<? extends K> var1, float var2, Hash.Strategy<K> var3) {
      this(16, var2, var3);
   ...
   public ObjectLinkedOpenCustomHashSet(Iterator<? extends K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public ObjectLinkedOpenCustomHashSet(K[] var1, int var2, int var3, float var4, Hash.Strategy<K> var5) {
   ...
   public ObjectLinkedOpenCustomHashSet(K[] var1, int var2, int var3, Hash.Strategy<K> var4) {
      this(var1, var2, var3, 0.75F, var4);
   }

   public ObjectLinkedOpenCustomHashSet(K[] var1, float var2, Hash.Strategy<K> var3) {
      this(var1, 0, var1.length, var2, var3);
   }

   public ObjectLinkedOpenCustomHashSet(K[] var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }
   ...
   public K removeFirst() {
      if (this.size == 0) {
         ...
         --this.size;
         if (this.strategy.equals(var2, (Object)null)) {
            this.containsNull = false;
            this.key[this.n] = null;
         } else {
            this.shiftKeys(var1);
   ...
   public boolean addAndMoveToFirst(K var1) {
      ...
      if (this.strategy.equals(var1, (Object)null)) {
         ...
         for(var2 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask; var3[var2] != null; var2 = var2 + 1 & this.mask) {
   ...
   public ObjectListIterator<K> iterator(K var1) {
      return new ObjectLinkedOpenCustomHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         int var9;
         if (this.strategy.equals(var2[var5], (Object)null)) {
            var9 = var1;
         } else {
            for(var9 = HashCommon.mix(this.strategy.hashCode(var2[var5])) & var3; var4[var9] != null; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public ObjectLinkedOpenCustomHashSet<K> clone() {
      ObjectLinkedOpenCustomHashSet var1;
      try {
         var1 = (ObjectLinkedOpenCustomHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var6-- != 0) {
         ...
         int var7;
         if (this.strategy.equals(var5, (Object)null)) {
            var7 = this.n;
            this.containsNull = true;
         } else if (var2[var7 = HashCommon.mix(this.strategy.hashCode(var5)) & this.mask] != null) {
   ...
   private class SetIterator implements ObjectListIterator<K> {
      ...
      SetIterator(K var2) {
         super();
         if (ObjectLinkedOpenCustomHashSet.this.strategy.equals(var2, (Object)null)) {
         ...
         } else if (ObjectLinkedOpenCustomHashSet.this.strategy.equals(ObjectLinkedOpenCustomHashSet.this.key[ObjectLinkedOpenCustomHashSet.this.last], var2)) {
            this.prev = ObjectLinkedOpenCustomHashSet.this.last;
            this.index = ObjectLinkedOpenCustomHashSet.this.size;
         } else {
            Object[] var3 = ObjectLinkedOpenCustomHashSet.this.key;

            for(int var4 = HashCommon.mix(ObjectLinkedOpenCustomHashSet.this.strategy.hashCode(var2)) & ObjectLinkedOpenCustomHashSet.this.mask; var3[var4] != null; var4 = var4 + 1 & ObjectLinkedOpenCustomHashSet.this.mask) {
               if (ObjectLinkedOpenCustomHashSet.this.strategy.equals(var3[var4], var2)) {
                  this.next = (int)ObjectLinkedOpenCustomHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = ObjectLinkedOpenCustomHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)ObjectLinkedOpenCustomHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = ObjectLinkedOpenCustomHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (ObjectLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = ObjectLinkedOpenCustomHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (ObjectLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == ObjectLinkedOpenCustomHashSet.this.n) {
               ...
               Object[] var5 = ObjectLinkedOpenCustomHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & ObjectLinkedOpenCustomHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(ObjectLinkedOpenCustomHashSet.this.strategy.hashCode(var4)) & ObjectLinkedOpenCustomHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  ObjectLinkedOpenCustomHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
