...
public interface Object2ShortMap<K> extends Object2ShortFunction<K>, Map<K, Short> {
   ...
   default Short put(K var1, Short var2) {
      return Object2ShortFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short get(Object var1) {
      return Object2ShortFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Short remove(Object var1) {
      return Object2ShortFunction.super.remove(var1);
   }
   ...
   default short computeShortIfAbsentPartial(K var1, Object2ShortFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.getShort(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<K> extends ObjectSet<Object2ShortMap.Entry<K>> {
      ...
      default void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
