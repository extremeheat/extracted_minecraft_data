...
public class Object2IntOpenCustomHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2IntOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Object2IntOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2IntOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Object2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2IntOpenCustomHashMap(Object2IntMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2IntOpenCustomHashMap(Object2IntMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2IntOpenCustomHashMap(K[] var1, int[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Object2IntOpenCustomHashMap(K[] var1, int[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Object2IntOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n]);
               }

               int var2 = Object2IntOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2IntOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Object2IntOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2IntOpenCustomHashMap<K> clone() {
      Object2IntOpenCustomHashMap var1;
      try {
         var1 = (Object2IntOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      int[] var3 = this.value;
      Object2IntOpenCustomHashMap.MapIterator var4 = new Object2IntOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n]);
         }

         int var2 = Object2IntOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2IntOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2IntOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2IntOpenCustomHashMap.this.size;
         Object2IntOpenCustomHashMap.this.removeInt(var1);
         return Object2IntOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Integer) {
               ...
               if (Object2IntOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Object2IntOpenCustomHashMap.this.containsNullKey && Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2IntOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2IntOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Object2IntOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2IntOpenCustomHashMap.this.mask]) != null) {
                        if (Object2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Object2IntOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Integer) {
               ...
               int var4 = (Integer)var2.getValue();
               if (Object2IntOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Object2IntOpenCustomHashMap.this.containsNullKey && Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2IntOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2IntOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Object2IntOpenCustomHashMap.this.value[var7] == var4) {
                        Object2IntOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2IntOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Object2IntOpenCustomHashMap.this.strategy.equals(var5, var3) || Object2IntOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2IntMap.Entry<K>> var1) {
         if (Object2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n], Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2IntOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenCustomHashMap.this.key[var2], Object2IntOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> var1) {
         ...
         if (Object2IntOpenCustomHashMap.this.containsNullKey) {
            var2.key = Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n];
            var2.value = Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2IntOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Object2IntOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Object2IntOpenCustomHashMap.this.key[var3];
               var2.value = Object2IntOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
      private final Object2IntOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2IntOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2IntOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(var2)) & Object2IntOpenCustomHashMap.this.mask; !Object2IntOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Object2IntOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2IntOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2IntOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(var4)) & Object2IntOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2IntOpenCustomHashMap.this.value[var2] = Object2IntOpenCustomHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Object2IntOpenCustomHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Object2IntOpenCustomHashMap.this.removeInt(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Object2IntMap.Entry<K>, java.util.Map.Entry<K, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Object2IntOpenCustomHashMap.this.value[this.index];
         Object2IntOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Object2IntOpenCustomHashMap.this.strategy.equals(Object2IntOpenCustomHashMap.this.key[this.index], var2.getKey()) && Object2IntOpenCustomHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
