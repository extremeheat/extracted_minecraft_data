...
public final class ObjectBigLists {
   ...
   public static <K> ObjectBigList<K> shuffle(ObjectBigList<K> var0, Random var1) {
   ...
   public static <K> ObjectBigList<K> singleton(K var0) {
      return new ObjectBigLists.Singleton(var0);
   }

   public static <K> ObjectBigList<K> synchronize(ObjectBigList<K> var0) {
      return new ObjectBigLists.SynchronizedBigList(var0);
   }

   public static <K> ObjectBigList<K> synchronize(ObjectBigList<K> var0, Object var1) {
      return new ObjectBigLists.SynchronizedBigList(var0, var1);
   }

   public static <K> ObjectBigList<K> unmodifiable(ObjectBigList<K> var0) {
      return new ObjectBigLists.UnmodifiableBigList(var0);
   }

   public static <K> ObjectBigList<K> asBigList(ObjectList<K> var0) {
      return new ObjectBigLists.ListBigList(var0);
   }
   ...
   public static class ListBigList<K> extends AbstractObjectBigList<K> implements Serializable {
      ...
      protected ListBigList(ObjectList<K> var1) {
         super();
         this.list = var1;
      }
      ...
      public ObjectBigList<K> subList(long var1, long var3) {
         return new ObjectBigLists.ListBigList(this.list.subList(this.intIndex(var1), this.intIndex(var3)));
      }
   ...
   public static class UnmodifiableBigList<K> extends ObjectCollections.UnmodifiableCollection<K> implements ObjectBigList<K>, Serializable {
      ...
      protected UnmodifiableBigList(ObjectBigList<K> var1) {
         super(var1);
         this.list = var1;
      }
      ...
      public ObjectBigList<K> subList(long var1, long var3) {
         return ObjectBigLists.unmodifiable(this.list.subList(var1, var3));
      }
   ...
   public static class SynchronizedBigList<K> extends ObjectCollections.SynchronizedCollection<K> implements ObjectBigList<K>, Serializable {
      ...
      protected SynchronizedBigList(ObjectBigList<K> var1, Object var2) {
         super(var1, var2);
         this.list = var1;
      }

      protected SynchronizedBigList(ObjectBigList<K> var1) {
         super(var1);
         this.list = var1;
      }
      ...
      public ObjectBigList<K> subList(long var1, long var3) {
         synchronized(this.sync) {
            return ObjectBigLists.synchronize(this.list.subList(var1, var3), this.sync);
         }
      }
   ...
   public static class Singleton<K> extends AbstractObjectBigList<K> implements Serializable, Cloneable {
      ...
      public ObjectBigList<K> subList(long var1, long var3) {
         ...
         if (var1 > var3) {
            ...
            return (ObjectBigList)(var1 == 0L && var3 == 1L ? this : ObjectBigLists.EMPTY_BIG_LIST);
         }
      }
