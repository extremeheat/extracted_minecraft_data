...
public class ObjectArrayList<K> extends AbstractObjectList<K> implements RandomAccess, Cloneable, Serializable {
   ...
   protected ObjectArrayList(K[] var1, boolean var2) {
      super();
      this.a = var1;
      this.wrapped = true;
   }
   ...
   public ObjectArrayList(Collection<? extends K> var1) {
      this(var1.size());
      this.size = ObjectIterators.unwrap(var1.iterator(), this.a);
   }

   public ObjectArrayList(ObjectCollection<? extends K> var1) {
      this(var1.size());
      this.size = ObjectIterators.unwrap(var1.iterator(), (Object[])this.a);
   }

   public ObjectArrayList(ObjectList<? extends K> var1) {
      this(var1.size());
      var1.getElements(0, this.a, 0, this.size = var1.size());
   }

   public ObjectArrayList(K[] var1) {
      this(var1, 0, var1.length);
   }

   public ObjectArrayList(K[] var1, int var2, int var3) {
      this(var3);
      System.arraycopy(var1, var2, this.a, 0, var3);
      this.size = var3;
   }

   public ObjectArrayList(Iterator<? extends K> var1) {
      this();
   ...
   public ObjectArrayList(ObjectIterator<? extends K> var1) {
      this();
   ...
   public static <K> ObjectArrayList<K> wrap(K[] var0, int var1) {
      if (var1 > var0.length) {
         throw new IllegalArgumentException("The specified length (" + var1 + ") is greater than the array size (" + var0.length + ")");
      } else {
         ObjectArrayList var2 = new ObjectArrayList(var0, false);
         var2.size = var1;
         return var2;
      }
   }

   public static <K> ObjectArrayList<K> wrap(K[] var0) {
   ...
   public int indexOf(Object var1) {
      for(int var2 = 0; var2 < this.size; ++var2) {
         if (Objects.equals(var1, this.a[var2])) {
            return var2;
         }
      }
   ...
   public int lastIndexOf(Object var1) {
      ...
      } while(!Objects.equals(var1, this.a[var2]));
   ...
   public ObjectListIterator<K> listIterator(final int var1) {
      ...
      return new ObjectListIterator<K>() {
         ...
         public void add(K var1x) {
            ObjectArrayList.this.add(this.pos++, var1x);
            this.last = -1;
         }
         ...
         public void set(K var1x) {
            if (this.last == -1) {
               ...
               ObjectArrayList.this.set(this.last, var1x);
            }
         }
   ...
   public ObjectArrayList<K> clone() {
      ObjectArrayList var1 = new ObjectArrayList(this.size);
   ...
   public boolean equals(ObjectArrayList<K> var1) {
      if (var1 == this) {
         return true;
      } else {
         int var2 = this.size();
         if (var2 != var1.size()) {
            ...
            } while(this.valEquals(var3[var2], var4[var2]));
   ...
   public int compareTo(ObjectArrayList<? extends K> var1) {
      int var2 = this.size();
      int var3 = var1.size();
      Object[] var4 = this.a;
      Object[] var5 = var1.a;
      ...
      for(var9 = 0; var9 < var2 && var9 < var3; ++var9) {
         Object var6 = var4[var9];
         Object var7 = var5[var9];
         int var8;
         if ((var8 = ((Comparable)var6).compareTo(var7)) != 0) {
            return var8;
         }
      }
