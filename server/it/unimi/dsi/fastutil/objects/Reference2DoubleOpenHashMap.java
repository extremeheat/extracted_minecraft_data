...
public class Reference2DoubleOpenHashMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2DoubleOpenHashMap(int var1, float var2) {
      super();
   ...
   public Reference2DoubleOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Reference2DoubleOpenHashMap(Map<? extends K, ? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2DoubleOpenHashMap(Map<? extends K, ? extends Double> var1) {
      this(var1, 0.75F);
   }

   public Reference2DoubleOpenHashMap(Reference2DoubleMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2DoubleOpenHashMap(Reference2DoubleMap<K> var1) {
      this(var1, 0.75F);
   }

   public Reference2DoubleOpenHashMap(K[] var1, double[] var2, float var3) {
   ...
   public Reference2DoubleOpenHashMap(K[] var1, double[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Reference2DoubleOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Reference2DoubleOpenHashMap.this.containsNullKey) {
                  var1.accept(Reference2DoubleOpenHashMap.this.value[Reference2DoubleOpenHashMap.this.n]);
               }

               int var2 = Reference2DoubleOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2DoubleOpenHashMap.this.key[var2] != null) {
                     var1.accept(Reference2DoubleOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2DoubleOpenHashMap<K> clone() {
      Reference2DoubleOpenHashMap var1;
      try {
         var1 = (Reference2DoubleOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      double[] var3 = this.value;
      Reference2DoubleOpenHashMap.MapIterator var4 = new Reference2DoubleOpenHashMap.MapIterator();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var7 = this.size; var7-- != 0; var3[var8] = var5) {
         ...
         if (var4 == null) {
            ...
            for(var8 = HashCommon.mix(System.identityHashCode(var4)) & this.mask; var2[var8] != null; var8 = var8 + 1 & this.mask) {
            }
         }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(Reference2DoubleOpenHashMap.this.key[Reference2DoubleOpenHashMap.this.n]);
         }

         int var2 = Reference2DoubleOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2DoubleOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2DoubleOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2DoubleOpenHashMap.this.size;
         Reference2DoubleOpenHashMap.this.removeDouble(var1);
         return Reference2DoubleOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               if (var3 == null) {
                  return Reference2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[Reference2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4);
               } else {
                  Object[] var7 = Reference2DoubleOpenHashMap.this.key;
                  Object var6;
                  int var8;
                  if ((var6 = var7[var8 = HashCommon.mix(System.identityHashCode(var3)) & Reference2DoubleOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3 == var6) {
                     return Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                  } else {
                     while((var6 = var7[var8 = var8 + 1 & Reference2DoubleOpenHashMap.this.mask]) != null) {
                        if (var3 == var6) {
                           return Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               double var4 = (Double)var2.getValue();
               if (var3 == null) {
                  if (Reference2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[Reference2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                  ...
                  if ((var6 = var7[var8 = HashCommon.mix(System.identityHashCode(var3)) & Reference2DoubleOpenHashMap.this.mask]) == null) {
                     ...
                     if (Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                        Reference2DoubleOpenHashMap.this.removeEntry(var8);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var7[var8 = var8 + 1 & Reference2DoubleOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(var6 != var3 || Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> var1) {
         if (Reference2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleOpenHashMap.this.key[Reference2DoubleOpenHashMap.this.n], Reference2DoubleOpenHashMap.this.value[Reference2DoubleOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2DoubleOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleOpenHashMap.this.key[var2], Reference2DoubleOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2DoubleMap.Entry<K>> var1) {
         ...
         if (Reference2DoubleOpenHashMap.this.containsNullKey) {
            var2.key = Reference2DoubleOpenHashMap.this.key[Reference2DoubleOpenHashMap.this.n];
            var2.value = Reference2DoubleOpenHashMap.this.value[Reference2DoubleOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2DoubleOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2DoubleOpenHashMap.this.key[var3] != null) {
               var2.key = Reference2DoubleOpenHashMap.this.key[var3];
               var2.value = Reference2DoubleOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2DoubleOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2DoubleMap.Entry<K>> {
      private final Reference2DoubleOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2DoubleOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2DoubleOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2DoubleMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2DoubleOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(System.identityHashCode(var2)) & Reference2DoubleOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Reference2DoubleOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2DoubleOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2DoubleOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(System.identityHashCode(var4)) & Reference2DoubleOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2DoubleOpenHashMap.this.value[var2] = Reference2DoubleOpenHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Reference2DoubleOpenHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Reference2DoubleOpenHashMap.this.removeDouble(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Reference2DoubleMap.Entry<K>, java.util.Map.Entry<K, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Reference2DoubleOpenHashMap.this.value[this.index];
         Reference2DoubleOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2DoubleOpenHashMap.this.key[this.index] == var2.getKey() && Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
