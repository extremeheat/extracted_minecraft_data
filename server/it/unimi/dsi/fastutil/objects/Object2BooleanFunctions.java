...
public final class Object2BooleanFunctions {
   public static final Object2BooleanFunctions.EmptyFunction EMPTY_FUNCTION = new Object2BooleanFunctions.EmptyFunction();

   private Object2BooleanFunctions() {
      super();
   }

   public static <K> Object2BooleanFunction<K> singleton(K var0, boolean var1) {
      return new Object2BooleanFunctions.Singleton(var0, var1);
   }
   ...
   public static <K> Object2BooleanFunction<K> synchronize(Object2BooleanFunction<K> var0) {
      return new Object2BooleanFunctions.SynchronizedFunction(var0);
   }

   public static <K> Object2BooleanFunction<K> synchronize(Object2BooleanFunction<K> var0, Object var1) {
      return new Object2BooleanFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K> Object2BooleanFunction<K> unmodifiable(Object2BooleanFunction<K> var0) {
      return new Object2BooleanFunctions.UnmodifiableFunction(var0);
   }

   public static <K> Object2BooleanFunction<K> primitive(Function<? super K, ? extends Boolean> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Object2BooleanFunction) {
         return (Object2BooleanFunction)var0;
      } else {
         return (Object2BooleanFunction)(var0 instanceof Predicate ? (var1) -> {
            return ((Predicate)var0).test(var1);
         } : new Object2BooleanFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class UnmodifiableFunction<K> extends AbstractObject2BooleanFunction<K> implements Serializable {
      ...
      protected UnmodifiableFunction(Object2BooleanFunction<K> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K> implements Object2BooleanFunction<K>, Serializable {
      ...
      protected SynchronizedFunction(Object2BooleanFunction<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Object2BooleanFunction<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
