...
public interface Object2DoubleMap<K> extends Object2DoubleFunction<K>, Map<K, Double> {
   ...
   default Double put(K var1, Double var2) {
      return Object2DoubleFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double get(Object var1) {
      return Object2DoubleFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Double remove(Object var1) {
      return Object2DoubleFunction.super.remove(var1);
   }
   ...
   default double computeDoubleIfAbsentPartial(K var1, Object2DoubleFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.getDouble(var1);
   ...
   public interface FastEntrySet<K> extends ObjectSet<Object2DoubleMap.Entry<K>> {
      ...
      default void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
