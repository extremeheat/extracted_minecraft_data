...
public class Object2FloatRBTreeMap<K> extends AbstractObject2FloatSortedMap<K> implements Serializable, Cloneable {
   ...
   public Object2FloatRBTreeMap(Comparator<? super K> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Object2FloatRBTreeMap(Map<? extends K, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Object2FloatRBTreeMap(SortedMap<K, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2FloatRBTreeMap(Object2FloatMap<? extends K> var1) {
      this();
      this.putAll(var1);
   }

   public Object2FloatRBTreeMap(Object2FloatSortedMap<K> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2FloatRBTreeMap(K[] var1, float[] var2, Comparator<? super K> var3) {
      this(var3);
   ...
   public Object2FloatRBTreeMap(K[] var1, float[] var2) {
   ...
   final Object2FloatRBTreeMap.Entry<K> findKey(K var1) {
      Object2FloatRBTreeMap.Entry var2;
      int var3;
   ...
   final Object2FloatRBTreeMap.Entry<K> locateKey(K var1) {
      Object2FloatRBTreeMap.Entry var2 = this.tree;
      Object2FloatRBTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(K var1, float var2) {
      Object2FloatRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Object2FloatRBTreeMap.Entry<K> add(K var1) {
      this.modified = false;
      int var2 = 0;
      Object2FloatRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Object2FloatRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Object2FloatRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Object2FloatRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Object2FloatRBTreeMap.Entry var7;
               Object2FloatRBTreeMap.Entry var8;
   ...
   public boolean containsValue(float var1) {
      Object2FloatRBTreeMap.ValueIterator var2 = new Object2FloatRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float getFloat(Object var1) {
      Object2FloatRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
            final Comparator<? super Object2FloatMap.Entry<K>> comparator = (var1x, var2) -> {
               return Object2FloatRBTreeMap.this.actualComparator.compare(var1x.getKey(), var2.getKey());
            };
            ...
            public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> var1) {
               return Object2FloatRBTreeMap.this.new EntryIterator(var1.getKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Float) {
                     Object2FloatRBTreeMap.Entry var3 = Object2FloatRBTreeMap.this.findKey(var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Float) {
                     ...
                     if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                        Object2FloatRBTreeMap.this.removeFloat(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> var1, Object2FloatMap.Entry<K> var2) {
               return Object2FloatRBTreeMap.this.subMap(var1.getKey(), var2.getKey()).object2FloatEntrySet();
            }

            public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> var1) {
               return Object2FloatRBTreeMap.this.headMap(var1.getKey()).object2FloatEntrySet();
            }

            public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> var1) {
               return Object2FloatRBTreeMap.this.tailMap(var1.getKey()).object2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Object2FloatRBTreeMap.this.containsValue(var1);
            }
   ...
   public Object2FloatSortedMap<K> headMap(K var1) {
      return new Object2FloatRBTreeMap.Submap((Object)null, true, var1, false);
   }

   public Object2FloatSortedMap<K> tailMap(K var1) {
      return new Object2FloatRBTreeMap.Submap(var1, false, (Object)null, true);
   }

   public Object2FloatSortedMap<K> subMap(K var1, K var2) {
      return new Object2FloatRBTreeMap.Submap(var1, false, var2, false);
   }

   public Object2FloatRBTreeMap<K> clone() {
      Object2FloatRBTreeMap var1;
      try {
         var1 = (Object2FloatRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Object2FloatRBTreeMap.Entry var5 = new Object2FloatRBTreeMap.Entry();
         Object2FloatRBTreeMap.Entry var6 = new Object2FloatRBTreeMap.Entry();
         Object2FloatRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Object2FloatRBTreeMap.Entry var4 = var6;
         var6.pred((Object2FloatRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Object2FloatRBTreeMap.EntryIterator var3 = new Object2FloatRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Object2FloatRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Object2FloatRBTreeMap.Entry<K> readTree(ObjectInputStream var1, int var2, Object2FloatRBTreeMap.Entry<K> var3, Object2FloatRBTreeMap.Entry<K> var4) throws IOException, ClassNotFoundException {
      Object2FloatRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Object2FloatRBTreeMap.Entry(var1.readObject(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Object2FloatRBTreeMap.Entry(var1.readObject(), var1.readFloat());
         var8.black(true);
         var8.right(new Object2FloatRBTreeMap.Entry(var1.readObject(), var1.readFloat()));
         ...
         Object2FloatRBTreeMap.Entry var7 = new Object2FloatRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Object2FloatRBTreeMap.Entry)null, (Object2FloatRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractObject2FloatSortedMap<K> implements Serializable {
      ...
      public Submap(K var2, boolean var3, K var4, boolean var5) {
         super();
         if (!var3 && !var5 && Object2FloatRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Object2FloatRBTreeMap.Submap.SubmapIterator var1 = new Object2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(K var1) {
         return (this.bottom || Object2FloatRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Object2FloatRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(Object var1) {
         return this.in(var1) && Object2FloatRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Object2FloatRBTreeMap.Submap.SubmapIterator var2 = new Object2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      public float getFloat(Object var1) {
         Object2FloatRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Object2FloatRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(K var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Object2FloatRBTreeMap.this.put(var1, var2);
            return Object2FloatRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float removeFloat(Object var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Object2FloatRBTreeMap.this.removeFloat(var1);
            return Object2FloatRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Object2FloatSortedMap<K> headMap(K var1) {
         if (this.top) {
            return Object2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Object2FloatRBTreeMap.this.compare(var1, this.to) < 0 ? Object2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Object2FloatSortedMap<K> tailMap(K var1) {
         if (this.bottom) {
            return Object2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Object2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? Object2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Object2FloatSortedMap<K> subMap(K var1, K var2) {
         if (this.top && this.bottom) {
            return Object2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Object2FloatRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Object2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Object2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Object2FloatRBTreeMap.Entry<K> firstEntry() {
         if (Object2FloatRBTreeMap.this.tree == null) {
            ...
            Object2FloatRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Object2FloatRBTreeMap.this.firstEntry;
            } else {
               var1 = Object2FloatRBTreeMap.this.locateKey(this.from);
               if (Object2FloatRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Object2FloatRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Object2FloatRBTreeMap.Entry<K> lastEntry() {
         if (Object2FloatRBTreeMap.this.tree == null) {
            ...
            Object2FloatRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Object2FloatRBTreeMap.this.lastEntry;
            } else {
               var1 = Object2FloatRBTreeMap.this.locateKey(this.to);
               if (Object2FloatRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Object2FloatRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public K firstKey() {
         Object2FloatRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public K lastKey() {
         Object2FloatRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Object2FloatRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2FloatMap.Entry<K>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Object2FloatRBTreeMap<K>.TreeIterator {
         ...
         SubmapIterator(K var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Object2FloatRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Object2FloatRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Object2FloatRBTreeMap.this.locateKey(var2);
                  if (Object2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractObject2FloatSortedMap<K>.KeySet {
      ...
      public ObjectBidirectionalIterator<K> iterator(K var1) {
         return Object2FloatRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Object2FloatRBTreeMap<K>.TreeIterator implements ObjectListIterator<Object2FloatMap.Entry<K>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(K var2) {
         super();
         if ((this.next = Object2FloatRBTreeMap.this.locateKey(var2)) != null) {
            if (Object2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<K> extends AbstractObject2FloatMap.BasicEntry<K> implements Cloneable {
      ...
      void pred(Object2FloatRBTreeMap.Entry<K> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Object2FloatRBTreeMap.Entry<K> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Object2FloatRBTreeMap.Entry<K> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Object2FloatRBTreeMap.Entry<K> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Object2FloatRBTreeMap.Entry<K> next() {
         Object2FloatRBTreeMap.Entry var1 = this.right;
      ...
      Object2FloatRBTreeMap.Entry<K> prev() {
         Object2FloatRBTreeMap.Entry var1 = this.left;
      ...
      public Object2FloatRBTreeMap.Entry<K> clone() {
         Object2FloatRBTreeMap.Entry var1;
         try {
            var1 = (Object2FloatRBTreeMap.Entry)super.clone();
