...
public abstract class AbstractReference2IntMap<K> extends AbstractReference2IntFunction<K> implements Reference2IntMap<K>, Serializable {
   ...
   public boolean containsKey(Object var1) {
      ObjectIterator var2 = this.reference2IntEntrySet().iterator();

      do {
         if (!var2.hasNext()) {
            return false;
         }
      } while(((Reference2IntMap.Entry)var2.next()).getKey() != var1);
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return AbstractReference2IntMap.this.containsKey(var1);
         }
   ...
   public IntCollection values() {
      return new AbstractIntCollection() {
         public boolean contains(int var1) {
            return AbstractReference2IntMap.this.containsValue(var1);
         }
   ...
   public void putAll(Map<? extends K, ? extends Integer> var1) {
      if (var1 instanceof Reference2IntMap) {
         ObjectIterator var2 = Reference2IntMaps.fastIterator((Reference2IntMap)var1);

         while(var2.hasNext()) {
            Reference2IntMap.Entry var3 = (Reference2IntMap.Entry)var2.next();
   ...
   public int hashCode() {
      ...
      for(ObjectIterator var3 = Reference2IntMaps.fastIterator(this); var2-- != 0; var1 += ((Reference2IntMap.Entry)var3.next()).hashCode()) {
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         Map var2 = (Map)var1;
         return var2.size() != this.size() ? false : this.reference2IntEntrySet().containsAll(var2.entrySet());
      }
   }

   public String toString() {
      StringBuilder var1 = new StringBuilder();
      ObjectIterator var2 = Reference2IntMaps.fastIterator(this);
      int var3 = this.size();
      boolean var5 = true;
      var1.append("{");
      ...
      while(var3-- != 0) {
         ...
         Reference2IntMap.Entry var4 = (Reference2IntMap.Entry)var2.next();
         if (this == var4.getKey()) {
   ...
   public abstract static class BasicEntrySet<K> extends AbstractObjectSet<Reference2IntMap.Entry<K>> {
      ...
      public BasicEntrySet(Reference2IntMap<K> var1) {
         super();
         this.map = var1;
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Object var3;
            if (var1 instanceof Reference2IntMap.Entry) {
               Reference2IntMap.Entry var5 = (Reference2IntMap.Entry)var1;
               var3 = var5.getKey();
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            return false;
         } else if (var1 instanceof Reference2IntMap.Entry) {
            Reference2IntMap.Entry var6 = (Reference2IntMap.Entry)var1;
   ...
   public static class BasicEntry<K> implements Reference2IntMap.Entry<K> {
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Reference2IntMap.Entry var5 = (Reference2IntMap.Entry)var1;
            return this.key == var5.getKey() && this.value == var5.getIntValue();
         } else {
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            Object var3 = var2.getKey();
            Object var4 = var2.getValue();
            if (var4 != null && var4 instanceof Integer) {
               return this.key == var3 && this.value == (Integer)var4;
            } else {
               return false;
            }
         }
