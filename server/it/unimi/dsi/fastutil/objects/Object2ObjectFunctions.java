...
public final class Object2ObjectFunctions {
   ...
   public static <K, V> Object2ObjectFunction<K, V> singleton(K var0, V var1) {
      return new Object2ObjectFunctions.Singleton(var0, var1);
   }

   public static <K, V> Object2ObjectFunction<K, V> synchronize(Object2ObjectFunction<K, V> var0) {
      return new Object2ObjectFunctions.SynchronizedFunction(var0);
   }

   public static <K, V> Object2ObjectFunction<K, V> synchronize(Object2ObjectFunction<K, V> var0, Object var1) {
      return new Object2ObjectFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K, V> Object2ObjectFunction<K, V> unmodifiable(Object2ObjectFunction<K, V> var0) {
      return new Object2ObjectFunctions.UnmodifiableFunction(var0);
   }
   ...
   public static class UnmodifiableFunction<K, V> extends AbstractObject2ObjectFunction<K, V> implements Serializable {
      ...
      protected UnmodifiableFunction(Object2ObjectFunction<K, V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K, V> implements Object2ObjectFunction<K, V>, Serializable {
      ...
      protected SynchronizedFunction(Object2ObjectFunction<K, V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Object2ObjectFunction<K, V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
