...
public class Object2ByteOpenCustomHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2ByteOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Object2ByteOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2ByteOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Object2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2ByteOpenCustomHashMap(Object2ByteMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2ByteOpenCustomHashMap(Object2ByteMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2ByteOpenCustomHashMap(K[] var1, byte[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Object2ByteOpenCustomHashMap(K[] var1, byte[] var2, Hash.Strategy<K> var3) {
   ...
   public Object2ByteMap.FastEntrySet<K> object2ByteEntrySet() {
      if (this.entries == null) {
         this.entries = new Object2ByteOpenCustomHashMap.MapEntrySet();
      }
   ...
   public ObjectSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Object2ByteOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            public ByteIterator iterator() {
               return Object2ByteOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(byte var1) {
               return Object2ByteOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]);
               }

               int var2 = Object2ByteOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2ByteOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Object2ByteOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2ByteOpenCustomHashMap<K> clone() {
      Object2ByteOpenCustomHashMap var1;
      try {
         var1 = (Object2ByteOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      byte[] var3 = this.value;
      Object2ByteOpenCustomHashMap.MapIterator var4 = new Object2ByteOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator implements ByteIterator {
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return Object2ByteOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(Consumer<? super K> var1) {
         if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n]);
         }

         int var2 = Object2ByteOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2ByteOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2ByteOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2ByteOpenCustomHashMap.this.size;
         Object2ByteOpenCustomHashMap.this.removeByte(var1);
         return Object2ByteOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements Object2ByteMap.FastEntrySet<K> {
      ...
      public ObjectIterator<Object2ByteMap.Entry<K>> iterator() {
         return Object2ByteOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator() {
         return Object2ByteOpenCustomHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               if (Object2ByteOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Object2ByteOpenCustomHashMap.this.containsNullKey && Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2ByteOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2ByteOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Object2ByteOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2ByteOpenCustomHashMap.this.mask]) != null) {
                        if (Object2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Object2ByteOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               byte var4 = (Byte)var2.getValue();
               if (Object2ByteOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Object2ByteOpenCustomHashMap.this.containsNullKey && Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2ByteOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2ByteOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Object2ByteOpenCustomHashMap.this.value[var7] == var4) {
                        Object2ByteOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2ByteOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Object2ByteOpenCustomHashMap.this.strategy.equals(var5, var3) || Object2ByteOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2ByteMap.Entry<K>> var1) {
         if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n], Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2ByteOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteOpenCustomHashMap.this.key[var2], Object2ByteOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> var1) {
         ...
         if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
            var2.key = Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n];
            var2.value = Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2ByteOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Object2ByteOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Object2ByteOpenCustomHashMap.this.key[var3];
               var2.value = Object2ByteOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2ByteMap.Entry<K>> {
      private final Object2ByteOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2ByteOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2ByteMap.Entry<K>> {
      ...
      public Object2ByteOpenCustomHashMap<K>.MapEntry next() {
         return this.entry = Object2ByteOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2ByteOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(var2)) & Object2ByteOpenCustomHashMap.this.mask; !Object2ByteOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Object2ByteOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2ByteOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2ByteOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(var4)) & Object2ByteOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2ByteOpenCustomHashMap.this.value[var2] = Object2ByteOpenCustomHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Object2ByteOpenCustomHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Object2ByteOpenCustomHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Object2ByteMap.Entry<K>, java.util.Map.Entry<K, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Object2ByteOpenCustomHashMap.this.value[this.index];
         Object2ByteOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[this.index], var2.getKey()) && Object2ByteOpenCustomHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
