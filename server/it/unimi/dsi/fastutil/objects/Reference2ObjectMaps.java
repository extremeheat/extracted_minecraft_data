...
public final class Reference2ObjectMaps {
   ...
   public static <K, V> ObjectIterator<Reference2ObjectMap.Entry<K, V>> fastIterator(Reference2ObjectMap<K, V> var0) {
      ObjectSet var1 = var0.reference2ObjectEntrySet();
      return var1 instanceof Reference2ObjectMap.FastEntrySet ? ((Reference2ObjectMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static <K, V> void fastForEach(Reference2ObjectMap<K, V> var0, Consumer<? super Reference2ObjectMap.Entry<K, V>> var1) {
      ObjectSet var2 = var0.reference2ObjectEntrySet();
      if (var2 instanceof Reference2ObjectMap.FastEntrySet) {
         ((Reference2ObjectMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static <K, V> ObjectIterable<Reference2ObjectMap.Entry<K, V>> fastIterable(Reference2ObjectMap<K, V> var0) {
      final ObjectSet var1 = var0.reference2ObjectEntrySet();
      return (ObjectIterable)(var1 instanceof Reference2ObjectMap.FastEntrySet ? new ObjectIterable<Reference2ObjectMap.Entry<K, V>>() {
         public ObjectIterator<Reference2ObjectMap.Entry<K, V>> iterator() {
            return ((Reference2ObjectMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> var1x) {
            ((Reference2ObjectMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }
   ...
   public static <K, V> Reference2ObjectMap<K, V> singleton(K var0, V var1) {
      return new Reference2ObjectMaps.Singleton(var0, var1);
   }

   public static <K, V> Reference2ObjectMap<K, V> synchronize(Reference2ObjectMap<K, V> var0) {
      return new Reference2ObjectMaps.SynchronizedMap(var0);
   }

   public static <K, V> Reference2ObjectMap<K, V> synchronize(Reference2ObjectMap<K, V> var0, Object var1) {
      return new Reference2ObjectMaps.SynchronizedMap(var0, var1);
   }

   public static <K, V> Reference2ObjectMap<K, V> unmodifiable(Reference2ObjectMap<K, V> var0) {
      return new Reference2ObjectMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap<K, V> extends Reference2ObjectFunctions.UnmodifiableFunction<K, V> implements Reference2ObjectMap<K, V>, Serializable {
      ...
      protected UnmodifiableMap(Reference2ObjectMap<K, V> var1) {
         super(var1);
         this.map = var1;
      }
   ...
   public static class SynchronizedMap<K, V> extends Reference2ObjectFunctions.SynchronizedFunction<K, V> implements Reference2ObjectMap<K, V>, Serializable {
      ...
      protected SynchronizedMap(Reference2ObjectMap<K, V> var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Reference2ObjectMap<K, V> var1) {
         super(var1);
         this.map = var1;
      }
