...
public final class Reference2ShortMaps {
   ...
   public static <K> ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator(Reference2ShortMap<K> var0) {
      ObjectSet var1 = var0.reference2ShortEntrySet();
      return var1 instanceof Reference2ShortMap.FastEntrySet ? ((Reference2ShortMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static <K> void fastForEach(Reference2ShortMap<K> var0, Consumer<? super Reference2ShortMap.Entry<K>> var1) {
      ObjectSet var2 = var0.reference2ShortEntrySet();
      if (var2 instanceof Reference2ShortMap.FastEntrySet) {
         ((Reference2ShortMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static <K> ObjectIterable<Reference2ShortMap.Entry<K>> fastIterable(Reference2ShortMap<K> var0) {
      final ObjectSet var1 = var0.reference2ShortEntrySet();
      return (ObjectIterable)(var1 instanceof Reference2ShortMap.FastEntrySet ? new ObjectIterable<Reference2ShortMap.Entry<K>>() {
         public ObjectIterator<Reference2ShortMap.Entry<K>> iterator() {
            return ((Reference2ShortMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> var1x) {
            ((Reference2ShortMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }
   ...
   public static <K> Reference2ShortMap<K> singleton(K var0, short var1) {
      return new Reference2ShortMaps.Singleton(var0, var1);
   }
   ...
   public static <K> Reference2ShortMap<K> synchronize(Reference2ShortMap<K> var0) {
      return new Reference2ShortMaps.SynchronizedMap(var0);
   }

   public static <K> Reference2ShortMap<K> synchronize(Reference2ShortMap<K> var0, Object var1) {
      return new Reference2ShortMaps.SynchronizedMap(var0, var1);
   }

   public static <K> Reference2ShortMap<K> unmodifiable(Reference2ShortMap<K> var0) {
      return new Reference2ShortMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap<K> extends Reference2ShortFunctions.UnmodifiableFunction<K> implements Reference2ShortMap<K>, Serializable {
      ...
      protected UnmodifiableMap(Reference2ShortMap<K> var1) {
         super(var1);
         this.map = var1;
      }
      ...
      public short computeShortIfAbsentPartial(K var1, Reference2ShortFunction<? super K> var2) {
         throw new UnsupportedOperationException();
      }
   ...
   public static class SynchronizedMap<K> extends Reference2ShortFunctions.SynchronizedFunction<K> implements Reference2ShortMap<K>, Serializable {
      ...
      protected SynchronizedMap(Reference2ShortMap<K> var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Reference2ShortMap<K> var1) {
         super(var1);
         this.map = var1;
      }
