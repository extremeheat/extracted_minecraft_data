...
public class Reference2BooleanArrayMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable {
   ...
   public Reference2BooleanArrayMap(Object[] var1, boolean[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2BooleanArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new boolean[var1];
   }

   public Reference2BooleanArrayMap(Reference2BooleanMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2BooleanArrayMap(Map<? extends K, ? extends Boolean> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2BooleanArrayMap(Object[] var1, boolean[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Reference2BooleanMap.FastEntrySet<K> reference2BooleanEntrySet() {
      return new Reference2BooleanArrayMap.EntrySet();
   }
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2BooleanArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2BooleanArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2BooleanArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2BooleanArrayMap.this.key, var2 + 1, Reference2BooleanArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2BooleanArrayMap.this.value, var2 + 1, Reference2BooleanArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2BooleanArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2BooleanArrayMap.this.key, this.pos, Reference2BooleanArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2BooleanArrayMap.this.value, this.pos, Reference2BooleanArrayMap.this.value, this.pos - 1, var1);
                     Reference2BooleanArrayMap.this.size--;
                  }
               }
            };
   ...
   public BooleanCollection values() {
      return new AbstractBooleanCollection() {
         public boolean contains(boolean var1) {
            return Reference2BooleanArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2BooleanArrayMap<K> clone() {
      Reference2BooleanArrayMap var1;
      try {
         var1 = (Reference2BooleanArrayMap)super.clone();
         ...
         return new ObjectIterator<Reference2BooleanMap.Entry<K>>() {
            ...
            public Reference2BooleanMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanArrayMap.this.key[this.curr = this.next], Reference2BooleanArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2BooleanArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2BooleanArrayMap.this.key, this.next + 1, Reference2BooleanArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2BooleanArrayMap.this.value, this.next + 1, Reference2BooleanArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2BooleanMap.Entry<K>>() {
            ...
            public Reference2BooleanMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2BooleanArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               return Reference2BooleanArrayMap.this.containsKey(var3) && Reference2BooleanArrayMap.this.getBoolean(var3) == (Boolean)var2.getValue();
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               int var5 = Reference2BooleanArrayMap.this.findKey(var3);
               if (var5 != -1 && var4 == Reference2BooleanArrayMap.this.value[var5]) {
                  int var6 = Reference2BooleanArrayMap.this.size - var5 - 1;
                  System.arraycopy(Reference2BooleanArrayMap.this.key, var5 + 1, Reference2BooleanArrayMap.this.key, var5, var6);
                  System.arraycopy(Reference2BooleanArrayMap.this.value, var5 + 1, Reference2BooleanArrayMap.this.value, var5, var6);
                  Reference2BooleanArrayMap.this.size--;
                  Reference2BooleanArrayMap.this.key[Reference2BooleanArrayMap.this.size] = null;
                  return true;
               } else {
