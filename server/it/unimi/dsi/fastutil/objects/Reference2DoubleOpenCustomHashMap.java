...
public class Reference2DoubleOpenCustomHashMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2DoubleOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Reference2DoubleOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2DoubleOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Reference2DoubleOpenCustomHashMap(Map<? extends K, ? extends Double> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2DoubleOpenCustomHashMap(Map<? extends K, ? extends Double> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2DoubleOpenCustomHashMap(Reference2DoubleMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2DoubleOpenCustomHashMap(Reference2DoubleMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2DoubleOpenCustomHashMap(K[] var1, double[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Reference2DoubleOpenCustomHashMap(K[] var1, double[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Reference2DoubleOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]);
               }

               int var2 = Reference2DoubleOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2DoubleOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Reference2DoubleOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2DoubleOpenCustomHashMap<K> clone() {
      Reference2DoubleOpenCustomHashMap var1;
      try {
         var1 = (Reference2DoubleOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      double[] var3 = this.value;
      Reference2DoubleOpenCustomHashMap.MapIterator var4 = new Reference2DoubleOpenCustomHashMap.MapIterator();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var7 = this.size; var7-- != 0; var3[var8] = var5) {
         ...
         if (this.strategy.equals(var4, (Object)null)) {
            ...
            for(var8 = HashCommon.mix(this.strategy.hashCode(var4)) & this.mask; var2[var8] != null; var8 = var8 + 1 & this.mask) {
            }
         }
   ...
   private final class ValueIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator implements DoubleIterator {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n]);
         }

         int var2 = Reference2DoubleOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2DoubleOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2DoubleOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2DoubleOpenCustomHashMap.this.size;
         Reference2DoubleOpenCustomHashMap.this.removeDouble(var1);
         return Reference2DoubleOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Reference2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4);
               } else {
                  Object[] var7 = Reference2DoubleOpenCustomHashMap.this.key;
                  Object var6;
                  int var8;
                  if ((var6 = var7[var8 = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2DoubleOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                     return Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                  } else {
                     while((var6 = var7[var8 = var8 + 1 & Reference2DoubleOpenCustomHashMap.this.mask]) != null) {
                        if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                           return Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               double var4 = (Double)var2.getValue();
               if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Reference2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                  ...
                  if ((var6 = var7[var8 = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2DoubleOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                     if (Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                        Reference2DoubleOpenCustomHashMap.this.removeEntry(var8);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var7[var8 = var8 + 1 & Reference2DoubleOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Reference2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3) || Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> var1) {
         if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n], Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2DoubleOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleOpenCustomHashMap.this.key[var2], Reference2DoubleOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2DoubleMap.Entry<K>> var1) {
         ...
         if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
            var2.key = Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n];
            var2.value = Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2DoubleOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2DoubleOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Reference2DoubleOpenCustomHashMap.this.key[var3];
               var2.value = Reference2DoubleOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2DoubleMap.Entry<K>> {
      private final Reference2DoubleOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2DoubleOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2DoubleMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2DoubleOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(var2)) & Reference2DoubleOpenCustomHashMap.this.mask; !Reference2DoubleOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Reference2DoubleOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2DoubleOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(var4)) & Reference2DoubleOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2DoubleOpenCustomHashMap.this.value[var2] = Reference2DoubleOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Reference2DoubleMap.Entry<K>, java.util.Map.Entry<K, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Reference2DoubleOpenCustomHashMap.this.value[this.index];
         Reference2DoubleOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[this.index], var2.getKey()) && Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
