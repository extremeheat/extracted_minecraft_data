...
public class Object2LongOpenHashMap<K> extends AbstractObject2LongMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2LongOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2LongOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2LongOpenHashMap(Map<? extends K, ? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2LongOpenHashMap(Map<? extends K, ? extends Long> var1) {
      this(var1, 0.75F);
   }

   public Object2LongOpenHashMap(Object2LongMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2LongOpenHashMap(Object2LongMap<K> var1) {
      this(var1, 0.75F);
   }

   public Object2LongOpenHashMap(K[] var1, long[] var2, float var3) {
   ...
   public Object2LongOpenHashMap(K[] var1, long[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Object2LongOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Object2LongOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n]);
               }

               int var2 = Object2LongOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2LongOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2LongOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2LongOpenHashMap<K> clone() {
      Object2LongOpenHashMap var1;
      try {
         var1 = (Object2LongOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      long[] var3 = this.value;
      Object2LongOpenHashMap.MapIterator var4 = new Object2LongOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2LongOpenHashMap.this.containsNullKey) {
            var1.accept(Object2LongOpenHashMap.this.key[Object2LongOpenHashMap.this.n]);
         }

         int var2 = Object2LongOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2LongOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2LongOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2LongOpenHashMap.this.size;
         Object2LongOpenHashMap.this.removeLong(var1);
         return Object2LongOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<K>> implements Object2LongMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               if (var3 == null) {
                  return Object2LongOpenHashMap.this.containsNullKey && Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n] == var4;
               } else {
                  Object[] var7 = Object2LongOpenHashMap.this.key;
                  Object var6;
                  int var8;
                  if ((var6 = var7[var8 = HashCommon.mix(var3.hashCode()) & Object2LongOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3.equals(var6)) {
                     return Object2LongOpenHashMap.this.value[var8] == var4;
                  } else {
                     while((var6 = var7[var8 = var8 + 1 & Object2LongOpenHashMap.this.mask]) != null) {
                        if (var3.equals(var6)) {
                           return Object2LongOpenHashMap.this.value[var8] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               long var4 = (Long)var2.getValue();
               if (var3 == null) {
                  if (Object2LongOpenHashMap.this.containsNullKey && Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n] == var4) {
                  ...
                  if ((var6 = var7[var8 = HashCommon.mix(var3.hashCode()) & Object2LongOpenHashMap.this.mask]) == null) {
                     ...
                     if (Object2LongOpenHashMap.this.value[var8] == var4) {
                        Object2LongOpenHashMap.this.removeEntry(var8);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var7[var8 = var8 + 1 & Object2LongOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!var6.equals(var3) || Object2LongOpenHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Object2LongMap.Entry<K>> var1) {
         if (Object2LongOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenHashMap.this.key[Object2LongOpenHashMap.this.n], Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2LongOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenHashMap.this.key[var2], Object2LongOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2LongMap.Entry<K>> var1) {
         ...
         if (Object2LongOpenHashMap.this.containsNullKey) {
            var2.key = Object2LongOpenHashMap.this.key[Object2LongOpenHashMap.this.n];
            var2.value = Object2LongOpenHashMap.this.value[Object2LongOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2LongOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2LongOpenHashMap.this.key[var3] != null) {
               var2.key = Object2LongOpenHashMap.this.key[var3];
               var2.value = Object2LongOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2LongOpenHashMap<K>.MapIterator implements ObjectIterator<Object2LongMap.Entry<K>> {
      private final Object2LongOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2LongOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2LongOpenHashMap<K>.MapIterator implements ObjectIterator<Object2LongMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2LongOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2LongOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2LongOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2LongOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2LongOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & Object2LongOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2LongOpenHashMap.this.value[var2] = Object2LongOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2LongMap.Entry<K>, java.util.Map.Entry<K, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Object2LongOpenHashMap.this.value[this.index];
         Object2LongOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2LongOpenHashMap.this.key[this.index], var2.getKey()) && Object2LongOpenHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
