...
public class Reference2BooleanOpenHashMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Reference2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Reference2BooleanOpenHashMap(Map<? extends K, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2BooleanOpenHashMap(Map<? extends K, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Reference2BooleanOpenHashMap(Reference2BooleanMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2BooleanOpenHashMap(Reference2BooleanMap<K> var1) {
      this(var1, 0.75F);
   }

   public Reference2BooleanOpenHashMap(K[] var1, boolean[] var2, float var3) {
   ...
   public Reference2BooleanOpenHashMap(K[] var1, boolean[] var2) {
   ...
   public Reference2BooleanMap.FastEntrySet<K> reference2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new Reference2BooleanOpenHashMap.MapEntrySet();
      }
   ...
   public ReferenceSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Reference2BooleanOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            public BooleanIterator iterator() {
               return Reference2BooleanOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(boolean var1) {
               return Reference2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n]);
               }

               int var2 = Reference2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2BooleanOpenHashMap.this.key[var2] != null) {
                     var1.accept(Reference2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2BooleanOpenHashMap<K> clone() {
      Reference2BooleanOpenHashMap var1;
      try {
         var1 = (Reference2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      boolean[] var3 = this.value;
      Reference2BooleanOpenHashMap.MapIterator var4 = new Reference2BooleanOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Reference2BooleanOpenHashMap<K>.MapIterator implements BooleanIterator {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return Reference2BooleanOpenHashMap.this.new KeyIterator();
      }

      public void forEach(Consumer<? super K> var1) {
         if (Reference2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.n]);
         }

         int var2 = Reference2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2BooleanOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2BooleanOpenHashMap.this.size;
         Reference2BooleanOpenHashMap.this.removeBoolean(var1);
         return Reference2BooleanOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Reference2BooleanOpenHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>> implements Reference2BooleanMap.FastEntrySet<K> {
      ...
      public ObjectIterator<Reference2BooleanMap.Entry<K>> iterator() {
         return Reference2BooleanOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Reference2BooleanMap.Entry<K>> fastIterator() {
         return Reference2BooleanOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               if (var3 == null) {
                  return Reference2BooleanOpenHashMap.this.containsNullKey && Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Reference2BooleanOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2BooleanOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3 == var5) {
                     return Reference2BooleanOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2BooleanOpenHashMap.this.mask]) != null) {
                        if (var3 == var5) {
                           return Reference2BooleanOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               boolean var4 = (Boolean)var2.getValue();
               if (var3 == null) {
                  if (Reference2BooleanOpenHashMap.this.containsNullKey && Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2BooleanOpenHashMap.this.mask]) == null) {
                     ...
                     if (Reference2BooleanOpenHashMap.this.value[var7] == var4) {
                        Reference2BooleanOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2BooleanOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(var5 != var3 || Reference2BooleanOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> var1) {
         if (Reference2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.n], Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2BooleanOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanOpenHashMap.this.key[var2], Reference2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> var1) {
         ...
         if (Reference2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.n];
            var2.value = Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2BooleanOpenHashMap.this.key[var3] != null) {
               var2.key = Reference2BooleanOpenHashMap.this.key[var3];
               var2.value = Reference2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2BooleanOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2BooleanMap.Entry<K>> {
      ...
      private FastEntryIterator() {
         super(null);
         this.entry = Reference2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2BooleanOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2BooleanMap.Entry<K>> {
      ...
      public Reference2BooleanOpenHashMap<K>.MapEntry next() {
         return this.entry = Reference2BooleanOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               return this.last = Reference2BooleanOpenHashMap.this.n;
            } else {
               Object[] var1 = Reference2BooleanOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(System.identityHashCode(var2)) & Reference2BooleanOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Reference2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(System.identityHashCode(var4)) & Reference2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2BooleanOpenHashMap.this.value[var2] = Reference2BooleanOpenHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Reference2BooleanOpenHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Reference2BooleanOpenHashMap.this.removeBoolean(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Reference2BooleanMap.Entry<K>, java.util.Map.Entry<K, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Reference2BooleanOpenHashMap.this.value[this.index];
         Reference2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2BooleanOpenHashMap.this.key[this.index] == var2.getKey() && Reference2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
