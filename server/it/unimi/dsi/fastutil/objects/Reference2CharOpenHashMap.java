...
public class Reference2CharOpenHashMap<K> extends AbstractReference2CharMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2CharOpenHashMap(int var1, float var2) {
      super();
   ...
   public Reference2CharOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> var1) {
      this(var1, 0.75F);
   }

   public Reference2CharOpenHashMap(Reference2CharMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2CharOpenHashMap(Reference2CharMap<K> var1) {
      this(var1, 0.75F);
   }

   public Reference2CharOpenHashMap(K[] var1, char[] var2, float var3) {
   ...
   public Reference2CharOpenHashMap(K[] var1, char[] var2) {
   ...
   public Reference2CharMap.FastEntrySet<K> reference2CharEntrySet() {
      if (this.entries == null) {
         this.entries = new Reference2CharOpenHashMap.MapEntrySet();
      }
   ...
   public ReferenceSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Reference2CharOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            public CharIterator iterator() {
               return Reference2CharOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(char var1) {
               return Reference2CharOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Reference2CharOpenHashMap.this.containsNullKey) {
                  var1.accept(Reference2CharOpenHashMap.this.value[Reference2CharOpenHashMap.this.n]);
               }

               int var2 = Reference2CharOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2CharOpenHashMap.this.key[var2] != null) {
                     var1.accept(Reference2CharOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2CharOpenHashMap<K> clone() {
      Reference2CharOpenHashMap var1;
      try {
         var1 = (Reference2CharOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      char[] var3 = this.value;
      Reference2CharOpenHashMap.MapIterator var4 = new Reference2CharOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Reference2CharOpenHashMap<K>.MapIterator implements CharIterator {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return Reference2CharOpenHashMap.this.new KeyIterator();
      }

      public void forEach(Consumer<? super K> var1) {
         if (Reference2CharOpenHashMap.this.containsNullKey) {
            var1.accept(Reference2CharOpenHashMap.this.key[Reference2CharOpenHashMap.this.n]);
         }

         int var2 = Reference2CharOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2CharOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2CharOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2CharOpenHashMap.this.size;
         Reference2CharOpenHashMap.this.removeChar(var1);
         return Reference2CharOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Reference2CharOpenHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry<K>> implements Reference2CharMap.FastEntrySet<K> {
      ...
      public ObjectIterator<Reference2CharMap.Entry<K>> iterator() {
         return Reference2CharOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Reference2CharMap.Entry<K>> fastIterator() {
         return Reference2CharOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               if (var3 == null) {
                  return Reference2CharOpenHashMap.this.containsNullKey && Reference2CharOpenHashMap.this.value[Reference2CharOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Reference2CharOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2CharOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3 == var5) {
                     return Reference2CharOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2CharOpenHashMap.this.mask]) != null) {
                        if (var3 == var5) {
                           return Reference2CharOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               char var4 = (Character)var2.getValue();
               if (var3 == null) {
                  if (Reference2CharOpenHashMap.this.containsNullKey && Reference2CharOpenHashMap.this.value[Reference2CharOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2CharOpenHashMap.this.mask]) == null) {
                     ...
                     if (Reference2CharOpenHashMap.this.value[var7] == var4) {
                        Reference2CharOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2CharOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(var5 != var3 || Reference2CharOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Reference2CharMap.Entry<K>> var1) {
         if (Reference2CharOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2CharMap.BasicEntry(Reference2CharOpenHashMap.this.key[Reference2CharOpenHashMap.this.n], Reference2CharOpenHashMap.this.value[Reference2CharOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2CharOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2CharMap.BasicEntry(Reference2CharOpenHashMap.this.key[var2], Reference2CharOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> var1) {
         ...
         if (Reference2CharOpenHashMap.this.containsNullKey) {
            var2.key = Reference2CharOpenHashMap.this.key[Reference2CharOpenHashMap.this.n];
            var2.value = Reference2CharOpenHashMap.this.value[Reference2CharOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2CharOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2CharOpenHashMap.this.key[var3] != null) {
               var2.key = Reference2CharOpenHashMap.this.key[var3];
               var2.value = Reference2CharOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2CharOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2CharMap.Entry<K>> {
      private final Reference2CharOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2CharOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2CharOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2CharMap.Entry<K>> {
      ...
      public Reference2CharOpenHashMap<K>.MapEntry next() {
         return this.entry = Reference2CharOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               return this.last = Reference2CharOpenHashMap.this.n;
            } else {
               Object[] var1 = Reference2CharOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(System.identityHashCode(var2)) & Reference2CharOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Reference2CharOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2CharOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2CharOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(System.identityHashCode(var4)) & Reference2CharOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2CharOpenHashMap.this.value[var2] = Reference2CharOpenHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Reference2CharOpenHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Reference2CharOpenHashMap.this.removeChar(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Reference2CharMap.Entry<K>, java.util.Map.Entry<K, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Reference2CharOpenHashMap.this.value[this.index];
         Reference2CharOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2CharOpenHashMap.this.key[this.index] == var2.getKey() && Reference2CharOpenHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
