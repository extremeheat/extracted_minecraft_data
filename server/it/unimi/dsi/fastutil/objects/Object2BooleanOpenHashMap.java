...
public class Object2BooleanOpenHashMap<K> extends AbstractObject2BooleanMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2BooleanOpenHashMap(Map<? extends K, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2BooleanOpenHashMap(Map<? extends K, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Object2BooleanOpenHashMap(Object2BooleanMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2BooleanOpenHashMap(Object2BooleanMap<K> var1) {
      this(var1, 0.75F);
   }

   public Object2BooleanOpenHashMap(K[] var1, boolean[] var2, float var3) {
   ...
   public Object2BooleanOpenHashMap(K[] var1, boolean[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Object2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Object2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n]);
               }

               int var2 = Object2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2BooleanOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2BooleanOpenHashMap<K> clone() {
      Object2BooleanOpenHashMap var1;
      try {
         var1 = (Object2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      boolean[] var3 = this.value;
      Object2BooleanOpenHashMap.MapIterator var4 = new Object2BooleanOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Object2BooleanOpenHashMap.this.key[Object2BooleanOpenHashMap.this.n]);
         }

         int var2 = Object2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2BooleanOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2BooleanOpenHashMap.this.size;
         Object2BooleanOpenHashMap.this.removeBoolean(var1);
         return Object2BooleanOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<K>> implements Object2BooleanMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               if (var3 == null) {
                  return Object2BooleanOpenHashMap.this.containsNullKey && Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2BooleanOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2BooleanOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3.equals(var5)) {
                     return Object2BooleanOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2BooleanOpenHashMap.this.mask]) != null) {
                        if (var3.equals(var5)) {
                           return Object2BooleanOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               boolean var4 = (Boolean)var2.getValue();
               if (var3 == null) {
                  if (Object2BooleanOpenHashMap.this.containsNullKey && Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2BooleanOpenHashMap.this.mask]) == null) {
                     ...
                     if (Object2BooleanOpenHashMap.this.value[var7] == var4) {
                        Object2BooleanOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2BooleanOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!var5.equals(var3) || Object2BooleanOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2BooleanMap.Entry<K>> var1) {
         if (Object2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2BooleanMap.BasicEntry(Object2BooleanOpenHashMap.this.key[Object2BooleanOpenHashMap.this.n], Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2BooleanOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2BooleanMap.BasicEntry(Object2BooleanOpenHashMap.this.key[var2], Object2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2BooleanMap.Entry<K>> var1) {
         ...
         if (Object2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Object2BooleanOpenHashMap.this.key[Object2BooleanOpenHashMap.this.n];
            var2.value = Object2BooleanOpenHashMap.this.value[Object2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2BooleanOpenHashMap.this.key[var3] != null) {
               var2.key = Object2BooleanOpenHashMap.this.key[var3];
               var2.value = Object2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2BooleanOpenHashMap<K>.MapIterator implements ObjectIterator<Object2BooleanMap.Entry<K>> {
      private final Object2BooleanOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2BooleanOpenHashMap<K>.MapIterator implements ObjectIterator<Object2BooleanMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2BooleanOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2BooleanOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & Object2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2BooleanOpenHashMap.this.value[var2] = Object2BooleanOpenHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Object2BooleanOpenHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Object2BooleanOpenHashMap.this.removeBoolean(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Object2BooleanMap.Entry<K>, java.util.Map.Entry<K, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Object2BooleanOpenHashMap.this.value[this.index];
         Object2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2BooleanOpenHashMap.this.key[this.index], var2.getKey()) && Object2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
