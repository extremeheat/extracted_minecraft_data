...
public final class Object2FloatMaps {
   public static final Object2FloatMaps.EmptyMap EMPTY_MAP = new Object2FloatMaps.EmptyMap();

   private Object2FloatMaps() {
      super();
   }

   public static <K> ObjectIterator<Object2FloatMap.Entry<K>> fastIterator(Object2FloatMap<K> var0) {
      ObjectSet var1 = var0.object2FloatEntrySet();
      return var1 instanceof Object2FloatMap.FastEntrySet ? ((Object2FloatMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static <K> void fastForEach(Object2FloatMap<K> var0, Consumer<? super Object2FloatMap.Entry<K>> var1) {
      ObjectSet var2 = var0.object2FloatEntrySet();
      if (var2 instanceof Object2FloatMap.FastEntrySet) {
         ((Object2FloatMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static <K> ObjectIterable<Object2FloatMap.Entry<K>> fastIterable(Object2FloatMap<K> var0) {
      final ObjectSet var1 = var0.object2FloatEntrySet();
      return (ObjectIterable)(var1 instanceof Object2FloatMap.FastEntrySet ? new ObjectIterable<Object2FloatMap.Entry<K>>() {
         public ObjectIterator<Object2FloatMap.Entry<K>> iterator() {
            return ((Object2FloatMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Object2FloatMap.Entry<K>> var1x) {
            ((Object2FloatMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }
   ...
   public static <K> Object2FloatMap<K> singleton(K var0, float var1) {
      return new Object2FloatMaps.Singleton(var0, var1);
   }
   ...
   public static <K> Object2FloatMap<K> synchronize(Object2FloatMap<K> var0) {
      return new Object2FloatMaps.SynchronizedMap(var0);
   }

   public static <K> Object2FloatMap<K> synchronize(Object2FloatMap<K> var0, Object var1) {
      return new Object2FloatMaps.SynchronizedMap(var0, var1);
   }

   public static <K> Object2FloatMap<K> unmodifiable(Object2FloatMap<K> var0) {
      return new Object2FloatMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap<K> extends Object2FloatFunctions.UnmodifiableFunction<K> implements Object2FloatMap<K>, Serializable {
      ...
      protected UnmodifiableMap(Object2FloatMap<K> var1) {
         super(var1);
         this.map = var1;
      }
      ...
      public float computeFloatIfAbsentPartial(K var1, Object2FloatFunction<? super K> var2) {
         throw new UnsupportedOperationException();
      }
   ...
   public static class SynchronizedMap<K> extends Object2FloatFunctions.SynchronizedFunction<K> implements Object2FloatMap<K>, Serializable {
      ...
      protected SynchronizedMap(Object2FloatMap<K> var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Object2FloatMap<K> var1) {
         super(var1);
         this.map = var1;
      }
