...
public final class Reference2LongFunctions {
   ...
   public static <K> Reference2LongFunction<K> singleton(K var0, long var1) {
      return new Reference2LongFunctions.Singleton(var0, var1);
   }
   ...
   public static <K> Reference2LongFunction<K> synchronize(Reference2LongFunction<K> var0) {
      return new Reference2LongFunctions.SynchronizedFunction(var0);
   }

   public static <K> Reference2LongFunction<K> synchronize(Reference2LongFunction<K> var0, Object var1) {
      return new Reference2LongFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K> Reference2LongFunction<K> unmodifiable(Reference2LongFunction<K> var0) {
      return new Reference2LongFunctions.UnmodifiableFunction(var0);
   }

   public static <K> Reference2LongFunction<K> primitive(Function<? super K, ? extends Long> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Reference2LongFunction) {
         return (Reference2LongFunction)var0;
      } else {
         return (Reference2LongFunction)(var0 instanceof ToLongFunction ? (var1) -> {
            return ((ToLongFunction)var0).applyAsLong(var1);
         } : new Reference2LongFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class UnmodifiableFunction<K> extends AbstractReference2LongFunction<K> implements Serializable {
      ...
      protected UnmodifiableFunction(Reference2LongFunction<K> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K> implements Reference2LongFunction<K>, Serializable {
      ...
      protected SynchronizedFunction(Reference2LongFunction<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Reference2LongFunction<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
