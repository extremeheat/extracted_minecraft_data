...
public class ObjectHeapSemiIndirectPriorityQueue<K> implements IndirectPriorityQueue<K> {
   ...
   public ObjectHeapSemiIndirectPriorityQueue(K[] var1, int var2, Comparator<? super K> var3) {
      super();
   ...
   public ObjectHeapSemiIndirectPriorityQueue(K[] var1, int var2) {
      this(var1, var2, (Comparator)null);
   }

   public ObjectHeapSemiIndirectPriorityQueue(K[] var1, Comparator<? super K> var2) {
      this(var1, var1.length, var2);
   }

   public ObjectHeapSemiIndirectPriorityQueue(K[] var1) {
      this(var1, var1.length, (Comparator)null);
   }

   public ObjectHeapSemiIndirectPriorityQueue(K[] var1, int[] var2, int var3, Comparator<? super K> var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      ObjectSemiIndirectHeaps.makeHeap(var1, var2, var3, var4);
   }
   ...
   public ObjectHeapSemiIndirectPriorityQueue(K[] var1, int[] var2, int var3) {
   ...
   public int front(int[] var1) {
      return this.c == null ? ObjectSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1) : ObjectSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1, this.c);
   }
