...
public interface Reference2IntMap<K> extends Reference2IntFunction<K>, Map<K, Integer> {
   ...
   default Integer put(K var1, Integer var2) {
      return Reference2IntFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Integer get(Object var1) {
      return Reference2IntFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Integer remove(Object var1) {
      return Reference2IntFunction.super.remove(var1);
   }
   ...
   default int computeIntIfAbsentPartial(K var1, Reference2IntFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      int var3 = this.getInt(var1);
      int var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<K> extends ObjectSet<Reference2IntMap.Entry<K>> {
      ObjectIterator<Reference2IntMap.Entry<K>> fastIterator();

      default void fastForEach(Consumer<? super Reference2IntMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
