...
public interface Reference2LongMap<K> extends Reference2LongFunction<K>, Map<K, Long> {
   ...
   default Long put(K var1, Long var2) {
      return Reference2LongFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Long get(Object var1) {
      return Reference2LongFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Long remove(Object var1) {
      return Reference2LongFunction.super.remove(var1);
   }
   ...
   default long computeLongIfAbsentPartial(K var1, Reference2LongFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      long var3 = this.getLong(var1);
   ...
   public interface FastEntrySet<K> extends ObjectSet<Reference2LongMap.Entry<K>> {
      ...
      default void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
