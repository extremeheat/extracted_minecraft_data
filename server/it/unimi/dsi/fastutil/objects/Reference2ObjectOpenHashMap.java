...
public class Reference2ObjectOpenHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
   ...
   public Reference2ObjectOpenHashMap(int var1, float var2) {
      super();
   ...
   public Reference2ObjectOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> var1) {
      this(var1, 0.75F);
   }

   public Reference2ObjectOpenHashMap(K[] var1, V[] var2, float var3) {
   ...
   public Reference2ObjectOpenHashMap(K[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Reference2ObjectOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Reference2ObjectOpenHashMap.this.containsNullKey) {
                  var1.accept(Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n]);
               }

               int var2 = Reference2ObjectOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2ObjectOpenHashMap.this.key[var2] != null) {
                     var1.accept(Reference2ObjectOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2ObjectOpenHashMap<K, V> clone() {
      Reference2ObjectOpenHashMap var1;
      try {
         var1 = (Reference2ObjectOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      Object[] var3 = this.value;
      Reference2ObjectOpenHashMap.MapIterator var4 = new Reference2ObjectOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(Reference2ObjectOpenHashMap.this.key[Reference2ObjectOpenHashMap.this.n]);
         }

         int var2 = Reference2ObjectOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2ObjectOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2ObjectOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2ObjectOpenHashMap.this.size;
         Reference2ObjectOpenHashMap.this.remove(var1);
         return Reference2ObjectOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var3 == null) {
               return Reference2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n], var4);
            } else {
               Object[] var6 = Reference2ObjectOpenHashMap.this.key;
               Object var5;
               int var7;
               if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2ObjectOpenHashMap.this.mask]) == null) {
                  return false;
               } else if (var3 == var5) {
                  return Objects.equals(Reference2ObjectOpenHashMap.this.value[var7], var4);
               } else {
                  while((var5 = var6[var7 = var7 + 1 & Reference2ObjectOpenHashMap.this.mask]) != null) {
                     if (var3 == var5) {
                        return Objects.equals(Reference2ObjectOpenHashMap.this.value[var7], var4);
                     }
                  }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Object var4 = var2.getValue();
            if (var3 == null) {
               if (Reference2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n], var4)) {
               ...
               if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2ObjectOpenHashMap.this.mask]) == null) {
                  ...
                  if (Objects.equals(Reference2ObjectOpenHashMap.this.value[var7], var4)) {
                     Reference2ObjectOpenHashMap.this.removeEntry(var7);
                     return true;
                  } else {
                     return false;
                  }
                  ...
                  do {
                     if ((var5 = var6[var7 = var7 + 1 & Reference2ObjectOpenHashMap.this.mask]) == null) {
                        return false;
                     }
                  } while(var5 != var3 || !Objects.equals(Reference2ObjectOpenHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> var1) {
         if (Reference2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectOpenHashMap.this.key[Reference2ObjectOpenHashMap.this.n], Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2ObjectOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectOpenHashMap.this.key[var2], Reference2ObjectOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> var1) {
         ...
         if (Reference2ObjectOpenHashMap.this.containsNullKey) {
            var2.key = Reference2ObjectOpenHashMap.this.key[Reference2ObjectOpenHashMap.this.n];
            var2.value = Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2ObjectOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2ObjectOpenHashMap.this.key[var3] != null) {
               var2.key = Reference2ObjectOpenHashMap.this.key[var3];
               var2.value = Reference2ObjectOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
   ...
   private class EntryIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2ObjectOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(System.identityHashCode(var2)) & Reference2ObjectOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Reference2ObjectOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2ObjectOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2ObjectOpenHashMap.this.mask;

            Object var4;
            while(true) {
               if ((var4 = var5[var1]) == null) {
                  var5[var2] = null;
                  Reference2ObjectOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(System.identityHashCode(var4)) & Reference2ObjectOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2ObjectOpenHashMap.this.value[var2] = Reference2ObjectOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Reference2ObjectMap.Entry<K, V>, java.util.Map.Entry<K, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Reference2ObjectOpenHashMap.this.value[this.index];
         Reference2ObjectOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2ObjectOpenHashMap.this.key[this.index] == var2.getKey() && Objects.equals(Reference2ObjectOpenHashMap.this.value[this.index], var2.getValue());
         }
      }
