...
public class Reference2ShortOpenCustomHashMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2ShortOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Reference2ShortOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2ShortOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Reference2ShortOpenCustomHashMap(Map<? extends K, ? extends Short> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2ShortOpenCustomHashMap(Map<? extends K, ? extends Short> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2ShortOpenCustomHashMap(Reference2ShortMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2ShortOpenCustomHashMap(Reference2ShortMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2ShortOpenCustomHashMap(K[] var1, short[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Reference2ShortOpenCustomHashMap(K[] var1, short[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Reference2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Reference2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2ShortOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Reference2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2ShortOpenCustomHashMap<K> clone() {
      Reference2ShortOpenCustomHashMap var1;
      try {
         var1 = (Reference2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      short[] var3 = this.value;
      Reference2ShortOpenCustomHashMap.MapIterator var4 = new Reference2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Reference2ShortOpenCustomHashMap<K>.MapIterator implements ShortIterator {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Reference2ShortOpenCustomHashMap.this.key[Reference2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Reference2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2ShortOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2ShortOpenCustomHashMap.this.size;
         Reference2ShortOpenCustomHashMap.this.removeShort(var1);
         return Reference2ShortOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Reference2ShortOpenCustomHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements Reference2ShortMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Short) {
               ...
               if (Reference2ShortOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Reference2ShortOpenCustomHashMap.this.containsNullKey && Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Reference2ShortOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2ShortOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Reference2ShortOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2ShortOpenCustomHashMap.this.mask]) != null) {
                        if (Reference2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Reference2ShortOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Short) {
               ...
               short var4 = (Short)var2.getValue();
               if (Reference2ShortOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Reference2ShortOpenCustomHashMap.this.containsNullKey && Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2ShortOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2ShortOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Reference2ShortOpenCustomHashMap.this.value[var7] == var4) {
                        Reference2ShortOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2ShortOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Reference2ShortOpenCustomHashMap.this.strategy.equals(var5, var3) || Reference2ShortOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> var1) {
         if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2ShortMap.BasicEntry(Reference2ShortOpenCustomHashMap.this.key[Reference2ShortOpenCustomHashMap.this.n], Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2ShortOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2ShortMap.BasicEntry(Reference2ShortOpenCustomHashMap.this.key[var2], Reference2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2ShortMap.Entry<K>> var1) {
         ...
         if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Reference2ShortOpenCustomHashMap.this.key[Reference2ShortOpenCustomHashMap.this.n];
            var2.value = Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2ShortOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Reference2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Reference2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2ShortOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2ShortMap.Entry<K>> {
      private final Reference2ShortOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2ShortOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2ShortMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2ShortOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Reference2ShortOpenCustomHashMap.this.mask; !Reference2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Reference2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Reference2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2ShortOpenCustomHashMap.this.value[var2] = Reference2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Reference2ShortMap.Entry<K>, java.util.Map.Entry<K, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Reference2ShortOpenCustomHashMap.this.value[this.index];
         Reference2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2ShortOpenCustomHashMap.this.strategy.equals(Reference2ShortOpenCustomHashMap.this.key[this.index], var2.getKey()) && Reference2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
