...
public class Reference2ByteOpenCustomHashMap<K> extends AbstractReference2ByteMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2ByteOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Reference2ByteOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2ByteOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Reference2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2ByteOpenCustomHashMap(Reference2ByteMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2ByteOpenCustomHashMap(Reference2ByteMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2ByteOpenCustomHashMap(K[] var1, byte[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Reference2ByteOpenCustomHashMap(K[] var1, byte[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Reference2ByteOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n]);
               }

               int var2 = Reference2ByteOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2ByteOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Reference2ByteOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2ByteOpenCustomHashMap<K> clone() {
      Reference2ByteOpenCustomHashMap var1;
      try {
         var1 = (Reference2ByteOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      byte[] var3 = this.value;
      Reference2ByteOpenCustomHashMap.MapIterator var4 = new Reference2ByteOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n]);
         }

         int var2 = Reference2ByteOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2ByteOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2ByteOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2ByteOpenCustomHashMap.this.size;
         Reference2ByteOpenCustomHashMap.this.removeByte(var1);
         return Reference2ByteOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry<K>> implements Reference2ByteMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               if (Reference2ByteOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Reference2ByteOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2ByteOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Reference2ByteOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2ByteOpenCustomHashMap.this.mask]) != null) {
                        if (Reference2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Reference2ByteOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               byte var4 = (Byte)var2.getValue();
               if (Reference2ByteOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2ByteOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2ByteOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Reference2ByteOpenCustomHashMap.this.value[var7] == var4) {
                        Reference2ByteOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Reference2ByteOpenCustomHashMap.this.strategy.equals(var5, var3) || Reference2ByteOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> var1) {
         if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2ByteMap.BasicEntry(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n], Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2ByteOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2ByteMap.BasicEntry(Reference2ByteOpenCustomHashMap.this.key[var2], Reference2ByteOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> var1) {
         ...
         if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
            var2.key = Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n];
            var2.value = Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2ByteOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2ByteOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Reference2ByteOpenCustomHashMap.this.key[var3];
               var2.value = Reference2ByteOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2ByteOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2ByteMap.Entry<K>> {
      private final Reference2ByteOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2ByteOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2ByteOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2ByteMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2ByteOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(var2)) & Reference2ByteOpenCustomHashMap.this.mask; !Reference2ByteOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Reference2ByteOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2ByteOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2ByteOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(var4)) & Reference2ByteOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2ByteOpenCustomHashMap.this.value[var2] = Reference2ByteOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Reference2ByteMap.Entry<K>, java.util.Map.Entry<K, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Reference2ByteOpenCustomHashMap.this.value[this.index];
         Reference2ByteOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2ByteOpenCustomHashMap.this.strategy.equals(Reference2ByteOpenCustomHashMap.this.key[this.index], var2.getKey()) && Reference2ByteOpenCustomHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
