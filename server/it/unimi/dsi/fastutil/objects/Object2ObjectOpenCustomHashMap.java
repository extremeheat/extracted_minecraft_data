...
public class Object2ObjectOpenCustomHashMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
   ...
   public Object2ObjectOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Object2ObjectOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2ObjectOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Object2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2ObjectOpenCustomHashMap(Object2ObjectMap<K, V> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2ObjectOpenCustomHashMap(Object2ObjectMap<K, V> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2ObjectOpenCustomHashMap(K[] var1, V[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Object2ObjectOpenCustomHashMap(K[] var1, V[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Object2ObjectOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n]);
               }

               int var2 = Object2ObjectOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2ObjectOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Object2ObjectOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2ObjectOpenCustomHashMap<K, V> clone() {
      ...
      try {
         var1 = (Object2ObjectOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      Object[] var3 = this.value;
      Object2ObjectOpenCustomHashMap.MapIterator var4 = new Object2ObjectOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n]);
         }

         int var2 = Object2ObjectOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2ObjectOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2ObjectOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2ObjectOpenCustomHashMap.this.size;
         Object2ObjectOpenCustomHashMap.this.remove(var1);
         return Object2ObjectOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectMap.FastEntrySet<K, V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (Object2ObjectOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
               return Object2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n], var4);
            } else {
               Object[] var6 = Object2ObjectOpenCustomHashMap.this.key;
               Object var5;
               int var7;
               if ((var5 = var6[var7 = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2ObjectOpenCustomHashMap.this.mask]) == null) {
                  return false;
               } else if (Object2ObjectOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                  return Objects.equals(Object2ObjectOpenCustomHashMap.this.value[var7], var4);
               } else {
                  while((var5 = var6[var7 = var7 + 1 & Object2ObjectOpenCustomHashMap.this.mask]) != null) {
                     if (Object2ObjectOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Objects.equals(Object2ObjectOpenCustomHashMap.this.value[var7], var4);
                     }
                  }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Object var4 = var2.getValue();
            if (Object2ObjectOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
               if (Object2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n], var4)) {
               ...
               if ((var5 = var6[var7 = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2ObjectOpenCustomHashMap.this.mask]) == null) {
                  return false;
               } else if (Object2ObjectOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                  if (Objects.equals(Object2ObjectOpenCustomHashMap.this.value[var7], var4)) {
                     Object2ObjectOpenCustomHashMap.this.removeEntry(var7);
                     return true;
                  } else {
                     return false;
                  }
                  ...
                  do {
                     if ((var5 = var6[var7 = var7 + 1 & Object2ObjectOpenCustomHashMap.this.mask]) == null) {
                        return false;
                     }
                  } while(!Object2ObjectOpenCustomHashMap.this.strategy.equals(var5, var3) || !Objects.equals(Object2ObjectOpenCustomHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> var1) {
         if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2ObjectMap.BasicEntry(Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n], Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2ObjectOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2ObjectMap.BasicEntry(Object2ObjectOpenCustomHashMap.this.key[var2], Object2ObjectOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2ObjectMap.Entry<K, V>> var1) {
         ...
         if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
            var2.key = Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n];
            var2.value = Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2ObjectOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Object2ObjectOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Object2ObjectOpenCustomHashMap.this.key[var3];
               var2.value = Object2ObjectOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
      ...
      private FastEntryIterator() {
         super(null);
         this.entry = Object2ObjectOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2ObjectOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(var2)) & Object2ObjectOpenCustomHashMap.this.mask; !Object2ObjectOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Object2ObjectOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2ObjectOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2ObjectOpenCustomHashMap.this.mask;

            Object var4;
            while(true) {
               if ((var4 = var5[var1]) == null) {
                  var5[var2] = null;
                  Object2ObjectOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(var4)) & Object2ObjectOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2ObjectOpenCustomHashMap.this.value[var2] = Object2ObjectOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2ObjectMap.Entry<K, V>, java.util.Map.Entry<K, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Object2ObjectOpenCustomHashMap.this.value[this.index];
         Object2ObjectOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[this.index], var2.getKey()) && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[this.index], var2.getValue());
         }
      }
