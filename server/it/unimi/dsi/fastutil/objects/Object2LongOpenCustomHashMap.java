...
public class Object2LongOpenCustomHashMap<K> extends AbstractObject2LongMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2LongOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Object2LongOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2LongOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Object2LongOpenCustomHashMap(Map<? extends K, ? extends Long> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2LongOpenCustomHashMap(Map<? extends K, ? extends Long> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2LongOpenCustomHashMap(Object2LongMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2LongOpenCustomHashMap(Object2LongMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2LongOpenCustomHashMap(K[] var1, long[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Object2LongOpenCustomHashMap(K[] var1, long[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Object2LongOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Object2LongOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n]);
               }

               int var2 = Object2LongOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2LongOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Object2LongOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2LongOpenCustomHashMap<K> clone() {
      Object2LongOpenCustomHashMap var1;
      try {
         var1 = (Object2LongOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      long[] var3 = this.value;
      Object2LongOpenCustomHashMap.MapIterator var4 = new Object2LongOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n]);
         }

         int var2 = Object2LongOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2LongOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2LongOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2LongOpenCustomHashMap.this.size;
         Object2LongOpenCustomHashMap.this.removeLong(var1);
         return Object2LongOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<K>> implements Object2LongMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               if (Object2LongOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Object2LongOpenCustomHashMap.this.containsNullKey && Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var7 = Object2LongOpenCustomHashMap.this.key;
                  Object var6;
                  int var8;
                  if ((var6 = var7[var8 = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2LongOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2LongOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                     return Object2LongOpenCustomHashMap.this.value[var8] == var4;
                  } else {
                     while((var6 = var7[var8 = var8 + 1 & Object2LongOpenCustomHashMap.this.mask]) != null) {
                        if (Object2LongOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                           return Object2LongOpenCustomHashMap.this.value[var8] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               long var4 = (Long)var2.getValue();
               if (Object2LongOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Object2LongOpenCustomHashMap.this.containsNullKey && Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var6 = var7[var8 = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2LongOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2LongOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                     if (Object2LongOpenCustomHashMap.this.value[var8] == var4) {
                        Object2LongOpenCustomHashMap.this.removeEntry(var8);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var7[var8 = var8 + 1 & Object2LongOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Object2LongOpenCustomHashMap.this.strategy.equals(var6, var3) || Object2LongOpenCustomHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Object2LongMap.Entry<K>> var1) {
         if (Object2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n], Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2LongOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2LongMap.BasicEntry(Object2LongOpenCustomHashMap.this.key[var2], Object2LongOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2LongMap.Entry<K>> var1) {
         ...
         if (Object2LongOpenCustomHashMap.this.containsNullKey) {
            var2.key = Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n];
            var2.value = Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2LongOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Object2LongOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Object2LongOpenCustomHashMap.this.key[var3];
               var2.value = Object2LongOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2LongOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2LongMap.Entry<K>> {
      private final Object2LongOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2LongOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2LongOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2LongMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2LongOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(var2)) & Object2LongOpenCustomHashMap.this.mask; !Object2LongOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Object2LongOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2LongOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2LongOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(var4)) & Object2LongOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2LongOpenCustomHashMap.this.value[var2] = Object2LongOpenCustomHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Object2LongOpenCustomHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Object2LongOpenCustomHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Object2LongMap.Entry<K>, java.util.Map.Entry<K, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Object2LongOpenCustomHashMap.this.value[this.index];
         Object2LongOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[this.index], var2.getKey()) && Object2LongOpenCustomHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
