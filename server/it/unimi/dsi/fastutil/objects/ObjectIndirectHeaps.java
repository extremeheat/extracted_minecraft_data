...
public final class ObjectIndirectHeaps {
   ...
   public static <K> int downHeap(K[] var0, int[] var1, int[] var2, int var3, int var4, Comparator<K> var5) {
      assert var4 < var3;
      ...
      if (var5 == null) {
         while((var8 = (var4 << 1) + 1) < var3) {
            var9 = var1[var8];
            var10 = var8 + 1;
            if (var10 < var3 && ((Comparable)var0[var1[var10]]).compareTo(var0[var9]) < 0) {
               var8 = var10;
               var9 = var1[var10];
            }

            if (((Comparable)var7).compareTo(var0[var9]) <= 0) {
               break;
            }
   ...
   public static <K> int upHeap(K[] var0, int[] var1, int[] var2, int var3, int var4, Comparator<K> var5) {
      assert var4 < var3;
      ...
      if (var5 == null) {
         while(var4 != 0) {
            var8 = var4 - 1 >>> 1;
            var9 = var1[var8];
            if (((Comparable)var0[var9]).compareTo(var7) <= 0) {
               break;
            }
   ...
   public static <K> void makeHeap(K[] var0, int var1, int var2, int[] var3, int[] var4, Comparator<K> var5) {
