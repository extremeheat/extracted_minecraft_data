...
public interface Reference2CharMap<K> extends Reference2CharFunction<K>, Map<K, Character> {
   ...
   default Character put(K var1, Character var2) {
      return Reference2CharFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Character get(Object var1) {
      return Reference2CharFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Character remove(Object var1) {
      return Reference2CharFunction.super.remove(var1);
   }
   ...
   default char computeCharIfAbsentPartial(K var1, Reference2CharFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      char var3 = this.getChar(var1);
      char var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<K> extends ObjectSet<Reference2CharMap.Entry<K>> {
      ...
      default void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
