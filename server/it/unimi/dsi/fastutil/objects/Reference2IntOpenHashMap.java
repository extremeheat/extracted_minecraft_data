...
public class Reference2IntOpenHashMap<K> extends AbstractReference2IntMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2IntOpenHashMap(int var1, float var2) {
      super();
   ...
   public Reference2IntOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Reference2IntOpenHashMap(Map<? extends K, ? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2IntOpenHashMap(Map<? extends K, ? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public Reference2IntOpenHashMap(Reference2IntMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Reference2IntOpenHashMap(Reference2IntMap<K> var1) {
      this(var1, 0.75F);
   }

   public Reference2IntOpenHashMap(K[] var1, int[] var2, float var3) {
   ...
   public Reference2IntOpenHashMap(K[] var1, int[] var2) {
   ...
   public Reference2IntMap.FastEntrySet<K> reference2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new Reference2IntOpenHashMap.MapEntrySet();
      }
   ...
   public ReferenceSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Reference2IntOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            public IntIterator iterator() {
               return Reference2IntOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(int var1) {
               return Reference2IntOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Reference2IntOpenHashMap.this.containsNullKey) {
                  var1.accept(Reference2IntOpenHashMap.this.value[Reference2IntOpenHashMap.this.n]);
               }

               int var2 = Reference2IntOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2IntOpenHashMap.this.key[var2] != null) {
                     var1.accept(Reference2IntOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2IntOpenHashMap<K> clone() {
      Reference2IntOpenHashMap var1;
      try {
         var1 = (Reference2IntOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      int[] var3 = this.value;
      Reference2IntOpenHashMap.MapIterator var4 = new Reference2IntOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Reference2IntOpenHashMap<K>.MapIterator implements IntIterator {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return Reference2IntOpenHashMap.this.new KeyIterator();
      }

      public void forEach(Consumer<? super K> var1) {
         if (Reference2IntOpenHashMap.this.containsNullKey) {
            var1.accept(Reference2IntOpenHashMap.this.key[Reference2IntOpenHashMap.this.n]);
         }

         int var2 = Reference2IntOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2IntOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2IntOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2IntOpenHashMap.this.size;
         Reference2IntOpenHashMap.this.removeInt(var1);
         return Reference2IntOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Reference2IntOpenHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>> implements Reference2IntMap.FastEntrySet<K> {
      ...
      public ObjectIterator<Reference2IntMap.Entry<K>> iterator() {
         return Reference2IntOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Reference2IntMap.Entry<K>> fastIterator() {
         return Reference2IntOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Integer) {
               ...
               if (var3 == null) {
                  return Reference2IntOpenHashMap.this.containsNullKey && Reference2IntOpenHashMap.this.value[Reference2IntOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Reference2IntOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2IntOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3 == var5) {
                     return Reference2IntOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2IntOpenHashMap.this.mask]) != null) {
                        if (var3 == var5) {
                           return Reference2IntOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Integer) {
               ...
               int var4 = (Integer)var2.getValue();
               if (var3 == null) {
                  if (Reference2IntOpenHashMap.this.containsNullKey && Reference2IntOpenHashMap.this.value[Reference2IntOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(System.identityHashCode(var3)) & Reference2IntOpenHashMap.this.mask]) == null) {
                     ...
                     if (Reference2IntOpenHashMap.this.value[var7] == var4) {
                        Reference2IntOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2IntOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(var5 != var3 || Reference2IntOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Reference2IntMap.Entry<K>> var1) {
         if (Reference2IntOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2IntMap.BasicEntry(Reference2IntOpenHashMap.this.key[Reference2IntOpenHashMap.this.n], Reference2IntOpenHashMap.this.value[Reference2IntOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2IntOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2IntMap.BasicEntry(Reference2IntOpenHashMap.this.key[var2], Reference2IntOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2IntMap.Entry<K>> var1) {
         ...
         if (Reference2IntOpenHashMap.this.containsNullKey) {
            var2.key = Reference2IntOpenHashMap.this.key[Reference2IntOpenHashMap.this.n];
            var2.value = Reference2IntOpenHashMap.this.value[Reference2IntOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2IntOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2IntOpenHashMap.this.key[var3] != null) {
               var2.key = Reference2IntOpenHashMap.this.key[var3];
               var2.value = Reference2IntOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2IntMap.Entry<K>> {
      private final Reference2IntOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2IntOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2IntMap.Entry<K>> {
      ...
      public Reference2IntOpenHashMap<K>.MapEntry next() {
         return this.entry = Reference2IntOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2IntOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(System.identityHashCode(var2)) & Reference2IntOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Reference2IntOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2IntOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2IntOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(System.identityHashCode(var4)) & Reference2IntOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2IntOpenHashMap.this.value[var2] = Reference2IntOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Reference2IntMap.Entry<K>, java.util.Map.Entry<K, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Reference2IntOpenHashMap.this.value[this.index];
         Reference2IntOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2IntOpenHashMap.this.key[this.index] == var2.getKey() && Reference2IntOpenHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
