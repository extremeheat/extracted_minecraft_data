...
public class ReferenceArraySet<K> extends AbstractReferenceSet<K> implements Serializable, Cloneable {
   ...
   public ReferenceArraySet(Object[] var1) {
      super();
      this.a = var1;
   ...
   public ReferenceArraySet(int var1) {
      super();
      this.a = new Object[var1];
   }

   public ReferenceArraySet(ReferenceCollection<K> var1) {
      this(var1.size());
      this.addAll(var1);
   }

   public ReferenceArraySet(Collection<? extends K> var1) {
      this(var1.size());
      this.addAll(var1);
   }

   public ReferenceArraySet(Object[] var1, int var2) {
      super();
      this.a = var1;
      this.size = var2;
      if (var2 > var1.length) {
   ...
   public ObjectIterator<K> iterator() {
      return new ObjectIterator<K>() {
         ...
         public void remove() {
            int var1 = ReferenceArraySet.this.size-- - this.next--;
            System.arraycopy(ReferenceArraySet.this.a, this.next + 1, ReferenceArraySet.this.a, this.next, var1);
   ...
   public ReferenceArraySet<K> clone() {
      ReferenceArraySet var1;
      try {
         var1 = (ReferenceArraySet)super.clone();
