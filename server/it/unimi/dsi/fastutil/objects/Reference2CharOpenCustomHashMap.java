...
public class Reference2CharOpenCustomHashMap<K> extends AbstractReference2CharMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Reference2CharOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Reference2CharOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2CharOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Reference2CharOpenCustomHashMap(Map<? extends K, ? extends Character> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2CharOpenCustomHashMap(Map<? extends K, ? extends Character> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2CharOpenCustomHashMap(Reference2CharMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Reference2CharOpenCustomHashMap(Reference2CharMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Reference2CharOpenCustomHashMap(K[] var1, char[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Reference2CharOpenCustomHashMap(K[] var1, char[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Reference2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Reference2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Reference2CharOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Reference2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Reference2CharOpenCustomHashMap<K> clone() {
      Reference2CharOpenCustomHashMap var1;
      try {
         var1 = (Reference2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      char[] var3 = this.value;
      Reference2CharOpenCustomHashMap.MapIterator var4 = new Reference2CharOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Reference2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Reference2CharOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Reference2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Reference2CharOpenCustomHashMap.this.size;
         Reference2CharOpenCustomHashMap.this.removeChar(var1);
         return Reference2CharOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry<K>> implements Reference2CharMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               if (Reference2CharOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Reference2CharOpenCustomHashMap.this.containsNullKey && Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Reference2CharOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2CharOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Reference2CharOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Reference2CharOpenCustomHashMap.this.mask]) != null) {
                        if (Reference2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Reference2CharOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Character) {
               ...
               char var4 = (Character)var2.getValue();
               if (Reference2CharOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Reference2CharOpenCustomHashMap.this.containsNullKey && Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Reference2CharOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Reference2CharOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Reference2CharOpenCustomHashMap.this.value[var7] == var4) {
                        Reference2CharOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Reference2CharOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Reference2CharOpenCustomHashMap.this.strategy.equals(var5, var3) || Reference2CharOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Reference2CharMap.Entry<K>> var1) {
         if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractReference2CharMap.BasicEntry(Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n], Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Reference2CharOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractReference2CharMap.BasicEntry(Reference2CharOpenCustomHashMap.this.key[var2], Reference2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> var1) {
         ...
         if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n];
            var2.value = Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Reference2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Reference2CharOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Reference2CharOpenCustomHashMap.this.key[var3];
               var2.value = Reference2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2CharMap.Entry<K>> {
      private final Reference2CharOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Reference2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2CharMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Reference2CharOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Reference2CharOpenCustomHashMap.this.mask; !Reference2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Reference2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Reference2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Reference2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Reference2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Reference2CharOpenCustomHashMap.this.value[var2] = Reference2CharOpenCustomHashMap.this.value[var1];
         }
      }
      ...
      public void remove() {
         if (this.last == -1) {
            ...
            if (this.last == Reference2CharOpenCustomHashMap.this.n) {
               ...
               if (this.pos < 0) {
                  Reference2CharOpenCustomHashMap.this.removeChar(this.wrapped.set(-this.pos - 1, (Object)null));
                  this.last = -1;
                  return;
               }
   ...
   final class MapEntry implements Reference2CharMap.Entry<K>, java.util.Map.Entry<K, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Reference2CharOpenCustomHashMap.this.value[this.index];
         Reference2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[this.index], var2.getKey()) && Reference2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
