...
public interface Object2FloatMap<K> extends Object2FloatFunction<K>, Map<K, Float> {
   ...
   default Float put(K var1, Float var2) {
      return Object2FloatFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float get(Object var1) {
      return Object2FloatFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Float remove(Object var1) {
      return Object2FloatFunction.super.remove(var1);
   }
   ...
   default float computeFloatIfAbsentPartial(K var1, Object2FloatFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.getFloat(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<K> extends ObjectSet<Object2FloatMap.Entry<K>> {
      ...
      default void fastForEach(Consumer<? super Object2FloatMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
