...
public class Object2ShortOpenHashMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2ShortOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2ShortOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2ShortOpenHashMap(Map<? extends K, ? extends Short> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2ShortOpenHashMap(Map<? extends K, ? extends Short> var1) {
      this(var1, 0.75F);
   }

   public Object2ShortOpenHashMap(Object2ShortMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2ShortOpenHashMap(Object2ShortMap<K> var1) {
      this(var1, 0.75F);
   }

   public Object2ShortOpenHashMap(K[] var1, short[] var2, float var3) {
   ...
   public Object2ShortOpenHashMap(K[] var1, short[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Object2ShortOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Object2ShortOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n]);
               }

               int var2 = Object2ShortOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2ShortOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2ShortOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2ShortOpenHashMap<K> clone() {
      Object2ShortOpenHashMap var1;
      try {
         var1 = (Object2ShortOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      short[] var3 = this.value;
      Object2ShortOpenHashMap.MapIterator var4 = new Object2ShortOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2ShortOpenHashMap.this.containsNullKey) {
            var1.accept(Object2ShortOpenHashMap.this.key[Object2ShortOpenHashMap.this.n]);
         }

         int var2 = Object2ShortOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2ShortOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2ShortOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2ShortOpenHashMap.this.size;
         Object2ShortOpenHashMap.this.removeShort(var1);
         return Object2ShortOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements Object2ShortMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Short) {
               ...
               if (var3 == null) {
                  return Object2ShortOpenHashMap.this.containsNullKey && Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2ShortOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2ShortOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3.equals(var5)) {
                     return Object2ShortOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2ShortOpenHashMap.this.mask]) != null) {
                        if (var3.equals(var5)) {
                           return Object2ShortOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Short) {
               ...
               short var4 = (Short)var2.getValue();
               if (var3 == null) {
                  if (Object2ShortOpenHashMap.this.containsNullKey && Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2ShortOpenHashMap.this.mask]) == null) {
                     ...
                     if (Object2ShortOpenHashMap.this.value[var7] == var4) {
                        Object2ShortOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2ShortOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!var5.equals(var3) || Object2ShortOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2ShortMap.Entry<K>> var1) {
         if (Object2ShortOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2ShortMap.BasicEntry(Object2ShortOpenHashMap.this.key[Object2ShortOpenHashMap.this.n], Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2ShortOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2ShortMap.BasicEntry(Object2ShortOpenHashMap.this.key[var2], Object2ShortOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> var1) {
         ...
         if (Object2ShortOpenHashMap.this.containsNullKey) {
            var2.key = Object2ShortOpenHashMap.this.key[Object2ShortOpenHashMap.this.n];
            var2.value = Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2ShortOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2ShortOpenHashMap.this.key[var3] != null) {
               var2.key = Object2ShortOpenHashMap.this.key[var3];
               var2.value = Object2ShortOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2ShortOpenHashMap<K>.MapIterator implements ObjectIterator<Object2ShortMap.Entry<K>> {
      ...
      private FastEntryIterator() {
         super(null);
         this.entry = Object2ShortOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2ShortOpenHashMap<K>.MapIterator implements ObjectIterator<Object2ShortMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2ShortOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2ShortOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2ShortOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2ShortOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2ShortOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & Object2ShortOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2ShortOpenHashMap.this.value[var2] = Object2ShortOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2ShortMap.Entry<K>, java.util.Map.Entry<K, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Object2ShortOpenHashMap.this.value[this.index];
         Object2ShortOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2ShortOpenHashMap.this.key[this.index], var2.getKey()) && Object2ShortOpenHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
