...
public class Reference2ByteArrayMap<K> extends AbstractReference2ByteMap<K> implements Serializable, Cloneable {
   ...
   public Reference2ByteArrayMap(Object[] var1, byte[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2ByteArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new byte[var1];
   }

   public Reference2ByteArrayMap(Reference2ByteMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ByteArrayMap(Map<? extends K, ? extends Byte> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ByteArrayMap(Object[] var1, byte[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2ByteArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2ByteArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2ByteArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2ByteArrayMap.this.key, var2 + 1, Reference2ByteArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2ByteArrayMap.this.value, var2 + 1, Reference2ByteArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2ByteArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2ByteArrayMap.this.key, this.pos, Reference2ByteArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2ByteArrayMap.this.value, this.pos, Reference2ByteArrayMap.this.value, this.pos - 1, var1);
                     Reference2ByteArrayMap.this.size--;
                  }
               }
            };
   ...
   public ByteCollection values() {
      return new AbstractByteCollection() {
         public boolean contains(byte var1) {
            return Reference2ByteArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2ByteArrayMap<K> clone() {
      Reference2ByteArrayMap var1;
      try {
         var1 = (Reference2ByteArrayMap)super.clone();
         ...
         return new ObjectIterator<Reference2ByteMap.Entry<K>>() {
            ...
            public Reference2ByteMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2ByteMap.BasicEntry(Reference2ByteArrayMap.this.key[this.curr = this.next], Reference2ByteArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2ByteArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2ByteArrayMap.this.key, this.next + 1, Reference2ByteArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2ByteArrayMap.this.value, this.next + 1, Reference2ByteArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2ByteMap.Entry<K>>() {
            ...
            public Reference2ByteMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2ByteArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               return Reference2ByteArrayMap.this.containsKey(var3) && Reference2ByteArrayMap.this.getByte(var3) == (Byte)var2.getValue();
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               int var5 = Reference2ByteArrayMap.this.findKey(var3);
               if (var5 != -1 && var4 == Reference2ByteArrayMap.this.value[var5]) {
                  int var6 = Reference2ByteArrayMap.this.size - var5 - 1;
                  System.arraycopy(Reference2ByteArrayMap.this.key, var5 + 1, Reference2ByteArrayMap.this.key, var5, var6);
                  System.arraycopy(Reference2ByteArrayMap.this.value, var5 + 1, Reference2ByteArrayMap.this.value, var5, var6);
                  Reference2ByteArrayMap.this.size--;
                  Reference2ByteArrayMap.this.key[Reference2ByteArrayMap.this.size] = null;
                  return true;
               } else {
