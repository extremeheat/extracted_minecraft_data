...
public interface Object2BooleanMap<K> extends Object2BooleanFunction<K>, Map<K, Boolean> {
   ...
   default Boolean put(K var1, Boolean var2) {
      return Object2BooleanFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Boolean get(Object var1) {
      return Object2BooleanFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Boolean remove(Object var1) {
      return Object2BooleanFunction.super.remove(var1);
   }
   ...
   default boolean computeBooleanIfAbsentPartial(K var1, Object2BooleanFunction<? super K> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.getBoolean(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<K> extends ObjectSet<Object2BooleanMap.Entry<K>> {
      ...
      default void fastForEach(Consumer<? super Object2BooleanMap.Entry<K>> var1) {
         this.forEach(var1);
      }
   }
}
