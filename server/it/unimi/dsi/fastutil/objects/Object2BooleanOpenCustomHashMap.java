...
public class Object2BooleanOpenCustomHashMap<K> extends AbstractObject2BooleanMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2BooleanOpenCustomHashMap(int var1, float var2, Hash.Strategy<K> var3) {
      super();
      this.strategy = var3;
   ...
   public Object2BooleanOpenCustomHashMap(int var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2BooleanOpenCustomHashMap(Hash.Strategy<K> var1) {
      this(16, 0.75F, var1);
   }

   public Object2BooleanOpenCustomHashMap(Map<? extends K, ? extends Boolean> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2BooleanOpenCustomHashMap(Map<? extends K, ? extends Boolean> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2BooleanOpenCustomHashMap(Object2BooleanMap<K> var1, float var2, Hash.Strategy<K> var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Object2BooleanOpenCustomHashMap(Object2BooleanMap<K> var1, Hash.Strategy<K> var2) {
      this(var1, 0.75F, var2);
   }

   public Object2BooleanOpenCustomHashMap(K[] var1, boolean[] var2, float var3, Hash.Strategy<K> var4) {
   ...
   public Object2BooleanOpenCustomHashMap(K[] var1, boolean[] var2, Hash.Strategy<K> var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Object2BooleanOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Object2BooleanOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Object2BooleanOpenCustomHashMap.this.value[Object2BooleanOpenCustomHashMap.this.n]);
               }

               int var2 = Object2BooleanOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2BooleanOpenCustomHashMap.this.key[var2] != null) {
                     var1.accept(Object2BooleanOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2BooleanOpenCustomHashMap<K> clone() {
      Object2BooleanOpenCustomHashMap var1;
      try {
         var1 = (Object2BooleanOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      boolean[] var3 = this.value;
      Object2BooleanOpenCustomHashMap.MapIterator var4 = new Object2BooleanOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Object2BooleanOpenCustomHashMap.this.key[Object2BooleanOpenCustomHashMap.this.n]);
         }

         int var2 = Object2BooleanOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2BooleanOpenCustomHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2BooleanOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2BooleanOpenCustomHashMap.this.size;
         Object2BooleanOpenCustomHashMap.this.removeBoolean(var1);
         return Object2BooleanOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<K>> implements Object2BooleanMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               if (Object2BooleanOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  return Object2BooleanOpenCustomHashMap.this.containsNullKey && Object2BooleanOpenCustomHashMap.this.value[Object2BooleanOpenCustomHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2BooleanOpenCustomHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Object2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2BooleanOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2BooleanOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Object2BooleanOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2BooleanOpenCustomHashMap.this.mask]) != null) {
                        if (Object2BooleanOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Object2BooleanOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
               ...
               boolean var4 = (Boolean)var2.getValue();
               if (Object2BooleanOpenCustomHashMap.this.strategy.equals(var3, (Object)null)) {
                  if (Object2BooleanOpenCustomHashMap.this.containsNullKey && Object2BooleanOpenCustomHashMap.this.value[Object2BooleanOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Object2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Object2BooleanOpenCustomHashMap.this.mask]) == null) {
                     return false;
                  } else if (Object2BooleanOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Object2BooleanOpenCustomHashMap.this.value[var7] == var4) {
                        Object2BooleanOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2BooleanOpenCustomHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!Object2BooleanOpenCustomHashMap.this.strategy.equals(var5, var3) || Object2BooleanOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2BooleanMap.Entry<K>> var1) {
         if (Object2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2BooleanMap.BasicEntry(Object2BooleanOpenCustomHashMap.this.key[Object2BooleanOpenCustomHashMap.this.n], Object2BooleanOpenCustomHashMap.this.value[Object2BooleanOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2BooleanOpenCustomHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2BooleanMap.BasicEntry(Object2BooleanOpenCustomHashMap.this.key[var2], Object2BooleanOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2BooleanMap.Entry<K>> var1) {
         ...
         if (Object2BooleanOpenCustomHashMap.this.containsNullKey) {
            var2.key = Object2BooleanOpenCustomHashMap.this.key[Object2BooleanOpenCustomHashMap.this.n];
            var2.value = Object2BooleanOpenCustomHashMap.this.value[Object2BooleanOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2BooleanOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Object2BooleanOpenCustomHashMap.this.key[var3] != null) {
               var2.key = Object2BooleanOpenCustomHashMap.this.key[var3];
               var2.value = Object2BooleanOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2BooleanOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2BooleanMap.Entry<K>> {
      private final Object2BooleanOpenCustomHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2BooleanOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2BooleanOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2BooleanMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2BooleanOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Object2BooleanOpenCustomHashMap.this.strategy.hashCode(var2)) & Object2BooleanOpenCustomHashMap.this.mask; !Object2BooleanOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Object2BooleanOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2BooleanOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2BooleanOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Object2BooleanOpenCustomHashMap.this.strategy.hashCode(var4)) & Object2BooleanOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2BooleanOpenCustomHashMap.this.value[var2] = Object2BooleanOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2BooleanMap.Entry<K>, java.util.Map.Entry<K, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Object2BooleanOpenCustomHashMap.this.value[this.index];
         Object2BooleanOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Object2BooleanOpenCustomHashMap.this.strategy.equals(Object2BooleanOpenCustomHashMap.this.key[this.index], var2.getKey()) && Object2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
