...
public class Object2CharAVLTreeMap<K> extends AbstractObject2CharSortedMap<K> implements Serializable, Cloneable {
   ...
   public Object2CharAVLTreeMap(Comparator<? super K> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Object2CharAVLTreeMap(Map<? extends K, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Object2CharAVLTreeMap(SortedMap<K, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2CharAVLTreeMap(Object2CharMap<? extends K> var1) {
      this();
      this.putAll(var1);
   }

   public Object2CharAVLTreeMap(Object2CharSortedMap<K> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2CharAVLTreeMap(K[] var1, char[] var2, Comparator<? super K> var3) {
      this(var3);
   ...
   public Object2CharAVLTreeMap(K[] var1, char[] var2) {
   ...
   final Object2CharAVLTreeMap.Entry<K> findKey(K var1) {
      Object2CharAVLTreeMap.Entry var2;
      int var3;
   ...
   final Object2CharAVLTreeMap.Entry<K> locateKey(K var1) {
      Object2CharAVLTreeMap.Entry var2 = this.tree;
      Object2CharAVLTreeMap.Entry var3 = this.tree;
   ...
   public char addTo(K var1, char var2) {
      Object2CharAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Object2CharAVLTreeMap.Entry<K> add(K var1) {
      this.modified = false;
      Object2CharAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Object2CharAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Object2CharAVLTreeMap.Entry var3 = this.tree;
         Object2CharAVLTreeMap.Entry var4 = null;
         Object2CharAVLTreeMap.Entry var5 = this.tree;
         Object2CharAVLTreeMap.Entry var6 = null;
         Object2CharAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Object2CharAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Object2CharAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Object2CharAVLTreeMap.Entry<K> parent(Object2CharAVLTreeMap.Entry<K> var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Object2CharAVLTreeMap.Entry var3 = var1;

         Object2CharAVLTreeMap.Entry var2;
         Object2CharAVLTreeMap.Entry var4;
   ...
   public char removeChar(Object var1) {
      ...
      if (this.tree == null) {
         ...
         Object2CharAVLTreeMap.Entry var7;
         Object2CharAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Object2CharAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(char var1) {
      Object2CharAVLTreeMap.ValueIterator var2 = new Object2CharAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char getChar(Object var1) {
      Object2CharAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
            final Comparator<? super Object2CharMap.Entry<K>> comparator = (var1x, var2) -> {
               return Object2CharAVLTreeMap.this.actualComparator.compare(var1x.getKey(), var2.getKey());
            };
            ...
            public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> var1) {
               return Object2CharAVLTreeMap.this.new EntryIterator(var1.getKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Character) {
                     Object2CharAVLTreeMap.Entry var3 = Object2CharAVLTreeMap.this.findKey(var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Character) {
                     ...
                     if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                        Object2CharAVLTreeMap.this.removeChar(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> var1, Object2CharMap.Entry<K> var2) {
               return Object2CharAVLTreeMap.this.subMap(var1.getKey(), var2.getKey()).object2CharEntrySet();
            }

            public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> var1) {
               return Object2CharAVLTreeMap.this.headMap(var1.getKey()).object2CharEntrySet();
            }

            public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> var1) {
               return Object2CharAVLTreeMap.this.tailMap(var1.getKey()).object2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Object2CharAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Object2CharSortedMap<K> headMap(K var1) {
      return new Object2CharAVLTreeMap.Submap((Object)null, true, var1, false);
   }

   public Object2CharSortedMap<K> tailMap(K var1) {
      return new Object2CharAVLTreeMap.Submap(var1, false, (Object)null, true);
   }

   public Object2CharSortedMap<K> subMap(K var1, K var2) {
      return new Object2CharAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Object2CharAVLTreeMap<K> clone() {
      Object2CharAVLTreeMap var1;
      try {
         var1 = (Object2CharAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Object2CharAVLTreeMap.Entry var5 = new Object2CharAVLTreeMap.Entry();
         Object2CharAVLTreeMap.Entry var6 = new Object2CharAVLTreeMap.Entry();
         Object2CharAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Object2CharAVLTreeMap.Entry var4 = var6;
         var6.pred((Object2CharAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Object2CharAVLTreeMap.EntryIterator var3 = new Object2CharAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Object2CharAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Object2CharAVLTreeMap.Entry<K> readTree(ObjectInputStream var1, int var2, Object2CharAVLTreeMap.Entry<K> var3, Object2CharAVLTreeMap.Entry<K> var4) throws IOException, ClassNotFoundException {
      Object2CharAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Object2CharAVLTreeMap.Entry(var1.readObject(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Object2CharAVLTreeMap.Entry(var1.readObject(), var1.readChar());
         var8.right(new Object2CharAVLTreeMap.Entry(var1.readObject(), var1.readChar()));
         ...
         Object2CharAVLTreeMap.Entry var7 = new Object2CharAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Object2CharAVLTreeMap.Entry)null, (Object2CharAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractObject2CharSortedMap<K> implements Serializable {
      ...
      public Submap(K var2, boolean var3, K var4, boolean var5) {
         super();
         if (!var3 && !var5 && Object2CharAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Object2CharAVLTreeMap.Submap.SubmapIterator var1 = new Object2CharAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(K var1) {
         return (this.bottom || Object2CharAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Object2CharAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(Object var1) {
         return this.in(var1) && Object2CharAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Object2CharAVLTreeMap.Submap.SubmapIterator var2 = new Object2CharAVLTreeMap.Submap.SubmapIterator();
      ...
      public char getChar(Object var1) {
         Object2CharAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Object2CharAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public char put(K var1, char var2) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Object2CharAVLTreeMap.this.put(var1, var2);
            return Object2CharAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public char removeChar(Object var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var2 = Object2CharAVLTreeMap.this.removeChar(var1);
            return Object2CharAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Object2CharSortedMap<K> headMap(K var1) {
         if (this.top) {
            return Object2CharAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Object2CharAVLTreeMap.this.compare(var1, this.to) < 0 ? Object2CharAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Object2CharSortedMap<K> tailMap(K var1) {
         if (this.bottom) {
            return Object2CharAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Object2CharAVLTreeMap.this.compare(var1, this.from) > 0 ? Object2CharAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Object2CharSortedMap<K> subMap(K var1, K var2) {
         if (this.top && this.bottom) {
            return Object2CharAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Object2CharAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Object2CharAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Object2CharAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Object2CharAVLTreeMap.Entry<K> firstEntry() {
         if (Object2CharAVLTreeMap.this.tree == null) {
            ...
            Object2CharAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Object2CharAVLTreeMap.this.firstEntry;
            } else {
               var1 = Object2CharAVLTreeMap.this.locateKey(this.from);
               if (Object2CharAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Object2CharAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Object2CharAVLTreeMap.Entry<K> lastEntry() {
         if (Object2CharAVLTreeMap.this.tree == null) {
            ...
            Object2CharAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Object2CharAVLTreeMap.this.lastEntry;
            } else {
               var1 = Object2CharAVLTreeMap.this.locateKey(this.to);
               if (Object2CharAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Object2CharAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public K firstKey() {
         Object2CharAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public K lastKey() {
         Object2CharAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Object2CharAVLTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2CharMap.Entry<K>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Object2CharAVLTreeMap<K>.TreeIterator {
         ...
         SubmapIterator(K var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Object2CharAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Object2CharAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Object2CharAVLTreeMap.this.locateKey(var2);
                  if (Object2CharAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractObject2CharSortedMap<K>.KeySet {
      ...
      public ObjectBidirectionalIterator<K> iterator(K var1) {
         return Object2CharAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Object2CharAVLTreeMap<K>.TreeIterator implements ObjectListIterator<Object2CharMap.Entry<K>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(K var2) {
         super();
         if ((this.next = Object2CharAVLTreeMap.this.locateKey(var2)) != null) {
            if (Object2CharAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<K> extends AbstractObject2CharMap.BasicEntry<K> implements Cloneable {
      ...
      void pred(Object2CharAVLTreeMap.Entry<K> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Object2CharAVLTreeMap.Entry<K> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Object2CharAVLTreeMap.Entry<K> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Object2CharAVLTreeMap.Entry<K> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Object2CharAVLTreeMap.Entry<K> next() {
         Object2CharAVLTreeMap.Entry var1 = this.right;
      ...
      Object2CharAVLTreeMap.Entry<K> prev() {
         Object2CharAVLTreeMap.Entry var1 = this.left;
      ...
      public Object2CharAVLTreeMap.Entry<K> clone() {
         Object2CharAVLTreeMap.Entry var1;
         try {
            var1 = (Object2CharAVLTreeMap.Entry)super.clone();
