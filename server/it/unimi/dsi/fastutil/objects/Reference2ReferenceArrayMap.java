...
public class Reference2ReferenceArrayMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable {
   ...
   public Reference2ReferenceArrayMap(Object[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2ReferenceArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new Object[var1];
   }

   public Reference2ReferenceArrayMap(Reference2ReferenceMap<K, V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ReferenceArrayMap(Map<? extends K, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ReferenceArrayMap(Object[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Reference2ReferenceMap.FastEntrySet<K, V> reference2ReferenceEntrySet() {
      return new Reference2ReferenceArrayMap.EntrySet();
   }
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2ReferenceArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2ReferenceArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2ReferenceArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2ReferenceArrayMap.this.key, var2 + 1, Reference2ReferenceArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2ReferenceArrayMap.this.value, var2 + 1, Reference2ReferenceArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2ReferenceArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2ReferenceArrayMap.this.key, this.pos, Reference2ReferenceArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2ReferenceArrayMap.this.value, this.pos, Reference2ReferenceArrayMap.this.value, this.pos - 1, var1);
                     Reference2ReferenceArrayMap.this.size--;
                  }
               }
            };
   ...
   public ReferenceCollection<V> values() {
      return new AbstractReferenceCollection<V>() {
         public boolean contains(Object var1) {
            return Reference2ReferenceArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2ReferenceArrayMap<K, V> clone() {
      Reference2ReferenceArrayMap var1;
      try {
         var1 = (Reference2ReferenceArrayMap)super.clone();
   ...
   private final class EntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> {
         ...
         return new ObjectIterator<Reference2ReferenceMap.Entry<K, V>>() {
            ...
            public Reference2ReferenceMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2ReferenceMap.BasicEntry(Reference2ReferenceArrayMap.this.key[this.curr = this.next], Reference2ReferenceArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2ReferenceArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2ReferenceArrayMap.this.key, this.next + 1, Reference2ReferenceArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2ReferenceArrayMap.this.value, this.next + 1, Reference2ReferenceArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2ReferenceMap.Entry<K, V>>() {
            ...
            public Reference2ReferenceMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2ReferenceArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            return Reference2ReferenceArrayMap.this.containsKey(var3) && Reference2ReferenceArrayMap.this.get(var3) == var2.getValue();
         }
      }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            int var5 = Reference2ReferenceArrayMap.this.findKey(var3);
            if (var5 != -1 && var4 == Reference2ReferenceArrayMap.this.value[var5]) {
               int var6 = Reference2ReferenceArrayMap.this.size - var5 - 1;
               System.arraycopy(Reference2ReferenceArrayMap.this.key, var5 + 1, Reference2ReferenceArrayMap.this.key, var5, var6);
               System.arraycopy(Reference2ReferenceArrayMap.this.value, var5 + 1, Reference2ReferenceArrayMap.this.value, var5, var6);
               Reference2ReferenceArrayMap.this.size--;
               Reference2ReferenceArrayMap.this.key[Reference2ReferenceArrayMap.this.size] = null;
               Reference2ReferenceArrayMap.this.value[Reference2ReferenceArrayMap.this.size] = null;
               return true;
