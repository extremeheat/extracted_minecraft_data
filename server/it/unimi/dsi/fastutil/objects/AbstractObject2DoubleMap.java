...
public abstract class AbstractObject2DoubleMap<K> extends AbstractObject2DoubleFunction<K> implements Object2DoubleMap<K>, Serializable {
   ...
   public boolean containsKey(Object var1) {
      ObjectIterator var2 = this.object2DoubleEntrySet().iterator();

      do {
         if (!var2.hasNext()) {
            return false;
         }
      } while(((Object2DoubleMap.Entry)var2.next()).getKey() != var1);
   ...
   public ObjectSet<K> keySet() {
      return new AbstractObjectSet<K>() {
         public boolean contains(Object var1) {
            return AbstractObject2DoubleMap.this.containsKey(var1);
         }
   ...
   public DoubleCollection values() {
      return new AbstractDoubleCollection() {
         public boolean contains(double var1) {
            return AbstractObject2DoubleMap.this.containsValue(var1);
         }
   ...
   public void putAll(Map<? extends K, ? extends Double> var1) {
      if (var1 instanceof Object2DoubleMap) {
         ObjectIterator var2 = Object2DoubleMaps.fastIterator((Object2DoubleMap)var1);

         while(var2.hasNext()) {
            Object2DoubleMap.Entry var3 = (Object2DoubleMap.Entry)var2.next();
   ...
   public int hashCode() {
      ...
      for(ObjectIterator var3 = Object2DoubleMaps.fastIterator(this); var2-- != 0; var1 += ((Object2DoubleMap.Entry)var3.next()).hashCode()) {
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         Map var2 = (Map)var1;
         return var2.size() != this.size() ? false : this.object2DoubleEntrySet().containsAll(var2.entrySet());
      }
   }

   public String toString() {
      StringBuilder var1 = new StringBuilder();
      ObjectIterator var2 = Object2DoubleMaps.fastIterator(this);
      int var3 = this.size();
      boolean var5 = true;
      var1.append("{");
      ...
      while(var3-- != 0) {
         ...
         Object2DoubleMap.Entry var4 = (Object2DoubleMap.Entry)var2.next();
         if (this == var4.getKey()) {
   ...
   public abstract static class BasicEntrySet<K> extends AbstractObjectSet<Object2DoubleMap.Entry<K>> {
      ...
      public BasicEntrySet(Object2DoubleMap<K> var1) {
         super();
         this.map = var1;
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Object var3;
            if (var1 instanceof Object2DoubleMap.Entry) {
               Object2DoubleMap.Entry var5 = (Object2DoubleMap.Entry)var1;
               var3 = var5.getKey();
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            return false;
         } else if (var1 instanceof Object2DoubleMap.Entry) {
            Object2DoubleMap.Entry var7 = (Object2DoubleMap.Entry)var1;
   ...
   public static class BasicEntry<K> implements Object2DoubleMap.Entry<K> {
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Object2DoubleMap.Entry var5 = (Object2DoubleMap.Entry)var1;
            return Objects.equals(this.key, var5.getKey()) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(var5.getDoubleValue());
         } else {
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            Object var3 = var2.getKey();
            Object var4 = var2.getValue();
            if (var4 != null && var4 instanceof Double) {
               return Objects.equals(this.key, var3) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((Double)var4);
            } else {
               return false;
            }
         }
