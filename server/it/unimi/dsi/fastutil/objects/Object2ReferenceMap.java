...
public interface Object2ReferenceMap<K, V> extends Object2ReferenceFunction<K, V>, Map<K, V> {
   ...
   default V put(K var1, V var2) {
      return Object2ReferenceFunction.super.put(var1, var2);
   }

   default V remove(Object var1) {
      return Object2ReferenceFunction.super.remove(var1);
   }
   ...
   public interface FastEntrySet<K, V> extends ObjectSet<Object2ReferenceMap.Entry<K, V>> {
      ...
      default void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> var1) {
         this.forEach(var1);
      }
   }
}
