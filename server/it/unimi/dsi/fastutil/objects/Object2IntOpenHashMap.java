...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2IntOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2IntOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2IntOpenHashMap(Map<? extends K, ? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2IntOpenHashMap(Map<? extends K, ? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public Object2IntOpenHashMap(Object2IntMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2IntOpenHashMap(Object2IntMap<K> var1) {
      this(var1, 0.75F);
   }

   public Object2IntOpenHashMap(K[] var1, int[] var2, float var3) {
   ...
   public Object2IntOpenHashMap(K[] var1, int[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Object2IntOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Object2IntOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n]);
               }

               int var2 = Object2IntOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2IntOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2IntOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2IntOpenHashMap<K> clone() {
      ...
      try {
         var1 = (Object2IntOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      int[] var3 = this.value;
      Object2IntOpenHashMap.MapIterator var4 = new Object2IntOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Object2IntOpenHashMap<K>.MapIterator implements IntIterator {
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2IntOpenHashMap.this.containsNullKey) {
            var1.accept(Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.n]);
         }

         int var2 = Object2IntOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2IntOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2IntOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2IntOpenHashMap.this.size;
         Object2IntOpenHashMap.this.removeInt(var1);
         return Object2IntOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Integer) {
               ...
               if (var3 == null) {
                  return Object2IntOpenHashMap.this.containsNullKey && Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2IntOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2IntOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3.equals(var5)) {
                     return Object2IntOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2IntOpenHashMap.this.mask]) != null) {
                        if (var3.equals(var5)) {
                           return Object2IntOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Integer) {
               ...
               int var4 = (Integer)var2.getValue();
               if (var3 == null) {
                  if (Object2IntOpenHashMap.this.containsNullKey && Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2IntOpenHashMap.this.mask]) == null) {
                     ...
                     if (Object2IntOpenHashMap.this.value[var7] == var4) {
                        Object2IntOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2IntOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!var5.equals(var3) || Object2IntOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2IntMap.Entry<K>> var1) {
         if (Object2IntOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.n], Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2IntOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenHashMap.this.key[var2], Object2IntOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> var1) {
         ...
         if (Object2IntOpenHashMap.this.containsNullKey) {
            var2.key = Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.n];
            var2.value = Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2IntOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2IntOpenHashMap.this.key[var3] != null) {
               var2.key = Object2IntOpenHashMap.this.key[var3];
               var2.value = Object2IntOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
   ...
   private class EntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2IntOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2IntOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2IntOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2IntOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2IntOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & Object2IntOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2IntOpenHashMap.this.value[var2] = Object2IntOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2IntMap.Entry<K>, java.util.Map.Entry<K, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Object2IntOpenHashMap.this.value[this.index];
         Object2IntOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2IntOpenHashMap.this.key[this.index], var2.getKey()) && Object2IntOpenHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
