...
public class Object2LongArrayMap<K> extends AbstractObject2LongMap<K> implements Serializable, Cloneable {
   ...
   public Object2LongArrayMap(Object[] var1, long[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Object2LongArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new long[var1];
   }

   public Object2LongArrayMap(Object2LongMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Object2LongArrayMap(Map<? extends K, ? extends Long> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Object2LongArrayMap(Object[] var1, long[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ObjectSet<K> keySet() {
      return new AbstractObjectSet<K>() {
         public boolean contains(Object var1) {
            return Object2LongArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Object2LongArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Object2LongArrayMap.this.size - var2 - 1;
               System.arraycopy(Object2LongArrayMap.this.key, var2 + 1, Object2LongArrayMap.this.key, var2, var3);
               System.arraycopy(Object2LongArrayMap.this.value, var2 + 1, Object2LongArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Object2LongArrayMap.this.size - this.pos;
                     System.arraycopy(Object2LongArrayMap.this.key, this.pos, Object2LongArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Object2LongArrayMap.this.value, this.pos, Object2LongArrayMap.this.value, this.pos - 1, var1);
                     Object2LongArrayMap.this.size--;
                  }
               }
            };
   ...
   public LongCollection values() {
      return new AbstractLongCollection() {
         public boolean contains(long var1) {
            return Object2LongArrayMap.this.containsValue(var1);
         }
   ...
   public Object2LongArrayMap<K> clone() {
      Object2LongArrayMap var1;
      try {
         var1 = (Object2LongArrayMap)super.clone();
         ...
         return new ObjectIterator<Object2LongMap.Entry<K>>() {
            ...
            public Object2LongMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractObject2LongMap.BasicEntry(Object2LongArrayMap.this.key[this.curr = this.next], Object2LongArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Object2LongArrayMap.this.size-- - this.next--;
                  System.arraycopy(Object2LongArrayMap.this.key, this.next + 1, Object2LongArrayMap.this.key, this.next, var1);
                  System.arraycopy(Object2LongArrayMap.this.value, this.next + 1, Object2LongArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Object2LongMap.Entry<K>>() {
            ...
            public Object2LongMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Object2LongArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               return Object2LongArrayMap.this.containsKey(var3) && Object2LongArrayMap.this.getLong(var3) == (Long)var2.getValue();
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Long) {
               ...
               int var6 = Object2LongArrayMap.this.findKey(var3);
               if (var6 != -1 && var4 == Object2LongArrayMap.this.value[var6]) {
                  int var7 = Object2LongArrayMap.this.size - var6 - 1;
                  System.arraycopy(Object2LongArrayMap.this.key, var6 + 1, Object2LongArrayMap.this.key, var6, var7);
                  System.arraycopy(Object2LongArrayMap.this.value, var6 + 1, Object2LongArrayMap.this.value, var6, var7);
                  Object2LongArrayMap.this.size--;
                  Object2LongArrayMap.this.key[Object2LongArrayMap.this.size] = null;
                  return true;
               } else {
