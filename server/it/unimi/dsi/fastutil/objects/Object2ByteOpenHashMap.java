...
public class Object2ByteOpenHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash {
   ...
   public Object2ByteOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2ByteOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2ByteOpenHashMap(Map<? extends K, ? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2ByteOpenHashMap(Map<? extends K, ? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public Object2ByteOpenHashMap(Object2ByteMap<K> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2ByteOpenHashMap(Object2ByteMap<K> var1) {
      this(var1, 0.75F);
   }

   public Object2ByteOpenHashMap(K[] var1, byte[] var2, float var3) {
   ...
   public Object2ByteOpenHashMap(K[] var1, byte[] var2) {
   ...
   public Object2ByteMap.FastEntrySet<K> object2ByteEntrySet() {
      if (this.entries == null) {
         this.entries = new Object2ByteOpenHashMap.MapEntrySet();
      }
   ...
   public ObjectSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Object2ByteOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            public ByteIterator iterator() {
               return Object2ByteOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(byte var1) {
               return Object2ByteOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Object2ByteOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2ByteOpenHashMap.this.value[Object2ByteOpenHashMap.this.n]);
               }

               int var2 = Object2ByteOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2ByteOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2ByteOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2ByteOpenHashMap<K> clone() {
      Object2ByteOpenHashMap var1;
      try {
         var1 = (Object2ByteOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      byte[] var3 = this.value;
      Object2ByteOpenHashMap.MapIterator var4 = new Object2ByteOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Object2ByteOpenHashMap<K>.MapIterator implements ByteIterator {
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return Object2ByteOpenHashMap.this.new KeyIterator();
      }

      public void forEach(Consumer<? super K> var1) {
         if (Object2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(Object2ByteOpenHashMap.this.key[Object2ByteOpenHashMap.this.n]);
         }

         int var2 = Object2ByteOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2ByteOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2ByteOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2ByteOpenHashMap.this.size;
         Object2ByteOpenHashMap.this.removeByte(var1);
         return Object2ByteOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Object2ByteOpenHashMap<K>.MapIterator implements ObjectIterator<K> {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements Object2ByteMap.FastEntrySet<K> {
      ...
      public ObjectIterator<Object2ByteMap.Entry<K>> iterator() {
         return Object2ByteOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator() {
         return Object2ByteOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               if (var3 == null) {
                  return Object2ByteOpenHashMap.this.containsNullKey && Object2ByteOpenHashMap.this.value[Object2ByteOpenHashMap.this.n] == var4;
               } else {
                  Object[] var6 = Object2ByteOpenHashMap.this.key;
                  Object var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2ByteOpenHashMap.this.mask]) == null) {
                     return false;
                  } else if (var3.equals(var5)) {
                     return Object2ByteOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Object2ByteOpenHashMap.this.mask]) != null) {
                        if (var3.equals(var5)) {
                           return Object2ByteOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Byte) {
               ...
               byte var4 = (Byte)var2.getValue();
               if (var3 == null) {
                  if (Object2ByteOpenHashMap.this.containsNullKey && Object2ByteOpenHashMap.this.value[Object2ByteOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2ByteOpenHashMap.this.mask]) == null) {
                     ...
                     if (Object2ByteOpenHashMap.this.value[var7] == var4) {
                        Object2ByteOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Object2ByteOpenHashMap.this.mask]) == null) {
                           return false;
                        }
                     } while(!var5.equals(var3) || Object2ByteOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2ByteMap.Entry<K>> var1) {
         if (Object2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteOpenHashMap.this.key[Object2ByteOpenHashMap.this.n], Object2ByteOpenHashMap.this.value[Object2ByteOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2ByteOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2ByteMap.BasicEntry(Object2ByteOpenHashMap.this.key[var2], Object2ByteOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> var1) {
         ...
         if (Object2ByteOpenHashMap.this.containsNullKey) {
            var2.key = Object2ByteOpenHashMap.this.key[Object2ByteOpenHashMap.this.n];
            var2.value = Object2ByteOpenHashMap.this.value[Object2ByteOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2ByteOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2ByteOpenHashMap.this.key[var3] != null) {
               var2.key = Object2ByteOpenHashMap.this.key[var3];
               var2.value = Object2ByteOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2ByteOpenHashMap<K>.MapIterator implements ObjectIterator<Object2ByteMap.Entry<K>> {
      private final Object2ByteOpenHashMap<K>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Object2ByteOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2ByteOpenHashMap<K>.MapIterator implements ObjectIterator<Object2ByteMap.Entry<K>> {
      ...
      public Object2ByteOpenHashMap<K>.MapEntry next() {
         return this.entry = Object2ByteOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2ByteOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2ByteOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2ByteOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2ByteOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2ByteOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4.hashCode()) & Object2ByteOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2ByteOpenHashMap.this.value[var2] = Object2ByteOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2ByteMap.Entry<K>, java.util.Map.Entry<K, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Object2ByteOpenHashMap.this.value[this.index];
         Object2ByteOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2ByteOpenHashMap.this.key[this.index], var2.getKey()) && Object2ByteOpenHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
