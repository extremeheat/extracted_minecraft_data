...
public final class ObjectCollections {
   ...
   public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> var0) {
      return new ObjectCollections.SynchronizedCollection(var0);
   }

   public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> var0, Object var1) {
      return new ObjectCollections.SynchronizedCollection(var0, var1);
   }

   public static <K> ObjectCollection<K> unmodifiable(ObjectCollection<K> var0) {
      return new ObjectCollections.UnmodifiableCollection(var0);
   }

   public static <K> ObjectCollection<K> asCollection(ObjectIterable<K> var0) {
      return (ObjectCollection)(var0 instanceof ObjectCollection ? (ObjectCollection)var0 : new ObjectCollections.IterableCollection(var0));
   }
   ...
   public static class UnmodifiableCollection<K> implements ObjectCollection<K>, Serializable {
      ...
      protected UnmodifiableCollection(ObjectCollection<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
   ...
   public static class SynchronizedCollection<K> implements ObjectCollection<K>, Serializable {
      ...
      protected SynchronizedCollection(ObjectCollection<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedCollection(ObjectCollection<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
