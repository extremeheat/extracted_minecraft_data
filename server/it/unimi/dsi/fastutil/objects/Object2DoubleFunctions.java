...
public final class Object2DoubleFunctions {
   ...
   public static <K> Object2DoubleFunction<K> singleton(K var0, double var1) {
      return new Object2DoubleFunctions.Singleton(var0, var1);
   }
   ...
   public static <K> Object2DoubleFunction<K> synchronize(Object2DoubleFunction<K> var0) {
      return new Object2DoubleFunctions.SynchronizedFunction(var0);
   }

   public static <K> Object2DoubleFunction<K> synchronize(Object2DoubleFunction<K> var0, Object var1) {
      return new Object2DoubleFunctions.SynchronizedFunction(var0, var1);
   }

   public static <K> Object2DoubleFunction<K> unmodifiable(Object2DoubleFunction<K> var0) {
      return new Object2DoubleFunctions.UnmodifiableFunction(var0);
   }

   public static <K> Object2DoubleFunction<K> primitive(Function<? super K, ? extends Double> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Object2DoubleFunction) {
         return (Object2DoubleFunction)var0;
      } else {
         return (Object2DoubleFunction)(var0 instanceof ToDoubleFunction ? (var1) -> {
            return ((ToDoubleFunction)var0).applyAsDouble(var1);
         } : new Object2DoubleFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class UnmodifiableFunction<K> extends AbstractObject2DoubleFunction<K> implements Serializable {
      ...
      protected UnmodifiableFunction(Object2DoubleFunction<K> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<K> implements Object2DoubleFunction<K>, Serializable {
      ...
      protected SynchronizedFunction(Object2DoubleFunction<K> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Object2DoubleFunction<K> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
