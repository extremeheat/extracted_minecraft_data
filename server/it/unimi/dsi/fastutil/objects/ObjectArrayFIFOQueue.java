...
public class ObjectArrayFIFOQueue<K> implements PriorityQueue<K>, Serializable {
   ...
   public ObjectArrayFIFOQueue(int var1) {
      super();
      if (var1 < 0) {
         throw new IllegalArgumentException("Initial capacity (" + var1 + ") is negative");
      } else {
         this.array = new Object[Math.max(1, var1)];
   ...
   public K dequeue() {
      if (this.start == this.end) {
         ...
         Object var1 = this.array[this.start];
   ...
   public K dequeueLast() {
      if (this.start == this.end) {
         ...
         Object var1 = this.array[--this.end];
   ...
   public void enqueueFirst(K var1) {
      if (this.start == 0) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      ...
      while(var2-- != 0) {
         var1.writeObject(this.array[var3++]);
         if (var3 == this.length) {
            var3 = 0;
         }
      }
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.array = new Object[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
