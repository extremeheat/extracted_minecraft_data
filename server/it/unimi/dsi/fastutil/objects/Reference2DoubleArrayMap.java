...
public class Reference2DoubleArrayMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable {
   ...
   public Reference2DoubleArrayMap(Object[] var1, double[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2DoubleArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new double[var1];
   }

   public Reference2DoubleArrayMap(Reference2DoubleMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2DoubleArrayMap(Map<? extends K, ? extends Double> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2DoubleArrayMap(Object[] var1, double[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Reference2DoubleMap.FastEntrySet<K> reference2DoubleEntrySet() {
      return new Reference2DoubleArrayMap.EntrySet();
   }
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2DoubleArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2DoubleArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2DoubleArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2DoubleArrayMap.this.key, var2 + 1, Reference2DoubleArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2DoubleArrayMap.this.value, var2 + 1, Reference2DoubleArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2DoubleArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2DoubleArrayMap.this.key, this.pos, Reference2DoubleArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2DoubleArrayMap.this.value, this.pos, Reference2DoubleArrayMap.this.value, this.pos - 1, var1);
                     Reference2DoubleArrayMap.this.size--;
                  }
               }
            };
   ...
   public DoubleCollection values() {
      return new AbstractDoubleCollection() {
         public boolean contains(double var1) {
            return Reference2DoubleArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2DoubleArrayMap<K> clone() {
      Reference2DoubleArrayMap var1;
      try {
         var1 = (Reference2DoubleArrayMap)super.clone();
         ...
         return new ObjectIterator<Reference2DoubleMap.Entry<K>>() {
            ...
            public Reference2DoubleMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleArrayMap.this.key[this.curr = this.next], Reference2DoubleArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2DoubleArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2DoubleArrayMap.this.key, this.next + 1, Reference2DoubleArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2DoubleArrayMap.this.value, this.next + 1, Reference2DoubleArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2DoubleMap.Entry<K>>() {
            ...
            public Reference2DoubleMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2DoubleArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               return Reference2DoubleArrayMap.this.containsKey(var3) && Double.doubleToLongBits(Reference2DoubleArrayMap.this.getDouble(var3)) == Double.doubleToLongBits((Double)var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Double) {
               ...
               int var6 = Reference2DoubleArrayMap.this.findKey(var3);
               if (var6 != -1 && Double.doubleToLongBits(var4) == Double.doubleToLongBits(Reference2DoubleArrayMap.this.value[var6])) {
                  int var7 = Reference2DoubleArrayMap.this.size - var6 - 1;
                  System.arraycopy(Reference2DoubleArrayMap.this.key, var6 + 1, Reference2DoubleArrayMap.this.key, var6, var7);
                  System.arraycopy(Reference2DoubleArrayMap.this.value, var6 + 1, Reference2DoubleArrayMap.this.value, var6, var7);
                  Reference2DoubleArrayMap.this.size--;
                  Reference2DoubleArrayMap.this.key[Reference2DoubleArrayMap.this.size] = null;
                  return true;
               } else {
