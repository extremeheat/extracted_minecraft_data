...
public class ObjectBigArrayBigList<K> extends AbstractObjectBigList<K> implements RandomAccess, Cloneable, Serializable {
   ...
   protected ObjectBigArrayBigList(K[][] var1, boolean var2) {
      super();
      this.a = var1;
      this.wrapped = true;
   }

   public ObjectBigArrayBigList(long var1) {
      super();
      if (var1 < 0L) {
   ...
   public ObjectBigArrayBigList(ObjectCollection<? extends K> var1) {
      this((long)var1.size());
   ...
   public ObjectBigArrayBigList(ObjectBigList<? extends K> var1) {
      this(var1.size64());
      var1.getElements(0L, this.a, 0L, this.size = var1.size64());
   }

   public ObjectBigArrayBigList(K[][] var1) {
      this(var1, 0L, ObjectBigArrays.length(var1));
   }

   public ObjectBigArrayBigList(K[][] var1, long var2, long var4) {
      this(var4);
      ObjectBigArrays.copy(var1, var2, this.a, 0L, var4);
      this.size = var4;
   }

   public ObjectBigArrayBigList(Iterator<? extends K> var1) {
      this();
   ...
   public ObjectBigArrayBigList(ObjectIterator<? extends K> var1) {
      this();
   ...
   public static <K> ObjectBigArrayBigList<K> wrap(K[][] var0, long var1) {
      if (var1 > ObjectBigArrays.length(var0)) {
         ...
         ObjectBigArrayBigList var3 = new ObjectBigArrayBigList(var0, false);
         var3.size = var1;
         return var3;
      }
   }

   public static <K> ObjectBigArrayBigList<K> wrap(K[][] var0) {
   ...
   public long indexOf(Object var1) {
      for(long var2 = 0L; var2 < this.size; ++var2) {
         if (Objects.equals(var1, ObjectBigArrays.get(this.a, var2))) {
            return var2;
         }
      }
   ...
   public long lastIndexOf(Object var1) {
      ...
      } while(!Objects.equals(var1, ObjectBigArrays.get(this.a, var2)));
      ...
      return new ObjectBigListIterator<K>() {
         ...
         public K next() {
            if (!this.hasNext()) {
               ...
               return ObjectBigArrays.get(ObjectBigArrayBigList.this.a, this.last = (long)(this.pos++));
            }
         }
         ...
         public K previous() {
            if (!this.hasPrevious()) {
               ...
               return ObjectBigArrays.get(ObjectBigArrayBigList.this.a, this.last = --this.pos);
            }
         }
         ...
         public void add(K var1x) {
            ObjectBigArrayBigList.this.add((long)(this.pos++), var1x);
            this.last = -1L;
         }
         ...
         public void set(K var1x) {
            if (this.last == -1L) {
               ...
               ObjectBigArrayBigList.this.set(this.last, var1x);
            }
         }
   ...
   public ObjectBigArrayBigList<K> clone() {
      ObjectBigArrayBigList var1 = new ObjectBigArrayBigList(this.size);
      ObjectBigArrays.copy(this.a, 0L, var1.a, 0L, this.size);
      var1.size = this.size;
      return var1;
   }

   private boolean valEquals(K var1, K var2) {
      return var1 == null ? var2 == null : var1.equals(var2);
   }

   public boolean equals(ObjectBigArrayBigList<K> var1) {
      if (var1 == this) {
         return true;
      } else {
         ...
         if (var2 != var1.size64()) {
            ...
            } while(this.valEquals(ObjectBigArrays.get(var4, var2), ObjectBigArrays.get(var5, var2)));
   ...
   public int compareTo(ObjectBigArrayBigList<? extends K> var1) {
      long var2 = this.size64();
      ...
      for(var11 = 0; (long)var11 < var2 && (long)var11 < var4; ++var11) {
         Object var8 = ObjectBigArrays.get(var6, (long)var11);
         Object var9 = ObjectBigArrays.get(var7, (long)var11);
         int var10;
         if ((var10 = ((Comparable)var8).compareTo(var9)) != 0) {
            return var10;
         }
      }
