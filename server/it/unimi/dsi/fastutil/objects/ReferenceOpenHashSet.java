...
public class ReferenceOpenHashSet<K> extends AbstractReferenceSet<K> implements Serializable, Cloneable, Hash {
   ...
   public ReferenceOpenHashSet(int var1, float var2) {
      super();
   ...
   public ReferenceOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public ReferenceOpenHashSet(Collection<? extends K> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ReferenceOpenHashSet(Collection<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ReferenceOpenHashSet(ReferenceCollection<? extends K> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ReferenceOpenHashSet(ReferenceCollection<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ReferenceOpenHashSet(Iterator<? extends K> var1, float var2) {
      this(16, var2);
   ...
   public ReferenceOpenHashSet(Iterator<? extends K> var1) {
      this(var1, 0.75F);
   }

   public ReferenceOpenHashSet(K[] var1, int var2, int var3, float var4) {
   ...
   public ReferenceOpenHashSet(K[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public ReferenceOpenHashSet(K[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public ReferenceOpenHashSet(K[] var1) {
      this(var1, 0.75F);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var7 = this.realSize(); var7-- != 0; var4[var6] = var2[var5]) {
         ...
         if (var4[var6 = HashCommon.mix(System.identityHashCode(var2[var5])) & var3] != null) {
   ...
   public ReferenceOpenHashSet<K> clone() {
      ReferenceOpenHashSet var1;
      try {
         var1 = (ReferenceOpenHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var4 = this.size; var4-- != 0; var2[var5] = var3) {
         ...
         if (var3 == null) {
            var5 = this.n;
            this.containsNull = true;
         } else if (var2[var5 = HashCommon.mix(System.identityHashCode(var3)) & this.mask] != null) {
   ...
   private class SetIterator implements ObjectIterator<K> {
      ...
      public K next() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNull) {
               ...
               Object[] var1 = ReferenceOpenHashSet.this.key;
      ...
      private final void shiftKeys(int var1) {
         Object[] var5 = ReferenceOpenHashSet.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & ReferenceOpenHashSet.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(System.identityHashCode(var4)) & ReferenceOpenHashSet.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
