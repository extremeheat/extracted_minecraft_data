...
public class Reference2ObjectArrayMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable {
   ...
   public Reference2ObjectArrayMap(Object[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2ObjectArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new Object[var1];
   }

   public Reference2ObjectArrayMap(Reference2ObjectMap<K, V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ObjectArrayMap(Map<? extends K, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ObjectArrayMap(Object[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2ObjectArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2ObjectArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2ObjectArrayMap.this.key, var2 + 1, Reference2ObjectArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2ObjectArrayMap.this.value, var2 + 1, Reference2ObjectArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2ObjectArrayMap.this.key, this.pos, Reference2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2ObjectArrayMap.this.value, this.pos, Reference2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Reference2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Reference2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2ObjectArrayMap<K, V> clone() {
      Reference2ObjectArrayMap var1;
      try {
         var1 = (Reference2ObjectArrayMap)super.clone();
   ...
   private final class EntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V> {
         ...
         return new ObjectIterator<Reference2ObjectMap.Entry<K, V>>() {
            ...
            public Reference2ObjectMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectArrayMap.this.key[this.curr = this.next], Reference2ObjectArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2ObjectArrayMap.this.key, this.next + 1, Reference2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2ObjectArrayMap.this.value, this.next + 1, Reference2ObjectArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2ObjectMap.Entry<K, V>>() {
            ...
            public Reference2ObjectMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2ObjectArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            return Reference2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Reference2ObjectArrayMap.this.get(var3), var2.getValue());
         }
      }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            int var5 = Reference2ObjectArrayMap.this.findKey(var3);
            if (var5 != -1 && Objects.equals(var4, Reference2ObjectArrayMap.this.value[var5])) {
               int var6 = Reference2ObjectArrayMap.this.size - var5 - 1;
               System.arraycopy(Reference2ObjectArrayMap.this.key, var5 + 1, Reference2ObjectArrayMap.this.key, var5, var6);
               System.arraycopy(Reference2ObjectArrayMap.this.value, var5 + 1, Reference2ObjectArrayMap.this.value, var5, var6);
               Reference2ObjectArrayMap.this.size--;
               Reference2ObjectArrayMap.this.key[Reference2ObjectArrayMap.this.size] = null;
               Reference2ObjectArrayMap.this.value[Reference2ObjectArrayMap.this.size] = null;
               return true;
