...
public final class ObjectBigListIterators {
   ...
   public static <K> ObjectBigListIterator<K> singleton(K var0) {
      return new ObjectBigListIterators.SingletonBigListIterator(var0);
   }

   public static <K> ObjectBigListIterator<K> unmodifiable(ObjectBigListIterator<K> var0) {
      return new ObjectBigListIterators.UnmodifiableBigListIterator(var0);
   }

   public static <K> ObjectBigListIterator<K> asBigListIterator(ObjectListIterator<K> var0) {
      return new ObjectBigListIterators.BigListIteratorListIterator(var0);
   }
   ...
   public static class BigListIteratorListIterator<K> implements ObjectBigListIterator<K> {
      ...
      protected BigListIteratorListIterator(ObjectListIterator<K> var1) {
         super();
         this.i = var1;
      }
   ...
   public static class UnmodifiableBigListIterator<K> implements ObjectBigListIterator<K> {
      ...
      public UnmodifiableBigListIterator(ObjectBigListIterator<K> var1) {
         super();
         this.i = var1;
      }
   ...
   private static class SingletonBigListIterator<K> implements ObjectBigListIterator<K> {
      ...
      public SingletonBigListIterator(K var1) {
         super();
         this.element = var1;
      }
