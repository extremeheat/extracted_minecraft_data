...
public class Reference2ShortArrayMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable {
   ...
   public Reference2ShortArrayMap(Object[] var1, short[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2ShortArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new short[var1];
   }

   public Reference2ShortArrayMap(Reference2ShortMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ShortArrayMap(Map<? extends K, ? extends Short> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2ShortArrayMap(Object[] var1, short[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2ShortArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2ShortArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2ShortArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2ShortArrayMap.this.key, var2 + 1, Reference2ShortArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2ShortArrayMap.this.value, var2 + 1, Reference2ShortArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2ShortArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2ShortArrayMap.this.key, this.pos, Reference2ShortArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2ShortArrayMap.this.value, this.pos, Reference2ShortArrayMap.this.value, this.pos - 1, var1);
                     Reference2ShortArrayMap.this.size--;
                  }
               }
            };
   ...
   public ShortCollection values() {
      return new AbstractShortCollection() {
         public boolean contains(short var1) {
            return Reference2ShortArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2ShortArrayMap<K> clone() {
      Reference2ShortArrayMap var1;
      try {
         var1 = (Reference2ShortArrayMap)super.clone();
         ...
         return new ObjectIterator<Reference2ShortMap.Entry<K>>() {
            ...
            public Reference2ShortMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2ShortMap.BasicEntry(Reference2ShortArrayMap.this.key[this.curr = this.next], Reference2ShortArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2ShortArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2ShortArrayMap.this.key, this.next + 1, Reference2ShortArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2ShortArrayMap.this.value, this.next + 1, Reference2ShortArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2ShortMap.Entry<K>>() {
            ...
            public Reference2ShortMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2ShortArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Short) {
               ...
               return Reference2ShortArrayMap.this.containsKey(var3) && Reference2ShortArrayMap.this.getShort(var3) == (Short)var2.getValue();
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Short) {
               ...
               int var5 = Reference2ShortArrayMap.this.findKey(var3);
               if (var5 != -1 && var4 == Reference2ShortArrayMap.this.value[var5]) {
                  int var6 = Reference2ShortArrayMap.this.size - var5 - 1;
                  System.arraycopy(Reference2ShortArrayMap.this.key, var5 + 1, Reference2ShortArrayMap.this.key, var5, var6);
                  System.arraycopy(Reference2ShortArrayMap.this.value, var5 + 1, Reference2ShortArrayMap.this.value, var5, var6);
                  Reference2ShortArrayMap.this.size--;
                  Reference2ShortArrayMap.this.key[Reference2ShortArrayMap.this.size] = null;
                  return true;
               } else {
