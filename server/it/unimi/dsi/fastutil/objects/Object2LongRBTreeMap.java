...
public class Object2LongRBTreeMap<K> extends AbstractObject2LongSortedMap<K> implements Serializable, Cloneable {
   ...
   public Object2LongRBTreeMap(Comparator<? super K> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Object2LongRBTreeMap(Map<? extends K, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Object2LongRBTreeMap(SortedMap<K, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2LongRBTreeMap(Object2LongMap<? extends K> var1) {
      this();
      this.putAll(var1);
   }

   public Object2LongRBTreeMap(Object2LongSortedMap<K> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Object2LongRBTreeMap(K[] var1, long[] var2, Comparator<? super K> var3) {
      this(var3);
   ...
   public Object2LongRBTreeMap(K[] var1, long[] var2) {
   ...
   final Object2LongRBTreeMap.Entry<K> findKey(K var1) {
      Object2LongRBTreeMap.Entry var2;
      int var3;
   ...
   final Object2LongRBTreeMap.Entry<K> locateKey(K var1) {
      Object2LongRBTreeMap.Entry var2 = this.tree;
      Object2LongRBTreeMap.Entry var3 = this.tree;
   ...
   public long addTo(K var1, long var2) {
      Object2LongRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Object2LongRBTreeMap.Entry<K> add(K var1) {
      this.modified = false;
      int var2 = 0;
      Object2LongRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Object2LongRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Object2LongRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Object2LongRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Object2LongRBTreeMap.Entry var7;
               Object2LongRBTreeMap.Entry var8;
   ...
   public boolean containsValue(long var1) {
      Object2LongRBTreeMap.ValueIterator var3 = new Object2LongRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long getLong(Object var1) {
      Object2LongRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
            final Comparator<? super Object2LongMap.Entry<K>> comparator = (var1x, var2) -> {
               return Object2LongRBTreeMap.this.actualComparator.compare(var1x.getKey(), var2.getKey());
            };
            ...
            public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> var1) {
               return Object2LongRBTreeMap.this.new EntryIterator(var1.getKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Long) {
                     Object2LongRBTreeMap.Entry var3 = Object2LongRBTreeMap.this.findKey(var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getValue() != null && var2.getValue() instanceof Long) {
                     ...
                     if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                        Object2LongRBTreeMap.this.removeLong(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> var1, Object2LongMap.Entry<K> var2) {
               return Object2LongRBTreeMap.this.subMap(var1.getKey(), var2.getKey()).object2LongEntrySet();
            }

            public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> var1) {
               return Object2LongRBTreeMap.this.headMap(var1.getKey()).object2LongEntrySet();
            }

            public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> var1) {
               return Object2LongRBTreeMap.this.tailMap(var1.getKey()).object2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Object2LongRBTreeMap.this.containsValue(var1);
            }
   ...
   public Object2LongSortedMap<K> headMap(K var1) {
      return new Object2LongRBTreeMap.Submap((Object)null, true, var1, false);
   }

   public Object2LongSortedMap<K> tailMap(K var1) {
      return new Object2LongRBTreeMap.Submap(var1, false, (Object)null, true);
   }

   public Object2LongSortedMap<K> subMap(K var1, K var2) {
      return new Object2LongRBTreeMap.Submap(var1, false, var2, false);
   }

   public Object2LongRBTreeMap<K> clone() {
      Object2LongRBTreeMap var1;
      try {
         var1 = (Object2LongRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Object2LongRBTreeMap.Entry var5 = new Object2LongRBTreeMap.Entry();
         Object2LongRBTreeMap.Entry var6 = new Object2LongRBTreeMap.Entry();
         Object2LongRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Object2LongRBTreeMap.Entry var4 = var6;
         var6.pred((Object2LongRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Object2LongRBTreeMap.EntryIterator var3 = new Object2LongRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Object2LongRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Object2LongRBTreeMap.Entry<K> readTree(ObjectInputStream var1, int var2, Object2LongRBTreeMap.Entry<K> var3, Object2LongRBTreeMap.Entry<K> var4) throws IOException, ClassNotFoundException {
      Object2LongRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Object2LongRBTreeMap.Entry(var1.readObject(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Object2LongRBTreeMap.Entry(var1.readObject(), var1.readLong());
         var8.black(true);
         var8.right(new Object2LongRBTreeMap.Entry(var1.readObject(), var1.readLong()));
         ...
         Object2LongRBTreeMap.Entry var7 = new Object2LongRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Object2LongRBTreeMap.Entry)null, (Object2LongRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractObject2LongSortedMap<K> implements Serializable {
      ...
      public Submap(K var2, boolean var3, K var4, boolean var5) {
         super();
         if (!var3 && !var5 && Object2LongRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Object2LongRBTreeMap.Submap.SubmapIterator var1 = new Object2LongRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(K var1) {
         return (this.bottom || Object2LongRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Object2LongRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(Object var1) {
         return this.in(var1) && Object2LongRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Object2LongRBTreeMap.Submap.SubmapIterator var3 = new Object2LongRBTreeMap.Submap.SubmapIterator();
      ...
      public long getLong(Object var1) {
         Object2LongRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Object2LongRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public long put(K var1, long var2) {
         ...
         if (!this.in(var1)) {
            ...
            long var4 = Object2LongRBTreeMap.this.put(var1, var2);
            return Object2LongRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public long removeLong(Object var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var2 = Object2LongRBTreeMap.this.removeLong(var1);
            return Object2LongRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Object2LongSortedMap<K> headMap(K var1) {
         if (this.top) {
            return Object2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Object2LongRBTreeMap.this.compare(var1, this.to) < 0 ? Object2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Object2LongSortedMap<K> tailMap(K var1) {
         if (this.bottom) {
            return Object2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Object2LongRBTreeMap.this.compare(var1, this.from) > 0 ? Object2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Object2LongSortedMap<K> subMap(K var1, K var2) {
         if (this.top && this.bottom) {
            return Object2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Object2LongRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Object2LongRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Object2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Object2LongRBTreeMap.Entry<K> firstEntry() {
         if (Object2LongRBTreeMap.this.tree == null) {
            ...
            Object2LongRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Object2LongRBTreeMap.this.firstEntry;
            } else {
               var1 = Object2LongRBTreeMap.this.locateKey(this.from);
               if (Object2LongRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Object2LongRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Object2LongRBTreeMap.Entry<K> lastEntry() {
         if (Object2LongRBTreeMap.this.tree == null) {
            ...
            Object2LongRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Object2LongRBTreeMap.this.lastEntry;
            } else {
               var1 = Object2LongRBTreeMap.this.locateKey(this.to);
               if (Object2LongRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Object2LongRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public K firstKey() {
         Object2LongRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public K lastKey() {
         Object2LongRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Object2LongRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2LongMap.Entry<K>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Object2LongRBTreeMap<K>.TreeIterator {
         ...
         SubmapIterator(K var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Object2LongRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Object2LongRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Object2LongRBTreeMap.this.locateKey(var2);
                  if (Object2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractObject2LongSortedMap<K>.KeySet {
      ...
      public ObjectBidirectionalIterator<K> iterator(K var1) {
         return Object2LongRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Object2LongRBTreeMap<K>.TreeIterator implements ObjectListIterator<Object2LongMap.Entry<K>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(K var2) {
         super();
         if ((this.next = Object2LongRBTreeMap.this.locateKey(var2)) != null) {
            if (Object2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<K> extends AbstractObject2LongMap.BasicEntry<K> implements Cloneable {
      ...
      void pred(Object2LongRBTreeMap.Entry<K> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Object2LongRBTreeMap.Entry<K> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Object2LongRBTreeMap.Entry<K> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Object2LongRBTreeMap.Entry<K> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Object2LongRBTreeMap.Entry<K> next() {
         Object2LongRBTreeMap.Entry var1 = this.right;
      ...
      Object2LongRBTreeMap.Entry<K> prev() {
         Object2LongRBTreeMap.Entry var1 = this.left;
      ...
      public Object2LongRBTreeMap.Entry<K> clone() {
         Object2LongRBTreeMap.Entry var1;
         try {
            var1 = (Object2LongRBTreeMap.Entry)super.clone();
