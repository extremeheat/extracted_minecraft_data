...
public class Object2ReferenceOpenHashMap<K, V> extends AbstractObject2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
   ...
   public Object2ReferenceOpenHashMap(int var1, float var2) {
      super();
   ...
   public Object2ReferenceOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Object2ReferenceOpenHashMap(Map<? extends K, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2ReferenceOpenHashMap(Map<? extends K, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Object2ReferenceOpenHashMap(Object2ReferenceMap<K, V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Object2ReferenceOpenHashMap(Object2ReferenceMap<K, V> var1) {
      this(var1, 0.75F);
   }

   public Object2ReferenceOpenHashMap(K[] var1, V[] var2, float var3) {
   ...
   public Object2ReferenceOpenHashMap(K[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Object2ReferenceOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Object2ReferenceOpenHashMap.this.containsNullKey) {
                  var1.accept(Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n]);
               }

               int var2 = Object2ReferenceOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Object2ReferenceOpenHashMap.this.key[var2] != null) {
                     var1.accept(Object2ReferenceOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Object2ReferenceOpenHashMap<K, V> clone() {
      Object2ReferenceOpenHashMap var1;
      try {
         var1 = (Object2ReferenceOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      Object[] var2 = this.key;
      Object[] var3 = this.value;
      Object2ReferenceOpenHashMap.MapIterator var4 = new Object2ReferenceOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public void forEach(Consumer<? super K> var1) {
         if (Object2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(Object2ReferenceOpenHashMap.this.key[Object2ReferenceOpenHashMap.this.n]);
         }

         int var2 = Object2ReferenceOpenHashMap.this.n;

         while(var2-- != 0) {
            Object var3 = Object2ReferenceOpenHashMap.this.key[var2];
            if (var3 != null) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(Object var1) {
         return Object2ReferenceOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(Object var1) {
         int var2 = Object2ReferenceOpenHashMap.this.size;
         Object2ReferenceOpenHashMap.this.remove(var1);
         return Object2ReferenceOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceMap.FastEntrySet<K, V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var3 == null) {
               return Object2ReferenceOpenHashMap.this.containsNullKey && Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n] == var4;
            } else {
               Object[] var6 = Object2ReferenceOpenHashMap.this.key;
               Object var5;
               int var7;
               if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2ReferenceOpenHashMap.this.mask]) == null) {
                  return false;
               } else if (var3.equals(var5)) {
                  return Object2ReferenceOpenHashMap.this.value[var7] == var4;
               } else {
                  while((var5 = var6[var7 = var7 + 1 & Object2ReferenceOpenHashMap.this.mask]) != null) {
                     if (var3.equals(var5)) {
                        return Object2ReferenceOpenHashMap.this.value[var7] == var4;
                     }
                  }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Object var4 = var2.getValue();
            if (var3 == null) {
               if (Object2ReferenceOpenHashMap.this.containsNullKey && Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n] == var4) {
               ...
               if ((var5 = var6[var7 = HashCommon.mix(var3.hashCode()) & Object2ReferenceOpenHashMap.this.mask]) == null) {
                  ...
                  if (Object2ReferenceOpenHashMap.this.value[var7] == var4) {
                     Object2ReferenceOpenHashMap.this.removeEntry(var7);
                     return true;
                  } else {
                     return false;
                  }
                  ...
                  do {
                     if ((var5 = var6[var7 = var7 + 1 & Object2ReferenceOpenHashMap.this.mask]) == null) {
                        return false;
                     }
                  } while(!var5.equals(var3) || Object2ReferenceOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> var1) {
         if (Object2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractObject2ReferenceMap.BasicEntry(Object2ReferenceOpenHashMap.this.key[Object2ReferenceOpenHashMap.this.n], Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Object2ReferenceOpenHashMap.this.key[var2] != null) {
               var1.accept(new AbstractObject2ReferenceMap.BasicEntry(Object2ReferenceOpenHashMap.this.key[var2], Object2ReferenceOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> var1) {
         ...
         if (Object2ReferenceOpenHashMap.this.containsNullKey) {
            var2.key = Object2ReferenceOpenHashMap.this.key[Object2ReferenceOpenHashMap.this.n];
            var2.value = Object2ReferenceOpenHashMap.this.value[Object2ReferenceOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Object2ReferenceOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Object2ReferenceOpenHashMap.this.key[var3] != null) {
               var2.key = Object2ReferenceOpenHashMap.this.key[var3];
               var2.value = Object2ReferenceOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Object2ReferenceOpenHashMap<K, V>.MapIterator implements ObjectIterator<Object2ReferenceMap.Entry<K, V>> {
      ...
      private FastEntryIterator() {
         super(null);
         this.entry = Object2ReferenceOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Object2ReferenceOpenHashMap<K, V>.MapIterator implements ObjectIterator<Object2ReferenceMap.Entry<K, V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               Object[] var1 = Object2ReferenceOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2.hashCode()) & Object2ReferenceOpenHashMap.this.mask; !var2.equals(var1[var3]); var3 = var3 + 1 & Object2ReferenceOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         Object[] var5 = Object2ReferenceOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Object2ReferenceOpenHashMap.this.mask;

            Object var4;
            while(true) {
               if ((var4 = var5[var1]) == null) {
                  var5[var2] = null;
                  Object2ReferenceOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4.hashCode()) & Object2ReferenceOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Object2ReferenceOpenHashMap.this.value[var2] = Object2ReferenceOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Object2ReferenceMap.Entry<K, V>, java.util.Map.Entry<K, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Object2ReferenceOpenHashMap.this.value[this.index];
         Object2ReferenceOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Objects.equals(Object2ReferenceOpenHashMap.this.key[this.index], var2.getKey()) && Object2ReferenceOpenHashMap.this.value[this.index] == var2.getValue();
         }
      }
