...
public class Reference2FloatArrayMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable {
   ...
   public Reference2FloatArrayMap(Object[] var1, float[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Reference2FloatArrayMap(int var1) {
      super();
      this.key = new Object[var1];
      this.value = new float[var1];
   }

   public Reference2FloatArrayMap(Reference2FloatMap<K> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2FloatArrayMap(Map<? extends K, ? extends Float> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Reference2FloatArrayMap(Object[] var1, float[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Reference2FloatMap.FastEntrySet<K> reference2FloatEntrySet() {
      return new Reference2FloatArrayMap.EntrySet();
   }
   ...
   public ReferenceSet<K> keySet() {
      return new AbstractReferenceSet<K>() {
         public boolean contains(Object var1) {
            return Reference2FloatArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(Object var1) {
            int var2 = Reference2FloatArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Reference2FloatArrayMap.this.size - var2 - 1;
               System.arraycopy(Reference2FloatArrayMap.this.key, var2 + 1, Reference2FloatArrayMap.this.key, var2, var3);
               System.arraycopy(Reference2FloatArrayMap.this.value, var2 + 1, Reference2FloatArrayMap.this.value, var2, var3);
            ...
            return new ObjectIterator<K>() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Reference2FloatArrayMap.this.size - this.pos;
                     System.arraycopy(Reference2FloatArrayMap.this.key, this.pos, Reference2FloatArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Reference2FloatArrayMap.this.value, this.pos, Reference2FloatArrayMap.this.value, this.pos - 1, var1);
                     Reference2FloatArrayMap.this.size--;
                  }
               }
            };
   ...
   public FloatCollection values() {
      return new AbstractFloatCollection() {
         public boolean contains(float var1) {
            return Reference2FloatArrayMap.this.containsValue(var1);
         }
   ...
   public Reference2FloatArrayMap<K> clone() {
      Reference2FloatArrayMap var1;
      try {
         var1 = (Reference2FloatArrayMap)super.clone();
         ...
         return new ObjectIterator<Reference2FloatMap.Entry<K>>() {
            ...
            public Reference2FloatMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2FloatMap.BasicEntry(Reference2FloatArrayMap.this.key[this.curr = this.next], Reference2FloatArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Reference2FloatArrayMap.this.size-- - this.next--;
                  System.arraycopy(Reference2FloatArrayMap.this.key, this.next + 1, Reference2FloatArrayMap.this.key, this.next, var1);
                  System.arraycopy(Reference2FloatArrayMap.this.value, this.next + 1, Reference2FloatArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Reference2FloatMap.Entry<K>>() {
            ...
            public Reference2FloatMap.Entry<K> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Reference2FloatArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Float) {
               ...
               return Reference2FloatArrayMap.this.containsKey(var3) && Float.floatToIntBits(Reference2FloatArrayMap.this.getFloat(var3)) == Float.floatToIntBits((Float)var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getValue() != null && var2.getValue() instanceof Float) {
               ...
               int var5 = Reference2FloatArrayMap.this.findKey(var3);
               if (var5 != -1 && Float.floatToIntBits(var4) == Float.floatToIntBits(Reference2FloatArrayMap.this.value[var5])) {
                  int var6 = Reference2FloatArrayMap.this.size - var5 - 1;
                  System.arraycopy(Reference2FloatArrayMap.this.key, var5 + 1, Reference2FloatArrayMap.this.key, var5, var6);
                  System.arraycopy(Reference2FloatArrayMap.this.value, var5 + 1, Reference2FloatArrayMap.this.value, var5, var6);
                  Reference2FloatArrayMap.this.size--;
                  Reference2FloatArrayMap.this.key[Reference2FloatArrayMap.this.size] = null;
                  return true;
               } else {
