...
public class Int2ShortOpenCustomHashMap extends AbstractInt2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Int2ShortOpenCustomHashMap(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Int2ShortOpenCustomHashMap(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2ShortOpenCustomHashMap(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Int2ShortOpenCustomHashMap(Map<? extends Integer, ? extends Short> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2ShortOpenCustomHashMap(Map<? extends Integer, ? extends Short> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2ShortOpenCustomHashMap(Int2ShortMap var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2ShortOpenCustomHashMap(Int2ShortMap var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2ShortOpenCustomHashMap(int[] var1, short[] var2, float var3, IntHash.Strategy var4) {
   ...
   public Int2ShortOpenCustomHashMap(int[] var1, short[] var2, IntHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Int2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.IntConsumer var1) {
               if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Int2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2ShortOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Int2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2ShortOpenCustomHashMap clone() {
      Int2ShortOpenCustomHashMap var1;
      try {
         var1 = (Int2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      short[] var3 = this.value;
      Int2ShortOpenCustomHashMap.MapIterator var4 = new Int2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Int2ShortOpenCustomHashMap.this.key[Int2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Int2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2ShortOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2ShortOpenCustomHashMap.this.size;
         Int2ShortOpenCustomHashMap.this.remove(var1);
         return Int2ShortOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements Int2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Int2ShortOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     return Int2ShortOpenCustomHashMap.this.containsNullKey && Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2ShortOpenCustomHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Int2ShortOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2ShortOpenCustomHashMap.this.mask]) != 0) {
                           if (Int2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Int2ShortOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (Int2ShortOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     if (Int2ShortOpenCustomHashMap.this.containsNullKey && Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2ShortOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Int2ShortOpenCustomHashMap.this.value[var7] == var4) {
                           Int2ShortOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2ShortOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Int2ShortOpenCustomHashMap.this.strategy.equals(var5, var3) || Int2ShortOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2ShortMap.Entry> var1) {
         if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortOpenCustomHashMap.this.key[Int2ShortOpenCustomHashMap.this.n], Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2ShortOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortOpenCustomHashMap.this.key[var2], Int2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2ShortMap.Entry> var1) {
         ...
         if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Int2ShortOpenCustomHashMap.this.key[Int2ShortOpenCustomHashMap.this.n];
            var2.value = Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Int2ShortOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Int2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Int2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Int2ShortMap.Entry> {
      private final Int2ShortOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Int2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2ShortOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Int2ShortOpenCustomHashMap.this.mask; !Int2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Int2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Int2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2ShortOpenCustomHashMap.this.value[var2] = Int2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2ShortMap.Entry, java.util.Map.Entry<Integer, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Int2ShortOpenCustomHashMap.this.value[this.index];
         Int2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2ShortOpenCustomHashMap.this.strategy.equals(Int2ShortOpenCustomHashMap.this.key[this.index], (Integer)var2.getKey()) && Int2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
