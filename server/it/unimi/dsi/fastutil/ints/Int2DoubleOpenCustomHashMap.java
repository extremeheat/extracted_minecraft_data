...
public class Int2DoubleOpenCustomHashMap extends AbstractInt2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Int2DoubleOpenCustomHashMap(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Int2DoubleOpenCustomHashMap(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2DoubleOpenCustomHashMap(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2DoubleOpenCustomHashMap(Int2DoubleMap var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2DoubleOpenCustomHashMap(Int2DoubleMap var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2DoubleOpenCustomHashMap(int[] var1, double[] var2, float var3, IntHash.Strategy var4) {
   ...
   public Int2DoubleOpenCustomHashMap(int[] var1, double[] var2, IntHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Int2DoubleOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]);
               }

               int var2 = Int2DoubleOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2DoubleOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Int2DoubleOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2DoubleOpenCustomHashMap clone() {
      Int2DoubleOpenCustomHashMap var1;
      try {
         var1 = (Int2DoubleOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      double[] var3 = this.value;
      Int2DoubleOpenCustomHashMap.MapIterator var4 = new Int2DoubleOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Int2DoubleOpenCustomHashMap.this.key[Int2DoubleOpenCustomHashMap.this.n]);
         }

         int var2 = Int2DoubleOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2DoubleOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2DoubleOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2DoubleOpenCustomHashMap.this.size;
         Int2DoubleOpenCustomHashMap.this.remove(var1);
         return Int2DoubleOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry> implements Int2DoubleMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (Int2DoubleOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     return Int2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4);
                  } else {
                     int[] var7 = Int2DoubleOpenCustomHashMap.this.key;
                     int var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2DoubleOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Int2DoubleOpenCustomHashMap.this.mask]) != 0) {
                           if (Int2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var4 = (Double)var2.getValue();
                  if (Int2DoubleOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     if (Int2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2DoubleOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                           Int2DoubleOpenCustomHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Int2DoubleOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Int2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3) || Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Int2DoubleMap.Entry> var1) {
         if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2DoubleMap.BasicEntry(Int2DoubleOpenCustomHashMap.this.key[Int2DoubleOpenCustomHashMap.this.n], Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2DoubleOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2DoubleMap.BasicEntry(Int2DoubleOpenCustomHashMap.this.key[var2], Int2DoubleOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2DoubleMap.Entry> var1) {
         ...
         if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
            var2.key = Int2DoubleOpenCustomHashMap.this.key[Int2DoubleOpenCustomHashMap.this.n];
            var2.value = Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2DoubleOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Int2DoubleOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Int2DoubleOpenCustomHashMap.this.key[var3];
               var2.value = Int2DoubleOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<Int2DoubleMap.Entry> {
      private final Int2DoubleOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2DoubleOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<Int2DoubleMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2DoubleOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(var2)) & Int2DoubleOpenCustomHashMap.this.mask; !Int2DoubleOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Int2DoubleOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2DoubleOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2DoubleOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(var4)) & Int2DoubleOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2DoubleOpenCustomHashMap.this.value[var2] = Int2DoubleOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2DoubleMap.Entry, java.util.Map.Entry<Integer, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Int2DoubleOpenCustomHashMap.this.value[this.index];
         Int2DoubleOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[this.index], (Integer)var2.getKey()) && Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
