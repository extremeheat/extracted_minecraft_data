...
public class Int2FloatRBTreeMap extends AbstractInt2FloatSortedMap implements Serializable, Cloneable {
   ...
   public Int2FloatRBTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2FloatRBTreeMap(Map<? extends Integer, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Int2FloatRBTreeMap(SortedMap<Integer, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2FloatRBTreeMap(Int2FloatMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2FloatRBTreeMap(Int2FloatSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2FloatRBTreeMap(int[] var1, float[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2FloatRBTreeMap(int[] var1, float[] var2) {
   ...
   final Int2FloatRBTreeMap.Entry findKey(int var1) {
      Int2FloatRBTreeMap.Entry var2;
      int var3;
   ...
   final Int2FloatRBTreeMap.Entry locateKey(int var1) {
      Int2FloatRBTreeMap.Entry var2 = this.tree;
      Int2FloatRBTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(int var1, float var2) {
      Int2FloatRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Int2FloatRBTreeMap.Entry add(int var1) {
      this.modified = false;
      int var2 = 0;
      Int2FloatRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Int2FloatRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Int2FloatRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Int2FloatRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Int2FloatRBTreeMap.Entry var7;
               Int2FloatRBTreeMap.Entry var8;
   ...
   public boolean containsValue(float var1) {
      Int2FloatRBTreeMap.ValueIterator var2 = new Int2FloatRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float get(int var1) {
      Int2FloatRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() {
            final Comparator<? super Int2FloatMap.Entry> comparator = (var1x, var2) -> {
               return Int2FloatRBTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry var1) {
               return Int2FloatRBTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        Int2FloatRBTreeMap.Entry var3 = Int2FloatRBTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                           Int2FloatRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry var1, Int2FloatMap.Entry var2) {
               return Int2FloatRBTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2FloatEntrySet();
            }

            public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry var1) {
               return Int2FloatRBTreeMap.this.headMap(var1.getIntKey()).int2FloatEntrySet();
            }

            public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry var1) {
               return Int2FloatRBTreeMap.this.tailMap(var1.getIntKey()).int2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Int2FloatRBTreeMap.this.containsValue(var1);
            }
   ...
   public Int2FloatSortedMap headMap(int var1) {
      return new Int2FloatRBTreeMap.Submap(0, true, var1, false);
   }

   public Int2FloatSortedMap tailMap(int var1) {
      return new Int2FloatRBTreeMap.Submap(var1, false, 0, true);
   }

   public Int2FloatSortedMap subMap(int var1, int var2) {
      return new Int2FloatRBTreeMap.Submap(var1, false, var2, false);
   }

   public Int2FloatRBTreeMap clone() {
      Int2FloatRBTreeMap var1;
      try {
         var1 = (Int2FloatRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2FloatRBTreeMap.Entry var5 = new Int2FloatRBTreeMap.Entry();
         Int2FloatRBTreeMap.Entry var6 = new Int2FloatRBTreeMap.Entry();
         Int2FloatRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2FloatRBTreeMap.Entry var4 = var6;
         var6.pred((Int2FloatRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2FloatRBTreeMap.EntryIterator var3 = new Int2FloatRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2FloatRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2FloatRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2FloatRBTreeMap.Entry var3, Int2FloatRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2FloatRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2FloatRBTreeMap.Entry(var1.readInt(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Int2FloatRBTreeMap.Entry(var1.readInt(), var1.readFloat());
         var8.black(true);
         var8.right(new Int2FloatRBTreeMap.Entry(var1.readInt(), var1.readFloat()));
         ...
         Int2FloatRBTreeMap.Entry var7 = new Int2FloatRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2FloatRBTreeMap.Entry)null, (Int2FloatRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2FloatSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2FloatRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2FloatRBTreeMap.Submap.SubmapIterator var1 = new Int2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2FloatRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2FloatRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2FloatRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Int2FloatRBTreeMap.Submap.SubmapIterator var2 = new Int2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      public float get(int var1) {
         Int2FloatRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2FloatRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(int var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Int2FloatRBTreeMap.this.put(var1, var2);
            return Int2FloatRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Int2FloatRBTreeMap.this.remove(var1);
            return Int2FloatRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2FloatSortedMap headMap(int var1) {
         if (this.top) {
            return Int2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2FloatRBTreeMap.this.compare(var1, this.to) < 0 ? Int2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2FloatSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? Int2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2FloatSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2FloatRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2FloatRBTreeMap.Entry firstEntry() {
         if (Int2FloatRBTreeMap.this.tree == null) {
            ...
            Int2FloatRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2FloatRBTreeMap.this.firstEntry;
            } else {
               var1 = Int2FloatRBTreeMap.this.locateKey(this.from);
               if (Int2FloatRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2FloatRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2FloatRBTreeMap.Entry lastEntry() {
         if (Int2FloatRBTreeMap.this.tree == null) {
            ...
            Int2FloatRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2FloatRBTreeMap.this.lastEntry;
            } else {
               var1 = Int2FloatRBTreeMap.this.locateKey(this.to);
               if (Int2FloatRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2FloatRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2FloatRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2FloatRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2FloatRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2FloatMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2FloatRBTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2FloatRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2FloatRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2FloatRBTreeMap.this.locateKey(var2);
                  if (Int2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2FloatSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2FloatRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2FloatRBTreeMap.TreeIterator implements ObjectListIterator<Int2FloatMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2FloatRBTreeMap.this.locateKey(var2)) != null) {
            if (Int2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2FloatMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2FloatRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2FloatRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2FloatRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2FloatRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2FloatRBTreeMap.Entry next() {
         Int2FloatRBTreeMap.Entry var1 = this.right;
      ...
      Int2FloatRBTreeMap.Entry prev() {
         Int2FloatRBTreeMap.Entry var1 = this.left;
      ...
      public Int2FloatRBTreeMap.Entry clone() {
         Int2FloatRBTreeMap.Entry var1;
         try {
            var1 = (Int2FloatRBTreeMap.Entry)super.clone();
