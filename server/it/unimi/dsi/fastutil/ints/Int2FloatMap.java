...
public interface Int2FloatMap extends Int2FloatFunction, Map<Integer, Float> {
   ...
   default Float put(Integer var1, Float var2) {
      return Int2FloatFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float get(Object var1) {
      return Int2FloatFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Float remove(Object var1) {
      return Int2FloatFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Int2FloatFunction.super.containsKey(var1);
   }
   ...
   default float getOrDefault(int var1, float var2) {
      float var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default float putIfAbsent(int var1, float var2) {
   ...
   default boolean remove(int var1, float var2) {
      float var3 = this.get(var1);
   ...
   default boolean replace(int var1, float var2, float var3) {
   ...
   default float replace(int var1, float var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default float computeIfAbsent(int var1, IntToDoubleFunction var2) {
   ...
   default float computeIfAbsentNullable(int var1, IntFunction<? extends Float> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default float computeIfAbsentPartial(int var1, Int2FloatFunction var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default float computeIfPresent(int var1, BiFunction<? super Integer, ? super Float, ? extends Float> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default float compute(int var1, BiFunction<? super Integer, ? super Float, ? extends Float> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
   ...
   default float merge(int var1, float var2, BiFunction<? super Float, ? super Float, ? extends Float> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Float putIfAbsent(Integer var1, Float var2) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Integer var1, Float var2, Float var3) {
      return super.replace(var1, var2, var3);
   }

   /** @deprecated */
   @Deprecated
   default Float replace(Integer var1, Float var2) {
      return (Float)super.replace(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float computeIfAbsent(Integer var1, Function<? super Integer, ? extends Float> var2) {
      return (Float)super.computeIfAbsent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float computeIfPresent(Integer var1, BiFunction<? super Integer, ? super Float, ? extends Float> var2) {
      return (Float)super.computeIfPresent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float compute(Integer var1, BiFunction<? super Integer, ? super Float, ? extends Float> var2) {
      return (Float)super.compute(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float merge(Integer var1, Float var2, BiFunction<? super Float, ? super Float, ? extends Float> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Int2FloatMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Int2FloatMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
