...
public class Int2CharOpenHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Int2CharOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2CharOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2CharOpenHashMap(Map<? extends Integer, ? extends Character> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2CharOpenHashMap(Map<? extends Integer, ? extends Character> var1) {
      this(var1, 0.75F);
   }

   public Int2CharOpenHashMap(Int2CharMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2CharOpenHashMap(Int2CharMap var1) {
      this(var1, 0.75F);
   }

   public Int2CharOpenHashMap(int[] var1, char[] var2, float var3) {
   ...
   public Int2CharOpenHashMap(int[] var1, char[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Int2CharOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.IntConsumer var1) {
               if (Int2CharOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2CharOpenHashMap.this.value[Int2CharOpenHashMap.this.n]);
               }

               int var2 = Int2CharOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2CharOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2CharOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2CharOpenHashMap clone() {
      Int2CharOpenHashMap var1;
      try {
         var1 = (Int2CharOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      char[] var3 = this.value;
      Int2CharOpenHashMap.MapIterator var4 = new Int2CharOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2CharOpenHashMap.this.containsNullKey) {
            var1.accept(Int2CharOpenHashMap.this.key[Int2CharOpenHashMap.this.n]);
         }

         int var2 = Int2CharOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2CharOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2CharOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2CharOpenHashMap.this.size;
         Int2CharOpenHashMap.this.remove(var1);
         return Int2CharOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (var3 == 0) {
                     return Int2CharOpenHashMap.this.containsNullKey && Int2CharOpenHashMap.this.value[Int2CharOpenHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2CharOpenHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2CharOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Int2CharOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2CharOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Int2CharOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (var3 == 0) {
                     if (Int2CharOpenHashMap.this.containsNullKey && Int2CharOpenHashMap.this.value[Int2CharOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2CharOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Int2CharOpenHashMap.this.value[var7] == var4) {
                           Int2CharOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2CharOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Int2CharOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2CharMap.Entry> var1) {
         if (Int2CharOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2CharMap.BasicEntry(Int2CharOpenHashMap.this.key[Int2CharOpenHashMap.this.n], Int2CharOpenHashMap.this.value[Int2CharOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2CharOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2CharMap.BasicEntry(Int2CharOpenHashMap.this.key[var2], Int2CharOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2CharMap.Entry> var1) {
         ...
         if (Int2CharOpenHashMap.this.containsNullKey) {
            var2.key = Int2CharOpenHashMap.this.key[Int2CharOpenHashMap.this.n];
            var2.value = Int2CharOpenHashMap.this.value[Int2CharOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2CharOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2CharOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2CharOpenHashMap.this.key[var3];
               var2.value = Int2CharOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2CharOpenHashMap.MapIterator implements ObjectIterator<Int2CharMap.Entry> {
      private final Int2CharOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2CharOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2CharOpenHashMap.MapIterator implements ObjectIterator<Int2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2CharOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2CharOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2CharOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2CharOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2CharOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2CharOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2CharOpenHashMap.this.value[var2] = Int2CharOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2CharMap.Entry, java.util.Map.Entry<Integer, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Int2CharOpenHashMap.this.value[this.index];
         Int2CharOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2CharOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Int2CharOpenHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
