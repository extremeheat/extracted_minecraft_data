...
public class Int2LongAVLTreeMap extends AbstractInt2LongSortedMap implements Serializable, Cloneable {
   ...
   public Int2LongAVLTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2LongAVLTreeMap(Map<? extends Integer, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Int2LongAVLTreeMap(SortedMap<Integer, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2LongAVLTreeMap(Int2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2LongAVLTreeMap(Int2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2LongAVLTreeMap(int[] var1, long[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2LongAVLTreeMap(int[] var1, long[] var2) {
   ...
   final Int2LongAVLTreeMap.Entry findKey(int var1) {
      Int2LongAVLTreeMap.Entry var2;
      int var3;
   ...
   final Int2LongAVLTreeMap.Entry locateKey(int var1) {
      Int2LongAVLTreeMap.Entry var2 = this.tree;
      Int2LongAVLTreeMap.Entry var3 = this.tree;
   ...
   public long addTo(int var1, long var2) {
      Int2LongAVLTreeMap.Entry var4 = this.add(var1);
   ...
   private Int2LongAVLTreeMap.Entry add(int var1) {
      this.modified = false;
      Int2LongAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Int2LongAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Int2LongAVLTreeMap.Entry var3 = this.tree;
         Int2LongAVLTreeMap.Entry var4 = null;
         Int2LongAVLTreeMap.Entry var5 = this.tree;
         Int2LongAVLTreeMap.Entry var6 = null;
         Int2LongAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Int2LongAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Int2LongAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Int2LongAVLTreeMap.Entry parent(Int2LongAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Int2LongAVLTreeMap.Entry var3 = var1;

         Int2LongAVLTreeMap.Entry var2;
         Int2LongAVLTreeMap.Entry var4;
   ...
   public long remove(int var1) {
      ...
      if (this.tree == null) {
         ...
         Int2LongAVLTreeMap.Entry var7;
         Int2LongAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
   ...
   public boolean containsValue(long var1) {
      Int2LongAVLTreeMap.ValueIterator var3 = new Int2LongAVLTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(int var1) {
      Int2LongAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>() {
            final Comparator<? super Int2LongMap.Entry> comparator = (var1x, var2) -> {
               return Int2LongAVLTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry var1) {
               return Int2LongAVLTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Int2LongAVLTreeMap.Entry var3 = Int2LongAVLTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Int2LongAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry var1, Int2LongMap.Entry var2) {
               return Int2LongAVLTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2LongEntrySet();
            }

            public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry var1) {
               return Int2LongAVLTreeMap.this.headMap(var1.getIntKey()).int2LongEntrySet();
            }

            public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry var1) {
               return Int2LongAVLTreeMap.this.tailMap(var1.getIntKey()).int2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Int2LongAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Int2LongSortedMap headMap(int var1) {
      return new Int2LongAVLTreeMap.Submap(0, true, var1, false);
   }

   public Int2LongSortedMap tailMap(int var1) {
      return new Int2LongAVLTreeMap.Submap(var1, false, 0, true);
   }

   public Int2LongSortedMap subMap(int var1, int var2) {
      return new Int2LongAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Int2LongAVLTreeMap clone() {
      Int2LongAVLTreeMap var1;
      try {
         var1 = (Int2LongAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2LongAVLTreeMap.Entry var5 = new Int2LongAVLTreeMap.Entry();
         Int2LongAVLTreeMap.Entry var6 = new Int2LongAVLTreeMap.Entry();
         Int2LongAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2LongAVLTreeMap.Entry var4 = var6;
         var6.pred((Int2LongAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2LongAVLTreeMap.EntryIterator var3 = new Int2LongAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2LongAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2LongAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2LongAVLTreeMap.Entry var3, Int2LongAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2LongAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2LongAVLTreeMap.Entry(var1.readInt(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Int2LongAVLTreeMap.Entry(var1.readInt(), var1.readLong());
         var8.right(new Int2LongAVLTreeMap.Entry(var1.readInt(), var1.readLong()));
         ...
         Int2LongAVLTreeMap.Entry var7 = new Int2LongAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2LongAVLTreeMap.Entry)null, (Int2LongAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2LongSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2LongAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2LongAVLTreeMap.Submap.SubmapIterator var1 = new Int2LongAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2LongAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2LongAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2LongAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Int2LongAVLTreeMap.Submap.SubmapIterator var3 = new Int2LongAVLTreeMap.Submap.SubmapIterator();
      ...
      public long get(int var1) {
         Int2LongAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2LongAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public long put(int var1, long var2) {
         ...
         if (!this.in(var1)) {
            ...
            long var4 = Int2LongAVLTreeMap.this.put(var1, var2);
            return Int2LongAVLTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public long remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var2 = Int2LongAVLTreeMap.this.remove(var1);
            return Int2LongAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2LongSortedMap headMap(int var1) {
         if (this.top) {
            return Int2LongAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2LongAVLTreeMap.this.compare(var1, this.to) < 0 ? Int2LongAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2LongSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2LongAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2LongAVLTreeMap.this.compare(var1, this.from) > 0 ? Int2LongAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2LongSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2LongAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2LongAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2LongAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2LongAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2LongAVLTreeMap.Entry firstEntry() {
         if (Int2LongAVLTreeMap.this.tree == null) {
            ...
            Int2LongAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2LongAVLTreeMap.this.firstEntry;
            } else {
               var1 = Int2LongAVLTreeMap.this.locateKey(this.from);
               if (Int2LongAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2LongAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2LongAVLTreeMap.Entry lastEntry() {
         if (Int2LongAVLTreeMap.this.tree == null) {
            ...
            Int2LongAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2LongAVLTreeMap.this.lastEntry;
            } else {
               var1 = Int2LongAVLTreeMap.this.locateKey(this.to);
               if (Int2LongAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2LongAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2LongAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2LongAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2LongAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2LongAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2LongAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2LongAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2LongAVLTreeMap.this.locateKey(var2);
                  if (Int2LongAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2LongSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2LongAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2LongAVLTreeMap.TreeIterator implements ObjectListIterator<Int2LongMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Int2LongMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Int2LongMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2LongAVLTreeMap.this.locateKey(var2)) != null) {
            if (Int2LongAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2LongMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2LongAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2LongAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2LongAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2LongAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2LongAVLTreeMap.Entry next() {
         Int2LongAVLTreeMap.Entry var1 = this.right;
      ...
      Int2LongAVLTreeMap.Entry prev() {
         Int2LongAVLTreeMap.Entry var1 = this.left;
      ...
      public Int2LongAVLTreeMap.Entry clone() {
         Int2LongAVLTreeMap.Entry var1;
         try {
            var1 = (Int2LongAVLTreeMap.Entry)super.clone();
