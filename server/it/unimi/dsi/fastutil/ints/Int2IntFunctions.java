...
public final class Int2IntFunctions {
   ...
   public static Int2IntFunction singleton(int var0, int var1) {
      return new Int2IntFunctions.Singleton(var0, var1);
   }

   public static Int2IntFunction singleton(Integer var0, Integer var1) {
      return new Int2IntFunctions.Singleton(var0, var1);
   }

   public static Int2IntFunction synchronize(Int2IntFunction var0) {
      return new Int2IntFunctions.SynchronizedFunction(var0);
   }

   public static Int2IntFunction synchronize(Int2IntFunction var0, Object var1) {
      return new Int2IntFunctions.SynchronizedFunction(var0, var1);
   }

   public static Int2IntFunction unmodifiable(Int2IntFunction var0) {
      return new Int2IntFunctions.UnmodifiableFunction(var0);
   }

   public static Int2IntFunction primitive(Function<? super Integer, ? extends Integer> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Int2IntFunction) {
         return (Int2IntFunction)var0;
         ...
         return new Int2IntFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Int2IntFunction {
      ...
      protected PrimitiveFunction(Function<? super Integer, ? extends Integer> var1) {
         super();
         this.function = var1;
      }
      ...
      public Integer get(Object var1) {
         return var1 == null ? null : (Integer)this.function.apply((Integer)var1);
      }

      /** @deprecated */
      @Deprecated
      public Integer put(Integer var1, Integer var2) {
   ...
   public static class UnmodifiableFunction extends AbstractInt2IntFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Int2IntFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Int2IntFunction, Serializable {
      ...
      protected SynchronizedFunction(Int2IntFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Int2IntFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
