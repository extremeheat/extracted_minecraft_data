...
public final class IntBigArrays {
   ...
   public static int get(int[][] var0, long var1) {
      return var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void set(int[][] var0, long var1, int var3) {
      var0[BigArrays.segment(var1)][BigArrays.displacement(var1)] = var3;
   }

   public static void swap(int[][] var0, long var1, long var3) {
      int var5 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   ...
   public static void add(int[][] var0, long var1, int var3) {
      int[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] += var3;
   }

   public static void mul(int[][] var0, long var1, int var3) {
      int[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] *= var3;
   }

   public static void incr(int[][] var0, long var1) {
      int var10002 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)]++;
   }

   public static void decr(int[][] var0, long var1) {
      int var10002 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)]--;
   }

   public static long length(int[][] var0) {
      int var1 = var0.length;
      return var1 == 0 ? 0L : BigArrays.start(var1 - 1) + (long)var0[var1 - 1].length;
   }

   public static void copy(int[][] var0, long var1, int[][] var3, long var4, long var6) {
      int var8;
      int var9;
      int var10;
      int var11;
   ...
   public static void copyFromBig(int[][] var0, long var1, int[] var3, int var4, int var5) {
   ...
   public static void copyToBig(int[] var0, int var1, int[][] var2, long var3, long var5) {
   ...
   public static int[][] newBigArray(long var0) {
      if (var0 == 0L) {
         ...
         if (var4 != 0) {
            for(var5 = 0; var5 < var2 - 1; ++var5) {
               var3[var5] = new int[134217728];
            }

            var3[var2 - 1] = new int[var4];
         } else {
   ...
   public static int[][] wrap(int[] var0) {
      if (var0.length == 0) {
         return EMPTY_BIG_ARRAY;
      } else if (var0.length <= 134217728) {
         return new int[][]{var0};
      } else {
         int[][] var1 = newBigArray((long)var0.length);
   ...
   public static int[][] ensureCapacity(int[][] var0, long var1) {
      return ensureCapacity(var0, var1, length(var0));
   }

   public static int[][] forceCapacity(int[][] var0, long var1, long var3) {
      ...
      int[][] var7 = (int[][])Arrays.copyOf(var0, var6);
      int var8 = (int)(var1 & 134217727L);
      int var9;
      if (var8 != 0) {
         for(var9 = var5; var9 < var6 - 1; ++var9) {
            var7[var9] = new int[134217728];
         }

         var7[var6 - 1] = new int[var8];
      } else {
   ...
   public static int[][] trim(int[][] var0, long var1) {
      ...
      if (var1 >= var3) {
         ...
         int[][] var6 = (int[][])Arrays.copyOf(var0, var5);
         int var7 = (int)(var1 & 134217727L);
         if (var7 != 0) {
            var6[var5 - 1] = IntArrays.trim(var6[var5 - 1], var7);
         }
   ...
   public static int[][] setLength(int[][] var0, long var1) {
      long var3 = length(var0);
      if (var1 == var3) {
         return var0;
      } else {
   ...
   public static int[][] copy(int[][] var0, long var1, long var3) {
      ensureOffsetLength(var0, var1, var3);
      int[][] var5 = newBigArray(var3);
      copy(var0, var1, var5, 0L, var3);
      return var5;
   }

   public static int[][] copy(int[][] var0) {
      int[][] var1 = (int[][])var0.clone();

      for(int var2 = var1.length; var2-- != 0; var1[var2] = (int[])var0[var2].clone()) {
      }
   ...
   public static void fill(int[][] var0, long var1, long var3, int var5) {
   ...
   public static void ensureFromTo(int[][] var0, long var1, long var3) {
      BigArrays.ensureFromTo(length(var0), var1, var3);
   }

   public static void ensureOffsetLength(int[][] var0, long var1, long var3) {
      BigArrays.ensureOffsetLength(length(var0), var1, var3);
   }

   private static void vecSwap(int[][] var0, long var1, long var3, long var5) {
   ...
   private static long med3(int[][] var0, long var1, long var3, long var5, IntComparator var7) {
   ...
   private static void selectionSort(int[][] var0, long var1, long var3, IntComparator var5) {
   ...
   public static void quickSort(int[][] var0, long var1, long var3, IntComparator var5) {
      long var6 = var3 - var1;
      if (var6 < 7L) {
   ...
   private static long med3(int[][] var0, long var1, long var3, long var5) {
      int var7 = Integer.compare(get(var0, var1), get(var0, var3));
      int var8 = Integer.compare(get(var0, var1), get(var0, var5));
      int var9 = Integer.compare(get(var0, var3), get(var0, var5));
      return var7 < 0 ? (var9 < 0 ? var3 : (var8 < 0 ? var5 : var1)) : (var9 > 0 ? var3 : (var8 > 0 ? var5 : var1));
   }

   private static void selectionSort(int[][] var0, long var1, long var3) {
   ...
   public static void quickSort(int[][] var0, long var1, long var3) {
      long var5 = var3 - var1;
      if (var5 < 7L) {
         ...
         while(true) {
            int var18;
            while(var12 > var14 || (var18 = Integer.compare(get(var0, var12), var22)) > 0) {
               for(; var14 >= var12 && (var18 = Integer.compare(get(var0, var14), var22)) >= 0; --var14) {
                  if (var18 == 0) {
   ...
   public static long binarySearch(int[][] var0, long var1, long var3, int var5) {
      --var3;

      while(var1 <= var3) {
         long var7 = var1 + var3 >>> 1;
         int var6 = get(var0, var7);
         if (var6 < var5) {
            var1 = var7 + 1L;
         } else {
            if (var6 <= var5) {
   ...
   public static long binarySearch(int[][] var0, int var1) {
      return binarySearch(var0, 0L, length(var0), var1);
   }

   public static long binarySearch(int[][] var0, long var1, long var3, int var5, IntComparator var6) {
      --var3;

      while(var1 <= var3) {
         long var8 = var1 + var3 >>> 1;
         int var7 = get(var0, var8);
   ...
   public static long binarySearch(int[][] var0, int var1, IntComparator var2) {
   ...
   public static void radixSort(int[][] var0, long var1, long var3) {
      boolean var5 = true;
      boolean var6 = true;
         ...
         while(var36 > 0) {
            ...
            if (var18 < 40L) {
               ...
               for(long var29 = 0L; var29 < var41; var13[var42] = 0L) {
                  int var33 = get(var0, var29 + var16);
   ...
   private static void selectionSort(int[][] var0, int[][] var1, long var2, long var4) {
   ...
   public static void radixSort(int[][] var0, int[][] var1, long var2, long var4) {
      boolean var6 = true;
      if (length(var0) != length(var1)) {
            ...
            while(var40 > 0) {
               ...
               if (var20 < 40L) {
                  ...
                  for(long var32 = 0L; var32 < var45; var15[var46] = 0L) {
                     int var36 = get(var0, var32 + var18);
                     int var37 = get(var1, var32 + var18);
   ...
   public static int[][] shuffle(int[][] var0, long var1, long var3, Random var5) {
      long var6 = var3 - var1;

      while(var6-- != 0L) {
         long var8 = (var5.nextLong() & 9223372036854775807L) % (var6 + 1L);
         int var10 = get(var0, var1 + var6);
   ...
   private static final class BigArrayHashStrategy implements Hash.Strategy<int[][]>, Serializable {
      ...
      public boolean equals(int[][] var1, int[][] var2) {
         return IntBigArrays.equals(var1, var2);
      }
