...
public class Int2ReferenceOpenCustomHashMap<V> extends AbstractInt2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Int2ReferenceOpenCustomHashMap(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Int2ReferenceOpenCustomHashMap(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2ReferenceOpenCustomHashMap(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Int2ReferenceOpenCustomHashMap(Map<? extends Integer, ? extends V> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2ReferenceOpenCustomHashMap(Map<? extends Integer, ? extends V> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2ReferenceOpenCustomHashMap(Int2ReferenceMap<V> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2ReferenceOpenCustomHashMap(Int2ReferenceMap<V> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2ReferenceOpenCustomHashMap(int[] var1, V[] var2, float var3, IntHash.Strategy var4) {
   ...
   public Int2ReferenceOpenCustomHashMap(int[] var1, V[] var2, IntHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Int2ReferenceOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n]);
               }

               int var2 = Int2ReferenceOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2ReferenceOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Int2ReferenceOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2ReferenceOpenCustomHashMap<V> clone() {
      Int2ReferenceOpenCustomHashMap var1;
      try {
         var1 = (Int2ReferenceOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      Object[] var3 = this.value;
      Int2ReferenceOpenCustomHashMap.MapIterator var4 = new Int2ReferenceOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Int2ReferenceOpenCustomHashMap.this.key[Int2ReferenceOpenCustomHashMap.this.n]);
         }

         int var2 = Int2ReferenceOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2ReferenceOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2ReferenceOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2ReferenceOpenCustomHashMap.this.size;
         Int2ReferenceOpenCustomHashMap.this.remove(var1);
         return Int2ReferenceOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               ...
               if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                  return Int2ReferenceOpenCustomHashMap.this.containsNullKey && Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n] == var4;
               } else {
                  int[] var6 = Int2ReferenceOpenCustomHashMap.this.key;
                  int var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Int2ReferenceOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Int2ReferenceOpenCustomHashMap.this.mask]) != 0) {
                        if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Int2ReferenceOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               ...
               Object var4 = var2.getValue();
               if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                  if (Int2ReferenceOpenCustomHashMap.this.containsNullKey && Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Int2ReferenceOpenCustomHashMap.this.value[var7] == var4) {
                        Int2ReferenceOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Int2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(!Int2ReferenceOpenCustomHashMap.this.strategy.equals(var5, var3) || Int2ReferenceOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> var1) {
         if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceOpenCustomHashMap.this.key[Int2ReferenceOpenCustomHashMap.this.n], Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2ReferenceOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceOpenCustomHashMap.this.key[var2], Int2ReferenceOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> var1) {
         ...
         if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var2.key = Int2ReferenceOpenCustomHashMap.this.key[Int2ReferenceOpenCustomHashMap.this.n];
            var2.value = Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2ReferenceOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Int2ReferenceOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Int2ReferenceOpenCustomHashMap.this.key[var3];
               var2.value = Int2ReferenceOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
      private final Int2ReferenceOpenCustomHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2ReferenceOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2ReferenceOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(var2)) & Int2ReferenceOpenCustomHashMap.this.mask; !Int2ReferenceOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Int2ReferenceOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2ReferenceOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2ReferenceOpenCustomHashMap.this.mask;

            int var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Int2ReferenceOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(var4)) & Int2ReferenceOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2ReferenceOpenCustomHashMap.this.value[var2] = Int2ReferenceOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2ReferenceMap.Entry<V>, java.util.Map.Entry<Integer, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Int2ReferenceOpenCustomHashMap.this.value[this.index];
         Int2ReferenceOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], (Integer)var2.getKey()) && Int2ReferenceOpenCustomHashMap.this.value[this.index] == var2.getValue();
         }
      }
