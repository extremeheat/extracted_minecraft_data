...
public abstract class AbstractIntBigList extends AbstractIntCollection implements IntBigList, IntStack {
   ...
   public boolean addAll(long var1, Collection<? extends Integer> var3) {
      ...
      while(var4.hasNext()) {
         this.add(var1++, (Integer)var4.next());
      }
      ...
      return new IntBigListIterator() {
         ...
         public int nextInt() {
            if (!this.hasNext()) {
               ...
               return AbstractIntBigList.this.getInt(this.last = (long)(this.pos++));
            }
         }
         ...
         public void add(int var1x) {
            AbstractIntBigList.this.add((long)(this.pos++), var1x);
            this.last = -1L;
         }
         ...
         public void set(int var1x) {
            if (this.last == -1L) {
               ...
               AbstractIntBigList.this.set(this.last, var1x);
            }
         }
   ...
   public long indexOf(int var1) {
      IntBigListIterator var2 = this.listIterator();
   ...
   public long lastIndexOf(int var1) {
      IntBigListIterator var2 = this.listIterator(this.size64());
   ...
   public IntBigList subList(long var1, long var3) {
      ...
      if (var1 > var3) {
         ...
         return new AbstractIntBigList.IntSubList(this, var1, var3);
      }
   }

   public void removeElements(long var1, long var3) {
      this.ensureIndex(var3);
      IntBigListIterator var5 = this.listIterator(var1);
      long var6 = var3 - var1;
      if (var6 < 0L) {
   ...
   public int hashCode() {
      IntBigListIterator var1 = this.iterator();
      int var2 = 1;
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         if (var3 != var2.size64()) {
            ...
            IntBigListIterator var5;
            if (var2 instanceof IntBigList) {
               var5 = this.listIterator();
               IntBigListIterator var7 = ((IntBigList)var2).listIterator();

               do {
                  if (var3-- == 0L) {
                     return true;
                  }
               } while(var5.nextInt() == var7.nextInt());
   ...
   public int compareTo(BigList<? extends Integer> var1) {
      if (var1 == this) {
         ...
         IntBigListIterator var2;
         int var4;
         if (var1 instanceof IntBigList) {
            var2 = this.listIterator();
            IntBigListIterator var7 = ((IntBigList)var1).listIterator();
   ...
   public int peekInt(int var1) {
      return this.getInt(this.size64() - 1L - (long)var1);
   }
   ...
   public boolean addAll(long var1, IntBigList var3) {
      return this.addAll(var1, (IntCollection)var3);
   }
   ...
   /** @deprecated */
   @Deprecated
   public Integer peek(int var1) {
      return this.peekInt(var1);
   }

   public String toString() {
      StringBuilder var1 = new StringBuilder();
      IntBigListIterator var2 = this.iterator();
      long var3 = this.size64();
      boolean var6 = true;
      var1.append("[");
   ...
   public static class IntSubList extends AbstractIntBigList implements Serializable {
      ...
      public IntSubList(IntBigList var1, long var2, long var4) {
         super();
         this.l = var1;
         this.from = var2;
         this.to = var4;
         ...
         return new IntBigListIterator() {
            ...
            public int nextInt() {
               if (!this.hasNext()) {
                  ...
                  return IntSubList.this.l.getInt(IntSubList.this.from + (this.last = (long)(this.pos++)));
               }
            }
            ...
            public void add(int var1x) {
               if (this.last == -1L) {
                  ...
                  IntSubList.this.add((long)(this.pos++), var1x);
                  this.last = -1L;
