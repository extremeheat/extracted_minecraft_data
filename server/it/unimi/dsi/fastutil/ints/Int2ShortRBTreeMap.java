...
public class Int2ShortRBTreeMap extends AbstractInt2ShortSortedMap implements Serializable, Cloneable {
   protected transient Int2ShortRBTreeMap.Entry tree;
   protected int count;
   protected transient Int2ShortRBTreeMap.Entry firstEntry;
   protected transient Int2ShortRBTreeMap.Entry lastEntry;
   ...
   private transient Int2ShortRBTreeMap.Entry[] nodePath;
   ...
   public Int2ShortRBTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2ShortRBTreeMap(Map<? extends Integer, ? extends Short> var1) {
      this();
      this.putAll(var1);
   }

   public Int2ShortRBTreeMap(SortedMap<Integer, Short> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2ShortRBTreeMap(Int2ShortMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2ShortRBTreeMap(Int2ShortSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2ShortRBTreeMap(int[] var1, short[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2ShortRBTreeMap(int[] var1, short[] var2) {
   ...
   final Int2ShortRBTreeMap.Entry findKey(int var1) {
      Int2ShortRBTreeMap.Entry var2;
      int var3;
   ...
   final Int2ShortRBTreeMap.Entry locateKey(int var1) {
      Int2ShortRBTreeMap.Entry var2 = this.tree;
      Int2ShortRBTreeMap.Entry var3 = this.tree;
   ...
   private void allocatePaths() {
      ...
      this.nodePath = new Int2ShortRBTreeMap.Entry[64];
   }

   public short addTo(int var1, short var2) {
      Int2ShortRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Int2ShortRBTreeMap.Entry add(int var1) {
      this.modified = false;
      int var2 = 0;
      Int2ShortRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Int2ShortRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Int2ShortRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Int2ShortRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Int2ShortRBTreeMap.Entry var7;
               Int2ShortRBTreeMap.Entry var8;
   ...
   public boolean containsValue(short var1) {
      Int2ShortRBTreeMap.ValueIterator var2 = new Int2ShortRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public short get(int var1) {
      Int2ShortRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>() {
            final Comparator<? super Int2ShortMap.Entry> comparator = (var1x, var2) -> {
               return Int2ShortRBTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator() {
               return Int2ShortRBTreeMap.this.new EntryIterator();
            }

            public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry var1) {
               return Int2ShortRBTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        Int2ShortRBTreeMap.Entry var3 = Int2ShortRBTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        ...
                        if (var3 != null && var3.getShortValue() == (Short)var2.getValue()) {
                           Int2ShortRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry var1, Int2ShortMap.Entry var2) {
               return Int2ShortRBTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2ShortEntrySet();
            }

            public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry var1) {
               return Int2ShortRBTreeMap.this.headMap(var1.getIntKey()).int2ShortEntrySet();
            }

            public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry var1) {
               return Int2ShortRBTreeMap.this.tailMap(var1.getIntKey()).int2ShortEntrySet();
            }
         };
      }
   ...
   public IntSortedSet keySet() {
      if (this.keys == null) {
         this.keys = new Int2ShortRBTreeMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            public ShortIterator iterator() {
               return Int2ShortRBTreeMap.this.new ValueIterator();
            }

            public boolean contains(short var1) {
               return Int2ShortRBTreeMap.this.containsValue(var1);
            }
   ...
   public Int2ShortSortedMap headMap(int var1) {
      return new Int2ShortRBTreeMap.Submap(0, true, var1, false);
   }

   public Int2ShortSortedMap tailMap(int var1) {
      return new Int2ShortRBTreeMap.Submap(var1, false, 0, true);
   }

   public Int2ShortSortedMap subMap(int var1, int var2) {
      return new Int2ShortRBTreeMap.Submap(var1, false, var2, false);
   }

   public Int2ShortRBTreeMap clone() {
      Int2ShortRBTreeMap var1;
      try {
         var1 = (Int2ShortRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2ShortRBTreeMap.Entry var5 = new Int2ShortRBTreeMap.Entry();
         Int2ShortRBTreeMap.Entry var6 = new Int2ShortRBTreeMap.Entry();
         Int2ShortRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2ShortRBTreeMap.Entry var4 = var6;
         var6.pred((Int2ShortRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2ShortRBTreeMap.EntryIterator var3 = new Int2ShortRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2ShortRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2ShortRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2ShortRBTreeMap.Entry var3, Int2ShortRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2ShortRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2ShortRBTreeMap.Entry(var1.readInt(), var1.readShort());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Int2ShortRBTreeMap.Entry(var1.readInt(), var1.readShort());
         var8.black(true);
         var8.right(new Int2ShortRBTreeMap.Entry(var1.readInt(), var1.readShort()));
         ...
         Int2ShortRBTreeMap.Entry var7 = new Int2ShortRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2ShortRBTreeMap.Entry)null, (Int2ShortRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2ShortSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2ShortRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2ShortRBTreeMap.Submap.SubmapIterator var1 = new Int2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2ShortRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2ShortRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public IntSortedSet keySet() {
         if (this.keys == null) {
            this.keys = new Int2ShortRBTreeMap.Submap.KeySet();
         }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2ShortRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(short var1) {
         Int2ShortRBTreeMap.Submap.SubmapIterator var2 = new Int2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      public short get(int var1) {
         Int2ShortRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2ShortRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public short put(int var1, short var2) {
         ...
         if (!this.in(var1)) {
            ...
            short var3 = Int2ShortRBTreeMap.this.put(var1, var2);
            return Int2ShortRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public short remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            short var2 = Int2ShortRBTreeMap.this.remove(var1);
            return Int2ShortRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public boolean isEmpty() {
         return !(new Int2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
      }
      ...
      public Int2ShortSortedMap headMap(int var1) {
         if (this.top) {
            return Int2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2ShortRBTreeMap.this.compare(var1, this.to) < 0 ? Int2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2ShortSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? Int2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2ShortSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2ShortRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2ShortRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2ShortRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2ShortRBTreeMap.Entry firstEntry() {
         if (Int2ShortRBTreeMap.this.tree == null) {
            ...
            Int2ShortRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2ShortRBTreeMap.this.firstEntry;
            } else {
               var1 = Int2ShortRBTreeMap.this.locateKey(this.from);
               if (Int2ShortRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2ShortRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2ShortRBTreeMap.Entry lastEntry() {
         if (Int2ShortRBTreeMap.this.tree == null) {
            ...
            Int2ShortRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2ShortRBTreeMap.this.lastEntry;
            } else {
               var1 = Int2ShortRBTreeMap.this.locateKey(this.to);
               if (Int2ShortRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2ShortRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2ShortRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2ShortRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private final class SubmapValueIterator extends Int2ShortRBTreeMap.Submap.SubmapIterator implements ShortListIterator {
      ...
      private final class SubmapKeyIterator extends Int2ShortRBTreeMap.Submap.SubmapIterator implements IntListIterator {
      ...
      private class SubmapEntryIterator extends Int2ShortRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2ShortMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2ShortRBTreeMap.TreeIterator {
         SubmapIterator() {
            super();
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2ShortRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2ShortRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2ShortRBTreeMap.this.locateKey(var2);
                  if (Int2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private final class ValueIterator extends Int2ShortRBTreeMap.TreeIterator implements ShortListIterator {
   ...
   private class KeySet extends AbstractInt2ShortSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator() {
         return Int2ShortRBTreeMap.this.new KeyIterator();
      }

      public IntBidirectionalIterator iterator(int var1) {
         return Int2ShortRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private final class KeyIterator extends Int2ShortRBTreeMap.TreeIterator implements IntListIterator {
      public KeyIterator() {
         super();
      }
   ...
   private class EntryIterator extends Int2ShortRBTreeMap.TreeIterator implements ObjectListIterator<Int2ShortMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      Int2ShortRBTreeMap.Entry prev;
      Int2ShortRBTreeMap.Entry next;
      Int2ShortRBTreeMap.Entry curr;
      int index = 0;
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2ShortRBTreeMap.this.locateKey(var2)) != null) {
            if (Int2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
      ...
      Int2ShortRBTreeMap.Entry nextEntry() {
         if (!this.hasNext()) {
            throw new NoSuchElementException();
         } else {
      ...
      Int2ShortRBTreeMap.Entry previousEntry() {
         if (!this.hasPrevious()) {
            throw new NoSuchElementException();
         } else {
   ...
   private static final class Entry extends AbstractInt2ShortMap.BasicEntry implements Cloneable {
      ...
      Int2ShortRBTreeMap.Entry left;
      Int2ShortRBTreeMap.Entry right;
      int info;
      ...
      void pred(Int2ShortRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2ShortRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2ShortRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2ShortRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2ShortRBTreeMap.Entry next() {
         Int2ShortRBTreeMap.Entry var1 = this.right;
      ...
      Int2ShortRBTreeMap.Entry prev() {
         Int2ShortRBTreeMap.Entry var1 = this.left;
      ...
      public Int2ShortRBTreeMap.Entry clone() {
         Int2ShortRBTreeMap.Entry var1;
         try {
            var1 = (Int2ShortRBTreeMap.Entry)super.clone();
