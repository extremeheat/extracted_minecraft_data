...
public class Int2IntArrayMap extends AbstractInt2IntMap implements Serializable, Cloneable {
   ...
   public Int2IntArrayMap(int[] var1, int[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Int2IntArrayMap(int var1) {
      super();
      this.key = new int[var1];
      this.value = new int[var1];
   }

   public Int2IntArrayMap(Int2IntMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2IntArrayMap(Map<? extends Integer, ? extends Integer> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2IntArrayMap(int[] var1, int[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public IntSet keySet() {
      return new AbstractIntSet() {
         public boolean contains(int var1) {
            return Int2IntArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(int var1) {
            int var2 = Int2IntArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Int2IntArrayMap.this.size - var2 - 1;
               System.arraycopy(Int2IntArrayMap.this.key, var2 + 1, Int2IntArrayMap.this.key, var2, var3);
               System.arraycopy(Int2IntArrayMap.this.value, var2 + 1, Int2IntArrayMap.this.value, var2, var3);
            ...
            return new IntIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Int2IntArrayMap.this.size - this.pos;
                     System.arraycopy(Int2IntArrayMap.this.key, this.pos, Int2IntArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Int2IntArrayMap.this.value, this.pos, Int2IntArrayMap.this.value, this.pos - 1, var1);
                     Int2IntArrayMap.this.size--;
                  }
               }
            };
   ...
   public IntCollection values() {
      return new AbstractIntCollection() {
         public boolean contains(int var1) {
            return Int2IntArrayMap.this.containsValue(var1);
         }
   ...
   public Int2IntArrayMap clone() {
      Int2IntArrayMap var1;
      try {
         var1 = (Int2IntArrayMap)super.clone();
         ...
         return new ObjectIterator<Int2IntMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Int2IntArrayMap.this.size-- - this.next--;
                  System.arraycopy(Int2IntArrayMap.this.key, this.next + 1, Int2IntArrayMap.this.key, this.next, var1);
                  System.arraycopy(Int2IntArrayMap.this.value, this.next + 1, Int2IntArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  return Int2IntArrayMap.this.containsKey(var3) && Int2IntArrayMap.this.get(var3) == (Integer)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var5 = Int2IntArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Int2IntArrayMap.this.value[var5]) {
                     int var6 = Int2IntArrayMap.this.size - var5 - 1;
                     System.arraycopy(Int2IntArrayMap.this.key, var5 + 1, Int2IntArrayMap.this.key, var5, var6);
                     System.arraycopy(Int2IntArrayMap.this.value, var5 + 1, Int2IntArrayMap.this.value, var5, var6);
                     Int2IntArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
