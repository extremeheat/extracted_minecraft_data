...
public class IntHeapIndirectPriorityQueue extends IntHeapSemiIndirectPriorityQueue {
   ...
   public IntHeapIndirectPriorityQueue(int[] var1, int var2, IntComparator var3) {
   ...
   public IntHeapIndirectPriorityQueue(int[] var1, int var2) {
      this(var1, var2, (IntComparator)null);
   }

   public IntHeapIndirectPriorityQueue(int[] var1, IntComparator var2) {
      this(var1, var1.length, var2);
   }

   public IntHeapIndirectPriorityQueue(int[] var1) {
      this(var1, var1.length, (IntComparator)null);
   }

   public IntHeapIndirectPriorityQueue(int[] var1, int[] var2, int var3, IntComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      ...
      IntIndirectHeaps.makeHeap(var1, var2, this.inv, var3, var4);
   }
   ...
   public IntHeapIndirectPriorityQueue(int[] var1, int[] var2, int var3) {
   ...
   public void changed(int var1) {
      ...
      if (var2 < 0) {
         ...
         int var3 = IntIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, var2, this.c);
         IntIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, var3, this.c);
      }
   }
