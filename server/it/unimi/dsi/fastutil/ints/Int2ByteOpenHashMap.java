...
public class Int2ByteOpenHashMap extends AbstractInt2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Int2ByteOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2ByteOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2ByteOpenHashMap(Map<? extends Integer, ? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2ByteOpenHashMap(Map<? extends Integer, ? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public Int2ByteOpenHashMap(Int2ByteMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2ByteOpenHashMap(Int2ByteMap var1) {
      this(var1, 0.75F);
   }

   public Int2ByteOpenHashMap(int[] var1, byte[] var2, float var3) {
   ...
   public Int2ByteOpenHashMap(int[] var1, byte[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Int2ByteOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.IntConsumer var1) {
               if (Int2ByteOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2ByteOpenHashMap.this.value[Int2ByteOpenHashMap.this.n]);
               }

               int var2 = Int2ByteOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2ByteOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2ByteOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2ByteOpenHashMap clone() {
      Int2ByteOpenHashMap var1;
      try {
         var1 = (Int2ByteOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      byte[] var3 = this.value;
      Int2ByteOpenHashMap.MapIterator var4 = new Int2ByteOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(Int2ByteOpenHashMap.this.key[Int2ByteOpenHashMap.this.n]);
         }

         int var2 = Int2ByteOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2ByteOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2ByteOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2ByteOpenHashMap.this.size;
         Int2ByteOpenHashMap.this.remove(var1);
         return Int2ByteOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements Int2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (var3 == 0) {
                     return Int2ByteOpenHashMap.this.containsNullKey && Int2ByteOpenHashMap.this.value[Int2ByteOpenHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2ByteOpenHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2ByteOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Int2ByteOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2ByteOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Int2ByteOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var4 = (Byte)var2.getValue();
                  if (var3 == 0) {
                     if (Int2ByteOpenHashMap.this.containsNullKey && Int2ByteOpenHashMap.this.value[Int2ByteOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2ByteOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Int2ByteOpenHashMap.this.value[var7] == var4) {
                           Int2ByteOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2ByteOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Int2ByteOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2ByteMap.Entry> var1) {
         if (Int2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2ByteMap.BasicEntry(Int2ByteOpenHashMap.this.key[Int2ByteOpenHashMap.this.n], Int2ByteOpenHashMap.this.value[Int2ByteOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2ByteOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2ByteMap.BasicEntry(Int2ByteOpenHashMap.this.key[var2], Int2ByteOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2ByteMap.Entry> var1) {
         ...
         if (Int2ByteOpenHashMap.this.containsNullKey) {
            var2.key = Int2ByteOpenHashMap.this.key[Int2ByteOpenHashMap.this.n];
            var2.value = Int2ByteOpenHashMap.this.value[Int2ByteOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2ByteOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2ByteOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2ByteOpenHashMap.this.key[var3];
               var2.value = Int2ByteOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2ByteOpenHashMap.MapIterator implements ObjectIterator<Int2ByteMap.Entry> {
      private final Int2ByteOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2ByteOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2ByteOpenHashMap.MapIterator implements ObjectIterator<Int2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2ByteOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2ByteOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2ByteOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2ByteOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2ByteOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2ByteOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2ByteOpenHashMap.this.value[var2] = Int2ByteOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2ByteMap.Entry, java.util.Map.Entry<Integer, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Int2ByteOpenHashMap.this.value[this.index];
         Int2ByteOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2ByteOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Int2ByteOpenHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
