...
public class Int2IntOpenHashMap extends AbstractInt2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Int2IntOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2IntOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2IntOpenHashMap(Map<? extends Integer, ? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2IntOpenHashMap(Map<? extends Integer, ? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public Int2IntOpenHashMap(Int2IntMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2IntOpenHashMap(Int2IntMap var1) {
      this(var1, 0.75F);
   }

   public Int2IntOpenHashMap(int[] var1, int[] var2, float var3) {
   ...
   public Int2IntOpenHashMap(int[] var1, int[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Int2IntOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.IntConsumer var1) {
               if (Int2IntOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n]);
               }

               int var2 = Int2IntOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2IntOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2IntOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2IntOpenHashMap clone() {
      Int2IntOpenHashMap var1;
      try {
         var1 = (Int2IntOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      int[] var3 = this.value;
      Int2IntOpenHashMap.MapIterator var4 = new Int2IntOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2IntOpenHashMap.this.containsNullKey) {
            var1.accept(Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.n]);
         }

         int var2 = Int2IntOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2IntOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2IntOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2IntOpenHashMap.this.size;
         Int2IntOpenHashMap.this.remove(var1);
         return Int2IntOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (var3 == 0) {
                     return Int2IntOpenHashMap.this.containsNullKey && Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2IntOpenHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2IntOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Int2IntOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2IntOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Int2IntOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var4 = (Integer)var2.getValue();
                  if (var3 == 0) {
                     if (Int2IntOpenHashMap.this.containsNullKey && Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2IntOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Int2IntOpenHashMap.this.value[var7] == var4) {
                           Int2IntOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2IntOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Int2IntOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2IntMap.Entry> var1) {
         if (Int2IntOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2IntMap.BasicEntry(Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.n], Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2IntOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2IntMap.BasicEntry(Int2IntOpenHashMap.this.key[var2], Int2IntOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2IntMap.Entry> var1) {
         ...
         if (Int2IntOpenHashMap.this.containsNullKey) {
            var2.key = Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.n];
            var2.value = Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2IntOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2IntOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2IntOpenHashMap.this.key[var3];
               var2.value = Int2IntOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2IntOpenHashMap.MapIterator implements ObjectIterator<Int2IntMap.Entry> {
   ...
   private class EntryIterator extends Int2IntOpenHashMap.MapIterator implements ObjectIterator<Int2IntMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2IntOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2IntOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2IntOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2IntOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2IntOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2IntOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2IntOpenHashMap.this.value[var2] = Int2IntOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2IntMap.Entry, java.util.Map.Entry<Integer, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Int2IntOpenHashMap.this.value[this.index];
         Int2IntOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2IntOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Int2IntOpenHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
