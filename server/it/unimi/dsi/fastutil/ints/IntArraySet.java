...
public class IntArraySet extends AbstractIntSet implements Serializable, Cloneable {
   ...
   public IntArraySet(IntCollection var1) {
      this(var1.size());
      this.addAll(var1);
   }

   public IntArraySet(Collection<? extends Integer> var1) {
      this(var1.size());
      this.addAll(var1);
   }

   public IntArraySet(int[] var1, int var2) {
      super();
      this.a = var1;
      this.size = var2;
      if (var2 > var1.length) {
   ...
   public IntIterator iterator() {
      return new IntIterator() {
         ...
         public void remove() {
            int var1 = IntArraySet.this.size-- - this.next--;
            System.arraycopy(IntArraySet.this.a, this.next + 1, IntArraySet.this.a, this.next, var1);
         }
      };
   }
   ...
   public boolean add(int var1) {
      ...
      if (var2 != -1) {
         ...
         if (this.size == this.a.length) {
            int[] var3 = new int[this.size == 0 ? 2 : this.size * 2];
   ...
   public IntArraySet clone() {
      IntArraySet var1;
      try {
         var1 = (IntArraySet)super.clone();
      } catch (CloneNotSupportedException var3) {
         throw new InternalError();
      }

      var1.a = (int[])this.a.clone();
      return var1;
   }
