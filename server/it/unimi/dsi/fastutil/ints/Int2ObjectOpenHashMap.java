...
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Int2ObjectOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2ObjectOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2ObjectOpenHashMap(Map<? extends Integer, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2ObjectOpenHashMap(Map<? extends Integer, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Int2ObjectOpenHashMap(Int2ObjectMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2ObjectOpenHashMap(Int2ObjectMap<V> var1) {
      this(var1, 0.75F);
   }

   public Int2ObjectOpenHashMap(int[] var1, V[] var2, float var3) {
   ...
   public Int2ObjectOpenHashMap(int[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Int2ObjectOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Int2ObjectOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n]);
               }

               int var2 = Int2ObjectOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2ObjectOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2ObjectOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2ObjectOpenHashMap<V> clone() {
      ...
      try {
         var1 = (Int2ObjectOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      Object[] var3 = this.value;
      Int2ObjectOpenHashMap.MapIterator var4 = new Int2ObjectOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.n]);
         }

         int var2 = Int2ObjectOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2ObjectOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2ObjectOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2ObjectOpenHashMap.this.size;
         Int2ObjectOpenHashMap.this.remove(var1);
         return Int2ObjectOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               ...
               if (var3 == 0) {
                  return Int2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n], var4);
               } else {
                  int[] var6 = Int2ObjectOpenHashMap.this.key;
                  int var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2ObjectOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (var3 == var5) {
                     return Objects.equals(Int2ObjectOpenHashMap.this.value[var7], var4);
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Int2ObjectOpenHashMap.this.mask]) != 0) {
                        if (var3 == var5) {
                           return Objects.equals(Int2ObjectOpenHashMap.this.value[var7], var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               ...
               Object var4 = var2.getValue();
               if (var3 == 0) {
                  if (Int2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n], var4)) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2ObjectOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Objects.equals(Int2ObjectOpenHashMap.this.value[var7], var4)) {
                        Int2ObjectOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Int2ObjectOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(var5 != var3 || !Objects.equals(Int2ObjectOpenHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> var1) {
         if (Int2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2ObjectMap.BasicEntry(Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.n], Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2ObjectOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2ObjectMap.BasicEntry(Int2ObjectOpenHashMap.this.key[var2], Int2ObjectOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> var1) {
         ...
         if (Int2ObjectOpenHashMap.this.containsNullKey) {
            var2.key = Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.n];
            var2.value = Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2ObjectOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2ObjectOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2ObjectOpenHashMap.this.key[var3];
               var2.value = Int2ObjectOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class EntryIterator extends Int2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2ObjectOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2ObjectOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2ObjectOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2ObjectOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2ObjectOpenHashMap.this.mask;

            int var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Int2ObjectOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4) & Int2ObjectOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2ObjectOpenHashMap.this.value[var2] = Int2ObjectOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2ObjectMap.Entry<V>, java.util.Map.Entry<Integer, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Int2ObjectOpenHashMap.this.value[this.index];
         Int2ObjectOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2ObjectOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Objects.equals(Int2ObjectOpenHashMap.this.value[this.index], var2.getValue());
         }
      }
