...
public class IntLinkedOpenHashSet extends AbstractIntSortedSet implements Serializable, Cloneable, Hash {
   ...
   public IntLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public IntLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public IntLinkedOpenHashSet(Collection<? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public IntLinkedOpenHashSet(Collection<? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public IntLinkedOpenHashSet(IntCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public IntLinkedOpenHashSet(IntCollection var1) {
      this(var1, 0.75F);
   }

   public IntLinkedOpenHashSet(IntIterator var1, float var2) {
      this(16, var2);
   ...
   public IntLinkedOpenHashSet(IntIterator var1) {
      this(var1, 0.75F);
   }

   public IntLinkedOpenHashSet(Iterator<?> var1, float var2) {
      this(IntIterators.asIntIterator(var1), var2);
   }

   public IntLinkedOpenHashSet(Iterator<?> var1) {
      this(IntIterators.asIntIterator(var1));
   }

   public IntLinkedOpenHashSet(int[] var1, int var2, int var3, float var4) {
   ...
   public IntLinkedOpenHashSet(int[] var1, int var2, int var3) {
   ...
   public IntListIterator iterator(int var1) {
      return new IntLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   public IntLinkedOpenHashSet clone() {
      IntLinkedOpenHashSet var1;
      try {
         var1 = (IntLinkedOpenHashSet)super.clone();
   ...
   private class SetIterator implements IntListIterator {
      ...
      SetIterator(int var2) {
         ...
         } else if (IntLinkedOpenHashSet.this.key[IntLinkedOpenHashSet.this.last] == var2) {
            this.prev = IntLinkedOpenHashSet.this.last;
            this.index = IntLinkedOpenHashSet.this.size;
         } else {
            int[] var3 = IntLinkedOpenHashSet.this.key;

            for(int var4 = HashCommon.mix(var2) & IntLinkedOpenHashSet.this.mask; var3[var4] != 0; var4 = var4 + 1 & IntLinkedOpenHashSet.this.mask) {
               if (var3[var4] == var2) {
                  this.next = (int)IntLinkedOpenHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = IntLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)IntLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = IntLinkedOpenHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (IntLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = IntLinkedOpenHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (IntLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == IntLinkedOpenHashSet.this.n) {
               IntLinkedOpenHashSet.this.containsNull = false;
               IntLinkedOpenHashSet.this.key[IntLinkedOpenHashSet.this.n] = 0;
            } else {
               int[] var5 = IntLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & IntLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(var4) & IntLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  IntLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
