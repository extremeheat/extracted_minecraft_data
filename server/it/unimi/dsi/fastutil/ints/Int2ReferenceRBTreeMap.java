...
public class Int2ReferenceRBTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements Serializable, Cloneable {
   ...
   public Int2ReferenceRBTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2ReferenceRBTreeMap(Map<? extends Integer, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Int2ReferenceRBTreeMap(SortedMap<Integer, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2ReferenceRBTreeMap(Int2ReferenceMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Int2ReferenceRBTreeMap(Int2ReferenceSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2ReferenceRBTreeMap(int[] var1, V[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2ReferenceRBTreeMap(int[] var1, V[] var2) {
   ...
   final Int2ReferenceRBTreeMap.Entry<V> findKey(int var1) {
      Int2ReferenceRBTreeMap.Entry var2;
      int var3;
   ...
   final Int2ReferenceRBTreeMap.Entry<V> locateKey(int var1) {
      Int2ReferenceRBTreeMap.Entry var2 = this.tree;
      Int2ReferenceRBTreeMap.Entry var3 = this.tree;
   ...
   public V put(int var1, V var2) {
      Int2ReferenceRBTreeMap.Entry var3 = this.add(var1);
      Object var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Int2ReferenceRBTreeMap.Entry<V> add(int var1) {
      this.modified = false;
      int var2 = 0;
      Int2ReferenceRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Int2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Int2ReferenceRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Int2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Int2ReferenceRBTreeMap.Entry var7;
               Int2ReferenceRBTreeMap.Entry var8;
   ...
   public boolean containsValue(Object var1) {
      Int2ReferenceRBTreeMap.ValueIterator var2 = new Int2ReferenceRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(int var1) {
      Int2ReferenceRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() {
            final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = (var1x, var2) -> {
               return Int2ReferenceRBTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> var1) {
               return Int2ReferenceRBTreeMap.this.new EntryIterator(var1.getIntKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     Int2ReferenceRBTreeMap.Entry var3 = Int2ReferenceRBTreeMap.this.findKey((Integer)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     ...
                     if (var3 != null && var3.getValue() == var2.getValue()) {
                        Int2ReferenceRBTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> var1, Int2ReferenceMap.Entry<V> var2) {
               return Int2ReferenceRBTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2ReferenceEntrySet();
            }

            public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> var1) {
               return Int2ReferenceRBTreeMap.this.headMap(var1.getIntKey()).int2ReferenceEntrySet();
            }

            public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> var1) {
               return Int2ReferenceRBTreeMap.this.tailMap(var1.getIntKey()).int2ReferenceEntrySet();
            }
         };
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Int2ReferenceRBTreeMap.this.containsValue(var1);
            }
   ...
   public Int2ReferenceSortedMap<V> headMap(int var1) {
      return new Int2ReferenceRBTreeMap.Submap(0, true, var1, false);
   }

   public Int2ReferenceSortedMap<V> tailMap(int var1) {
      return new Int2ReferenceRBTreeMap.Submap(var1, false, 0, true);
   }

   public Int2ReferenceSortedMap<V> subMap(int var1, int var2) {
      return new Int2ReferenceRBTreeMap.Submap(var1, false, var2, false);
   }

   public Int2ReferenceRBTreeMap<V> clone() {
      Int2ReferenceRBTreeMap var1;
      try {
         var1 = (Int2ReferenceRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2ReferenceRBTreeMap.Entry var5 = new Int2ReferenceRBTreeMap.Entry();
         Int2ReferenceRBTreeMap.Entry var6 = new Int2ReferenceRBTreeMap.Entry();
         Int2ReferenceRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2ReferenceRBTreeMap.Entry var4 = var6;
         var6.pred((Int2ReferenceRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2ReferenceRBTreeMap.EntryIterator var3 = new Int2ReferenceRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2ReferenceRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2ReferenceRBTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Int2ReferenceRBTreeMap.Entry<V> var3, Int2ReferenceRBTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Int2ReferenceRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2ReferenceRBTreeMap.Entry(var1.readInt(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Int2ReferenceRBTreeMap.Entry(var1.readInt(), var1.readObject());
         var8.black(true);
         var8.right(new Int2ReferenceRBTreeMap.Entry(var1.readInt(), var1.readObject()));
         ...
         Int2ReferenceRBTreeMap.Entry var7 = new Int2ReferenceRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2ReferenceRBTreeMap.Entry)null, (Int2ReferenceRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2ReferenceSortedMap<V> implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2ReferenceRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2ReferenceRBTreeMap.Submap.SubmapIterator var1 = new Int2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2ReferenceRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2ReferenceRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2ReferenceRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Int2ReferenceRBTreeMap.Submap.SubmapIterator var2 = new Int2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(int var1) {
         Int2ReferenceRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2ReferenceRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public V put(int var1, V var2) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Int2ReferenceRBTreeMap.this.put(var1, var2);
            return Int2ReferenceRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public V remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var2 = Int2ReferenceRBTreeMap.this.remove(var1);
            return Int2ReferenceRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2ReferenceSortedMap<V> headMap(int var1) {
         if (this.top) {
            return Int2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2ReferenceRBTreeMap.this.compare(var1, this.to) < 0 ? Int2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2ReferenceSortedMap<V> tailMap(int var1) {
         if (this.bottom) {
            return Int2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? Int2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2ReferenceSortedMap<V> subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2ReferenceRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2ReferenceRBTreeMap.Entry<V> firstEntry() {
         if (Int2ReferenceRBTreeMap.this.tree == null) {
            ...
            Int2ReferenceRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2ReferenceRBTreeMap.this.firstEntry;
            } else {
               var1 = Int2ReferenceRBTreeMap.this.locateKey(this.from);
               if (Int2ReferenceRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2ReferenceRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2ReferenceRBTreeMap.Entry<V> lastEntry() {
         if (Int2ReferenceRBTreeMap.this.tree == null) {
            ...
            Int2ReferenceRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2ReferenceRBTreeMap.this.lastEntry;
            } else {
               var1 = Int2ReferenceRBTreeMap.this.locateKey(this.to);
               if (Int2ReferenceRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2ReferenceRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2ReferenceRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2ReferenceRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2ReferenceRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2ReferenceRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2ReferenceRBTreeMap.this.locateKey(var2);
                  if (Int2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2ReferenceSortedMap<V>.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2ReferenceRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2ReferenceRBTreeMap.this.locateKey(var2)) != null) {
            if (Int2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractInt2ReferenceMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Int2ReferenceRBTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2ReferenceRBTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2ReferenceRBTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2ReferenceRBTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2ReferenceRBTreeMap.Entry<V> next() {
         Int2ReferenceRBTreeMap.Entry var1 = this.right;
      ...
      Int2ReferenceRBTreeMap.Entry<V> prev() {
         Int2ReferenceRBTreeMap.Entry var1 = this.left;
      ...
      public Int2ReferenceRBTreeMap.Entry<V> clone() {
         Int2ReferenceRBTreeMap.Entry var1;
         try {
            var1 = (Int2ReferenceRBTreeMap.Entry)super.clone();
