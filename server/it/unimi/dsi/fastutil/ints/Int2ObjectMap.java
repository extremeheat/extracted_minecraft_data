...
public interface Int2ObjectMap<V> extends Int2ObjectFunction<V>, Map<Integer, V> {
   ...
   default V put(Integer var1, V var2) {
      return Int2ObjectFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V get(Object var1) {
      return Int2ObjectFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default V remove(Object var1) {
      return Int2ObjectFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Int2ObjectFunction.super.containsKey(var1);
   }

   default V getOrDefault(int var1, V var2) {
      Object var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default V putIfAbsent(int var1, V var2) {
   ...
   default boolean remove(int var1, Object var2) {
      Object var3 = this.get(var1);
      if (Objects.equals(var3, var2) && (var3 != this.defaultReturnValue() || this.containsKey(var1))) {
         this.remove(var1);
         return true;
      } else {
         return false;
   ...
   default boolean replace(int var1, V var2, V var3) {
      Object var4 = this.get(var1);
      if (Objects.equals(var4, var2) && (var4 != this.defaultReturnValue() || this.containsKey(var1))) {
         this.put(var1, var3);
         return true;
      } else {
         return false;
   ...
   default V replace(int var1, V var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default V computeIfAbsent(int var1, IntFunction<? extends V> var2) {
   ...
   default V computeIfAbsentPartial(int var1, Int2ObjectFunction<? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default V computeIfPresent(int var1, BiFunction<? super Integer, ? super V, ? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default V compute(int var1, BiFunction<? super Integer, ? super V, ? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
   ...
   default V merge(int var1, V var2, BiFunction<? super V, ? super V, ? extends V> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default V putIfAbsent(Integer var1, V var2) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Integer var1, V var2, V var3) {
      return super.replace(var1, var2, var3);
   }

   /** @deprecated */
   @Deprecated
   default V replace(Integer var1, V var2) {
      return super.replace(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V computeIfAbsent(Integer var1, Function<? super Integer, ? extends V> var2) {
      return super.computeIfAbsent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V computeIfPresent(Integer var1, BiFunction<? super Integer, ? super V, ? extends V> var2) {
      return super.computeIfPresent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V compute(Integer var1, BiFunction<? super Integer, ? super V, ? extends V> var2) {
      return super.compute(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V merge(Integer var1, V var2, BiFunction<? super V, ? super V, ? extends V> var3) {
   ...
   public interface FastEntrySet<V> extends ObjectSet<Int2ObjectMap.Entry<V>> {
      ...
      default void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> var1) {
         this.forEach(var1);
      }
   }
}
