...
public class Int2FloatOpenCustomHashMap extends AbstractInt2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Int2FloatOpenCustomHashMap(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Int2FloatOpenCustomHashMap(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2FloatOpenCustomHashMap(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Int2FloatOpenCustomHashMap(Map<? extends Integer, ? extends Float> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2FloatOpenCustomHashMap(Map<? extends Integer, ? extends Float> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2FloatOpenCustomHashMap(Int2FloatMap var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2FloatOpenCustomHashMap(Int2FloatMap var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2FloatOpenCustomHashMap(int[] var1, float[] var2, float var3, IntHash.Strategy var4) {
   ...
   private void insert(int var1, int var2, float var3) {
      if (var1 == this.n) {
   ...
   public Int2FloatMap.FastEntrySet int2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Int2FloatOpenCustomHashMap.MapEntrySet();
      }
   ...
   public IntSet keySet() {
      if (this.keys == null) {
         this.keys = new Int2FloatOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            public FloatIterator iterator() {
               return Int2FloatOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(float var1) {
               return Int2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Int2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2FloatOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept((double)Int2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2FloatOpenCustomHashMap clone() {
      Int2FloatOpenCustomHashMap var1;
      try {
         var1 = (Int2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      float[] var3 = this.value;
      Int2FloatOpenCustomHashMap.MapIterator var4 = new Int2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Int2FloatOpenCustomHashMap.MapIterator implements FloatIterator {
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntIterator iterator() {
         return Int2FloatOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Int2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2FloatOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2FloatOpenCustomHashMap.this.size;
         Int2FloatOpenCustomHashMap.this.remove(var1);
         return Int2FloatOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Int2FloatOpenCustomHashMap.MapIterator implements IntIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet {
      ...
      public ObjectIterator<Int2FloatMap.Entry> iterator() {
         return Int2FloatOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Int2FloatMap.Entry> fastIterator() {
         return Int2FloatOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Int2FloatOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     return Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     int[] var6 = Int2FloatOpenCustomHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2FloatOpenCustomHashMap.this.mask]) != 0) {
                           if (Int2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (Int2FloatOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     if (Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2FloatOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Int2FloatOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2FloatOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Int2FloatOpenCustomHashMap.this.strategy.equals(var5, var3) || Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Int2FloatMap.Entry> var1) {
         if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.n], Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2FloatOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenCustomHashMap.this.key[var2], Int2FloatOpenCustomHashMap.this.value[var2]));
            }
         }

      }

      public void fastForEach(Consumer<? super Int2FloatMap.Entry> var1) {
         AbstractInt2FloatMap.BasicEntry var2 = new AbstractInt2FloatMap.BasicEntry();
         if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.n];
            var2.value = Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Int2FloatOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Int2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Int2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Int2FloatMap.Entry> {
      private final Int2FloatOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Int2FloatMap.Entry> {
      ...
      public Int2FloatOpenCustomHashMap.MapEntry next() {
         return this.entry = Int2FloatOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2FloatOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Int2FloatOpenCustomHashMap.this.mask; !Int2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Int2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Int2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2FloatOpenCustomHashMap.this.value[var2] = Int2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2FloatMap.Entry, java.util.Map.Entry<Integer, Float> {
      int index;
      ...
      public float setValue(float var1) {
         float var2 = Int2FloatOpenCustomHashMap.this.value[this.index];
         Int2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], (Integer)var2.getKey()) && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
