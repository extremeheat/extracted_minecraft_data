...
public final class IntIndirectHeaps {
   ...
   public static int downHeap(int[] var0, int[] var1, int[] var2, int var3, int var4, IntComparator var5) {
      assert var4 < var3;
   ...
   public static int upHeap(int[] var0, int[] var1, int[] var2, int var3, int var4, IntComparator var5) {
      assert var4 < var3;
   ...
   public static void makeHeap(int[] var0, int var1, int var2, int[] var3, int[] var4, IntComparator var5) {
