...
public class Int2BooleanOpenHashMap extends AbstractInt2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Int2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2BooleanOpenHashMap(Map<? extends Integer, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2BooleanOpenHashMap(Map<? extends Integer, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Int2BooleanOpenHashMap(Int2BooleanMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2BooleanOpenHashMap(Int2BooleanMap var1) {
      this(var1, 0.75F);
   }

   public Int2BooleanOpenHashMap(int[] var1, boolean[] var2, float var3) {
   ...
   public Int2BooleanOpenHashMap(int[] var1, boolean[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Int2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Int2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n]);
               }

               int var2 = Int2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2BooleanOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2BooleanOpenHashMap clone() {
      Int2BooleanOpenHashMap var1;
      try {
         var1 = (Int2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      boolean[] var3 = this.value;
      Int2BooleanOpenHashMap.MapIterator var4 = new Int2BooleanOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Int2BooleanOpenHashMap.MapIterator implements BooleanIterator {
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n]);
         }

         int var2 = Int2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2BooleanOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2BooleanOpenHashMap.this.size;
         Int2BooleanOpenHashMap.this.remove(var1);
         return Int2BooleanOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Int2BooleanOpenHashMap.MapIterator implements IntIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (var3 == 0) {
                     return Int2BooleanOpenHashMap.this.containsNullKey && Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2BooleanOpenHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2BooleanOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Int2BooleanOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2BooleanOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Int2BooleanOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var4 = (Boolean)var2.getValue();
                  if (var3 == 0) {
                     if (Int2BooleanOpenHashMap.this.containsNullKey && Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2BooleanOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Int2BooleanOpenHashMap.this.value[var7] == var4) {
                           Int2BooleanOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2BooleanOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Int2BooleanOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2BooleanMap.Entry> var1) {
         if (Int2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n], Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2BooleanOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanOpenHashMap.this.key[var2], Int2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2BooleanMap.Entry> var1) {
         ...
         if (Int2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n];
            var2.value = Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2BooleanOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2BooleanOpenHashMap.this.key[var3];
               var2.value = Int2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2BooleanOpenHashMap.MapIterator implements ObjectIterator<Int2BooleanMap.Entry> {
      private final Int2BooleanOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2BooleanOpenHashMap.MapIterator implements ObjectIterator<Int2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2BooleanOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2BooleanOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2BooleanOpenHashMap.this.value[var2] = Int2BooleanOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2BooleanMap.Entry, java.util.Map.Entry<Integer, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Int2BooleanOpenHashMap.this.value[this.index];
         Int2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2BooleanOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Int2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
