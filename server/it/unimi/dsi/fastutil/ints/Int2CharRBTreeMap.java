...
public class Int2CharRBTreeMap extends AbstractInt2CharSortedMap implements Serializable, Cloneable {
   ...
   public Int2CharRBTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2CharRBTreeMap(Map<? extends Integer, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Int2CharRBTreeMap(SortedMap<Integer, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2CharRBTreeMap(Int2CharMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2CharRBTreeMap(Int2CharSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2CharRBTreeMap(int[] var1, char[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2CharRBTreeMap(int[] var1, char[] var2) {
   ...
   final Int2CharRBTreeMap.Entry findKey(int var1) {
      Int2CharRBTreeMap.Entry var2;
      int var3;
   ...
   final Int2CharRBTreeMap.Entry locateKey(int var1) {
      Int2CharRBTreeMap.Entry var2 = this.tree;
      Int2CharRBTreeMap.Entry var3 = this.tree;
   ...
   public char addTo(int var1, char var2) {
      Int2CharRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Int2CharRBTreeMap.Entry add(int var1) {
      this.modified = false;
      int var2 = 0;
      Int2CharRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Int2CharRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Int2CharRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Int2CharRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Int2CharRBTreeMap.Entry var7;
               Int2CharRBTreeMap.Entry var8;
   ...
   public boolean containsValue(char var1) {
      Int2CharRBTreeMap.ValueIterator var2 = new Int2CharRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char get(int var1) {
      Int2CharRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
            final Comparator<? super Int2CharMap.Entry> comparator = (var1x, var2) -> {
               return Int2CharRBTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry var1) {
               return Int2CharRBTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        Int2CharRBTreeMap.Entry var3 = Int2CharRBTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        ...
                        if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                           Int2CharRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry var1, Int2CharMap.Entry var2) {
               return Int2CharRBTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2CharEntrySet();
            }

            public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry var1) {
               return Int2CharRBTreeMap.this.headMap(var1.getIntKey()).int2CharEntrySet();
            }

            public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry var1) {
               return Int2CharRBTreeMap.this.tailMap(var1.getIntKey()).int2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Int2CharRBTreeMap.this.containsValue(var1);
            }
   ...
   public Int2CharSortedMap headMap(int var1) {
      return new Int2CharRBTreeMap.Submap(0, true, var1, false);
   }

   public Int2CharSortedMap tailMap(int var1) {
      return new Int2CharRBTreeMap.Submap(var1, false, 0, true);
   }

   public Int2CharSortedMap subMap(int var1, int var2) {
      return new Int2CharRBTreeMap.Submap(var1, false, var2, false);
   }

   public Int2CharRBTreeMap clone() {
      Int2CharRBTreeMap var1;
      try {
         var1 = (Int2CharRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2CharRBTreeMap.Entry var5 = new Int2CharRBTreeMap.Entry();
         Int2CharRBTreeMap.Entry var6 = new Int2CharRBTreeMap.Entry();
         Int2CharRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2CharRBTreeMap.Entry var4 = var6;
         var6.pred((Int2CharRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2CharRBTreeMap.EntryIterator var3 = new Int2CharRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2CharRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2CharRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2CharRBTreeMap.Entry var3, Int2CharRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2CharRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2CharRBTreeMap.Entry(var1.readInt(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Int2CharRBTreeMap.Entry(var1.readInt(), var1.readChar());
         var8.black(true);
         var8.right(new Int2CharRBTreeMap.Entry(var1.readInt(), var1.readChar()));
         ...
         Int2CharRBTreeMap.Entry var7 = new Int2CharRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2CharRBTreeMap.Entry)null, (Int2CharRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2CharSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2CharRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2CharRBTreeMap.Submap.SubmapIterator var1 = new Int2CharRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2CharRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2CharRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2CharRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Int2CharRBTreeMap.Submap.SubmapIterator var2 = new Int2CharRBTreeMap.Submap.SubmapIterator();
      ...
      public char get(int var1) {
         Int2CharRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2CharRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public char put(int var1, char var2) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Int2CharRBTreeMap.this.put(var1, var2);
            return Int2CharRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public char remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var2 = Int2CharRBTreeMap.this.remove(var1);
            return Int2CharRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2CharSortedMap headMap(int var1) {
         if (this.top) {
            return Int2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2CharRBTreeMap.this.compare(var1, this.to) < 0 ? Int2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2CharSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2CharRBTreeMap.this.compare(var1, this.from) > 0 ? Int2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2CharSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2CharRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2CharRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2CharRBTreeMap.Entry firstEntry() {
         if (Int2CharRBTreeMap.this.tree == null) {
            ...
            Int2CharRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2CharRBTreeMap.this.firstEntry;
            } else {
               var1 = Int2CharRBTreeMap.this.locateKey(this.from);
               if (Int2CharRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2CharRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2CharRBTreeMap.Entry lastEntry() {
         if (Int2CharRBTreeMap.this.tree == null) {
            ...
            Int2CharRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2CharRBTreeMap.this.lastEntry;
            } else {
               var1 = Int2CharRBTreeMap.this.locateKey(this.to);
               if (Int2CharRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2CharRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2CharRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2CharRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2CharRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2CharMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2CharRBTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2CharRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2CharRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2CharRBTreeMap.this.locateKey(var2);
                  if (Int2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2CharSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2CharRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2CharRBTreeMap.TreeIterator implements ObjectListIterator<Int2CharMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2CharRBTreeMap.this.locateKey(var2)) != null) {
            if (Int2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2CharRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2CharRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2CharRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2CharRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2CharRBTreeMap.Entry next() {
         Int2CharRBTreeMap.Entry var1 = this.right;
      ...
      Int2CharRBTreeMap.Entry prev() {
         Int2CharRBTreeMap.Entry var1 = this.left;
      ...
      public Int2CharRBTreeMap.Entry clone() {
         Int2CharRBTreeMap.Entry var1;
         try {
            var1 = (Int2CharRBTreeMap.Entry)super.clone();
