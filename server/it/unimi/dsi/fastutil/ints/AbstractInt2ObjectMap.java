...
public abstract class AbstractInt2ObjectMap<V> extends AbstractInt2ObjectFunction<V> implements Int2ObjectMap<V>, Serializable {
   ...
   public boolean containsKey(int var1) {
      ...
      } while(((Int2ObjectMap.Entry)var2.next()).getIntKey() != var1);
   ...
   public IntSet keySet() {
      return new AbstractIntSet() {
         public boolean contains(int var1) {
            return AbstractInt2ObjectMap.this.containsKey(var1);
         }
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return AbstractInt2ObjectMap.this.containsValue(var1);
         }
   ...
   public void putAll(Map<? extends Integer, ? extends V> var1) {
      if (var1 instanceof Int2ObjectMap) {
         ObjectIterator var2 = Int2ObjectMaps.fastIterator((Int2ObjectMap)var1);
   ...
   public int hashCode() {
      ...
      for(ObjectIterator var3 = Int2ObjectMaps.fastIterator(this); var2-- != 0; var1 += ((Int2ObjectMap.Entry)var3.next()).hashCode()) {
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         Map var2 = (Map)var1;
         return var2.size() != this.size() ? false : this.int2ObjectEntrySet().containsAll(var2.entrySet());
      }
   }

   public String toString() {
      StringBuilder var1 = new StringBuilder();
      ObjectIterator var2 = Int2ObjectMaps.fastIterator(this);
      int var3 = this.size();
      boolean var5 = true;
      var1.append("{");
      ...
      while(var3-- != 0) {
         ...
         Int2ObjectMap.Entry var4 = (Int2ObjectMap.Entry)var2.next();
   ...
   public abstract static class BasicEntrySet<V> extends AbstractObjectSet<Int2ObjectMap.Entry<V>> {
      ...
      public BasicEntrySet(Int2ObjectMap<V> var1) {
         super();
         this.map = var1;
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            return false;
         } else if (var1 instanceof Int2ObjectMap.Entry) {
            Int2ObjectMap.Entry var6 = (Int2ObjectMap.Entry)var1;
   ...
   public static class BasicEntry<V> implements Int2ObjectMap.Entry<V> {
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            Int2ObjectMap.Entry var5 = (Int2ObjectMap.Entry)var1;
            return this.key == var5.getIntKey() && Objects.equals(this.value, var5.getValue());
         } else {
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            Object var3 = var2.getKey();
            if (var3 != null && var3 instanceof Integer) {
               Object var4 = var2.getValue();
               return this.key == (Integer)var3 && Objects.equals(this.value, var4);
            } else {
               return false;
            }
         }
