...
public interface Int2ReferenceMap<V> extends Int2ReferenceFunction<V>, Map<Integer, V> {
   ...
   default V put(Integer var1, V var2) {
      return Int2ReferenceFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V get(Object var1) {
      return Int2ReferenceFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default V remove(Object var1) {
      return Int2ReferenceFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Int2ReferenceFunction.super.containsKey(var1);
   }
   ...
   default V computeIfAbsentPartial(int var1, Int2ReferenceFunction<? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<V> extends ObjectSet<Int2ReferenceMap.Entry<V>> {
      ...
      default void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> var1) {
         this.forEach(var1);
      }
   }
}
