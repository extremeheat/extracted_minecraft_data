...
public class Int2CharArrayMap extends AbstractInt2CharMap implements Serializable, Cloneable {
   ...
   public Int2CharArrayMap(int[] var1, char[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Int2CharArrayMap(int var1) {
      super();
      this.key = new int[var1];
      this.value = new char[var1];
   }

   public Int2CharArrayMap(Int2CharMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2CharArrayMap(Map<? extends Integer, ? extends Character> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2CharArrayMap(int[] var1, char[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public IntSet keySet() {
      return new AbstractIntSet() {
         public boolean contains(int var1) {
            return Int2CharArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(int var1) {
            int var2 = Int2CharArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Int2CharArrayMap.this.size - var2 - 1;
               System.arraycopy(Int2CharArrayMap.this.key, var2 + 1, Int2CharArrayMap.this.key, var2, var3);
               System.arraycopy(Int2CharArrayMap.this.value, var2 + 1, Int2CharArrayMap.this.value, var2, var3);
            ...
            return new IntIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Int2CharArrayMap.this.size - this.pos;
                     System.arraycopy(Int2CharArrayMap.this.key, this.pos, Int2CharArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Int2CharArrayMap.this.value, this.pos, Int2CharArrayMap.this.value, this.pos - 1, var1);
                     Int2CharArrayMap.this.size--;
                  }
               }
            };
   ...
   public CharCollection values() {
      return new AbstractCharCollection() {
         public boolean contains(char var1) {
            return Int2CharArrayMap.this.containsValue(var1);
         }
   ...
   public Int2CharArrayMap clone() {
      Int2CharArrayMap var1;
      try {
         var1 = (Int2CharArrayMap)super.clone();
   ...
   private final class EntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
      private EntrySet() {
         super();
      }
         ...
         return new ObjectIterator<Int2CharMap.Entry>() {
            ...
            public Int2CharMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractInt2CharMap.BasicEntry(Int2CharArrayMap.this.key[this.curr = this.next], Int2CharArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Int2CharArrayMap.this.size-- - this.next--;
                  System.arraycopy(Int2CharArrayMap.this.key, this.next + 1, Int2CharArrayMap.this.key, this.next, var1);
                  System.arraycopy(Int2CharArrayMap.this.value, this.next + 1, Int2CharArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  return Int2CharArrayMap.this.containsKey(var3) && Int2CharArrayMap.this.get(var3) == (Character)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  int var5 = Int2CharArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Int2CharArrayMap.this.value[var5]) {
                     int var6 = Int2CharArrayMap.this.size - var5 - 1;
                     System.arraycopy(Int2CharArrayMap.this.key, var5 + 1, Int2CharArrayMap.this.key, var5, var6);
                     System.arraycopy(Int2CharArrayMap.this.value, var5 + 1, Int2CharArrayMap.this.value, var5, var6);
                     Int2CharArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
