...
public class Int2FloatOpenHashMap extends AbstractInt2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Int2FloatOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2FloatOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2FloatOpenHashMap(Map<? extends Integer, ? extends Float> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2FloatOpenHashMap(Map<? extends Integer, ? extends Float> var1) {
      this(var1, 0.75F);
   }

   public Int2FloatOpenHashMap(Int2FloatMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2FloatOpenHashMap(Int2FloatMap var1) {
      this(var1, 0.75F);
   }

   public Int2FloatOpenHashMap(int[] var1, float[] var2, float var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Int2FloatOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Int2FloatOpenHashMap.this.containsNullKey) {
                  var1.accept((double)Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]);
               }

               int var2 = Int2FloatOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2FloatOpenHashMap.this.key[var2] != 0) {
                     var1.accept((double)Int2FloatOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2FloatOpenHashMap clone() {
      Int2FloatOpenHashMap var1;
      try {
         var1 = (Int2FloatOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      float[] var3 = this.value;
      Int2FloatOpenHashMap.MapIterator var4 = new Int2FloatOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2FloatOpenHashMap.this.containsNullKey) {
            var1.accept(Int2FloatOpenHashMap.this.key[Int2FloatOpenHashMap.this.n]);
         }

         int var2 = Int2FloatOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2FloatOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2FloatOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2FloatOpenHashMap.this.size;
         Int2FloatOpenHashMap.this.remove(var1);
         return Int2FloatOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (var3 == 0) {
                     return Int2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     int[] var6 = Int2FloatOpenHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2FloatOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Float.floatToIntBits(Int2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2FloatOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Float.floatToIntBits(Int2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (var3 == 0) {
                     if (Int2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2FloatOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float.floatToIntBits(Int2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Int2FloatOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2FloatOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Float.floatToIntBits(Int2FloatOpenHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Int2FloatMap.Entry> var1) {
         if (Int2FloatOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenHashMap.this.key[Int2FloatOpenHashMap.this.n], Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2FloatOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenHashMap.this.key[var2], Int2FloatOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2FloatMap.Entry> var1) {
         ...
         if (Int2FloatOpenHashMap.this.containsNullKey) {
            var2.key = Int2FloatOpenHashMap.this.key[Int2FloatOpenHashMap.this.n];
            var2.value = Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2FloatOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2FloatOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2FloatOpenHashMap.this.key[var3];
               var2.value = Int2FloatOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2FloatOpenHashMap.MapIterator implements ObjectIterator<Int2FloatMap.Entry> {
      private final Int2FloatOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2FloatOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2FloatOpenHashMap.MapIterator implements ObjectIterator<Int2FloatMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2FloatOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2FloatOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2FloatOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2FloatOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2FloatOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2FloatOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2FloatOpenHashMap.this.value[var2] = Int2FloatOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2FloatMap.Entry, java.util.Map.Entry<Integer, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Int2FloatOpenHashMap.this.value[this.index];
         Int2FloatOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2FloatOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Float.floatToIntBits(Int2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
