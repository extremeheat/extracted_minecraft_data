...
public class Int2IntAVLTreeMap extends AbstractInt2IntSortedMap implements Serializable, Cloneable {
   ...
   public Int2IntAVLTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2IntAVLTreeMap(Map<? extends Integer, ? extends Integer> var1) {
      this();
      this.putAll(var1);
   }

   public Int2IntAVLTreeMap(SortedMap<Integer, Integer> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2IntAVLTreeMap(Int2IntMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2IntAVLTreeMap(Int2IntSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2IntAVLTreeMap(int[] var1, int[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2IntAVLTreeMap(int[] var1, int[] var2) {
   ...
   final Int2IntAVLTreeMap.Entry findKey(int var1) {
      Int2IntAVLTreeMap.Entry var2;
      int var3;
   ...
   final Int2IntAVLTreeMap.Entry locateKey(int var1) {
      Int2IntAVLTreeMap.Entry var2 = this.tree;
      Int2IntAVLTreeMap.Entry var3 = this.tree;
   ...
   public int addTo(int var1, int var2) {
      Int2IntAVLTreeMap.Entry var3 = this.add(var1);
      int var4 = var3.value;
      var3.value += var2;
      return var4;
   }
   ...
   private Int2IntAVLTreeMap.Entry add(int var1) {
      this.modified = false;
      Int2IntAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Int2IntAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Int2IntAVLTreeMap.Entry var3 = this.tree;
         Int2IntAVLTreeMap.Entry var4 = null;
         Int2IntAVLTreeMap.Entry var5 = this.tree;
         Int2IntAVLTreeMap.Entry var6 = null;
         Int2IntAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Int2IntAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
   ...
   private Int2IntAVLTreeMap.Entry parent(Int2IntAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Int2IntAVLTreeMap.Entry var3 = var1;

         Int2IntAVLTreeMap.Entry var2;
         Int2IntAVLTreeMap.Entry var4;
   ...
   public int remove(int var1) {
      ...
      if (this.tree == null) {
         ...
         Int2IntAVLTreeMap.Entry var7;
         Int2IntAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
   ...
   public boolean containsValue(int var1) {
      Int2IntAVLTreeMap.ValueIterator var2 = new Int2IntAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public int get(int var1) {
      Int2IntAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
            final Comparator<? super Int2IntMap.Entry> comparator = (var1x, var2) -> {
               return Int2IntAVLTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry var1) {
               return Int2IntAVLTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        Int2IntAVLTreeMap.Entry var3 = Int2IntAVLTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        ...
                        if (var3 != null && var3.getIntValue() == (Integer)var2.getValue()) {
                           Int2IntAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry var1, Int2IntMap.Entry var2) {
               return Int2IntAVLTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2IntEntrySet();
            }

            public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry var1) {
               return Int2IntAVLTreeMap.this.headMap(var1.getIntKey()).int2IntEntrySet();
            }

            public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry var1) {
               return Int2IntAVLTreeMap.this.tailMap(var1.getIntKey()).int2IntEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Int2IntAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Int2IntSortedMap headMap(int var1) {
      return new Int2IntAVLTreeMap.Submap(0, true, var1, false);
   }

   public Int2IntSortedMap tailMap(int var1) {
      return new Int2IntAVLTreeMap.Submap(var1, false, 0, true);
   }

   public Int2IntSortedMap subMap(int var1, int var2) {
      return new Int2IntAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Int2IntAVLTreeMap clone() {
      Int2IntAVLTreeMap var1;
      try {
         var1 = (Int2IntAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2IntAVLTreeMap.Entry var5 = new Int2IntAVLTreeMap.Entry();
         Int2IntAVLTreeMap.Entry var6 = new Int2IntAVLTreeMap.Entry();
         Int2IntAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2IntAVLTreeMap.Entry var4 = var6;
         var6.pred((Int2IntAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2IntAVLTreeMap.EntryIterator var3 = new Int2IntAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2IntAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2IntAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2IntAVLTreeMap.Entry var3, Int2IntAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2IntAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2IntAVLTreeMap.Entry(var1.readInt(), var1.readInt());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Int2IntAVLTreeMap.Entry(var1.readInt(), var1.readInt());
         var8.right(new Int2IntAVLTreeMap.Entry(var1.readInt(), var1.readInt()));
         ...
         Int2IntAVLTreeMap.Entry var7 = new Int2IntAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2IntAVLTreeMap.Entry)null, (Int2IntAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2IntSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2IntAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2IntAVLTreeMap.Submap.SubmapIterator var1 = new Int2IntAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2IntAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2IntAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2IntAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(int var1) {
         Int2IntAVLTreeMap.Submap.SubmapIterator var2 = new Int2IntAVLTreeMap.Submap.SubmapIterator();
      ...
      public int get(int var1) {
         Int2IntAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2IntAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public int put(int var1, int var2) {
         ...
         if (!this.in(var1)) {
            ...
            int var3 = Int2IntAVLTreeMap.this.put(var1, var2);
            return Int2IntAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public int remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            int var2 = Int2IntAVLTreeMap.this.remove(var1);
            return Int2IntAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2IntSortedMap headMap(int var1) {
         if (this.top) {
            return Int2IntAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2IntAVLTreeMap.this.compare(var1, this.to) < 0 ? Int2IntAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2IntSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2IntAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2IntAVLTreeMap.this.compare(var1, this.from) > 0 ? Int2IntAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2IntSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2IntAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2IntAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2IntAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2IntAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2IntAVLTreeMap.Entry firstEntry() {
         if (Int2IntAVLTreeMap.this.tree == null) {
            ...
            Int2IntAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2IntAVLTreeMap.this.firstEntry;
            } else {
               var1 = Int2IntAVLTreeMap.this.locateKey(this.from);
               if (Int2IntAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2IntAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2IntAVLTreeMap.Entry lastEntry() {
         if (Int2IntAVLTreeMap.this.tree == null) {
            ...
            Int2IntAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2IntAVLTreeMap.this.lastEntry;
            } else {
               var1 = Int2IntAVLTreeMap.this.locateKey(this.to);
               if (Int2IntAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2IntAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2IntAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2IntAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2IntAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2IntMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2IntAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2IntAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2IntAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2IntAVLTreeMap.this.locateKey(var2);
                  if (Int2IntAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2IntSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2IntAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2IntAVLTreeMap.TreeIterator implements ObjectListIterator<Int2IntMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2IntAVLTreeMap.this.locateKey(var2)) != null) {
            if (Int2IntAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2IntMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2IntAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2IntAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2IntAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2IntAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2IntAVLTreeMap.Entry next() {
         Int2IntAVLTreeMap.Entry var1 = this.right;
      ...
      Int2IntAVLTreeMap.Entry prev() {
         Int2IntAVLTreeMap.Entry var1 = this.left;
      ...
      public Int2IntAVLTreeMap.Entry clone() {
         Int2IntAVLTreeMap.Entry var1;
         try {
            var1 = (Int2IntAVLTreeMap.Entry)super.clone();
