...
public class IntLinkedOpenCustomHashSet extends AbstractIntSortedSet implements Serializable, Cloneable, Hash {
   ...
   public IntLinkedOpenCustomHashSet(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.first = -1;
      this.last = -1;
      this.strategy = var3;
   ...
   public IntLinkedOpenCustomHashSet(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public IntLinkedOpenCustomHashSet(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public IntLinkedOpenCustomHashSet(Collection<? extends Integer> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public IntLinkedOpenCustomHashSet(Collection<? extends Integer> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public IntLinkedOpenCustomHashSet(IntCollection var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public IntLinkedOpenCustomHashSet(IntCollection var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public IntLinkedOpenCustomHashSet(IntIterator var1, float var2, IntHash.Strategy var3) {
      this(16, var2, var3);
   ...
   public IntLinkedOpenCustomHashSet(IntIterator var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public IntLinkedOpenCustomHashSet(Iterator<?> var1, float var2, IntHash.Strategy var3) {
      this(IntIterators.asIntIterator(var1), var2, var3);
   }

   public IntLinkedOpenCustomHashSet(Iterator<?> var1, IntHash.Strategy var2) {
      this(IntIterators.asIntIterator(var1), var2);
   }

   public IntLinkedOpenCustomHashSet(int[] var1, int var2, int var3, float var4, IntHash.Strategy var5) {
   ...
   public IntLinkedOpenCustomHashSet(int[] var1, int var2, int var3, IntHash.Strategy var4) {
   ...
   public int removeFirstInt() {
      if (this.size == 0) {
         ...
         int var2 = this.key[var1];
         --this.size;
         if (this.strategy.equals(var2, 0)) {
            this.containsNull = false;
            this.key[this.n] = 0;
         } else {
            this.shiftKeys(var1);
   ...
   public boolean addAndMoveToFirst(int var1) {
      int var2;
      if (this.strategy.equals(var1, 0)) {
         if (this.containsNull) {
   ...
   public boolean addAndMoveToLast(int var1) {
      int var2;
      if (this.strategy.equals(var1, 0)) {
         if (this.containsNull) {
   ...
   public IntListIterator iterator(int var1) {
      return new IntLinkedOpenCustomHashSet.SetIterator(var1);
   }

   public IntListIterator iterator() {
      return new IntLinkedOpenCustomHashSet.SetIterator();
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         int var9;
         if (this.strategy.equals(var2[var5], 0)) {
            var9 = var1;
         } else {
   ...
   public IntLinkedOpenCustomHashSet clone() {
      IntLinkedOpenCustomHashSet var1;
      try {
         var1 = (IntLinkedOpenCustomHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var6-- != 0) {
         ...
         int var7;
         if (this.strategy.equals(var5, 0)) {
            var7 = this.n;
            this.containsNull = true;
   ...
   private class SetIterator implements IntListIterator {
      ...
      SetIterator(int var2) {
         super();
         if (IntLinkedOpenCustomHashSet.this.strategy.equals(var2, 0)) {
         ...
         } else if (IntLinkedOpenCustomHashSet.this.strategy.equals(IntLinkedOpenCustomHashSet.this.key[IntLinkedOpenCustomHashSet.this.last], var2)) {
            this.prev = IntLinkedOpenCustomHashSet.this.last;
            this.index = IntLinkedOpenCustomHashSet.this.size;
         } else {
            int[] var3 = IntLinkedOpenCustomHashSet.this.key;

            for(int var4 = HashCommon.mix(IntLinkedOpenCustomHashSet.this.strategy.hashCode(var2)) & IntLinkedOpenCustomHashSet.this.mask; var3[var4] != 0; var4 = var4 + 1 & IntLinkedOpenCustomHashSet.this.mask) {
               if (IntLinkedOpenCustomHashSet.this.strategy.equals(var3[var4], var2)) {
                  this.next = (int)IntLinkedOpenCustomHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = IntLinkedOpenCustomHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)IntLinkedOpenCustomHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = IntLinkedOpenCustomHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (IntLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = IntLinkedOpenCustomHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (IntLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == IntLinkedOpenCustomHashSet.this.n) {
               ...
               int[] var5 = IntLinkedOpenCustomHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & IntLinkedOpenCustomHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(IntLinkedOpenCustomHashSet.this.strategy.hashCode(var4)) & IntLinkedOpenCustomHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  IntLinkedOpenCustomHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
