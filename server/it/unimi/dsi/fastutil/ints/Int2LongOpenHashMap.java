...
public class Int2LongOpenHashMap extends AbstractInt2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Int2LongOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2LongOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2LongOpenHashMap(Map<? extends Integer, ? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2LongOpenHashMap(Map<? extends Integer, ? extends Long> var1) {
      this(var1, 0.75F);
   }

   public Int2LongOpenHashMap(Int2LongMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2LongOpenHashMap(Int2LongMap var1) {
      this(var1, 0.75F);
   }

   public Int2LongOpenHashMap(int[] var1, long[] var2, float var3) {
   ...
   public Int2LongOpenHashMap(int[] var1, long[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Int2LongOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Int2LongOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n]);
               }

               int var2 = Int2LongOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2LongOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2LongOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2LongOpenHashMap clone() {
      Int2LongOpenHashMap var1;
      try {
         var1 = (Int2LongOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      long[] var3 = this.value;
      Int2LongOpenHashMap.MapIterator var4 = new Int2LongOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2LongOpenHashMap.this.containsNullKey) {
            var1.accept(Int2LongOpenHashMap.this.key[Int2LongOpenHashMap.this.n]);
         }

         int var2 = Int2LongOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2LongOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2LongOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2LongOpenHashMap.this.size;
         Int2LongOpenHashMap.this.remove(var1);
         return Int2LongOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (var3 == 0) {
                     return Int2LongOpenHashMap.this.containsNullKey && Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n] == var4;
                  } else {
                     int[] var7 = Int2LongOpenHashMap.this.key;
                     int var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Int2LongOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var6) {
                        return Int2LongOpenHashMap.this.value[var8] == var4;
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Int2LongOpenHashMap.this.mask]) != 0) {
                           if (var3 == var6) {
                              return Int2LongOpenHashMap.this.value[var8] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var4 = (Long)var2.getValue();
                  if (var3 == 0) {
                     if (Int2LongOpenHashMap.this.containsNullKey && Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n] == var4) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Int2LongOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Int2LongOpenHashMap.this.value[var8] == var4) {
                           Int2LongOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Int2LongOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var6 != var3 || Int2LongOpenHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Int2LongMap.Entry> var1) {
         if (Int2LongOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2LongMap.BasicEntry(Int2LongOpenHashMap.this.key[Int2LongOpenHashMap.this.n], Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2LongOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2LongMap.BasicEntry(Int2LongOpenHashMap.this.key[var2], Int2LongOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2LongMap.Entry> var1) {
         ...
         if (Int2LongOpenHashMap.this.containsNullKey) {
            var2.key = Int2LongOpenHashMap.this.key[Int2LongOpenHashMap.this.n];
            var2.value = Int2LongOpenHashMap.this.value[Int2LongOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2LongOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2LongOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2LongOpenHashMap.this.key[var3];
               var2.value = Int2LongOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2LongOpenHashMap.MapIterator implements ObjectIterator<Int2LongMap.Entry> {
      private final Int2LongOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2LongOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2LongOpenHashMap.MapIterator implements ObjectIterator<Int2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      private MapIterator() {
         super();
         this.pos = Int2LongOpenHashMap.this.n;
         this.last = -1;
         this.c = Int2LongOpenHashMap.this.size;
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2LongOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2LongOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2LongOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2LongOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2LongOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2LongOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2LongOpenHashMap.this.value[var2] = Int2LongOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2LongMap.Entry, java.util.Map.Entry<Integer, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Int2LongOpenHashMap.this.value[this.index];
         Int2LongOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2LongOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Int2LongOpenHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
