...
public class Int2FloatArrayMap extends AbstractInt2FloatMap implements Serializable, Cloneable {
   ...
   public Int2FloatArrayMap(int[] var1, float[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Int2FloatArrayMap(int var1) {
      super();
      this.key = new int[var1];
      this.value = new float[var1];
   }

   public Int2FloatArrayMap(Int2FloatMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2FloatArrayMap(Map<? extends Integer, ? extends Float> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2FloatArrayMap(int[] var1, float[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public IntSet keySet() {
      return new AbstractIntSet() {
         public boolean contains(int var1) {
            return Int2FloatArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(int var1) {
            int var2 = Int2FloatArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Int2FloatArrayMap.this.size - var2 - 1;
               System.arraycopy(Int2FloatArrayMap.this.key, var2 + 1, Int2FloatArrayMap.this.key, var2, var3);
               System.arraycopy(Int2FloatArrayMap.this.value, var2 + 1, Int2FloatArrayMap.this.value, var2, var3);
            ...
            return new IntIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Int2FloatArrayMap.this.size - this.pos;
                     System.arraycopy(Int2FloatArrayMap.this.key, this.pos, Int2FloatArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Int2FloatArrayMap.this.value, this.pos, Int2FloatArrayMap.this.value, this.pos - 1, var1);
                     Int2FloatArrayMap.this.size--;
                  }
               }
            };
   ...
   public FloatCollection values() {
      return new AbstractFloatCollection() {
         public boolean contains(float var1) {
            return Int2FloatArrayMap.this.containsValue(var1);
         }
   ...
   public Int2FloatArrayMap clone() {
      Int2FloatArrayMap var1;
      try {
         var1 = (Int2FloatArrayMap)super.clone();
         ...
         return new ObjectIterator<Int2FloatMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Int2FloatArrayMap.this.size-- - this.next--;
                  System.arraycopy(Int2FloatArrayMap.this.key, this.next + 1, Int2FloatArrayMap.this.key, this.next, var1);
                  System.arraycopy(Int2FloatArrayMap.this.value, this.next + 1, Int2FloatArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  return Int2FloatArrayMap.this.containsKey(var3) && Float.floatToIntBits(Int2FloatArrayMap.this.get(var3)) == Float.floatToIntBits((Float)var2.getValue());
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  int var5 = Int2FloatArrayMap.this.findKey(var3);
                  if (var5 != -1 && Float.floatToIntBits(var4) == Float.floatToIntBits(Int2FloatArrayMap.this.value[var5])) {
                     int var6 = Int2FloatArrayMap.this.size - var5 - 1;
                     System.arraycopy(Int2FloatArrayMap.this.key, var5 + 1, Int2FloatArrayMap.this.key, var5, var6);
                     System.arraycopy(Int2FloatArrayMap.this.value, var5 + 1, Int2FloatArrayMap.this.value, var5, var6);
                     Int2FloatArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
