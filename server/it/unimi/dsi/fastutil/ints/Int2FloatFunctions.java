...
public final class Int2FloatFunctions {
   ...
   public static Int2FloatFunction singleton(int var0, float var1) {
      return new Int2FloatFunctions.Singleton(var0, var1);
   }

   public static Int2FloatFunction singleton(Integer var0, Float var1) {
      return new Int2FloatFunctions.Singleton(var0, var1);
   }

   public static Int2FloatFunction synchronize(Int2FloatFunction var0) {
      return new Int2FloatFunctions.SynchronizedFunction(var0);
   }

   public static Int2FloatFunction synchronize(Int2FloatFunction var0, Object var1) {
      return new Int2FloatFunctions.SynchronizedFunction(var0, var1);
   }

   public static Int2FloatFunction unmodifiable(Int2FloatFunction var0) {
      return new Int2FloatFunctions.UnmodifiableFunction(var0);
   }

   public static Int2FloatFunction primitive(Function<? super Integer, ? extends Float> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Int2FloatFunction) {
         return (Int2FloatFunction)var0;
      } else {
         return (Int2FloatFunction)(var0 instanceof IntToDoubleFunction ? (var1) -> {
            return SafeMath.safeDoubleToFloat(((IntToDoubleFunction)var0).applyAsDouble(var1));
         } : new Int2FloatFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class PrimitiveFunction implements Int2FloatFunction {
      ...
      protected PrimitiveFunction(Function<? super Integer, ? extends Float> var1) {
         super();
         this.function = var1;
      }
      ...
      public Float get(Object var1) {
         return var1 == null ? null : (Float)this.function.apply((Integer)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractInt2FloatFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Int2FloatFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Int2FloatFunction, Serializable {
      ...
      protected SynchronizedFunction(Int2FloatFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Int2FloatFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Float apply(Integer var1) {
         synchronized(this.sync) {
