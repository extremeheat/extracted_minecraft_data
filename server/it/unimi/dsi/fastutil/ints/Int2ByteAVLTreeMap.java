...
public class Int2ByteAVLTreeMap extends AbstractInt2ByteSortedMap implements Serializable, Cloneable {
   ...
   public Int2ByteAVLTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2ByteAVLTreeMap(Map<? extends Integer, ? extends Byte> var1) {
      this();
      this.putAll(var1);
   }

   public Int2ByteAVLTreeMap(SortedMap<Integer, Byte> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2ByteAVLTreeMap(Int2ByteMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2ByteAVLTreeMap(Int2ByteSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2ByteAVLTreeMap(int[] var1, byte[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2ByteAVLTreeMap(int[] var1, byte[] var2) {
   ...
   final Int2ByteAVLTreeMap.Entry findKey(int var1) {
      Int2ByteAVLTreeMap.Entry var2;
      int var3;
   ...
   final Int2ByteAVLTreeMap.Entry locateKey(int var1) {
      Int2ByteAVLTreeMap.Entry var2 = this.tree;
      Int2ByteAVLTreeMap.Entry var3 = this.tree;
   ...
   public byte addTo(int var1, byte var2) {
      Int2ByteAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Int2ByteAVLTreeMap.Entry add(int var1) {
      this.modified = false;
      Int2ByteAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Int2ByteAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Int2ByteAVLTreeMap.Entry var3 = this.tree;
         Int2ByteAVLTreeMap.Entry var4 = null;
         Int2ByteAVLTreeMap.Entry var5 = this.tree;
         Int2ByteAVLTreeMap.Entry var6 = null;
         Int2ByteAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Int2ByteAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Int2ByteAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Int2ByteAVLTreeMap.Entry parent(Int2ByteAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Int2ByteAVLTreeMap.Entry var3 = var1;

         Int2ByteAVLTreeMap.Entry var2;
         Int2ByteAVLTreeMap.Entry var4;
   ...
   public byte remove(int var1) {
      ...
      if (this.tree == null) {
         ...
         Int2ByteAVLTreeMap.Entry var7;
         Int2ByteAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
   ...
   public boolean containsValue(byte var1) {
      Int2ByteAVLTreeMap.ValueIterator var2 = new Int2ByteAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public byte get(int var1) {
      Int2ByteAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
            final Comparator<? super Int2ByteMap.Entry> comparator = (var1x, var2) -> {
               return Int2ByteAVLTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry var1) {
               return Int2ByteAVLTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        Int2ByteAVLTreeMap.Entry var3 = Int2ByteAVLTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        ...
                        if (var3 != null && var3.getByteValue() == (Byte)var2.getValue()) {
                           Int2ByteAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry var1, Int2ByteMap.Entry var2) {
               return Int2ByteAVLTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2ByteEntrySet();
            }

            public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry var1) {
               return Int2ByteAVLTreeMap.this.headMap(var1.getIntKey()).int2ByteEntrySet();
            }

            public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry var1) {
               return Int2ByteAVLTreeMap.this.tailMap(var1.getIntKey()).int2ByteEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Int2ByteAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Int2ByteSortedMap headMap(int var1) {
      return new Int2ByteAVLTreeMap.Submap(0, true, var1, false);
   }

   public Int2ByteSortedMap tailMap(int var1) {
      return new Int2ByteAVLTreeMap.Submap(var1, false, 0, true);
   }

   public Int2ByteSortedMap subMap(int var1, int var2) {
      return new Int2ByteAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Int2ByteAVLTreeMap clone() {
      Int2ByteAVLTreeMap var1;
      try {
         var1 = (Int2ByteAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2ByteAVLTreeMap.Entry var5 = new Int2ByteAVLTreeMap.Entry();
         Int2ByteAVLTreeMap.Entry var6 = new Int2ByteAVLTreeMap.Entry();
         Int2ByteAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2ByteAVLTreeMap.Entry var4 = var6;
         var6.pred((Int2ByteAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2ByteAVLTreeMap.EntryIterator var3 = new Int2ByteAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2ByteAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2ByteAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2ByteAVLTreeMap.Entry var3, Int2ByteAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2ByteAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2ByteAVLTreeMap.Entry(var1.readInt(), var1.readByte());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Int2ByteAVLTreeMap.Entry(var1.readInt(), var1.readByte());
         var8.right(new Int2ByteAVLTreeMap.Entry(var1.readInt(), var1.readByte()));
         ...
         Int2ByteAVLTreeMap.Entry var7 = new Int2ByteAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2ByteAVLTreeMap.Entry)null, (Int2ByteAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2ByteSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2ByteAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2ByteAVLTreeMap.Submap.SubmapIterator var1 = new Int2ByteAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2ByteAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2ByteAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2ByteAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(byte var1) {
         Int2ByteAVLTreeMap.Submap.SubmapIterator var2 = new Int2ByteAVLTreeMap.Submap.SubmapIterator();
      ...
      public byte get(int var1) {
         Int2ByteAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2ByteAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public byte put(int var1, byte var2) {
         ...
         if (!this.in(var1)) {
            ...
            byte var3 = Int2ByteAVLTreeMap.this.put(var1, var2);
            return Int2ByteAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public byte remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            byte var2 = Int2ByteAVLTreeMap.this.remove(var1);
            return Int2ByteAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2ByteSortedMap headMap(int var1) {
         if (this.top) {
            return Int2ByteAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2ByteAVLTreeMap.this.compare(var1, this.to) < 0 ? Int2ByteAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2ByteSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2ByteAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2ByteAVLTreeMap.this.compare(var1, this.from) > 0 ? Int2ByteAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2ByteSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2ByteAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2ByteAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2ByteAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2ByteAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2ByteAVLTreeMap.Entry firstEntry() {
         if (Int2ByteAVLTreeMap.this.tree == null) {
            ...
            Int2ByteAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2ByteAVLTreeMap.this.firstEntry;
            } else {
               var1 = Int2ByteAVLTreeMap.this.locateKey(this.from);
               if (Int2ByteAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2ByteAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2ByteAVLTreeMap.Entry lastEntry() {
         if (Int2ByteAVLTreeMap.this.tree == null) {
            ...
            Int2ByteAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2ByteAVLTreeMap.this.lastEntry;
            } else {
               var1 = Int2ByteAVLTreeMap.this.locateKey(this.to);
               if (Int2ByteAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2ByteAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2ByteAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2ByteAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2ByteAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2ByteMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2ByteAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2ByteAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2ByteAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2ByteAVLTreeMap.this.locateKey(var2);
                  if (Int2ByteAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2ByteSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2ByteAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2ByteAVLTreeMap.TreeIterator implements ObjectListIterator<Int2ByteMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Int2ByteMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Int2ByteMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2ByteAVLTreeMap.this.locateKey(var2)) != null) {
            if (Int2ByteAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2ByteMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2ByteAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2ByteAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2ByteAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2ByteAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2ByteAVLTreeMap.Entry next() {
         Int2ByteAVLTreeMap.Entry var1 = this.right;
      ...
      Int2ByteAVLTreeMap.Entry prev() {
         Int2ByteAVLTreeMap.Entry var1 = this.left;
      ...
      public Int2ByteAVLTreeMap.Entry clone() {
         Int2ByteAVLTreeMap.Entry var1;
         try {
            var1 = (Int2ByteAVLTreeMap.Entry)super.clone();
