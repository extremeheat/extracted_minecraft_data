...
public class Int2BooleanAVLTreeMap extends AbstractInt2BooleanSortedMap implements Serializable, Cloneable {
   ...
   public Int2BooleanAVLTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2BooleanAVLTreeMap(Map<? extends Integer, ? extends Boolean> var1) {
      this();
      this.putAll(var1);
   }

   public Int2BooleanAVLTreeMap(SortedMap<Integer, Boolean> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2BooleanAVLTreeMap(Int2BooleanMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2BooleanAVLTreeMap(Int2BooleanSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2BooleanAVLTreeMap(int[] var1, boolean[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2BooleanAVLTreeMap(int[] var1, boolean[] var2) {
   ...
   final Int2BooleanAVLTreeMap.Entry findKey(int var1) {
      Int2BooleanAVLTreeMap.Entry var2;
      int var3;
   ...
   final Int2BooleanAVLTreeMap.Entry locateKey(int var1) {
      Int2BooleanAVLTreeMap.Entry var2 = this.tree;
      Int2BooleanAVLTreeMap.Entry var3 = this.tree;
   ...
   public boolean put(int var1, boolean var2) {
      Int2BooleanAVLTreeMap.Entry var3 = this.add(var1);
      boolean var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Int2BooleanAVLTreeMap.Entry add(int var1) {
      this.modified = false;
      Int2BooleanAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Int2BooleanAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Int2BooleanAVLTreeMap.Entry var3 = this.tree;
         Int2BooleanAVLTreeMap.Entry var4 = null;
         Int2BooleanAVLTreeMap.Entry var5 = this.tree;
         Int2BooleanAVLTreeMap.Entry var6 = null;
         Int2BooleanAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Int2BooleanAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Int2BooleanAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Int2BooleanAVLTreeMap.Entry parent(Int2BooleanAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Int2BooleanAVLTreeMap.Entry var3 = var1;

         Int2BooleanAVLTreeMap.Entry var2;
         Int2BooleanAVLTreeMap.Entry var4;
   ...
   public boolean remove(int var1) {
      ...
      if (this.tree == null) {
         ...
         Int2BooleanAVLTreeMap.Entry var7;
         Int2BooleanAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Int2BooleanAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(boolean var1) {
      Int2BooleanAVLTreeMap.ValueIterator var2 = new Int2BooleanAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public boolean get(int var1) {
      Int2BooleanAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
            final Comparator<? super Int2BooleanMap.Entry> comparator = (var1x, var2) -> {
               return Int2BooleanAVLTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry var1) {
               return Int2BooleanAVLTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        Int2BooleanAVLTreeMap.Entry var3 = Int2BooleanAVLTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        ...
                        if (var3 != null && var3.getBooleanValue() == (Boolean)var2.getValue()) {
                           Int2BooleanAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry var1, Int2BooleanMap.Entry var2) {
               return Int2BooleanAVLTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2BooleanEntrySet();
            }

            public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry var1) {
               return Int2BooleanAVLTreeMap.this.headMap(var1.getIntKey()).int2BooleanEntrySet();
            }

            public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry var1) {
               return Int2BooleanAVLTreeMap.this.tailMap(var1.getIntKey()).int2BooleanEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Int2BooleanAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Int2BooleanSortedMap headMap(int var1) {
      return new Int2BooleanAVLTreeMap.Submap(0, true, var1, false);
   }

   public Int2BooleanSortedMap tailMap(int var1) {
      return new Int2BooleanAVLTreeMap.Submap(var1, false, 0, true);
   }

   public Int2BooleanSortedMap subMap(int var1, int var2) {
      return new Int2BooleanAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Int2BooleanAVLTreeMap clone() {
      Int2BooleanAVLTreeMap var1;
      try {
         var1 = (Int2BooleanAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2BooleanAVLTreeMap.Entry var5 = new Int2BooleanAVLTreeMap.Entry();
         Int2BooleanAVLTreeMap.Entry var6 = new Int2BooleanAVLTreeMap.Entry();
         Int2BooleanAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2BooleanAVLTreeMap.Entry var4 = var6;
         var6.pred((Int2BooleanAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2BooleanAVLTreeMap.EntryIterator var3 = new Int2BooleanAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2BooleanAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2BooleanAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2BooleanAVLTreeMap.Entry var3, Int2BooleanAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2BooleanAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2BooleanAVLTreeMap.Entry(var1.readInt(), var1.readBoolean());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Int2BooleanAVLTreeMap.Entry(var1.readInt(), var1.readBoolean());
         var8.right(new Int2BooleanAVLTreeMap.Entry(var1.readInt(), var1.readBoolean()));
         ...
         Int2BooleanAVLTreeMap.Entry var7 = new Int2BooleanAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2BooleanAVLTreeMap.Entry)null, (Int2BooleanAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2BooleanSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2BooleanAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2BooleanAVLTreeMap.Submap.SubmapIterator var1 = new Int2BooleanAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2BooleanAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2BooleanAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2BooleanAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(boolean var1) {
         Int2BooleanAVLTreeMap.Submap.SubmapIterator var2 = new Int2BooleanAVLTreeMap.Submap.SubmapIterator();
      ...
      public boolean get(int var1) {
         Int2BooleanAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2BooleanAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public boolean put(int var1, boolean var2) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var3 = Int2BooleanAVLTreeMap.this.put(var1, var2);
            return Int2BooleanAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public boolean remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var2 = Int2BooleanAVLTreeMap.this.remove(var1);
            return Int2BooleanAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2BooleanSortedMap headMap(int var1) {
         if (this.top) {
            return Int2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2BooleanAVLTreeMap.this.compare(var1, this.to) < 0 ? Int2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2BooleanSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2BooleanAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2BooleanAVLTreeMap.this.compare(var1, this.from) > 0 ? Int2BooleanAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2BooleanSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2BooleanAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2BooleanAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2BooleanAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2BooleanAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2BooleanAVLTreeMap.Entry firstEntry() {
         if (Int2BooleanAVLTreeMap.this.tree == null) {
            ...
            Int2BooleanAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2BooleanAVLTreeMap.this.firstEntry;
            } else {
               var1 = Int2BooleanAVLTreeMap.this.locateKey(this.from);
               if (Int2BooleanAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2BooleanAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2BooleanAVLTreeMap.Entry lastEntry() {
         if (Int2BooleanAVLTreeMap.this.tree == null) {
            ...
            Int2BooleanAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2BooleanAVLTreeMap.this.lastEntry;
            } else {
               var1 = Int2BooleanAVLTreeMap.this.locateKey(this.to);
               if (Int2BooleanAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2BooleanAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2BooleanAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2BooleanAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2BooleanAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2BooleanMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2BooleanAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2BooleanAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2BooleanAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2BooleanAVLTreeMap.this.locateKey(var2);
                  if (Int2BooleanAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2BooleanSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2BooleanAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2BooleanAVLTreeMap.TreeIterator implements ObjectListIterator<Int2BooleanMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2BooleanAVLTreeMap.this.locateKey(var2)) != null) {
            if (Int2BooleanAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2BooleanMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2BooleanAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2BooleanAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2BooleanAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2BooleanAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2BooleanAVLTreeMap.Entry next() {
         Int2BooleanAVLTreeMap.Entry var1 = this.right;
      ...
      Int2BooleanAVLTreeMap.Entry prev() {
         Int2BooleanAVLTreeMap.Entry var1 = this.left;
      ...
      public Int2BooleanAVLTreeMap.Entry clone() {
         Int2BooleanAVLTreeMap.Entry var1;
         try {
            var1 = (Int2BooleanAVLTreeMap.Entry)super.clone();
