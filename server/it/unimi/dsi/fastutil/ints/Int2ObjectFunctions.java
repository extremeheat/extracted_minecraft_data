...
public final class Int2ObjectFunctions {
   ...
   public static <V> Int2ObjectFunction<V> singleton(int var0, V var1) {
      return new Int2ObjectFunctions.Singleton(var0, var1);
   }

   public static <V> Int2ObjectFunction<V> singleton(Integer var0, V var1) {
      return new Int2ObjectFunctions.Singleton(var0, var1);
   }

   public static <V> Int2ObjectFunction<V> synchronize(Int2ObjectFunction<V> var0) {
      return new Int2ObjectFunctions.SynchronizedFunction(var0);
   }

   public static <V> Int2ObjectFunction<V> synchronize(Int2ObjectFunction<V> var0, Object var1) {
      return new Int2ObjectFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Int2ObjectFunction<V> unmodifiable(Int2ObjectFunction<V> var0) {
      return new Int2ObjectFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Int2ObjectFunction<V> primitive(Function<? super Integer, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Int2ObjectFunction) {
         return (Int2ObjectFunction)var0;
         ...
         return new Int2ObjectFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class UnmodifiableFunction<V> extends AbstractInt2ObjectFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Int2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Int2ObjectFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Int2ObjectFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Int2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
