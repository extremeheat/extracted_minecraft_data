...
public class Int2DoubleRBTreeMap extends AbstractInt2DoubleSortedMap implements Serializable, Cloneable {
   ...
   public Int2DoubleRBTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2DoubleRBTreeMap(Map<? extends Integer, ? extends Double> var1) {
      this();
      this.putAll(var1);
   }

   public Int2DoubleRBTreeMap(SortedMap<Integer, Double> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2DoubleRBTreeMap(Int2DoubleMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2DoubleRBTreeMap(Int2DoubleSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2DoubleRBTreeMap(int[] var1, double[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2DoubleRBTreeMap(int[] var1, double[] var2) {
   ...
   final Int2DoubleRBTreeMap.Entry findKey(int var1) {
      Int2DoubleRBTreeMap.Entry var2;
      int var3;
   ...
   final Int2DoubleRBTreeMap.Entry locateKey(int var1) {
      Int2DoubleRBTreeMap.Entry var2 = this.tree;
      Int2DoubleRBTreeMap.Entry var3 = this.tree;
   ...
   public double addTo(int var1, double var2) {
      Int2DoubleRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Int2DoubleRBTreeMap.Entry add(int var1) {
      this.modified = false;
      int var2 = 0;
      Int2DoubleRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Int2DoubleRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Int2DoubleRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Int2DoubleRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Int2DoubleRBTreeMap.Entry var7;
               Int2DoubleRBTreeMap.Entry var8;
   ...
   public boolean containsValue(double var1) {
      Int2DoubleRBTreeMap.ValueIterator var3 = new Int2DoubleRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public double get(int var1) {
      Int2DoubleRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
            final Comparator<? super Int2DoubleMap.Entry> comparator = (var1x, var2) -> {
               return Int2DoubleRBTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry var1) {
               return Int2DoubleRBTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        Int2DoubleRBTreeMap.Entry var3 = Int2DoubleRBTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        ...
                        if (var3 != null && Double.doubleToLongBits(var3.getDoubleValue()) == Double.doubleToLongBits((Double)var2.getValue())) {
                           Int2DoubleRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry var1, Int2DoubleMap.Entry var2) {
               return Int2DoubleRBTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2DoubleEntrySet();
            }

            public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry var1) {
               return Int2DoubleRBTreeMap.this.headMap(var1.getIntKey()).int2DoubleEntrySet();
            }

            public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry var1) {
               return Int2DoubleRBTreeMap.this.tailMap(var1.getIntKey()).int2DoubleEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Int2DoubleRBTreeMap.this.containsValue(var1);
            }
   ...
   public Int2DoubleSortedMap headMap(int var1) {
      return new Int2DoubleRBTreeMap.Submap(0, true, var1, false);
   }

   public Int2DoubleSortedMap tailMap(int var1) {
      return new Int2DoubleRBTreeMap.Submap(var1, false, 0, true);
   }

   public Int2DoubleSortedMap subMap(int var1, int var2) {
      return new Int2DoubleRBTreeMap.Submap(var1, false, var2, false);
   }

   public Int2DoubleRBTreeMap clone() {
      Int2DoubleRBTreeMap var1;
      try {
         var1 = (Int2DoubleRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2DoubleRBTreeMap.Entry var5 = new Int2DoubleRBTreeMap.Entry();
         Int2DoubleRBTreeMap.Entry var6 = new Int2DoubleRBTreeMap.Entry();
         Int2DoubleRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2DoubleRBTreeMap.Entry var4 = var6;
         var6.pred((Int2DoubleRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2DoubleRBTreeMap.EntryIterator var3 = new Int2DoubleRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2DoubleRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2DoubleRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2DoubleRBTreeMap.Entry var3, Int2DoubleRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2DoubleRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2DoubleRBTreeMap.Entry(var1.readInt(), var1.readDouble());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Int2DoubleRBTreeMap.Entry(var1.readInt(), var1.readDouble());
         var8.black(true);
         var8.right(new Int2DoubleRBTreeMap.Entry(var1.readInt(), var1.readDouble()));
         ...
         Int2DoubleRBTreeMap.Entry var7 = new Int2DoubleRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2DoubleRBTreeMap.Entry)null, (Int2DoubleRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2DoubleSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2DoubleRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2DoubleRBTreeMap.Submap.SubmapIterator var1 = new Int2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2DoubleRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2DoubleRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2DoubleRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(double var1) {
         Int2DoubleRBTreeMap.Submap.SubmapIterator var3 = new Int2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      public double get(int var1) {
         Int2DoubleRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2DoubleRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public double put(int var1, double var2) {
         ...
         if (!this.in(var1)) {
            ...
            double var4 = Int2DoubleRBTreeMap.this.put(var1, var2);
            return Int2DoubleRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public double remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            double var2 = Int2DoubleRBTreeMap.this.remove(var1);
            return Int2DoubleRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Int2DoubleSortedMap headMap(int var1) {
         if (this.top) {
            return Int2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2DoubleRBTreeMap.this.compare(var1, this.to) < 0 ? Int2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2DoubleSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? Int2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2DoubleSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2DoubleRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2DoubleRBTreeMap.Entry firstEntry() {
         if (Int2DoubleRBTreeMap.this.tree == null) {
            ...
            Int2DoubleRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2DoubleRBTreeMap.this.firstEntry;
            } else {
               var1 = Int2DoubleRBTreeMap.this.locateKey(this.from);
               if (Int2DoubleRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2DoubleRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2DoubleRBTreeMap.Entry lastEntry() {
         if (Int2DoubleRBTreeMap.this.tree == null) {
            ...
            Int2DoubleRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2DoubleRBTreeMap.this.lastEntry;
            } else {
               var1 = Int2DoubleRBTreeMap.this.locateKey(this.to);
               if (Int2DoubleRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2DoubleRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2DoubleRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2DoubleRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Int2DoubleRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2DoubleMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2DoubleRBTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2DoubleRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2DoubleRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2DoubleRBTreeMap.this.locateKey(var2);
                  if (Int2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractInt2DoubleSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator(int var1) {
         return Int2DoubleRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Int2DoubleRBTreeMap.TreeIterator implements ObjectListIterator<Int2DoubleMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2DoubleRBTreeMap.this.locateKey(var2)) != null) {
            if (Int2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2DoubleMap.BasicEntry implements Cloneable {
      ...
      void pred(Int2DoubleRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2DoubleRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2DoubleRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2DoubleRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2DoubleRBTreeMap.Entry next() {
         Int2DoubleRBTreeMap.Entry var1 = this.right;
      ...
      Int2DoubleRBTreeMap.Entry prev() {
         Int2DoubleRBTreeMap.Entry var1 = this.left;
      ...
      public Int2DoubleRBTreeMap.Entry clone() {
         Int2DoubleRBTreeMap.Entry var1;
         try {
            var1 = (Int2DoubleRBTreeMap.Entry)super.clone();
