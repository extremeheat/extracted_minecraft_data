...
public class Int2ObjectArrayMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Int2ObjectArrayMap(int[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Int2ObjectArrayMap(int var1) {
      super();
      this.key = new int[var1];
      this.value = new Object[var1];
   }

   public Int2ObjectArrayMap(Int2ObjectMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2ObjectArrayMap(Map<? extends Integer, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Int2ObjectArrayMap(int[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Int2ObjectMap.FastEntrySet<V> int2ObjectEntrySet() {
      return new Int2ObjectArrayMap.EntrySet();
   }
   ...
   public IntSet keySet() {
      return new AbstractIntSet() {
         public boolean contains(int var1) {
            return Int2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(int var1) {
            int var2 = Int2ObjectArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Int2ObjectArrayMap.this.size - var2 - 1;
               System.arraycopy(Int2ObjectArrayMap.this.key, var2 + 1, Int2ObjectArrayMap.this.key, var2, var3);
               System.arraycopy(Int2ObjectArrayMap.this.value, var2 + 1, Int2ObjectArrayMap.this.value, var2, var3);
            ...
            return new IntIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Int2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Int2ObjectArrayMap.this.key, this.pos, Int2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Int2ObjectArrayMap.this.value, this.pos, Int2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Int2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Int2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Int2ObjectArrayMap<V> clone() {
      Int2ObjectArrayMap var1;
      try {
         var1 = (Int2ObjectArrayMap)super.clone();
         ...
         return new ObjectIterator<Int2ObjectMap.Entry<V>>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Int2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Int2ObjectArrayMap.this.key, this.next + 1, Int2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Int2ObjectArrayMap.this.value, this.next + 1, Int2ObjectArrayMap.this.value, this.next, var1);
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               ...
               return Int2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Int2ObjectArrayMap.this.get(var3), var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               ...
               int var5 = Int2ObjectArrayMap.this.findKey(var3);
               if (var5 != -1 && Objects.equals(var4, Int2ObjectArrayMap.this.value[var5])) {
                  int var6 = Int2ObjectArrayMap.this.size - var5 - 1;
                  System.arraycopy(Int2ObjectArrayMap.this.key, var5 + 1, Int2ObjectArrayMap.this.key, var5, var6);
                  System.arraycopy(Int2ObjectArrayMap.this.value, var5 + 1, Int2ObjectArrayMap.this.value, var5, var6);
                  Int2ObjectArrayMap.this.size--;
                  Int2ObjectArrayMap.this.value[Int2ObjectArrayMap.this.size] = null;
                  return true;
               } else {
