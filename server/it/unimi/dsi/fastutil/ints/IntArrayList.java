...
public class IntArrayList extends AbstractIntList implements RandomAccess, Cloneable, Serializable {
   ...
   protected IntArrayList(int[] var1, boolean var2) {
      super();
      this.a = var1;
   }
   ...
   public IntArrayList(Collection<? extends Integer> var1) {
      this(var1.size());
      this.size = IntIterators.unwrap(IntIterators.asIntIterator(var1.iterator()), this.a);
   }

   public IntArrayList(IntCollection var1) {
      this(var1.size());
      this.size = IntIterators.unwrap(var1.iterator(), this.a);
   }

   public IntArrayList(IntList var1) {
      this(var1.size());
   ...
   public IntArrayList(int[] var1, int var2, int var3) {
      this(var3);
      System.arraycopy(var1, var2, this.a, 0, var3);
      this.size = var3;
   }

   public IntArrayList(Iterator<? extends Integer> var1) {
      this();
   ...
   public IntArrayList(IntIterator var1) {
      this();
   ...
   public static IntArrayList wrap(int[] var0, int var1) {
      if (var1 > var0.length) {
         throw new IllegalArgumentException("The specified length (" + var1 + ") is greater than the array size (" + var0.length + ")");
      } else {
         IntArrayList var2 = new IntArrayList(var0, false);
         var2.size = var1;
         return var2;
      }
   }

   public static IntArrayList wrap(int[] var0) {
      return wrap(var0, var0.length);
   }

   public void ensureCapacity(int var1) {
      if (var1 > this.a.length && this.a != IntArrays.DEFAULT_EMPTY_ARRAY) {
         this.a = IntArrays.ensureCapacity(this.a, var1, this.size);
   ...
   private void grow(int var1) {
      if (var1 > this.a.length) {
         ...
         this.a = IntArrays.forceCapacity(this.a, var1, this.size);
   ...
   public void size(int var1) {
      ...
      if (var1 > this.size) {
         Arrays.fill(this.a, this.size, var1, 0);
      }
   ...
   public void trim(int var1) {
      if (var1 < this.a.length && this.size != this.a.length) {
         int[] var2 = new int[Math.max(var1, this.size)];
   ...
   public boolean addAll(int var1, IntCollection var2) {
      ...
      if (var3 == 0) {
         ...
         for(this.size += var3; var3-- != 0; this.a[var1++] = var4.nextInt()) {
         }
   ...
   public IntListIterator listIterator(final int var1) {
      ...
      return new IntListIterator() {
         ...
         public void add(int var1x) {
            IntArrayList.this.add(this.pos++, var1x);
            this.last = -1;
         }
         ...
         public void set(int var1x) {
            if (this.last == -1) {
               ...
               IntArrayList.this.set(this.last, var1x);
            }
         }
   ...
   public boolean equals(IntArrayList var1) {
      if (var1 == this) {
         return true;
      } else {
         int var2 = this.size();
   ...
   public int compareTo(IntArrayList var1) {
      int var2 = this.size();
      int var3 = var1.size();
      int[] var4 = this.a;
      int[] var5 = var1.a;
      ...
      for(var9 = 0; var9 < var2 && var9 < var3; ++var9) {
         ...
         int var7 = var5[var9];
         int var8;
         if ((var8 = Integer.compare(var6, var7)) != 0) {
            return var8;
         }
      }
