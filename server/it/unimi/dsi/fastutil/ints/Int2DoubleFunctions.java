...
public final class Int2DoubleFunctions {
   ...
   public static Int2DoubleFunction singleton(int var0, double var1) {
      return new Int2DoubleFunctions.Singleton(var0, var1);
   }

   public static Int2DoubleFunction singleton(Integer var0, Double var1) {
      return new Int2DoubleFunctions.Singleton(var0, var1);
   }

   public static Int2DoubleFunction synchronize(Int2DoubleFunction var0) {
      return new Int2DoubleFunctions.SynchronizedFunction(var0);
   }

   public static Int2DoubleFunction synchronize(Int2DoubleFunction var0, Object var1) {
      return new Int2DoubleFunctions.SynchronizedFunction(var0, var1);
   }

   public static Int2DoubleFunction unmodifiable(Int2DoubleFunction var0) {
      return new Int2DoubleFunctions.UnmodifiableFunction(var0);
   }

   public static Int2DoubleFunction primitive(Function<? super Integer, ? extends Double> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Int2DoubleFunction) {
         return (Int2DoubleFunction)var0;
         ...
         return new Int2DoubleFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Int2DoubleFunction {
      ...
      protected PrimitiveFunction(Function<? super Integer, ? extends Double> var1) {
         super();
         this.function = var1;
      }
      ...
      public Double get(Object var1) {
         return var1 == null ? null : (Double)this.function.apply((Integer)var1);
      }

      /** @deprecated */
      @Deprecated
      public Double put(Integer var1, Double var2) {
   ...
   public static class UnmodifiableFunction extends AbstractInt2DoubleFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Int2DoubleFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Int2DoubleFunction, Serializable {
      ...
      protected SynchronizedFunction(Int2DoubleFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Int2DoubleFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Double apply(Integer var1) {
         synchronized(this.sync) {
