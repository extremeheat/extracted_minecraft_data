...
public class Int2CharOpenCustomHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Int2CharOpenCustomHashMap(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Int2CharOpenCustomHashMap(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2CharOpenCustomHashMap(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Int2CharOpenCustomHashMap(Map<? extends Integer, ? extends Character> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2CharOpenCustomHashMap(Map<? extends Integer, ? extends Character> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2CharOpenCustomHashMap(Int2CharMap var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2CharOpenCustomHashMap(Int2CharMap var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2CharOpenCustomHashMap(int[] var1, char[] var2, float var3, IntHash.Strategy var4) {
   ...
   public Int2CharOpenCustomHashMap(int[] var1, char[] var2, IntHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Int2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.IntConsumer var1) {
               if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Int2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2CharOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Int2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2CharOpenCustomHashMap clone() {
      Int2CharOpenCustomHashMap var1;
      try {
         var1 = (Int2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      char[] var3 = this.value;
      Int2CharOpenCustomHashMap.MapIterator var4 = new Int2CharOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Int2CharOpenCustomHashMap.MapIterator implements CharIterator {
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Int2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2CharOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2CharOpenCustomHashMap.this.size;
         Int2CharOpenCustomHashMap.this.remove(var1);
         return Int2CharOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Int2CharOpenCustomHashMap.MapIterator implements IntIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Int2CharOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     return Int2CharOpenCustomHashMap.this.containsNullKey && Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2CharOpenCustomHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Int2CharOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2CharOpenCustomHashMap.this.mask]) != 0) {
                           if (Int2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Int2CharOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (Int2CharOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     if (Int2CharOpenCustomHashMap.this.containsNullKey && Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2CharOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Int2CharOpenCustomHashMap.this.value[var7] == var4) {
                           Int2CharOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2CharOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Int2CharOpenCustomHashMap.this.strategy.equals(var5, var3) || Int2CharOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2CharMap.Entry> var1) {
         if (Int2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2CharMap.BasicEntry(Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.n], Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2CharOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2CharMap.BasicEntry(Int2CharOpenCustomHashMap.this.key[var2], Int2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2CharMap.Entry> var1) {
         ...
         if (Int2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.n];
            var2.value = Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Int2CharOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Int2CharOpenCustomHashMap.this.key[var3];
               var2.value = Int2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Int2CharMap.Entry> {
      private final Int2CharOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Int2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2CharOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Int2CharOpenCustomHashMap.this.mask; !Int2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Int2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Int2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2CharOpenCustomHashMap.this.value[var2] = Int2CharOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2CharMap.Entry, java.util.Map.Entry<Integer, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Int2CharOpenCustomHashMap.this.value[this.index];
         Int2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2CharOpenCustomHashMap.this.strategy.equals(Int2CharOpenCustomHashMap.this.key[this.index], (Integer)var2.getKey()) && Int2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
