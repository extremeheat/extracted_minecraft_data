...
public class Int2ShortOpenHashMap extends AbstractInt2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Int2ShortOpenHashMap(int var1, float var2) {
      super();
   ...
   public Int2ShortOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Int2ShortOpenHashMap(Map<? extends Integer, ? extends Short> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2ShortOpenHashMap(Map<? extends Integer, ? extends Short> var1) {
      this(var1, 0.75F);
   }

   public Int2ShortOpenHashMap(Int2ShortMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Int2ShortOpenHashMap(Int2ShortMap var1) {
      this(var1, 0.75F);
   }

   public Int2ShortOpenHashMap(int[] var1, short[] var2, float var3) {
   ...
   public Int2ShortOpenHashMap(int[] var1, short[] var2) {
   ...
   public Int2ShortMap.FastEntrySet int2ShortEntrySet() {
      if (this.entries == null) {
         this.entries = new Int2ShortOpenHashMap.MapEntrySet();
      }
   ...
   public IntSet keySet() {
      if (this.keys == null) {
         this.keys = new Int2ShortOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            public ShortIterator iterator() {
               return Int2ShortOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(short var1) {
               return Int2ShortOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.IntConsumer var1) {
               if (Int2ShortOpenHashMap.this.containsNullKey) {
                  var1.accept(Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n]);
               }

               int var2 = Int2ShortOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2ShortOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Int2ShortOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2ShortOpenHashMap clone() {
      Int2ShortOpenHashMap var1;
      try {
         var1 = (Int2ShortOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      short[] var3 = this.value;
      Int2ShortOpenHashMap.MapIterator var4 = new Int2ShortOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Int2ShortOpenHashMap.MapIterator implements ShortIterator {
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntIterator iterator() {
         return Int2ShortOpenHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2ShortOpenHashMap.this.containsNullKey) {
            var1.accept(Int2ShortOpenHashMap.this.key[Int2ShortOpenHashMap.this.n]);
         }

         int var2 = Int2ShortOpenHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2ShortOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2ShortOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2ShortOpenHashMap.this.size;
         Int2ShortOpenHashMap.this.remove(var1);
         return Int2ShortOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Int2ShortOpenHashMap.MapIterator implements IntIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements Int2ShortMap.FastEntrySet {
      ...
      public ObjectIterator<Int2ShortMap.Entry> iterator() {
         return Int2ShortOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Int2ShortMap.Entry> fastIterator() {
         return Int2ShortOpenHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (var3 == 0) {
                     return Int2ShortOpenHashMap.this.containsNullKey && Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n] == var4;
                  } else {
                     int[] var6 = Int2ShortOpenHashMap.this.key;
                     int var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2ShortOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Int2ShortOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Int2ShortOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Int2ShortOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (var3 == 0) {
                     if (Int2ShortOpenHashMap.this.containsNullKey && Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Int2ShortOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Int2ShortOpenHashMap.this.value[var7] == var4) {
                           Int2ShortOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Int2ShortOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Int2ShortOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Int2ShortMap.Entry> var1) {
         if (Int2ShortOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortOpenHashMap.this.key[Int2ShortOpenHashMap.this.n], Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2ShortOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2ShortMap.BasicEntry(Int2ShortOpenHashMap.this.key[var2], Int2ShortOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Int2ShortMap.Entry> var1) {
         ...
         if (Int2ShortOpenHashMap.this.containsNullKey) {
            var2.key = Int2ShortOpenHashMap.this.key[Int2ShortOpenHashMap.this.n];
            var2.value = Int2ShortOpenHashMap.this.value[Int2ShortOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2ShortOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Int2ShortOpenHashMap.this.key[var3] != 0) {
               var2.key = Int2ShortOpenHashMap.this.key[var3];
               var2.value = Int2ShortOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2ShortOpenHashMap.MapIterator implements ObjectIterator<Int2ShortMap.Entry> {
      private final Int2ShortOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2ShortOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2ShortOpenHashMap.MapIterator implements ObjectIterator<Int2ShortMap.Entry> {
      ...
      public Int2ShortOpenHashMap.MapEntry next() {
         return this.entry = Int2ShortOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2ShortOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Int2ShortOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Int2ShortOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2ShortOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2ShortOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Int2ShortOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2ShortOpenHashMap.this.value[var2] = Int2ShortOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2ShortMap.Entry, java.util.Map.Entry<Integer, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Int2ShortOpenHashMap.this.value[this.index];
         Int2ShortOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2ShortOpenHashMap.this.key[this.index] == (Integer)var2.getKey() && Int2ShortOpenHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
