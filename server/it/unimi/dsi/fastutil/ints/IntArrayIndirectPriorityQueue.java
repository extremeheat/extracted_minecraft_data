...
public class IntArrayIndirectPriorityQueue implements IntIndirectPriorityQueue {
   ...
   public IntArrayIndirectPriorityQueue(int[] var1, int var2, IntComparator var3) {
      super();
   ...
   public IntArrayIndirectPriorityQueue(int[] var1, int var2) {
      this(var1, var2, (IntComparator)null);
   }

   public IntArrayIndirectPriorityQueue(int[] var1, IntComparator var2) {
      this(var1, var1.length, var2);
   }

   public IntArrayIndirectPriorityQueue(int[] var1) {
      this(var1, var1.length, (IntComparator)null);
   }

   public IntArrayIndirectPriorityQueue(int[] var1, int[] var2, int var3, IntComparator var4) {
      this(var1, 0, var4);
      this.array = var2;
      this.size = var3;
   }
   ...
   public IntArrayIndirectPriorityQueue(int[] var1, int[] var2, int var3) {
   ...
   private int findFirst() {
      if (this.firstIndexValid) {
         ...
         --var1;
         int var2 = var1;
         int var3 = this.refArray[this.array[var1]];
         if (this.c == null) {
            while(var1-- != 0) {
   ...
   public int front(int[] var1) {
      int var2 = this.refArray[this.array[this.findFirst()]];
      int var3 = this.size;
      int var4 = 0;
