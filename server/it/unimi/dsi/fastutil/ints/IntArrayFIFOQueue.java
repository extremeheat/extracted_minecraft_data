...
public class IntArrayFIFOQueue implements IntPriorityQueue, Serializable {
   ...
   public int dequeueInt() {
      if (this.start == this.end) {
         ...
         int var1 = this.array[this.start];
   ...
   public void enqueueFirst(int var1) {
      if (this.start == 0) {
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.array = new int[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
