...
public class Int2LongOpenCustomHashMap extends AbstractInt2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Int2LongOpenCustomHashMap(int var1, float var2, IntHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Int2LongOpenCustomHashMap(int var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2LongOpenCustomHashMap(IntHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Int2LongOpenCustomHashMap(Map<? extends Integer, ? extends Long> var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2LongOpenCustomHashMap(Map<? extends Integer, ? extends Long> var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2LongOpenCustomHashMap(Int2LongMap var1, float var2, IntHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Int2LongOpenCustomHashMap(Int2LongMap var1, IntHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Int2LongOpenCustomHashMap(int[] var1, long[] var2, float var3, IntHash.Strategy var4) {
   ...
   public Int2LongOpenCustomHashMap(int[] var1, long[] var2, IntHash.Strategy var3) {
   ...
   private void insert(int var1, int var2, long var3) {
      if (var1 == this.n) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Int2LongOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Int2LongOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n]);
               }

               int var2 = Int2LongOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Int2LongOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Int2LongOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Int2LongOpenCustomHashMap clone() {
      Int2LongOpenCustomHashMap var1;
      try {
         var1 = (Int2LongOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int[] var2 = this.key;
      long[] var3 = this.value;
      Int2LongOpenCustomHashMap.MapIterator var4 = new Int2LongOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Int2LongOpenCustomHashMap.MapIterator implements LongIterator {
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public void forEach(java.util.function.IntConsumer var1) {
         if (Int2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Int2LongOpenCustomHashMap.this.key[Int2LongOpenCustomHashMap.this.n]);
         }

         int var2 = Int2LongOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            int var3 = Int2LongOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(int var1) {
         return Int2LongOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(int var1) {
         int var2 = Int2LongOpenCustomHashMap.this.size;
         Int2LongOpenCustomHashMap.this.remove(var1);
         return Int2LongOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Int2LongOpenCustomHashMap.MapIterator implements IntIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (Int2LongOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     return Int2LongOpenCustomHashMap.this.containsNullKey && Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n] == var4;
                  } else {
                     int[] var7 = Int2LongOpenCustomHashMap.this.key;
                     int var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2LongOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2LongOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Int2LongOpenCustomHashMap.this.value[var8] == var4;
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Int2LongOpenCustomHashMap.this.mask]) != 0) {
                           if (Int2LongOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Int2LongOpenCustomHashMap.this.value[var8] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Integer) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var4 = (Long)var2.getValue();
                  if (Int2LongOpenCustomHashMap.this.strategy.equals(var3, 0)) {
                     if (Int2LongOpenCustomHashMap.this.containsNullKey && Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Int2LongOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Int2LongOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Int2LongOpenCustomHashMap.this.value[var8] == var4) {
                           Int2LongOpenCustomHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Int2LongOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Int2LongOpenCustomHashMap.this.strategy.equals(var6, var3) || Int2LongOpenCustomHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Int2LongMap.Entry> var1) {
         if (Int2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractInt2LongMap.BasicEntry(Int2LongOpenCustomHashMap.this.key[Int2LongOpenCustomHashMap.this.n], Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Int2LongOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractInt2LongMap.BasicEntry(Int2LongOpenCustomHashMap.this.key[var2], Int2LongOpenCustomHashMap.this.value[var2]));
            }
         }

      }

      public void fastForEach(Consumer<? super Int2LongMap.Entry> var1) {
         AbstractInt2LongMap.BasicEntry var2 = new AbstractInt2LongMap.BasicEntry();
         if (Int2LongOpenCustomHashMap.this.containsNullKey) {
            var2.key = Int2LongOpenCustomHashMap.this.key[Int2LongOpenCustomHashMap.this.n];
            var2.value = Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Int2LongOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Int2LongOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Int2LongOpenCustomHashMap.this.key[var3];
               var2.value = Int2LongOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Int2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Int2LongMap.Entry> {
      private final Int2LongOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Int2LongOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Int2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Int2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int[] var1 = Int2LongOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(var2)) & Int2LongOpenCustomHashMap.this.mask; !Int2LongOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Int2LongOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         int[] var5 = Int2LongOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Int2LongOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Int2LongOpenCustomHashMap.this.strategy.hashCode(var4)) & Int2LongOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Int2LongOpenCustomHashMap.this.value[var2] = Int2LongOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Int2LongMap.Entry, java.util.Map.Entry<Integer, Long> {
      int index;
      ...
      public long setValue(long var1) {
         long var3 = Int2LongOpenCustomHashMap.this.value[this.index];
         Int2LongOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[this.index], (Integer)var2.getKey()) && Int2LongOpenCustomHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
