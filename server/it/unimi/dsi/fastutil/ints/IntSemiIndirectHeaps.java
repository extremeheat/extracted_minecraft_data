...
public final class IntSemiIndirectHeaps {
   ...
   public static int downHeap(int[] var0, int[] var1, int var2, int var3, IntComparator var4) {
      assert var3 < var2;
   ...
   public static int upHeap(int[] var0, int[] var1, int var2, int var3, IntComparator var4) {
      assert var3 < var2;
   ...
   public static void makeHeap(int[] var0, int var1, int var2, int[] var3, IntComparator var4) {
   ...
   public static int[] makeHeap(int[] var0, int var1, int var2, IntComparator var3) {
      int[] var4 = var2 <= 0 ? IntArrays.EMPTY_ARRAY : new int[var2];
      makeHeap(var0, var1, var2, var4, var3);
      return var4;
   }

   public static void makeHeap(int[] var0, int[] var1, int var2, IntComparator var3) {
      int var4 = var2 >>> 1;
   ...
   public static int front(int[] var0, int[] var1, int var2, int[] var3) {
   ...
   public static int front(int[] var0, int[] var1, int var2, int[] var3, IntComparator var4) {
      int var5 = var0[var1[0]];
      int var6 = 0;
      int var7 = 0;
      int var8 = 1;
      int var9 = 0;
