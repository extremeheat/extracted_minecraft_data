...
public class Int2IntRBTreeMap extends AbstractInt2IntSortedMap implements Serializable, Cloneable {
   protected transient Int2IntRBTreeMap.Entry tree;
   protected int count;
   protected transient Int2IntRBTreeMap.Entry firstEntry;
   protected transient Int2IntRBTreeMap.Entry lastEntry;
   ...
   private transient Int2IntRBTreeMap.Entry[] nodePath;
   ...
   public Int2IntRBTreeMap(Comparator<? super Integer> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Int2IntRBTreeMap(Map<? extends Integer, ? extends Integer> var1) {
      this();
      this.putAll(var1);
   }

   public Int2IntRBTreeMap(SortedMap<Integer, Integer> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Int2IntRBTreeMap(Int2IntMap var1) {
      this();
      this.putAll(var1);
   }

   public Int2IntRBTreeMap(Int2IntSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Int2IntRBTreeMap(int[] var1, int[] var2, Comparator<? super Integer> var3) {
      this(var3);
   ...
   public Int2IntRBTreeMap(int[] var1, int[] var2) {
   ...
   final Int2IntRBTreeMap.Entry findKey(int var1) {
      Int2IntRBTreeMap.Entry var2;
      int var3;
   ...
   final Int2IntRBTreeMap.Entry locateKey(int var1) {
      Int2IntRBTreeMap.Entry var2 = this.tree;
      Int2IntRBTreeMap.Entry var3 = this.tree;
   ...
   private void allocatePaths() {
      ...
      this.nodePath = new Int2IntRBTreeMap.Entry[64];
   }

   public int addTo(int var1, int var2) {
      Int2IntRBTreeMap.Entry var3 = this.add(var1);
      int var4 = var3.value;
      var3.value += var2;
      return var4;
   }
   ...
   private Int2IntRBTreeMap.Entry add(int var1) {
      this.modified = false;
      int var2 = 0;
      Int2IntRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Int2IntRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Int2IntRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Int2IntRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Int2IntRBTreeMap.Entry var7;
               Int2IntRBTreeMap.Entry var8;
   ...
   public boolean containsValue(int var1) {
      Int2IntRBTreeMap.ValueIterator var2 = new Int2IntRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public int get(int var1) {
      Int2IntRBTreeMap.Entry var2 = this.findKey(var1);
   ...
   public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
            final Comparator<? super Int2IntMap.Entry> comparator = (var1x, var2) -> {
               return Int2IntRBTreeMap.this.actualComparator.compare(var1x.getIntKey(), var2.getIntKey());
            };
            ...
            public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator() {
               return Int2IntRBTreeMap.this.new EntryIterator();
            }

            public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry var1) {
               return Int2IntRBTreeMap.this.new EntryIterator(var1.getIntKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        Int2IntRBTreeMap.Entry var3 = Int2IntRBTreeMap.this.findKey((Integer)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Integer) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        ...
                        if (var3 != null && var3.getIntValue() == (Integer)var2.getValue()) {
                           Int2IntRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry var1, Int2IntMap.Entry var2) {
               return Int2IntRBTreeMap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2IntEntrySet();
            }

            public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry var1) {
               return Int2IntRBTreeMap.this.headMap(var1.getIntKey()).int2IntEntrySet();
            }

            public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry var1) {
               return Int2IntRBTreeMap.this.tailMap(var1.getIntKey()).int2IntEntrySet();
            }
         };
      }
   ...
   public IntSortedSet keySet() {
      if (this.keys == null) {
         this.keys = new Int2IntRBTreeMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            public IntIterator iterator() {
               return Int2IntRBTreeMap.this.new ValueIterator();
            }

            public boolean contains(int var1) {
               return Int2IntRBTreeMap.this.containsValue(var1);
            }
   ...
   public Int2IntSortedMap headMap(int var1) {
      return new Int2IntRBTreeMap.Submap(0, true, var1, false);
   }

   public Int2IntSortedMap tailMap(int var1) {
      return new Int2IntRBTreeMap.Submap(var1, false, 0, true);
   }

   public Int2IntSortedMap subMap(int var1, int var2) {
      return new Int2IntRBTreeMap.Submap(var1, false, var2, false);
   }

   public Int2IntRBTreeMap clone() {
      Int2IntRBTreeMap var1;
      try {
         var1 = (Int2IntRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Int2IntRBTreeMap.Entry var5 = new Int2IntRBTreeMap.Entry();
         Int2IntRBTreeMap.Entry var6 = new Int2IntRBTreeMap.Entry();
         Int2IntRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Int2IntRBTreeMap.Entry var4 = var6;
         var6.pred((Int2IntRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Int2IntRBTreeMap.EntryIterator var3 = new Int2IntRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Int2IntRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Int2IntRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Int2IntRBTreeMap.Entry var3, Int2IntRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Int2IntRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Int2IntRBTreeMap.Entry(var1.readInt(), var1.readInt());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Int2IntRBTreeMap.Entry(var1.readInt(), var1.readInt());
         var8.black(true);
         var8.right(new Int2IntRBTreeMap.Entry(var1.readInt(), var1.readInt()));
         ...
         Int2IntRBTreeMap.Entry var7 = new Int2IntRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Int2IntRBTreeMap.Entry)null, (Int2IntRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractInt2IntSortedMap implements Serializable {
      ...
      public Submap(int var2, boolean var3, int var4, boolean var5) {
         super();
         if (!var3 && !var5 && Int2IntRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Int2IntRBTreeMap.Submap.SubmapIterator var1 = new Int2IntRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(int var1) {
         return (this.bottom || Int2IntRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Int2IntRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
         if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
               ...
               public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry var1, Int2IntMap.Entry var2) {
                  return Submap.this.subMap(var1.getIntKey(), var2.getIntKey()).int2IntEntrySet();
               }

               public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry var1) {
                  return Submap.this.headMap(var1.getIntKey()).int2IntEntrySet();
               }

               public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry var1) {
                  return Submap.this.tailMap(var1.getIntKey()).int2IntEntrySet();
               }
            };
         }
      ...
      public IntSortedSet keySet() {
         if (this.keys == null) {
            this.keys = new Int2IntRBTreeMap.Submap.KeySet();
         }
      ...
      public boolean containsKey(int var1) {
         return this.in(var1) && Int2IntRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(int var1) {
         Int2IntRBTreeMap.Submap.SubmapIterator var2 = new Int2IntRBTreeMap.Submap.SubmapIterator();
      ...
      public int get(int var1) {
         Int2IntRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Int2IntRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public int put(int var1, int var2) {
         ...
         if (!this.in(var1)) {
            ...
            int var3 = Int2IntRBTreeMap.this.put(var1, var2);
            return Int2IntRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public int remove(int var1) {
         ...
         if (!this.in(var1)) {
            ...
            int var2 = Int2IntRBTreeMap.this.remove(var1);
            return Int2IntRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public boolean isEmpty() {
         return !(new Int2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
      }
      ...
      public Int2IntSortedMap headMap(int var1) {
         if (this.top) {
            return Int2IntRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Int2IntRBTreeMap.this.compare(var1, this.to) < 0 ? Int2IntRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Int2IntSortedMap tailMap(int var1) {
         if (this.bottom) {
            return Int2IntRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Int2IntRBTreeMap.this.compare(var1, this.from) > 0 ? Int2IntRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Int2IntSortedMap subMap(int var1, int var2) {
         if (this.top && this.bottom) {
            return Int2IntRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Int2IntRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Int2IntRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Int2IntRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Int2IntRBTreeMap.Entry firstEntry() {
         if (Int2IntRBTreeMap.this.tree == null) {
            ...
            Int2IntRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Int2IntRBTreeMap.this.firstEntry;
            } else {
               var1 = Int2IntRBTreeMap.this.locateKey(this.from);
               if (Int2IntRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Int2IntRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Int2IntRBTreeMap.Entry lastEntry() {
         if (Int2IntRBTreeMap.this.tree == null) {
            ...
            Int2IntRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Int2IntRBTreeMap.this.lastEntry;
            } else {
               var1 = Int2IntRBTreeMap.this.locateKey(this.to);
               if (Int2IntRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Int2IntRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public int firstIntKey() {
         Int2IntRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public int lastIntKey() {
         Int2IntRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private final class SubmapValueIterator extends Int2IntRBTreeMap.Submap.SubmapIterator implements IntListIterator {
      ...
      private final class SubmapKeyIterator extends Int2IntRBTreeMap.Submap.SubmapIterator implements IntListIterator {
      ...
      private class SubmapEntryIterator extends Int2IntRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2IntMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Int2IntRBTreeMap.TreeIterator {
         ...
         SubmapIterator(int var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2IntRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2IntRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Int2IntRBTreeMap.this.locateKey(var2);
                  if (Int2IntRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private final class ValueIterator extends Int2IntRBTreeMap.TreeIterator implements IntListIterator {
   ...
   private class KeySet extends AbstractInt2IntSortedMap.KeySet {
      ...
      public IntBidirectionalIterator iterator() {
         return Int2IntRBTreeMap.this.new KeyIterator();
      }

      public IntBidirectionalIterator iterator(int var1) {
         return Int2IntRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private final class KeyIterator extends Int2IntRBTreeMap.TreeIterator implements IntListIterator {
      public KeyIterator() {
         super();
      }
   ...
   private class EntryIterator extends Int2IntRBTreeMap.TreeIterator implements ObjectListIterator<Int2IntMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(int var2) {
         super();
         if ((this.next = Int2IntRBTreeMap.this.locateKey(var2)) != null) {
            if (Int2IntRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractInt2IntMap.BasicEntry implements Cloneable {
      private static final int BLACK_MASK = 1;
      private static final int SUCC_MASK = -2147483648;
      private static final int PRED_MASK = 1073741824;
      Int2IntRBTreeMap.Entry left;
      Int2IntRBTreeMap.Entry right;
      int info;
      ...
      void pred(Int2IntRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Int2IntRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Int2IntRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Int2IntRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Int2IntRBTreeMap.Entry next() {
         Int2IntRBTreeMap.Entry var1 = this.right;
      ...
      Int2IntRBTreeMap.Entry prev() {
         Int2IntRBTreeMap.Entry var1 = this.left;
      ...
      public Int2IntRBTreeMap.Entry clone() {
         Int2IntRBTreeMap.Entry var1;
         try {
            var1 = (Int2IntRBTreeMap.Entry)super.clone();
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return this.key == (Integer)var2.getKey() && this.value == (Integer)var2.getValue();
         }
      }
