...
public final class IntArrays {
   ...
   public static int[] forceCapacity(int[] var0, int var1, int var2) {
   ...
   public static int[] grow(int[] var0, int var1) {
      return grow(var0, var1, var0.length);
   }

   public static int[] grow(int[] var0, int var1, int var2) {
      if (var1 > var0.length) {
   ...
   public static int[] trim(int[] var0, int var1) {
      if (var1 >= var0.length) {
         return var0;
      } else {
         int[] var2 = var1 == 0 ? EMPTY_ARRAY : new int[var1];
         System.arraycopy(var0, 0, var2, 0, var1);
         return var2;
      }
   }

   public static int[] setLength(int[] var0, int var1) {
      if (var1 == var0.length) {
         return var0;
      } else {
   ...
   public static int[] copy(int[] var0, int var1, int var2) {
      ensureOffsetLength(var0, var1, var2);
      int[] var3 = var2 == 0 ? EMPTY_ARRAY : new int[var2];
   ...
   public static void ensureSameLength(int[] var0, int[] var1) {
   ...
   private static int med3(int[] var0, int var1, int var2, int var3, IntComparator var4) {
   ...
   private static void selectionSort(int[] var0, int var1, int var2, IntComparator var3) {
   ...
   private static void insertionSort(int[] var0, int var1, int var2, IntComparator var3) {
      int var4 = var1;
      ...
      while(true) {
         ...
         for(int var7 = var0[var4 - 1]; var3.compare(var5, var7) < 0; var7 = var0[var6 - 1]) {
            var0[var6] = var7;
            if (var1 == var6 - 1) {
               --var6;
               break;
   ...
   public static void quickSort(int[] var0, int var1, int var2, IntComparator var3) {
      int var4 = var2 - var1;
      if (var4 < 16) {
         ...
         while(true) {
            int var13;
            while(var10 > var11 || (var13 = var3.compare(var0[var10], var8)) > 0) {
               for(; var11 >= var10 && (var13 = var3.compare(var0[var11], var8)) >= 0; --var11) {
                  if (var13 == 0) {
   ...
   public static void quickSort(int[] var0, IntComparator var1) {
      quickSort(var0, 0, var0.length, var1);
   }

   public static void parallelQuickSort(int[] var0, int var1, int var2, IntComparator var3) {
      if (var2 - var1 < 8192) {
         quickSort(var0, var1, var2, var3);
      } else {
         ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var4.invoke(new IntArrays.ForkJoinQuickSortComp(var0, var1, var2, var3));
         var4.shutdown();
      }

   }

   public static void parallelQuickSort(int[] var0, IntComparator var1) {
      parallelQuickSort(var0, 0, var0.length, var1);
   }

   private static int med3(int[] var0, int var1, int var2, int var3) {
      int var4 = Integer.compare(var0[var1], var0[var2]);
      int var5 = Integer.compare(var0[var1], var0[var3]);
      int var6 = Integer.compare(var0[var2], var0[var3]);
      return var4 < 0 ? (var6 < 0 ? var2 : (var5 < 0 ? var3 : var1)) : (var6 > 0 ? var2 : (var5 > 0 ? var3 : var1));
   }

   private static void selectionSort(int[] var0, int var1, int var2) {
   ...
   private static void insertionSort(int[] var0, int var1, int var2) {
      int var3 = var1;
      ...
      while(true) {
         ...
         for(int var6 = var0[var3 - 1]; var4 < var6; var6 = var0[var5 - 1]) {
            var0[var5] = var6;
            if (var1 == var5 - 1) {
               --var5;
               break;
   ...
   public static void quickSort(int[] var0, int var1, int var2) {
      ...
      if (var3 < 16) {
         ...
         while(true) {
            int var12;
            while(var9 > var10 || (var12 = Integer.compare(var0[var9], var7)) > 0) {
               for(; var10 >= var9 && (var12 = Integer.compare(var0[var10], var7)) >= 0; --var10) {
                  if (var12 == 0) {
                     swap(var0, var10, var11--);
                  }
               }
   ...
   public static void parallelQuickSort(int[] var0, int var1, int var2) {
      if (var2 - var1 < 8192) {
         quickSort(var0, var1, var2);
      } else {
         ForkJoinPool var3 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var3.invoke(new IntArrays.ForkJoinQuickSort(var0, var1, var2));
         var3.shutdown();
      }

   }

   public static void parallelQuickSort(int[] var0) {
      parallelQuickSort(var0, 0, var0.length);
   }

   private static int med3Indirect(int[] var0, int[] var1, int var2, int var3, int var4) {
      int var5 = var1[var0[var2]];
      int var6 = var1[var0[var3]];
      int var7 = var1[var0[var4]];
      int var8 = Integer.compare(var5, var6);
      int var9 = Integer.compare(var5, var7);
      int var10 = Integer.compare(var6, var7);
      return var8 < 0 ? (var10 < 0 ? var3 : (var9 < 0 ? var4 : var2)) : (var10 > 0 ? var3 : (var9 > 0 ? var4 : var2));
   }

   private static void insertionSortIndirect(int[] var0, int[] var1, int var2, int var3) {
      int var4 = var2;
   ...
   public static void quickSortIndirect(int[] var0, int[] var1, int var2, int var3) {
      int var4 = var3 - var2;
      if (var4 < 16) {
         ...
         while(true) {
            int var13;
            while(var10 > var11 || (var13 = Integer.compare(var1[var0[var10]], var8)) > 0) {
               for(; var11 >= var10 && (var13 = Integer.compare(var1[var0[var11]], var8)) >= 0; --var11) {
                  if (var13 == 0) {
                     swap(var0, var11, var12--);
                  }
               }
               ...
               if (var10 > var11) {
                  ...
                  swap(var0, var2, var10 - var13, var13);
                  var13 = Math.min(var12 - var11, var3 - var12 - 1);
                  swap(var0, var10, var3 - var13, var13);
                  if ((var13 = var10 - var9) > 1) {
   ...
   public static void quickSortIndirect(int[] var0, int[] var1) {
      quickSortIndirect(var0, var1, 0, var1.length);
   }

   public static void parallelQuickSortIndirect(int[] var0, int[] var1, int var2, int var3) {
      if (var3 - var2 < 8192) {
         quickSortIndirect(var0, var1, var2, var3);
      } else {
         ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var4.invoke(new IntArrays.ForkJoinQuickSortIndirect(var0, var1, var2, var3));
         var4.shutdown();
      }

   }

   public static void parallelQuickSortIndirect(int[] var0, int[] var1) {
      parallelQuickSortIndirect(var0, var1, 0, var1.length);
   }

   public static void stabilize(int[] var0, int[] var1, int var2, int var3) {
      int var4 = var2;

      for(int var5 = var2 + 1; var5 < var3; ++var5) {
         if (var1[var0[var5]] != var1[var0[var4]]) {
            if (var5 - var4 > 1) {
               parallelQuickSort(var0, var4, var5);
            }
      ...
      if (var3 - var4 > 1) {
         parallelQuickSort(var0, var4, var3);
      }

   }

   public static void stabilize(int[] var0, int[] var1) {
      stabilize(var0, var1, 0, var0.length);
   }

   private static int med3(int[] var0, int[] var1, int var2, int var3, int var4) {
      int var5;
      int var6 = (var5 = Integer.compare(var0[var2], var0[var3])) == 0 ? Integer.compare(var1[var2], var1[var3]) : var5;
      int var7 = (var5 = Integer.compare(var0[var2], var0[var4])) == 0 ? Integer.compare(var1[var2], var1[var4]) : var5;
      int var8 = (var5 = Integer.compare(var0[var3], var0[var4])) == 0 ? Integer.compare(var1[var3], var1[var4]) : var5;
      return var6 < 0 ? (var8 < 0 ? var3 : (var7 < 0 ? var4 : var2)) : (var8 > 0 ? var3 : (var7 > 0 ? var4 : var2));
   }

   private static void swap(int[] var0, int[] var1, int var2, int var3) {
      int var4 = var0[var2];
      int var5 = var1[var2];
      var0[var2] = var0[var3];
      var1[var2] = var1[var3];
   ...
   private static void swap(int[] var0, int[] var1, int var2, int var3, int var4) {
   ...
   private static void selectionSort(int[] var0, int[] var1, int var2, int var3) {
      for(int var4 = var2; var4 < var3 - 1; ++var4) {
         int var5 = var4;

         int var7;
         for(var7 = var4 + 1; var7 < var3; ++var7) {
            int var6;
            if ((var6 = Integer.compare(var0[var7], var0[var5])) < 0 || var6 == 0 && var1[var7] < var1[var5]) {
               var5 = var7;
            }
         }
   ...
   public static void quickSort(int[] var0, int[] var1, int var2, int var3) {
      int var4 = var3 - var2;
      if (var4 < 16) {
         selectionSort(var0, var1, var2, var3);
      } else {
         ...
         while(true) {
            int var14;
            int var15;
            while(var11 > var12 || (var14 = (var15 = Integer.compare(var0[var11], var8)) == 0 ? Integer.compare(var1[var11], var9) : var15) > 0) {
               for(; var12 >= var11 && (var14 = (var15 = Integer.compare(var0[var12], var8)) == 0 ? Integer.compare(var1[var12], var9) : var15) >= 0; --var12) {
                  if (var14 == 0) {
   ...
   public static void quickSort(int[] var0, int[] var1) {
      ensureSameLength(var0, var1);
      quickSort(var0, var1, 0, var0.length);
   }

   public static void parallelQuickSort(int[] var0, int[] var1, int var2, int var3) {
      if (var3 - var2 < 8192) {
         quickSort(var0, var1, var2, var3);
      }

      ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
      var4.invoke(new IntArrays.ForkJoinQuickSort2(var0, var1, var2, var3));
      var4.shutdown();
   }

   public static void parallelQuickSort(int[] var0, int[] var1) {
      ensureSameLength(var0, var1);
      parallelQuickSort(var0, var1, 0, var0.length);
   }

   public static void mergeSort(int[] var0, int var1, int var2, int[] var3) {
      int var4 = var2 - var1;
      if (var4 < 16) {
   ...
   public static void mergeSort(int[] var0, int var1, int var2) {
      mergeSort(var0, var1, var2, (int[])var0.clone());
   }

   public static void mergeSort(int[] var0) {
      mergeSort(var0, 0, var0.length);
   }

   public static void mergeSort(int[] var0, int var1, int var2, IntComparator var3, int[] var4) {
      int var5 = var2 - var1;
      if (var5 < 16) {
   ...
   public static void mergeSort(int[] var0, int var1, int var2, IntComparator var3) {
      mergeSort(var0, var1, var2, var3, (int[])var0.clone());
   }

   public static void mergeSort(int[] var0, IntComparator var1) {
      mergeSort(var0, 0, var0.length, (IntComparator)var1);
   }
   ...
   public static int binarySearch(int[] var0, int var1, int var2, int var3, IntComparator var4) {
      --var2;
   ...
   public static int binarySearch(int[] var0, int var1, IntComparator var2) {
      return binarySearch(var0, 0, var0.length, var1, var2);
   }

   public static void radixSort(int[] var0) {
      radixSort((int[])var0, 0, var0.length);
   }

   public static void radixSort(int[] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         quickSort(var0, var1, var2);
      } else {
         boolean var3 = true;
   ...
   public static void parallelRadixSort(int[] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         quickSort(var0, var1, var2);
      } else {
         boolean var3 = true;
         LinkedBlockingQueue var4 = new LinkedBlockingQueue();
         var4.add(new IntArrays.Segment(var1, var2 - var1, 0));
         ...
         while(var9-- != 0) {
            var8.submit(() -> {
               ...
               while(true) {
                  ...
                  IntArrays.Segment var19 = (IntArrays.Segment)var4.take();
                  ...
                  for(boolean var15 = true; var14 <= var13; var4x[var20] = 0) {
                     ...
                     if (var9 < 3 && var4x[var20] > 1) {
                        if (var4x[var20] < 1024) {
                           ...
                           var4.add(new IntArrays.Segment(var14, var4x[var20], var9 + 1));
                        }
                     }
   ...
   public static void parallelRadixSort(int[] var0) {
      parallelRadixSort(var0, 0, var0.length);
   }

   public static void radixSortIndirect(int[] var0, int[] var1, boolean var2) {
      radixSortIndirect(var0, var1, 0, var0.length, var2);
   }

   public static void radixSortIndirect(int[] var0, int[] var1, int var2, int var3, boolean var4) {
      if (var3 - var2 < 1024) {
         insertionSortIndirect(var0, var1, var2, var3);
      } else {
         boolean var5 = true;
   ...
   public static void parallelRadixSortIndirect(int[] var0, int[] var1, int var2, int var3, boolean var4) {
      if (var3 - var2 < 1024) {
         radixSortIndirect(var0, var1, var2, var3, var4);
      } else {
         boolean var5 = true;
         LinkedBlockingQueue var6 = new LinkedBlockingQueue();
         var6.add(new IntArrays.Segment(var2, var3 - var2, 0));
         ...
         while(var12-- != 0) {
            var10.submit(() -> {
               ...
               while(true) {
                  ...
                  IntArrays.Segment var22 = (IntArrays.Segment)var6.take();
                     ...
                     for(var17 = var10; var16 <= var15; ++var16) {
                        if (var12 < 3 && var7x[var16] > 1) {
                           if (var7x[var16] < 1024) {
                              ...
                              var6.add(new IntArrays.Segment(var17, var7x[var16], var12 + 1));
                           }
                        }
                     ...
                     for(boolean var18 = true; var17 <= var16; var7x[var23] = 0) {
                        ...
                        if (var12 < 3 && var7x[var23] > 1) {
                           if (var7x[var23] < 1024) {
                              ...
                              var7.incrementAndGet();
                              var6.add(new IntArrays.Segment(var17, var7x[var23], var12 + 1));
                           }
                        }
   ...
   public static void parallelRadixSortIndirect(int[] var0, int[] var1, boolean var2) {
      parallelRadixSortIndirect(var0, var1, 0, var1.length, var2);
   }

   public static void radixSort(int[] var0, int[] var1) {
      ensureSameLength(var0, var1);
      radixSort(var0, var1, 0, var0.length);
   }

   public static void radixSort(int[] var0, int[] var1, int var2, int var3) {
      if (var3 - var2 < 1024) {
         selectionSort(var0, var1, var2, var3);
      } else {
         boolean var4 = true;
   ...
   public static void parallelRadixSort(int[] var0, int[] var1, int var2, int var3) {
      if (var3 - var2 < 1024) {
         quickSort(var0, var1, var2, var3);
      } else {
         boolean var4 = true;
            ...
            while(var11-- != 0) {
               var10.submit(() -> {
                  ...
                  while(true) {
                     ...
                     IntArrays.Segment var23 = (IntArrays.Segment)var6.take();
                     ...
                     for(boolean var17 = true; var16 <= var15; var5[var24] = 0) {
                        int var19 = var0[var16];
                        int var20 = var1[var16];
                        ...
                        if (var10 < 7 && var5[var24] > 1) {
                           if (var5[var24] < 1024) {
                              ...
                              var7.incrementAndGet();
                              var6.add(new IntArrays.Segment(var16, var5[var24], var10 + 1));
                           }
                        }
   ...
   public static void parallelRadixSort(int[] var0, int[] var1) {
      ensureSameLength(var0, var1);
      parallelRadixSort(var0, var1, 0, var0.length);
   }

   private static void insertionSortIndirect(int[] var0, int[] var1, int[] var2, int var3, int var4) {
      int var5 = var3;
   ...
   public static void radixSortIndirect(int[] var0, int[] var1, int[] var2, boolean var3) {
      ensureSameLength(var1, var2);
      radixSortIndirect(var0, var1, var2, 0, var1.length, var3);
   }

   public static void radixSortIndirect(int[] var0, int[] var1, int[] var2, int var3, int var4, boolean var5) {
      if (var4 - var3 < 1024) {
   ...
   private static void selectionSort(int[][] var0, int var1, int var2, int var3) {
      ...
      for(int var6 = var1; var6 < var2 - 1; ++var6) {
         ...
         if (var7 != var6) {
            for(var8 = var4; var8-- != 0; var0[var8][var7] = var9) {
               var9 = var0[var8][var6];
   ...
   public static void radixSort(int[][] var0) {
      radixSort((int[][])var0, 0, var0[0].length);
   }
   ...
   public static int[] shuffle(int[] var0, int var1, int var2, Random var3) {
      int var5;
      int var6;
   ...
   public static int[] shuffle(int[] var0, Random var1) {
      int var3;
      int var4;
   ...
   public static int[] reverse(int[] var0, int var1, int var2) {
      int var3 = var2 - var1;
   ...
   protected static class ForkJoinQuickSort2 extends RecursiveAction {
      ...
      public ForkJoinQuickSort2(int[] var1, int[] var2, int var3, int var4) {
         super();
         this.from = var3;
         this.to = var4;
         this.x = var1;
      ...
      protected void compute() {
         ...
         if (var3 < 8192) {
            IntArrays.quickSort(var1, var2, this.from, this.to);
         } else {
            int var4 = this.from + var3 / 2;
            int var5 = this.from;
            int var6 = this.to - 1;
            int var7 = var3 / 8;
            var5 = IntArrays.med3(var1, var2, var5, var5 + var7, var5 + 2 * var7);
            var4 = IntArrays.med3(var1, var2, var4 - var7, var4, var4 + var7);
            var6 = IntArrays.med3(var1, var2, var6 - 2 * var7, var6 - var7, var6);
            var4 = IntArrays.med3(var1, var2, var5, var4, var6);
            int var8 = var1[var4];
            int var9 = var2[var4];
            int var10 = this.from;
            int var11 = var10;
            ...
            while(true) {
               int var14;
               int var15;
               while(var11 > var12 || (var14 = (var15 = Integer.compare(var1[var11], var8)) == 0 ? Integer.compare(var2[var11], var9) : var15) > 0) {
                  for(; var12 >= var11 && (var14 = (var15 = Integer.compare(var1[var12], var8)) == 0 ? Integer.compare(var2[var12], var9) : var15) >= 0; --var12) {
                     if (var14 == 0) {
                        IntArrays.swap(var1, var2, var12, var13--);
                     }
                  }

                  if (var11 > var12) {
                     var7 = Math.min(var10 - this.from, var11 - var10);
                     IntArrays.swap(var1, var2, this.from, var11 - var7, var7);
                     var7 = Math.min(var13 - var12, this.to - var13 - 1);
                     IntArrays.swap(var1, var2, var11, this.to - var7, var7);
                     var7 = var11 - var10;
                     var14 = var13 - var12;
                     if (var7 > 1 && var14 > 1) {
                        invokeAll(new IntArrays.ForkJoinQuickSort2(var1, var2, this.from, this.from + var7), new IntArrays.ForkJoinQuickSort2(var1, var2, this.to - var14, this.to));
                     } else if (var7 > 1) {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSort2(var1, var2, this.from, this.from + var7)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSort2(var1, var2, this.to - var14, this.to)});
                     }

                     return;
                  }

                  IntArrays.swap(var1, var2, var11++, var12--);
               }

               if (var14 == 0) {
                  IntArrays.swap(var1, var2, var10++, var11);
               }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      public ForkJoinQuickSortIndirect(int[] var1, int[] var2, int var3, int var4) {
         super();
         this.from = var3;
         this.to = var4;
         this.x = var2;
      ...
      protected void compute() {
         ...
         if (var2 < 8192) {
            IntArrays.quickSortIndirect(this.perm, var1, this.from, this.to);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = IntArrays.med3Indirect(this.perm, var1, var4, var4 + var6, var4 + 2 * var6);
            var3 = IntArrays.med3Indirect(this.perm, var1, var3 - var6, var3, var3 + var6);
            var5 = IntArrays.med3Indirect(this.perm, var1, var5 - 2 * var6, var5 - var6, var5);
            var3 = IntArrays.med3Indirect(this.perm, var1, var4, var3, var5);
            int var7 = var1[this.perm[var3]];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            int var11 = var10;
            ...
            while(true) {
               int var12;
               while(var9 > var10 || (var12 = Integer.compare(var1[this.perm[var9]], var7)) > 0) {
                  for(; var10 >= var9 && (var12 = Integer.compare(var1[this.perm[var10]], var7)) >= 0; --var10) {
                     if (var12 == 0) {
                  ...
                  if (var9 > var10) {
                     ...
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new IntArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.from, this.from + var6), new IntArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.to - var12, this.to));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.from, this.from + var6)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.to - var12, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSort extends RecursiveAction {
      ...
      public ForkJoinQuickSort(int[] var1, int var2, int var3) {
         super();
         this.from = var2;
         this.to = var3;
         this.x = var1;
      ...
      protected void compute() {
         ...
         int var2 = this.to - this.from;
         if (var2 < 8192) {
            IntArrays.quickSort(var1, this.from, this.to);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = IntArrays.med3(var1, var4, var4 + var6, var4 + 2 * var6);
            var3 = IntArrays.med3(var1, var3 - var6, var3, var3 + var6);
            var5 = IntArrays.med3(var1, var5 - 2 * var6, var5 - var6, var5);
            var3 = IntArrays.med3(var1, var4, var3, var5);
            int var7 = var1[var3];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            ...
            while(true) {
               int var12;
               while(var9 > var10 || (var12 = Integer.compare(var1[var9], var7)) > 0) {
                  for(; var10 >= var9 && (var12 = Integer.compare(var1[var10], var7)) >= 0; --var10) {
                     if (var12 == 0) {
                        IntArrays.swap(var1, var10, var11--);
                     }
                  }

                  if (var9 > var10) {
                     var6 = Math.min(var8 - this.from, var9 - var8);
                     IntArrays.swap(var1, this.from, var9 - var6, var6);
                     var6 = Math.min(var11 - var10, this.to - var11 - 1);
                     IntArrays.swap(var1, var9, this.to - var6, var6);
                     var6 = var9 - var8;
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new IntArrays.ForkJoinQuickSort(var1, this.from, this.from + var6), new IntArrays.ForkJoinQuickSort(var1, this.to - var12, this.to));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSort(var1, this.from, this.from + var6)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSort(var1, this.to - var12, this.to)});
                     }

                     return;
                  }

                  IntArrays.swap(var1, var9++, var10--);
               }

               if (var12 == 0) {
                  IntArrays.swap(var1, var8++, var9);
               }
   ...
   protected static class ForkJoinQuickSortComp extends RecursiveAction {
      ...
      public ForkJoinQuickSortComp(int[] var1, int var2, int var3, IntComparator var4) {
         super();
         this.from = var2;
         this.to = var3;
         this.x = var1;
      ...
      protected void compute() {
         ...
         int var2 = this.to - this.from;
         if (var2 < 8192) {
            IntArrays.quickSort(var1, this.from, this.to, this.comp);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = IntArrays.med3(var1, var4, var4 + var6, var4 + 2 * var6, this.comp);
            var3 = IntArrays.med3(var1, var3 - var6, var3, var3 + var6, this.comp);
            var5 = IntArrays.med3(var1, var5 - 2 * var6, var5 - var6, var5, this.comp);
            var3 = IntArrays.med3(var1, var4, var3, var5, this.comp);
            int var7 = var1[var3];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            ...
            while(true) {
               ...
               while(var9 > var10 || (var12 = this.comp.compare(var1[var9], var7)) > 0) {
                  ...
                  if (var9 > var10) {
                     ...
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new IntArrays.ForkJoinQuickSortComp(var1, this.from, this.from + var6, this.comp), new IntArrays.ForkJoinQuickSortComp(var1, this.to - var12, this.to, this.comp));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSortComp(var1, this.from, this.from + var6, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new IntArrays.ForkJoinQuickSortComp(var1, this.to - var12, this.to, this.comp)});
                     }
