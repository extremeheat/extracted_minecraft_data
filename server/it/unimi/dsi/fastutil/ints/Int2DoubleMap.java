...
public interface Int2DoubleMap extends Int2DoubleFunction, Map<Integer, Double> {
   ...
   default Double put(Integer var1, Double var2) {
      return Int2DoubleFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double get(Object var1) {
      return Int2DoubleFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Double remove(Object var1) {
      return Int2DoubleFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Int2DoubleFunction.super.containsKey(var1);
   }
   ...
   default double getOrDefault(int var1, double var2) {
      double var4;
      return (var4 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var4;
   }

   default double putIfAbsent(int var1, double var2) {
   ...
   default boolean remove(int var1, double var2) {
      double var4 = this.get(var1);
   ...
   default boolean replace(int var1, double var2, double var4) {
   ...
   default double replace(int var1, double var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default double computeIfAbsent(int var1, IntToDoubleFunction var2) {
   ...
   default double computeIfAbsentNullable(int var1, IntFunction<? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
   ...
   default double computeIfAbsentPartial(int var1, Int2DoubleFunction var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default double computeIfPresent(int var1, BiFunction<? super Integer, ? super Double, ? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default double compute(int var1, BiFunction<? super Integer, ? super Double, ? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
   ...
   default double merge(int var1, double var2, BiFunction<? super Double, ? super Double, ? extends Double> var4) {
   ...
   /** @deprecated */
   @Deprecated
   default Double putIfAbsent(Integer var1, Double var2) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Integer var1, Double var2, Double var3) {
      return super.replace(var1, var2, var3);
   }

   /** @deprecated */
   @Deprecated
   default Double replace(Integer var1, Double var2) {
      return (Double)super.replace(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double computeIfAbsent(Integer var1, Function<? super Integer, ? extends Double> var2) {
      return (Double)super.computeIfAbsent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double computeIfPresent(Integer var1, BiFunction<? super Integer, ? super Double, ? extends Double> var2) {
      return (Double)super.computeIfPresent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double compute(Integer var1, BiFunction<? super Integer, ? super Double, ? extends Double> var2) {
      return (Double)super.compute(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double merge(Integer var1, Double var2, BiFunction<? super Double, ? super Double, ? extends Double> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Int2DoubleMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Int2DoubleMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
