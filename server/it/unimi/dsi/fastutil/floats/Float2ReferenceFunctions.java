...
public final class Float2ReferenceFunctions {
   public static final Float2ReferenceFunctions.EmptyFunction EMPTY_FUNCTION = new Float2ReferenceFunctions.EmptyFunction();

   private Float2ReferenceFunctions() {
      super();
   }

   public static <V> Float2ReferenceFunction<V> singleton(float var0, V var1) {
      return new Float2ReferenceFunctions.Singleton(var0, var1);
   }
   ...
   public static <V> Float2ReferenceFunction<V> synchronize(Float2ReferenceFunction<V> var0) {
      return new Float2ReferenceFunctions.SynchronizedFunction(var0);
   }

   public static <V> Float2ReferenceFunction<V> synchronize(Float2ReferenceFunction<V> var0, Object var1) {
      return new Float2ReferenceFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Float2ReferenceFunction<V> unmodifiable(Float2ReferenceFunction<V> var0) {
      return new Float2ReferenceFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Float2ReferenceFunction<V> primitive(Function<? super Float, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Float2ReferenceFunction) {
         return (Float2ReferenceFunction)var0;
         ...
         return new Float2ReferenceFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction<V> implements Float2ReferenceFunction<V> {
      ...
      protected PrimitiveFunction(Function<? super Float, ? extends V> var1) {
         super();
         this.function = var1;
      }
      ...
      public V get(Object var1) {
         return var1 == null ? null : this.function.apply((Float)var1);
      }
   ...
   public static class UnmodifiableFunction<V> extends AbstractFloat2ReferenceFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Float2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Float2ReferenceFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Float2ReferenceFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Float2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
