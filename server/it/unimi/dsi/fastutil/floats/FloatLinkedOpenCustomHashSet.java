...
public class FloatLinkedOpenCustomHashSet extends AbstractFloatSortedSet implements Serializable, Cloneable, Hash {
   ...
   public FloatLinkedOpenCustomHashSet(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.first = -1;
      this.last = -1;
      this.strategy = var3;
   ...
   public FloatLinkedOpenCustomHashSet(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public FloatLinkedOpenCustomHashSet(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public FloatLinkedOpenCustomHashSet(Collection<? extends Float> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public FloatLinkedOpenCustomHashSet(Collection<? extends Float> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public FloatLinkedOpenCustomHashSet(FloatCollection var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public FloatLinkedOpenCustomHashSet(FloatCollection var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public FloatLinkedOpenCustomHashSet(FloatIterator var1, float var2, FloatHash.Strategy var3) {
      this(16, var2, var3);
   ...
   public FloatLinkedOpenCustomHashSet(FloatIterator var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public FloatLinkedOpenCustomHashSet(Iterator<?> var1, float var2, FloatHash.Strategy var3) {
      this(FloatIterators.asFloatIterator(var1), var2, var3);
   }

   public FloatLinkedOpenCustomHashSet(Iterator<?> var1, FloatHash.Strategy var2) {
      this(FloatIterators.asFloatIterator(var1), var2);
   }

   public FloatLinkedOpenCustomHashSet(float[] var1, int var2, int var3, float var4, FloatHash.Strategy var5) {
   ...
   public FloatLinkedOpenCustomHashSet(float[] var1, int var2, int var3, FloatHash.Strategy var4) {
      this(var1, var2, var3, 0.75F, var4);
   }

   public FloatLinkedOpenCustomHashSet(float[] var1, float var2, FloatHash.Strategy var3) {
      this(var1, 0, var1.length, var2, var3);
   }

   public FloatLinkedOpenCustomHashSet(float[] var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }
   ...
   public float removeFirstFloat() {
      if (this.size == 0) {
         ...
         --this.size;
         if (this.strategy.equals(var2, 0.0F)) {
            this.containsNull = false;
            this.key[this.n] = 0.0F;
         } else {
            this.shiftKeys(var1);
   ...
   public boolean addAndMoveToFirst(float var1) {
      ...
      if (this.strategy.equals(var1, 0.0F)) {
         ...
         for(var2 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask; Float.floatToIntBits(var3[var2]) != 0; var2 = var2 + 1 & this.mask) {
   ...
   public FloatListIterator iterator(float var1) {
      return new FloatLinkedOpenCustomHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         int var9;
         if (this.strategy.equals(var2[var5], 0.0F)) {
            var9 = var1;
         } else {
            for(var9 = HashCommon.mix(this.strategy.hashCode(var2[var5])) & var3; Float.floatToIntBits(var4[var9]) != 0; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public FloatLinkedOpenCustomHashSet clone() {
      FloatLinkedOpenCustomHashSet var1;
      try {
         var1 = (FloatLinkedOpenCustomHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var6-- != 0) {
         ...
         int var7;
         if (this.strategy.equals(var5, 0.0F)) {
            var7 = this.n;
            this.containsNull = true;
         } else if (Float.floatToIntBits(var2[var7 = HashCommon.mix(this.strategy.hashCode(var5)) & this.mask]) != 0) {
   ...
   private class SetIterator implements FloatListIterator {
      ...
      SetIterator(float var2) {
         super();
         if (FloatLinkedOpenCustomHashSet.this.strategy.equals(var2, 0.0F)) {
         ...
         } else if (FloatLinkedOpenCustomHashSet.this.strategy.equals(FloatLinkedOpenCustomHashSet.this.key[FloatLinkedOpenCustomHashSet.this.last], var2)) {
            this.prev = FloatLinkedOpenCustomHashSet.this.last;
            this.index = FloatLinkedOpenCustomHashSet.this.size;
         } else {
            float[] var3 = FloatLinkedOpenCustomHashSet.this.key;

            for(int var4 = HashCommon.mix(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(var2)) & FloatLinkedOpenCustomHashSet.this.mask; Float.floatToIntBits(var3[var4]) != 0; var4 = var4 + 1 & FloatLinkedOpenCustomHashSet.this.mask) {
               if (FloatLinkedOpenCustomHashSet.this.strategy.equals(var3[var4], var2)) {
                  this.next = (int)FloatLinkedOpenCustomHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = FloatLinkedOpenCustomHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)FloatLinkedOpenCustomHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = FloatLinkedOpenCustomHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (FloatLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = FloatLinkedOpenCustomHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (FloatLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == FloatLinkedOpenCustomHashSet.this.n) {
               ...
               float[] var5 = FloatLinkedOpenCustomHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & FloatLinkedOpenCustomHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(var4)) & FloatLinkedOpenCustomHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  FloatLinkedOpenCustomHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
