...
public class Float2IntOpenHashMap extends AbstractFloat2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Float2IntOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2IntOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2IntOpenHashMap(Map<? extends Float, ? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2IntOpenHashMap(Map<? extends Float, ? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public Float2IntOpenHashMap(Float2IntMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2IntOpenHashMap(Float2IntMap var1) {
      this(var1, 0.75F);
   }

   public Float2IntOpenHashMap(float[] var1, int[] var2, float var3) {
   ...
   public Float2IntOpenHashMap(float[] var1, int[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Float2IntOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Float2IntOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2IntOpenHashMap.this.value[Float2IntOpenHashMap.this.n]);
               }

               int var2 = Float2IntOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2IntOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2IntOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2IntOpenHashMap clone() {
      Float2IntOpenHashMap var1;
      try {
         var1 = (Float2IntOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      int[] var3 = this.value;
      Float2IntOpenHashMap.MapIterator var4 = new Float2IntOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2IntOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2IntOpenHashMap.this.key[Float2IntOpenHashMap.this.n]);
         }

         int var2 = Float2IntOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2IntOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2IntOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2IntOpenHashMap.this.size;
         Float2IntOpenHashMap.this.remove(var1);
         return Float2IntOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements Float2IntMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (Float.floatToIntBits(var3) == 0) {
                     return Float2IntOpenHashMap.this.containsNullKey && Float2IntOpenHashMap.this.value[Float2IntOpenHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2IntOpenHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2IntOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var5)) {
                        return Float2IntOpenHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2IntOpenHashMap.this.mask]) != 0) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var4 = (Integer)var2.getValue();
                  if (Float.floatToIntBits(var3) == 0) {
                     if (Float2IntOpenHashMap.this.containsNullKey && Float2IntOpenHashMap.this.value[Float2IntOpenHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2IntOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float2IntOpenHashMap.this.value[var7] == var4) {
                           Float2IntOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2IntOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(Float.floatToIntBits(var5) != Float.floatToIntBits(var3) || Float2IntOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2IntMap.Entry> var1) {
         if (Float2IntOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntOpenHashMap.this.key[Float2IntOpenHashMap.this.n], Float2IntOpenHashMap.this.value[Float2IntOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2IntOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntOpenHashMap.this.key[var2], Float2IntOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2IntMap.Entry> var1) {
         ...
         if (Float2IntOpenHashMap.this.containsNullKey) {
            var2.key = Float2IntOpenHashMap.this.key[Float2IntOpenHashMap.this.n];
            var2.value = Float2IntOpenHashMap.this.value[Float2IntOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2IntOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2IntOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2IntOpenHashMap.this.key[var3];
               var2.value = Float2IntOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2IntOpenHashMap.MapIterator implements ObjectIterator<Float2IntMap.Entry> {
      private final Float2IntOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2IntOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2IntOpenHashMap.MapIterator implements ObjectIterator<Float2IntMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2IntOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2IntOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2IntOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2IntOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2IntOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2IntOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2IntOpenHashMap.this.value[var2] = Float2IntOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2IntMap.Entry, java.util.Map.Entry<Float, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Float2IntOpenHashMap.this.value[this.index];
         Float2IntOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2IntOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Float2IntOpenHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
