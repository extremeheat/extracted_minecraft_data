...
public final class Float2ShortFunctions {
   ...
   public static Float2ShortFunction singleton(float var0, short var1) {
      return new Float2ShortFunctions.Singleton(var0, var1);
   }
   ...
   public static Float2ShortFunction synchronize(Float2ShortFunction var0) {
      return new Float2ShortFunctions.SynchronizedFunction(var0);
   }

   public static Float2ShortFunction synchronize(Float2ShortFunction var0, Object var1) {
      return new Float2ShortFunctions.SynchronizedFunction(var0, var1);
   }

   public static Float2ShortFunction unmodifiable(Float2ShortFunction var0) {
      return new Float2ShortFunctions.UnmodifiableFunction(var0);
   }

   public static Float2ShortFunction primitive(Function<? super Float, ? extends Short> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Float2ShortFunction) {
         return (Float2ShortFunction)var0;
      } else {
         return (Float2ShortFunction)(var0 instanceof DoubleToIntFunction ? (var1) -> {
            return SafeMath.safeIntToShort(((DoubleToIntFunction)var0).applyAsInt((double)var1));
         } : new Float2ShortFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class PrimitiveFunction implements Float2ShortFunction {
      ...
      protected PrimitiveFunction(Function<? super Float, ? extends Short> var1) {
         super();
         this.function = var1;
      }
      ...
      public Short get(Object var1) {
         return var1 == null ? null : (Short)this.function.apply((Float)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractFloat2ShortFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Float2ShortFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Float2ShortFunction, Serializable {
      ...
      protected SynchronizedFunction(Float2ShortFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Float2ShortFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
