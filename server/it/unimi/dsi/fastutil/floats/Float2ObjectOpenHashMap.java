...
public class Float2ObjectOpenHashMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Float2ObjectOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2ObjectOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2ObjectOpenHashMap(Map<? extends Float, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2ObjectOpenHashMap(Map<? extends Float, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Float2ObjectOpenHashMap(Float2ObjectMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2ObjectOpenHashMap(Float2ObjectMap<V> var1) {
      this(var1, 0.75F);
   }

   public Float2ObjectOpenHashMap(float[] var1, V[] var2, float var3) {
   ...
   public Float2ObjectOpenHashMap(float[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Float2ObjectOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Float2ObjectOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n]);
               }

               int var2 = Float2ObjectOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2ObjectOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2ObjectOpenHashMap<V> clone() {
      Float2ObjectOpenHashMap var1;
      try {
         var1 = (Float2ObjectOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      Object[] var3 = this.value;
      Float2ObjectOpenHashMap.MapIterator var4 = new Float2ObjectOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Float2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2ObjectOpenHashMap.this.key[Float2ObjectOpenHashMap.this.n]);
         }

         int var2 = Float2ObjectOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2ObjectOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2ObjectOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2ObjectOpenHashMap.this.size;
         Float2ObjectOpenHashMap.this.remove(var1);
         return Float2ObjectOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Float2ObjectOpenHashMap<V>.MapIterator implements FloatIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               if (Float.floatToIntBits(var3) == 0) {
                  return Float2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n], var4);
               } else {
                  float[] var6 = Float2ObjectOpenHashMap.this.key;
                  float var5;
                  int var7;
                  if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2ObjectOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var5)) {
                     return Objects.equals(Float2ObjectOpenHashMap.this.value[var7], var4);
                  } else {
                     while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ObjectOpenHashMap.this.mask]) != 0) {
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               Object var4 = var2.getValue();
               if (Float.floatToIntBits(var3) == 0) {
                  if (Float2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n], var4)) {
                  ...
                  if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2ObjectOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Objects.equals(Float2ObjectOpenHashMap.this.value[var7], var4)) {
                        Float2ObjectOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ObjectOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(Float.floatToIntBits(var5) != Float.floatToIntBits(var3) || !Objects.equals(Float2ObjectOpenHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> var1) {
         if (Float2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectOpenHashMap.this.key[Float2ObjectOpenHashMap.this.n], Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectOpenHashMap.this.key[var2], Float2ObjectOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2ObjectMap.Entry<V>> var1) {
         ...
         if (Float2ObjectOpenHashMap.this.containsNullKey) {
            var2.key = Float2ObjectOpenHashMap.this.key[Float2ObjectOpenHashMap.this.n];
            var2.value = Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2ObjectOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2ObjectOpenHashMap.this.key[var3];
               var2.value = Float2ObjectOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Float2ObjectMap.Entry<V>> {
      private final Float2ObjectOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2ObjectOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Float2ObjectMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2ObjectOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2ObjectOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2ObjectOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2ObjectOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2ObjectOpenHashMap.this.mask;

            float var4;
            while(true) {
               if (Float.floatToIntBits(var4 = var5[var1]) == 0) {
                  var5[var2] = 0.0F;
                  Float2ObjectOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2ObjectOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2ObjectOpenHashMap.this.value[var2] = Float2ObjectOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2ObjectMap.Entry<V>, java.util.Map.Entry<Float, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Float2ObjectOpenHashMap.this.value[this.index];
         Float2ObjectOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Objects.equals(Float2ObjectOpenHashMap.this.value[this.index], var2.getValue());
         }
      }
