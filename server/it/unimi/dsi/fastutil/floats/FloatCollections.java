...
public final class FloatCollections {
   ...
   public static FloatCollection synchronize(FloatCollection var0) {
      return new FloatCollections.SynchronizedCollection(var0);
   }

   public static FloatCollection synchronize(FloatCollection var0, Object var1) {
      return new FloatCollections.SynchronizedCollection(var0, var1);
   }

   public static FloatCollection unmodifiable(FloatCollection var0) {
      return new FloatCollections.UnmodifiableCollection(var0);
   }

   public static FloatCollection asCollection(FloatIterable var0) {
      return (FloatCollection)(var0 instanceof FloatCollection ? (FloatCollection)var0 : new FloatCollections.IterableCollection(var0));
   }
   ...
   public static class IterableCollection extends AbstractFloatCollection implements Serializable {
      ...
      protected IterableCollection(FloatIterable var1) {
         super();
         if (var1 == null) {
      ...
      public int size() {
         ...
         for(FloatIterator var2 = this.iterator(); var2.hasNext(); ++var1) {
            var2.nextFloat();
         }
   ...
   public static class UnmodifiableCollection implements FloatCollection, Serializable {
      ...
      protected UnmodifiableCollection(FloatCollection var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
   ...
   public static class SynchronizedCollection implements FloatCollection, Serializable {
      ...
      protected SynchronizedCollection(FloatCollection var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedCollection(FloatCollection var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
