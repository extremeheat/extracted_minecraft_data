...
public class Float2BooleanOpenCustomHashMap extends AbstractFloat2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Float2BooleanOpenCustomHashMap(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Float2BooleanOpenCustomHashMap(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2BooleanOpenCustomHashMap(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Float2BooleanOpenCustomHashMap(Map<? extends Float, ? extends Boolean> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2BooleanOpenCustomHashMap(Map<? extends Float, ? extends Boolean> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2BooleanOpenCustomHashMap(Float2BooleanMap var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2BooleanOpenCustomHashMap(Float2BooleanMap var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2BooleanOpenCustomHashMap(float[] var1, boolean[] var2, float var3, FloatHash.Strategy var4) {
   ...
   public Float2BooleanOpenCustomHashMap(float[] var1, boolean[] var2, FloatHash.Strategy var3) {
   ...
   public Float2BooleanMap.FastEntrySet float2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new Float2BooleanOpenCustomHashMap.MapEntrySet();
      }
   ...
   public FloatSet keySet() {
      if (this.keys == null) {
         this.keys = new Float2BooleanOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            public BooleanIterator iterator() {
               return Float2BooleanOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(boolean var1) {
               return Float2BooleanOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n]);
               }

               int var2 = Float2BooleanOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2BooleanOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2BooleanOpenCustomHashMap clone() {
      Float2BooleanOpenCustomHashMap var1;
      try {
         var1 = (Float2BooleanOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      boolean[] var3 = this.value;
      Float2BooleanOpenCustomHashMap.MapIterator var4 = new Float2BooleanOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Float2BooleanOpenCustomHashMap.MapIterator implements BooleanIterator {
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatIterator iterator() {
         return Float2BooleanOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(DoubleConsumer var1) {
         if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept((double)Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n]);
         }

         int var2 = Float2BooleanOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2BooleanOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2BooleanOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2BooleanOpenCustomHashMap.this.size;
         Float2BooleanOpenCustomHashMap.this.remove(var1);
         return Float2BooleanOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Float2BooleanOpenCustomHashMap.MapIterator implements FloatIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanMap.FastEntrySet {
      ...
      public ObjectIterator<Float2BooleanMap.Entry> iterator() {
         return Float2BooleanOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Float2BooleanMap.Entry> fastIterator() {
         return Float2BooleanOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (Float2BooleanOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     return Float2BooleanOpenCustomHashMap.this.containsNullKey && Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2BooleanOpenCustomHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2BooleanOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2BooleanOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float2BooleanOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2BooleanOpenCustomHashMap.this.mask]) != 0) {
                           if (Float2BooleanOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float2BooleanOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var4 = (Boolean)var2.getValue();
                  if (Float2BooleanOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     if (Float2BooleanOpenCustomHashMap.this.containsNullKey && Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2BooleanOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2BooleanOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float2BooleanOpenCustomHashMap.this.value[var7] == var4) {
                           Float2BooleanOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2BooleanOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Float2BooleanOpenCustomHashMap.this.strategy.equals(var5, var3) || Float2BooleanOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2BooleanMap.Entry> var1) {
         if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2BooleanMap.BasicEntry(Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n], Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2BooleanMap.BasicEntry(Float2BooleanOpenCustomHashMap.this.key[var2], Float2BooleanOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2BooleanMap.Entry> var1) {
         ...
         if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
            var2.key = Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n];
            var2.value = Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2BooleanOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[var3]) != 0) {
               var2.key = Float2BooleanOpenCustomHashMap.this.key[var3];
               var2.value = Float2BooleanOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Float2BooleanMap.Entry> {
      private final Float2BooleanOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2BooleanOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Float2BooleanMap.Entry> {
      ...
      public Float2BooleanOpenCustomHashMap.MapEntry next() {
         return this.entry = Float2BooleanOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2BooleanOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(var2)) & Float2BooleanOpenCustomHashMap.this.mask; !Float2BooleanOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Float2BooleanOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2BooleanOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2BooleanOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(var4)) & Float2BooleanOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2BooleanOpenCustomHashMap.this.value[var2] = Float2BooleanOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2BooleanMap.Entry, java.util.Map.Entry<Float, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Float2BooleanOpenCustomHashMap.this.value[this.index];
         Float2BooleanOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float2BooleanOpenCustomHashMap.this.strategy.equals(Float2BooleanOpenCustomHashMap.this.key[this.index], (Float)var2.getKey()) && Float2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
