...
public interface Float2BooleanMap extends Float2BooleanFunction, Map<Float, Boolean> {
   ...
   /** @deprecated */
   @Deprecated
   default Boolean put(Float var1, Boolean var2) {
      return Float2BooleanFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Boolean get(Object var1) {
      return Float2BooleanFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Boolean remove(Object var1) {
      return Float2BooleanFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Float2BooleanFunction.super.containsKey(var1);
   }
   ...
   default boolean getOrDefault(float var1, boolean var2) {
      boolean var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default boolean putIfAbsent(float var1, boolean var2) {
   ...
   default boolean remove(float var1, boolean var2) {
      boolean var3 = this.get(var1);
   ...
   default boolean replace(float var1, boolean var2, boolean var3) {
   ...
   default boolean replace(float var1, boolean var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default boolean computeIfAbsent(float var1, DoublePredicate var2) {
   ...
   default boolean computeIfAbsentNullable(float var1, DoubleFunction<? extends Boolean> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
         Boolean var5 = (Boolean)var2.apply((double)var1);
         if (var5 == null) {
            return var4;
         } else {
            boolean var6 = var5;
   ...
   default boolean computeIfAbsentPartial(float var1, Float2BooleanFunction var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default boolean computeIfPresent(float var1, BiFunction<? super Float, ? super Boolean, ? extends Boolean> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default boolean compute(float var1, BiFunction<? super Float, ? super Boolean, ? extends Boolean> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
   ...
   default boolean merge(float var1, boolean var2, BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Boolean computeIfAbsent(Float var1, Function<? super Float, ? extends Boolean> var2) {
   ...
   public interface FastEntrySet extends ObjectSet<Float2BooleanMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Float2BooleanMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
