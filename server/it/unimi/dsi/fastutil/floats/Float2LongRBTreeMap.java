...
public class Float2LongRBTreeMap extends AbstractFloat2LongSortedMap implements Serializable, Cloneable {
   ...
   public Float2LongRBTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2LongRBTreeMap(Map<? extends Float, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Float2LongRBTreeMap(SortedMap<Float, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2LongRBTreeMap(Float2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2LongRBTreeMap(Float2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2LongRBTreeMap(float[] var1, long[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2LongRBTreeMap(float[] var1, long[] var2) {
   ...
   final Float2LongRBTreeMap.Entry findKey(float var1) {
      Float2LongRBTreeMap.Entry var2;
      int var3;
   ...
   final Float2LongRBTreeMap.Entry locateKey(float var1) {
      Float2LongRBTreeMap.Entry var2 = this.tree;
      Float2LongRBTreeMap.Entry var3 = this.tree;
   ...
   public long addTo(float var1, long var2) {
      Float2LongRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Float2LongRBTreeMap.Entry add(float var1) {
      this.modified = false;
      int var2 = 0;
      Float2LongRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Float2LongRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Float2LongRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Float2LongRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Float2LongRBTreeMap.Entry var7;
               Float2LongRBTreeMap.Entry var8;
   ...
   public boolean containsValue(long var1) {
      Float2LongRBTreeMap.ValueIterator var3 = new Float2LongRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(float var1) {
      Float2LongRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>() {
            final Comparator<? super Float2LongMap.Entry> comparator = (var1x, var2) -> {
               return Float2LongRBTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry var1) {
               return Float2LongRBTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Float2LongRBTreeMap.Entry var3 = Float2LongRBTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Float2LongRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry var1, Float2LongMap.Entry var2) {
               return Float2LongRBTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2LongEntrySet();
            }

            public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry var1) {
               return Float2LongRBTreeMap.this.headMap(var1.getFloatKey()).float2LongEntrySet();
            }

            public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry var1) {
               return Float2LongRBTreeMap.this.tailMap(var1.getFloatKey()).float2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Float2LongRBTreeMap.this.containsValue(var1);
            }
   ...
   public Float2LongSortedMap headMap(float var1) {
      return new Float2LongRBTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2LongSortedMap tailMap(float var1) {
      return new Float2LongRBTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2LongSortedMap subMap(float var1, float var2) {
      return new Float2LongRBTreeMap.Submap(var1, false, var2, false);
   }

   public Float2LongRBTreeMap clone() {
      Float2LongRBTreeMap var1;
      try {
         var1 = (Float2LongRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2LongRBTreeMap.Entry var5 = new Float2LongRBTreeMap.Entry();
         Float2LongRBTreeMap.Entry var6 = new Float2LongRBTreeMap.Entry();
         Float2LongRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2LongRBTreeMap.Entry var4 = var6;
         var6.pred((Float2LongRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2LongRBTreeMap.EntryIterator var3 = new Float2LongRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2LongRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2LongRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2LongRBTreeMap.Entry var3, Float2LongRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2LongRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2LongRBTreeMap.Entry(var1.readFloat(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Float2LongRBTreeMap.Entry(var1.readFloat(), var1.readLong());
         var8.black(true);
         var8.right(new Float2LongRBTreeMap.Entry(var1.readFloat(), var1.readLong()));
         ...
         Float2LongRBTreeMap.Entry var7 = new Float2LongRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2LongRBTreeMap.Entry)null, (Float2LongRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2LongSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2LongRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2LongRBTreeMap.Submap.SubmapIterator var1 = new Float2LongRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2LongRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2LongRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2LongRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Float2LongRBTreeMap.Submap.SubmapIterator var3 = new Float2LongRBTreeMap.Submap.SubmapIterator();
      ...
      public long get(float var1) {
         Float2LongRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2LongRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public long put(float var1, long var2) {
         ...
         if (!this.in(var1)) {
            ...
            long var4 = Float2LongRBTreeMap.this.put(var1, var2);
            return Float2LongRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public long remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var2 = Float2LongRBTreeMap.this.remove(var1);
            return Float2LongRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2LongSortedMap headMap(float var1) {
         if (this.top) {
            return Float2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2LongRBTreeMap.this.compare(var1, this.to) < 0 ? Float2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2LongSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2LongRBTreeMap.this.compare(var1, this.from) > 0 ? Float2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2LongSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2LongRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2LongRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2LongRBTreeMap.Entry firstEntry() {
         if (Float2LongRBTreeMap.this.tree == null) {
            ...
            Float2LongRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2LongRBTreeMap.this.firstEntry;
            } else {
               var1 = Float2LongRBTreeMap.this.locateKey(this.from);
               if (Float2LongRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2LongRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2LongRBTreeMap.Entry lastEntry() {
         if (Float2LongRBTreeMap.this.tree == null) {
            ...
            Float2LongRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2LongRBTreeMap.this.lastEntry;
            } else {
               var1 = Float2LongRBTreeMap.this.locateKey(this.to);
               if (Float2LongRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2LongRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2LongRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2LongRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2LongRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2LongRBTreeMap.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2LongRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2LongRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2LongRBTreeMap.this.locateKey(var2);
                  if (Float2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2LongSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2LongRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2LongRBTreeMap.TreeIterator implements ObjectListIterator<Float2LongMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2LongRBTreeMap.this.locateKey(var2)) != null) {
            if (Float2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2LongMap.BasicEntry implements Cloneable {
      ...
      void pred(Float2LongRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2LongRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2LongRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2LongRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2LongRBTreeMap.Entry next() {
         Float2LongRBTreeMap.Entry var1 = this.right;
      ...
      Float2LongRBTreeMap.Entry prev() {
         Float2LongRBTreeMap.Entry var1 = this.left;
      ...
      public Float2LongRBTreeMap.Entry clone() {
         Float2LongRBTreeMap.Entry var1;
         try {
            var1 = (Float2LongRBTreeMap.Entry)super.clone();
