...
public class Float2ByteRBTreeMap extends AbstractFloat2ByteSortedMap implements Serializable, Cloneable {
   ...
   public Float2ByteRBTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2ByteRBTreeMap(Map<? extends Float, ? extends Byte> var1) {
      this();
      this.putAll(var1);
   }

   public Float2ByteRBTreeMap(SortedMap<Float, Byte> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2ByteRBTreeMap(Float2ByteMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2ByteRBTreeMap(Float2ByteSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2ByteRBTreeMap(float[] var1, byte[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2ByteRBTreeMap(float[] var1, byte[] var2) {
   ...
   final Float2ByteRBTreeMap.Entry findKey(float var1) {
      Float2ByteRBTreeMap.Entry var2;
      int var3;
   ...
   final Float2ByteRBTreeMap.Entry locateKey(float var1) {
      Float2ByteRBTreeMap.Entry var2 = this.tree;
      Float2ByteRBTreeMap.Entry var3 = this.tree;
   ...
   public byte addTo(float var1, byte var2) {
      Float2ByteRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Float2ByteRBTreeMap.Entry add(float var1) {
      this.modified = false;
      int var2 = 0;
      Float2ByteRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Float2ByteRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Float2ByteRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Float2ByteRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Float2ByteRBTreeMap.Entry var7;
               Float2ByteRBTreeMap.Entry var8;
   ...
   public boolean containsValue(byte var1) {
      Float2ByteRBTreeMap.ValueIterator var2 = new Float2ByteRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public byte get(float var1) {
      Float2ByteRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
            final Comparator<? super Float2ByteMap.Entry> comparator = (var1x, var2) -> {
               return Float2ByteRBTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry var1) {
               return Float2ByteRBTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        Float2ByteRBTreeMap.Entry var3 = Float2ByteRBTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        ...
                        if (var3 != null && var3.getByteValue() == (Byte)var2.getValue()) {
                           Float2ByteRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry var1, Float2ByteMap.Entry var2) {
               return Float2ByteRBTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2ByteEntrySet();
            }

            public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry var1) {
               return Float2ByteRBTreeMap.this.headMap(var1.getFloatKey()).float2ByteEntrySet();
            }

            public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry var1) {
               return Float2ByteRBTreeMap.this.tailMap(var1.getFloatKey()).float2ByteEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Float2ByteRBTreeMap.this.containsValue(var1);
            }
   ...
   public Float2ByteSortedMap headMap(float var1) {
      return new Float2ByteRBTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2ByteSortedMap tailMap(float var1) {
      return new Float2ByteRBTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2ByteSortedMap subMap(float var1, float var2) {
      return new Float2ByteRBTreeMap.Submap(var1, false, var2, false);
   }

   public Float2ByteRBTreeMap clone() {
      Float2ByteRBTreeMap var1;
      try {
         var1 = (Float2ByteRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2ByteRBTreeMap.Entry var5 = new Float2ByteRBTreeMap.Entry();
         Float2ByteRBTreeMap.Entry var6 = new Float2ByteRBTreeMap.Entry();
         Float2ByteRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2ByteRBTreeMap.Entry var4 = var6;
         var6.pred((Float2ByteRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2ByteRBTreeMap.EntryIterator var3 = new Float2ByteRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2ByteRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2ByteRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2ByteRBTreeMap.Entry var3, Float2ByteRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2ByteRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2ByteRBTreeMap.Entry(var1.readFloat(), var1.readByte());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Float2ByteRBTreeMap.Entry(var1.readFloat(), var1.readByte());
         var8.black(true);
         var8.right(new Float2ByteRBTreeMap.Entry(var1.readFloat(), var1.readByte()));
         ...
         Float2ByteRBTreeMap.Entry var7 = new Float2ByteRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2ByteRBTreeMap.Entry)null, (Float2ByteRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2ByteSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2ByteRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2ByteRBTreeMap.Submap.SubmapIterator var1 = new Float2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2ByteRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2ByteRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2ByteRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(byte var1) {
         Float2ByteRBTreeMap.Submap.SubmapIterator var2 = new Float2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      public byte get(float var1) {
         Float2ByteRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2ByteRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public byte put(float var1, byte var2) {
         ...
         if (!this.in(var1)) {
            ...
            byte var3 = Float2ByteRBTreeMap.this.put(var1, var2);
            return Float2ByteRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public byte remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            byte var2 = Float2ByteRBTreeMap.this.remove(var1);
            return Float2ByteRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2ByteSortedMap headMap(float var1) {
         if (this.top) {
            return Float2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2ByteRBTreeMap.this.compare(var1, this.to) < 0 ? Float2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2ByteSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? Float2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2ByteSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2ByteRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2ByteRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2ByteRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2ByteRBTreeMap.Entry firstEntry() {
         if (Float2ByteRBTreeMap.this.tree == null) {
            ...
            Float2ByteRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2ByteRBTreeMap.this.firstEntry;
            } else {
               var1 = Float2ByteRBTreeMap.this.locateKey(this.from);
               if (Float2ByteRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2ByteRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2ByteRBTreeMap.Entry lastEntry() {
         if (Float2ByteRBTreeMap.this.tree == null) {
            ...
            Float2ByteRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2ByteRBTreeMap.this.lastEntry;
            } else {
               var1 = Float2ByteRBTreeMap.this.locateKey(this.to);
               if (Float2ByteRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2ByteRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2ByteRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2ByteRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2ByteRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2ByteMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2ByteRBTreeMap.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2ByteRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2ByteRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2ByteRBTreeMap.this.locateKey(var2);
                  if (Float2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2ByteSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2ByteRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2ByteRBTreeMap.TreeIterator implements ObjectListIterator<Float2ByteMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2ByteRBTreeMap.this.locateKey(var2)) != null) {
            if (Float2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2ByteMap.BasicEntry implements Cloneable {
      ...
      void pred(Float2ByteRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2ByteRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2ByteRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2ByteRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2ByteRBTreeMap.Entry next() {
         Float2ByteRBTreeMap.Entry var1 = this.right;
      ...
      Float2ByteRBTreeMap.Entry prev() {
         Float2ByteRBTreeMap.Entry var1 = this.left;
      ...
      public Float2ByteRBTreeMap.Entry clone() {
         Float2ByteRBTreeMap.Entry var1;
         try {
            var1 = (Float2ByteRBTreeMap.Entry)super.clone();
