...
public abstract class AbstractFloatList extends AbstractFloatCollection implements FloatList, FloatStack {
   ...
   public FloatListIterator listIterator(final int var1) {
      ...
      return new FloatListIterator() {
         ...
         public void add(float var1x) {
            AbstractFloatList.this.add(this.pos++, var1x);
            this.last = -1;
         }
         ...
         public void set(float var1x) {
            if (this.last == -1) {
               ...
               AbstractFloatList.this.set(this.last, var1x);
            }
         }
   ...
   public int lastIndexOf(float var1) {
      FloatListIterator var2 = this.listIterator(this.size());
   ...
   public FloatList subList(int var1, int var2) {
      ...
      if (var1 > var2) {
         ...
         return new AbstractFloatList.FloatSubList(this, var1, var2);
      }
   }

   public void removeElements(int var1, int var2) {
      this.ensureIndex(var2);
      FloatListIterator var3 = this.listIterator(var1);
      int var4 = var2 - var1;
      if (var4 < 0) {
   ...
   public void getElements(int var1, float[] var2, int var3, int var4) {
      FloatListIterator var5 = this.listIterator(var1);
      if (var3 < 0) {
         throw new ArrayIndexOutOfBoundsException("Offset (" + var3 + ") is negative");
      } else if (var3 + var4 > var2.length) {
         throw new ArrayIndexOutOfBoundsException("End index (" + (var3 + var4) + ") is greater than array length (" + var2.length + ")");
   ...
   public int hashCode() {
      FloatListIterator var1 = this.iterator();
      int var2 = 1;

      float var4;
      for(int var3 = this.size(); var3-- != 0; var2 = 31 * var2 + HashCommon.float2int(var4)) {
         var4 = var1.nextFloat();
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         if (var3 != var2.size()) {
            ...
            FloatListIterator var4;
            if (var2 instanceof FloatList) {
               var4 = this.listIterator();
               FloatListIterator var6 = ((FloatList)var2).listIterator();

               do {
                  if (var3-- == 0) {
                     return true;
                  }
               } while(var4.nextFloat() == var6.nextFloat());
   ...
   public int compareTo(List<? extends Float> var1) {
      if (var1 == this) {
         ...
         FloatListIterator var2;
         int var4;
         if (var1 instanceof FloatList) {
            var2 = this.listIterator();
            FloatListIterator var7 = ((FloatList)var1).listIterator();
   ...
   public float peekFloat(int var1) {
      return this.getFloat(this.size() - 1 - var1);
   }
   ...
   public boolean addAll(int var1, FloatCollection var2) {
      this.ensureIndex(var1);
      FloatIterator var3 = var2.iterator();
      boolean var4 = var3.hasNext();

      while(var3.hasNext()) {
         this.add(var1++, var3.nextFloat());
      }
   ...
   public boolean addAll(int var1, FloatList var2) {
      return this.addAll(var1, (FloatCollection)var2);
   }
   ...
   public static class FloatSubList extends AbstractFloatList implements Serializable {
      ...
      public FloatSubList(FloatList var1, int var2, int var3) {
         super();
         this.l = var1;
         this.from = var2;
         this.to = var3;
         ...
         return new FloatListIterator() {
            ...
            public void add(float var1x) {
               if (this.last == -1) {
                  ...
                  FloatSubList.this.add(this.pos++, var1x);
                  this.last = -1;
