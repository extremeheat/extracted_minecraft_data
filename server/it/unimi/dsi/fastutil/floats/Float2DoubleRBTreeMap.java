...
public class Float2DoubleRBTreeMap extends AbstractFloat2DoubleSortedMap implements Serializable, Cloneable {
   ...
   public Float2DoubleRBTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2DoubleRBTreeMap(Map<? extends Float, ? extends Double> var1) {
      this();
      this.putAll(var1);
   }

   public Float2DoubleRBTreeMap(SortedMap<Float, Double> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2DoubleRBTreeMap(Float2DoubleMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2DoubleRBTreeMap(Float2DoubleSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2DoubleRBTreeMap(float[] var1, double[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2DoubleRBTreeMap(float[] var1, double[] var2) {
   ...
   final Float2DoubleRBTreeMap.Entry findKey(float var1) {
      Float2DoubleRBTreeMap.Entry var2;
      int var3;
   ...
   final Float2DoubleRBTreeMap.Entry locateKey(float var1) {
      Float2DoubleRBTreeMap.Entry var2 = this.tree;
      Float2DoubleRBTreeMap.Entry var3 = this.tree;
   ...
   public double addTo(float var1, double var2) {
      Float2DoubleRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Float2DoubleRBTreeMap.Entry add(float var1) {
      this.modified = false;
      int var2 = 0;
      Float2DoubleRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Float2DoubleRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Float2DoubleRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Float2DoubleRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Float2DoubleRBTreeMap.Entry var7;
               Float2DoubleRBTreeMap.Entry var8;
   ...
   public boolean containsValue(double var1) {
      Float2DoubleRBTreeMap.ValueIterator var3 = new Float2DoubleRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public double get(float var1) {
      Float2DoubleRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>() {
            final Comparator<? super Float2DoubleMap.Entry> comparator = (var1x, var2) -> {
               return Float2DoubleRBTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry var1) {
               return Float2DoubleRBTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        Float2DoubleRBTreeMap.Entry var3 = Float2DoubleRBTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        ...
                        if (var3 != null && Double.doubleToLongBits(var3.getDoubleValue()) == Double.doubleToLongBits((Double)var2.getValue())) {
                           Float2DoubleRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry var1, Float2DoubleMap.Entry var2) {
               return Float2DoubleRBTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2DoubleEntrySet();
            }

            public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry var1) {
               return Float2DoubleRBTreeMap.this.headMap(var1.getFloatKey()).float2DoubleEntrySet();
            }

            public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry var1) {
               return Float2DoubleRBTreeMap.this.tailMap(var1.getFloatKey()).float2DoubleEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Float2DoubleRBTreeMap.this.containsValue(var1);
            }
   ...
   public Float2DoubleSortedMap headMap(float var1) {
      return new Float2DoubleRBTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2DoubleSortedMap tailMap(float var1) {
      return new Float2DoubleRBTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2DoubleSortedMap subMap(float var1, float var2) {
      return new Float2DoubleRBTreeMap.Submap(var1, false, var2, false);
   }

   public Float2DoubleRBTreeMap clone() {
      Float2DoubleRBTreeMap var1;
      try {
         var1 = (Float2DoubleRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2DoubleRBTreeMap.Entry var5 = new Float2DoubleRBTreeMap.Entry();
         Float2DoubleRBTreeMap.Entry var6 = new Float2DoubleRBTreeMap.Entry();
         Float2DoubleRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2DoubleRBTreeMap.Entry var4 = var6;
         var6.pred((Float2DoubleRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2DoubleRBTreeMap.EntryIterator var3 = new Float2DoubleRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2DoubleRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2DoubleRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2DoubleRBTreeMap.Entry var3, Float2DoubleRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2DoubleRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2DoubleRBTreeMap.Entry(var1.readFloat(), var1.readDouble());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Float2DoubleRBTreeMap.Entry(var1.readFloat(), var1.readDouble());
         var8.black(true);
         var8.right(new Float2DoubleRBTreeMap.Entry(var1.readFloat(), var1.readDouble()));
         ...
         Float2DoubleRBTreeMap.Entry var7 = new Float2DoubleRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2DoubleRBTreeMap.Entry)null, (Float2DoubleRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2DoubleSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2DoubleRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2DoubleRBTreeMap.Submap.SubmapIterator var1 = new Float2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2DoubleRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2DoubleRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2DoubleRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(double var1) {
         Float2DoubleRBTreeMap.Submap.SubmapIterator var3 = new Float2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      public double get(float var1) {
         Float2DoubleRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2DoubleRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public double put(float var1, double var2) {
         ...
         if (!this.in(var1)) {
            ...
            double var4 = Float2DoubleRBTreeMap.this.put(var1, var2);
            return Float2DoubleRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public double remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            double var2 = Float2DoubleRBTreeMap.this.remove(var1);
            return Float2DoubleRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2DoubleSortedMap headMap(float var1) {
         if (this.top) {
            return Float2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2DoubleRBTreeMap.this.compare(var1, this.to) < 0 ? Float2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2DoubleSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? Float2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2DoubleSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2DoubleRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2DoubleRBTreeMap.Entry firstEntry() {
         if (Float2DoubleRBTreeMap.this.tree == null) {
            ...
            Float2DoubleRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2DoubleRBTreeMap.this.firstEntry;
            } else {
               var1 = Float2DoubleRBTreeMap.this.locateKey(this.from);
               if (Float2DoubleRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2DoubleRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2DoubleRBTreeMap.Entry lastEntry() {
         if (Float2DoubleRBTreeMap.this.tree == null) {
            ...
            Float2DoubleRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2DoubleRBTreeMap.this.lastEntry;
            } else {
               var1 = Float2DoubleRBTreeMap.this.locateKey(this.to);
               if (Float2DoubleRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2DoubleRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2DoubleRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2DoubleRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2DoubleRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2DoubleMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2DoubleRBTreeMap.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2DoubleRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2DoubleRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2DoubleRBTreeMap.this.locateKey(var2);
                  if (Float2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2DoubleSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2DoubleRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2DoubleRBTreeMap.TreeIterator implements ObjectListIterator<Float2DoubleMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2DoubleRBTreeMap.this.locateKey(var2)) != null) {
            if (Float2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2DoubleMap.BasicEntry implements Cloneable {
      ...
      void pred(Float2DoubleRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2DoubleRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2DoubleRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2DoubleRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2DoubleRBTreeMap.Entry next() {
         Float2DoubleRBTreeMap.Entry var1 = this.right;
      ...
      Float2DoubleRBTreeMap.Entry prev() {
         Float2DoubleRBTreeMap.Entry var1 = this.left;
      ...
      public Float2DoubleRBTreeMap.Entry clone() {
         Float2DoubleRBTreeMap.Entry var1;
         try {
            var1 = (Float2DoubleRBTreeMap.Entry)super.clone();
