...
public final class Float2FloatFunctions {
   ...
   public static Float2FloatFunction singleton(float var0, float var1) {
      return new Float2FloatFunctions.Singleton(var0, var1);
   }
   ...
   public static Float2FloatFunction synchronize(Float2FloatFunction var0) {
      return new Float2FloatFunctions.SynchronizedFunction(var0);
   }

   public static Float2FloatFunction synchronize(Float2FloatFunction var0, Object var1) {
      return new Float2FloatFunctions.SynchronizedFunction(var0, var1);
   }

   public static Float2FloatFunction unmodifiable(Float2FloatFunction var0) {
      return new Float2FloatFunctions.UnmodifiableFunction(var0);
   }

   public static Float2FloatFunction primitive(Function<? super Float, ? extends Float> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Float2FloatFunction) {
         return (Float2FloatFunction)var0;
      } else {
         return (Float2FloatFunction)(var0 instanceof DoubleUnaryOperator ? (var1) -> {
            return SafeMath.safeDoubleToFloat(((DoubleUnaryOperator)var0).applyAsDouble((double)var1));
         } : new Float2FloatFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class PrimitiveFunction implements Float2FloatFunction {
      ...
      protected PrimitiveFunction(Function<? super Float, ? extends Float> var1) {
         super();
         this.function = var1;
      }
      ...
      public Float get(Object var1) {
         return var1 == null ? null : (Float)this.function.apply((Float)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractFloat2FloatFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Float2FloatFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Float2FloatFunction, Serializable {
      ...
      protected SynchronizedFunction(Float2FloatFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Float2FloatFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
