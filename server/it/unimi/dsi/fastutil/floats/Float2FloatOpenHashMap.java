...
public class Float2FloatOpenHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Float2FloatOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2FloatOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2FloatOpenHashMap(Map<? extends Float, ? extends Float> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2FloatOpenHashMap(Map<? extends Float, ? extends Float> var1) {
      this(var1, 0.75F);
   }

   public Float2FloatOpenHashMap(Float2FloatMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2FloatOpenHashMap(Float2FloatMap var1) {
      this(var1, 0.75F);
   }

   public Float2FloatOpenHashMap(float[] var1, float[] var2, float var3) {
   ...
   public Float2FloatOpenHashMap(float[] var1, float[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Float2FloatOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Float2FloatOpenHashMap.this.containsNullKey) {
                  var1.accept((double)Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n]);
               }

               int var2 = Float2FloatOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2FloatOpenHashMap.this.key[var2]) != 0) {
                     var1.accept((double)Float2FloatOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2FloatOpenHashMap clone() {
      Float2FloatOpenHashMap var1;
      try {
         var1 = (Float2FloatOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      float[] var3 = this.value;
      Float2FloatOpenHashMap.MapIterator var4 = new Float2FloatOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2FloatOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2FloatOpenHashMap.this.key[Float2FloatOpenHashMap.this.n]);
         }

         int var2 = Float2FloatOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2FloatOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2FloatOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2FloatOpenHashMap.this.size;
         Float2FloatOpenHashMap.this.remove(var1);
         return Float2FloatOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Float.floatToIntBits(var3) == 0) {
                     return Float2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     float[] var6 = Float2FloatOpenHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2FloatOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var5)) {
                        return Float.floatToIntBits(Float2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2FloatOpenHashMap.this.mask]) != 0) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (Float.floatToIntBits(var3) == 0) {
                     if (Float2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2FloatOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float.floatToIntBits(Float2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Float2FloatOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2FloatOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(Float.floatToIntBits(var5) != Float.floatToIntBits(var3) || Float.floatToIntBits(Float2FloatOpenHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Float2FloatMap.Entry> var1) {
         if (Float2FloatOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2FloatMap.BasicEntry(Float2FloatOpenHashMap.this.key[Float2FloatOpenHashMap.this.n], Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2FloatOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2FloatMap.BasicEntry(Float2FloatOpenHashMap.this.key[var2], Float2FloatOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2FloatMap.Entry> var1) {
         ...
         if (Float2FloatOpenHashMap.this.containsNullKey) {
            var2.key = Float2FloatOpenHashMap.this.key[Float2FloatOpenHashMap.this.n];
            var2.value = Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2FloatOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2FloatOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2FloatOpenHashMap.this.key[var3];
               var2.value = Float2FloatOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2FloatOpenHashMap.MapIterator implements ObjectIterator<Float2FloatMap.Entry> {
      private final Float2FloatOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2FloatOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2FloatOpenHashMap.MapIterator implements ObjectIterator<Float2FloatMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2FloatOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2FloatOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2FloatOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2FloatOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2FloatOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2FloatOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2FloatOpenHashMap.this.value[var2] = Float2FloatOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2FloatMap.Entry, java.util.Map.Entry<Float, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Float2FloatOpenHashMap.this.value[this.index];
         Float2FloatOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2FloatOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Float.floatToIntBits(Float2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
