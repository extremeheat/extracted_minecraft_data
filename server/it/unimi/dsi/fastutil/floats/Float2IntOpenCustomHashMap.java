...
public class Float2IntOpenCustomHashMap extends AbstractFloat2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Float2IntOpenCustomHashMap(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Float2IntOpenCustomHashMap(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2IntOpenCustomHashMap(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Float2IntOpenCustomHashMap(Map<? extends Float, ? extends Integer> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2IntOpenCustomHashMap(Map<? extends Float, ? extends Integer> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2IntOpenCustomHashMap(Float2IntMap var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2IntOpenCustomHashMap(Float2IntMap var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2IntOpenCustomHashMap(float[] var1, int[] var2, float var3, FloatHash.Strategy var4) {
   ...
   public Float2IntOpenCustomHashMap(float[] var1, int[] var2, FloatHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Float2IntOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Float2IntOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n]);
               }

               int var2 = Float2IntOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2IntOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2IntOpenCustomHashMap clone() {
      Float2IntOpenCustomHashMap var1;
      try {
         var1 = (Float2IntOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      int[] var3 = this.value;
      Float2IntOpenCustomHashMap.MapIterator var4 = new Float2IntOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept((double)Float2IntOpenCustomHashMap.this.key[Float2IntOpenCustomHashMap.this.n]);
         }

         int var2 = Float2IntOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2IntOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2IntOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2IntOpenCustomHashMap.this.size;
         Float2IntOpenCustomHashMap.this.remove(var1);
         return Float2IntOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements Float2IntMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (Float2IntOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     return Float2IntOpenCustomHashMap.this.containsNullKey && Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2IntOpenCustomHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2IntOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float2IntOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2IntOpenCustomHashMap.this.mask]) != 0) {
                           if (Float2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float2IntOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var4 = (Integer)var2.getValue();
                  if (Float2IntOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     if (Float2IntOpenCustomHashMap.this.containsNullKey && Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2IntOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2IntOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float2IntOpenCustomHashMap.this.value[var7] == var4) {
                           Float2IntOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2IntOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Float2IntOpenCustomHashMap.this.strategy.equals(var5, var3) || Float2IntOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2IntMap.Entry> var1) {
         if (Float2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntOpenCustomHashMap.this.key[Float2IntOpenCustomHashMap.this.n], Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntOpenCustomHashMap.this.key[var2], Float2IntOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2IntMap.Entry> var1) {
         ...
         if (Float2IntOpenCustomHashMap.this.containsNullKey) {
            var2.key = Float2IntOpenCustomHashMap.this.key[Float2IntOpenCustomHashMap.this.n];
            var2.value = Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2IntOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[var3]) != 0) {
               var2.key = Float2IntOpenCustomHashMap.this.key[var3];
               var2.value = Float2IntOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Float2IntMap.Entry> {
      private final Float2IntOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2IntOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Float2IntMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2IntOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(var2)) & Float2IntOpenCustomHashMap.this.mask; !Float2IntOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Float2IntOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2IntOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2IntOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(var4)) & Float2IntOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2IntOpenCustomHashMap.this.value[var2] = Float2IntOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2IntMap.Entry, java.util.Map.Entry<Float, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Float2IntOpenCustomHashMap.this.value[this.index];
         Float2IntOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[this.index], (Float)var2.getKey()) && Float2IntOpenCustomHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
