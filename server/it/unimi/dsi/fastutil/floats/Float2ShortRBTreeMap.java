...
public class Float2ShortRBTreeMap extends AbstractFloat2ShortSortedMap implements Serializable, Cloneable {
   protected transient Float2ShortRBTreeMap.Entry tree;
   protected int count;
   protected transient Float2ShortRBTreeMap.Entry firstEntry;
   protected transient Float2ShortRBTreeMap.Entry lastEntry;
   ...
   private transient Float2ShortRBTreeMap.Entry[] nodePath;
   ...
   public Float2ShortRBTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2ShortRBTreeMap(Map<? extends Float, ? extends Short> var1) {
      this();
      this.putAll(var1);
   }

   public Float2ShortRBTreeMap(SortedMap<Float, Short> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2ShortRBTreeMap(Float2ShortMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2ShortRBTreeMap(Float2ShortSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2ShortRBTreeMap(float[] var1, short[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2ShortRBTreeMap(float[] var1, short[] var2) {
   ...
   final Float2ShortRBTreeMap.Entry findKey(float var1) {
      Float2ShortRBTreeMap.Entry var2;
      int var3;
   ...
   final Float2ShortRBTreeMap.Entry locateKey(float var1) {
      Float2ShortRBTreeMap.Entry var2 = this.tree;
      Float2ShortRBTreeMap.Entry var3 = this.tree;
   ...
   private void allocatePaths() {
      ...
      this.nodePath = new Float2ShortRBTreeMap.Entry[64];
   }

   public short addTo(float var1, short var2) {
      Float2ShortRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Float2ShortRBTreeMap.Entry add(float var1) {
      this.modified = false;
      int var2 = 0;
      Float2ShortRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Float2ShortRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Float2ShortRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Float2ShortRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Float2ShortRBTreeMap.Entry var7;
               Float2ShortRBTreeMap.Entry var8;
   ...
   public boolean containsValue(short var1) {
      Float2ShortRBTreeMap.ValueIterator var2 = new Float2ShortRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public short get(float var1) {
      Float2ShortRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() {
            final Comparator<? super Float2ShortMap.Entry> comparator = (var1x, var2) -> {
               return Float2ShortRBTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator() {
               return Float2ShortRBTreeMap.this.new EntryIterator();
            }

            public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry var1) {
               return Float2ShortRBTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        Float2ShortRBTreeMap.Entry var3 = Float2ShortRBTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        ...
                        if (var3 != null && var3.getShortValue() == (Short)var2.getValue()) {
                           Float2ShortRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2ShortMap.Entry> subSet(Float2ShortMap.Entry var1, Float2ShortMap.Entry var2) {
               return Float2ShortRBTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2ShortEntrySet();
            }

            public ObjectSortedSet<Float2ShortMap.Entry> headSet(Float2ShortMap.Entry var1) {
               return Float2ShortRBTreeMap.this.headMap(var1.getFloatKey()).float2ShortEntrySet();
            }

            public ObjectSortedSet<Float2ShortMap.Entry> tailSet(Float2ShortMap.Entry var1) {
               return Float2ShortRBTreeMap.this.tailMap(var1.getFloatKey()).float2ShortEntrySet();
            }
         };
      }
   ...
   public FloatSortedSet keySet() {
      if (this.keys == null) {
         this.keys = new Float2ShortRBTreeMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            public ShortIterator iterator() {
               return Float2ShortRBTreeMap.this.new ValueIterator();
            }

            public boolean contains(short var1) {
               return Float2ShortRBTreeMap.this.containsValue(var1);
            }
   ...
   public Float2ShortSortedMap headMap(float var1) {
      return new Float2ShortRBTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2ShortSortedMap tailMap(float var1) {
      return new Float2ShortRBTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2ShortSortedMap subMap(float var1, float var2) {
      return new Float2ShortRBTreeMap.Submap(var1, false, var2, false);
   }

   public Float2ShortRBTreeMap clone() {
      Float2ShortRBTreeMap var1;
      try {
         var1 = (Float2ShortRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2ShortRBTreeMap.Entry var5 = new Float2ShortRBTreeMap.Entry();
         Float2ShortRBTreeMap.Entry var6 = new Float2ShortRBTreeMap.Entry();
         Float2ShortRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2ShortRBTreeMap.Entry var4 = var6;
         var6.pred((Float2ShortRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2ShortRBTreeMap.EntryIterator var3 = new Float2ShortRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2ShortRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2ShortRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2ShortRBTreeMap.Entry var3, Float2ShortRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2ShortRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2ShortRBTreeMap.Entry(var1.readFloat(), var1.readShort());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Float2ShortRBTreeMap.Entry(var1.readFloat(), var1.readShort());
         var8.black(true);
         var8.right(new Float2ShortRBTreeMap.Entry(var1.readFloat(), var1.readShort()));
         ...
         Float2ShortRBTreeMap.Entry var7 = new Float2ShortRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2ShortRBTreeMap.Entry)null, (Float2ShortRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2ShortSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2ShortRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2ShortRBTreeMap.Submap.SubmapIterator var1 = new Float2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2ShortRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2ShortRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public FloatSortedSet keySet() {
         if (this.keys == null) {
            this.keys = new Float2ShortRBTreeMap.Submap.KeySet();
         }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2ShortRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(short var1) {
         Float2ShortRBTreeMap.Submap.SubmapIterator var2 = new Float2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      public short get(float var1) {
         Float2ShortRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2ShortRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public short put(float var1, short var2) {
         ...
         if (!this.in(var1)) {
            ...
            short var3 = Float2ShortRBTreeMap.this.put(var1, var2);
            return Float2ShortRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public short remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            short var2 = Float2ShortRBTreeMap.this.remove(var1);
            return Float2ShortRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public boolean isEmpty() {
         return !(new Float2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
      }
      ...
      public Float2ShortSortedMap headMap(float var1) {
         if (this.top) {
            return Float2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2ShortRBTreeMap.this.compare(var1, this.to) < 0 ? Float2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2ShortSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? Float2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2ShortSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2ShortRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2ShortRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2ShortRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2ShortRBTreeMap.Entry firstEntry() {
         if (Float2ShortRBTreeMap.this.tree == null) {
            ...
            Float2ShortRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2ShortRBTreeMap.this.firstEntry;
            } else {
               var1 = Float2ShortRBTreeMap.this.locateKey(this.from);
               if (Float2ShortRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2ShortRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2ShortRBTreeMap.Entry lastEntry() {
         if (Float2ShortRBTreeMap.this.tree == null) {
            ...
            Float2ShortRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2ShortRBTreeMap.this.lastEntry;
            } else {
               var1 = Float2ShortRBTreeMap.this.locateKey(this.to);
               if (Float2ShortRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2ShortRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2ShortRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2ShortRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private final class SubmapValueIterator extends Float2ShortRBTreeMap.Submap.SubmapIterator implements ShortListIterator {
      ...
      private final class SubmapKeyIterator extends Float2ShortRBTreeMap.Submap.SubmapIterator implements FloatListIterator {
      ...
      private class SubmapEntryIterator extends Float2ShortRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2ShortMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2ShortRBTreeMap.TreeIterator {
         SubmapIterator() {
            super();
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2ShortRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2ShortRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2ShortRBTreeMap.this.locateKey(var2);
                  if (Float2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Float2ShortRBTreeMap.this.compare(this.prev.key, Submap.this.from) < 0) {
               this.prev = null;
            }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Float2ShortRBTreeMap.this.compare(this.next.key, Submap.this.to) >= 0) {
               this.next = null;
            }
   ...
   private final class ValueIterator extends Float2ShortRBTreeMap.TreeIterator implements ShortListIterator {
   ...
   private class KeySet extends AbstractFloat2ShortSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator() {
         return Float2ShortRBTreeMap.this.new KeyIterator();
      }

      public FloatBidirectionalIterator iterator(float var1) {
         return Float2ShortRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private final class KeyIterator extends Float2ShortRBTreeMap.TreeIterator implements FloatListIterator {
      public KeyIterator() {
         super();
      }
   ...
   private class EntryIterator extends Float2ShortRBTreeMap.TreeIterator implements ObjectListIterator<Float2ShortMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2ShortRBTreeMap.this.locateKey(var2)) != null) {
            if (Float2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2ShortMap.BasicEntry implements Cloneable {
      ...
      Float2ShortRBTreeMap.Entry left;
      Float2ShortRBTreeMap.Entry right;
      int info;
      ...
      void pred(Float2ShortRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2ShortRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2ShortRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2ShortRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2ShortRBTreeMap.Entry next() {
         Float2ShortRBTreeMap.Entry var1 = this.right;
      ...
      Float2ShortRBTreeMap.Entry prev() {
         Float2ShortRBTreeMap.Entry var1 = this.left;
      ...
      public Float2ShortRBTreeMap.Entry clone() {
         Float2ShortRBTreeMap.Entry var1;
         try {
            var1 = (Float2ShortRBTreeMap.Entry)super.clone();
