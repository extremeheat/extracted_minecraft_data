...
public class Float2LongOpenHashMap extends AbstractFloat2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Float2LongOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2LongOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2LongOpenHashMap(Map<? extends Float, ? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2LongOpenHashMap(Map<? extends Float, ? extends Long> var1) {
      this(var1, 0.75F);
   }

   public Float2LongOpenHashMap(Float2LongMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2LongOpenHashMap(Float2LongMap var1) {
      this(var1, 0.75F);
   }

   public Float2LongOpenHashMap(float[] var1, long[] var2, float var3) {
   ...
   public Float2LongOpenHashMap(float[] var1, long[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Float2LongOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Float2LongOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2LongOpenHashMap.this.value[Float2LongOpenHashMap.this.n]);
               }

               int var2 = Float2LongOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2LongOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2LongOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2LongOpenHashMap clone() {
      Float2LongOpenHashMap var1;
      try {
         var1 = (Float2LongOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      long[] var3 = this.value;
      Float2LongOpenHashMap.MapIterator var4 = new Float2LongOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2LongOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2LongOpenHashMap.this.key[Float2LongOpenHashMap.this.n]);
         }

         int var2 = Float2LongOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2LongOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2LongOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2LongOpenHashMap.this.size;
         Float2LongOpenHashMap.this.remove(var1);
         return Float2LongOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (Float.floatToIntBits(var3) == 0) {
                     return Float2LongOpenHashMap.this.containsNullKey && Float2LongOpenHashMap.this.value[Float2LongOpenHashMap.this.n] == var4;
                  } else {
                     float[] var7 = Float2LongOpenHashMap.this.key;
                     float var6;
                     int var8;
                     if (Float.floatToIntBits(var6 = var7[var8 = HashCommon.mix(HashCommon.float2int(var3)) & Float2LongOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var6)) {
                        return Float2LongOpenHashMap.this.value[var8] == var4;
                     } else {
                        while(Float.floatToIntBits(var6 = var7[var8 = var8 + 1 & Float2LongOpenHashMap.this.mask]) != 0) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var4 = (Long)var2.getValue();
                  if (Float.floatToIntBits(var3) == 0) {
                     if (Float2LongOpenHashMap.this.containsNullKey && Float2LongOpenHashMap.this.value[Float2LongOpenHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var6 = var7[var8 = HashCommon.mix(HashCommon.float2int(var3)) & Float2LongOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float2LongOpenHashMap.this.value[var8] == var4) {
                           Float2LongOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var6 = var7[var8 = var8 + 1 & Float2LongOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(Float.floatToIntBits(var6) != Float.floatToIntBits(var3) || Float2LongOpenHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Float2LongMap.Entry> var1) {
         if (Float2LongOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2LongMap.BasicEntry(Float2LongOpenHashMap.this.key[Float2LongOpenHashMap.this.n], Float2LongOpenHashMap.this.value[Float2LongOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2LongOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2LongMap.BasicEntry(Float2LongOpenHashMap.this.key[var2], Float2LongOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2LongMap.Entry> var1) {
         ...
         if (Float2LongOpenHashMap.this.containsNullKey) {
            var2.key = Float2LongOpenHashMap.this.key[Float2LongOpenHashMap.this.n];
            var2.value = Float2LongOpenHashMap.this.value[Float2LongOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2LongOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2LongOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2LongOpenHashMap.this.key[var3];
               var2.value = Float2LongOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2LongOpenHashMap.MapIterator implements ObjectIterator<Float2LongMap.Entry> {
      private final Float2LongOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2LongOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2LongOpenHashMap.MapIterator implements ObjectIterator<Float2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2LongOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2LongOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2LongOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2LongOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2LongOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2LongOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2LongOpenHashMap.this.value[var2] = Float2LongOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2LongMap.Entry, java.util.Map.Entry<Float, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Float2LongOpenHashMap.this.value[this.index];
         Float2LongOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2LongOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Float2LongOpenHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
