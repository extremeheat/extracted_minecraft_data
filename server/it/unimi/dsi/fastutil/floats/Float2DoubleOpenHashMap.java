...
public class Float2DoubleOpenHashMap extends AbstractFloat2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Float2DoubleOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2DoubleOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2DoubleOpenHashMap(Map<? extends Float, ? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2DoubleOpenHashMap(Map<? extends Float, ? extends Double> var1) {
      this(var1, 0.75F);
   }

   public Float2DoubleOpenHashMap(Float2DoubleMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2DoubleOpenHashMap(Float2DoubleMap var1) {
      this(var1, 0.75F);
   }

   public Float2DoubleOpenHashMap(float[] var1, double[] var2, float var3) {
   ...
   public Float2DoubleOpenHashMap(float[] var1, double[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Float2DoubleOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Float2DoubleOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n]);
               }

               int var2 = Float2DoubleOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2DoubleOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2DoubleOpenHashMap clone() {
      Float2DoubleOpenHashMap var1;
      try {
         var1 = (Float2DoubleOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      double[] var3 = this.value;
      Float2DoubleOpenHashMap.MapIterator var4 = new Float2DoubleOpenHashMap.MapIterator();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var7 = this.size; var7-- != 0; var3[var8] = var5) {
         ...
         if (Float.floatToIntBits(var4) == 0) {
            ...
            for(var8 = HashCommon.mix(HashCommon.float2int(var4)) & this.mask; Float.floatToIntBits(var2[var8]) != 0; var8 = var8 + 1 & this.mask) {
            }
         }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2DoubleOpenHashMap.this.key[Float2DoubleOpenHashMap.this.n]);
         }

         int var2 = Float2DoubleOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2DoubleOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2DoubleOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2DoubleOpenHashMap.this.size;
         Float2DoubleOpenHashMap.this.remove(var1);
         return Float2DoubleOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (Float.floatToIntBits(var3) == 0) {
                     return Float2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4);
                  } else {
                     float[] var7 = Float2DoubleOpenHashMap.this.key;
                     float var6;
                     int var8;
                     if (Float.floatToIntBits(var6 = var7[var8 = HashCommon.mix(HashCommon.float2int(var3)) & Float2DoubleOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var6)) {
                        return Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                     } else {
                        while(Float.floatToIntBits(var6 = var7[var8 = var8 + 1 & Float2DoubleOpenHashMap.this.mask]) != 0) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var4 = (Double)var2.getValue();
                  if (Float.floatToIntBits(var3) == 0) {
                     if (Float2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                     ...
                     if (Float.floatToIntBits(var6 = var7[var8 = HashCommon.mix(HashCommon.float2int(var3)) & Float2DoubleOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                           Float2DoubleOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var6 = var7[var8 = var8 + 1 & Float2DoubleOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(Float.floatToIntBits(var6) != Float.floatToIntBits(var3) || Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Float2DoubleMap.Entry> var1) {
         if (Float2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2DoubleMap.BasicEntry(Float2DoubleOpenHashMap.this.key[Float2DoubleOpenHashMap.this.n], Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2DoubleMap.BasicEntry(Float2DoubleOpenHashMap.this.key[var2], Float2DoubleOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2DoubleMap.Entry> var1) {
         ...
         if (Float2DoubleOpenHashMap.this.containsNullKey) {
            var2.key = Float2DoubleOpenHashMap.this.key[Float2DoubleOpenHashMap.this.n];
            var2.value = Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2DoubleOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2DoubleOpenHashMap.this.key[var3];
               var2.value = Float2DoubleOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2DoubleOpenHashMap.MapIterator implements ObjectIterator<Float2DoubleMap.Entry> {
      private final Float2DoubleOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2DoubleOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2DoubleOpenHashMap.MapIterator implements ObjectIterator<Float2DoubleMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2DoubleOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2DoubleOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2DoubleOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2DoubleOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2DoubleOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2DoubleOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2DoubleOpenHashMap.this.value[var2] = Float2DoubleOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2DoubleMap.Entry, java.util.Map.Entry<Float, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Float2DoubleOpenHashMap.this.value[this.index];
         Float2DoubleOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
