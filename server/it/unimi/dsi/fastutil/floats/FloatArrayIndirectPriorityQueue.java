...
public class FloatArrayIndirectPriorityQueue implements FloatIndirectPriorityQueue {
   ...
   public FloatArrayIndirectPriorityQueue(float[] var1, int var2, FloatComparator var3) {
      super();
   ...
   public FloatArrayIndirectPriorityQueue(float[] var1, int var2) {
      this(var1, var2, (FloatComparator)null);
   }

   public FloatArrayIndirectPriorityQueue(float[] var1, FloatComparator var2) {
      this(var1, var1.length, var2);
   }

   public FloatArrayIndirectPriorityQueue(float[] var1) {
      this(var1, var1.length, (FloatComparator)null);
   }

   public FloatArrayIndirectPriorityQueue(float[] var1, int[] var2, int var3, FloatComparator var4) {
      this(var1, 0, var4);
      this.array = var2;
      this.size = var3;
   }
   ...
   public FloatArrayIndirectPriorityQueue(float[] var1, int[] var2, int var3) {
   ...
   private int findFirst() {
      if (this.firstIndexValid) {
         ...
         --var1;
         int var2 = var1;
         float var3 = this.refArray[this.array[var1]];
         if (this.c == null) {
            while(var1-- != 0) {
               if (Float.compare(this.refArray[this.array[var1]], var3) < 0) {
                  var2 = var1;
   ...
   private int findLast() {
      ...
      if (this.c == null) {
         while(var1-- != 0) {
            if (Float.compare(var3, this.refArray[this.array[var1]]) < 0) {
               var2 = var1;
               var3 = this.refArray[this.array[var1]];
            }
         }
   ...
   public void enqueue(int var1) {
      ...
      if (this.firstIndexValid) {
         if (this.c == null) {
            if (Float.compare(this.refArray[var1], this.refArray[this.array[this.firstIndex]]) < 0) {
   ...
   public int front(int[] var1) {
      float var2 = this.refArray[this.array[this.findFirst()]];
      int var3 = this.size;
      int var4 = 0;

      while(var3-- != 0) {
         if (Float.floatToIntBits(var2) == Float.floatToIntBits(this.refArray[this.array[var3]])) {
