...
public class Float2FloatAVLTreeMap extends AbstractFloat2FloatSortedMap implements Serializable, Cloneable {
   ...
   public Float2FloatAVLTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2FloatAVLTreeMap(Map<? extends Float, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Float2FloatAVLTreeMap(SortedMap<Float, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2FloatAVLTreeMap(Float2FloatMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2FloatAVLTreeMap(Float2FloatSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2FloatAVLTreeMap(float[] var1, float[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2FloatAVLTreeMap(float[] var1, float[] var2) {
   ...
   final Float2FloatAVLTreeMap.Entry findKey(float var1) {
      Float2FloatAVLTreeMap.Entry var2;
      int var3;
   ...
   final Float2FloatAVLTreeMap.Entry locateKey(float var1) {
      Float2FloatAVLTreeMap.Entry var2 = this.tree;
      Float2FloatAVLTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(float var1, float var2) {
      Float2FloatAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Float2FloatAVLTreeMap.Entry add(float var1) {
      this.modified = false;
      Float2FloatAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Float2FloatAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Float2FloatAVLTreeMap.Entry var3 = this.tree;
         Float2FloatAVLTreeMap.Entry var4 = null;
         Float2FloatAVLTreeMap.Entry var5 = this.tree;
         Float2FloatAVLTreeMap.Entry var6 = null;
         Float2FloatAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Float2FloatAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Float2FloatAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Float2FloatAVLTreeMap.Entry parent(Float2FloatAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Float2FloatAVLTreeMap.Entry var3 = var1;

         Float2FloatAVLTreeMap.Entry var2;
         Float2FloatAVLTreeMap.Entry var4;
   ...
   public float remove(float var1) {
      ...
      if (this.tree == null) {
         ...
         Float2FloatAVLTreeMap.Entry var7;
         Float2FloatAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Float2FloatAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(float var1) {
      Float2FloatAVLTreeMap.ValueIterator var2 = new Float2FloatAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float get(float var1) {
      Float2FloatAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
            final Comparator<? super Float2FloatMap.Entry> comparator = (var1x, var2) -> {
               return Float2FloatAVLTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(Float2FloatMap.Entry var1) {
               return Float2FloatAVLTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        Float2FloatAVLTreeMap.Entry var3 = Float2FloatAVLTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                           Float2FloatAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry var1, Float2FloatMap.Entry var2) {
               return Float2FloatAVLTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2FloatEntrySet();
            }

            public ObjectSortedSet<Float2FloatMap.Entry> headSet(Float2FloatMap.Entry var1) {
               return Float2FloatAVLTreeMap.this.headMap(var1.getFloatKey()).float2FloatEntrySet();
            }

            public ObjectSortedSet<Float2FloatMap.Entry> tailSet(Float2FloatMap.Entry var1) {
               return Float2FloatAVLTreeMap.this.tailMap(var1.getFloatKey()).float2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Float2FloatAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Float2FloatSortedMap headMap(float var1) {
      return new Float2FloatAVLTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2FloatSortedMap tailMap(float var1) {
      return new Float2FloatAVLTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2FloatSortedMap subMap(float var1, float var2) {
      return new Float2FloatAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Float2FloatAVLTreeMap clone() {
      Float2FloatAVLTreeMap var1;
      try {
         var1 = (Float2FloatAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2FloatAVLTreeMap.Entry var5 = new Float2FloatAVLTreeMap.Entry();
         Float2FloatAVLTreeMap.Entry var6 = new Float2FloatAVLTreeMap.Entry();
         Float2FloatAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2FloatAVLTreeMap.Entry var4 = var6;
         var6.pred((Float2FloatAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2FloatAVLTreeMap.EntryIterator var3 = new Float2FloatAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2FloatAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2FloatAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2FloatAVLTreeMap.Entry var3, Float2FloatAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2FloatAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2FloatAVLTreeMap.Entry(var1.readFloat(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Float2FloatAVLTreeMap.Entry(var1.readFloat(), var1.readFloat());
         var8.right(new Float2FloatAVLTreeMap.Entry(var1.readFloat(), var1.readFloat()));
         ...
         Float2FloatAVLTreeMap.Entry var7 = new Float2FloatAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2FloatAVLTreeMap.Entry)null, (Float2FloatAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2FloatSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2FloatAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2FloatAVLTreeMap.Submap.SubmapIterator var1 = new Float2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2FloatAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2FloatAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2FloatAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Float2FloatAVLTreeMap.Submap.SubmapIterator var2 = new Float2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      public float get(float var1) {
         Float2FloatAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2FloatAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(float var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Float2FloatAVLTreeMap.this.put(var1, var2);
            return Float2FloatAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Float2FloatAVLTreeMap.this.remove(var1);
            return Float2FloatAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2FloatSortedMap headMap(float var1) {
         if (this.top) {
            return Float2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2FloatAVLTreeMap.this.compare(var1, this.to) < 0 ? Float2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2FloatSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? Float2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2FloatSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2FloatAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2FloatAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2FloatAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2FloatAVLTreeMap.Entry firstEntry() {
         if (Float2FloatAVLTreeMap.this.tree == null) {
            ...
            Float2FloatAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2FloatAVLTreeMap.this.firstEntry;
            } else {
               var1 = Float2FloatAVLTreeMap.this.locateKey(this.from);
               if (Float2FloatAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2FloatAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2FloatAVLTreeMap.Entry lastEntry() {
         if (Float2FloatAVLTreeMap.this.tree == null) {
            ...
            Float2FloatAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2FloatAVLTreeMap.this.lastEntry;
            } else {
               var1 = Float2FloatAVLTreeMap.this.locateKey(this.to);
               if (Float2FloatAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2FloatAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2FloatAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2FloatAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2FloatAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2FloatMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2FloatAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2FloatAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2FloatAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2FloatAVLTreeMap.this.locateKey(var2);
                  if (Float2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2FloatSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2FloatAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2FloatAVLTreeMap.TreeIterator implements ObjectListIterator<Float2FloatMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2FloatAVLTreeMap.this.locateKey(var2)) != null) {
            if (Float2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2FloatMap.BasicEntry implements Cloneable {
      ...
      void pred(Float2FloatAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2FloatAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2FloatAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2FloatAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2FloatAVLTreeMap.Entry next() {
         Float2FloatAVLTreeMap.Entry var1 = this.right;
      ...
      Float2FloatAVLTreeMap.Entry prev() {
         Float2FloatAVLTreeMap.Entry var1 = this.left;
      ...
      public Float2FloatAVLTreeMap.Entry clone() {
         Float2FloatAVLTreeMap.Entry var1;
         try {
            var1 = (Float2FloatAVLTreeMap.Entry)super.clone();
