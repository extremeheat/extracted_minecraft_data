...
public interface Float2ShortMap extends Float2ShortFunction, Map<Float, Short> {
   ...
   default Short put(Float var1, Short var2) {
      return Float2ShortFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short get(Object var1) {
      return Float2ShortFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Short remove(Object var1) {
      return Float2ShortFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Float2ShortFunction.super.containsKey(var1);
   }
   ...
   default short getOrDefault(float var1, short var2) {
      short var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default short putIfAbsent(float var1, short var2) {
   ...
   default boolean remove(float var1, short var2) {
      short var3 = this.get(var1);
   ...
   default boolean replace(float var1, short var2, short var3) {
   ...
   default short replace(float var1, short var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default short computeIfAbsent(float var1, DoubleToIntFunction var2) {
   ...
   default short computeIfAbsentNullable(float var1, DoubleFunction<? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
         Short var5 = (Short)var2.apply((double)var1);
         if (var5 == null) {
            return var4;
         } else {
            short var6 = var5;
   ...
   default short computeIfAbsentPartial(float var1, Float2ShortFunction var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short computeIfPresent(float var1, BiFunction<? super Float, ? super Short, ? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short compute(float var1, BiFunction<? super Float, ? super Short, ? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
   ...
   default short merge(float var1, short var2, BiFunction<? super Short, ? super Short, ? extends Short> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Short computeIfAbsent(Float var1, Function<? super Float, ? extends Short> var2) {
   ...
   public interface FastEntrySet extends ObjectSet<Float2ShortMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Float2ShortMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
