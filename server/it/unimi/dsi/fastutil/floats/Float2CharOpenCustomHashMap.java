...
public class Float2CharOpenCustomHashMap extends AbstractFloat2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Float2CharOpenCustomHashMap(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Float2CharOpenCustomHashMap(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2CharOpenCustomHashMap(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Float2CharOpenCustomHashMap(Map<? extends Float, ? extends Character> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2CharOpenCustomHashMap(Map<? extends Float, ? extends Character> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2CharOpenCustomHashMap(Float2CharMap var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2CharOpenCustomHashMap(Float2CharMap var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2CharOpenCustomHashMap(float[] var1, char[] var2, float var3, FloatHash.Strategy var4) {
   ...
   public Float2CharOpenCustomHashMap(float[] var1, char[] var2, FloatHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Float2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Float2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Float2CharOpenCustomHashMap.this.value[Float2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Float2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2CharOpenCustomHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2CharOpenCustomHashMap clone() {
      Float2CharOpenCustomHashMap var1;
      try {
         var1 = (Float2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      char[] var3 = this.value;
      Float2CharOpenCustomHashMap.MapIterator var4 = new Float2CharOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept((double)Float2CharOpenCustomHashMap.this.key[Float2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Float2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2CharOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2CharOpenCustomHashMap.this.size;
         Float2CharOpenCustomHashMap.this.remove(var1);
         return Float2CharOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Float2CharOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     return Float2CharOpenCustomHashMap.this.containsNullKey && Float2CharOpenCustomHashMap.this.value[Float2CharOpenCustomHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2CharOpenCustomHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float2CharOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2CharOpenCustomHashMap.this.mask]) != 0) {
                           if (Float2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float2CharOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (Float2CharOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     if (Float2CharOpenCustomHashMap.this.containsNullKey && Float2CharOpenCustomHashMap.this.value[Float2CharOpenCustomHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2CharOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float2CharOpenCustomHashMap.this.value[var7] == var4) {
                           Float2CharOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2CharOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Float2CharOpenCustomHashMap.this.strategy.equals(var5, var3) || Float2CharOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2CharMap.Entry> var1) {
         if (Float2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2CharMap.BasicEntry(Float2CharOpenCustomHashMap.this.key[Float2CharOpenCustomHashMap.this.n], Float2CharOpenCustomHashMap.this.value[Float2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2CharOpenCustomHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2CharMap.BasicEntry(Float2CharOpenCustomHashMap.this.key[var2], Float2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2CharMap.Entry> var1) {
         ...
         if (Float2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Float2CharOpenCustomHashMap.this.key[Float2CharOpenCustomHashMap.this.n];
            var2.value = Float2CharOpenCustomHashMap.this.value[Float2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2CharOpenCustomHashMap.this.key[var3]) != 0) {
               var2.key = Float2CharOpenCustomHashMap.this.key[var3];
               var2.value = Float2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> {
      private final Float2CharOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2CharOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Float2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Float2CharOpenCustomHashMap.this.mask; !Float2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Float2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Float2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Float2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2CharOpenCustomHashMap.this.value[var2] = Float2CharOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2CharMap.Entry, java.util.Map.Entry<Float, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Float2CharOpenCustomHashMap.this.value[this.index];
         Float2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[this.index], (Float)var2.getKey()) && Float2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
