...
public final class FloatIndirectHeaps {
   ...
   public static int downHeap(float[] var0, int[] var1, int[] var2, int var3, int var4, FloatComparator var5) {
      assert var4 < var3;
      ...
      if (var5 == null) {
         while((var8 = (var4 << 1) + 1) < var3) {
            var9 = var1[var8];
            var10 = var8 + 1;
            if (var10 < var3 && Float.compare(var0[var1[var10]], var0[var9]) < 0) {
               var8 = var10;
               var9 = var1[var10];
            }

            if (Float.compare(var7, var0[var9]) <= 0) {
               break;
            }
   ...
   public static int upHeap(float[] var0, int[] var1, int[] var2, int var3, int var4, FloatComparator var5) {
      assert var4 < var3;
      ...
      if (var5 == null) {
         while(var4 != 0) {
            var8 = var4 - 1 >>> 1;
            var9 = var1[var8];
            if (Float.compare(var0[var9], var7) <= 0) {
               break;
            }
   ...
   public static void makeHeap(float[] var0, int var1, int var2, int[] var3, int[] var4, FloatComparator var5) {
