...
public class Float2ByteArrayMap extends AbstractFloat2ByteMap implements Serializable, Cloneable {
   ...
   public Float2ByteArrayMap(float[] var1, byte[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Float2ByteArrayMap(int var1) {
      super();
      this.key = new float[var1];
      this.value = new byte[var1];
   }

   public Float2ByteArrayMap(Float2ByteMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2ByteArrayMap(Map<? extends Float, ? extends Byte> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2ByteArrayMap(float[] var1, byte[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public FloatSet keySet() {
      return new AbstractFloatSet() {
         public boolean contains(float var1) {
            return Float2ByteArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(float var1) {
            int var2 = Float2ByteArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Float2ByteArrayMap.this.size - var2 - 1;
               System.arraycopy(Float2ByteArrayMap.this.key, var2 + 1, Float2ByteArrayMap.this.key, var2, var3);
               System.arraycopy(Float2ByteArrayMap.this.value, var2 + 1, Float2ByteArrayMap.this.value, var2, var3);
            ...
            return new FloatIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Float2ByteArrayMap.this.size - this.pos;
                     System.arraycopy(Float2ByteArrayMap.this.key, this.pos, Float2ByteArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Float2ByteArrayMap.this.value, this.pos, Float2ByteArrayMap.this.value, this.pos - 1, var1);
                     Float2ByteArrayMap.this.size--;
                  }
               }
            };
   ...
   public ByteCollection values() {
      return new AbstractByteCollection() {
         public boolean contains(byte var1) {
            return Float2ByteArrayMap.this.containsValue(var1);
         }
   ...
   public Float2ByteArrayMap clone() {
      Float2ByteArrayMap var1;
      try {
         var1 = (Float2ByteArrayMap)super.clone();
         ...
         return new ObjectIterator<Float2ByteMap.Entry>() {
            ...
            public Float2ByteMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractFloat2ByteMap.BasicEntry(Float2ByteArrayMap.this.key[this.curr = this.next], Float2ByteArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Float2ByteArrayMap.this.size-- - this.next--;
                  System.arraycopy(Float2ByteArrayMap.this.key, this.next + 1, Float2ByteArrayMap.this.key, this.next, var1);
                  System.arraycopy(Float2ByteArrayMap.this.value, this.next + 1, Float2ByteArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  return Float2ByteArrayMap.this.containsKey(var3) && Float2ByteArrayMap.this.get(var3) == (Byte)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  int var5 = Float2ByteArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Float2ByteArrayMap.this.value[var5]) {
                     int var6 = Float2ByteArrayMap.this.size - var5 - 1;
                     System.arraycopy(Float2ByteArrayMap.this.key, var5 + 1, Float2ByteArrayMap.this.key, var5, var6);
                     System.arraycopy(Float2ByteArrayMap.this.value, var5 + 1, Float2ByteArrayMap.this.value, var5, var6);
                     Float2ByteArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
