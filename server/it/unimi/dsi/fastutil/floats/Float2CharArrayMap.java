...
public class Float2CharArrayMap extends AbstractFloat2CharMap implements Serializable, Cloneable {
   ...
   public Float2CharArrayMap(float[] var1, char[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Float2CharArrayMap(int var1) {
      super();
      this.key = new float[var1];
      this.value = new char[var1];
   }

   public Float2CharArrayMap(Float2CharMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2CharArrayMap(Map<? extends Float, ? extends Character> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2CharArrayMap(float[] var1, char[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public FloatSet keySet() {
      return new AbstractFloatSet() {
         public boolean contains(float var1) {
            return Float2CharArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(float var1) {
            int var2 = Float2CharArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Float2CharArrayMap.this.size - var2 - 1;
               System.arraycopy(Float2CharArrayMap.this.key, var2 + 1, Float2CharArrayMap.this.key, var2, var3);
               System.arraycopy(Float2CharArrayMap.this.value, var2 + 1, Float2CharArrayMap.this.value, var2, var3);
            ...
            return new FloatIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Float2CharArrayMap.this.size - this.pos;
                     System.arraycopy(Float2CharArrayMap.this.key, this.pos, Float2CharArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Float2CharArrayMap.this.value, this.pos, Float2CharArrayMap.this.value, this.pos - 1, var1);
                     Float2CharArrayMap.this.size--;
                  }
               }
            };
   ...
   public CharCollection values() {
      return new AbstractCharCollection() {
         public boolean contains(char var1) {
            return Float2CharArrayMap.this.containsValue(var1);
         }
   ...
   public Float2CharArrayMap clone() {
      Float2CharArrayMap var1;
      try {
         var1 = (Float2CharArrayMap)super.clone();
         ...
         return new ObjectIterator<Float2CharMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Float2CharArrayMap.this.size-- - this.next--;
                  System.arraycopy(Float2CharArrayMap.this.key, this.next + 1, Float2CharArrayMap.this.key, this.next, var1);
                  System.arraycopy(Float2CharArrayMap.this.value, this.next + 1, Float2CharArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  return Float2CharArrayMap.this.containsKey(var3) && Float2CharArrayMap.this.get(var3) == (Character)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  int var5 = Float2CharArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Float2CharArrayMap.this.value[var5]) {
                     int var6 = Float2CharArrayMap.this.size - var5 - 1;
                     System.arraycopy(Float2CharArrayMap.this.key, var5 + 1, Float2CharArrayMap.this.key, var5, var6);
                     System.arraycopy(Float2CharArrayMap.this.value, var5 + 1, Float2CharArrayMap.this.value, var5, var6);
                     Float2CharArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
