...
public class Float2ObjectRBTreeMap<V> extends AbstractFloat2ObjectSortedMap<V> implements Serializable, Cloneable {
   ...
   public Float2ObjectRBTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2ObjectRBTreeMap(Map<? extends Float, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Float2ObjectRBTreeMap(SortedMap<Float, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2ObjectRBTreeMap(Float2ObjectMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Float2ObjectRBTreeMap(Float2ObjectSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2ObjectRBTreeMap(float[] var1, V[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2ObjectRBTreeMap(float[] var1, V[] var2) {
   ...
   final Float2ObjectRBTreeMap.Entry<V> findKey(float var1) {
      Float2ObjectRBTreeMap.Entry var2;
      int var3;
   ...
   final Float2ObjectRBTreeMap.Entry<V> locateKey(float var1) {
      Float2ObjectRBTreeMap.Entry var2 = this.tree;
      Float2ObjectRBTreeMap.Entry var3 = this.tree;
   ...
   public V put(float var1, V var2) {
      Float2ObjectRBTreeMap.Entry var3 = this.add(var1);
      Object var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Float2ObjectRBTreeMap.Entry<V> add(float var1) {
      this.modified = false;
      int var2 = 0;
      Float2ObjectRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Float2ObjectRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Float2ObjectRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Float2ObjectRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Float2ObjectRBTreeMap.Entry var7;
               Float2ObjectRBTreeMap.Entry var8;
   ...
   public boolean containsValue(Object var1) {
      Float2ObjectRBTreeMap.ValueIterator var2 = new Float2ObjectRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(float var1) {
      Float2ObjectRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>() {
            final Comparator<? super Float2ObjectMap.Entry<V>> comparator = (var1x, var2) -> {
               return Float2ObjectRBTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> var1) {
               return Float2ObjectRBTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     Float2ObjectRBTreeMap.Entry var3 = Float2ObjectRBTreeMap.this.findKey((Float)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     ...
                     if (var3 != null && Objects.equals(var3.getValue(), var2.getValue())) {
                        Float2ObjectRBTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> var1, Float2ObjectMap.Entry<V> var2) {
               return Float2ObjectRBTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2ObjectEntrySet();
            }

            public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> var1) {
               return Float2ObjectRBTreeMap.this.headMap(var1.getFloatKey()).float2ObjectEntrySet();
            }

            public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> var1) {
               return Float2ObjectRBTreeMap.this.tailMap(var1.getFloatKey()).float2ObjectEntrySet();
            }
         };
      }
   ...
   public ObjectCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Float2ObjectRBTreeMap.this.containsValue(var1);
            }
   ...
   public Float2ObjectSortedMap<V> headMap(float var1) {
      return new Float2ObjectRBTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2ObjectSortedMap<V> tailMap(float var1) {
      return new Float2ObjectRBTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2ObjectSortedMap<V> subMap(float var1, float var2) {
      return new Float2ObjectRBTreeMap.Submap(var1, false, var2, false);
   }

   public Float2ObjectRBTreeMap<V> clone() {
      Float2ObjectRBTreeMap var1;
      try {
         var1 = (Float2ObjectRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2ObjectRBTreeMap.Entry var5 = new Float2ObjectRBTreeMap.Entry();
         Float2ObjectRBTreeMap.Entry var6 = new Float2ObjectRBTreeMap.Entry();
         Float2ObjectRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2ObjectRBTreeMap.Entry var4 = var6;
         var6.pred((Float2ObjectRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2ObjectRBTreeMap.EntryIterator var3 = new Float2ObjectRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2ObjectRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2ObjectRBTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Float2ObjectRBTreeMap.Entry<V> var3, Float2ObjectRBTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Float2ObjectRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2ObjectRBTreeMap.Entry(var1.readFloat(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Float2ObjectRBTreeMap.Entry(var1.readFloat(), var1.readObject());
         var8.black(true);
         var8.right(new Float2ObjectRBTreeMap.Entry(var1.readFloat(), var1.readObject()));
         ...
         Float2ObjectRBTreeMap.Entry var7 = new Float2ObjectRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2ObjectRBTreeMap.Entry)null, (Float2ObjectRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2ObjectSortedMap<V> implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2ObjectRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2ObjectRBTreeMap.Submap.SubmapIterator var1 = new Float2ObjectRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2ObjectRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2ObjectRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2ObjectRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Float2ObjectRBTreeMap.Submap.SubmapIterator var2 = new Float2ObjectRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(float var1) {
         Float2ObjectRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2ObjectRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public V put(float var1, V var2) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Float2ObjectRBTreeMap.this.put(var1, var2);
            return Float2ObjectRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public V remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var2 = Float2ObjectRBTreeMap.this.remove(var1);
            return Float2ObjectRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2ObjectSortedMap<V> headMap(float var1) {
         if (this.top) {
            return Float2ObjectRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2ObjectRBTreeMap.this.compare(var1, this.to) < 0 ? Float2ObjectRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2ObjectSortedMap<V> tailMap(float var1) {
         if (this.bottom) {
            return Float2ObjectRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2ObjectRBTreeMap.this.compare(var1, this.from) > 0 ? Float2ObjectRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2ObjectSortedMap<V> subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2ObjectRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2ObjectRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2ObjectRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2ObjectRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2ObjectRBTreeMap.Entry<V> firstEntry() {
         if (Float2ObjectRBTreeMap.this.tree == null) {
            ...
            Float2ObjectRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2ObjectRBTreeMap.this.firstEntry;
            } else {
               var1 = Float2ObjectRBTreeMap.this.locateKey(this.from);
               if (Float2ObjectRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2ObjectRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2ObjectRBTreeMap.Entry<V> lastEntry() {
         if (Float2ObjectRBTreeMap.this.tree == null) {
            ...
            Float2ObjectRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2ObjectRBTreeMap.this.lastEntry;
            } else {
               var1 = Float2ObjectRBTreeMap.this.locateKey(this.to);
               if (Float2ObjectRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2ObjectRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2ObjectRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2ObjectRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2ObjectRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2ObjectRBTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2ObjectRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2ObjectRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2ObjectRBTreeMap.this.locateKey(var2);
                  if (Float2ObjectRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2ObjectSortedMap<V>.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2ObjectRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2ObjectRBTreeMap<V>.TreeIterator implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2ObjectRBTreeMap.this.locateKey(var2)) != null) {
            if (Float2ObjectRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractFloat2ObjectMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Float2ObjectRBTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2ObjectRBTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2ObjectRBTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2ObjectRBTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2ObjectRBTreeMap.Entry<V> next() {
         Float2ObjectRBTreeMap.Entry var1 = this.right;
      ...
      Float2ObjectRBTreeMap.Entry<V> prev() {
         Float2ObjectRBTreeMap.Entry var1 = this.left;
      ...
      public Float2ObjectRBTreeMap.Entry<V> clone() {
         Float2ObjectRBTreeMap.Entry var1;
         try {
            var1 = (Float2ObjectRBTreeMap.Entry)super.clone();
