...
public class Float2ReferenceOpenHashMap<V> extends AbstractFloat2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Float2ReferenceOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2ReferenceOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2ReferenceOpenHashMap(Map<? extends Float, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2ReferenceOpenHashMap(Map<? extends Float, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Float2ReferenceOpenHashMap(Float2ReferenceMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2ReferenceOpenHashMap(Float2ReferenceMap<V> var1) {
      this(var1, 0.75F);
   }

   public Float2ReferenceOpenHashMap(float[] var1, V[] var2, float var3) {
   ...
   public Float2ReferenceOpenHashMap(float[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Float2ReferenceOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2ReferenceOpenHashMap.this.value[Float2ReferenceOpenHashMap.this.n]);
               }

               int var2 = Float2ReferenceOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2ReferenceOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2ReferenceOpenHashMap<V> clone() {
      Float2ReferenceOpenHashMap var1;
      try {
         var1 = (Float2ReferenceOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      Object[] var3 = this.value;
      Float2ReferenceOpenHashMap.MapIterator var4 = new Float2ReferenceOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2ReferenceOpenHashMap.this.key[Float2ReferenceOpenHashMap.this.n]);
         }

         int var2 = Float2ReferenceOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2ReferenceOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2ReferenceOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2ReferenceOpenHashMap.this.size;
         Float2ReferenceOpenHashMap.this.remove(var1);
         return Float2ReferenceOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry<V>> implements Float2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               if (Float.floatToIntBits(var3) == 0) {
                  return Float2ReferenceOpenHashMap.this.containsNullKey && Float2ReferenceOpenHashMap.this.value[Float2ReferenceOpenHashMap.this.n] == var4;
               } else {
                  float[] var6 = Float2ReferenceOpenHashMap.this.key;
                  float var5;
                  int var7;
                  if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2ReferenceOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var5)) {
                     return Float2ReferenceOpenHashMap.this.value[var7] == var4;
                  } else {
                     while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ReferenceOpenHashMap.this.mask]) != 0) {
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               Object var4 = var2.getValue();
               if (Float.floatToIntBits(var3) == 0) {
                  if (Float2ReferenceOpenHashMap.this.containsNullKey && Float2ReferenceOpenHashMap.this.value[Float2ReferenceOpenHashMap.this.n] == var4) {
                  ...
                  if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2ReferenceOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Float2ReferenceOpenHashMap.this.value[var7] == var4) {
                        Float2ReferenceOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ReferenceOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(Float.floatToIntBits(var5) != Float.floatToIntBits(var3) || Float2ReferenceOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> var1) {
         if (Float2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceOpenHashMap.this.key[Float2ReferenceOpenHashMap.this.n], Float2ReferenceOpenHashMap.this.value[Float2ReferenceOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceOpenHashMap.this.key[var2], Float2ReferenceOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2ReferenceMap.Entry<V>> var1) {
         ...
         if (Float2ReferenceOpenHashMap.this.containsNullKey) {
            var2.key = Float2ReferenceOpenHashMap.this.key[Float2ReferenceOpenHashMap.this.n];
            var2.value = Float2ReferenceOpenHashMap.this.value[Float2ReferenceOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2ReferenceOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2ReferenceOpenHashMap.this.key[var3];
               var2.value = Float2ReferenceOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
      private final Float2ReferenceOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2ReferenceOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      private MapIterator() {
         super();
         this.pos = Float2ReferenceOpenHashMap.this.n;
         this.last = -1;
         this.c = Float2ReferenceOpenHashMap.this.size;
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2ReferenceOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2ReferenceOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2ReferenceOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2ReferenceOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2ReferenceOpenHashMap.this.mask;

            float var4;
            while(true) {
               if (Float.floatToIntBits(var4 = var5[var1]) == 0) {
                  var5[var2] = 0.0F;
                  Float2ReferenceOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2ReferenceOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2ReferenceOpenHashMap.this.value[var2] = Float2ReferenceOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2ReferenceMap.Entry<V>, java.util.Map.Entry<Float, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Float2ReferenceOpenHashMap.this.value[this.index];
         Float2ReferenceOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Float2ReferenceOpenHashMap.this.value[this.index] == var2.getValue();
         }
      }
