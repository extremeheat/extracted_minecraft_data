...
public final class FloatBigArrays {
   ...
   public static final Hash.Strategy HASH_STRATEGY = new FloatBigArrays.BigArrayHashStrategy();
   ...
   public static float get(float[][] var0, long var1) {
      return var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void set(float[][] var0, long var1, float var3) {
      var0[BigArrays.segment(var1)][BigArrays.displacement(var1)] = var3;
   }

   public static void swap(float[][] var0, long var1, long var3) {
      float var5 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   ...
   public static void add(float[][] var0, long var1, float var3) {
      float[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] += var3;
   }

   public static void mul(float[][] var0, long var1, float var3) {
      float[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] *= var3;
   }

   public static void incr(float[][] var0, long var1) {
      int var10002 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)]++;
   }

   public static void decr(float[][] var0, long var1) {
      int var10002 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)]--;
   }

   public static long length(float[][] var0) {
      int var1 = var0.length;
      return var1 == 0 ? 0L : BigArrays.start(var1 - 1) + (long)var0[var1 - 1].length;
   }

   public static void copy(float[][] var0, long var1, float[][] var3, long var4, long var6) {
      int var8;
      int var9;
      int var10;
      int var11;
   ...
   public static void copyFromBig(float[][] var0, long var1, float[] var3, int var4, int var5) {
   ...
   public static void copyToBig(float[] var0, int var1, float[][] var2, long var3, long var5) {
   ...
   public static float[][] newBigArray(long var0) {
      if (var0 == 0L) {
         ...
         if (var4 != 0) {
            for(var5 = 0; var5 < var2 - 1; ++var5) {
               var3[var5] = new float[134217728];
            }

            var3[var2 - 1] = new float[var4];
         } else {
   ...
   public static float[][] wrap(float[] var0) {
      if (var0.length == 0) {
         ...
         float[][] var1 = newBigArray((long)var0.length);
   ...
   public static float[][] ensureCapacity(float[][] var0, long var1) {
      return ensureCapacity(var0, var1, length(var0));
   }

   public static float[][] forceCapacity(float[][] var0, long var1, long var3) {
      ...
      float[][] var7 = (float[][])Arrays.copyOf(var0, var6);
      int var8 = (int)(var1 & 134217727L);
      int var9;
      if (var8 != 0) {
         for(var9 = var5; var9 < var6 - 1; ++var9) {
            var7[var9] = new float[134217728];
         }

         var7[var6 - 1] = new float[var8];
      } else {
   ...
   public static float[][] trim(float[][] var0, long var1) {
      ...
      if (var1 >= var3) {
         ...
         float[][] var6 = (float[][])Arrays.copyOf(var0, var5);
         int var7 = (int)(var1 & 134217727L);
         if (var7 != 0) {
            var6[var5 - 1] = FloatArrays.trim(var6[var5 - 1], var7);
         }
   ...
   public static float[][] setLength(float[][] var0, long var1) {
      long var3 = length(var0);
      if (var1 == var3) {
         return var0;
      } else {
   ...
   public static float[][] copy(float[][] var0, long var1, long var3) {
      ensureOffsetLength(var0, var1, var3);
      float[][] var5 = newBigArray(var3);
      copy(var0, var1, var5, 0L, var3);
      return var5;
   }

   public static float[][] copy(float[][] var0) {
      float[][] var1 = (float[][])var0.clone();

      for(int var2 = var1.length; var2-- != 0; var1[var2] = (float[])var0[var2].clone()) {
      }
   ...
   public static void fill(float[][] var0, long var1, long var3, float var5) {
   ...
   public static boolean equals(float[][] var0, float[][] var1) {
      if (length(var0) != length(var1)) {
         ...
         while(var2-- != 0) {
            ...
            while(var3-- != 0) {
               if (Float.floatToIntBits(var4[var3]) != Float.floatToIntBits(var5[var3])) {
                  return false;
               }
            }
         }
   ...
   public static void ensureFromTo(float[][] var0, long var1, long var3) {
      BigArrays.ensureFromTo(length(var0), var1, var3);
   }

   public static void ensureOffsetLength(float[][] var0, long var1, long var3) {
      BigArrays.ensureOffsetLength(length(var0), var1, var3);
   }

   private static void vecSwap(float[][] var0, long var1, long var3, long var5) {
   ...
   private static long med3(float[][] var0, long var1, long var3, long var5, FloatComparator var7) {
   ...
   private static void selectionSort(float[][] var0, long var1, long var3, FloatComparator var5) {
   ...
   public static void quickSort(float[][] var0, long var1, long var3, FloatComparator var5) {
      long var6 = var3 - var1;
      if (var6 < 7L) {
   ...
   private static long med3(float[][] var0, long var1, long var3, long var5) {
      int var7 = Float.compare(get(var0, var1), get(var0, var3));
      int var8 = Float.compare(get(var0, var1), get(var0, var5));
      int var9 = Float.compare(get(var0, var3), get(var0, var5));
      return var7 < 0 ? (var9 < 0 ? var3 : (var8 < 0 ? var5 : var1)) : (var9 > 0 ? var3 : (var8 > 0 ? var5 : var1));
   }

   private static void selectionSort(float[][] var0, long var1, long var3) {
      for(long var5 = var1; var5 < var3 - 1L; ++var5) {
         long var7 = var5;

         for(long var9 = var5 + 1L; var9 < var3; ++var9) {
            if (Float.compare(get(var0, var9), get(var0, var7)) < 0) {
               var7 = var9;
            }
         }
   ...
   public static void quickSort(float[][] var0, long var1, long var3) {
      long var5 = var3 - var1;
      if (var5 < 7L) {
         ...
         while(true) {
            int var18;
            while(var12 > var14 || (var18 = Float.compare(get(var0, var12), var22)) > 0) {
               for(; var14 >= var12 && (var18 = Float.compare(get(var0, var14), var22)) >= 0; --var14) {
                  if (var18 == 0) {
   ...
   public static long binarySearch(float[][] var0, long var1, long var3, float var5) {
      --var3;

      while(var1 <= var3) {
         long var7 = var1 + var3 >>> 1;
         float var6 = get(var0, var7);
         if (var6 < var5) {
            var1 = var7 + 1L;
         } else {
            if (var6 <= var5) {
   ...
   public static long binarySearch(float[][] var0, float var1) {
      return binarySearch(var0, 0L, length(var0), var1);
   }

   public static long binarySearch(float[][] var0, long var1, long var3, float var5, FloatComparator var6) {
      --var3;

      while(var1 <= var3) {
         long var8 = var1 + var3 >>> 1;
         float var7 = get(var0, var8);
   ...
   public static long binarySearch(float[][] var0, float var1, FloatComparator var2) {
      return binarySearch(var0, 0L, length(var0), var1, var2);
   }

   private static final long fixFloat(float var0) {
      long var1 = (long)Float.floatToRawIntBits(var0);
      return var1 >= 0L ? var1 : var1 ^ 2147483647L;
   }
   ...
   public static void radixSort(float[][] var0, long var1, long var3) {
      boolean var5 = true;
      boolean var6 = true;
      long[] var7 = new long[766];
      byte var8 = 0;
      ...
      while(true) {
         while(var36 > 0) {
            ...
            int var21 = var20 % 4 == 0 ? 128 : 0;
            if (var18 < 40L) {
               selectionSort(var0, var16, var16 + var18);
            } else {
               int var22 = (3 - var20 % 4) * 8;
               long var23 = var18;

               while(var23-- != 0L) {
                  ByteBigArrays.set(var15, var23, (byte)((int)(fixFloat(get(var0, var16 + var23)) >>> var22 & 255L ^ (long)var21)));
               }
               ...
               for(long var29 = 0L; var29 < var41; var13[var42] = 0L) {
                  float var33 = get(var0, var29 + var16);
   ...
   private static void selectionSort(float[][] var0, float[][] var1, long var2, long var4) {
      for(long var6 = var2; var6 < var4 - 1L; ++var6) {
         long var8 = var6;

         for(long var10 = var6 + 1L; var10 < var4; ++var10) {
            if (Float.compare(get(var0, var10), get(var0, var8)) < 0 || Float.compare(get(var0, var10), get(var0, var8)) == 0 && Float.compare(get(var1, var10), get(var1, var8)) < 0) {
               var8 = var10;
            }
         }

         if (var8 != var6) {
            float var12 = get(var0, var6);
   ...
   public static void radixSort(float[][] var0, float[][] var1, long var2, long var4) {
      boolean var6 = true;
      if (length(var0) != length(var1)) {
         ...
         byte var10 = 0;
         long[] var11 = new long[1786];
         byte var12 = 0;
         int[] var13 = new int[1786];
         byte var14 = 0;
         int var40 = var10 + 1;
         var9[var10] = var2;
         int var41 = var12 + 1;
         ...
         while(true) {
            while(var40 > 0) {
               ...
               int var23 = var22 % 4 == 0 ? 128 : 0;
               if (var20 < 40L) {
                  selectionSort(var0, var1, var18, var18 + var20);
               } else {
                  float[][] var24 = var22 < 4 ? var0 : var1;
                  int var25 = (3 - var22 % 4) * 8;
                  long var26 = var20;

                  while(var26-- != 0L) {
                     ByteBigArrays.set(var17, var26, (byte)((int)(fixFloat(get(var24, var18 + var26)) >>> var25 & 255L ^ (long)var23)));
                  }
                  ...
                  for(long var32 = 0L; var32 < var45; var15[var46] = 0L) {
                     float var36 = get(var0, var32 + var18);
                     float var37 = get(var1, var32 + var18);
   ...
   public static float[][] shuffle(float[][] var0, long var1, long var3, Random var5) {
      long var6 = var3 - var1;

      while(var6-- != 0L) {
         long var8 = (var5.nextLong() & 9223372036854775807L) % (var6 + 1L);
         float var10 = get(var0, var1 + var6);
   ...
   private static final class BigArrayHashStrategy implements Hash.Strategy<float[][]>, Serializable {
      ...
      public boolean equals(float[][] var1, float[][] var2) {
         return FloatBigArrays.equals(var1, var2);
      }
