...
public class Float2ObjectArrayMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Float2ObjectArrayMap(float[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Float2ObjectArrayMap(int var1) {
      super();
      this.key = new float[var1];
      this.value = new Object[var1];
   }

   public Float2ObjectArrayMap(Float2ObjectMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2ObjectArrayMap(Map<? extends Float, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2ObjectArrayMap(float[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Float2ObjectMap.FastEntrySet<V> float2ObjectEntrySet() {
      return new Float2ObjectArrayMap.EntrySet();
   }
   ...
   public FloatSet keySet() {
      return new AbstractFloatSet() {
         public boolean contains(float var1) {
            return Float2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(float var1) {
            int var2 = Float2ObjectArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Float2ObjectArrayMap.this.size - var2 - 1;
               System.arraycopy(Float2ObjectArrayMap.this.key, var2 + 1, Float2ObjectArrayMap.this.key, var2, var3);
               System.arraycopy(Float2ObjectArrayMap.this.value, var2 + 1, Float2ObjectArrayMap.this.value, var2, var3);
            ...
            return new FloatIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Float2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Float2ObjectArrayMap.this.key, this.pos, Float2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Float2ObjectArrayMap.this.value, this.pos, Float2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Float2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Float2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Float2ObjectArrayMap<V> clone() {
      Float2ObjectArrayMap var1;
      try {
         var1 = (Float2ObjectArrayMap)super.clone();
         ...
         return new ObjectIterator<Float2ObjectMap.Entry<V>>() {
            ...
            public Float2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectArrayMap.this.key[this.curr = this.next], Float2ObjectArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Float2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Float2ObjectArrayMap.this.key, this.next + 1, Float2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Float2ObjectArrayMap.this.value, this.next + 1, Float2ObjectArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Float2ObjectMap.Entry<V>>() {
            ...
            public Float2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Float2ObjectArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               return Float2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Float2ObjectArrayMap.this.get(var3), var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               int var5 = Float2ObjectArrayMap.this.findKey(var3);
               if (var5 != -1 && Objects.equals(var4, Float2ObjectArrayMap.this.value[var5])) {
                  int var6 = Float2ObjectArrayMap.this.size - var5 - 1;
                  System.arraycopy(Float2ObjectArrayMap.this.key, var5 + 1, Float2ObjectArrayMap.this.key, var5, var6);
                  System.arraycopy(Float2ObjectArrayMap.this.value, var5 + 1, Float2ObjectArrayMap.this.value, var5, var6);
                  Float2ObjectArrayMap.this.size--;
                  Float2ObjectArrayMap.this.value[Float2ObjectArrayMap.this.size] = null;
                  return true;
               } else {
