...
public class Float2CharOpenHashMap extends AbstractFloat2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Float2CharOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2CharOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2CharOpenHashMap(Map<? extends Float, ? extends Character> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2CharOpenHashMap(Map<? extends Float, ? extends Character> var1) {
      this(var1, 0.75F);
   }

   public Float2CharOpenHashMap(Float2CharMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2CharOpenHashMap(Float2CharMap var1) {
      this(var1, 0.75F);
   }

   public Float2CharOpenHashMap(float[] var1, char[] var2, float var3) {
   ...
   public Float2CharOpenHashMap(float[] var1, char[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Float2CharOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Float2CharOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n]);
               }

               int var2 = Float2CharOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2CharOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2CharOpenHashMap clone() {
      Float2CharOpenHashMap var1;
      try {
         var1 = (Float2CharOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      char[] var3 = this.value;
      Float2CharOpenHashMap.MapIterator var4 = new Float2CharOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2CharOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2CharOpenHashMap.this.key[Float2CharOpenHashMap.this.n]);
         }

         int var2 = Float2CharOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2CharOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2CharOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2CharOpenHashMap.this.size;
         Float2CharOpenHashMap.this.remove(var1);
         return Float2CharOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Float.floatToIntBits(var3) == 0) {
                     return Float2CharOpenHashMap.this.containsNullKey && Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2CharOpenHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2CharOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var5)) {
                        return Float2CharOpenHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2CharOpenHashMap.this.mask]) != 0) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (Float.floatToIntBits(var3) == 0) {
                     if (Float2CharOpenHashMap.this.containsNullKey && Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2CharOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float2CharOpenHashMap.this.value[var7] == var4) {
                           Float2CharOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2CharOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(Float.floatToIntBits(var5) != Float.floatToIntBits(var3) || Float2CharOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2CharMap.Entry> var1) {
         if (Float2CharOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2CharMap.BasicEntry(Float2CharOpenHashMap.this.key[Float2CharOpenHashMap.this.n], Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2CharMap.BasicEntry(Float2CharOpenHashMap.this.key[var2], Float2CharOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2CharMap.Entry> var1) {
         ...
         if (Float2CharOpenHashMap.this.containsNullKey) {
            var2.key = Float2CharOpenHashMap.this.key[Float2CharOpenHashMap.this.n];
            var2.value = Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2CharOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2CharOpenHashMap.this.key[var3];
               var2.value = Float2CharOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2CharOpenHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> {
      private final Float2CharOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2CharOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2CharOpenHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2CharOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2CharOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2CharOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2CharOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2CharOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2CharOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2CharOpenHashMap.this.value[var2] = Float2CharOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2CharMap.Entry, java.util.Map.Entry<Float, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Float2CharOpenHashMap.this.value[this.index];
         Float2CharOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2CharOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Float2CharOpenHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
