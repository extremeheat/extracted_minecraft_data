...
public class Float2ShortOpenHashMap extends AbstractFloat2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Float2ShortOpenHashMap(int var1, float var2) {
      super();
   ...
   public Float2ShortOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Float2ShortOpenHashMap(Map<? extends Float, ? extends Short> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2ShortOpenHashMap(Map<? extends Float, ? extends Short> var1) {
      this(var1, 0.75F);
   }

   public Float2ShortOpenHashMap(Float2ShortMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Float2ShortOpenHashMap(Float2ShortMap var1) {
      this(var1, 0.75F);
   }

   public Float2ShortOpenHashMap(float[] var1, short[] var2, float var3) {
   ...
   public Float2ShortOpenHashMap(float[] var1, short[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Float2ShortOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Float2ShortOpenHashMap.this.containsNullKey) {
                  var1.accept(Float2ShortOpenHashMap.this.value[Float2ShortOpenHashMap.this.n]);
               }

               int var2 = Float2ShortOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2ShortOpenHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2ShortOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2ShortOpenHashMap clone() {
      Float2ShortOpenHashMap var1;
      try {
         var1 = (Float2ShortOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      short[] var3 = this.value;
      Float2ShortOpenHashMap.MapIterator var4 = new Float2ShortOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2ShortOpenHashMap.this.containsNullKey) {
            var1.accept((double)Float2ShortOpenHashMap.this.key[Float2ShortOpenHashMap.this.n]);
         }

         int var2 = Float2ShortOpenHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2ShortOpenHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2ShortOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2ShortOpenHashMap.this.size;
         Float2ShortOpenHashMap.this.remove(var1);
         return Float2ShortOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Float.floatToIntBits(var3) == 0) {
                     return Float2ShortOpenHashMap.this.containsNullKey && Float2ShortOpenHashMap.this.value[Float2ShortOpenHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2ShortOpenHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2ShortOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float.floatToIntBits(var3) == Float.floatToIntBits(var5)) {
                        return Float2ShortOpenHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ShortOpenHashMap.this.mask]) != 0) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (Float.floatToIntBits(var3) == 0) {
                     if (Float2ShortOpenHashMap.this.containsNullKey && Float2ShortOpenHashMap.this.value[Float2ShortOpenHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(HashCommon.float2int(var3)) & Float2ShortOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float2ShortOpenHashMap.this.value[var7] == var4) {
                           Float2ShortOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ShortOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(Float.floatToIntBits(var5) != Float.floatToIntBits(var3) || Float2ShortOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2ShortMap.Entry> var1) {
         if (Float2ShortOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenHashMap.this.key[Float2ShortOpenHashMap.this.n], Float2ShortOpenHashMap.this.value[Float2ShortOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2ShortOpenHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenHashMap.this.key[var2], Float2ShortOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2ShortMap.Entry> var1) {
         ...
         if (Float2ShortOpenHashMap.this.containsNullKey) {
            var2.key = Float2ShortOpenHashMap.this.key[Float2ShortOpenHashMap.this.n];
            var2.value = Float2ShortOpenHashMap.this.value[Float2ShortOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2ShortOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2ShortOpenHashMap.this.key[var3]) != 0) {
               var2.key = Float2ShortOpenHashMap.this.key[var3];
               var2.value = Float2ShortOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2ShortOpenHashMap.MapIterator implements ObjectIterator<Float2ShortMap.Entry> {
      private final Float2ShortOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2ShortOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2ShortOpenHashMap.MapIterator implements ObjectIterator<Float2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2ShortOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(HashCommon.float2int(var2)) & Float2ShortOpenHashMap.this.mask; Float.floatToIntBits(var2) != Float.floatToIntBits(var1[var3]); var3 = var3 + 1 & Float2ShortOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2ShortOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2ShortOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(HashCommon.float2int(var4)) & Float2ShortOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2ShortOpenHashMap.this.value[var2] = Float2ShortOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2ShortMap.Entry, java.util.Map.Entry<Float, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Float2ShortOpenHashMap.this.value[this.index];
         Float2ShortOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(Float2ShortOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)var2.getKey()) && Float2ShortOpenHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
