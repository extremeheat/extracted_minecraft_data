...
public class Float2CharRBTreeMap extends AbstractFloat2CharSortedMap implements Serializable, Cloneable {
   ...
   public Float2CharRBTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2CharRBTreeMap(Map<? extends Float, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Float2CharRBTreeMap(SortedMap<Float, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2CharRBTreeMap(Float2CharMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2CharRBTreeMap(Float2CharSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2CharRBTreeMap(float[] var1, char[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2CharRBTreeMap(float[] var1, char[] var2) {
   ...
   final Float2CharRBTreeMap.Entry findKey(float var1) {
      Float2CharRBTreeMap.Entry var2;
      int var3;
   ...
   final Float2CharRBTreeMap.Entry locateKey(float var1) {
      Float2CharRBTreeMap.Entry var2 = this.tree;
      Float2CharRBTreeMap.Entry var3 = this.tree;
   ...
   public char addTo(float var1, char var2) {
      Float2CharRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Float2CharRBTreeMap.Entry add(float var1) {
      this.modified = false;
      int var2 = 0;
      Float2CharRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Float2CharRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Float2CharRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Float2CharRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Float2CharRBTreeMap.Entry var7;
               Float2CharRBTreeMap.Entry var8;
   ...
   public boolean containsValue(char var1) {
      Float2CharRBTreeMap.ValueIterator var2 = new Float2CharRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char get(float var1) {
      Float2CharRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>() {
            final Comparator<? super Float2CharMap.Entry> comparator = (var1x, var2) -> {
               return Float2CharRBTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry var1) {
               return Float2CharRBTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        Float2CharRBTreeMap.Entry var3 = Float2CharRBTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        ...
                        if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                           Float2CharRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry var1, Float2CharMap.Entry var2) {
               return Float2CharRBTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2CharEntrySet();
            }

            public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry var1) {
               return Float2CharRBTreeMap.this.headMap(var1.getFloatKey()).float2CharEntrySet();
            }

            public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry var1) {
               return Float2CharRBTreeMap.this.tailMap(var1.getFloatKey()).float2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Float2CharRBTreeMap.this.containsValue(var1);
            }
   ...
   public Float2CharSortedMap headMap(float var1) {
      return new Float2CharRBTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2CharSortedMap tailMap(float var1) {
      return new Float2CharRBTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2CharSortedMap subMap(float var1, float var2) {
      return new Float2CharRBTreeMap.Submap(var1, false, var2, false);
   }

   public Float2CharRBTreeMap clone() {
      Float2CharRBTreeMap var1;
      try {
         var1 = (Float2CharRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2CharRBTreeMap.Entry var5 = new Float2CharRBTreeMap.Entry();
         Float2CharRBTreeMap.Entry var6 = new Float2CharRBTreeMap.Entry();
         Float2CharRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2CharRBTreeMap.Entry var4 = var6;
         var6.pred((Float2CharRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2CharRBTreeMap.EntryIterator var3 = new Float2CharRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2CharRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2CharRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2CharRBTreeMap.Entry var3, Float2CharRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2CharRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2CharRBTreeMap.Entry(var1.readFloat(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Float2CharRBTreeMap.Entry(var1.readFloat(), var1.readChar());
         var8.black(true);
         var8.right(new Float2CharRBTreeMap.Entry(var1.readFloat(), var1.readChar()));
         ...
         Float2CharRBTreeMap.Entry var7 = new Float2CharRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2CharRBTreeMap.Entry)null, (Float2CharRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2CharSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2CharRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2CharRBTreeMap.Submap.SubmapIterator var1 = new Float2CharRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2CharRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2CharRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2CharRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Float2CharRBTreeMap.Submap.SubmapIterator var2 = new Float2CharRBTreeMap.Submap.SubmapIterator();
      ...
      public char get(float var1) {
         Float2CharRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2CharRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public char put(float var1, char var2) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Float2CharRBTreeMap.this.put(var1, var2);
            return Float2CharRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public char remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var2 = Float2CharRBTreeMap.this.remove(var1);
            return Float2CharRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2CharSortedMap headMap(float var1) {
         if (this.top) {
            return Float2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2CharRBTreeMap.this.compare(var1, this.to) < 0 ? Float2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2CharSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2CharRBTreeMap.this.compare(var1, this.from) > 0 ? Float2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2CharSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2CharRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2CharRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2CharRBTreeMap.Entry firstEntry() {
         if (Float2CharRBTreeMap.this.tree == null) {
            ...
            Float2CharRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2CharRBTreeMap.this.firstEntry;
            } else {
               var1 = Float2CharRBTreeMap.this.locateKey(this.from);
               if (Float2CharRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2CharRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2CharRBTreeMap.Entry lastEntry() {
         if (Float2CharRBTreeMap.this.tree == null) {
            ...
            Float2CharRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2CharRBTreeMap.this.lastEntry;
            } else {
               var1 = Float2CharRBTreeMap.this.locateKey(this.to);
               if (Float2CharRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2CharRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2CharRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2CharRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2CharRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2CharMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2CharRBTreeMap.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2CharRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2CharRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2CharRBTreeMap.this.locateKey(var2);
                  if (Float2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2CharSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2CharRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2CharRBTreeMap.TreeIterator implements ObjectListIterator<Float2CharMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2CharRBTreeMap.this.locateKey(var2)) != null) {
            if (Float2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Float2CharRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2CharRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2CharRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2CharRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2CharRBTreeMap.Entry next() {
         Float2CharRBTreeMap.Entry var1 = this.right;
      ...
      Float2CharRBTreeMap.Entry prev() {
         Float2CharRBTreeMap.Entry var1 = this.left;
      ...
      public Float2CharRBTreeMap.Entry clone() {
         Float2CharRBTreeMap.Entry var1;
         try {
            var1 = (Float2CharRBTreeMap.Entry)super.clone();
