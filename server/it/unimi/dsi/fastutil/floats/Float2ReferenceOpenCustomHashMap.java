...
public class Float2ReferenceOpenCustomHashMap<V> extends AbstractFloat2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Float2ReferenceOpenCustomHashMap(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Float2ReferenceOpenCustomHashMap(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2ReferenceOpenCustomHashMap(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Float2ReferenceOpenCustomHashMap(Map<? extends Float, ? extends V> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2ReferenceOpenCustomHashMap(Map<? extends Float, ? extends V> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2ReferenceOpenCustomHashMap(Float2ReferenceMap<V> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2ReferenceOpenCustomHashMap(Float2ReferenceMap<V> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2ReferenceOpenCustomHashMap(float[] var1, V[] var2, float var3, FloatHash.Strategy var4) {
   ...
   public Float2ReferenceOpenCustomHashMap(float[] var1, V[] var2, FloatHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Float2ReferenceOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Float2ReferenceOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Float2ReferenceOpenCustomHashMap.this.value[Float2ReferenceOpenCustomHashMap.this.n]);
               }

               int var2 = Float2ReferenceOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2ReferenceOpenCustomHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2ReferenceOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2ReferenceOpenCustomHashMap<V> clone() {
      Float2ReferenceOpenCustomHashMap var1;
      try {
         var1 = (Float2ReferenceOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      Object[] var3 = this.value;
      Float2ReferenceOpenCustomHashMap.MapIterator var4 = new Float2ReferenceOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept((double)Float2ReferenceOpenCustomHashMap.this.key[Float2ReferenceOpenCustomHashMap.this.n]);
         }

         int var2 = Float2ReferenceOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2ReferenceOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2ReferenceOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2ReferenceOpenCustomHashMap.this.size;
         Float2ReferenceOpenCustomHashMap.this.remove(var1);
         return Float2ReferenceOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry<V>> implements Float2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                  return Float2ReferenceOpenCustomHashMap.this.containsNullKey && Float2ReferenceOpenCustomHashMap.this.value[Float2ReferenceOpenCustomHashMap.this.n] == var4;
               } else {
                  float[] var6 = Float2ReferenceOpenCustomHashMap.this.key;
                  float var5;
                  int var7;
                  if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Float2ReferenceOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ReferenceOpenCustomHashMap.this.mask]) != 0) {
                        if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Float2ReferenceOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               ...
               Object var4 = var2.getValue();
               if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                  if (Float2ReferenceOpenCustomHashMap.this.containsNullKey && Float2ReferenceOpenCustomHashMap.this.value[Float2ReferenceOpenCustomHashMap.this.n] == var4) {
                  ...
                  if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Float2ReferenceOpenCustomHashMap.this.value[var7] == var4) {
                        Float2ReferenceOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(!Float2ReferenceOpenCustomHashMap.this.strategy.equals(var5, var3) || Float2ReferenceOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> var1) {
         if (Float2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceOpenCustomHashMap.this.key[Float2ReferenceOpenCustomHashMap.this.n], Float2ReferenceOpenCustomHashMap.this.value[Float2ReferenceOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2ReferenceOpenCustomHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceOpenCustomHashMap.this.key[var2], Float2ReferenceOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2ReferenceMap.Entry<V>> var1) {
         ...
         if (Float2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var2.key = Float2ReferenceOpenCustomHashMap.this.key[Float2ReferenceOpenCustomHashMap.this.n];
            var2.value = Float2ReferenceOpenCustomHashMap.this.value[Float2ReferenceOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2ReferenceOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2ReferenceOpenCustomHashMap.this.key[var3]) != 0) {
               var2.key = Float2ReferenceOpenCustomHashMap.this.key[var3];
               var2.value = Float2ReferenceOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
      private final Float2ReferenceOpenCustomHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2ReferenceOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2ReferenceOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(var2)) & Float2ReferenceOpenCustomHashMap.this.mask; !Float2ReferenceOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Float2ReferenceOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2ReferenceOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2ReferenceOpenCustomHashMap.this.mask;

            float var4;
            while(true) {
               if (Float.floatToIntBits(var4 = var5[var1]) == 0) {
                  var5[var2] = 0.0F;
                  Float2ReferenceOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(var4)) & Float2ReferenceOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2ReferenceOpenCustomHashMap.this.value[var2] = Float2ReferenceOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2ReferenceMap.Entry<V>, java.util.Map.Entry<Float, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Float2ReferenceOpenCustomHashMap.this.value[this.index];
         Float2ReferenceOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float2ReferenceOpenCustomHashMap.this.strategy.equals(Float2ReferenceOpenCustomHashMap.this.key[this.index], (Float)var2.getKey()) && Float2ReferenceOpenCustomHashMap.this.value[this.index] == var2.getValue();
         }
      }
