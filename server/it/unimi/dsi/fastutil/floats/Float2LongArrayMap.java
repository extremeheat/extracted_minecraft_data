...
public class Float2LongArrayMap extends AbstractFloat2LongMap implements Serializable, Cloneable {
   ...
   public Float2LongArrayMap(float[] var1, long[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Float2LongArrayMap(int var1) {
      super();
      this.key = new float[var1];
      this.value = new long[var1];
   }

   public Float2LongArrayMap(Float2LongMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2LongArrayMap(Map<? extends Float, ? extends Long> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2LongArrayMap(float[] var1, long[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public FloatSet keySet() {
      return new AbstractFloatSet() {
         public boolean contains(float var1) {
            return Float2LongArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(float var1) {
            int var2 = Float2LongArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Float2LongArrayMap.this.size - var2 - 1;
               System.arraycopy(Float2LongArrayMap.this.key, var2 + 1, Float2LongArrayMap.this.key, var2, var3);
               System.arraycopy(Float2LongArrayMap.this.value, var2 + 1, Float2LongArrayMap.this.value, var2, var3);
            ...
            return new FloatIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Float2LongArrayMap.this.size - this.pos;
                     System.arraycopy(Float2LongArrayMap.this.key, this.pos, Float2LongArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Float2LongArrayMap.this.value, this.pos, Float2LongArrayMap.this.value, this.pos - 1, var1);
                     Float2LongArrayMap.this.size--;
                  }
               }
            };
   ...
   public LongCollection values() {
      return new AbstractLongCollection() {
         public boolean contains(long var1) {
            return Float2LongArrayMap.this.containsValue(var1);
         }
   ...
   public Float2LongArrayMap clone() {
      Float2LongArrayMap var1;
      try {
         var1 = (Float2LongArrayMap)super.clone();
         ...
         return new ObjectIterator<Float2LongMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Float2LongArrayMap.this.size-- - this.next--;
                  System.arraycopy(Float2LongArrayMap.this.key, this.next + 1, Float2LongArrayMap.this.key, this.next, var1);
                  System.arraycopy(Float2LongArrayMap.this.value, this.next + 1, Float2LongArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  return Float2LongArrayMap.this.containsKey(var3) && Float2LongArrayMap.this.get(var3) == (Long)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  int var6 = Float2LongArrayMap.this.findKey(var3);
                  if (var6 != -1 && var4 == Float2LongArrayMap.this.value[var6]) {
                     int var7 = Float2LongArrayMap.this.size - var6 - 1;
                     System.arraycopy(Float2LongArrayMap.this.key, var6 + 1, Float2LongArrayMap.this.key, var6, var7);
                     System.arraycopy(Float2LongArrayMap.this.value, var6 + 1, Float2LongArrayMap.this.value, var6, var7);
                     Float2LongArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
