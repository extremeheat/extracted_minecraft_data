...
public class Float2FloatOpenCustomHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Float2FloatOpenCustomHashMap(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Float2FloatOpenCustomHashMap(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2FloatOpenCustomHashMap(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Float2FloatOpenCustomHashMap(Map<? extends Float, ? extends Float> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2FloatOpenCustomHashMap(Map<? extends Float, ? extends Float> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2FloatOpenCustomHashMap(Float2FloatMap var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2FloatOpenCustomHashMap(Float2FloatMap var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2FloatOpenCustomHashMap(float[] var1, float[] var2, float var3, FloatHash.Strategy var4) {
   ...
   public Float2FloatOpenCustomHashMap(float[] var1, float[] var2, FloatHash.Strategy var3) {
   ...
   public Float2FloatMap.FastEntrySet float2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Float2FloatOpenCustomHashMap.MapEntrySet();
      }
   ...
   public FloatSet keySet() {
      if (this.keys == null) {
         this.keys = new Float2FloatOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            public FloatIterator iterator() {
               return Float2FloatOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(float var1) {
               return Float2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Float2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[var2]) != 0) {
                     var1.accept((double)Float2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2FloatOpenCustomHashMap clone() {
      Float2FloatOpenCustomHashMap var1;
      try {
         var1 = (Float2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      float[] var3 = this.value;
      Float2FloatOpenCustomHashMap.MapIterator var4 = new Float2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Float2FloatOpenCustomHashMap.MapIterator implements FloatIterator {
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatIterator iterator() {
         return Float2FloatOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(DoubleConsumer var1) {
         if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept((double)Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Float2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2FloatOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2FloatOpenCustomHashMap.this.size;
         Float2FloatOpenCustomHashMap.this.remove(var1);
         return Float2FloatOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Float2FloatOpenCustomHashMap.MapIterator implements FloatIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
      ...
      public ObjectIterator<Float2FloatMap.Entry> iterator() {
         return Float2FloatOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Float2FloatMap.Entry> fastIterator() {
         return Float2FloatOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Float2FloatOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     return Float2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     float[] var6 = Float2FloatOpenCustomHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2FloatOpenCustomHashMap.this.mask]) != 0) {
                           if (Float2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (Float2FloatOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     if (Float2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2FloatOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Float2FloatOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2FloatOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Float2FloatOpenCustomHashMap.this.strategy.equals(var5, var3) || Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Float2FloatMap.Entry> var1) {
         if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2FloatMap.BasicEntry(Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.n], Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2FloatMap.BasicEntry(Float2FloatOpenCustomHashMap.this.key[var2], Float2FloatOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2FloatMap.Entry> var1) {
         ...
         if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.n];
            var2.value = Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[var3]) != 0) {
               var2.key = Float2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Float2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Float2FloatMap.Entry> {
      private final Float2FloatOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Float2FloatMap.Entry> {
      ...
      public Float2FloatOpenCustomHashMap.MapEntry next() {
         return this.entry = Float2FloatOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2FloatOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Float2FloatOpenCustomHashMap.this.mask; !Float2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Float2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Float2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2FloatOpenCustomHashMap.this.value[var2] = Float2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2FloatMap.Entry, java.util.Map.Entry<Float, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Float2FloatOpenCustomHashMap.this.value[this.index];
         Float2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], (Float)var2.getKey()) && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
