...
public class Float2ShortArrayMap extends AbstractFloat2ShortMap implements Serializable, Cloneable {
   ...
   public Float2ShortArrayMap(float[] var1, short[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Float2ShortArrayMap(int var1) {
      super();
      this.key = new float[var1];
      this.value = new short[var1];
   }

   public Float2ShortArrayMap(Float2ShortMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2ShortArrayMap(Map<? extends Float, ? extends Short> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Float2ShortArrayMap(float[] var1, short[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Float2ShortMap.FastEntrySet float2ShortEntrySet() {
      return new Float2ShortArrayMap.EntrySet();
   }
   ...
   public FloatSet keySet() {
      return new AbstractFloatSet() {
         public boolean contains(float var1) {
            return Float2ShortArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(float var1) {
            int var2 = Float2ShortArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Float2ShortArrayMap.this.size - var2 - 1;
               System.arraycopy(Float2ShortArrayMap.this.key, var2 + 1, Float2ShortArrayMap.this.key, var2, var3);
               System.arraycopy(Float2ShortArrayMap.this.value, var2 + 1, Float2ShortArrayMap.this.value, var2, var3);
            ...
            return new FloatIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Float2ShortArrayMap.this.size - this.pos;
                     System.arraycopy(Float2ShortArrayMap.this.key, this.pos, Float2ShortArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Float2ShortArrayMap.this.value, this.pos, Float2ShortArrayMap.this.value, this.pos - 1, var1);
                     Float2ShortArrayMap.this.size--;
                  }
               }
            };
   ...
   public ShortCollection values() {
      return new AbstractShortCollection() {
         public boolean contains(short var1) {
            return Float2ShortArrayMap.this.containsValue(var1);
         }
   ...
   public Float2ShortArrayMap clone() {
      Float2ShortArrayMap var1;
      try {
         var1 = (Float2ShortArrayMap)super.clone();
         ...
         return new ObjectIterator<Float2ShortMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Float2ShortArrayMap.this.size-- - this.next--;
                  System.arraycopy(Float2ShortArrayMap.this.key, this.next + 1, Float2ShortArrayMap.this.key, this.next, var1);
                  System.arraycopy(Float2ShortArrayMap.this.value, this.next + 1, Float2ShortArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  return Float2ShortArrayMap.this.containsKey(var3) && Float2ShortArrayMap.this.get(var3) == (Short)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  int var5 = Float2ShortArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Float2ShortArrayMap.this.value[var5]) {
                     int var6 = Float2ShortArrayMap.this.size - var5 - 1;
                     System.arraycopy(Float2ShortArrayMap.this.key, var5 + 1, Float2ShortArrayMap.this.key, var5, var6);
                     System.arraycopy(Float2ShortArrayMap.this.value, var5 + 1, Float2ShortArrayMap.this.value, var5, var6);
                     Float2ShortArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
