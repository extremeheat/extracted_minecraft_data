...
public class Float2BooleanAVLTreeMap extends AbstractFloat2BooleanSortedMap implements Serializable, Cloneable {
   ...
   public Float2BooleanAVLTreeMap(Comparator<? super Float> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Float2BooleanAVLTreeMap(Map<? extends Float, ? extends Boolean> var1) {
      this();
      this.putAll(var1);
   }

   public Float2BooleanAVLTreeMap(SortedMap<Float, Boolean> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Float2BooleanAVLTreeMap(Float2BooleanMap var1) {
      this();
      this.putAll(var1);
   }

   public Float2BooleanAVLTreeMap(Float2BooleanSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Float2BooleanAVLTreeMap(float[] var1, boolean[] var2, Comparator<? super Float> var3) {
      this(var3);
   ...
   public Float2BooleanAVLTreeMap(float[] var1, boolean[] var2) {
   ...
   final Float2BooleanAVLTreeMap.Entry findKey(float var1) {
      Float2BooleanAVLTreeMap.Entry var2;
      int var3;
   ...
   final Float2BooleanAVLTreeMap.Entry locateKey(float var1) {
      Float2BooleanAVLTreeMap.Entry var2 = this.tree;
      Float2BooleanAVLTreeMap.Entry var3 = this.tree;
   ...
   public boolean put(float var1, boolean var2) {
      Float2BooleanAVLTreeMap.Entry var3 = this.add(var1);
      boolean var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Float2BooleanAVLTreeMap.Entry add(float var1) {
      this.modified = false;
      Float2BooleanAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Float2BooleanAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Float2BooleanAVLTreeMap.Entry var3 = this.tree;
         Float2BooleanAVLTreeMap.Entry var4 = null;
         Float2BooleanAVLTreeMap.Entry var5 = this.tree;
         Float2BooleanAVLTreeMap.Entry var6 = null;
         Float2BooleanAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Float2BooleanAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Float2BooleanAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Float2BooleanAVLTreeMap.Entry parent(Float2BooleanAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Float2BooleanAVLTreeMap.Entry var3 = var1;

         Float2BooleanAVLTreeMap.Entry var2;
         Float2BooleanAVLTreeMap.Entry var4;
   ...
   public boolean remove(float var1) {
      ...
      if (this.tree == null) {
         ...
         Float2BooleanAVLTreeMap.Entry var7;
         Float2BooleanAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Float2BooleanAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(boolean var1) {
      Float2BooleanAVLTreeMap.ValueIterator var2 = new Float2BooleanAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public boolean get(float var1) {
      Float2BooleanAVLTreeMap.Entry var2 = this.findKey(var1);
   ...
   public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>() {
            final Comparator<? super Float2BooleanMap.Entry> comparator = (var1x, var2) -> {
               return Float2BooleanAVLTreeMap.this.actualComparator.compare(var1x.getFloatKey(), var2.getFloatKey());
            };
            ...
            public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry var1) {
               return Float2BooleanAVLTreeMap.this.new EntryIterator(var1.getFloatKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        Float2BooleanAVLTreeMap.Entry var3 = Float2BooleanAVLTreeMap.this.findKey((Float)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Float) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        ...
                        if (var3 != null && var3.getBooleanValue() == (Boolean)var2.getValue()) {
                           Float2BooleanAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry var1, Float2BooleanMap.Entry var2) {
               return Float2BooleanAVLTreeMap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2BooleanEntrySet();
            }

            public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry var1) {
               return Float2BooleanAVLTreeMap.this.headMap(var1.getFloatKey()).float2BooleanEntrySet();
            }

            public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry var1) {
               return Float2BooleanAVLTreeMap.this.tailMap(var1.getFloatKey()).float2BooleanEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Float2BooleanAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Float2BooleanSortedMap headMap(float var1) {
      return new Float2BooleanAVLTreeMap.Submap(0.0F, true, var1, false);
   }

   public Float2BooleanSortedMap tailMap(float var1) {
      return new Float2BooleanAVLTreeMap.Submap(var1, false, 0.0F, true);
   }

   public Float2BooleanSortedMap subMap(float var1, float var2) {
      return new Float2BooleanAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Float2BooleanAVLTreeMap clone() {
      Float2BooleanAVLTreeMap var1;
      try {
         var1 = (Float2BooleanAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Float2BooleanAVLTreeMap.Entry var5 = new Float2BooleanAVLTreeMap.Entry();
         Float2BooleanAVLTreeMap.Entry var6 = new Float2BooleanAVLTreeMap.Entry();
         Float2BooleanAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Float2BooleanAVLTreeMap.Entry var4 = var6;
         var6.pred((Float2BooleanAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Float2BooleanAVLTreeMap.EntryIterator var3 = new Float2BooleanAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Float2BooleanAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Float2BooleanAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Float2BooleanAVLTreeMap.Entry var3, Float2BooleanAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Float2BooleanAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Float2BooleanAVLTreeMap.Entry(var1.readFloat(), var1.readBoolean());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Float2BooleanAVLTreeMap.Entry(var1.readFloat(), var1.readBoolean());
         var8.right(new Float2BooleanAVLTreeMap.Entry(var1.readFloat(), var1.readBoolean()));
         ...
         Float2BooleanAVLTreeMap.Entry var7 = new Float2BooleanAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Float2BooleanAVLTreeMap.Entry)null, (Float2BooleanAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractFloat2BooleanSortedMap implements Serializable {
      ...
      public Submap(float var2, boolean var3, float var4, boolean var5) {
         super();
         if (!var3 && !var5 && Float2BooleanAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Float2BooleanAVLTreeMap.Submap.SubmapIterator var1 = new Float2BooleanAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(float var1) {
         return (this.bottom || Float2BooleanAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Float2BooleanAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
         if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>() {
               ...
               public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry var1, Float2BooleanMap.Entry var2) {
                  return Submap.this.subMap(var1.getFloatKey(), var2.getFloatKey()).float2BooleanEntrySet();
               }

               public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry var1) {
                  return Submap.this.headMap(var1.getFloatKey()).float2BooleanEntrySet();
               }

               public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry var1) {
                  return Submap.this.tailMap(var1.getFloatKey()).float2BooleanEntrySet();
               }
            };
         }
      ...
      public boolean containsKey(float var1) {
         return this.in(var1) && Float2BooleanAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(boolean var1) {
         Float2BooleanAVLTreeMap.Submap.SubmapIterator var2 = new Float2BooleanAVLTreeMap.Submap.SubmapIterator();
      ...
      public boolean get(float var1) {
         Float2BooleanAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Float2BooleanAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public boolean put(float var1, boolean var2) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var3 = Float2BooleanAVLTreeMap.this.put(var1, var2);
            return Float2BooleanAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public boolean remove(float var1) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var2 = Float2BooleanAVLTreeMap.this.remove(var1);
            return Float2BooleanAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Float2BooleanSortedMap headMap(float var1) {
         if (this.top) {
            return Float2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Float2BooleanAVLTreeMap.this.compare(var1, this.to) < 0 ? Float2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Float2BooleanSortedMap tailMap(float var1) {
         if (this.bottom) {
            return Float2BooleanAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Float2BooleanAVLTreeMap.this.compare(var1, this.from) > 0 ? Float2BooleanAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Float2BooleanSortedMap subMap(float var1, float var2) {
         if (this.top && this.bottom) {
            return Float2BooleanAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Float2BooleanAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Float2BooleanAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Float2BooleanAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Float2BooleanAVLTreeMap.Entry firstEntry() {
         if (Float2BooleanAVLTreeMap.this.tree == null) {
            ...
            Float2BooleanAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Float2BooleanAVLTreeMap.this.firstEntry;
            } else {
               var1 = Float2BooleanAVLTreeMap.this.locateKey(this.from);
               if (Float2BooleanAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Float2BooleanAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Float2BooleanAVLTreeMap.Entry lastEntry() {
         if (Float2BooleanAVLTreeMap.this.tree == null) {
            ...
            Float2BooleanAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Float2BooleanAVLTreeMap.this.lastEntry;
            } else {
               var1 = Float2BooleanAVLTreeMap.this.locateKey(this.to);
               if (Float2BooleanAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Float2BooleanAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public float firstFloatKey() {
         Float2BooleanAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public float lastFloatKey() {
         Float2BooleanAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Float2BooleanAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Float2BooleanMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Float2BooleanAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(float var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Float2BooleanAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Float2BooleanAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Float2BooleanAVLTreeMap.this.locateKey(var2);
                  if (Float2BooleanAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractFloat2BooleanSortedMap.KeySet {
      ...
      public FloatBidirectionalIterator iterator(float var1) {
         return Float2BooleanAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Float2BooleanAVLTreeMap.TreeIterator implements ObjectListIterator<Float2BooleanMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(float var2) {
         super();
         if ((this.next = Float2BooleanAVLTreeMap.this.locateKey(var2)) != null) {
            if (Float2BooleanAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractFloat2BooleanMap.BasicEntry implements Cloneable {
      ...
      void pred(Float2BooleanAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Float2BooleanAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Float2BooleanAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Float2BooleanAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Float2BooleanAVLTreeMap.Entry next() {
         Float2BooleanAVLTreeMap.Entry var1 = this.right;
      ...
      Float2BooleanAVLTreeMap.Entry prev() {
         Float2BooleanAVLTreeMap.Entry var1 = this.left;
      ...
      public Float2BooleanAVLTreeMap.Entry clone() {
         Float2BooleanAVLTreeMap.Entry var1;
         try {
            var1 = (Float2BooleanAVLTreeMap.Entry)super.clone();
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits((Float)var2.getKey()) && this.value == (Boolean)var2.getValue();
         }
      }
