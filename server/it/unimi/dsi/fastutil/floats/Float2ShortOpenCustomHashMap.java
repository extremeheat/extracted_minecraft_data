...
public class Float2ShortOpenCustomHashMap extends AbstractFloat2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Float2ShortOpenCustomHashMap(int var1, float var2, FloatHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Float2ShortOpenCustomHashMap(int var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2ShortOpenCustomHashMap(FloatHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Float2ShortOpenCustomHashMap(Map<? extends Float, ? extends Short> var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2ShortOpenCustomHashMap(Map<? extends Float, ? extends Short> var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2ShortOpenCustomHashMap(Float2ShortMap var1, float var2, FloatHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Float2ShortOpenCustomHashMap(Float2ShortMap var1, FloatHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Float2ShortOpenCustomHashMap(float[] var1, short[] var2, float var3, FloatHash.Strategy var4) {
   ...
   public Float2ShortOpenCustomHashMap(float[] var1, short[] var2, FloatHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Float2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Float2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Float.floatToIntBits(Float2ShortOpenCustomHashMap.this.key[var2]) != 0) {
                     var1.accept(Float2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Float2ShortOpenCustomHashMap clone() {
      Float2ShortOpenCustomHashMap var1;
      try {
         var1 = (Float2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      float[] var2 = this.key;
      short[] var3 = this.value;
      Float2ShortOpenCustomHashMap.MapIterator var4 = new Float2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public void forEach(DoubleConsumer var1) {
         if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept((double)Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Float2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            float var3 = Float2ShortOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(float var1) {
         return Float2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(float var1) {
         int var2 = Float2ShortOpenCustomHashMap.this.size;
         Float2ShortOpenCustomHashMap.this.remove(var1);
         return Float2ShortOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Float2ShortOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     return Float2ShortOpenCustomHashMap.this.containsNullKey && Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.n] == var4;
                  } else {
                     float[] var6 = Float2ShortOpenCustomHashMap.this.key;
                     float var5;
                     int var7;
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float2ShortOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while(Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ShortOpenCustomHashMap.this.mask]) != 0) {
                           if (Float2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float2ShortOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Float) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (Float2ShortOpenCustomHashMap.this.strategy.equals(var3, 0.0F)) {
                     if (Float2ShortOpenCustomHashMap.this.containsNullKey && Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.n] == var4) {
                     ...
                     if (Float.floatToIntBits(var5 = var6[var7 = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Float2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Float2ShortOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float2ShortOpenCustomHashMap.this.value[var7] == var4) {
                           Float2ShortOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Float.floatToIntBits(var5 = var6[var7 = var7 + 1 & Float2ShortOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Float2ShortOpenCustomHashMap.this.strategy.equals(var5, var3) || Float2ShortOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Float2ShortMap.Entry> var1) {
         if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.n], Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Float.floatToIntBits(Float2ShortOpenCustomHashMap.this.key[var2]) != 0) {
               var1.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenCustomHashMap.this.key[var2], Float2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Float2ShortMap.Entry> var1) {
         ...
         if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.n];
            var2.value = Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Float2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Float.floatToIntBits(Float2ShortOpenCustomHashMap.this.key[var3]) != 0) {
               var2.key = Float2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Float2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Float2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Float2ShortMap.Entry> {
      private final Float2ShortOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Float2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Float2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Float2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               float[] var1 = Float2ShortOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Float2ShortOpenCustomHashMap.this.mask; !Float2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Float2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         float[] var5 = Float2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Float2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Float2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Float2ShortOpenCustomHashMap.this.value[var2] = Float2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Float2ShortMap.Entry, java.util.Map.Entry<Float, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Float2ShortOpenCustomHashMap.this.value[this.index];
         Float2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[this.index], (Float)var2.getKey()) && Float2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
