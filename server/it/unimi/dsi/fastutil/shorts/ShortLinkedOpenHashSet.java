...
public class ShortLinkedOpenHashSet extends AbstractShortSortedSet implements Serializable, Cloneable, Hash {
   ...
   public ShortLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public ShortLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public ShortLinkedOpenHashSet(Collection<? extends Short> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ShortLinkedOpenHashSet(Collection<? extends Short> var1) {
      this(var1, 0.75F);
   }

   public ShortLinkedOpenHashSet(ShortCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ShortLinkedOpenHashSet(ShortCollection var1) {
      this(var1, 0.75F);
   }

   public ShortLinkedOpenHashSet(ShortIterator var1, float var2) {
      this(16, var2);
   ...
   public ShortLinkedOpenHashSet(ShortIterator var1) {
      this(var1, 0.75F);
   }

   public ShortLinkedOpenHashSet(Iterator<?> var1, float var2) {
      this(ShortIterators.asShortIterator(var1), var2);
   }

   public ShortLinkedOpenHashSet(Iterator<?> var1) {
      this(ShortIterators.asShortIterator(var1));
   }

   public ShortLinkedOpenHashSet(short[] var1, int var2, int var3, float var4) {
   ...
   public ShortLinkedOpenHashSet(short[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public ShortLinkedOpenHashSet(short[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public ShortLinkedOpenHashSet(short[] var1) {
      this(var1, 0.75F);
   }
   ...
   public boolean addAndMoveToFirst(short var1) {
      ...
      if (var1 == 0) {
         ...
         for(var2 = HashCommon.mix(var1) & this.mask; var3[var2] != 0; var2 = var2 + 1 & this.mask) {
            if (var1 == var3[var2]) {
   ...
   public ShortListIterator iterator(short var1) {
      return new ShortLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         ...
         if (var2[var5] == 0) {
            ...
            for(var9 = HashCommon.mix(var2[var5]) & var3; var4[var9] != 0; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public ShortLinkedOpenHashSet clone() {
      ShortLinkedOpenHashSet var1;
      try {
         var1 = (ShortLinkedOpenHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var6-- != 0) {
         ...
         if (var5 == 0) {
            var7 = this.n;
            this.containsNull = true;
         } else if (var2[var7 = HashCommon.mix(var5) & this.mask] != 0) {
   ...
   private class SetIterator implements ShortListIterator {
      ...
      SetIterator(short var2) {
         ...
         } else if (ShortLinkedOpenHashSet.this.key[ShortLinkedOpenHashSet.this.last] == var2) {
            this.prev = ShortLinkedOpenHashSet.this.last;
            this.index = ShortLinkedOpenHashSet.this.size;
         } else {
            short[] var3 = ShortLinkedOpenHashSet.this.key;

            for(int var4 = HashCommon.mix(var2) & ShortLinkedOpenHashSet.this.mask; var3[var4] != 0; var4 = var4 + 1 & ShortLinkedOpenHashSet.this.mask) {
               if (var3[var4] == var2) {
                  this.next = (int)ShortLinkedOpenHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = ShortLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)ShortLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = ShortLinkedOpenHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (ShortLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = ShortLinkedOpenHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (ShortLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == ShortLinkedOpenHashSet.this.n) {
               ShortLinkedOpenHashSet.this.containsNull = false;
               ShortLinkedOpenHashSet.this.key[ShortLinkedOpenHashSet.this.n] = 0;
            } else {
               short[] var5 = ShortLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & ShortLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(var4) & ShortLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  ShortLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
