...
public final class Short2IntFunctions {
   ...
   public static Short2IntFunction singleton(short var0, int var1) {
      return new Short2IntFunctions.Singleton(var0, var1);
   }

   public static Short2IntFunction singleton(Short var0, Integer var1) {
      return new Short2IntFunctions.Singleton(var0, var1);
   }

   public static Short2IntFunction synchronize(Short2IntFunction var0) {
      return new Short2IntFunctions.SynchronizedFunction(var0);
   }

   public static Short2IntFunction synchronize(Short2IntFunction var0, Object var1) {
      return new Short2IntFunctions.SynchronizedFunction(var0, var1);
   }

   public static Short2IntFunction unmodifiable(Short2IntFunction var0) {
      return new Short2IntFunctions.UnmodifiableFunction(var0);
   }

   public static Short2IntFunction primitive(Function<? super Short, ? extends Integer> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Short2IntFunction) {
         return (Short2IntFunction)var0;
         ...
         return new Short2IntFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Short2IntFunction {
      ...
      protected PrimitiveFunction(Function<? super Short, ? extends Integer> var1) {
         super();
         this.function = var1;
      }
      ...
      public Integer get(Object var1) {
         return var1 == null ? null : (Integer)this.function.apply((Short)var1);
      }

      /** @deprecated */
      @Deprecated
      public Integer put(Short var1, Integer var2) {
   ...
   public static class UnmodifiableFunction extends AbstractShort2IntFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Short2IntFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Short2IntFunction, Serializable {
      ...
      protected SynchronizedFunction(Short2IntFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Short2IntFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Integer apply(Short var1) {
         synchronized(this.sync) {
