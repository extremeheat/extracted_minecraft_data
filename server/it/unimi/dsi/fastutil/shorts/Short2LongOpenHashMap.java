...
public class Short2LongOpenHashMap extends AbstractShort2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Short2LongOpenHashMap(int var1, float var2) {
      super();
   ...
   public Short2LongOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Short2LongOpenHashMap(Map<? extends Short, ? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2LongOpenHashMap(Map<? extends Short, ? extends Long> var1) {
      this(var1, 0.75F);
   }

   public Short2LongOpenHashMap(Short2LongMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2LongOpenHashMap(Short2LongMap var1) {
      this(var1, 0.75F);
   }

   public Short2LongOpenHashMap(short[] var1, long[] var2, float var3) {
   ...
   public Short2LongOpenHashMap(short[] var1, long[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Short2LongOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Short2LongOpenHashMap.this.containsNullKey) {
                  var1.accept(Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n]);
               }

               int var2 = Short2LongOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2LongOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Short2LongOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2LongOpenHashMap clone() {
      Short2LongOpenHashMap var1;
      try {
         var1 = (Short2LongOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      long[] var3 = this.value;
      Short2LongOpenHashMap.MapIterator var4 = new Short2LongOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2LongOpenHashMap.this.containsNullKey) {
            var1.accept(Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n]);
         }

         int var2 = Short2LongOpenHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2LongOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2LongOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2LongOpenHashMap.this.size;
         Short2LongOpenHashMap.this.remove(var1);
         return Short2LongOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements Short2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (var3 == 0) {
                     return Short2LongOpenHashMap.this.containsNullKey && Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n] == var4;
                  } else {
                     short[] var7 = Short2LongOpenHashMap.this.key;
                     short var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Short2LongOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var6) {
                        return Short2LongOpenHashMap.this.value[var8] == var4;
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Short2LongOpenHashMap.this.mask]) != 0) {
                           if (var3 == var6) {
                              return Short2LongOpenHashMap.this.value[var8] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var4 = (Long)var2.getValue();
                  if (var3 == 0) {
                     if (Short2LongOpenHashMap.this.containsNullKey && Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n] == var4) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Short2LongOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Short2LongOpenHashMap.this.value[var8] == var4) {
                           Short2LongOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Short2LongOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var6 != var3 || Short2LongOpenHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Short2LongMap.Entry> var1) {
         if (Short2LongOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2LongMap.BasicEntry(Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n], Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2LongOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2LongMap.BasicEntry(Short2LongOpenHashMap.this.key[var2], Short2LongOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2LongMap.Entry> var1) {
         ...
         if (Short2LongOpenHashMap.this.containsNullKey) {
            var2.key = Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n];
            var2.value = Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2LongOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Short2LongOpenHashMap.this.key[var3] != 0) {
               var2.key = Short2LongOpenHashMap.this.key[var3];
               var2.value = Short2LongOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2LongOpenHashMap.MapIterator implements ObjectIterator<Short2LongMap.Entry> {
      private final Short2LongOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2LongOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2LongOpenHashMap.MapIterator implements ObjectIterator<Short2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2LongOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Short2LongOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Short2LongOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2LongOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2LongOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Short2LongOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2LongOpenHashMap.this.value[var2] = Short2LongOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2LongMap.Entry, java.util.Map.Entry<Short, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Short2LongOpenHashMap.this.value[this.index];
         Short2LongOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2LongOpenHashMap.this.key[this.index] == (Short)var2.getKey() && Short2LongOpenHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
