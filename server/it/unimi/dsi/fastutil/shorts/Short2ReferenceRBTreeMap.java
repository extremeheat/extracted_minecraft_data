...
public class Short2ReferenceRBTreeMap<V> extends AbstractShort2ReferenceSortedMap<V> implements Serializable, Cloneable {
   ...
   public Short2ReferenceRBTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2ReferenceRBTreeMap(Map<? extends Short, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Short2ReferenceRBTreeMap(SortedMap<Short, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2ReferenceRBTreeMap(Short2ReferenceMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Short2ReferenceRBTreeMap(Short2ReferenceSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2ReferenceRBTreeMap(short[] var1, V[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2ReferenceRBTreeMap(short[] var1, V[] var2) {
   ...
   final Short2ReferenceRBTreeMap.Entry<V> findKey(short var1) {
      Short2ReferenceRBTreeMap.Entry var2;
      int var3;
   ...
   final Short2ReferenceRBTreeMap.Entry<V> locateKey(short var1) {
      Short2ReferenceRBTreeMap.Entry var2 = this.tree;
      Short2ReferenceRBTreeMap.Entry var3 = this.tree;
   ...
   public V put(short var1, V var2) {
      Short2ReferenceRBTreeMap.Entry var3 = this.add(var1);
      Object var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Short2ReferenceRBTreeMap.Entry<V> add(short var1) {
      this.modified = false;
      int var2 = 0;
      Short2ReferenceRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Short2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Short2ReferenceRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Short2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Short2ReferenceRBTreeMap.Entry var7;
               Short2ReferenceRBTreeMap.Entry var8;
   ...
   public boolean containsValue(Object var1) {
      Short2ReferenceRBTreeMap.ValueIterator var2 = new Short2ReferenceRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(short var1) {
      Short2ReferenceRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>() {
            final Comparator<? super Short2ReferenceMap.Entry<V>> comparator = (var1x, var2) -> {
               return Short2ReferenceRBTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> var1) {
               return Short2ReferenceRBTreeMap.this.new EntryIterator(var1.getShortKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     Short2ReferenceRBTreeMap.Entry var3 = Short2ReferenceRBTreeMap.this.findKey((Short)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     ...
                     if (var3 != null && var3.getValue() == var2.getValue()) {
                        Short2ReferenceRBTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> var1, Short2ReferenceMap.Entry<V> var2) {
               return Short2ReferenceRBTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2ReferenceEntrySet();
            }

            public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> var1) {
               return Short2ReferenceRBTreeMap.this.headMap(var1.getShortKey()).short2ReferenceEntrySet();
            }

            public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> var1) {
               return Short2ReferenceRBTreeMap.this.tailMap(var1.getShortKey()).short2ReferenceEntrySet();
            }
         };
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Short2ReferenceRBTreeMap.this.containsValue(var1);
            }
   ...
   public Short2ReferenceSortedMap<V> headMap(short var1) {
      return new Short2ReferenceRBTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2ReferenceSortedMap<V> tailMap(short var1) {
      return new Short2ReferenceRBTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2ReferenceSortedMap<V> subMap(short var1, short var2) {
      return new Short2ReferenceRBTreeMap.Submap(var1, false, var2, false);
   }

   public Short2ReferenceRBTreeMap<V> clone() {
      Short2ReferenceRBTreeMap var1;
      try {
         var1 = (Short2ReferenceRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2ReferenceRBTreeMap.Entry var5 = new Short2ReferenceRBTreeMap.Entry();
         Short2ReferenceRBTreeMap.Entry var6 = new Short2ReferenceRBTreeMap.Entry();
         Short2ReferenceRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2ReferenceRBTreeMap.Entry var4 = var6;
         var6.pred((Short2ReferenceRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2ReferenceRBTreeMap.EntryIterator var3 = new Short2ReferenceRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2ReferenceRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2ReferenceRBTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Short2ReferenceRBTreeMap.Entry<V> var3, Short2ReferenceRBTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Short2ReferenceRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2ReferenceRBTreeMap.Entry(var1.readShort(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Short2ReferenceRBTreeMap.Entry(var1.readShort(), var1.readObject());
         var8.black(true);
         var8.right(new Short2ReferenceRBTreeMap.Entry(var1.readShort(), var1.readObject()));
         ...
         Short2ReferenceRBTreeMap.Entry var7 = new Short2ReferenceRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2ReferenceRBTreeMap.Entry)null, (Short2ReferenceRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2ReferenceSortedMap<V> implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2ReferenceRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2ReferenceRBTreeMap.Submap.SubmapIterator var1 = new Short2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2ReferenceRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2ReferenceRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2ReferenceRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Short2ReferenceRBTreeMap.Submap.SubmapIterator var2 = new Short2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(short var1) {
         Short2ReferenceRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2ReferenceRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public V put(short var1, V var2) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Short2ReferenceRBTreeMap.this.put(var1, var2);
            return Short2ReferenceRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public V remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var2 = Short2ReferenceRBTreeMap.this.remove(var1);
            return Short2ReferenceRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Short2ReferenceSortedMap<V> headMap(short var1) {
         if (this.top) {
            return Short2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2ReferenceRBTreeMap.this.compare(var1, this.to) < 0 ? Short2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2ReferenceSortedMap<V> tailMap(short var1) {
         if (this.bottom) {
            return Short2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? Short2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2ReferenceSortedMap<V> subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2ReferenceRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2ReferenceRBTreeMap.Entry<V> firstEntry() {
         if (Short2ReferenceRBTreeMap.this.tree == null) {
            ...
            Short2ReferenceRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2ReferenceRBTreeMap.this.firstEntry;
            } else {
               var1 = Short2ReferenceRBTreeMap.this.locateKey(this.from);
               if (Short2ReferenceRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2ReferenceRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2ReferenceRBTreeMap.Entry<V> lastEntry() {
         if (Short2ReferenceRBTreeMap.this.tree == null) {
            ...
            Short2ReferenceRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2ReferenceRBTreeMap.this.lastEntry;
            } else {
               var1 = Short2ReferenceRBTreeMap.this.locateKey(this.to);
               if (Short2ReferenceRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2ReferenceRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2ReferenceRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2ReferenceRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2ReferenceRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2ReferenceRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2ReferenceRBTreeMap.this.locateKey(var2);
                  if (Short2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractShort2ReferenceSortedMap<V>.KeySet {
      ...
      public ShortBidirectionalIterator iterator(short var1) {
         return Short2ReferenceRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2ReferenceRBTreeMap.this.locateKey(var2)) != null) {
            if (Short2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractShort2ReferenceMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Short2ReferenceRBTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2ReferenceRBTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2ReferenceRBTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2ReferenceRBTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2ReferenceRBTreeMap.Entry<V> next() {
         Short2ReferenceRBTreeMap.Entry var1 = this.right;
      ...
      Short2ReferenceRBTreeMap.Entry<V> prev() {
         Short2ReferenceRBTreeMap.Entry var1 = this.left;
      ...
      public Short2ReferenceRBTreeMap.Entry<V> clone() {
         Short2ReferenceRBTreeMap.Entry var1;
         try {
            var1 = (Short2ReferenceRBTreeMap.Entry)super.clone();
