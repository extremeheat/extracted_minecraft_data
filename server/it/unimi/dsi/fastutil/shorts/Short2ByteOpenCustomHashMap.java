...
public class Short2ByteOpenCustomHashMap extends AbstractShort2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Short2ByteOpenCustomHashMap(int var1, float var2, ShortHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Short2ByteOpenCustomHashMap(int var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ByteOpenCustomHashMap(ShortHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Short2ByteOpenCustomHashMap(Map<? extends Short, ? extends Byte> var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2ByteOpenCustomHashMap(Map<? extends Short, ? extends Byte> var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ByteOpenCustomHashMap(Short2ByteMap var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2ByteOpenCustomHashMap(Short2ByteMap var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ByteOpenCustomHashMap(short[] var1, byte[] var2, float var3, ShortHash.Strategy var4) {
   ...
   public Short2ByteOpenCustomHashMap(short[] var1, byte[] var2, ShortHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Short2ByteOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.n]);
               }

               int var2 = Short2ByteOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2ByteOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Short2ByteOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2ByteOpenCustomHashMap clone() {
      Short2ByteOpenCustomHashMap var1;
      try {
         var1 = (Short2ByteOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      byte[] var3 = this.value;
      Short2ByteOpenCustomHashMap.MapIterator var4 = new Short2ByteOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Short2ByteOpenCustomHashMap.this.key[Short2ByteOpenCustomHashMap.this.n]);
         }

         int var2 = Short2ByteOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2ByteOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2ByteOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2ByteOpenCustomHashMap.this.size;
         Short2ByteOpenCustomHashMap.this.remove(var1);
         return Short2ByteOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry> implements Short2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (Short2ByteOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                     return Short2ByteOpenCustomHashMap.this.containsNullKey && Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.n] == var4;
                  } else {
                     short[] var6 = Short2ByteOpenCustomHashMap.this.key;
                     short var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Short2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2ByteOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Short2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Short2ByteOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Short2ByteOpenCustomHashMap.this.mask]) != 0) {
                           if (Short2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Short2ByteOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var4 = (Byte)var2.getValue();
                  if (Short2ByteOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                     if (Short2ByteOpenCustomHashMap.this.containsNullKey && Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Short2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2ByteOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Short2ByteOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Short2ByteOpenCustomHashMap.this.value[var7] == var4) {
                           Short2ByteOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Short2ByteOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Short2ByteOpenCustomHashMap.this.strategy.equals(var5, var3) || Short2ByteOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Short2ByteMap.Entry> var1) {
         if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2ByteMap.BasicEntry(Short2ByteOpenCustomHashMap.this.key[Short2ByteOpenCustomHashMap.this.n], Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2ByteOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2ByteMap.BasicEntry(Short2ByteOpenCustomHashMap.this.key[var2], Short2ByteOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2ByteMap.Entry> var1) {
         ...
         if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
            var2.key = Short2ByteOpenCustomHashMap.this.key[Short2ByteOpenCustomHashMap.this.n];
            var2.value = Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2ByteOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Short2ByteOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Short2ByteOpenCustomHashMap.this.key[var3];
               var2.value = Short2ByteOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Short2ByteMap.Entry> {
      private final Short2ByteOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2ByteOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Short2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2ByteOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Short2ByteOpenCustomHashMap.this.strategy.hashCode(var2)) & Short2ByteOpenCustomHashMap.this.mask; !Short2ByteOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Short2ByteOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2ByteOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2ByteOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Short2ByteOpenCustomHashMap.this.strategy.hashCode(var4)) & Short2ByteOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2ByteOpenCustomHashMap.this.value[var2] = Short2ByteOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2ByteMap.Entry, java.util.Map.Entry<Short, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Short2ByteOpenCustomHashMap.this.value[this.index];
         Short2ByteOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2ByteOpenCustomHashMap.this.strategy.equals(Short2ByteOpenCustomHashMap.this.key[this.index], (Short)var2.getKey()) && Short2ByteOpenCustomHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
