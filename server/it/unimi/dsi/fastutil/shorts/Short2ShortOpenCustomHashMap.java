...
public class Short2ShortOpenCustomHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Short2ShortOpenCustomHashMap(int var1, float var2, ShortHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Short2ShortOpenCustomHashMap(int var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ShortOpenCustomHashMap(ShortHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Short2ShortOpenCustomHashMap(Map<? extends Short, ? extends Short> var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2ShortOpenCustomHashMap(Map<? extends Short, ? extends Short> var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ShortOpenCustomHashMap(Short2ShortMap var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2ShortOpenCustomHashMap(Short2ShortMap var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ShortOpenCustomHashMap(short[] var1, short[] var2, float var3, ShortHash.Strategy var4) {
   ...
   public Short2ShortOpenCustomHashMap(short[] var1, short[] var2, ShortHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Short2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Short2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2ShortOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Short2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2ShortOpenCustomHashMap clone() {
      Short2ShortOpenCustomHashMap var1;
      try {
         var1 = (Short2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      short[] var3 = this.value;
      Short2ShortOpenCustomHashMap.MapIterator var4 = new Short2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Short2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2ShortOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2ShortOpenCustomHashMap.this.size;
         Short2ShortOpenCustomHashMap.this.remove(var1);
         return Short2ShortOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Short2ShortOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                     return Short2ShortOpenCustomHashMap.this.containsNullKey && Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n] == var4;
                  } else {
                     short[] var6 = Short2ShortOpenCustomHashMap.this.key;
                     short var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Short2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Short2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Short2ShortOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Short2ShortOpenCustomHashMap.this.mask]) != 0) {
                           if (Short2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Short2ShortOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (Short2ShortOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                     if (Short2ShortOpenCustomHashMap.this.containsNullKey && Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Short2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Short2ShortOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Short2ShortOpenCustomHashMap.this.value[var7] == var4) {
                           Short2ShortOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Short2ShortOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Short2ShortOpenCustomHashMap.this.strategy.equals(var5, var3) || Short2ShortOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Short2ShortMap.Entry> var1) {
         if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2ShortMap.BasicEntry(Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.n], Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2ShortOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2ShortMap.BasicEntry(Short2ShortOpenCustomHashMap.this.key[var2], Short2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2ShortMap.Entry> var1) {
         ...
         if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.n];
            var2.value = Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Short2ShortOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Short2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Short2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Short2ShortMap.Entry> {
      private final Short2ShortOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Short2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2ShortOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Short2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Short2ShortOpenCustomHashMap.this.mask; !Short2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Short2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Short2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Short2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2ShortOpenCustomHashMap.this.value[var2] = Short2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2ShortMap.Entry, java.util.Map.Entry<Short, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Short2ShortOpenCustomHashMap.this.value[this.index];
         Short2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[this.index], (Short)var2.getKey()) && Short2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
