...
public class Short2CharArrayMap extends AbstractShort2CharMap implements Serializable, Cloneable {
   ...
   public Short2CharArrayMap(short[] var1, char[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Short2CharArrayMap(int var1) {
      super();
      this.key = new short[var1];
      this.value = new char[var1];
   }

   public Short2CharArrayMap(Short2CharMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Short2CharArrayMap(Map<? extends Short, ? extends Character> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Short2CharArrayMap(short[] var1, char[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ShortSet keySet() {
      return new AbstractShortSet() {
         public boolean contains(short var1) {
            return Short2CharArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(short var1) {
            int var2 = Short2CharArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Short2CharArrayMap.this.size - var2 - 1;
               System.arraycopy(Short2CharArrayMap.this.key, var2 + 1, Short2CharArrayMap.this.key, var2, var3);
               System.arraycopy(Short2CharArrayMap.this.value, var2 + 1, Short2CharArrayMap.this.value, var2, var3);
            ...
            return new ShortIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Short2CharArrayMap.this.size - this.pos;
                     System.arraycopy(Short2CharArrayMap.this.key, this.pos, Short2CharArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Short2CharArrayMap.this.value, this.pos, Short2CharArrayMap.this.value, this.pos - 1, var1);
                     Short2CharArrayMap.this.size--;
                  }
               }
            };
   ...
   public CharCollection values() {
      return new AbstractCharCollection() {
         public boolean contains(char var1) {
            return Short2CharArrayMap.this.containsValue(var1);
         }
   ...
   public Short2CharArrayMap clone() {
      Short2CharArrayMap var1;
      try {
         var1 = (Short2CharArrayMap)super.clone();
         ...
         return new ObjectIterator<Short2CharMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Short2CharArrayMap.this.size-- - this.next--;
                  System.arraycopy(Short2CharArrayMap.this.key, this.next + 1, Short2CharArrayMap.this.key, this.next, var1);
                  System.arraycopy(Short2CharArrayMap.this.value, this.next + 1, Short2CharArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  return Short2CharArrayMap.this.containsKey(var3) && Short2CharArrayMap.this.get(var3) == (Character)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  int var5 = Short2CharArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Short2CharArrayMap.this.value[var5]) {
                     int var6 = Short2CharArrayMap.this.size - var5 - 1;
                     System.arraycopy(Short2CharArrayMap.this.key, var5 + 1, Short2CharArrayMap.this.key, var5, var6);
                     System.arraycopy(Short2CharArrayMap.this.value, var5 + 1, Short2CharArrayMap.this.value, var5, var6);
                     Short2CharArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
