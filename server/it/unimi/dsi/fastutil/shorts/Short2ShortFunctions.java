...
public final class Short2ShortFunctions {
   ...
   public static Short2ShortFunction singleton(short var0, short var1) {
      return new Short2ShortFunctions.Singleton(var0, var1);
   }
   ...
   public static Short2ShortFunction synchronize(Short2ShortFunction var0) {
      return new Short2ShortFunctions.SynchronizedFunction(var0);
   }

   public static Short2ShortFunction synchronize(Short2ShortFunction var0, Object var1) {
      return new Short2ShortFunctions.SynchronizedFunction(var0, var1);
   }

   public static Short2ShortFunction unmodifiable(Short2ShortFunction var0) {
      return new Short2ShortFunctions.UnmodifiableFunction(var0);
   }

   public static Short2ShortFunction primitive(Function<? super Short, ? extends Short> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Short2ShortFunction) {
         return (Short2ShortFunction)var0;
      } else {
         return (Short2ShortFunction)(var0 instanceof IntUnaryOperator ? (var1) -> {
            return SafeMath.safeIntToShort(((IntUnaryOperator)var0).applyAsInt(var1));
         } : new Short2ShortFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class PrimitiveFunction implements Short2ShortFunction {
      ...
      protected PrimitiveFunction(Function<? super Short, ? extends Short> var1) {
         super();
         this.function = var1;
      }
      ...
      public Short get(Object var1) {
         return var1 == null ? null : (Short)this.function.apply((Short)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractShort2ShortFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Short2ShortFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Short2ShortFunction, Serializable {
      ...
      protected SynchronizedFunction(Short2ShortFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Short2ShortFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
