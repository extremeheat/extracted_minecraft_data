...
public class Short2ObjectOpenCustomHashMap<V> extends AbstractShort2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Short2ObjectOpenCustomHashMap(int var1, float var2, ShortHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Short2ObjectOpenCustomHashMap(int var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ObjectOpenCustomHashMap(ShortHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Short2ObjectOpenCustomHashMap(Map<? extends Short, ? extends V> var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2ObjectOpenCustomHashMap(Map<? extends Short, ? extends V> var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ObjectOpenCustomHashMap(Short2ObjectMap<V> var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2ObjectOpenCustomHashMap(Short2ObjectMap<V> var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2ObjectOpenCustomHashMap(short[] var1, V[] var2, float var3, ShortHash.Strategy var4) {
   ...
   public Short2ObjectOpenCustomHashMap(short[] var1, V[] var2, ShortHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Short2ObjectOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n]);
               }

               int var2 = Short2ObjectOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2ObjectOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Short2ObjectOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2ObjectOpenCustomHashMap<V> clone() {
      Short2ObjectOpenCustomHashMap var1;
      try {
         var1 = (Short2ObjectOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      Object[] var3 = this.value;
      Short2ObjectOpenCustomHashMap.MapIterator var4 = new Short2ObjectOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Short2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Short2ObjectOpenCustomHashMap.this.key[Short2ObjectOpenCustomHashMap.this.n]);
         }

         int var2 = Short2ObjectOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2ObjectOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2ObjectOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2ObjectOpenCustomHashMap.this.size;
         Short2ObjectOpenCustomHashMap.this.remove(var1);
         return Short2ObjectOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Short2ObjectOpenCustomHashMap<V>.MapIterator implements ShortIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               ...
               if (Short2ObjectOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                  return Short2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n], var4);
               } else {
                  short[] var6 = Short2ObjectOpenCustomHashMap.this.key;
                  short var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2ObjectOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Short2ObjectOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Objects.equals(Short2ObjectOpenCustomHashMap.this.value[var7], var4);
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Short2ObjectOpenCustomHashMap.this.mask]) != 0) {
                        if (Short2ObjectOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Objects.equals(Short2ObjectOpenCustomHashMap.this.value[var7], var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               ...
               Object var4 = var2.getValue();
               if (Short2ObjectOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                  if (Short2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n], var4)) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2ObjectOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Short2ObjectOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Objects.equals(Short2ObjectOpenCustomHashMap.this.value[var7], var4)) {
                        Short2ObjectOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Short2ObjectOpenCustomHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(!Short2ObjectOpenCustomHashMap.this.strategy.equals(var5, var3) || !Objects.equals(Short2ObjectOpenCustomHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Short2ObjectMap.Entry<V>> var1) {
         if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2ObjectMap.BasicEntry(Short2ObjectOpenCustomHashMap.this.key[Short2ObjectOpenCustomHashMap.this.n], Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2ObjectOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2ObjectMap.BasicEntry(Short2ObjectOpenCustomHashMap.this.key[var2], Short2ObjectOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2ObjectMap.Entry<V>> var1) {
         ...
         if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
            var2.key = Short2ObjectOpenCustomHashMap.this.key[Short2ObjectOpenCustomHashMap.this.n];
            var2.value = Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2ObjectOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Short2ObjectOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Short2ObjectOpenCustomHashMap.this.key[var3];
               var2.value = Short2ObjectOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Short2ObjectMap.Entry<V>> {
      private final Short2ObjectOpenCustomHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2ObjectOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Short2ObjectMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2ObjectOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(var2)) & Short2ObjectOpenCustomHashMap.this.mask; !Short2ObjectOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Short2ObjectOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2ObjectOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2ObjectOpenCustomHashMap.this.mask;

            short var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Short2ObjectOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Short2ObjectOpenCustomHashMap.this.strategy.hashCode(var4)) & Short2ObjectOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2ObjectOpenCustomHashMap.this.value[var2] = Short2ObjectOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2ObjectMap.Entry<V>, java.util.Map.Entry<Short, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Short2ObjectOpenCustomHashMap.this.value[this.index];
         Short2ObjectOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2ObjectOpenCustomHashMap.this.strategy.equals(Short2ObjectOpenCustomHashMap.this.key[this.index], (Short)var2.getKey()) && Objects.equals(Short2ObjectOpenCustomHashMap.this.value[this.index], var2.getValue());
         }
      }
