...
public class ShortArrayIndirectPriorityQueue implements ShortIndirectPriorityQueue {
   ...
   public ShortArrayIndirectPriorityQueue(short[] var1, int var2, ShortComparator var3) {
      super();
   ...
   public ShortArrayIndirectPriorityQueue(short[] var1, int var2) {
      this(var1, var2, (ShortComparator)null);
   }

   public ShortArrayIndirectPriorityQueue(short[] var1, ShortComparator var2) {
      this(var1, var1.length, var2);
   }

   public ShortArrayIndirectPriorityQueue(short[] var1) {
      this(var1, var1.length, (ShortComparator)null);
   }

   public ShortArrayIndirectPriorityQueue(short[] var1, int[] var2, int var3, ShortComparator var4) {
      this(var1, 0, var4);
      this.array = var2;
      this.size = var3;
   }
   ...
   public ShortArrayIndirectPriorityQueue(short[] var1, int[] var2, int var3) {
   ...
   private int findFirst() {
      if (this.firstIndexValid) {
         ...
         --var1;
         int var2 = var1;
         short var3 = this.refArray[this.array[var1]];
         if (this.c == null) {
            while(var1-- != 0) {
   ...
   public int front(int[] var1) {
      short var2 = this.refArray[this.array[this.findFirst()]];
      int var3 = this.size;
      int var4 = 0;
