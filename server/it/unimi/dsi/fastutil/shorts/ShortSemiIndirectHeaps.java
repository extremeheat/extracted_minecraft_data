...
public final class ShortSemiIndirectHeaps {
   ...
   public static int downHeap(short[] var0, int[] var1, int var2, int var3, ShortComparator var4) {
      assert var3 < var2;
   ...
   public static int upHeap(short[] var0, int[] var1, int var2, int var3, ShortComparator var4) {
      assert var3 < var2;
   ...
   public static int[] makeHeap(short[] var0, int var1, int var2, ShortComparator var3) {
      int[] var4 = var2 <= 0 ? IntArrays.EMPTY_ARRAY : new int[var2];
      makeHeap(var0, var1, var2, var4, var3);
      return var4;
   }

   public static void makeHeap(short[] var0, int[] var1, int var2, ShortComparator var3) {
      int var4 = var2 >>> 1;
   ...
   public static int front(short[] var0, int[] var1, int var2, int[] var3) {
      short var4 = var0[var1[0]];
      int var5 = 0;
      int var6 = 0;
      int var7 = 1;
      int var8 = 0;
   ...
   public static int front(short[] var0, int[] var1, int var2, int[] var3, ShortComparator var4) {
      short var5 = var0[var1[0]];
      int var6 = 0;
      int var7 = 0;
      int var8 = 1;
      int var9 = 0;
