...
public class Short2IntArrayMap extends AbstractShort2IntMap implements Serializable, Cloneable {
   ...
   public Short2IntArrayMap(short[] var1, int[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Short2IntArrayMap(int var1) {
      super();
      this.key = new short[var1];
      this.value = new int[var1];
   }

   public Short2IntArrayMap(Short2IntMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Short2IntArrayMap(Map<? extends Short, ? extends Integer> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Short2IntArrayMap(short[] var1, int[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Short2IntMap.FastEntrySet short2IntEntrySet() {
      return new Short2IntArrayMap.EntrySet();
   }
   ...
   public ShortSet keySet() {
      return new AbstractShortSet() {
         public boolean contains(short var1) {
            return Short2IntArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(short var1) {
            int var2 = Short2IntArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Short2IntArrayMap.this.size - var2 - 1;
               System.arraycopy(Short2IntArrayMap.this.key, var2 + 1, Short2IntArrayMap.this.key, var2, var3);
               System.arraycopy(Short2IntArrayMap.this.value, var2 + 1, Short2IntArrayMap.this.value, var2, var3);
            ...
            return new ShortIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Short2IntArrayMap.this.size - this.pos;
                     System.arraycopy(Short2IntArrayMap.this.key, this.pos, Short2IntArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Short2IntArrayMap.this.value, this.pos, Short2IntArrayMap.this.value, this.pos - 1, var1);
                     Short2IntArrayMap.this.size--;
                  }
               }
            };
   ...
   public IntCollection values() {
      return new AbstractIntCollection() {
         public boolean contains(int var1) {
            return Short2IntArrayMap.this.containsValue(var1);
         }
   ...
   public Short2IntArrayMap clone() {
      Short2IntArrayMap var1;
      try {
         var1 = (Short2IntArrayMap)super.clone();
         ...
         return new ObjectIterator<Short2IntMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Short2IntArrayMap.this.size-- - this.next--;
                  System.arraycopy(Short2IntArrayMap.this.key, this.next + 1, Short2IntArrayMap.this.key, this.next, var1);
                  System.arraycopy(Short2IntArrayMap.this.value, this.next + 1, Short2IntArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  return Short2IntArrayMap.this.containsKey(var3) && Short2IntArrayMap.this.get(var3) == (Integer)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var5 = Short2IntArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Short2IntArrayMap.this.value[var5]) {
                     int var6 = Short2IntArrayMap.this.size - var5 - 1;
                     System.arraycopy(Short2IntArrayMap.this.key, var5 + 1, Short2IntArrayMap.this.key, var5, var6);
                     System.arraycopy(Short2IntArrayMap.this.value, var5 + 1, Short2IntArrayMap.this.value, var5, var6);
                     Short2IntArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
