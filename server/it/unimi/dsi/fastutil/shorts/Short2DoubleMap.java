...
public interface Short2DoubleMap extends Short2DoubleFunction, Map<Short, Double> {
   ...
   default Double put(Short var1, Double var2) {
      return Short2DoubleFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double get(Object var1) {
      return Short2DoubleFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Double remove(Object var1) {
      return Short2DoubleFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Short2DoubleFunction.super.containsKey(var1);
   }
   ...
   default double getOrDefault(short var1, double var2) {
      double var4;
      return (var4 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var4;
   }

   default double putIfAbsent(short var1, double var2) {
   ...
   default boolean remove(short var1, double var2) {
      double var4 = this.get(var1);
   ...
   default boolean replace(short var1, double var2, double var4) {
   ...
   default double replace(short var1, double var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default double computeIfAbsent(short var1, IntToDoubleFunction var2) {
   ...
   default double computeIfAbsentNullable(short var1, IntFunction<? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
   ...
   default double computeIfAbsentPartial(short var1, Short2DoubleFunction var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default double computeIfPresent(short var1, BiFunction<? super Short, ? super Double, ? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default double compute(short var1, BiFunction<? super Short, ? super Double, ? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
   ...
   default double merge(short var1, double var2, BiFunction<? super Double, ? super Double, ? extends Double> var4) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Short var1, Double var2, Double var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Double computeIfAbsent(Short var1, Function<? super Short, ? extends Double> var2) {
   ...
   /** @deprecated */
   @Deprecated
   default Double merge(Short var1, Double var2, BiFunction<? super Double, ? super Double, ? extends Double> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Short2DoubleMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Short2DoubleMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
