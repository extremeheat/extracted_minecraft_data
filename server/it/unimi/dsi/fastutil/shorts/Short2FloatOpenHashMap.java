...
public class Short2FloatOpenHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Short2FloatOpenHashMap(int var1, float var2) {
      super();
   ...
   public Short2FloatOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Short2FloatOpenHashMap(Map<? extends Short, ? extends Float> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2FloatOpenHashMap(Map<? extends Short, ? extends Float> var1) {
      this(var1, 0.75F);
   }

   public Short2FloatOpenHashMap(Short2FloatMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2FloatOpenHashMap(Short2FloatMap var1) {
      this(var1, 0.75F);
   }

   public Short2FloatOpenHashMap(short[] var1, float[] var2, float var3) {
   ...
   public Short2FloatOpenHashMap(short[] var1, float[] var2) {
   ...
   public Short2FloatMap.FastEntrySet short2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Short2FloatOpenHashMap.MapEntrySet();
      }
   ...
   public ShortSet keySet() {
      if (this.keys == null) {
         this.keys = new Short2FloatOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            public FloatIterator iterator() {
               return Short2FloatOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(float var1) {
               return Short2FloatOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Short2FloatOpenHashMap.this.containsNullKey) {
                  var1.accept((double)Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]);
               }

               int var2 = Short2FloatOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2FloatOpenHashMap.this.key[var2] != 0) {
                     var1.accept((double)Short2FloatOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2FloatOpenHashMap clone() {
      Short2FloatOpenHashMap var1;
      try {
         var1 = (Short2FloatOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      float[] var3 = this.value;
      Short2FloatOpenHashMap.MapIterator var4 = new Short2FloatOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Short2FloatOpenHashMap.MapIterator implements FloatIterator {
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortIterator iterator() {
         return Short2FloatOpenHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Short2FloatOpenHashMap.this.containsNullKey) {
            var1.accept(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n]);
         }

         int var2 = Short2FloatOpenHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2FloatOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2FloatOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2FloatOpenHashMap.this.size;
         Short2FloatOpenHashMap.this.remove(var1);
         return Short2FloatOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Short2FloatOpenHashMap.MapIterator implements ShortIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
      ...
      public ObjectIterator<Short2FloatMap.Entry> iterator() {
         return Short2FloatOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Short2FloatMap.Entry> fastIterator() {
         return Short2FloatOpenHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (var3 == 0) {
                     return Short2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     short[] var6 = Short2FloatOpenHashMap.this.key;
                     short var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2FloatOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Float.floatToIntBits(Short2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Short2FloatOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Float.floatToIntBits(Short2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (var3 == 0) {
                     if (Short2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2FloatOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Float.floatToIntBits(Short2FloatOpenHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Short2FloatOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Short2FloatOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Float.floatToIntBits(Short2FloatOpenHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Short2FloatMap.Entry> var1) {
         if (Short2FloatOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n], Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2FloatOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatOpenHashMap.this.key[var2], Short2FloatOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2FloatMap.Entry> var1) {
         ...
         if (Short2FloatOpenHashMap.this.containsNullKey) {
            var2.key = Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n];
            var2.value = Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2FloatOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Short2FloatOpenHashMap.this.key[var3] != 0) {
               var2.key = Short2FloatOpenHashMap.this.key[var3];
               var2.value = Short2FloatOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2FloatOpenHashMap.MapIterator implements ObjectIterator<Short2FloatMap.Entry> {
      private final Short2FloatOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2FloatOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2FloatOpenHashMap.MapIterator implements ObjectIterator<Short2FloatMap.Entry> {
      ...
      public Short2FloatOpenHashMap.MapEntry next() {
         return this.entry = Short2FloatOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2FloatOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Short2FloatOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Short2FloatOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2FloatOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2FloatOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Short2FloatOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2FloatOpenHashMap.this.value[var2] = Short2FloatOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2FloatMap.Entry, java.util.Map.Entry<Short, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Short2FloatOpenHashMap.this.value[this.index];
         Short2FloatOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2FloatOpenHashMap.this.key[this.index] == (Short)var2.getKey() && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
