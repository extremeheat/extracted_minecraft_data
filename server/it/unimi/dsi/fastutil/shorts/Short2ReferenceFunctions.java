...
public final class Short2ReferenceFunctions {
   ...
   public static <V> Short2ReferenceFunction<V> singleton(short var0, V var1) {
      return new Short2ReferenceFunctions.Singleton(var0, var1);
   }
   ...
   public static <V> Short2ReferenceFunction<V> synchronize(Short2ReferenceFunction<V> var0) {
      return new Short2ReferenceFunctions.SynchronizedFunction(var0);
   }

   public static <V> Short2ReferenceFunction<V> synchronize(Short2ReferenceFunction<V> var0, Object var1) {
      return new Short2ReferenceFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Short2ReferenceFunction<V> unmodifiable(Short2ReferenceFunction<V> var0) {
      return new Short2ReferenceFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Short2ReferenceFunction<V> primitive(Function<? super Short, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Short2ReferenceFunction) {
         return (Short2ReferenceFunction)var0;
         ...
         return new Short2ReferenceFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class UnmodifiableFunction<V> extends AbstractShort2ReferenceFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Short2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Short2ReferenceFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Short2ReferenceFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Short2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
