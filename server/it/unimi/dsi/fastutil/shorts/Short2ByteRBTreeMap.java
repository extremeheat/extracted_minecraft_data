...
public class Short2ByteRBTreeMap extends AbstractShort2ByteSortedMap implements Serializable, Cloneable {
   protected transient Short2ByteRBTreeMap.Entry tree;
   protected int count;
   protected transient Short2ByteRBTreeMap.Entry firstEntry;
   protected transient Short2ByteRBTreeMap.Entry lastEntry;
   ...
   private transient Short2ByteRBTreeMap.Entry[] nodePath;
   ...
   public Short2ByteRBTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2ByteRBTreeMap(Map<? extends Short, ? extends Byte> var1) {
      this();
      this.putAll(var1);
   }

   public Short2ByteRBTreeMap(SortedMap<Short, Byte> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2ByteRBTreeMap(Short2ByteMap var1) {
      this();
      this.putAll(var1);
   }

   public Short2ByteRBTreeMap(Short2ByteSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2ByteRBTreeMap(short[] var1, byte[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2ByteRBTreeMap(short[] var1, byte[] var2) {
   ...
   final Short2ByteRBTreeMap.Entry findKey(short var1) {
      Short2ByteRBTreeMap.Entry var2;
      int var3;
   ...
   final Short2ByteRBTreeMap.Entry locateKey(short var1) {
      Short2ByteRBTreeMap.Entry var2 = this.tree;
      Short2ByteRBTreeMap.Entry var3 = this.tree;
   ...
   private void allocatePaths() {
      ...
      this.nodePath = new Short2ByteRBTreeMap.Entry[64];
   }

   public byte addTo(short var1, byte var2) {
      Short2ByteRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Short2ByteRBTreeMap.Entry add(short var1) {
      this.modified = false;
      int var2 = 0;
      Short2ByteRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Short2ByteRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Short2ByteRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Short2ByteRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Short2ByteRBTreeMap.Entry var7;
               Short2ByteRBTreeMap.Entry var8;
   ...
   public boolean containsValue(byte var1) {
      Short2ByteRBTreeMap.ValueIterator var2 = new Short2ByteRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public byte get(short var1) {
      Short2ByteRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>() {
            final Comparator<? super Short2ByteMap.Entry> comparator = (var1x, var2) -> {
               return Short2ByteRBTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator() {
               return Short2ByteRBTreeMap.this.new EntryIterator();
            }

            public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry var1) {
               return Short2ByteRBTreeMap.this.new EntryIterator(var1.getShortKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        Short2ByteRBTreeMap.Entry var3 = Short2ByteRBTreeMap.this.findKey((Short)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        ...
                        if (var3 != null && var3.getByteValue() == (Byte)var2.getValue()) {
                           Short2ByteRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry var1, Short2ByteMap.Entry var2) {
               return Short2ByteRBTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2ByteEntrySet();
            }

            public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry var1) {
               return Short2ByteRBTreeMap.this.headMap(var1.getShortKey()).short2ByteEntrySet();
            }

            public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry var1) {
               return Short2ByteRBTreeMap.this.tailMap(var1.getShortKey()).short2ByteEntrySet();
            }
         };
      }
   ...
   public ShortSortedSet keySet() {
      if (this.keys == null) {
         this.keys = new Short2ByteRBTreeMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            public ByteIterator iterator() {
               return Short2ByteRBTreeMap.this.new ValueIterator();
            }

            public boolean contains(byte var1) {
               return Short2ByteRBTreeMap.this.containsValue(var1);
            }
   ...
   public Short2ByteSortedMap headMap(short var1) {
      return new Short2ByteRBTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2ByteSortedMap tailMap(short var1) {
      return new Short2ByteRBTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2ByteSortedMap subMap(short var1, short var2) {
      return new Short2ByteRBTreeMap.Submap(var1, false, var2, false);
   }

   public Short2ByteRBTreeMap clone() {
      Short2ByteRBTreeMap var1;
      try {
         var1 = (Short2ByteRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2ByteRBTreeMap.Entry var5 = new Short2ByteRBTreeMap.Entry();
         Short2ByteRBTreeMap.Entry var6 = new Short2ByteRBTreeMap.Entry();
         Short2ByteRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2ByteRBTreeMap.Entry var4 = var6;
         var6.pred((Short2ByteRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2ByteRBTreeMap.EntryIterator var3 = new Short2ByteRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2ByteRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2ByteRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Short2ByteRBTreeMap.Entry var3, Short2ByteRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Short2ByteRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2ByteRBTreeMap.Entry(var1.readShort(), var1.readByte());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Short2ByteRBTreeMap.Entry(var1.readShort(), var1.readByte());
         var8.black(true);
         var8.right(new Short2ByteRBTreeMap.Entry(var1.readShort(), var1.readByte()));
         ...
         Short2ByteRBTreeMap.Entry var7 = new Short2ByteRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2ByteRBTreeMap.Entry)null, (Short2ByteRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2ByteSortedMap implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2ByteRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2ByteRBTreeMap.Submap.SubmapIterator var1 = new Short2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2ByteRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2ByteRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ShortSortedSet keySet() {
         if (this.keys == null) {
            this.keys = new Short2ByteRBTreeMap.Submap.KeySet();
         }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2ByteRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(byte var1) {
         Short2ByteRBTreeMap.Submap.SubmapIterator var2 = new Short2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      public byte get(short var1) {
         Short2ByteRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2ByteRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public byte put(short var1, byte var2) {
         ...
         if (!this.in(var1)) {
            ...
            byte var3 = Short2ByteRBTreeMap.this.put(var1, var2);
            return Short2ByteRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public byte remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            byte var2 = Short2ByteRBTreeMap.this.remove(var1);
            return Short2ByteRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public boolean isEmpty() {
         return !(new Short2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
      }
      ...
      public Short2ByteSortedMap headMap(short var1) {
         if (this.top) {
            return Short2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2ByteRBTreeMap.this.compare(var1, this.to) < 0 ? Short2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2ByteSortedMap tailMap(short var1) {
         if (this.bottom) {
            return Short2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? Short2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2ByteSortedMap subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2ByteRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2ByteRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2ByteRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2ByteRBTreeMap.Entry firstEntry() {
         if (Short2ByteRBTreeMap.this.tree == null) {
            ...
            Short2ByteRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2ByteRBTreeMap.this.firstEntry;
            } else {
               var1 = Short2ByteRBTreeMap.this.locateKey(this.from);
               if (Short2ByteRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2ByteRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2ByteRBTreeMap.Entry lastEntry() {
         if (Short2ByteRBTreeMap.this.tree == null) {
            ...
            Short2ByteRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2ByteRBTreeMap.this.lastEntry;
            } else {
               var1 = Short2ByteRBTreeMap.this.locateKey(this.to);
               if (Short2ByteRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2ByteRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2ByteRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2ByteRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private final class SubmapValueIterator extends Short2ByteRBTreeMap.Submap.SubmapIterator implements ByteListIterator {
      ...
      private final class SubmapKeyIterator extends Short2ByteRBTreeMap.Submap.SubmapIterator implements ShortListIterator {
      ...
      private class SubmapEntryIterator extends Short2ByteRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2ByteMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2ByteRBTreeMap.TreeIterator {
         SubmapIterator() {
            super();
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2ByteRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2ByteRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2ByteRBTreeMap.this.locateKey(var2);
                  if (Short2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private final class ValueIterator extends Short2ByteRBTreeMap.TreeIterator implements ByteListIterator {
   ...
   private class KeySet extends AbstractShort2ByteSortedMap.KeySet {
      ...
      public ShortBidirectionalIterator iterator() {
         return Short2ByteRBTreeMap.this.new KeyIterator();
      }

      public ShortBidirectionalIterator iterator(short var1) {
         return Short2ByteRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private final class KeyIterator extends Short2ByteRBTreeMap.TreeIterator implements ShortListIterator {
      public KeyIterator() {
         super();
      }
   ...
   private class EntryIterator extends Short2ByteRBTreeMap.TreeIterator implements ObjectListIterator<Short2ByteMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2ByteRBTreeMap.this.locateKey(var2)) != null) {
            if (Short2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractShort2ByteMap.BasicEntry implements Cloneable {
      ...
      Short2ByteRBTreeMap.Entry left;
      Short2ByteRBTreeMap.Entry right;
      int info;
      ...
      void pred(Short2ByteRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2ByteRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2ByteRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2ByteRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2ByteRBTreeMap.Entry next() {
         Short2ByteRBTreeMap.Entry var1 = this.right;
      ...
      Short2ByteRBTreeMap.Entry prev() {
         Short2ByteRBTreeMap.Entry var1 = this.left;
      ...
      public Short2ByteRBTreeMap.Entry clone() {
         Short2ByteRBTreeMap.Entry var1;
         try {
            var1 = (Short2ByteRBTreeMap.Entry)super.clone();
