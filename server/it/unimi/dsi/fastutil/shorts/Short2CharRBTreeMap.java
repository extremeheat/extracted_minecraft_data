...
public class Short2CharRBTreeMap extends AbstractShort2CharSortedMap implements Serializable, Cloneable {
   ...
   public Short2CharRBTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2CharRBTreeMap(Map<? extends Short, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Short2CharRBTreeMap(SortedMap<Short, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2CharRBTreeMap(Short2CharMap var1) {
      this();
      this.putAll(var1);
   }

   public Short2CharRBTreeMap(Short2CharSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2CharRBTreeMap(short[] var1, char[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2CharRBTreeMap(short[] var1, char[] var2) {
   ...
   final Short2CharRBTreeMap.Entry findKey(short var1) {
      Short2CharRBTreeMap.Entry var2;
      int var3;
   ...
   final Short2CharRBTreeMap.Entry locateKey(short var1) {
      Short2CharRBTreeMap.Entry var2 = this.tree;
      Short2CharRBTreeMap.Entry var3 = this.tree;
   ...
   public char addTo(short var1, char var2) {
      Short2CharRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Short2CharRBTreeMap.Entry add(short var1) {
      this.modified = false;
      int var2 = 0;
      Short2CharRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Short2CharRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Short2CharRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Short2CharRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Short2CharRBTreeMap.Entry var7;
               Short2CharRBTreeMap.Entry var8;
   ...
   public boolean containsValue(char var1) {
      Short2CharRBTreeMap.ValueIterator var2 = new Short2CharRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char get(short var1) {
      Short2CharRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
            final Comparator<? super Short2CharMap.Entry> comparator = (var1x, var2) -> {
               return Short2CharRBTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry var1) {
               return Short2CharRBTreeMap.this.new EntryIterator(var1.getShortKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        Short2CharRBTreeMap.Entry var3 = Short2CharRBTreeMap.this.findKey((Short)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        ...
                        if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                           Short2CharRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry var1, Short2CharMap.Entry var2) {
               return Short2CharRBTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2CharEntrySet();
            }

            public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry var1) {
               return Short2CharRBTreeMap.this.headMap(var1.getShortKey()).short2CharEntrySet();
            }

            public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry var1) {
               return Short2CharRBTreeMap.this.tailMap(var1.getShortKey()).short2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Short2CharRBTreeMap.this.containsValue(var1);
            }
   ...
   public Short2CharSortedMap headMap(short var1) {
      return new Short2CharRBTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2CharSortedMap tailMap(short var1) {
      return new Short2CharRBTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2CharSortedMap subMap(short var1, short var2) {
      return new Short2CharRBTreeMap.Submap(var1, false, var2, false);
   }

   public Short2CharRBTreeMap clone() {
      Short2CharRBTreeMap var1;
      try {
         var1 = (Short2CharRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2CharRBTreeMap.Entry var5 = new Short2CharRBTreeMap.Entry();
         Short2CharRBTreeMap.Entry var6 = new Short2CharRBTreeMap.Entry();
         Short2CharRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2CharRBTreeMap.Entry var4 = var6;
         var6.pred((Short2CharRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2CharRBTreeMap.EntryIterator var3 = new Short2CharRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2CharRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2CharRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Short2CharRBTreeMap.Entry var3, Short2CharRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Short2CharRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2CharRBTreeMap.Entry(var1.readShort(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Short2CharRBTreeMap.Entry(var1.readShort(), var1.readChar());
         var8.black(true);
         var8.right(new Short2CharRBTreeMap.Entry(var1.readShort(), var1.readChar()));
         ...
         Short2CharRBTreeMap.Entry var7 = new Short2CharRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2CharRBTreeMap.Entry)null, (Short2CharRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2CharSortedMap implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2CharRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2CharRBTreeMap.Submap.SubmapIterator var1 = new Short2CharRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2CharRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2CharRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2CharRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Short2CharRBTreeMap.Submap.SubmapIterator var2 = new Short2CharRBTreeMap.Submap.SubmapIterator();
      ...
      public char get(short var1) {
         Short2CharRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2CharRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public char put(short var1, char var2) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Short2CharRBTreeMap.this.put(var1, var2);
            return Short2CharRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public char remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var2 = Short2CharRBTreeMap.this.remove(var1);
            return Short2CharRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Short2CharSortedMap headMap(short var1) {
         if (this.top) {
            return Short2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2CharRBTreeMap.this.compare(var1, this.to) < 0 ? Short2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2CharSortedMap tailMap(short var1) {
         if (this.bottom) {
            return Short2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2CharRBTreeMap.this.compare(var1, this.from) > 0 ? Short2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2CharSortedMap subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2CharRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2CharRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2CharRBTreeMap.Entry firstEntry() {
         if (Short2CharRBTreeMap.this.tree == null) {
            ...
            Short2CharRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2CharRBTreeMap.this.firstEntry;
            } else {
               var1 = Short2CharRBTreeMap.this.locateKey(this.from);
               if (Short2CharRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2CharRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2CharRBTreeMap.Entry lastEntry() {
         if (Short2CharRBTreeMap.this.tree == null) {
            ...
            Short2CharRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2CharRBTreeMap.this.lastEntry;
            } else {
               var1 = Short2CharRBTreeMap.this.locateKey(this.to);
               if (Short2CharRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2CharRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2CharRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2CharRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Short2CharRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2CharMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2CharRBTreeMap.TreeIterator {
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2CharRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2CharRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2CharRBTreeMap.this.locateKey(var2);
                  if (Short2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractShort2CharSortedMap.KeySet {
      ...
      public ShortBidirectionalIterator iterator(short var1) {
         return Short2CharRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Short2CharRBTreeMap.TreeIterator implements ObjectListIterator<Short2CharMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2CharRBTreeMap.this.locateKey(var2)) != null) {
            if (Short2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractShort2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Short2CharRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2CharRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2CharRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2CharRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2CharRBTreeMap.Entry next() {
         Short2CharRBTreeMap.Entry var1 = this.right;
      ...
      Short2CharRBTreeMap.Entry prev() {
         Short2CharRBTreeMap.Entry var1 = this.left;
      ...
      public Short2CharRBTreeMap.Entry clone() {
         Short2CharRBTreeMap.Entry var1;
         try {
            var1 = (Short2CharRBTreeMap.Entry)super.clone();
