...
public class Short2ReferenceOpenHashMap<V> extends AbstractShort2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Short2ReferenceOpenHashMap(int var1, float var2) {
      super();
   ...
   public Short2ReferenceOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Short2ReferenceOpenHashMap(Map<? extends Short, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2ReferenceOpenHashMap(Map<? extends Short, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Short2ReferenceOpenHashMap(Short2ReferenceMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2ReferenceOpenHashMap(Short2ReferenceMap<V> var1) {
      this(var1, 0.75F);
   }

   public Short2ReferenceOpenHashMap(short[] var1, V[] var2, float var3) {
   ...
   public Short2ReferenceOpenHashMap(short[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Short2ReferenceOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Short2ReferenceOpenHashMap.this.containsNullKey) {
                  var1.accept(Short2ReferenceOpenHashMap.this.value[Short2ReferenceOpenHashMap.this.n]);
               }

               int var2 = Short2ReferenceOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2ReferenceOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Short2ReferenceOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2ReferenceOpenHashMap<V> clone() {
      Short2ReferenceOpenHashMap var1;
      try {
         var1 = (Short2ReferenceOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      Object[] var3 = this.value;
      Short2ReferenceOpenHashMap.MapIterator var4 = new Short2ReferenceOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(Short2ReferenceOpenHashMap.this.key[Short2ReferenceOpenHashMap.this.n]);
         }

         int var2 = Short2ReferenceOpenHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2ReferenceOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2ReferenceOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2ReferenceOpenHashMap.this.size;
         Short2ReferenceOpenHashMap.this.remove(var1);
         return Short2ReferenceOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               ...
               if (var3 == 0) {
                  return Short2ReferenceOpenHashMap.this.containsNullKey && Short2ReferenceOpenHashMap.this.value[Short2ReferenceOpenHashMap.this.n] == var4;
               } else {
                  short[] var6 = Short2ReferenceOpenHashMap.this.key;
                  short var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2ReferenceOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (var3 == var5) {
                     return Short2ReferenceOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Short2ReferenceOpenHashMap.this.mask]) != 0) {
                        if (var3 == var5) {
                           return Short2ReferenceOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               ...
               Object var4 = var2.getValue();
               if (var3 == 0) {
                  if (Short2ReferenceOpenHashMap.this.containsNullKey && Short2ReferenceOpenHashMap.this.value[Short2ReferenceOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2ReferenceOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Short2ReferenceOpenHashMap.this.value[var7] == var4) {
                        Short2ReferenceOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Short2ReferenceOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(var5 != var3 || Short2ReferenceOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> var1) {
         if (Short2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2ReferenceMap.BasicEntry(Short2ReferenceOpenHashMap.this.key[Short2ReferenceOpenHashMap.this.n], Short2ReferenceOpenHashMap.this.value[Short2ReferenceOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2ReferenceOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2ReferenceMap.BasicEntry(Short2ReferenceOpenHashMap.this.key[var2], Short2ReferenceOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2ReferenceMap.Entry<V>> var1) {
         ...
         if (Short2ReferenceOpenHashMap.this.containsNullKey) {
            var2.key = Short2ReferenceOpenHashMap.this.key[Short2ReferenceOpenHashMap.this.n];
            var2.value = Short2ReferenceOpenHashMap.this.value[Short2ReferenceOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2ReferenceOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Short2ReferenceOpenHashMap.this.key[var3] != 0) {
               var2.key = Short2ReferenceOpenHashMap.this.key[var3];
               var2.value = Short2ReferenceOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Short2ReferenceMap.Entry<V>> {
      ...
      private FastEntryIterator() {
         super(null);
         this.entry = Short2ReferenceOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Short2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2ReferenceOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Short2ReferenceOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Short2ReferenceOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2ReferenceOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2ReferenceOpenHashMap.this.mask;

            short var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Short2ReferenceOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4) & Short2ReferenceOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2ReferenceOpenHashMap.this.value[var2] = Short2ReferenceOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2ReferenceMap.Entry<V>, java.util.Map.Entry<Short, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Short2ReferenceOpenHashMap.this.value[this.index];
         Short2ReferenceOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2ReferenceOpenHashMap.this.key[this.index] == (Short)var2.getKey() && Short2ReferenceOpenHashMap.this.value[this.index] == var2.getValue();
         }
      }
