...
public class Short2ObjectArrayMap<V> extends AbstractShort2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Short2ObjectArrayMap(short[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Short2ObjectArrayMap(int var1) {
      super();
      this.key = new short[var1];
      this.value = new Object[var1];
   }

   public Short2ObjectArrayMap(Short2ObjectMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Short2ObjectArrayMap(Map<? extends Short, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Short2ObjectArrayMap(short[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ShortSet keySet() {
      return new AbstractShortSet() {
         public boolean contains(short var1) {
            return Short2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(short var1) {
            int var2 = Short2ObjectArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Short2ObjectArrayMap.this.size - var2 - 1;
               System.arraycopy(Short2ObjectArrayMap.this.key, var2 + 1, Short2ObjectArrayMap.this.key, var2, var3);
               System.arraycopy(Short2ObjectArrayMap.this.value, var2 + 1, Short2ObjectArrayMap.this.value, var2, var3);
            ...
            return new ShortIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Short2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Short2ObjectArrayMap.this.key, this.pos, Short2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Short2ObjectArrayMap.this.value, this.pos, Short2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Short2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Short2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Short2ObjectArrayMap<V> clone() {
      Short2ObjectArrayMap var1;
      try {
         var1 = (Short2ObjectArrayMap)super.clone();
         ...
         return new ObjectIterator<Short2ObjectMap.Entry<V>>() {
            ...
            public Short2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractShort2ObjectMap.BasicEntry(Short2ObjectArrayMap.this.key[this.curr = this.next], Short2ObjectArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Short2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Short2ObjectArrayMap.this.key, this.next + 1, Short2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Short2ObjectArrayMap.this.value, this.next + 1, Short2ObjectArrayMap.this.value, this.next, var1);
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               ...
               return Short2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Short2ObjectArrayMap.this.get(var3), var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               ...
               int var5 = Short2ObjectArrayMap.this.findKey(var3);
               if (var5 != -1 && Objects.equals(var4, Short2ObjectArrayMap.this.value[var5])) {
                  int var6 = Short2ObjectArrayMap.this.size - var5 - 1;
                  System.arraycopy(Short2ObjectArrayMap.this.key, var5 + 1, Short2ObjectArrayMap.this.key, var5, var6);
                  System.arraycopy(Short2ObjectArrayMap.this.value, var5 + 1, Short2ObjectArrayMap.this.value, var5, var6);
                  Short2ObjectArrayMap.this.size--;
                  Short2ObjectArrayMap.this.value[Short2ObjectArrayMap.this.size] = null;
                  return true;
               } else {
