...
public class Short2FloatAVLTreeMap extends AbstractShort2FloatSortedMap implements Serializable, Cloneable {
   ...
   public Short2FloatAVLTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2FloatAVLTreeMap(Map<? extends Short, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Short2FloatAVLTreeMap(SortedMap<Short, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2FloatAVLTreeMap(Short2FloatMap var1) {
      this();
      this.putAll(var1);
   }

   public Short2FloatAVLTreeMap(Short2FloatSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2FloatAVLTreeMap(short[] var1, float[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2FloatAVLTreeMap(short[] var1, float[] var2) {
   ...
   final Short2FloatAVLTreeMap.Entry findKey(short var1) {
      Short2FloatAVLTreeMap.Entry var2;
      int var3;
   ...
   final Short2FloatAVLTreeMap.Entry locateKey(short var1) {
      Short2FloatAVLTreeMap.Entry var2 = this.tree;
      Short2FloatAVLTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(short var1, float var2) {
      Short2FloatAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Short2FloatAVLTreeMap.Entry add(short var1) {
      this.modified = false;
      Short2FloatAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Short2FloatAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Short2FloatAVLTreeMap.Entry var3 = this.tree;
         Short2FloatAVLTreeMap.Entry var4 = null;
         Short2FloatAVLTreeMap.Entry var5 = this.tree;
         Short2FloatAVLTreeMap.Entry var6 = null;
         Short2FloatAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Short2FloatAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Short2FloatAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Short2FloatAVLTreeMap.Entry parent(Short2FloatAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Short2FloatAVLTreeMap.Entry var3 = var1;

         Short2FloatAVLTreeMap.Entry var2;
         Short2FloatAVLTreeMap.Entry var4;
   ...
   public float remove(short var1) {
      ...
      if (this.tree == null) {
         ...
         Short2FloatAVLTreeMap.Entry var7;
         Short2FloatAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Short2FloatAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(float var1) {
      Short2FloatAVLTreeMap.ValueIterator var2 = new Short2FloatAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float get(short var1) {
      Short2FloatAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
            final Comparator<? super Short2FloatMap.Entry> comparator = (var1x, var2) -> {
               return Short2FloatAVLTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry var1) {
               return Short2FloatAVLTreeMap.this.new EntryIterator(var1.getShortKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        Short2FloatAVLTreeMap.Entry var3 = Short2FloatAVLTreeMap.this.findKey((Short)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                           Short2FloatAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry var1, Short2FloatMap.Entry var2) {
               return Short2FloatAVLTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2FloatEntrySet();
            }

            public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry var1) {
               return Short2FloatAVLTreeMap.this.headMap(var1.getShortKey()).short2FloatEntrySet();
            }

            public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry var1) {
               return Short2FloatAVLTreeMap.this.tailMap(var1.getShortKey()).short2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Short2FloatAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Short2FloatSortedMap headMap(short var1) {
      return new Short2FloatAVLTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2FloatSortedMap tailMap(short var1) {
      return new Short2FloatAVLTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2FloatSortedMap subMap(short var1, short var2) {
      return new Short2FloatAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Short2FloatAVLTreeMap clone() {
      Short2FloatAVLTreeMap var1;
      try {
         var1 = (Short2FloatAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2FloatAVLTreeMap.Entry var5 = new Short2FloatAVLTreeMap.Entry();
         Short2FloatAVLTreeMap.Entry var6 = new Short2FloatAVLTreeMap.Entry();
         Short2FloatAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2FloatAVLTreeMap.Entry var4 = var6;
         var6.pred((Short2FloatAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2FloatAVLTreeMap.EntryIterator var3 = new Short2FloatAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2FloatAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2FloatAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Short2FloatAVLTreeMap.Entry var3, Short2FloatAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Short2FloatAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2FloatAVLTreeMap.Entry(var1.readShort(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Short2FloatAVLTreeMap.Entry(var1.readShort(), var1.readFloat());
         var8.right(new Short2FloatAVLTreeMap.Entry(var1.readShort(), var1.readFloat()));
         ...
         Short2FloatAVLTreeMap.Entry var7 = new Short2FloatAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2FloatAVLTreeMap.Entry)null, (Short2FloatAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2FloatSortedMap implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2FloatAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2FloatAVLTreeMap.Submap.SubmapIterator var1 = new Short2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2FloatAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2FloatAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2FloatAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Short2FloatAVLTreeMap.Submap.SubmapIterator var2 = new Short2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      public float get(short var1) {
         Short2FloatAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2FloatAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(short var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Short2FloatAVLTreeMap.this.put(var1, var2);
            return Short2FloatAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Short2FloatAVLTreeMap.this.remove(var1);
            return Short2FloatAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Short2FloatSortedMap headMap(short var1) {
         if (this.top) {
            return Short2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2FloatAVLTreeMap.this.compare(var1, this.to) < 0 ? Short2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2FloatSortedMap tailMap(short var1) {
         if (this.bottom) {
            return Short2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? Short2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2FloatSortedMap subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2FloatAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2FloatAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2FloatAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2FloatAVLTreeMap.Entry firstEntry() {
         if (Short2FloatAVLTreeMap.this.tree == null) {
            ...
            Short2FloatAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2FloatAVLTreeMap.this.firstEntry;
            } else {
               var1 = Short2FloatAVLTreeMap.this.locateKey(this.from);
               if (Short2FloatAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2FloatAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2FloatAVLTreeMap.Entry lastEntry() {
         if (Short2FloatAVLTreeMap.this.tree == null) {
            ...
            Short2FloatAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2FloatAVLTreeMap.this.lastEntry;
            } else {
               var1 = Short2FloatAVLTreeMap.this.locateKey(this.to);
               if (Short2FloatAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2FloatAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2FloatAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2FloatAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Short2FloatAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2FloatMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2FloatAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2FloatAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2FloatAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2FloatAVLTreeMap.this.locateKey(var2);
                  if (Short2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractShort2FloatSortedMap.KeySet {
      ...
      public ShortBidirectionalIterator iterator(short var1) {
         return Short2FloatAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Short2FloatAVLTreeMap.TreeIterator implements ObjectListIterator<Short2FloatMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Short2FloatMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Short2FloatMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2FloatAVLTreeMap.this.locateKey(var2)) != null) {
            if (Short2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractShort2FloatMap.BasicEntry implements Cloneable {
      ...
      void pred(Short2FloatAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2FloatAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2FloatAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2FloatAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2FloatAVLTreeMap.Entry next() {
         Short2FloatAVLTreeMap.Entry var1 = this.right;
      ...
      Short2FloatAVLTreeMap.Entry prev() {
         Short2FloatAVLTreeMap.Entry var1 = this.left;
      ...
      public Short2FloatAVLTreeMap.Entry clone() {
         Short2FloatAVLTreeMap.Entry var1;
         try {
            var1 = (Short2FloatAVLTreeMap.Entry)super.clone();
