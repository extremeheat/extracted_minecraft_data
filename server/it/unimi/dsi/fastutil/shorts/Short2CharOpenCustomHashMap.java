...
public class Short2CharOpenCustomHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Short2CharOpenCustomHashMap(int var1, float var2, ShortHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Short2CharOpenCustomHashMap(int var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2CharOpenCustomHashMap(ShortHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Short2CharOpenCustomHashMap(Map<? extends Short, ? extends Character> var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2CharOpenCustomHashMap(Map<? extends Short, ? extends Character> var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2CharOpenCustomHashMap(Short2CharMap var1, float var2, ShortHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Short2CharOpenCustomHashMap(Short2CharMap var1, ShortHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Short2CharOpenCustomHashMap(short[] var1, char[] var2, float var3, ShortHash.Strategy var4) {
   ...
   public Short2CharOpenCustomHashMap(short[] var1, char[] var2, ShortHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Short2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Short2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2CharOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Short2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2CharOpenCustomHashMap clone() {
      Short2CharOpenCustomHashMap var1;
      try {
         var1 = (Short2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      char[] var3 = this.value;
      Short2CharOpenCustomHashMap.MapIterator var4 = new Short2CharOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Short2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2CharOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2CharOpenCustomHashMap.this.size;
         Short2CharOpenCustomHashMap.this.remove(var1);
         return Short2CharOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Short2CharOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                     return Short2CharOpenCustomHashMap.this.containsNullKey && Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n] == var4;
                  } else {
                     short[] var6 = Short2CharOpenCustomHashMap.this.key;
                     short var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Short2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Short2CharOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Short2CharOpenCustomHashMap.this.mask]) != 0) {
                           if (Short2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Short2CharOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (Short2CharOpenCustomHashMap.this.strategy.equals(var3, (short)0)) {
                     if (Short2CharOpenCustomHashMap.this.containsNullKey && Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Short2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Short2CharOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Short2CharOpenCustomHashMap.this.value[var7] == var4) {
                           Short2CharOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Short2CharOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Short2CharOpenCustomHashMap.this.strategy.equals(var5, var3) || Short2CharOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Short2CharMap.Entry> var1) {
         if (Short2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2CharMap.BasicEntry(Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.n], Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2CharOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2CharMap.BasicEntry(Short2CharOpenCustomHashMap.this.key[var2], Short2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2CharMap.Entry> var1) {
         ...
         if (Short2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.n];
            var2.value = Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Short2CharOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Short2CharOpenCustomHashMap.this.key[var3];
               var2.value = Short2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Short2CharMap.Entry> {
      private final Short2CharOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Short2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2CharOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Short2CharOpenCustomHashMap.this.mask; !Short2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Short2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Short2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2CharOpenCustomHashMap.this.value[var2] = Short2CharOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2CharMap.Entry, java.util.Map.Entry<Short, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Short2CharOpenCustomHashMap.this.value[this.index];
         Short2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[this.index], (Short)var2.getKey()) && Short2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
