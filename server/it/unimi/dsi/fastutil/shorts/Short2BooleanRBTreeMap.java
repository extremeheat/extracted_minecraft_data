...
public class Short2BooleanRBTreeMap extends AbstractShort2BooleanSortedMap implements Serializable, Cloneable {
   ...
   public Short2BooleanRBTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2BooleanRBTreeMap(Map<? extends Short, ? extends Boolean> var1) {
      this();
      this.putAll(var1);
   }

   public Short2BooleanRBTreeMap(SortedMap<Short, Boolean> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2BooleanRBTreeMap(Short2BooleanMap var1) {
      this();
      this.putAll(var1);
   }

   public Short2BooleanRBTreeMap(Short2BooleanSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2BooleanRBTreeMap(short[] var1, boolean[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2BooleanRBTreeMap(short[] var1, boolean[] var2) {
   ...
   final Short2BooleanRBTreeMap.Entry findKey(short var1) {
      Short2BooleanRBTreeMap.Entry var2;
      int var3;
   ...
   final Short2BooleanRBTreeMap.Entry locateKey(short var1) {
      Short2BooleanRBTreeMap.Entry var2 = this.tree;
      Short2BooleanRBTreeMap.Entry var3 = this.tree;
   ...
   public boolean put(short var1, boolean var2) {
      Short2BooleanRBTreeMap.Entry var3 = this.add(var1);
      boolean var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Short2BooleanRBTreeMap.Entry add(short var1) {
      this.modified = false;
      int var2 = 0;
      Short2BooleanRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Short2BooleanRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Short2BooleanRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Short2BooleanRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Short2BooleanRBTreeMap.Entry var7;
               Short2BooleanRBTreeMap.Entry var8;
   ...
   public boolean containsValue(boolean var1) {
      Short2BooleanRBTreeMap.ValueIterator var2 = new Short2BooleanRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public boolean get(short var1) {
      Short2BooleanRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
            final Comparator<? super Short2BooleanMap.Entry> comparator = (var1x, var2) -> {
               return Short2BooleanRBTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry var1) {
               return Short2BooleanRBTreeMap.this.new EntryIterator(var1.getShortKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        Short2BooleanRBTreeMap.Entry var3 = Short2BooleanRBTreeMap.this.findKey((Short)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        ...
                        if (var3 != null && var3.getBooleanValue() == (Boolean)var2.getValue()) {
                           Short2BooleanRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry var1, Short2BooleanMap.Entry var2) {
               return Short2BooleanRBTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2BooleanEntrySet();
            }

            public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry var1) {
               return Short2BooleanRBTreeMap.this.headMap(var1.getShortKey()).short2BooleanEntrySet();
            }

            public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry var1) {
               return Short2BooleanRBTreeMap.this.tailMap(var1.getShortKey()).short2BooleanEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Short2BooleanRBTreeMap.this.containsValue(var1);
            }
   ...
   public Short2BooleanSortedMap headMap(short var1) {
      return new Short2BooleanRBTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2BooleanSortedMap tailMap(short var1) {
      return new Short2BooleanRBTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2BooleanSortedMap subMap(short var1, short var2) {
      return new Short2BooleanRBTreeMap.Submap(var1, false, var2, false);
   }

   public Short2BooleanRBTreeMap clone() {
      Short2BooleanRBTreeMap var1;
      try {
         var1 = (Short2BooleanRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2BooleanRBTreeMap.Entry var5 = new Short2BooleanRBTreeMap.Entry();
         Short2BooleanRBTreeMap.Entry var6 = new Short2BooleanRBTreeMap.Entry();
         Short2BooleanRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2BooleanRBTreeMap.Entry var4 = var6;
         var6.pred((Short2BooleanRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2BooleanRBTreeMap.EntryIterator var3 = new Short2BooleanRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2BooleanRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2BooleanRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Short2BooleanRBTreeMap.Entry var3, Short2BooleanRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Short2BooleanRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2BooleanRBTreeMap.Entry(var1.readShort(), var1.readBoolean());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Short2BooleanRBTreeMap.Entry(var1.readShort(), var1.readBoolean());
         var8.black(true);
         var8.right(new Short2BooleanRBTreeMap.Entry(var1.readShort(), var1.readBoolean()));
         ...
         Short2BooleanRBTreeMap.Entry var7 = new Short2BooleanRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2BooleanRBTreeMap.Entry)null, (Short2BooleanRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2BooleanSortedMap implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2BooleanRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2BooleanRBTreeMap.Submap.SubmapIterator var1 = new Short2BooleanRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2BooleanRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2BooleanRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2BooleanRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(boolean var1) {
         Short2BooleanRBTreeMap.Submap.SubmapIterator var2 = new Short2BooleanRBTreeMap.Submap.SubmapIterator();
      ...
      public boolean get(short var1) {
         Short2BooleanRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2BooleanRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public boolean put(short var1, boolean var2) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var3 = Short2BooleanRBTreeMap.this.put(var1, var2);
            return Short2BooleanRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public boolean remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var2 = Short2BooleanRBTreeMap.this.remove(var1);
            return Short2BooleanRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Short2BooleanSortedMap headMap(short var1) {
         if (this.top) {
            return Short2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2BooleanRBTreeMap.this.compare(var1, this.to) < 0 ? Short2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2BooleanSortedMap tailMap(short var1) {
         if (this.bottom) {
            return Short2BooleanRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2BooleanRBTreeMap.this.compare(var1, this.from) > 0 ? Short2BooleanRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2BooleanSortedMap subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2BooleanRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2BooleanRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2BooleanRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2BooleanRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2BooleanRBTreeMap.Entry firstEntry() {
         if (Short2BooleanRBTreeMap.this.tree == null) {
            ...
            Short2BooleanRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2BooleanRBTreeMap.this.firstEntry;
            } else {
               var1 = Short2BooleanRBTreeMap.this.locateKey(this.from);
               if (Short2BooleanRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2BooleanRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2BooleanRBTreeMap.Entry lastEntry() {
         if (Short2BooleanRBTreeMap.this.tree == null) {
            ...
            Short2BooleanRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2BooleanRBTreeMap.this.lastEntry;
            } else {
               var1 = Short2BooleanRBTreeMap.this.locateKey(this.to);
               if (Short2BooleanRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2BooleanRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2BooleanRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2BooleanRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Short2BooleanRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2BooleanMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2BooleanRBTreeMap.TreeIterator {
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2BooleanRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2BooleanRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2BooleanRBTreeMap.this.locateKey(var2);
                  if (Short2BooleanRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractShort2BooleanSortedMap.KeySet {
      ...
      public ShortBidirectionalIterator iterator(short var1) {
         return Short2BooleanRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Short2BooleanRBTreeMap.TreeIterator implements ObjectListIterator<Short2BooleanMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2BooleanRBTreeMap.this.locateKey(var2)) != null) {
            if (Short2BooleanRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractShort2BooleanMap.BasicEntry implements Cloneable {
      ...
      void pred(Short2BooleanRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2BooleanRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2BooleanRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2BooleanRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2BooleanRBTreeMap.Entry next() {
         Short2BooleanRBTreeMap.Entry var1 = this.right;
      ...
      Short2BooleanRBTreeMap.Entry prev() {
         Short2BooleanRBTreeMap.Entry var1 = this.left;
      ...
      public Short2BooleanRBTreeMap.Entry clone() {
         Short2BooleanRBTreeMap.Entry var1;
         try {
            var1 = (Short2BooleanRBTreeMap.Entry)super.clone();
