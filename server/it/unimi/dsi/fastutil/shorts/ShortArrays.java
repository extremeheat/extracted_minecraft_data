...
public final class ShortArrays {
   ...
   public static final Hash.Strategy<short[]> HASH_STRATEGY = new ShortArrays.ArrayHashStrategy();

   private ShortArrays() {
      super();
   }

   public static short[] forceCapacity(short[] var0, int var1, int var2) {
      short[] var3 = new short[var1];
      System.arraycopy(var0, 0, var3, 0, var2);
      return var3;
   }

   public static short[] ensureCapacity(short[] var0, int var1) {
   ...
   public static short[] grow(short[] var0, int var1) {
      return grow(var0, var1, var0.length);
   }

   public static short[] grow(short[] var0, int var1, int var2) {
      if (var1 > var0.length) {
   ...
   public static short[] trim(short[] var0, int var1) {
      if (var1 >= var0.length) {
         return var0;
      } else {
         short[] var2 = var1 == 0 ? EMPTY_ARRAY : new short[var1];
         System.arraycopy(var0, 0, var2, 0, var1);
         return var2;
      }
   }

   public static short[] setLength(short[] var0, int var1) {
      if (var1 == var0.length) {
         return var0;
      } else {
   ...
   public static short[] copy(short[] var0, int var1, int var2) {
      ensureOffsetLength(var0, var1, var2);
      short[] var3 = var2 == 0 ? EMPTY_ARRAY : new short[var2];
      System.arraycopy(var0, var1, var3, 0, var2);
      return var3;
   }

   public static short[] copy(short[] var0) {
      return (short[])var0.clone();
   }
   ...
   public static void ensureFromTo(short[] var0, int var1, int var2) {
      Arrays.ensureFromTo(var0.length, var1, var2);
   }

   public static void ensureOffsetLength(short[] var0, int var1, int var2) {
      Arrays.ensureOffsetLength(var0.length, var1, var2);
   }

   public static void ensureSameLength(short[] var0, short[] var1) {
   ...
   private static int med3(short[] var0, int var1, int var2, int var3, ShortComparator var4) {
   ...
   private static void selectionSort(short[] var0, int var1, int var2, ShortComparator var3) {
   ...
   private static void insertionSort(short[] var0, int var1, int var2, ShortComparator var3) {
      int var4 = var1;
      ...
      while(true) {
         ...
         for(short var7 = var0[var4 - 1]; var3.compare(var5, var7) < 0; var7 = var0[var6 - 1]) {
            var0[var6] = var7;
            if (var1 == var6 - 1) {
               --var6;
               break;
   ...
   public static void quickSort(short[] var0, int var1, int var2, ShortComparator var3) {
      int var4 = var2 - var1;
      if (var4 < 16) {
   ...
   public static void quickSort(short[] var0, ShortComparator var1) {
      quickSort(var0, 0, var0.length, var1);
   }

   public static void parallelQuickSort(short[] var0, int var1, int var2, ShortComparator var3) {
      if (var2 - var1 < 8192) {
         quickSort(var0, var1, var2, var3);
      } else {
         ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var4.invoke(new ShortArrays.ForkJoinQuickSortComp(var0, var1, var2, var3));
         var4.shutdown();
      }

   }

   public static void parallelQuickSort(short[] var0, ShortComparator var1) {
      parallelQuickSort(var0, 0, var0.length, var1);
   }

   private static int med3(short[] var0, int var1, int var2, int var3) {
      int var4 = Short.compare(var0[var1], var0[var2]);
      int var5 = Short.compare(var0[var1], var0[var3]);
      int var6 = Short.compare(var0[var2], var0[var3]);
      return var4 < 0 ? (var6 < 0 ? var2 : (var5 < 0 ? var3 : var1)) : (var6 > 0 ? var2 : (var5 > 0 ? var3 : var1));
   }

   private static void selectionSort(short[] var0, int var1, int var2) {
   ...
   private static void insertionSort(short[] var0, int var1, int var2) {
      int var3 = var1;
      ...
      while(true) {
         ...
         for(short var6 = var0[var3 - 1]; var4 < var6; var6 = var0[var5 - 1]) {
            var0[var5] = var6;
            if (var1 == var5 - 1) {
               --var5;
               break;
   ...
   public static void quickSort(short[] var0, int var1, int var2) {
      int var3 = var2 - var1;
      if (var3 < 16) {
         ...
         while(true) {
            int var12;
            while(var9 > var10 || (var12 = Short.compare(var0[var9], var13)) > 0) {
               for(; var10 >= var9 && (var12 = Short.compare(var0[var10], var13)) >= 0; --var10) {
                  if (var12 == 0) {
                     swap(var0, var10, var11--);
                  }
               }
   ...
   public static void quickSort(short[] var0) {
      quickSort(var0, 0, var0.length);
   }

   public static void parallelQuickSort(short[] var0, int var1, int var2) {
      if (var2 - var1 < 8192) {
         quickSort(var0, var1, var2);
      } else {
         ForkJoinPool var3 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var3.invoke(new ShortArrays.ForkJoinQuickSort(var0, var1, var2));
         var3.shutdown();
      }

   }

   public static void parallelQuickSort(short[] var0) {
      parallelQuickSort(var0, 0, var0.length);
   }

   private static int med3Indirect(int[] var0, short[] var1, int var2, int var3, int var4) {
      short var5 = var1[var0[var2]];
      short var6 = var1[var0[var3]];
      short var7 = var1[var0[var4]];
      int var8 = Short.compare(var5, var6);
      int var9 = Short.compare(var5, var7);
      int var10 = Short.compare(var6, var7);
      return var8 < 0 ? (var10 < 0 ? var3 : (var9 < 0 ? var4 : var2)) : (var10 > 0 ? var3 : (var9 > 0 ? var4 : var2));
   }

   private static void insertionSortIndirect(int[] var0, short[] var1, int var2, int var3) {
      int var4 = var2;
   ...
   public static void quickSortIndirect(int[] var0, short[] var1, int var2, int var3) {
      int var4 = var3 - var2;
      if (var4 < 16) {
         ...
         while(true) {
            int var13;
            while(var10 > var11 || (var13 = Short.compare(var1[var0[var10]], var14)) > 0) {
               for(; var11 >= var10 && (var13 = Short.compare(var1[var0[var11]], var14)) >= 0; --var11) {
                  if (var13 == 0) {
   ...
   public static void quickSortIndirect(int[] var0, short[] var1) {
      quickSortIndirect(var0, var1, 0, var1.length);
   }

   public static void parallelQuickSortIndirect(int[] var0, short[] var1, int var2, int var3) {
      if (var3 - var2 < 8192) {
         quickSortIndirect(var0, var1, var2, var3);
      } else {
         ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var4.invoke(new ShortArrays.ForkJoinQuickSortIndirect(var0, var1, var2, var3));
         var4.shutdown();
      }

   }

   public static void parallelQuickSortIndirect(int[] var0, short[] var1) {
      parallelQuickSortIndirect(var0, var1, 0, var1.length);
   }

   public static void stabilize(int[] var0, short[] var1, int var2, int var3) {
      int var4 = var2;
   ...
   public static void stabilize(int[] var0, short[] var1) {
      stabilize(var0, var1, 0, var0.length);
   }

   private static int med3(short[] var0, short[] var1, int var2, int var3, int var4) {
      int var5;
      int var6 = (var5 = Short.compare(var0[var2], var0[var3])) == 0 ? Short.compare(var1[var2], var1[var3]) : var5;
      int var7 = (var5 = Short.compare(var0[var2], var0[var4])) == 0 ? Short.compare(var1[var2], var1[var4]) : var5;
      int var8 = (var5 = Short.compare(var0[var3], var0[var4])) == 0 ? Short.compare(var1[var3], var1[var4]) : var5;
      return var6 < 0 ? (var8 < 0 ? var3 : (var7 < 0 ? var4 : var2)) : (var8 > 0 ? var3 : (var7 > 0 ? var4 : var2));
   }

   private static void swap(short[] var0, short[] var1, int var2, int var3) {
   ...
   private static void swap(short[] var0, short[] var1, int var2, int var3, int var4) {
   ...
   private static void selectionSort(short[] var0, short[] var1, int var2, int var3) {
      for(int var4 = var2; var4 < var3 - 1; ++var4) {
         int var5 = var4;

         for(int var7 = var4 + 1; var7 < var3; ++var7) {
            int var6;
            if ((var6 = Short.compare(var0[var7], var0[var5])) < 0 || var6 == 0 && var1[var7] < var1[var5]) {
               var5 = var7;
            }
         }

         if (var5 != var4) {
            short var8 = var0[var4];
            var0[var4] = var0[var5];
            var0[var5] = var8;
            var8 = var1[var4];
            var1[var4] = var1[var5];
   ...
   public static void quickSort(short[] var0, short[] var1, int var2, int var3) {
      int var4 = var3 - var2;
      if (var4 < 16) {
         selectionSort(var0, var1, var2, var3);
      } else {
         ...
         short var16 = var0[var5];
         short var9 = var1[var5];
         int var10 = var2;
         int var11 = var2;
         int var12 = var3 - 1;
         int var13 = var12;
         ...
         while(true) {
            int var14;
            int var15;
            while(var11 > var12 || (var14 = (var15 = Short.compare(var0[var11], var16)) == 0 ? Short.compare(var1[var11], var9) : var15) > 0) {
               for(; var12 >= var11 && (var14 = (var15 = Short.compare(var0[var12], var16)) == 0 ? Short.compare(var1[var12], var9) : var15) >= 0; --var12) {
                  if (var14 == 0) {
   ...
   public static void quickSort(short[] var0, short[] var1) {
      ensureSameLength(var0, var1);
      quickSort(var0, var1, 0, var0.length);
   }

   public static void parallelQuickSort(short[] var0, short[] var1, int var2, int var3) {
      if (var3 - var2 < 8192) {
         quickSort(var0, var1, var2, var3);
      }

      ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
      var4.invoke(new ShortArrays.ForkJoinQuickSort2(var0, var1, var2, var3));
      var4.shutdown();
   }

   public static void parallelQuickSort(short[] var0, short[] var1) {
      ensureSameLength(var0, var1);
      parallelQuickSort(var0, var1, 0, var0.length);
   }

   public static void mergeSort(short[] var0, int var1, int var2, short[] var3) {
      int var4 = var2 - var1;
      if (var4 < 16) {
   ...
   public static void mergeSort(short[] var0, int var1, int var2) {
      mergeSort(var0, var1, var2, (short[])var0.clone());
   }

   public static void mergeSort(short[] var0) {
      mergeSort(var0, 0, var0.length);
   }

   public static void mergeSort(short[] var0, int var1, int var2, ShortComparator var3, short[] var4) {
      int var5 = var2 - var1;
      if (var5 < 16) {
   ...
   public static void mergeSort(short[] var0, int var1, int var2, ShortComparator var3) {
      mergeSort(var0, var1, var2, var3, (short[])var0.clone());
   }

   public static void mergeSort(short[] var0, ShortComparator var1) {
      mergeSort(var0, 0, var0.length, (ShortComparator)var1);
   }
   ...
   public static int binarySearch(short[] var0, int var1, int var2, short var3, ShortComparator var4) {
      --var2;
   ...
   public static int binarySearch(short[] var0, short var1, ShortComparator var2) {
      return binarySearch(var0, 0, var0.length, var1, var2);
   }

   public static void radixSort(short[] var0) {
      radixSort((short[])var0, 0, var0.length);
   }

   public static void radixSort(short[] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         quickSort(var0, var1, var2);
      } else {
         boolean var3 = true;
         ...
         while(var23 > 0) {
            ...
            int var14 = var13 % 2 == 0 ? 128 : 0;
            int var15 = (1 - var13 % 2) * 8;

            int var16;
            for(var16 = var11 + var12; var16-- != var11; ++var9[var0[var16] >>> var15 & 255 ^ var14]) {
            }
            ...
            for(boolean var19 = true; var18 <= var17; var9[var25] = 0) {
               short var21 = var0[var18];
               var25 = var21 >>> var15 & 255 ^ var14;
               if (var18 < var17) {
                  int var20;
   ...
   public static void parallelRadixSort(short[] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         quickSort(var0, var1, var2);
      } else {
         boolean var3 = true;
         LinkedBlockingQueue var4 = new LinkedBlockingQueue();
         var4.add(new ShortArrays.Segment(var1, var2 - var1, 0));
         ...
         while(var9-- != 0) {
            var8.submit(() -> {
               ...
               while(true) {
                  ...
                  ShortArrays.Segment var19 = (ShortArrays.Segment)var4.take();
                  ...
                  int var10 = var9 % 2 == 0 ? 128 : 0;
                  int var11 = (1 - var9 % 2) * 8;

                  int var12;
                  for(var12 = var7 + var8; var12-- != var7; ++var4x[var0[var12] >>> var11 & 255 ^ var10]) {
                  }
                  ...
                  for(boolean var15 = true; var14 <= var13; var4x[var20] = 0) {
                     short var17 = var0[var14];
                     var20 = var17 >>> var11 & 255 ^ var10;
                     if (var14 < var13) {
                        int var16;
                     ...
                     if (var9 < 1 && var4x[var20] > 1) {
                        if (var4x[var20] < 1024) {
                           ...
                           var4.add(new ShortArrays.Segment(var14, var4x[var20], var9 + 1));
                        }
                     }
   ...
   public static void parallelRadixSort(short[] var0) {
      parallelRadixSort(var0, 0, var0.length);
   }

   public static void radixSortIndirect(int[] var0, short[] var1, boolean var2) {
      radixSortIndirect(var0, var1, 0, var0.length, var2);
   }

   public static void radixSortIndirect(int[] var0, short[] var1, int var2, int var3, boolean var4) {
      if (var3 - var2 < 1024) {
         insertionSortIndirect(var0, var1, var2, var3);
      } else {
         boolean var5 = true;
         ...
         while(true) {
            while(var26 > 0) {
               ...
               int var17 = var16 % 2 == 0 ? 128 : 0;
               int var18 = (1 - var16 % 2) * 8;

               int var19;
               for(var19 = var14 + var15; var19-- != var14; ++var11[var1[var0[var19]] >>> var18 & 255 ^ var17]) {
               }
               ...
               if (var4) {
                  for(var20 = var14 + var15; var20-- != var14; var13[--var12[var1[var0[var20]] >>> var18 & 255 ^ var17]] = var0[var20]) {
                  }
                  ...
                  for(boolean var22 = true; var21 <= var20; var11[var28] = 0) {
                     ...
                     var28 = var1[var24] >>> var18 & 255 ^ var17;
                     if (var21 < var20) {
                        int var23;
   ...
   public static void parallelRadixSortIndirect(int[] var0, short[] var1, int var2, int var3, boolean var4) {
      if (var3 - var2 < 1024) {
         radixSortIndirect(var0, var1, var2, var3, var4);
      } else {
         boolean var5 = true;
         LinkedBlockingQueue var6 = new LinkedBlockingQueue();
         var6.add(new ShortArrays.Segment(var2, var3 - var2, 0));
         ...
         while(var12-- != 0) {
            var10.submit(() -> {
               ...
               while(true) {
                  ...
                  ShortArrays.Segment var22 = (ShortArrays.Segment)var6.take();
                  ...
                  int var13 = var12 % 2 == 0 ? 128 : 0;
                  int var14 = (1 - var12 % 2) * 8;

                  int var15;
                  for(var15 = var10 + var11x; var15-- != var10; ++var7x[var1[var0[var15]] >>> var14 & 255 ^ var13]) {
                  }
                  ...
                  if (var4) {
                     for(var16 = var10 + var11x; var16-- != var10; var11[--var8x[var1[var0[var16]] >>> var14 & 255 ^ var13]] = var0[var16]) {
                     }
                     ...
                     for(var17 = var10; var16 <= var15; ++var16) {
                        if (var12 < 1 && var7x[var16] > 1) {
                           if (var7x[var16] < 1024) {
                              ...
                              var6.add(new ShortArrays.Segment(var17, var7x[var16], var12 + 1));
                           }
                        }
                     ...
                     for(boolean var18 = true; var17 <= var16; var7x[var23] = 0) {
                        ...
                        var23 = var1[var20] >>> var14 & 255 ^ var13;
                        if (var17 < var16) {
                           int var19;
                        ...
                        if (var12 < 1 && var7x[var23] > 1) {
                           if (var7x[var23] < 1024) {
                              ...
                              var7.incrementAndGet();
                              var6.add(new ShortArrays.Segment(var17, var7x[var23], var12 + 1));
                           }
                        }
   ...
   public static void parallelRadixSortIndirect(int[] var0, short[] var1, boolean var2) {
      parallelRadixSortIndirect(var0, var1, 0, var1.length, var2);
   }

   public static void radixSort(short[] var0, short[] var1) {
      ensureSameLength(var0, var1);
      radixSort(var0, var1, 0, var0.length);
   }

   public static void radixSort(short[] var0, short[] var1, int var2, int var3) {
      if (var3 - var2 < 1024) {
         selectionSort(var0, var1, var2, var3);
      } else {
         boolean var4 = true;
         ...
         while(var27 > 0) {
            ...
            int var16 = var15 % 2 == 0 ? 128 : 0;
            short[] var17 = var15 < 2 ? var0 : var1;
            int var18 = (1 - var15 % 2) * 8;

            int var19;
            for(var19 = var13 + var14; var19-- != var13; ++var11[var17[var19] >>> var18 & 255 ^ var16]) {
            }
            ...
            for(boolean var22 = true; var21 <= var20; var11[var29] = 0) {
               short var24 = var0[var21];
               short var25 = var1[var21];
               var29 = var17[var21] >>> var18 & 255 ^ var16;
               if (var21 < var20) {
                  int var23;
                  while((var23 = --var12[var29]) > var21) {
                     var29 = var17[var23] >>> var18 & 255 ^ var16;
                     short var26 = var24;
                     var24 = var0[var23];
                     var0[var23] = var26;
                     var26 = var25;
   ...
   public static void parallelRadixSort(short[] var0, short[] var1, int var2, int var3) {
      if (var3 - var2 < 1024) {
         quickSort(var0, var1, var2, var3);
      } else {
         boolean var4 = true;
            ...
            while(var11-- != 0) {
               var10.submit(() -> {
                  ...
                  while(true) {
                     ...
                     ShortArrays.Segment var23 = (ShortArrays.Segment)var6.take();
                     ...
                     for(boolean var17 = true; var16 <= var15; var5[var24] = 0) {
                        short var19 = var0[var16];
                        short var20 = var1[var16];
                        ...
                        if (var10 < 3 && var5[var24] > 1) {
                           if (var5[var24] < 1024) {
                              ...
                              var7.incrementAndGet();
                              var6.add(new ShortArrays.Segment(var16, var5[var24], var10 + 1));
                           }
                        }
   ...
   public static void parallelRadixSort(short[] var0, short[] var1) {
      ensureSameLength(var0, var1);
      parallelRadixSort(var0, var1, 0, var0.length);
   }

   private static void insertionSortIndirect(int[] var0, short[] var1, short[] var2, int var3, int var4) {
      int var5 = var3;
   ...
   public static void radixSortIndirect(int[] var0, short[] var1, short[] var2, boolean var3) {
      ensureSameLength(var1, var2);
      radixSortIndirect(var0, var1, var2, 0, var1.length, var3);
   }

   public static void radixSortIndirect(int[] var0, short[] var1, short[] var2, int var3, int var4, boolean var5) {
      if (var4 - var3 < 1024) {
         ...
         while(true) {
            while(var29 > 0) {
               ...
               int var19 = var18 % 2 == 0 ? 128 : 0;
               short[] var20 = var18 < 2 ? var1 : var2;
               int var21 = (1 - var18 % 2) * 8;

               int var22;
               for(var22 = var16 + var17; var22-- != var16; ++var13[var20[var0[var22]] >>> var21 & 255 ^ var19]) {
               }
               ...
               if (var5) {
                  for(var23 = var16 + var17; var23-- != var16; var15[--var14[var20[var0[var23]] >>> var21 & 255 ^ var19]] = var0[var23]) {
                  }
                  ...
                  for(boolean var25 = true; var24 <= var23; var13[var31] = 0) {
                     ...
                     var31 = var20[var27] >>> var21 & 255 ^ var19;
                     if (var24 < var23) {
                        int var26;
   ...
   private static void selectionSort(short[][] var0, int var1, int var2, int var3) {
   ...
   public static void radixSort(short[][] var0) {
      radixSort((short[][])var0, 0, var0[0].length);
   }
   ...
   public static void radixSort(short[][] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         ...
         while(var6 > 0) {
            ...
            int var15 = var9[var6];
            int var16 = var15 % 2 == 0 ? 128 : 0;
            short[] var17 = var0[var15 / 2];
            int var18 = (1 - var15 % 2) * 8;

            int var19;
            for(var19 = var13 + var14; var19-- != var13; ++var10[var17[var19] >>> var18 & 255 ^ var16]) {
            }
            ...
            for(boolean var22 = true; var21 <= var20; var10[var28] = 0) {
               ...
               var28 = var17[var21] >>> var18 & 255 ^ var16;
               if (var21 < var20) {
                  label92:
                  while(true) {
                     int var23;
                     ...
                     var28 = var17[var23] >>> var18 & 255 ^ var16;
   ...
   public static short[] shuffle(short[] var0, int var1, int var2, Random var3) {
      int var5;
      short var6;
   ...
   public static short[] shuffle(short[] var0, Random var1) {
      int var3;
      short var4;
   ...
   public static short[] reverse(short[] var0) {
   ...
   public static short[] reverse(short[] var0, int var1, int var2) {
      int var3 = var2 - var1;
   ...
   protected static class ForkJoinQuickSort2 extends RecursiveAction {
      ...
      public ForkJoinQuickSort2(short[] var1, short[] var2, int var3, int var4) {
         super();
         this.from = var3;
         this.to = var4;
         this.x = var1;
      ...
      protected void compute() {
         ...
         if (var3 < 8192) {
            ShortArrays.quickSort(var1, var2, this.from, this.to);
         } else {
            int var4 = this.from + var3 / 2;
            int var5 = this.from;
            int var6 = this.to - 1;
            int var7 = var3 / 8;
            var5 = ShortArrays.med3(var1, var2, var5, var5 + var7, var5 + 2 * var7);
            var4 = ShortArrays.med3(var1, var2, var4 - var7, var4, var4 + var7);
            var6 = ShortArrays.med3(var1, var2, var6 - 2 * var7, var6 - var7, var6);
            var4 = ShortArrays.med3(var1, var2, var5, var4, var6);
            short var8 = var1[var4];
            short var9 = var2[var4];
            int var10 = this.from;
            int var11 = var10;
            int var12 = this.to - 1;
            int var13 = var12;
            ...
            while(true) {
               int var14;
               int var15;
               while(var11 > var12 || (var14 = (var15 = Short.compare(var1[var11], var8)) == 0 ? Short.compare(var2[var11], var9) : var15) > 0) {
                  for(; var12 >= var11 && (var14 = (var15 = Short.compare(var1[var12], var8)) == 0 ? Short.compare(var2[var12], var9) : var15) >= 0; --var12) {
                     if (var14 == 0) {
                        ShortArrays.swap(var1, var2, var12, var13--);
                     }
                  }

                  if (var11 > var12) {
                     var7 = Math.min(var10 - this.from, var11 - var10);
                     ShortArrays.swap(var1, var2, this.from, var11 - var7, var7);
                     var7 = Math.min(var13 - var12, this.to - var13 - 1);
                     ShortArrays.swap(var1, var2, var11, this.to - var7, var7);
                     var7 = var11 - var10;
                     var14 = var13 - var12;
                     if (var7 > 1 && var14 > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSort2(var1, var2, this.from, this.from + var7), new ShortArrays.ForkJoinQuickSort2(var1, var2, this.to - var14, this.to));
                     } else if (var7 > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort2(var1, var2, this.from, this.from + var7)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort2(var1, var2, this.to - var14, this.to)});
                     }

                     return;
                  }

                  ShortArrays.swap(var1, var2, var11++, var12--);
               }

               if (var14 == 0) {
                  ShortArrays.swap(var1, var2, var10++, var11);
               }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      public ForkJoinQuickSortIndirect(int[] var1, short[] var2, int var3, int var4) {
         super();
         this.from = var3;
         this.to = var4;
         this.x = var2;
      ...
      protected void compute() {
         ...
         if (var2 < 8192) {
            ShortArrays.quickSortIndirect(this.perm, var1, this.from, this.to);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = ShortArrays.med3Indirect(this.perm, var1, var4, var4 + var6, var4 + 2 * var6);
            var3 = ShortArrays.med3Indirect(this.perm, var1, var3 - var6, var3, var3 + var6);
            var5 = ShortArrays.med3Indirect(this.perm, var1, var5 - 2 * var6, var5 - var6, var5);
            var3 = ShortArrays.med3Indirect(this.perm, var1, var4, var3, var5);
            short var7 = var1[this.perm[var3]];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            int var11 = var10;
            ...
            while(true) {
               int var12;
               while(var9 > var10 || (var12 = Short.compare(var1[this.perm[var9]], var7)) > 0) {
                  for(; var10 >= var9 && (var12 = Short.compare(var1[this.perm[var10]], var7)) >= 0; --var10) {
                     if (var12 == 0) {
                  ...
                  if (var9 > var10) {
                     ...
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.from, this.from + var6), new ShortArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.to - var12, this.to));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.from, this.from + var6)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.to - var12, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSort extends RecursiveAction {
      ...
      public ForkJoinQuickSort(short[] var1, int var2, int var3) {
         super();
         this.from = var2;
         this.to = var3;
         this.x = var1;
      ...
      protected void compute() {
         ...
         int var2 = this.to - this.from;
         if (var2 < 8192) {
            ShortArrays.quickSort(var1, this.from, this.to);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = ShortArrays.med3(var1, var4, var4 + var6, var4 + 2 * var6);
            var3 = ShortArrays.med3(var1, var3 - var6, var3, var3 + var6);
            var5 = ShortArrays.med3(var1, var5 - 2 * var6, var5 - var6, var5);
            var3 = ShortArrays.med3(var1, var4, var3, var5);
            short var7 = var1[var3];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            int var11 = var10;
            ...
            while(true) {
               int var12;
               while(var9 > var10 || (var12 = Short.compare(var1[var9], var7)) > 0) {
                  for(; var10 >= var9 && (var12 = Short.compare(var1[var10], var7)) >= 0; --var10) {
                     if (var12 == 0) {
                        ShortArrays.swap(var1, var10, var11--);
                     }
                  }

                  if (var9 > var10) {
                     var6 = Math.min(var8 - this.from, var9 - var8);
                     ShortArrays.swap(var1, this.from, var9 - var6, var6);
                     var6 = Math.min(var11 - var10, this.to - var11 - 1);
                     ShortArrays.swap(var1, var9, this.to - var6, var6);
                     var6 = var9 - var8;
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSort(var1, this.from, this.from + var6), new ShortArrays.ForkJoinQuickSort(var1, this.to - var12, this.to));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort(var1, this.from, this.from + var6)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSort(var1, this.to - var12, this.to)});
                     }

                     return;
                  }

                  ShortArrays.swap(var1, var9++, var10--);
               }

               if (var12 == 0) {
                  ShortArrays.swap(var1, var8++, var9);
               }
   ...
   protected static class ForkJoinQuickSortComp extends RecursiveAction {
      ...
      public ForkJoinQuickSortComp(short[] var1, int var2, int var3, ShortComparator var4) {
         super();
         this.from = var2;
         this.to = var3;
         this.x = var1;
      ...
      protected void compute() {
         ...
         int var2 = this.to - this.from;
         if (var2 < 8192) {
            ShortArrays.quickSort(var1, this.from, this.to, this.comp);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = ShortArrays.med3(var1, var4, var4 + var6, var4 + 2 * var6, this.comp);
            var3 = ShortArrays.med3(var1, var3 - var6, var3, var3 + var6, this.comp);
            var5 = ShortArrays.med3(var1, var5 - 2 * var6, var5 - var6, var5, this.comp);
            var3 = ShortArrays.med3(var1, var4, var3, var5, this.comp);
            short var7 = var1[var3];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            ...
            while(true) {
               ...
               while(var9 > var10 || (var12 = this.comp.compare(var1[var9], var7)) > 0) {
                  ...
                  if (var9 > var10) {
                     ...
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new ShortArrays.ForkJoinQuickSortComp(var1, this.from, this.from + var6, this.comp), new ShortArrays.ForkJoinQuickSortComp(var1, this.to - var12, this.to, this.comp));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortComp(var1, this.from, this.from + var6, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ShortArrays.ForkJoinQuickSortComp(var1, this.to - var12, this.to, this.comp)});
                     }
