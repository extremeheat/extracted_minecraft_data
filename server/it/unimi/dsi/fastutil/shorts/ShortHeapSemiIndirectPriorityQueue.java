...
public class ShortHeapSemiIndirectPriorityQueue implements ShortIndirectPriorityQueue {
   ...
   public ShortHeapSemiIndirectPriorityQueue(short[] var1, int var2, ShortComparator var3) {
      super();
   ...
   public ShortHeapSemiIndirectPriorityQueue(short[] var1, int var2) {
      this(var1, var2, (ShortComparator)null);
   }

   public ShortHeapSemiIndirectPriorityQueue(short[] var1, ShortComparator var2) {
      this(var1, var1.length, var2);
   }

   public ShortHeapSemiIndirectPriorityQueue(short[] var1) {
      this(var1, var1.length, (ShortComparator)null);
   }

   public ShortHeapSemiIndirectPriorityQueue(short[] var1, int[] var2, int var3, ShortComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      ShortSemiIndirectHeaps.makeHeap(var1, var2, var3, var4);
   }
   ...
   public ShortHeapSemiIndirectPriorityQueue(short[] var1, int[] var2, int var3) {
   ...
   public int front(int[] var1) {
      return this.c == null ? ShortSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1) : ShortSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1, this.c);
   }
