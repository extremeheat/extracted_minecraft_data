...
public class Short2LongAVLTreeMap extends AbstractShort2LongSortedMap implements Serializable, Cloneable {
   ...
   public Short2LongAVLTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2LongAVLTreeMap(Map<? extends Short, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Short2LongAVLTreeMap(SortedMap<Short, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2LongAVLTreeMap(Short2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Short2LongAVLTreeMap(Short2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2LongAVLTreeMap(short[] var1, long[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2LongAVLTreeMap(short[] var1, long[] var2) {
   ...
   final Short2LongAVLTreeMap.Entry findKey(short var1) {
      Short2LongAVLTreeMap.Entry var2;
      int var3;
   ...
   final Short2LongAVLTreeMap.Entry locateKey(short var1) {
      Short2LongAVLTreeMap.Entry var2 = this.tree;
      Short2LongAVLTreeMap.Entry var3 = this.tree;
   ...
   public long addTo(short var1, long var2) {
      Short2LongAVLTreeMap.Entry var4 = this.add(var1);
   ...
   private Short2LongAVLTreeMap.Entry add(short var1) {
      this.modified = false;
      Short2LongAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Short2LongAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Short2LongAVLTreeMap.Entry var3 = this.tree;
         Short2LongAVLTreeMap.Entry var4 = null;
         Short2LongAVLTreeMap.Entry var5 = this.tree;
         Short2LongAVLTreeMap.Entry var6 = null;
         Short2LongAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Short2LongAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Short2LongAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Short2LongAVLTreeMap.Entry parent(Short2LongAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Short2LongAVLTreeMap.Entry var3 = var1;

         Short2LongAVLTreeMap.Entry var2;
         Short2LongAVLTreeMap.Entry var4;
   ...
   public long remove(short var1) {
      ...
      if (this.tree == null) {
         ...
         Short2LongAVLTreeMap.Entry var7;
         Short2LongAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Short2LongAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(long var1) {
      Short2LongAVLTreeMap.ValueIterator var3 = new Short2LongAVLTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(short var1) {
      Short2LongAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() {
            final Comparator<? super Short2LongMap.Entry> comparator = (var1x, var2) -> {
               return Short2LongAVLTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry var1) {
               return Short2LongAVLTreeMap.this.new EntryIterator(var1.getShortKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Short2LongAVLTreeMap.Entry var3 = Short2LongAVLTreeMap.this.findKey((Short)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Short2LongAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry var1, Short2LongMap.Entry var2) {
               return Short2LongAVLTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2LongEntrySet();
            }

            public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry var1) {
               return Short2LongAVLTreeMap.this.headMap(var1.getShortKey()).short2LongEntrySet();
            }

            public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry var1) {
               return Short2LongAVLTreeMap.this.tailMap(var1.getShortKey()).short2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Short2LongAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Short2LongSortedMap headMap(short var1) {
      return new Short2LongAVLTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2LongSortedMap tailMap(short var1) {
      return new Short2LongAVLTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2LongSortedMap subMap(short var1, short var2) {
      return new Short2LongAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Short2LongAVLTreeMap clone() {
      Short2LongAVLTreeMap var1;
      try {
         var1 = (Short2LongAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2LongAVLTreeMap.Entry var5 = new Short2LongAVLTreeMap.Entry();
         Short2LongAVLTreeMap.Entry var6 = new Short2LongAVLTreeMap.Entry();
         Short2LongAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2LongAVLTreeMap.Entry var4 = var6;
         var6.pred((Short2LongAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2LongAVLTreeMap.EntryIterator var3 = new Short2LongAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2LongAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2LongAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Short2LongAVLTreeMap.Entry var3, Short2LongAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Short2LongAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2LongAVLTreeMap.Entry(var1.readShort(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Short2LongAVLTreeMap.Entry(var1.readShort(), var1.readLong());
         var8.right(new Short2LongAVLTreeMap.Entry(var1.readShort(), var1.readLong()));
         ...
         Short2LongAVLTreeMap.Entry var7 = new Short2LongAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2LongAVLTreeMap.Entry)null, (Short2LongAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2LongSortedMap implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2LongAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2LongAVLTreeMap.Submap.SubmapIterator var1 = new Short2LongAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2LongAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2LongAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2LongAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Short2LongAVLTreeMap.Submap.SubmapIterator var3 = new Short2LongAVLTreeMap.Submap.SubmapIterator();
      ...
      public long get(short var1) {
         Short2LongAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2LongAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public long put(short var1, long var2) {
         ...
         if (!this.in(var1)) {
            ...
            long var4 = Short2LongAVLTreeMap.this.put(var1, var2);
            return Short2LongAVLTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public long remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var2 = Short2LongAVLTreeMap.this.remove(var1);
            return Short2LongAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Short2LongSortedMap headMap(short var1) {
         if (this.top) {
            return Short2LongAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2LongAVLTreeMap.this.compare(var1, this.to) < 0 ? Short2LongAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2LongSortedMap tailMap(short var1) {
         if (this.bottom) {
            return Short2LongAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2LongAVLTreeMap.this.compare(var1, this.from) > 0 ? Short2LongAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2LongSortedMap subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2LongAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2LongAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2LongAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2LongAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2LongAVLTreeMap.Entry firstEntry() {
         if (Short2LongAVLTreeMap.this.tree == null) {
            ...
            Short2LongAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2LongAVLTreeMap.this.firstEntry;
            } else {
               var1 = Short2LongAVLTreeMap.this.locateKey(this.from);
               if (Short2LongAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2LongAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2LongAVLTreeMap.Entry lastEntry() {
         if (Short2LongAVLTreeMap.this.tree == null) {
            ...
            Short2LongAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2LongAVLTreeMap.this.lastEntry;
            } else {
               var1 = Short2LongAVLTreeMap.this.locateKey(this.to);
               if (Short2LongAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2LongAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2LongAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2LongAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Short2LongAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2LongAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2LongAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2LongAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2LongAVLTreeMap.this.locateKey(var2);
                  if (Short2LongAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractShort2LongSortedMap.KeySet {
      ...
      public ShortBidirectionalIterator iterator(short var1) {
         return Short2LongAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Short2LongAVLTreeMap.TreeIterator implements ObjectListIterator<Short2LongMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Short2LongMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Short2LongMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2LongAVLTreeMap.this.locateKey(var2)) != null) {
            if (Short2LongAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractShort2LongMap.BasicEntry implements Cloneable {
      ...
      void pred(Short2LongAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2LongAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2LongAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2LongAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2LongAVLTreeMap.Entry next() {
         Short2LongAVLTreeMap.Entry var1 = this.right;
      ...
      Short2LongAVLTreeMap.Entry prev() {
         Short2LongAVLTreeMap.Entry var1 = this.left;
      ...
      public Short2LongAVLTreeMap.Entry clone() {
         Short2LongAVLTreeMap.Entry var1;
         try {
            var1 = (Short2LongAVLTreeMap.Entry)super.clone();
