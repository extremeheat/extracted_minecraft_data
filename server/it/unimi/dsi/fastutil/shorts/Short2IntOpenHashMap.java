...
public class Short2IntOpenHashMap extends AbstractShort2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Short2IntOpenHashMap(int var1, float var2) {
      super();
   ...
   public Short2IntOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Short2IntOpenHashMap(Map<? extends Short, ? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2IntOpenHashMap(Map<? extends Short, ? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public Short2IntOpenHashMap(Short2IntMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2IntOpenHashMap(Short2IntMap var1) {
      this(var1, 0.75F);
   }

   public Short2IntOpenHashMap(short[] var1, int[] var2, float var3) {
   ...
   public Short2IntOpenHashMap(short[] var1, int[] var2) {
   ...
   public Short2IntMap.FastEntrySet short2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new Short2IntOpenHashMap.MapEntrySet();
      }
   ...
   public ShortSet keySet() {
      if (this.keys == null) {
         this.keys = new Short2IntOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            public IntIterator iterator() {
               return Short2IntOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(int var1) {
               return Short2IntOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Short2IntOpenHashMap.this.containsNullKey) {
                  var1.accept(Short2IntOpenHashMap.this.value[Short2IntOpenHashMap.this.n]);
               }

               int var2 = Short2IntOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2IntOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Short2IntOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2IntOpenHashMap clone() {
      Short2IntOpenHashMap var1;
      try {
         var1 = (Short2IntOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      int[] var3 = this.value;
      Short2IntOpenHashMap.MapIterator var4 = new Short2IntOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Short2IntOpenHashMap.MapIterator implements IntIterator {
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortIterator iterator() {
         return Short2IntOpenHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Short2IntOpenHashMap.this.containsNullKey) {
            var1.accept(Short2IntOpenHashMap.this.key[Short2IntOpenHashMap.this.n]);
         }

         int var2 = Short2IntOpenHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2IntOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2IntOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2IntOpenHashMap.this.size;
         Short2IntOpenHashMap.this.remove(var1);
         return Short2IntOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Short2IntOpenHashMap.MapIterator implements ShortIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntMap.FastEntrySet {
      ...
      public ObjectIterator<Short2IntMap.Entry> iterator() {
         return Short2IntOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Short2IntMap.Entry> fastIterator() {
         return Short2IntOpenHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (var3 == 0) {
                     return Short2IntOpenHashMap.this.containsNullKey && Short2IntOpenHashMap.this.value[Short2IntOpenHashMap.this.n] == var4;
                  } else {
                     short[] var6 = Short2IntOpenHashMap.this.key;
                     short var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2IntOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Short2IntOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Short2IntOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Short2IntOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var4 = (Integer)var2.getValue();
                  if (var3 == 0) {
                     if (Short2IntOpenHashMap.this.containsNullKey && Short2IntOpenHashMap.this.value[Short2IntOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2IntOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Short2IntOpenHashMap.this.value[var7] == var4) {
                           Short2IntOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Short2IntOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Short2IntOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Short2IntMap.Entry> var1) {
         if (Short2IntOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2IntMap.BasicEntry(Short2IntOpenHashMap.this.key[Short2IntOpenHashMap.this.n], Short2IntOpenHashMap.this.value[Short2IntOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2IntOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2IntMap.BasicEntry(Short2IntOpenHashMap.this.key[var2], Short2IntOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2IntMap.Entry> var1) {
         ...
         if (Short2IntOpenHashMap.this.containsNullKey) {
            var2.key = Short2IntOpenHashMap.this.key[Short2IntOpenHashMap.this.n];
            var2.value = Short2IntOpenHashMap.this.value[Short2IntOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2IntOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Short2IntOpenHashMap.this.key[var3] != 0) {
               var2.key = Short2IntOpenHashMap.this.key[var3];
               var2.value = Short2IntOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2IntOpenHashMap.MapIterator implements ObjectIterator<Short2IntMap.Entry> {
      private final Short2IntOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2IntOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2IntOpenHashMap.MapIterator implements ObjectIterator<Short2IntMap.Entry> {
      private Short2IntOpenHashMap.MapEntry entry;
      ...
      public Short2IntOpenHashMap.MapEntry next() {
         return this.entry = Short2IntOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2IntOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Short2IntOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Short2IntOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2IntOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2IntOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Short2IntOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2IntOpenHashMap.this.value[var2] = Short2IntOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2IntMap.Entry, java.util.Map.Entry<Short, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Short2IntOpenHashMap.this.value[this.index];
         Short2IntOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2IntOpenHashMap.this.key[this.index] == (Short)var2.getKey() && Short2IntOpenHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
