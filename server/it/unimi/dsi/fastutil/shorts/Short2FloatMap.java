...
public interface Short2FloatMap extends Short2FloatFunction, Map<Short, Float> {
   ...
   default Float put(Short var1, Float var2) {
      return Short2FloatFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Float get(Object var1) {
      return Short2FloatFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Float remove(Object var1) {
      return Short2FloatFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Short2FloatFunction.super.containsKey(var1);
   }
   ...
   default float getOrDefault(short var1, float var2) {
      float var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default float putIfAbsent(short var1, float var2) {
   ...
   default boolean remove(short var1, float var2) {
      float var3 = this.get(var1);
   ...
   default boolean replace(short var1, float var2, float var3) {
   ...
   default float replace(short var1, float var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default float computeIfAbsent(short var1, IntToDoubleFunction var2) {
   ...
   default float computeIfAbsentNullable(short var1, IntFunction<? extends Float> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default float computeIfAbsentPartial(short var1, Short2FloatFunction var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default float computeIfPresent(short var1, BiFunction<? super Short, ? super Float, ? extends Float> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default float compute(short var1, BiFunction<? super Short, ? super Float, ? extends Float> var2) {
      Objects.requireNonNull(var2);
      float var3 = this.get(var1);
      float var4 = this.defaultReturnValue();
   ...
   default float merge(short var1, float var2, BiFunction<? super Float, ? super Float, ? extends Float> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Float computeIfAbsent(Short var1, Function<? super Short, ? extends Float> var2) {
   ...
   public interface FastEntrySet extends ObjectSet<Short2FloatMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Short2FloatMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
