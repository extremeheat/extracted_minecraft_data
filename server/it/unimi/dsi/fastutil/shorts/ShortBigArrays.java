...
public final class ShortBigArrays {
   ...
   public static final Hash.Strategy HASH_STRATEGY = new ShortBigArrays.BigArrayHashStrategy();
   ...
   public static short get(short[][] var0, long var1) {
      return var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void set(short[][] var0, long var1, short var3) {
      var0[BigArrays.segment(var1)][BigArrays.displacement(var1)] = var3;
   }

   public static void swap(short[][] var0, long var1, long var3) {
      short var5 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   ...
   public static void add(short[][] var0, long var1, short var3) {
      short[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] += var3;
   }

   public static void mul(short[][] var0, long var1, short var3) {
      short[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] *= var3;
   }

   public static void incr(short[][] var0, long var1) {
      ++var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void decr(short[][] var0, long var1) {
      --var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static long length(short[][] var0) {
      int var1 = var0.length;
      return var1 == 0 ? 0L : BigArrays.start(var1 - 1) + (long)var0[var1 - 1].length;
   }

   public static void copy(short[][] var0, long var1, short[][] var3, long var4, long var6) {
      int var8;
      int var9;
      int var10;
      int var11;
   ...
   public static void copyFromBig(short[][] var0, long var1, short[] var3, int var4, int var5) {
   ...
   public static void copyToBig(short[] var0, int var1, short[][] var2, long var3, long var5) {
   ...
   public static short[][] newBigArray(long var0) {
      if (var0 == 0L) {
         ...
         if (var4 != 0) {
            for(var5 = 0; var5 < var2 - 1; ++var5) {
               var3[var5] = new short[134217728];
            }

            var3[var2 - 1] = new short[var4];
         } else {
   ...
   public static short[][] wrap(short[] var0) {
      if (var0.length == 0) {
         return EMPTY_BIG_ARRAY;
      } else if (var0.length <= 134217728) {
         return new short[][]{var0};
      } else {
         short[][] var1 = newBigArray((long)var0.length);
   ...
   public static short[][] ensureCapacity(short[][] var0, long var1) {
      return ensureCapacity(var0, var1, length(var0));
   }

   public static short[][] forceCapacity(short[][] var0, long var1, long var3) {
      ...
      short[][] var7 = (short[][])Arrays.copyOf(var0, var6);
      int var8 = (int)(var1 & 134217727L);
      int var9;
      if (var8 != 0) {
         for(var9 = var5; var9 < var6 - 1; ++var9) {
            var7[var9] = new short[134217728];
         }

         var7[var6 - 1] = new short[var8];
      } else {
   ...
   public static short[][] trim(short[][] var0, long var1) {
      ...
      if (var1 >= var3) {
         ...
         short[][] var6 = (short[][])Arrays.copyOf(var0, var5);
         int var7 = (int)(var1 & 134217727L);
         if (var7 != 0) {
            var6[var5 - 1] = ShortArrays.trim(var6[var5 - 1], var7);
         }
   ...
   public static short[][] setLength(short[][] var0, long var1) {
      long var3 = length(var0);
      if (var1 == var3) {
         return var0;
      } else {
   ...
   public static short[][] copy(short[][] var0, long var1, long var3) {
      ensureOffsetLength(var0, var1, var3);
      short[][] var5 = newBigArray(var3);
      copy(var0, var1, var5, 0L, var3);
      return var5;
   }

   public static short[][] copy(short[][] var0) {
      short[][] var1 = (short[][])var0.clone();

      for(int var2 = var1.length; var2-- != 0; var1[var2] = (short[])var0[var2].clone()) {
      }
   ...
   public static void fill(short[][] var0, long var1, long var3, short var5) {
   ...
   public static void ensureFromTo(short[][] var0, long var1, long var3) {
      BigArrays.ensureFromTo(length(var0), var1, var3);
   }

   public static void ensureOffsetLength(short[][] var0, long var1, long var3) {
      BigArrays.ensureOffsetLength(length(var0), var1, var3);
   }

   private static void vecSwap(short[][] var0, long var1, long var3, long var5) {
   ...
   private static long med3(short[][] var0, long var1, long var3, long var5, ShortComparator var7) {
   ...
   private static void selectionSort(short[][] var0, long var1, long var3, ShortComparator var5) {
   ...
   public static void quickSort(short[][] var0, long var1, long var3, ShortComparator var5) {
      long var6 = var3 - var1;
      if (var6 < 7L) {
   ...
   private static long med3(short[][] var0, long var1, long var3, long var5) {
      int var7 = Short.compare(get(var0, var1), get(var0, var3));
      int var8 = Short.compare(get(var0, var1), get(var0, var5));
      int var9 = Short.compare(get(var0, var3), get(var0, var5));
      return var7 < 0 ? (var9 < 0 ? var3 : (var8 < 0 ? var5 : var1)) : (var9 > 0 ? var3 : (var8 > 0 ? var5 : var1));
   }

   private static void selectionSort(short[][] var0, long var1, long var3) {
   ...
   public static void quickSort(short[][] var0, long var1, long var3) {
      long var5 = var3 - var1;
      if (var5 < 7L) {
         ...
         while(true) {
            int var18;
            while(var12 > var14 || (var18 = Short.compare(get(var0, var12), var22)) > 0) {
               for(; var14 >= var12 && (var18 = Short.compare(get(var0, var14), var22)) >= 0; --var14) {
                  if (var18 == 0) {
   ...
   public static long binarySearch(short[][] var0, long var1, long var3, short var5) {
      --var3;

      while(var1 <= var3) {
         long var7 = var1 + var3 >>> 1;
         short var6 = get(var0, var7);
         if (var6 < var5) {
            var1 = var7 + 1L;
         } else {
            if (var6 <= var5) {
   ...
   public static long binarySearch(short[][] var0, short var1) {
      return binarySearch(var0, 0L, length(var0), var1);
   }

   public static long binarySearch(short[][] var0, long var1, long var3, short var5, ShortComparator var6) {
      --var3;

      while(var1 <= var3) {
         long var8 = var1 + var3 >>> 1;
         short var7 = get(var0, var8);
   ...
   public static long binarySearch(short[][] var0, short var1, ShortComparator var2) {
   ...
   public static void radixSort(short[][] var0, long var1, long var3) {
      boolean var5 = true;
      boolean var6 = true;
      ...
      while(true) {
         while(var36 > 0) {
            ...
            if (var18 < 40L) {
               ...
               while(var23-- != 0L) {
                  ByteBigArrays.set(var15, var23, (byte)(get(var0, var16 + var23) >>> var22 & 255 ^ var21));
               }
               ...
               for(long var29 = 0L; var29 < var41; var13[var42] = 0L) {
                  short var33 = get(var0, var29 + var16);
   ...
   private static void selectionSort(short[][] var0, short[][] var1, long var2, long var4) {
   ...
   public static void radixSort(short[][] var0, short[][] var1, long var2, long var4) {
      boolean var6 = true;
      if (length(var0) != length(var1)) {
         ...
         while(true) {
            while(var40 > 0) {
               ...
               int var23 = var22 % 2 == 0 ? 128 : 0;
               if (var20 < 40L) {
                  selectionSort(var0, var1, var18, var18 + var20);
               } else {
                  short[][] var24 = var22 < 2 ? var0 : var1;
                  int var25 = (1 - var22 % 2) * 8;
                  long var26 = var20;

                  while(var26-- != 0L) {
                     ByteBigArrays.set(var17, var26, (byte)(get(var24, var18 + var26) >>> var25 & 255 ^ var23));
                  }
                  ...
                  for(long var32 = 0L; var32 < var45; var15[var46] = 0L) {
                     short var36 = get(var0, var32 + var18);
                     short var37 = get(var1, var32 + var18);
   ...
   public static short[][] shuffle(short[][] var0, long var1, long var3, Random var5) {
      long var6 = var3 - var1;

      while(var6-- != 0L) {
         long var8 = (var5.nextLong() & 9223372036854775807L) % (var6 + 1L);
         short var10 = get(var0, var1 + var6);
   ...
   private static final class BigArrayHashStrategy implements Hash.Strategy<short[][]>, Serializable {
      ...
      public boolean equals(short[][] var1, short[][] var2) {
         return ShortBigArrays.equals(var1, var2);
      }
