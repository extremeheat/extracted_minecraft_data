...
public class Short2DoubleRBTreeMap extends AbstractShort2DoubleSortedMap implements Serializable, Cloneable {
   ...
   public Short2DoubleRBTreeMap(Comparator<? super Short> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Short2DoubleRBTreeMap(Map<? extends Short, ? extends Double> var1) {
      this();
      this.putAll(var1);
   }

   public Short2DoubleRBTreeMap(SortedMap<Short, Double> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Short2DoubleRBTreeMap(Short2DoubleMap var1) {
      this();
      this.putAll(var1);
   }

   public Short2DoubleRBTreeMap(Short2DoubleSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Short2DoubleRBTreeMap(short[] var1, double[] var2, Comparator<? super Short> var3) {
      this(var3);
   ...
   public Short2DoubleRBTreeMap(short[] var1, double[] var2) {
   ...
   final Short2DoubleRBTreeMap.Entry findKey(short var1) {
      Short2DoubleRBTreeMap.Entry var2;
      int var3;
   ...
   final Short2DoubleRBTreeMap.Entry locateKey(short var1) {
      Short2DoubleRBTreeMap.Entry var2 = this.tree;
      Short2DoubleRBTreeMap.Entry var3 = this.tree;
   ...
   public double addTo(short var1, double var2) {
      Short2DoubleRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Short2DoubleRBTreeMap.Entry add(short var1) {
      this.modified = false;
      int var2 = 0;
      Short2DoubleRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Short2DoubleRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Short2DoubleRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Short2DoubleRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Short2DoubleRBTreeMap.Entry var7;
               Short2DoubleRBTreeMap.Entry var8;
   ...
   public boolean containsValue(double var1) {
      Short2DoubleRBTreeMap.ValueIterator var3 = new Short2DoubleRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public double get(short var1) {
      Short2DoubleRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>() {
            final Comparator<? super Short2DoubleMap.Entry> comparator = (var1x, var2) -> {
               return Short2DoubleRBTreeMap.this.actualComparator.compare(var1x.getShortKey(), var2.getShortKey());
            };
            ...
            public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry var1) {
               return Short2DoubleRBTreeMap.this.new EntryIterator(var1.getShortKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        Short2DoubleRBTreeMap.Entry var3 = Short2DoubleRBTreeMap.this.findKey((Short)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Short) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        ...
                        if (var3 != null && Double.doubleToLongBits(var3.getDoubleValue()) == Double.doubleToLongBits((Double)var2.getValue())) {
                           Short2DoubleRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry var1, Short2DoubleMap.Entry var2) {
               return Short2DoubleRBTreeMap.this.subMap(var1.getShortKey(), var2.getShortKey()).short2DoubleEntrySet();
            }

            public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry var1) {
               return Short2DoubleRBTreeMap.this.headMap(var1.getShortKey()).short2DoubleEntrySet();
            }

            public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry var1) {
               return Short2DoubleRBTreeMap.this.tailMap(var1.getShortKey()).short2DoubleEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Short2DoubleRBTreeMap.this.containsValue(var1);
            }
   ...
   public Short2DoubleSortedMap headMap(short var1) {
      return new Short2DoubleRBTreeMap.Submap((short)0, true, var1, false);
   }

   public Short2DoubleSortedMap tailMap(short var1) {
      return new Short2DoubleRBTreeMap.Submap(var1, false, (short)0, true);
   }

   public Short2DoubleSortedMap subMap(short var1, short var2) {
      return new Short2DoubleRBTreeMap.Submap(var1, false, var2, false);
   }

   public Short2DoubleRBTreeMap clone() {
      Short2DoubleRBTreeMap var1;
      try {
         var1 = (Short2DoubleRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Short2DoubleRBTreeMap.Entry var5 = new Short2DoubleRBTreeMap.Entry();
         Short2DoubleRBTreeMap.Entry var6 = new Short2DoubleRBTreeMap.Entry();
         Short2DoubleRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Short2DoubleRBTreeMap.Entry var4 = var6;
         var6.pred((Short2DoubleRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Short2DoubleRBTreeMap.EntryIterator var3 = new Short2DoubleRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Short2DoubleRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Short2DoubleRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Short2DoubleRBTreeMap.Entry var3, Short2DoubleRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Short2DoubleRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Short2DoubleRBTreeMap.Entry(var1.readShort(), var1.readDouble());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Short2DoubleRBTreeMap.Entry(var1.readShort(), var1.readDouble());
         var8.black(true);
         var8.right(new Short2DoubleRBTreeMap.Entry(var1.readShort(), var1.readDouble()));
         ...
         Short2DoubleRBTreeMap.Entry var7 = new Short2DoubleRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Short2DoubleRBTreeMap.Entry)null, (Short2DoubleRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractShort2DoubleSortedMap implements Serializable {
      ...
      public Submap(short var2, boolean var3, short var4, boolean var5) {
         super();
         if (!var3 && !var5 && Short2DoubleRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Short2DoubleRBTreeMap.Submap.SubmapIterator var1 = new Short2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(short var1) {
         return (this.bottom || Short2DoubleRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Short2DoubleRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(short var1) {
         return this.in(var1) && Short2DoubleRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(double var1) {
         Short2DoubleRBTreeMap.Submap.SubmapIterator var3 = new Short2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      public double get(short var1) {
         Short2DoubleRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Short2DoubleRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public double put(short var1, double var2) {
         ...
         if (!this.in(var1)) {
            ...
            double var4 = Short2DoubleRBTreeMap.this.put(var1, var2);
            return Short2DoubleRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public double remove(short var1) {
         ...
         if (!this.in(var1)) {
            ...
            double var2 = Short2DoubleRBTreeMap.this.remove(var1);
            return Short2DoubleRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Short2DoubleSortedMap headMap(short var1) {
         if (this.top) {
            return Short2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Short2DoubleRBTreeMap.this.compare(var1, this.to) < 0 ? Short2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Short2DoubleSortedMap tailMap(short var1) {
         if (this.bottom) {
            return Short2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Short2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? Short2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Short2DoubleSortedMap subMap(short var1, short var2) {
         if (this.top && this.bottom) {
            return Short2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Short2DoubleRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Short2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Short2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Short2DoubleRBTreeMap.Entry firstEntry() {
         if (Short2DoubleRBTreeMap.this.tree == null) {
            ...
            Short2DoubleRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Short2DoubleRBTreeMap.this.firstEntry;
            } else {
               var1 = Short2DoubleRBTreeMap.this.locateKey(this.from);
               if (Short2DoubleRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Short2DoubleRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Short2DoubleRBTreeMap.Entry lastEntry() {
         if (Short2DoubleRBTreeMap.this.tree == null) {
            ...
            Short2DoubleRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Short2DoubleRBTreeMap.this.lastEntry;
            } else {
               var1 = Short2DoubleRBTreeMap.this.locateKey(this.to);
               if (Short2DoubleRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Short2DoubleRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public short firstShortKey() {
         Short2DoubleRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public short lastShortKey() {
         Short2DoubleRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Short2DoubleRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2DoubleMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Short2DoubleRBTreeMap.TreeIterator {
         ...
         SubmapIterator(short var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Short2DoubleRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Short2DoubleRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Short2DoubleRBTreeMap.this.locateKey(var2);
                  if (Short2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractShort2DoubleSortedMap.KeySet {
      ...
      public ShortBidirectionalIterator iterator(short var1) {
         return Short2DoubleRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Short2DoubleRBTreeMap.TreeIterator implements ObjectListIterator<Short2DoubleMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(short var2) {
         super();
         if ((this.next = Short2DoubleRBTreeMap.this.locateKey(var2)) != null) {
            if (Short2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractShort2DoubleMap.BasicEntry implements Cloneable {
      ...
      void pred(Short2DoubleRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Short2DoubleRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Short2DoubleRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Short2DoubleRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Short2DoubleRBTreeMap.Entry next() {
         Short2DoubleRBTreeMap.Entry var1 = this.right;
      ...
      Short2DoubleRBTreeMap.Entry prev() {
         Short2DoubleRBTreeMap.Entry var1 = this.left;
      ...
      public Short2DoubleRBTreeMap.Entry clone() {
         Short2DoubleRBTreeMap.Entry var1;
         try {
            var1 = (Short2DoubleRBTreeMap.Entry)super.clone();
