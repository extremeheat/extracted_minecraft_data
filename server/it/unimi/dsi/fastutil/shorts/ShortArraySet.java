...
public class ShortArraySet extends AbstractShortSet implements Serializable, Cloneable {
   ...
   public ShortArraySet(short[] var1) {
      super();
      this.a = var1;
   ...
   public ShortArraySet(int var1) {
      super();
      this.a = new short[var1];
   }

   public ShortArraySet(ShortCollection var1) {
      this(var1.size());
      this.addAll(var1);
   }

   public ShortArraySet(Collection<? extends Short> var1) {
      this(var1.size());
      this.addAll(var1);
   }

   public ShortArraySet(short[] var1, int var2) {
      super();
      this.a = var1;
      this.size = var2;
      if (var2 > var1.length) {
   ...
   public ShortIterator iterator() {
      return new ShortIterator() {
         ...
         public void remove() {
            int var1 = ShortArraySet.this.size-- - this.next--;
            System.arraycopy(ShortArraySet.this.a, this.next + 1, ShortArraySet.this.a, this.next, var1);
         }
      };
   }
   ...
   public boolean add(short var1) {
      ...
      if (var2 != -1) {
         ...
         if (this.size == this.a.length) {
            short[] var3 = new short[this.size == 0 ? 2 : this.size * 2];
   ...
   public ShortArraySet clone() {
      ShortArraySet var1;
      try {
         var1 = (ShortArraySet)super.clone();
      } catch (CloneNotSupportedException var3) {
         throw new InternalError();
      }

      var1.a = (short[])this.a.clone();
      return var1;
   }
