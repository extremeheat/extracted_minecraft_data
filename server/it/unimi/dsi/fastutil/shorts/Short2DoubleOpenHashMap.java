...
public class Short2DoubleOpenHashMap extends AbstractShort2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Short2DoubleOpenHashMap(int var1, float var2) {
      super();
   ...
   public Short2DoubleOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Short2DoubleOpenHashMap(Map<? extends Short, ? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2DoubleOpenHashMap(Map<? extends Short, ? extends Double> var1) {
      this(var1, 0.75F);
   }

   public Short2DoubleOpenHashMap(Short2DoubleMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2DoubleOpenHashMap(Short2DoubleMap var1) {
      this(var1, 0.75F);
   }

   public Short2DoubleOpenHashMap(short[] var1, double[] var2, float var3) {
   ...
   public Short2DoubleOpenHashMap(short[] var1, double[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Short2DoubleOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Short2DoubleOpenHashMap.this.containsNullKey) {
                  var1.accept(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]);
               }

               int var2 = Short2DoubleOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2DoubleOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Short2DoubleOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2DoubleOpenHashMap clone() {
      Short2DoubleOpenHashMap var1;
      try {
         var1 = (Short2DoubleOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      double[] var3 = this.value;
      Short2DoubleOpenHashMap.MapIterator var4 = new Short2DoubleOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(Short2DoubleOpenHashMap.this.key[Short2DoubleOpenHashMap.this.n]);
         }

         int var2 = Short2DoubleOpenHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2DoubleOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2DoubleOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2DoubleOpenHashMap.this.size;
         Short2DoubleOpenHashMap.this.remove(var1);
         return Short2DoubleOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (var3 == 0) {
                     return Short2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4);
                  } else {
                     short[] var7 = Short2DoubleOpenHashMap.this.key;
                     short var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Short2DoubleOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var6) {
                        return Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Short2DoubleOpenHashMap.this.mask]) != 0) {
                           if (var3 == var6) {
                              return Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var4 = (Double)var2.getValue();
                  if (var3 == 0) {
                     if (Short2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Short2DoubleOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                           Short2DoubleOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Short2DoubleOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var6 != var3 || Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Short2DoubleMap.Entry> var1) {
         if (Short2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleOpenHashMap.this.key[Short2DoubleOpenHashMap.this.n], Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2DoubleOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleOpenHashMap.this.key[var2], Short2DoubleOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2DoubleMap.Entry> var1) {
         ...
         if (Short2DoubleOpenHashMap.this.containsNullKey) {
            var2.key = Short2DoubleOpenHashMap.this.key[Short2DoubleOpenHashMap.this.n];
            var2.value = Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2DoubleOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Short2DoubleOpenHashMap.this.key[var3] != 0) {
               var2.key = Short2DoubleOpenHashMap.this.key[var3];
               var2.value = Short2DoubleOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2DoubleOpenHashMap.MapIterator implements ObjectIterator<Short2DoubleMap.Entry> {
      private final Short2DoubleOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2DoubleOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2DoubleOpenHashMap.MapIterator implements ObjectIterator<Short2DoubleMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2DoubleOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Short2DoubleOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Short2DoubleOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2DoubleOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2DoubleOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Short2DoubleOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2DoubleOpenHashMap.this.value[var2] = Short2DoubleOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2DoubleMap.Entry, java.util.Map.Entry<Short, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Short2DoubleOpenHashMap.this.value[this.index];
         Short2DoubleOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2DoubleOpenHashMap.this.key[this.index] == (Short)var2.getKey() && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
