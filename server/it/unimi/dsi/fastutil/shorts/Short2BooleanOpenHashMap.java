...
public class Short2BooleanOpenHashMap extends AbstractShort2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Short2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Short2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Short2BooleanOpenHashMap(Map<? extends Short, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2BooleanOpenHashMap(Map<? extends Short, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Short2BooleanOpenHashMap(Short2BooleanMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Short2BooleanOpenHashMap(Short2BooleanMap var1) {
      this(var1, 0.75F);
   }

   public Short2BooleanOpenHashMap(short[] var1, boolean[] var2, float var3) {
   ...
   public Short2BooleanOpenHashMap(short[] var1, boolean[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Short2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Short2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n]);
               }

               int var2 = Short2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Short2BooleanOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Short2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Short2BooleanOpenHashMap clone() {
      Short2BooleanOpenHashMap var1;
      try {
         var1 = (Short2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      short[] var2 = this.key;
      boolean[] var3 = this.value;
      Short2BooleanOpenHashMap.MapIterator var4 = new Short2BooleanOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Short2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Short2BooleanOpenHashMap.this.key[Short2BooleanOpenHashMap.this.n]);
         }

         int var2 = Short2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            short var3 = Short2BooleanOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(short var1) {
         return Short2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(short var1) {
         int var2 = Short2BooleanOpenHashMap.this.size;
         Short2BooleanOpenHashMap.this.remove(var1);
         return Short2BooleanOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (var3 == 0) {
                     return Short2BooleanOpenHashMap.this.containsNullKey && Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n] == var4;
                  } else {
                     short[] var6 = Short2BooleanOpenHashMap.this.key;
                     short var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2BooleanOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Short2BooleanOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Short2BooleanOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Short2BooleanOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Short) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var4 = (Boolean)var2.getValue();
                  if (var3 == 0) {
                     if (Short2BooleanOpenHashMap.this.containsNullKey && Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Short2BooleanOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Short2BooleanOpenHashMap.this.value[var7] == var4) {
                           Short2BooleanOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Short2BooleanOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Short2BooleanOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Short2BooleanMap.Entry> var1) {
         if (Short2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractShort2BooleanMap.BasicEntry(Short2BooleanOpenHashMap.this.key[Short2BooleanOpenHashMap.this.n], Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Short2BooleanOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractShort2BooleanMap.BasicEntry(Short2BooleanOpenHashMap.this.key[var2], Short2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Short2BooleanMap.Entry> var1) {
         ...
         if (Short2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Short2BooleanOpenHashMap.this.key[Short2BooleanOpenHashMap.this.n];
            var2.value = Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Short2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Short2BooleanOpenHashMap.this.key[var3] != 0) {
               var2.key = Short2BooleanOpenHashMap.this.key[var3];
               var2.value = Short2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Short2BooleanOpenHashMap.MapIterator implements ObjectIterator<Short2BooleanMap.Entry> {
      private final Short2BooleanOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Short2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Short2BooleanOpenHashMap.MapIterator implements ObjectIterator<Short2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               short[] var1 = Short2BooleanOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Short2BooleanOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Short2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         short[] var5 = Short2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Short2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Short2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Short2BooleanOpenHashMap.this.value[var2] = Short2BooleanOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Short2BooleanMap.Entry, java.util.Map.Entry<Short, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Short2BooleanOpenHashMap.this.value[this.index];
         Short2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Short2BooleanOpenHashMap.this.key[this.index] == (Short)var2.getKey() && Short2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
