...
public final class Short2LongFunctions {
   ...
   public static Short2LongFunction singleton(short var0, long var1) {
      return new Short2LongFunctions.Singleton(var0, var1);
   }
   ...
   public static Short2LongFunction synchronize(Short2LongFunction var0) {
      return new Short2LongFunctions.SynchronizedFunction(var0);
   }

   public static Short2LongFunction synchronize(Short2LongFunction var0, Object var1) {
      return new Short2LongFunctions.SynchronizedFunction(var0, var1);
   }

   public static Short2LongFunction unmodifiable(Short2LongFunction var0) {
      return new Short2LongFunctions.UnmodifiableFunction(var0);
   }

   public static Short2LongFunction primitive(Function<? super Short, ? extends Long> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Short2LongFunction) {
         return (Short2LongFunction)var0;
         ...
         return new Short2LongFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Short2LongFunction {
      ...
      protected PrimitiveFunction(Function<? super Short, ? extends Long> var1) {
         super();
         this.function = var1;
      }
      ...
      public Long get(Object var1) {
         return var1 == null ? null : (Long)this.function.apply((Short)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractShort2LongFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Short2LongFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Short2LongFunction, Serializable {
      ...
      protected SynchronizedFunction(Short2LongFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Short2LongFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
