...
public final class BooleanBigArrays {
   ...
   public static final Hash.Strategy HASH_STRATEGY = new BooleanBigArrays.BigArrayHashStrategy();
   ...
   public static boolean get(boolean[][] var0, long var1) {
      return var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void set(boolean[][] var0, long var1, boolean var3) {
      var0[BigArrays.segment(var1)][BigArrays.displacement(var1)] = var3;
   }

   public static void swap(boolean[][] var0, long var1, long var3) {
      boolean var5 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   ...
   public static long length(boolean[][] var0) {
      int var1 = var0.length;
      return var1 == 0 ? 0L : BigArrays.start(var1 - 1) + (long)var0[var1 - 1].length;
   }

   public static void copy(boolean[][] var0, long var1, boolean[][] var3, long var4, long var6) {
      int var8;
      int var9;
      int var10;
      int var11;
   ...
   public static void copyFromBig(boolean[][] var0, long var1, boolean[] var3, int var4, int var5) {
   ...
   public static void copyToBig(boolean[] var0, int var1, boolean[][] var2, long var3, long var5) {
   ...
   public static boolean[][] newBigArray(long var0) {
      if (var0 == 0L) {
         ...
         if (var4 != 0) {
            for(var5 = 0; var5 < var2 - 1; ++var5) {
               var3[var5] = new boolean[134217728];
            }

            var3[var2 - 1] = new boolean[var4];
         } else {
   ...
   public static boolean[][] wrap(boolean[] var0) {
      if (var0.length == 0) {
         return EMPTY_BIG_ARRAY;
      } else if (var0.length <= 134217728) {
         return new boolean[][]{var0};
      } else {
         boolean[][] var1 = newBigArray((long)var0.length);
   ...
   public static boolean[][] ensureCapacity(boolean[][] var0, long var1) {
      return ensureCapacity(var0, var1, length(var0));
   }

   public static boolean[][] forceCapacity(boolean[][] var0, long var1, long var3) {
      ...
      boolean[][] var7 = (boolean[][])Arrays.copyOf(var0, var6);
      int var8 = (int)(var1 & 134217727L);
      int var9;
      if (var8 != 0) {
         for(var9 = var5; var9 < var6 - 1; ++var9) {
            var7[var9] = new boolean[134217728];
         }

         var7[var6 - 1] = new boolean[var8];
      } else {
   ...
   public static boolean[][] ensureCapacity(boolean[][] var0, long var1, long var3) {
      return var1 > length(var0) ? forceCapacity(var0, var1, var3) : var0;
   }

   public static boolean[][] grow(boolean[][] var0, long var1) {
      long var3 = length(var0);
      return var1 > var3 ? grow(var0, var1, var3) : var0;
   }

   public static boolean[][] grow(boolean[][] var0, long var1, long var3) {
      long var5 = length(var0);
      return var1 > var5 ? ensureCapacity(var0, Math.max(var5 + (var5 >> 1), var1), var3) : var0;
   }

   public static boolean[][] trim(boolean[][] var0, long var1) {
      BigArrays.ensureLength(var1);
      long var3 = length(var0);
      if (var1 >= var3) {
         return var0;
         ...
         boolean[][] var6 = (boolean[][])Arrays.copyOf(var0, var5);
         int var7 = (int)(var1 & 134217727L);
         if (var7 != 0) {
            var6[var5 - 1] = BooleanArrays.trim(var6[var5 - 1], var7);
         }
   ...
   public static boolean[][] setLength(boolean[][] var0, long var1) {
      long var3 = length(var0);
      if (var1 == var3) {
         return var0;
      } else {
   ...
   public static boolean[][] copy(boolean[][] var0, long var1, long var3) {
      ensureOffsetLength(var0, var1, var3);
      boolean[][] var5 = newBigArray(var3);
      copy(var0, var1, var5, 0L, var3);
      return var5;
   }

   public static boolean[][] copy(boolean[][] var0) {
      boolean[][] var1 = (boolean[][])var0.clone();

      for(int var2 = var1.length; var2-- != 0; var1[var2] = (boolean[])var0[var2].clone()) {
      }
   ...
   public static void fill(boolean[][] var0, long var1, long var3, boolean var5) {
   ...
   public static void ensureFromTo(boolean[][] var0, long var1, long var3) {
      BigArrays.ensureFromTo(length(var0), var1, var3);
   }

   public static void ensureOffsetLength(boolean[][] var0, long var1, long var3) {
      BigArrays.ensureOffsetLength(length(var0), var1, var3);
   }

   private static void vecSwap(boolean[][] var0, long var1, long var3, long var5) {
   ...
   private static long med3(boolean[][] var0, long var1, long var3, long var5, BooleanComparator var7) {
   ...
   private static void selectionSort(boolean[][] var0, long var1, long var3, BooleanComparator var5) {
   ...
   public static void quickSort(boolean[][] var0, long var1, long var3, BooleanComparator var5) {
      long var6 = var3 - var1;
      if (var6 < 7L) {
   ...
   private static long med3(boolean[][] var0, long var1, long var3, long var5) {
      int var7 = Boolean.compare(get(var0, var1), get(var0, var3));
      int var8 = Boolean.compare(get(var0, var1), get(var0, var5));
      int var9 = Boolean.compare(get(var0, var3), get(var0, var5));
      return var7 < 0 ? (var9 < 0 ? var3 : (var8 < 0 ? var5 : var1)) : (var9 > 0 ? var3 : (var8 > 0 ? var5 : var1));
   }

   private static void selectionSort(boolean[][] var0, long var1, long var3) {
   ...
   public static void quickSort(boolean[][] var0, long var1, long var3) {
      long var5 = var3 - var1;
      if (var5 < 7L) {
         ...
         while(true) {
            int var18;
            while(var12 > var14 || (var18 = Boolean.compare(get(var0, var12), var22)) > 0) {
               for(; var14 >= var12 && (var18 = Boolean.compare(get(var0, var14), var22)) >= 0; --var14) {
                  if (var18 == 0) {
   ...
   public static boolean[][] shuffle(boolean[][] var0, long var1, long var3, Random var5) {
      long var6 = var3 - var1;

      while(var6-- != 0L) {
         long var8 = (var5.nextLong() & 9223372036854775807L) % (var6 + 1L);
         boolean var10 = get(var0, var1 + var6);
   ...
   private static final class BigArrayHashStrategy implements Hash.Strategy<boolean[][]>, Serializable {
      ...
      public boolean equals(boolean[][] var1, boolean[][] var2) {
         return BooleanBigArrays.equals(var1, var2);
      }
