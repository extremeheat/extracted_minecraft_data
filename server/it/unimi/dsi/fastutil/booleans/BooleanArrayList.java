...
public class BooleanArrayList extends AbstractBooleanList implements RandomAccess, Cloneable, Serializable {
   ...
   protected BooleanArrayList(boolean[] var1, boolean var2) {
      super();
      this.a = var1;
   }

   public BooleanArrayList(int var1) {
      super();
      if (var1 < 0) {
   ...
   public BooleanArrayList(Collection<? extends Boolean> var1) {
      this(var1.size());
      this.size = BooleanIterators.unwrap(BooleanIterators.asBooleanIterator(var1.iterator()), this.a);
   }

   public BooleanArrayList(BooleanCollection var1) {
      this(var1.size());
      this.size = BooleanIterators.unwrap(var1.iterator(), this.a);
   }

   public BooleanArrayList(BooleanList var1) {
      this(var1.size());
      var1.getElements(0, this.a, 0, this.size = var1.size());
   }

   public BooleanArrayList(boolean[] var1) {
      this(var1, 0, var1.length);
   }

   public BooleanArrayList(boolean[] var1, int var2, int var3) {
      this(var3);
      System.arraycopy(var1, var2, this.a, 0, var3);
      this.size = var3;
   }

   public BooleanArrayList(Iterator<? extends Boolean> var1) {
      this();
   ...
   public BooleanArrayList(BooleanIterator var1) {
      this();
   ...
   public static BooleanArrayList wrap(boolean[] var0, int var1) {
      if (var1 > var0.length) {
         throw new IllegalArgumentException("The specified length (" + var1 + ") is greater than the array size (" + var0.length + ")");
      } else {
         BooleanArrayList var2 = new BooleanArrayList(var0, false);
         var2.size = var1;
         return var2;
      }
   }

   public static BooleanArrayList wrap(boolean[] var0) {
      return wrap(var0, var0.length);
   }

   public void ensureCapacity(int var1) {
      if (var1 > this.a.length && this.a != BooleanArrays.DEFAULT_EMPTY_ARRAY) {
         this.a = BooleanArrays.ensureCapacity(this.a, var1, this.size);
   ...
   private void grow(int var1) {
      if (var1 > this.a.length) {
         ...
         this.a = BooleanArrays.forceCapacity(this.a, var1, this.size);
   ...
   public void size(int var1) {
      ...
      if (var1 > this.size) {
         Arrays.fill(this.a, this.size, var1, false);
      }
   ...
   public void trim(int var1) {
      if (var1 < this.a.length && this.size != this.a.length) {
         boolean[] var2 = new boolean[Math.max(var1, this.size)];
   ...
   public void getElements(int var1, boolean[] var2, int var3, int var4) {
      BooleanArrays.ensureOffsetLength(var2, var3, var4);
   ...
   public boolean addAll(int var1, BooleanCollection var2) {
      ...
      if (var3 == 0) {
         ...
         BooleanIterator var4 = var2.iterator();

         for(this.size += var3; var3-- != 0; this.a[var1++] = var4.nextBoolean()) {
         }
   ...
   public BooleanListIterator listIterator(final int var1) {
      ...
      return new BooleanListIterator() {
         ...
         public void add(boolean var1x) {
            BooleanArrayList.this.add(this.pos++, var1x);
            this.last = -1;
         }
         ...
         public void set(boolean var1x) {
            if (this.last == -1) {
               ...
               BooleanArrayList.this.set(this.last, var1x);
            }
         }
   ...
   public BooleanArrayList clone() {
      BooleanArrayList var1 = new BooleanArrayList(this.size);
      System.arraycopy(this.a, 0, var1.a, 0, this.size);
      var1.size = this.size;
      return var1;
   }

   public boolean equals(BooleanArrayList var1) {
      if (var1 == this) {
         return true;
      } else {
         int var2 = this.size();
   ...
   public int compareTo(BooleanArrayList var1) {
      int var2 = this.size();
      int var3 = var1.size();
      boolean[] var4 = this.a;
      boolean[] var5 = var1.a;
      ...
      for(var9 = 0; var9 < var2 && var9 < var3; ++var9) {
         boolean var6 = var4[var9];
         boolean var7 = var5[var9];
         int var8;
         if ((var8 = Boolean.compare(var6, var7)) != 0) {
            return var8;
         }
      }
