...
public class Double2ByteOpenHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Double2ByteOpenHashMap(int var1, float var2) {
      super();
   ...
   public Double2ByteOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Double2ByteOpenHashMap(Map<? extends Double, ? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2ByteOpenHashMap(Map<? extends Double, ? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public Double2ByteOpenHashMap(Double2ByteMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2ByteOpenHashMap(Double2ByteMap var1) {
      this(var1, 0.75F);
   }

   public Double2ByteOpenHashMap(double[] var1, byte[] var2, float var3) {
   ...
   public Double2ByteOpenHashMap(double[] var1, byte[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Double2ByteOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Double2ByteOpenHashMap.this.containsNullKey) {
                  var1.accept(Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n]);
               }

               int var2 = Double2ByteOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2ByteOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2ByteOpenHashMap clone() {
      Double2ByteOpenHashMap var1;
      try {
         var1 = (Double2ByteOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      byte[] var3 = this.value;
      Double2ByteOpenHashMap.MapIterator var4 = new Double2ByteOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Double2ByteOpenHashMap.MapIterator implements ByteIterator {
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n]);
         }

         int var2 = Double2ByteOpenHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2ByteOpenHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2ByteOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2ByteOpenHashMap.this.size;
         Double2ByteOpenHashMap.this.remove(var1);
         return Double2ByteOpenHashMap.this.size != var3;
      }
   ...
   private final class KeyIterator extends Double2ByteOpenHashMap.MapIterator implements DoubleIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (Double.doubleToLongBits(var3) == 0L) {
                     return Double2ByteOpenHashMap.this.containsNullKey && Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n] == var5;
                  } else {
                     double[] var8 = Double2ByteOpenHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2ByteOpenHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double.doubleToLongBits(var3) == Double.doubleToLongBits(var6)) {
                        return Double2ByteOpenHashMap.this.value[var9] == var5;
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ByteOpenHashMap.this.mask]) != 0L) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var5 = (Byte)var2.getValue();
                  if (Double.doubleToLongBits(var3) == 0L) {
                     if (Double2ByteOpenHashMap.this.containsNullKey && Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2ByteOpenHashMap.this.mask]) == 0L) {
                        ...
                        if (Double2ByteOpenHashMap.this.value[var9] == var5) {
                           Double2ByteOpenHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ByteOpenHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(Double.doubleToLongBits(var6) != Double.doubleToLongBits(var3) || Double2ByteOpenHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2ByteMap.Entry> var1) {
         if (Double2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n], Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenHashMap.this.key[var2], Double2ByteOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2ByteMap.Entry> var1) {
         ...
         if (Double2ByteOpenHashMap.this.containsNullKey) {
            var2.key = Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n];
            var2.value = Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2ByteOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[var3]) != 0L) {
               var2.key = Double2ByteOpenHashMap.this.key[var3];
               var2.value = Double2ByteOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2ByteOpenHashMap.MapIterator implements ObjectIterator<Double2ByteMap.Entry> {
      private final Double2ByteOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2ByteOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2ByteOpenHashMap.MapIterator implements ObjectIterator<Double2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      private MapIterator() {
         super();
         this.pos = Double2ByteOpenHashMap.this.n;
         this.last = -1;
         this.c = Double2ByteOpenHashMap.this.size;
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2ByteOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2)) & Double2ByteOpenHashMap.this.mask; Double.doubleToLongBits(var2) != Double.doubleToLongBits(var1[var4]); var4 = var4 + 1 & Double2ByteOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2ByteOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2ByteOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var4)) & Double2ByteOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2ByteOpenHashMap.this.value[var2] = Double2ByteOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2ByteMap.Entry, java.util.Map.Entry<Double, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Double2ByteOpenHashMap.this.value[this.index];
         Double2ByteOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)var2.getKey()) && Double2ByteOpenHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
