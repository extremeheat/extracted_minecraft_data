...
public final class Double2ShortMaps {
   ...
   public static ObjectIterator<Double2ShortMap.Entry> fastIterator(Double2ShortMap var0) {
      ObjectSet var1 = var0.double2ShortEntrySet();
      return var1 instanceof Double2ShortMap.FastEntrySet ? ((Double2ShortMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static void fastForEach(Double2ShortMap var0, Consumer<? super Double2ShortMap.Entry> var1) {
      ObjectSet var2 = var0.double2ShortEntrySet();
      if (var2 instanceof Double2ShortMap.FastEntrySet) {
         ((Double2ShortMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static ObjectIterable<Double2ShortMap.Entry> fastIterable(Double2ShortMap var0) {
      final ObjectSet var1 = var0.double2ShortEntrySet();
      return (ObjectIterable)(var1 instanceof Double2ShortMap.FastEntrySet ? new ObjectIterable<Double2ShortMap.Entry>() {
         public ObjectIterator<Double2ShortMap.Entry> iterator() {
            return ((Double2ShortMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Double2ShortMap.Entry> var1x) {
            ((Double2ShortMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }

   public static Double2ShortMap singleton(double var0, short var2) {
      return new Double2ShortMaps.Singleton(var0, var2);
   }

   public static Double2ShortMap singleton(Double var0, Short var1) {
      return new Double2ShortMaps.Singleton(var0, var1);
   }

   public static Double2ShortMap synchronize(Double2ShortMap var0) {
      return new Double2ShortMaps.SynchronizedMap(var0);
   }

   public static Double2ShortMap synchronize(Double2ShortMap var0, Object var1) {
      return new Double2ShortMaps.SynchronizedMap(var0, var1);
   }

   public static Double2ShortMap unmodifiable(Double2ShortMap var0) {
      return new Double2ShortMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap extends Double2ShortFunctions.UnmodifiableFunction implements Double2ShortMap, Serializable {
      ...
      protected UnmodifiableMap(Double2ShortMap var1) {
         super(var1);
         this.map = var1;
      }
      ...
      public void forEach(BiConsumer<? super Double, ? super Short> var1) {
         this.map.forEach(var1);
      }

      public void replaceAll(BiFunction<? super Double, ? super Short, ? extends Short> var1) {
         throw new UnsupportedOperationException();
      }
      ...
      public short computeIfAbsentPartial(double var1, Double2ShortFunction var3) {
         throw new UnsupportedOperationException();
      }
      ...
      /** @deprecated */
      @Deprecated
      public Short replace(Double var1, Short var2) {
         throw new UnsupportedOperationException();
      }

      /** @deprecated */
      @Deprecated
      public boolean replace(Double var1, Short var2, Short var3) {
         throw new UnsupportedOperationException();
      }

      /** @deprecated */
      @Deprecated
      public Short putIfAbsent(Double var1, Short var2) {
         throw new UnsupportedOperationException();
      }

      /** @deprecated */
      @Deprecated
      public Short computeIfAbsent(Double var1, Function<? super Double, ? extends Short> var2) {
         throw new UnsupportedOperationException();
      }

      /** @deprecated */
      @Deprecated
      public Short computeIfPresent(Double var1, BiFunction<? super Double, ? super Short, ? extends Short> var2) {
         throw new UnsupportedOperationException();
      }

      /** @deprecated */
      @Deprecated
      public Short compute(Double var1, BiFunction<? super Double, ? super Short, ? extends Short> var2) {
         throw new UnsupportedOperationException();
      }

      /** @deprecated */
      @Deprecated
      public Short merge(Double var1, Short var2, BiFunction<? super Short, ? super Short, ? extends Short> var3) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   public static class SynchronizedMap extends Double2ShortFunctions.SynchronizedFunction implements Double2ShortMap, Serializable {
      ...
      protected SynchronizedMap(Double2ShortMap var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Double2ShortMap var1) {
         super(var1);
         this.map = var1;
      }
