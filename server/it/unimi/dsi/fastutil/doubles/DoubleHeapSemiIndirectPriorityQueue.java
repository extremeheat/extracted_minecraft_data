...
public class DoubleHeapSemiIndirectPriorityQueue implements DoubleIndirectPriorityQueue {
   ...
   public DoubleHeapSemiIndirectPriorityQueue(double[] var1, int var2, DoubleComparator var3) {
      super();
   ...
   public DoubleHeapSemiIndirectPriorityQueue(double[] var1, int var2) {
      this(var1, var2, (DoubleComparator)null);
   }

   public DoubleHeapSemiIndirectPriorityQueue(double[] var1, DoubleComparator var2) {
      this(var1, var1.length, var2);
   }

   public DoubleHeapSemiIndirectPriorityQueue(double[] var1) {
      this(var1, var1.length, (DoubleComparator)null);
   }

   public DoubleHeapSemiIndirectPriorityQueue(double[] var1, int[] var2, int var3, DoubleComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      DoubleSemiIndirectHeaps.makeHeap(var1, var2, var3, var4);
   }
   ...
   public DoubleHeapSemiIndirectPriorityQueue(double[] var1, int[] var2, int var3) {
   ...
   public int front(int[] var1) {
      return this.c == null ? DoubleSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1) : DoubleSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1, this.c);
   }
