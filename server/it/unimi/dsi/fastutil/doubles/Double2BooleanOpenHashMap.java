...
public class Double2BooleanOpenHashMap extends AbstractDouble2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Double2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Double2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Double2BooleanOpenHashMap(Map<? extends Double, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2BooleanOpenHashMap(Map<? extends Double, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Double2BooleanOpenHashMap(Double2BooleanMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2BooleanOpenHashMap(Double2BooleanMap var1) {
      this(var1, 0.75F);
   }

   public Double2BooleanOpenHashMap(double[] var1, boolean[] var2, float var3) {
   ...
   public Double2BooleanOpenHashMap(double[] var1, boolean[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Double2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Double2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.n]);
               }

               int var2 = Double2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2BooleanOpenHashMap clone() {
      Double2BooleanOpenHashMap var1;
      try {
         var1 = (Double2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      boolean[] var3 = this.value;
      Double2BooleanOpenHashMap.MapIterator var4 = new Double2BooleanOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Double2BooleanOpenHashMap.this.key[Double2BooleanOpenHashMap.this.n]);
         }

         int var2 = Double2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2BooleanOpenHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2BooleanOpenHashMap.this.size;
         Double2BooleanOpenHashMap.this.remove(var1);
         return Double2BooleanOpenHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (Double.doubleToLongBits(var3) == 0L) {
                     return Double2BooleanOpenHashMap.this.containsNullKey && Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.n] == var5;
                  } else {
                     double[] var8 = Double2BooleanOpenHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2BooleanOpenHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double.doubleToLongBits(var3) == Double.doubleToLongBits(var6)) {
                        return Double2BooleanOpenHashMap.this.value[var9] == var5;
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2BooleanOpenHashMap.this.mask]) != 0L) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var5 = (Boolean)var2.getValue();
                  if (Double.doubleToLongBits(var3) == 0L) {
                     if (Double2BooleanOpenHashMap.this.containsNullKey && Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2BooleanOpenHashMap.this.mask]) == 0L) {
                        ...
                        if (Double2BooleanOpenHashMap.this.value[var9] == var5) {
                           Double2BooleanOpenHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2BooleanOpenHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(Double.doubleToLongBits(var6) != Double.doubleToLongBits(var3) || Double2BooleanOpenHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2BooleanMap.Entry> var1) {
         if (Double2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2BooleanMap.BasicEntry(Double2BooleanOpenHashMap.this.key[Double2BooleanOpenHashMap.this.n], Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2BooleanMap.BasicEntry(Double2BooleanOpenHashMap.this.key[var2], Double2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2BooleanMap.Entry> var1) {
         ...
         if (Double2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Double2BooleanOpenHashMap.this.key[Double2BooleanOpenHashMap.this.n];
            var2.value = Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[var3]) != 0L) {
               var2.key = Double2BooleanOpenHashMap.this.key[var3];
               var2.value = Double2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2BooleanOpenHashMap.MapIterator implements ObjectIterator<Double2BooleanMap.Entry> {
      private final Double2BooleanOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2BooleanOpenHashMap.MapIterator implements ObjectIterator<Double2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2BooleanOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2)) & Double2BooleanOpenHashMap.this.mask; Double.doubleToLongBits(var2) != Double.doubleToLongBits(var1[var4]); var4 = var4 + 1 & Double2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var4)) & Double2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2BooleanOpenHashMap.this.value[var2] = Double2BooleanOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2BooleanMap.Entry, java.util.Map.Entry<Double, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Double2BooleanOpenHashMap.this.value[this.index];
         Double2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)var2.getKey()) && Double2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
