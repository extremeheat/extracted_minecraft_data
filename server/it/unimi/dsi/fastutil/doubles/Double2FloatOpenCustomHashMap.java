...
public class Double2FloatOpenCustomHashMap extends AbstractDouble2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Double2FloatOpenCustomHashMap(int var1, float var2, DoubleHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Double2FloatOpenCustomHashMap(int var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2FloatOpenCustomHashMap(DoubleHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Double2FloatOpenCustomHashMap(Map<? extends Double, ? extends Float> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2FloatOpenCustomHashMap(Map<? extends Double, ? extends Float> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2FloatOpenCustomHashMap(Double2FloatMap var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2FloatOpenCustomHashMap(Double2FloatMap var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2FloatOpenCustomHashMap(double[] var1, float[] var2, float var3, DoubleHash.Strategy var4) {
   ...
   public Double2FloatOpenCustomHashMap(double[] var1, float[] var2, DoubleHash.Strategy var3) {
   ...
   public boolean remove(double var1, float var3) {
      if (this.strategy.equals(var1, 0.0D)) {
         ...
         if (Double.doubleToLongBits(var4 = var6[var7 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask]) == 0L) {
            return false;
         } else if (this.strategy.equals(var1, var4) && Float.floatToIntBits(var3) == Float.floatToIntBits(this.value[var7])) {
            ...
            } while(!this.strategy.equals(var1, var4) || Float.floatToIntBits(var3) != Float.floatToIntBits(this.value[var7]));
   ...
   public Double2FloatMap.FastEntrySet double2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Double2FloatOpenCustomHashMap.MapEntrySet();
      }
   ...
   public DoubleSet keySet() {
      if (this.keys == null) {
         this.keys = new Double2FloatOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            public FloatIterator iterator() {
               return Double2FloatOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(float var1) {
               return Double2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.DoubleConsumer var1) {
               if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Double2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[var2]) != 0L) {
                     var1.accept((double)Double2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2FloatOpenCustomHashMap clone() {
      Double2FloatOpenCustomHashMap var1;
      try {
         var1 = (Double2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      float[] var3 = this.value;
      Double2FloatOpenCustomHashMap.MapIterator var4 = new Double2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Double2FloatOpenCustomHashMap.MapIterator implements FloatIterator {
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleIterator iterator() {
         return Double2FloatOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Double2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2FloatOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2FloatOpenCustomHashMap.this.size;
         Double2FloatOpenCustomHashMap.this.remove(var1);
         return Double2FloatOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class KeyIterator extends Double2FloatOpenCustomHashMap.MapIterator implements DoubleIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> implements Double2FloatMap.FastEntrySet {
      ...
      public ObjectIterator<Double2FloatMap.Entry> iterator() {
         return Double2FloatOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Double2FloatMap.Entry> fastIterator() {
         return Double2FloatOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Double2FloatOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     return Double2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var5);
                  } else {
                     double[] var8 = Double2FloatOpenCustomHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2FloatOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2FloatOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[var9]) == Float.floatToIntBits(var5);
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2FloatOpenCustomHashMap.this.mask]) != 0L) {
                           if (Double2FloatOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[var9]) == Float.floatToIntBits(var5);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var5 = (Float)var2.getValue();
                  if (Double2FloatOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     if (Double2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var5)) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2FloatOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2FloatOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[var9]) == Float.floatToIntBits(var5)) {
                           Double2FloatOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2FloatOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Double2FloatOpenCustomHashMap.this.strategy.equals(var6, var3) || Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[var9]) != Float.floatToIntBits(var5));
      ...
      public void forEach(Consumer<? super Double2FloatMap.Entry> var1) {
         if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2FloatMap.BasicEntry(Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n], Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2FloatMap.BasicEntry(Double2FloatOpenCustomHashMap.this.key[var2], Double2FloatOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2FloatMap.Entry> var1) {
         ...
         if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n];
            var2.value = Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[var3]) != 0L) {
               var2.key = Double2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Double2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Double2FloatMap.Entry> {
      private final Double2FloatOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Double2FloatMap.Entry> {
      ...
      public Double2FloatOpenCustomHashMap.MapEntry next() {
         return this.entry = Double2FloatOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               return this.last = Double2FloatOpenCustomHashMap.this.n;
            } else {
               double[] var1 = Double2FloatOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Double2FloatOpenCustomHashMap.this.mask; !Double2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Double2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Double2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2FloatOpenCustomHashMap.this.value[var2] = Double2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2FloatMap.Entry, java.util.Map.Entry<Double, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Double2FloatOpenCustomHashMap.this.value[this.index];
         Double2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double2FloatOpenCustomHashMap.this.strategy.equals(Double2FloatOpenCustomHashMap.this.key[this.index], (Double)var2.getKey()) && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
