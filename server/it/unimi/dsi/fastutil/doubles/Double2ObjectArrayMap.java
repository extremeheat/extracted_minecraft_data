...
public class Double2ObjectArrayMap<V> extends AbstractDouble2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Double2ObjectArrayMap(double[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Double2ObjectArrayMap(int var1) {
      super();
      this.key = new double[var1];
      this.value = new Object[var1];
   }

   public Double2ObjectArrayMap(Double2ObjectMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Double2ObjectArrayMap(Map<? extends Double, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Double2ObjectArrayMap(double[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Double2ObjectMap.FastEntrySet<V> double2ObjectEntrySet() {
      return new Double2ObjectArrayMap.EntrySet();
   }
   ...
   public DoubleSet keySet() {
      return new AbstractDoubleSet() {
         public boolean contains(double var1) {
            return Double2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(double var1) {
            int var3 = Double2ObjectArrayMap.this.findKey(var1);
            if (var3 == -1) {
               return false;
            } else {
               int var4 = Double2ObjectArrayMap.this.size - var3 - 1;
               System.arraycopy(Double2ObjectArrayMap.this.key, var3 + 1, Double2ObjectArrayMap.this.key, var3, var4);
               System.arraycopy(Double2ObjectArrayMap.this.value, var3 + 1, Double2ObjectArrayMap.this.value, var3, var4);
            ...
            return new DoubleIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Double2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Double2ObjectArrayMap.this.key, this.pos, Double2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Double2ObjectArrayMap.this.value, this.pos, Double2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Double2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Double2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Double2ObjectArrayMap<V> clone() {
      Double2ObjectArrayMap var1;
      try {
         var1 = (Double2ObjectArrayMap)super.clone();
         ...
         return new ObjectIterator<Double2ObjectMap.Entry<V>>() {
            ...
            public Double2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractDouble2ObjectMap.BasicEntry(Double2ObjectArrayMap.this.key[this.curr = this.next], Double2ObjectArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Double2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Double2ObjectArrayMap.this.key, this.next + 1, Double2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Double2ObjectArrayMap.this.value, this.next + 1, Double2ObjectArrayMap.this.value, this.next, var1);
         ...
         return new ObjectIterator<Double2ObjectMap.Entry<V>>() {
            ...
            public Double2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Double2ObjectArrayMap.this.key[this.curr = this.next];
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               ...
               return Double2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Double2ObjectArrayMap.this.get(var3), var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               ...
               int var6 = Double2ObjectArrayMap.this.findKey(var3);
               if (var6 != -1 && Objects.equals(var5, Double2ObjectArrayMap.this.value[var6])) {
                  int var7 = Double2ObjectArrayMap.this.size - var6 - 1;
                  System.arraycopy(Double2ObjectArrayMap.this.key, var6 + 1, Double2ObjectArrayMap.this.key, var6, var7);
                  System.arraycopy(Double2ObjectArrayMap.this.value, var6 + 1, Double2ObjectArrayMap.this.value, var6, var7);
                  Double2ObjectArrayMap.this.size--;
                  Double2ObjectArrayMap.this.value[Double2ObjectArrayMap.this.size] = null;
                  return true;
               } else {
