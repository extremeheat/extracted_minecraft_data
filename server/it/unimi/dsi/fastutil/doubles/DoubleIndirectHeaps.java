...
public final class DoubleIndirectHeaps {
   ...
   public static int downHeap(double[] var0, int[] var1, int[] var2, int var3, int var4, DoubleComparator var5) {
      assert var4 < var3;
      ...
      if (var5 == null) {
         while((var9 = (var4 << 1) + 1) < var3) {
            var10 = var1[var9];
            var11 = var9 + 1;
            if (var11 < var3 && Double.compare(var0[var1[var11]], var0[var10]) < 0) {
               var9 = var11;
               var10 = var1[var11];
            }

            if (Double.compare(var7, var0[var10]) <= 0) {
               break;
            }
   ...
   public static int upHeap(double[] var0, int[] var1, int[] var2, int var3, int var4, DoubleComparator var5) {
      assert var4 < var3;
      ...
      if (var5 == null) {
         while(var4 != 0) {
            var9 = var4 - 1 >>> 1;
            var10 = var1[var9];
            if (Double.compare(var0[var10], var7) <= 0) {
               break;
            }
   ...
   public static void makeHeap(double[] var0, int var1, int var2, int[] var3, int[] var4, DoubleComparator var5) {
