...
public interface Double2ObjectMap<V> extends Double2ObjectFunction<V>, Map<Double, V> {
   ...
   default V put(Double var1, V var2) {
      return Double2ObjectFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V get(Object var1) {
      return Double2ObjectFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default V remove(Object var1) {
      return Double2ObjectFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Double2ObjectFunction.super.containsKey(var1);
   }
   ...
   default V computeIfAbsentPartial(double var1, Double2ObjectFunction<? extends V> var3) {
      Objects.requireNonNull(var3);
      Object var4 = this.get(var1);
      Object var5 = this.defaultReturnValue();
      if (var4 == var5 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<V> extends ObjectSet<Double2ObjectMap.Entry<V>> {
      ...
      default void fastForEach(Consumer<? super Double2ObjectMap.Entry<V>> var1) {
         this.forEach(var1);
      }
   }
}
