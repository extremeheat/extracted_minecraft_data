...
public class Double2LongArrayMap extends AbstractDouble2LongMap implements Serializable, Cloneable {
   ...
   public Double2LongArrayMap(double[] var1, long[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Double2LongArrayMap(int var1) {
      super();
      this.key = new double[var1];
      this.value = new long[var1];
   }

   public Double2LongArrayMap(Double2LongMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Double2LongArrayMap(Map<? extends Double, ? extends Long> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Double2LongArrayMap(double[] var1, long[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public DoubleSet keySet() {
      return new AbstractDoubleSet() {
         public boolean contains(double var1) {
            return Double2LongArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(double var1) {
            int var3 = Double2LongArrayMap.this.findKey(var1);
            if (var3 == -1) {
               return false;
            } else {
               int var4 = Double2LongArrayMap.this.size - var3 - 1;
               System.arraycopy(Double2LongArrayMap.this.key, var3 + 1, Double2LongArrayMap.this.key, var3, var4);
               System.arraycopy(Double2LongArrayMap.this.value, var3 + 1, Double2LongArrayMap.this.value, var3, var4);
            ...
            return new DoubleIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Double2LongArrayMap.this.size - this.pos;
                     System.arraycopy(Double2LongArrayMap.this.key, this.pos, Double2LongArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Double2LongArrayMap.this.value, this.pos, Double2LongArrayMap.this.value, this.pos - 1, var1);
                     Double2LongArrayMap.this.size--;
                  }
               }
            };
   ...
   public LongCollection values() {
      return new AbstractLongCollection() {
         public boolean contains(long var1) {
            return Double2LongArrayMap.this.containsValue(var1);
         }
   ...
   public Double2LongArrayMap clone() {
      Double2LongArrayMap var1;
      try {
         var1 = (Double2LongArrayMap)super.clone();
         ...
         return new ObjectIterator<Double2LongMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Double2LongArrayMap.this.size-- - this.next--;
                  System.arraycopy(Double2LongArrayMap.this.key, this.next + 1, Double2LongArrayMap.this.key, this.next, var1);
                  System.arraycopy(Double2LongArrayMap.this.value, this.next + 1, Double2LongArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  return Double2LongArrayMap.this.containsKey(var3) && Double2LongArrayMap.this.get(var3) == (Long)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  int var7 = Double2LongArrayMap.this.findKey(var3);
                  if (var7 != -1 && var5 == Double2LongArrayMap.this.value[var7]) {
                     int var8 = Double2LongArrayMap.this.size - var7 - 1;
                     System.arraycopy(Double2LongArrayMap.this.key, var7 + 1, Double2LongArrayMap.this.key, var7, var8);
                     System.arraycopy(Double2LongArrayMap.this.value, var7 + 1, Double2LongArrayMap.this.value, var7, var8);
                     Double2LongArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
