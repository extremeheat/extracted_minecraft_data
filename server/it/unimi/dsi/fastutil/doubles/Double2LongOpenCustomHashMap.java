...
public class Double2LongOpenCustomHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Double2LongOpenCustomHashMap(int var1, float var2, DoubleHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Double2LongOpenCustomHashMap(int var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2LongOpenCustomHashMap(DoubleHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Double2LongOpenCustomHashMap(Map<? extends Double, ? extends Long> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2LongOpenCustomHashMap(Map<? extends Double, ? extends Long> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2LongOpenCustomHashMap(Double2LongMap var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2LongOpenCustomHashMap(Double2LongMap var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2LongOpenCustomHashMap(double[] var1, long[] var2, float var3, DoubleHash.Strategy var4) {
   ...
   public Double2LongOpenCustomHashMap(double[] var1, long[] var2, DoubleHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Double2LongOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n]);
               }

               int var2 = Double2LongOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2LongOpenCustomHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2LongOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2LongOpenCustomHashMap clone() {
      Double2LongOpenCustomHashMap var1;
      try {
         var1 = (Double2LongOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      long[] var3 = this.value;
      Double2LongOpenCustomHashMap.MapIterator var4 = new Double2LongOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.n]);
         }

         int var2 = Double2LongOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2LongOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2LongOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2LongOpenCustomHashMap.this.size;
         Double2LongOpenCustomHashMap.this.remove(var1);
         return Double2LongOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (Double2LongOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     return Double2LongOpenCustomHashMap.this.containsNullKey && Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n] == var5;
                  } else {
                     double[] var9 = Double2LongOpenCustomHashMap.this.key;
                     double var7;
                     int var10;
                     if (Double.doubleToLongBits(var7 = var9[var10 = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2LongOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2LongOpenCustomHashMap.this.strategy.equals(var3, var7)) {
                        return Double2LongOpenCustomHashMap.this.value[var10] == var5;
                     } else {
                        while(Double.doubleToLongBits(var7 = var9[var10 = var10 + 1 & Double2LongOpenCustomHashMap.this.mask]) != 0L) {
                           if (Double2LongOpenCustomHashMap.this.strategy.equals(var3, var7)) {
                              return Double2LongOpenCustomHashMap.this.value[var10] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var5 = (Long)var2.getValue();
                  if (Double2LongOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     if (Double2LongOpenCustomHashMap.this.containsNullKey && Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var7 = var9[var10 = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2LongOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2LongOpenCustomHashMap.this.strategy.equals(var7, var3)) {
                        if (Double2LongOpenCustomHashMap.this.value[var10] == var5) {
                           Double2LongOpenCustomHashMap.this.removeEntry(var10);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var7 = var9[var10 = var10 + 1 & Double2LongOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Double2LongOpenCustomHashMap.this.strategy.equals(var7, var3) || Double2LongOpenCustomHashMap.this.value[var10] != var5);
      ...
      public void forEach(Consumer<? super Double2LongMap.Entry> var1) {
         if (Double2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.n], Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2LongOpenCustomHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongOpenCustomHashMap.this.key[var2], Double2LongOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2LongMap.Entry> var1) {
         ...
         if (Double2LongOpenCustomHashMap.this.containsNullKey) {
            var2.key = Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.n];
            var2.value = Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2LongOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2LongOpenCustomHashMap.this.key[var3]) != 0L) {
               var2.key = Double2LongOpenCustomHashMap.this.key[var3];
               var2.value = Double2LongOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Double2LongMap.Entry> {
      private final Double2LongOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2LongOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Double2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2LongOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(var2)) & Double2LongOpenCustomHashMap.this.mask; !Double2LongOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Double2LongOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2LongOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2LongOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Double2LongOpenCustomHashMap.this.strategy.hashCode(var4)) & Double2LongOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2LongOpenCustomHashMap.this.value[var2] = Double2LongOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2LongMap.Entry, java.util.Map.Entry<Double, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Double2LongOpenCustomHashMap.this.value[this.index];
         Double2LongOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double2LongOpenCustomHashMap.this.strategy.equals(Double2LongOpenCustomHashMap.this.key[this.index], (Double)var2.getKey()) && Double2LongOpenCustomHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
