...
public final class Double2ReferenceFunctions {
   ...
   public static <V> Double2ReferenceFunction<V> singleton(double var0, V var2) {
      return new Double2ReferenceFunctions.Singleton(var0, var2);
   }

   public static <V> Double2ReferenceFunction<V> singleton(Double var0, V var1) {
      return new Double2ReferenceFunctions.Singleton(var0, var1);
   }

   public static <V> Double2ReferenceFunction<V> synchronize(Double2ReferenceFunction<V> var0) {
      return new Double2ReferenceFunctions.SynchronizedFunction(var0);
   }

   public static <V> Double2ReferenceFunction<V> synchronize(Double2ReferenceFunction<V> var0, Object var1) {
      return new Double2ReferenceFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Double2ReferenceFunction<V> unmodifiable(Double2ReferenceFunction<V> var0) {
      return new Double2ReferenceFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Double2ReferenceFunction<V> primitive(Function<? super Double, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Double2ReferenceFunction) {
         return (Double2ReferenceFunction)var0;
         ...
         return new Double2ReferenceFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class UnmodifiableFunction<V> extends AbstractDouble2ReferenceFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Double2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Double2ReferenceFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Double2ReferenceFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Double2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
