...
public class DoubleArrayIndirectPriorityQueue implements DoubleIndirectPriorityQueue {
   ...
   public DoubleArrayIndirectPriorityQueue(double[] var1, int var2, DoubleComparator var3) {
      super();
   ...
   public DoubleArrayIndirectPriorityQueue(double[] var1, int var2) {
      this(var1, var2, (DoubleComparator)null);
   }

   public DoubleArrayIndirectPriorityQueue(double[] var1, DoubleComparator var2) {
      this(var1, var1.length, var2);
   }

   public DoubleArrayIndirectPriorityQueue(double[] var1) {
      this(var1, var1.length, (DoubleComparator)null);
   }

   public DoubleArrayIndirectPriorityQueue(double[] var1, int[] var2, int var3, DoubleComparator var4) {
      this(var1, 0, var4);
      this.array = var2;
      this.size = var3;
   }
   ...
   public DoubleArrayIndirectPriorityQueue(double[] var1, int[] var2, int var3) {
   ...
   private int findFirst() {
      if (this.firstIndexValid) {
         ...
         --var1;
         int var2 = var1;
         double var3 = this.refArray[this.array[var1]];
         if (this.c == null) {
            while(var1-- != 0) {
               if (Double.compare(this.refArray[this.array[var1]], var3) < 0) {
                  var2 = var1;
   ...
   private int findLast() {
      ...
      if (this.c == null) {
         while(var1-- != 0) {
            if (Double.compare(var3, this.refArray[this.array[var1]]) < 0) {
               var2 = var1;
               var3 = this.refArray[this.array[var1]];
            }
         }
   ...
   public void enqueue(int var1) {
      ...
      if (this.firstIndexValid) {
         if (this.c == null) {
            if (Double.compare(this.refArray[var1], this.refArray[this.array[this.firstIndex]]) < 0) {
   ...
   public int front(int[] var1) {
      double var2 = this.refArray[this.array[this.findFirst()]];
      int var4 = this.size;
      int var5 = 0;

      while(var4-- != 0) {
         if (Double.doubleToLongBits(var2) == Double.doubleToLongBits(this.refArray[this.array[var4]])) {
