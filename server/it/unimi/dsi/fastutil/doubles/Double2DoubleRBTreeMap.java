...
public class Double2DoubleRBTreeMap extends AbstractDouble2DoubleSortedMap implements Serializable, Cloneable {
   ...
   public Double2DoubleRBTreeMap(Comparator<? super Double> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Double2DoubleRBTreeMap(Map<? extends Double, ? extends Double> var1) {
      this();
      this.putAll(var1);
   }

   public Double2DoubleRBTreeMap(SortedMap<Double, Double> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Double2DoubleRBTreeMap(Double2DoubleMap var1) {
      this();
      this.putAll(var1);
   }

   public Double2DoubleRBTreeMap(Double2DoubleSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Double2DoubleRBTreeMap(double[] var1, double[] var2, Comparator<? super Double> var3) {
      this(var3);
   ...
   public Double2DoubleRBTreeMap(double[] var1, double[] var2) {
   ...
   final Double2DoubleRBTreeMap.Entry findKey(double var1) {
      Double2DoubleRBTreeMap.Entry var3;
      int var4;
   ...
   final Double2DoubleRBTreeMap.Entry locateKey(double var1) {
      Double2DoubleRBTreeMap.Entry var3 = this.tree;
      Double2DoubleRBTreeMap.Entry var4 = this.tree;
   ...
   public double addTo(double var1, double var3) {
      Double2DoubleRBTreeMap.Entry var5 = this.add(var1);
   ...
   private Double2DoubleRBTreeMap.Entry add(double var1) {
      this.modified = false;
      int var3 = 0;
      Double2DoubleRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Double2DoubleRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Double2DoubleRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Double2DoubleRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Double2DoubleRBTreeMap.Entry var8;
               Double2DoubleRBTreeMap.Entry var9;
   ...
   public double remove(double var1) {
      ...
      if (this.tree == null) {
         ...
         Double2DoubleRBTreeMap.Entry var9;
         Double2DoubleRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(double var1) {
      Double2DoubleRBTreeMap.ValueIterator var3 = new Double2DoubleRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public double get(double var1) {
      Double2DoubleRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>() {
            final Comparator<? super Double2DoubleMap.Entry> comparator = (var1x, var2) -> {
               return Double2DoubleRBTreeMap.this.actualComparator.compare(var1x.getDoubleKey(), var2.getDoubleKey());
            };
            ...
            public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(Double2DoubleMap.Entry var1) {
               return Double2DoubleRBTreeMap.this.new EntryIterator(var1.getDoubleKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Double) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        Double2DoubleRBTreeMap.Entry var3 = Double2DoubleRBTreeMap.this.findKey((Double)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Double) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        ...
                        if (var3 != null && Double.doubleToLongBits(var3.getDoubleValue()) == Double.doubleToLongBits((Double)var2.getValue())) {
                           Double2DoubleRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry var1, Double2DoubleMap.Entry var2) {
               return Double2DoubleRBTreeMap.this.subMap(var1.getDoubleKey(), var2.getDoubleKey()).double2DoubleEntrySet();
            }

            public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry var1) {
               return Double2DoubleRBTreeMap.this.headMap(var1.getDoubleKey()).double2DoubleEntrySet();
            }

            public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry var1) {
               return Double2DoubleRBTreeMap.this.tailMap(var1.getDoubleKey()).double2DoubleEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Double2DoubleRBTreeMap.this.containsValue(var1);
            }
   ...
   public Double2DoubleSortedMap headMap(double var1) {
      return new Double2DoubleRBTreeMap.Submap(0.0D, true, var1, false);
   }

   public Double2DoubleSortedMap tailMap(double var1) {
      return new Double2DoubleRBTreeMap.Submap(var1, false, 0.0D, true);
   }

   public Double2DoubleSortedMap subMap(double var1, double var3) {
      return new Double2DoubleRBTreeMap.Submap(var1, false, var3, false);
   }

   public Double2DoubleRBTreeMap clone() {
      Double2DoubleRBTreeMap var1;
      try {
         var1 = (Double2DoubleRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Double2DoubleRBTreeMap.Entry var5 = new Double2DoubleRBTreeMap.Entry();
         Double2DoubleRBTreeMap.Entry var6 = new Double2DoubleRBTreeMap.Entry();
         Double2DoubleRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Double2DoubleRBTreeMap.Entry var4 = var6;
         var6.pred((Double2DoubleRBTreeMap.Entry)null);

         while(true) {
            Double2DoubleRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Double2DoubleRBTreeMap.EntryIterator var3 = new Double2DoubleRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Double2DoubleRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Double2DoubleRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Double2DoubleRBTreeMap.Entry var3, Double2DoubleRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Double2DoubleRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Double2DoubleRBTreeMap.Entry(var1.readDouble(), var1.readDouble());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Double2DoubleRBTreeMap.Entry(var1.readDouble(), var1.readDouble());
         var8.black(true);
         var8.right(new Double2DoubleRBTreeMap.Entry(var1.readDouble(), var1.readDouble()));
         ...
         Double2DoubleRBTreeMap.Entry var7 = new Double2DoubleRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Double2DoubleRBTreeMap.Entry)null, (Double2DoubleRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractDouble2DoubleSortedMap implements Serializable {
      ...
      public Submap(double var2, boolean var4, double var5, boolean var7) {
         super();
         if (!var4 && !var7 && Double2DoubleRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Double2DoubleRBTreeMap.Submap.SubmapIterator var1 = new Double2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(double var1) {
         return (this.bottom || Double2DoubleRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Double2DoubleRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(double var1) {
         return this.in(var1) && Double2DoubleRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(double var1) {
         Double2DoubleRBTreeMap.Submap.SubmapIterator var3 = new Double2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      public double get(double var1) {
         Double2DoubleRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Double2DoubleRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public double put(double var1, double var3) {
         ...
         if (!this.in(var1)) {
            ...
            double var5 = Double2DoubleRBTreeMap.this.put(var1, var3);
            return Double2DoubleRBTreeMap.this.modified ? this.defRetValue : var5;
         }
      }
      ...
      public double remove(double var1) {
         ...
         if (!this.in(var1)) {
            ...
            double var3 = Double2DoubleRBTreeMap.this.remove(var1);
            return Double2DoubleRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Double2DoubleSortedMap headMap(double var1) {
         if (this.top) {
            return Double2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Double2DoubleRBTreeMap.this.compare(var1, this.to) < 0 ? Double2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Double2DoubleSortedMap tailMap(double var1) {
         if (this.bottom) {
            return Double2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Double2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? Double2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Double2DoubleSortedMap subMap(double var1, double var3) {
         if (this.top && this.bottom) {
            return Double2DoubleRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Double2DoubleRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Double2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Double2DoubleRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Double2DoubleRBTreeMap.Entry firstEntry() {
         if (Double2DoubleRBTreeMap.this.tree == null) {
            ...
            Double2DoubleRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Double2DoubleRBTreeMap.this.firstEntry;
            } else {
               var1 = Double2DoubleRBTreeMap.this.locateKey(this.from);
               if (Double2DoubleRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Double2DoubleRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Double2DoubleRBTreeMap.Entry lastEntry() {
         if (Double2DoubleRBTreeMap.this.tree == null) {
            ...
            Double2DoubleRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Double2DoubleRBTreeMap.this.lastEntry;
            } else {
               var1 = Double2DoubleRBTreeMap.this.locateKey(this.to);
               if (Double2DoubleRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Double2DoubleRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public double firstDoubleKey() {
         Double2DoubleRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public double lastDoubleKey() {
         Double2DoubleRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Double2DoubleRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Double2DoubleMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Double2DoubleRBTreeMap.TreeIterator {
         ...
         SubmapIterator(double var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Double2DoubleRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Double2DoubleRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Double2DoubleRBTreeMap.this.locateKey(var2);
                  if (Double2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractDouble2DoubleSortedMap.KeySet {
      ...
      public DoubleBidirectionalIterator iterator(double var1) {
         return Double2DoubleRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Double2DoubleRBTreeMap.TreeIterator implements ObjectListIterator<Double2DoubleMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(double var2) {
         super();
         if ((this.next = Double2DoubleRBTreeMap.this.locateKey(var2)) != null) {
            if (Double2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractDouble2DoubleMap.BasicEntry implements Cloneable {
      ...
      void pred(Double2DoubleRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Double2DoubleRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Double2DoubleRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Double2DoubleRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Double2DoubleRBTreeMap.Entry next() {
         Double2DoubleRBTreeMap.Entry var1 = this.right;
      ...
      Double2DoubleRBTreeMap.Entry prev() {
         Double2DoubleRBTreeMap.Entry var1 = this.left;
      ...
      public Double2DoubleRBTreeMap.Entry clone() {
         Double2DoubleRBTreeMap.Entry var1;
         try {
            var1 = (Double2DoubleRBTreeMap.Entry)super.clone();
