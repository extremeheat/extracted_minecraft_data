...
public class Double2ReferenceOpenCustomHashMap<V> extends AbstractDouble2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Double2ReferenceOpenCustomHashMap(int var1, float var2, DoubleHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Double2ReferenceOpenCustomHashMap(int var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ReferenceOpenCustomHashMap(DoubleHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Double2ReferenceOpenCustomHashMap(Map<? extends Double, ? extends V> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2ReferenceOpenCustomHashMap(Map<? extends Double, ? extends V> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ReferenceOpenCustomHashMap(Double2ReferenceMap<V> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2ReferenceOpenCustomHashMap(Double2ReferenceMap<V> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ReferenceOpenCustomHashMap(double[] var1, V[] var2, float var3, DoubleHash.Strategy var4) {
   ...
   public Double2ReferenceOpenCustomHashMap(double[] var1, V[] var2, DoubleHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Double2ReferenceOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Double2ReferenceOpenCustomHashMap.this.value[Double2ReferenceOpenCustomHashMap.this.n]);
               }

               int var2 = Double2ReferenceOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2ReferenceOpenCustomHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2ReferenceOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2ReferenceOpenCustomHashMap<V> clone() {
      Double2ReferenceOpenCustomHashMap var1;
      try {
         var1 = (Double2ReferenceOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      Object[] var3 = this.value;
      Double2ReferenceOpenCustomHashMap.MapIterator var4 = new Double2ReferenceOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Double2ReferenceOpenCustomHashMap.this.key[Double2ReferenceOpenCustomHashMap.this.n]);
         }

         int var2 = Double2ReferenceOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2ReferenceOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2ReferenceOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2ReferenceOpenCustomHashMap.this.size;
         Double2ReferenceOpenCustomHashMap.this.remove(var1);
         return Double2ReferenceOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry<V>> implements Double2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               ...
               if (Double2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                  return Double2ReferenceOpenCustomHashMap.this.containsNullKey && Double2ReferenceOpenCustomHashMap.this.value[Double2ReferenceOpenCustomHashMap.this.n] == var5;
               } else {
                  double[] var8 = Double2ReferenceOpenCustomHashMap.this.key;
                  double var6;
                  int var9;
                  if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2ReferenceOpenCustomHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Double2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                     return Double2ReferenceOpenCustomHashMap.this.value[var9] == var5;
                  } else {
                     while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ReferenceOpenCustomHashMap.this.mask]) != 0L) {
                        if (Double2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                           return Double2ReferenceOpenCustomHashMap.this.value[var9] == var5;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               ...
               Object var5 = var2.getValue();
               if (Double2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                  if (Double2ReferenceOpenCustomHashMap.this.containsNullKey && Double2ReferenceOpenCustomHashMap.this.value[Double2ReferenceOpenCustomHashMap.this.n] == var5) {
                  ...
                  if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2ReferenceOpenCustomHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Double2ReferenceOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                     if (Double2ReferenceOpenCustomHashMap.this.value[var9] == var5) {
                        Double2ReferenceOpenCustomHashMap.this.removeEntry(var9);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ReferenceOpenCustomHashMap.this.mask]) == 0L) {
                           return false;
                        }
                     } while(!Double2ReferenceOpenCustomHashMap.this.strategy.equals(var6, var3) || Double2ReferenceOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> var1) {
         if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2ReferenceMap.BasicEntry(Double2ReferenceOpenCustomHashMap.this.key[Double2ReferenceOpenCustomHashMap.this.n], Double2ReferenceOpenCustomHashMap.this.value[Double2ReferenceOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2ReferenceOpenCustomHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2ReferenceMap.BasicEntry(Double2ReferenceOpenCustomHashMap.this.key[var2], Double2ReferenceOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2ReferenceMap.Entry<V>> var1) {
         ...
         if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var2.key = Double2ReferenceOpenCustomHashMap.this.key[Double2ReferenceOpenCustomHashMap.this.n];
            var2.value = Double2ReferenceOpenCustomHashMap.this.value[Double2ReferenceOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2ReferenceOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2ReferenceOpenCustomHashMap.this.key[var3]) != 0L) {
               var2.key = Double2ReferenceOpenCustomHashMap.this.key[var3];
               var2.value = Double2ReferenceOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
      private final Double2ReferenceOpenCustomHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2ReferenceOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2ReferenceOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Double2ReferenceOpenCustomHashMap.this.strategy.hashCode(var2)) & Double2ReferenceOpenCustomHashMap.this.mask; !Double2ReferenceOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Double2ReferenceOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2ReferenceOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2ReferenceOpenCustomHashMap.this.mask;

            double var4;
            while(true) {
               if (Double.doubleToLongBits(var4 = var6[var1]) == 0L) {
                  var6[var2] = 0.0D;
                  Double2ReferenceOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Double2ReferenceOpenCustomHashMap.this.strategy.hashCode(var4)) & Double2ReferenceOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2ReferenceOpenCustomHashMap.this.value[var2] = Double2ReferenceOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2ReferenceMap.Entry<V>, java.util.Map.Entry<Double, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Double2ReferenceOpenCustomHashMap.this.value[this.index];
         Double2ReferenceOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double2ReferenceOpenCustomHashMap.this.strategy.equals(Double2ReferenceOpenCustomHashMap.this.key[this.index], (Double)var2.getKey()) && Double2ReferenceOpenCustomHashMap.this.value[this.index] == var2.getValue();
         }
      }
