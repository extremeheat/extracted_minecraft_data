...
public class Double2ShortOpenCustomHashMap extends AbstractDouble2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Double2ShortOpenCustomHashMap(int var1, float var2, DoubleHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Double2ShortOpenCustomHashMap(int var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ShortOpenCustomHashMap(DoubleHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Double2ShortOpenCustomHashMap(Map<? extends Double, ? extends Short> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2ShortOpenCustomHashMap(Map<? extends Double, ? extends Short> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ShortOpenCustomHashMap(Double2ShortMap var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2ShortOpenCustomHashMap(Double2ShortMap var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ShortOpenCustomHashMap(double[] var1, short[] var2, float var3, DoubleHash.Strategy var4) {
   ...
   public Double2ShortOpenCustomHashMap(double[] var1, short[] var2, DoubleHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Double2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Double2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Double2ShortOpenCustomHashMap.this.value[Double2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Double2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2ShortOpenCustomHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2ShortOpenCustomHashMap clone() {
      Double2ShortOpenCustomHashMap var1;
      try {
         var1 = (Double2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      short[] var3 = this.value;
      Double2ShortOpenCustomHashMap.MapIterator var4 = new Double2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Double2ShortOpenCustomHashMap.this.key[Double2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Double2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2ShortOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2ShortOpenCustomHashMap.this.size;
         Double2ShortOpenCustomHashMap.this.remove(var1);
         return Double2ShortOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry> implements Double2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Double2ShortOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     return Double2ShortOpenCustomHashMap.this.containsNullKey && Double2ShortOpenCustomHashMap.this.value[Double2ShortOpenCustomHashMap.this.n] == var5;
                  } else {
                     double[] var8 = Double2ShortOpenCustomHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2ShortOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2ShortOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Double2ShortOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ShortOpenCustomHashMap.this.mask]) != 0L) {
                           if (Double2ShortOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Double2ShortOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var5 = (Short)var2.getValue();
                  if (Double2ShortOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     if (Double2ShortOpenCustomHashMap.this.containsNullKey && Double2ShortOpenCustomHashMap.this.value[Double2ShortOpenCustomHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2ShortOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2ShortOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Double2ShortOpenCustomHashMap.this.value[var9] == var5) {
                           Double2ShortOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ShortOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Double2ShortOpenCustomHashMap.this.strategy.equals(var6, var3) || Double2ShortOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2ShortMap.Entry> var1) {
         if (Double2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2ShortMap.BasicEntry(Double2ShortOpenCustomHashMap.this.key[Double2ShortOpenCustomHashMap.this.n], Double2ShortOpenCustomHashMap.this.value[Double2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2ShortOpenCustomHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2ShortMap.BasicEntry(Double2ShortOpenCustomHashMap.this.key[var2], Double2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2ShortMap.Entry> var1) {
         ...
         if (Double2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Double2ShortOpenCustomHashMap.this.key[Double2ShortOpenCustomHashMap.this.n];
            var2.value = Double2ShortOpenCustomHashMap.this.value[Double2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2ShortOpenCustomHashMap.this.key[var3]) != 0L) {
               var2.key = Double2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Double2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Double2ShortMap.Entry> {
      private final Double2ShortOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Double2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2ShortOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Double2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Double2ShortOpenCustomHashMap.this.mask; !Double2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Double2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Double2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Double2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2ShortOpenCustomHashMap.this.value[var2] = Double2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2ShortMap.Entry, java.util.Map.Entry<Double, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Double2ShortOpenCustomHashMap.this.value[this.index];
         Double2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double2ShortOpenCustomHashMap.this.strategy.equals(Double2ShortOpenCustomHashMap.this.key[this.index], (Double)var2.getKey()) && Double2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
