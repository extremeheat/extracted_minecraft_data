...
public class Double2BooleanOpenCustomHashMap extends AbstractDouble2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Double2BooleanOpenCustomHashMap(int var1, float var2, DoubleHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Double2BooleanOpenCustomHashMap(int var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2BooleanOpenCustomHashMap(DoubleHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Double2BooleanOpenCustomHashMap(Map<? extends Double, ? extends Boolean> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2BooleanOpenCustomHashMap(Map<? extends Double, ? extends Boolean> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2BooleanOpenCustomHashMap(Double2BooleanMap var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2BooleanOpenCustomHashMap(Double2BooleanMap var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2BooleanOpenCustomHashMap(double[] var1, boolean[] var2, float var3, DoubleHash.Strategy var4) {
   ...
   public Double2BooleanOpenCustomHashMap(double[] var1, boolean[] var2, DoubleHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Double2BooleanOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Double2BooleanOpenCustomHashMap.this.value[Double2BooleanOpenCustomHashMap.this.n]);
               }

               int var2 = Double2BooleanOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2BooleanOpenCustomHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2BooleanOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2BooleanOpenCustomHashMap clone() {
      Double2BooleanOpenCustomHashMap var1;
      try {
         var1 = (Double2BooleanOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      boolean[] var3 = this.value;
      Double2BooleanOpenCustomHashMap.MapIterator var4 = new Double2BooleanOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Double2BooleanOpenCustomHashMap.this.key[Double2BooleanOpenCustomHashMap.this.n]);
         }

         int var2 = Double2BooleanOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2BooleanOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2BooleanOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2BooleanOpenCustomHashMap.this.size;
         Double2BooleanOpenCustomHashMap.this.remove(var1);
         return Double2BooleanOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (Double2BooleanOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     return Double2BooleanOpenCustomHashMap.this.containsNullKey && Double2BooleanOpenCustomHashMap.this.value[Double2BooleanOpenCustomHashMap.this.n] == var5;
                  } else {
                     double[] var8 = Double2BooleanOpenCustomHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2BooleanOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2BooleanOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Double2BooleanOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2BooleanOpenCustomHashMap.this.mask]) != 0L) {
                           if (Double2BooleanOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Double2BooleanOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var5 = (Boolean)var2.getValue();
                  if (Double2BooleanOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     if (Double2BooleanOpenCustomHashMap.this.containsNullKey && Double2BooleanOpenCustomHashMap.this.value[Double2BooleanOpenCustomHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2BooleanOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2BooleanOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Double2BooleanOpenCustomHashMap.this.value[var9] == var5) {
                           Double2BooleanOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2BooleanOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Double2BooleanOpenCustomHashMap.this.strategy.equals(var6, var3) || Double2BooleanOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2BooleanMap.Entry> var1) {
         if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2BooleanMap.BasicEntry(Double2BooleanOpenCustomHashMap.this.key[Double2BooleanOpenCustomHashMap.this.n], Double2BooleanOpenCustomHashMap.this.value[Double2BooleanOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2BooleanOpenCustomHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2BooleanMap.BasicEntry(Double2BooleanOpenCustomHashMap.this.key[var2], Double2BooleanOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2BooleanMap.Entry> var1) {
         ...
         if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
            var2.key = Double2BooleanOpenCustomHashMap.this.key[Double2BooleanOpenCustomHashMap.this.n];
            var2.value = Double2BooleanOpenCustomHashMap.this.value[Double2BooleanOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2BooleanOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2BooleanOpenCustomHashMap.this.key[var3]) != 0L) {
               var2.key = Double2BooleanOpenCustomHashMap.this.key[var3];
               var2.value = Double2BooleanOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Double2BooleanMap.Entry> {
      private final Double2BooleanOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2BooleanOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Double2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2BooleanOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Double2BooleanOpenCustomHashMap.this.strategy.hashCode(var2)) & Double2BooleanOpenCustomHashMap.this.mask; !Double2BooleanOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Double2BooleanOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2BooleanOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2BooleanOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Double2BooleanOpenCustomHashMap.this.strategy.hashCode(var4)) & Double2BooleanOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2BooleanOpenCustomHashMap.this.value[var2] = Double2BooleanOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2BooleanMap.Entry, java.util.Map.Entry<Double, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Double2BooleanOpenCustomHashMap.this.value[this.index];
         Double2BooleanOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double2BooleanOpenCustomHashMap.this.strategy.equals(Double2BooleanOpenCustomHashMap.this.key[this.index], (Double)var2.getKey()) && Double2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
