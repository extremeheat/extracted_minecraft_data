...
public class Double2LongRBTreeMap extends AbstractDouble2LongSortedMap implements Serializable, Cloneable {
   ...
   public Double2LongRBTreeMap(Comparator<? super Double> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Double2LongRBTreeMap(Map<? extends Double, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Double2LongRBTreeMap(SortedMap<Double, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Double2LongRBTreeMap(Double2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Double2LongRBTreeMap(Double2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Double2LongRBTreeMap(double[] var1, long[] var2, Comparator<? super Double> var3) {
      this(var3);
   ...
   public Double2LongRBTreeMap(double[] var1, long[] var2) {
   ...
   final Double2LongRBTreeMap.Entry findKey(double var1) {
      Double2LongRBTreeMap.Entry var3;
      int var4;
   ...
   final Double2LongRBTreeMap.Entry locateKey(double var1) {
      Double2LongRBTreeMap.Entry var3 = this.tree;
      Double2LongRBTreeMap.Entry var4 = this.tree;
   ...
   public long addTo(double var1, long var3) {
      Double2LongRBTreeMap.Entry var5 = this.add(var1);
   ...
   private Double2LongRBTreeMap.Entry add(double var1) {
      this.modified = false;
      int var3 = 0;
      Double2LongRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Double2LongRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Double2LongRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Double2LongRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Double2LongRBTreeMap.Entry var8;
               Double2LongRBTreeMap.Entry var9;
   ...
   public long remove(double var1) {
      ...
      if (this.tree == null) {
         ...
         Double2LongRBTreeMap.Entry var9;
         Double2LongRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(long var1) {
      Double2LongRBTreeMap.ValueIterator var3 = new Double2LongRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(double var1) {
      Double2LongRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() {
            final Comparator<? super Double2LongMap.Entry> comparator = (var1x, var2) -> {
               return Double2LongRBTreeMap.this.actualComparator.compare(var1x.getDoubleKey(), var2.getDoubleKey());
            };
            ...
            public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry var1) {
               return Double2LongRBTreeMap.this.new EntryIterator(var1.getDoubleKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Double) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Double2LongRBTreeMap.Entry var3 = Double2LongRBTreeMap.this.findKey((Double)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Double) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Double2LongRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry var1, Double2LongMap.Entry var2) {
               return Double2LongRBTreeMap.this.subMap(var1.getDoubleKey(), var2.getDoubleKey()).double2LongEntrySet();
            }

            public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry var1) {
               return Double2LongRBTreeMap.this.headMap(var1.getDoubleKey()).double2LongEntrySet();
            }

            public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry var1) {
               return Double2LongRBTreeMap.this.tailMap(var1.getDoubleKey()).double2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Double2LongRBTreeMap.this.containsValue(var1);
            }
   ...
   public Double2LongSortedMap headMap(double var1) {
      return new Double2LongRBTreeMap.Submap(0.0D, true, var1, false);
   }

   public Double2LongSortedMap tailMap(double var1) {
      return new Double2LongRBTreeMap.Submap(var1, false, 0.0D, true);
   }

   public Double2LongSortedMap subMap(double var1, double var3) {
      return new Double2LongRBTreeMap.Submap(var1, false, var3, false);
   }

   public Double2LongRBTreeMap clone() {
      Double2LongRBTreeMap var1;
      try {
         var1 = (Double2LongRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Double2LongRBTreeMap.Entry var5 = new Double2LongRBTreeMap.Entry();
         Double2LongRBTreeMap.Entry var6 = new Double2LongRBTreeMap.Entry();
         Double2LongRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Double2LongRBTreeMap.Entry var4 = var6;
         var6.pred((Double2LongRBTreeMap.Entry)null);

         while(true) {
            Double2LongRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Double2LongRBTreeMap.EntryIterator var3 = new Double2LongRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Double2LongRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Double2LongRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Double2LongRBTreeMap.Entry var3, Double2LongRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Double2LongRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Double2LongRBTreeMap.Entry(var1.readDouble(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Double2LongRBTreeMap.Entry(var1.readDouble(), var1.readLong());
         var8.black(true);
         var8.right(new Double2LongRBTreeMap.Entry(var1.readDouble(), var1.readLong()));
         ...
         Double2LongRBTreeMap.Entry var7 = new Double2LongRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Double2LongRBTreeMap.Entry)null, (Double2LongRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractDouble2LongSortedMap implements Serializable {
      ...
      public Submap(double var2, boolean var4, double var5, boolean var7) {
         super();
         if (!var4 && !var7 && Double2LongRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Double2LongRBTreeMap.Submap.SubmapIterator var1 = new Double2LongRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(double var1) {
         return (this.bottom || Double2LongRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Double2LongRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(double var1) {
         return this.in(var1) && Double2LongRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Double2LongRBTreeMap.Submap.SubmapIterator var3 = new Double2LongRBTreeMap.Submap.SubmapIterator();
      ...
      public long get(double var1) {
         Double2LongRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Double2LongRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public long put(double var1, long var3) {
         ...
         if (!this.in(var1)) {
            ...
            long var5 = Double2LongRBTreeMap.this.put(var1, var3);
            return Double2LongRBTreeMap.this.modified ? this.defRetValue : var5;
         }
      }
      ...
      public long remove(double var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var3 = Double2LongRBTreeMap.this.remove(var1);
            return Double2LongRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Double2LongSortedMap headMap(double var1) {
         if (this.top) {
            return Double2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Double2LongRBTreeMap.this.compare(var1, this.to) < 0 ? Double2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Double2LongSortedMap tailMap(double var1) {
         if (this.bottom) {
            return Double2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Double2LongRBTreeMap.this.compare(var1, this.from) > 0 ? Double2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Double2LongSortedMap subMap(double var1, double var3) {
         if (this.top && this.bottom) {
            return Double2LongRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Double2LongRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Double2LongRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Double2LongRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Double2LongRBTreeMap.Entry firstEntry() {
         if (Double2LongRBTreeMap.this.tree == null) {
            ...
            Double2LongRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Double2LongRBTreeMap.this.firstEntry;
            } else {
               var1 = Double2LongRBTreeMap.this.locateKey(this.from);
               if (Double2LongRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Double2LongRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Double2LongRBTreeMap.Entry lastEntry() {
         if (Double2LongRBTreeMap.this.tree == null) {
            ...
            Double2LongRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Double2LongRBTreeMap.this.lastEntry;
            } else {
               var1 = Double2LongRBTreeMap.this.locateKey(this.to);
               if (Double2LongRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Double2LongRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public double firstDoubleKey() {
         Double2LongRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public double lastDoubleKey() {
         Double2LongRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Double2LongRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Double2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Double2LongRBTreeMap.TreeIterator {
         ...
         SubmapIterator(double var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Double2LongRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Double2LongRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Double2LongRBTreeMap.this.locateKey(var2);
                  if (Double2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractDouble2LongSortedMap.KeySet {
      ...
      public DoubleBidirectionalIterator iterator(double var1) {
         return Double2LongRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Double2LongRBTreeMap.TreeIterator implements ObjectListIterator<Double2LongMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(double var2) {
         super();
         if ((this.next = Double2LongRBTreeMap.this.locateKey(var2)) != null) {
            if (Double2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractDouble2LongMap.BasicEntry implements Cloneable {
      ...
      void pred(Double2LongRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Double2LongRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Double2LongRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Double2LongRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Double2LongRBTreeMap.Entry next() {
         Double2LongRBTreeMap.Entry var1 = this.right;
      ...
      Double2LongRBTreeMap.Entry prev() {
         Double2LongRBTreeMap.Entry var1 = this.left;
      ...
      public Double2LongRBTreeMap.Entry clone() {
         Double2LongRBTreeMap.Entry var1;
         try {
            var1 = (Double2LongRBTreeMap.Entry)super.clone();
