...
public class DoubleLinkedOpenHashSet extends AbstractDoubleSortedSet implements Serializable, Cloneable, Hash {
   ...
   public DoubleLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public DoubleLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public DoubleLinkedOpenHashSet(Collection<? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public DoubleLinkedOpenHashSet(Collection<? extends Double> var1) {
      this(var1, 0.75F);
   }

   public DoubleLinkedOpenHashSet(DoubleCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public DoubleLinkedOpenHashSet(DoubleCollection var1) {
      this(var1, 0.75F);
   }

   public DoubleLinkedOpenHashSet(DoubleIterator var1, float var2) {
      this(16, var2);
   ...
   public DoubleLinkedOpenHashSet(DoubleIterator var1) {
      this(var1, 0.75F);
   }

   public DoubleLinkedOpenHashSet(Iterator<?> var1, float var2) {
      this(DoubleIterators.asDoubleIterator(var1), var2);
   }

   public DoubleLinkedOpenHashSet(Iterator<?> var1) {
      this(DoubleIterators.asDoubleIterator(var1));
   }

   public DoubleLinkedOpenHashSet(double[] var1, int var2, int var3, float var4) {
   ...
   public DoubleLinkedOpenHashSet(double[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public DoubleLinkedOpenHashSet(double[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public DoubleLinkedOpenHashSet(double[] var1) {
      this(var1, 0.75F);
   }
   ...
   public boolean add(double var1) {
      ...
      if (Double.doubleToLongBits(var1) == 0L) {
         ...
         double var4;
         if (Double.doubleToLongBits(var4 = var6[var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var1)) & this.mask]) != 0L) {
            if (Double.doubleToLongBits(var4) == Double.doubleToLongBits(var1)) {
               return false;
            }
   ...
   public boolean addAndMoveToFirst(double var1) {
      ...
      if (Double.doubleToLongBits(var1) == 0L) {
         ...
         for(var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var1)) & this.mask; Double.doubleToLongBits(var4[var3]) != 0L; var3 = var3 + 1 & this.mask) {
            if (Double.doubleToLongBits(var1) == Double.doubleToLongBits(var4[var3])) {
   ...
   public DoubleListIterator iterator(double var1) {
      return new DoubleLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         int var9;
         if (Double.doubleToLongBits(var2[var5]) == 0L) {
            var9 = var1;
         } else {
            for(var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2[var5])) & var3; Double.doubleToLongBits(var4[var9]) != 0L; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public DoubleLinkedOpenHashSet clone() {
      DoubleLinkedOpenHashSet var1;
      try {
         var1 = (DoubleLinkedOpenHashSet)super.clone();
   ...
   public int hashCode() {
      ...
      for(int var3 = 0; var2-- != 0; ++var3) {
         ...
         var1 += HashCommon.double2int(this.key[var3]);
      }
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var7-- != 0) {
         ...
         if (Double.doubleToLongBits(var5) == 0L) {
            var8 = this.n;
            this.containsNull = true;
         } else if (Double.doubleToLongBits(var2[var8 = (int)HashCommon.mix(Double.doubleToRawLongBits(var5)) & this.mask]) != 0L) {
   ...
   private class SetIterator implements DoubleListIterator {
      ...
      SetIterator(double var2) {
         ...
         } else if (Double.doubleToLongBits(DoubleLinkedOpenHashSet.this.key[DoubleLinkedOpenHashSet.this.last]) == Double.doubleToLongBits(var2)) {
            this.prev = DoubleLinkedOpenHashSet.this.last;
            this.index = DoubleLinkedOpenHashSet.this.size;
         } else {
            double[] var4 = DoubleLinkedOpenHashSet.this.key;

            for(int var5 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2)) & DoubleLinkedOpenHashSet.this.mask; Double.doubleToLongBits(var4[var5]) != 0L; var5 = var5 + 1 & DoubleLinkedOpenHashSet.this.mask) {
               if (Double.doubleToLongBits(var4[var5]) == Double.doubleToLongBits(var2)) {
                  this.next = (int)DoubleLinkedOpenHashSet.this.link[var5];
                  this.prev = var5;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = DoubleLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)DoubleLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var7 = DoubleLinkedOpenHashSet.this.link;
               var10001 = this.prev;
               var7[var10001] ^= (DoubleLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var7 = DoubleLinkedOpenHashSet.this.link;
               var10001 = this.next;
               var7[var10001] ^= (DoubleLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == DoubleLinkedOpenHashSet.this.n) {
               DoubleLinkedOpenHashSet.this.containsNull = false;
               DoubleLinkedOpenHashSet.this.key[DoubleLinkedOpenHashSet.this.n] = 0.0D;
            } else {
               double[] var6 = DoubleLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & DoubleLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = (int)HashCommon.mix(Double.doubleToRawLongBits(var4)) & DoubleLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  DoubleLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
