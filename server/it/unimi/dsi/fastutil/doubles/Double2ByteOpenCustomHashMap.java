...
public class Double2ByteOpenCustomHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Double2ByteOpenCustomHashMap(int var1, float var2, DoubleHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Double2ByteOpenCustomHashMap(int var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ByteOpenCustomHashMap(DoubleHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Double2ByteOpenCustomHashMap(Map<? extends Double, ? extends Byte> var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2ByteOpenCustomHashMap(Map<? extends Double, ? extends Byte> var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ByteOpenCustomHashMap(Double2ByteMap var1, float var2, DoubleHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Double2ByteOpenCustomHashMap(Double2ByteMap var1, DoubleHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Double2ByteOpenCustomHashMap(double[] var1, byte[] var2, float var3, DoubleHash.Strategy var4) {
   ...
   public Double2ByteOpenCustomHashMap(double[] var1, byte[] var2, DoubleHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Double2ByteOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n]);
               }

               int var2 = Double2ByteOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2ByteOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2ByteOpenCustomHashMap clone() {
      Double2ByteOpenCustomHashMap var1;
      try {
         var1 = (Double2ByteOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      byte[] var3 = this.value;
      Double2ByteOpenCustomHashMap.MapIterator var4 = new Double2ByteOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Double2ByteOpenCustomHashMap.this.key[Double2ByteOpenCustomHashMap.this.n]);
         }

         int var2 = Double2ByteOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2ByteOpenCustomHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2ByteOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2ByteOpenCustomHashMap.this.size;
         Double2ByteOpenCustomHashMap.this.remove(var1);
         return Double2ByteOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (Double2ByteOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     return Double2ByteOpenCustomHashMap.this.containsNullKey && Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n] == var5;
                  } else {
                     double[] var8 = Double2ByteOpenCustomHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2ByteOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2ByteOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Double2ByteOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ByteOpenCustomHashMap.this.mask]) != 0L) {
                           if (Double2ByteOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Double2ByteOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var5 = (Byte)var2.getValue();
                  if (Double2ByteOpenCustomHashMap.this.strategy.equals(var3, 0.0D)) {
                     if (Double2ByteOpenCustomHashMap.this.containsNullKey && Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Double2ByteOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double2ByteOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Double2ByteOpenCustomHashMap.this.value[var9] == var5) {
                           Double2ByteOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ByteOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Double2ByteOpenCustomHashMap.this.strategy.equals(var6, var3) || Double2ByteOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2ByteMap.Entry> var1) {
         if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenCustomHashMap.this.key[Double2ByteOpenCustomHashMap.this.n], Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenCustomHashMap.this.key[var2], Double2ByteOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2ByteMap.Entry> var1) {
         ...
         if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
            var2.key = Double2ByteOpenCustomHashMap.this.key[Double2ByteOpenCustomHashMap.this.n];
            var2.value = Double2ByteOpenCustomHashMap.this.value[Double2ByteOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2ByteOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[var3]) != 0L) {
               var2.key = Double2ByteOpenCustomHashMap.this.key[var3];
               var2.value = Double2ByteOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Double2ByteMap.Entry> {
      private final Double2ByteOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2ByteOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Double2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2ByteOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(var2)) & Double2ByteOpenCustomHashMap.this.mask; !Double2ByteOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Double2ByteOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2ByteOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2ByteOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Double2ByteOpenCustomHashMap.this.strategy.hashCode(var4)) & Double2ByteOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2ByteOpenCustomHashMap.this.value[var2] = Double2ByteOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2ByteMap.Entry, java.util.Map.Entry<Double, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Double2ByteOpenCustomHashMap.this.value[this.index];
         Double2ByteOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double2ByteOpenCustomHashMap.this.strategy.equals(Double2ByteOpenCustomHashMap.this.key[this.index], (Double)var2.getKey()) && Double2ByteOpenCustomHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
