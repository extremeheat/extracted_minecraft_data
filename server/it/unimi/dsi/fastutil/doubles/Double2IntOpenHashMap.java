...
public class Double2IntOpenHashMap extends AbstractDouble2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Double2IntOpenHashMap(int var1, float var2) {
      super();
   ...
   public Double2IntOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Double2IntOpenHashMap(Map<? extends Double, ? extends Integer> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2IntOpenHashMap(Map<? extends Double, ? extends Integer> var1) {
      this(var1, 0.75F);
   }

   public Double2IntOpenHashMap(Double2IntMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2IntOpenHashMap(Double2IntMap var1) {
      this(var1, 0.75F);
   }

   public Double2IntOpenHashMap(double[] var1, int[] var2, float var3) {
   ...
   public Double2IntOpenHashMap(double[] var1, int[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Double2IntOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Double2IntOpenHashMap.this.containsNullKey) {
                  var1.accept(Double2IntOpenHashMap.this.value[Double2IntOpenHashMap.this.n]);
               }

               int var2 = Double2IntOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2IntOpenHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2IntOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2IntOpenHashMap clone() {
      Double2IntOpenHashMap var1;
      try {
         var1 = (Double2IntOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      int[] var3 = this.value;
      Double2IntOpenHashMap.MapIterator var4 = new Double2IntOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2IntOpenHashMap.this.containsNullKey) {
            var1.accept(Double2IntOpenHashMap.this.key[Double2IntOpenHashMap.this.n]);
         }

         int var2 = Double2IntOpenHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2IntOpenHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2IntOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2IntOpenHashMap.this.size;
         Double2IntOpenHashMap.this.remove(var1);
         return Double2IntOpenHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry> implements Double2IntMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (Double.doubleToLongBits(var3) == 0L) {
                     return Double2IntOpenHashMap.this.containsNullKey && Double2IntOpenHashMap.this.value[Double2IntOpenHashMap.this.n] == var5;
                  } else {
                     double[] var8 = Double2IntOpenHashMap.this.key;
                     double var6;
                     int var9;
                     if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2IntOpenHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Double.doubleToLongBits(var3) == Double.doubleToLongBits(var6)) {
                        return Double2IntOpenHashMap.this.value[var9] == var5;
                     } else {
                        while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2IntOpenHashMap.this.mask]) != 0L) {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var5 = (Integer)var2.getValue();
                  if (Double.doubleToLongBits(var3) == 0L) {
                     if (Double2IntOpenHashMap.this.containsNullKey && Double2IntOpenHashMap.this.value[Double2IntOpenHashMap.this.n] == var5) {
                     ...
                     if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2IntOpenHashMap.this.mask]) == 0L) {
                        ...
                        if (Double2IntOpenHashMap.this.value[var9] == var5) {
                           Double2IntOpenHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2IntOpenHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(Double.doubleToLongBits(var6) != Double.doubleToLongBits(var3) || Double2IntOpenHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Double2IntMap.Entry> var1) {
         if (Double2IntOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2IntMap.BasicEntry(Double2IntOpenHashMap.this.key[Double2IntOpenHashMap.this.n], Double2IntOpenHashMap.this.value[Double2IntOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2IntOpenHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2IntMap.BasicEntry(Double2IntOpenHashMap.this.key[var2], Double2IntOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2IntMap.Entry> var1) {
         ...
         if (Double2IntOpenHashMap.this.containsNullKey) {
            var2.key = Double2IntOpenHashMap.this.key[Double2IntOpenHashMap.this.n];
            var2.value = Double2IntOpenHashMap.this.value[Double2IntOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2IntOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2IntOpenHashMap.this.key[var3]) != 0L) {
               var2.key = Double2IntOpenHashMap.this.key[var3];
               var2.value = Double2IntOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2IntOpenHashMap.MapIterator implements ObjectIterator<Double2IntMap.Entry> {
      private final Double2IntOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2IntOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2IntOpenHashMap.MapIterator implements ObjectIterator<Double2IntMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2IntOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2)) & Double2IntOpenHashMap.this.mask; Double.doubleToLongBits(var2) != Double.doubleToLongBits(var1[var4]); var4 = var4 + 1 & Double2IntOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2IntOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2IntOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var4)) & Double2IntOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2IntOpenHashMap.this.value[var2] = Double2IntOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2IntMap.Entry, java.util.Map.Entry<Double, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Double2IntOpenHashMap.this.value[this.index];
         Double2IntOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double.doubleToLongBits(Double2IntOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)var2.getKey()) && Double2IntOpenHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
