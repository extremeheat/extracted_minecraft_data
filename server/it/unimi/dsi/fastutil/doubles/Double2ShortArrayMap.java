...
public class Double2ShortArrayMap extends AbstractDouble2ShortMap implements Serializable, Cloneable {
   ...
   public Double2ShortArrayMap(double[] var1, short[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Double2ShortArrayMap(int var1) {
      super();
      this.key = new double[var1];
      this.value = new short[var1];
   }

   public Double2ShortArrayMap(Double2ShortMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Double2ShortArrayMap(Map<? extends Double, ? extends Short> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Double2ShortArrayMap(double[] var1, short[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public DoubleSet keySet() {
      return new AbstractDoubleSet() {
         public boolean contains(double var1) {
            return Double2ShortArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(double var1) {
            int var3 = Double2ShortArrayMap.this.findKey(var1);
            if (var3 == -1) {
               return false;
            } else {
               int var4 = Double2ShortArrayMap.this.size - var3 - 1;
               System.arraycopy(Double2ShortArrayMap.this.key, var3 + 1, Double2ShortArrayMap.this.key, var3, var4);
               System.arraycopy(Double2ShortArrayMap.this.value, var3 + 1, Double2ShortArrayMap.this.value, var3, var4);
            ...
            return new DoubleIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Double2ShortArrayMap.this.size - this.pos;
                     System.arraycopy(Double2ShortArrayMap.this.key, this.pos, Double2ShortArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Double2ShortArrayMap.this.value, this.pos, Double2ShortArrayMap.this.value, this.pos - 1, var1);
                     Double2ShortArrayMap.this.size--;
                  }
               }
            };
   ...
   public ShortCollection values() {
      return new AbstractShortCollection() {
         public boolean contains(short var1) {
            return Double2ShortArrayMap.this.containsValue(var1);
         }
   ...
   public Double2ShortArrayMap clone() {
      Double2ShortArrayMap var1;
      try {
         var1 = (Double2ShortArrayMap)super.clone();
         ...
         return new ObjectIterator<Double2ShortMap.Entry>() {
            ...
            public Double2ShortMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractDouble2ShortMap.BasicEntry(Double2ShortArrayMap.this.key[this.curr = this.next], Double2ShortArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Double2ShortArrayMap.this.size-- - this.next--;
                  System.arraycopy(Double2ShortArrayMap.this.key, this.next + 1, Double2ShortArrayMap.this.key, this.next, var1);
                  System.arraycopy(Double2ShortArrayMap.this.value, this.next + 1, Double2ShortArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  return Double2ShortArrayMap.this.containsKey(var3) && Double2ShortArrayMap.this.get(var3) == (Short)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  int var6 = Double2ShortArrayMap.this.findKey(var3);
                  if (var6 != -1 && var5 == Double2ShortArrayMap.this.value[var6]) {
                     int var7 = Double2ShortArrayMap.this.size - var6 - 1;
                     System.arraycopy(Double2ShortArrayMap.this.key, var6 + 1, Double2ShortArrayMap.this.key, var6, var7);
                     System.arraycopy(Double2ShortArrayMap.this.value, var6 + 1, Double2ShortArrayMap.this.value, var6, var7);
                     Double2ShortArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
