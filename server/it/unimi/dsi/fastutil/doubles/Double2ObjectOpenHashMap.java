...
public class Double2ObjectOpenHashMap<V> extends AbstractDouble2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Double2ObjectOpenHashMap(int var1, float var2) {
      super();
   ...
   public Double2ObjectOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Double2ObjectOpenHashMap(Map<? extends Double, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2ObjectOpenHashMap(Map<? extends Double, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Double2ObjectOpenHashMap(Double2ObjectMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Double2ObjectOpenHashMap(Double2ObjectMap<V> var1) {
      this(var1, 0.75F);
   }

   public Double2ObjectOpenHashMap(double[] var1, V[] var2, float var3) {
   ...
   public Double2ObjectOpenHashMap(double[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Double2ObjectOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Double2ObjectOpenHashMap.this.containsNullKey) {
                  var1.accept(Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n]);
               }

               int var2 = Double2ObjectOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Double.doubleToLongBits(Double2ObjectOpenHashMap.this.key[var2]) != 0L) {
                     var1.accept(Double2ObjectOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Double2ObjectOpenHashMap<V> clone() {
      Double2ObjectOpenHashMap var1;
      try {
         var1 = (Double2ObjectOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      double[] var2 = this.key;
      Object[] var3 = this.value;
      Double2ObjectOpenHashMap.MapIterator var4 = new Double2ObjectOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public void forEach(java.util.function.DoubleConsumer var1) {
         if (Double2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(Double2ObjectOpenHashMap.this.key[Double2ObjectOpenHashMap.this.n]);
         }

         int var2 = Double2ObjectOpenHashMap.this.n;

         while(var2-- != 0) {
            double var3 = Double2ObjectOpenHashMap.this.key[var2];
      ...
      public boolean contains(double var1) {
         return Double2ObjectOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(double var1) {
         int var3 = Double2ObjectOpenHashMap.this.size;
         Double2ObjectOpenHashMap.this.remove(var1);
         return Double2ObjectOpenHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               ...
               if (Double.doubleToLongBits(var3) == 0L) {
                  return Double2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n], var5);
               } else {
                  double[] var8 = Double2ObjectOpenHashMap.this.key;
                  double var6;
                  int var9;
                  if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2ObjectOpenHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Double.doubleToLongBits(var3) == Double.doubleToLongBits(var6)) {
                     return Objects.equals(Double2ObjectOpenHashMap.this.value[var9], var5);
                  } else {
                     while(Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ObjectOpenHashMap.this.mask]) != 0L) {
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Double) {
               ...
               Object var5 = var2.getValue();
               if (Double.doubleToLongBits(var3) == 0L) {
                  if (Double2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n], var5)) {
                  ...
                  if (Double.doubleToLongBits(var6 = var8[var9 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & Double2ObjectOpenHashMap.this.mask]) == 0L) {
                     ...
                     if (Objects.equals(Double2ObjectOpenHashMap.this.value[var9], var5)) {
                        Double2ObjectOpenHashMap.this.removeEntry(var9);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if (Double.doubleToLongBits(var6 = var8[var9 = var9 + 1 & Double2ObjectOpenHashMap.this.mask]) == 0L) {
                           return false;
                        }
                     } while(Double.doubleToLongBits(var6) != Double.doubleToLongBits(var3) || !Objects.equals(Double2ObjectOpenHashMap.this.value[var9], var5));
      ...
      public void forEach(Consumer<? super Double2ObjectMap.Entry<V>> var1) {
         if (Double2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractDouble2ObjectMap.BasicEntry(Double2ObjectOpenHashMap.this.key[Double2ObjectOpenHashMap.this.n], Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Double.doubleToLongBits(Double2ObjectOpenHashMap.this.key[var2]) != 0L) {
               var1.accept(new AbstractDouble2ObjectMap.BasicEntry(Double2ObjectOpenHashMap.this.key[var2], Double2ObjectOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Double2ObjectMap.Entry<V>> var1) {
         ...
         if (Double2ObjectOpenHashMap.this.containsNullKey) {
            var2.key = Double2ObjectOpenHashMap.this.key[Double2ObjectOpenHashMap.this.n];
            var2.value = Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Double2ObjectOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Double.doubleToLongBits(Double2ObjectOpenHashMap.this.key[var3]) != 0L) {
               var2.key = Double2ObjectOpenHashMap.this.key[var3];
               var2.value = Double2ObjectOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Double2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Double2ObjectMap.Entry<V>> {
      private final Double2ObjectOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Double2ObjectOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Double2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Double2ObjectMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               double[] var1 = Double2ObjectOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2)) & Double2ObjectOpenHashMap.this.mask; Double.doubleToLongBits(var2) != Double.doubleToLongBits(var1[var4]); var4 = var4 + 1 & Double2ObjectOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         double[] var6 = Double2ObjectOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Double2ObjectOpenHashMap.this.mask;

            double var4;
            while(true) {
               if (Double.doubleToLongBits(var4 = var6[var1]) == 0L) {
                  var6[var2] = 0.0D;
                  Double2ObjectOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var4)) & Double2ObjectOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Double2ObjectOpenHashMap.this.value[var2] = Double2ObjectOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Double2ObjectMap.Entry<V>, java.util.Map.Entry<Double, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Double2ObjectOpenHashMap.this.value[this.index];
         Double2ObjectOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Double.doubleToLongBits(Double2ObjectOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)var2.getKey()) && Objects.equals(Double2ObjectOpenHashMap.this.value[this.index], var2.getValue());
         }
      }
