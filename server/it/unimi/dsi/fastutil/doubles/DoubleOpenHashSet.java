...
public class DoubleOpenHashSet extends AbstractDoubleSet implements Serializable, Cloneable, Hash {
   ...
   public DoubleOpenHashSet(int var1, float var2) {
      super();
   ...
   public DoubleOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public DoubleOpenHashSet(Collection<? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public DoubleOpenHashSet(Collection<? extends Double> var1) {
      this(var1, 0.75F);
   }

   public DoubleOpenHashSet(DoubleCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public DoubleOpenHashSet(DoubleCollection var1) {
      this(var1, 0.75F);
   }

   public DoubleOpenHashSet(DoubleIterator var1, float var2) {
      this(16, var2);
   ...
   public DoubleOpenHashSet(DoubleIterator var1) {
      this(var1, 0.75F);
   }

   public DoubleOpenHashSet(Iterator<?> var1, float var2) {
      this(DoubleIterators.asDoubleIterator(var1), var2);
   }

   public DoubleOpenHashSet(Iterator<?> var1) {
      this(DoubleIterators.asDoubleIterator(var1));
   }

   public DoubleOpenHashSet(double[] var1, int var2, int var3, float var4) {
   ...
   public DoubleOpenHashSet(double[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public DoubleOpenHashSet(double[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public DoubleOpenHashSet(double[] var1) {
      this(var1, 0.75F);
   }
   ...
   public DoubleIterator iterator() {
      return new DoubleOpenHashSet.SetIterator();
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var7 = this.realSize(); var7-- != 0; var4[var6] = var2[var5]) {
         ...
         if (Double.doubleToLongBits(var4[var6 = (int)HashCommon.mix(Double.doubleToRawLongBits(var2[var5])) & var3]) != 0L) {
   ...
   public DoubleOpenHashSet clone() {
      DoubleOpenHashSet var1;
      try {
         var1 = (DoubleOpenHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var5 = this.size; var5-- != 0; var2[var6] = var3) {
         ...
         if (Double.doubleToLongBits(var3) == 0L) {
            var6 = this.n;
            this.containsNull = true;
         } else if (Double.doubleToLongBits(var2[var6 = (int)HashCommon.mix(Double.doubleToRawLongBits(var3)) & this.mask]) != 0L) {
   ...
   private class SetIterator implements DoubleIterator {
      ...
      public double nextDouble() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNull) {
               ...
               double[] var1 = DoubleOpenHashSet.this.key;
      ...
      private final void shiftKeys(int var1) {
         double[] var6 = DoubleOpenHashSet.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & DoubleOpenHashSet.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(Double.doubleToRawLongBits(var4)) & DoubleOpenHashSet.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
