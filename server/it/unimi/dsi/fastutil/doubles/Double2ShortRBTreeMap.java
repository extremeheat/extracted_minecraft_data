...
public class Double2ShortRBTreeMap extends AbstractDouble2ShortSortedMap implements Serializable, Cloneable {
   ...
   public Double2ShortRBTreeMap(Comparator<? super Double> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Double2ShortRBTreeMap(Map<? extends Double, ? extends Short> var1) {
      this();
      this.putAll(var1);
   }

   public Double2ShortRBTreeMap(SortedMap<Double, Short> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Double2ShortRBTreeMap(Double2ShortMap var1) {
      this();
      this.putAll(var1);
   }

   public Double2ShortRBTreeMap(Double2ShortSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Double2ShortRBTreeMap(double[] var1, short[] var2, Comparator<? super Double> var3) {
      this(var3);
   ...
   public Double2ShortRBTreeMap(double[] var1, short[] var2) {
   ...
   final Double2ShortRBTreeMap.Entry findKey(double var1) {
      Double2ShortRBTreeMap.Entry var3;
      int var4;
   ...
   final Double2ShortRBTreeMap.Entry locateKey(double var1) {
      Double2ShortRBTreeMap.Entry var3 = this.tree;
      Double2ShortRBTreeMap.Entry var4 = this.tree;
   ...
   public short addTo(double var1, short var3) {
      Double2ShortRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Double2ShortRBTreeMap.Entry add(double var1) {
      this.modified = false;
      int var3 = 0;
      Double2ShortRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Double2ShortRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Double2ShortRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Double2ShortRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Double2ShortRBTreeMap.Entry var8;
               Double2ShortRBTreeMap.Entry var9;
   ...
   public short remove(double var1) {
      ...
      if (this.tree == null) {
         ...
         Double2ShortRBTreeMap.Entry var9;
         Double2ShortRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(short var1) {
      Double2ShortRBTreeMap.ValueIterator var2 = new Double2ShortRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public short get(double var1) {
      Double2ShortRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
            final Comparator<? super Double2ShortMap.Entry> comparator = (var1x, var2) -> {
               return Double2ShortRBTreeMap.this.actualComparator.compare(var1x.getDoubleKey(), var2.getDoubleKey());
            };
            ...
            public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry var1) {
               return Double2ShortRBTreeMap.this.new EntryIterator(var1.getDoubleKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Double) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        Double2ShortRBTreeMap.Entry var3 = Double2ShortRBTreeMap.this.findKey((Double)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Double) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        ...
                        if (var3 != null && var3.getShortValue() == (Short)var2.getValue()) {
                           Double2ShortRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry var1, Double2ShortMap.Entry var2) {
               return Double2ShortRBTreeMap.this.subMap(var1.getDoubleKey(), var2.getDoubleKey()).double2ShortEntrySet();
            }

            public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry var1) {
               return Double2ShortRBTreeMap.this.headMap(var1.getDoubleKey()).double2ShortEntrySet();
            }

            public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry var1) {
               return Double2ShortRBTreeMap.this.tailMap(var1.getDoubleKey()).double2ShortEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Double2ShortRBTreeMap.this.containsValue(var1);
            }
   ...
   public Double2ShortSortedMap headMap(double var1) {
      return new Double2ShortRBTreeMap.Submap(0.0D, true, var1, false);
   }

   public Double2ShortSortedMap tailMap(double var1) {
      return new Double2ShortRBTreeMap.Submap(var1, false, 0.0D, true);
   }

   public Double2ShortSortedMap subMap(double var1, double var3) {
      return new Double2ShortRBTreeMap.Submap(var1, false, var3, false);
   }

   public Double2ShortRBTreeMap clone() {
      Double2ShortRBTreeMap var1;
      try {
         var1 = (Double2ShortRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Double2ShortRBTreeMap.Entry var5 = new Double2ShortRBTreeMap.Entry();
         Double2ShortRBTreeMap.Entry var6 = new Double2ShortRBTreeMap.Entry();
         Double2ShortRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Double2ShortRBTreeMap.Entry var4 = var6;
         var6.pred((Double2ShortRBTreeMap.Entry)null);

         while(true) {
            Double2ShortRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Double2ShortRBTreeMap.EntryIterator var3 = new Double2ShortRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Double2ShortRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Double2ShortRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Double2ShortRBTreeMap.Entry var3, Double2ShortRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Double2ShortRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Double2ShortRBTreeMap.Entry(var1.readDouble(), var1.readShort());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Double2ShortRBTreeMap.Entry(var1.readDouble(), var1.readShort());
         var8.black(true);
         var8.right(new Double2ShortRBTreeMap.Entry(var1.readDouble(), var1.readShort()));
         ...
         Double2ShortRBTreeMap.Entry var7 = new Double2ShortRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Double2ShortRBTreeMap.Entry)null, (Double2ShortRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractDouble2ShortSortedMap implements Serializable {
      ...
      public Submap(double var2, boolean var4, double var5, boolean var7) {
         super();
         if (!var4 && !var7 && Double2ShortRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Double2ShortRBTreeMap.Submap.SubmapIterator var1 = new Double2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(double var1) {
         return (this.bottom || Double2ShortRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Double2ShortRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(double var1) {
         return this.in(var1) && Double2ShortRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(short var1) {
         Double2ShortRBTreeMap.Submap.SubmapIterator var2 = new Double2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      public short get(double var1) {
         Double2ShortRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Double2ShortRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public short put(double var1, short var3) {
         ...
         if (!this.in(var1)) {
            ...
            short var4 = Double2ShortRBTreeMap.this.put(var1, var3);
            return Double2ShortRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public short remove(double var1) {
         ...
         if (!this.in(var1)) {
            ...
            short var3 = Double2ShortRBTreeMap.this.remove(var1);
            return Double2ShortRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Double2ShortSortedMap headMap(double var1) {
         if (this.top) {
            return Double2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Double2ShortRBTreeMap.this.compare(var1, this.to) < 0 ? Double2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Double2ShortSortedMap tailMap(double var1) {
         if (this.bottom) {
            return Double2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Double2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? Double2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Double2ShortSortedMap subMap(double var1, double var3) {
         if (this.top && this.bottom) {
            return Double2ShortRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Double2ShortRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Double2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Double2ShortRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Double2ShortRBTreeMap.Entry firstEntry() {
         if (Double2ShortRBTreeMap.this.tree == null) {
            ...
            Double2ShortRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Double2ShortRBTreeMap.this.firstEntry;
            } else {
               var1 = Double2ShortRBTreeMap.this.locateKey(this.from);
               if (Double2ShortRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Double2ShortRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Double2ShortRBTreeMap.Entry lastEntry() {
         if (Double2ShortRBTreeMap.this.tree == null) {
            ...
            Double2ShortRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Double2ShortRBTreeMap.this.lastEntry;
            } else {
               var1 = Double2ShortRBTreeMap.this.locateKey(this.to);
               if (Double2ShortRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Double2ShortRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public double firstDoubleKey() {
         Double2ShortRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public double lastDoubleKey() {
         Double2ShortRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Double2ShortRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Double2ShortMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Double2ShortRBTreeMap.TreeIterator {
         ...
         SubmapIterator(double var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Double2ShortRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Double2ShortRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Double2ShortRBTreeMap.this.locateKey(var2);
                  if (Double2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractDouble2ShortSortedMap.KeySet {
      ...
      public DoubleBidirectionalIterator iterator(double var1) {
         return Double2ShortRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Double2ShortRBTreeMap.TreeIterator implements ObjectListIterator<Double2ShortMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(double var2) {
         super();
         if ((this.next = Double2ShortRBTreeMap.this.locateKey(var2)) != null) {
            if (Double2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractDouble2ShortMap.BasicEntry implements Cloneable {
      ...
      void pred(Double2ShortRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Double2ShortRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Double2ShortRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Double2ShortRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Double2ShortRBTreeMap.Entry next() {
         Double2ShortRBTreeMap.Entry var1 = this.right;
      ...
      Double2ShortRBTreeMap.Entry prev() {
         Double2ShortRBTreeMap.Entry var1 = this.left;
      ...
      public Double2ShortRBTreeMap.Entry clone() {
         Double2ShortRBTreeMap.Entry var1;
         try {
            var1 = (Double2ShortRBTreeMap.Entry)super.clone();
