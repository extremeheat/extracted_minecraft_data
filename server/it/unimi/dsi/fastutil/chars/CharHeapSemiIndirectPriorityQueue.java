...
public class CharHeapSemiIndirectPriorityQueue implements CharIndirectPriorityQueue {
   ...
   public CharHeapSemiIndirectPriorityQueue(char[] var1, int var2, CharComparator var3) {
      super();
   ...
   public CharHeapSemiIndirectPriorityQueue(char[] var1, int var2) {
      this(var1, var2, (CharComparator)null);
   }

   public CharHeapSemiIndirectPriorityQueue(char[] var1, CharComparator var2) {
      this(var1, var1.length, var2);
   }

   public CharHeapSemiIndirectPriorityQueue(char[] var1) {
      this(var1, var1.length, (CharComparator)null);
   }

   public CharHeapSemiIndirectPriorityQueue(char[] var1, int[] var2, int var3, CharComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      CharSemiIndirectHeaps.makeHeap(var1, var2, var3, var4);
   }
   ...
   public CharHeapSemiIndirectPriorityQueue(char[] var1, int[] var2, int var3) {
      this(var1, var2, var3, (CharComparator)null);
   }
   ...
   public int front(int[] var1) {
      return this.c == null ? CharSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1) : CharSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1, this.c);
   }
