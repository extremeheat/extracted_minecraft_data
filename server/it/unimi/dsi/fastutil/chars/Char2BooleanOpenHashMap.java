...
public class Char2BooleanOpenHashMap extends AbstractChar2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Char2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Char2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Char2BooleanOpenHashMap(Char2BooleanMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2BooleanOpenHashMap(Char2BooleanMap var1) {
      this(var1, 0.75F);
   }

   public Char2BooleanOpenHashMap(char[] var1, boolean[] var2, float var3) {
   ...
   public Char2BooleanOpenHashMap(char[] var1, boolean[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Char2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Char2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n]);
               }

               int var2 = Char2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2BooleanOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Char2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2BooleanOpenHashMap clone() {
      Char2BooleanOpenHashMap var1;
      try {
         var1 = (Char2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      boolean[] var3 = this.value;
      Char2BooleanOpenHashMap.MapIterator var4 = new Char2BooleanOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Char2BooleanOpenHashMap.this.key[Char2BooleanOpenHashMap.this.n]);
         }

         int var2 = Char2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2BooleanOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2BooleanOpenHashMap.this.size;
         Char2BooleanOpenHashMap.this.remove(var1);
         return Char2BooleanOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2BooleanMap.Entry> implements Char2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (var3 == 0) {
                     return Char2BooleanOpenHashMap.this.containsNullKey && Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n] == var4;
                  } else {
                     char[] var6 = Char2BooleanOpenHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2BooleanOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Char2BooleanOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2BooleanOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Char2BooleanOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var4 = (Boolean)var2.getValue();
                  if (var3 == 0) {
                     if (Char2BooleanOpenHashMap.this.containsNullKey && Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2BooleanOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Char2BooleanOpenHashMap.this.value[var7] == var4) {
                           Char2BooleanOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2BooleanOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Char2BooleanOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2BooleanMap.Entry> var1) {
         if (Char2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2BooleanMap.BasicEntry(Char2BooleanOpenHashMap.this.key[Char2BooleanOpenHashMap.this.n], Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2BooleanOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2BooleanMap.BasicEntry(Char2BooleanOpenHashMap.this.key[var2], Char2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2BooleanMap.Entry> var1) {
         ...
         if (Char2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Char2BooleanOpenHashMap.this.key[Char2BooleanOpenHashMap.this.n];
            var2.value = Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Char2BooleanOpenHashMap.this.key[var3] != 0) {
               var2.key = Char2BooleanOpenHashMap.this.key[var3];
               var2.value = Char2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2BooleanOpenHashMap.MapIterator implements ObjectIterator<Char2BooleanMap.Entry> {
      private final Char2BooleanOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2BooleanOpenHashMap.MapIterator implements ObjectIterator<Char2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2BooleanOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Char2BooleanOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Char2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Char2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2BooleanOpenHashMap.this.value[var2] = Char2BooleanOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2BooleanMap.Entry, java.util.Map.Entry<Character, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Char2BooleanOpenHashMap.this.value[this.index];
         Char2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2BooleanOpenHashMap.this.key[this.index] == (Character)var2.getKey() && Char2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
