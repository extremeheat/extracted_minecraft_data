...
public class Char2ReferenceArrayMap<V> extends AbstractChar2ReferenceMap<V> implements Serializable, Cloneable {
   ...
   public Char2ReferenceArrayMap(char[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2ReferenceArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new Object[var1];
   }

   public Char2ReferenceArrayMap(Char2ReferenceMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2ReferenceArrayMap(Map<? extends Character, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2ReferenceArrayMap(char[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2ReferenceArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2ReferenceArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2ReferenceArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2ReferenceArrayMap.this.key, var2 + 1, Char2ReferenceArrayMap.this.key, var2, var3);
               System.arraycopy(Char2ReferenceArrayMap.this.value, var2 + 1, Char2ReferenceArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2ReferenceArrayMap.this.size - this.pos;
                     System.arraycopy(Char2ReferenceArrayMap.this.key, this.pos, Char2ReferenceArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2ReferenceArrayMap.this.value, this.pos, Char2ReferenceArrayMap.this.value, this.pos - 1, var1);
                     Char2ReferenceArrayMap.this.size--;
                  }
               }
            };
   ...
   public ReferenceCollection<V> values() {
      return new AbstractReferenceCollection<V>() {
         public boolean contains(Object var1) {
            return Char2ReferenceArrayMap.this.containsValue(var1);
         }
   ...
   public Char2ReferenceArrayMap<V> clone() {
      Char2ReferenceArrayMap var1;
      try {
         var1 = (Char2ReferenceArrayMap)super.clone();
   ...
   private final class EntrySet extends AbstractObjectSet<Char2ReferenceMap.Entry<V>> implements Char2ReferenceMap.FastEntrySet<V> {
      private EntrySet() {
         super();
      }
         ...
         return new ObjectIterator<Char2ReferenceMap.Entry<V>>() {
            ...
            public Char2ReferenceMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceArrayMap.this.key[this.curr = this.next], Char2ReferenceArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2ReferenceArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2ReferenceArrayMap.this.key, this.next + 1, Char2ReferenceArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2ReferenceArrayMap.this.value, this.next + 1, Char2ReferenceArrayMap.this.value, this.next, var1);
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               return Char2ReferenceArrayMap.this.containsKey(var3) && Char2ReferenceArrayMap.this.get(var3) == var2.getValue();
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               int var5 = Char2ReferenceArrayMap.this.findKey(var3);
               if (var5 != -1 && var4 == Char2ReferenceArrayMap.this.value[var5]) {
                  int var6 = Char2ReferenceArrayMap.this.size - var5 - 1;
                  System.arraycopy(Char2ReferenceArrayMap.this.key, var5 + 1, Char2ReferenceArrayMap.this.key, var5, var6);
                  System.arraycopy(Char2ReferenceArrayMap.this.value, var5 + 1, Char2ReferenceArrayMap.this.value, var5, var6);
                  Char2ReferenceArrayMap.this.size--;
                  Char2ReferenceArrayMap.this.value[Char2ReferenceArrayMap.this.size] = null;
                  return true;
               } else {
