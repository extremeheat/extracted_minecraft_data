...
public class CharLinkedOpenHashSet extends AbstractCharSortedSet implements Serializable, Cloneable, Hash {
   ...
   public CharLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public CharLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public CharLinkedOpenHashSet(Collection<? extends Character> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public CharLinkedOpenHashSet(Collection<? extends Character> var1) {
      this(var1, 0.75F);
   }

   public CharLinkedOpenHashSet(CharCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public CharLinkedOpenHashSet(CharCollection var1) {
      this(var1, 0.75F);
   }

   public CharLinkedOpenHashSet(CharIterator var1, float var2) {
      this(16, var2);
   ...
   public CharLinkedOpenHashSet(CharIterator var1) {
      this(var1, 0.75F);
   }

   public CharLinkedOpenHashSet(Iterator<?> var1, float var2) {
      this(CharIterators.asCharIterator(var1), var2);
   }

   public CharLinkedOpenHashSet(Iterator<?> var1) {
      this(CharIterators.asCharIterator(var1));
   }

   public CharLinkedOpenHashSet(char[] var1, int var2, int var3, float var4) {
   ...
   public CharLinkedOpenHashSet(char[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public CharLinkedOpenHashSet(char[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public CharLinkedOpenHashSet(char[] var1) {
      this(var1, 0.75F);
   }
   ...
   public CharListIterator iterator(char var1) {
      return new CharLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   public CharLinkedOpenHashSet clone() {
      CharLinkedOpenHashSet var1;
      try {
         var1 = (CharLinkedOpenHashSet)super.clone();
   ...
   private class SetIterator implements CharListIterator {
      ...
      SetIterator(char var2) {
         ...
         } else if (CharLinkedOpenHashSet.this.key[CharLinkedOpenHashSet.this.last] == var2) {
            this.prev = CharLinkedOpenHashSet.this.last;
            this.index = CharLinkedOpenHashSet.this.size;
         } else {
            char[] var3 = CharLinkedOpenHashSet.this.key;

            for(int var4 = HashCommon.mix(var2) & CharLinkedOpenHashSet.this.mask; var3[var4] != 0; var4 = var4 + 1 & CharLinkedOpenHashSet.this.mask) {
               if (var3[var4] == var2) {
                  this.next = (int)CharLinkedOpenHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = CharLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)CharLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = CharLinkedOpenHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (CharLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = CharLinkedOpenHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (CharLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == CharLinkedOpenHashSet.this.n) {
               CharLinkedOpenHashSet.this.containsNull = false;
               CharLinkedOpenHashSet.this.key[CharLinkedOpenHashSet.this.n] = 0;
            } else {
               char[] var5 = CharLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & CharLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(var4) & CharLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  CharLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
