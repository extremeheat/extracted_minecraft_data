...
public class Char2IntRBTreeMap extends AbstractChar2IntSortedMap implements Serializable, Cloneable {
   ...
   public Char2IntRBTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2IntRBTreeMap(Map<? extends Character, ? extends Integer> var1) {
      this();
      this.putAll(var1);
   }

   public Char2IntRBTreeMap(SortedMap<Character, Integer> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2IntRBTreeMap(Char2IntMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2IntRBTreeMap(Char2IntSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2IntRBTreeMap(char[] var1, int[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2IntRBTreeMap(char[] var1, int[] var2) {
   ...
   final Char2IntRBTreeMap.Entry findKey(char var1) {
      Char2IntRBTreeMap.Entry var2;
      int var3;
   ...
   final Char2IntRBTreeMap.Entry locateKey(char var1) {
      Char2IntRBTreeMap.Entry var2 = this.tree;
      Char2IntRBTreeMap.Entry var3 = this.tree;
   ...
   public int addTo(char var1, int var2) {
      Char2IntRBTreeMap.Entry var3 = this.add(var1);
      int var4 = var3.value;
      var3.value += var2;
      return var4;
   }
   ...
   private Char2IntRBTreeMap.Entry add(char var1) {
      this.modified = false;
      int var2 = 0;
      Char2IntRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Char2IntRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Char2IntRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Char2IntRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Char2IntRBTreeMap.Entry var7;
               Char2IntRBTreeMap.Entry var8;
   ...
   public boolean containsValue(int var1) {
      Char2IntRBTreeMap.ValueIterator var2 = new Char2IntRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public int get(char var1) {
      Char2IntRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
            final Comparator<? super Char2IntMap.Entry> comparator = (var1x, var2) -> {
               return Char2IntRBTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry var1) {
               return Char2IntRBTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        Char2IntRBTreeMap.Entry var3 = Char2IntRBTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        ...
                        if (var3 != null && var3.getIntValue() == (Integer)var2.getValue()) {
                           Char2IntRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry var1, Char2IntMap.Entry var2) {
               return Char2IntRBTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2IntEntrySet();
            }

            public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry var1) {
               return Char2IntRBTreeMap.this.headMap(var1.getCharKey()).char2IntEntrySet();
            }

            public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry var1) {
               return Char2IntRBTreeMap.this.tailMap(var1.getCharKey()).char2IntEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Char2IntRBTreeMap.this.containsValue(var1);
            }
   ...
   public Char2IntSortedMap headMap(char var1) {
      return new Char2IntRBTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2IntSortedMap tailMap(char var1) {
      return new Char2IntRBTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2IntSortedMap subMap(char var1, char var2) {
      return new Char2IntRBTreeMap.Submap(var1, false, var2, false);
   }

   public Char2IntRBTreeMap clone() {
      Char2IntRBTreeMap var1;
      try {
         var1 = (Char2IntRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2IntRBTreeMap.Entry var5 = new Char2IntRBTreeMap.Entry();
         Char2IntRBTreeMap.Entry var6 = new Char2IntRBTreeMap.Entry();
         Char2IntRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2IntRBTreeMap.Entry var4 = var6;
         var6.pred((Char2IntRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2IntRBTreeMap.EntryIterator var3 = new Char2IntRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2IntRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2IntRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2IntRBTreeMap.Entry var3, Char2IntRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2IntRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2IntRBTreeMap.Entry(var1.readChar(), var1.readInt());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Char2IntRBTreeMap.Entry(var1.readChar(), var1.readInt());
         var8.black(true);
         var8.right(new Char2IntRBTreeMap.Entry(var1.readChar(), var1.readInt()));
         ...
         Char2IntRBTreeMap.Entry var7 = new Char2IntRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2IntRBTreeMap.Entry)null, (Char2IntRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2IntSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2IntRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2IntRBTreeMap.Submap.SubmapIterator var1 = new Char2IntRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2IntRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2IntRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2IntRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(int var1) {
         Char2IntRBTreeMap.Submap.SubmapIterator var2 = new Char2IntRBTreeMap.Submap.SubmapIterator();
      ...
      public int get(char var1) {
         Char2IntRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2IntRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public int put(char var1, int var2) {
         ...
         if (!this.in(var1)) {
            ...
            int var3 = Char2IntRBTreeMap.this.put(var1, var2);
            return Char2IntRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public int remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            int var2 = Char2IntRBTreeMap.this.remove(var1);
            return Char2IntRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2IntSortedMap headMap(char var1) {
         if (this.top) {
            return Char2IntRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2IntRBTreeMap.this.compare(var1, this.to) < 0 ? Char2IntRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2IntSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2IntRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2IntRBTreeMap.this.compare(var1, this.from) > 0 ? Char2IntRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2IntSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2IntRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2IntRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2IntRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2IntRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2IntRBTreeMap.Entry firstEntry() {
         if (Char2IntRBTreeMap.this.tree == null) {
            ...
            Char2IntRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2IntRBTreeMap.this.firstEntry;
            } else {
               var1 = Char2IntRBTreeMap.this.locateKey(this.from);
               if (Char2IntRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2IntRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2IntRBTreeMap.Entry lastEntry() {
         if (Char2IntRBTreeMap.this.tree == null) {
            ...
            Char2IntRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2IntRBTreeMap.this.lastEntry;
            } else {
               var1 = Char2IntRBTreeMap.this.locateKey(this.to);
               if (Char2IntRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2IntRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2IntRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2IntRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2IntRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2IntMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2IntRBTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2IntRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2IntRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2IntRBTreeMap.this.locateKey(var2);
                  if (Char2IntRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2IntSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2IntRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2IntRBTreeMap.TreeIterator implements ObjectListIterator<Char2IntMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2IntRBTreeMap.this.locateKey(var2)) != null) {
            if (Char2IntRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2IntMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2IntRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2IntRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2IntRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2IntRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2IntRBTreeMap.Entry next() {
         Char2IntRBTreeMap.Entry var1 = this.right;
      ...
      Char2IntRBTreeMap.Entry prev() {
         Char2IntRBTreeMap.Entry var1 = this.left;
      ...
      public Char2IntRBTreeMap.Entry clone() {
         Char2IntRBTreeMap.Entry var1;
         try {
            var1 = (Char2IntRBTreeMap.Entry)super.clone();
