...
public class Char2FloatRBTreeMap extends AbstractChar2FloatSortedMap implements Serializable, Cloneable {
   ...
   public Char2FloatRBTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2FloatRBTreeMap(Map<? extends Character, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Char2FloatRBTreeMap(SortedMap<Character, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2FloatRBTreeMap(Char2FloatMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2FloatRBTreeMap(Char2FloatSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2FloatRBTreeMap(char[] var1, float[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2FloatRBTreeMap(char[] var1, float[] var2) {
   ...
   final Char2FloatRBTreeMap.Entry findKey(char var1) {
      Char2FloatRBTreeMap.Entry var2;
      int var3;
   ...
   final Char2FloatRBTreeMap.Entry locateKey(char var1) {
      Char2FloatRBTreeMap.Entry var2 = this.tree;
      Char2FloatRBTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(char var1, float var2) {
      Char2FloatRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Char2FloatRBTreeMap.Entry add(char var1) {
      this.modified = false;
      int var2 = 0;
      Char2FloatRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Char2FloatRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Char2FloatRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Char2FloatRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Char2FloatRBTreeMap.Entry var7;
               Char2FloatRBTreeMap.Entry var8;
   ...
   public boolean containsValue(float var1) {
      Char2FloatRBTreeMap.ValueIterator var2 = new Char2FloatRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float get(char var1) {
      Char2FloatRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
            final Comparator<? super Char2FloatMap.Entry> comparator = (var1x, var2) -> {
               return Char2FloatRBTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry var1) {
               return Char2FloatRBTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        Char2FloatRBTreeMap.Entry var3 = Char2FloatRBTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                           Char2FloatRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry var1, Char2FloatMap.Entry var2) {
               return Char2FloatRBTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2FloatEntrySet();
            }

            public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry var1) {
               return Char2FloatRBTreeMap.this.headMap(var1.getCharKey()).char2FloatEntrySet();
            }

            public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry var1) {
               return Char2FloatRBTreeMap.this.tailMap(var1.getCharKey()).char2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Char2FloatRBTreeMap.this.containsValue(var1);
            }
   ...
   public Char2FloatSortedMap headMap(char var1) {
      return new Char2FloatRBTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2FloatSortedMap tailMap(char var1) {
      return new Char2FloatRBTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2FloatSortedMap subMap(char var1, char var2) {
      return new Char2FloatRBTreeMap.Submap(var1, false, var2, false);
   }

   public Char2FloatRBTreeMap clone() {
      Char2FloatRBTreeMap var1;
      try {
         var1 = (Char2FloatRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2FloatRBTreeMap.Entry var5 = new Char2FloatRBTreeMap.Entry();
         Char2FloatRBTreeMap.Entry var6 = new Char2FloatRBTreeMap.Entry();
         Char2FloatRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2FloatRBTreeMap.Entry var4 = var6;
         var6.pred((Char2FloatRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2FloatRBTreeMap.EntryIterator var3 = new Char2FloatRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2FloatRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2FloatRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2FloatRBTreeMap.Entry var3, Char2FloatRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2FloatRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2FloatRBTreeMap.Entry(var1.readChar(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Char2FloatRBTreeMap.Entry(var1.readChar(), var1.readFloat());
         var8.black(true);
         var8.right(new Char2FloatRBTreeMap.Entry(var1.readChar(), var1.readFloat()));
         ...
         Char2FloatRBTreeMap.Entry var7 = new Char2FloatRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2FloatRBTreeMap.Entry)null, (Char2FloatRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2FloatSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2FloatRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2FloatRBTreeMap.Submap.SubmapIterator var1 = new Char2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2FloatRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2FloatRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2FloatRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Char2FloatRBTreeMap.Submap.SubmapIterator var2 = new Char2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      public float get(char var1) {
         Char2FloatRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2FloatRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(char var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Char2FloatRBTreeMap.this.put(var1, var2);
            return Char2FloatRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Char2FloatRBTreeMap.this.remove(var1);
            return Char2FloatRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2FloatSortedMap headMap(char var1) {
         if (this.top) {
            return Char2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2FloatRBTreeMap.this.compare(var1, this.to) < 0 ? Char2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2FloatSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? Char2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2FloatSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2FloatRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2FloatRBTreeMap.Entry firstEntry() {
         if (Char2FloatRBTreeMap.this.tree == null) {
            ...
            Char2FloatRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2FloatRBTreeMap.this.firstEntry;
            } else {
               var1 = Char2FloatRBTreeMap.this.locateKey(this.from);
               if (Char2FloatRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2FloatRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2FloatRBTreeMap.Entry lastEntry() {
         if (Char2FloatRBTreeMap.this.tree == null) {
            ...
            Char2FloatRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2FloatRBTreeMap.this.lastEntry;
            } else {
               var1 = Char2FloatRBTreeMap.this.locateKey(this.to);
               if (Char2FloatRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2FloatRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2FloatRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2FloatRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2FloatRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2FloatMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2FloatRBTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2FloatRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2FloatRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2FloatRBTreeMap.this.locateKey(var2);
                  if (Char2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2FloatSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2FloatRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2FloatRBTreeMap.TreeIterator implements ObjectListIterator<Char2FloatMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2FloatRBTreeMap.this.locateKey(var2)) != null) {
            if (Char2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2FloatMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2FloatRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2FloatRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2FloatRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2FloatRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2FloatRBTreeMap.Entry next() {
         Char2FloatRBTreeMap.Entry var1 = this.right;
      ...
      Char2FloatRBTreeMap.Entry prev() {
         Char2FloatRBTreeMap.Entry var1 = this.left;
      ...
      public Char2FloatRBTreeMap.Entry clone() {
         Char2FloatRBTreeMap.Entry var1;
         try {
            var1 = (Char2FloatRBTreeMap.Entry)super.clone();
