...
public class Char2ObjectOpenHashMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Char2ObjectOpenHashMap(int var1, float var2) {
      super();
   ...
   public Char2ObjectOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Char2ObjectOpenHashMap(Map<? extends Character, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2ObjectOpenHashMap(Map<? extends Character, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Char2ObjectOpenHashMap(Char2ObjectMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2ObjectOpenHashMap(Char2ObjectMap<V> var1) {
      this(var1, 0.75F);
   }

   public Char2ObjectOpenHashMap(char[] var1, V[] var2, float var3) {
   ...
   public Char2ObjectOpenHashMap(char[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Char2ObjectOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Char2ObjectOpenHashMap.this.containsNullKey) {
                  var1.accept(Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n]);
               }

               int var2 = Char2ObjectOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2ObjectOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Char2ObjectOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2ObjectOpenHashMap<V> clone() {
      Char2ObjectOpenHashMap var1;
      try {
         var1 = (Char2ObjectOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      Object[] var3 = this.value;
      Char2ObjectOpenHashMap.MapIterator var4 = new Char2ObjectOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(Char2ObjectOpenHashMap.this.key[Char2ObjectOpenHashMap.this.n]);
         }

         int var2 = Char2ObjectOpenHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2ObjectOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2ObjectOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2ObjectOpenHashMap.this.size;
         Char2ObjectOpenHashMap.this.remove(var1);
         return Char2ObjectOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               if (var3 == 0) {
                  return Char2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n], var4);
               } else {
                  char[] var6 = Char2ObjectOpenHashMap.this.key;
                  char var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2ObjectOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (var3 == var5) {
                     return Objects.equals(Char2ObjectOpenHashMap.this.value[var7], var4);
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Char2ObjectOpenHashMap.this.mask]) != 0) {
                        if (var3 == var5) {
                           return Objects.equals(Char2ObjectOpenHashMap.this.value[var7], var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               Object var4 = var2.getValue();
               if (var3 == 0) {
                  if (Char2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n], var4)) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2ObjectOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Objects.equals(Char2ObjectOpenHashMap.this.value[var7], var4)) {
                        Char2ObjectOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Char2ObjectOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(var5 != var3 || !Objects.equals(Char2ObjectOpenHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> var1) {
         if (Char2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2ObjectMap.BasicEntry(Char2ObjectOpenHashMap.this.key[Char2ObjectOpenHashMap.this.n], Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2ObjectOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2ObjectMap.BasicEntry(Char2ObjectOpenHashMap.this.key[var2], Char2ObjectOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2ObjectMap.Entry<V>> var1) {
         ...
         if (Char2ObjectOpenHashMap.this.containsNullKey) {
            var2.key = Char2ObjectOpenHashMap.this.key[Char2ObjectOpenHashMap.this.n];
            var2.value = Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2ObjectOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Char2ObjectOpenHashMap.this.key[var3] != 0) {
               var2.key = Char2ObjectOpenHashMap.this.key[var3];
               var2.value = Char2ObjectOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Char2ObjectMap.Entry<V>> {
      private final Char2ObjectOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2ObjectOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Char2ObjectMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2ObjectOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Char2ObjectOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Char2ObjectOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2ObjectOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2ObjectOpenHashMap.this.mask;

            char var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Char2ObjectOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4) & Char2ObjectOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2ObjectOpenHashMap.this.value[var2] = Char2ObjectOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2ObjectMap.Entry<V>, java.util.Map.Entry<Character, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Char2ObjectOpenHashMap.this.value[this.index];
         Char2ObjectOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2ObjectOpenHashMap.this.key[this.index] == (Character)var2.getKey() && Objects.equals(Char2ObjectOpenHashMap.this.value[this.index], var2.getValue());
         }
      }
