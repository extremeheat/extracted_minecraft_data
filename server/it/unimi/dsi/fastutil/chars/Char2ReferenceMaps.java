...
public final class Char2ReferenceMaps {
   ...
   public static <V> ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator(Char2ReferenceMap<V> var0) {
      ObjectSet var1 = var0.char2ReferenceEntrySet();
      return var1 instanceof Char2ReferenceMap.FastEntrySet ? ((Char2ReferenceMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static <V> void fastForEach(Char2ReferenceMap<V> var0, Consumer<? super Char2ReferenceMap.Entry<V>> var1) {
      ObjectSet var2 = var0.char2ReferenceEntrySet();
      if (var2 instanceof Char2ReferenceMap.FastEntrySet) {
         ((Char2ReferenceMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static <V> ObjectIterable<Char2ReferenceMap.Entry<V>> fastIterable(Char2ReferenceMap<V> var0) {
      final ObjectSet var1 = var0.char2ReferenceEntrySet();
      return (ObjectIterable)(var1 instanceof Char2ReferenceMap.FastEntrySet ? new ObjectIterable<Char2ReferenceMap.Entry<V>>() {
         public ObjectIterator<Char2ReferenceMap.Entry<V>> iterator() {
            return ((Char2ReferenceMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> var1x) {
            ((Char2ReferenceMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }
   ...
   public static <V> Char2ReferenceMap<V> singleton(char var0, V var1) {
      return new Char2ReferenceMaps.Singleton(var0, var1);
   }

   public static <V> Char2ReferenceMap<V> singleton(Character var0, V var1) {
      return new Char2ReferenceMaps.Singleton(var0, var1);
   }

   public static <V> Char2ReferenceMap<V> synchronize(Char2ReferenceMap<V> var0) {
      return new Char2ReferenceMaps.SynchronizedMap(var0);
   }

   public static <V> Char2ReferenceMap<V> synchronize(Char2ReferenceMap<V> var0, Object var1) {
      return new Char2ReferenceMaps.SynchronizedMap(var0, var1);
   }

   public static <V> Char2ReferenceMap<V> unmodifiable(Char2ReferenceMap<V> var0) {
      return new Char2ReferenceMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap<V> extends Char2ReferenceFunctions.UnmodifiableFunction<V> implements Char2ReferenceMap<V>, Serializable {
      ...
      protected UnmodifiableMap(Char2ReferenceMap<V> var1) {
         super(var1);
         this.map = var1;
      }
      ...
      public V computeIfAbsentPartial(char var1, Char2ReferenceFunction<? extends V> var2) {
         throw new UnsupportedOperationException();
      }
   ...
   public static class SynchronizedMap<V> extends Char2ReferenceFunctions.SynchronizedFunction<V> implements Char2ReferenceMap<V>, Serializable {
      ...
      protected SynchronizedMap(Char2ReferenceMap<V> var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Char2ReferenceMap<V> var1) {
         super(var1);
         this.map = var1;
      }
