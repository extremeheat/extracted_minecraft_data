...
public class CharOpenCustomHashSet extends AbstractCharSet implements Serializable, Cloneable, Hash {
   ...
   public CharOpenCustomHashSet(int var1, float var2, CharHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public CharOpenCustomHashSet(int var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public CharOpenCustomHashSet(CharHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public CharOpenCustomHashSet(Collection<? extends Character> var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public CharOpenCustomHashSet(Collection<? extends Character> var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public CharOpenCustomHashSet(CharCollection var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public CharOpenCustomHashSet(CharCollection var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public CharOpenCustomHashSet(CharIterator var1, float var2, CharHash.Strategy var3) {
      this(16, var2, var3);
   ...
   public CharOpenCustomHashSet(CharIterator var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public CharOpenCustomHashSet(Iterator<?> var1, float var2, CharHash.Strategy var3) {
      this(CharIterators.asCharIterator(var1), var2, var3);
   }

   public CharOpenCustomHashSet(Iterator<?> var1, CharHash.Strategy var2) {
      this(CharIterators.asCharIterator(var1), var2);
   }

   public CharOpenCustomHashSet(char[] var1, int var2, int var3, float var4, CharHash.Strategy var5) {
   ...
   public CharOpenCustomHashSet(char[] var1, int var2, int var3, CharHash.Strategy var4) {
      this(var1, var2, var3, 0.75F, var4);
   }

   public CharOpenCustomHashSet(char[] var1, float var2, CharHash.Strategy var3) {
      this(var1, 0, var1.length, var2, var3);
   }

   public CharOpenCustomHashSet(char[] var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }
   ...
   public CharOpenCustomHashSet clone() {
      CharOpenCustomHashSet var1;
      try {
         var1 = (CharOpenCustomHashSet)super.clone();
   ...
   private class SetIterator implements CharIterator {
      ...
      public char nextChar() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNull) {
               ...
               char[] var1 = CharOpenCustomHashSet.this.key;
      ...
      private final void shiftKeys(int var1) {
         char[] var5 = CharOpenCustomHashSet.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & CharOpenCustomHashSet.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(CharOpenCustomHashSet.this.strategy.hashCode(var4)) & CharOpenCustomHashSet.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
