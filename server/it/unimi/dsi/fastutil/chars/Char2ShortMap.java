...
public interface Char2ShortMap extends Char2ShortFunction, Map<Character, Short> {
   ...
   default Short put(Character var1, Short var2) {
      return Char2ShortFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short get(Object var1) {
      return Char2ShortFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Short remove(Object var1) {
      return Char2ShortFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Char2ShortFunction.super.containsKey(var1);
   }
   ...
   default short getOrDefault(char var1, short var2) {
      short var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default short putIfAbsent(char var1, short var2) {
   ...
   default boolean remove(char var1, short var2) {
      short var3 = this.get(var1);
   ...
   default boolean replace(char var1, short var2, short var3) {
   ...
   default short replace(char var1, short var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default short computeIfAbsent(char var1, IntUnaryOperator var2) {
   ...
   default short computeIfAbsentNullable(char var1, IntFunction<? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short computeIfAbsentPartial(char var1, Char2ShortFunction var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short computeIfPresent(char var1, BiFunction<? super Character, ? super Short, ? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short compute(char var1, BiFunction<? super Character, ? super Short, ? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
   ...
   default short merge(char var1, short var2, BiFunction<? super Short, ? super Short, ? extends Short> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Short putIfAbsent(Character var1, Short var2) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Character var1, Short var2, Short var3) {
      return super.replace(var1, var2, var3);
   }

   /** @deprecated */
   @Deprecated
   default Short replace(Character var1, Short var2) {
      return (Short)super.replace(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short computeIfAbsent(Character var1, Function<? super Character, ? extends Short> var2) {
      return (Short)super.computeIfAbsent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short computeIfPresent(Character var1, BiFunction<? super Character, ? super Short, ? extends Short> var2) {
      return (Short)super.computeIfPresent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short compute(Character var1, BiFunction<? super Character, ? super Short, ? extends Short> var2) {
      return (Short)super.compute(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short merge(Character var1, Short var2, BiFunction<? super Short, ? super Short, ? extends Short> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Char2ShortMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Char2ShortMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
