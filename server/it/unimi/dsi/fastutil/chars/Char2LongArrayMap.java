...
public class Char2LongArrayMap extends AbstractChar2LongMap implements Serializable, Cloneable {
   ...
   public Char2LongArrayMap(char[] var1, long[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2LongArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new long[var1];
   }

   public Char2LongArrayMap(Char2LongMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2LongArrayMap(Map<? extends Character, ? extends Long> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2LongArrayMap(char[] var1, long[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2LongArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2LongArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2LongArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2LongArrayMap.this.key, var2 + 1, Char2LongArrayMap.this.key, var2, var3);
               System.arraycopy(Char2LongArrayMap.this.value, var2 + 1, Char2LongArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2LongArrayMap.this.size - this.pos;
                     System.arraycopy(Char2LongArrayMap.this.key, this.pos, Char2LongArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2LongArrayMap.this.value, this.pos, Char2LongArrayMap.this.value, this.pos - 1, var1);
                     Char2LongArrayMap.this.size--;
                  }
               }
            };
   ...
   public LongCollection values() {
      return new AbstractLongCollection() {
         public boolean contains(long var1) {
            return Char2LongArrayMap.this.containsValue(var1);
         }
   ...
   public Char2LongArrayMap clone() {
      Char2LongArrayMap var1;
      try {
         var1 = (Char2LongArrayMap)super.clone();
         ...
         return new ObjectIterator<Char2LongMap.Entry>() {
            ...
            public Char2LongMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2LongMap.BasicEntry(Char2LongArrayMap.this.key[this.curr = this.next], Char2LongArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2LongArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2LongArrayMap.this.key, this.next + 1, Char2LongArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2LongArrayMap.this.value, this.next + 1, Char2LongArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  return Char2LongArrayMap.this.containsKey(var3) && Char2LongArrayMap.this.get(var3) == (Long)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  int var6 = Char2LongArrayMap.this.findKey(var3);
                  if (var6 != -1 && var4 == Char2LongArrayMap.this.value[var6]) {
                     int var7 = Char2LongArrayMap.this.size - var6 - 1;
                     System.arraycopy(Char2LongArrayMap.this.key, var6 + 1, Char2LongArrayMap.this.key, var6, var7);
                     System.arraycopy(Char2LongArrayMap.this.value, var6 + 1, Char2LongArrayMap.this.value, var6, var7);
                     Char2LongArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
