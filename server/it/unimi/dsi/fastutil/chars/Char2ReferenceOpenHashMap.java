...
public class Char2ReferenceOpenHashMap<V> extends AbstractChar2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Char2ReferenceOpenHashMap(int var1, float var2) {
      super();
   ...
   public Char2ReferenceOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> var1) {
      this(var1, 0.75F);
   }

   public Char2ReferenceOpenHashMap(char[] var1, V[] var2, float var3) {
   ...
   public Char2ReferenceOpenHashMap(char[] var1, V[] var2) {
   ...
   public Char2ReferenceMap.FastEntrySet<V> char2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new Char2ReferenceOpenHashMap.MapEntrySet();
      }
   ...
   public CharSet keySet() {
      if (this.keys == null) {
         this.keys = new Char2ReferenceOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            public ObjectIterator<V> iterator() {
               return Char2ReferenceOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(Object var1) {
               return Char2ReferenceOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                  var1.accept(Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n]);
               }

               int var2 = Char2ReferenceOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2ReferenceOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Char2ReferenceOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2ReferenceOpenHashMap<V> clone() {
      Char2ReferenceOpenHashMap var1;
      try {
         var1 = (Char2ReferenceOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      Object[] var3 = this.value;
      Char2ReferenceOpenHashMap.MapIterator var4 = new Char2ReferenceOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharIterator iterator() {
         return Char2ReferenceOpenHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Char2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.n]);
         }

         int var2 = Char2ReferenceOpenHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2ReferenceOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2ReferenceOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2ReferenceOpenHashMap.this.size;
         Char2ReferenceOpenHashMap.this.remove(var1);
         return Char2ReferenceOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements CharIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ReferenceMap.Entry<V>> implements Char2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectIterator<Char2ReferenceMap.Entry<V>> iterator() {
         return Char2ReferenceOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator() {
         return Char2ReferenceOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               if (var3 == 0) {
                  return Char2ReferenceOpenHashMap.this.containsNullKey && Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n] == var4;
               } else {
                  char[] var6 = Char2ReferenceOpenHashMap.this.key;
                  char var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2ReferenceOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (var3 == var5) {
                     return Char2ReferenceOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Char2ReferenceOpenHashMap.this.mask]) != 0) {
                        if (var3 == var5) {
                           return Char2ReferenceOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               Object var4 = var2.getValue();
               if (var3 == 0) {
                  if (Char2ReferenceOpenHashMap.this.containsNullKey && Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2ReferenceOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Char2ReferenceOpenHashMap.this.value[var7] == var4) {
                        Char2ReferenceOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Char2ReferenceOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(var5 != var3 || Char2ReferenceOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> var1) {
         if (Char2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.n], Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2ReferenceOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceOpenHashMap.this.key[var2], Char2ReferenceOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> var1) {
         ...
         if (Char2ReferenceOpenHashMap.this.containsNullKey) {
            var2.key = Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.n];
            var2.value = Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2ReferenceOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Char2ReferenceOpenHashMap.this.key[var3] != 0) {
               var2.key = Char2ReferenceOpenHashMap.this.key[var3];
               var2.value = Char2ReferenceOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
      private final Char2ReferenceOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2ReferenceOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
      ...
      public Char2ReferenceOpenHashMap<V>.MapEntry next() {
         return this.entry = Char2ReferenceOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2ReferenceOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Char2ReferenceOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Char2ReferenceOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2ReferenceOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2ReferenceOpenHashMap.this.mask;

            char var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Char2ReferenceOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4) & Char2ReferenceOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2ReferenceOpenHashMap.this.value[var2] = Char2ReferenceOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2ReferenceMap.Entry<V>, java.util.Map.Entry<Character, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Char2ReferenceOpenHashMap.this.value[this.index];
         Char2ReferenceOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2ReferenceOpenHashMap.this.key[this.index] == (Character)var2.getKey() && Char2ReferenceOpenHashMap.this.value[this.index] == var2.getValue();
         }
      }
