...
public interface Char2LongMap extends Char2LongFunction, Map<Character, Long> {
   ...
   default Long put(Character var1, Long var2) {
      return Char2LongFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Long get(Object var1) {
      return Char2LongFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Long remove(Object var1) {
      return Char2LongFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Char2LongFunction.super.containsKey(var1);
   }
   ...
   default long getOrDefault(char var1, long var2) {
      long var4;
      return (var4 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var4;
   }

   default long putIfAbsent(char var1, long var2) {
   ...
   default boolean remove(char var1, long var2) {
      long var4 = this.get(var1);
   ...
   default boolean replace(char var1, long var2, long var4) {
   ...
   default long replace(char var1, long var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default long computeIfAbsent(char var1, IntToLongFunction var2) {
   ...
   default long computeIfAbsentNullable(char var1, IntFunction<? extends Long> var2) {
      Objects.requireNonNull(var2);
      long var3 = this.get(var1);
   ...
   default long computeIfAbsentPartial(char var1, Char2LongFunction var2) {
      Objects.requireNonNull(var2);
      long var3 = this.get(var1);
      long var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default long computeIfPresent(char var1, BiFunction<? super Character, ? super Long, ? extends Long> var2) {
      Objects.requireNonNull(var2);
      long var3 = this.get(var1);
      long var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default long compute(char var1, BiFunction<? super Character, ? super Long, ? extends Long> var2) {
      Objects.requireNonNull(var2);
      long var3 = this.get(var1);
      long var5 = this.defaultReturnValue();
   ...
   default long merge(char var1, long var2, BiFunction<? super Long, ? super Long, ? extends Long> var4) {
   ...
   /** @deprecated */
   @Deprecated
   default Long putIfAbsent(Character var1, Long var2) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Character var1, Long var2, Long var3) {
      return super.replace(var1, var2, var3);
   }

   /** @deprecated */
   @Deprecated
   default Long replace(Character var1, Long var2) {
      return (Long)super.replace(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Long computeIfAbsent(Character var1, Function<? super Character, ? extends Long> var2) {
      return (Long)super.computeIfAbsent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Long computeIfPresent(Character var1, BiFunction<? super Character, ? super Long, ? extends Long> var2) {
      return (Long)super.computeIfPresent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Long compute(Character var1, BiFunction<? super Character, ? super Long, ? extends Long> var2) {
      return (Long)super.compute(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Long merge(Character var1, Long var2, BiFunction<? super Long, ? super Long, ? extends Long> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Char2LongMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Char2LongMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
