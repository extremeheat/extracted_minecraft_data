...
public class Char2IntAVLTreeMap extends AbstractChar2IntSortedMap implements Serializable, Cloneable {
   ...
   public Char2IntAVLTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2IntAVLTreeMap(Map<? extends Character, ? extends Integer> var1) {
      this();
      this.putAll(var1);
   }

   public Char2IntAVLTreeMap(SortedMap<Character, Integer> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2IntAVLTreeMap(Char2IntMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2IntAVLTreeMap(Char2IntSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2IntAVLTreeMap(char[] var1, int[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2IntAVLTreeMap(char[] var1, int[] var2) {
   ...
   final Char2IntAVLTreeMap.Entry findKey(char var1) {
      Char2IntAVLTreeMap.Entry var2;
      int var3;
   ...
   final Char2IntAVLTreeMap.Entry locateKey(char var1) {
      Char2IntAVLTreeMap.Entry var2 = this.tree;
      Char2IntAVLTreeMap.Entry var3 = this.tree;
   ...
   public int addTo(char var1, int var2) {
      Char2IntAVLTreeMap.Entry var3 = this.add(var1);
      int var4 = var3.value;
      var3.value += var2;
      return var4;
   }
   ...
   private Char2IntAVLTreeMap.Entry add(char var1) {
      this.modified = false;
      Char2IntAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Char2IntAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Char2IntAVLTreeMap.Entry var3 = this.tree;
         Char2IntAVLTreeMap.Entry var4 = null;
         Char2IntAVLTreeMap.Entry var5 = this.tree;
         Char2IntAVLTreeMap.Entry var6 = null;
         Char2IntAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Char2IntAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Char2IntAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Char2IntAVLTreeMap.Entry parent(Char2IntAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Char2IntAVLTreeMap.Entry var3 = var1;

         Char2IntAVLTreeMap.Entry var2;
         Char2IntAVLTreeMap.Entry var4;
   ...
   public int remove(char var1) {
      ...
      if (this.tree == null) {
         ...
         Char2IntAVLTreeMap.Entry var7;
         Char2IntAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
   ...
   public boolean containsValue(int var1) {
      Char2IntAVLTreeMap.ValueIterator var2 = new Char2IntAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public int get(char var1) {
      Char2IntAVLTreeMap.Entry var2 = this.findKey(var1);
   ...
   public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
            final Comparator<? super Char2IntMap.Entry> comparator = (var1x, var2) -> {
               return Char2IntAVLTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry var1) {
               return Char2IntAVLTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        Char2IntAVLTreeMap.Entry var3 = Char2IntAVLTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        ...
                        if (var3 != null && var3.getIntValue() == (Integer)var2.getValue()) {
                           Char2IntAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry var1, Char2IntMap.Entry var2) {
               return Char2IntAVLTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2IntEntrySet();
            }

            public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry var1) {
               return Char2IntAVLTreeMap.this.headMap(var1.getCharKey()).char2IntEntrySet();
            }

            public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry var1) {
               return Char2IntAVLTreeMap.this.tailMap(var1.getCharKey()).char2IntEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Char2IntAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Char2IntSortedMap headMap(char var1) {
      return new Char2IntAVLTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2IntSortedMap tailMap(char var1) {
      return new Char2IntAVLTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2IntSortedMap subMap(char var1, char var2) {
      return new Char2IntAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Char2IntAVLTreeMap clone() {
      Char2IntAVLTreeMap var1;
      try {
         var1 = (Char2IntAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2IntAVLTreeMap.Entry var5 = new Char2IntAVLTreeMap.Entry();
         Char2IntAVLTreeMap.Entry var6 = new Char2IntAVLTreeMap.Entry();
         Char2IntAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2IntAVLTreeMap.Entry var4 = var6;
         var6.pred((Char2IntAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2IntAVLTreeMap.EntryIterator var3 = new Char2IntAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2IntAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2IntAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2IntAVLTreeMap.Entry var3, Char2IntAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2IntAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2IntAVLTreeMap.Entry(var1.readChar(), var1.readInt());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Char2IntAVLTreeMap.Entry(var1.readChar(), var1.readInt());
         var8.right(new Char2IntAVLTreeMap.Entry(var1.readChar(), var1.readInt()));
         ...
         Char2IntAVLTreeMap.Entry var7 = new Char2IntAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2IntAVLTreeMap.Entry)null, (Char2IntAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2IntSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2IntAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2IntAVLTreeMap.Submap.SubmapIterator var1 = new Char2IntAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2IntAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2IntAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
         if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
               ...
               public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry var1, Char2IntMap.Entry var2) {
                  return Submap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2IntEntrySet();
               }

               public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry var1) {
                  return Submap.this.headMap(var1.getCharKey()).char2IntEntrySet();
               }

               public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry var1) {
                  return Submap.this.tailMap(var1.getCharKey()).char2IntEntrySet();
               }
            };
         }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2IntAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(int var1) {
         Char2IntAVLTreeMap.Submap.SubmapIterator var2 = new Char2IntAVLTreeMap.Submap.SubmapIterator();
      ...
      public int get(char var1) {
         Char2IntAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2IntAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public int put(char var1, int var2) {
         ...
         if (!this.in(var1)) {
            ...
            int var3 = Char2IntAVLTreeMap.this.put(var1, var2);
            return Char2IntAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public int remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            int var2 = Char2IntAVLTreeMap.this.remove(var1);
            return Char2IntAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2IntSortedMap headMap(char var1) {
         if (this.top) {
            return Char2IntAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2IntAVLTreeMap.this.compare(var1, this.to) < 0 ? Char2IntAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2IntSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2IntAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2IntAVLTreeMap.this.compare(var1, this.from) > 0 ? Char2IntAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2IntSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2IntAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2IntAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2IntAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2IntAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2IntAVLTreeMap.Entry firstEntry() {
         if (Char2IntAVLTreeMap.this.tree == null) {
            ...
            Char2IntAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2IntAVLTreeMap.this.firstEntry;
            } else {
               var1 = Char2IntAVLTreeMap.this.locateKey(this.from);
               if (Char2IntAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2IntAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2IntAVLTreeMap.Entry lastEntry() {
         if (Char2IntAVLTreeMap.this.tree == null) {
            ...
            Char2IntAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2IntAVLTreeMap.this.lastEntry;
            } else {
               var1 = Char2IntAVLTreeMap.this.locateKey(this.to);
               if (Char2IntAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2IntAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2IntAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2IntAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2IntAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2IntMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2IntAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2IntAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2IntAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2IntAVLTreeMap.this.locateKey(var2);
                  if (Char2IntAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2IntSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2IntAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2IntAVLTreeMap.TreeIterator implements ObjectListIterator<Char2IntMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2IntAVLTreeMap.this.locateKey(var2)) != null) {
            if (Char2IntAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2IntMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2IntAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2IntAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2IntAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2IntAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2IntAVLTreeMap.Entry next() {
         Char2IntAVLTreeMap.Entry var1 = this.right;
      ...
      Char2IntAVLTreeMap.Entry prev() {
         Char2IntAVLTreeMap.Entry var1 = this.left;
      ...
      public Char2IntAVLTreeMap.Entry clone() {
         Char2IntAVLTreeMap.Entry var1;
         try {
            var1 = (Char2IntAVLTreeMap.Entry)super.clone();
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return this.key == (Character)var2.getKey() && this.value == (Integer)var2.getValue();
         }
      }
