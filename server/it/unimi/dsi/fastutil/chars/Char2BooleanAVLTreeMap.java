...
public class Char2BooleanAVLTreeMap extends AbstractChar2BooleanSortedMap implements Serializable, Cloneable {
   ...
   public Char2BooleanAVLTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2BooleanAVLTreeMap(Map<? extends Character, ? extends Boolean> var1) {
      this();
      this.putAll(var1);
   }

   public Char2BooleanAVLTreeMap(SortedMap<Character, Boolean> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2BooleanAVLTreeMap(Char2BooleanMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2BooleanAVLTreeMap(Char2BooleanSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2BooleanAVLTreeMap(char[] var1, boolean[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2BooleanAVLTreeMap(char[] var1, boolean[] var2) {
   ...
   final Char2BooleanAVLTreeMap.Entry findKey(char var1) {
      Char2BooleanAVLTreeMap.Entry var2;
      int var3;
   ...
   final Char2BooleanAVLTreeMap.Entry locateKey(char var1) {
      Char2BooleanAVLTreeMap.Entry var2 = this.tree;
      Char2BooleanAVLTreeMap.Entry var3 = this.tree;
   ...
   public boolean put(char var1, boolean var2) {
      Char2BooleanAVLTreeMap.Entry var3 = this.add(var1);
      boolean var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Char2BooleanAVLTreeMap.Entry add(char var1) {
      this.modified = false;
      Char2BooleanAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Char2BooleanAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Char2BooleanAVLTreeMap.Entry var3 = this.tree;
         Char2BooleanAVLTreeMap.Entry var4 = null;
         Char2BooleanAVLTreeMap.Entry var5 = this.tree;
         Char2BooleanAVLTreeMap.Entry var6 = null;
         Char2BooleanAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Char2BooleanAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Char2BooleanAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Char2BooleanAVLTreeMap.Entry parent(Char2BooleanAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Char2BooleanAVLTreeMap.Entry var3 = var1;

         Char2BooleanAVLTreeMap.Entry var2;
         Char2BooleanAVLTreeMap.Entry var4;
   ...
   public boolean remove(char var1) {
      ...
      if (this.tree == null) {
         ...
         Char2BooleanAVLTreeMap.Entry var7;
         Char2BooleanAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Char2BooleanAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(boolean var1) {
      Char2BooleanAVLTreeMap.ValueIterator var2 = new Char2BooleanAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public boolean get(char var1) {
      Char2BooleanAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>() {
            final Comparator<? super Char2BooleanMap.Entry> comparator = (var1x, var2) -> {
               return Char2BooleanAVLTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry var1) {
               return Char2BooleanAVLTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        Char2BooleanAVLTreeMap.Entry var3 = Char2BooleanAVLTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        ...
                        if (var3 != null && var3.getBooleanValue() == (Boolean)var2.getValue()) {
                           Char2BooleanAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry var1, Char2BooleanMap.Entry var2) {
               return Char2BooleanAVLTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2BooleanEntrySet();
            }

            public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry var1) {
               return Char2BooleanAVLTreeMap.this.headMap(var1.getCharKey()).char2BooleanEntrySet();
            }

            public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry var1) {
               return Char2BooleanAVLTreeMap.this.tailMap(var1.getCharKey()).char2BooleanEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Char2BooleanAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Char2BooleanSortedMap headMap(char var1) {
      return new Char2BooleanAVLTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2BooleanSortedMap tailMap(char var1) {
      return new Char2BooleanAVLTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2BooleanSortedMap subMap(char var1, char var2) {
      return new Char2BooleanAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Char2BooleanAVLTreeMap clone() {
      Char2BooleanAVLTreeMap var1;
      try {
         var1 = (Char2BooleanAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2BooleanAVLTreeMap.Entry var5 = new Char2BooleanAVLTreeMap.Entry();
         Char2BooleanAVLTreeMap.Entry var6 = new Char2BooleanAVLTreeMap.Entry();
         Char2BooleanAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2BooleanAVLTreeMap.Entry var4 = var6;
         var6.pred((Char2BooleanAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2BooleanAVLTreeMap.EntryIterator var3 = new Char2BooleanAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2BooleanAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2BooleanAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2BooleanAVLTreeMap.Entry var3, Char2BooleanAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2BooleanAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2BooleanAVLTreeMap.Entry(var1.readChar(), var1.readBoolean());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Char2BooleanAVLTreeMap.Entry(var1.readChar(), var1.readBoolean());
         var8.right(new Char2BooleanAVLTreeMap.Entry(var1.readChar(), var1.readBoolean()));
         ...
         Char2BooleanAVLTreeMap.Entry var7 = new Char2BooleanAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2BooleanAVLTreeMap.Entry)null, (Char2BooleanAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2BooleanSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2BooleanAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2BooleanAVLTreeMap.Submap.SubmapIterator var1 = new Char2BooleanAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2BooleanAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2BooleanAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2BooleanAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(boolean var1) {
         Char2BooleanAVLTreeMap.Submap.SubmapIterator var2 = new Char2BooleanAVLTreeMap.Submap.SubmapIterator();
      ...
      public boolean get(char var1) {
         Char2BooleanAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2BooleanAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public boolean put(char var1, boolean var2) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var3 = Char2BooleanAVLTreeMap.this.put(var1, var2);
            return Char2BooleanAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public boolean remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var2 = Char2BooleanAVLTreeMap.this.remove(var1);
            return Char2BooleanAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2BooleanSortedMap headMap(char var1) {
         if (this.top) {
            return Char2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2BooleanAVLTreeMap.this.compare(var1, this.to) < 0 ? Char2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2BooleanSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2BooleanAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2BooleanAVLTreeMap.this.compare(var1, this.from) > 0 ? Char2BooleanAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2BooleanSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2BooleanAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2BooleanAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2BooleanAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2BooleanAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2BooleanAVLTreeMap.Entry firstEntry() {
         if (Char2BooleanAVLTreeMap.this.tree == null) {
            ...
            Char2BooleanAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2BooleanAVLTreeMap.this.firstEntry;
            } else {
               var1 = Char2BooleanAVLTreeMap.this.locateKey(this.from);
               if (Char2BooleanAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2BooleanAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2BooleanAVLTreeMap.Entry lastEntry() {
         if (Char2BooleanAVLTreeMap.this.tree == null) {
            ...
            Char2BooleanAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2BooleanAVLTreeMap.this.lastEntry;
            } else {
               var1 = Char2BooleanAVLTreeMap.this.locateKey(this.to);
               if (Char2BooleanAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2BooleanAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2BooleanAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2BooleanAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2BooleanAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2BooleanMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2BooleanAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2BooleanAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2BooleanAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2BooleanAVLTreeMap.this.locateKey(var2);
                  if (Char2BooleanAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2BooleanSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2BooleanAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2BooleanAVLTreeMap.TreeIterator implements ObjectListIterator<Char2BooleanMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Char2BooleanMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Char2BooleanMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2BooleanAVLTreeMap.this.locateKey(var2)) != null) {
            if (Char2BooleanAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2BooleanMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2BooleanAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2BooleanAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2BooleanAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2BooleanAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2BooleanAVLTreeMap.Entry next() {
         Char2BooleanAVLTreeMap.Entry var1 = this.right;
      ...
      Char2BooleanAVLTreeMap.Entry prev() {
         Char2BooleanAVLTreeMap.Entry var1 = this.left;
      ...
      public Char2BooleanAVLTreeMap.Entry clone() {
         Char2BooleanAVLTreeMap.Entry var1;
         try {
            var1 = (Char2BooleanAVLTreeMap.Entry)super.clone();
