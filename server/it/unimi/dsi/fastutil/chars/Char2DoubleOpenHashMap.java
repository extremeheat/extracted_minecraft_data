...
public class Char2DoubleOpenHashMap extends AbstractChar2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Char2DoubleOpenHashMap(int var1, float var2) {
      super();
   ...
   public Char2DoubleOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Char2DoubleOpenHashMap(Map<? extends Character, ? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2DoubleOpenHashMap(Map<? extends Character, ? extends Double> var1) {
      this(var1, 0.75F);
   }

   public Char2DoubleOpenHashMap(Char2DoubleMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2DoubleOpenHashMap(Char2DoubleMap var1) {
      this(var1, 0.75F);
   }

   public Char2DoubleOpenHashMap(char[] var1, double[] var2, float var3) {
   ...
   public Char2DoubleOpenHashMap(char[] var1, double[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Char2DoubleOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Char2DoubleOpenHashMap.this.containsNullKey) {
                  var1.accept(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]);
               }

               int var2 = Char2DoubleOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2DoubleOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Char2DoubleOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2DoubleOpenHashMap clone() {
      Char2DoubleOpenHashMap var1;
      try {
         var1 = (Char2DoubleOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      double[] var3 = this.value;
      Char2DoubleOpenHashMap.MapIterator var4 = new Char2DoubleOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Char2DoubleOpenHashMap.MapIterator implements DoubleIterator {
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.n]);
         }

         int var2 = Char2DoubleOpenHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2DoubleOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2DoubleOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2DoubleOpenHashMap.this.size;
         Char2DoubleOpenHashMap.this.remove(var1);
         return Char2DoubleOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Char2DoubleOpenHashMap.MapIterator implements CharIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (var3 == 0) {
                     return Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4);
                  } else {
                     char[] var7 = Char2DoubleOpenHashMap.this.key;
                     char var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Char2DoubleOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var6) {
                        return Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Char2DoubleOpenHashMap.this.mask]) != 0) {
                           if (var3 == var6) {
                              return Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var4 = (Double)var2.getValue();
                  if (var3 == 0) {
                     if (Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Char2DoubleOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                           Char2DoubleOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Char2DoubleOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var6 != var3 || Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Char2DoubleMap.Entry> var1) {
         if (Char2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2DoubleMap.BasicEntry(Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.n], Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2DoubleOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2DoubleMap.BasicEntry(Char2DoubleOpenHashMap.this.key[var2], Char2DoubleOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2DoubleMap.Entry> var1) {
         ...
         if (Char2DoubleOpenHashMap.this.containsNullKey) {
            var2.key = Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.n];
            var2.value = Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2DoubleOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Char2DoubleOpenHashMap.this.key[var3] != 0) {
               var2.key = Char2DoubleOpenHashMap.this.key[var3];
               var2.value = Char2DoubleOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2DoubleOpenHashMap.MapIterator implements ObjectIterator<Char2DoubleMap.Entry> {
      private final Char2DoubleOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2DoubleOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2DoubleOpenHashMap.MapIterator implements ObjectIterator<Char2DoubleMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2DoubleOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Char2DoubleOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Char2DoubleOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2DoubleOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2DoubleOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Char2DoubleOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2DoubleOpenHashMap.this.value[var2] = Char2DoubleOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2DoubleMap.Entry, java.util.Map.Entry<Character, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Char2DoubleOpenHashMap.this.value[this.index];
         Char2DoubleOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2DoubleOpenHashMap.this.key[this.index] == (Character)var2.getKey() && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
