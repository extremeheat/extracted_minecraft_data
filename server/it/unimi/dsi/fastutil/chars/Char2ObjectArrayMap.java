...
public class Char2ObjectArrayMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Char2ObjectArrayMap(char[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2ObjectArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new Object[var1];
   }

   public Char2ObjectArrayMap(Char2ObjectMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2ObjectArrayMap(Map<? extends Character, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2ObjectArrayMap(char[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2ObjectArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2ObjectArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2ObjectArrayMap.this.key, var2 + 1, Char2ObjectArrayMap.this.key, var2, var3);
               System.arraycopy(Char2ObjectArrayMap.this.value, var2 + 1, Char2ObjectArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Char2ObjectArrayMap.this.key, this.pos, Char2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2ObjectArrayMap.this.value, this.pos, Char2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Char2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Char2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Char2ObjectArrayMap<V> clone() {
      Char2ObjectArrayMap var1;
      try {
         var1 = (Char2ObjectArrayMap)super.clone();
         ...
         return new ObjectIterator<Char2ObjectMap.Entry<V>>() {
            ...
            public Char2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2ObjectMap.BasicEntry(Char2ObjectArrayMap.this.key[this.curr = this.next], Char2ObjectArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2ObjectArrayMap.this.key, this.next + 1, Char2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2ObjectArrayMap.this.value, this.next + 1, Char2ObjectArrayMap.this.value, this.next, var1);
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               return Char2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Char2ObjectArrayMap.this.get(var3), var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               ...
               int var5 = Char2ObjectArrayMap.this.findKey(var3);
               if (var5 != -1 && Objects.equals(var4, Char2ObjectArrayMap.this.value[var5])) {
                  int var6 = Char2ObjectArrayMap.this.size - var5 - 1;
                  System.arraycopy(Char2ObjectArrayMap.this.key, var5 + 1, Char2ObjectArrayMap.this.key, var5, var6);
                  System.arraycopy(Char2ObjectArrayMap.this.value, var5 + 1, Char2ObjectArrayMap.this.value, var5, var6);
                  Char2ObjectArrayMap.this.size--;
                  Char2ObjectArrayMap.this.value[Char2ObjectArrayMap.this.size] = null;
                  return true;
               } else {
