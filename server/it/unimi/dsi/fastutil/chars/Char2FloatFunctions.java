...
public final class Char2FloatFunctions {
   ...
   public static Char2FloatFunction singleton(char var0, float var1) {
      return new Char2FloatFunctions.Singleton(var0, var1);
   }

   public static Char2FloatFunction singleton(Character var0, Float var1) {
      return new Char2FloatFunctions.Singleton(var0, var1);
   }

   public static Char2FloatFunction synchronize(Char2FloatFunction var0) {
      return new Char2FloatFunctions.SynchronizedFunction(var0);
   }

   public static Char2FloatFunction synchronize(Char2FloatFunction var0, Object var1) {
      return new Char2FloatFunctions.SynchronizedFunction(var0, var1);
   }

   public static Char2FloatFunction unmodifiable(Char2FloatFunction var0) {
      return new Char2FloatFunctions.UnmodifiableFunction(var0);
   }

   public static Char2FloatFunction primitive(Function<? super Character, ? extends Float> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Char2FloatFunction) {
         return (Char2FloatFunction)var0;
      } else {
         return (Char2FloatFunction)(var0 instanceof IntToDoubleFunction ? (var1) -> {
            return SafeMath.safeDoubleToFloat(((IntToDoubleFunction)var0).applyAsDouble(var1));
         } : new Char2FloatFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class PrimitiveFunction implements Char2FloatFunction {
      ...
      protected PrimitiveFunction(Function<? super Character, ? extends Float> var1) {
         super();
         this.function = var1;
      }
      ...
      public Float get(Object var1) {
         return var1 == null ? null : (Float)this.function.apply((Character)var1);
      }

      /** @deprecated */
      @Deprecated
      public Float put(Character var1, Float var2) {
   ...
   public static class UnmodifiableFunction extends AbstractChar2FloatFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Char2FloatFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Char2FloatFunction, Serializable {
      ...
      protected SynchronizedFunction(Char2FloatFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Char2FloatFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Float apply(Character var1) {
         synchronized(this.sync) {
