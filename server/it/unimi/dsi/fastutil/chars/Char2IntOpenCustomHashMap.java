...
public class Char2IntOpenCustomHashMap extends AbstractChar2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Char2IntOpenCustomHashMap(int var1, float var2, CharHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Char2IntOpenCustomHashMap(int var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2IntOpenCustomHashMap(CharHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Char2IntOpenCustomHashMap(Map<? extends Character, ? extends Integer> var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2IntOpenCustomHashMap(Map<? extends Character, ? extends Integer> var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2IntOpenCustomHashMap(Char2IntMap var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2IntOpenCustomHashMap(Char2IntMap var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2IntOpenCustomHashMap(char[] var1, int[] var2, float var3, CharHash.Strategy var4) {
   ...
   public Char2IntOpenCustomHashMap(char[] var1, int[] var2, CharHash.Strategy var3) {
   ...
   public Char2IntMap.FastEntrySet char2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new Char2IntOpenCustomHashMap.MapEntrySet();
      }
   ...
   public CharSet keySet() {
      if (this.keys == null) {
         this.keys = new Char2IntOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            public IntIterator iterator() {
               return Char2IntOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(int var1) {
               return Char2IntOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n]);
               }

               int var2 = Char2IntOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2IntOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Char2IntOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2IntOpenCustomHashMap clone() {
      Char2IntOpenCustomHashMap var1;
      try {
         var1 = (Char2IntOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      int[] var3 = this.value;
      Char2IntOpenCustomHashMap.MapIterator var4 = new Char2IntOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Char2IntOpenCustomHashMap.MapIterator implements IntIterator {
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharIterator iterator() {
         return Char2IntOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Char2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n]);
         }

         int var2 = Char2IntOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2IntOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2IntOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2IntOpenCustomHashMap.this.size;
         Char2IntOpenCustomHashMap.this.remove(var1);
         return Char2IntOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Char2IntOpenCustomHashMap.MapIterator implements CharIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet {
      ...
      public ObjectIterator<Char2IntMap.Entry> iterator() {
         return Char2IntOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Char2IntMap.Entry> fastIterator() {
         return Char2IntOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (Char2IntOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     return Char2IntOpenCustomHashMap.this.containsNullKey && Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n] == var4;
                  } else {
                     char[] var6 = Char2IntOpenCustomHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2IntOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Char2IntOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2IntOpenCustomHashMap.this.mask]) != 0) {
                           if (Char2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Char2IntOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var4 = (Integer)var2.getValue();
                  if (Char2IntOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     if (Char2IntOpenCustomHashMap.this.containsNullKey && Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2IntOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2IntOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Char2IntOpenCustomHashMap.this.value[var7] == var4) {
                           Char2IntOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2IntOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Char2IntOpenCustomHashMap.this.strategy.equals(var5, var3) || Char2IntOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2IntMap.Entry> var1) {
         if (Char2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2IntMap.BasicEntry(Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n], Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2IntOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2IntMap.BasicEntry(Char2IntOpenCustomHashMap.this.key[var2], Char2IntOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2IntMap.Entry> var1) {
         ...
         if (Char2IntOpenCustomHashMap.this.containsNullKey) {
            var2.key = Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n];
            var2.value = Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2IntOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Char2IntOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Char2IntOpenCustomHashMap.this.key[var3];
               var2.value = Char2IntOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Char2IntMap.Entry> {
      private final Char2IntOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2IntOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Char2IntMap.Entry> {
      ...
      public Char2IntOpenCustomHashMap.MapEntry next() {
         return this.entry = Char2IntOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2IntOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(var2)) & Char2IntOpenCustomHashMap.this.mask; !Char2IntOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Char2IntOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2IntOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2IntOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(var4)) & Char2IntOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2IntOpenCustomHashMap.this.value[var2] = Char2IntOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2IntMap.Entry, java.util.Map.Entry<Character, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Char2IntOpenCustomHashMap.this.value[this.index];
         Char2IntOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2IntOpenCustomHashMap.this.strategy.equals(Char2IntOpenCustomHashMap.this.key[this.index], (Character)var2.getKey()) && Char2IntOpenCustomHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
