...
public class Char2ByteOpenHashMap extends AbstractChar2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Char2ByteOpenHashMap(int var1, float var2) {
      super();
   ...
   public Char2ByteOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Char2ByteOpenHashMap(Map<? extends Character, ? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2ByteOpenHashMap(Map<? extends Character, ? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public Char2ByteOpenHashMap(Char2ByteMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Char2ByteOpenHashMap(Char2ByteMap var1) {
      this(var1, 0.75F);
   }

   public Char2ByteOpenHashMap(char[] var1, byte[] var2, float var3) {
   ...
   public Char2ByteOpenHashMap(char[] var1, byte[] var2) {
   ...
   public Char2ByteMap.FastEntrySet char2ByteEntrySet() {
      if (this.entries == null) {
         this.entries = new Char2ByteOpenHashMap.MapEntrySet();
      }
   ...
   public CharSet keySet() {
      if (this.keys == null) {
         this.keys = new Char2ByteOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            public ByteIterator iterator() {
               return Char2ByteOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(byte var1) {
               return Char2ByteOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Char2ByteOpenHashMap.this.containsNullKey) {
                  var1.accept(Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n]);
               }

               int var2 = Char2ByteOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2ByteOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Char2ByteOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2ByteOpenHashMap clone() {
      Char2ByteOpenHashMap var1;
      try {
         var1 = (Char2ByteOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      byte[] var3 = this.value;
      Char2ByteOpenHashMap.MapIterator var4 = new Char2ByteOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Char2ByteOpenHashMap.MapIterator implements ByteIterator {
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharIterator iterator() {
         return Char2ByteOpenHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Char2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n]);
         }

         int var2 = Char2ByteOpenHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2ByteOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2ByteOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2ByteOpenHashMap.this.size;
         Char2ByteOpenHashMap.this.remove(var1);
         return Char2ByteOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Char2ByteOpenHashMap.MapIterator implements CharIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
      ...
      public ObjectIterator<Char2ByteMap.Entry> iterator() {
         return Char2ByteOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Char2ByteMap.Entry> fastIterator() {
         return Char2ByteOpenHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (var3 == 0) {
                     return Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == var4;
                  } else {
                     char[] var6 = Char2ByteOpenHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2ByteOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Char2ByteOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2ByteOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Char2ByteOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var4 = (Byte)var2.getValue();
                  if (var3 == 0) {
                     if (Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Char2ByteOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Char2ByteOpenHashMap.this.value[var7] == var4) {
                           Char2ByteOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2ByteOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Char2ByteOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2ByteMap.Entry> var1) {
         if (Char2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n], Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2ByteOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenHashMap.this.key[var2], Char2ByteOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2ByteMap.Entry> var1) {
         ...
         if (Char2ByteOpenHashMap.this.containsNullKey) {
            var2.key = Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n];
            var2.value = Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2ByteOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Char2ByteOpenHashMap.this.key[var3] != 0) {
               var2.key = Char2ByteOpenHashMap.this.key[var3];
               var2.value = Char2ByteOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2ByteOpenHashMap.MapIterator implements ObjectIterator<Char2ByteMap.Entry> {
      private final Char2ByteOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2ByteOpenHashMap.this.new MapEntry();
      }

      public Char2ByteOpenHashMap.MapEntry next() {
   ...
   private class EntryIterator extends Char2ByteOpenHashMap.MapIterator implements ObjectIterator<Char2ByteMap.Entry> {
      ...
      public Char2ByteOpenHashMap.MapEntry next() {
         return this.entry = Char2ByteOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2ByteOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Char2ByteOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Char2ByteOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2ByteOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2ByteOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Char2ByteOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2ByteOpenHashMap.this.value[var2] = Char2ByteOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2ByteMap.Entry, java.util.Map.Entry<Character, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Char2ByteOpenHashMap.this.value[this.index];
         Char2ByteOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2ByteOpenHashMap.this.key[this.index] == (Character)var2.getKey() && Char2ByteOpenHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
