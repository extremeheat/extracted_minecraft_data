...
public class Char2ByteOpenCustomHashMap extends AbstractChar2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Char2ByteOpenCustomHashMap(int var1, float var2, CharHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Char2ByteOpenCustomHashMap(int var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2ByteOpenCustomHashMap(CharHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Char2ByteOpenCustomHashMap(Map<? extends Character, ? extends Byte> var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2ByteOpenCustomHashMap(Map<? extends Character, ? extends Byte> var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2ByteOpenCustomHashMap(Char2ByteMap var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2ByteOpenCustomHashMap(Char2ByteMap var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2ByteOpenCustomHashMap(char[] var1, byte[] var2, float var3, CharHash.Strategy var4) {
   ...
   public Char2ByteOpenCustomHashMap(char[] var1, byte[] var2, CharHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Char2ByteOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.n]);
               }

               int var2 = Char2ByteOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2ByteOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Char2ByteOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2ByteOpenCustomHashMap clone() {
      Char2ByteOpenCustomHashMap var1;
      try {
         var1 = (Char2ByteOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      byte[] var3 = this.value;
      Char2ByteOpenCustomHashMap.MapIterator var4 = new Char2ByteOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.n]);
         }

         int var2 = Char2ByteOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2ByteOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2ByteOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2ByteOpenCustomHashMap.this.size;
         Char2ByteOpenCustomHashMap.this.remove(var1);
         return Char2ByteOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (Char2ByteOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     return Char2ByteOpenCustomHashMap.this.containsNullKey && Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.n] == var4;
                  } else {
                     char[] var6 = Char2ByteOpenCustomHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2ByteOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Char2ByteOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2ByteOpenCustomHashMap.this.mask]) != 0) {
                           if (Char2ByteOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Char2ByteOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var4 = (Byte)var2.getValue();
                  if (Char2ByteOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     if (Char2ByteOpenCustomHashMap.this.containsNullKey && Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2ByteOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2ByteOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Char2ByteOpenCustomHashMap.this.value[var7] == var4) {
                           Char2ByteOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2ByteOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Char2ByteOpenCustomHashMap.this.strategy.equals(var5, var3) || Char2ByteOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2ByteMap.Entry> var1) {
         if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.n], Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2ByteOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenCustomHashMap.this.key[var2], Char2ByteOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2ByteMap.Entry> var1) {
         ...
         if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
            var2.key = Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.n];
            var2.value = Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2ByteOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Char2ByteOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Char2ByteOpenCustomHashMap.this.key[var3];
               var2.value = Char2ByteOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Char2ByteMap.Entry> {
      private final Char2ByteOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2ByteOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Char2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2ByteOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(var2)) & Char2ByteOpenCustomHashMap.this.mask; !Char2ByteOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Char2ByteOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2ByteOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2ByteOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(var4)) & Char2ByteOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2ByteOpenCustomHashMap.this.value[var2] = Char2ByteOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2ByteMap.Entry, java.util.Map.Entry<Character, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Char2ByteOpenCustomHashMap.this.value[this.index];
         Char2ByteOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[this.index], (Character)var2.getKey()) && Char2ByteOpenCustomHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
