...
public class Char2FloatOpenCustomHashMap extends AbstractChar2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Char2FloatOpenCustomHashMap(int var1, float var2, CharHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Char2FloatOpenCustomHashMap(int var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2FloatOpenCustomHashMap(CharHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2FloatOpenCustomHashMap(Char2FloatMap var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2FloatOpenCustomHashMap(Char2FloatMap var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2FloatOpenCustomHashMap(char[] var1, float[] var2, float var3, CharHash.Strategy var4) {
   ...
   public Char2FloatOpenCustomHashMap(char[] var1, float[] var2, CharHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Char2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Char2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2FloatOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept((double)Char2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2FloatOpenCustomHashMap clone() {
      Char2FloatOpenCustomHashMap var1;
      try {
         var1 = (Char2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      float[] var3 = this.value;
      Char2FloatOpenCustomHashMap.MapIterator var4 = new Char2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Char2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2FloatOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2FloatOpenCustomHashMap.this.size;
         Char2FloatOpenCustomHashMap.this.remove(var1);
         return Char2FloatOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Char2FloatOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     return Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     char[] var6 = Char2FloatOpenCustomHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2FloatOpenCustomHashMap.this.mask]) != 0) {
                           if (Char2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (Char2FloatOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     if (Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2FloatOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Char2FloatOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2FloatOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Char2FloatOpenCustomHashMap.this.strategy.equals(var5, var3) || Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Char2FloatMap.Entry> var1) {
         if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2FloatMap.BasicEntry(Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.n], Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2FloatOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2FloatMap.BasicEntry(Char2FloatOpenCustomHashMap.this.key[var2], Char2FloatOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2FloatMap.Entry> var1) {
         ...
         if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.n];
            var2.value = Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Char2FloatOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Char2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Char2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Char2FloatMap.Entry> {
      private final Char2FloatOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Char2FloatMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2FloatOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Char2FloatOpenCustomHashMap.this.mask; !Char2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Char2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Char2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2FloatOpenCustomHashMap.this.value[var2] = Char2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2FloatMap.Entry, java.util.Map.Entry<Character, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Char2FloatOpenCustomHashMap.this.value[this.index];
         Char2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[this.index], (Character)var2.getKey()) && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
