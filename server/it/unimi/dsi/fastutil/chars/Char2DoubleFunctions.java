...
public final class Char2DoubleFunctions {
   ...
   public static Char2DoubleFunction singleton(char var0, double var1) {
      return new Char2DoubleFunctions.Singleton(var0, var1);
   }

   public static Char2DoubleFunction singleton(Character var0, Double var1) {
      return new Char2DoubleFunctions.Singleton(var0, var1);
   }

   public static Char2DoubleFunction synchronize(Char2DoubleFunction var0) {
      return new Char2DoubleFunctions.SynchronizedFunction(var0);
   }

   public static Char2DoubleFunction synchronize(Char2DoubleFunction var0, Object var1) {
      return new Char2DoubleFunctions.SynchronizedFunction(var0, var1);
   }

   public static Char2DoubleFunction unmodifiable(Char2DoubleFunction var0) {
      return new Char2DoubleFunctions.UnmodifiableFunction(var0);
   }

   public static Char2DoubleFunction primitive(Function<? super Character, ? extends Double> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Char2DoubleFunction) {
         return (Char2DoubleFunction)var0;
         ...
         return new Char2DoubleFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Char2DoubleFunction {
      ...
      protected PrimitiveFunction(Function<? super Character, ? extends Double> var1) {
         super();
         this.function = var1;
      }
      ...
      public Double get(Object var1) {
         return var1 == null ? null : (Double)this.function.apply((Character)var1);
      }

      /** @deprecated */
      @Deprecated
      public Double put(Character var1, Double var2) {
   ...
   public static class UnmodifiableFunction extends AbstractChar2DoubleFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Char2DoubleFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Char2DoubleFunction, Serializable {
      ...
      protected SynchronizedFunction(Char2DoubleFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Char2DoubleFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Double apply(Character var1) {
         synchronized(this.sync) {
