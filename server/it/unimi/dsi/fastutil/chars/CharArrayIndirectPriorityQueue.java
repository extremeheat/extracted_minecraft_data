...
public class CharArrayIndirectPriorityQueue implements CharIndirectPriorityQueue {
   ...
   public CharArrayIndirectPriorityQueue(char[] var1, int var2, CharComparator var3) {
      super();
   ...
   public CharArrayIndirectPriorityQueue(char[] var1, int var2) {
      this(var1, var2, (CharComparator)null);
   }

   public CharArrayIndirectPriorityQueue(char[] var1, CharComparator var2) {
      this(var1, var1.length, var2);
   }

   public CharArrayIndirectPriorityQueue(char[] var1) {
      this(var1, var1.length, (CharComparator)null);
   }

   public CharArrayIndirectPriorityQueue(char[] var1, int[] var2, int var3, CharComparator var4) {
      this(var1, 0, var4);
      this.array = var2;
      this.size = var3;
   }
   ...
   public CharArrayIndirectPriorityQueue(char[] var1, int[] var2, int var3) {
   ...
   private int findFirst() {
      if (this.firstIndexValid) {
         ...
         --var1;
         int var2 = var1;
         char var3 = this.refArray[this.array[var1]];
         if (this.c == null) {
            while(var1-- != 0) {
   ...
   public int front(int[] var1) {
      char var2 = this.refArray[this.array[this.findFirst()]];
      int var3 = this.size;
      int var4 = 0;

      while(var3-- != 0) {
         if (var2 == this.refArray[this.array[var3]]) {
