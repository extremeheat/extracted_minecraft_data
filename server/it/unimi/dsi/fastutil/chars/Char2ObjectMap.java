...
public interface Char2ObjectMap<V> extends Char2ObjectFunction<V>, Map<Character, V> {
   ...
   default V put(Character var1, V var2) {
      return Char2ObjectFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V get(Object var1) {
      return Char2ObjectFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default V remove(Object var1) {
      return Char2ObjectFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Char2ObjectFunction.super.containsKey(var1);
   }
   ...
   default V computeIfAbsentPartial(char var1, Char2ObjectFunction<? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<V> extends ObjectSet<Char2ObjectMap.Entry<V>> {
      ...
      default void fastForEach(Consumer<? super Char2ObjectMap.Entry<V>> var1) {
         this.forEach(var1);
      }
   }
}
