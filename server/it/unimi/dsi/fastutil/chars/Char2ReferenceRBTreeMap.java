...
public class Char2ReferenceRBTreeMap<V> extends AbstractChar2ReferenceSortedMap<V> implements Serializable, Cloneable {
   ...
   public Char2ReferenceRBTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2ReferenceRBTreeMap(Map<? extends Character, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Char2ReferenceRBTreeMap(SortedMap<Character, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2ReferenceRBTreeMap(Char2ReferenceMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Char2ReferenceRBTreeMap(Char2ReferenceSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2ReferenceRBTreeMap(char[] var1, V[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2ReferenceRBTreeMap(char[] var1, V[] var2) {
   ...
   final Char2ReferenceRBTreeMap.Entry<V> findKey(char var1) {
      Char2ReferenceRBTreeMap.Entry var2;
      int var3;
   ...
   final Char2ReferenceRBTreeMap.Entry<V> locateKey(char var1) {
      Char2ReferenceRBTreeMap.Entry var2 = this.tree;
      Char2ReferenceRBTreeMap.Entry var3 = this.tree;
   ...
   public V put(char var1, V var2) {
      Char2ReferenceRBTreeMap.Entry var3 = this.add(var1);
      Object var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Char2ReferenceRBTreeMap.Entry<V> add(char var1) {
      this.modified = false;
      int var2 = 0;
      Char2ReferenceRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Char2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Char2ReferenceRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Char2ReferenceRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Char2ReferenceRBTreeMap.Entry var7;
               Char2ReferenceRBTreeMap.Entry var8;
   ...
   public boolean containsValue(Object var1) {
      Char2ReferenceRBTreeMap.ValueIterator var2 = new Char2ReferenceRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(char var1) {
      Char2ReferenceRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>() {
            final Comparator<? super Char2ReferenceMap.Entry<V>> comparator = (var1x, var2) -> {
               return Char2ReferenceRBTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> var1) {
               return Char2ReferenceRBTreeMap.this.new EntryIterator(var1.getCharKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     Char2ReferenceRBTreeMap.Entry var3 = Char2ReferenceRBTreeMap.this.findKey((Character)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     ...
                     if (var3 != null && var3.getValue() == var2.getValue()) {
                        Char2ReferenceRBTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> var1, Char2ReferenceMap.Entry<V> var2) {
               return Char2ReferenceRBTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2ReferenceEntrySet();
            }

            public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> var1) {
               return Char2ReferenceRBTreeMap.this.headMap(var1.getCharKey()).char2ReferenceEntrySet();
            }

            public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> var1) {
               return Char2ReferenceRBTreeMap.this.tailMap(var1.getCharKey()).char2ReferenceEntrySet();
            }
         };
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Char2ReferenceRBTreeMap.this.containsValue(var1);
            }
   ...
   public Char2ReferenceSortedMap<V> headMap(char var1) {
      return new Char2ReferenceRBTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2ReferenceSortedMap<V> tailMap(char var1) {
      return new Char2ReferenceRBTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2ReferenceSortedMap<V> subMap(char var1, char var2) {
      return new Char2ReferenceRBTreeMap.Submap(var1, false, var2, false);
   }

   public Char2ReferenceRBTreeMap<V> clone() {
      Char2ReferenceRBTreeMap var1;
      try {
         var1 = (Char2ReferenceRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2ReferenceRBTreeMap.Entry var5 = new Char2ReferenceRBTreeMap.Entry();
         Char2ReferenceRBTreeMap.Entry var6 = new Char2ReferenceRBTreeMap.Entry();
         Char2ReferenceRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2ReferenceRBTreeMap.Entry var4 = var6;
         var6.pred((Char2ReferenceRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2ReferenceRBTreeMap.EntryIterator var3 = new Char2ReferenceRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2ReferenceRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2ReferenceRBTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Char2ReferenceRBTreeMap.Entry<V> var3, Char2ReferenceRBTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Char2ReferenceRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2ReferenceRBTreeMap.Entry(var1.readChar(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Char2ReferenceRBTreeMap.Entry(var1.readChar(), var1.readObject());
         var8.black(true);
         var8.right(new Char2ReferenceRBTreeMap.Entry(var1.readChar(), var1.readObject()));
         ...
         Char2ReferenceRBTreeMap.Entry var7 = new Char2ReferenceRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2ReferenceRBTreeMap.Entry)null, (Char2ReferenceRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2ReferenceSortedMap<V> implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2ReferenceRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2ReferenceRBTreeMap.Submap.SubmapIterator var1 = new Char2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2ReferenceRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2ReferenceRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2ReferenceRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Char2ReferenceRBTreeMap.Submap.SubmapIterator var2 = new Char2ReferenceRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(char var1) {
         Char2ReferenceRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2ReferenceRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public V put(char var1, V var2) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Char2ReferenceRBTreeMap.this.put(var1, var2);
            return Char2ReferenceRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public V remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var2 = Char2ReferenceRBTreeMap.this.remove(var1);
            return Char2ReferenceRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2ReferenceSortedMap<V> headMap(char var1) {
         if (this.top) {
            return Char2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2ReferenceRBTreeMap.this.compare(var1, this.to) < 0 ? Char2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2ReferenceSortedMap<V> tailMap(char var1) {
         if (this.bottom) {
            return Char2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? Char2ReferenceRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2ReferenceSortedMap<V> subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2ReferenceRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2ReferenceRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2ReferenceRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2ReferenceRBTreeMap.Entry<V> firstEntry() {
         if (Char2ReferenceRBTreeMap.this.tree == null) {
            ...
            Char2ReferenceRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2ReferenceRBTreeMap.this.firstEntry;
            } else {
               var1 = Char2ReferenceRBTreeMap.this.locateKey(this.from);
               if (Char2ReferenceRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2ReferenceRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2ReferenceRBTreeMap.Entry<V> lastEntry() {
         if (Char2ReferenceRBTreeMap.this.tree == null) {
            ...
            Char2ReferenceRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2ReferenceRBTreeMap.this.lastEntry;
            } else {
               var1 = Char2ReferenceRBTreeMap.this.locateKey(this.to);
               if (Char2ReferenceRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2ReferenceRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2ReferenceRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2ReferenceRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2ReferenceRBTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2ReferenceRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2ReferenceRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2ReferenceRBTreeMap.this.locateKey(var2);
                  if (Char2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2ReferenceSortedMap<V>.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2ReferenceRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2ReferenceRBTreeMap.this.locateKey(var2)) != null) {
            if (Char2ReferenceRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractChar2ReferenceMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Char2ReferenceRBTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2ReferenceRBTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2ReferenceRBTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2ReferenceRBTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2ReferenceRBTreeMap.Entry<V> next() {
         Char2ReferenceRBTreeMap.Entry var1 = this.right;
      ...
      Char2ReferenceRBTreeMap.Entry<V> prev() {
         Char2ReferenceRBTreeMap.Entry var1 = this.left;
      ...
      public Char2ReferenceRBTreeMap.Entry<V> clone() {
         Char2ReferenceRBTreeMap.Entry var1;
         try {
            var1 = (Char2ReferenceRBTreeMap.Entry)super.clone();
