...
public class Char2ShortRBTreeMap extends AbstractChar2ShortSortedMap implements Serializable, Cloneable {
   ...
   public Char2ShortRBTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2ShortRBTreeMap(Map<? extends Character, ? extends Short> var1) {
      this();
      this.putAll(var1);
   }

   public Char2ShortRBTreeMap(SortedMap<Character, Short> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2ShortRBTreeMap(Char2ShortMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2ShortRBTreeMap(Char2ShortSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2ShortRBTreeMap(char[] var1, short[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2ShortRBTreeMap(char[] var1, short[] var2) {
   ...
   final Char2ShortRBTreeMap.Entry findKey(char var1) {
      Char2ShortRBTreeMap.Entry var2;
      int var3;
   ...
   final Char2ShortRBTreeMap.Entry locateKey(char var1) {
      Char2ShortRBTreeMap.Entry var2 = this.tree;
      Char2ShortRBTreeMap.Entry var3 = this.tree;
   ...
   public short addTo(char var1, short var2) {
      Char2ShortRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Char2ShortRBTreeMap.Entry add(char var1) {
      this.modified = false;
      int var2 = 0;
      Char2ShortRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Char2ShortRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Char2ShortRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Char2ShortRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Char2ShortRBTreeMap.Entry var7;
               Char2ShortRBTreeMap.Entry var8;
   ...
   public boolean containsValue(short var1) {
      Char2ShortRBTreeMap.ValueIterator var2 = new Char2ShortRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public short get(char var1) {
      Char2ShortRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
            final Comparator<? super Char2ShortMap.Entry> comparator = (var1x, var2) -> {
               return Char2ShortRBTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry var1) {
               return Char2ShortRBTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        Char2ShortRBTreeMap.Entry var3 = Char2ShortRBTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        ...
                        if (var3 != null && var3.getShortValue() == (Short)var2.getValue()) {
                           Char2ShortRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry var1, Char2ShortMap.Entry var2) {
               return Char2ShortRBTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2ShortEntrySet();
            }

            public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry var1) {
               return Char2ShortRBTreeMap.this.headMap(var1.getCharKey()).char2ShortEntrySet();
            }

            public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry var1) {
               return Char2ShortRBTreeMap.this.tailMap(var1.getCharKey()).char2ShortEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Char2ShortRBTreeMap.this.containsValue(var1);
            }
   ...
   public Char2ShortSortedMap headMap(char var1) {
      return new Char2ShortRBTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2ShortSortedMap tailMap(char var1) {
      return new Char2ShortRBTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2ShortSortedMap subMap(char var1, char var2) {
      return new Char2ShortRBTreeMap.Submap(var1, false, var2, false);
   }

   public Char2ShortRBTreeMap clone() {
      Char2ShortRBTreeMap var1;
      try {
         var1 = (Char2ShortRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2ShortRBTreeMap.Entry var5 = new Char2ShortRBTreeMap.Entry();
         Char2ShortRBTreeMap.Entry var6 = new Char2ShortRBTreeMap.Entry();
         Char2ShortRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2ShortRBTreeMap.Entry var4 = var6;
         var6.pred((Char2ShortRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2ShortRBTreeMap.EntryIterator var3 = new Char2ShortRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2ShortRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2ShortRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2ShortRBTreeMap.Entry var3, Char2ShortRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2ShortRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2ShortRBTreeMap.Entry(var1.readChar(), var1.readShort());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Char2ShortRBTreeMap.Entry(var1.readChar(), var1.readShort());
         var8.black(true);
         var8.right(new Char2ShortRBTreeMap.Entry(var1.readChar(), var1.readShort()));
         ...
         Char2ShortRBTreeMap.Entry var7 = new Char2ShortRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2ShortRBTreeMap.Entry)null, (Char2ShortRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2ShortSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2ShortRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2ShortRBTreeMap.Submap.SubmapIterator var1 = new Char2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2ShortRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2ShortRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2ShortRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(short var1) {
         Char2ShortRBTreeMap.Submap.SubmapIterator var2 = new Char2ShortRBTreeMap.Submap.SubmapIterator();
      ...
      public short get(char var1) {
         Char2ShortRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2ShortRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public short put(char var1, short var2) {
         ...
         if (!this.in(var1)) {
            ...
            short var3 = Char2ShortRBTreeMap.this.put(var1, var2);
            return Char2ShortRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public short remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            short var2 = Char2ShortRBTreeMap.this.remove(var1);
            return Char2ShortRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2ShortSortedMap headMap(char var1) {
         if (this.top) {
            return Char2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2ShortRBTreeMap.this.compare(var1, this.to) < 0 ? Char2ShortRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2ShortSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? Char2ShortRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2ShortSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2ShortRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2ShortRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2ShortRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2ShortRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2ShortRBTreeMap.Entry firstEntry() {
         if (Char2ShortRBTreeMap.this.tree == null) {
            ...
            Char2ShortRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2ShortRBTreeMap.this.firstEntry;
            } else {
               var1 = Char2ShortRBTreeMap.this.locateKey(this.from);
               if (Char2ShortRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2ShortRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2ShortRBTreeMap.Entry lastEntry() {
         if (Char2ShortRBTreeMap.this.tree == null) {
            ...
            Char2ShortRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2ShortRBTreeMap.this.lastEntry;
            } else {
               var1 = Char2ShortRBTreeMap.this.locateKey(this.to);
               if (Char2ShortRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2ShortRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2ShortRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2ShortRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2ShortRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2ShortMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2ShortRBTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2ShortRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2ShortRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2ShortRBTreeMap.this.locateKey(var2);
                  if (Char2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2ShortSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2ShortRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2ShortRBTreeMap.TreeIterator implements ObjectListIterator<Char2ShortMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2ShortRBTreeMap.this.locateKey(var2)) != null) {
            if (Char2ShortRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2ShortMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2ShortRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2ShortRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2ShortRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2ShortRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2ShortRBTreeMap.Entry next() {
         Char2ShortRBTreeMap.Entry var1 = this.right;
      ...
      Char2ShortRBTreeMap.Entry prev() {
         Char2ShortRBTreeMap.Entry var1 = this.left;
      ...
      public Char2ShortRBTreeMap.Entry clone() {
         Char2ShortRBTreeMap.Entry var1;
         try {
            var1 = (Char2ShortRBTreeMap.Entry)super.clone();
