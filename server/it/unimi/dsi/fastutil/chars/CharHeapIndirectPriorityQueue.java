...
public class CharHeapIndirectPriorityQueue extends CharHeapSemiIndirectPriorityQueue {
   ...
   public CharHeapIndirectPriorityQueue(char[] var1, int var2, CharComparator var3) {
   ...
   public CharHeapIndirectPriorityQueue(char[] var1, int var2) {
      this(var1, var2, (CharComparator)null);
   }

   public CharHeapIndirectPriorityQueue(char[] var1, CharComparator var2) {
      this(var1, var1.length, var2);
   }

   public CharHeapIndirectPriorityQueue(char[] var1) {
      this(var1, var1.length, (CharComparator)null);
   }

   public CharHeapIndirectPriorityQueue(char[] var1, int[] var2, int var3, CharComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      ...
      CharIndirectHeaps.makeHeap(var1, var2, this.inv, var3, var4);
   }
   ...
   public CharHeapIndirectPriorityQueue(char[] var1, int[] var2, int var3) {
   ...
   public void changed(int var1) {
      ...
      if (var2 < 0) {
         ...
         int var3 = CharIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, var2, this.c);
         CharIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, var3, this.c);
      }
   }
