...
public class Char2LongRBTreeMap extends AbstractChar2LongSortedMap implements Serializable, Cloneable {
   ...
   public Char2LongRBTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2LongRBTreeMap(Map<? extends Character, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Char2LongRBTreeMap(SortedMap<Character, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2LongRBTreeMap(Char2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2LongRBTreeMap(Char2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2LongRBTreeMap(char[] var1, long[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2LongRBTreeMap(char[] var1, long[] var2) {
   ...
   final Char2LongRBTreeMap.Entry findKey(char var1) {
      Char2LongRBTreeMap.Entry var2;
      int var3;
   ...
   final Char2LongRBTreeMap.Entry locateKey(char var1) {
      Char2LongRBTreeMap.Entry var2 = this.tree;
      Char2LongRBTreeMap.Entry var3 = this.tree;
   ...
   public long addTo(char var1, long var2) {
      Char2LongRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Char2LongRBTreeMap.Entry add(char var1) {
      this.modified = false;
      int var2 = 0;
      Char2LongRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Char2LongRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Char2LongRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Char2LongRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Char2LongRBTreeMap.Entry var7;
               Char2LongRBTreeMap.Entry var8;
   ...
   public boolean containsValue(long var1) {
      Char2LongRBTreeMap.ValueIterator var3 = new Char2LongRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(char var1) {
      Char2LongRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>() {
            final Comparator<? super Char2LongMap.Entry> comparator = (var1x, var2) -> {
               return Char2LongRBTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry var1) {
               return Char2LongRBTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Char2LongRBTreeMap.Entry var3 = Char2LongRBTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Char2LongRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry var1, Char2LongMap.Entry var2) {
               return Char2LongRBTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2LongEntrySet();
            }

            public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry var1) {
               return Char2LongRBTreeMap.this.headMap(var1.getCharKey()).char2LongEntrySet();
            }

            public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry var1) {
               return Char2LongRBTreeMap.this.tailMap(var1.getCharKey()).char2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Char2LongRBTreeMap.this.containsValue(var1);
            }
   ...
   public Char2LongSortedMap headMap(char var1) {
      return new Char2LongRBTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2LongSortedMap tailMap(char var1) {
      return new Char2LongRBTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2LongSortedMap subMap(char var1, char var2) {
      return new Char2LongRBTreeMap.Submap(var1, false, var2, false);
   }

   public Char2LongRBTreeMap clone() {
      Char2LongRBTreeMap var1;
      try {
         var1 = (Char2LongRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2LongRBTreeMap.Entry var5 = new Char2LongRBTreeMap.Entry();
         Char2LongRBTreeMap.Entry var6 = new Char2LongRBTreeMap.Entry();
         Char2LongRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2LongRBTreeMap.Entry var4 = var6;
         var6.pred((Char2LongRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2LongRBTreeMap.EntryIterator var3 = new Char2LongRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2LongRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2LongRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2LongRBTreeMap.Entry var3, Char2LongRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2LongRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2LongRBTreeMap.Entry(var1.readChar(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Char2LongRBTreeMap.Entry(var1.readChar(), var1.readLong());
         var8.black(true);
         var8.right(new Char2LongRBTreeMap.Entry(var1.readChar(), var1.readLong()));
         ...
         Char2LongRBTreeMap.Entry var7 = new Char2LongRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2LongRBTreeMap.Entry)null, (Char2LongRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2LongSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2LongRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2LongRBTreeMap.Submap.SubmapIterator var1 = new Char2LongRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2LongRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2LongRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2LongRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Char2LongRBTreeMap.Submap.SubmapIterator var3 = new Char2LongRBTreeMap.Submap.SubmapIterator();
      ...
      public long get(char var1) {
         Char2LongRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2LongRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public long put(char var1, long var2) {
         ...
         if (!this.in(var1)) {
            ...
            long var4 = Char2LongRBTreeMap.this.put(var1, var2);
            return Char2LongRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public long remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var2 = Char2LongRBTreeMap.this.remove(var1);
            return Char2LongRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2LongSortedMap headMap(char var1) {
         if (this.top) {
            return Char2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2LongRBTreeMap.this.compare(var1, this.to) < 0 ? Char2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2LongSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2LongRBTreeMap.this.compare(var1, this.from) > 0 ? Char2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2LongSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2LongRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2LongRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2LongRBTreeMap.Entry firstEntry() {
         if (Char2LongRBTreeMap.this.tree == null) {
            ...
            Char2LongRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2LongRBTreeMap.this.firstEntry;
            } else {
               var1 = Char2LongRBTreeMap.this.locateKey(this.from);
               if (Char2LongRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2LongRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2LongRBTreeMap.Entry lastEntry() {
         if (Char2LongRBTreeMap.this.tree == null) {
            ...
            Char2LongRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2LongRBTreeMap.this.lastEntry;
            } else {
               var1 = Char2LongRBTreeMap.this.locateKey(this.to);
               if (Char2LongRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2LongRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2LongRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2LongRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2LongRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2LongRBTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2LongRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2LongRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2LongRBTreeMap.this.locateKey(var2);
                  if (Char2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2LongSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2LongRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2LongRBTreeMap.TreeIterator implements ObjectListIterator<Char2LongMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2LongRBTreeMap.this.locateKey(var2)) != null) {
            if (Char2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2LongMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2LongRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2LongRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2LongRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2LongRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2LongRBTreeMap.Entry next() {
         Char2LongRBTreeMap.Entry var1 = this.right;
      ...
      Char2LongRBTreeMap.Entry prev() {
         Char2LongRBTreeMap.Entry var1 = this.left;
      ...
      public Char2LongRBTreeMap.Entry clone() {
         Char2LongRBTreeMap.Entry var1;
         try {
            var1 = (Char2LongRBTreeMap.Entry)super.clone();
