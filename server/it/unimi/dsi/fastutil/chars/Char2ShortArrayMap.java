...
public class Char2ShortArrayMap extends AbstractChar2ShortMap implements Serializable, Cloneable {
   ...
   public Char2ShortArrayMap(char[] var1, short[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2ShortArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new short[var1];
   }

   public Char2ShortArrayMap(Char2ShortMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2ShortArrayMap(Map<? extends Character, ? extends Short> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2ShortArrayMap(char[] var1, short[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2ShortArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2ShortArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2ShortArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2ShortArrayMap.this.key, var2 + 1, Char2ShortArrayMap.this.key, var2, var3);
               System.arraycopy(Char2ShortArrayMap.this.value, var2 + 1, Char2ShortArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2ShortArrayMap.this.size - this.pos;
                     System.arraycopy(Char2ShortArrayMap.this.key, this.pos, Char2ShortArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2ShortArrayMap.this.value, this.pos, Char2ShortArrayMap.this.value, this.pos - 1, var1);
                     Char2ShortArrayMap.this.size--;
                  }
               }
            };
   ...
   public ShortCollection values() {
      return new AbstractShortCollection() {
         public boolean contains(short var1) {
            return Char2ShortArrayMap.this.containsValue(var1);
         }
   ...
   public Char2ShortArrayMap clone() {
      Char2ShortArrayMap var1;
      try {
         var1 = (Char2ShortArrayMap)super.clone();
         ...
         return new ObjectIterator<Char2ShortMap.Entry>() {
            ...
            public Char2ShortMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2ShortMap.BasicEntry(Char2ShortArrayMap.this.key[this.curr = this.next], Char2ShortArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2ShortArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2ShortArrayMap.this.key, this.next + 1, Char2ShortArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2ShortArrayMap.this.value, this.next + 1, Char2ShortArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  return Char2ShortArrayMap.this.containsKey(var3) && Char2ShortArrayMap.this.get(var3) == (Short)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  int var5 = Char2ShortArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Char2ShortArrayMap.this.value[var5]) {
                     int var6 = Char2ShortArrayMap.this.size - var5 - 1;
                     System.arraycopy(Char2ShortArrayMap.this.key, var5 + 1, Char2ShortArrayMap.this.key, var5, var6);
                     System.arraycopy(Char2ShortArrayMap.this.value, var5 + 1, Char2ShortArrayMap.this.value, var5, var6);
                     Char2ShortArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
