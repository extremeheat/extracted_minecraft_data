...
public final class Char2ObjectFunctions {
   ...
   public static <V> Char2ObjectFunction<V> singleton(char var0, V var1) {
      return new Char2ObjectFunctions.Singleton(var0, var1);
   }

   public static <V> Char2ObjectFunction<V> singleton(Character var0, V var1) {
      return new Char2ObjectFunctions.Singleton(var0, var1);
   }

   public static <V> Char2ObjectFunction<V> synchronize(Char2ObjectFunction<V> var0) {
      return new Char2ObjectFunctions.SynchronizedFunction(var0);
   }

   public static <V> Char2ObjectFunction<V> synchronize(Char2ObjectFunction<V> var0, Object var1) {
      return new Char2ObjectFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Char2ObjectFunction<V> unmodifiable(Char2ObjectFunction<V> var0) {
      return new Char2ObjectFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Char2ObjectFunction<V> primitive(Function<? super Character, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Char2ObjectFunction) {
         return (Char2ObjectFunction)var0;
         ...
         return new Char2ObjectFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class UnmodifiableFunction<V> extends AbstractChar2ObjectFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Char2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Char2ObjectFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Char2ObjectFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Char2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
