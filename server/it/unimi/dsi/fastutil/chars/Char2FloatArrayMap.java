...
public class Char2FloatArrayMap extends AbstractChar2FloatMap implements Serializable, Cloneable {
   ...
   public Char2FloatArrayMap(char[] var1, float[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2FloatArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new float[var1];
   }

   public Char2FloatArrayMap(Char2FloatMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2FloatArrayMap(Map<? extends Character, ? extends Float> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2FloatArrayMap(char[] var1, float[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2FloatArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2FloatArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2FloatArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2FloatArrayMap.this.key, var2 + 1, Char2FloatArrayMap.this.key, var2, var3);
               System.arraycopy(Char2FloatArrayMap.this.value, var2 + 1, Char2FloatArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2FloatArrayMap.this.size - this.pos;
                     System.arraycopy(Char2FloatArrayMap.this.key, this.pos, Char2FloatArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2FloatArrayMap.this.value, this.pos, Char2FloatArrayMap.this.value, this.pos - 1, var1);
                     Char2FloatArrayMap.this.size--;
                  }
               }
            };
   ...
   public FloatCollection values() {
      return new AbstractFloatCollection() {
         public boolean contains(float var1) {
            return Char2FloatArrayMap.this.containsValue(var1);
         }
   ...
   public Char2FloatArrayMap clone() {
      Char2FloatArrayMap var1;
      try {
         var1 = (Char2FloatArrayMap)super.clone();
         ...
         return new ObjectIterator<Char2FloatMap.Entry>() {
            ...
            public Char2FloatMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2FloatMap.BasicEntry(Char2FloatArrayMap.this.key[this.curr = this.next], Char2FloatArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2FloatArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2FloatArrayMap.this.key, this.next + 1, Char2FloatArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2FloatArrayMap.this.value, this.next + 1, Char2FloatArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  return Char2FloatArrayMap.this.containsKey(var3) && Float.floatToIntBits(Char2FloatArrayMap.this.get(var3)) == Float.floatToIntBits((Float)var2.getValue());
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  int var5 = Char2FloatArrayMap.this.findKey(var3);
                  if (var5 != -1 && Float.floatToIntBits(var4) == Float.floatToIntBits(Char2FloatArrayMap.this.value[var5])) {
                     int var6 = Char2FloatArrayMap.this.size - var5 - 1;
                     System.arraycopy(Char2FloatArrayMap.this.key, var5 + 1, Char2FloatArrayMap.this.key, var5, var6);
                     System.arraycopy(Char2FloatArrayMap.this.value, var5 + 1, Char2FloatArrayMap.this.value, var5, var6);
                     Char2FloatArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
