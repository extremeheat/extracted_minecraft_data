...
public class Char2CharRBTreeMap extends AbstractChar2CharSortedMap implements Serializable, Cloneable {
   ...
   public Char2CharRBTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2CharRBTreeMap(Map<? extends Character, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Char2CharRBTreeMap(SortedMap<Character, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2CharRBTreeMap(Char2CharMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2CharRBTreeMap(Char2CharSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2CharRBTreeMap(char[] var1, char[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2CharRBTreeMap(char[] var1, char[] var2) {
   ...
   final Char2CharRBTreeMap.Entry findKey(char var1) {
      Char2CharRBTreeMap.Entry var2;
      int var3;
   ...
   final Char2CharRBTreeMap.Entry locateKey(char var1) {
      Char2CharRBTreeMap.Entry var2 = this.tree;
      Char2CharRBTreeMap.Entry var3 = this.tree;
   ...
   public char addTo(char var1, char var2) {
      Char2CharRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Char2CharRBTreeMap.Entry add(char var1) {
      this.modified = false;
      int var2 = 0;
      Char2CharRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Char2CharRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Char2CharRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Char2CharRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Char2CharRBTreeMap.Entry var7;
               Char2CharRBTreeMap.Entry var8;
   ...
   public boolean containsValue(char var1) {
      Char2CharRBTreeMap.ValueIterator var2 = new Char2CharRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char get(char var1) {
      Char2CharRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>() {
            final Comparator<? super Char2CharMap.Entry> comparator = (var1x, var2) -> {
               return Char2CharRBTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry var1) {
               return Char2CharRBTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        Char2CharRBTreeMap.Entry var3 = Char2CharRBTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        ...
                        if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                           Char2CharRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry var1, Char2CharMap.Entry var2) {
               return Char2CharRBTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2CharEntrySet();
            }

            public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry var1) {
               return Char2CharRBTreeMap.this.headMap(var1.getCharKey()).char2CharEntrySet();
            }

            public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry var1) {
               return Char2CharRBTreeMap.this.tailMap(var1.getCharKey()).char2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Char2CharRBTreeMap.this.containsValue(var1);
            }
   ...
   public Char2CharSortedMap headMap(char var1) {
      return new Char2CharRBTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2CharSortedMap tailMap(char var1) {
      return new Char2CharRBTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2CharSortedMap subMap(char var1, char var2) {
      return new Char2CharRBTreeMap.Submap(var1, false, var2, false);
   }

   public Char2CharRBTreeMap clone() {
      Char2CharRBTreeMap var1;
      try {
         var1 = (Char2CharRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2CharRBTreeMap.Entry var5 = new Char2CharRBTreeMap.Entry();
         Char2CharRBTreeMap.Entry var6 = new Char2CharRBTreeMap.Entry();
         Char2CharRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2CharRBTreeMap.Entry var4 = var6;
         var6.pred((Char2CharRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2CharRBTreeMap.EntryIterator var3 = new Char2CharRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2CharRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2CharRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2CharRBTreeMap.Entry var3, Char2CharRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2CharRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2CharRBTreeMap.Entry(var1.readChar(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Char2CharRBTreeMap.Entry(var1.readChar(), var1.readChar());
         var8.black(true);
         var8.right(new Char2CharRBTreeMap.Entry(var1.readChar(), var1.readChar()));
         ...
         Char2CharRBTreeMap.Entry var7 = new Char2CharRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2CharRBTreeMap.Entry)null, (Char2CharRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2CharSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2CharRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2CharRBTreeMap.Submap.SubmapIterator var1 = new Char2CharRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2CharRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2CharRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2CharRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Char2CharRBTreeMap.Submap.SubmapIterator var2 = new Char2CharRBTreeMap.Submap.SubmapIterator();
      ...
      public char get(char var1) {
         Char2CharRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2CharRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public char put(char var1, char var2) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Char2CharRBTreeMap.this.put(var1, var2);
            return Char2CharRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public char remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var2 = Char2CharRBTreeMap.this.remove(var1);
            return Char2CharRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2CharSortedMap headMap(char var1) {
         if (this.top) {
            return Char2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2CharRBTreeMap.this.compare(var1, this.to) < 0 ? Char2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2CharSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2CharRBTreeMap.this.compare(var1, this.from) > 0 ? Char2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2CharSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2CharRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2CharRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2CharRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2CharRBTreeMap.Entry firstEntry() {
         if (Char2CharRBTreeMap.this.tree == null) {
            ...
            Char2CharRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2CharRBTreeMap.this.firstEntry;
            } else {
               var1 = Char2CharRBTreeMap.this.locateKey(this.from);
               if (Char2CharRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2CharRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2CharRBTreeMap.Entry lastEntry() {
         if (Char2CharRBTreeMap.this.tree == null) {
            ...
            Char2CharRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2CharRBTreeMap.this.lastEntry;
            } else {
               var1 = Char2CharRBTreeMap.this.locateKey(this.to);
               if (Char2CharRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2CharRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2CharRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2CharRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2CharRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2CharMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2CharRBTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2CharRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2CharRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2CharRBTreeMap.this.locateKey(var2);
                  if (Char2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2CharSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2CharRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2CharRBTreeMap.TreeIterator implements ObjectListIterator<Char2CharMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2CharRBTreeMap.this.locateKey(var2)) != null) {
            if (Char2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2CharRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2CharRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2CharRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2CharRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2CharRBTreeMap.Entry next() {
         Char2CharRBTreeMap.Entry var1 = this.right;
      ...
      Char2CharRBTreeMap.Entry prev() {
         Char2CharRBTreeMap.Entry var1 = this.left;
      ...
      public Char2CharRBTreeMap.Entry clone() {
         Char2CharRBTreeMap.Entry var1;
         try {
            var1 = (Char2CharRBTreeMap.Entry)super.clone();
