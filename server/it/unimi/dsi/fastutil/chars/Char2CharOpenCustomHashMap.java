...
public class Char2CharOpenCustomHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Char2CharOpenCustomHashMap(int var1, float var2, CharHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Char2CharOpenCustomHashMap(int var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2CharOpenCustomHashMap(CharHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2CharOpenCustomHashMap(Char2CharMap var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2CharOpenCustomHashMap(Char2CharMap var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2CharOpenCustomHashMap(char[] var1, char[] var2, float var3, CharHash.Strategy var4) {
   ...
   public Char2CharOpenCustomHashMap(char[] var1, char[] var2, CharHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Char2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Char2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2CharOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Char2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2CharOpenCustomHashMap clone() {
      Char2CharOpenCustomHashMap var1;
      try {
         var1 = (Char2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      char[] var3 = this.value;
      Char2CharOpenCustomHashMap.MapIterator var4 = new Char2CharOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Char2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2CharOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2CharOpenCustomHashMap.this.size;
         Char2CharOpenCustomHashMap.this.remove(var1);
         return Char2CharOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Char2CharOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     return Char2CharOpenCustomHashMap.this.containsNullKey && Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n] == var4;
                  } else {
                     char[] var6 = Char2CharOpenCustomHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Char2CharOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2CharOpenCustomHashMap.this.mask]) != 0) {
                           if (Char2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Char2CharOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (Char2CharOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     if (Char2CharOpenCustomHashMap.this.containsNullKey && Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2CharOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Char2CharOpenCustomHashMap.this.value[var7] == var4) {
                           Char2CharOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2CharOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Char2CharOpenCustomHashMap.this.strategy.equals(var5, var3) || Char2CharOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2CharMap.Entry> var1) {
         if (Char2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2CharMap.BasicEntry(Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.n], Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2CharOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2CharMap.BasicEntry(Char2CharOpenCustomHashMap.this.key[var2], Char2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2CharMap.Entry> var1) {
         ...
         if (Char2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.n];
            var2.value = Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Char2CharOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Char2CharOpenCustomHashMap.this.key[var3];
               var2.value = Char2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Char2CharMap.Entry> {
      private final Char2CharOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Char2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2CharOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Char2CharOpenCustomHashMap.this.mask; !Char2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Char2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Char2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2CharOpenCustomHashMap.this.value[var2] = Char2CharOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2CharMap.Entry, java.util.Map.Entry<Character, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Char2CharOpenCustomHashMap.this.value[this.index];
         Char2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[this.index], (Character)var2.getKey()) && Char2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
