...
public final class Char2LongFunctions {
   ...
   public static Char2LongFunction singleton(char var0, long var1) {
      return new Char2LongFunctions.Singleton(var0, var1);
   }

   public static Char2LongFunction singleton(Character var0, Long var1) {
      return new Char2LongFunctions.Singleton(var0, var1);
   }

   public static Char2LongFunction synchronize(Char2LongFunction var0) {
      return new Char2LongFunctions.SynchronizedFunction(var0);
   }

   public static Char2LongFunction synchronize(Char2LongFunction var0, Object var1) {
      return new Char2LongFunctions.SynchronizedFunction(var0, var1);
   }

   public static Char2LongFunction unmodifiable(Char2LongFunction var0) {
      return new Char2LongFunctions.UnmodifiableFunction(var0);
   }

   public static Char2LongFunction primitive(Function<? super Character, ? extends Long> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Char2LongFunction) {
         return (Char2LongFunction)var0;
         ...
         return new Char2LongFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Char2LongFunction {
      ...
      protected PrimitiveFunction(Function<? super Character, ? extends Long> var1) {
         super();
         this.function = var1;
      }
      ...
      public Long get(Object var1) {
         return var1 == null ? null : (Long)this.function.apply((Character)var1);
      }

      /** @deprecated */
      @Deprecated
      public Long put(Character var1, Long var2) {
   ...
   public static class UnmodifiableFunction extends AbstractChar2LongFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Char2LongFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Char2LongFunction, Serializable {
      ...
      protected SynchronizedFunction(Char2LongFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Char2LongFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Long apply(Character var1) {
         synchronized(this.sync) {
