...
public class Char2IntArrayMap extends AbstractChar2IntMap implements Serializable, Cloneable {
   ...
   public Char2IntArrayMap(char[] var1, int[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2IntArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new int[var1];
   }

   public Char2IntArrayMap(Char2IntMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2IntArrayMap(Map<? extends Character, ? extends Integer> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2IntArrayMap(char[] var1, int[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2IntArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2IntArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2IntArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2IntArrayMap.this.key, var2 + 1, Char2IntArrayMap.this.key, var2, var3);
               System.arraycopy(Char2IntArrayMap.this.value, var2 + 1, Char2IntArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2IntArrayMap.this.size - this.pos;
                     System.arraycopy(Char2IntArrayMap.this.key, this.pos, Char2IntArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2IntArrayMap.this.value, this.pos, Char2IntArrayMap.this.value, this.pos - 1, var1);
                     Char2IntArrayMap.this.size--;
                  }
               }
            };
   ...
   public IntCollection values() {
      return new AbstractIntCollection() {
         public boolean contains(int var1) {
            return Char2IntArrayMap.this.containsValue(var1);
         }
   ...
   public Char2IntArrayMap clone() {
      Char2IntArrayMap var1;
      try {
         var1 = (Char2IntArrayMap)super.clone();
         ...
         return new ObjectIterator<Char2IntMap.Entry>() {
            ...
            public Char2IntMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2IntMap.BasicEntry(Char2IntArrayMap.this.key[this.curr = this.next], Char2IntArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2IntArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2IntArrayMap.this.key, this.next + 1, Char2IntArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2IntArrayMap.this.value, this.next + 1, Char2IntArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  return Char2IntArrayMap.this.containsKey(var3) && Char2IntArrayMap.this.get(var3) == (Integer)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var5 = Char2IntArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Char2IntArrayMap.this.value[var5]) {
                     int var6 = Char2IntArrayMap.this.size - var5 - 1;
                     System.arraycopy(Char2IntArrayMap.this.key, var5 + 1, Char2IntArrayMap.this.key, var5, var6);
                     System.arraycopy(Char2IntArrayMap.this.value, var5 + 1, Char2IntArrayMap.this.value, var5, var6);
                     Char2IntArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
