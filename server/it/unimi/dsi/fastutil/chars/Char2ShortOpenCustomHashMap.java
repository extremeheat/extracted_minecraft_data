...
public class Char2ShortOpenCustomHashMap extends AbstractChar2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Char2ShortOpenCustomHashMap(int var1, float var2, CharHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Char2ShortOpenCustomHashMap(int var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2ShortOpenCustomHashMap(CharHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Char2ShortOpenCustomHashMap(Map<? extends Character, ? extends Short> var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2ShortOpenCustomHashMap(Map<? extends Character, ? extends Short> var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2ShortOpenCustomHashMap(Char2ShortMap var1, float var2, CharHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Char2ShortOpenCustomHashMap(Char2ShortMap var1, CharHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Char2ShortOpenCustomHashMap(char[] var1, short[] var2, float var3, CharHash.Strategy var4) {
   ...
   public Char2ShortOpenCustomHashMap(char[] var1, short[] var2, CharHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Char2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Char2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Char2ShortOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Char2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Char2ShortOpenCustomHashMap clone() {
      Char2ShortOpenCustomHashMap var1;
      try {
         var1 = (Char2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      char[] var2 = this.key;
      short[] var3 = this.value;
      Char2ShortOpenCustomHashMap.MapIterator var4 = new Char2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Char2ShortOpenCustomHashMap.this.key[Char2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Char2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            char var3 = Char2ShortOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(char var1) {
         return Char2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(char var1) {
         int var2 = Char2ShortOpenCustomHashMap.this.size;
         Char2ShortOpenCustomHashMap.this.remove(var1);
         return Char2ShortOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Char2ShortOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     return Char2ShortOpenCustomHashMap.this.containsNullKey && Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n] == var4;
                  } else {
                     char[] var6 = Char2ShortOpenCustomHashMap.this.key;
                     char var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Char2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Char2ShortOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Char2ShortOpenCustomHashMap.this.mask]) != 0) {
                           if (Char2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Char2ShortOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (Char2ShortOpenCustomHashMap.this.strategy.equals(var3, '\u0000')) {
                     if (Char2ShortOpenCustomHashMap.this.containsNullKey && Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Char2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Char2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Char2ShortOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Char2ShortOpenCustomHashMap.this.value[var7] == var4) {
                           Char2ShortOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Char2ShortOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Char2ShortOpenCustomHashMap.this.strategy.equals(var5, var3) || Char2ShortOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Char2ShortMap.Entry> var1) {
         if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractChar2ShortMap.BasicEntry(Char2ShortOpenCustomHashMap.this.key[Char2ShortOpenCustomHashMap.this.n], Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Char2ShortOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractChar2ShortMap.BasicEntry(Char2ShortOpenCustomHashMap.this.key[var2], Char2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Char2ShortMap.Entry> var1) {
         ...
         if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Char2ShortOpenCustomHashMap.this.key[Char2ShortOpenCustomHashMap.this.n];
            var2.value = Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Char2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Char2ShortOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Char2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Char2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Char2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Char2ShortMap.Entry> {
      private final Char2ShortOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Char2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Char2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Char2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               char[] var1 = Char2ShortOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Char2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Char2ShortOpenCustomHashMap.this.mask; !Char2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Char2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         char[] var5 = Char2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Char2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Char2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Char2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Char2ShortOpenCustomHashMap.this.value[var2] = Char2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Char2ShortMap.Entry, java.util.Map.Entry<Character, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Char2ShortOpenCustomHashMap.this.value[this.index];
         Char2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Char2ShortOpenCustomHashMap.this.strategy.equals(Char2ShortOpenCustomHashMap.this.key[this.index], (Character)var2.getKey()) && Char2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
