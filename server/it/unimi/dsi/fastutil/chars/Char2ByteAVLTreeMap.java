...
public class Char2ByteAVLTreeMap extends AbstractChar2ByteSortedMap implements Serializable, Cloneable {
   ...
   public Char2ByteAVLTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2ByteAVLTreeMap(Map<? extends Character, ? extends Byte> var1) {
      this();
      this.putAll(var1);
   }

   public Char2ByteAVLTreeMap(SortedMap<Character, Byte> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2ByteAVLTreeMap(Char2ByteMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2ByteAVLTreeMap(Char2ByteSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2ByteAVLTreeMap(char[] var1, byte[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2ByteAVLTreeMap(char[] var1, byte[] var2) {
   ...
   final Char2ByteAVLTreeMap.Entry findKey(char var1) {
      Char2ByteAVLTreeMap.Entry var2;
      int var3;
   ...
   final Char2ByteAVLTreeMap.Entry locateKey(char var1) {
      Char2ByteAVLTreeMap.Entry var2 = this.tree;
      Char2ByteAVLTreeMap.Entry var3 = this.tree;
   ...
   public byte addTo(char var1, byte var2) {
      Char2ByteAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Char2ByteAVLTreeMap.Entry add(char var1) {
      this.modified = false;
      Char2ByteAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Char2ByteAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Char2ByteAVLTreeMap.Entry var3 = this.tree;
         Char2ByteAVLTreeMap.Entry var4 = null;
         Char2ByteAVLTreeMap.Entry var5 = this.tree;
         Char2ByteAVLTreeMap.Entry var6 = null;
         Char2ByteAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Char2ByteAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Char2ByteAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Char2ByteAVLTreeMap.Entry parent(Char2ByteAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Char2ByteAVLTreeMap.Entry var3 = var1;

         Char2ByteAVLTreeMap.Entry var2;
         Char2ByteAVLTreeMap.Entry var4;
   ...
   public byte remove(char var1) {
      ...
      if (this.tree == null) {
         ...
         Char2ByteAVLTreeMap.Entry var7;
         Char2ByteAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Char2ByteAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(byte var1) {
      Char2ByteAVLTreeMap.ValueIterator var2 = new Char2ByteAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public byte get(char var1) {
      Char2ByteAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>() {
            final Comparator<? super Char2ByteMap.Entry> comparator = (var1x, var2) -> {
               return Char2ByteAVLTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry var1) {
               return Char2ByteAVLTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        Char2ByteAVLTreeMap.Entry var3 = Char2ByteAVLTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        ...
                        if (var3 != null && var3.getByteValue() == (Byte)var2.getValue()) {
                           Char2ByteAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry var1, Char2ByteMap.Entry var2) {
               return Char2ByteAVLTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2ByteEntrySet();
            }

            public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry var1) {
               return Char2ByteAVLTreeMap.this.headMap(var1.getCharKey()).char2ByteEntrySet();
            }

            public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry var1) {
               return Char2ByteAVLTreeMap.this.tailMap(var1.getCharKey()).char2ByteEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Char2ByteAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Char2ByteSortedMap headMap(char var1) {
      return new Char2ByteAVLTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2ByteSortedMap tailMap(char var1) {
      return new Char2ByteAVLTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2ByteSortedMap subMap(char var1, char var2) {
      return new Char2ByteAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Char2ByteAVLTreeMap clone() {
      Char2ByteAVLTreeMap var1;
      try {
         var1 = (Char2ByteAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2ByteAVLTreeMap.Entry var5 = new Char2ByteAVLTreeMap.Entry();
         Char2ByteAVLTreeMap.Entry var6 = new Char2ByteAVLTreeMap.Entry();
         Char2ByteAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2ByteAVLTreeMap.Entry var4 = var6;
         var6.pred((Char2ByteAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2ByteAVLTreeMap.EntryIterator var3 = new Char2ByteAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2ByteAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2ByteAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2ByteAVLTreeMap.Entry var3, Char2ByteAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2ByteAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2ByteAVLTreeMap.Entry(var1.readChar(), var1.readByte());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Char2ByteAVLTreeMap.Entry(var1.readChar(), var1.readByte());
         var8.right(new Char2ByteAVLTreeMap.Entry(var1.readChar(), var1.readByte()));
         ...
         Char2ByteAVLTreeMap.Entry var7 = new Char2ByteAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2ByteAVLTreeMap.Entry)null, (Char2ByteAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2ByteSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2ByteAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2ByteAVLTreeMap.Submap.SubmapIterator var1 = new Char2ByteAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2ByteAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2ByteAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2ByteAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(byte var1) {
         Char2ByteAVLTreeMap.Submap.SubmapIterator var2 = new Char2ByteAVLTreeMap.Submap.SubmapIterator();
      ...
      public byte get(char var1) {
         Char2ByteAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2ByteAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public byte put(char var1, byte var2) {
         ...
         if (!this.in(var1)) {
            ...
            byte var3 = Char2ByteAVLTreeMap.this.put(var1, var2);
            return Char2ByteAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public byte remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            byte var2 = Char2ByteAVLTreeMap.this.remove(var1);
            return Char2ByteAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2ByteSortedMap headMap(char var1) {
         if (this.top) {
            return Char2ByteAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2ByteAVLTreeMap.this.compare(var1, this.to) < 0 ? Char2ByteAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2ByteSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2ByteAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2ByteAVLTreeMap.this.compare(var1, this.from) > 0 ? Char2ByteAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2ByteSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2ByteAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2ByteAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2ByteAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2ByteAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2ByteAVLTreeMap.Entry firstEntry() {
         if (Char2ByteAVLTreeMap.this.tree == null) {
            ...
            Char2ByteAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2ByteAVLTreeMap.this.firstEntry;
            } else {
               var1 = Char2ByteAVLTreeMap.this.locateKey(this.from);
               if (Char2ByteAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2ByteAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2ByteAVLTreeMap.Entry lastEntry() {
         if (Char2ByteAVLTreeMap.this.tree == null) {
            ...
            Char2ByteAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2ByteAVLTreeMap.this.lastEntry;
            } else {
               var1 = Char2ByteAVLTreeMap.this.locateKey(this.to);
               if (Char2ByteAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2ByteAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2ByteAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2ByteAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2ByteAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2ByteMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2ByteAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2ByteAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2ByteAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2ByteAVLTreeMap.this.locateKey(var2);
                  if (Char2ByteAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2ByteSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2ByteAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2ByteAVLTreeMap.TreeIterator implements ObjectListIterator<Char2ByteMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Char2ByteMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Char2ByteMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2ByteAVLTreeMap.this.locateKey(var2)) != null) {
            if (Char2ByteAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2ByteMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2ByteAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2ByteAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2ByteAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2ByteAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2ByteAVLTreeMap.Entry next() {
         Char2ByteAVLTreeMap.Entry var1 = this.right;
      ...
      Char2ByteAVLTreeMap.Entry prev() {
         Char2ByteAVLTreeMap.Entry var1 = this.left;
      ...
      public Char2ByteAVLTreeMap.Entry clone() {
         Char2ByteAVLTreeMap.Entry var1;
         try {
            var1 = (Char2ByteAVLTreeMap.Entry)super.clone();
