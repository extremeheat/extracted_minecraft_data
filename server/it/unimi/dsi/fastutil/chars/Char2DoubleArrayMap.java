...
public class Char2DoubleArrayMap extends AbstractChar2DoubleMap implements Serializable, Cloneable {
   ...
   public Char2DoubleArrayMap(char[] var1, double[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Char2DoubleArrayMap(int var1) {
      super();
      this.key = new char[var1];
      this.value = new double[var1];
   }

   public Char2DoubleArrayMap(Char2DoubleMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2DoubleArrayMap(Map<? extends Character, ? extends Double> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Char2DoubleArrayMap(char[] var1, double[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Char2DoubleMap.FastEntrySet char2DoubleEntrySet() {
      return new Char2DoubleArrayMap.EntrySet();
   }
   ...
   public CharSet keySet() {
      return new AbstractCharSet() {
         public boolean contains(char var1) {
            return Char2DoubleArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(char var1) {
            int var2 = Char2DoubleArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Char2DoubleArrayMap.this.size - var2 - 1;
               System.arraycopy(Char2DoubleArrayMap.this.key, var2 + 1, Char2DoubleArrayMap.this.key, var2, var3);
               System.arraycopy(Char2DoubleArrayMap.this.value, var2 + 1, Char2DoubleArrayMap.this.value, var2, var3);
            ...
            return new CharIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Char2DoubleArrayMap.this.size - this.pos;
                     System.arraycopy(Char2DoubleArrayMap.this.key, this.pos, Char2DoubleArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Char2DoubleArrayMap.this.value, this.pos, Char2DoubleArrayMap.this.value, this.pos - 1, var1);
                     Char2DoubleArrayMap.this.size--;
                  }
               }
            };
   ...
   public DoubleCollection values() {
      return new AbstractDoubleCollection() {
         public boolean contains(double var1) {
            return Char2DoubleArrayMap.this.containsValue(var1);
         }
   ...
   public Char2DoubleArrayMap clone() {
      Char2DoubleArrayMap var1;
      try {
         var1 = (Char2DoubleArrayMap)super.clone();
         ...
         return new ObjectIterator<Char2DoubleMap.Entry>() {
            ...
            public Char2DoubleMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractChar2DoubleMap.BasicEntry(Char2DoubleArrayMap.this.key[this.curr = this.next], Char2DoubleArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Char2DoubleArrayMap.this.size-- - this.next--;
                  System.arraycopy(Char2DoubleArrayMap.this.key, this.next + 1, Char2DoubleArrayMap.this.key, this.next, var1);
                  System.arraycopy(Char2DoubleArrayMap.this.value, this.next + 1, Char2DoubleArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         return new ObjectIterator<Char2DoubleMap.Entry>() {
            ...
            public Char2DoubleMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Char2DoubleArrayMap.this.key[this.curr = this.next];
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  return Char2DoubleArrayMap.this.containsKey(var3) && Double.doubleToLongBits(Char2DoubleArrayMap.this.get(var3)) == Double.doubleToLongBits((Double)var2.getValue());
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Character) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  int var6 = Char2DoubleArrayMap.this.findKey(var3);
                  if (var6 != -1 && Double.doubleToLongBits(var4) == Double.doubleToLongBits(Char2DoubleArrayMap.this.value[var6])) {
                     int var7 = Char2DoubleArrayMap.this.size - var6 - 1;
                     System.arraycopy(Char2DoubleArrayMap.this.key, var6 + 1, Char2DoubleArrayMap.this.key, var6, var7);
                     System.arraycopy(Char2DoubleArrayMap.this.value, var6 + 1, Char2DoubleArrayMap.this.value, var6, var7);
                     Char2DoubleArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
