...
public class Char2ShortAVLTreeMap extends AbstractChar2ShortSortedMap implements Serializable, Cloneable {
   ...
   public Char2ShortAVLTreeMap(Comparator<? super Character> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Char2ShortAVLTreeMap(Map<? extends Character, ? extends Short> var1) {
      this();
      this.putAll(var1);
   }

   public Char2ShortAVLTreeMap(SortedMap<Character, Short> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Char2ShortAVLTreeMap(Char2ShortMap var1) {
      this();
      this.putAll(var1);
   }

   public Char2ShortAVLTreeMap(Char2ShortSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Char2ShortAVLTreeMap(char[] var1, short[] var2, Comparator<? super Character> var3) {
      this(var3);
   ...
   public Char2ShortAVLTreeMap(char[] var1, short[] var2) {
   ...
   final Char2ShortAVLTreeMap.Entry findKey(char var1) {
      Char2ShortAVLTreeMap.Entry var2;
      int var3;
   ...
   final Char2ShortAVLTreeMap.Entry locateKey(char var1) {
      Char2ShortAVLTreeMap.Entry var2 = this.tree;
      Char2ShortAVLTreeMap.Entry var3 = this.tree;
   ...
   public short addTo(char var1, short var2) {
      Char2ShortAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Char2ShortAVLTreeMap.Entry add(char var1) {
      this.modified = false;
      Char2ShortAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Char2ShortAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Char2ShortAVLTreeMap.Entry var3 = this.tree;
         Char2ShortAVLTreeMap.Entry var4 = null;
         Char2ShortAVLTreeMap.Entry var5 = this.tree;
         Char2ShortAVLTreeMap.Entry var6 = null;
         Char2ShortAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Char2ShortAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Char2ShortAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Char2ShortAVLTreeMap.Entry parent(Char2ShortAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Char2ShortAVLTreeMap.Entry var3 = var1;

         Char2ShortAVLTreeMap.Entry var2;
         Char2ShortAVLTreeMap.Entry var4;
   ...
   public short remove(char var1) {
      ...
      if (this.tree == null) {
         ...
         Char2ShortAVLTreeMap.Entry var7;
         Char2ShortAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Char2ShortAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(short var1) {
      Char2ShortAVLTreeMap.ValueIterator var2 = new Char2ShortAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public short get(char var1) {
      Char2ShortAVLTreeMap.Entry var2 = this.findKey(var1);
   ...
   public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
            final Comparator<? super Char2ShortMap.Entry> comparator = (var1x, var2) -> {
               return Char2ShortAVLTreeMap.this.actualComparator.compare(var1x.getCharKey(), var2.getCharKey());
            };
            ...
            public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry var1) {
               return Char2ShortAVLTreeMap.this.new EntryIterator(var1.getCharKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        Char2ShortAVLTreeMap.Entry var3 = Char2ShortAVLTreeMap.this.findKey((Character)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Character) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        ...
                        if (var3 != null && var3.getShortValue() == (Short)var2.getValue()) {
                           Char2ShortAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry var1, Char2ShortMap.Entry var2) {
               return Char2ShortAVLTreeMap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2ShortEntrySet();
            }

            public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry var1) {
               return Char2ShortAVLTreeMap.this.headMap(var1.getCharKey()).char2ShortEntrySet();
            }

            public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry var1) {
               return Char2ShortAVLTreeMap.this.tailMap(var1.getCharKey()).char2ShortEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Char2ShortAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Char2ShortSortedMap headMap(char var1) {
      return new Char2ShortAVLTreeMap.Submap('\u0000', true, var1, false);
   }

   public Char2ShortSortedMap tailMap(char var1) {
      return new Char2ShortAVLTreeMap.Submap(var1, false, '\u0000', true);
   }

   public Char2ShortSortedMap subMap(char var1, char var2) {
      return new Char2ShortAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Char2ShortAVLTreeMap clone() {
      Char2ShortAVLTreeMap var1;
      try {
         var1 = (Char2ShortAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Char2ShortAVLTreeMap.Entry var5 = new Char2ShortAVLTreeMap.Entry();
         Char2ShortAVLTreeMap.Entry var6 = new Char2ShortAVLTreeMap.Entry();
         Char2ShortAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Char2ShortAVLTreeMap.Entry var4 = var6;
         var6.pred((Char2ShortAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Char2ShortAVLTreeMap.EntryIterator var3 = new Char2ShortAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Char2ShortAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Char2ShortAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Char2ShortAVLTreeMap.Entry var3, Char2ShortAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Char2ShortAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Char2ShortAVLTreeMap.Entry(var1.readChar(), var1.readShort());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Char2ShortAVLTreeMap.Entry(var1.readChar(), var1.readShort());
         var8.right(new Char2ShortAVLTreeMap.Entry(var1.readChar(), var1.readShort()));
         ...
         Char2ShortAVLTreeMap.Entry var7 = new Char2ShortAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Char2ShortAVLTreeMap.Entry)null, (Char2ShortAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractChar2ShortSortedMap implements Serializable {
      ...
      public Submap(char var2, boolean var3, char var4, boolean var5) {
         super();
         if (!var3 && !var5 && Char2ShortAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Char2ShortAVLTreeMap.Submap.SubmapIterator var1 = new Char2ShortAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(char var1) {
         return (this.bottom || Char2ShortAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Char2ShortAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
         if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
               ...
               public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry var1, Char2ShortMap.Entry var2) {
                  return Submap.this.subMap(var1.getCharKey(), var2.getCharKey()).char2ShortEntrySet();
               }

               public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry var1) {
                  return Submap.this.headMap(var1.getCharKey()).char2ShortEntrySet();
               }

               public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry var1) {
                  return Submap.this.tailMap(var1.getCharKey()).char2ShortEntrySet();
               }
            };
         }
      ...
      public boolean containsKey(char var1) {
         return this.in(var1) && Char2ShortAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(short var1) {
         Char2ShortAVLTreeMap.Submap.SubmapIterator var2 = new Char2ShortAVLTreeMap.Submap.SubmapIterator();
      ...
      public short get(char var1) {
         Char2ShortAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Char2ShortAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public short put(char var1, short var2) {
         ...
         if (!this.in(var1)) {
            ...
            short var3 = Char2ShortAVLTreeMap.this.put(var1, var2);
            return Char2ShortAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public short remove(char var1) {
         ...
         if (!this.in(var1)) {
            ...
            short var2 = Char2ShortAVLTreeMap.this.remove(var1);
            return Char2ShortAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Char2ShortSortedMap headMap(char var1) {
         if (this.top) {
            return Char2ShortAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Char2ShortAVLTreeMap.this.compare(var1, this.to) < 0 ? Char2ShortAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Char2ShortSortedMap tailMap(char var1) {
         if (this.bottom) {
            return Char2ShortAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Char2ShortAVLTreeMap.this.compare(var1, this.from) > 0 ? Char2ShortAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Char2ShortSortedMap subMap(char var1, char var2) {
         if (this.top && this.bottom) {
            return Char2ShortAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Char2ShortAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Char2ShortAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Char2ShortAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Char2ShortAVLTreeMap.Entry firstEntry() {
         if (Char2ShortAVLTreeMap.this.tree == null) {
            ...
            Char2ShortAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Char2ShortAVLTreeMap.this.firstEntry;
            } else {
               var1 = Char2ShortAVLTreeMap.this.locateKey(this.from);
               if (Char2ShortAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Char2ShortAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Char2ShortAVLTreeMap.Entry lastEntry() {
         if (Char2ShortAVLTreeMap.this.tree == null) {
            ...
            Char2ShortAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Char2ShortAVLTreeMap.this.lastEntry;
            } else {
               var1 = Char2ShortAVLTreeMap.this.locateKey(this.to);
               if (Char2ShortAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Char2ShortAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public char firstCharKey() {
         Char2ShortAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public char lastCharKey() {
         Char2ShortAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Char2ShortAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Char2ShortMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Char2ShortAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(char var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Char2ShortAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Char2ShortAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Char2ShortAVLTreeMap.this.locateKey(var2);
                  if (Char2ShortAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractChar2ShortSortedMap.KeySet {
      ...
      public CharBidirectionalIterator iterator(char var1) {
         return Char2ShortAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Char2ShortAVLTreeMap.TreeIterator implements ObjectListIterator<Char2ShortMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(char var2) {
         super();
         if ((this.next = Char2ShortAVLTreeMap.this.locateKey(var2)) != null) {
            if (Char2ShortAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractChar2ShortMap.BasicEntry implements Cloneable {
      ...
      void pred(Char2ShortAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Char2ShortAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Char2ShortAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Char2ShortAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Char2ShortAVLTreeMap.Entry next() {
         Char2ShortAVLTreeMap.Entry var1 = this.right;
      ...
      Char2ShortAVLTreeMap.Entry prev() {
         Char2ShortAVLTreeMap.Entry var1 = this.left;
      ...
      public Char2ShortAVLTreeMap.Entry clone() {
         Char2ShortAVLTreeMap.Entry var1;
         try {
            var1 = (Char2ShortAVLTreeMap.Entry)super.clone();
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return this.key == (Character)var2.getKey() && this.value == (Short)var2.getValue();
         }
      }
