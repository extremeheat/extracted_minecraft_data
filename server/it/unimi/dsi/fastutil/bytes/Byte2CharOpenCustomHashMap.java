...
public class Byte2CharOpenCustomHashMap extends AbstractByte2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2CharOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2CharOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2CharOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2CharOpenCustomHashMap(Byte2CharMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2CharOpenCustomHashMap(Byte2CharMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2CharOpenCustomHashMap(byte[] var1, char[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2CharOpenCustomHashMap(byte[] var1, char[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Byte2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Byte2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2CharOpenCustomHashMap.this.value[Byte2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2CharOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2CharOpenCustomHashMap clone() {
      Byte2CharOpenCustomHashMap var1;
      try {
         var1 = (Byte2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      char[] var3 = this.value;
      Byte2CharOpenCustomHashMap.MapIterator var4 = new Byte2CharOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2CharOpenCustomHashMap.this.key[Byte2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2CharOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2CharOpenCustomHashMap.this.size;
         Byte2CharOpenCustomHashMap.this.remove(var1);
         return Byte2CharOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry> implements Byte2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Byte2CharOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2CharOpenCustomHashMap.this.containsNullKey && Byte2CharOpenCustomHashMap.this.value[Byte2CharOpenCustomHashMap.this.n] == var4;
                  } else {
                     byte[] var6 = Byte2CharOpenCustomHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Byte2CharOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2CharOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2CharOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Byte2CharOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (Byte2CharOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2CharOpenCustomHashMap.this.containsNullKey && Byte2CharOpenCustomHashMap.this.value[Byte2CharOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2CharOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2CharOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Byte2CharOpenCustomHashMap.this.value[var7] == var4) {
                           Byte2CharOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2CharOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2CharOpenCustomHashMap.this.strategy.equals(var5, var3) || Byte2CharOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2CharMap.Entry> var1) {
         if (Byte2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenCustomHashMap.this.key[Byte2CharOpenCustomHashMap.this.n], Byte2CharOpenCustomHashMap.this.value[Byte2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2CharOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenCustomHashMap.this.key[var2], Byte2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2CharMap.Entry> var1) {
         ...
         if (Byte2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2CharOpenCustomHashMap.this.key[Byte2CharOpenCustomHashMap.this.n];
            var2.value = Byte2CharOpenCustomHashMap.this.value[Byte2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2CharOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2CharOpenCustomHashMap.this.key[var3];
               var2.value = Byte2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2CharMap.Entry> {
      private final Byte2CharOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2CharOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2CharOpenCustomHashMap.this.mask; !Byte2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2CharOpenCustomHashMap.this.value[var2] = Byte2CharOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2CharMap.Entry, java.util.Map.Entry<Byte, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Byte2CharOpenCustomHashMap.this.value[this.index];
         Byte2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Byte2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
