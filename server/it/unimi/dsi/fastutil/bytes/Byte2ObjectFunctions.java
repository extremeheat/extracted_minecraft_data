...
public final class Byte2ObjectFunctions {
   ...
   public static <V> Byte2ObjectFunction<V> singleton(byte var0, V var1) {
      return new Byte2ObjectFunctions.Singleton(var0, var1);
   }
   ...
   public static <V> Byte2ObjectFunction<V> synchronize(Byte2ObjectFunction<V> var0) {
      return new Byte2ObjectFunctions.SynchronizedFunction(var0);
   }

   public static <V> Byte2ObjectFunction<V> synchronize(Byte2ObjectFunction<V> var0, Object var1) {
      return new Byte2ObjectFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Byte2ObjectFunction<V> unmodifiable(Byte2ObjectFunction<V> var0) {
      return new Byte2ObjectFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Byte2ObjectFunction<V> primitive(Function<? super Byte, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Byte2ObjectFunction) {
         return (Byte2ObjectFunction)var0;
         ...
         return new Byte2ObjectFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class UnmodifiableFunction<V> extends AbstractByte2ObjectFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Byte2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Byte2ObjectFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Byte2ObjectFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Byte2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
