...
public class Byte2IntOpenCustomHashMap extends AbstractByte2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2IntOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2IntOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2IntOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2IntOpenCustomHashMap(Map<? extends Byte, ? extends Integer> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2IntOpenCustomHashMap(Map<? extends Byte, ? extends Integer> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2IntOpenCustomHashMap(Byte2IntMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2IntOpenCustomHashMap(Byte2IntMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2IntOpenCustomHashMap(byte[] var1, int[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2IntOpenCustomHashMap(byte[] var1, int[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public boolean contains(int var1) {
               return Byte2IntOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2IntOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2IntOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2IntOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2IntOpenCustomHashMap clone() {
      Byte2IntOpenCustomHashMap var1;
      try {
         var1 = (Byte2IntOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      int[] var3 = this.value;
      Byte2IntOpenCustomHashMap.MapIterator var4 = new Byte2IntOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2IntOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2IntOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2IntOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2IntOpenCustomHashMap.this.size;
         Byte2IntOpenCustomHashMap.this.remove(var1);
         return Byte2IntOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (Byte2IntOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2IntOpenCustomHashMap.this.containsNullKey && Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n] == var4;
                  } else {
                     byte[] var6 = Byte2IntOpenCustomHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2IntOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Byte2IntOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2IntOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2IntOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Byte2IntOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var4 = (Integer)var2.getValue();
                  if (Byte2IntOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2IntOpenCustomHashMap.this.containsNullKey && Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2IntOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2IntOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Byte2IntOpenCustomHashMap.this.value[var7] == var4) {
                           Byte2IntOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2IntOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2IntOpenCustomHashMap.this.strategy.equals(var5, var3) || Byte2IntOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2IntMap.Entry> var1) {
         if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.n], Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2IntOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntOpenCustomHashMap.this.key[var2], Byte2IntOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2IntMap.Entry> var1) {
         ...
         if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.n];
            var2.value = Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2IntOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2IntOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2IntOpenCustomHashMap.this.key[var3];
               var2.value = Byte2IntOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2IntMap.Entry> {
      private final Byte2IntOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2IntOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2IntMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2IntOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2IntOpenCustomHashMap.this.mask; !Byte2IntOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2IntOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2IntOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2IntOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2IntOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2IntOpenCustomHashMap.this.value[var2] = Byte2IntOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2IntMap.Entry, java.util.Map.Entry<Byte, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Byte2IntOpenCustomHashMap.this.value[this.index];
         Byte2IntOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2IntOpenCustomHashMap.this.strategy.equals(Byte2IntOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Byte2IntOpenCustomHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
