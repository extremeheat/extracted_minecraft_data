...
public class Byte2ObjectArrayMap<V> extends AbstractByte2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Byte2ObjectArrayMap(byte[] var1, Object[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Byte2ObjectArrayMap(int var1) {
      super();
      this.key = new byte[var1];
      this.value = new Object[var1];
   }

   public Byte2ObjectArrayMap(Byte2ObjectMap<V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2ObjectArrayMap(Map<? extends Byte, ? extends V> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2ObjectArrayMap(byte[] var1, Object[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ByteSet keySet() {
      return new AbstractByteSet() {
         public boolean contains(byte var1) {
            return Byte2ObjectArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(byte var1) {
            int var2 = Byte2ObjectArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Byte2ObjectArrayMap.this.size - var2 - 1;
               System.arraycopy(Byte2ObjectArrayMap.this.key, var2 + 1, Byte2ObjectArrayMap.this.key, var2, var3);
               System.arraycopy(Byte2ObjectArrayMap.this.value, var2 + 1, Byte2ObjectArrayMap.this.value, var2, var3);
            ...
            return new ByteIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Byte2ObjectArrayMap.this.size - this.pos;
                     System.arraycopy(Byte2ObjectArrayMap.this.key, this.pos, Byte2ObjectArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Byte2ObjectArrayMap.this.value, this.pos, Byte2ObjectArrayMap.this.value, this.pos - 1, var1);
                     Byte2ObjectArrayMap.this.size--;
                  }
               }
            };
   ...
   public ObjectCollection<V> values() {
      return new AbstractObjectCollection<V>() {
         public boolean contains(Object var1) {
            return Byte2ObjectArrayMap.this.containsValue(var1);
         }
   ...
   public Byte2ObjectArrayMap<V> clone() {
      Byte2ObjectArrayMap var1;
      try {
         var1 = (Byte2ObjectArrayMap)super.clone();
         ...
         return new ObjectIterator<Byte2ObjectMap.Entry<V>>() {
            ...
            public Byte2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractByte2ObjectMap.BasicEntry(Byte2ObjectArrayMap.this.key[this.curr = this.next], Byte2ObjectArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Byte2ObjectArrayMap.this.size-- - this.next--;
                  System.arraycopy(Byte2ObjectArrayMap.this.key, this.next + 1, Byte2ObjectArrayMap.this.key, this.next, var1);
                  System.arraycopy(Byte2ObjectArrayMap.this.value, this.next + 1, Byte2ObjectArrayMap.this.value, this.next, var1);
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               return Byte2ObjectArrayMap.this.containsKey(var3) && Objects.equals(Byte2ObjectArrayMap.this.get(var3), var2.getValue());
            } else {
               return false;
            }
         }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               int var5 = Byte2ObjectArrayMap.this.findKey(var3);
               if (var5 != -1 && Objects.equals(var4, Byte2ObjectArrayMap.this.value[var5])) {
                  int var6 = Byte2ObjectArrayMap.this.size - var5 - 1;
                  System.arraycopy(Byte2ObjectArrayMap.this.key, var5 + 1, Byte2ObjectArrayMap.this.key, var5, var6);
                  System.arraycopy(Byte2ObjectArrayMap.this.value, var5 + 1, Byte2ObjectArrayMap.this.value, var5, var6);
                  Byte2ObjectArrayMap.this.size--;
                  Byte2ObjectArrayMap.this.value[Byte2ObjectArrayMap.this.size] = null;
                  return true;
               } else {
