...
public class Byte2ObjectRBTreeMap<V> extends AbstractByte2ObjectSortedMap<V> implements Serializable, Cloneable {
   ...
   public Byte2ObjectRBTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2ObjectRBTreeMap(Map<? extends Byte, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2ObjectRBTreeMap(SortedMap<Byte, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2ObjectRBTreeMap(Byte2ObjectMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2ObjectRBTreeMap(Byte2ObjectSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2ObjectRBTreeMap(byte[] var1, V[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2ObjectRBTreeMap(byte[] var1, V[] var2) {
   ...
   final Byte2ObjectRBTreeMap.Entry<V> findKey(byte var1) {
      Byte2ObjectRBTreeMap.Entry var2;
      int var3;
   ...
   final Byte2ObjectRBTreeMap.Entry<V> locateKey(byte var1) {
      Byte2ObjectRBTreeMap.Entry var2 = this.tree;
      Byte2ObjectRBTreeMap.Entry var3 = this.tree;
   ...
   public V put(byte var1, V var2) {
      Byte2ObjectRBTreeMap.Entry var3 = this.add(var1);
      Object var4 = var3.value;
      var3.value = var2;
      return var4;
   }

   private Byte2ObjectRBTreeMap.Entry<V> add(byte var1) {
      this.modified = false;
      int var2 = 0;
      Byte2ObjectRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Byte2ObjectRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Byte2ObjectRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Byte2ObjectRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Byte2ObjectRBTreeMap.Entry var7;
               Byte2ObjectRBTreeMap.Entry var8;
   ...
   public boolean containsValue(Object var1) {
      Byte2ObjectRBTreeMap.ValueIterator var2 = new Byte2ObjectRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(byte var1) {
      Byte2ObjectRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>() {
            final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = (var1x, var2) -> {
               return Byte2ObjectRBTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> var1) {
               return Byte2ObjectRBTreeMap.this.new EntryIterator(var1.getByteKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     Byte2ObjectRBTreeMap.Entry var3 = Byte2ObjectRBTreeMap.this.findKey((Byte)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     ...
                     if (var3 != null && Objects.equals(var3.getValue(), var2.getValue())) {
                        Byte2ObjectRBTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> var1, Byte2ObjectMap.Entry<V> var2) {
               return Byte2ObjectRBTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2ObjectEntrySet();
            }

            public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> var1) {
               return Byte2ObjectRBTreeMap.this.headMap(var1.getByteKey()).byte2ObjectEntrySet();
            }

            public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> var1) {
               return Byte2ObjectRBTreeMap.this.tailMap(var1.getByteKey()).byte2ObjectEntrySet();
            }
         };
      }
   ...
   public ObjectCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Byte2ObjectRBTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2ObjectSortedMap<V> headMap(byte var1) {
      return new Byte2ObjectRBTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2ObjectSortedMap<V> tailMap(byte var1) {
      return new Byte2ObjectRBTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2ObjectSortedMap<V> subMap(byte var1, byte var2) {
      return new Byte2ObjectRBTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2ObjectRBTreeMap<V> clone() {
      Byte2ObjectRBTreeMap var1;
      try {
         var1 = (Byte2ObjectRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2ObjectRBTreeMap.Entry var5 = new Byte2ObjectRBTreeMap.Entry();
         Byte2ObjectRBTreeMap.Entry var6 = new Byte2ObjectRBTreeMap.Entry();
         Byte2ObjectRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2ObjectRBTreeMap.Entry var4 = var6;
         var6.pred((Byte2ObjectRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2ObjectRBTreeMap.EntryIterator var3 = new Byte2ObjectRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2ObjectRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2ObjectRBTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Byte2ObjectRBTreeMap.Entry<V> var3, Byte2ObjectRBTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Byte2ObjectRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2ObjectRBTreeMap.Entry(var1.readByte(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Byte2ObjectRBTreeMap.Entry(var1.readByte(), var1.readObject());
         var8.black(true);
         var8.right(new Byte2ObjectRBTreeMap.Entry(var1.readByte(), var1.readObject()));
         ...
         Byte2ObjectRBTreeMap.Entry var7 = new Byte2ObjectRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2ObjectRBTreeMap.Entry)null, (Byte2ObjectRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2ObjectSortedMap<V> implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2ObjectRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2ObjectRBTreeMap.Submap.SubmapIterator var1 = new Byte2ObjectRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2ObjectRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2ObjectRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2ObjectRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Byte2ObjectRBTreeMap.Submap.SubmapIterator var2 = new Byte2ObjectRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(byte var1) {
         Byte2ObjectRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2ObjectRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public V put(byte var1, V var2) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Byte2ObjectRBTreeMap.this.put(var1, var2);
            return Byte2ObjectRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public V remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var2 = Byte2ObjectRBTreeMap.this.remove(var1);
            return Byte2ObjectRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Byte2ObjectSortedMap<V> headMap(byte var1) {
         if (this.top) {
            return Byte2ObjectRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2ObjectRBTreeMap.this.compare(var1, this.to) < 0 ? Byte2ObjectRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2ObjectSortedMap<V> tailMap(byte var1) {
         if (this.bottom) {
            return Byte2ObjectRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2ObjectRBTreeMap.this.compare(var1, this.from) > 0 ? Byte2ObjectRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2ObjectSortedMap<V> subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2ObjectRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2ObjectRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2ObjectRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2ObjectRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Byte2ObjectRBTreeMap.Entry<V> firstEntry() {
         if (Byte2ObjectRBTreeMap.this.tree == null) {
            ...
            Byte2ObjectRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2ObjectRBTreeMap.this.firstEntry;
            } else {
               var1 = Byte2ObjectRBTreeMap.this.locateKey(this.from);
               if (Byte2ObjectRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2ObjectRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Byte2ObjectRBTreeMap.Entry<V> lastEntry() {
         if (Byte2ObjectRBTreeMap.this.tree == null) {
            ...
            Byte2ObjectRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2ObjectRBTreeMap.this.lastEntry;
            } else {
               var1 = Byte2ObjectRBTreeMap.this.locateKey(this.to);
               if (Byte2ObjectRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2ObjectRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2ObjectRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2ObjectRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Byte2ObjectRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Byte2ObjectMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2ObjectRBTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2ObjectRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2ObjectRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2ObjectRBTreeMap.this.locateKey(var2);
                  if (Byte2ObjectRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractByte2ObjectSortedMap<V>.KeySet {
      ...
      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2ObjectRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Byte2ObjectRBTreeMap<V>.TreeIterator implements ObjectListIterator<Byte2ObjectMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2ObjectRBTreeMap.this.locateKey(var2)) != null) {
            if (Byte2ObjectRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractByte2ObjectMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Byte2ObjectRBTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2ObjectRBTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2ObjectRBTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2ObjectRBTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2ObjectRBTreeMap.Entry<V> next() {
         Byte2ObjectRBTreeMap.Entry var1 = this.right;
      ...
      Byte2ObjectRBTreeMap.Entry<V> prev() {
         Byte2ObjectRBTreeMap.Entry var1 = this.left;
      ...
      public Byte2ObjectRBTreeMap.Entry<V> clone() {
         Byte2ObjectRBTreeMap.Entry var1;
         try {
            var1 = (Byte2ObjectRBTreeMap.Entry)super.clone();
