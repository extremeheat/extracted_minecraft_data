...
public final class ByteArrays {
   ...
   public static final Hash.Strategy<byte[]> HASH_STRATEGY = new ByteArrays.ArrayHashStrategy();

   private ByteArrays() {
      super();
   }

   public static byte[] forceCapacity(byte[] var0, int var1, int var2) {
   ...
   public static byte[] grow(byte[] var0, int var1) {
      return grow(var0, var1, var0.length);
   }

   public static byte[] grow(byte[] var0, int var1, int var2) {
      if (var1 > var0.length) {
   ...
   public static byte[] trim(byte[] var0, int var1) {
      if (var1 >= var0.length) {
         ...
         byte[] var2 = var1 == 0 ? EMPTY_ARRAY : new byte[var1];
         System.arraycopy(var0, 0, var2, 0, var1);
         return var2;
      }
   }

   public static byte[] setLength(byte[] var0, int var1) {
      if (var1 == var0.length) {
         return var0;
      } else {
   ...
   public static byte[] copy(byte[] var0, int var1, int var2) {
      ensureOffsetLength(var0, var1, var2);
      byte[] var3 = var2 == 0 ? EMPTY_ARRAY : new byte[var2];
   ...
   public static void ensureFromTo(byte[] var0, int var1, int var2) {
      Arrays.ensureFromTo(var0.length, var1, var2);
   }

   public static void ensureOffsetLength(byte[] var0, int var1, int var2) {
      Arrays.ensureOffsetLength(var0.length, var1, var2);
   }

   public static void ensureSameLength(byte[] var0, byte[] var1) {
   ...
   private static int med3(byte[] var0, int var1, int var2, int var3, ByteComparator var4) {
   ...
   private static void selectionSort(byte[] var0, int var1, int var2, ByteComparator var3) {
   ...
   private static void insertionSort(byte[] var0, int var1, int var2, ByteComparator var3) {
      int var4 = var1;
      ...
      while(true) {
         ...
         for(byte var7 = var0[var4 - 1]; var3.compare(var5, var7) < 0; var7 = var0[var6 - 1]) {
            var0[var6] = var7;
            if (var1 == var6 - 1) {
               --var6;
               break;
   ...
   public static void quickSort(byte[] var0, int var1, int var2, ByteComparator var3) {
      int var4 = var2 - var1;
      if (var4 < 16) {
   ...
   public static void quickSort(byte[] var0, ByteComparator var1) {
      quickSort(var0, 0, var0.length, var1);
   }

   public static void parallelQuickSort(byte[] var0, int var1, int var2, ByteComparator var3) {
      if (var2 - var1 < 8192) {
         quickSort(var0, var1, var2, var3);
      } else {
         ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var4.invoke(new ByteArrays.ForkJoinQuickSortComp(var0, var1, var2, var3));
         var4.shutdown();
      }

   }

   public static void parallelQuickSort(byte[] var0, ByteComparator var1) {
      parallelQuickSort(var0, 0, var0.length, var1);
   }

   private static int med3(byte[] var0, int var1, int var2, int var3) {
      int var4 = Byte.compare(var0[var1], var0[var2]);
      int var5 = Byte.compare(var0[var1], var0[var3]);
      int var6 = Byte.compare(var0[var2], var0[var3]);
      return var4 < 0 ? (var6 < 0 ? var2 : (var5 < 0 ? var3 : var1)) : (var6 > 0 ? var2 : (var5 > 0 ? var3 : var1));
   }

   private static void selectionSort(byte[] var0, int var1, int var2) {
   ...
   private static void insertionSort(byte[] var0, int var1, int var2) {
      int var3 = var1;
      ...
      while(true) {
         ...
         for(byte var6 = var0[var3 - 1]; var4 < var6; var6 = var0[var5 - 1]) {
            var0[var5] = var6;
            if (var1 == var5 - 1) {
               --var5;
               break;
   ...
   public static void quickSort(byte[] var0, int var1, int var2) {
      int var3 = var2 - var1;
      if (var3 < 16) {
         ...
         while(true) {
            int var12;
            while(var9 > var10 || (var12 = Byte.compare(var0[var9], var13)) > 0) {
               for(; var10 >= var9 && (var12 = Byte.compare(var0[var10], var13)) >= 0; --var10) {
                  if (var12 == 0) {
                     swap(var0, var10, var11--);
                  }
               }
   ...
   public static void quickSort(byte[] var0) {
      quickSort(var0, 0, var0.length);
   }

   public static void parallelQuickSort(byte[] var0, int var1, int var2) {
      if (var2 - var1 < 8192) {
         quickSort(var0, var1, var2);
      } else {
         ForkJoinPool var3 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var3.invoke(new ByteArrays.ForkJoinQuickSort(var0, var1, var2));
         var3.shutdown();
      }

   }

   public static void parallelQuickSort(byte[] var0) {
      parallelQuickSort(var0, 0, var0.length);
   }

   private static int med3Indirect(int[] var0, byte[] var1, int var2, int var3, int var4) {
      byte var5 = var1[var0[var2]];
      byte var6 = var1[var0[var3]];
      byte var7 = var1[var0[var4]];
      int var8 = Byte.compare(var5, var6);
      int var9 = Byte.compare(var5, var7);
      int var10 = Byte.compare(var6, var7);
      return var8 < 0 ? (var10 < 0 ? var3 : (var9 < 0 ? var4 : var2)) : (var10 > 0 ? var3 : (var9 > 0 ? var4 : var2));
   }

   private static void insertionSortIndirect(int[] var0, byte[] var1, int var2, int var3) {
      int var4 = var2;
   ...
   public static void quickSortIndirect(int[] var0, byte[] var1, int var2, int var3) {
      int var4 = var3 - var2;
      if (var4 < 16) {
         ...
         while(true) {
            int var13;
            while(var10 > var11 || (var13 = Byte.compare(var1[var0[var10]], var14)) > 0) {
               for(; var11 >= var10 && (var13 = Byte.compare(var1[var0[var11]], var14)) >= 0; --var11) {
                  if (var13 == 0) {
   ...
   public static void quickSortIndirect(int[] var0, byte[] var1) {
      quickSortIndirect(var0, var1, 0, var1.length);
   }

   public static void parallelQuickSortIndirect(int[] var0, byte[] var1, int var2, int var3) {
      if (var3 - var2 < 8192) {
         quickSortIndirect(var0, var1, var2, var3);
      } else {
         ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
         var4.invoke(new ByteArrays.ForkJoinQuickSortIndirect(var0, var1, var2, var3));
         var4.shutdown();
      }

   }

   public static void parallelQuickSortIndirect(int[] var0, byte[] var1) {
      parallelQuickSortIndirect(var0, var1, 0, var1.length);
   }

   public static void stabilize(int[] var0, byte[] var1, int var2, int var3) {
      int var4 = var2;
   ...
   public static void stabilize(int[] var0, byte[] var1) {
      stabilize(var0, var1, 0, var0.length);
   }

   private static int med3(byte[] var0, byte[] var1, int var2, int var3, int var4) {
      int var5;
      int var6 = (var5 = Byte.compare(var0[var2], var0[var3])) == 0 ? Byte.compare(var1[var2], var1[var3]) : var5;
      int var7 = (var5 = Byte.compare(var0[var2], var0[var4])) == 0 ? Byte.compare(var1[var2], var1[var4]) : var5;
      int var8 = (var5 = Byte.compare(var0[var3], var0[var4])) == 0 ? Byte.compare(var1[var3], var1[var4]) : var5;
      return var6 < 0 ? (var8 < 0 ? var3 : (var7 < 0 ? var4 : var2)) : (var8 > 0 ? var3 : (var7 > 0 ? var4 : var2));
   }

   private static void swap(byte[] var0, byte[] var1, int var2, int var3) {
      byte var4 = var0[var2];
      byte var5 = var1[var2];
      var0[var2] = var0[var3];
      var1[var2] = var1[var3];
   ...
   private static void swap(byte[] var0, byte[] var1, int var2, int var3, int var4) {
   ...
   private static void selectionSort(byte[] var0, byte[] var1, int var2, int var3) {
      for(int var4 = var2; var4 < var3 - 1; ++var4) {
         int var5 = var4;

         for(int var7 = var4 + 1; var7 < var3; ++var7) {
            int var6;
            if ((var6 = Byte.compare(var0[var7], var0[var5])) < 0 || var6 == 0 && var1[var7] < var1[var5]) {
               var5 = var7;
            }
         }
   ...
   public static void quickSort(byte[] var0, byte[] var1, int var2, int var3) {
      int var4 = var3 - var2;
      if (var4 < 16) {
         selectionSort(var0, var1, var2, var3);
      } else {
         ...
         while(true) {
            int var14;
            int var15;
            while(var11 > var12 || (var14 = (var15 = Byte.compare(var0[var11], var16)) == 0 ? Byte.compare(var1[var11], var9) : var15) > 0) {
               for(; var12 >= var11 && (var14 = (var15 = Byte.compare(var0[var12], var16)) == 0 ? Byte.compare(var1[var12], var9) : var15) >= 0; --var12) {
                  if (var14 == 0) {
   ...
   public static void quickSort(byte[] var0, byte[] var1) {
      ensureSameLength(var0, var1);
      quickSort(var0, var1, 0, var0.length);
   }

   public static void parallelQuickSort(byte[] var0, byte[] var1, int var2, int var3) {
      if (var3 - var2 < 8192) {
         quickSort(var0, var1, var2, var3);
      }

      ForkJoinPool var4 = new ForkJoinPool(Runtime.getRuntime().availableProcessors());
      var4.invoke(new ByteArrays.ForkJoinQuickSort2(var0, var1, var2, var3));
      var4.shutdown();
   }

   public static void parallelQuickSort(byte[] var0, byte[] var1) {
      ensureSameLength(var0, var1);
      parallelQuickSort(var0, var1, 0, var0.length);
   }

   public static void mergeSort(byte[] var0, int var1, int var2, byte[] var3) {
      int var4 = var2 - var1;
      if (var4 < 16) {
   ...
   public static void mergeSort(byte[] var0, int var1, int var2) {
      mergeSort(var0, var1, var2, (byte[])var0.clone());
   }

   public static void mergeSort(byte[] var0) {
      mergeSort(var0, 0, var0.length);
   }

   public static void mergeSort(byte[] var0, int var1, int var2, ByteComparator var3, byte[] var4) {
      int var5 = var2 - var1;
      if (var5 < 16) {
   ...
   public static void mergeSort(byte[] var0, int var1, int var2, ByteComparator var3) {
      mergeSort(var0, var1, var2, var3, (byte[])var0.clone());
   }

   public static void mergeSort(byte[] var0, ByteComparator var1) {
      mergeSort(var0, 0, var0.length, (ByteComparator)var1);
   }
   ...
   public static int binarySearch(byte[] var0, int var1, int var2, byte var3, ByteComparator var4) {
      --var2;
   ...
   public static int binarySearch(byte[] var0, byte var1, ByteComparator var2) {
      return binarySearch(var0, 0, var0.length, var1, var2);
   }

   public static void radixSort(byte[] var0) {
      radixSort((byte[])var0, 0, var0.length);
   }

   public static void radixSort(byte[] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         quickSort(var0, var1, var2);
      } else {
         boolean var3 = false;
         ...
         while(var23 > 0) {
            ...
            int var14 = var13 % 1 == 0 ? 128 : 0;
            int var15 = (0 - var13 % 1) * 8;
   ...
   public static void parallelRadixSort(byte[] var0, int var1, int var2) {
      if (var2 - var1 < 1024) {
         quickSort(var0, var1, var2);
      } else {
         boolean var3 = false;
         LinkedBlockingQueue var4 = new LinkedBlockingQueue();
         var4.add(new ByteArrays.Segment(var1, var2 - var1, 0));
         ...
         while(var9-- != 0) {
            var8.submit(() -> {
               ...
               while(true) {
                  ...
                  ByteArrays.Segment var19 = (ByteArrays.Segment)var4.take();
                  ...
                  int var10 = var9 % 1 == 0 ? 128 : 0;
                  int var11 = (0 - var9 % 1) * 8;
                  ...
                  for(boolean var15 = true; var14 <= var13; var4x[var20] = 0) {
                     ...
                     if (var9 < 0 && var4x[var20] > 1) {
                        if (var4x[var20] < 1024) {
                           quickSort(var0, var14, var14 + var4x[var20]);
                        } else {
                           var5.incrementAndGet();
                           var4.add(new ByteArrays.Segment(var14, var4x[var20], var9 + 1));
                        }
                     }
   ...
   public static void parallelRadixSort(byte[] var0) {
      parallelRadixSort(var0, 0, var0.length);
   }

   public static void radixSortIndirect(int[] var0, byte[] var1, boolean var2) {
      radixSortIndirect(var0, var1, 0, var0.length, var2);
   }

   public static void radixSortIndirect(int[] var0, byte[] var1, int var2, int var3, boolean var4) {
      if (var3 - var2 < 1024) {
         insertionSortIndirect(var0, var1, var2, var3);
      } else {
         boolean var5 = false;
         ...
         while(true) {
            while(var26 > 0) {
               ...
               int var17 = var16 % 1 == 0 ? 128 : 0;
               int var18 = (0 - var16 % 1) * 8;
   ...
   public static void parallelRadixSortIndirect(int[] var0, byte[] var1, int var2, int var3, boolean var4) {
      if (var3 - var2 < 1024) {
         radixSortIndirect(var0, var1, var2, var3, var4);
      } else {
         boolean var5 = false;
         LinkedBlockingQueue var6 = new LinkedBlockingQueue();
         var6.add(new ByteArrays.Segment(var2, var3 - var2, 0));
         ...
         while(var12-- != 0) {
            var10.submit(() -> {
               ...
               while(true) {
                  ...
                  ByteArrays.Segment var22 = (ByteArrays.Segment)var6.take();
                  ...
                  int var13 = var12 % 1 == 0 ? 128 : 0;
                  int var14 = (0 - var12 % 1) * 8;
                  ...
                  if (var4) {
                     ...
                     for(var17 = var10; var16 <= var15; ++var16) {
                        if (var12 < 0 && var7x[var16] > 1) {
                           if (var7x[var16] < 1024) {
                              radixSortIndirect(var0, var1, var17, var17 + var7x[var16], var4);
                           } else {
                              var7.incrementAndGet();
                              var6.add(new ByteArrays.Segment(var17, var7x[var16], var12 + 1));
                           }
                        }
                     ...
                     for(boolean var18 = true; var17 <= var16; var7x[var23] = 0) {
                        ...
                        if (var12 < 0 && var7x[var23] > 1) {
                           if (var7x[var23] < 1024) {
                              radixSortIndirect(var0, var1, var17, var17 + var7x[var23], var4);
                           } else {
                              var7.incrementAndGet();
                              var6.add(new ByteArrays.Segment(var17, var7x[var23], var12 + 1));
                           }
                        }
   ...
   public static void parallelRadixSortIndirect(int[] var0, byte[] var1, boolean var2) {
      parallelRadixSortIndirect(var0, var1, 0, var1.length, var2);
   }

   public static void radixSort(byte[] var0, byte[] var1) {
      ensureSameLength(var0, var1);
      radixSort(var0, var1, 0, var0.length);
   }

   public static void radixSort(byte[] var0, byte[] var1, int var2, int var3) {
      if (var3 - var2 < 1024) {
         selectionSort(var0, var1, var2, var3);
      } else {
         boolean var4 = true;
         ...
         while(var27 > 0) {
            ...
            int var16 = var15 % 1 == 0 ? 128 : 0;
            byte[] var17 = var15 < 1 ? var0 : var1;
            int var18 = (0 - var15 % 1) * 8;
            ...
            for(boolean var22 = true; var21 <= var20; var11[var29] = 0) {
               byte var24 = var0[var21];
               byte var25 = var1[var21];
   ...
   public static void parallelRadixSort(byte[] var0, byte[] var1, int var2, int var3) {
      if (var3 - var2 < 1024) {
         quickSort(var0, var1, var2, var3);
      } else {
         boolean var4 = true;
            ...
            while(var11-- != 0) {
               var10.submit(() -> {
                  ...
                  while(true) {
                     ...
                     ByteArrays.Segment var23 = (ByteArrays.Segment)var6.take();
                     ...
                     int var11 = var10 % 1 == 0 ? 128 : 0;
                     byte[] var12 = var10 < 1 ? var0 : var1;
                     int var13 = (0 - var10 % 1) * 8;
                     ...
                     for(boolean var17 = true; var16 <= var15; var5[var24] = 0) {
                        byte var19 = var0[var16];
                        byte var20 = var1[var16];
                        ...
                        if (var10 < 1 && var5[var24] > 1) {
                           if (var5[var24] < 1024) {
                              quickSort(var0, var1, var16, var16 + var5[var24]);
                           } else {
                              var7.incrementAndGet();
                              var6.add(new ByteArrays.Segment(var16, var5[var24], var10 + 1));
                           }
                        }
   ...
   public static void parallelRadixSort(byte[] var0, byte[] var1) {
      ensureSameLength(var0, var1);
      parallelRadixSort(var0, var1, 0, var0.length);
   }

   private static void insertionSortIndirect(int[] var0, byte[] var1, byte[] var2, int var3, int var4) {
      int var5 = var3;
   ...
   public static void radixSortIndirect(int[] var0, byte[] var1, byte[] var2, boolean var3) {
      ensureSameLength(var1, var2);
      radixSortIndirect(var0, var1, var2, 0, var1.length, var3);
   }

   public static void radixSortIndirect(int[] var0, byte[] var1, byte[] var2, int var3, int var4, boolean var5) {
      if (var4 - var3 < 1024) {
         ...
         while(true) {
            while(var29 > 0) {
               ...
               int var19 = var18 % 1 == 0 ? 128 : 0;
               byte[] var20 = var18 < 1 ? var1 : var2;
               int var21 = (0 - var18 % 1) * 8;
   ...
   private static void selectionSort(byte[][] var0, int var1, int var2, int var3) {
   ...
   public static void radixSort(byte[][] var0) {
      radixSort((byte[][])var0, 0, var0[0].length);
   }
   ...
   public static byte[] shuffle(byte[] var0, int var1, int var2, Random var3) {
      int var5;
      byte var6;
   ...
   public static byte[] shuffle(byte[] var0, Random var1) {
      int var3;
      byte var4;
   ...
   public static byte[] reverse(byte[] var0, int var1, int var2) {
      int var3 = var2 - var1;
   ...
   protected static class ForkJoinQuickSort2 extends RecursiveAction {
      ...
      public ForkJoinQuickSort2(byte[] var1, byte[] var2, int var3, int var4) {
         super();
         this.from = var3;
         this.to = var4;
         this.x = var1;
      ...
      protected void compute() {
         ...
         if (var3 < 8192) {
            ByteArrays.quickSort(var1, var2, this.from, this.to);
         } else {
            int var4 = this.from + var3 / 2;
            int var5 = this.from;
            int var6 = this.to - 1;
            int var7 = var3 / 8;
            var5 = ByteArrays.med3(var1, var2, var5, var5 + var7, var5 + 2 * var7);
            var4 = ByteArrays.med3(var1, var2, var4 - var7, var4, var4 + var7);
            var6 = ByteArrays.med3(var1, var2, var6 - 2 * var7, var6 - var7, var6);
            var4 = ByteArrays.med3(var1, var2, var5, var4, var6);
            byte var8 = var1[var4];
            byte var9 = var2[var4];
            int var10 = this.from;
            int var11 = var10;
            ...
            while(true) {
               int var14;
               int var15;
               while(var11 > var12 || (var14 = (var15 = Byte.compare(var1[var11], var8)) == 0 ? Byte.compare(var2[var11], var9) : var15) > 0) {
                  for(; var12 >= var11 && (var14 = (var15 = Byte.compare(var1[var12], var8)) == 0 ? Byte.compare(var2[var12], var9) : var15) >= 0; --var12) {
                     if (var14 == 0) {
                        ByteArrays.swap(var1, var2, var12, var13--);
                     }
                  }

                  if (var11 > var12) {
                     var7 = Math.min(var10 - this.from, var11 - var10);
                     ByteArrays.swap(var1, var2, this.from, var11 - var7, var7);
                     var7 = Math.min(var13 - var12, this.to - var13 - 1);
                     ByteArrays.swap(var1, var2, var11, this.to - var7, var7);
                     var7 = var11 - var10;
                     var14 = var13 - var12;
                     if (var7 > 1 && var14 > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSort2(var1, var2, this.from, this.from + var7), new ByteArrays.ForkJoinQuickSort2(var1, var2, this.to - var14, this.to));
                     } else if (var7 > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort2(var1, var2, this.from, this.from + var7)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort2(var1, var2, this.to - var14, this.to)});
                     }

                     return;
                  }

                  ByteArrays.swap(var1, var2, var11++, var12--);
               }

               if (var14 == 0) {
                  ByteArrays.swap(var1, var2, var10++, var11);
               }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      public ForkJoinQuickSortIndirect(int[] var1, byte[] var2, int var3, int var4) {
         super();
         this.from = var3;
         this.to = var4;
         this.x = var2;
      ...
      protected void compute() {
         ...
         if (var2 < 8192) {
            ByteArrays.quickSortIndirect(this.perm, var1, this.from, this.to);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = ByteArrays.med3Indirect(this.perm, var1, var4, var4 + var6, var4 + 2 * var6);
            var3 = ByteArrays.med3Indirect(this.perm, var1, var3 - var6, var3, var3 + var6);
            var5 = ByteArrays.med3Indirect(this.perm, var1, var5 - 2 * var6, var5 - var6, var5);
            var3 = ByteArrays.med3Indirect(this.perm, var1, var4, var3, var5);
            byte var7 = var1[this.perm[var3]];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            int var11 = var10;
            ...
            while(true) {
               int var12;
               while(var9 > var10 || (var12 = Byte.compare(var1[this.perm[var9]], var7)) > 0) {
                  for(; var10 >= var9 && (var12 = Byte.compare(var1[this.perm[var10]], var7)) >= 0; --var10) {
                     if (var12 == 0) {
                  ...
                  if (var9 > var10) {
                     ...
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.from, this.from + var6), new ByteArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.to - var12, this.to));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.from, this.from + var6)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortIndirect(this.perm, var1, this.to - var12, this.to)});
                     }
   ...
   protected static class ForkJoinQuickSort extends RecursiveAction {
      ...
      public ForkJoinQuickSort(byte[] var1, int var2, int var3) {
         super();
         this.from = var2;
         this.to = var3;
         this.x = var1;
      ...
      protected void compute() {
         ...
         int var2 = this.to - this.from;
         if (var2 < 8192) {
            ByteArrays.quickSort(var1, this.from, this.to);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = ByteArrays.med3(var1, var4, var4 + var6, var4 + 2 * var6);
            var3 = ByteArrays.med3(var1, var3 - var6, var3, var3 + var6);
            var5 = ByteArrays.med3(var1, var5 - 2 * var6, var5 - var6, var5);
            var3 = ByteArrays.med3(var1, var4, var3, var5);
            byte var7 = var1[var3];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            ...
            while(true) {
               int var12;
               while(var9 > var10 || (var12 = Byte.compare(var1[var9], var7)) > 0) {
                  for(; var10 >= var9 && (var12 = Byte.compare(var1[var10], var7)) >= 0; --var10) {
                     if (var12 == 0) {
                        ByteArrays.swap(var1, var10, var11--);
                     }
                  }

                  if (var9 > var10) {
                     var6 = Math.min(var8 - this.from, var9 - var8);
                     ByteArrays.swap(var1, this.from, var9 - var6, var6);
                     var6 = Math.min(var11 - var10, this.to - var11 - 1);
                     ByteArrays.swap(var1, var9, this.to - var6, var6);
                     var6 = var9 - var8;
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSort(var1, this.from, this.from + var6), new ByteArrays.ForkJoinQuickSort(var1, this.to - var12, this.to));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort(var1, this.from, this.from + var6)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSort(var1, this.to - var12, this.to)});
                     }

                     return;
                  }

                  ByteArrays.swap(var1, var9++, var10--);
               }

               if (var12 == 0) {
                  ByteArrays.swap(var1, var8++, var9);
               }
   ...
   protected static class ForkJoinQuickSortComp extends RecursiveAction {
      ...
      public ForkJoinQuickSortComp(byte[] var1, int var2, int var3, ByteComparator var4) {
         super();
         this.from = var2;
         this.to = var3;
         this.x = var1;
      ...
      protected void compute() {
         ...
         int var2 = this.to - this.from;
         if (var2 < 8192) {
            ByteArrays.quickSort(var1, this.from, this.to, this.comp);
         } else {
            int var3 = this.from + var2 / 2;
            int var4 = this.from;
            int var5 = this.to - 1;
            int var6 = var2 / 8;
            var4 = ByteArrays.med3(var1, var4, var4 + var6, var4 + 2 * var6, this.comp);
            var3 = ByteArrays.med3(var1, var3 - var6, var3, var3 + var6, this.comp);
            var5 = ByteArrays.med3(var1, var5 - 2 * var6, var5 - var6, var5, this.comp);
            var3 = ByteArrays.med3(var1, var4, var3, var5, this.comp);
            byte var7 = var1[var3];
            int var8 = this.from;
            int var9 = var8;
            int var10 = this.to - 1;
            ...
            while(true) {
               ...
               while(var9 > var10 || (var12 = this.comp.compare(var1[var9], var7)) > 0) {
                  ...
                  if (var9 > var10) {
                     ...
                     var12 = var11 - var10;
                     if (var6 > 1 && var12 > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSortComp(var1, this.from, this.from + var6, this.comp), new ByteArrays.ForkJoinQuickSortComp(var1, this.to - var12, this.to, this.comp));
                     } else if (var6 > 1) {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortComp(var1, this.from, this.from + var6, this.comp)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ByteArrays.ForkJoinQuickSortComp(var1, this.to - var12, this.to, this.comp)});
                     }
