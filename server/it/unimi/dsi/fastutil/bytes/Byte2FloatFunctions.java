...
public final class Byte2FloatFunctions {
   ...
   public static Byte2FloatFunction singleton(byte var0, float var1) {
      return new Byte2FloatFunctions.Singleton(var0, var1);
   }
   ...
   public static Byte2FloatFunction synchronize(Byte2FloatFunction var0) {
      return new Byte2FloatFunctions.SynchronizedFunction(var0);
   }

   public static Byte2FloatFunction synchronize(Byte2FloatFunction var0, Object var1) {
      return new Byte2FloatFunctions.SynchronizedFunction(var0, var1);
   }

   public static Byte2FloatFunction unmodifiable(Byte2FloatFunction var0) {
      return new Byte2FloatFunctions.UnmodifiableFunction(var0);
   }

   public static Byte2FloatFunction primitive(Function<? super Byte, ? extends Float> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Byte2FloatFunction) {
         return (Byte2FloatFunction)var0;
      } else {
         return (Byte2FloatFunction)(var0 instanceof IntToDoubleFunction ? (var1) -> {
            return SafeMath.safeDoubleToFloat(((IntToDoubleFunction)var0).applyAsDouble(var1));
         } : new Byte2FloatFunctions.PrimitiveFunction(var0));
      }
   }
   ...
   public static class PrimitiveFunction implements Byte2FloatFunction {
      ...
      protected PrimitiveFunction(Function<? super Byte, ? extends Float> var1) {
         super();
         this.function = var1;
      }
      ...
      public Float get(Object var1) {
         return var1 == null ? null : (Float)this.function.apply((Byte)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractByte2FloatFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Byte2FloatFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Byte2FloatFunction, Serializable {
      ...
      protected SynchronizedFunction(Byte2FloatFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Byte2FloatFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
