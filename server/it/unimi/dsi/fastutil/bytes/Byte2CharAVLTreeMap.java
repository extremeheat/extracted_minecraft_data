...
public class Byte2CharAVLTreeMap extends AbstractByte2CharSortedMap implements Serializable, Cloneable {
   ...
   public Byte2CharAVLTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2CharAVLTreeMap(Map<? extends Byte, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2CharAVLTreeMap(SortedMap<Byte, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2CharAVLTreeMap(Byte2CharMap var1) {
      this();
      this.putAll(var1);
   }

   public Byte2CharAVLTreeMap(Byte2CharSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2CharAVLTreeMap(byte[] var1, char[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2CharAVLTreeMap(byte[] var1, char[] var2) {
   ...
   final Byte2CharAVLTreeMap.Entry findKey(byte var1) {
      Byte2CharAVLTreeMap.Entry var2;
      int var3;
   ...
   final Byte2CharAVLTreeMap.Entry locateKey(byte var1) {
      Byte2CharAVLTreeMap.Entry var2 = this.tree;
      Byte2CharAVLTreeMap.Entry var3 = this.tree;
   ...
   public char addTo(byte var1, char var2) {
      Byte2CharAVLTreeMap.Entry var3 = this.add(var1);
   ...
   private Byte2CharAVLTreeMap.Entry add(byte var1) {
      this.modified = false;
      Byte2CharAVLTreeMap.Entry var2 = null;
      if (this.tree == null) {
         ++this.count;
         var2 = this.tree = this.lastEntry = this.firstEntry = new Byte2CharAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Byte2CharAVLTreeMap.Entry var3 = this.tree;
         Byte2CharAVLTreeMap.Entry var4 = null;
         Byte2CharAVLTreeMap.Entry var5 = this.tree;
         Byte2CharAVLTreeMap.Entry var6 = null;
         Byte2CharAVLTreeMap.Entry var7 = null;
         int var9 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var9++] = var8 > 0) {
               if (var3.succ()) {
                  ++this.count;
                  var2 = new Byte2CharAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var3.right == null) {
                     this.lastEntry = var2;
                  }
         ...
         Byte2CharAVLTreeMap.Entry var10;
         if (var5.balance() == -2) {
            var10 = var5.left;
            if (var10.balance() == -1) {
               var7 = var10;
   ...
   private Byte2CharAVLTreeMap.Entry parent(Byte2CharAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Byte2CharAVLTreeMap.Entry var3 = var1;

         Byte2CharAVLTreeMap.Entry var2;
         Byte2CharAVLTreeMap.Entry var4;
   ...
   public char remove(byte var1) {
      ...
      if (this.tree == null) {
         ...
         Byte2CharAVLTreeMap.Entry var7;
         Byte2CharAVLTreeMap.Entry var8;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var4 != null) {
                  if (var5) {
         ...
         while(var4 != null) {
            ...
            Byte2CharAVLTreeMap.Entry var9;
            if (!var5) {
   ...
   public boolean containsValue(char var1) {
      Byte2CharAVLTreeMap.ValueIterator var2 = new Byte2CharAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char get(byte var1) {
      Byte2CharAVLTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>() {
            final Comparator<? super Byte2CharMap.Entry> comparator = (var1x, var2) -> {
               return Byte2CharAVLTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry var1) {
               return Byte2CharAVLTreeMap.this.new EntryIterator(var1.getByteKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        Byte2CharAVLTreeMap.Entry var3 = Byte2CharAVLTreeMap.this.findKey((Byte)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        ...
                        if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                           Byte2CharAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry var1, Byte2CharMap.Entry var2) {
               return Byte2CharAVLTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2CharEntrySet();
            }

            public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry var1) {
               return Byte2CharAVLTreeMap.this.headMap(var1.getByteKey()).byte2CharEntrySet();
            }

            public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry var1) {
               return Byte2CharAVLTreeMap.this.tailMap(var1.getByteKey()).byte2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Byte2CharAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2CharSortedMap headMap(byte var1) {
      return new Byte2CharAVLTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2CharSortedMap tailMap(byte var1) {
      return new Byte2CharAVLTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2CharSortedMap subMap(byte var1, byte var2) {
      return new Byte2CharAVLTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2CharAVLTreeMap clone() {
      Byte2CharAVLTreeMap var1;
      try {
         var1 = (Byte2CharAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2CharAVLTreeMap.Entry var5 = new Byte2CharAVLTreeMap.Entry();
         Byte2CharAVLTreeMap.Entry var6 = new Byte2CharAVLTreeMap.Entry();
         Byte2CharAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2CharAVLTreeMap.Entry var4 = var6;
         var6.pred((Byte2CharAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2CharAVLTreeMap.EntryIterator var3 = new Byte2CharAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2CharAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2CharAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Byte2CharAVLTreeMap.Entry var3, Byte2CharAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Byte2CharAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2CharAVLTreeMap.Entry(var1.readByte(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Byte2CharAVLTreeMap.Entry(var1.readByte(), var1.readChar());
         var8.right(new Byte2CharAVLTreeMap.Entry(var1.readByte(), var1.readChar()));
         ...
         Byte2CharAVLTreeMap.Entry var7 = new Byte2CharAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2CharAVLTreeMap.Entry)null, (Byte2CharAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2CharSortedMap implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2CharAVLTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2CharAVLTreeMap.Submap.SubmapIterator var1 = new Byte2CharAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2CharAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2CharAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2CharAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Byte2CharAVLTreeMap.Submap.SubmapIterator var2 = new Byte2CharAVLTreeMap.Submap.SubmapIterator();
      ...
      public char get(byte var1) {
         Byte2CharAVLTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2CharAVLTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public char put(byte var1, char var2) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Byte2CharAVLTreeMap.this.put(var1, var2);
            return Byte2CharAVLTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public char remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var2 = Byte2CharAVLTreeMap.this.remove(var1);
            return Byte2CharAVLTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Byte2CharSortedMap headMap(byte var1) {
         if (this.top) {
            return Byte2CharAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2CharAVLTreeMap.this.compare(var1, this.to) < 0 ? Byte2CharAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2CharSortedMap tailMap(byte var1) {
         if (this.bottom) {
            return Byte2CharAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2CharAVLTreeMap.this.compare(var1, this.from) > 0 ? Byte2CharAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2CharSortedMap subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2CharAVLTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2CharAVLTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2CharAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2CharAVLTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Byte2CharAVLTreeMap.Entry firstEntry() {
         if (Byte2CharAVLTreeMap.this.tree == null) {
            ...
            Byte2CharAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2CharAVLTreeMap.this.firstEntry;
            } else {
               var1 = Byte2CharAVLTreeMap.this.locateKey(this.from);
               if (Byte2CharAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2CharAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Byte2CharAVLTreeMap.Entry lastEntry() {
         if (Byte2CharAVLTreeMap.this.tree == null) {
            ...
            Byte2CharAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2CharAVLTreeMap.this.lastEntry;
            } else {
               var1 = Byte2CharAVLTreeMap.this.locateKey(this.to);
               if (Byte2CharAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2CharAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2CharAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2CharAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Byte2CharAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2CharMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2CharAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2CharAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2CharAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2CharAVLTreeMap.this.locateKey(var2);
                  if (Byte2CharAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractByte2CharSortedMap.KeySet {
      ...
      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2CharAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Byte2CharAVLTreeMap.TreeIterator implements ObjectListIterator<Byte2CharMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Byte2CharMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Byte2CharMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2CharAVLTreeMap.this.locateKey(var2)) != null) {
            if (Byte2CharAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractByte2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Byte2CharAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2CharAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2CharAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2CharAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2CharAVLTreeMap.Entry next() {
         Byte2CharAVLTreeMap.Entry var1 = this.right;
      ...
      Byte2CharAVLTreeMap.Entry prev() {
         Byte2CharAVLTreeMap.Entry var1 = this.left;
      ...
      public Byte2CharAVLTreeMap.Entry clone() {
         Byte2CharAVLTreeMap.Entry var1;
         try {
            var1 = (Byte2CharAVLTreeMap.Entry)super.clone();
