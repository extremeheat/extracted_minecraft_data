...
public class ByteOpenHashSet extends AbstractByteSet implements Serializable, Cloneable, Hash {
   ...
   public ByteOpenHashSet(int var1, float var2) {
      super();
   ...
   public ByteOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public ByteOpenHashSet(Collection<? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ByteOpenHashSet(Collection<? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public ByteOpenHashSet(ByteCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ByteOpenHashSet(ByteCollection var1) {
      this(var1, 0.75F);
   }

   public ByteOpenHashSet(ByteIterator var1, float var2) {
      this(16, var2);
   ...
   public ByteOpenHashSet(ByteIterator var1) {
      this(var1, 0.75F);
   }

   public ByteOpenHashSet(Iterator<?> var1, float var2) {
      this(ByteIterators.asByteIterator(var1), var2);
   }

   public ByteOpenHashSet(Iterator<?> var1) {
      this(ByteIterators.asByteIterator(var1));
   }

   public ByteOpenHashSet(byte[] var1, int var2, int var3, float var4) {
   ...
   public ByteOpenHashSet(byte[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public ByteOpenHashSet(byte[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public ByteOpenHashSet(byte[] var1) {
      this(var1, 0.75F);
   }
   ...
   public ByteOpenHashSet clone() {
      ByteOpenHashSet var1;
      try {
         var1 = (ByteOpenHashSet)super.clone();
   ...
   private class SetIterator implements ByteIterator {
      ...
      public byte nextByte() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNull) {
               ...
               byte[] var1 = ByteOpenHashSet.this.key;
      ...
      private final void shiftKeys(int var1) {
         byte[] var5 = ByteOpenHashSet.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & ByteOpenHashSet.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & ByteOpenHashSet.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
