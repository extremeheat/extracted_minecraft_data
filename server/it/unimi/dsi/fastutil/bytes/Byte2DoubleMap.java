...
public interface Byte2DoubleMap extends Byte2DoubleFunction, Map<Byte, Double> {
   ...
   default Double put(Byte var1, Double var2) {
      return Byte2DoubleFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double get(Object var1) {
      return Byte2DoubleFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Double remove(Object var1) {
      return Byte2DoubleFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Byte2DoubleFunction.super.containsKey(var1);
   }
   ...
   default double getOrDefault(byte var1, double var2) {
      double var4;
      return (var4 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var4;
   }

   default double putIfAbsent(byte var1, double var2) {
   ...
   default boolean remove(byte var1, double var2) {
      double var4 = this.get(var1);
   ...
   default boolean replace(byte var1, double var2, double var4) {
   ...
   default double replace(byte var1, double var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default double computeIfAbsent(byte var1, IntToDoubleFunction var2) {
   ...
   default double computeIfAbsentNullable(byte var1, IntFunction<? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
   ...
   default double computeIfAbsentPartial(byte var1, Byte2DoubleFunction var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default double computeIfPresent(byte var1, BiFunction<? super Byte, ? super Double, ? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
      if (var3 == var5 && !this.containsKey(var1)) {
   ...
   default double compute(byte var1, BiFunction<? super Byte, ? super Double, ? extends Double> var2) {
      Objects.requireNonNull(var2);
      double var3 = this.get(var1);
      double var5 = this.defaultReturnValue();
   ...
   default double merge(byte var1, double var2, BiFunction<? super Double, ? super Double, ? extends Double> var4) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Byte var1, Double var2, Double var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Double computeIfAbsent(Byte var1, Function<? super Byte, ? extends Double> var2) {
   ...
   /** @deprecated */
   @Deprecated
   default Double merge(Byte var1, Double var2, BiFunction<? super Double, ? super Double, ? extends Double> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Byte2DoubleMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Byte2DoubleMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
