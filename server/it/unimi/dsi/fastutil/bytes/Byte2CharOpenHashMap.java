...
public class Byte2CharOpenHashMap extends AbstractByte2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2CharOpenHashMap(int var1, float var2) {
      super();
   ...
   public Byte2CharOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Byte2CharOpenHashMap(Map<? extends Byte, ? extends Character> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2CharOpenHashMap(Map<? extends Byte, ? extends Character> var1) {
      this(var1, 0.75F);
   }

   public Byte2CharOpenHashMap(Byte2CharMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2CharOpenHashMap(Byte2CharMap var1) {
      this(var1, 0.75F);
   }

   public Byte2CharOpenHashMap(byte[] var1, char[] var2, float var3) {
   ...
   public Byte2CharOpenHashMap(byte[] var1, char[] var2) {
   ...
   public Byte2CharMap.FastEntrySet byte2CharEntrySet() {
      if (this.entries == null) {
         this.entries = new Byte2CharOpenHashMap.MapEntrySet();
      }
   ...
   public ByteSet keySet() {
      if (this.keys == null) {
         this.keys = new Byte2CharOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            public CharIterator iterator() {
               return Byte2CharOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(char var1) {
               return Byte2CharOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Byte2CharOpenHashMap.this.containsNullKey) {
                  var1.accept(Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n]);
               }

               int var2 = Byte2CharOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2CharOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2CharOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2CharOpenHashMap clone() {
      Byte2CharOpenHashMap var1;
      try {
         var1 = (Byte2CharOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      char[] var3 = this.value;
      Byte2CharOpenHashMap.MapIterator var4 = new Byte2CharOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Byte2CharOpenHashMap.MapIterator implements CharIterator {
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteIterator iterator() {
         return Byte2CharOpenHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Byte2CharOpenHashMap.this.containsNullKey) {
            var1.accept(Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.n]);
         }

         int var2 = Byte2CharOpenHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2CharOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2CharOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2CharOpenHashMap.this.size;
         Byte2CharOpenHashMap.this.remove(var1);
         return Byte2CharOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Byte2CharOpenHashMap.MapIterator implements ByteIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry> implements Byte2CharMap.FastEntrySet {
      ...
      public ObjectIterator<Byte2CharMap.Entry> iterator() {
         return Byte2CharOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Byte2CharMap.Entry> fastIterator() {
         return Byte2CharOpenHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (var3 == 0) {
                     return Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n] == var4;
                  } else {
                     byte[] var6 = Byte2CharOpenHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2CharOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Byte2CharOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2CharOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Byte2CharOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var4 = (Character)var2.getValue();
                  if (var3 == 0) {
                     if (Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2CharOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Byte2CharOpenHashMap.this.value[var7] == var4) {
                           Byte2CharOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2CharOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Byte2CharOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2CharMap.Entry> var1) {
         if (Byte2CharOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.n], Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2CharOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenHashMap.this.key[var2], Byte2CharOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2CharMap.Entry> var1) {
         ...
         if (Byte2CharOpenHashMap.this.containsNullKey) {
            var2.key = Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.n];
            var2.value = Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2CharOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2CharOpenHashMap.this.key[var3] != 0) {
               var2.key = Byte2CharOpenHashMap.this.key[var3];
               var2.value = Byte2CharOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2CharOpenHashMap.MapIterator implements ObjectIterator<Byte2CharMap.Entry> {
      private final Byte2CharOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2CharOpenHashMap.this.new MapEntry();
      }

      public Byte2CharOpenHashMap.MapEntry next() {
   ...
   private class EntryIterator extends Byte2CharOpenHashMap.MapIterator implements ObjectIterator<Byte2CharMap.Entry> {
      ...
      public Byte2CharOpenHashMap.MapEntry next() {
         return this.entry = Byte2CharOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2CharOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Byte2CharOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Byte2CharOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2CharOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2CharOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Byte2CharOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2CharOpenHashMap.this.value[var2] = Byte2CharOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2CharMap.Entry, java.util.Map.Entry<Byte, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Byte2CharOpenHashMap.this.value[this.index];
         Byte2CharOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2CharOpenHashMap.this.key[this.index] == (Byte)var2.getKey() && Byte2CharOpenHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
