...
public class Byte2LongRBTreeMap extends AbstractByte2LongSortedMap implements Serializable, Cloneable {
   protected transient Byte2LongRBTreeMap.Entry tree;
   protected int count;
   protected transient Byte2LongRBTreeMap.Entry firstEntry;
   protected transient Byte2LongRBTreeMap.Entry lastEntry;
   ...
   private transient Byte2LongRBTreeMap.Entry[] nodePath;
   ...
   public Byte2LongRBTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2LongRBTreeMap(Map<? extends Byte, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2LongRBTreeMap(SortedMap<Byte, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2LongRBTreeMap(Byte2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Byte2LongRBTreeMap(Byte2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2LongRBTreeMap(byte[] var1, long[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2LongRBTreeMap(byte[] var1, long[] var2) {
   ...
   final Byte2LongRBTreeMap.Entry findKey(byte var1) {
      Byte2LongRBTreeMap.Entry var2;
      int var3;
   ...
   final Byte2LongRBTreeMap.Entry locateKey(byte var1) {
      Byte2LongRBTreeMap.Entry var2 = this.tree;
      Byte2LongRBTreeMap.Entry var3 = this.tree;
   ...
   private void allocatePaths() {
      ...
      this.nodePath = new Byte2LongRBTreeMap.Entry[64];
   }

   public long addTo(byte var1, long var2) {
      Byte2LongRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Byte2LongRBTreeMap.Entry add(byte var1) {
      this.modified = false;
      int var2 = 0;
      Byte2LongRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Byte2LongRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Byte2LongRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Byte2LongRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Byte2LongRBTreeMap.Entry var7;
               Byte2LongRBTreeMap.Entry var8;
   ...
   public boolean containsValue(long var1) {
      Byte2LongRBTreeMap.ValueIterator var3 = new Byte2LongRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(byte var1) {
      Byte2LongRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() {
            final Comparator<? super Byte2LongMap.Entry> comparator = (var1x, var2) -> {
               return Byte2LongRBTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator() {
               return Byte2LongRBTreeMap.this.new EntryIterator();
            }

            public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry var1) {
               return Byte2LongRBTreeMap.this.new EntryIterator(var1.getByteKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Byte2LongRBTreeMap.Entry var3 = Byte2LongRBTreeMap.this.findKey((Byte)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Byte2LongRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry var1, Byte2LongMap.Entry var2) {
               return Byte2LongRBTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2LongEntrySet();
            }

            public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry var1) {
               return Byte2LongRBTreeMap.this.headMap(var1.getByteKey()).byte2LongEntrySet();
            }

            public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry var1) {
               return Byte2LongRBTreeMap.this.tailMap(var1.getByteKey()).byte2LongEntrySet();
            }
         };
      }
   ...
   public ByteSortedSet keySet() {
      if (this.keys == null) {
         this.keys = new Byte2LongRBTreeMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            public LongIterator iterator() {
               return Byte2LongRBTreeMap.this.new ValueIterator();
            }

            public boolean contains(long var1) {
               return Byte2LongRBTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2LongSortedMap headMap(byte var1) {
      return new Byte2LongRBTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2LongSortedMap tailMap(byte var1) {
      return new Byte2LongRBTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2LongSortedMap subMap(byte var1, byte var2) {
      return new Byte2LongRBTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2LongRBTreeMap clone() {
      Byte2LongRBTreeMap var1;
      try {
         var1 = (Byte2LongRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2LongRBTreeMap.Entry var5 = new Byte2LongRBTreeMap.Entry();
         Byte2LongRBTreeMap.Entry var6 = new Byte2LongRBTreeMap.Entry();
         Byte2LongRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2LongRBTreeMap.Entry var4 = var6;
         var6.pred((Byte2LongRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2LongRBTreeMap.EntryIterator var3 = new Byte2LongRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2LongRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2LongRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Byte2LongRBTreeMap.Entry var3, Byte2LongRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Byte2LongRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2LongRBTreeMap.Entry(var1.readByte(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Byte2LongRBTreeMap.Entry(var1.readByte(), var1.readLong());
         var8.black(true);
         var8.right(new Byte2LongRBTreeMap.Entry(var1.readByte(), var1.readLong()));
         ...
         Byte2LongRBTreeMap.Entry var7 = new Byte2LongRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2LongRBTreeMap.Entry)null, (Byte2LongRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2LongSortedMap implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2LongRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2LongRBTreeMap.Submap.SubmapIterator var1 = new Byte2LongRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2LongRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2LongRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ByteSortedSet keySet() {
         if (this.keys == null) {
            this.keys = new Byte2LongRBTreeMap.Submap.KeySet();
         }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2LongRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Byte2LongRBTreeMap.Submap.SubmapIterator var3 = new Byte2LongRBTreeMap.Submap.SubmapIterator();
      ...
      public long get(byte var1) {
         Byte2LongRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2LongRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public long put(byte var1, long var2) {
         ...
         if (!this.in(var1)) {
            ...
            long var4 = Byte2LongRBTreeMap.this.put(var1, var2);
            return Byte2LongRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public long remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var2 = Byte2LongRBTreeMap.this.remove(var1);
            return Byte2LongRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public boolean isEmpty() {
         return !(new Byte2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
      }
      ...
      public Byte2LongSortedMap headMap(byte var1) {
         if (this.top) {
            return Byte2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2LongRBTreeMap.this.compare(var1, this.to) < 0 ? Byte2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2LongSortedMap tailMap(byte var1) {
         if (this.bottom) {
            return Byte2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2LongRBTreeMap.this.compare(var1, this.from) > 0 ? Byte2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2LongSortedMap subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2LongRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2LongRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2LongRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Byte2LongRBTreeMap.Entry firstEntry() {
         if (Byte2LongRBTreeMap.this.tree == null) {
            ...
            Byte2LongRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2LongRBTreeMap.this.firstEntry;
            } else {
               var1 = Byte2LongRBTreeMap.this.locateKey(this.from);
               if (Byte2LongRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2LongRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Byte2LongRBTreeMap.Entry lastEntry() {
         if (Byte2LongRBTreeMap.this.tree == null) {
            ...
            Byte2LongRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2LongRBTreeMap.this.lastEntry;
            } else {
               var1 = Byte2LongRBTreeMap.this.locateKey(this.to);
               if (Byte2LongRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2LongRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2LongRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2LongRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private final class SubmapValueIterator extends Byte2LongRBTreeMap.Submap.SubmapIterator implements LongListIterator {
      ...
      private final class SubmapKeyIterator extends Byte2LongRBTreeMap.Submap.SubmapIterator implements ByteListIterator {
      ...
      private class SubmapEntryIterator extends Byte2LongRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2LongRBTreeMap.TreeIterator {
         SubmapIterator() {
            super();
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2LongRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2LongRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2LongRBTreeMap.this.locateKey(var2);
                  if (Byte2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private final class ValueIterator extends Byte2LongRBTreeMap.TreeIterator implements LongListIterator {
   ...
   private class KeySet extends AbstractByte2LongSortedMap.KeySet {
      ...
      public ByteBidirectionalIterator iterator() {
         return Byte2LongRBTreeMap.this.new KeyIterator();
      }

      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2LongRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private final class KeyIterator extends Byte2LongRBTreeMap.TreeIterator implements ByteListIterator {
      public KeyIterator() {
         super();
      }
   ...
   private class EntryIterator extends Byte2LongRBTreeMap.TreeIterator implements ObjectListIterator<Byte2LongMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2LongRBTreeMap.this.locateKey(var2)) != null) {
            if (Byte2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractByte2LongMap.BasicEntry implements Cloneable {
      ...
      Byte2LongRBTreeMap.Entry left;
      Byte2LongRBTreeMap.Entry right;
      int info;
      ...
      void pred(Byte2LongRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2LongRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2LongRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2LongRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2LongRBTreeMap.Entry next() {
         Byte2LongRBTreeMap.Entry var1 = this.right;
      ...
      Byte2LongRBTreeMap.Entry prev() {
         Byte2LongRBTreeMap.Entry var1 = this.left;
      ...
      public Byte2LongRBTreeMap.Entry clone() {
         Byte2LongRBTreeMap.Entry var1;
         try {
            var1 = (Byte2LongRBTreeMap.Entry)super.clone();
