...
public class Byte2DoubleOpenHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2DoubleOpenHashMap(int var1, float var2) {
      super();
   ...
   public Byte2DoubleOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Byte2DoubleOpenHashMap(Map<? extends Byte, ? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2DoubleOpenHashMap(Map<? extends Byte, ? extends Double> var1) {
      this(var1, 0.75F);
   }

   public Byte2DoubleOpenHashMap(Byte2DoubleMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2DoubleOpenHashMap(Byte2DoubleMap var1) {
      this(var1, 0.75F);
   }

   public Byte2DoubleOpenHashMap(byte[] var1, double[] var2, float var3) {
   ...
   public Byte2DoubleOpenHashMap(byte[] var1, double[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Byte2DoubleOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Byte2DoubleOpenHashMap.this.containsNullKey) {
                  var1.accept(Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]);
               }

               int var2 = Byte2DoubleOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2DoubleOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2DoubleOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2DoubleOpenHashMap clone() {
      Byte2DoubleOpenHashMap var1;
      try {
         var1 = (Byte2DoubleOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      double[] var3 = this.value;
      Byte2DoubleOpenHashMap.MapIterator var4 = new Byte2DoubleOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(Byte2DoubleOpenHashMap.this.key[Byte2DoubleOpenHashMap.this.n]);
         }

         int var2 = Byte2DoubleOpenHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2DoubleOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2DoubleOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2DoubleOpenHashMap.this.size;
         Byte2DoubleOpenHashMap.this.remove(var1);
         return Byte2DoubleOpenHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (var3 == 0) {
                     return Byte2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4);
                  } else {
                     byte[] var7 = Byte2DoubleOpenHashMap.this.key;
                     byte var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Byte2DoubleOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var6) {
                        return Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Byte2DoubleOpenHashMap.this.mask]) != 0) {
                           if (var3 == var6) {
                              return Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var4 = (Double)var2.getValue();
                  if (var3 == 0) {
                     if (Byte2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(var3) & Byte2DoubleOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                           Byte2DoubleOpenHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Byte2DoubleOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var6 != var3 || Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Byte2DoubleMap.Entry> var1) {
         if (Byte2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleOpenHashMap.this.key[Byte2DoubleOpenHashMap.this.n], Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2DoubleOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleOpenHashMap.this.key[var2], Byte2DoubleOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> var1) {
         ...
         if (Byte2DoubleOpenHashMap.this.containsNullKey) {
            var2.key = Byte2DoubleOpenHashMap.this.key[Byte2DoubleOpenHashMap.this.n];
            var2.value = Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2DoubleOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2DoubleOpenHashMap.this.key[var3] != 0) {
               var2.key = Byte2DoubleOpenHashMap.this.key[var3];
               var2.value = Byte2DoubleOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2DoubleOpenHashMap.MapIterator implements ObjectIterator<Byte2DoubleMap.Entry> {
      private final Byte2DoubleOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2DoubleOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2DoubleOpenHashMap.MapIterator implements ObjectIterator<Byte2DoubleMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2DoubleOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Byte2DoubleOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Byte2DoubleOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2DoubleOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2DoubleOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Byte2DoubleOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2DoubleOpenHashMap.this.value[var2] = Byte2DoubleOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2DoubleMap.Entry, java.util.Map.Entry<Byte, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Byte2DoubleOpenHashMap.this.value[this.index];
         Byte2DoubleOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2DoubleOpenHashMap.this.key[this.index] == (Byte)var2.getKey() && Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
