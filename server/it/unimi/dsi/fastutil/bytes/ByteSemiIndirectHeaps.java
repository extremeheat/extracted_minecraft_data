...
public final class ByteSemiIndirectHeaps {
   ...
   public static int downHeap(byte[] var0, int[] var1, int var2, int var3, ByteComparator var4) {
      assert var3 < var2;
   ...
   public static int upHeap(byte[] var0, int[] var1, int var2, int var3, ByteComparator var4) {
      assert var3 < var2;
   ...
   public static void makeHeap(byte[] var0, int var1, int var2, int[] var3, ByteComparator var4) {
   ...
   public static int[] makeHeap(byte[] var0, int var1, int var2, ByteComparator var3) {
      int[] var4 = var2 <= 0 ? IntArrays.EMPTY_ARRAY : new int[var2];
      makeHeap(var0, var1, var2, var4, var3);
      return var4;
   }

   public static void makeHeap(byte[] var0, int[] var1, int var2, ByteComparator var3) {
      int var4 = var2 >>> 1;
   ...
   public static int front(byte[] var0, int[] var1, int var2, int[] var3) {
   ...
   public static int front(byte[] var0, int[] var1, int var2, int[] var3, ByteComparator var4) {
