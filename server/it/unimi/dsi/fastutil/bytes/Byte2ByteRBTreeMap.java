...
public class Byte2ByteRBTreeMap extends AbstractByte2ByteSortedMap implements Serializable, Cloneable {
   ...
   public Byte2ByteRBTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2ByteRBTreeMap(Map<? extends Byte, ? extends Byte> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2ByteRBTreeMap(SortedMap<Byte, Byte> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2ByteRBTreeMap(Byte2ByteMap var1) {
      this();
      this.putAll(var1);
   }

   public Byte2ByteRBTreeMap(Byte2ByteSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2ByteRBTreeMap(byte[] var1, byte[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2ByteRBTreeMap(byte[] var1, byte[] var2) {
   ...
   final Byte2ByteRBTreeMap.Entry findKey(byte var1) {
      Byte2ByteRBTreeMap.Entry var2;
      int var3;
   ...
   final Byte2ByteRBTreeMap.Entry locateKey(byte var1) {
      Byte2ByteRBTreeMap.Entry var2 = this.tree;
      Byte2ByteRBTreeMap.Entry var3 = this.tree;
   ...
   public byte addTo(byte var1, byte var2) {
      Byte2ByteRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Byte2ByteRBTreeMap.Entry add(byte var1) {
      this.modified = false;
      int var2 = 0;
      Byte2ByteRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Byte2ByteRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Byte2ByteRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Byte2ByteRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Byte2ByteRBTreeMap.Entry var7;
               Byte2ByteRBTreeMap.Entry var8;
   ...
   public boolean containsValue(byte var1) {
      Byte2ByteRBTreeMap.ValueIterator var2 = new Byte2ByteRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public byte get(byte var1) {
      Byte2ByteRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
            final Comparator<? super Byte2ByteMap.Entry> comparator = (var1x, var2) -> {
               return Byte2ByteRBTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry var1) {
               return Byte2ByteRBTreeMap.this.new EntryIterator(var1.getByteKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        Byte2ByteRBTreeMap.Entry var3 = Byte2ByteRBTreeMap.this.findKey((Byte)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        ...
                        if (var3 != null && var3.getByteValue() == (Byte)var2.getValue()) {
                           Byte2ByteRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry var1, Byte2ByteMap.Entry var2) {
               return Byte2ByteRBTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2ByteEntrySet();
            }

            public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry var1) {
               return Byte2ByteRBTreeMap.this.headMap(var1.getByteKey()).byte2ByteEntrySet();
            }

            public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry var1) {
               return Byte2ByteRBTreeMap.this.tailMap(var1.getByteKey()).byte2ByteEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Byte2ByteRBTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2ByteSortedMap headMap(byte var1) {
      return new Byte2ByteRBTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2ByteSortedMap tailMap(byte var1) {
      return new Byte2ByteRBTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2ByteSortedMap subMap(byte var1, byte var2) {
      return new Byte2ByteRBTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2ByteRBTreeMap clone() {
      Byte2ByteRBTreeMap var1;
      try {
         var1 = (Byte2ByteRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2ByteRBTreeMap.Entry var5 = new Byte2ByteRBTreeMap.Entry();
         Byte2ByteRBTreeMap.Entry var6 = new Byte2ByteRBTreeMap.Entry();
         Byte2ByteRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2ByteRBTreeMap.Entry var4 = var6;
         var6.pred((Byte2ByteRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2ByteRBTreeMap.EntryIterator var3 = new Byte2ByteRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2ByteRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2ByteRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Byte2ByteRBTreeMap.Entry var3, Byte2ByteRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Byte2ByteRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2ByteRBTreeMap.Entry(var1.readByte(), var1.readByte());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Byte2ByteRBTreeMap.Entry(var1.readByte(), var1.readByte());
         var8.black(true);
         var8.right(new Byte2ByteRBTreeMap.Entry(var1.readByte(), var1.readByte()));
         ...
         Byte2ByteRBTreeMap.Entry var7 = new Byte2ByteRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2ByteRBTreeMap.Entry)null, (Byte2ByteRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2ByteSortedMap implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2ByteRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2ByteRBTreeMap.Submap.SubmapIterator var1 = new Byte2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2ByteRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2ByteRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2ByteRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(byte var1) {
         Byte2ByteRBTreeMap.Submap.SubmapIterator var2 = new Byte2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      public byte get(byte var1) {
         Byte2ByteRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2ByteRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public byte put(byte var1, byte var2) {
         ...
         if (!this.in(var1)) {
            ...
            byte var3 = Byte2ByteRBTreeMap.this.put(var1, var2);
            return Byte2ByteRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public byte remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            byte var2 = Byte2ByteRBTreeMap.this.remove(var1);
            return Byte2ByteRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Byte2ByteSortedMap headMap(byte var1) {
         if (this.top) {
            return Byte2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2ByteRBTreeMap.this.compare(var1, this.to) < 0 ? Byte2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2ByteSortedMap tailMap(byte var1) {
         if (this.bottom) {
            return Byte2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? Byte2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2ByteSortedMap subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2ByteRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2ByteRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2ByteRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Byte2ByteRBTreeMap.Entry firstEntry() {
         if (Byte2ByteRBTreeMap.this.tree == null) {
            ...
            Byte2ByteRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2ByteRBTreeMap.this.firstEntry;
            } else {
               var1 = Byte2ByteRBTreeMap.this.locateKey(this.from);
               if (Byte2ByteRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2ByteRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Byte2ByteRBTreeMap.Entry lastEntry() {
         if (Byte2ByteRBTreeMap.this.tree == null) {
            ...
            Byte2ByteRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2ByteRBTreeMap.this.lastEntry;
            } else {
               var1 = Byte2ByteRBTreeMap.this.locateKey(this.to);
               if (Byte2ByteRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2ByteRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2ByteRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2ByteRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Byte2ByteRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2ByteMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2ByteRBTreeMap.TreeIterator {
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2ByteRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2ByteRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2ByteRBTreeMap.this.locateKey(var2);
                  if (Byte2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractByte2ByteSortedMap.KeySet {
      ...
      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2ByteRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Byte2ByteRBTreeMap.TreeIterator implements ObjectListIterator<Byte2ByteMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2ByteRBTreeMap.this.locateKey(var2)) != null) {
            if (Byte2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractByte2ByteMap.BasicEntry implements Cloneable {
      ...
      void pred(Byte2ByteRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2ByteRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2ByteRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2ByteRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2ByteRBTreeMap.Entry next() {
         Byte2ByteRBTreeMap.Entry var1 = this.right;
      ...
      Byte2ByteRBTreeMap.Entry prev() {
         Byte2ByteRBTreeMap.Entry var1 = this.left;
      ...
      public Byte2ByteRBTreeMap.Entry clone() {
         Byte2ByteRBTreeMap.Entry var1;
         try {
            var1 = (Byte2ByteRBTreeMap.Entry)super.clone();
