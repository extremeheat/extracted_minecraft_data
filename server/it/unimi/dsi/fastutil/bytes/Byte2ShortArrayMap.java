...
public class Byte2ShortArrayMap extends AbstractByte2ShortMap implements Serializable, Cloneable {
   ...
   public Byte2ShortArrayMap(byte[] var1, short[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Byte2ShortArrayMap(int var1) {
      super();
      this.key = new byte[var1];
      this.value = new short[var1];
   }

   public Byte2ShortArrayMap(Byte2ShortMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2ShortArrayMap(Map<? extends Byte, ? extends Short> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2ShortArrayMap(byte[] var1, short[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ByteSet keySet() {
      return new AbstractByteSet() {
         public boolean contains(byte var1) {
            return Byte2ShortArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(byte var1) {
            int var2 = Byte2ShortArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Byte2ShortArrayMap.this.size - var2 - 1;
               System.arraycopy(Byte2ShortArrayMap.this.key, var2 + 1, Byte2ShortArrayMap.this.key, var2, var3);
               System.arraycopy(Byte2ShortArrayMap.this.value, var2 + 1, Byte2ShortArrayMap.this.value, var2, var3);
            ...
            return new ByteIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Byte2ShortArrayMap.this.size - this.pos;
                     System.arraycopy(Byte2ShortArrayMap.this.key, this.pos, Byte2ShortArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Byte2ShortArrayMap.this.value, this.pos, Byte2ShortArrayMap.this.value, this.pos - 1, var1);
                     Byte2ShortArrayMap.this.size--;
                  }
               }
            };
   ...
   public ShortCollection values() {
      return new AbstractShortCollection() {
         public boolean contains(short var1) {
            return Byte2ShortArrayMap.this.containsValue(var1);
         }
   ...
   public Byte2ShortArrayMap clone() {
      Byte2ShortArrayMap var1;
      try {
         var1 = (Byte2ShortArrayMap)super.clone();
         ...
         return new ObjectIterator<Byte2ShortMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Byte2ShortArrayMap.this.size-- - this.next--;
                  System.arraycopy(Byte2ShortArrayMap.this.key, this.next + 1, Byte2ShortArrayMap.this.key, this.next, var1);
                  System.arraycopy(Byte2ShortArrayMap.this.value, this.next + 1, Byte2ShortArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  return Byte2ShortArrayMap.this.containsKey(var3) && Byte2ShortArrayMap.this.get(var3) == (Short)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  int var5 = Byte2ShortArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Byte2ShortArrayMap.this.value[var5]) {
                     int var6 = Byte2ShortArrayMap.this.size - var5 - 1;
                     System.arraycopy(Byte2ShortArrayMap.this.key, var5 + 1, Byte2ShortArrayMap.this.key, var5, var6);
                     System.arraycopy(Byte2ShortArrayMap.this.value, var5 + 1, Byte2ShortArrayMap.this.value, var5, var6);
                     Byte2ShortArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
