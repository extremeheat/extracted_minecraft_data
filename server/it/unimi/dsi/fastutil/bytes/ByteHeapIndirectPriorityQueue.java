...
public class ByteHeapIndirectPriorityQueue extends ByteHeapSemiIndirectPriorityQueue {
   ...
   public ByteHeapIndirectPriorityQueue(byte[] var1, int var2, ByteComparator var3) {
   ...
   public ByteHeapIndirectPriorityQueue(byte[] var1, int var2) {
      this(var1, var2, (ByteComparator)null);
   }

   public ByteHeapIndirectPriorityQueue(byte[] var1, ByteComparator var2) {
      this(var1, var1.length, var2);
   }

   public ByteHeapIndirectPriorityQueue(byte[] var1) {
      this(var1, var1.length, (ByteComparator)null);
   }

   public ByteHeapIndirectPriorityQueue(byte[] var1, int[] var2, int var3, ByteComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      ...
      ByteIndirectHeaps.makeHeap(var1, var2, this.inv, var3, var4);
   }
   ...
   public ByteHeapIndirectPriorityQueue(byte[] var1, int[] var2, int var3) {
   ...
   public void changed(int var1) {
      ...
      if (var2 < 0) {
         ...
         int var3 = ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, var2, this.c);
         ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, var3, this.c);
      }
   }
