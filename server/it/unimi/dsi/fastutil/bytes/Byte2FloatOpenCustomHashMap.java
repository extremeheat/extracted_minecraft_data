...
public class Byte2FloatOpenCustomHashMap extends AbstractByte2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2FloatOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2FloatOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2FloatOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2FloatOpenCustomHashMap(Map<? extends Byte, ? extends Float> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2FloatOpenCustomHashMap(Map<? extends Byte, ? extends Float> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2FloatOpenCustomHashMap(Byte2FloatMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2FloatOpenCustomHashMap(Byte2FloatMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2FloatOpenCustomHashMap(byte[] var1, float[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2FloatOpenCustomHashMap(byte[] var1, float[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Byte2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2FloatOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept((double)Byte2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2FloatOpenCustomHashMap clone() {
      Byte2FloatOpenCustomHashMap var1;
      try {
         var1 = (Byte2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      float[] var3 = this.value;
      Byte2FloatOpenCustomHashMap.MapIterator var4 = new Byte2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2FloatOpenCustomHashMap.this.key[Byte2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2FloatOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2FloatOpenCustomHashMap.this.size;
         Byte2FloatOpenCustomHashMap.this.remove(var1);
         return Byte2FloatOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> implements Byte2FloatMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Byte2FloatOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4);
                  } else {
                     byte[] var6 = Byte2FloatOpenCustomHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2FloatOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2FloatOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var4 = (Float)var2.getValue();
                  if (Byte2FloatOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var4)) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2FloatOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2FloatOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[var7]) == Float.floatToIntBits(var4)) {
                           Byte2FloatOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2FloatOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2FloatOpenCustomHashMap.this.strategy.equals(var5, var3) || Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[var7]) != Float.floatToIntBits(var4));
      ...
      public void forEach(Consumer<? super Byte2FloatMap.Entry> var1) {
         if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2FloatMap.BasicEntry(Byte2FloatOpenCustomHashMap.this.key[Byte2FloatOpenCustomHashMap.this.n], Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2FloatOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2FloatMap.BasicEntry(Byte2FloatOpenCustomHashMap.this.key[var2], Byte2FloatOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2FloatMap.Entry> var1) {
         ...
         if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2FloatOpenCustomHashMap.this.key[Byte2FloatOpenCustomHashMap.this.n];
            var2.value = Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2FloatOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Byte2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2FloatMap.Entry> {
      private final Byte2FloatOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2FloatMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2FloatOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2FloatOpenCustomHashMap.this.mask; !Byte2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2FloatOpenCustomHashMap.this.value[var2] = Byte2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2FloatMap.Entry, java.util.Map.Entry<Byte, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Byte2FloatOpenCustomHashMap.this.value[this.index];
         Byte2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
