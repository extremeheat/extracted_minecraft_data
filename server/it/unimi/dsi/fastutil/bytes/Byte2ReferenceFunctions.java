...
public final class Byte2ReferenceFunctions {
   ...
   public static <V> Byte2ReferenceFunction<V> singleton(byte var0, V var1) {
      return new Byte2ReferenceFunctions.Singleton(var0, var1);
   }
   ...
   public static <V> Byte2ReferenceFunction<V> synchronize(Byte2ReferenceFunction<V> var0) {
      return new Byte2ReferenceFunctions.SynchronizedFunction(var0);
   }

   public static <V> Byte2ReferenceFunction<V> synchronize(Byte2ReferenceFunction<V> var0, Object var1) {
      return new Byte2ReferenceFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Byte2ReferenceFunction<V> unmodifiable(Byte2ReferenceFunction<V> var0) {
      return new Byte2ReferenceFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Byte2ReferenceFunction<V> primitive(Function<? super Byte, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Byte2ReferenceFunction) {
         return (Byte2ReferenceFunction)var0;
         ...
         return new Byte2ReferenceFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction<V> implements Byte2ReferenceFunction<V> {
      ...
      protected PrimitiveFunction(Function<? super Byte, ? extends V> var1) {
         super();
         this.function = var1;
      }
      ...
      public V get(Object var1) {
         return var1 == null ? null : this.function.apply((Byte)var1);
      }
   ...
   public static class UnmodifiableFunction<V> extends AbstractByte2ReferenceFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Byte2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Byte2ReferenceFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Byte2ReferenceFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Byte2ReferenceFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
