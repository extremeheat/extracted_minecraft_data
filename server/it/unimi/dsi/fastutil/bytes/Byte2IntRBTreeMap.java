...
public class Byte2IntRBTreeMap extends AbstractByte2IntSortedMap implements Serializable, Cloneable {
   protected transient Byte2IntRBTreeMap.Entry tree;
   protected int count;
   protected transient Byte2IntRBTreeMap.Entry firstEntry;
   protected transient Byte2IntRBTreeMap.Entry lastEntry;
   ...
   private transient Byte2IntRBTreeMap.Entry[] nodePath;
   ...
   public Byte2IntRBTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2IntRBTreeMap(Map<? extends Byte, ? extends Integer> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2IntRBTreeMap(SortedMap<Byte, Integer> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2IntRBTreeMap(Byte2IntMap var1) {
      this();
      this.putAll(var1);
   }

   public Byte2IntRBTreeMap(Byte2IntSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2IntRBTreeMap(byte[] var1, int[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2IntRBTreeMap(byte[] var1, int[] var2) {
   ...
   final Byte2IntRBTreeMap.Entry findKey(byte var1) {
      Byte2IntRBTreeMap.Entry var2;
      int var3;
   ...
   final Byte2IntRBTreeMap.Entry locateKey(byte var1) {
      Byte2IntRBTreeMap.Entry var2 = this.tree;
      Byte2IntRBTreeMap.Entry var3 = this.tree;
   ...
   private void allocatePaths() {
      ...
      this.nodePath = new Byte2IntRBTreeMap.Entry[64];
   }

   public int addTo(byte var1, int var2) {
      Byte2IntRBTreeMap.Entry var3 = this.add(var1);
      int var4 = var3.value;
      var3.value += var2;
      return var4;
   }
   ...
   private Byte2IntRBTreeMap.Entry add(byte var1) {
      this.modified = false;
      int var2 = 0;
      Byte2IntRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Byte2IntRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Byte2IntRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Byte2IntRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Byte2IntRBTreeMap.Entry var7;
               Byte2IntRBTreeMap.Entry var8;
   ...
   public boolean containsValue(int var1) {
      Byte2IntRBTreeMap.ValueIterator var2 = new Byte2IntRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public int get(byte var1) {
      Byte2IntRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
            final Comparator<? super Byte2IntMap.Entry> comparator = (var1x, var2) -> {
               return Byte2IntRBTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator() {
               return Byte2IntRBTreeMap.this.new EntryIterator();
            }

            public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry var1) {
               return Byte2IntRBTreeMap.this.new EntryIterator(var1.getByteKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        Byte2IntRBTreeMap.Entry var3 = Byte2IntRBTreeMap.this.findKey((Byte)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                        ...
                        if (var3 != null && var3.getIntValue() == (Integer)var2.getValue()) {
                           Byte2IntRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry var1, Byte2IntMap.Entry var2) {
               return Byte2IntRBTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2IntEntrySet();
            }

            public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry var1) {
               return Byte2IntRBTreeMap.this.headMap(var1.getByteKey()).byte2IntEntrySet();
            }

            public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry var1) {
               return Byte2IntRBTreeMap.this.tailMap(var1.getByteKey()).byte2IntEntrySet();
            }
         };
      }
   ...
   public ByteSortedSet keySet() {
      if (this.keys == null) {
         this.keys = new Byte2IntRBTreeMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            public IntIterator iterator() {
               return Byte2IntRBTreeMap.this.new ValueIterator();
            }

            public boolean contains(int var1) {
               return Byte2IntRBTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2IntSortedMap headMap(byte var1) {
      return new Byte2IntRBTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2IntSortedMap tailMap(byte var1) {
      return new Byte2IntRBTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2IntSortedMap subMap(byte var1, byte var2) {
      return new Byte2IntRBTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2IntRBTreeMap clone() {
      Byte2IntRBTreeMap var1;
      try {
         var1 = (Byte2IntRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2IntRBTreeMap.Entry var5 = new Byte2IntRBTreeMap.Entry();
         Byte2IntRBTreeMap.Entry var6 = new Byte2IntRBTreeMap.Entry();
         Byte2IntRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2IntRBTreeMap.Entry var4 = var6;
         var6.pred((Byte2IntRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2IntRBTreeMap.EntryIterator var3 = new Byte2IntRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2IntRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2IntRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Byte2IntRBTreeMap.Entry var3, Byte2IntRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Byte2IntRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2IntRBTreeMap.Entry(var1.readByte(), var1.readInt());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Byte2IntRBTreeMap.Entry(var1.readByte(), var1.readInt());
         var8.black(true);
         var8.right(new Byte2IntRBTreeMap.Entry(var1.readByte(), var1.readInt()));
         ...
         Byte2IntRBTreeMap.Entry var7 = new Byte2IntRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2IntRBTreeMap.Entry)null, (Byte2IntRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2IntSortedMap implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2IntRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2IntRBTreeMap.Submap.SubmapIterator var1 = new Byte2IntRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2IntRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2IntRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public ByteSortedSet keySet() {
         if (this.keys == null) {
            this.keys = new Byte2IntRBTreeMap.Submap.KeySet();
         }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2IntRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(int var1) {
         Byte2IntRBTreeMap.Submap.SubmapIterator var2 = new Byte2IntRBTreeMap.Submap.SubmapIterator();
      ...
      public int get(byte var1) {
         Byte2IntRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2IntRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public int put(byte var1, int var2) {
         ...
         if (!this.in(var1)) {
            ...
            int var3 = Byte2IntRBTreeMap.this.put(var1, var2);
            return Byte2IntRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public int remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            int var2 = Byte2IntRBTreeMap.this.remove(var1);
            return Byte2IntRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public boolean isEmpty() {
         return !(new Byte2IntRBTreeMap.Submap.SubmapIterator()).hasNext();
      }
      ...
      public Byte2IntSortedMap headMap(byte var1) {
         if (this.top) {
            return Byte2IntRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2IntRBTreeMap.this.compare(var1, this.to) < 0 ? Byte2IntRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2IntSortedMap tailMap(byte var1) {
         if (this.bottom) {
            return Byte2IntRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2IntRBTreeMap.this.compare(var1, this.from) > 0 ? Byte2IntRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2IntSortedMap subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2IntRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2IntRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2IntRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2IntRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }

      public Byte2IntRBTreeMap.Entry firstEntry() {
         if (Byte2IntRBTreeMap.this.tree == null) {
            return null;
         } else {
            Byte2IntRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2IntRBTreeMap.this.firstEntry;
            } else {
               var1 = Byte2IntRBTreeMap.this.locateKey(this.from);
               if (Byte2IntRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2IntRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }

      public Byte2IntRBTreeMap.Entry lastEntry() {
         if (Byte2IntRBTreeMap.this.tree == null) {
            return null;
         } else {
            Byte2IntRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2IntRBTreeMap.this.lastEntry;
            } else {
               var1 = Byte2IntRBTreeMap.this.locateKey(this.to);
               if (Byte2IntRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2IntRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2IntRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2IntRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private final class SubmapValueIterator extends Byte2IntRBTreeMap.Submap.SubmapIterator implements IntListIterator {
      ...
      private final class SubmapKeyIterator extends Byte2IntRBTreeMap.Submap.SubmapIterator implements ByteListIterator {
      ...
      private class SubmapEntryIterator extends Byte2IntRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2IntMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2IntRBTreeMap.TreeIterator {
         SubmapIterator() {
            super();
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2IntRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2IntRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2IntRBTreeMap.this.locateKey(var2);
                  if (Byte2IntRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Byte2IntRBTreeMap.this.compare(this.next.key, Submap.this.to) >= 0) {
               this.next = null;
            }
   ...
   private final class ValueIterator extends Byte2IntRBTreeMap.TreeIterator implements IntListIterator {
   ...
   private class KeySet extends AbstractByte2IntSortedMap.KeySet {
      ...
      public ByteBidirectionalIterator iterator() {
         return Byte2IntRBTreeMap.this.new KeyIterator();
      }

      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2IntRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private final class KeyIterator extends Byte2IntRBTreeMap.TreeIterator implements ByteListIterator {
      public KeyIterator() {
         super();
      }
   ...
   private class EntryIterator extends Byte2IntRBTreeMap.TreeIterator implements ObjectListIterator<Byte2IntMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      Byte2IntRBTreeMap.Entry prev;
      Byte2IntRBTreeMap.Entry next;
      Byte2IntRBTreeMap.Entry curr;
      int index = 0;
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2IntRBTreeMap.this.locateKey(var2)) != null) {
            if (Byte2IntRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
      ...
      Byte2IntRBTreeMap.Entry nextEntry() {
         if (!this.hasNext()) {
            throw new NoSuchElementException();
         } else {
      ...
      Byte2IntRBTreeMap.Entry previousEntry() {
         if (!this.hasPrevious()) {
            throw new NoSuchElementException();
         } else {
   ...
   private static final class Entry extends AbstractByte2IntMap.BasicEntry implements Cloneable {
      ...
      Byte2IntRBTreeMap.Entry left;
      Byte2IntRBTreeMap.Entry right;
      int info;
      ...
      void pred(Byte2IntRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2IntRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2IntRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2IntRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2IntRBTreeMap.Entry next() {
         Byte2IntRBTreeMap.Entry var1 = this.right;
      ...
      Byte2IntRBTreeMap.Entry prev() {
         Byte2IntRBTreeMap.Entry var1 = this.left;
      ...
      public Byte2IntRBTreeMap.Entry clone() {
         Byte2IntRBTreeMap.Entry var1;
         try {
            var1 = (Byte2IntRBTreeMap.Entry)super.clone();
