...
public interface Byte2BooleanMap extends Byte2BooleanFunction, Map<Byte, Boolean> {
   ...
   /** @deprecated */
   @Deprecated
   default Boolean put(Byte var1, Boolean var2) {
      return Byte2BooleanFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Boolean get(Object var1) {
      return Byte2BooleanFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Boolean remove(Object var1) {
      return Byte2BooleanFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Byte2BooleanFunction.super.containsKey(var1);
   }
   ...
   default boolean getOrDefault(byte var1, boolean var2) {
      boolean var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default boolean putIfAbsent(byte var1, boolean var2) {
   ...
   default boolean remove(byte var1, boolean var2) {
      boolean var3 = this.get(var1);
   ...
   default boolean replace(byte var1, boolean var2, boolean var3) {
   ...
   default boolean replace(byte var1, boolean var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default boolean computeIfAbsent(byte var1, IntPredicate var2) {
   ...
   default boolean computeIfAbsentNullable(byte var1, IntFunction<? extends Boolean> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default boolean computeIfAbsentPartial(byte var1, Byte2BooleanFunction var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default boolean computeIfPresent(byte var1, BiFunction<? super Byte, ? super Boolean, ? extends Boolean> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default boolean compute(byte var1, BiFunction<? super Byte, ? super Boolean, ? extends Boolean> var2) {
      Objects.requireNonNull(var2);
      boolean var3 = this.get(var1);
      boolean var4 = this.defaultReturnValue();
   ...
   default boolean merge(byte var1, boolean var2, BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Boolean computeIfAbsent(Byte var1, Function<? super Byte, ? extends Boolean> var2) {
   ...
   public interface FastEntrySet extends ObjectSet<Byte2BooleanMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Byte2BooleanMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
