...
public class Byte2ReferenceOpenCustomHashMap<V> extends AbstractByte2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Byte2ReferenceOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2ReferenceOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2ReferenceOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2ReferenceOpenCustomHashMap(Map<? extends Byte, ? extends V> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2ReferenceOpenCustomHashMap(Map<? extends Byte, ? extends V> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2ReferenceOpenCustomHashMap(byte[] var1, V[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2ReferenceOpenCustomHashMap(byte[] var1, V[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Byte2ReferenceOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2ReferenceOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2ReferenceOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2ReferenceOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2ReferenceOpenCustomHashMap<V> clone() {
      Byte2ReferenceOpenCustomHashMap var1;
      try {
         var1 = (Byte2ReferenceOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      Object[] var3 = this.value;
      Byte2ReferenceOpenCustomHashMap.MapIterator var4 = new Byte2ReferenceOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2ReferenceOpenCustomHashMap.this.key[Byte2ReferenceOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2ReferenceOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2ReferenceOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2ReferenceOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2ReferenceOpenCustomHashMap.this.size;
         Byte2ReferenceOpenCustomHashMap.this.remove(var1);
         return Byte2ReferenceOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                  return Byte2ReferenceOpenCustomHashMap.this.containsNullKey && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == var4;
               } else {
                  byte[] var6 = Byte2ReferenceOpenCustomHashMap.this.key;
                  byte var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                     return Byte2ReferenceOpenCustomHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Byte2ReferenceOpenCustomHashMap.this.mask]) != 0) {
                        if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                           return Byte2ReferenceOpenCustomHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               Object var4 = var2.getValue();
               if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                  if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                     return false;
                  } else if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                     if (Byte2ReferenceOpenCustomHashMap.this.value[var7] == var4) {
                        Byte2ReferenceOpenCustomHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var5, var3) || Byte2ReferenceOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> var1) {
         if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceOpenCustomHashMap.this.key[Byte2ReferenceOpenCustomHashMap.this.n], Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2ReferenceOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceOpenCustomHashMap.this.key[var2], Byte2ReferenceOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> var1) {
         ...
         if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2ReferenceOpenCustomHashMap.this.key[Byte2ReferenceOpenCustomHashMap.this.n];
            var2.value = Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2ReferenceOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2ReferenceOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2ReferenceOpenCustomHashMap.this.key[var3];
               var2.value = Byte2ReferenceOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
      private final Byte2ReferenceOpenCustomHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2ReferenceOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2ReferenceOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2ReferenceOpenCustomHashMap.this.mask; !Byte2ReferenceOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2ReferenceOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2ReferenceOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;

            byte var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Byte2ReferenceOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2ReferenceOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2ReferenceOpenCustomHashMap.this.value[var2] = Byte2ReferenceOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2ReferenceMap.Entry<V>, java.util.Map.Entry<Byte, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Byte2ReferenceOpenCustomHashMap.this.value[this.index];
         Byte2ReferenceOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Byte2ReferenceOpenCustomHashMap.this.value[this.index] == var2.getValue();
         }
      }
