...
public class Byte2BooleanOpenCustomHashMap extends AbstractByte2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2BooleanOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2BooleanOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2BooleanOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2BooleanOpenCustomHashMap(Map<? extends Byte, ? extends Boolean> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2BooleanOpenCustomHashMap(Map<? extends Byte, ? extends Boolean> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2BooleanOpenCustomHashMap(Byte2BooleanMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2BooleanOpenCustomHashMap(Byte2BooleanMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2BooleanOpenCustomHashMap(byte[] var1, boolean[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2BooleanOpenCustomHashMap(byte[] var1, boolean[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Byte2BooleanOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2BooleanOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2BooleanOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2BooleanOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2BooleanOpenCustomHashMap clone() {
      Byte2BooleanOpenCustomHashMap var1;
      try {
         var1 = (Byte2BooleanOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      boolean[] var3 = this.value;
      Byte2BooleanOpenCustomHashMap.MapIterator var4 = new Byte2BooleanOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2BooleanOpenCustomHashMap.this.key[Byte2BooleanOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2BooleanOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2BooleanOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2BooleanOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2BooleanOpenCustomHashMap.this.size;
         Byte2BooleanOpenCustomHashMap.this.remove(var1);
         return Byte2BooleanOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2BooleanOpenCustomHashMap.this.containsNullKey && Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n] == var4;
                  } else {
                     byte[] var6 = Byte2BooleanOpenCustomHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Byte2BooleanOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2BooleanOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Byte2BooleanOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var4 = (Boolean)var2.getValue();
                  if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2BooleanOpenCustomHashMap.this.containsNullKey && Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2BooleanOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Byte2BooleanOpenCustomHashMap.this.value[var7] == var4) {
                           Byte2BooleanOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2BooleanOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2BooleanOpenCustomHashMap.this.strategy.equals(var5, var3) || Byte2BooleanOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2BooleanMap.Entry> var1) {
         if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2BooleanMap.BasicEntry(Byte2BooleanOpenCustomHashMap.this.key[Byte2BooleanOpenCustomHashMap.this.n], Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2BooleanOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2BooleanMap.BasicEntry(Byte2BooleanOpenCustomHashMap.this.key[var2], Byte2BooleanOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2BooleanMap.Entry> var1) {
         ...
         if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2BooleanOpenCustomHashMap.this.key[Byte2BooleanOpenCustomHashMap.this.n];
            var2.value = Byte2BooleanOpenCustomHashMap.this.value[Byte2BooleanOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2BooleanOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2BooleanOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2BooleanOpenCustomHashMap.this.key[var3];
               var2.value = Byte2BooleanOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2BooleanMap.Entry> {
      private final Byte2BooleanOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2BooleanOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2BooleanOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2BooleanOpenCustomHashMap.this.mask; !Byte2BooleanOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2BooleanOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2BooleanOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2BooleanOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2BooleanOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2BooleanOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2BooleanOpenCustomHashMap.this.value[var2] = Byte2BooleanOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2BooleanMap.Entry, java.util.Map.Entry<Byte, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Byte2BooleanOpenCustomHashMap.this.value[this.index];
         Byte2BooleanOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2BooleanOpenCustomHashMap.this.strategy.equals(Byte2BooleanOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Byte2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
