...
public interface Byte2ObjectMap<V> extends Byte2ObjectFunction<V>, Map<Byte, V> {
   ...
   default V put(Byte var1, V var2) {
      return Byte2ObjectFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V get(Object var1) {
      return Byte2ObjectFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default V remove(Object var1) {
      return Byte2ObjectFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Byte2ObjectFunction.super.containsKey(var1);
   }

   default V getOrDefault(byte var1, V var2) {
      Object var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default V putIfAbsent(byte var1, V var2) {
   ...
   default boolean remove(byte var1, Object var2) {
      Object var3 = this.get(var1);
   ...
   default boolean replace(byte var1, V var2, V var3) {
   ...
   default V replace(byte var1, V var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default V computeIfAbsent(byte var1, IntFunction<? extends V> var2) {
   ...
   default V computeIfAbsentPartial(byte var1, Byte2ObjectFunction<? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default V computeIfPresent(byte var1, BiFunction<? super Byte, ? super V, ? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default V compute(byte var1, BiFunction<? super Byte, ? super V, ? extends V> var2) {
      Objects.requireNonNull(var2);
      Object var3 = this.get(var1);
      Object var4 = this.defaultReturnValue();
   ...
   default V merge(byte var1, V var2, BiFunction<? super V, ? super V, ? extends V> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default V computeIfAbsent(Byte var1, Function<? super Byte, ? extends V> var2) {
   ...
   public interface FastEntrySet<V> extends ObjectSet<Byte2ObjectMap.Entry<V>> {
      ...
      default void fastForEach(Consumer<? super Byte2ObjectMap.Entry<V>> var1) {
         this.forEach(var1);
      }
   }
}
