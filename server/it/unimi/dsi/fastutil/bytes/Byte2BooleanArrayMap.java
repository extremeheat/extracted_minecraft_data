...
public class Byte2BooleanArrayMap extends AbstractByte2BooleanMap implements Serializable, Cloneable {
   ...
   public Byte2BooleanArrayMap(byte[] var1, boolean[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Byte2BooleanArrayMap(int var1) {
      super();
      this.key = new byte[var1];
      this.value = new boolean[var1];
   }

   public Byte2BooleanArrayMap(Byte2BooleanMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2BooleanArrayMap(Map<? extends Byte, ? extends Boolean> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2BooleanArrayMap(byte[] var1, boolean[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public Byte2BooleanMap.FastEntrySet byte2BooleanEntrySet() {
      return new Byte2BooleanArrayMap.EntrySet();
   }
   ...
   public ByteSet keySet() {
      return new AbstractByteSet() {
         public boolean contains(byte var1) {
            return Byte2BooleanArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(byte var1) {
            int var2 = Byte2BooleanArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Byte2BooleanArrayMap.this.size - var2 - 1;
               System.arraycopy(Byte2BooleanArrayMap.this.key, var2 + 1, Byte2BooleanArrayMap.this.key, var2, var3);
               System.arraycopy(Byte2BooleanArrayMap.this.value, var2 + 1, Byte2BooleanArrayMap.this.value, var2, var3);
            ...
            return new ByteIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Byte2BooleanArrayMap.this.size - this.pos;
                     System.arraycopy(Byte2BooleanArrayMap.this.key, this.pos, Byte2BooleanArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Byte2BooleanArrayMap.this.value, this.pos, Byte2BooleanArrayMap.this.value, this.pos - 1, var1);
                     Byte2BooleanArrayMap.this.size--;
                  }
               }
            };
   ...
   public BooleanCollection values() {
      return new AbstractBooleanCollection() {
         public boolean contains(boolean var1) {
            return Byte2BooleanArrayMap.this.containsValue(var1);
         }
   ...
   public Byte2BooleanArrayMap clone() {
      Byte2BooleanArrayMap var1;
      try {
         var1 = (Byte2BooleanArrayMap)super.clone();
         ...
         return new ObjectIterator<Byte2BooleanMap.Entry>() {
            ...
            public Byte2BooleanMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractByte2BooleanMap.BasicEntry(Byte2BooleanArrayMap.this.key[this.curr = this.next], Byte2BooleanArrayMap.this.value[this.next++]);
               }
            }
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Byte2BooleanArrayMap.this.size-- - this.next--;
                  System.arraycopy(Byte2BooleanArrayMap.this.key, this.next + 1, Byte2BooleanArrayMap.this.key, this.next, var1);
                  System.arraycopy(Byte2BooleanArrayMap.this.value, this.next + 1, Byte2BooleanArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         return new ObjectIterator<Byte2BooleanMap.Entry>() {
            ...
            public Byte2BooleanMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  this.entry.key = Byte2BooleanArrayMap.this.key[this.curr = this.next];
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  return Byte2BooleanArrayMap.this.containsKey(var3) && Byte2BooleanArrayMap.this.get(var3) == (Boolean)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  int var5 = Byte2BooleanArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Byte2BooleanArrayMap.this.value[var5]) {
                     int var6 = Byte2BooleanArrayMap.this.size - var5 - 1;
                     System.arraycopy(Byte2BooleanArrayMap.this.key, var5 + 1, Byte2BooleanArrayMap.this.key, var5, var6);
                     System.arraycopy(Byte2BooleanArrayMap.this.value, var5 + 1, Byte2BooleanArrayMap.this.value, var5, var6);
                     Byte2BooleanArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
