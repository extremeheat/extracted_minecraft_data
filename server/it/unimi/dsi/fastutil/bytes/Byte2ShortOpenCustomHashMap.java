...
public class Byte2ShortOpenCustomHashMap extends AbstractByte2ShortMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2ShortOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2ShortOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2ShortOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2ShortOpenCustomHashMap(Map<? extends Byte, ? extends Short> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2ShortOpenCustomHashMap(Map<? extends Byte, ? extends Short> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2ShortOpenCustomHashMap(Byte2ShortMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2ShortOpenCustomHashMap(Byte2ShortMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2ShortOpenCustomHashMap(byte[] var1, short[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2ShortOpenCustomHashMap(byte[] var1, short[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Byte2ShortOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2ShortOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2ShortOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2ShortOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2ShortOpenCustomHashMap clone() {
      Byte2ShortOpenCustomHashMap var1;
      try {
         var1 = (Byte2ShortOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      short[] var3 = this.value;
      Byte2ShortOpenCustomHashMap.MapIterator var4 = new Byte2ShortOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2ShortOpenCustomHashMap.this.key[Byte2ShortOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2ShortOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2ShortOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2ShortOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2ShortOpenCustomHashMap.this.size;
         Byte2ShortOpenCustomHashMap.this.remove(var1);
         return Byte2ShortOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ShortMap.Entry> implements Byte2ShortMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  if (Byte2ShortOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2ShortOpenCustomHashMap.this.containsNullKey && Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n] == var4;
                  } else {
                     byte[] var6 = Byte2ShortOpenCustomHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                        return Byte2ShortOpenCustomHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2ShortOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2ShortOpenCustomHashMap.this.strategy.equals(var3, var5)) {
                              return Byte2ShortOpenCustomHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Short) {
                  ...
                  short var4 = (Short)var2.getValue();
                  if (Byte2ShortOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2ShortOpenCustomHashMap.this.containsNullKey && Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2ShortOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2ShortOpenCustomHashMap.this.strategy.equals(var5, var3)) {
                        if (Byte2ShortOpenCustomHashMap.this.value[var7] == var4) {
                           Byte2ShortOpenCustomHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2ShortOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2ShortOpenCustomHashMap.this.strategy.equals(var5, var3) || Byte2ShortOpenCustomHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2ShortMap.Entry> var1) {
         if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2ShortMap.BasicEntry(Byte2ShortOpenCustomHashMap.this.key[Byte2ShortOpenCustomHashMap.this.n], Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2ShortOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2ShortMap.BasicEntry(Byte2ShortOpenCustomHashMap.this.key[var2], Byte2ShortOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2ShortMap.Entry> var1) {
         ...
         if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2ShortOpenCustomHashMap.this.key[Byte2ShortOpenCustomHashMap.this.n];
            var2.value = Byte2ShortOpenCustomHashMap.this.value[Byte2ShortOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2ShortOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2ShortOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2ShortOpenCustomHashMap.this.key[var3];
               var2.value = Byte2ShortOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2ShortMap.Entry> {
      private final Byte2ShortOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2ShortOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2ShortMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2ShortOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2ShortOpenCustomHashMap.this.mask; !Byte2ShortOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2ShortOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2ShortOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2ShortOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2ShortOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2ShortOpenCustomHashMap.this.value[var2] = Byte2ShortOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2ShortMap.Entry, java.util.Map.Entry<Byte, Short> {
      ...
      public short setValue(short var1) {
         short var2 = Byte2ShortOpenCustomHashMap.this.value[this.index];
         Byte2ShortOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2ShortOpenCustomHashMap.this.strategy.equals(Byte2ShortOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Byte2ShortOpenCustomHashMap.this.value[this.index] == (Short)var2.getValue();
         }
      }
