...
public class Byte2LongOpenCustomHashMap extends AbstractByte2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2LongOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2LongOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2LongOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2LongOpenCustomHashMap(Byte2LongMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2LongOpenCustomHashMap(Byte2LongMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2LongOpenCustomHashMap(byte[] var1, long[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2LongOpenCustomHashMap(byte[] var1, long[] var2, ByteHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Byte2LongOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(LongConsumer var1) {
               if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2LongOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2LongOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2LongOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2LongOpenCustomHashMap clone() {
      Byte2LongOpenCustomHashMap var1;
      try {
         var1 = (Byte2LongOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      long[] var3 = this.value;
      Byte2LongOpenCustomHashMap.MapIterator var4 = new Byte2LongOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2LongOpenCustomHashMap.this.key[Byte2LongOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2LongOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2LongOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2LongOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2LongOpenCustomHashMap.this.size;
         Byte2LongOpenCustomHashMap.this.remove(var1);
         return Byte2LongOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (Byte2LongOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2LongOpenCustomHashMap.this.containsNullKey && Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n] == var4;
                  } else {
                     byte[] var7 = Byte2LongOpenCustomHashMap.this.key;
                     byte var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2LongOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2LongOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Byte2LongOpenCustomHashMap.this.value[var8] == var4;
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Byte2LongOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2LongOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Byte2LongOpenCustomHashMap.this.value[var8] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var4 = (Long)var2.getValue();
                  if (Byte2LongOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2LongOpenCustomHashMap.this.containsNullKey && Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n] == var4) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2LongOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2LongOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Byte2LongOpenCustomHashMap.this.value[var8] == var4) {
                           Byte2LongOpenCustomHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Byte2LongOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2LongOpenCustomHashMap.this.strategy.equals(var6, var3) || Byte2LongOpenCustomHashMap.this.value[var8] != var4);
      ...
      public void forEach(Consumer<? super Byte2LongMap.Entry> var1) {
         if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2LongMap.BasicEntry(Byte2LongOpenCustomHashMap.this.key[Byte2LongOpenCustomHashMap.this.n], Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2LongOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2LongMap.BasicEntry(Byte2LongOpenCustomHashMap.this.key[var2], Byte2LongOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2LongMap.Entry> var1) {
         ...
         if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2LongOpenCustomHashMap.this.key[Byte2LongOpenCustomHashMap.this.n];
            var2.value = Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2LongOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2LongOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2LongOpenCustomHashMap.this.key[var3];
               var2.value = Byte2LongOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2LongMap.Entry> {
      private final Byte2LongOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2LongOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2LongOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2LongOpenCustomHashMap.this.mask; !Byte2LongOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2LongOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2LongOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2LongOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2LongOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2LongOpenCustomHashMap.this.value[var2] = Byte2LongOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2LongMap.Entry, java.util.Map.Entry<Byte, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Byte2LongOpenCustomHashMap.this.value[this.index];
         Byte2LongOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Byte2LongOpenCustomHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
