...
public class Byte2ObjectOpenHashMap<V> extends AbstractByte2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Byte2ObjectOpenHashMap(int var1, float var2) {
      super();
   ...
   public Byte2ObjectOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Byte2ObjectOpenHashMap(Map<? extends Byte, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2ObjectOpenHashMap(Map<? extends Byte, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Byte2ObjectOpenHashMap(Byte2ObjectMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2ObjectOpenHashMap(Byte2ObjectMap<V> var1) {
      this(var1, 0.75F);
   }

   public Byte2ObjectOpenHashMap(byte[] var1, V[] var2, float var3) {
   ...
   public Byte2ObjectOpenHashMap(byte[] var1, V[] var2) {
   ...
   public Byte2ObjectMap.FastEntrySet<V> byte2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new Byte2ObjectOpenHashMap.MapEntrySet();
      }
   ...
   public ByteSet keySet() {
      if (this.keys == null) {
         this.keys = new Byte2ObjectOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            public ObjectIterator<V> iterator() {
               return Byte2ObjectOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(Object var1) {
               return Byte2ObjectOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Byte2ObjectOpenHashMap.this.containsNullKey) {
                  var1.accept(Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n]);
               }

               int var2 = Byte2ObjectOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2ObjectOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2ObjectOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2ObjectOpenHashMap<V> clone() {
      Byte2ObjectOpenHashMap var1;
      try {
         var1 = (Byte2ObjectOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      Object[] var3 = this.value;
      Byte2ObjectOpenHashMap.MapIterator var4 = new Byte2ObjectOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Byte2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteIterator iterator() {
         return Byte2ObjectOpenHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Byte2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(Byte2ObjectOpenHashMap.this.key[Byte2ObjectOpenHashMap.this.n]);
         }

         int var2 = Byte2ObjectOpenHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2ObjectOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2ObjectOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2ObjectOpenHashMap.this.size;
         Byte2ObjectOpenHashMap.this.remove(var1);
         return Byte2ObjectOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Byte2ObjectOpenHashMap<V>.MapIterator implements ByteIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectIterator<Byte2ObjectMap.Entry<V>> iterator() {
         return Byte2ObjectOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator() {
         return Byte2ObjectOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               if (var3 == 0) {
                  return Byte2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n], var4);
               } else {
                  byte[] var6 = Byte2ObjectOpenHashMap.this.key;
                  byte var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2ObjectOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (var3 == var5) {
                     return Objects.equals(Byte2ObjectOpenHashMap.this.value[var7], var4);
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Byte2ObjectOpenHashMap.this.mask]) != 0) {
                        if (var3 == var5) {
                           return Objects.equals(Byte2ObjectOpenHashMap.this.value[var7], var4);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               Object var4 = var2.getValue();
               if (var3 == 0) {
                  if (Byte2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n], var4)) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2ObjectOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Objects.equals(Byte2ObjectOpenHashMap.this.value[var7], var4)) {
                        Byte2ObjectOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Byte2ObjectOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(var5 != var3 || !Objects.equals(Byte2ObjectOpenHashMap.this.value[var7], var4));
      ...
      public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> var1) {
         if (Byte2ObjectOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2ObjectMap.BasicEntry(Byte2ObjectOpenHashMap.this.key[Byte2ObjectOpenHashMap.this.n], Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2ObjectOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2ObjectMap.BasicEntry(Byte2ObjectOpenHashMap.this.key[var2], Byte2ObjectOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2ObjectMap.Entry<V>> var1) {
         ...
         if (Byte2ObjectOpenHashMap.this.containsNullKey) {
            var2.key = Byte2ObjectOpenHashMap.this.key[Byte2ObjectOpenHashMap.this.n];
            var2.value = Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2ObjectOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2ObjectOpenHashMap.this.key[var3] != 0) {
               var2.key = Byte2ObjectOpenHashMap.this.key[var3];
               var2.value = Byte2ObjectOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
      private final Byte2ObjectOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2ObjectOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
      ...
      public Byte2ObjectOpenHashMap<V>.MapEntry next() {
         return this.entry = Byte2ObjectOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               return this.last = Byte2ObjectOpenHashMap.this.n;
            } else {
               byte[] var1 = Byte2ObjectOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Byte2ObjectOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Byte2ObjectOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2ObjectOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2ObjectOpenHashMap.this.mask;

            byte var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Byte2ObjectOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4) & Byte2ObjectOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2ObjectOpenHashMap.this.value[var2] = Byte2ObjectOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2ObjectMap.Entry<V>, java.util.Map.Entry<Byte, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Byte2ObjectOpenHashMap.this.value[this.index];
         Byte2ObjectOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2ObjectOpenHashMap.this.key[this.index] == (Byte)var2.getKey() && Objects.equals(Byte2ObjectOpenHashMap.this.value[this.index], var2.getValue());
         }
      }
