...
public interface Byte2ShortMap extends Byte2ShortFunction, Map<Byte, Short> {
   ...
   default Short put(Byte var1, Short var2) {
      return Byte2ShortFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Short get(Object var1) {
      return Byte2ShortFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Short remove(Object var1) {
      return Byte2ShortFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Byte2ShortFunction.super.containsKey(var1);
   }
   ...
   default short getOrDefault(byte var1, short var2) {
      short var3;
      return (var3 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var2 : var3;
   }

   default short putIfAbsent(byte var1, short var2) {
   ...
   default boolean remove(byte var1, short var2) {
      short var3 = this.get(var1);
   ...
   default boolean replace(byte var1, short var2, short var3) {
   ...
   default short replace(byte var1, short var2) {
      return this.containsKey(var1) ? this.put(var1, var2) : this.defaultReturnValue();
   }

   default short computeIfAbsent(byte var1, IntUnaryOperator var2) {
   ...
   default short computeIfAbsentNullable(byte var1, IntFunction<? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short computeIfAbsentPartial(byte var1, Byte2ShortFunction var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short computeIfPresent(byte var1, BiFunction<? super Byte, ? super Short, ? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
      if (var3 == var4 && !this.containsKey(var1)) {
   ...
   default short compute(byte var1, BiFunction<? super Byte, ? super Short, ? extends Short> var2) {
      Objects.requireNonNull(var2);
      short var3 = this.get(var1);
      short var4 = this.defaultReturnValue();
   ...
   default short merge(byte var1, short var2, BiFunction<? super Short, ? super Short, ? extends Short> var3) {
   ...
   /** @deprecated */
   @Deprecated
   default Short computeIfAbsent(Byte var1, Function<? super Byte, ? extends Short> var2) {
   ...
   public interface FastEntrySet extends ObjectSet<Byte2ShortMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Byte2ShortMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
