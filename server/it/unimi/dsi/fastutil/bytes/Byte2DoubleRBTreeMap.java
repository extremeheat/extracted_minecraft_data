...
public class Byte2DoubleRBTreeMap extends AbstractByte2DoubleSortedMap implements Serializable, Cloneable {
   ...
   public Byte2DoubleRBTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2DoubleRBTreeMap(Map<? extends Byte, ? extends Double> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2DoubleRBTreeMap(SortedMap<Byte, Double> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2DoubleRBTreeMap(Byte2DoubleMap var1) {
      this();
      this.putAll(var1);
   }

   public Byte2DoubleRBTreeMap(Byte2DoubleSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2DoubleRBTreeMap(byte[] var1, double[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2DoubleRBTreeMap(byte[] var1, double[] var2) {
   ...
   final Byte2DoubleRBTreeMap.Entry findKey(byte var1) {
      Byte2DoubleRBTreeMap.Entry var2;
      int var3;
   ...
   final Byte2DoubleRBTreeMap.Entry locateKey(byte var1) {
      Byte2DoubleRBTreeMap.Entry var2 = this.tree;
      Byte2DoubleRBTreeMap.Entry var3 = this.tree;
   ...
   public double addTo(byte var1, double var2) {
      Byte2DoubleRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Byte2DoubleRBTreeMap.Entry add(byte var1) {
      this.modified = false;
      int var2 = 0;
      Byte2DoubleRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Byte2DoubleRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Byte2DoubleRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Byte2DoubleRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Byte2DoubleRBTreeMap.Entry var7;
               Byte2DoubleRBTreeMap.Entry var8;
   ...
   public boolean containsValue(double var1) {
      Byte2DoubleRBTreeMap.ValueIterator var3 = new Byte2DoubleRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public double get(byte var1) {
      Byte2DoubleRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>() {
            final Comparator<? super Byte2DoubleMap.Entry> comparator = (var1x, var2) -> {
               return Byte2DoubleRBTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry var1) {
               return Byte2DoubleRBTreeMap.this.new EntryIterator(var1.getByteKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        Byte2DoubleRBTreeMap.Entry var3 = Byte2DoubleRBTreeMap.this.findKey((Byte)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        ...
                        if (var3 != null && Double.doubleToLongBits(var3.getDoubleValue()) == Double.doubleToLongBits((Double)var2.getValue())) {
                           Byte2DoubleRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry var1, Byte2DoubleMap.Entry var2) {
               return Byte2DoubleRBTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2DoubleEntrySet();
            }

            public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry var1) {
               return Byte2DoubleRBTreeMap.this.headMap(var1.getByteKey()).byte2DoubleEntrySet();
            }

            public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry var1) {
               return Byte2DoubleRBTreeMap.this.tailMap(var1.getByteKey()).byte2DoubleEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Byte2DoubleRBTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2DoubleSortedMap headMap(byte var1) {
      return new Byte2DoubleRBTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2DoubleSortedMap tailMap(byte var1) {
      return new Byte2DoubleRBTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2DoubleSortedMap subMap(byte var1, byte var2) {
      return new Byte2DoubleRBTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2DoubleRBTreeMap clone() {
      Byte2DoubleRBTreeMap var1;
      try {
         var1 = (Byte2DoubleRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2DoubleRBTreeMap.Entry var5 = new Byte2DoubleRBTreeMap.Entry();
         Byte2DoubleRBTreeMap.Entry var6 = new Byte2DoubleRBTreeMap.Entry();
         Byte2DoubleRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2DoubleRBTreeMap.Entry var4 = var6;
         var6.pred((Byte2DoubleRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2DoubleRBTreeMap.EntryIterator var3 = new Byte2DoubleRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2DoubleRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2DoubleRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Byte2DoubleRBTreeMap.Entry var3, Byte2DoubleRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Byte2DoubleRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2DoubleRBTreeMap.Entry(var1.readByte(), var1.readDouble());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Byte2DoubleRBTreeMap.Entry(var1.readByte(), var1.readDouble());
         var8.black(true);
         var8.right(new Byte2DoubleRBTreeMap.Entry(var1.readByte(), var1.readDouble()));
         ...
         Byte2DoubleRBTreeMap.Entry var7 = new Byte2DoubleRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2DoubleRBTreeMap.Entry)null, (Byte2DoubleRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2DoubleSortedMap implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2DoubleRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2DoubleRBTreeMap.Submap.SubmapIterator var1 = new Byte2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2DoubleRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2DoubleRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2DoubleRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(double var1) {
         Byte2DoubleRBTreeMap.Submap.SubmapIterator var3 = new Byte2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      public double get(byte var1) {
         Byte2DoubleRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2DoubleRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public double put(byte var1, double var2) {
         ...
         if (!this.in(var1)) {
            ...
            double var4 = Byte2DoubleRBTreeMap.this.put(var1, var2);
            return Byte2DoubleRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public double remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            double var2 = Byte2DoubleRBTreeMap.this.remove(var1);
            return Byte2DoubleRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Byte2DoubleSortedMap headMap(byte var1) {
         if (this.top) {
            return Byte2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2DoubleRBTreeMap.this.compare(var1, this.to) < 0 ? Byte2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2DoubleSortedMap tailMap(byte var1) {
         if (this.bottom) {
            return Byte2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? Byte2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2DoubleSortedMap subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2DoubleRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2DoubleRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Byte2DoubleRBTreeMap.Entry firstEntry() {
         if (Byte2DoubleRBTreeMap.this.tree == null) {
            ...
            Byte2DoubleRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2DoubleRBTreeMap.this.firstEntry;
            } else {
               var1 = Byte2DoubleRBTreeMap.this.locateKey(this.from);
               if (Byte2DoubleRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2DoubleRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Byte2DoubleRBTreeMap.Entry lastEntry() {
         if (Byte2DoubleRBTreeMap.this.tree == null) {
            ...
            Byte2DoubleRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2DoubleRBTreeMap.this.lastEntry;
            } else {
               var1 = Byte2DoubleRBTreeMap.this.locateKey(this.to);
               if (Byte2DoubleRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2DoubleRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2DoubleRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2DoubleRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Byte2DoubleRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2DoubleMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2DoubleRBTreeMap.TreeIterator {
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2DoubleRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2DoubleRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2DoubleRBTreeMap.this.locateKey(var2);
                  if (Byte2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractByte2DoubleSortedMap.KeySet {
      ...
      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2DoubleRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Byte2DoubleRBTreeMap.TreeIterator implements ObjectListIterator<Byte2DoubleMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2DoubleRBTreeMap.this.locateKey(var2)) != null) {
            if (Byte2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractByte2DoubleMap.BasicEntry implements Cloneable {
      ...
      void pred(Byte2DoubleRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2DoubleRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2DoubleRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2DoubleRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2DoubleRBTreeMap.Entry next() {
         Byte2DoubleRBTreeMap.Entry var1 = this.right;
      ...
      Byte2DoubleRBTreeMap.Entry prev() {
         Byte2DoubleRBTreeMap.Entry var1 = this.left;
      ...
      public Byte2DoubleRBTreeMap.Entry clone() {
         Byte2DoubleRBTreeMap.Entry var1;
         try {
            var1 = (Byte2DoubleRBTreeMap.Entry)super.clone();
