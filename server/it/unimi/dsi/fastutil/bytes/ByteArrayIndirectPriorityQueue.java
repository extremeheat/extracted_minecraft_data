...
public class ByteArrayIndirectPriorityQueue implements ByteIndirectPriorityQueue {
   ...
   public ByteArrayIndirectPriorityQueue(byte[] var1, int var2, ByteComparator var3) {
      super();
   ...
   public ByteArrayIndirectPriorityQueue(byte[] var1, int var2) {
      this(var1, var2, (ByteComparator)null);
   }

   public ByteArrayIndirectPriorityQueue(byte[] var1, ByteComparator var2) {
      this(var1, var1.length, var2);
   }

   public ByteArrayIndirectPriorityQueue(byte[] var1) {
      this(var1, var1.length, (ByteComparator)null);
   }

   public ByteArrayIndirectPriorityQueue(byte[] var1, int[] var2, int var3, ByteComparator var4) {
      this(var1, 0, var4);
      this.array = var2;
      this.size = var3;
   }
   ...
   public ByteArrayIndirectPriorityQueue(byte[] var1, int[] var2, int var3) {
   ...
   private int findFirst() {
      if (this.firstIndexValid) {
         ...
         --var1;
         int var2 = var1;
         byte var3 = this.refArray[this.array[var1]];
         if (this.c == null) {
            while(var1-- != 0) {
   ...
   public int front(int[] var1) {
      byte var2 = this.refArray[this.array[this.findFirst()]];
      int var3 = this.size;
      int var4 = 0;
