...
public class Byte2DoubleOpenCustomHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2DoubleOpenCustomHashMap(int var1, float var2, ByteHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Byte2DoubleOpenCustomHashMap(int var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2DoubleOpenCustomHashMap(ByteHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Byte2DoubleOpenCustomHashMap(Map<? extends Byte, ? extends Double> var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2DoubleOpenCustomHashMap(Map<? extends Byte, ? extends Double> var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2DoubleOpenCustomHashMap(Byte2DoubleMap var1, float var2, ByteHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Byte2DoubleOpenCustomHashMap(Byte2DoubleMap var1, ByteHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Byte2DoubleOpenCustomHashMap(byte[] var1, double[] var2, float var3, ByteHash.Strategy var4) {
   ...
   public Byte2DoubleOpenCustomHashMap(byte[] var1, double[] var2, ByteHash.Strategy var3) {
   ...
   private void insert(int var1, byte var2, double var3) {
      if (var1 == this.n) {
   ...
   public Byte2DoubleMap.FastEntrySet byte2DoubleEntrySet() {
      if (this.entries == null) {
         this.entries = new Byte2DoubleOpenCustomHashMap.MapEntrySet();
      }
   ...
   public ByteSet keySet() {
      if (this.keys == null) {
         this.keys = new Byte2DoubleOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            public DoubleIterator iterator() {
               return Byte2DoubleOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(double var1) {
               return Byte2DoubleOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]);
               }

               int var2 = Byte2DoubleOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2DoubleOpenCustomHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2DoubleOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2DoubleOpenCustomHashMap clone() {
      Byte2DoubleOpenCustomHashMap var1;
      try {
         var1 = (Byte2DoubleOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      double[] var3 = this.value;
      Byte2DoubleOpenCustomHashMap.MapIterator var4 = new Byte2DoubleOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Byte2DoubleOpenCustomHashMap.MapIterator implements DoubleIterator {
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteIterator iterator() {
         return Byte2DoubleOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(IntConsumer var1) {
         if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.n]);
         }

         int var2 = Byte2DoubleOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2DoubleOpenCustomHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2DoubleOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2DoubleOpenCustomHashMap.this.size;
         Byte2DoubleOpenCustomHashMap.this.remove(var1);
         return Byte2DoubleOpenCustomHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Byte2DoubleOpenCustomHashMap.MapIterator implements ByteIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
      ...
      public ObjectIterator<Byte2DoubleMap.Entry> iterator() {
         return Byte2DoubleOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Byte2DoubleMap.Entry> fastIterator() {
         return Byte2DoubleOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     return Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4);
                  } else {
                     byte[] var7 = Byte2DoubleOpenCustomHashMap.this.key;
                     byte var6;
                     int var8;
                     if ((var6 = var7[var8 = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                     } else {
                        while((var6 = var7[var8 = var8 + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) != 0) {
                           if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var4 = (Double)var2.getValue();
                  if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(var3, (byte)0)) {
                     if (Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(var4)) {
                     ...
                     if ((var6 = var7[var8 = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(var3)) & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) {
                        return false;
                     } else if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[var8]) == Double.doubleToLongBits(var4)) {
                           Byte2DoubleOpenCustomHashMap.this.removeEntry(var8);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var7[var8 = var8 + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(!Byte2DoubleOpenCustomHashMap.this.strategy.equals(var6, var3) || Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[var8]) != Double.doubleToLongBits(var4));
      ...
      public void forEach(Consumer<? super Byte2DoubleMap.Entry> var1) {
         if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.n], Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2DoubleOpenCustomHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleOpenCustomHashMap.this.key[var2], Byte2DoubleOpenCustomHashMap.this.value[var2]));
            }
         }

      }

      public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> var1) {
         AbstractByte2DoubleMap.BasicEntry var2 = new AbstractByte2DoubleMap.BasicEntry();
         if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
            var2.key = Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.n];
            var2.value = Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2DoubleOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2DoubleOpenCustomHashMap.this.key[var3] != 0) {
               var2.key = Byte2DoubleOpenCustomHashMap.this.key[var3];
               var2.value = Byte2DoubleOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2DoubleMap.Entry> {
      private final Byte2DoubleOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2DoubleOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2DoubleMap.Entry> {
      private Byte2DoubleOpenCustomHashMap.MapEntry entry;
      ...
      public Byte2DoubleOpenCustomHashMap.MapEntry next() {
         return this.entry = Byte2DoubleOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2DoubleOpenCustomHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(var2)) & Byte2DoubleOpenCustomHashMap.this.mask; !Byte2DoubleOpenCustomHashMap.this.strategy.equals(var2, var1[var3]); var3 = var3 + 1 & Byte2DoubleOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2DoubleOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(var4)) & Byte2DoubleOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2DoubleOpenCustomHashMap.this.value[var2] = Byte2DoubleOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2DoubleMap.Entry, java.util.Map.Entry<Byte, Double> {
      int index;
      ...
      public double setValue(double var1) {
         double var3 = Byte2DoubleOpenCustomHashMap.this.value[this.index];
         Byte2DoubleOpenCustomHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], (Byte)var2.getKey()) && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
