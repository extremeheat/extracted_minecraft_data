...
public class Byte2FloatRBTreeMap extends AbstractByte2FloatSortedMap implements Serializable, Cloneable {
   ...
   public Byte2FloatRBTreeMap(Comparator<? super Byte> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Byte2FloatRBTreeMap(Map<? extends Byte, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Byte2FloatRBTreeMap(SortedMap<Byte, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Byte2FloatRBTreeMap(Byte2FloatMap var1) {
      this();
      this.putAll(var1);
   }

   public Byte2FloatRBTreeMap(Byte2FloatSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Byte2FloatRBTreeMap(byte[] var1, float[] var2, Comparator<? super Byte> var3) {
      this(var3);
   ...
   public Byte2FloatRBTreeMap(byte[] var1, float[] var2) {
   ...
   final Byte2FloatRBTreeMap.Entry findKey(byte var1) {
      Byte2FloatRBTreeMap.Entry var2;
      int var3;
   ...
   final Byte2FloatRBTreeMap.Entry locateKey(byte var1) {
      Byte2FloatRBTreeMap.Entry var2 = this.tree;
      Byte2FloatRBTreeMap.Entry var3 = this.tree;
   ...
   public float addTo(byte var1, float var2) {
      Byte2FloatRBTreeMap.Entry var3 = this.add(var1);
   ...
   private Byte2FloatRBTreeMap.Entry add(byte var1) {
      this.modified = false;
      int var2 = 0;
      Byte2FloatRBTreeMap.Entry var3;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Byte2FloatRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Byte2FloatRBTreeMap.Entry var4 = this.tree;
         int var6 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var6++] = var5 > 0) {
               ...
               ++this.count;
               var3 = new Byte2FloatRBTreeMap.Entry(var1, this.defRetValue);
               if (var4.right == null) {
                  this.lastEntry = var3;
               }
            ...
            while(true) {
               ...
               Byte2FloatRBTreeMap.Entry var7;
               Byte2FloatRBTreeMap.Entry var8;
   ...
   public boolean containsValue(float var1) {
      Byte2FloatRBTreeMap.ValueIterator var2 = new Byte2FloatRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float get(byte var1) {
      Byte2FloatRBTreeMap.Entry var2 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>() {
            final Comparator<? super Byte2FloatMap.Entry> comparator = (var1x, var2) -> {
               return Byte2FloatRBTreeMap.this.actualComparator.compare(var1x.getByteKey(), var2.getByteKey());
            };
            ...
            public ObjectBidirectionalIterator<Byte2FloatMap.Entry> iterator(Byte2FloatMap.Entry var1) {
               return Byte2FloatRBTreeMap.this.new EntryIterator(var1.getByteKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        Byte2FloatRBTreeMap.Entry var3 = Byte2FloatRBTreeMap.this.findKey((Byte)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Byte) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                           Byte2FloatRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry var1, Byte2FloatMap.Entry var2) {
               return Byte2FloatRBTreeMap.this.subMap(var1.getByteKey(), var2.getByteKey()).byte2FloatEntrySet();
            }

            public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry var1) {
               return Byte2FloatRBTreeMap.this.headMap(var1.getByteKey()).byte2FloatEntrySet();
            }

            public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry var1) {
               return Byte2FloatRBTreeMap.this.tailMap(var1.getByteKey()).byte2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Byte2FloatRBTreeMap.this.containsValue(var1);
            }
   ...
   public Byte2FloatSortedMap headMap(byte var1) {
      return new Byte2FloatRBTreeMap.Submap((byte)0, true, var1, false);
   }

   public Byte2FloatSortedMap tailMap(byte var1) {
      return new Byte2FloatRBTreeMap.Submap(var1, false, (byte)0, true);
   }

   public Byte2FloatSortedMap subMap(byte var1, byte var2) {
      return new Byte2FloatRBTreeMap.Submap(var1, false, var2, false);
   }

   public Byte2FloatRBTreeMap clone() {
      Byte2FloatRBTreeMap var1;
      try {
         var1 = (Byte2FloatRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Byte2FloatRBTreeMap.Entry var5 = new Byte2FloatRBTreeMap.Entry();
         Byte2FloatRBTreeMap.Entry var6 = new Byte2FloatRBTreeMap.Entry();
         Byte2FloatRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Byte2FloatRBTreeMap.Entry var4 = var6;
         var6.pred((Byte2FloatRBTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Byte2FloatRBTreeMap.EntryIterator var3 = new Byte2FloatRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Byte2FloatRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Byte2FloatRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Byte2FloatRBTreeMap.Entry var3, Byte2FloatRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Byte2FloatRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Byte2FloatRBTreeMap.Entry(var1.readByte(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Byte2FloatRBTreeMap.Entry(var1.readByte(), var1.readFloat());
         var8.black(true);
         var8.right(new Byte2FloatRBTreeMap.Entry(var1.readByte(), var1.readFloat()));
         ...
         Byte2FloatRBTreeMap.Entry var7 = new Byte2FloatRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Byte2FloatRBTreeMap.Entry)null, (Byte2FloatRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractByte2FloatSortedMap implements Serializable {
      ...
      public Submap(byte var2, boolean var3, byte var4, boolean var5) {
         super();
         if (!var3 && !var5 && Byte2FloatRBTreeMap.this.compare(var2, var4) > 0) {
      ...
      public void clear() {
         Byte2FloatRBTreeMap.Submap.SubmapIterator var1 = new Byte2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(byte var1) {
         return (this.bottom || Byte2FloatRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Byte2FloatRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(byte var1) {
         return this.in(var1) && Byte2FloatRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Byte2FloatRBTreeMap.Submap.SubmapIterator var2 = new Byte2FloatRBTreeMap.Submap.SubmapIterator();
      ...
      public float get(byte var1) {
         Byte2FloatRBTreeMap.Entry var2;
         return this.in(var1) && (var2 = Byte2FloatRBTreeMap.this.findKey(var1)) != null ? var2.value : this.defRetValue;
      }
      ...
      public float put(byte var1, float var2) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Byte2FloatRBTreeMap.this.put(var1, var2);
            return Byte2FloatRBTreeMap.this.modified ? this.defRetValue : var3;
         }
      }
      ...
      public float remove(byte var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var2 = Byte2FloatRBTreeMap.this.remove(var1);
            return Byte2FloatRBTreeMap.this.modified ? var2 : this.defRetValue;
         }
      }
      ...
      public Byte2FloatSortedMap headMap(byte var1) {
         if (this.top) {
            return Byte2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Byte2FloatRBTreeMap.this.compare(var1, this.to) < 0 ? Byte2FloatRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Byte2FloatSortedMap tailMap(byte var1) {
         if (this.bottom) {
            return Byte2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Byte2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? Byte2FloatRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Byte2FloatSortedMap subMap(byte var1, byte var2) {
         if (this.top && this.bottom) {
            return Byte2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         } else {
            if (!this.top) {
               var2 = Byte2FloatRBTreeMap.this.compare(var2, this.to) < 0 ? var2 : this.to;
            }

            if (!this.bottom) {
               var1 = Byte2FloatRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var2 == this.to ? this : Byte2FloatRBTreeMap.this.new Submap(var1, false, var2, false);
         }
      }
      ...
      public Byte2FloatRBTreeMap.Entry firstEntry() {
         if (Byte2FloatRBTreeMap.this.tree == null) {
            ...
            Byte2FloatRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Byte2FloatRBTreeMap.this.firstEntry;
            } else {
               var1 = Byte2FloatRBTreeMap.this.locateKey(this.from);
               if (Byte2FloatRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Byte2FloatRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Byte2FloatRBTreeMap.Entry lastEntry() {
         if (Byte2FloatRBTreeMap.this.tree == null) {
            ...
            Byte2FloatRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Byte2FloatRBTreeMap.this.lastEntry;
            } else {
               var1 = Byte2FloatRBTreeMap.this.locateKey(this.to);
               if (Byte2FloatRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Byte2FloatRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public byte firstByteKey() {
         Byte2FloatRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public byte lastByteKey() {
         Byte2FloatRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Byte2FloatRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2FloatMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Byte2FloatRBTreeMap.TreeIterator {
         ...
         SubmapIterator(byte var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Byte2FloatRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Byte2FloatRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Byte2FloatRBTreeMap.this.locateKey(var2);
                  if (Byte2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractByte2FloatSortedMap.KeySet {
      ...
      public ByteBidirectionalIterator iterator(byte var1) {
         return Byte2FloatRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Byte2FloatRBTreeMap.TreeIterator implements ObjectListIterator<Byte2FloatMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(byte var2) {
         super();
         if ((this.next = Byte2FloatRBTreeMap.this.locateKey(var2)) != null) {
            if (Byte2FloatRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractByte2FloatMap.BasicEntry implements Cloneable {
      ...
      void pred(Byte2FloatRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Byte2FloatRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Byte2FloatRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Byte2FloatRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Byte2FloatRBTreeMap.Entry next() {
         Byte2FloatRBTreeMap.Entry var1 = this.right;
      ...
      Byte2FloatRBTreeMap.Entry prev() {
         Byte2FloatRBTreeMap.Entry var1 = this.left;
      ...
      public Byte2FloatRBTreeMap.Entry clone() {
         Byte2FloatRBTreeMap.Entry var1;
         try {
            var1 = (Byte2FloatRBTreeMap.Entry)super.clone();
