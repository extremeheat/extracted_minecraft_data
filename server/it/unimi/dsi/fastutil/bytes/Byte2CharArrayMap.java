...
public class Byte2CharArrayMap extends AbstractByte2CharMap implements Serializable, Cloneable {
   ...
   public Byte2CharArrayMap(byte[] var1, char[] var2) {
      super();
      this.key = var1;
      this.value = var2;
   ...
   public Byte2CharArrayMap(int var1) {
      super();
      this.key = new byte[var1];
      this.value = new char[var1];
   }

   public Byte2CharArrayMap(Byte2CharMap var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2CharArrayMap(Map<? extends Byte, ? extends Character> var1) {
      this(var1.size());
      this.putAll(var1);
   }

   public Byte2CharArrayMap(byte[] var1, char[] var2, int var3) {
      super();
      this.key = var1;
      this.value = var2;
      this.size = var3;
   ...
   public ByteSet keySet() {
      return new AbstractByteSet() {
         public boolean contains(byte var1) {
            return Byte2CharArrayMap.this.findKey(var1) != -1;
         }

         public boolean remove(byte var1) {
            int var2 = Byte2CharArrayMap.this.findKey(var1);
            if (var2 == -1) {
               return false;
            } else {
               int var3 = Byte2CharArrayMap.this.size - var2 - 1;
               System.arraycopy(Byte2CharArrayMap.this.key, var2 + 1, Byte2CharArrayMap.this.key, var2, var3);
               System.arraycopy(Byte2CharArrayMap.this.value, var2 + 1, Byte2CharArrayMap.this.value, var2, var3);
            ...
            return new ByteIterator() {
               ...
               public void remove() {
                  if (this.pos == 0) {
                     ...
                     int var1 = Byte2CharArrayMap.this.size - this.pos;
                     System.arraycopy(Byte2CharArrayMap.this.key, this.pos, Byte2CharArrayMap.this.key, this.pos - 1, var1);
                     System.arraycopy(Byte2CharArrayMap.this.value, this.pos, Byte2CharArrayMap.this.value, this.pos - 1, var1);
                     Byte2CharArrayMap.this.size--;
                  }
               }
            };
   ...
   public CharCollection values() {
      return new AbstractCharCollection() {
         public boolean contains(char var1) {
            return Byte2CharArrayMap.this.containsValue(var1);
         }
   ...
   public Byte2CharArrayMap clone() {
      Byte2CharArrayMap var1;
      try {
         var1 = (Byte2CharArrayMap)super.clone();
         ...
         return new ObjectIterator<Byte2CharMap.Entry>() {
            ...
            public void remove() {
               if (this.curr == -1) {
                  ...
                  this.curr = -1;
                  int var1 = Byte2CharArrayMap.this.size-- - this.next--;
                  System.arraycopy(Byte2CharArrayMap.this.key, this.next + 1, Byte2CharArrayMap.this.key, this.next, var1);
                  System.arraycopy(Byte2CharArrayMap.this.value, this.next + 1, Byte2CharArrayMap.this.value, this.next, var1);
               }
            }
         };
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  return Byte2CharArrayMap.this.containsKey(var3) && Byte2CharArrayMap.this.get(var3) == (Character)var2.getValue();
               } else {
                  return false;
               }
            } else {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  int var5 = Byte2CharArrayMap.this.findKey(var3);
                  if (var5 != -1 && var4 == Byte2CharArrayMap.this.value[var5]) {
                     int var6 = Byte2CharArrayMap.this.size - var5 - 1;
                     System.arraycopy(Byte2CharArrayMap.this.key, var5 + 1, Byte2CharArrayMap.this.key, var5, var6);
                     System.arraycopy(Byte2CharArrayMap.this.value, var5 + 1, Byte2CharArrayMap.this.value, var5, var6);
                     Byte2CharArrayMap.this.size--;
                     return true;
                  } else {
                     return false;
