...
public class Byte2ReferenceOpenHashMap<V> extends AbstractByte2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Byte2ReferenceOpenHashMap(int var1, float var2) {
      super();
   ...
   public Byte2ReferenceOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Byte2ReferenceOpenHashMap(Map<? extends Byte, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2ReferenceOpenHashMap(Map<? extends Byte, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Byte2ReferenceOpenHashMap(Byte2ReferenceMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2ReferenceOpenHashMap(Byte2ReferenceMap<V> var1) {
      this(var1, 0.75F);
   }

   public Byte2ReferenceOpenHashMap(byte[] var1, V[] var2, float var3) {
   ...
   public Byte2ReferenceOpenHashMap(byte[] var1, V[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Byte2ReferenceOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
                  var1.accept(Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n]);
               }

               int var2 = Byte2ReferenceOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2ReferenceOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2ReferenceOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2ReferenceOpenHashMap<V> clone() {
      Byte2ReferenceOpenHashMap var1;
      try {
         var1 = (Byte2ReferenceOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      Object[] var3 = this.value;
      Byte2ReferenceOpenHashMap.MapIterator var4 = new Byte2ReferenceOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Byte2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n]);
         }

         int var2 = Byte2ReferenceOpenHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2ReferenceOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2ReferenceOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2ReferenceOpenHashMap.this.size;
         Byte2ReferenceOpenHashMap.this.remove(var1);
         return Byte2ReferenceOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Byte2ReferenceOpenHashMap<V>.MapIterator implements ByteIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               if (var3 == 0) {
                  return Byte2ReferenceOpenHashMap.this.containsNullKey && Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n] == var4;
               } else {
                  byte[] var6 = Byte2ReferenceOpenHashMap.this.key;
                  byte var5;
                  int var7;
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2ReferenceOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (var3 == var5) {
                     return Byte2ReferenceOpenHashMap.this.value[var7] == var4;
                  } else {
                     while((var5 = var6[var7 = var7 + 1 & Byte2ReferenceOpenHashMap.this.mask]) != 0) {
                        if (var3 == var5) {
                           return Byte2ReferenceOpenHashMap.this.value[var7] == var4;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               ...
               Object var4 = var2.getValue();
               if (var3 == 0) {
                  if (Byte2ReferenceOpenHashMap.this.containsNullKey && Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n] == var4) {
                  ...
                  if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2ReferenceOpenHashMap.this.mask]) == 0) {
                     ...
                     if (Byte2ReferenceOpenHashMap.this.value[var7] == var4) {
                        Byte2ReferenceOpenHashMap.this.removeEntry(var7);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var5 = var6[var7 = var7 + 1 & Byte2ReferenceOpenHashMap.this.mask]) == 0) {
                           return false;
                        }
                     } while(var5 != var3 || Byte2ReferenceOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> var1) {
         if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n], Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2ReferenceOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceOpenHashMap.this.key[var2], Byte2ReferenceOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> var1) {
         ...
         if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
            var2.key = Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n];
            var2.value = Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2ReferenceOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2ReferenceOpenHashMap.this.key[var3] != 0) {
               var2.key = Byte2ReferenceOpenHashMap.this.key[var3];
               var2.value = Byte2ReferenceOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
      private final Byte2ReferenceOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2ReferenceOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2ReferenceOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Byte2ReferenceOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Byte2ReferenceOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2ReferenceOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2ReferenceOpenHashMap.this.mask;

            byte var4;
            while(true) {
               if ((var4 = var5[var1]) == 0) {
                  var5[var2] = 0;
                  Byte2ReferenceOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(var4) & Byte2ReferenceOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2ReferenceOpenHashMap.this.value[var2] = Byte2ReferenceOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2ReferenceMap.Entry<V>, java.util.Map.Entry<Byte, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Byte2ReferenceOpenHashMap.this.value[this.index];
         Byte2ReferenceOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2ReferenceOpenHashMap.this.key[this.index] == (Byte)var2.getKey() && Byte2ReferenceOpenHashMap.this.value[this.index] == var2.getValue();
         }
      }
