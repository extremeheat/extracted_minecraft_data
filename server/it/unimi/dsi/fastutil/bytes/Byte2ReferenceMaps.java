...
public final class Byte2ReferenceMaps {
   ...
   public static <V> ObjectIterator<Byte2ReferenceMap.Entry<V>> fastIterator(Byte2ReferenceMap<V> var0) {
      ObjectSet var1 = var0.byte2ReferenceEntrySet();
      return var1 instanceof Byte2ReferenceMap.FastEntrySet ? ((Byte2ReferenceMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static <V> void fastForEach(Byte2ReferenceMap<V> var0, Consumer<? super Byte2ReferenceMap.Entry<V>> var1) {
      ObjectSet var2 = var0.byte2ReferenceEntrySet();
      if (var2 instanceof Byte2ReferenceMap.FastEntrySet) {
         ((Byte2ReferenceMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static <V> ObjectIterable<Byte2ReferenceMap.Entry<V>> fastIterable(Byte2ReferenceMap<V> var0) {
      final ObjectSet var1 = var0.byte2ReferenceEntrySet();
      return (ObjectIterable)(var1 instanceof Byte2ReferenceMap.FastEntrySet ? new ObjectIterable<Byte2ReferenceMap.Entry<V>>() {
         public ObjectIterator<Byte2ReferenceMap.Entry<V>> iterator() {
            return ((Byte2ReferenceMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> var1x) {
            ((Byte2ReferenceMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }
   ...
   public static <V> Byte2ReferenceMap<V> singleton(byte var0, V var1) {
      return new Byte2ReferenceMaps.Singleton(var0, var1);
   }
   ...
   public static <V> Byte2ReferenceMap<V> synchronize(Byte2ReferenceMap<V> var0) {
      return new Byte2ReferenceMaps.SynchronizedMap(var0);
   }

   public static <V> Byte2ReferenceMap<V> synchronize(Byte2ReferenceMap<V> var0, Object var1) {
      return new Byte2ReferenceMaps.SynchronizedMap(var0, var1);
   }

   public static <V> Byte2ReferenceMap<V> unmodifiable(Byte2ReferenceMap<V> var0) {
      return new Byte2ReferenceMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap<V> extends Byte2ReferenceFunctions.UnmodifiableFunction<V> implements Byte2ReferenceMap<V>, Serializable {
      ...
      protected UnmodifiableMap(Byte2ReferenceMap<V> var1) {
         super(var1);
         this.map = var1;
      }
      ...
      public V computeIfAbsentPartial(byte var1, Byte2ReferenceFunction<? extends V> var2) {
         throw new UnsupportedOperationException();
      }
   ...
   public static class SynchronizedMap<V> extends Byte2ReferenceFunctions.SynchronizedFunction<V> implements Byte2ReferenceMap<V>, Serializable {
      ...
      protected SynchronizedMap(Byte2ReferenceMap<V> var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Byte2ReferenceMap<V> var1) {
         super(var1);
         this.map = var1;
      }
