...
public class ByteLinkedOpenHashSet extends AbstractByteSortedSet implements Serializable, Cloneable, Hash {
   ...
   public ByteLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public ByteLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public ByteLinkedOpenHashSet(Collection<? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ByteLinkedOpenHashSet(Collection<? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public ByteLinkedOpenHashSet(ByteCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public ByteLinkedOpenHashSet(ByteCollection var1) {
      this(var1, 0.75F);
   }

   public ByteLinkedOpenHashSet(ByteIterator var1, float var2) {
      this(16, var2);
   ...
   public ByteLinkedOpenHashSet(ByteIterator var1) {
      this(var1, 0.75F);
   }

   public ByteLinkedOpenHashSet(Iterator<?> var1, float var2) {
      this(ByteIterators.asByteIterator(var1), var2);
   }

   public ByteLinkedOpenHashSet(Iterator<?> var1) {
      this(ByteIterators.asByteIterator(var1));
   }

   public ByteLinkedOpenHashSet(byte[] var1, int var2, int var3, float var4) {
   ...
   public ByteLinkedOpenHashSet(byte[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public ByteLinkedOpenHashSet(byte[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public ByteLinkedOpenHashSet(byte[] var1) {
      this(var1, 0.75F);
   }
   ...
   public ByteListIterator iterator(byte var1) {
      return new ByteLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   public ByteLinkedOpenHashSet clone() {
      ByteLinkedOpenHashSet var1;
      try {
         var1 = (ByteLinkedOpenHashSet)super.clone();
   ...
   private class SetIterator implements ByteListIterator {
      ...
      SetIterator(byte var2) {
         ...
         } else if (ByteLinkedOpenHashSet.this.key[ByteLinkedOpenHashSet.this.last] == var2) {
            this.prev = ByteLinkedOpenHashSet.this.last;
            this.index = ByteLinkedOpenHashSet.this.size;
         } else {
            byte[] var3 = ByteLinkedOpenHashSet.this.key;

            for(int var4 = HashCommon.mix(var2) & ByteLinkedOpenHashSet.this.mask; var3[var4] != 0; var4 = var4 + 1 & ByteLinkedOpenHashSet.this.mask) {
               if (var3[var4] == var2) {
                  this.next = (int)ByteLinkedOpenHashSet.this.link[var4];
                  this.prev = var4;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = ByteLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)ByteLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var6 = ByteLinkedOpenHashSet.this.link;
               var10001 = this.prev;
               var6[var10001] ^= (ByteLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var6 = ByteLinkedOpenHashSet.this.link;
               var10001 = this.next;
               var6[var10001] ^= (ByteLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == ByteLinkedOpenHashSet.this.n) {
               ByteLinkedOpenHashSet.this.containsNull = false;
               ByteLinkedOpenHashSet.this.key[ByteLinkedOpenHashSet.this.n] = 0;
            } else {
               byte[] var5 = ByteLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & ByteLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(var4) & ByteLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  ByteLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
