...
public final class Byte2IntFunctions {
   ...
   public static Byte2IntFunction singleton(byte var0, int var1) {
      return new Byte2IntFunctions.Singleton(var0, var1);
   }

   public static Byte2IntFunction singleton(Byte var0, Integer var1) {
      return new Byte2IntFunctions.Singleton(var0, var1);
   }

   public static Byte2IntFunction synchronize(Byte2IntFunction var0) {
      return new Byte2IntFunctions.SynchronizedFunction(var0);
   }

   public static Byte2IntFunction synchronize(Byte2IntFunction var0, Object var1) {
      return new Byte2IntFunctions.SynchronizedFunction(var0, var1);
   }

   public static Byte2IntFunction unmodifiable(Byte2IntFunction var0) {
      return new Byte2IntFunctions.UnmodifiableFunction(var0);
   }

   public static Byte2IntFunction primitive(Function<? super Byte, ? extends Integer> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Byte2IntFunction) {
         return (Byte2IntFunction)var0;
         ...
         return new Byte2IntFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Byte2IntFunction {
      ...
      protected PrimitiveFunction(Function<? super Byte, ? extends Integer> var1) {
         super();
         this.function = var1;
      }
      ...
      public Integer get(Object var1) {
         return var1 == null ? null : (Integer)this.function.apply((Byte)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractByte2IntFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Byte2IntFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Byte2IntFunction, Serializable {
      ...
      protected SynchronizedFunction(Byte2IntFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Byte2IntFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      /** @deprecated */
      @Deprecated
      public Integer apply(Byte var1) {
         synchronized(this.sync) {
