...
public abstract class AbstractByteList extends AbstractByteCollection implements ByteList, ByteStack {
   ...
   public ByteListIterator listIterator(final int var1) {
      ...
      return new ByteListIterator() {
         ...
         public void add(byte var1x) {
            AbstractByteList.this.add(this.pos++, var1x);
            this.last = -1;
         }
         ...
         public void set(byte var1x) {
            if (this.last == -1) {
               ...
               AbstractByteList.this.set(this.last, var1x);
            }
         }
   ...
   public int lastIndexOf(byte var1) {
      ByteListIterator var2 = this.listIterator(this.size());
   ...
   public ByteList subList(int var1, int var2) {
      ...
      if (var1 > var2) {
         ...
         return new AbstractByteList.ByteSubList(this, var1, var2);
      }
   }

   public void removeElements(int var1, int var2) {
      this.ensureIndex(var2);
      ByteListIterator var3 = this.listIterator(var1);
      int var4 = var2 - var1;
      if (var4 < 0) {
   ...
   public void getElements(int var1, byte[] var2, int var3, int var4) {
      ByteListIterator var5 = this.listIterator(var1);
      if (var3 < 0) {
         throw new ArrayIndexOutOfBoundsException("Offset (" + var3 + ") is negative");
      } else if (var3 + var4 > var2.length) {
         throw new ArrayIndexOutOfBoundsException("End index (" + (var3 + var4) + ") is greater than array length (" + var2.length + ")");
   ...
   public int hashCode() {
      ByteListIterator var1 = this.iterator();
      int var2 = 1;
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         if (var3 != var2.size()) {
            ...
            ByteListIterator var4;
            if (var2 instanceof ByteList) {
               var4 = this.listIterator();
               ByteListIterator var6 = ((ByteList)var2).listIterator();

               do {
                  if (var3-- == 0) {
                     return true;
                  }
               } while(var4.nextByte() == var6.nextByte());
   ...
   public int compareTo(List<? extends Byte> var1) {
      if (var1 == this) {
         ...
         ByteListIterator var2;
         int var4;
         if (var1 instanceof ByteList) {
            var2 = this.listIterator();
            ByteListIterator var7 = ((ByteList)var1).listIterator();
   ...
   public byte peekByte(int var1) {
      return this.getByte(this.size() - 1 - var1);
   }
   ...
   public boolean addAll(int var1, ByteCollection var2) {
      this.ensureIndex(var1);
      ByteIterator var3 = var2.iterator();
      boolean var4 = var3.hasNext();

      while(var3.hasNext()) {
         this.add(var1++, var3.nextByte());
      }
   ...
   public boolean addAll(int var1, ByteList var2) {
      return this.addAll(var1, (ByteCollection)var2);
   }
   ...
   public static class ByteSubList extends AbstractByteList implements Serializable {
      ...
      public ByteSubList(ByteList var1, int var2, int var3) {
         super();
         this.l = var1;
         this.from = var2;
         this.to = var3;
         ...
         return new ByteListIterator() {
            ...
            public void add(byte var1x) {
               if (this.last == -1) {
                  ...
                  ByteSubList.this.add(this.pos++, var1x);
                  this.last = -1;
