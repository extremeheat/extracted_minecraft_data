...
public final class Byte2DoubleFunctions {
   ...
   public static Byte2DoubleFunction singleton(byte var0, double var1) {
      return new Byte2DoubleFunctions.Singleton(var0, var1);
   }
   ...
   public static Byte2DoubleFunction synchronize(Byte2DoubleFunction var0) {
      return new Byte2DoubleFunctions.SynchronizedFunction(var0);
   }

   public static Byte2DoubleFunction synchronize(Byte2DoubleFunction var0, Object var1) {
      return new Byte2DoubleFunctions.SynchronizedFunction(var0, var1);
   }

   public static Byte2DoubleFunction unmodifiable(Byte2DoubleFunction var0) {
      return new Byte2DoubleFunctions.UnmodifiableFunction(var0);
   }

   public static Byte2DoubleFunction primitive(Function<? super Byte, ? extends Double> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Byte2DoubleFunction) {
         return (Byte2DoubleFunction)var0;
         ...
         return new Byte2DoubleFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class PrimitiveFunction implements Byte2DoubleFunction {
      ...
      protected PrimitiveFunction(Function<? super Byte, ? extends Double> var1) {
         super();
         this.function = var1;
      }
      ...
      public Double get(Object var1) {
         return var1 == null ? null : (Double)this.function.apply((Byte)var1);
      }
   ...
   public static class UnmodifiableFunction extends AbstractByte2DoubleFunction implements Serializable {
      ...
      protected UnmodifiableFunction(Byte2DoubleFunction var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction implements Byte2DoubleFunction, Serializable {
      ...
      protected SynchronizedFunction(Byte2DoubleFunction var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Byte2DoubleFunction var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
