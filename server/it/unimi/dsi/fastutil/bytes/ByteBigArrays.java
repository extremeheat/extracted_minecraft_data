...
public final class ByteBigArrays {
   ...
   public static byte get(byte[][] var0, long var1) {
      return var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void set(byte[][] var0, long var1, byte var3) {
      var0[BigArrays.segment(var1)][BigArrays.displacement(var1)] = var3;
   }

   public static void swap(byte[][] var0, long var1, long var3) {
      byte var5 = var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   ...
   public static void add(byte[][] var0, long var1, byte var3) {
      byte[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] += var3;
   }

   public static void mul(byte[][] var0, long var1, byte var3) {
      byte[] var10000 = var0[BigArrays.segment(var1)];
      int var10001 = BigArrays.displacement(var1);
      var10000[var10001] *= var3;
   }

   public static void incr(byte[][] var0, long var1) {
      ++var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static void decr(byte[][] var0, long var1) {
      --var0[BigArrays.segment(var1)][BigArrays.displacement(var1)];
   }

   public static long length(byte[][] var0) {
      int var1 = var0.length;
      return var1 == 0 ? 0L : BigArrays.start(var1 - 1) + (long)var0[var1 - 1].length;
   }

   public static void copy(byte[][] var0, long var1, byte[][] var3, long var4, long var6) {
      int var8;
      int var9;
      int var10;
      int var11;
   ...
   public static void copyFromBig(byte[][] var0, long var1, byte[] var3, int var4, int var5) {
   ...
   public static void copyToBig(byte[] var0, int var1, byte[][] var2, long var3, long var5) {
   ...
   public static byte[][] newBigArray(long var0) {
      if (var0 == 0L) {
         ...
         if (var4 != 0) {
            for(var5 = 0; var5 < var2 - 1; ++var5) {
               var3[var5] = new byte[134217728];
            }

            var3[var2 - 1] = new byte[var4];
         } else {
   ...
   public static byte[][] wrap(byte[] var0) {
      if (var0.length == 0) {
         return EMPTY_BIG_ARRAY;
      } else if (var0.length <= 134217728) {
         return new byte[][]{var0};
      } else {
         byte[][] var1 = newBigArray((long)var0.length);
   ...
   public static byte[][] ensureCapacity(byte[][] var0, long var1) {
      return ensureCapacity(var0, var1, length(var0));
   }

   public static byte[][] forceCapacity(byte[][] var0, long var1, long var3) {
      ...
      byte[][] var7 = (byte[][])Arrays.copyOf(var0, var6);
      int var8 = (int)(var1 & 134217727L);
      int var9;
      if (var8 != 0) {
         for(var9 = var5; var9 < var6 - 1; ++var9) {
            var7[var9] = new byte[134217728];
         }

         var7[var6 - 1] = new byte[var8];
      } else {
   ...
   public static byte[][] trim(byte[][] var0, long var1) {
      ...
      if (var1 >= var3) {
         ...
         byte[][] var6 = (byte[][])Arrays.copyOf(var0, var5);
         int var7 = (int)(var1 & 134217727L);
         if (var7 != 0) {
            var6[var5 - 1] = ByteArrays.trim(var6[var5 - 1], var7);
         }
   ...
   public static byte[][] setLength(byte[][] var0, long var1) {
      long var3 = length(var0);
      if (var1 == var3) {
         return var0;
      } else {
   ...
   public static byte[][] copy(byte[][] var0, long var1, long var3) {
      ensureOffsetLength(var0, var1, var3);
      byte[][] var5 = newBigArray(var3);
   ...
   public static byte[][] copy(byte[][] var0) {
      ...
      for(int var2 = var1.length; var2-- != 0; var1[var2] = (byte[])var0[var2].clone()) {
      }
   ...
   public static void fill(byte[][] var0, long var1, long var3, byte var5) {
   ...
   public static void ensureFromTo(byte[][] var0, long var1, long var3) {
      BigArrays.ensureFromTo(length(var0), var1, var3);
   }

   public static void ensureOffsetLength(byte[][] var0, long var1, long var3) {
      BigArrays.ensureOffsetLength(length(var0), var1, var3);
   }

   private static void vecSwap(byte[][] var0, long var1, long var3, long var5) {
   ...
   private static long med3(byte[][] var0, long var1, long var3, long var5, ByteComparator var7) {
   ...
   private static void selectionSort(byte[][] var0, long var1, long var3, ByteComparator var5) {
   ...
   public static void quickSort(byte[][] var0, long var1, long var3, ByteComparator var5) {
      long var6 = var3 - var1;
      if (var6 < 7L) {
   ...
   private static long med3(byte[][] var0, long var1, long var3, long var5) {
      int var7 = Byte.compare(get(var0, var1), get(var0, var3));
      int var8 = Byte.compare(get(var0, var1), get(var0, var5));
      int var9 = Byte.compare(get(var0, var3), get(var0, var5));
      return var7 < 0 ? (var9 < 0 ? var3 : (var8 < 0 ? var5 : var1)) : (var9 > 0 ? var3 : (var8 > 0 ? var5 : var1));
   }

   private static void selectionSort(byte[][] var0, long var1, long var3) {
   ...
   public static void quickSort(byte[][] var0, long var1, long var3) {
      long var5 = var3 - var1;
      if (var5 < 7L) {
         ...
         while(true) {
            int var18;
            while(var12 > var14 || (var18 = Byte.compare(get(var0, var12), var22)) > 0) {
               for(; var14 >= var12 && (var18 = Byte.compare(get(var0, var14), var22)) >= 0; --var14) {
                  if (var18 == 0) {
   ...
   public static long binarySearch(byte[][] var0, long var1, long var3, byte var5) {
      --var3;

      while(var1 <= var3) {
         long var7 = var1 + var3 >>> 1;
         byte var6 = get(var0, var7);
         if (var6 < var5) {
            var1 = var7 + 1L;
         } else {
            if (var6 <= var5) {
   ...
   public static long binarySearch(byte[][] var0, byte var1) {
      return binarySearch(var0, 0L, length(var0), var1);
   }

   public static long binarySearch(byte[][] var0, long var1, long var3, byte var5, ByteComparator var6) {
      --var3;

      while(var1 <= var3) {
         long var8 = var1 + var3 >>> 1;
         byte var7 = get(var0, var8);
   ...
   public static long binarySearch(byte[][] var0, byte var1, ByteComparator var2) {
   ...
   public static void radixSort(byte[][] var0, long var1, long var3) {
      boolean var5 = false;
      boolean var6 = true;
      long[] var7 = new long[1];
      byte var8 = 0;
      ...
      byte[][] var15 = newBigArray(var3 - var1);
      ...
      while(true) {
         while(var36 > 0) {
            ...
            int var21 = var20 % 1 == 0 ? 128 : 0;
            if (var18 < 40L) {
               selectionSort(var0, var16, var16 + var18);
            } else {
               int var22 = (0 - var20 % 1) * 8;
               long var23 = var18;

               while(var23-- != 0L) {
                  set(var15, var23, (byte)(get(var0, var16 + var23) >>> var22 & 255 ^ var21));
               }

               for(var23 = var18; var23-- != 0L; ++var13[get(var15, var23) & 255]) {
               }
               ...
               for(long var29 = 0L; var29 < var41; var13[var42] = 0L) {
                  byte var33 = get(var0, var29 + var16);
                  var42 = get(var15, var29) & 255;
                  ...
                  while((var31 = --var14[var42]) > var29) {
                     ...
                     var42 = get(var15, var31) & 255;
                     set(var0, var31 + var16, var34);
                     set(var15, var31, (byte)var35);
                  }
   ...
   private static void selectionSort(byte[][] var0, byte[][] var1, long var2, long var4) {
   ...
   public static void radixSort(byte[][] var0, byte[][] var1, long var2, long var4) {
      boolean var6 = true;
      if (length(var0) != length(var1)) {
         ...
         byte[][] var17 = newBigArray(var4 - var2);
         ...
         while(true) {
            while(var40 > 0) {
               ...
               int var23 = var22 % 1 == 0 ? 128 : 0;
               if (var20 < 40L) {
                  selectionSort(var0, var1, var18, var18 + var20);
               } else {
                  byte[][] var24 = var22 < 1 ? var0 : var1;
                  int var25 = (0 - var22 % 1) * 8;
                  long var26 = var20;

                  while(var26-- != 0L) {
                     set(var17, var26, (byte)(get(var24, var18 + var26) >>> var25 & 255 ^ var23));
                  }

                  for(var26 = var20; var26-- != 0L; ++var15[get(var17, var26) & 255]) {
                  }
                  ...
                  for(long var32 = 0L; var32 < var45; var15[var46] = 0L) {
                     byte var36 = get(var0, var32 + var18);
                     byte var37 = get(var1, var32 + var18);
                     var46 = get(var17, var32) & 255;
                     ...
                     while((var34 = --var16[var46]) > var32) {
                        ...
                        var46 = get(var17, var34) & 255;
                        set(var17, var34, (byte)var39);
                     }
   ...
   public static byte[][] shuffle(byte[][] var0, long var1, long var3, Random var5) {
      long var6 = var3 - var1;

      while(var6-- != 0L) {
         long var8 = (var5.nextLong() & 9223372036854775807L) % (var6 + 1L);
         byte var10 = get(var0, var1 + var6);
   ...
   private static final class BigArrayHashStrategy implements Hash.Strategy<byte[][]>, Serializable {
      ...
      public boolean equals(byte[][] var1, byte[][] var2) {
         return ByteBigArrays.equals(var1, var2);
      }
