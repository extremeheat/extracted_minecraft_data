...
public class Byte2ByteOpenHashMap extends AbstractByte2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Byte2ByteOpenHashMap(int var1, float var2) {
      super();
   ...
   public Byte2ByteOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> var1) {
      this(var1, 0.75F);
   }

   public Byte2ByteOpenHashMap(Byte2ByteMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Byte2ByteOpenHashMap(Byte2ByteMap var1) {
      this(var1, 0.75F);
   }

   public Byte2ByteOpenHashMap(byte[] var1, byte[] var2, float var3) {
   ...
   public Byte2ByteOpenHashMap(byte[] var1, byte[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Byte2ByteOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Byte2ByteOpenHashMap.this.containsNullKey) {
                  var1.accept(Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n]);
               }

               int var2 = Byte2ByteOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Byte2ByteOpenHashMap.this.key[var2] != 0) {
                     var1.accept(Byte2ByteOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Byte2ByteOpenHashMap clone() {
      Byte2ByteOpenHashMap var1;
      try {
         var1 = (Byte2ByteOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      byte[] var2 = this.key;
      byte[] var3 = this.value;
      Byte2ByteOpenHashMap.MapIterator var4 = new Byte2ByteOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Byte2ByteOpenHashMap.MapIterator implements ByteIterator {
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public void forEach(IntConsumer var1) {
         if (Byte2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n]);
         }

         int var2 = Byte2ByteOpenHashMap.this.n;

         while(var2-- != 0) {
            byte var3 = Byte2ByteOpenHashMap.this.key[var2];
            if (var3 != 0) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(byte var1) {
         return Byte2ByteOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(byte var1) {
         int var2 = Byte2ByteOpenHashMap.this.size;
         Byte2ByteOpenHashMap.this.remove(var1);
         return Byte2ByteOpenHashMap.this.size != var2;
      }
   ...
   private final class KeyIterator extends Byte2ByteOpenHashMap.MapIterator implements ByteIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (var3 == 0) {
                     return Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n] == var4;
                  } else {
                     byte[] var6 = Byte2ByteOpenHashMap.this.key;
                     byte var5;
                     int var7;
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2ByteOpenHashMap.this.mask]) == 0) {
                        return false;
                     } else if (var3 == var5) {
                        return Byte2ByteOpenHashMap.this.value[var7] == var4;
                     } else {
                        while((var5 = var6[var7 = var7 + 1 & Byte2ByteOpenHashMap.this.mask]) != 0) {
                           if (var3 == var5) {
                              return Byte2ByteOpenHashMap.this.value[var7] == var4;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Byte) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var4 = (Byte)var2.getValue();
                  if (var3 == 0) {
                     if (Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n] == var4) {
                     ...
                     if ((var5 = var6[var7 = HashCommon.mix(var3) & Byte2ByteOpenHashMap.this.mask]) == 0) {
                        ...
                        if (Byte2ByteOpenHashMap.this.value[var7] == var4) {
                           Byte2ByteOpenHashMap.this.removeEntry(var7);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var5 = var6[var7 = var7 + 1 & Byte2ByteOpenHashMap.this.mask]) == 0) {
                              return false;
                           }
                        } while(var5 != var3 || Byte2ByteOpenHashMap.this.value[var7] != var4);
      ...
      public void forEach(Consumer<? super Byte2ByteMap.Entry> var1) {
         if (Byte2ByteOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n], Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Byte2ByteOpenHashMap.this.key[var2] != 0) {
               var1.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteOpenHashMap.this.key[var2], Byte2ByteOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Byte2ByteMap.Entry> var1) {
         ...
         if (Byte2ByteOpenHashMap.this.containsNullKey) {
            var2.key = Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n];
            var2.value = Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Byte2ByteOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Byte2ByteOpenHashMap.this.key[var3] != 0) {
               var2.key = Byte2ByteOpenHashMap.this.key[var3];
               var2.value = Byte2ByteOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Byte2ByteOpenHashMap.MapIterator implements ObjectIterator<Byte2ByteMap.Entry> {
      private final Byte2ByteOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Byte2ByteOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Byte2ByteOpenHashMap.MapIterator implements ObjectIterator<Byte2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               byte[] var1 = Byte2ByteOpenHashMap.this.key;
               ...
               int var3;
               for(var3 = HashCommon.mix(var2) & Byte2ByteOpenHashMap.this.mask; var2 != var1[var3]; var3 = var3 + 1 & Byte2ByteOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         byte[] var5 = Byte2ByteOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Byte2ByteOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(var4) & Byte2ByteOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var5[var2] = var4;
            Byte2ByteOpenHashMap.this.value[var2] = Byte2ByteOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Byte2ByteMap.Entry, java.util.Map.Entry<Byte, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Byte2ByteOpenHashMap.this.value[this.index];
         Byte2ByteOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Byte2ByteOpenHashMap.this.key[this.index] == (Byte)var2.getKey() && Byte2ByteOpenHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
