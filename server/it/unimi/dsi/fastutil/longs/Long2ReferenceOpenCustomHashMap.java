...
public class Long2ReferenceOpenCustomHashMap<V> extends AbstractLong2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Long2ReferenceOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2ReferenceOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ReferenceOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2ReferenceOpenCustomHashMap(Map<? extends Long, ? extends V> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2ReferenceOpenCustomHashMap(Map<? extends Long, ? extends V> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ReferenceOpenCustomHashMap(Long2ReferenceMap<V> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2ReferenceOpenCustomHashMap(Long2ReferenceMap<V> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ReferenceOpenCustomHashMap(long[] var1, V[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2ReferenceOpenCustomHashMap(long[] var1, V[] var2, LongHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Long2ReferenceOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Long2ReferenceOpenCustomHashMap.this.value[Long2ReferenceOpenCustomHashMap.this.n]);
               }

               int var2 = Long2ReferenceOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2ReferenceOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2ReferenceOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2ReferenceOpenCustomHashMap<V> clone() {
      Long2ReferenceOpenCustomHashMap var1;
      try {
         var1 = (Long2ReferenceOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      Object[] var3 = this.value;
      Long2ReferenceOpenCustomHashMap.MapIterator var4 = new Long2ReferenceOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2ReferenceOpenCustomHashMap.this.key[Long2ReferenceOpenCustomHashMap.this.n]);
         }

         int var2 = Long2ReferenceOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2ReferenceOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2ReferenceOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2ReferenceOpenCustomHashMap.this.size;
         Long2ReferenceOpenCustomHashMap.this.remove(var1);
         return Long2ReferenceOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry<V>> implements Long2ReferenceMap.FastEntrySet<V> {
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               ...
               if (Long2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                  return Long2ReferenceOpenCustomHashMap.this.containsNullKey && Long2ReferenceOpenCustomHashMap.this.value[Long2ReferenceOpenCustomHashMap.this.n] == var5;
               } else {
                  long[] var8 = Long2ReferenceOpenCustomHashMap.this.key;
                  long var6;
                  int var9;
                  if ((var6 = var8[var9 = HashCommon.mix(Long2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2ReferenceOpenCustomHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Long2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                     return Long2ReferenceOpenCustomHashMap.this.value[var9] == var5;
                  } else {
                     while((var6 = var8[var9 = var9 + 1 & Long2ReferenceOpenCustomHashMap.this.mask]) != 0L) {
                        if (Long2ReferenceOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                           return Long2ReferenceOpenCustomHashMap.this.value[var9] == var5;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               ...
               Object var5 = var2.getValue();
               if (Long2ReferenceOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                  if (Long2ReferenceOpenCustomHashMap.this.containsNullKey && Long2ReferenceOpenCustomHashMap.this.value[Long2ReferenceOpenCustomHashMap.this.n] == var5) {
                  ...
                  if ((var6 = var8[var9 = HashCommon.mix(Long2ReferenceOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2ReferenceOpenCustomHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Long2ReferenceOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                     if (Long2ReferenceOpenCustomHashMap.this.value[var9] == var5) {
                        Long2ReferenceOpenCustomHashMap.this.removeEntry(var9);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var8[var9 = var9 + 1 & Long2ReferenceOpenCustomHashMap.this.mask]) == 0L) {
                           return false;
                        }
                     } while(!Long2ReferenceOpenCustomHashMap.this.strategy.equals(var6, var3) || Long2ReferenceOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2ReferenceMap.Entry<V>> var1) {
         if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceOpenCustomHashMap.this.key[Long2ReferenceOpenCustomHashMap.this.n], Long2ReferenceOpenCustomHashMap.this.value[Long2ReferenceOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2ReferenceOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceOpenCustomHashMap.this.key[var2], Long2ReferenceOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2ReferenceMap.Entry<V>> var1) {
         ...
         if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2ReferenceOpenCustomHashMap.this.key[Long2ReferenceOpenCustomHashMap.this.n];
            var2.value = Long2ReferenceOpenCustomHashMap.this.value[Long2ReferenceOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2ReferenceOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2ReferenceOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2ReferenceOpenCustomHashMap.this.key[var3];
               var2.value = Long2ReferenceOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Long2ReferenceMap.Entry<V>> {
      ...
      private FastEntryIterator() {
         super(null);
         this.entry = Long2ReferenceOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Long2ReferenceMap.Entry<V>> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2ReferenceOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2ReferenceOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2ReferenceOpenCustomHashMap.this.mask; !Long2ReferenceOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2ReferenceOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2ReferenceOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2ReferenceOpenCustomHashMap.this.mask;

            long var4;
            while(true) {
               if ((var4 = var6[var1]) == 0L) {
                  var6[var2] = 0L;
                  Long2ReferenceOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Long2ReferenceOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2ReferenceOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2ReferenceOpenCustomHashMap.this.value[var2] = Long2ReferenceOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2ReferenceMap.Entry<V>, java.util.Map.Entry<Long, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Long2ReferenceOpenCustomHashMap.this.value[this.index];
         Long2ReferenceOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2ReferenceOpenCustomHashMap.this.strategy.equals(Long2ReferenceOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Long2ReferenceOpenCustomHashMap.this.value[this.index] == var2.getValue();
         }
      }
