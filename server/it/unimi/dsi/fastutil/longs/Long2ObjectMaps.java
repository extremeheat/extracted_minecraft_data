...
public final class Long2ObjectMaps {
   ...
   public static <V> ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator(Long2ObjectMap<V> var0) {
      ObjectSet var1 = var0.long2ObjectEntrySet();
      return var1 instanceof Long2ObjectMap.FastEntrySet ? ((Long2ObjectMap.FastEntrySet)var1).fastIterator() : var1.iterator();
   }

   public static <V> void fastForEach(Long2ObjectMap<V> var0, Consumer<? super Long2ObjectMap.Entry<V>> var1) {
      ObjectSet var2 = var0.long2ObjectEntrySet();
      if (var2 instanceof Long2ObjectMap.FastEntrySet) {
         ((Long2ObjectMap.FastEntrySet)var2).fastForEach(var1);
      } else {
         var2.forEach(var1);
      }
   ...
   public static <V> ObjectIterable<Long2ObjectMap.Entry<V>> fastIterable(Long2ObjectMap<V> var0) {
      final ObjectSet var1 = var0.long2ObjectEntrySet();
      return (ObjectIterable)(var1 instanceof Long2ObjectMap.FastEntrySet ? new ObjectIterable<Long2ObjectMap.Entry<V>>() {
         public ObjectIterator<Long2ObjectMap.Entry<V>> iterator() {
            return ((Long2ObjectMap.FastEntrySet)var1).fastIterator();
         }

         public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> var1x) {
            ((Long2ObjectMap.FastEntrySet)var1).fastForEach(var1x);
         }
      } : var1);
   }
   ...
   public static <V> Long2ObjectMap<V> singleton(long var0, V var2) {
      return new Long2ObjectMaps.Singleton(var0, var2);
   }

   public static <V> Long2ObjectMap<V> singleton(Long var0, V var1) {
      return new Long2ObjectMaps.Singleton(var0, var1);
   }

   public static <V> Long2ObjectMap<V> synchronize(Long2ObjectMap<V> var0) {
      return new Long2ObjectMaps.SynchronizedMap(var0);
   }

   public static <V> Long2ObjectMap<V> synchronize(Long2ObjectMap<V> var0, Object var1) {
      return new Long2ObjectMaps.SynchronizedMap(var0, var1);
   }

   public static <V> Long2ObjectMap<V> unmodifiable(Long2ObjectMap<V> var0) {
      return new Long2ObjectMaps.UnmodifiableMap(var0);
   }
   ...
   public static class UnmodifiableMap<V> extends Long2ObjectFunctions.UnmodifiableFunction<V> implements Long2ObjectMap<V>, Serializable {
      ...
      protected UnmodifiableMap(Long2ObjectMap<V> var1) {
         super(var1);
         this.map = var1;
      }
      ...
      public V computeIfAbsentPartial(long var1, Long2ObjectFunction<? extends V> var3) {
         throw new UnsupportedOperationException();
      }
   ...
   public static class SynchronizedMap<V> extends Long2ObjectFunctions.SynchronizedFunction<V> implements Long2ObjectMap<V>, Serializable {
      ...
      protected SynchronizedMap(Long2ObjectMap<V> var1, Object var2) {
         super(var1, var2);
         this.map = var1;
      }

      protected SynchronizedMap(Long2ObjectMap<V> var1) {
         super(var1);
         this.map = var1;
      }
