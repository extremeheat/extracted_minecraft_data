...
public class LongLinkedOpenCustomHashSet extends AbstractLongSortedSet implements Serializable, Cloneable, Hash {
   ...
   public LongLinkedOpenCustomHashSet(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.first = -1;
      this.last = -1;
      this.strategy = var3;
   ...
   public LongLinkedOpenCustomHashSet(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongLinkedOpenCustomHashSet(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public LongLinkedOpenCustomHashSet(Collection<? extends Long> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public LongLinkedOpenCustomHashSet(Collection<? extends Long> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongLinkedOpenCustomHashSet(LongCollection var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public LongLinkedOpenCustomHashSet(LongCollection var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongLinkedOpenCustomHashSet(LongIterator var1, float var2, LongHash.Strategy var3) {
      this(16, var2, var3);
   ...
   public LongLinkedOpenCustomHashSet(LongIterator var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongLinkedOpenCustomHashSet(Iterator<?> var1, float var2, LongHash.Strategy var3) {
      this(LongIterators.asLongIterator(var1), var2, var3);
   }

   public LongLinkedOpenCustomHashSet(Iterator<?> var1, LongHash.Strategy var2) {
      this(LongIterators.asLongIterator(var1), var2);
   }

   public LongLinkedOpenCustomHashSet(long[] var1, int var2, int var3, float var4, LongHash.Strategy var5) {
   ...
   public LongLinkedOpenCustomHashSet(long[] var1, int var2, int var3, LongHash.Strategy var4) {
      this(var1, var2, var3, 0.75F, var4);
   }

   public LongLinkedOpenCustomHashSet(long[] var1, float var2, LongHash.Strategy var3) {
      this(var1, 0, var1.length, var2, var3);
   }

   public LongLinkedOpenCustomHashSet(long[] var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }
   ...
   public boolean add(long var1) {
      ...
      if (this.strategy.equals(var1, 0L)) {
         ...
         long[] var6 = this.key;
         long var4;
         if ((var4 = var6[var3 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask]) != 0L) {
   ...
   public long removeFirstLong() {
      if (this.size == 0) {
         ...
         --this.size;
         if (this.strategy.equals(var2, 0L)) {
            this.containsNull = false;
            this.key[this.n] = 0L;
         } else {
            this.shiftKeys(var1);
   ...
   public boolean addAndMoveToFirst(long var1) {
      int var3;
      if (this.strategy.equals(var1, 0L)) {
         if (this.containsNull) {
         ...
         for(var3 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask; var4[var3] != 0L; var3 = var3 + 1 & this.mask) {
   ...
   public boolean addAndMoveToLast(long var1) {
      int var3;
      if (this.strategy.equals(var1, 0L)) {
         if (this.containsNull) {
   ...
   public LongListIterator iterator(long var1) {
      return new LongLinkedOpenCustomHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         int var9;
         if (this.strategy.equals(var2[var5], 0L)) {
            var9 = var1;
         } else {
            for(var9 = HashCommon.mix(this.strategy.hashCode(var2[var5])) & var3; var4[var9] != 0L; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public LongLinkedOpenCustomHashSet clone() {
      LongLinkedOpenCustomHashSet var1;
      try {
         var1 = (LongLinkedOpenCustomHashSet)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      LongListIterator var2 = this.iterator();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var7-- != 0) {
         ...
         int var8;
         if (this.strategy.equals(var5, 0L)) {
            var8 = this.n;
            this.containsNull = true;
         } else if (var2[var8 = HashCommon.mix(this.strategy.hashCode(var5)) & this.mask] != 0L) {
            while(var2[var8 = var8 + 1 & this.mask] != 0L) {
            }
         }
   ...
   private class SetIterator implements LongListIterator {
      ...
      SetIterator(long var2) {
         super();
         if (LongLinkedOpenCustomHashSet.this.strategy.equals(var2, 0L)) {
         ...
         } else if (LongLinkedOpenCustomHashSet.this.strategy.equals(LongLinkedOpenCustomHashSet.this.key[LongLinkedOpenCustomHashSet.this.last], var2)) {
            this.prev = LongLinkedOpenCustomHashSet.this.last;
            this.index = LongLinkedOpenCustomHashSet.this.size;
         } else {
            long[] var4 = LongLinkedOpenCustomHashSet.this.key;

            for(int var5 = HashCommon.mix(LongLinkedOpenCustomHashSet.this.strategy.hashCode(var2)) & LongLinkedOpenCustomHashSet.this.mask; var4[var5] != 0L; var5 = var5 + 1 & LongLinkedOpenCustomHashSet.this.mask) {
               if (LongLinkedOpenCustomHashSet.this.strategy.equals(var4[var5], var2)) {
                  this.next = (int)LongLinkedOpenCustomHashSet.this.link[var5];
                  this.prev = var5;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = LongLinkedOpenCustomHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)LongLinkedOpenCustomHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var7 = LongLinkedOpenCustomHashSet.this.link;
               var10001 = this.prev;
               var7[var10001] ^= (LongLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var7 = LongLinkedOpenCustomHashSet.this.link;
               var10001 = this.next;
               var7[var10001] ^= (LongLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == LongLinkedOpenCustomHashSet.this.n) {
               ...
               long[] var6 = LongLinkedOpenCustomHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & LongLinkedOpenCustomHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = HashCommon.mix(LongLinkedOpenCustomHashSet.this.strategy.hashCode(var4)) & LongLinkedOpenCustomHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  LongLinkedOpenCustomHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
