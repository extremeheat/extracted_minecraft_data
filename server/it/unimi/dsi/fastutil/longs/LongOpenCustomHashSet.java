...
public class LongOpenCustomHashSet extends AbstractLongSet implements Serializable, Cloneable, Hash {
   ...
   public LongOpenCustomHashSet(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public LongOpenCustomHashSet(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongOpenCustomHashSet(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public LongOpenCustomHashSet(Collection<? extends Long> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public LongOpenCustomHashSet(Collection<? extends Long> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongOpenCustomHashSet(LongCollection var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.addAll(var1);
   }

   public LongOpenCustomHashSet(LongCollection var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongOpenCustomHashSet(LongIterator var1, float var2, LongHash.Strategy var3) {
      this(16, var2, var3);
   ...
   public LongOpenCustomHashSet(LongIterator var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public LongOpenCustomHashSet(Iterator<?> var1, float var2, LongHash.Strategy var3) {
      this(LongIterators.asLongIterator(var1), var2, var3);
   }

   public LongOpenCustomHashSet(Iterator<?> var1, LongHash.Strategy var2) {
      this(LongIterators.asLongIterator(var1), var2);
   }

   public LongOpenCustomHashSet(long[] var1, int var2, int var3, float var4, LongHash.Strategy var5) {
   ...
   public LongOpenCustomHashSet(long[] var1, int var2, int var3, LongHash.Strategy var4) {
      this(var1, var2, var3, 0.75F, var4);
   }

   public LongOpenCustomHashSet(long[] var1, float var2, LongHash.Strategy var3) {
      this(var1, 0, var1.length, var2, var3);
   }

   public LongOpenCustomHashSet(long[] var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var7 = this.realSize(); var7-- != 0; var4[var6] = var2[var5]) {
         ...
         if (var4[var6 = HashCommon.mix(this.strategy.hashCode(var2[var5])) & var3] != 0L) {
   ...
   public LongOpenCustomHashSet clone() {
      LongOpenCustomHashSet var1;
      try {
         var1 = (LongOpenCustomHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var5 = this.size; var5-- != 0; var2[var6] = var3) {
         var3 = var1.readLong();
         if (this.strategy.equals(var3, 0L)) {
            var6 = this.n;
            this.containsNull = true;
         } else if (var2[var6 = HashCommon.mix(this.strategy.hashCode(var3)) & this.mask] != 0L) {
   ...
   private class SetIterator implements LongIterator {
      ...
      public long nextLong() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNull) {
               ...
               long[] var1 = LongOpenCustomHashSet.this.key;
      ...
      private final void shiftKeys(int var1) {
         long[] var6 = LongOpenCustomHashSet.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & LongOpenCustomHashSet.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(LongOpenCustomHashSet.this.strategy.hashCode(var4)) & LongOpenCustomHashSet.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
