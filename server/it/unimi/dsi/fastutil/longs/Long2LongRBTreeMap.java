...
public class Long2LongRBTreeMap extends AbstractLong2LongSortedMap implements Serializable, Cloneable {
   ...
   public Long2LongRBTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2LongRBTreeMap(Map<? extends Long, ? extends Long> var1) {
      this();
      this.putAll(var1);
   }

   public Long2LongRBTreeMap(SortedMap<Long, Long> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2LongRBTreeMap(Long2LongMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2LongRBTreeMap(Long2LongSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2LongRBTreeMap(long[] var1, long[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2LongRBTreeMap(long[] var1, long[] var2) {
   ...
   final Long2LongRBTreeMap.Entry findKey(long var1) {
      Long2LongRBTreeMap.Entry var3;
      int var4;
   ...
   final Long2LongRBTreeMap.Entry locateKey(long var1) {
      Long2LongRBTreeMap.Entry var3 = this.tree;
      Long2LongRBTreeMap.Entry var4 = this.tree;
   ...
   public long addTo(long var1, long var3) {
      Long2LongRBTreeMap.Entry var5 = this.add(var1);
   ...
   private Long2LongRBTreeMap.Entry add(long var1) {
      this.modified = false;
      int var3 = 0;
      Long2LongRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Long2LongRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Long2LongRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Long2LongRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Long2LongRBTreeMap.Entry var8;
               Long2LongRBTreeMap.Entry var9;
   ...
   public long remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2LongRBTreeMap.Entry var9;
         Long2LongRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(long var1) {
      Long2LongRBTreeMap.ValueIterator var3 = new Long2LongRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public long get(long var1) {
      Long2LongRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
            final Comparator<? super Long2LongMap.Entry> comparator = (var1x, var2) -> {
               return Long2LongRBTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry var1) {
               return Long2LongRBTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        Long2LongRBTreeMap.Entry var3 = Long2LongRBTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Long) {
                        ...
                        if (var3 != null && var3.getLongValue() == (Long)var2.getValue()) {
                           Long2LongRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry var1, Long2LongMap.Entry var2) {
               return Long2LongRBTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2LongEntrySet();
            }

            public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry var1) {
               return Long2LongRBTreeMap.this.headMap(var1.getLongKey()).long2LongEntrySet();
            }

            public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry var1) {
               return Long2LongRBTreeMap.this.tailMap(var1.getLongKey()).long2LongEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Long2LongRBTreeMap.this.containsValue(var1);
            }
   ...
   public Long2LongSortedMap headMap(long var1) {
      return new Long2LongRBTreeMap.Submap(0L, true, var1, false);
   }

   public Long2LongSortedMap tailMap(long var1) {
      return new Long2LongRBTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2LongSortedMap subMap(long var1, long var3) {
      return new Long2LongRBTreeMap.Submap(var1, false, var3, false);
   }

   public Long2LongRBTreeMap clone() {
      Long2LongRBTreeMap var1;
      try {
         var1 = (Long2LongRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2LongRBTreeMap.Entry var5 = new Long2LongRBTreeMap.Entry();
         Long2LongRBTreeMap.Entry var6 = new Long2LongRBTreeMap.Entry();
         Long2LongRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2LongRBTreeMap.Entry var4 = var6;
         var6.pred((Long2LongRBTreeMap.Entry)null);

         while(true) {
            Long2LongRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2LongRBTreeMap.EntryIterator var3 = new Long2LongRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2LongRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2LongRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2LongRBTreeMap.Entry var3, Long2LongRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2LongRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2LongRBTreeMap.Entry(var1.readLong(), var1.readLong());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Long2LongRBTreeMap.Entry(var1.readLong(), var1.readLong());
         var8.black(true);
         var8.right(new Long2LongRBTreeMap.Entry(var1.readLong(), var1.readLong()));
         ...
         Long2LongRBTreeMap.Entry var7 = new Long2LongRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2LongRBTreeMap.Entry)null, (Long2LongRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2LongSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2LongRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2LongRBTreeMap.Submap.SubmapIterator var1 = new Long2LongRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2LongRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2LongRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2LongRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(long var1) {
         Long2LongRBTreeMap.Submap.SubmapIterator var3 = new Long2LongRBTreeMap.Submap.SubmapIterator();
      ...
      public long get(long var1) {
         Long2LongRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2LongRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public long put(long var1, long var3) {
         ...
         if (!this.in(var1)) {
            ...
            long var5 = Long2LongRBTreeMap.this.put(var1, var3);
            return Long2LongRBTreeMap.this.modified ? this.defRetValue : var5;
         }
      }
      ...
      public long remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            long var3 = Long2LongRBTreeMap.this.remove(var1);
            return Long2LongRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2LongSortedMap headMap(long var1) {
         if (this.top) {
            return Long2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2LongRBTreeMap.this.compare(var1, this.to) < 0 ? Long2LongRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2LongSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2LongRBTreeMap.this.compare(var1, this.from) > 0 ? Long2LongRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2LongSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2LongRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2LongRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2LongRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2LongRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2LongRBTreeMap.Entry firstEntry() {
         if (Long2LongRBTreeMap.this.tree == null) {
            ...
            Long2LongRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2LongRBTreeMap.this.firstEntry;
            } else {
               var1 = Long2LongRBTreeMap.this.locateKey(this.from);
               if (Long2LongRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2LongRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2LongRBTreeMap.Entry lastEntry() {
         if (Long2LongRBTreeMap.this.tree == null) {
            ...
            Long2LongRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2LongRBTreeMap.this.lastEntry;
            } else {
               var1 = Long2LongRBTreeMap.this.locateKey(this.to);
               if (Long2LongRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2LongRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2LongRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2LongRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2LongRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2LongMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2LongRBTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2LongRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2LongRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2LongRBTreeMap.this.locateKey(var2);
                  if (Long2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2LongSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2LongRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2LongRBTreeMap.TreeIterator implements ObjectListIterator<Long2LongMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2LongRBTreeMap.this.locateKey(var2)) != null) {
            if (Long2LongRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2LongMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2LongRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2LongRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2LongRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2LongRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2LongRBTreeMap.Entry next() {
         Long2LongRBTreeMap.Entry var1 = this.right;
      ...
      Long2LongRBTreeMap.Entry prev() {
         Long2LongRBTreeMap.Entry var1 = this.left;
      ...
      public Long2LongRBTreeMap.Entry clone() {
         Long2LongRBTreeMap.Entry var1;
         try {
            var1 = (Long2LongRBTreeMap.Entry)super.clone();
