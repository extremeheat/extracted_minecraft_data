...
public class Long2BooleanOpenCustomHashMap extends AbstractLong2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Long2BooleanOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2BooleanOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2BooleanOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2BooleanOpenCustomHashMap(Map<? extends Long, ? extends Boolean> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2BooleanOpenCustomHashMap(Map<? extends Long, ? extends Boolean> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2BooleanOpenCustomHashMap(Long2BooleanMap var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2BooleanOpenCustomHashMap(Long2BooleanMap var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2BooleanOpenCustomHashMap(long[] var1, boolean[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2BooleanOpenCustomHashMap(long[] var1, boolean[] var2, LongHash.Strategy var3) {
   ...
   public Long2BooleanMap.FastEntrySet long2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new Long2BooleanOpenCustomHashMap.MapEntrySet();
      }
   ...
   public LongSet keySet() {
      if (this.keys == null) {
         this.keys = new Long2BooleanOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            public BooleanIterator iterator() {
               return Long2BooleanOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(boolean var1) {
               return Long2BooleanOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n]);
               }

               int var2 = Long2BooleanOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2BooleanOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2BooleanOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2BooleanOpenCustomHashMap clone() {
      Long2BooleanOpenCustomHashMap var1;
      try {
         var1 = (Long2BooleanOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      boolean[] var3 = this.value;
      Long2BooleanOpenCustomHashMap.MapIterator var4 = new Long2BooleanOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Long2BooleanOpenCustomHashMap.MapIterator implements BooleanIterator {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongIterator iterator() {
         return Long2BooleanOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.n]);
         }

         int var2 = Long2BooleanOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2BooleanOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2BooleanOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2BooleanOpenCustomHashMap.this.size;
         Long2BooleanOpenCustomHashMap.this.remove(var1);
         return Long2BooleanOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class KeyIterator extends Long2BooleanOpenCustomHashMap.MapIterator implements LongIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements Long2BooleanMap.FastEntrySet {
      ...
      public ObjectIterator<Long2BooleanMap.Entry> iterator() {
         return Long2BooleanOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Long2BooleanMap.Entry> fastIterator() {
         return Long2BooleanOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (Long2BooleanOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     return Long2BooleanOpenCustomHashMap.this.containsNullKey && Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n] == var5;
                  } else {
                     long[] var8 = Long2BooleanOpenCustomHashMap.this.key;
                     long var6;
                     int var9;
                     if ((var6 = var8[var9 = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2BooleanOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Long2BooleanOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while((var6 = var8[var9 = var9 + 1 & Long2BooleanOpenCustomHashMap.this.mask]) != 0L) {
                           if (Long2BooleanOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Long2BooleanOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var5 = (Boolean)var2.getValue();
                  if (Long2BooleanOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     if (Long2BooleanOpenCustomHashMap.this.containsNullKey && Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n] == var5) {
                     ...
                     if ((var6 = var8[var9 = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2BooleanOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Long2BooleanOpenCustomHashMap.this.value[var9] == var5) {
                           Long2BooleanOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var8[var9 = var9 + 1 & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Long2BooleanOpenCustomHashMap.this.strategy.equals(var6, var3) || Long2BooleanOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2BooleanMap.Entry> var1) {
         if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2BooleanMap.BasicEntry(Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.n], Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2BooleanOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2BooleanMap.BasicEntry(Long2BooleanOpenCustomHashMap.this.key[var2], Long2BooleanOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2BooleanMap.Entry> var1) {
         ...
         if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.n];
            var2.value = Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2BooleanOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2BooleanOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2BooleanOpenCustomHashMap.this.key[var3];
               var2.value = Long2BooleanOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Long2BooleanMap.Entry> {
      private final Long2BooleanOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2BooleanOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Long2BooleanMap.Entry> {
      ...
      public Long2BooleanOpenCustomHashMap.MapEntry next() {
         return this.entry = Long2BooleanOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2BooleanOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2BooleanOpenCustomHashMap.this.mask; !Long2BooleanOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2BooleanOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2BooleanOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2BooleanOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2BooleanOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2BooleanOpenCustomHashMap.this.value[var2] = Long2BooleanOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2BooleanMap.Entry, java.util.Map.Entry<Long, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Long2BooleanOpenCustomHashMap.this.value[this.index];
         Long2BooleanOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2BooleanOpenCustomHashMap.this.strategy.equals(Long2BooleanOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Long2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
