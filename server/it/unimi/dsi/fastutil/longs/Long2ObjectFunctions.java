...
public final class Long2ObjectFunctions {
   ...
   public static <V> Long2ObjectFunction<V> singleton(long var0, V var2) {
      return new Long2ObjectFunctions.Singleton(var0, var2);
   }

   public static <V> Long2ObjectFunction<V> singleton(Long var0, V var1) {
      return new Long2ObjectFunctions.Singleton(var0, var1);
   }

   public static <V> Long2ObjectFunction<V> synchronize(Long2ObjectFunction<V> var0) {
      return new Long2ObjectFunctions.SynchronizedFunction(var0);
   }

   public static <V> Long2ObjectFunction<V> synchronize(Long2ObjectFunction<V> var0, Object var1) {
      return new Long2ObjectFunctions.SynchronizedFunction(var0, var1);
   }

   public static <V> Long2ObjectFunction<V> unmodifiable(Long2ObjectFunction<V> var0) {
      return new Long2ObjectFunctions.UnmodifiableFunction(var0);
   }

   public static <V> Long2ObjectFunction<V> primitive(Function<? super Long, ? extends V> var0) {
      Objects.requireNonNull(var0);
      if (var0 instanceof Long2ObjectFunction) {
         return (Long2ObjectFunction)var0;
         ...
         return new Long2ObjectFunctions.PrimitiveFunction(var0);
      }
   }
   ...
   public static class UnmodifiableFunction<V> extends AbstractLong2ObjectFunction<V> implements Serializable {
      ...
      protected UnmodifiableFunction(Long2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
   ...
   public static class SynchronizedFunction<V> implements Long2ObjectFunction<V>, Serializable {
      ...
      protected SynchronizedFunction(Long2ObjectFunction<V> var1, Object var2) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
      ...
      protected SynchronizedFunction(Long2ObjectFunction<V> var1) {
         super();
         if (var1 == null) {
            throw new NullPointerException();
         } else {
