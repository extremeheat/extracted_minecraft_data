...
public class Long2ObjectRBTreeMap<V> extends AbstractLong2ObjectSortedMap<V> implements Serializable, Cloneable {
   ...
   public Long2ObjectRBTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2ObjectRBTreeMap(Map<? extends Long, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Long2ObjectRBTreeMap(SortedMap<Long, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2ObjectRBTreeMap(Long2ObjectMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Long2ObjectRBTreeMap(Long2ObjectSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2ObjectRBTreeMap(long[] var1, V[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2ObjectRBTreeMap(long[] var1, V[] var2) {
   ...
   final Long2ObjectRBTreeMap.Entry<V> findKey(long var1) {
      Long2ObjectRBTreeMap.Entry var3;
      int var4;
   ...
   final Long2ObjectRBTreeMap.Entry<V> locateKey(long var1) {
      Long2ObjectRBTreeMap.Entry var3 = this.tree;
      Long2ObjectRBTreeMap.Entry var4 = this.tree;
   ...
   public V put(long var1, V var3) {
      Long2ObjectRBTreeMap.Entry var4 = this.add(var1);
      Object var5 = var4.value;
      var4.value = var3;
      return var5;
   }

   private Long2ObjectRBTreeMap.Entry<V> add(long var1) {
      this.modified = false;
      int var3 = 0;
      Long2ObjectRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Long2ObjectRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Long2ObjectRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Long2ObjectRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Long2ObjectRBTreeMap.Entry var8;
               Long2ObjectRBTreeMap.Entry var9;
   ...
   public V remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2ObjectRBTreeMap.Entry var9;
         Long2ObjectRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(Object var1) {
      Long2ObjectRBTreeMap.ValueIterator var2 = new Long2ObjectRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(long var1) {
      Long2ObjectRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
            final Comparator<? super Long2ObjectMap.Entry<V>> comparator = (var1x, var2) -> {
               return Long2ObjectRBTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> var1) {
               return Long2ObjectRBTreeMap.this.new EntryIterator(var1.getLongKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     Long2ObjectRBTreeMap.Entry var3 = Long2ObjectRBTreeMap.this.findKey((Long)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     ...
                     if (var3 != null && Objects.equals(var3.getValue(), var2.getValue())) {
                        Long2ObjectRBTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> var1, Long2ObjectMap.Entry<V> var2) {
               return Long2ObjectRBTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2ObjectEntrySet();
            }

            public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> var1) {
               return Long2ObjectRBTreeMap.this.headMap(var1.getLongKey()).long2ObjectEntrySet();
            }

            public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> var1) {
               return Long2ObjectRBTreeMap.this.tailMap(var1.getLongKey()).long2ObjectEntrySet();
            }
         };
      }
   ...
   public ObjectCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Long2ObjectRBTreeMap.this.containsValue(var1);
            }
   ...
   public Long2ObjectSortedMap<V> headMap(long var1) {
      return new Long2ObjectRBTreeMap.Submap(0L, true, var1, false);
   }

   public Long2ObjectSortedMap<V> tailMap(long var1) {
      return new Long2ObjectRBTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2ObjectSortedMap<V> subMap(long var1, long var3) {
      return new Long2ObjectRBTreeMap.Submap(var1, false, var3, false);
   }

   public Long2ObjectRBTreeMap<V> clone() {
      Long2ObjectRBTreeMap var1;
      try {
         var1 = (Long2ObjectRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2ObjectRBTreeMap.Entry var5 = new Long2ObjectRBTreeMap.Entry();
         Long2ObjectRBTreeMap.Entry var6 = new Long2ObjectRBTreeMap.Entry();
         Long2ObjectRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2ObjectRBTreeMap.Entry var4 = var6;
         var6.pred((Long2ObjectRBTreeMap.Entry)null);

         while(true) {
            Long2ObjectRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2ObjectRBTreeMap.EntryIterator var3 = new Long2ObjectRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2ObjectRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2ObjectRBTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Long2ObjectRBTreeMap.Entry<V> var3, Long2ObjectRBTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Long2ObjectRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2ObjectRBTreeMap.Entry(var1.readLong(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Long2ObjectRBTreeMap.Entry(var1.readLong(), var1.readObject());
         var8.black(true);
         var8.right(new Long2ObjectRBTreeMap.Entry(var1.readLong(), var1.readObject()));
         ...
         Long2ObjectRBTreeMap.Entry var7 = new Long2ObjectRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2ObjectRBTreeMap.Entry)null, (Long2ObjectRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2ObjectSortedMap<V> implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2ObjectRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2ObjectRBTreeMap.Submap.SubmapIterator var1 = new Long2ObjectRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2ObjectRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2ObjectRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2ObjectRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Long2ObjectRBTreeMap.Submap.SubmapIterator var2 = new Long2ObjectRBTreeMap.Submap.SubmapIterator();
      ...
      public V get(long var1) {
         Long2ObjectRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2ObjectRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public V put(long var1, V var3) {
         ...
         if (!this.in(var1)) {
            ...
            Object var4 = Long2ObjectRBTreeMap.this.put(var1, var3);
            return Long2ObjectRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public V remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Long2ObjectRBTreeMap.this.remove(var1);
            return Long2ObjectRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2ObjectSortedMap<V> headMap(long var1) {
         if (this.top) {
            return Long2ObjectRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2ObjectRBTreeMap.this.compare(var1, this.to) < 0 ? Long2ObjectRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2ObjectSortedMap<V> tailMap(long var1) {
         if (this.bottom) {
            return Long2ObjectRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2ObjectRBTreeMap.this.compare(var1, this.from) > 0 ? Long2ObjectRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2ObjectSortedMap<V> subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2ObjectRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2ObjectRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2ObjectRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2ObjectRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2ObjectRBTreeMap.Entry<V> firstEntry() {
         if (Long2ObjectRBTreeMap.this.tree == null) {
            ...
            Long2ObjectRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2ObjectRBTreeMap.this.firstEntry;
            } else {
               var1 = Long2ObjectRBTreeMap.this.locateKey(this.from);
               if (Long2ObjectRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2ObjectRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2ObjectRBTreeMap.Entry<V> lastEntry() {
         if (Long2ObjectRBTreeMap.this.tree == null) {
            ...
            Long2ObjectRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2ObjectRBTreeMap.this.lastEntry;
            } else {
               var1 = Long2ObjectRBTreeMap.this.locateKey(this.to);
               if (Long2ObjectRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2ObjectRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2ObjectRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2ObjectRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2ObjectRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Long2ObjectMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2ObjectRBTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2ObjectRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2ObjectRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2ObjectRBTreeMap.this.locateKey(var2);
                  if (Long2ObjectRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2ObjectSortedMap<V>.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2ObjectRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2ObjectRBTreeMap<V>.TreeIterator implements ObjectListIterator<Long2ObjectMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2ObjectRBTreeMap.this.locateKey(var2)) != null) {
            if (Long2ObjectRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractLong2ObjectMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Long2ObjectRBTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2ObjectRBTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2ObjectRBTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2ObjectRBTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2ObjectRBTreeMap.Entry<V> next() {
         Long2ObjectRBTreeMap.Entry var1 = this.right;
      ...
      Long2ObjectRBTreeMap.Entry<V> prev() {
         Long2ObjectRBTreeMap.Entry var1 = this.left;
      ...
      public Long2ObjectRBTreeMap.Entry<V> clone() {
         Long2ObjectRBTreeMap.Entry var1;
         try {
            var1 = (Long2ObjectRBTreeMap.Entry)super.clone();
