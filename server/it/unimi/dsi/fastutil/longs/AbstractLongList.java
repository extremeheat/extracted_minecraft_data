...
public abstract class AbstractLongList extends AbstractLongCollection implements LongList, LongStack {
   ...
   public LongListIterator listIterator(final int var1) {
      ...
      return new LongListIterator() {
         ...
         public void add(long var1x) {
            AbstractLongList.this.add(this.pos++, var1x);
            this.last = -1;
         }
         ...
         public void set(long var1x) {
            if (this.last == -1) {
               ...
               AbstractLongList.this.set(this.last, var1x);
            }
         }
   ...
   public int indexOf(long var1) {
      LongListIterator var3 = this.listIterator();
   ...
   public int lastIndexOf(long var1) {
      LongListIterator var3 = this.listIterator(this.size());
   ...
   public LongList subList(int var1, int var2) {
      ...
      if (var1 > var2) {
         ...
         return new AbstractLongList.LongSubList(this, var1, var2);
      }
   }

   public void removeElements(int var1, int var2) {
      this.ensureIndex(var2);
      LongListIterator var3 = this.listIterator(var1);
      int var4 = var2 - var1;
      if (var4 < 0) {
   ...
   public void getElements(int var1, long[] var2, int var3, int var4) {
      LongListIterator var5 = this.listIterator(var1);
      if (var3 < 0) {
         throw new ArrayIndexOutOfBoundsException("Offset (" + var3 + ") is negative");
      } else if (var3 + var4 > var2.length) {
         throw new ArrayIndexOutOfBoundsException("End index (" + (var3 + var4) + ") is greater than array length (" + var2.length + ")");
   ...
   public int hashCode() {
      LongListIterator var1 = this.iterator();
      int var2 = 1;

      long var4;
      for(int var3 = this.size(); var3-- != 0; var2 = 31 * var2 + HashCommon.long2int(var4)) {
         var4 = var1.nextLong();
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         if (var3 != var2.size()) {
            ...
            LongListIterator var4;
            if (var2 instanceof LongList) {
               var4 = this.listIterator();
               LongListIterator var6 = ((LongList)var2).listIterator();

               do {
                  if (var3-- == 0) {
                     return true;
                  }
               } while(var4.nextLong() == var6.nextLong());
   ...
   public int compareTo(List<? extends Long> var1) {
      if (var1 == this) {
         ...
         LongListIterator var2;
         int var4;
         if (var1 instanceof LongList) {
            var2 = this.listIterator();
            LongListIterator var9 = ((LongList)var1).listIterator();
   ...
   public long peekLong(int var1) {
      return this.getLong(this.size() - 1 - var1);
   }
   ...
   public boolean addAll(int var1, LongCollection var2) {
      this.ensureIndex(var1);
      LongIterator var3 = var2.iterator();
      boolean var4 = var3.hasNext();

      while(var3.hasNext()) {
         this.add(var1++, var3.nextLong());
      }
   ...
   public boolean addAll(int var1, LongList var2) {
      return this.addAll(var1, (LongCollection)var2);
   }
   ...
   public static class LongSubList extends AbstractLongList implements Serializable {
      ...
      public LongSubList(LongList var1, int var2, int var3) {
         super();
         this.l = var1;
         this.from = var2;
         this.to = var3;
         ...
         return new LongListIterator() {
            ...
            public void add(long var1x) {
               if (this.last == -1) {
                  ...
                  LongSubList.this.add(this.pos++, var1x);
                  this.last = -1;
