...
public class Long2ReferenceOpenHashMap<V> extends AbstractLong2ReferenceMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Long2ReferenceOpenHashMap(int var1, float var2) {
      super();
   ...
   public Long2ReferenceOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Long2ReferenceOpenHashMap(Map<? extends Long, ? extends V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2ReferenceOpenHashMap(Map<? extends Long, ? extends V> var1) {
      this(var1, 0.75F);
   }

   public Long2ReferenceOpenHashMap(Long2ReferenceMap<V> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2ReferenceOpenHashMap(Long2ReferenceMap<V> var1) {
      this(var1, 0.75F);
   }

   public Long2ReferenceOpenHashMap(long[] var1, V[] var2, float var3) {
   ...
   public Long2ReferenceOpenHashMap(long[] var1, V[] var2) {
   ...
   public Long2ReferenceMap.FastEntrySet<V> long2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new Long2ReferenceOpenHashMap.MapEntrySet();
      }
   ...
   public LongSet keySet() {
      if (this.keys == null) {
         this.keys = new Long2ReferenceOpenHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            public ObjectIterator<V> iterator() {
               return Long2ReferenceOpenHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(Object var1) {
               return Long2ReferenceOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Long2ReferenceOpenHashMap.this.containsNullKey) {
                  var1.accept(Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n]);
               }

               int var2 = Long2ReferenceOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2ReferenceOpenHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2ReferenceOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2ReferenceOpenHashMap<V> clone() {
      Long2ReferenceOpenHashMap var1;
      try {
         var1 = (Long2ReferenceOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      Object[] var3 = this.value;
      Long2ReferenceOpenHashMap.MapIterator var4 = new Long2ReferenceOpenHashMap.MapIterator();
   ...
   private final class ValueIterator extends Long2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongIterator iterator() {
         return Long2ReferenceOpenHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(Long2ReferenceOpenHashMap.this.key[Long2ReferenceOpenHashMap.this.n]);
         }

         int var2 = Long2ReferenceOpenHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2ReferenceOpenHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2ReferenceOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2ReferenceOpenHashMap.this.size;
         Long2ReferenceOpenHashMap.this.remove(var1);
         return Long2ReferenceOpenHashMap.this.size != var3;
      }
   ...
   private final class KeyIterator extends Long2ReferenceOpenHashMap<V>.MapIterator implements LongIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry<V>> implements Long2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectIterator<Long2ReferenceMap.Entry<V>> iterator() {
         return Long2ReferenceOpenHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Long2ReferenceMap.Entry<V>> fastIterator() {
         return Long2ReferenceOpenHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               ...
               if (var3 == 0L) {
                  return Long2ReferenceOpenHashMap.this.containsNullKey && Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n] == var5;
               } else {
                  long[] var8 = Long2ReferenceOpenHashMap.this.key;
                  long var6;
                  int var9;
                  if ((var6 = var8[var9 = (int)HashCommon.mix(var3) & Long2ReferenceOpenHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (var3 == var6) {
                     return Long2ReferenceOpenHashMap.this.value[var9] == var5;
                  } else {
                     while((var6 = var8[var9 = var9 + 1 & Long2ReferenceOpenHashMap.this.mask]) != 0L) {
                        if (var3 == var6) {
                           return Long2ReferenceOpenHashMap.this.value[var9] == var5;
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               ...
               Object var5 = var2.getValue();
               if (var3 == 0L) {
                  if (Long2ReferenceOpenHashMap.this.containsNullKey && Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n] == var5) {
                  ...
                  if ((var6 = var8[var9 = (int)HashCommon.mix(var3) & Long2ReferenceOpenHashMap.this.mask]) == 0L) {
                     ...
                     if (Long2ReferenceOpenHashMap.this.value[var9] == var5) {
                        Long2ReferenceOpenHashMap.this.removeEntry(var9);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var8[var9 = var9 + 1 & Long2ReferenceOpenHashMap.this.mask]) == 0L) {
                           return false;
                        }
                     } while(var6 != var3 || Long2ReferenceOpenHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2ReferenceMap.Entry<V>> var1) {
         if (Long2ReferenceOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceOpenHashMap.this.key[Long2ReferenceOpenHashMap.this.n], Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2ReferenceOpenHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceOpenHashMap.this.key[var2], Long2ReferenceOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2ReferenceMap.Entry<V>> var1) {
         ...
         if (Long2ReferenceOpenHashMap.this.containsNullKey) {
            var2.key = Long2ReferenceOpenHashMap.this.key[Long2ReferenceOpenHashMap.this.n];
            var2.value = Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2ReferenceOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Long2ReferenceOpenHashMap.this.key[var3] != 0L) {
               var2.key = Long2ReferenceOpenHashMap.this.key[var3];
               var2.value = Long2ReferenceOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Long2ReferenceMap.Entry<V>> {
      private final Long2ReferenceOpenHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2ReferenceOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Long2ReferenceMap.Entry<V>> {
      ...
      public Long2ReferenceOpenHashMap<V>.MapEntry next() {
         return this.entry = Long2ReferenceOpenHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2ReferenceOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(var2) & Long2ReferenceOpenHashMap.this.mask; var2 != var1[var4]; var4 = var4 + 1 & Long2ReferenceOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2ReferenceOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2ReferenceOpenHashMap.this.mask;

            long var4;
            while(true) {
               if ((var4 = var6[var1]) == 0L) {
                  var6[var2] = 0L;
                  Long2ReferenceOpenHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = (int)HashCommon.mix(var4) & Long2ReferenceOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2ReferenceOpenHashMap.this.value[var2] = Long2ReferenceOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2ReferenceMap.Entry<V>, java.util.Map.Entry<Long, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Long2ReferenceOpenHashMap.this.value[this.index];
         Long2ReferenceOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2ReferenceOpenHashMap.this.key[this.index] == (Long)var2.getKey() && Long2ReferenceOpenHashMap.this.value[this.index] == var2.getValue();
         }
      }
