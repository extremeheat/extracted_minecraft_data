...
public class Long2CharRBTreeMap extends AbstractLong2CharSortedMap implements Serializable, Cloneable {
   ...
   public Long2CharRBTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2CharRBTreeMap(Map<? extends Long, ? extends Character> var1) {
      this();
      this.putAll(var1);
   }

   public Long2CharRBTreeMap(SortedMap<Long, Character> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2CharRBTreeMap(Long2CharMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2CharRBTreeMap(Long2CharSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2CharRBTreeMap(long[] var1, char[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2CharRBTreeMap(long[] var1, char[] var2) {
   ...
   final Long2CharRBTreeMap.Entry findKey(long var1) {
      Long2CharRBTreeMap.Entry var3;
      int var4;
   ...
   final Long2CharRBTreeMap.Entry locateKey(long var1) {
      Long2CharRBTreeMap.Entry var3 = this.tree;
      Long2CharRBTreeMap.Entry var4 = this.tree;
   ...
   public char addTo(long var1, char var3) {
      Long2CharRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Long2CharRBTreeMap.Entry add(long var1) {
      this.modified = false;
      int var3 = 0;
      Long2CharRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Long2CharRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Long2CharRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Long2CharRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Long2CharRBTreeMap.Entry var8;
               Long2CharRBTreeMap.Entry var9;
   ...
   public char remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2CharRBTreeMap.Entry var9;
         Long2CharRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(char var1) {
      Long2CharRBTreeMap.ValueIterator var2 = new Long2CharRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public char get(long var1) {
      Long2CharRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>() {
            final Comparator<? super Long2CharMap.Entry> comparator = (var1x, var2) -> {
               return Long2CharRBTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry var1) {
               return Long2CharRBTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        Long2CharRBTreeMap.Entry var3 = Long2CharRBTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Character) {
                        ...
                        if (var3 != null && var3.getCharValue() == (Character)var2.getValue()) {
                           Long2CharRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry var1, Long2CharMap.Entry var2) {
               return Long2CharRBTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2CharEntrySet();
            }

            public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry var1) {
               return Long2CharRBTreeMap.this.headMap(var1.getLongKey()).long2CharEntrySet();
            }

            public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry var1) {
               return Long2CharRBTreeMap.this.tailMap(var1.getLongKey()).long2CharEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Long2CharRBTreeMap.this.containsValue(var1);
            }
   ...
   public Long2CharSortedMap headMap(long var1) {
      return new Long2CharRBTreeMap.Submap(0L, true, var1, false);
   }

   public Long2CharSortedMap tailMap(long var1) {
      return new Long2CharRBTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2CharSortedMap subMap(long var1, long var3) {
      return new Long2CharRBTreeMap.Submap(var1, false, var3, false);
   }

   public Long2CharRBTreeMap clone() {
      Long2CharRBTreeMap var1;
      try {
         var1 = (Long2CharRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2CharRBTreeMap.Entry var5 = new Long2CharRBTreeMap.Entry();
         Long2CharRBTreeMap.Entry var6 = new Long2CharRBTreeMap.Entry();
         Long2CharRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2CharRBTreeMap.Entry var4 = var6;
         var6.pred((Long2CharRBTreeMap.Entry)null);

         while(true) {
            Long2CharRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2CharRBTreeMap.EntryIterator var3 = new Long2CharRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2CharRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2CharRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2CharRBTreeMap.Entry var3, Long2CharRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2CharRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2CharRBTreeMap.Entry(var1.readLong(), var1.readChar());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Long2CharRBTreeMap.Entry(var1.readLong(), var1.readChar());
         var8.black(true);
         var8.right(new Long2CharRBTreeMap.Entry(var1.readLong(), var1.readChar()));
         ...
         Long2CharRBTreeMap.Entry var7 = new Long2CharRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2CharRBTreeMap.Entry)null, (Long2CharRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2CharSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2CharRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2CharRBTreeMap.Submap.SubmapIterator var1 = new Long2CharRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2CharRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2CharRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2CharRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(char var1) {
         Long2CharRBTreeMap.Submap.SubmapIterator var2 = new Long2CharRBTreeMap.Submap.SubmapIterator();
      ...
      public char get(long var1) {
         Long2CharRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2CharRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public char put(long var1, char var3) {
         ...
         if (!this.in(var1)) {
            ...
            char var4 = Long2CharRBTreeMap.this.put(var1, var3);
            return Long2CharRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public char remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            char var3 = Long2CharRBTreeMap.this.remove(var1);
            return Long2CharRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2CharSortedMap headMap(long var1) {
         if (this.top) {
            return Long2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2CharRBTreeMap.this.compare(var1, this.to) < 0 ? Long2CharRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2CharSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2CharRBTreeMap.this.compare(var1, this.from) > 0 ? Long2CharRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2CharSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2CharRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2CharRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2CharRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2CharRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2CharRBTreeMap.Entry firstEntry() {
         if (Long2CharRBTreeMap.this.tree == null) {
            ...
            Long2CharRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2CharRBTreeMap.this.firstEntry;
            } else {
               var1 = Long2CharRBTreeMap.this.locateKey(this.from);
               if (Long2CharRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2CharRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2CharRBTreeMap.Entry lastEntry() {
         if (Long2CharRBTreeMap.this.tree == null) {
            ...
            Long2CharRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2CharRBTreeMap.this.lastEntry;
            } else {
               var1 = Long2CharRBTreeMap.this.locateKey(this.to);
               if (Long2CharRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2CharRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2CharRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2CharRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2CharRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2CharMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2CharRBTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2CharRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2CharRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2CharRBTreeMap.this.locateKey(var2);
                  if (Long2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2CharSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2CharRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2CharRBTreeMap.TreeIterator implements ObjectListIterator<Long2CharMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2CharRBTreeMap.this.locateKey(var2)) != null) {
            if (Long2CharRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2CharRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2CharRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2CharRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2CharRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2CharRBTreeMap.Entry next() {
         Long2CharRBTreeMap.Entry var1 = this.right;
      ...
      Long2CharRBTreeMap.Entry prev() {
         Long2CharRBTreeMap.Entry var1 = this.left;
      ...
      public Long2CharRBTreeMap.Entry clone() {
         Long2CharRBTreeMap.Entry var1;
         try {
            var1 = (Long2CharRBTreeMap.Entry)super.clone();
