...
public class Long2LongOpenHashMap extends AbstractLong2LongMap implements Serializable, Cloneable, Hash {
   ...
   public Long2LongOpenHashMap(int var1, float var2) {
      super();
   ...
   public Long2LongOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Long2LongOpenHashMap(Map<? extends Long, ? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2LongOpenHashMap(Map<? extends Long, ? extends Long> var1) {
      this(var1, 0.75F);
   }

   public Long2LongOpenHashMap(Long2LongMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2LongOpenHashMap(Long2LongMap var1) {
      this(var1, 0.75F);
   }

   public Long2LongOpenHashMap(long[] var1, long[] var2, float var3) {
   ...
   public Long2LongOpenHashMap(long[] var1, long[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public boolean contains(long var1) {
               return Long2LongOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(java.util.function.LongConsumer var1) {
               if (Long2LongOpenHashMap.this.containsNullKey) {
                  var1.accept(Long2LongOpenHashMap.this.value[Long2LongOpenHashMap.this.n]);
               }

               int var2 = Long2LongOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2LongOpenHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2LongOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2LongOpenHashMap clone() {
      Long2LongOpenHashMap var1;
      try {
         var1 = (Long2LongOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      long[] var3 = this.value;
      Long2LongOpenHashMap.MapIterator var4 = new Long2LongOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2LongOpenHashMap.this.containsNullKey) {
            var1.accept(Long2LongOpenHashMap.this.key[Long2LongOpenHashMap.this.n]);
         }

         int var2 = Long2LongOpenHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2LongOpenHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2LongOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2LongOpenHashMap.this.size;
         Long2LongOpenHashMap.this.remove(var1);
         return Long2LongOpenHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2LongMap.Entry> implements Long2LongMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  if (var3 == 0L) {
                     return Long2LongOpenHashMap.this.containsNullKey && Long2LongOpenHashMap.this.value[Long2LongOpenHashMap.this.n] == var5;
                  } else {
                     long[] var9 = Long2LongOpenHashMap.this.key;
                     long var7;
                     int var10;
                     if ((var7 = var9[var10 = (int)HashCommon.mix(var3) & Long2LongOpenHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (var3 == var7) {
                        return Long2LongOpenHashMap.this.value[var10] == var5;
                     } else {
                        while((var7 = var9[var10 = var10 + 1 & Long2LongOpenHashMap.this.mask]) != 0L) {
                           if (var3 == var7) {
                              return Long2LongOpenHashMap.this.value[var10] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Long) {
                  ...
                  long var5 = (Long)var2.getValue();
                  if (var3 == 0L) {
                     if (Long2LongOpenHashMap.this.containsNullKey && Long2LongOpenHashMap.this.value[Long2LongOpenHashMap.this.n] == var5) {
                     ...
                     if ((var7 = var9[var10 = (int)HashCommon.mix(var3) & Long2LongOpenHashMap.this.mask]) == 0L) {
                        ...
                        if (Long2LongOpenHashMap.this.value[var10] == var5) {
                           Long2LongOpenHashMap.this.removeEntry(var10);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var7 = var9[var10 = var10 + 1 & Long2LongOpenHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(var7 != var3 || Long2LongOpenHashMap.this.value[var10] != var5);
      ...
      public void forEach(Consumer<? super Long2LongMap.Entry> var1) {
         if (Long2LongOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2LongMap.BasicEntry(Long2LongOpenHashMap.this.key[Long2LongOpenHashMap.this.n], Long2LongOpenHashMap.this.value[Long2LongOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2LongOpenHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2LongMap.BasicEntry(Long2LongOpenHashMap.this.key[var2], Long2LongOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2LongMap.Entry> var1) {
         ...
         if (Long2LongOpenHashMap.this.containsNullKey) {
            var2.key = Long2LongOpenHashMap.this.key[Long2LongOpenHashMap.this.n];
            var2.value = Long2LongOpenHashMap.this.value[Long2LongOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2LongOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Long2LongOpenHashMap.this.key[var3] != 0L) {
               var2.key = Long2LongOpenHashMap.this.key[var3];
               var2.value = Long2LongOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2LongOpenHashMap.MapIterator implements ObjectIterator<Long2LongMap.Entry> {
      private final Long2LongOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2LongOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2LongOpenHashMap.MapIterator implements ObjectIterator<Long2LongMap.Entry> {
   ...
   private class MapIterator {
      ...
      private MapIterator() {
         super();
         this.pos = Long2LongOpenHashMap.this.n;
         this.last = -1;
         this.c = Long2LongOpenHashMap.this.size;
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2LongOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(var2) & Long2LongOpenHashMap.this.mask; var2 != var1[var4]; var4 = var4 + 1 & Long2LongOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2LongOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2LongOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(var4) & Long2LongOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2LongOpenHashMap.this.value[var2] = Long2LongOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2LongMap.Entry, java.util.Map.Entry<Long, Long> {
      ...
      public long setValue(long var1) {
         long var3 = Long2LongOpenHashMap.this.value[this.index];
         Long2LongOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2LongOpenHashMap.this.key[this.index] == (Long)var2.getKey() && Long2LongOpenHashMap.this.value[this.index] == (Long)var2.getValue();
         }
      }
