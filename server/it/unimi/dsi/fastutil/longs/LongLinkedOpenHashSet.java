...
public class LongLinkedOpenHashSet extends AbstractLongSortedSet implements Serializable, Cloneable, Hash {
   ...
   public LongLinkedOpenHashSet(int var1, float var2) {
      super();
      this.first = -1;
      this.last = -1;
   ...
   public LongLinkedOpenHashSet(int var1) {
      this(var1, 0.75F);
   }
   ...
   public LongLinkedOpenHashSet(Collection<? extends Long> var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public LongLinkedOpenHashSet(Collection<? extends Long> var1) {
      this(var1, 0.75F);
   }

   public LongLinkedOpenHashSet(LongCollection var1, float var2) {
      this(var1.size(), var2);
      this.addAll(var1);
   }

   public LongLinkedOpenHashSet(LongCollection var1) {
      this(var1, 0.75F);
   }

   public LongLinkedOpenHashSet(LongIterator var1, float var2) {
      this(16, var2);
   ...
   public LongLinkedOpenHashSet(LongIterator var1) {
      this(var1, 0.75F);
   }

   public LongLinkedOpenHashSet(Iterator<?> var1, float var2) {
      this(LongIterators.asLongIterator(var1), var2);
   }

   public LongLinkedOpenHashSet(Iterator<?> var1) {
      this(LongIterators.asLongIterator(var1));
   }

   public LongLinkedOpenHashSet(long[] var1, int var2, int var3, float var4) {
   ...
   public LongLinkedOpenHashSet(long[] var1, int var2, int var3) {
      this(var1, var2, var3, 0.75F);
   }

   public LongLinkedOpenHashSet(long[] var1, float var2) {
      this(var1, 0, var1.length, var2);
   }

   public LongLinkedOpenHashSet(long[] var1) {
      this(var1, 0.75F);
   }
   ...
   public boolean addAndMoveToFirst(long var1) {
      ...
      if (var1 == 0L) {
         ...
         for(var3 = (int)HashCommon.mix(var1) & this.mask; var4[var3] != 0L; var3 = var3 + 1 & this.mask) {
            if (var1 == var4[var3]) {
   ...
   public LongListIterator iterator(long var1) {
      return new LongLinkedOpenHashSet.SetIterator(var1);
   }
   ...
   protected void rehash(int var1) {
      ...
      for(int var12 = this.size; var12-- != 0; var6 = var8) {
         ...
         if (var2[var5] == 0L) {
            ...
            for(var9 = (int)HashCommon.mix(var2[var5]) & var3; var4[var9] != 0L; var9 = var9 + 1 & var3) {
            }
         }
   ...
   public LongLinkedOpenHashSet clone() {
      LongLinkedOpenHashSet var1;
      try {
         var1 = (LongLinkedOpenHashSet)super.clone();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      while(var7-- != 0) {
         ...
         if (var5 == 0L) {
            var8 = this.n;
            this.containsNull = true;
         } else if (var2[var8 = (int)HashCommon.mix(var5) & this.mask] != 0L) {
   ...
   private class SetIterator implements LongListIterator {
      ...
      SetIterator(long var2) {
         ...
         } else if (LongLinkedOpenHashSet.this.key[LongLinkedOpenHashSet.this.last] == var2) {
            this.prev = LongLinkedOpenHashSet.this.last;
            this.index = LongLinkedOpenHashSet.this.size;
         } else {
            long[] var4 = LongLinkedOpenHashSet.this.key;

            for(int var5 = (int)HashCommon.mix(var2) & LongLinkedOpenHashSet.this.mask; var4[var5] != 0L; var5 = var5 + 1 & LongLinkedOpenHashSet.this.mask) {
               if (var4[var5] == var2) {
                  this.next = (int)LongLinkedOpenHashSet.this.link[var5];
                  this.prev = var5;
                  return;
               }
            }
      ...
      private final void ensureIndexKnown() {
         if (this.index < 0) {
            if (this.prev == -1) {
               ...
               int var1 = LongLinkedOpenHashSet.this.first;

               for(this.index = 1; var1 != this.prev; ++this.index) {
                  var1 = (int)LongLinkedOpenHashSet.this.link[var1];
               }
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               var7 = LongLinkedOpenHashSet.this.link;
               var10001 = this.prev;
               var7[var10001] ^= (LongLinkedOpenHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
            }
            ...
            if (this.next == -1) {
               ...
               var7 = LongLinkedOpenHashSet.this.link;
               var10001 = this.next;
               var7[var10001] ^= (LongLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }

            int var3 = this.curr;
            this.curr = -1;
            if (var3 == LongLinkedOpenHashSet.this.n) {
               LongLinkedOpenHashSet.this.containsNull = false;
               LongLinkedOpenHashSet.this.key[LongLinkedOpenHashSet.this.n] = 0L;
            } else {
               long[] var6 = LongLinkedOpenHashSet.this.key;

               while(true) {
                  int var1 = var3;
                  var3 = var3 + 1 & LongLinkedOpenHashSet.this.mask;
                  ...
                  while(true) {
                     ...
                     int var2 = (int)HashCommon.mix(var4) & LongLinkedOpenHashSet.this.mask;
                     if (var1 <= var3) {
                  ...
                  LongLinkedOpenHashSet.this.fixPointers(var3, var1);
               }
            }
         }
      }
