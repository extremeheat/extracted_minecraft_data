...
public class Long2IntOpenCustomHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
   ...
   public Long2IntOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2IntOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2IntOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2IntOpenCustomHashMap(Map<? extends Long, ? extends Integer> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2IntOpenCustomHashMap(Map<? extends Long, ? extends Integer> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2IntOpenCustomHashMap(Long2IntMap var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2IntOpenCustomHashMap(Long2IntMap var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2IntOpenCustomHashMap(long[] var1, int[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2IntOpenCustomHashMap(long[] var1, int[] var2, LongHash.Strategy var3) {
   ...
   public Long2IntMap.FastEntrySet long2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new Long2IntOpenCustomHashMap.MapEntrySet();
      }
   ...
   public LongSet keySet() {
      if (this.keys == null) {
         this.keys = new Long2IntOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            public IntIterator iterator() {
               return Long2IntOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(int var1) {
               return Long2IntOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.n]);
               }

               int var2 = Long2IntOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2IntOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2IntOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2IntOpenCustomHashMap clone() {
      Long2IntOpenCustomHashMap var1;
      try {
         var1 = (Long2IntOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      int[] var3 = this.value;
      Long2IntOpenCustomHashMap.MapIterator var4 = new Long2IntOpenCustomHashMap.MapIterator();
   ...
   private final class ValueIterator extends Long2IntOpenCustomHashMap.MapIterator implements IntIterator {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongIterator iterator() {
         return Long2IntOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.n]);
         }

         int var2 = Long2IntOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2IntOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2IntOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2IntOpenCustomHashMap.this.size;
         Long2IntOpenCustomHashMap.this.remove(var1);
         return Long2IntOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class KeyIterator extends Long2IntOpenCustomHashMap.MapIterator implements LongIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2IntMap.Entry> implements Long2IntMap.FastEntrySet {
      ...
      public ObjectIterator<Long2IntMap.Entry> iterator() {
         return Long2IntOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Long2IntMap.Entry> fastIterator() {
         return Long2IntOpenCustomHashMap.this.new FastEntryIterator();
      }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  if (Long2IntOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     return Long2IntOpenCustomHashMap.this.containsNullKey && Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.n] == var5;
                  } else {
                     long[] var8 = Long2IntOpenCustomHashMap.this.key;
                     long var6;
                     int var9;
                     if ((var6 = var8[var9 = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2IntOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2IntOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Long2IntOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while((var6 = var8[var9 = var9 + 1 & Long2IntOpenCustomHashMap.this.mask]) != 0L) {
                           if (Long2IntOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Long2IntOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Integer) {
                  ...
                  int var5 = (Integer)var2.getValue();
                  if (Long2IntOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     if (Long2IntOpenCustomHashMap.this.containsNullKey && Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.n] == var5) {
                     ...
                     if ((var6 = var8[var9 = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2IntOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2IntOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Long2IntOpenCustomHashMap.this.value[var9] == var5) {
                           Long2IntOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var8[var9 = var9 + 1 & Long2IntOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Long2IntOpenCustomHashMap.this.strategy.equals(var6, var3) || Long2IntOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2IntMap.Entry> var1) {
         if (Long2IntOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2IntMap.BasicEntry(Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.n], Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2IntOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2IntMap.BasicEntry(Long2IntOpenCustomHashMap.this.key[var2], Long2IntOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2IntMap.Entry> var1) {
         ...
         if (Long2IntOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.n];
            var2.value = Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2IntOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2IntOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2IntOpenCustomHashMap.this.key[var3];
               var2.value = Long2IntOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Long2IntMap.Entry> {
      private final Long2IntOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2IntOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Long2IntMap.Entry> {
      ...
      public Long2IntOpenCustomHashMap.MapEntry next() {
         return this.entry = Long2IntOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2IntOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2IntOpenCustomHashMap.this.mask; !Long2IntOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2IntOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2IntOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2IntOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2IntOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2IntOpenCustomHashMap.this.value[var2] = Long2IntOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2IntMap.Entry, java.util.Map.Entry<Long, Integer> {
      ...
      public int setValue(int var1) {
         int var2 = Long2IntOpenCustomHashMap.this.value[this.index];
         Long2IntOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Long2IntOpenCustomHashMap.this.value[this.index] == (Integer)var2.getValue();
         }
      }
