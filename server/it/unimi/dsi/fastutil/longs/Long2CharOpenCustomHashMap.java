...
public class Long2CharOpenCustomHashMap extends AbstractLong2CharMap implements Serializable, Cloneable, Hash {
   ...
   public Long2CharOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2CharOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2CharOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2CharOpenCustomHashMap(Long2CharMap var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2CharOpenCustomHashMap(Long2CharMap var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2CharOpenCustomHashMap(long[] var1, char[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2CharOpenCustomHashMap(long[] var1, char[] var2, LongHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public boolean contains(char var1) {
               return Long2CharOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n]);
               }

               int var2 = Long2CharOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2CharOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2CharOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2CharOpenCustomHashMap clone() {
      Long2CharOpenCustomHashMap var1;
      try {
         var1 = (Long2CharOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      char[] var3 = this.value;
      Long2CharOpenCustomHashMap.MapIterator var4 = new Long2CharOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2CharOpenCustomHashMap.this.key[Long2CharOpenCustomHashMap.this.n]);
         }

         int var2 = Long2CharOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2CharOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2CharOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2CharOpenCustomHashMap.this.size;
         Long2CharOpenCustomHashMap.this.remove(var1);
         return Long2CharOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  if (Long2CharOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     return Long2CharOpenCustomHashMap.this.containsNullKey && Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n] == var5;
                  } else {
                     long[] var8 = Long2CharOpenCustomHashMap.this.key;
                     long var6;
                     int var9;
                     if ((var6 = var8[var9 = HashCommon.mix(Long2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2CharOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2CharOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Long2CharOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while((var6 = var8[var9 = var9 + 1 & Long2CharOpenCustomHashMap.this.mask]) != 0L) {
                           if (Long2CharOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Long2CharOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Character) {
                  ...
                  char var5 = (Character)var2.getValue();
                  if (Long2CharOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     if (Long2CharOpenCustomHashMap.this.containsNullKey && Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n] == var5) {
                     ...
                     if ((var6 = var8[var9 = HashCommon.mix(Long2CharOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2CharOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2CharOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Long2CharOpenCustomHashMap.this.value[var9] == var5) {
                           Long2CharOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var8[var9 = var9 + 1 & Long2CharOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Long2CharOpenCustomHashMap.this.strategy.equals(var6, var3) || Long2CharOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2CharMap.Entry> var1) {
         if (Long2CharOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2CharMap.BasicEntry(Long2CharOpenCustomHashMap.this.key[Long2CharOpenCustomHashMap.this.n], Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2CharOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2CharMap.BasicEntry(Long2CharOpenCustomHashMap.this.key[var2], Long2CharOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2CharMap.Entry> var1) {
         ...
         if (Long2CharOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2CharOpenCustomHashMap.this.key[Long2CharOpenCustomHashMap.this.n];
            var2.value = Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2CharOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2CharOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2CharOpenCustomHashMap.this.key[var3];
               var2.value = Long2CharOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Long2CharMap.Entry> {
      private final Long2CharOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2CharOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Long2CharMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2CharOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2CharOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2CharOpenCustomHashMap.this.mask; !Long2CharOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2CharOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2CharOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2CharOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Long2CharOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2CharOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2CharOpenCustomHashMap.this.value[var2] = Long2CharOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2CharMap.Entry, java.util.Map.Entry<Long, Character> {
      ...
      public char setValue(char var1) {
         char var2 = Long2CharOpenCustomHashMap.this.value[this.index];
         Long2CharOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Long2CharOpenCustomHashMap.this.value[this.index] == (Character)var2.getValue();
         }
      }
