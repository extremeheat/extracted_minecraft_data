...
public class Long2BooleanRBTreeMap extends AbstractLong2BooleanSortedMap implements Serializable, Cloneable {
   ...
   public Long2BooleanRBTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2BooleanRBTreeMap(Map<? extends Long, ? extends Boolean> var1) {
      this();
      this.putAll(var1);
   }

   public Long2BooleanRBTreeMap(SortedMap<Long, Boolean> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2BooleanRBTreeMap(Long2BooleanMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2BooleanRBTreeMap(Long2BooleanSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2BooleanRBTreeMap(long[] var1, boolean[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2BooleanRBTreeMap(long[] var1, boolean[] var2) {
   ...
   final Long2BooleanRBTreeMap.Entry findKey(long var1) {
      Long2BooleanRBTreeMap.Entry var3;
      int var4;
   ...
   final Long2BooleanRBTreeMap.Entry locateKey(long var1) {
      Long2BooleanRBTreeMap.Entry var3 = this.tree;
      Long2BooleanRBTreeMap.Entry var4 = this.tree;
   ...
   public boolean put(long var1, boolean var3) {
      Long2BooleanRBTreeMap.Entry var4 = this.add(var1);
      boolean var5 = var4.value;
      var4.value = var3;
      return var5;
   }

   private Long2BooleanRBTreeMap.Entry add(long var1) {
      this.modified = false;
      int var3 = 0;
      Long2BooleanRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Long2BooleanRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Long2BooleanRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Long2BooleanRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Long2BooleanRBTreeMap.Entry var8;
               Long2BooleanRBTreeMap.Entry var9;
   ...
   public boolean remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2BooleanRBTreeMap.Entry var9;
         Long2BooleanRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(boolean var1) {
      Long2BooleanRBTreeMap.ValueIterator var2 = new Long2BooleanRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public boolean get(long var1) {
      Long2BooleanRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>() {
            final Comparator<? super Long2BooleanMap.Entry> comparator = (var1x, var2) -> {
               return Long2BooleanRBTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry var1) {
               return Long2BooleanRBTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        Long2BooleanRBTreeMap.Entry var3 = Long2BooleanRBTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                        ...
                        if (var3 != null && var3.getBooleanValue() == (Boolean)var2.getValue()) {
                           Long2BooleanRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry var1, Long2BooleanMap.Entry var2) {
               return Long2BooleanRBTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2BooleanEntrySet();
            }

            public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry var1) {
               return Long2BooleanRBTreeMap.this.headMap(var1.getLongKey()).long2BooleanEntrySet();
            }

            public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry var1) {
               return Long2BooleanRBTreeMap.this.tailMap(var1.getLongKey()).long2BooleanEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Long2BooleanRBTreeMap.this.containsValue(var1);
            }
   ...
   public Long2BooleanSortedMap headMap(long var1) {
      return new Long2BooleanRBTreeMap.Submap(0L, true, var1, false);
   }

   public Long2BooleanSortedMap tailMap(long var1) {
      return new Long2BooleanRBTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2BooleanSortedMap subMap(long var1, long var3) {
      return new Long2BooleanRBTreeMap.Submap(var1, false, var3, false);
   }

   public Long2BooleanRBTreeMap clone() {
      Long2BooleanRBTreeMap var1;
      try {
         var1 = (Long2BooleanRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2BooleanRBTreeMap.Entry var5 = new Long2BooleanRBTreeMap.Entry();
         Long2BooleanRBTreeMap.Entry var6 = new Long2BooleanRBTreeMap.Entry();
         Long2BooleanRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2BooleanRBTreeMap.Entry var4 = var6;
         var6.pred((Long2BooleanRBTreeMap.Entry)null);

         while(true) {
            Long2BooleanRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2BooleanRBTreeMap.EntryIterator var3 = new Long2BooleanRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2BooleanRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2BooleanRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2BooleanRBTreeMap.Entry var3, Long2BooleanRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2BooleanRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2BooleanRBTreeMap.Entry(var1.readLong(), var1.readBoolean());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Long2BooleanRBTreeMap.Entry(var1.readLong(), var1.readBoolean());
         var8.black(true);
         var8.right(new Long2BooleanRBTreeMap.Entry(var1.readLong(), var1.readBoolean()));
         ...
         Long2BooleanRBTreeMap.Entry var7 = new Long2BooleanRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2BooleanRBTreeMap.Entry)null, (Long2BooleanRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2BooleanSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2BooleanRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2BooleanRBTreeMap.Submap.SubmapIterator var1 = new Long2BooleanRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2BooleanRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2BooleanRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2BooleanRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(boolean var1) {
         Long2BooleanRBTreeMap.Submap.SubmapIterator var2 = new Long2BooleanRBTreeMap.Submap.SubmapIterator();
      ...
      public boolean get(long var1) {
         Long2BooleanRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2BooleanRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public boolean put(long var1, boolean var3) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var4 = Long2BooleanRBTreeMap.this.put(var1, var3);
            return Long2BooleanRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public boolean remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            boolean var3 = Long2BooleanRBTreeMap.this.remove(var1);
            return Long2BooleanRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2BooleanSortedMap headMap(long var1) {
         if (this.top) {
            return Long2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2BooleanRBTreeMap.this.compare(var1, this.to) < 0 ? Long2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2BooleanSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2BooleanRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2BooleanRBTreeMap.this.compare(var1, this.from) > 0 ? Long2BooleanRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2BooleanSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2BooleanRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2BooleanRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2BooleanRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2BooleanRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2BooleanRBTreeMap.Entry firstEntry() {
         if (Long2BooleanRBTreeMap.this.tree == null) {
            ...
            Long2BooleanRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2BooleanRBTreeMap.this.firstEntry;
            } else {
               var1 = Long2BooleanRBTreeMap.this.locateKey(this.from);
               if (Long2BooleanRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2BooleanRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2BooleanRBTreeMap.Entry lastEntry() {
         if (Long2BooleanRBTreeMap.this.tree == null) {
            ...
            Long2BooleanRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2BooleanRBTreeMap.this.lastEntry;
            } else {
               var1 = Long2BooleanRBTreeMap.this.locateKey(this.to);
               if (Long2BooleanRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2BooleanRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2BooleanRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2BooleanRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2BooleanRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2BooleanMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2BooleanRBTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2BooleanRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2BooleanRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2BooleanRBTreeMap.this.locateKey(var2);
                  if (Long2BooleanRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2BooleanSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2BooleanRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2BooleanRBTreeMap.TreeIterator implements ObjectListIterator<Long2BooleanMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2BooleanRBTreeMap.this.locateKey(var2)) != null) {
            if (Long2BooleanRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2BooleanMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2BooleanRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2BooleanRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2BooleanRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2BooleanRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2BooleanRBTreeMap.Entry next() {
         Long2BooleanRBTreeMap.Entry var1 = this.right;
      ...
      Long2BooleanRBTreeMap.Entry prev() {
         Long2BooleanRBTreeMap.Entry var1 = this.left;
      ...
      public Long2BooleanRBTreeMap.Entry clone() {
         Long2BooleanRBTreeMap.Entry var1;
         try {
            var1 = (Long2BooleanRBTreeMap.Entry)super.clone();
