...
public class Long2BooleanOpenHashMap extends AbstractLong2BooleanMap implements Serializable, Cloneable, Hash {
   ...
   public Long2BooleanOpenHashMap(int var1, float var2) {
      super();
   ...
   public Long2BooleanOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Long2BooleanOpenHashMap(Map<? extends Long, ? extends Boolean> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2BooleanOpenHashMap(Map<? extends Long, ? extends Boolean> var1) {
      this(var1, 0.75F);
   }

   public Long2BooleanOpenHashMap(Long2BooleanMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2BooleanOpenHashMap(Long2BooleanMap var1) {
      this(var1, 0.75F);
   }

   public Long2BooleanOpenHashMap(long[] var1, boolean[] var2, float var3) {
   ...
   public Long2BooleanOpenHashMap(long[] var1, boolean[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public boolean contains(boolean var1) {
               return Long2BooleanOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(BooleanConsumer var1) {
               if (Long2BooleanOpenHashMap.this.containsNullKey) {
                  var1.accept(Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n]);
               }

               int var2 = Long2BooleanOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2BooleanOpenHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2BooleanOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2BooleanOpenHashMap clone() {
      Long2BooleanOpenHashMap var1;
      try {
         var1 = (Long2BooleanOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      boolean[] var3 = this.value;
      Long2BooleanOpenHashMap.MapIterator var4 = new Long2BooleanOpenHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(Long2BooleanOpenHashMap.this.key[Long2BooleanOpenHashMap.this.n]);
         }

         int var2 = Long2BooleanOpenHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2BooleanOpenHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2BooleanOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2BooleanOpenHashMap.this.size;
         Long2BooleanOpenHashMap.this.remove(var1);
         return Long2BooleanOpenHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements Long2BooleanMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  if (var3 == 0L) {
                     return Long2BooleanOpenHashMap.this.containsNullKey && Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n] == var5;
                  } else {
                     long[] var8 = Long2BooleanOpenHashMap.this.key;
                     long var6;
                     int var9;
                     if ((var6 = var8[var9 = (int)HashCommon.mix(var3) & Long2BooleanOpenHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (var3 == var6) {
                        return Long2BooleanOpenHashMap.this.value[var9] == var5;
                     } else {
                        while((var6 = var8[var9 = var9 + 1 & Long2BooleanOpenHashMap.this.mask]) != 0L) {
                           if (var3 == var6) {
                              return Long2BooleanOpenHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Boolean) {
                  ...
                  boolean var5 = (Boolean)var2.getValue();
                  if (var3 == 0L) {
                     if (Long2BooleanOpenHashMap.this.containsNullKey && Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n] == var5) {
                     ...
                     if ((var6 = var8[var9 = (int)HashCommon.mix(var3) & Long2BooleanOpenHashMap.this.mask]) == 0L) {
                        ...
                        if (Long2BooleanOpenHashMap.this.value[var9] == var5) {
                           Long2BooleanOpenHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var8[var9 = var9 + 1 & Long2BooleanOpenHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(var6 != var3 || Long2BooleanOpenHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2BooleanMap.Entry> var1) {
         if (Long2BooleanOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2BooleanMap.BasicEntry(Long2BooleanOpenHashMap.this.key[Long2BooleanOpenHashMap.this.n], Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2BooleanOpenHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2BooleanMap.BasicEntry(Long2BooleanOpenHashMap.this.key[var2], Long2BooleanOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2BooleanMap.Entry> var1) {
         ...
         if (Long2BooleanOpenHashMap.this.containsNullKey) {
            var2.key = Long2BooleanOpenHashMap.this.key[Long2BooleanOpenHashMap.this.n];
            var2.value = Long2BooleanOpenHashMap.this.value[Long2BooleanOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2BooleanOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Long2BooleanOpenHashMap.this.key[var3] != 0L) {
               var2.key = Long2BooleanOpenHashMap.this.key[var3];
               var2.value = Long2BooleanOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2BooleanOpenHashMap.MapIterator implements ObjectIterator<Long2BooleanMap.Entry> {
      private final Long2BooleanOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2BooleanOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2BooleanOpenHashMap.MapIterator implements ObjectIterator<Long2BooleanMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2BooleanOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(var2) & Long2BooleanOpenHashMap.this.mask; var2 != var1[var4]; var4 = var4 + 1 & Long2BooleanOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2BooleanOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2BooleanOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(var4) & Long2BooleanOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2BooleanOpenHashMap.this.value[var2] = Long2BooleanOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2BooleanMap.Entry, java.util.Map.Entry<Long, Boolean> {
      ...
      public boolean setValue(boolean var1) {
         boolean var2 = Long2BooleanOpenHashMap.this.value[this.index];
         Long2BooleanOpenHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2BooleanOpenHashMap.this.key[this.index] == (Long)var2.getKey() && Long2BooleanOpenHashMap.this.value[this.index] == (Boolean)var2.getValue();
         }
      }
