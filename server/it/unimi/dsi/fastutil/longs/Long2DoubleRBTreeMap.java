...
public class Long2DoubleRBTreeMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable {
   ...
   public Long2DoubleRBTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2DoubleRBTreeMap(Map<? extends Long, ? extends Double> var1) {
      this();
      this.putAll(var1);
   }

   public Long2DoubleRBTreeMap(SortedMap<Long, Double> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2DoubleRBTreeMap(Long2DoubleMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2DoubleRBTreeMap(Long2DoubleSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2DoubleRBTreeMap(long[] var1, double[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2DoubleRBTreeMap(long[] var1, double[] var2) {
   ...
   final Long2DoubleRBTreeMap.Entry findKey(long var1) {
      Long2DoubleRBTreeMap.Entry var3;
      int var4;
   ...
   final Long2DoubleRBTreeMap.Entry locateKey(long var1) {
      Long2DoubleRBTreeMap.Entry var3 = this.tree;
      Long2DoubleRBTreeMap.Entry var4 = this.tree;
   ...
   public double addTo(long var1, double var3) {
      Long2DoubleRBTreeMap.Entry var5 = this.add(var1);
   ...
   private Long2DoubleRBTreeMap.Entry add(long var1) {
      this.modified = false;
      int var3 = 0;
      Long2DoubleRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Long2DoubleRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Long2DoubleRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Long2DoubleRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Long2DoubleRBTreeMap.Entry var8;
               Long2DoubleRBTreeMap.Entry var9;
   ...
   public double remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2DoubleRBTreeMap.Entry var9;
         Long2DoubleRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(double var1) {
      Long2DoubleRBTreeMap.ValueIterator var3 = new Long2DoubleRBTreeMap.ValueIterator();
      int var6 = this.count;
   ...
   public double get(long var1) {
      Long2DoubleRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
            final Comparator<? super Long2DoubleMap.Entry> comparator = (var1x, var2) -> {
               return Long2DoubleRBTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry var1) {
               return Long2DoubleRBTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        Long2DoubleRBTreeMap.Entry var3 = Long2DoubleRBTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Double) {
                        ...
                        if (var3 != null && Double.doubleToLongBits(var3.getDoubleValue()) == Double.doubleToLongBits((Double)var2.getValue())) {
                           Long2DoubleRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry var1, Long2DoubleMap.Entry var2) {
               return Long2DoubleRBTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2DoubleEntrySet();
            }

            public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry var1) {
               return Long2DoubleRBTreeMap.this.headMap(var1.getLongKey()).long2DoubleEntrySet();
            }

            public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry var1) {
               return Long2DoubleRBTreeMap.this.tailMap(var1.getLongKey()).long2DoubleEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Long2DoubleRBTreeMap.this.containsValue(var1);
            }
   ...
   public Long2DoubleSortedMap headMap(long var1) {
      return new Long2DoubleRBTreeMap.Submap(0L, true, var1, false);
   }

   public Long2DoubleSortedMap tailMap(long var1) {
      return new Long2DoubleRBTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2DoubleSortedMap subMap(long var1, long var3) {
      return new Long2DoubleRBTreeMap.Submap(var1, false, var3, false);
   }

   public Long2DoubleRBTreeMap clone() {
      Long2DoubleRBTreeMap var1;
      try {
         var1 = (Long2DoubleRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2DoubleRBTreeMap.Entry var5 = new Long2DoubleRBTreeMap.Entry();
         Long2DoubleRBTreeMap.Entry var6 = new Long2DoubleRBTreeMap.Entry();
         Long2DoubleRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2DoubleRBTreeMap.Entry var4 = var6;
         var6.pred((Long2DoubleRBTreeMap.Entry)null);

         while(true) {
            Long2DoubleRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2DoubleRBTreeMap.EntryIterator var3 = new Long2DoubleRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2DoubleRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2DoubleRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2DoubleRBTreeMap.Entry var3, Long2DoubleRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2DoubleRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2DoubleRBTreeMap.Entry(var1.readLong(), var1.readDouble());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Long2DoubleRBTreeMap.Entry(var1.readLong(), var1.readDouble());
         var8.black(true);
         var8.right(new Long2DoubleRBTreeMap.Entry(var1.readLong(), var1.readDouble()));
         ...
         Long2DoubleRBTreeMap.Entry var7 = new Long2DoubleRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2DoubleRBTreeMap.Entry)null, (Long2DoubleRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2DoubleSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2DoubleRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2DoubleRBTreeMap.Submap.SubmapIterator var1 = new Long2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2DoubleRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2DoubleRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2DoubleRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(double var1) {
         Long2DoubleRBTreeMap.Submap.SubmapIterator var3 = new Long2DoubleRBTreeMap.Submap.SubmapIterator();
      ...
      public double get(long var1) {
         Long2DoubleRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2DoubleRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public double put(long var1, double var3) {
         ...
         if (!this.in(var1)) {
            ...
            double var5 = Long2DoubleRBTreeMap.this.put(var1, var3);
            return Long2DoubleRBTreeMap.this.modified ? this.defRetValue : var5;
         }
      }
      ...
      public double remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            double var3 = Long2DoubleRBTreeMap.this.remove(var1);
            return Long2DoubleRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2DoubleSortedMap headMap(long var1) {
         if (this.top) {
            return Long2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2DoubleRBTreeMap.this.compare(var1, this.to) < 0 ? Long2DoubleRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2DoubleSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? Long2DoubleRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2DoubleSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2DoubleRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2DoubleRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2DoubleRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2DoubleRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2DoubleRBTreeMap.Entry firstEntry() {
         if (Long2DoubleRBTreeMap.this.tree == null) {
            ...
            Long2DoubleRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2DoubleRBTreeMap.this.firstEntry;
            } else {
               var1 = Long2DoubleRBTreeMap.this.locateKey(this.from);
               if (Long2DoubleRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2DoubleRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2DoubleRBTreeMap.Entry lastEntry() {
         if (Long2DoubleRBTreeMap.this.tree == null) {
            ...
            Long2DoubleRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2DoubleRBTreeMap.this.lastEntry;
            } else {
               var1 = Long2DoubleRBTreeMap.this.locateKey(this.to);
               if (Long2DoubleRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2DoubleRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2DoubleRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2DoubleRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2DoubleRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2DoubleMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2DoubleRBTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2DoubleRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2DoubleRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2DoubleRBTreeMap.this.locateKey(var2);
                  if (Long2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2DoubleSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2DoubleRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2DoubleRBTreeMap.TreeIterator implements ObjectListIterator<Long2DoubleMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2DoubleRBTreeMap.this.locateKey(var2)) != null) {
            if (Long2DoubleRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2DoubleMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2DoubleRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2DoubleRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2DoubleRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2DoubleRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2DoubleRBTreeMap.Entry next() {
         Long2DoubleRBTreeMap.Entry var1 = this.right;
      ...
      Long2DoubleRBTreeMap.Entry prev() {
         Long2DoubleRBTreeMap.Entry var1 = this.left;
      ...
      public Long2DoubleRBTreeMap.Entry clone() {
         Long2DoubleRBTreeMap.Entry var1;
         try {
            var1 = (Long2DoubleRBTreeMap.Entry)super.clone();
