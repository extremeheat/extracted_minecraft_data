...
public interface Long2DoubleMap extends Long2DoubleFunction, Map<Long, Double> {
   ...
   /** @deprecated */
   @Deprecated
   default Double put(Long var1, Double var2) {
      return Long2DoubleFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double get(Object var1) {
      return Long2DoubleFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default Double remove(Object var1) {
      return Long2DoubleFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Long2DoubleFunction.super.containsKey(var1);
   }
   ...
   default double getOrDefault(long var1, double var3) {
      double var5;
      return (var5 = this.get(var1)) == this.defaultReturnValue() && !this.containsKey(var1) ? var3 : var5;
   }

   default double putIfAbsent(long var1, double var3) {
   ...
   default boolean remove(long var1, double var3) {
      double var5 = this.get(var1);
   ...
   default boolean replace(long var1, double var3, double var5) {
   ...
   default double replace(long var1, double var3) {
      return this.containsKey(var1) ? this.put(var1, var3) : this.defaultReturnValue();
   }

   default double computeIfAbsent(long var1, LongToDoubleFunction var3) {
   ...
   default double computeIfAbsentNullable(long var1, LongFunction<? extends Double> var3) {
      Objects.requireNonNull(var3);
      double var4 = this.get(var1);
   ...
   default double computeIfAbsentPartial(long var1, Long2DoubleFunction var3) {
      Objects.requireNonNull(var3);
      double var4 = this.get(var1);
      double var6 = this.defaultReturnValue();
      if (var4 == var6 && !this.containsKey(var1)) {
   ...
   default double computeIfPresent(long var1, BiFunction<? super Long, ? super Double, ? extends Double> var3) {
      Objects.requireNonNull(var3);
      double var4 = this.get(var1);
      double var6 = this.defaultReturnValue();
      if (var4 == var6 && !this.containsKey(var1)) {
   ...
   default double compute(long var1, BiFunction<? super Long, ? super Double, ? extends Double> var3) {
      Objects.requireNonNull(var3);
      double var4 = this.get(var1);
      double var6 = this.defaultReturnValue();
   ...
   default double merge(long var1, double var3, BiFunction<? super Double, ? super Double, ? extends Double> var5) {
   ...
   /** @deprecated */
   @Deprecated
   default Double putIfAbsent(Long var1, Double var2) {
   ...
   /** @deprecated */
   @Deprecated
   default boolean replace(Long var1, Double var2, Double var3) {
      return super.replace(var1, var2, var3);
   }

   /** @deprecated */
   @Deprecated
   default Double replace(Long var1, Double var2) {
      return (Double)super.replace(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double computeIfAbsent(Long var1, Function<? super Long, ? extends Double> var2) {
      return (Double)super.computeIfAbsent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double computeIfPresent(Long var1, BiFunction<? super Long, ? super Double, ? extends Double> var2) {
      return (Double)super.computeIfPresent(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double compute(Long var1, BiFunction<? super Long, ? super Double, ? extends Double> var2) {
      return (Double)super.compute(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default Double merge(Long var1, Double var2, BiFunction<? super Double, ? super Double, ? extends Double> var3) {
   ...
   public interface FastEntrySet extends ObjectSet<Long2DoubleMap.Entry> {
      ...
      default void fastForEach(Consumer<? super Long2DoubleMap.Entry> var1) {
         this.forEach(var1);
      }
   }
}
