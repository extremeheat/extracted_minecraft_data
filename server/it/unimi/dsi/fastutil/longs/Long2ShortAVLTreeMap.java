...
public class Long2ShortAVLTreeMap extends AbstractLong2ShortSortedMap implements Serializable, Cloneable {
   ...
   public Long2ShortAVLTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2ShortAVLTreeMap(Map<? extends Long, ? extends Short> var1) {
      this();
      this.putAll(var1);
   }

   public Long2ShortAVLTreeMap(SortedMap<Long, Short> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2ShortAVLTreeMap(Long2ShortMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2ShortAVLTreeMap(Long2ShortSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2ShortAVLTreeMap(long[] var1, short[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2ShortAVLTreeMap(long[] var1, short[] var2) {
   ...
   final Long2ShortAVLTreeMap.Entry findKey(long var1) {
      Long2ShortAVLTreeMap.Entry var3;
      int var4;
   ...
   final Long2ShortAVLTreeMap.Entry locateKey(long var1) {
      Long2ShortAVLTreeMap.Entry var3 = this.tree;
      Long2ShortAVLTreeMap.Entry var4 = this.tree;
   ...
   public short addTo(long var1, short var3) {
      Long2ShortAVLTreeMap.Entry var4 = this.add(var1);
   ...
   private Long2ShortAVLTreeMap.Entry add(long var1) {
      this.modified = false;
      Long2ShortAVLTreeMap.Entry var3 = null;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Long2ShortAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Long2ShortAVLTreeMap.Entry var4 = this.tree;
         Long2ShortAVLTreeMap.Entry var5 = null;
         Long2ShortAVLTreeMap.Entry var6 = this.tree;
         Long2ShortAVLTreeMap.Entry var7 = null;
         Long2ShortAVLTreeMap.Entry var8 = null;
         int var10 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var10++] = var9 > 0) {
               if (var4.succ()) {
                  ++this.count;
                  var3 = new Long2ShortAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var4.right == null) {
                     this.lastEntry = var3;
                  }
         ...
         Long2ShortAVLTreeMap.Entry var11;
         if (var6.balance() == -2) {
            var11 = var6.left;
            if (var11.balance() == -1) {
               var8 = var11;
   ...
   private Long2ShortAVLTreeMap.Entry parent(Long2ShortAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Long2ShortAVLTreeMap.Entry var3 = var1;

         Long2ShortAVLTreeMap.Entry var2;
         Long2ShortAVLTreeMap.Entry var4;
   ...
   public short remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2ShortAVLTreeMap.Entry var9;
         Long2ShortAVLTreeMap.Entry var10;
         if (var4.succ()) {
            if (var4.pred()) {
               if (var5 != null) {
                  if (var6) {
   ...
   public boolean containsValue(short var1) {
      Long2ShortAVLTreeMap.ValueIterator var2 = new Long2ShortAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public short get(long var1) {
      Long2ShortAVLTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() {
            final Comparator<? super Long2ShortMap.Entry> comparator = (var1x, var2) -> {
               return Long2ShortAVLTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry var1) {
               return Long2ShortAVLTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        Long2ShortAVLTreeMap.Entry var3 = Long2ShortAVLTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Short) {
                        ...
                        if (var3 != null && var3.getShortValue() == (Short)var2.getValue()) {
                           Long2ShortAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry var1, Long2ShortMap.Entry var2) {
               return Long2ShortAVLTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2ShortEntrySet();
            }

            public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry var1) {
               return Long2ShortAVLTreeMap.this.headMap(var1.getLongKey()).long2ShortEntrySet();
            }

            public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry var1) {
               return Long2ShortAVLTreeMap.this.tailMap(var1.getLongKey()).long2ShortEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public boolean contains(short var1) {
               return Long2ShortAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Long2ShortSortedMap headMap(long var1) {
      return new Long2ShortAVLTreeMap.Submap(0L, true, var1, false);
   }

   public Long2ShortSortedMap tailMap(long var1) {
      return new Long2ShortAVLTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2ShortSortedMap subMap(long var1, long var3) {
      return new Long2ShortAVLTreeMap.Submap(var1, false, var3, false);
   }

   public Long2ShortAVLTreeMap clone() {
      Long2ShortAVLTreeMap var1;
      try {
         var1 = (Long2ShortAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2ShortAVLTreeMap.Entry var5 = new Long2ShortAVLTreeMap.Entry();
         Long2ShortAVLTreeMap.Entry var6 = new Long2ShortAVLTreeMap.Entry();
         Long2ShortAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2ShortAVLTreeMap.Entry var4 = var6;
         var6.pred((Long2ShortAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2ShortAVLTreeMap.EntryIterator var3 = new Long2ShortAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2ShortAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2ShortAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2ShortAVLTreeMap.Entry var3, Long2ShortAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2ShortAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2ShortAVLTreeMap.Entry(var1.readLong(), var1.readShort());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Long2ShortAVLTreeMap.Entry(var1.readLong(), var1.readShort());
         var8.right(new Long2ShortAVLTreeMap.Entry(var1.readLong(), var1.readShort()));
         ...
         Long2ShortAVLTreeMap.Entry var7 = new Long2ShortAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2ShortAVLTreeMap.Entry)null, (Long2ShortAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2ShortSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2ShortAVLTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2ShortAVLTreeMap.Submap.SubmapIterator var1 = new Long2ShortAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2ShortAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2ShortAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2ShortAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(short var1) {
         Long2ShortAVLTreeMap.Submap.SubmapIterator var2 = new Long2ShortAVLTreeMap.Submap.SubmapIterator();
      ...
      public short get(long var1) {
         Long2ShortAVLTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2ShortAVLTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public short put(long var1, short var3) {
         ...
         if (!this.in(var1)) {
            ...
            short var4 = Long2ShortAVLTreeMap.this.put(var1, var3);
            return Long2ShortAVLTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public short remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            short var3 = Long2ShortAVLTreeMap.this.remove(var1);
            return Long2ShortAVLTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2ShortSortedMap headMap(long var1) {
         if (this.top) {
            return Long2ShortAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2ShortAVLTreeMap.this.compare(var1, this.to) < 0 ? Long2ShortAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2ShortSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2ShortAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2ShortAVLTreeMap.this.compare(var1, this.from) > 0 ? Long2ShortAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2ShortSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2ShortAVLTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2ShortAVLTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2ShortAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2ShortAVLTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2ShortAVLTreeMap.Entry firstEntry() {
         if (Long2ShortAVLTreeMap.this.tree == null) {
            ...
            Long2ShortAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2ShortAVLTreeMap.this.firstEntry;
            } else {
               var1 = Long2ShortAVLTreeMap.this.locateKey(this.from);
               if (Long2ShortAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2ShortAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2ShortAVLTreeMap.Entry lastEntry() {
         if (Long2ShortAVLTreeMap.this.tree == null) {
            ...
            Long2ShortAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2ShortAVLTreeMap.this.lastEntry;
            } else {
               var1 = Long2ShortAVLTreeMap.this.locateKey(this.to);
               if (Long2ShortAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2ShortAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2ShortAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2ShortAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2ShortAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2ShortMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2ShortAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2ShortAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2ShortAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2ShortAVLTreeMap.this.locateKey(var2);
                  if (Long2ShortAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2ShortSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2ShortAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2ShortAVLTreeMap.TreeIterator implements ObjectListIterator<Long2ShortMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2ShortAVLTreeMap.this.locateKey(var2)) != null) {
            if (Long2ShortAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2ShortMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2ShortAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2ShortAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2ShortAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2ShortAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2ShortAVLTreeMap.Entry next() {
         Long2ShortAVLTreeMap.Entry var1 = this.right;
      ...
      Long2ShortAVLTreeMap.Entry prev() {
         Long2ShortAVLTreeMap.Entry var1 = this.left;
      ...
      public Long2ShortAVLTreeMap.Entry clone() {
         Long2ShortAVLTreeMap.Entry var1;
         try {
            var1 = (Long2ShortAVLTreeMap.Entry)super.clone();
