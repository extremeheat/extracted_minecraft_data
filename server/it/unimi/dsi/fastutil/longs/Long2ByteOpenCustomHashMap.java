...
public class Long2ByteOpenCustomHashMap extends AbstractLong2ByteMap implements Serializable, Cloneable, Hash {
   ...
   public Long2ByteOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2ByteOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ByteOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2ByteOpenCustomHashMap(Map<? extends Long, ? extends Byte> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2ByteOpenCustomHashMap(Map<? extends Long, ? extends Byte> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ByteOpenCustomHashMap(Long2ByteMap var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2ByteOpenCustomHashMap(Long2ByteMap var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ByteOpenCustomHashMap(long[] var1, byte[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2ByteOpenCustomHashMap(long[] var1, byte[] var2, LongHash.Strategy var3) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Long2ByteOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(IntConsumer var1) {
               if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n]);
               }

               int var2 = Long2ByteOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2ByteOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2ByteOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2ByteOpenCustomHashMap clone() {
      Long2ByteOpenCustomHashMap var1;
      try {
         var1 = (Long2ByteOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      byte[] var3 = this.value;
      Long2ByteOpenCustomHashMap.MapIterator var4 = new Long2ByteOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.n]);
         }

         int var2 = Long2ByteOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2ByteOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2ByteOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2ByteOpenCustomHashMap.this.size;
         Long2ByteOpenCustomHashMap.this.remove(var1);
         return Long2ByteOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  if (Long2ByteOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     return Long2ByteOpenCustomHashMap.this.containsNullKey && Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n] == var5;
                  } else {
                     long[] var8 = Long2ByteOpenCustomHashMap.this.key;
                     long var6;
                     int var9;
                     if ((var6 = var8[var9 = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2ByteOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2ByteOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Long2ByteOpenCustomHashMap.this.value[var9] == var5;
                     } else {
                        while((var6 = var8[var9 = var9 + 1 & Long2ByteOpenCustomHashMap.this.mask]) != 0L) {
                           if (Long2ByteOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Long2ByteOpenCustomHashMap.this.value[var9] == var5;
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                  ...
                  byte var5 = (Byte)var2.getValue();
                  if (Long2ByteOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     if (Long2ByteOpenCustomHashMap.this.containsNullKey && Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n] == var5) {
                     ...
                     if ((var6 = var8[var9 = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2ByteOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2ByteOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Long2ByteOpenCustomHashMap.this.value[var9] == var5) {
                           Long2ByteOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var8[var9 = var9 + 1 & Long2ByteOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Long2ByteOpenCustomHashMap.this.strategy.equals(var6, var3) || Long2ByteOpenCustomHashMap.this.value[var9] != var5);
      ...
      public void forEach(Consumer<? super Long2ByteMap.Entry> var1) {
         if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2ByteMap.BasicEntry(Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.n], Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2ByteOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2ByteMap.BasicEntry(Long2ByteOpenCustomHashMap.this.key[var2], Long2ByteOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2ByteMap.Entry> var1) {
         ...
         if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.n];
            var2.value = Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2ByteOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2ByteOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2ByteOpenCustomHashMap.this.key[var3];
               var2.value = Long2ByteOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Long2ByteMap.Entry> {
      private final Long2ByteOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2ByteOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Long2ByteMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2ByteOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2ByteOpenCustomHashMap.this.mask; !Long2ByteOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2ByteOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2ByteOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2ByteOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2ByteOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2ByteOpenCustomHashMap.this.value[var2] = Long2ByteOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2ByteMap.Entry, java.util.Map.Entry<Long, Byte> {
      ...
      public byte setValue(byte var1) {
         byte var2 = Long2ByteOpenCustomHashMap.this.value[this.index];
         Long2ByteOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2ByteOpenCustomHashMap.this.strategy.equals(Long2ByteOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Long2ByteOpenCustomHashMap.this.value[this.index] == (Byte)var2.getValue();
         }
      }
