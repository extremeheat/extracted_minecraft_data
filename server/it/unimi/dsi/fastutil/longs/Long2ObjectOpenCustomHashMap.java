...
public class Long2ObjectOpenCustomHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   public Long2ObjectOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2ObjectOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ObjectOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2ObjectOpenCustomHashMap(Map<? extends Long, ? extends V> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2ObjectOpenCustomHashMap(Map<? extends Long, ? extends V> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ObjectOpenCustomHashMap(Long2ObjectMap<V> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2ObjectOpenCustomHashMap(Long2ObjectMap<V> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2ObjectOpenCustomHashMap(long[] var1, V[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2ObjectOpenCustomHashMap(long[] var1, V[] var2, LongHash.Strategy var3) {
   ...
   public V getOrDefault(long var1, V var3) {
      if (this.strategy.equals(var1, 0L)) {
         ...
         long var4;
         int var7;
         if ((var4 = var6[var7 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask]) == 0L) {
            return var3;
   ...
   public Long2ObjectMap.FastEntrySet<V> long2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new Long2ObjectOpenCustomHashMap.MapEntrySet();
      }
   ...
   public LongSet keySet() {
      if (this.keys == null) {
         this.keys = new Long2ObjectOpenCustomHashMap.KeySet();
      }
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            public ObjectIterator<V> iterator() {
               return Long2ObjectOpenCustomHashMap.this.new ValueIterator();
            }
            ...
            public boolean contains(Object var1) {
               return Long2ObjectOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(Consumer<? super V> var1) {
               if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
                  var1.accept(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n]);
               }

               int var2 = Long2ObjectOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2ObjectOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2ObjectOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2ObjectOpenCustomHashMap<V> clone() {
      Long2ObjectOpenCustomHashMap var1;
      try {
         var1 = (Long2ObjectOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      Object[] var3 = this.value;
      Long2ObjectOpenCustomHashMap.MapIterator var4 = new Long2ObjectOpenCustomHashMap.MapIterator();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var7 = this.size; var7-- != 0; var3[var8] = var6) {
         ...
         if (this.strategy.equals(var4, 0L)) {
            ...
            for(var8 = HashCommon.mix(this.strategy.hashCode(var4)) & this.mask; var2[var8] != 0L; var8 = var8 + 1 & this.mask) {
            }
         }
   ...
   private final class ValueIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<V> {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongIterator iterator() {
         return Long2ObjectOpenCustomHashMap.this.new KeyIterator();
      }

      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n]);
         }

         int var2 = Long2ObjectOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2ObjectOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2ObjectOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2ObjectOpenCustomHashMap.this.size;
         Long2ObjectOpenCustomHashMap.this.remove(var1);
         return Long2ObjectOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class KeyIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements LongIterator {
      public KeyIterator() {
         super(null);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements Long2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectIterator<Long2ObjectMap.Entry<V>> iterator() {
         return Long2ObjectOpenCustomHashMap.this.new EntryIterator();
      }

      public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator() {
         return Long2ObjectOpenCustomHashMap.this.new FastEntryIterator();
      }
      ...
      public boolean contains(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               ...
               if (Long2ObjectOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                  return Long2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n], var5);
               } else {
                  long[] var8 = Long2ObjectOpenCustomHashMap.this.key;
                  long var6;
                  int var9;
                  if ((var6 = var8[var9 = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2ObjectOpenCustomHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Long2ObjectOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                     return Objects.equals(Long2ObjectOpenCustomHashMap.this.value[var9], var5);
                  } else {
                     while((var6 = var8[var9 = var9 + 1 & Long2ObjectOpenCustomHashMap.this.mask]) != 0L) {
                        if (Long2ObjectOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                           return Objects.equals(Long2ObjectOpenCustomHashMap.this.value[var9], var5);
                        }
                     }
      ...
      public boolean remove(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               ...
               Object var5 = var2.getValue();
               if (Long2ObjectOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                  if (Long2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n], var5)) {
                  ...
                  if ((var6 = var8[var9 = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2ObjectOpenCustomHashMap.this.mask]) == 0L) {
                     return false;
                  } else if (Long2ObjectOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                     if (Objects.equals(Long2ObjectOpenCustomHashMap.this.value[var9], var5)) {
                        Long2ObjectOpenCustomHashMap.this.removeEntry(var9);
                        return true;
                     } else {
                        return false;
                     }
                     ...
                     do {
                        if ((var6 = var8[var9 = var9 + 1 & Long2ObjectOpenCustomHashMap.this.mask]) == 0L) {
                           return false;
                        }
                     } while(!Long2ObjectOpenCustomHashMap.this.strategy.equals(var6, var3) || !Objects.equals(Long2ObjectOpenCustomHashMap.this.value[var9], var5));
      ...
      public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> var1) {
         if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2ObjectMap.BasicEntry(Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n], Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2ObjectOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2ObjectMap.BasicEntry(Long2ObjectOpenCustomHashMap.this.key[var2], Long2ObjectOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2ObjectMap.Entry<V>> var1) {
         ...
         if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n];
            var2.value = Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2ObjectOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2ObjectOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2ObjectOpenCustomHashMap.this.key[var3];
               var2.value = Long2ObjectOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Long2ObjectMap.Entry<V>> {
      private final Long2ObjectOpenCustomHashMap<V>.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2ObjectOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Long2ObjectMap.Entry<V>> {
      ...
      public Long2ObjectOpenCustomHashMap<V>.MapEntry next() {
         return this.entry = Long2ObjectOpenCustomHashMap.this.new MapEntry(this.nextEntry());
      }
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2ObjectOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2ObjectOpenCustomHashMap.this.mask; !Long2ObjectOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2ObjectOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2ObjectOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2ObjectOpenCustomHashMap.this.mask;

            long var4;
            while(true) {
               if ((var4 = var6[var1]) == 0L) {
                  var6[var2] = 0L;
                  Long2ObjectOpenCustomHashMap.this.value[var2] = null;
                  return;
               }

               int var3 = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2ObjectOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2ObjectOpenCustomHashMap.this.value[var2] = Long2ObjectOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2ObjectMap.Entry<V>, java.util.Map.Entry<Long, V> {
      ...
      public V setValue(V var1) {
         Object var2 = Long2ObjectOpenCustomHashMap.this.value[this.index];
         Long2ObjectOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[this.index], var2.getValue());
         }
      }
