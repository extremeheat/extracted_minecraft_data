...
public class Long2DoubleOpenHashMap extends AbstractLong2DoubleMap implements Serializable, Cloneable, Hash {
   ...
   public Long2DoubleOpenHashMap(int var1, float var2) {
      super();
   ...
   public Long2DoubleOpenHashMap(int var1) {
      this(var1, 0.75F);
   }
   ...
   public Long2DoubleOpenHashMap(Map<? extends Long, ? extends Double> var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2DoubleOpenHashMap(Map<? extends Long, ? extends Double> var1) {
      this(var1, 0.75F);
   }

   public Long2DoubleOpenHashMap(Long2DoubleMap var1, float var2) {
      this(var1.size(), var2);
      this.putAll(var1);
   }

   public Long2DoubleOpenHashMap(Long2DoubleMap var1) {
      this(var1, 0.75F);
   }

   public Long2DoubleOpenHashMap(long[] var1, double[] var2, float var3) {
   ...
   public Long2DoubleOpenHashMap(long[] var1, double[] var2) {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public boolean contains(double var1) {
               return Long2DoubleOpenHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Long2DoubleOpenHashMap.this.containsNullKey) {
                  var1.accept(Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n]);
               }

               int var2 = Long2DoubleOpenHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2DoubleOpenHashMap.this.key[var2] != 0L) {
                     var1.accept(Long2DoubleOpenHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2DoubleOpenHashMap clone() {
      Long2DoubleOpenHashMap var1;
      try {
         var1 = (Long2DoubleOpenHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      double[] var3 = this.value;
      Long2DoubleOpenHashMap.MapIterator var4 = new Long2DoubleOpenHashMap.MapIterator();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      for(int var8 = this.size; var8-- != 0; var3[var9] = var6) {
         ...
         if (var4 == 0L) {
            ...
            for(var9 = (int)HashCommon.mix(var4) & this.mask; var2[var9] != 0L; var9 = var9 + 1 & this.mask) {
            }
         }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(Long2DoubleOpenHashMap.this.key[Long2DoubleOpenHashMap.this.n]);
         }

         int var2 = Long2DoubleOpenHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2DoubleOpenHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2DoubleOpenHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2DoubleOpenHashMap.this.size;
         Long2DoubleOpenHashMap.this.remove(var1);
         return Long2DoubleOpenHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry> implements Long2DoubleMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  if (var3 == 0L) {
                     return Long2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var5);
                  } else {
                     long[] var9 = Long2DoubleOpenHashMap.this.key;
                     long var7;
                     int var10;
                     if ((var7 = var9[var10 = (int)HashCommon.mix(var3) & Long2DoubleOpenHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (var3 == var7) {
                        return Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[var10]) == Double.doubleToLongBits(var5);
                     } else {
                        while((var7 = var9[var10 = var10 + 1 & Long2DoubleOpenHashMap.this.mask]) != 0L) {
                           if (var3 == var7) {
                              return Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[var10]) == Double.doubleToLongBits(var5);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Double) {
                  ...
                  double var5 = (Double)var2.getValue();
                  if (var3 == 0L) {
                     if (Long2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n]) == Double.doubleToLongBits(var5)) {
                     ...
                     if ((var7 = var9[var10 = (int)HashCommon.mix(var3) & Long2DoubleOpenHashMap.this.mask]) == 0L) {
                        ...
                        if (Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[var10]) == Double.doubleToLongBits(var5)) {
                           Long2DoubleOpenHashMap.this.removeEntry(var10);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var7 = var9[var10 = var10 + 1 & Long2DoubleOpenHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(var7 != var3 || Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[var10]) != Double.doubleToLongBits(var5));
      ...
      public void forEach(Consumer<? super Long2DoubleMap.Entry> var1) {
         if (Long2DoubleOpenHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2DoubleMap.BasicEntry(Long2DoubleOpenHashMap.this.key[Long2DoubleOpenHashMap.this.n], Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2DoubleOpenHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2DoubleMap.BasicEntry(Long2DoubleOpenHashMap.this.key[var2], Long2DoubleOpenHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2DoubleMap.Entry> var1) {
         ...
         if (Long2DoubleOpenHashMap.this.containsNullKey) {
            var2.key = Long2DoubleOpenHashMap.this.key[Long2DoubleOpenHashMap.this.n];
            var2.value = Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2DoubleOpenHashMap.this.n;

         while(var3-- != 0) {
            if (Long2DoubleOpenHashMap.this.key[var3] != 0L) {
               var2.key = Long2DoubleOpenHashMap.this.key[var3];
               var2.value = Long2DoubleOpenHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2DoubleOpenHashMap.MapIterator implements ObjectIterator<Long2DoubleMap.Entry> {
      private final Long2DoubleOpenHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2DoubleOpenHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2DoubleOpenHashMap.MapIterator implements ObjectIterator<Long2DoubleMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2DoubleOpenHashMap.this.key;
               ...
               int var4;
               for(var4 = (int)HashCommon.mix(var2) & Long2DoubleOpenHashMap.this.mask; var2 != var1[var4]; var4 = var4 + 1 & Long2DoubleOpenHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2DoubleOpenHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2DoubleOpenHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = (int)HashCommon.mix(var4) & Long2DoubleOpenHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2DoubleOpenHashMap.this.value[var2] = Long2DoubleOpenHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2DoubleMap.Entry, java.util.Map.Entry<Long, Double> {
      ...
      public double setValue(double var1) {
         double var3 = Long2DoubleOpenHashMap.this.value[this.index];
         Long2DoubleOpenHashMap.this.value[this.index] = var1;
         return var3;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2DoubleOpenHashMap.this.key[this.index] == (Long)var2.getKey() && Double.doubleToLongBits(Long2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)var2.getValue());
         }
      }
