...
public class Long2FloatAVLTreeMap extends AbstractLong2FloatSortedMap implements Serializable, Cloneable {
   ...
   public Long2FloatAVLTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2FloatAVLTreeMap(Map<? extends Long, ? extends Float> var1) {
      this();
      this.putAll(var1);
   }

   public Long2FloatAVLTreeMap(SortedMap<Long, Float> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2FloatAVLTreeMap(Long2FloatMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2FloatAVLTreeMap(Long2FloatSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2FloatAVLTreeMap(long[] var1, float[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2FloatAVLTreeMap(long[] var1, float[] var2) {
   ...
   final Long2FloatAVLTreeMap.Entry findKey(long var1) {
      Long2FloatAVLTreeMap.Entry var3;
      int var4;
   ...
   final Long2FloatAVLTreeMap.Entry locateKey(long var1) {
      Long2FloatAVLTreeMap.Entry var3 = this.tree;
      Long2FloatAVLTreeMap.Entry var4 = this.tree;
   ...
   public float addTo(long var1, float var3) {
      Long2FloatAVLTreeMap.Entry var4 = this.add(var1);
   ...
   private Long2FloatAVLTreeMap.Entry add(long var1) {
      this.modified = false;
      Long2FloatAVLTreeMap.Entry var3 = null;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Long2FloatAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Long2FloatAVLTreeMap.Entry var4 = this.tree;
         Long2FloatAVLTreeMap.Entry var5 = null;
         Long2FloatAVLTreeMap.Entry var6 = this.tree;
         Long2FloatAVLTreeMap.Entry var7 = null;
         Long2FloatAVLTreeMap.Entry var8 = null;
         int var10 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var10++] = var9 > 0) {
               if (var4.succ()) {
                  ++this.count;
                  var3 = new Long2FloatAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var4.right == null) {
                     this.lastEntry = var3;
                  }
         ...
         Long2FloatAVLTreeMap.Entry var11;
         if (var6.balance() == -2) {
            var11 = var6.left;
            if (var11.balance() == -1) {
               var8 = var11;
   ...
   private Long2FloatAVLTreeMap.Entry parent(Long2FloatAVLTreeMap.Entry var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Long2FloatAVLTreeMap.Entry var3 = var1;

         Long2FloatAVLTreeMap.Entry var2;
         Long2FloatAVLTreeMap.Entry var4;
   ...
   public float remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2FloatAVLTreeMap.Entry var9;
         Long2FloatAVLTreeMap.Entry var10;
         if (var4.succ()) {
            if (var4.pred()) {
               if (var5 != null) {
                  if (var6) {
   ...
   public boolean containsValue(float var1) {
      Long2FloatAVLTreeMap.ValueIterator var2 = new Long2FloatAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public float get(long var1) {
      Long2FloatAVLTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
            final Comparator<? super Long2FloatMap.Entry> comparator = (var1x, var2) -> {
               return Long2FloatAVLTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry var1) {
               return Long2FloatAVLTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        Long2FloatAVLTreeMap.Entry var3 = Long2FloatAVLTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Float) {
                        ...
                        if (var3 != null && Float.floatToIntBits(var3.getFloatValue()) == Float.floatToIntBits((Float)var2.getValue())) {
                           Long2FloatAVLTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry var1, Long2FloatMap.Entry var2) {
               return Long2FloatAVLTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2FloatEntrySet();
            }

            public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry var1) {
               return Long2FloatAVLTreeMap.this.headMap(var1.getLongKey()).long2FloatEntrySet();
            }

            public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry var1) {
               return Long2FloatAVLTreeMap.this.tailMap(var1.getLongKey()).long2FloatEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Long2FloatAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Long2FloatSortedMap headMap(long var1) {
      return new Long2FloatAVLTreeMap.Submap(0L, true, var1, false);
   }

   public Long2FloatSortedMap tailMap(long var1) {
      return new Long2FloatAVLTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2FloatSortedMap subMap(long var1, long var3) {
      return new Long2FloatAVLTreeMap.Submap(var1, false, var3, false);
   }

   public Long2FloatAVLTreeMap clone() {
      Long2FloatAVLTreeMap var1;
      try {
         var1 = (Long2FloatAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2FloatAVLTreeMap.Entry var5 = new Long2FloatAVLTreeMap.Entry();
         Long2FloatAVLTreeMap.Entry var6 = new Long2FloatAVLTreeMap.Entry();
         Long2FloatAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2FloatAVLTreeMap.Entry var4 = var6;
         var6.pred((Long2FloatAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2FloatAVLTreeMap.EntryIterator var3 = new Long2FloatAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2FloatAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2FloatAVLTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2FloatAVLTreeMap.Entry var3, Long2FloatAVLTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2FloatAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2FloatAVLTreeMap.Entry(var1.readLong(), var1.readFloat());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Long2FloatAVLTreeMap.Entry(var1.readLong(), var1.readFloat());
         var8.right(new Long2FloatAVLTreeMap.Entry(var1.readLong(), var1.readFloat()));
         ...
         Long2FloatAVLTreeMap.Entry var7 = new Long2FloatAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2FloatAVLTreeMap.Entry)null, (Long2FloatAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2FloatSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2FloatAVLTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2FloatAVLTreeMap.Submap.SubmapIterator var1 = new Long2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2FloatAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2FloatAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2FloatAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(float var1) {
         Long2FloatAVLTreeMap.Submap.SubmapIterator var2 = new Long2FloatAVLTreeMap.Submap.SubmapIterator();
      ...
      public float get(long var1) {
         Long2FloatAVLTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2FloatAVLTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public float put(long var1, float var3) {
         ...
         if (!this.in(var1)) {
            ...
            float var4 = Long2FloatAVLTreeMap.this.put(var1, var3);
            return Long2FloatAVLTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public float remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            float var3 = Long2FloatAVLTreeMap.this.remove(var1);
            return Long2FloatAVLTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2FloatSortedMap headMap(long var1) {
         if (this.top) {
            return Long2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2FloatAVLTreeMap.this.compare(var1, this.to) < 0 ? Long2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2FloatSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? Long2FloatAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2FloatSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2FloatAVLTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2FloatAVLTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2FloatAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2FloatAVLTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2FloatAVLTreeMap.Entry firstEntry() {
         if (Long2FloatAVLTreeMap.this.tree == null) {
            ...
            Long2FloatAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2FloatAVLTreeMap.this.firstEntry;
            } else {
               var1 = Long2FloatAVLTreeMap.this.locateKey(this.from);
               if (Long2FloatAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2FloatAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2FloatAVLTreeMap.Entry lastEntry() {
         if (Long2FloatAVLTreeMap.this.tree == null) {
            ...
            Long2FloatAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2FloatAVLTreeMap.this.lastEntry;
            } else {
               var1 = Long2FloatAVLTreeMap.this.locateKey(this.to);
               if (Long2FloatAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2FloatAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2FloatAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2FloatAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2FloatAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2FloatMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2FloatAVLTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2FloatAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2FloatAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2FloatAVLTreeMap.this.locateKey(var2);
                  if (Long2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2FloatSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2FloatAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2FloatAVLTreeMap.TreeIterator implements ObjectListIterator<Long2FloatMap.Entry> {
      EntryIterator() {
         super();
      }
      ...
      public void set(Long2FloatMap.Entry var1) {
         throw new UnsupportedOperationException();
      }

      public void add(Long2FloatMap.Entry var1) {
         throw new UnsupportedOperationException();
      }
   }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2FloatAVLTreeMap.this.locateKey(var2)) != null) {
            if (Long2FloatAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2FloatMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2FloatAVLTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2FloatAVLTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2FloatAVLTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2FloatAVLTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2FloatAVLTreeMap.Entry next() {
         Long2FloatAVLTreeMap.Entry var1 = this.right;
      ...
      Long2FloatAVLTreeMap.Entry prev() {
         Long2FloatAVLTreeMap.Entry var1 = this.left;
      ...
      public Long2FloatAVLTreeMap.Entry clone() {
         Long2FloatAVLTreeMap.Entry var1;
         try {
            var1 = (Long2FloatAVLTreeMap.Entry)super.clone();
