...
public class Long2ByteRBTreeMap extends AbstractLong2ByteSortedMap implements Serializable, Cloneable {
   ...
   public Long2ByteRBTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2ByteRBTreeMap(Map<? extends Long, ? extends Byte> var1) {
      this();
      this.putAll(var1);
   }

   public Long2ByteRBTreeMap(SortedMap<Long, Byte> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2ByteRBTreeMap(Long2ByteMap var1) {
      this();
      this.putAll(var1);
   }

   public Long2ByteRBTreeMap(Long2ByteSortedMap var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2ByteRBTreeMap(long[] var1, byte[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2ByteRBTreeMap(long[] var1, byte[] var2) {
   ...
   final Long2ByteRBTreeMap.Entry findKey(long var1) {
      Long2ByteRBTreeMap.Entry var3;
      int var4;
   ...
   final Long2ByteRBTreeMap.Entry locateKey(long var1) {
      Long2ByteRBTreeMap.Entry var3 = this.tree;
      Long2ByteRBTreeMap.Entry var4 = this.tree;
   ...
   public byte addTo(long var1, byte var3) {
      Long2ByteRBTreeMap.Entry var4 = this.add(var1);
   ...
   private Long2ByteRBTreeMap.Entry add(long var1) {
      this.modified = false;
      int var3 = 0;
      Long2ByteRBTreeMap.Entry var4;
      if (this.tree == null) {
         ++this.count;
         var4 = this.tree = this.lastEntry = this.firstEntry = new Long2ByteRBTreeMap.Entry(var1, this.defRetValue);
      } else {
         Long2ByteRBTreeMap.Entry var5 = this.tree;
         int var7 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var7++] = var6 > 0) {
               ...
               ++this.count;
               var4 = new Long2ByteRBTreeMap.Entry(var1, this.defRetValue);
               if (var5.right == null) {
                  this.lastEntry = var4;
               }
            ...
            while(true) {
               ...
               Long2ByteRBTreeMap.Entry var8;
               Long2ByteRBTreeMap.Entry var9;
   ...
   public byte remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2ByteRBTreeMap.Entry var9;
         Long2ByteRBTreeMap.Entry var10;
         if (var3.succ()) {
            if (var3.pred()) {
               if (var5 == 0) {
                  this.tree = var3.left;
   ...
   public boolean containsValue(byte var1) {
      Long2ByteRBTreeMap.ValueIterator var2 = new Long2ByteRBTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public byte get(long var1) {
      Long2ByteRBTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() {
            final Comparator<? super Long2ByteMap.Entry> comparator = (var1x, var2) -> {
               return Long2ByteRBTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry var1) {
               return Long2ByteRBTreeMap.this.new EntryIterator(var1.getLongKey());
            }
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        Long2ByteRBTreeMap.Entry var3 = Long2ByteRBTreeMap.this.findKey((Long)var2.getKey());
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     if (var2.getValue() != null && var2.getValue() instanceof Byte) {
                        ...
                        if (var3 != null && var3.getByteValue() == (Byte)var2.getValue()) {
                           Long2ByteRBTreeMap.this.remove(var3.key);
                           return true;
                        } else {
                           return false;
                        }
            ...
            public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry var1, Long2ByteMap.Entry var2) {
               return Long2ByteRBTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2ByteEntrySet();
            }

            public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry var1) {
               return Long2ByteRBTreeMap.this.headMap(var1.getLongKey()).long2ByteEntrySet();
            }

            public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry var1) {
               return Long2ByteRBTreeMap.this.tailMap(var1.getLongKey()).long2ByteEntrySet();
            }
         };
      }
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public boolean contains(byte var1) {
               return Long2ByteRBTreeMap.this.containsValue(var1);
            }
   ...
   public Long2ByteSortedMap headMap(long var1) {
      return new Long2ByteRBTreeMap.Submap(0L, true, var1, false);
   }

   public Long2ByteSortedMap tailMap(long var1) {
      return new Long2ByteRBTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2ByteSortedMap subMap(long var1, long var3) {
      return new Long2ByteRBTreeMap.Submap(var1, false, var3, false);
   }

   public Long2ByteRBTreeMap clone() {
      Long2ByteRBTreeMap var1;
      try {
         var1 = (Long2ByteRBTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2ByteRBTreeMap.Entry var5 = new Long2ByteRBTreeMap.Entry();
         Long2ByteRBTreeMap.Entry var6 = new Long2ByteRBTreeMap.Entry();
         Long2ByteRBTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2ByteRBTreeMap.Entry var4 = var6;
         var6.pred((Long2ByteRBTreeMap.Entry)null);

         while(true) {
            Long2ByteRBTreeMap.Entry var2;
            if (!var3.pred()) {
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2ByteRBTreeMap.EntryIterator var3 = new Long2ByteRBTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2ByteRBTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2ByteRBTreeMap.Entry readTree(ObjectInputStream var1, int var2, Long2ByteRBTreeMap.Entry var3, Long2ByteRBTreeMap.Entry var4) throws IOException, ClassNotFoundException {
      Long2ByteRBTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2ByteRBTreeMap.Entry(var1.readLong(), var1.readByte());
         var8.pred(var3);
         var8.succ(var4);
         var8.black(true);
         return var8;
         ...
         var8 = new Long2ByteRBTreeMap.Entry(var1.readLong(), var1.readByte());
         var8.black(true);
         var8.right(new Long2ByteRBTreeMap.Entry(var1.readLong(), var1.readByte()));
         ...
         Long2ByteRBTreeMap.Entry var7 = new Long2ByteRBTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2ByteRBTreeMap.Entry)null, (Long2ByteRBTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2ByteSortedMap implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2ByteRBTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2ByteRBTreeMap.Submap.SubmapIterator var1 = new Long2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2ByteRBTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2ByteRBTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2ByteRBTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(byte var1) {
         Long2ByteRBTreeMap.Submap.SubmapIterator var2 = new Long2ByteRBTreeMap.Submap.SubmapIterator();
      ...
      public byte get(long var1) {
         Long2ByteRBTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2ByteRBTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public byte put(long var1, byte var3) {
         ...
         if (!this.in(var1)) {
            ...
            byte var4 = Long2ByteRBTreeMap.this.put(var1, var3);
            return Long2ByteRBTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public byte remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            byte var3 = Long2ByteRBTreeMap.this.remove(var1);
            return Long2ByteRBTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2ByteSortedMap headMap(long var1) {
         if (this.top) {
            return Long2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2ByteRBTreeMap.this.compare(var1, this.to) < 0 ? Long2ByteRBTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2ByteSortedMap tailMap(long var1) {
         if (this.bottom) {
            return Long2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? Long2ByteRBTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2ByteSortedMap subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2ByteRBTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2ByteRBTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2ByteRBTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2ByteRBTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2ByteRBTreeMap.Entry firstEntry() {
         if (Long2ByteRBTreeMap.this.tree == null) {
            ...
            Long2ByteRBTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2ByteRBTreeMap.this.firstEntry;
            } else {
               var1 = Long2ByteRBTreeMap.this.locateKey(this.from);
               if (Long2ByteRBTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2ByteRBTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2ByteRBTreeMap.Entry lastEntry() {
         if (Long2ByteRBTreeMap.this.tree == null) {
            ...
            Long2ByteRBTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2ByteRBTreeMap.this.lastEntry;
            } else {
               var1 = Long2ByteRBTreeMap.this.locateKey(this.to);
               if (Long2ByteRBTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2ByteRBTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2ByteRBTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2ByteRBTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2ByteRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Long2ByteMap.Entry> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2ByteRBTreeMap.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2ByteRBTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2ByteRBTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2ByteRBTreeMap.this.locateKey(var2);
                  if (Long2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2ByteSortedMap.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2ByteRBTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2ByteRBTreeMap.TreeIterator implements ObjectListIterator<Long2ByteMap.Entry> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2ByteRBTreeMap.this.locateKey(var2)) != null) {
            if (Long2ByteRBTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry extends AbstractLong2ByteMap.BasicEntry implements Cloneable {
      ...
      void pred(Long2ByteRBTreeMap.Entry var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2ByteRBTreeMap.Entry var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2ByteRBTreeMap.Entry var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2ByteRBTreeMap.Entry var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2ByteRBTreeMap.Entry next() {
         Long2ByteRBTreeMap.Entry var1 = this.right;
      ...
      Long2ByteRBTreeMap.Entry prev() {
         Long2ByteRBTreeMap.Entry var1 = this.left;
      ...
      public Long2ByteRBTreeMap.Entry clone() {
         Long2ByteRBTreeMap.Entry var1;
         try {
            var1 = (Long2ByteRBTreeMap.Entry)super.clone();
