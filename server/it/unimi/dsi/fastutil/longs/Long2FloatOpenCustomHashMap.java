...
public class Long2FloatOpenCustomHashMap extends AbstractLong2FloatMap implements Serializable, Cloneable, Hash {
   ...
   public Long2FloatOpenCustomHashMap(int var1, float var2, LongHash.Strategy var3) {
      super();
      this.strategy = var3;
   ...
   public Long2FloatOpenCustomHashMap(int var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2FloatOpenCustomHashMap(LongHash.Strategy var1) {
      this(16, 0.75F, var1);
   }

   public Long2FloatOpenCustomHashMap(Map<? extends Long, ? extends Float> var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2FloatOpenCustomHashMap(Map<? extends Long, ? extends Float> var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2FloatOpenCustomHashMap(Long2FloatMap var1, float var2, LongHash.Strategy var3) {
      this(var1.size(), var2, var3);
      this.putAll(var1);
   }

   public Long2FloatOpenCustomHashMap(Long2FloatMap var1, LongHash.Strategy var2) {
      this(var1, 0.75F, var2);
   }

   public Long2FloatOpenCustomHashMap(long[] var1, float[] var2, float var3, LongHash.Strategy var4) {
   ...
   public Long2FloatOpenCustomHashMap(long[] var1, float[] var2, LongHash.Strategy var3) {
   ...
   public float addTo(long var1, float var3) {
      ...
      if (this.strategy.equals(var1, 0L)) {
         ...
         long[] var7 = this.key;
         long var5;
         if ((var5 = var7[var4 = HashCommon.mix(this.strategy.hashCode(var1)) & this.mask]) != 0L) {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public boolean contains(float var1) {
               return Long2FloatOpenCustomHashMap.this.containsValue(var1);
            }
            ...
            public void forEach(DoubleConsumer var1) {
               if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                  var1.accept((double)Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]);
               }

               int var2 = Long2FloatOpenCustomHashMap.this.n;

               while(var2-- != 0) {
                  if (Long2FloatOpenCustomHashMap.this.key[var2] != 0L) {
                     var1.accept((double)Long2FloatOpenCustomHashMap.this.value[var2]);
                  }
               }
   ...
   public Long2FloatOpenCustomHashMap clone() {
      Long2FloatOpenCustomHashMap var1;
      try {
         var1 = (Long2FloatOpenCustomHashMap)super.clone();
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      long[] var2 = this.key;
      float[] var3 = this.value;
      Long2FloatOpenCustomHashMap.MapIterator var4 = new Long2FloatOpenCustomHashMap.MapIterator();
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer var1) {
         if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(Long2FloatOpenCustomHashMap.this.key[Long2FloatOpenCustomHashMap.this.n]);
         }

         int var2 = Long2FloatOpenCustomHashMap.this.n;

         while(var2-- != 0) {
            long var3 = Long2FloatOpenCustomHashMap.this.key[var2];
            if (var3 != 0L) {
               var1.accept(var3);
            }
         }
      ...
      public boolean contains(long var1) {
         return Long2FloatOpenCustomHashMap.this.containsKey(var1);
      }

      public boolean remove(long var1) {
         int var3 = Long2FloatOpenCustomHashMap.this.size;
         Long2FloatOpenCustomHashMap.this.remove(var1);
         return Long2FloatOpenCustomHashMap.this.size != var3;
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet {
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  if (Long2FloatOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     return Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var5);
                  } else {
                     long[] var8 = Long2FloatOpenCustomHashMap.this.key;
                     long var6;
                     int var9;
                     if ((var6 = var8[var9 = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2FloatOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2FloatOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                        return Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[var9]) == Float.floatToIntBits(var5);
                     } else {
                        while((var6 = var8[var9 = var9 + 1 & Long2FloatOpenCustomHashMap.this.mask]) != 0L) {
                           if (Long2FloatOpenCustomHashMap.this.strategy.equals(var3, var6)) {
                              return Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[var9]) == Float.floatToIntBits(var5);
                           }
                        }
         ...
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            if (var2.getKey() != null && var2.getKey() instanceof Long) {
               if (var2.getValue() != null && var2.getValue() instanceof Float) {
                  ...
                  float var5 = (Float)var2.getValue();
                  if (Long2FloatOpenCustomHashMap.this.strategy.equals(var3, 0L)) {
                     if (Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(var5)) {
                     ...
                     if ((var6 = var8[var9 = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(var3)) & Long2FloatOpenCustomHashMap.this.mask]) == 0L) {
                        return false;
                     } else if (Long2FloatOpenCustomHashMap.this.strategy.equals(var6, var3)) {
                        if (Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[var9]) == Float.floatToIntBits(var5)) {
                           Long2FloatOpenCustomHashMap.this.removeEntry(var9);
                           return true;
                        } else {
                           return false;
                        }
                        ...
                        do {
                           if ((var6 = var8[var9 = var9 + 1 & Long2FloatOpenCustomHashMap.this.mask]) == 0L) {
                              return false;
                           }
                        } while(!Long2FloatOpenCustomHashMap.this.strategy.equals(var6, var3) || Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[var9]) != Float.floatToIntBits(var5));
      ...
      public void forEach(Consumer<? super Long2FloatMap.Entry> var1) {
         if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
            var1.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatOpenCustomHashMap.this.key[Long2FloatOpenCustomHashMap.this.n], Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]));
         }
         ...
         while(var2-- != 0) {
            if (Long2FloatOpenCustomHashMap.this.key[var2] != 0L) {
               var1.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatOpenCustomHashMap.this.key[var2], Long2FloatOpenCustomHashMap.this.value[var2]));
            }
         }
      ...
      public void fastForEach(Consumer<? super Long2FloatMap.Entry> var1) {
         ...
         if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
            var2.key = Long2FloatOpenCustomHashMap.this.key[Long2FloatOpenCustomHashMap.this.n];
            var2.value = Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n];
            var1.accept(var2);
         }

         int var3 = Long2FloatOpenCustomHashMap.this.n;

         while(var3-- != 0) {
            if (Long2FloatOpenCustomHashMap.this.key[var3] != 0L) {
               var2.key = Long2FloatOpenCustomHashMap.this.key[var3];
               var2.value = Long2FloatOpenCustomHashMap.this.value[var3];
               var1.accept(var2);
            }
         }
   ...
   private class FastEntryIterator extends Long2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Long2FloatMap.Entry> {
      private final Long2FloatOpenCustomHashMap.MapEntry entry;

      private FastEntryIterator() {
         super(null);
         this.entry = Long2FloatOpenCustomHashMap.this.new MapEntry();
      }
   ...
   private class EntryIterator extends Long2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Long2FloatMap.Entry> {
   ...
   private class MapIterator {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               long[] var1 = Long2FloatOpenCustomHashMap.this.key;
               ...
               int var4;
               for(var4 = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(var2)) & Long2FloatOpenCustomHashMap.this.mask; !Long2FloatOpenCustomHashMap.this.strategy.equals(var2, var1[var4]); var4 = var4 + 1 & Long2FloatOpenCustomHashMap.this.mask) {
               }
      ...
      private void shiftKeys(int var1) {
         long[] var6 = Long2FloatOpenCustomHashMap.this.key;

         while(true) {
            int var2 = var1;
            var1 = var1 + 1 & Long2FloatOpenCustomHashMap.this.mask;
            ...
            while(true) {
               ...
               int var3 = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(var4)) & Long2FloatOpenCustomHashMap.this.mask;
               if (var2 <= var1) {
                  if (var2 >= var3 || var3 > var1) {
                     break;
                  }
            ...
            var6[var2] = var4;
            Long2FloatOpenCustomHashMap.this.value[var2] = Long2FloatOpenCustomHashMap.this.value[var1];
         }
      }
   ...
   final class MapEntry implements Long2FloatMap.Entry, java.util.Map.Entry<Long, Float> {
      ...
      public float setValue(float var1) {
         float var2 = Long2FloatOpenCustomHashMap.this.value[this.index];
         Long2FloatOpenCustomHashMap.this.value[this.index] = var1;
         return var2;
      }
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            java.util.Map.Entry var2 = (java.util.Map.Entry)var1;
            return Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[this.index], (Long)var2.getKey()) && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)var2.getValue());
         }
      }
