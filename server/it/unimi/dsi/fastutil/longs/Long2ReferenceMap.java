...
public interface Long2ReferenceMap<V> extends Long2ReferenceFunction<V>, Map<Long, V> {
   ...
   default V put(Long var1, V var2) {
      return Long2ReferenceFunction.super.put(var1, var2);
   }

   /** @deprecated */
   @Deprecated
   default V get(Object var1) {
      return Long2ReferenceFunction.super.get(var1);
   }

   /** @deprecated */
   @Deprecated
   default V remove(Object var1) {
      return Long2ReferenceFunction.super.remove(var1);
   }
   ...
   default boolean containsKey(Object var1) {
      return Long2ReferenceFunction.super.containsKey(var1);
   }
   ...
   default V computeIfAbsentPartial(long var1, Long2ReferenceFunction<? extends V> var3) {
      Objects.requireNonNull(var3);
      Object var4 = this.get(var1);
      Object var5 = this.defaultReturnValue();
      if (var4 == var5 && !this.containsKey(var1)) {
   ...
   public interface FastEntrySet<V> extends ObjectSet<Long2ReferenceMap.Entry<V>> {
      ...
      default void fastForEach(Consumer<? super Long2ReferenceMap.Entry<V>> var1) {
         this.forEach(var1);
      }
   }
}
