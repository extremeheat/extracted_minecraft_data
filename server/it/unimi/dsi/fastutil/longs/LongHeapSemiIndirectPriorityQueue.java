...
public class LongHeapSemiIndirectPriorityQueue implements LongIndirectPriorityQueue {
   ...
   public LongHeapSemiIndirectPriorityQueue(long[] var1, int var2, LongComparator var3) {
      super();
   ...
   public LongHeapSemiIndirectPriorityQueue(long[] var1, int var2) {
      this(var1, var2, (LongComparator)null);
   }

   public LongHeapSemiIndirectPriorityQueue(long[] var1, LongComparator var2) {
      this(var1, var1.length, var2);
   }

   public LongHeapSemiIndirectPriorityQueue(long[] var1) {
      this(var1, var1.length, (LongComparator)null);
   }

   public LongHeapSemiIndirectPriorityQueue(long[] var1, int[] var2, int var3, LongComparator var4) {
      this(var1, 0, var4);
      this.heap = var2;
      this.size = var3;
      LongSemiIndirectHeaps.makeHeap(var1, var2, var3, var4);
   }
   ...
   public LongHeapSemiIndirectPriorityQueue(long[] var1, int[] var2, int var3) {
   ...
   public int front(int[] var1) {
      return this.c == null ? LongSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1) : LongSemiIndirectHeaps.front(this.refArray, this.heap, this.size, var1, this.c);
   }
