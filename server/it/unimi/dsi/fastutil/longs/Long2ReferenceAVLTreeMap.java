...
public class Long2ReferenceAVLTreeMap<V> extends AbstractLong2ReferenceSortedMap<V> implements Serializable, Cloneable {
   ...
   public Long2ReferenceAVLTreeMap(Comparator<? super Long> var1) {
      this();
      this.storedComparator = var1;
      this.setActualComparator();
   }

   public Long2ReferenceAVLTreeMap(Map<? extends Long, ? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Long2ReferenceAVLTreeMap(SortedMap<Long, V> var1) {
      this(var1.comparator());
      this.putAll(var1);
   }

   public Long2ReferenceAVLTreeMap(Long2ReferenceMap<? extends V> var1) {
      this();
      this.putAll(var1);
   }

   public Long2ReferenceAVLTreeMap(Long2ReferenceSortedMap<V> var1) {
      this((Comparator)var1.comparator());
      this.putAll(var1);
   }

   public Long2ReferenceAVLTreeMap(long[] var1, V[] var2, Comparator<? super Long> var3) {
      this(var3);
   ...
   public Long2ReferenceAVLTreeMap(long[] var1, V[] var2) {
   ...
   final Long2ReferenceAVLTreeMap.Entry<V> findKey(long var1) {
      Long2ReferenceAVLTreeMap.Entry var3;
      int var4;
   ...
   final Long2ReferenceAVLTreeMap.Entry<V> locateKey(long var1) {
      Long2ReferenceAVLTreeMap.Entry var3 = this.tree;
      Long2ReferenceAVLTreeMap.Entry var4 = this.tree;
   ...
   public V put(long var1, V var3) {
      Long2ReferenceAVLTreeMap.Entry var4 = this.add(var1);
      Object var5 = var4.value;
      var4.value = var3;
      return var5;
   }

   private Long2ReferenceAVLTreeMap.Entry<V> add(long var1) {
      this.modified = false;
      Long2ReferenceAVLTreeMap.Entry var3 = null;
      if (this.tree == null) {
         ++this.count;
         var3 = this.tree = this.lastEntry = this.firstEntry = new Long2ReferenceAVLTreeMap.Entry(var1, this.defRetValue);
         this.modified = true;
      } else {
         Long2ReferenceAVLTreeMap.Entry var4 = this.tree;
         Long2ReferenceAVLTreeMap.Entry var5 = null;
         Long2ReferenceAVLTreeMap.Entry var6 = this.tree;
         Long2ReferenceAVLTreeMap.Entry var7 = null;
         Long2ReferenceAVLTreeMap.Entry var8 = null;
         int var10 = 0;
         ...
         while(true) {
            ...
            if (this.dirPath[var10++] = var9 > 0) {
               if (var4.succ()) {
                  ++this.count;
                  var3 = new Long2ReferenceAVLTreeMap.Entry(var1, this.defRetValue);
                  this.modified = true;
                  if (var4.right == null) {
                     this.lastEntry = var3;
                  }
         ...
         Long2ReferenceAVLTreeMap.Entry var11;
         if (var6.balance() == -2) {
            var11 = var6.left;
            if (var11.balance() == -1) {
               var8 = var11;
   ...
   private Long2ReferenceAVLTreeMap.Entry<V> parent(Long2ReferenceAVLTreeMap.Entry<V> var1) {
      if (var1 == this.tree) {
         return null;
      } else {
         Long2ReferenceAVLTreeMap.Entry var3 = var1;

         Long2ReferenceAVLTreeMap.Entry var2;
         Long2ReferenceAVLTreeMap.Entry var4;
   ...
   public V remove(long var1) {
      ...
      if (this.tree == null) {
         ...
         Long2ReferenceAVLTreeMap.Entry var9;
         Long2ReferenceAVLTreeMap.Entry var10;
         if (var4.succ()) {
            if (var4.pred()) {
               if (var5 != null) {
                  if (var6) {
   ...
   public boolean containsValue(Object var1) {
      Long2ReferenceAVLTreeMap.ValueIterator var2 = new Long2ReferenceAVLTreeMap.ValueIterator();
      int var4 = this.count;
   ...
   public V get(long var1) {
      Long2ReferenceAVLTreeMap.Entry var3 = this.findKey(var1);
      ...
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() {
            final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = (var1x, var2) -> {
               return Long2ReferenceAVLTreeMap.this.actualComparator.compare(var1x.getLongKey(), var2.getLongKey());
            };
            ...
            public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> var1) {
               return Long2ReferenceAVLTreeMap.this.new EntryIterator(var1.getLongKey());
            }
            ...
            public boolean contains(Object var1) {
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     Long2ReferenceAVLTreeMap.Entry var3 = Long2ReferenceAVLTreeMap.this.findKey((Long)var2.getKey());
               ...
               if (!(var1 instanceof java.util.Map.Entry)) {
                  ...
                  if (var2.getKey() != null && var2.getKey() instanceof Long) {
                     ...
                     if (var3 != null && var3.getValue() == var2.getValue()) {
                        Long2ReferenceAVLTreeMap.this.remove(var3.key);
                        return true;
                     } else {
                        return false;
                     }
            ...
            public ObjectSortedSet<Long2ReferenceMap.Entry<V>> subSet(Long2ReferenceMap.Entry<V> var1, Long2ReferenceMap.Entry<V> var2) {
               return Long2ReferenceAVLTreeMap.this.subMap(var1.getLongKey(), var2.getLongKey()).long2ReferenceEntrySet();
            }

            public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> var1) {
               return Long2ReferenceAVLTreeMap.this.headMap(var1.getLongKey()).long2ReferenceEntrySet();
            }

            public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> var1) {
               return Long2ReferenceAVLTreeMap.this.tailMap(var1.getLongKey()).long2ReferenceEntrySet();
            }
         };
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public boolean contains(Object var1) {
               return Long2ReferenceAVLTreeMap.this.containsValue(var1);
            }
   ...
   public Long2ReferenceSortedMap<V> headMap(long var1) {
      return new Long2ReferenceAVLTreeMap.Submap(0L, true, var1, false);
   }

   public Long2ReferenceSortedMap<V> tailMap(long var1) {
      return new Long2ReferenceAVLTreeMap.Submap(var1, false, 0L, true);
   }

   public Long2ReferenceSortedMap<V> subMap(long var1, long var3) {
      return new Long2ReferenceAVLTreeMap.Submap(var1, false, var3, false);
   }

   public Long2ReferenceAVLTreeMap<V> clone() {
      Long2ReferenceAVLTreeMap var1;
      try {
         var1 = (Long2ReferenceAVLTreeMap)super.clone();
      ...
      if (this.count == 0) {
         ...
         Long2ReferenceAVLTreeMap.Entry var5 = new Long2ReferenceAVLTreeMap.Entry();
         Long2ReferenceAVLTreeMap.Entry var6 = new Long2ReferenceAVLTreeMap.Entry();
         Long2ReferenceAVLTreeMap.Entry var3 = var5;
         var5.left(this.tree);
         Long2ReferenceAVLTreeMap.Entry var4 = var6;
         var6.pred((Long2ReferenceAVLTreeMap.Entry)null);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      int var2 = this.count;
      Long2ReferenceAVLTreeMap.EntryIterator var3 = new Long2ReferenceAVLTreeMap.EntryIterator();
      var1.defaultWriteObject();

      while(var2-- != 0) {
         Long2ReferenceAVLTreeMap.Entry var4 = var3.nextEntry();
   ...
   private Long2ReferenceAVLTreeMap.Entry<V> readTree(ObjectInputStream var1, int var2, Long2ReferenceAVLTreeMap.Entry<V> var3, Long2ReferenceAVLTreeMap.Entry<V> var4) throws IOException, ClassNotFoundException {
      Long2ReferenceAVLTreeMap.Entry var8;
      if (var2 == 1) {
         var8 = new Long2ReferenceAVLTreeMap.Entry(var1.readLong(), var1.readObject());
         var8.pred(var3);
         var8.succ(var4);
         return var8;
      } else if (var2 == 2) {
         var8 = new Long2ReferenceAVLTreeMap.Entry(var1.readLong(), var1.readObject());
         var8.right(new Long2ReferenceAVLTreeMap.Entry(var1.readLong(), var1.readObject()));
         ...
         Long2ReferenceAVLTreeMap.Entry var7 = new Long2ReferenceAVLTreeMap.Entry();
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      this.allocatePaths();
      if (this.count != 0) {
         this.tree = this.readTree(var1, this.count, (Long2ReferenceAVLTreeMap.Entry)null, (Long2ReferenceAVLTreeMap.Entry)null);
   ...
   private final class Submap extends AbstractLong2ReferenceSortedMap<V> implements Serializable {
      ...
      public Submap(long var2, boolean var4, long var5, boolean var7) {
         super();
         if (!var4 && !var7 && Long2ReferenceAVLTreeMap.this.compare(var2, var5) > 0) {
      ...
      public void clear() {
         Long2ReferenceAVLTreeMap.Submap.SubmapIterator var1 = new Long2ReferenceAVLTreeMap.Submap.SubmapIterator();
      ...
      final boolean in(long var1) {
         return (this.bottom || Long2ReferenceAVLTreeMap.this.compare(var1, this.from) >= 0) && (this.top || Long2ReferenceAVLTreeMap.this.compare(var1, this.to) < 0);
      }
      ...
      public boolean containsKey(long var1) {
         return this.in(var1) && Long2ReferenceAVLTreeMap.this.containsKey(var1);
      }

      public boolean containsValue(Object var1) {
         Long2ReferenceAVLTreeMap.Submap.SubmapIterator var2 = new Long2ReferenceAVLTreeMap.Submap.SubmapIterator();
      ...
      public V get(long var1) {
         Long2ReferenceAVLTreeMap.Entry var3;
         return this.in(var1) && (var3 = Long2ReferenceAVLTreeMap.this.findKey(var1)) != null ? var3.value : this.defRetValue;
      }
      ...
      public V put(long var1, V var3) {
         ...
         if (!this.in(var1)) {
            ...
            Object var4 = Long2ReferenceAVLTreeMap.this.put(var1, var3);
            return Long2ReferenceAVLTreeMap.this.modified ? this.defRetValue : var4;
         }
      }
      ...
      public V remove(long var1) {
         ...
         if (!this.in(var1)) {
            ...
            Object var3 = Long2ReferenceAVLTreeMap.this.remove(var1);
            return Long2ReferenceAVLTreeMap.this.modified ? var3 : this.defRetValue;
         }
      }
      ...
      public Long2ReferenceSortedMap<V> headMap(long var1) {
         if (this.top) {
            return Long2ReferenceAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false);
         } else {
            return Long2ReferenceAVLTreeMap.this.compare(var1, this.to) < 0 ? Long2ReferenceAVLTreeMap.this.new Submap(this.from, this.bottom, var1, false) : this;
         }
      }

      public Long2ReferenceSortedMap<V> tailMap(long var1) {
         if (this.bottom) {
            return Long2ReferenceAVLTreeMap.this.new Submap(var1, false, this.to, this.top);
         } else {
            return Long2ReferenceAVLTreeMap.this.compare(var1, this.from) > 0 ? Long2ReferenceAVLTreeMap.this.new Submap(var1, false, this.to, this.top) : this;
         }
      }

      public Long2ReferenceSortedMap<V> subMap(long var1, long var3) {
         if (this.top && this.bottom) {
            return Long2ReferenceAVLTreeMap.this.new Submap(var1, false, var3, false);
         } else {
            if (!this.top) {
               var3 = Long2ReferenceAVLTreeMap.this.compare(var3, this.to) < 0 ? var3 : this.to;
            }

            if (!this.bottom) {
               var1 = Long2ReferenceAVLTreeMap.this.compare(var1, this.from) > 0 ? var1 : this.from;
            }

            return !this.top && !this.bottom && var1 == this.from && var3 == this.to ? this : Long2ReferenceAVLTreeMap.this.new Submap(var1, false, var3, false);
         }
      }
      ...
      public Long2ReferenceAVLTreeMap.Entry<V> firstEntry() {
         if (Long2ReferenceAVLTreeMap.this.tree == null) {
            ...
            Long2ReferenceAVLTreeMap.Entry var1;
            if (this.bottom) {
               var1 = Long2ReferenceAVLTreeMap.this.firstEntry;
            } else {
               var1 = Long2ReferenceAVLTreeMap.this.locateKey(this.from);
               if (Long2ReferenceAVLTreeMap.this.compare(var1.key, this.from) < 0) {
                  var1 = var1.next();
               }
            }

            return var1 != null && (this.top || Long2ReferenceAVLTreeMap.this.compare(var1.key, this.to) < 0) ? var1 : null;
         }
      }
      ...
      public Long2ReferenceAVLTreeMap.Entry<V> lastEntry() {
         if (Long2ReferenceAVLTreeMap.this.tree == null) {
            ...
            Long2ReferenceAVLTreeMap.Entry var1;
            if (this.top) {
               var1 = Long2ReferenceAVLTreeMap.this.lastEntry;
            } else {
               var1 = Long2ReferenceAVLTreeMap.this.locateKey(this.to);
               if (Long2ReferenceAVLTreeMap.this.compare(var1.key, this.to) >= 0) {
                  var1 = var1.prev();
               }
            }

            return var1 != null && (this.bottom || Long2ReferenceAVLTreeMap.this.compare(var1.key, this.from) >= 0) ? var1 : null;
         }
      }

      public long firstLongKey() {
         Long2ReferenceAVLTreeMap.Entry var1 = this.firstEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      public long lastLongKey() {
         Long2ReferenceAVLTreeMap.Entry var1 = this.lastEntry();
         if (var1 == null) {
            throw new NoSuchElementException();
         } else {
            return var1.key;
      ...
      private class SubmapEntryIterator extends Long2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
         SubmapEntryIterator() {
            super();
         }
      ...
      private class SubmapIterator extends Long2ReferenceAVLTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(long var2) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2ReferenceAVLTreeMap.this.compare(var2, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2ReferenceAVLTreeMap.this.compare(var2, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
                  this.next = Long2ReferenceAVLTreeMap.this.locateKey(var2);
                  if (Long2ReferenceAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
                     this.prev = this.next;
   ...
   private class KeySet extends AbstractLong2ReferenceSortedMap<V>.KeySet {
      ...
      public LongBidirectionalIterator iterator(long var1) {
         return Long2ReferenceAVLTreeMap.this.new KeyIterator(var1);
      }
   ...
   private class EntryIterator extends Long2ReferenceAVLTreeMap<V>.TreeIterator implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
      EntryIterator() {
         super();
      }
   ...
   private class TreeIterator {
      ...
      TreeIterator(long var2) {
         super();
         if ((this.next = Long2ReferenceAVLTreeMap.this.locateKey(var2)) != null) {
            if (Long2ReferenceAVLTreeMap.this.compare(this.next.key, var2) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
   ...
   private static final class Entry<V> extends AbstractLong2ReferenceMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Long2ReferenceAVLTreeMap.Entry<V> var1) {
         this.info |= 1073741824;
         this.left = var1;
      }

      void succ(Long2ReferenceAVLTreeMap.Entry<V> var1) {
         this.info |= -2147483648;
         this.right = var1;
      }

      void left(Long2ReferenceAVLTreeMap.Entry<V> var1) {
         this.info &= -1073741825;
         this.left = var1;
      }

      void right(Long2ReferenceAVLTreeMap.Entry<V> var1) {
         this.info &= 2147483647;
         this.right = var1;
      }
      ...
      Long2ReferenceAVLTreeMap.Entry<V> next() {
         Long2ReferenceAVLTreeMap.Entry var1 = this.right;
      ...
      Long2ReferenceAVLTreeMap.Entry<V> prev() {
         Long2ReferenceAVLTreeMap.Entry var1 = this.left;
      ...
      public Long2ReferenceAVLTreeMap.Entry<V> clone() {
         Long2ReferenceAVLTreeMap.Entry var1;
         try {
            var1 = (Long2ReferenceAVLTreeMap.Entry)super.clone();
