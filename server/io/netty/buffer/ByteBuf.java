...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf> {
   ...
   public float getFloatLE(int var1) {
      return Float.intBitsToFloat(this.getIntLE(var1));
   }

   public abstract double getDouble(int var1);

   public double getDoubleLE(int var1) {
      return Double.longBitsToDouble(this.getLongLE(var1));
   }
   ...
   public ByteBuf setFloatLE(int var1, float var2) {
      return this.setIntLE(var1, Float.floatToRawIntBits(var2));
   }

   public abstract ByteBuf setDouble(int var1, double var2);

   public ByteBuf setDoubleLE(int var1, double var2) {
      return this.setLongLE(var1, Double.doubleToRawLongBits(var2));
   }
   ...
   public ByteBuf writeFloatLE(float var1) {
      return this.writeIntLE(Float.floatToRawIntBits(var1));
   }

   public abstract ByteBuf writeDouble(double var1);

   public ByteBuf writeDoubleLE(double var1) {
      return this.writeLongLE(Double.doubleToRawLongBits(var1));
   }
