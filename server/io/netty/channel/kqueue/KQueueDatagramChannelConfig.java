...
public final class KQueueDatagramChannelConfig extends KQueueChannelConfig implements DatagramChannelConfig {
   ...
   KQueueDatagramChannelConfig(KQueueDatagramChannel var1) {
      super(var1);
   ...
   public <T> T getOption(ChannelOption<T> var1) {
      if (var1 == ChannelOption.SO_BROADCAST) {
         ...
         return var1 == UnixChannelOption.SO_REUSEPORT ? this.isReusePort() : super.getOption(var1);
      }
   }
   ...
   public KQueueDatagramChannelConfig setReusePort(boolean var1) {
      try {
   ...
   public KQueueDatagramChannelConfig setRcvAllocTransportProvidesGuess(boolean var1) {
      super.setRcvAllocTransportProvidesGuess(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setMessageSizeEstimator(MessageSizeEstimator var1) {
   ...
   /** @deprecated */
   @Deprecated
   public KQueueDatagramChannelConfig setWriteBufferLowWaterMark(int var1) {
   ...
   /** @deprecated */
   @Deprecated
   public KQueueDatagramChannelConfig setWriteBufferHighWaterMark(int var1) {
      super.setWriteBufferHighWaterMark(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark var1) {
      super.setWriteBufferWaterMark(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setAutoClose(boolean var1) {
      super.setAutoClose(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setAutoRead(boolean var1) {
      super.setAutoRead(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator var1) {
      super.setRecvByteBufAllocator(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setWriteSpinCount(int var1) {
      super.setWriteSpinCount(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setAllocator(ByteBufAllocator var1) {
      super.setAllocator(var1);
      return this;
   }

   public KQueueDatagramChannelConfig setConnectTimeoutMillis(int var1) {
   ...
   /** @deprecated */
   @Deprecated
   public KQueueDatagramChannelConfig setMaxMessagesPerRead(int var1) {
   ...
   public KQueueDatagramChannelConfig setSendBufferSize(int var1) {
      try {
   ...
   public KQueueDatagramChannelConfig setReceiveBufferSize(int var1) {
      try {
   ...
   public KQueueDatagramChannelConfig setTrafficClass(int var1) {
      try {
   ...
   public KQueueDatagramChannelConfig setReuseAddress(boolean var1) {
      try {
   ...
   public KQueueDatagramChannelConfig setBroadcast(boolean var1) {
      try {
   ...
   public KQueueDatagramChannelConfig setTimeToLive(int var1) {
      throw new UnsupportedOperationException("Multicast not supported");
   }
   ...
   public KQueueDatagramChannelConfig setInterface(InetAddress var1) {
      throw new UnsupportedOperationException("Multicast not supported");
   }
   ...
   public KQueueDatagramChannelConfig setNetworkInterface(NetworkInterface var1) {
      throw new UnsupportedOperationException("Multicast not supported");
   }
}
