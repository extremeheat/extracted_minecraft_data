...
public class HttpResponseStatus implements Comparable<HttpResponseStatus> {
   ...
   private static HttpResponseStatus newStatus(int var0, String var1) {
      return new HttpResponseStatus(var0, var1, true);
   }

   public static HttpResponseStatus valueOf(int var0) {
      HttpResponseStatus var1 = valueOf0(var0);
      return var1 != null ? var1 : new HttpResponseStatus(var0);
   }

   private static HttpResponseStatus valueOf0(int var0) {
      switch(var0) {
      case 100:
         return CONTINUE;
      case 101:
   ...
   public static HttpResponseStatus valueOf(int var0, String var1) {
      HttpResponseStatus var2 = valueOf0(var0);
      return var2 != null && var2.reasonPhrase().contentEquals(var1) ? var2 : new HttpResponseStatus(var0, var1);
   }

   public static HttpResponseStatus parseLine(CharSequence var0) {
      return var0 instanceof AsciiString ? parseLine((AsciiString)var0) : parseLine(var0.toString());
   }

   public static HttpResponseStatus parseLine(String var0) {
      try {
         int var1 = var0.indexOf(32);
         return var1 == -1 ? valueOf(Integer.parseInt(var0)) : valueOf(Integer.parseInt(var0.substring(0, var1)), var0.substring(var1 + 1));
      } catch (Exception var2) {
         throw new IllegalArgumentException("malformed status line: " + var0, var2);
      }
   }

   public static HttpResponseStatus parseLine(AsciiString var0) {
      try {
         int var1 = var0.forEachByte(ByteProcessor.FIND_ASCII_SPACE);
         return var1 == -1 ? valueOf(var0.parseInt()) : valueOf(var0.parseInt(0, var1), var0.toString(var1 + 1));
      } catch (Exception var2) {
         throw new IllegalArgumentException("malformed status line: " + var0, var2);
      }
   }

   private HttpResponseStatus(int var1) {
      this(var1, HttpStatusClass.valueOf(var1).defaultReasonPhrase() + " (" + var1 + ')', false);
   }
   ...
   private HttpResponseStatus(int var1, String var2, boolean var3) {
      super();
      if (var1 < 0) {
         ...
         this.codeAsText = new AsciiString(var6);
         this.reasonPhrase = var2;
         if (var3) {
            this.bytes = (var6 + ' ' + var2).getBytes(CharsetUtil.US_ASCII);
         } else {
            this.bytes = null;
         }
   ...
   public HttpStatusClass codeClass() {
      HttpStatusClass var1 = this.codeClass;
      if (var1 == null) {
         this.codeClass = var1 = HttpStatusClass.valueOf(this.code);
      }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof HttpResponseStatus)) {
         return false;
      } else {
         return this.code() == ((HttpResponseStatus)var1).code();
      }
   }
   ...
   void encode(ByteBuf var1) {
      if (this.bytes == null) {
         ByteBufUtil.copy(this.codeAsText, var1);
         var1.writeByte(32);
         var1.writeCharSequence(this.reasonPhrase, CharsetUtil.US_ASCII);
      } else {
