...
public class DiskFileUpload extends AbstractDiskHttpData implements FileUpload {
   ...
   public FileUpload replace(ByteBuf var1) {
      DiskFileUpload var2 = new DiskFileUpload(this.getName(), this.getFilename(), this.getContentType(), this.getContentTransferEncoding(), this.getCharset(), this.size);
      if (var1 != null) {
         try {
