...
public class DefaultFullBinaryMemcacheRequest extends DefaultBinaryMemcacheRequest implements FullBinaryMemcacheRequest {
   ...
   public DefaultFullBinaryMemcacheRequest(ByteBuf var1, ByteBuf var2) {
      this(var1, var2, Unpooled.buffer(0));
   }

   public DefaultFullBinaryMemcacheRequest(ByteBuf var1, ByteBuf var2, ByteBuf var3) {
      super(var1, var2);
      if (var3 == null) {
   ...
   public FullBinaryMemcacheRequest copy() {
      ...
      return new DefaultFullBinaryMemcacheRequest(var1, var2, this.content().copy());
   }
   ...
   public FullBinaryMemcacheRequest duplicate() {
      ...
      return new DefaultFullBinaryMemcacheRequest(var1, var2, this.content().duplicate());
   }
   ...
   public FullBinaryMemcacheRequest replace(ByteBuf var1) {
      ...
      return new DefaultFullBinaryMemcacheRequest(var2, var3, var1);
   }
}
