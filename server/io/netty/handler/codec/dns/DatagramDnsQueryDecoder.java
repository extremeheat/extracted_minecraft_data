...
public class DatagramDnsQueryDecoder extends MessageToMessageDecoder<DatagramPacket> {
   ...
   public DatagramDnsQueryDecoder(DnsRecordDecoder var1) {
      super();
   ...
   protected void decode(ChannelHandlerContext var1, DatagramPacket var2, List<Object> var3) throws Exception {
      ...
      DnsQuery var5 = newQuery(var2, var4);
      boolean var6 = false;
   ...
   private static DnsQuery newQuery(DatagramPacket var0, ByteBuf var1) {
      int var2 = var1.readUnsignedShort();
      int var3 = var1.readUnsignedShort();
      if (var3 >> 15 == 1) {
         throw new CorruptedFrameException("not a query");
      } else {
         DatagramDnsQuery var4 = new DatagramDnsQuery((InetSocketAddress)var0.sender(), (InetSocketAddress)var0.recipient(), var2, DnsOpCode.valueOf((byte)(var3 >> 11 & 15)));
   ...
   private void decodeQuestions(DnsQuery var1, ByteBuf var2, int var3) throws Exception {
   ...
   private void decodeRecords(DnsQuery var1, DnsSection var2, ByteBuf var3, int var4) throws Exception {
