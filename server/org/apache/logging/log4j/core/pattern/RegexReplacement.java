...
public final class RegexReplacement {
   ...
   @PluginFactory
   public static RegexReplacement createRegexReplacement(@PluginAttribute("regex") Pattern var0, @PluginAttribute("replacement") String var1) {
      if (var0 == null) {
         ...
         return new RegexReplacement(var0, var1);
      }
   }
}
