...
public class Caverphone2 extends AbstractCaverphone {
   ...
   public String encode(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         var2 = var2.replaceAll("^trough", "trou2f");
         ...
         var2 = var2.replaceAll("^y", "A");
         var2 = var2.replaceAll("y", "3");
