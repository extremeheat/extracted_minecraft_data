...
public class HashCache {
   ...
   public void purgeStaleAndWrite() throws IOException {
      ...
      try {
         ...
         LOGGER.warn((String)"Unable write cachefile {}: {}", (Object)this.cachePath, (Object)var3.toString());
         return;
      }
      ...
      }).collect(Collectors.toList()), System.lineSeparator(), (Writer)var1);
      var1.close();
      LOGGER.debug((String)"Caching: cache hits: {}, created: {} removed: {}", (Object)this.hits, this.newCache.size() - this.hits, this.oldCache.size());
   }
      ...
      this.walkOutputFiles().forEach((var1) -> {
         if (this.had(var1) && !this.keep.contains(var1)) {
            try {
               ...
               LOGGER.debug((String)"Unable to delete: {} ({})", (Object)var1, (Object)var3.toString());
            }
         }
