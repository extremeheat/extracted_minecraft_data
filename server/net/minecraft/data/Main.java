...
public class Main {
   ...
   public static void main(String[] var0) throws IOException {
      ...
      ArgumentAcceptingOptionSpec var9 = var1.accepts("output", "Output folder").withRequiredArg().defaultsTo("generated");
      ArgumentAcceptingOptionSpec var10 = var1.accepts("input", "Input folder").withRequiredArg();
      OptionSet var11 = var1.parse(var0);
      if (!var11.has((OptionSpec)var2) && var11.hasOptions()) {
         Path var12 = Paths.get((String)var9.value(var11));
         boolean var13 = var11.has((OptionSpec)var8);
         boolean var14 = var13 || var11.has((OptionSpec)var4);
         boolean var15 = var13 || var11.has((OptionSpec)var3);
         boolean var16 = var13 || var11.has((OptionSpec)var5);
         boolean var17 = var13 || var11.has((OptionSpec)var6);
         boolean var18 = var13 || var11.has((OptionSpec)var7);
         DataGenerator var19 = createStandardGenerator(var12, (Collection)var11.valuesOf((OptionSpec)var10).stream().map((var0x) -> {
            return Paths.get(var0x);
         }).collect(Collectors.toList()), var14, var15, var16, var17, var18);
         var19.run();
      } else {
         var1.printHelpOn((OutputStream)System.out);
      }
   }
