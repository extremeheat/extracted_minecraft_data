...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   private Advancement.Builder addBreedable(Advancement.Builder var1) {
      ...
      var1.addCriterion(EntityType.getKey(EntityType.TURTLE).toString(), (CriterionTriggerInstance)BredAnimalsTrigger.TriggerInstance.bredAnimals(EntityPredicate.Builder.entity().of(EntityType.TURTLE).build(), EntityPredicate.Builder.entity().of(EntityType.TURTLE).build(), EntityPredicate.ANY));
      return var1;
   }
