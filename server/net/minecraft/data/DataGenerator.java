...
public class DataGenerator {
   ...
   public void run() throws IOException {
      ...
      while(var4.hasNext()) {
         ...
         LOGGER.info((String)"Starting provider: {}", (Object)var5.getName());
         var3.start();
         var5.run(var1);
         var3.stop();
         LOGGER.info((String)"{} finished after {} ms", (Object)var5.getName(), (Object)var3.elapsed(TimeUnit.MILLISECONDS));
         var3.reset();
      }

      LOGGER.info((String)"All providers took: {} ms", (Object)var2.elapsed(TimeUnit.MILLISECONDS));
