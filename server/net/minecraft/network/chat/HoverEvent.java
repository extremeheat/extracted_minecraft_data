   ...
   public static class ItemStackInfo {
         ...
         if (var0.isJsonPrimitive()) {
            ...
            if (var1.has("tag")) {
               ...
               try {
                  ...
                  HoverEvent.LOGGER.warn((String)"Failed to parse tag: {}", (Object)var4, (Object)var6);
               }
            }
      ...
      private static HoverEvent.ItemStackInfo create(Component var0) {
         try {
            ...
            HoverEvent.LOGGER.warn((String)"Failed to parse item tag: {}", (Object)var0, (Object)var2);
            return null;
         }
      }
      ...
      private JsonElement serialize() {
         ...
         if (this.count != 1) {
            var1.addProperty("count", (Number)this.count);
         }
