...
public enum MobCategory implements StringRepresentable {
   ...
   private static final Map<String, MobCategory> BY_NAME = (Map)Arrays.stream(values()).collect(Collectors.toMap(MobCategory::getName, (var0) -> {
      return var0;
   }));
   ...
   public static MobCategory byName(String var0) {
      return (MobCategory)BY_NAME.get(var0);
   }
