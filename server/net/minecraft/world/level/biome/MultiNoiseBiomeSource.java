...
public class MultiNoiseBiomeSource extends BiomeSource {
   ...
   public static final MapCodec<MultiNoiseBiomeSource> DIRECT_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
      return var0.group(Codec.LONG.fieldOf("seed").forGetter((var0x) -> {
         ...
         return var0x.group(Biome.ClimateParameters.CODEC.fieldOf("parameters").forGetter(Pair::getFirst), Biome.CODEC.fieldOf("biome").forGetter(Pair::getSecond)).apply(var0x, (BiFunction)(Pair::of));
      ...
      })).apply(var0, (Function6)(MultiNoiseBiomeSource::new));
   });
