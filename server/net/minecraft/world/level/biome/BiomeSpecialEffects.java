...
public class BiomeSpecialEffects {
   public static final Codec<BiomeSpecialEffects> CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      })).apply(var0, (Function12)(BiomeSpecialEffects::new));
   });
   ...
   // $FF: synthetic method
   BiomeSpecialEffects(int var1, int var2, int var3, int var4, Optional var5, Optional var6, BiomeSpecialEffects.GrassColorModifier var7, Optional var8, Optional var9, Optional var10, Optional var11, Optional var12, Object var13) {
   ...
   public static enum GrassColorModifier implements StringRepresentable {
      ...
      // $FF: synthetic method
      GrassColorModifier(String var3, Object var4) {
         this(var3);
      }
   }
