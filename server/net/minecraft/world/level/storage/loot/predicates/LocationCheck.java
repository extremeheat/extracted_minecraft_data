...
public class LocationCheck implements LootItemCondition {
   ...
   public boolean test(LootContext var1) {
      ...
      return var2 != null && this.predicate.matches(var1.getLevel(), var2.x() + (double)this.offset.getX(), var2.y() + (double)this.offset.getY(), var2.z() + (double)this.offset.getZ());
   }
   ...
   // $FF: synthetic method
   LocationCheck(LocationPredicate var1, BlockPos var2, Object var3) {
      this(var1, var2);
   }
   ...
   public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<LocationCheck> {
      ...
      public void serialize(JsonObject var1, LocationCheck var2, JsonSerializationContext var3) {
         ...
         if (var2.offset.getX() != 0) {
            var1.addProperty("offsetX", (Number)var2.offset.getX());
         }

         if (var2.offset.getY() != 0) {
            var1.addProperty("offsetY", (Number)var2.offset.getY());
         }

         if (var2.offset.getZ() != 0) {
            var1.addProperty("offsetZ", (Number)var2.offset.getZ());
         }
