...
public class PlayerDataStorage {
   ...
   public void save(Player var1) {
      try {
         ...
         LOGGER.warn((String)"Failed to save player data for {}", (Object)var1.getName().getString());
      }
   ...
   public CompoundTag load(Player var1) {
      ...
      try {
         ...
         LOGGER.warn((String)"Failed to load player data for {}", (Object)var1.getName().getString());
      }
