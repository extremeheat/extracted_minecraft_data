...
public class RegionFile implements AutoCloseable {
         ...
         if (var5 != -1) {
            ...
            for(int var8 = 0; var8 < 1024; ++var8) {
               ...
               if (var9 != 0) {
                  ...
                  if (var10 < 2) {
                     LOGGER.warn((String)"Region file {} has invalid sector at index: {}; sector {} overlaps with header", (Object)var1, var8, var10);
                     this.offsets.put(var8, 0);
                  } else if (var11 == 0) {
                     LOGGER.warn((String)"Region file {} has an invalid sector at index: {}; size has to be > 0", (Object)var1, (Object)var8);
                     this.offsets.put(var8, 0);
                  } else if ((long)var10 * 4096L > var6) {
                     LOGGER.warn((String)"Region file {} has an invalid sector at index: {}; sector {} is out of bounds", (Object)var1, var8, var10);
                     this.offsets.put(var8, 0);
                  } else {
   ...
   public synchronized DataInputStream getChunkDataInputStream(ChunkPos var1) throws IOException {
      ...
      if (var2 == 0) {
         ...
         var6.flip();
         if (var6.remaining() < 5) {
            LOGGER.error((String)"Chunk {} header is truncated: expected {} but read {}", (Object)var1, var5, var6.remaining());
            return null;
         } else {
            int var7 = var6.getInt();
            byte var8 = var6.get();
            if (var7 == 0) {
               LOGGER.warn((String)"Chunk {} is allocated, but stream is missing", (Object)var1);
               return null;
            } else {
               int var9 = var7 - 1;
               if (isExternalStreamChunk(var8)) {
                  ...
                  LOGGER.error((String)"Chunk {} stream is truncated: expected {} but read {}", (Object)var1, var9, var6.remaining());
                  return null;
               } else if (var9 < 0) {
                  LOGGER.error((String)"Declared size {} of chunk {} is negative", (Object)var7, (Object)var1);
                  return null;
               } else {
   ...
   private DataInputStream createChunkInputStream(ChunkPos var1, byte var2, InputStream var3) throws IOException {
      ...
      if (var4 == null) {
         LOGGER.error((String)"Chunk {} has invalid chunk stream version {}", (Object)var1, (Object)var2);
         return null;
      } else {
   ...
   private DataInputStream createExternalChunkInputStream(ChunkPos var1, byte var2) throws IOException {
      ...
      if (!Files.isRegularFile(var3, new LinkOption[0])) {
         LOGGER.error((String)"External chunk path {} is not file", (Object)var3);
         return null;
      } else {
   ...
   protected synchronized void write(ChunkPos var1, ByteBuffer var2) throws IOException {
      ...
      if (var8 >= 256) {
         ...
         LOGGER.warn((String)"Saving oversized chunk {} ({} bytes} to external file {}", (Object)var1, var7, var11);
         var8 = 1;
