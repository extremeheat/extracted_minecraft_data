...
public class AxisAlignedLinearPosTest extends PosRuleTest {
   public static final Codec<AxisAlignedLinearPosTest> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(Codec.FLOAT.fieldOf("min_chance").orElse(0.0F).forGetter((var0x) -> {
         ...
         return var0x.axis;
      })).apply(var0, (Function5)(AxisAlignedLinearPosTest::new));
   });
   ...
   public boolean test(BlockPos var1, BlockPos var2, BlockPos var3, Random var4) {
      ...
      return (double)var10 <= Mth.clampedLerp((double)this.minChance, (double)this.maxChance, Mth.inverseLerp((double)var9, (double)this.minDist, (double)this.maxDist));
   }
