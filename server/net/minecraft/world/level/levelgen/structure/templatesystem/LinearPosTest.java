...
public class LinearPosTest extends PosRuleTest {
   public static final Codec<LinearPosTest> CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      })).apply(var0, (Function4)(LinearPosTest::new));
   });
   ...
   public boolean test(BlockPos var1, BlockPos var2, BlockPos var3, Random var4) {
      ...
      return (double)var6 <= Mth.clampedLerp((double)this.minChance, (double)this.maxChance, Mth.inverseLerp((double)var5, (double)this.minDist, (double)this.maxDist));
   }
