...
public class V1460 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:arrow", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:chest_minecart", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:commandblock_minecart", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:donkey", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:enderman", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:falling_block", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:fireworks_rocket", (Function)((var1x) -> {
         return DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(var1));
      }));
      var1.register(var2, "minecraft:furnace_minecart", (Function)((var1x) -> {
         return DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1));
      }));
      registerMob(var1, var2, "minecraft:ghast");
      registerMob(var1, var2, "minecraft:giant");
      registerMob(var1, var2, "minecraft:guardian");
      var1.register(var2, "minecraft:hopper_minecart", (Function)((var1x) -> {
         return DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), "Items", DSL.list(References.ITEM_STACK.in(var1)));
      }));
      var1.register(var2, "minecraft:horse", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:item", (Function)((var1x) -> {
         return DSL.optionalFields("Item", References.ITEM_STACK.in(var1));
      }));
      var1.register(var2, "minecraft:item_frame", (Function)((var1x) -> {
         return DSL.optionalFields("Item", References.ITEM_STACK.in(var1));
      }));
      var1.registerSimple(var2, "minecraft:leash_knot");
      var1.register(var2, "minecraft:llama", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:minecart", (Function)((var1x) -> {
         return DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1));
      }));
      registerMob(var1, var2, "minecraft:mooshroom");
      var1.register(var2, "minecraft:mule", (Function)((var1x) -> {
         return DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(var1)), "SaddleItem", References.ITEM_STACK.in(var1), V100.equipment(var1));
      }));
      ...
      var1.register(var2, "minecraft:potion", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:skeleton_horse", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:spawner_minecart", (Function)((var1x) -> {
         return DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), References.UNTAGGED_SPAWNER.in(var1));
      }));
      var1.register(var2, "minecraft:spectral_arrow", (Function)((var1x) -> {
         return DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(var1));
      }));
      ...
      var1.register(var2, "minecraft:tnt_minecart", (Function)((var1x) -> {
         return DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1));
      }));
      registerMob(var1, var2, "minecraft:vex");
      var1.register(var2, "minecraft:villager", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:zombie_horse", (Function)((var1x) -> {
         return DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(var1), V100.equipment(var1));
      }));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:jukebox", (Function)((var1x) -> {
      ...
      var1.register(var2, "minecraft:mob_spawner", (Function)((var1x) -> {
         return References.UNTAGGED_SPAWNER.in(var1);
      }));
      var1.register(var2, "minecraft:piston", (Function)((var1x) -> {
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      ...
      var1.registerType(false, References.STRUCTURE_FEATURE, () -> {
         return DSL.optionalFields("Children", DSL.list(DSL.optionalFields("CA", References.BLOCK_STATE.in(var1), "CB", References.BLOCK_STATE.in(var1), "CC", References.BLOCK_STATE.in(var1), "CD", References.BLOCK_STATE.in(var1))));
      });
