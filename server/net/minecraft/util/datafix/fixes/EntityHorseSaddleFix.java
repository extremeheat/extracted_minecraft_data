...
public class EntityHorseSaddleFix extends NamedEntityFix {
   ...
   protected Typed<?> fix(Typed<?> var1) {
      ...
      if (!var5.isPresent() && var6.get("Saddle").asBoolean(false)) {
         ...
         var7 = var7.set(var2, (Object)Pair.of(References.ITEM_NAME.typeName(), "minecraft:saddle"));
         Dynamic var8 = var6.emptyMap();
         var8 = var8.set("Count", var8.createByte((byte)1));
         var8 = var8.set("Damage", var8.createShort((short)0));
         var7 = var7.set(DSL.remainderFinder(), (Object)var8);
         var6.remove("Saddle");
         return var1.set(var4, var7).set(DSL.remainderFinder(), (Object)var6);
      } else {
         return var1;
      }
   }
