         ...
         if (var4x.isPresent() && Objects.equals(((Pair)var4x.get()).getSecond(), "minecraft:shulker_box")) {
            ...
            if (var5.isPresent()) {
               ...
               if (var7.isPresent()) {
                  ...
                  var9.remove("Color");
                  return var3x.set(var3, var6.set(var4, var8.set(DSL.remainderFinder(), (Object)var9))).set(var2, (Object)Pair.of(References.ITEM_NAME.typeName(), NAMES_BY_COLOR[var10 % 16]));
               }
            }
         }
