                  ...
                  if (var11.get("Base").asNumber().result().isPresent()) {
                     ...
                     if (var12.isPresent()) {
                        ...
                        if (Objects.equals(var13, var14)) {
                           return var3x.set(DSL.remainderFinder(), (Object)var5);
                        }
                     }

                     var11.remove("Base");
                     return var3x.set(DSL.remainderFinder(), (Object)var5).set(var3, var7.set(var4, var9.set(DSL.remainderFinder(), (Object)var11)));
                  }
               }
            }
