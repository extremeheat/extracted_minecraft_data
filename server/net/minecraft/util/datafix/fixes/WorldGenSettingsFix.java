...
public class WorldGenSettingsFix extends DataFix {
   ...
   private static <T> Dynamic<T> noise(long var0, DynamicLike<T> var2, Dynamic<T> var3, Dynamic<T> var4) {
      return var2.createMap(ImmutableMap.of(var2.createString("type"), var2.createString("minecraft:noise"), var2.createString("biome_source"), var4, var2.createString("seed"), var2.createLong(var0), var2.createString("settings"), var3));
   }

   private static <T> Dynamic<T> vanillaBiomeSource(Dynamic<T> var0, long var1, boolean var3, boolean var4) {
      ImmutableMap.Builder var5 = ImmutableMap.builder().put(var0.createString("type"), var0.createString("minecraft:vanilla_layered")).put(var0.createString("seed"), var0.createLong(var1)).put(var0.createString("large_biomes"), var0.createBoolean(var4));
      if (var3) {
   ...
   private static <T> Dynamic<T> fix(Dynamic<T> var0) {
      ...
      return new Dynamic(var1, var1.createMap((Map)var23.build()));
   }
   ...
   protected static <T> T vanillaLevels(Dynamic<T> var0, long var1, Dynamic<T> var3, boolean var4) {
      ...
      return var5.createMap((Map)ImmutableMap.of(var5.createString("minecraft:overworld"), var5.createMap((Map)ImmutableMap.of(var5.createString("type"), var5.createString("minecraft:overworld" + (var4 ? "_caves" : "")), var5.createString("generator"), var3.getValue())), var5.createString("minecraft:the_nether"), var5.createMap((Map)ImmutableMap.of(var5.createString("type"), var5.createString("minecraft:the_nether"), var5.createString("generator"), noise(var1, var0, var0.createString("minecraft:nether"), var0.createMap(ImmutableMap.of(var0.createString("type"), var0.createString("minecraft:multi_noise"), var0.createString("seed"), var0.createLong(var1), var0.createString("preset"), var0.createString("minecraft:nether")))).getValue())), var5.createString("minecraft:the_end"), var5.createMap((Map)ImmutableMap.of(var5.createString("type"), var5.createString("minecraft:the_end"), var5.createString("generator"), noise(var1, var0, var0.createString("minecraft:end"), var0.createMap(ImmutableMap.of(var0.createString("type"), var0.createString("minecraft:the_end"), var0.createString("seed"), var0.createLong(var1)))).getValue()))));
   }
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> fixFlatStructures(DynamicOps<T> var0, OptionalDynamic<T> var1) {
            ...
            var6x.getMapValues().result().ifPresent((var6xx) -> {
               var6xx.forEach((var6x, var7) -> {
                  ...
                  if ("stronghold".equals(var8)) {
                     ...
                     case -895684237:
                        if (var9.equals("spread")) {
                           var12 = 1;
                        }
                        break;
                     case 94851343:
                        if (var9.equals("count")) {
                           var12 = 2;
                        }
                        break;
                     case 288459765:
                     ...
                     switch(var9.hashCode()) {
                     case -2116852922:
                        if (var9.equals("separation")) {
                           var12 = 1;
                        }
                        break;
                     case -2012158909:
                        if (var9.equals("spacing")) {
                           var12 = 2;
                        }
                        break;
                     case 288459765:
                     ...
                     case 0:
                        ...
                        switch(var8.hashCode()) {
                        case -1606796090:
                           if (var8.equals("endcity")) {
                              var15 = 2;
                           }
                           break;
                        case -107033518:
                           if (var8.equals("biome_1")) {
                              var15 = 1;
                           }
                           break;
                        case 460367020:
                           if (var8.equals("village")) {
                              var15 = 0;
                           }
                           break;
                        case 835798799:
                           if (var8.equals("mansion")) {
                              var15 = 3;
                           }
                        }
      ...
      var7.put(var1.createString("structures"), var1.createMap((Map)var6.entrySet().stream().collect(Collectors.toMap((var1x) -> {
         ...
         return ((WorldGenSettingsFix.StructureFeatureConfiguration)var1x.getValue()).serialize(var0);
      }))));
      if (var5.isTrue()) {
   ...
   static final class StructureFeatureConfiguration {
      public static final Codec<WorldGenSettingsFix.StructureFeatureConfiguration> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(Codec.INT.fieldOf("spacing").forGetter((var0x) -> {
            ...
            return var0x.salt;
         })).apply(var0, (Function3)(WorldGenSettingsFix.StructureFeatureConfiguration::new));
      });
