...
public class EntityEquipmentToArmorAndHandFix extends DataFix {
   ...
   private <IS> TypeRewriteRule cap(Type<IS> var1) {
      Type var2 = DSL.and(DSL.optional((Type)DSL.field("Equipment", (Type)DSL.list(var1))), DSL.remainderType());
      Type var3 = DSL.and(DSL.optional((Type)DSL.field("ArmorItems", (Type)DSL.list(var1))), DSL.optional((Type)DSL.field("HandItems", (Type)DSL.list(var1))), DSL.remainderType());
      ...
      return this.fixTypeEverywhereTyped("EntityEquipmentToArmorAndHandFix", this.getInputSchema().getType(References.ENTITY), this.getOutputSchema().getType(References.ENTITY), (var4x) -> {
         ...
         if (var8.isPresent()) {
            ...
            if (var9.size() > 1) {
               ArrayList var11 = Lists.newArrayList(var10, var10, var10, var10);
