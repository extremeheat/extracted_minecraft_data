...
public class EntityRidingToPassengersFix extends DataFix {
   ...
   private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule cap(Schema var1, Schema var2, Type<OldEntityTree> var3, Type<NewEntityTree> var4, Type<Entity> var5) {
      Type var6 = DSL.named(References.ENTITY_TREE.typeName(), DSL.and(DSL.optional((Type)DSL.field("Riding", var3)), var5));
      Type var7 = DSL.named(References.ENTITY_TREE.typeName(), DSL.and(DSL.optional((Type)DSL.field("Passengers", (Type)DSL.list(var4))), var5));
            ...
            return (var6) -> {
               ...
               while(true) {
                  Either var9 = (Either)DataFixUtils.orElse(var7.map((var4x) -> {
                     ...
                     Object var6 = var5.set(var11, (Object)var4x).getOptional(var12).orElseThrow(() -> {
