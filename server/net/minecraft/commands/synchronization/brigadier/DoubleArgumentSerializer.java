...
public class DoubleArgumentSerializer implements ArgumentSerializer<DoubleArgumentType> {
   ...
   public DoubleArgumentType deserializeFromNetwork(FriendlyByteBuf var1) {
      ...
      double var5 = BrigadierArgumentSerializers.numberHasMax(var2) ? var1.readDouble() : 1.7976931348623157E308D;
   ...
   public void serializeToJson(DoubleArgumentType var1, JsonObject var2) {
      if (var1.getMinimum() != -1.7976931348623157E308D) {
         var2.addProperty("min", (Number)var1.getMinimum());
      }

      if (var1.getMaximum() != 1.7976931348623157E308D) {
         var2.addProperty("max", (Number)var1.getMaximum());
      }
