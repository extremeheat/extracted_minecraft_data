   ...
   public static void main(String[] var0) {
      ...
      try {
         ...
         if (var16.has((OptionSpec)var3)) {
            LOGGER.info((String)"Initialized '{}' and '{}'", (Object)var18.toAbsolutePath(), (Object)var20.toAbsolutePath());
            return;
         }
         ...
         if (var37 == null) {
            ...
            if (var16.has((OptionSpec)var4)) {
               ...
               var39 = var16.has((OptionSpec)var5) ? var40.worldGenSettings.withBonusChest() : var40.worldGenSettings;
            }
         ...
         if (var16.has((OptionSpec)var6)) {
            forceUpgrade(var29, DataFixers.getDataFixer(), var16.has((OptionSpec)var7), () -> {
               return true;
