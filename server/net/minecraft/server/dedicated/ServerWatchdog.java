   ...
   public void run() {
      while(this.server.isRunning()) {
         ...
         if (var5 > this.maxTickTime) {
            LOGGER.fatal((String)"A single server tick took {} seconds (should be max {})", (Object)String.format(Locale.ROOT, "%.2f", (float)var5 / 1000.0F), (Object)String.format(Locale.ROOT, "%.2f", 0.05F));
