...
public class OldUsersConverter {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  ...
                  if (var2x == null) {
                     OldUsersConverter.LOGGER.warn((String)"Could not convert user banlist entry for {}", (Object)var1x.getName());
               ...
               public void onProfileLookupFailed(GameProfile var1x, Exception var2x) {
                  OldUsersConverter.LOGGER.warn((String)"Could not lookup user banlist entry for {}", (Object)var1x.getName(), (Object)var2x);
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               ...
               public void onProfileLookupFailed(GameProfile var1x, Exception var2) {
                  OldUsersConverter.LOGGER.warn((String)"Could not lookup oplist entry for {}", (Object)var1x.getName(), (Object)var2);
      ...
      if (OLD_WHITELIST.exists() && OLD_WHITELIST.isFile()) {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               ...
               public void onProfileLookupFailed(GameProfile var1x, Exception var2) {
                  OldUsersConverter.LOGGER.warn((String)"Could not lookup user whitelist entry for {}", (Object)var1x.getName(), (Object)var2);
                  if (!(var2 instanceof ProfileNotFoundException)) {
                     throw new OldUsersConverter.ConversionError("Could not request user " + var1x.getName() + " from backend systems", var2);
                  }
               }
      ...
      if (var1.exists() && var1.isDirectory()) {
         ...
         try {
            ...
            ProfileLookupCallback var14 = new ProfileLookupCallback() {
               ...
               public void onProfileLookupFailed(GameProfile var1x, Exception var2x) {
                  OldUsersConverter.LOGGER.warn((String)"Could not lookup user uuid for {}", (Object)var1x.getName(), (Object)var2x);
                  if (var2x instanceof ProfileNotFoundException) {
            ...
            lookupPlayers(var0, Lists.newArrayList((Object[])var13), var14);
            return true;
   ...
   private static boolean areOldUserlistsRemoved() {
      ...
      if (!var0 && !var1 && !var2 && !var3) {
         ...
         if (var0) {
            LOGGER.warn((String)"* {}", (Object)OLD_USERBANLIST.getName());
         }

         if (var1) {
            LOGGER.warn((String)"* {}", (Object)OLD_IPBANLIST.getName());
         }

         if (var2) {
            LOGGER.warn((String)"* {}", (Object)OLD_OPLIST.getName());
         }

         if (var3) {
            LOGGER.warn((String)"* {}", (Object)OLD_WHITELIST.getName());
         }
   ...
   private static boolean areOldPlayersConverted(MinecraftServer var0) {
      ...
      if (!var1.exists() || !var1.isDirectory() || var1.list().length <= 0 && var1.delete()) {
         ...
         LOGGER.warn((String)"** please restart the server and if the problem persists, remove the directory '{}'", (Object)var1.getPath());
         return false;
      }
   }
