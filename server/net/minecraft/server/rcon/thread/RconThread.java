...
public class RconThread extends GenericThread {
      ...
      try {
         while(this.running) {
            try {
               ...
               if (this.running) {
                  LOGGER.info((String)"IO exception: ", (Throwable)var8);
               }
            }
         }
      } finally {
         ...
         if (var4.isEmpty()) {
            ...
            try {
               ...
               if (!var6.start()) {
                  ...
                  LOGGER.info((String)"RCON running on {}:{}", (Object)var2, (Object)var3);
                  return var6;
               }
            } catch (IOException var7) {
               LOGGER.warn((String)"Unable to initialise RCON on {}:{}", (Object)var2, var3, var7);
               return null;
            }
         }
      } else {
         LOGGER.warn((String)"Invalid rcon port {} found in server.properties, rcon disabled!", (Object)var3);
         return null;
      }
   }
   ...
   private void closeSocket(ServerSocket var1) {
      LOGGER.debug((String)"closeSocket: {}", (Object)var1);

      try {
         var1.close();
      } catch (IOException var3) {
         LOGGER.warn((String)"Failed to close socket", (Throwable)var3);
      }
